...
public abstract class j8 {
    public static Context f44021a;
    public static i8.e f44022b;
    ...
    public static Context b(Context context) {
        Context context2;
        Context context3 = f44021a;
        if (context3 == null) {
            context.getApplicationContext();
            try {
                context2 = y6.e.c(context, y6.e.f46319b, "com.google.android.gms.maps_dynamite").f46328a;
            } catch (Exception e) {
                try {
                    if (!"com.google.android.gms.maps_dynamite".equals("com.google.android.gms.maps_dynamite")) {
                        ...
                        AtomicBoolean atomicBoolean2 = k6.g.f13511a;
                        context2 = context.createPackageContext("com.google.android.gms", 3);
                    }
