...
public abstract class j8 {
    public static Context f43971a;
    public static i8.e f43972b;
    ...
    public static Context b(Context context) {
        Context context2;
        Context context3 = f43971a;
        if (context3 == null) {
            context.getApplicationContext();
            try {
                context2 = y6.e.c(context, y6.e.f46273b, "com.google.android.gms.maps_dynamite").f46282a;
            } catch (Exception e) {
                try {
