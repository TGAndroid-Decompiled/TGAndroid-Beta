...
public final class g1 extends Binder implements j {
    public final WeakReference f14535a;
    public final ni.f f14536b;
    public final Set f14537c;
    public e9.z0 d;
    public int e;

    public g1(a0 a0Var) {
        attachInterface(this, "androidx.media3.session.IMediaSession");
        this.f14535a = new WeakReference(a0Var);
        this.f14536b = new ni.f(a0Var);
        this.f14537c = DesugarCollections.synchronizedSet(new HashSet());
        this.d = e9.z0.f8146r;
    }
    ...
    public static i9.w I0(a0 a0Var, r rVar, int i10, f1 f1Var, e2.h hVar) {
        ...
        ?? obj = new Object();
        wVar.a(new i5(a0Var, obj, hVar, wVar, 23), i9.q.f11051a);
        return obj;
    }
    ...
    public final void G0(i iVar, int i10, m1 m1Var, int i11, f1 f1Var) {
        ...
        try {
            a0 a0Var = (a0) this.f14535a.get();
            if (a0Var != null && !a0Var.j()) {
                r t10 = this.f14536b.t(iVar.asBinder());
                if (t10 == null) {
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                    return;
                }
                e2.d0.U(a0Var.f14456l, new x0(this, t10, m1Var, a0Var, i10, i11, f1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final i1 H0(i1 i1Var) {
        e9.i0 i0Var = i1Var.D.f3318a;
        e9.f0 u10 = e9.i0.u();
        ?? aVar = new a5.a(4, 5);
        for (int i10 = 0; i10 < i0Var.size(); i10++) {
            b2.r1 r1Var = (b2.r1) i0Var.get(i10);
            b2.l1 l1Var = r1Var.f3265b;
            ...
            if (str == null) {
                ...
                sb2.append("-");
                sb2.append(l1Var.f3089b);
                str = sb2.toString();
            }
            aVar.F(l1Var, str);
            u10.b(new b2.r1(new b2.l1(str, r1Var.f3265b.d), r1Var.f3266c, r1Var.d, r1Var.e));
        }
        this.d = aVar.e();
        ...
        while (it.hasNext()) {
            ...
            b2.l1 l1Var2 = m1Var.f3115a;
            String str3 = (String) this.d.get(l1Var2);
            if (str3 != null) {
                c10.a(new b2.m1(new b2.l1(str3, l1Var2.d), m1Var.f3116b));
            } else {
                c10.a(m1Var);
            }
        }
        ...
        if (iVar != null && bundle != null) {
            try {
                ...
                try {
                    ...
                    synchronized (fVar.f15255a) {
                        r t10 = fVar.t(asBinder);
                        vVar = null;
                        if (t10 != null) {
                            eVar = (e) ((a0.f) fVar.f15257c).get(t10);
                        } else {
                            eVar = null;
                        }
                    }
    ...
    public final void N0(r rVar, int i10, int i11, f1 f1Var) {
        ...
        try {
            a0 a0Var = (a0) this.f14535a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.f14456l, new ii.i0(this, rVar, i11, a0Var, i10, f1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 3015:
                ...
                WeakReference weakReference = this.f14535a;
                if (G06 != null && bundle2 != null) {
                    try {
                        ...
                        try {
                            n4.a0 a0Var = new n4.a0(a2.f14507c, callingPid, callingUid);
                            a0 a0Var2 = (a0) weakReference.get();
                            if (a0Var2 != null && n4.d0.a(a0Var2.f14451f).b(a0Var)) {
                                z10 = true;
                            } else {
                                z10 = false;
                            }
                            int i12 = a2.f14505a;
                            int i13 = a2.f14506b;
                            r rVar = new r(a0Var, i12, i13, z10, new c1(G06, i13), a2.e);
                            a0 a0Var3 = (a0) weakReference.get();
                            if (a0Var3 != null && !a0Var3.j()) {
                                this.f14537c.add(rVar);
                                try {
                                    try {
                                        e2.d0.U(a0Var3.f14456l, new i5(this, rVar, a0Var3, G06, 22));
                                        break;
                                    } catch (Throwable th2) {
                                        th = th2;
                                        throw th;
            ...
            case 3016:
                ...
                if (G07 != null && bundle3 != null && bundle4 != null) {
                    try {
                        int i14 = bundle3.getInt(m1.f14613f, 0);
                        if (i14 != 0) {
                            m1Var = new m1(i14);
                        } else {
                            String string = bundle3.getString(m1.f14614g);
                            string.getClass();
                            Bundle bundle5 = bundle3.getBundle(m1.h);
                            if (bundle5 == null) {
                                bundle5 = Bundle.EMPTY;
                            }
                            m1Var = new m1(string, bundle5);
                        }
                        g1Var = this;
                        g1Var.G0(G07, readInt6, m1Var, 0, new y0(new j2.e(25, m1Var, bundle4), 1));
                        break;
            ...
            case 3019:
                ...
                if (G010 != null && readInt11 >= 0) {
                    M0(G010, readInt10, 20, new k2.v(new n0(this, readInt11, 4), 4));
                    return true;
                }
                break;
            case 3020:
                ...
                if (G011 != null && readInt13 >= 0 && readInt14 >= readInt13) {
                    M0(G011, readInt12, 20, new k2.v(new m0(this, readInt13, readInt14), 4));
                    return true;
                }
                break;
            case 3021:
                ...
                if (G013 != null && readInt17 >= 0 && readInt18 >= 0) {
                    M0(G013, readInt16, 20, P0(new e2.h() {
                        ...
                        public final void accept(Object obj) {
                            switch (r3) {
                                case 0:
                                    ((k1) obj).M(readInt17, readInt18);
                                    return;
                                default:
                                    ((k1) obj).q0(readInt17, readInt18);
                                    return;
                            }
                        }
                    }));
            ...
            case 3023:
                ...
                if (G014 != null && readInt20 >= 0 && readInt21 >= readInt20 && readInt22 >= 0) {
                    M0(G014, readInt19, 20, P0(new e2.h() {
                        @Override
                        public final void accept(Object obj) {
                            ((k1) obj).r0(readInt20, readInt21, readInt22);
                        }
                    }));
                    return true;
                }
            ...
            case 3024:
                ...
                if (G015 != null && (t10 = this.f14536b.t(G015.asBinder())) != null) {
            ...
            case 3025:
                ...
                if (G016 != null && (t11 = this.f14536b.t(G016.asBinder())) != null) {
            ...
            case 3027:
                ...
                if (G018 != null && bundle6 != null) {
                    try {
                        M0(G018, readInt26, 13, P0(new f3(new b2.v0(bundle6.getFloat(b2.v0.e, 1.0f), bundle6.getFloat(b2.v0.f3332f, 1.0f)), 6)));
                        break;
            ...
            case 3029:
                ...
                if (G020 != null && bundle7 != null) {
                    try {
                        ...
                        M0(G020, readInt28, 20, new y0(new ah.b(26, new f1() {
                            @Override
            ...
            case 3030:
                ...
                if (G021 != null && bundle8 != null && readInt30 >= 0) {
                    try {
                        ...
                        M0(G021, readInt29, 20, new y0(new ah.b(26, new f1() {
                            @Override
                            public final Object h(a0 a0Var4, r rVar2, int i15) {
                                switch (r2) {
                                    case 0:
            ...
            case 3031:
                ...
                if (G022 != null && readStrongBinder2 != null) {
                    try {
                        ...
                        M0(G022, readInt31, 20, new y0(new ah.b(26, new i2.y(3, u10.i()), new j2.e(28)), 1));
                        break;
            ...
            case 3032:
                ...
                if (G023 != null && readStrongBinder3 != null && readInt33 >= 0) {
                    try {
                        ...
                        M0(G023, readInt32, 20, new y0(new ah.b(26, new i2.y(2, u11.i()), new n0(this, readInt33, 3)), 1));
                        break;
            ...
            case 3034:
                ...
                if (G025 != null && (t12 = this.f14536b.t(G025.asBinder())) != null) {
            ...
            case 3035:
                ...
                if (G026 != null) {
                    ...
                    try {
                        a0 a0Var4 = (a0) this.f14535a.get();
                        if (a0Var4 != null && !a0Var4.j()) {
                            e2.d0.U(a0Var4.f14456l, new g0(1, this, G026));
                            return true;
                        }
                        return true;
                    } finally {
            ...
            case 3037:
                ...
                if (G028 != null && readInt38 >= 0) {
                    M0(G028, readInt37, 10, new k2.v(new n0(this, readInt38, 0), 4));
                    return true;
                }
                break;
            case 3038:
            ...
            case 3039:
                ...
                if (G030 != null && readInt41 >= 0) {
                    M0(G030, readInt40, 10, new k2.v(new j2.d(this, readInt41, readLong2, 1), 4));
                    return true;
                }
                break;
            case 3040:
                ...
                if (G031 != null && (t13 = this.f14536b.t(G031.asBinder())) != null) {
            ...
            case 3041:
                ...
                if (G032 != null && (t14 = this.f14536b.t(G032.asBinder())) != null) {
            ...
            case 3045:
                ...
                if (G036 != null) {
                    ...
                    try {
                        a0 a0Var5 = (a0) this.f14535a.get();
                        if (a0Var5 != null && !a0Var5.j()) {
                            r t17 = this.f14536b.t(G036.asBinder());
                            if (t17 != null) {
                                e2.d0.U(a0Var5.f14456l, new g0(2, this, t17));
                            }
                            return true;
                        }
                        return true;
            ...
            case 3046:
                ...
                if (G037 != null && (t15 = this.f14536b.t(G037.asBinder())) != null) {
            ...
            case 3047:
                ...
                if (G038 != null && (t16 = this.f14536b.t(G038.asBinder())) != null) {
            ...
            case 3049:
                ...
                if (G040 != null && readString != null && bundle13 != null) {
                    if (TextUtils.isEmpty(readString)) {
                        ...
                        try {
                            g1Var = this;
                            g1Var.G0(G040, readInt50, null, 40010, new y0(new j2.e(27, readString, b2.c1.a(bundle13)), 1));
                            break;
            ...
            case 3050:
                ...
                if (G041 != null && bundle14 != null) {
                    try {
                        G0(G041, readInt51, null, 40010, new y0(new u0(b2.c1.a(bundle14), 5), 1));
                ...
                if (G042 != null && readInt53 >= 0) {
                    M0(G042, readInt52, 33, P0(new e2.h() {
                        ...
                        public final void accept(Object obj) {
                            switch (r3) {
                                case 0:
                                    ((k1) obj).M(readInt53, readInt54);
                                    return;
                                default:
                                    ((k1) obj).q0(readInt53, readInt54);
                                    return;
                            }
                        }
                    }));
            ...
            case 3055:
                ...
                if (G046 != null && bundle15 != null && readInt62 >= 0) {
                    try {
                        ...
                        M0(G046, readInt61, 20, new y0(new ah.b(26, new f1() {
                            @Override
            ...
            case 3056:
                ...
                if (G047 != null && readStrongBinder4 != null && readInt64 >= 0 && readInt65 >= readInt64) {
                    try {
                        ...
                        M0(G047, readInt63, 20, new y0(new ah.b(26, new k2.v(u12.i(), 3), new m0(this, readInt64, readInt65)), 1));
                        break;
                ...
                switch (i10) {
                    case 4001:
                        ...
                        if (G049 != null) {
                            ...
                            g1Var = this;
                            g1Var.G0(G049, readInt67, null, 50000, new y0(new u0(nVar, 1), 0));
                            break;
                        }
                        break;
                    case 4002:
                        ...
                        if (G050 != null) {
                            ...
                            G0(G050, readInt68, null, 50004, new y0(new j2.e(readString2, 26), 0));
                            return true;
                        }
                        break;
                    case 4003:
                        ...
                        if (G051 != null) {
                            if (TextUtils.isEmpty(readString3)) {
                                ...
                                G0(G051, readInt69, null, 50003, new y0(new j2.e(readString3, readInt70, readInt71, nVar), 0));
                            }
                        }
                        break;
                    case 4004:
                        ...
                        if (G052 != null) {
                            if (TextUtils.isEmpty(readString4)) {
                                ...
                                G0(G052, readInt72, null, 50005, new y0(new u0(readString4, nVar, 3), 0));
                            }
                        }
                        break;
                    case 4005:
                        ...
                        if (G053 != null) {
                            if (TextUtils.isEmpty(readString5)) {
                                ...
                                G0(G053, readInt73, null, 50006, new y0(new u0(readString5, readInt74, readInt75, nVar), 0));
                            }
                        }
                        break;
                    case 4006:
                        ...
                        if (G054 != null) {
                            if (TextUtils.isEmpty(readString6)) {
                                ...
                                G0(G054, readInt76, null, 50001, new y0(new u0(readString6, nVar, 2), 0));
                            }
                        }
                        break;
                    case 4007:
                        ...
                        if (G055 != null) {
                            ...
                            G0(G055, readInt77, null, 50002, new y0(new j2.e(readString7, 23), 0));
                            return true;
                        }
                        break;
                    default:
