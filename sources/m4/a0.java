...
public class a0 {
    ...
    public final x f14452c;
    public final w d;
    public final na.d e;
    public final Context f14453f;
    public final g1 f14454g;
    public final l0 h;
    public final String f14455i;
    public final r1 f14456j;
    public final t f14457k;
    public final Handler f14458l;
    public final n4.y f14459m;
    public final u f14460n;
    public final Handler f14461o;
    public final boolean f14462p;
    public final boolean f14463q;
    public final e9.i0 f14464r;
    public i1 f14465s;
    public k1 f14466t;
    public y f14467u;
    public boolean v;
    ...
    public final e9.i0 f14470y;
    public final e9.i0 f14471z;
    ...
    public a0(t tVar, Context context, b2.b1 b1Var, e9.i0 i0Var, e9.i0 i0Var2, e9.i0 i0Var3, na.d dVar, Bundle bundle, Bundle bundle2, n4.y yVar) {
        e2.a.i("MediaSessionImpl", "Init " + Integer.toHexString(System.identityHashCode(this)) + " [AndroidXMedia3/1.8.1] [" + e2.d0.f7883a + "]");
        this.f14457k = tVar;
        this.f14453f = context;
        this.f14455i = "pip-media-session";
        this.f14470y = i0Var;
        this.f14471z = i0Var2;
        this.f14464r = i0Var3;
        this.e = dVar;
        ...
        this.f14454g = g1Var;
        this.f14461o = new Handler(Looper.getMainLooper());
        Looper y02 = b1Var.y0();
        Handler handler = new Handler(y02);
        this.f14458l = handler;
        this.f14465s = i1.F;
        this.f14452c = new x(this, y02);
        ...
        this.f14451b = build;
        l0 l0Var = new l0(this, build, handler, bundle, i0Var, i0Var2, p.e, p.f14636f, bundle2);
        this.h = l0Var;
        this.f14456j = new r1(Process.myUid(), context.getPackageName(), g1Var, bundle, ((n4.r) l0Var.f14599k.f14994b).f14977c.f14991b);
        k1 k1Var = new k1(b1Var);
        this.f14466t = k1Var;
        e2.d0.U(handler, new x1(29, this, k1Var));
        this.f14468w = 3000L;
        this.f14460n = new u(this, 2);
        e2.d0.U(handler, new u(this, 3));
    }

    public static void a(a0 a0Var) {
        synchronized (a0Var.f14450a) {
            try {
                if (a0Var.v) {
                    return;
                }
                final p1 O0 = a0Var.f14466t.O0();
                if (!a0Var.f14452c.hasMessages(1)) {
                    p1 p1Var = a0Var.f14465s.f14559c;
                    b2.a1 a1Var = O0.f14653a;
                    int i10 = a1Var.f2925b;
                    b2.a1 a1Var2 = p1Var.f14653a;
                    if (i10 == a1Var2.f2925b && a1Var.e == a1Var2.e && a1Var.h == a1Var2.h && a1Var.f2929i == a1Var2.f2929i) {
                        ni.f fVar = a0Var.f14454g.f14538b;
                        e9.i0 s10 = fVar.s();
                        for (int i11 = 0; i11 < s10.size(); i11++) {
                            ...
                            a0Var.c(rVar, new z() {
                                ...
                                public final void d(q qVar, int i12) {
                                    qVar.e(i12, p1.this, B2, B3, rVar.f14669c);
                                }
                            });
                        }
                        try {
                            a0Var.h.f14597i.e(0, O0, true, true, 0);
    ...
    public static boolean k(r rVar) {
        if (rVar != null && Objects.equals(rVar.f14667a.f14929a.f14930a, "com.android.systemui")) {
            return true;
        }
        return false;
    }
    ...
    public final boolean b(KeyEvent keyEvent, boolean z10, boolean z11) {
        ...
        e2.d0.U(this.f14458l, new s4(this, z11, e, bVar, 6));
        return true;
    }

    public final void c(r rVar, z zVar) {
        int i10;
        g1 g1Var = this.f14454g;
        try {
    ...
    public final void d(z zVar) {
        e9.i0 s10 = this.f14454g.f14538b.s();
        for (int i10 = 0; i10 < s10.size(); i10++) {
            c((r) s10.get(i10), zVar);
        }
        try {
            zVar.d(this.h.f14597i, 0);
        } catch (RemoteException e) {
            e2.a.f("MediaSessionImpl", "Exception in using media1 API", e);
        }
    }
    ...
    public final void f(b2.x0 x0Var) {
        this.f14452c.a(false, false);
        d(new k2.v(x0Var, 3));
        try {
            j0 j0Var = this.h.f14597i;
            b2.l lVar = this.f14465s.f14570q;
            j0Var.k();
        } catch (RemoteException e) {
            e2.a.f("MediaSessionImpl", "Exception in using media1 API", e);
        }
    ...
    public final void g(r rVar, boolean z10) {
        ...
        boolean z12;
        if (o()) {
            if (this.f14466t.m0(16) && this.f14466t.w() != null) {
                z11 = true;
            } else {
                z11 = false;
            }
            if (!this.f14466t.m0(31) && !this.f14466t.m0(20)) {
                z12 = false;
            } else {
                z12 = true;
            }
    ...
    public final boolean h(r rVar) {
        if (!this.f14454g.f14538b.A(rVar) && !this.h.f14595f.A(rVar)) {
            return false;
        }
        return true;
    }
    ...
    public final boolean i(r rVar) {
        if (!Objects.equals(rVar.f14667a.f14929a.f14930a, this.f14453f.getPackageName()) || rVar.f14668b == 0 || !new Bundle(rVar.e).getBoolean("androidx.media3.session.MediaNotificationManager", false)) {
            return false;
        }
        return true;
    }
    ...
    public final p m(r rVar) {
        e9.i0 v;
        boolean z10 = this.f14469x;
        e9.i0 i0Var = null;
        l0 l0Var = this.h;
        if (z10 && k(rVar)) {
            l0Var.getClass();
            n1 n1Var = p.e;
            n1 n1Var2 = l0Var.f14609u;
            n1Var2.getClass();
            b2.x0 x0Var = l0Var.v;
            x0Var.getClass();
            e9.i0 i0Var2 = l0Var.f14607s;
            if (i0Var2 == null) {
                v = null;
            } else {
                v = e9.i0.v(i0Var2);
            }
            e9.i0 i0Var3 = l0Var.f14608t;
            if (i0Var3 != null) {
        ...
        if (i(rVar)) {
            ...
            this.f14469x = true;
            t tVar = this.f14457k;
            e9.i0 i0Var4 = tVar.f14699a.f14471z;
            if (i0Var4.isEmpty()) {
                l0Var.f14607s = tVar.f14699a.f14470y;
            } else {
                l0Var.f14608t = i0Var4;
                Bundle bundle = l0Var.f14606r;
                ...
                if (bundle.getBoolean("android.media.playback.ALWAYS_RESERVE_SPACE_FOR.ACTION_SKIP_TO_PREVIOUS", false) != z12 || bundle.getBoolean("android.media.playback.ALWAYS_RESERVE_SPACE_FOR.ACTION_SKIP_TO_NEXT", false) != z13) {
                    ((n4.r) l0Var.f14599k.f14994b).f14975a.setExtras(bundle);
                }
            }
            a0 a0Var = l0Var.f14596g;
            Bundle bundle2 = l0Var.f14606r;
            if (l0Var.v.a(17) == x0Var2.a(17)) {
                z11 = false;
            }
            l0Var.f14609u = n1Var3;
            l0Var.v = x0Var2;
            if (!l0Var.f14608t.isEmpty()) {
                ...
                if (bundle2.getBoolean("android.media.playback.ALWAYS_RESERVE_SPACE_FOR.ACTION_SKIP_TO_PREVIOUS", false) != z14 || bundle2.getBoolean("android.media.playback.ALWAYS_RESERVE_SPACE_FOR.ACTION_SKIP_TO_NEXT", false) != z15) {
                    ((n4.r) l0Var.f14599k.f14994b).f14975a.setExtras(bundle2);
                }
            }
            if (z11) {
                e2.d0.U(a0Var.f14458l, new f0(l0Var, a0Var.f14466t, 0));
                return pVar;
            }
            l0Var.N(a0Var.f14466t);
        }
        return pVar;
    }
    ...
    public final boolean o() {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            ?? obj = new Object();
            this.f14461o.post(new x1(27, this, (Object) obj));
            try {
    ...
    public final void r() {
        e2.a.i("MediaSessionImpl", "Release " + Integer.toHexString(System.identityHashCode(this)) + " [AndroidXMedia3/1.8.1] [" + e2.d0.f7883a + "] [" + b2.l0.b() + "]");
        synchronized (this.f14450a) {
            try {
                if (this.v) {
                    return;
                ...
                this.v = true;
                w wVar = this.d;
                gg.t tVar = wVar.f14711a;
                if (tVar != null) {
                    wVar.removeCallbacks(tVar);
                    wVar.f14711a = null;
                }
                this.f14458l.removeCallbacksAndMessages(null);
                try {
                    e2.d0.U(this.f14458l, new u(this, 0));
                } catch (Exception e) {
                    e2.a.o("MediaSessionImpl", "Exception thrown while closing", e);
                }
                l0 l0Var = this.h;
                ComponentName componentName = l0Var.f14601m;
                a0 a0Var = l0Var.f14596g;
                ...
                if (i10 < 31) {
                    if (componentName == null) {
                        ((n4.r) yVar.f14994b).f14975a.setMediaButtonReceiver(null);
                    } else {
                        Intent intent = new Intent("android.intent.action.MEDIA_BUTTON", a0Var.f14451b);
                        intent.setComponent(componentName);
                        ((n4.r) yVar.f14994b).f14975a.setMediaButtonReceiver(PendingIntent.getBroadcast(a0Var.f14453f, 0, intent, l0.f14594w));
                    }
                }
                androidx.mediarouter.app.g gVar = l0Var.f14600l;
                if (gVar != null) {
                    a0Var.f14453f.unregisterReceiver(gVar);
                }
                ...
                rVar.f14976b.f14974a.clear();
                mediaSession.release();
                g1 g1Var = this.f14454g;
                Set<r> set = g1Var.f14539c;
    ...
    public final void t() {
        Handler handler = this.f14458l;
        u uVar = this.f14460n;
        handler.removeCallbacks(uVar);
        if (this.f14463q) {
            long j3 = this.f14468w;
            if (j3 > 0) {
                if (this.f14466t.i0() || this.f14466t.c()) {
    ...
    public final void u(k1 k1Var, k1 k1Var2) {
        ...
        this.f14467u = yVar2;
        try {
            l0Var.f14597i.m(0, k1Var, k1Var2);
        } catch (RemoteException e) {
            e2.a.f("MediaSessionImpl", "Exception in using media1 API", e);
        }
        if (k1Var == null) {
            ((n4.r) l0Var.f14599k.f14994b).f14975a.setActive(true);
        }
        b2.u0 W = k1Var2.W();
        p1 O0 = k1Var2.O0();
        b2.a1 N0 = k1Var2.N0();
        ...
        this.f14465s = new i1(W, 0, O0, N0, N02, 0, h, l4, A0, E, Q0, 0, n0Var2, f7, eVar2, dVar2, K, i10, z10, u10, 1, u02, d, i02, c10, R0, L0, Z, z11, s1Var, k1Var2.B0());
        f(k1Var2.t());
    }

    public final void v() {
        if (Looper.myLooper() == this.f14458l.getLooper()) {
            return;
        }
