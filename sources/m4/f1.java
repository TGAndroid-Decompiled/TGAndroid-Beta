...
public final class f1 extends Binder implements j {
    public final WeakReference f14746a;
    public final oi.f f14747b;
    public final Set f14748c;
    public e9.z0 d;
    public int e;

    public f1(a0 a0Var) {
        attachInterface(this, "androidx.media3.session.IMediaSession");
        this.f14746a = new WeakReference(a0Var);
        this.f14747b = new oi.f(a0Var);
        this.f14748c = DesugarCollections.synchronizedSet(new HashSet());
        this.d = e9.z0.f8148r;
    }
    ...
    public final void G0(i iVar, int i10, l1 l1Var, int i11, e1 e1Var) {
        ...
        try {
            a0 a0Var = (a0) this.f14746a.get();
            if (a0Var != null && !a0Var.j()) {
                r t10 = this.f14747b.t(iVar.asBinder());
                if (t10 == null) {
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                    return;
                }
                e2.d0.U(a0Var.f14694l, new w0(this, t10, l1Var, a0Var, i10, i11, e1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final h1 H0(h1 h1Var) {
        ...
        for (int i10 = 0; i10 < i0Var.size(); i10++) {
            ...
            aVar.F(l1Var, str);
            u10.b(new b2.r1(new b2.l1(str, r1Var.f3267b.d), r1Var.f3268c, r1Var.d, r1Var.e));
        }
        this.d = aVar.d();
            ...
            try {
                ...
                try {
                    ...
                    synchronized (fVar.f15763a) {
                        ...
                        vVar = null;
                        if (t10 != null) {
                            eVar = (e) ((a0.f) fVar.f15765c).get(t10);
                        } else {
                            eVar = null;
                        }
                    }
    ...
    public final void N0(r rVar, int i10, int i11, e1 e1Var) {
        ...
        try {
            a0 a0Var = (a0) this.f14746a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.f14694l, new ii.i0(this, rVar, i11, a0Var, i10, e1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 3015:
                ...
                WeakReference weakReference = this.f14746a;
                if (G06 != null && bundle2 != null) {
                    try {
                        ...
                        try {
                            n4.a0 a0Var = new n4.a0(a2.f14742c, callingPid, callingUid);
                            a0 a0Var2 = (a0) weakReference.get();
                            if (a0Var2 != null && n4.d0.a(a0Var2.f14689f).b(a0Var)) {
                                z10 = true;
                            } else {
                                z10 = false;
                            }
                            ...
                            if (a0Var3 != null && !a0Var3.j()) {
                                this.f14748c.add(rVar);
                                try {
                                    try {
                                        e2.d0.U(a0Var3.f14694l, new i5(this, rVar, a0Var3, G06, 22));
                                        break;
                                    } catch (Throwable th2) {
                                        th = th2;
                                        throw th;
            ...
            case 3016:
                ...
                if (G07 != null && bundle3 != null && bundle4 != null) {
                    try {
                        int i14 = bundle3.getInt(l1.f14845f, 0);
                        if (i14 != 0) {
                            l1Var = new l1(i14);
                        } else {
                            String string = bundle3.getString(l1.f14846g);
                            string.getClass();
            ...
            case 3017:
                ...
                if (G08 != null && (readInt8 == 2 || readInt8 == 0 || readInt8 == 1)) {
                    M0(G08, readInt7, 15, P0(new ai.m(readInt8, 3)));
                    return true;
                }
                break;
            case 3018:
            ...
            case 3019:
                ...
                if (G010 != null && readInt11 >= 0) {
                    M0(G010, readInt10, 20, new k2.v(new m0(this, readInt11, 4), 5));
                    return true;
                }
                break;
            case 3020:
                ...
                if (G011 != null && readInt13 >= 0 && readInt14 >= readInt13) {
                    M0(G011, readInt12, 20, new k2.v(new l0(this, readInt13, readInt14), 5));
                    return true;
                }
                break;
            case 3021:
                ...
                if (G012 != null) {
                    M0(G012, readInt15, 20, P0(new ai.i(17)));
                    return true;
                }
                break;
            case 3022:
            ...
            case 3024:
                ...
                if (G015 != null && (t10 = this.f14747b.t(G015.asBinder())) != null) {
            ...
            case 3025:
                ...
                if (G016 != null && (t11 = this.f14747b.t(G016.asBinder())) != null) {
            ...
            case 3026:
                ...
                if (G017 != null) {
                    M0(G017, readInt25, 2, P0(new ai.i(15)));
                    return true;
                }
                break;
            case 3027:
                ...
                if (G018 != null && bundle6 != null) {
                    try {
                        M0(G018, readInt26, 13, P0(new f3(new b2.v0(bundle6.getFloat(b2.v0.e, 1.0f), bundle6.getFloat(b2.v0.f3334f, 1.0f)), 6)));
                        break;
            ...
            case 3032:
                ...
                if (G023 != null && readStrongBinder3 != null && readInt33 >= 0) {
                    try {
                        ...
                        M0(G023, readInt32, 20, new x0(new ah.b(27, new i2.y(2, u11.i()), new m0(this, readInt33, 3)), 1));
                        break;
            ...
            case 3033:
                ...
                if (G024 != null && bundle11 != null) {
                    try {
                        M0(G024, readInt34, 19, P0(new f3(b2.n0.b(bundle11), 8)));
                        break;
            ...
            case 3034:
                ...
                if (G025 != null && (t12 = this.f14747b.t(G025.asBinder())) != null) {
            ...
            case 3035:
                ...
                if (G026 != null) {
                    ...
                    try {
                        a0 a0Var4 = (a0) this.f14746a.get();
                        if (a0Var4 != null && !a0Var4.j()) {
                            e2.d0.U(a0Var4.f14694l, new ki.l(7, this, G026));
                            return true;
                        }
                        return true;
                    } finally {
            ...
            case 3036:
                ...
                if (G027 != null) {
                    M0(G027, readInt36, 4, P0(new ai.i(16)));
                    return true;
                }
                break;
            case 3037:
                ...
                if (G028 != null && readInt38 >= 0) {
                    M0(G028, readInt37, 10, new k2.v(new m0(this, readInt38, 0), 5));
                    return true;
                }
                break;
            case 3038:
            ...
            case 3039:
                ...
                if (G030 != null && readInt41 >= 0) {
                    M0(G030, readInt40, 10, new k2.v(new j2.d(this, readInt41, readLong2, 1), 5));
                    return true;
                }
                break;
            case 3040:
                ...
                if (G031 != null && (t13 = this.f14747b.t(G031.asBinder())) != null) {
            ...
            case 3041:
                ...
                if (G032 != null && (t14 = this.f14747b.t(G032.asBinder())) != null) {
            ...
            case 3042:
                ...
                if (G033 != null) {
                    M0(G033, readInt44, 6, P0(new ai.i(10)));
                    return true;
                }
                break;
            case 3043:
                ...
                if (G034 != null) {
                    M0(G034, readInt45, 8, P0(new ai.i(6)));
                    return true;
                }
                break;
            case 3044:
                ...
                if (G035 != null) {
                    M0(G035, readInt46, 27, P0(new f3(surface, 7)));
                    return true;
                }
                break;
            case 3045:
                ...
                if (G036 != null) {
                    ...
                    try {
                        a0 a0Var5 = (a0) this.f14746a.get();
                        if (a0Var5 != null && !a0Var5.j()) {
                            r t17 = this.f14747b.t(G036.asBinder());
                            if (t17 != null) {
                                e2.d0.U(a0Var5.f14694l, new ki.l(8, this, t17));
                            }
                            return true;
                        }
                        return true;
            ...
            case 3046:
                ...
                if (G037 != null && (t15 = this.f14747b.t(G037.asBinder())) != null) {
            ...
            case 3047:
                ...
                if (G038 != null && (t16 = this.f14747b.t(G038.asBinder())) != null) {
            ...
            case 3048:
                ...
                if (G039 != null && bundle12 != null) {
                    try {
                        M0(G039, readInt49, 29, P0(new g3(1, this, b2.q1.b(bundle12))));
                        break;
            ...
            case 3052:
                ...
                if (G043 != null) {
                    M0(G043, readInt55, 34, P0(new ai.m(readInt56, 2)));
                    return true;
                }
                break;
            case 3053:
                ...
                if (G044 != null) {
                    M0(G044, readInt57, 34, P0(new ai.m(readInt58, 1)));
                    return true;
                }
                break;
            case 3054:
            ...
            case 3056:
                ...
                if (G047 != null && readStrongBinder4 != null && readInt64 >= 0 && readInt65 >= readInt64) {
                    try {
                        ...
                        M0(G047, readInt63, 20, new x0(new ah.b(27, new k2.v(u12.i(), 4), new l0(this, readInt64, readInt65)), 1));
                        break;
            ...
            case 3057:
                ...
                if (G048 != null && bundle17 != null) {
                    try {
                        M0(G048, readInt66, 35, P0(new t0(0, b2.e.a(bundle17), z12)));
                        break;
