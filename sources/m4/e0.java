    ...
    public final void run() {
        ...
        switch (this.f15900a) {
            ...
            case 2:
                ...
                int i11 = qsVar.N;
                if (this.f15902c == qsVar.f29836d0 && TextUtils.equals(tL_messages_searchGlobal.f20007q, qsVar.f29837e0)) {
                    qsVar.Z = false;
                    if (!this.f15901b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i12 < size) {
                            ...
                            messageObject.setQuery(qsVar.f29837e0);
                            arrayList.add(messageObject);
                        }
                        qsVar.f29834b0 = messages_messages instanceof TLRPC.TL_messages_messagesSlice;
                        Math.max(arrayList.size(), messages_messages.count);
                        qsVar.f29835c0 = messages_messages.next_rate;
                    }
                    qsVar.N(true);
                    return;
                }
            ...
            case 3:
                ...
                int i13 = ssVar.N;
                if (this.f15902c == ssVar.f30433a0 && TextUtils.equals(tL_messages_searchGlobal2.f20007q, ssVar.f30434b0)) {
                    ssVar.W = false;
                    if (!this.f15901b) {
                        arrayList3.clear();
                    }
                    if (tLObject2 instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size2) {
                            ...
                            messageObject2.setQuery(ssVar.f30434b0);
            ...
            default:
                ...
                if (document != null) {
                    ...
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, j6.f20635a7, 0.3f);
