...
public final class e0 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f15873a) {
            case 0:
                k0 k0Var = (k0) this.d;
                n4.a0 a0Var = (n4.a0) this.f15876e;
                j0 j0Var = (j0) this.f15877f;
                a0 a0Var2 = k0Var.f15970g;
                if (!a0Var2.j()) {
                    boolean isActive = ((n4.r) k0Var.f15973k.f16496b).f16476a.isActive();
                    int i10 = this.f15875c;
                    if (!isActive) {
                        StringBuilder l4 = i2.g.l(i10, "Ignore incoming player command before initialization. command=", ", pid=");
                        l4.append(a0Var.f16425a.f16427b);
                        e2.a.n("MediaSessionLegacyStub", l4.toString());
                        return;
                    }
                    r L = k0Var.L(a0Var);
                    if (!k0Var.f15969f.C(L, i10)) {
                        if (i10 == 1 && !a0Var2.f15843t.u()) {
                ...
                return;
            case 1:
                ((MessagesController) this.d).lambda$startShortPoll$333((TLRPC.Chat) this.f15876e, this.f15874b, this.f15875c, (q0.a) this.f15877f);
                return;
            case 2:
                qs qsVar = (qs) this.d;
                TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal = (TLRPC.TL_messages_searchGlobal) this.f15876e;
                TLObject tLObject = (TLObject) this.f15877f;
                ArrayList arrayList = qsVar.T;
                int i11 = qsVar.N;
                if (this.f15875c == qsVar.f29808d0 && TextUtils.equals(tL_messages_searchGlobal.f19980q, qsVar.f29809e0)) {
                    qsVar.Z = false;
                    if (!this.f15874b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i12 < size) {
                            ...
                            messageObject.setQuery(qsVar.f29809e0);
                            arrayList.add(messageObject);
                        }
                        qsVar.f29806b0 = messages_messages instanceof TLRPC.TL_messages_messagesSlice;
                        Math.max(arrayList.size(), messages_messages.count);
                        qsVar.f29807c0 = messages_messages.next_rate;
                    }
                    qsVar.N(true);
                    return;
                }
            ...
            case 3:
                ss ssVar = (ss) this.d;
                TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal2 = (TLRPC.TL_messages_searchGlobal) this.f15876e;
                TLObject tLObject2 = (TLObject) this.f15877f;
                ArrayList arrayList3 = ssVar.P;
                int i13 = ssVar.N;
                if (this.f15875c == ssVar.f30405a0 && TextUtils.equals(tL_messages_searchGlobal2.f19980q, ssVar.f30406b0)) {
                    ssVar.W = false;
                    if (!this.f15874b) {
                        arrayList3.clear();
                    }
                    if (tLObject2 instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size2) {
                            ...
                            messageObject2.setQuery(ssVar.f30406b0);
            ...
            case 4:
                ...
                qg.r0 r0Var = (qg.r0) this.f15876e;
                Runnable runnable = (Runnable) this.f15877f;
                ...
                q0Var.d(r0Var, this.f15875c, rectF);
                if (z10) {
                    q0Var.h = null;
                }
                if (runnable != null) {
            ...
            default:
                ...
                ImageReceiver imageReceiver = (ImageReceiver) this.f15876e;
                boolean[] zArr = (boolean[]) this.f15877f;
                boolean z11 = this.f15874b;
                int i15 = this.f15875c;
                if (z11) {
                        ...
                        if (i16 < tL_messages_stickerSet.packs.size()) {
                            ...
                            if (TextUtils.equals(tL_stickerPack.emoticon, str2) && !tL_stickerPack.documents.isEmpty()) {
                                ...
                                for (int i17 = 0; i17 < tL_messages_stickerSet.documents.size(); i17++) {
                                    ...
                                    if (document == null || document.f19875id != longValue) {
                                    }
                                }
                            } else {
                                i16++;
                ...
                if (document != null) {
                    ...
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, j6.f20607a7, 0.3f);
    ...
    public e0(v51 v51Var, int i10, TLRPC.TL_messages_searchGlobal tL_messages_searchGlobal, boolean z10, TLObject tLObject, int i11) {
        ...
        this.d = v51Var;
        this.f15875c = i10;
        this.f15876e = tL_messages_searchGlobal;
        this.f15874b = z10;
        this.f15877f = tLObject;
    }
