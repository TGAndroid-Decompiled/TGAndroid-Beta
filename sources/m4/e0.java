    ...
    public final void run() {
        ...
        switch (this.f14508a) {
            ...
            case 2:
                ...
                int i11 = rsVar.N;
                if (this.f14510c == rsVar.f27684d0 && TextUtils.equals(tL_messages_searchGlobal.f18232q, rsVar.f27685e0)) {
                    rsVar.Z = false;
                    if (!this.f14509b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i12 < size) {
                            ...
                            messageObject.setQuery(rsVar.f27685e0);
                            arrayList.add(messageObject);
                        }
                        rsVar.f27682b0 = messages_messages instanceof TLRPC.TL_messages_messagesSlice;
                        Math.max(arrayList.size(), messages_messages.count);
                        rsVar.f27683c0 = messages_messages.next_rate;
                    }
                    rsVar.N(true);
                    return;
                }
            ...
            case 3:
                ...
                int i13 = tsVar.N;
                if (this.f14510c == tsVar.f28199a0 && TextUtils.equals(tL_messages_searchGlobal2.f18232q, tsVar.f28200b0)) {
                    tsVar.W = false;
                    if (!this.f14509b) {
                        arrayList3.clear();
                    }
                    if (tLObject2 instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size2) {
                            ...
                            messageObject2.setQuery(tsVar.f28200b0);
            ...
            default:
                ...
                if (document != null) {
                    ...
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, j6.f18807a7, 0.3f);
