    ...
    public final void run() {
        ...
        switch (this.f15873a) {
            ...
            case 2:
                ...
                int i11 = qsVar.N;
                if (this.f15875c == qsVar.f29809d0 && TextUtils.equals(tL_messages_searchGlobal.f19980q, qsVar.f29810e0)) {
                    qsVar.Z = false;
                    if (!this.f15874b) {
                        arrayList.clear();
                    }
                    if (tLObject instanceof TLRPC.messages_Messages) {
                        ...
                        while (i12 < size) {
                            ...
                            messageObject.setQuery(qsVar.f29810e0);
                            arrayList.add(messageObject);
                        }
                        qsVar.f29807b0 = messages_messages instanceof TLRPC.TL_messages_messagesSlice;
                        Math.max(arrayList.size(), messages_messages.count);
                        qsVar.f29808c0 = messages_messages.next_rate;
                    }
                    qsVar.N(true);
                    return;
                }
            ...
            case 3:
                ...
                int i13 = ssVar.N;
                if (this.f15875c == ssVar.f30406a0 && TextUtils.equals(tL_messages_searchGlobal2.f19980q, ssVar.f30407b0)) {
                    ssVar.W = false;
                    if (!this.f15874b) {
                        arrayList3.clear();
                    }
                    if (tLObject2 instanceof TLRPC.messages_Messages) {
                        ...
                        while (i14 < size2) {
                            ...
                            messageObject2.setQuery(ssVar.f30407b0);
            ...
            default:
                ...
                if (document != null) {
                    ...
                    SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(document, j6.f20608a7, 0.3f);
