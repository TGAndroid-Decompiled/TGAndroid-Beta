...
public final class h0 implements k0, IMapsProvider.OnMarkerClickListener {
    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        ArrayList arrayList = kd0Var.f35224g0;
        if (iMarker.getTag() instanceof jd0) {
            ...
            if (!kd0Var.C0) {
                ...
                kd0Var.f35214a.setTag(Integer.valueOf(i14));
                kd0Var.C0 = true;
            }
            int i15 = 0;
            while (true) {
            ...
            if (jd0Var != null && kd0Var2.f35231n0 != jd0Var) {
                kd0Var2.y0(false);
                ...
                kd0Var2.f35231n0 = jd0Var;
                kd0Var2.m0 = iMarker;
                Context context = hd0Var.getContext();
                FrameLayout frameLayout = new FrameLayout(context);
                hd0Var.addView(frameLayout, x5.c(114.0f, -2));
                FrameLayout frameLayout2 = new FrameLayout(context);
                kd0Var2.f35232o0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                kd0Var2.f35232o0.getBackground().setColorFilter(new PorterDuffColorFilter(kd0Var2.getThemedColor(j6.f18933h5), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(kd0Var2.f35232o0, x5.c(71.0f, -2));
                kd0Var2.f35232o0.setAlpha(0.0f);
                kd0Var2.f35232o0.setOnClickListener(new uv(17, hd0Var, jd0Var));
                ...
                FrameLayout frameLayout3 = kd0Var2.f35232o0;
                if (LocaleController.isRTL) {
                    i11 = 5;
                } else {
                    i11 = 3;
                ...
                f7.setGravity(i12);
                FrameLayout frameLayout4 = kd0Var2.f35232o0;
                if (LocaleController.isRTL) {
                    i13 = 5;
                } else {
                    i13 = 3;
                ...
                textView.setText(jd0Var.f34849c.title);
                f7.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout5 = new FrameLayout(context);
                frameLayout5.setBackground(j6.K(AndroidUtilities.dp(36.0f), t4.a(jd0Var.f34847a)));
                frameLayout.addView(frameLayout5, x5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                u9 u9Var = new u9(context);
                u9Var.f(a4.a.s(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), jd0Var.f34849c.venue_type, "_64.png"), null, null);
