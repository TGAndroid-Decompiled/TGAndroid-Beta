...
public final class h0 implements k0, IMapsProvider.OnMarkerClickListener {
    ...
    public void g(r rVar) {
        ((l0) this.f14542b).f14596g.f14466t.a(this.f14541a);
    }
    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        int i12;
        int i13;
        id0 id0Var = (id0) this.f14542b;
        ArrayList arrayList = id0Var.f34622g0;
        if (iMarker.getTag() instanceof hd0) {
            ...
            if (!id0Var.C0) {
                ...
                id0Var.f34612a.setTag(Integer.valueOf(i14));
                id0Var.C0 = true;
            }
            int i15 = 0;
            while (true) {
                ...
                if (cd0Var != null && cd0Var.e == iMarker) {
                    ...
                    id0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(cd0Var.e.getPosition(), this.f14541a));
                } else {
                    i15++;
                }
            }
            ...
            if (hd0Var != null && id0Var2.f34629n0 != hd0Var) {
                id0Var2.y0(false);
                ...
                id0Var2.f34629n0 = hd0Var;
                id0Var2.m0 = iMarker;
                Context context = fd0Var.getContext();
                FrameLayout frameLayout = new FrameLayout(context);
                fd0Var.addView(frameLayout, x5.c(114.0f, -2));
                FrameLayout frameLayout2 = new FrameLayout(context);
                id0Var2.f34630o0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                id0Var2.f34630o0.getBackground().setColorFilter(new PorterDuffColorFilter(id0Var2.getThemedColor(i6.f18907h5), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(id0Var2.f34630o0, x5.c(71.0f, -2));
                id0Var2.f34630o0.setAlpha(0.0f);
                id0Var2.f34630o0.setOnClickListener(new sv(17, fd0Var, hd0Var));
                ...
                FrameLayout frameLayout3 = id0Var2.f34630o0;
                if (LocaleController.isRTL) {
                    i11 = 5;
                } else {
                    i11 = 3;
                ...
                f7.setGravity(i12);
                FrameLayout frameLayout4 = id0Var2.f34630o0;
                if (LocaleController.isRTL) {
                    i13 = 5;
                } else {
                    i13 = 3;
                ...
                textView.setText(hd0Var.f34245c.title);
                f7.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout5 = new FrameLayout(context);
                frameLayout5.setBackground(i6.K(AndroidUtilities.dp(36.0f), t4.a(hd0Var.f34243a)));
                frameLayout.addView(frameLayout5, x5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                u9 u9Var = new u9(context);
                u9Var.f(a4.a.s(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), hd0Var.f34245c.venue_type, "_64.png"), null, null);
