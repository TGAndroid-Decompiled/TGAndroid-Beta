...
public final class t0 implements e2.h {
    ...
    public final void accept(Object obj) {
        ...
        switch (this.f14880a) {
            case 0:
                ((j1) obj).K0((b2.e) this.f14882c, this.f14881b);
                return;
            case 1:
                sc scVar = (sc) this.f14882c;
                View view = (View) obj;
                rc rcVar = (rc) view;
                ...
                return;
            case 2:
                zn znVar = (zn) this.f14882c;
                View view2 = (View) obj;
                boolean z13 = view2 instanceof u1;
                boolean z14 = this.f14881b;
                if (z13) {
                    u1 u1Var = (u1) view2;
                    ...
                    ((org.telegram.ui.Cells.w0) view2).f21694e0 = z14;
                    return;
                } else {
                    return;
                }
            default:
                w81 w81Var = (w81) this.f14882c;
                View view3 = (View) obj;
                w81Var.v.getClass();
                int S = RecyclerView.S(view3);
                if (view3 instanceof u81) {
                    u81 u81Var = (u81) view3;
                    if (this.f14881b && (v81Var = w81Var.f29986y) != null && ((l.d) v81Var).G(S)) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
