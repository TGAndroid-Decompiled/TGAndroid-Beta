...
public final class w0 implements Runnable {
    ...
    public final void run() {
        switch (this.f14929a) {
            case 0:
                r rVar = (r) this.e;
                l1 l1Var = (l1) this.f14932f;
                a0 a0Var = (a0) this.h;
                e1 e1Var = (e1) this.f14933n;
                oi.f fVar = ((f1) this.d).f14732b;
                if (fVar.A(rVar)) {
                    ...
                    } else if (!fVar.C(rVar, this.f14931c)) {
                        f1.O0(a0Var, rVar, i10, new p1(-4));
                        return;
                    }
                ...
                return;
            default:
                ((MediaDataController) this.d).lambda$toggleStickerSet$108((boolean[]) this.e, (TLRPC.StickerSet) this.f14932f, this.f14930b, this.f14931c, (TLRPC.TL_messages_stickerSet) this.h, (Runnable) this.f14933n);
                return;
        }
    }
    ...
    public w0(MediaDataController mediaDataController, boolean[] zArr, TLRPC.StickerSet stickerSet, int i10, int i11, TLRPC.TL_messages_stickerSet tL_messages_stickerSet, Runnable runnable) {
        ...
        this.e = zArr;
        this.f14932f = stickerSet;
        this.f14930b = i10;
        this.f14931c = i11;
        this.h = tL_messages_stickerSet;
        this.f14933n = runnable;
    }
}
