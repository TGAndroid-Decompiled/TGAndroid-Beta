...
public final class i0 implements i9.r, q {
    ...
    public void c(int i10, b2.x0 x0Var) {
        ...
        if (k0Var.f14846q != i11) {
            k0Var.f14846q = i11;
            ((n4.r) k0Var.f14840k.f15207b).f15188a.setFlags(i11 | 3);
        }
        k0Var.N(e1Var);
    }
    ...
    public void d(int i10, g1 g1Var) {
        ...
        n4.y yVar = ((k0) this.e).f14840k;
        String str = g1Var.f14803b;
        yVar.getClass();
        if (!TextUtils.isEmpty(str)) {
            ...
            if (Build.VERSION.SDK_INT < 23) {
                synchronized (rVar.d) {
                    for (int beginBroadcast = rVar.f15191f.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                        try {
                            ((n4.f) rVar.f15191f.getBroadcastItem(beginBroadcast)).t0(str);
            ...
            rVar.f15188a.sendSessionEvent(str, bundle);
            return;
        }
    ...
    public void h(Throwable th2) {
        if (this != ((k0) ((i0) this.e).e).f14845p) {
            return;
        }
    ...
    public void j(b2.e eVar) {
        k0 k0Var = (k0) this.e;
        k0Var.f14837g.f14692t.K().getClass();
        int e = k.e(eVar);
        n4.r rVar = (n4.r) k0Var.f14840k.f15207b;
        rVar.getClass();
        AudioAttributes.Builder builder = new AudioAttributes.Builder();
        builder.setLegacyStreamType(e);
        rVar.f15188a.setPlaybackToLocal(builder.build());
    }
    ...
    public void l(b2.k0 k0Var) {
        k0 k0Var2 = (k0) this.e;
        n4.y yVar = k0Var2.f14840k;
        r();
        if (k0Var == null) {
            ((n4.r) yVar.f15207b).e(0);
        } else {
            ((n4.r) yVar.f15207b).e(k.f(k0Var.d.f3139i));
        }
    ...
    public void n(b2.n0 n0Var) {
        ...
        if (!TextUtils.equals(((n4.j) ((k2.u) yVar.f15208c).f13369b).f15170a.getQueueTitle(), n0Var.f3134a)) {
            ((n4.r) yVar.f15207b).f15188a.setQueueTitle((k0Var.v.a(17) && k0Var.f14837g.f14692t.t().a(17)) ? null : null);
        }
    }
    ...
    public void o(int i10) {
        ...
        if (rVar.f15195k != i12) {
            ...
            synchronized (rVar.d) {
                for (int beginBroadcast = rVar.f15191f.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        ((n4.f) rVar.f15191f.getBroadcastItem(beginBroadcast)).onRepeatModeChanged(i12);
                    } catch (RemoteException | SecurityException e) {
    ...
    public void onSuccess(Object obj) {
        ...
        if (this != k0Var.f14845p) {
            return;
        }
        k0.E(k0Var.f14840k, k.b(this.f14809a, this.f14810b, this.f14811c, this.d, bitmap));
        a0 a0Var = k0Var.f14837g;
        e2.d0.U(a0Var.f14687o, new u(a0Var, 1));
    }
    ...
    public void p(boolean z10) {
        ...
        n4.r rVar = (n4.r) yVar.f15207b;
        if (rVar.f15196l != z10) {
            rVar.f15196l = z10 ? 1 : 0;
            synchronized (rVar.d) {
                for (int beginBroadcast = rVar.f15191f.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                    try {
                        ((n4.f) rVar.f15191f.getBroadcastItem(beginBroadcast)).h(z10 ? 1 : 0);
                    } catch (RemoteException | SecurityException e) {
    ...
    public void r() {
        ...
        if (bArr != null) {
            ...
            Uri uri5 = R0.f3143m;
            if (uri5 != null) {
                la.h hVar = (la.h) yVar.f15208c;
                if (hVar != null && (uri2 = (Uri) hVar.f14152c) != null && uri2.equals(uri5)) {
                    wVar = (i9.w) ((la.h) yVar.f15208c).d;
                    e2.d.h(wVar);
                } else {
                    g2.i iVar = (g2.i) yVar.f15207b;
                    i9.w a2 = ((i9.y) iVar.f9348a).a(new com.google.firebase.messaging.h(2, iVar, uri5));
                    yVar.f15208c = new la.h(uri5, a2);
                    wVar = a2;
                }
            } else {
                wVar = null;
        ...
        if (wVar != null) {
            ...
            if (wVar.isDone()) {
                ...
                k0.E(k0Var.f14840k, k.b(n0Var, str2, uri3, j3, bitmap));
            }
        }
        j3 = j10;
        uri3 = uri;
