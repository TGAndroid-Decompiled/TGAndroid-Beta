...
public final class g0 implements j0, IMapsProvider.OnMarkerClickListener {
    ...
    public void f(r rVar) {
        ((k0) this.f14771b).f14821g.f14702t.a(this.f14770a);
    }
    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        int i12;
        int i13;
        kd0 kd0Var = (kd0) this.f14771b;
        ArrayList arrayList = kd0Var.f35125g0;
        if (iMarker.getTag() instanceof jd0) {
            ...
            if (!kd0Var.C0) {
                ...
                kd0Var.f35115a.setTag(Integer.valueOf(i14));
                kd0Var.C0 = true;
            }
            int i15 = 0;
            while (true) {
                ...
                if (ed0Var != null && ed0Var.e == iMarker) {
                    ...
                    kd0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(ed0Var.e.getPosition(), this.f14770a));
                } else {
                    i15++;
                }
            }
            ...
            if (jd0Var != null && kd0Var2.f35132n0 != jd0Var) {
                kd0Var2.y0(false);
                ...
                kd0Var2.f35132n0 = jd0Var;
                kd0Var2.m0 = iMarker;
                Context context = hd0Var.getContext();
                FrameLayout frameLayout = new FrameLayout(context);
                hd0Var.addView(frameLayout, y5.c(114.0f, -2));
                FrameLayout frameLayout2 = new FrameLayout(context);
                kd0Var2.f35133o0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                kd0Var2.f35133o0.getBackground().setColorFilter(new PorterDuffColorFilter(kd0Var2.getThemedColor(j6.f19180h5), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(kd0Var2.f35133o0, y5.c(71.0f, -2));
                kd0Var2.f35133o0.setAlpha(0.0f);
                kd0Var2.f35133o0.setOnClickListener(new tv(17, hd0Var, jd0Var));
                ...
                FrameLayout frameLayout3 = kd0Var2.f35133o0;
                if (LocaleController.isRTL) {
                    i11 = 5;
                } else {
                    i11 = 3;
                ...
                h.setGravity(i12);
                FrameLayout frameLayout4 = kd0Var2.f35133o0;
                if (LocaleController.isRTL) {
                    i13 = 5;
                } else {
                    i13 = 3;
                ...
                textView.setText(jd0Var.f34922c.title);
                h.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout5 = new FrameLayout(context);
                frameLayout5.setBackground(j6.K(AndroidUtilities.dp(36.0f), v4.a(jd0Var.f34920a)));
                frameLayout.addView(frameLayout5, y5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                v9 v9Var = new v9(context);
                v9Var.f(a4.a.s(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), jd0Var.f34922c.venue_type, "_64.png"), null, null);
