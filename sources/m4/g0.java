...
public final class g0 implements j0, IMapsProvider.OnMarkerClickListener {
    ...
    public boolean onClick(IMapsProvider.IMarker iMarker) {
        ...
        ArrayList arrayList = id0Var.f37342g0;
        if (iMarker.getTag() instanceof hd0) {
            ...
            if (!id0Var.C0) {
                ...
                id0Var.f37331a.setTag(Integer.valueOf(i14));
                id0Var.C0 = true;
            }
            int i15 = 0;
            while (true) {
                ...
                if (cd0Var != null && cd0Var.f35104e == iMarker) {
                    id0Var.f37344i0 = cd0Var.f35101a;
                    if (id0Var.f37345j0) {
                        id0Var.f37345j0 = false;
                        id0Var.C0();
                    }
                    id0Var.I.animateCamera(ApplicationLoader.getMapsProvider().newCameraUpdateLatLngZoom(cd0Var.f35104e.getPosition(), this.f15943a));
                } else {
                    i15++;
                }
            }
            fd0 fd0Var = id0Var.f37362x;
            id0 id0Var2 = fd0Var.f36404b;
            HashMap hashMap = fd0Var.f36403a;
            hd0 hd0Var = (hd0) iMarker.getTag();
            if (hd0Var != null && id0Var2.f37349n0 != hd0Var) {
                id0Var2.y0(false);
                ...
                id0Var2.f37349n0 = hd0Var;
                id0Var2.m0 = iMarker;
                Context context = fd0Var.getContext();
                FrameLayout frameLayout = new FrameLayout(context);
                fd0Var.addView(frameLayout, x5.c(114.0f, -2));
                FrameLayout frameLayout2 = new FrameLayout(context);
                id0Var2.f37350o0 = frameLayout2;
                frameLayout2.setBackgroundResource(R.drawable.venue_tooltip);
                id0Var2.f37350o0.getBackground().setColorFilter(new PorterDuffColorFilter(id0Var2.getThemedColor(j6.f20762h5), PorterDuff.Mode.MULTIPLY));
                frameLayout.addView(id0Var2.f37350o0, x5.c(71.0f, -2));
                id0Var2.f37350o0.setAlpha(0.0f);
                id0Var2.f37350o0.setOnClickListener(new tv(17, fd0Var, hd0Var));
                ...
                FrameLayout frameLayout3 = id0Var2.f37350o0;
                if (LocaleController.isRTL) {
                    i11 = 5;
                } else {
                    i11 = 3;
                ...
                f7.setGravity(i12);
                FrameLayout frameLayout4 = id0Var2.f37350o0;
                if (LocaleController.isRTL) {
                    i13 = 5;
                } else {
                    i13 = 3;
                ...
                textView.setText(hd0Var.f36988c.title);
                f7.setText(LocaleController.getString(R.string.TapToSendLocation));
                FrameLayout frameLayout5 = new FrameLayout(context);
                frameLayout5.setBackground(j6.K(AndroidUtilities.dp(36.0f), t4.a(hd0Var.f36986a)));
                frameLayout.addView(frameLayout5, x5.d(36, 36.0f, 81, 0.0f, 0.0f, 0.0f, 4.0f));
                x9 x9Var = new x9(context);
                x9Var.f(a4.a.s(new StringBuilder("https://ss3.4sqi.net/img/categories_v2/"), hd0Var.f36988c.venue_type, "_64.png"), null, null);
