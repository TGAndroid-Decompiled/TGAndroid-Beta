...
public final class b1 extends Binder implements j {
    public final WeakReference f14465a;
    public final ni.f f14466b;
    public final Set f14467c;
    public e9.z0 d;
    public int e;

    public b1(a0 a0Var) {
        attachInterface(this, "androidx.media3.session.IMediaSession");
        this.f14465a = new WeakReference(a0Var);
        this.f14466b = new ni.f(a0Var);
        this.f14467c = DesugarCollections.synchronizedSet(new HashSet());
        this.d = e9.z0.f8132r;
    }
    ...
    public final void G0(i iVar, int i10, h1 h1Var, int i11, a1 a1Var) {
        ...
        try {
            a0 a0Var = (a0) this.f14465a.get();
            if (a0Var != null && !a0Var.j()) {
                r t10 = this.f14466b.t(iVar.asBinder());
                if (t10 == null) {
                    Binder.restoreCallingIdentity(clearCallingIdentity);
                    return;
                }
                e2.d0.U(a0Var.f14446l, new t0(this, t10, h1Var, a0Var, i10, i11, a1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
        ...
        if (iVar != null && bundle != null) {
            try {
                ...
                try {
                    ...
                    synchronized (fVar.f15232a) {
                        r t10 = fVar.t(asBinder);
                        vVar = null;
                        if (t10 != null) {
                            eVar = (e) ((a0.f) fVar.f15234c).get(t10);
                        } else {
                            eVar = null;
                        }
                    }
    ...
    public final void N0(r rVar, int i10, int i11, a1 a1Var) {
        ...
        try {
            a0 a0Var = (a0) this.f14465a.get();
            if (a0Var != null && !a0Var.j()) {
                e2.d0.U(a0Var.f14446l, new ii.i0(this, rVar, i11, a0Var, i10, a1Var));
                Binder.restoreCallingIdentity(clearCallingIdentity);
            }
        } finally {
            Binder.restoreCallingIdentity(clearCallingIdentity);
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        switch (i10) {
            ...
            case 3015:
                ...
                WeakReference weakReference = this.f14465a;
                if (G06 != null && bundle2 != null) {
                    try {
                        ...
                        try {
                            n4.a0 a0Var = new n4.a0(a2.f14532c, callingPid, callingUid);
                            a0 a0Var2 = (a0) weakReference.get();
                            if (a0Var2 != null && n4.d0.a(a0Var2.f14441f).b(a0Var)) {
                                z10 = true;
                            } else {
                                z10 = false;
                            }
                            int i12 = a2.f14530a;
                            int i13 = a2.f14531b;
                            r rVar = new r(a0Var, i12, i13, z10, new x0(G06, i13), a2.e);
                            a0 a0Var3 = (a0) weakReference.get();
                            if (a0Var3 != null && !a0Var3.j()) {
                                this.f14467c.add(rVar);
                                try {
                                    try {
                                        e2.d0.U(a0Var3.f14446l, new h5(this, rVar, a0Var3, G06, 22));
                                        break;
                                    } catch (Throwable th2) {
                                        th = th2;
                                        throw th;
            ...
            case 3016:
                ...
                if (G07 != null && bundle3 != null && bundle4 != null) {
                    try {
                        int i14 = bundle3.getInt(h1.f14566f, 0);
                        if (i14 != 0) {
                            h1Var = new h1(i14);
                        } else {
                            String string = bundle3.getString(h1.f14567g);
                            string.getClass();
                        ...
                        b1Var = this;
                        b1Var.G0(G07, readInt6, h1Var, 0, new u0(new j2.e(29, h1Var, bundle4), 1));
                        break;
            ...
            case 3019:
                ...
                if (G010 != null && readInt11 >= 0) {
                    M0(G010, readInt10, 20, new le.b(new n0(this, readInt11, 4), 5));
                    return true;
                }
                break;
            case 3020:
                ...
                if (G011 != null && readInt13 >= 0 && readInt14 >= readInt13) {
                    M0(G011, readInt12, 20, new le.b(new m0(this, readInt13, readInt14), 5));
                    return true;
                }
                break;
            case 3021:
                ...
                if (G012 != null) {
                    M0(G012, readInt15, 20, P0(new p0(15)));
                    return true;
                }
                break;
            case 3022:
            ...
            case 3024:
                ...
                if (G015 != null && (t10 = this.f14466b.t(G015.asBinder())) != null) {
                    N0(t10, readInt23, 1, P0(new ah.b(26, this, t10)));
                    return true;
                }
                break;
            case 3025:
                ...
                if (G016 != null && (t11 = this.f14466b.t(G016.asBinder())) != null) {
                    N0(t11, readInt24, 1, P0(new j2.e(25)));
                    return true;
                }
                break;
            case 3026:
                ...
                if (G017 != null) {
                    M0(G017, readInt25, 2, P0(new p0(12)));
                    return true;
                }
                break;
            case 3027:
            ...
            case 3029:
                ...
                if (G020 != null && bundle7 != null) {
                    try {
                        ...
                        M0(G020, readInt28, 20, new u0(new ah.b(28, new a1() {
                            @Override
            ...
            case 3030:
                ...
                if (G021 != null && bundle8 != null && readInt30 >= 0) {
                    try {
                        ...
                        M0(G021, readInt29, 20, new u0(new ah.b(28, new a1() {
                            @Override
                            public final Object h(a0 a0Var4, r rVar2, int i15) {
                                switch (r2) {
                                    case 0:
            ...
            case 3031:
                ...
                if (G022 != null && readStrongBinder2 != null) {
                    try {
                        ...
                        M0(G022, readInt31, 20, new u0(new ah.b(28, new i2.z(3, u10.i()), new p0(6)), 1));
                        break;
            ...
            case 3032:
                ...
                if (G023 != null && readStrongBinder3 != null && readInt33 >= 0) {
                    try {
                        ...
                        M0(G023, readInt32, 20, new u0(new ah.b(28, new i2.z(2, u11.i()), new n0(this, readInt33, 3)), 1));
                        break;
            ...
            case 3034:
                ...
                if (G025 != null && (t12 = this.f14466b.t(G025.asBinder())) != null) {
                    N0(t12, readInt35, 3, P0(new p0(10)));
                    return true;
                }
                break;
            case 3035:
                ...
                if (G026 != null) {
                    ...
                    try {
                        a0 a0Var4 = (a0) this.f14465a.get();
                        if (a0Var4 != null && !a0Var4.j()) {
                            e2.d0.U(a0Var4.f14446l, new g0(1, this, G026));
                            return true;
                        }
                        return true;
                    } finally {
            ...
            case 3036:
                ...
                if (G027 != null) {
                    M0(G027, readInt36, 4, P0(new p0(13)));
                    return true;
                }
                break;
            case 3037:
                ...
                if (G028 != null && readInt38 >= 0) {
                    M0(G028, readInt37, 10, new le.b(new n0(this, readInt38, 0), 5));
                    return true;
                }
                break;
            case 3038:
            ...
            case 3040:
                ...
                if (G031 != null && (t13 = this.f14466b.t(G031.asBinder())) != null) {
                    N0(t13, readInt42, 11, P0(new j2.e(28)));
                    return true;
                }
                break;
            case 3041:
                ...
                if (G032 != null && (t14 = this.f14466b.t(G032.asBinder())) != null) {
                    N0(t14, readInt43, 12, P0(new p0(3)));
                    return true;
                }
                break;
            case 3042:
                ...
                if (G033 != null) {
                    M0(G033, readInt44, 6, P0(new p0(1)));
                    return true;
                }
                break;
            case 3043:
                ...
                if (G034 != null) {
                    M0(G034, readInt45, 8, P0(new j2.e(26)));
                    return true;
                }
                break;
            case 3044:
            ...
            case 3045:
                ...
                if (G036 != null) {
                    ...
                    try {
                        a0 a0Var5 = (a0) this.f14465a.get();
                        if (a0Var5 != null && !a0Var5.j()) {
                            r t17 = this.f14466b.t(G036.asBinder());
                            if (t17 != null) {
                                e2.d0.U(a0Var5.f14446l, new g0(2, this, t17));
                            }
                            return true;
                        }
                        return true;
            ...
            case 3046:
                ...
                if (G037 != null && (t15 = this.f14466b.t(G037.asBinder())) != null) {
                    N0(t15, readInt47, 7, P0(new p0(0)));
                    return true;
                }
                break;
            case 3047:
                ...
                if (G038 != null && (t16 = this.f14466b.t(G038.asBinder())) != null) {
                    N0(t16, readInt48, 9, P0(new p0(4)));
                    return true;
                }
                break;
            case 3048:
                ...
                if (G039 != null && bundle12 != null) {
                    try {
                        M0(G039, readInt49, 29, P0(new ah.b(25, this, q1.b(bundle12))));
                        break;
            ...
            case 3049:
                ...
                if (G040 != null && readString != null && bundle13 != null) {
                    if (TextUtils.isEmpty(readString)) {
                        ...
                        try {
                            b1Var = this;
                            b1Var.G0(G040, readInt50, null, 40010, new u0(new p0(readString, 5, b2.c1.a(bundle13)), 1));
                            break;
            ...
            case 3050:
                ...
                if (G041 != null && bundle14 != null) {
                    try {
                        G0(G041, readInt51, null, 40010, new u0(new p0(b2.c1.a(bundle14), 18), 1));
            ...
            case 3055:
                ...
                if (G046 != null && bundle15 != null && readInt62 >= 0) {
                    try {
                        ...
                        M0(G046, readInt61, 20, new u0(new ah.b(28, new a1() {
                            @Override
            ...
            case 3056:
                ...
                if (G047 != null && readStrongBinder4 != null && readInt64 >= 0 && readInt65 >= readInt64) {
                    try {
                        ...
                        M0(G047, readInt63, 20, new u0(new ah.b(28, new le.b(u12.i(), 2), new m0(this, readInt64, readInt65)), 1));
                        break;
                ...
                switch (i10) {
                    case 4001:
                        ...
                        if (G049 != null) {
                            ...
                            b1Var = this;
                            b1Var.G0(G049, readInt67, null, 50000, new u0(new p0(nVar, 11), 0));
                            break;
                        }
                        break;
                    case 4002:
                        ...
                        if (G050 != null) {
                            ...
                            G0(G050, readInt68, null, 50004, new u0(new p0(readString2, 2), 0));
                            return true;
                        }
                        break;
                    case 4003:
                        ...
                        if (G051 != null) {
                            if (TextUtils.isEmpty(readString3)) {
                                ...
                                G0(G051, readInt69, null, 50003, new u0(new j2.e(readString3, readInt70, readInt71, nVar), 0));
                            }
                        }
                        break;
                    case 4004:
                        ...
                        if (G052 != null) {
                            if (TextUtils.isEmpty(readString4)) {
                                ...
                                G0(G052, readInt72, null, 50005, new u0(new p0(readString4, 16, nVar), 0));
                            }
                        }
                        break;
                    case 4005:
                        ...
                        if (G053 != null) {
                            if (TextUtils.isEmpty(readString5)) {
                                ...
                                G0(G053, readInt73, null, 50006, new u0(new p0(readString5, readInt74, readInt75, nVar), 0));
                            }
                        }
                        break;
                    case 4006:
                        ...
                        if (G054 != null) {
                            if (TextUtils.isEmpty(readString6)) {
                                ...
                                G0(G054, readInt76, null, 50001, new u0(new p0(readString6, 14, nVar), 0));
                            }
                        }
                        break;
                    case 4007:
                        ...
                        if (G055 != null) {
                            ...
                            G0(G055, readInt77, null, 50002, new u0(new j2.e(readString7, 23), 0));
                            return true;
                        }
                        break;
                    default:
