...
public final class x extends Handler {
    ...
    public final void handleMessage(Message message) {
        ...
        int i10;
        c1 c1Var;
        a0 a0Var = this.f14933c;
        a1 a1Var = a0Var.f14680g;
        if (message.what == 1) {
            c1 c10 = a0Var.f14691s.c(a0Var.f14692t.Q0(), a0Var.f14692t.O0(), a0Var.f14691s.f14731k);
            a0Var.f14691s = c10;
            ...
            for (int i11 = 0; i11 < s10.size(); i11++) {
                ...
                try {
                    ...
                    if (w10 == null) {
                        fVar.v(rVar2);
                        b2.x0 a2 = w7.u.a(fVar.r(rVar2), a0Var.f14692t.t());
                        try {
                            q qVar = rVar2.d;
                            e2.d.h(qVar);
                            if (w10 == null) {
