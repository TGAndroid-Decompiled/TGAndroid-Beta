...
public final class x extends Handler {
    ...
    public final void handleMessage(Message message) {
        ...
        int i10;
        i1 i1Var;
        a0 a0Var = this.f14726c;
        g1 g1Var = a0Var.f14464g;
        if (message.what == 1) {
            i1 c10 = a0Var.f14475s.c(a0Var.f14476t.Q0(), a0Var.f14476t.O0(), a0Var.f14475s.f14574k);
            a0Var.f14475s = c10;
            boolean z10 = this.f14724a;
            boolean z11 = this.f14725b;
            i1 H0 = g1Var.H0(c10);
            ...
            for (int i11 = 0; i11 < s10.size(); i11++) {
                ...
                try {
                    ...
                    if (w10 == null) {
                        fVar.v(rVar2);
                        b2.x0 a2 = w7.t.a(fVar.r(rVar2), a0Var.f14476t.t());
                        try {
                            q qVar = rVar2.d;
                            e2.d.h(qVar);
                            if (w10 == null) {
