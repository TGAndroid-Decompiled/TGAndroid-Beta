...
public class t {
    ...
    public static final HashMap f14929c = new HashMap();
    public final a0 f14930a;
    ...
    public t(LaunchActivity launchActivity, b2.b1 b1Var, e9.i0 i0Var, e9.i0 i0Var2, e9.i0 i0Var3, na.d dVar, Bundle bundle, Bundle bundle2, of.b bVar) {
        ...
        this.f14930a = new a0(this, launchActivity, b1Var, i0Var, i0Var2, i0Var3, dVar, bundle, bundle2, bVar);
    }
    ...
    public final void a(b2.b1 b1Var) {
        ...
        e2.d.b(b1Var.Q());
        Looper y02 = b1Var.y0();
        a0 a0Var = this.f14930a;
        boolean z11 = false;
        if (y02 == a0Var.f14702t.f14817a.y0()) {
            z10 = true;
        } else {
            z10 = false;
        }
