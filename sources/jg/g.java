...
public abstract class g extends View implements i {
    ...
    public void C(int i10, int i11) {
        ...
        if (bVar != null) {
            ...
            if (i12 != this.f13715s0) {
                ...
                if (eVar != null) {
                    getSelectedDate();
                    la1 la1Var = (la1) ((vl0) eVar).f41617b;
                    la1Var.f();
                    la1Var.f38280b.f13716t0.d(false, false);
                }
                B();
                invalidate();
            }
        ...
        if (f7 != 0.0f) {
            ...
            if (f10 != f11) {
                ...
                if (f12 > 1.0f) {
                    ...
                    float f13 = this.T0;
                    this.v = (pr.f29495g.getInterpolation(f12) * (f11 - f13)) + f13;
                }
                invalidate();
            }
            if (this.P0) {
                ...
                if (f14 != f15) {
                    ...
                    if (f16 > 1.0f) {
                        ...
                        float f17 = this.U0;
                        this.f13719w = (pr.f29495g.getInterpolation(f16) * (f15 - f17)) + f17;
                    }
                    invalidate();
                }
            }
    ...
    public final void G() {
        ...
        this.S.setColor(j6.v0(j6.f20691d6, f6Var));
