...
public final class b implements Runnable {
    ...
    public final MessageObject f9394c;
    ...
    public final void run() {
        switch (this.f9392a) {
            case 0:
                AndroidUtilities.runOnUIThread(new b(this.f9393b, this.f9394c, this.d, 1));
                return;
            default:
                t1 t1Var = this.f9393b.f9397c;
                long dialogId = this.f9394c.getDialogId();
