...
public final class a extends Drawable {
    public final TextPaint f11692a;
    public final TextPaint f11693b;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f11694c;
        rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f11693b);
        ...
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.dp(16.5f) + bounds.left, AndroidUtilities.dp(13.0f) + bounds.top, this.f11692a);
        }
    }
    ...
    public final int getIntrinsicWidth() {
        return (int) (AndroidUtilities.dp(23.0f) + this.f11695e);
    }
