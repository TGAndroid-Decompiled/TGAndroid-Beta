...
public final class c extends f8 {
    public final ObjectAnimator f10570a;
    ...
    public c(AnimationDrawable animationDrawable, boolean z10, boolean z11) {
        ...
        obj.f10573b = numberOfFrames2;
        int[] iArr = obj.f10572a;
        if (iArr == null || iArr.length < numberOfFrames2) {
            obj.f10572a = new int[numberOfFrames2];
        }
        int[] iArr2 = obj.f10572a;
        int i13 = 0;
