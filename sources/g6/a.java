...
public abstract class a {
    public static final Pattern f9428a = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");
    public static final Random f9429b = new Random(SystemClock.elapsedRealtime());
