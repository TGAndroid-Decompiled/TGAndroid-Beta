...
public abstract class a {
    public static final Pattern f9410a = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");
    public static final Random f9411b = new Random(SystemClock.elapsedRealtime());
