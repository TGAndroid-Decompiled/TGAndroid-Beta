...
public abstract class a {
    public static final Pattern f9423a = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");
    public static final Random f9424b = new Random(SystemClock.elapsedRealtime());
