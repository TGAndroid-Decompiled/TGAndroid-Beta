...
public abstract class a {
    public static final Pattern f9411a = Pattern.compile("urn:x-cast:[-A-Za-z0-9_]+(\\.[-A-Za-z0-9_]+)*");
    public static final Random f9412b = new Random(SystemClock.elapsedRealtime());
