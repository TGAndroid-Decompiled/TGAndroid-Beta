...
public abstract class p {
    ...
    public p(String str) {
        a.b(str);
        this.f9443b = str;
        this.f9442a = new b("MediaControlChannel", null);
    ...
    public final long b() {
        aa.a aVar = this.f9444c;
        if (aVar == null) {
            b bVar = this.f9442a;
            Log.e(bVar.f9412a, bVar.d("Attempt to generate requestId without a sink", new Object[0]));
            return 0L;
        }
    ...
    public final void c(long j3, String str) {
        ...
        if (aVar == null) {
            b bVar = this.f9442a;
            Log.e(bVar.f9412a, bVar.d("Attempt to send text message without a sink", new Object[0]));
            return;
        }
        ...
        if (f0Var != null) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                b bVar2 = e0.G;
                Log.w(bVar2.f9412a, bVar2.d("Message send failed. Message exceeds maximum size", new Object[0]));
