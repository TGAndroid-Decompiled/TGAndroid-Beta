...
public final class v extends n6.g {
    public static final b f9470n0 = new b("CastClientImpl", null);
    public static final Object f9471o0 = new Object();
    public static final Object f9472p0 = new Object();
    public c6.d U;
    ...
    public u f9473a0;
    public String f9474b0;
    public boolean f9475c0;
    public boolean f9476d0;
    public boolean f9477e0;
    public double f9478f0;
    public c6.x f9479g0;
    public int f9480h0;
    public int f9481i0;
    public String f9482j0;
    public String f9483k0;
    public Bundle f9484l0;
    ...
    public final void B(int i10, IBinder iBinder, Bundle bundle, int i11) {
        f9470n0.b("in onPostInitHandler; statusCode=%d", Integer.valueOf(i10));
        if (i10 == 0 || i10 == 2300) {
            this.f9476d0 = true;
            this.f9477e0 = true;
        }
    ...
    public final void H() {
        f9470n0.b("removing all MessageReceivedCallbacks", new Object[0]);
        synchronized (this.X) {
            this.X.clear();
        }
    }
    ...
    public final void disconnect() {
        Object[] objArr = {this.f9473a0, Boolean.valueOf(j())};
        b bVar = f9470n0;
        ...
        this.f9473a0 = null;
        if (uVar != null) {
            v vVar2 = (v) uVar.f9468b.getAndSet(null);
            if (vVar2 != null) {
                vVar2.f9480h0 = -1;
                vVar2.f9481i0 = -1;
                vVar2.U = null;
    ...
    public final Bundle t() {
        ...
        f9470n0.b("getRemoteService(): mLastApplicationId=%s, mLastSessionId=%s", this.f9482j0, this.f9483k0);
        CastDevice castDevice = this.V;
        castDevice.getClass();
        ...
        String str = this.f9482j0;
        if (str != null) {
            bundle.putString("last_application_id", str);
            String str2 = this.f9483k0;
            if (str2 != null) {
