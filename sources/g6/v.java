...
public final class v extends n6.g {
    public static final b f9471n0 = new b("CastClientImpl", null);
    public static final Object f9472o0 = new Object();
    public static final Object f9473p0 = new Object();
    public c6.d U;
    ...
    public u f9474a0;
    public String f9475b0;
    public boolean f9476c0;
    public boolean f9477d0;
    public boolean f9478e0;
    public double f9479f0;
    public c6.x f9480g0;
    public int f9481h0;
    public int f9482i0;
    public String f9483j0;
    public String f9484k0;
    public Bundle f9485l0;
    ...
    public final void B(int i10, IBinder iBinder, Bundle bundle, int i11) {
        f9471n0.b("in onPostInitHandler; statusCode=%d", Integer.valueOf(i10));
        if (i10 == 0 || i10 == 2300) {
            this.f9477d0 = true;
            this.f9478e0 = true;
        }
    ...
    public final void H() {
        f9471n0.b("removing all MessageReceivedCallbacks", new Object[0]);
        synchronized (this.X) {
            this.X.clear();
        }
    }
    ...
    public final void disconnect() {
        Object[] objArr = {this.f9474a0, Boolean.valueOf(j())};
        b bVar = f9471n0;
        ...
        this.f9474a0 = null;
        if (uVar != null) {
            v vVar2 = (v) uVar.f9469b.getAndSet(null);
            if (vVar2 != null) {
                vVar2.f9481h0 = -1;
                vVar2.f9482i0 = -1;
                vVar2.U = null;
    ...
    public final Bundle t() {
        ...
        f9471n0.b("getRemoteService(): mLastApplicationId=%s, mLastSessionId=%s", this.f9483j0, this.f9484k0);
        CastDevice castDevice = this.V;
        castDevice.getClass();
