...
public final class v extends n6.g {
    public static final b f9453n0 = new b("CastClientImpl", null);
    public static final Object f9454o0 = new Object();
    public static final Object f9455p0 = new Object();
    public c6.d U;
    ...
    public u f9456a0;
    public String f9457b0;
    public boolean f9458c0;
    public boolean f9459d0;
    public boolean f9460e0;
    public double f9461f0;
    public c6.x f9462g0;
    public int f9463h0;
    public int f9464i0;
    public String f9465j0;
    public String f9466k0;
    public Bundle f9467l0;
    ...
    public final void B(int i10, IBinder iBinder, Bundle bundle, int i11) {
        f9453n0.b("in onPostInitHandler; statusCode=%d", Integer.valueOf(i10));
        if (i10 == 0 || i10 == 2300) {
            this.f9459d0 = true;
            this.f9460e0 = true;
        }
    ...
    public final void H() {
        f9453n0.b("removing all MessageReceivedCallbacks", new Object[0]);
        synchronized (this.X) {
            this.X.clear();
        }
    }
    ...
    public final void disconnect() {
        Object[] objArr = {this.f9456a0, Boolean.valueOf(j())};
        b bVar = f9453n0;
        ...
        this.f9456a0 = null;
        if (uVar != null) {
            v vVar2 = (v) uVar.f9451b.getAndSet(null);
            if (vVar2 != null) {
                vVar2.f9463h0 = -1;
                vVar2.f9464i0 = -1;
                vVar2.U = null;
    ...
    public final Bundle t() {
        ...
        f9453n0.b("getRemoteService(): mLastApplicationId=%s, mLastSessionId=%s", this.f9465j0, this.f9466k0);
        CastDevice castDevice = this.V;
        castDevice.getClass();
        ...
        String str = this.f9465j0;
        if (str != null) {
            bundle.putString("last_application_id", str);
            String str2 = this.f9466k0;
            if (str2 != null) {
