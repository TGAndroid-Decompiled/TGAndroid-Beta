...
public final class e implements com.google.android.gms.common.api.q, Iterable, Closeable {
    public final DataHolder f45965a;
    public boolean f45966b = false;
    public ArrayList f45967c;
    public final Status d;

    public e(DataHolder dataHolder) {
        this.f45965a = dataHolder;
        this.d = new Status(dataHolder.e, null, null, null);
    }

    @Override
    public final void close() {
        DataHolder dataHolder = this.f45965a;
        if (dataHolder != null) {
            dataHolder.close();
        }
    }
    ...
    public final int n(int i10) {
        if (i10 >= 0 && i10 < this.f45967c.size()) {
            return ((Integer) this.f45967c.get(i10)).intValue();
        }
