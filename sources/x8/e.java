...
public final class e implements com.google.android.gms.common.api.q, Iterable, Closeable {
    public final DataHolder f45716a;
    public boolean f45717b = false;
    public ArrayList f45718c;
    public final Status d;

    public e(DataHolder dataHolder) {
        this.f45716a = dataHolder;
        this.d = new Status(dataHolder.e, null, null, null);
    }

    @Override
    public final void close() {
        DataHolder dataHolder = this.f45716a;
        if (dataHolder != null) {
            dataHolder.close();
        }
    }
    ...
    public final int n(int i10) {
        if (i10 >= 0 && i10 < this.f45718c.size()) {
            return ((Integer) this.f45718c.get(i10)).intValue();
        }
