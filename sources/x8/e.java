...
public final class e implements com.google.android.gms.common.api.q, Iterable, Closeable {
    public final DataHolder f45711a;
    public boolean f45712b = false;
    public ArrayList f45713c;
    public final Status d;

    public e(DataHolder dataHolder) {
        this.f45711a = dataHolder;
        this.d = new Status(dataHolder.e, null, null, null);
    }

    @Override
    public final void close() {
        DataHolder dataHolder = this.f45711a;
        if (dataHolder != null) {
            dataHolder.close();
        }
    }
    ...
    public final int n(int i10) {
        if (i10 >= 0 && i10 < this.f45713c.size()) {
            return ((Integer) this.f45713c.get(i10)).intValue();
        }
