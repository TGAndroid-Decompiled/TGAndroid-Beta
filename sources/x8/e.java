...
public final class e implements com.google.android.gms.common.api.q, Iterable, Closeable {
    public final DataHolder f45638a;
    public boolean f45639b = false;
    public ArrayList f45640c;
    public final Status d;

    public e(DataHolder dataHolder) {
        this.f45638a = dataHolder;
        this.d = new Status(dataHolder.e, null, null, null);
    }

    @Override
    public final void close() {
        DataHolder dataHolder = this.f45638a;
        if (dataHolder != null) {
            dataHolder.close();
        }
    }
    ...
    public final int n(int i10) {
        if (i10 >= 0 && i10 < this.f45640c.size()) {
            return ((Integer) this.f45640c.get(i10)).intValue();
        }
