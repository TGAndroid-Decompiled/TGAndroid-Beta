...
public final class b implements g, MessagesStorage.LongCallback, a2, MessagesController.ErrorDelegate, m {
    ...
    public a1 b(int i10, l1 l1Var, int[] iArr) {
        p pVar = (p) this.f4182c;
        i iVar = (i) this.d;
        pVar.getClass();
        d dVar = new d(pVar, iVar);
        int i11 = ((int[]) this.e)[i10];
        f0 u10 = i0.u();
        for (int i12 = 0; i12 < l1Var.f3086a; i12++) {
            u10.b(new e(i10, l1Var, i12, iVar, iArr[i12], this.f4181b, dVar, i11));
        }
        return u10.i();
    }
    ...
    public void f(b2 b2Var, int i10) {
        ...
        switch (this.f4180a) {
            case 2:
                ...
                s4 s4Var = (s4) this.f4182c;
                EditTextBoldCursor editTextBoldCursor = (EditTextBoldCursor) this.d;
                t3 t3Var = (t3) this.e;
                int i11 = t3Var.f11630b;
                if (!z10) {
                    s4Var.run();
                    return;
                }
                ...
                return;
            case 3:
                bo boVar = (bo) this.f4182c;
                boolean z11 = this.f4181b;
                ...
                return;
            case 4:
                boolean z12 = this.f4181b;
                Context context = (Context) this.f4182c;
    ...
    public boolean run(TLRPC.TL_error tL_error) {
        return ProfileActivity.Z((ProfileActivity) this.f4182c, (boolean[]) this.d, this.f4181b, (n2) this.e, tL_error);
    }
