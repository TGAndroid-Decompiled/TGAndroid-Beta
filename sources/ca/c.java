...
public final class c {
    ...
    public static final Charset f3020e = Charset.forName("UTF-8");
    public final Context f3021a;
    public final z9.b f3022b;
    public final d f3023c = new d();
    ...
    public static void b(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        String str4 = null;
        if (errorStream != null) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f3020e));
            try {
        ...
        if (!TextUtils.isEmpty(str4)) {
            ...
            Log.w("Firebase-Installations", th.j("Firebase options used while communicating with Firebase server APIs: ", str2, ", ", str3, e10));
        }
    }
    ...
    public static a e(HttpURLConnection httpURLConnection) {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f3020e));
        j2 a2 = b.a();
            ...
            if (nextName.equals("name")) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (nextName2.equals("token")) {
                        a2.f559c = jsonReader.nextString();
    ...
    public final java.net.HttpURLConnection c(java.net.URL r10, java.lang.String r11) {
        throw new UnsupportedOperationException("Method not decompiled: ca.c.c(java.net.URL, java.lang.String):java.net.HttpURLConnection");
    }
}
