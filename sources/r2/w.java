...
public abstract class w {
    public static final HashMap f42292a = new HashMap();

    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (Build.VERSION.SDK_INT < 26 && Build.DEVICE.equals("R9") && arrayList.size() == 1 && ((o) arrayList.get(0)).f42249a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
        ...
        if (Build.VERSION.SDK_INT < 32 && arrayList.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((o) arrayList.get(0)).f42249a)) {
        ...
        synchronized (w.class) {
            try {
                ...
                if (z10 && e.isEmpty() && Build.VERSION.SDK_INT <= 23) {
                    ...
                    if (!e.isEmpty()) {
                        e2.a.n("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((o) e.get(0)).f42249a);
                    }
                }
                a(str, e);
                i0 v = i0.v(e);
