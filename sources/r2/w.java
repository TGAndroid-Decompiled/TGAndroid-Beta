...
public abstract class w {
    public static final HashMap f42028a = new HashMap();

    public static void a(String str, ArrayList arrayList) {
        if ("audio/raw".equals(str)) {
            if (Build.VERSION.SDK_INT < 26 && Build.DEVICE.equals("R9") && arrayList.size() == 1 && ((o) arrayList.get(0)).f41985a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
        ...
        if (Build.VERSION.SDK_INT < 32 && arrayList.size() > 1 && "OMX.qti.audio.decoder.flac".equals(((o) arrayList.get(0)).f41985a)) {
        ...
        synchronized (w.class) {
            try {
                ...
                if (z10 && e.isEmpty() && Build.VERSION.SDK_INT <= 23) {
                    ...
                    if (!e.isEmpty()) {
                        e2.a.n("MediaCodecUtil", "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + ((o) e.get(0)).f41985a);
                    }
                }
                a(str, e);
                i0 v = i0.v(e);
    ...
    public static a1 f(i iVar, b2.s sVar, boolean z10, boolean z11) {
        List a2;
        List a10 = iVar.a(sVar.f3309r, z10, z11);
        String b10 = b(sVar);
        if (b10 == null) {
            a2 = a1.e;
        } else {
