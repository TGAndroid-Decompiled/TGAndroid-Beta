...
public abstract class r extends i2.f {
    ...
    public l f44878b0;
    public b2.s f44879c0;
    public MediaFormat f44880d0;
    public boolean f44881e0;
    public float f44882f0;
    public ArrayDeque f44883g0;
    public p f44884h0;
    public o f44885i0;
    public int f44886j0;
    public boolean f44887k0;
    public boolean f44888l0;
    public boolean m0;
    public boolean f44889n0;
    public boolean f44890o0;
    public boolean f44891p0;
    public long f44892q0;
    public long f44893r0;
    public int f44894s0;
    public int f44895t0;
    public ByteBuffer f44896u0;
    public boolean f44897v0;
    public boolean f44898w0;
    public boolean f44899x0;
    public boolean f44900y0;
    public boolean f44901z0;
    ...
    public r(int i10, k kVar, float f7) {
        ...
        this.f44894s0 = -1;
        this.f44895t0 = -1;
        this.f44893r0 = -9223372036854775807L;
        this.H0 = -9223372036854775807L;
        this.I0 = -9223372036854775807L;
        this.Q0 = -9223372036854775807L;
        this.f44892q0 = -9223372036854775807L;
        this.C0 = 0;
        this.D0 = 0;
        this.O0 = new Object();
    ...
    public final boolean C(long j3, long j10) {
        ...
        if (gVar2.g()) {
            ...
            int i13 = this.f44895t0;
            int i14 = gVar2.f44852s;
            long j11 = gVar2.f10877e;
            boolean T = T(this.f11528w, gVar2.f44851r);
            ...
            if (w10 != -5) {
                if (w10 != -4) {
                    ...
                    if (gVar.g()) {
                        ...
                        if (T(j12, gVar.f44851r) != T(j12, hVar.f10877e)) {
                            break;
                        }
                    }
                    if (!gVar.f(hVar)) {
        ...
        if (!gVar.g() && !this.J0 && !this.f44901z0) {
            return false;
        }
        return true;
    }
    ...
    public final boolean G(long j3, long j10) {
        ...
        boolean z14;
        int h;
        l lVar = this.f44878b0;
        lVar.getClass();
        int i10 = this.f44895t0;
        ...
        if (i10 < 0) {
            ...
            if (h < 0) {
                if (h == -2) {
                    this.G0 = true;
                    l lVar2 = this.f44878b0;
                    lVar2.getClass();
                    MediaFormat outputFormat = lVar2.getOutputFormat();
                    if (this.f44886j0 != 0 && outputFormat.getInteger("width") == 32 && outputFormat.getInteger("height") == 32) {
                        this.f44890o0 = true;
                        return true;
                    }
                    this.f44880d0 = outputFormat;
                    this.f44881e0 = true;
                    return true;
                }
                if (this.f44891p0 && (this.J0 || this.C0 == 2)) {
                    g0();
                }
                long j11 = this.f44892q0;
                ...
                this.f44896u0 = outputBuffer;
                if (outputBuffer != null) {
                    outputBuffer.position(bufferInfo2.offset);
                    this.f44896u0.limit(bufferInfo2.offset + bufferInfo2.size);
                }
        ...
        if (this.m0 && this.F0) {
            try {
                ByteBuffer byteBuffer = this.f44896u0;
                int i11 = this.f44895t0;
                int i12 = bufferInfo2.flags;
                boolean z15 = this.f44897v0;
                boolean z16 = this.f44898w0;
                b2.s sVar = this.T;
                sVar.getClass();
            ...
            z12 = false;
            z13 = true;
            ByteBuffer byteBuffer2 = this.f44896u0;
            int i13 = this.f44895t0;
            int i14 = bufferInfo.flags;
            boolean z17 = this.f44897v0;
            boolean z18 = this.f44898w0;
            b2.s sVar2 = this.T;
            sVar2.getClass();
        ...
        if (h02) {
            ...
            if (!z14 && this.F0 && this.f44898w0) {
                this.h.getClass();
                this.f44892q0 = System.currentTimeMillis();
            }
            this.f44895t0 = -1;
            this.f44896u0 = null;
            if (!z14) {
    ...
    public final boolean H() {
        ...
        if (this.C0 == 1) {
            if (!this.f44891p0) {
                this.F0 = true;
                lVar.a(0L, this.f44894s0, 0, 4);
                this.f44894s0 = -1;
                hVar.f10876c = null;
            }
            this.C0 = 2;
            return false;
        } else if (this.f44889n0) {
            this.f44889n0 = false;
            ByteBuffer byteBuffer = hVar.f10876c;
            byteBuffer.getClass();
            byteBuffer.put(W0);
            lVar.a(0L, this.f44894s0, 38, 0);
            this.f44894s0 = -1;
            hVar.f10876c = null;
            this.E0 = true;
            return true;
            ...
            if (this.B0 == 1) {
                ...
                while (true) {
                    ...
                    byteBuffer2.put((byte[]) this.f44879c0.f2400u.get(i11));
                    i11++;
                }
                this.B0 = 2;
            }
            ...
            try {
                ...
                if (w10 == -3) {
                    ...
                    if (!this.E0 && !hVar.isKeyFrame()) {
                        ...
                        if (flag) {
                            lVar.b(this.f44894s0, hVar.f10875b, j3, L);
                        } else {
                            int i12 = this.f44894s0;
    ...
    public final void V(MediaCrypto mediaCrypto, boolean z10) {
        ...
        b2.s sVar = this.S;
        sVar.getClass();
        if (this.f44883g0 == null) {
            try {
                List K = K(z10);
                this.f44883g0 = new ArrayDeque();
                ArrayList arrayList = (ArrayList) K;
                if (!arrayList.isEmpty()) {
                    this.f44883g0.add((o) arrayList.get(0));
                }
                this.f44884h0 = null;
            } catch (t e7) {
        ...
        if (!this.f44883g0.isEmpty()) {
            ArrayDeque arrayDeque = this.f44883g0;
            arrayDeque.getClass();
            while (this.f44878b0 == null) {
                ...
                try {
                    ...
                    String str2 = "Decoder init failed: " + oVar.f44860a + ", " + sVar;
                    ...
                    X(pVar);
                    p pVar2 = this.f44884h0;
                    if (pVar2 == null) {
                        this.f44884h0 = pVar;
                    } else {
                        this.f44884h0 = new p(pVar2.getMessage(), pVar2.getCause(), pVar2.f44870a, pVar2.f44871b, pVar2.f44872c, pVar2.d);
                    }
                    if (arrayDeque.isEmpty()) {
                        throw this.f44884h0;
                    }
    ...
    public void d0(long j3) {
        ...
        while (true) {
            ArrayDeque arrayDeque = this.Q;
            if (!arrayDeque.isEmpty() && j3 >= ((q) arrayDeque.peek()).f44874a) {
    ...
    public boolean m() {
        if (this.S != null) {
            if (!n() && this.f44895t0 < 0) {
                if (this.f44893r0 != -9223372036854775807L) {
                    this.h.getClass();
                    if (SystemClock.elapsedRealtime() < this.f44893r0) {
                        return true;
                    }
                    return false;
                }
    ...
    public final void p0(q qVar) {
        this.P0 = qVar;
        if (qVar.f44876c != -9223372036854775807L) {
            this.R0 = true;
            c0();
        }
    }
    ...
    public boolean t0() {
        boolean z10;
        int i10 = this.D0;
        if (i10 == 3 || ((this.f44887k0 && !this.G0) || (this.f44888l0 && this.F0))) {
            return true;
        }
        if (i10 == 2) {
    ...
    public final boolean w0(b2.s sVar) {
        if (Build.VERSION.SDK_INT >= 23 && this.f44878b0 != null && this.D0 != 3 && this.f11525n != 0) {
            float f7 = this.f44877a0;
            sVar.getClass();
            b2.s[] sVarArr = this.f11527s;
            sVarArr.getClass();
            float N = N(f7, sVar, sVarArr);
            float f10 = this.f44882f0;
            if (f10 != N) {
                if (N == -1.0f) {
                    if (this.E0) {
                        this.C0 = 1;
    ...
    public final void y0(long j3) {
        ...
        if (sVar == null && this.R0 && this.f44880d0 != null) {
            sVar = (b2.s) this.P0.d.f();
        }
        if (sVar != null) {
            this.T = sVar;
        } else if (!this.f44881e0 || this.T == null) {
            return;
        }
        b2.s sVar2 = this.T;
        sVar2.getClass();
        b0(sVar2, this.f44880d0);
        this.f44881e0 = false;
        this.R0 = false;
    }
