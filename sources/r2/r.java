...
public abstract class r extends i2.f {
    ...
    public final long Y;
    public float Z;
    public float f41930a0;
    public l f41931b0;
    public b2.s f41932c0;
    public MediaFormat f41933d0;
    public boolean f41934e0;
    public float f41935f0;
    public ArrayDeque f41936g0;
    public p f41937h0;
    public o f41938i0;
    public int f41939j0;
    public boolean f41940k0;
    public boolean f41941l0;
    public boolean m0;
    public boolean f41942n0;
    public boolean f41943o0;
    public boolean f41944p0;
    public long f41945q0;
    public long f41946r0;
    public int f41947s0;
    public int f41948t0;
    public ByteBuffer f41949u0;
    public boolean f41950v0;
    public boolean f41951w0;
    public boolean f41952x0;
    public boolean f41953y0;
    public boolean f41954z0;
    ...
    public r(int i10, k kVar, float f7) {
        ...
        this.P0 = q.e;
        hVar.b(0);
        hVar.f10079c.order(ByteOrder.nativeOrder());
        ?? obj = new Object();
        obj.f13299a = c2.h.f3664a;
        obj.f13301c = 0;
        obj.f13300b = 2;
        this.R = obj;
        this.f41935f0 = -1.0f;
        ...
        this.f41947s0 = -1;
        this.f41948t0 = -1;
        this.f41946r0 = -9223372036854775807L;
        this.H0 = -9223372036854775807L;
        this.I0 = -9223372036854775807L;
        this.Q0 = -9223372036854775807L;
        this.f41945q0 = -9223372036854775807L;
        this.C0 = 0;
        this.D0 = 0;
        this.O0 = new Object();
    ...
    public final boolean C(long j3, long j10) {
        ...
        g gVar2 = this.O;
        if (gVar2.f()) {
            ByteBuffer byteBuffer = gVar2.f10079c;
            int i13 = this.f41948t0;
            int i14 = gVar2.f41907s;
            long j11 = gVar2.e;
            boolean T = T(this.f10645w, gVar2.f41906r);
                ...
                if (w10 != -4) {
                    ...
                    if (sVar3 != null && Objects.equals(sVar3.f3301r, "audio/opus")) {
                        ...
                        if (this.f10645w - hVar.e <= 80000) {
                            ...
                            j0 j0Var = this.R;
                            j0Var.getClass();
                            hVar.f10079c.getClass();
                            if (hVar.f10079c.limit() - hVar.f10079c.position() != 0) {
                                if (j0Var.f13300b == 2 && (list.size() == 1 || list.size() == 3)) {
                                ...
                                if (j0Var.f13299a.capacity() < i18) {
                                    j0Var.f13299a = ByteBuffer.allocate(i18).order(ByteOrder.LITTLE_ENDIAN);
                                } else {
                                    j0Var.f13299a.clear();
                                }
                                ByteBuffer byteBuffer3 = j0Var.f13299a;
                                if (j0Var.f13300b == 2) {
                                    if (bArr != null) {
                                ...
                                int k10 = j0Var.f13301c + ((int) ((c3.b.k(b11, b10) * 48000) / 1000000));
                                j0Var.f13301c = k10;
                                j0.a(byteBuffer3, k10, j0Var.f13300b, i17, false);
                                ...
                                j0Var.f13300b++;
                                j0Var.f13299a = byteBuffer3;
                                hVar.clear();
                                hVar.b(j0Var.f13299a.remaining());
                                hVar.f10079c.put(j0Var.f13299a);
                                hVar.c();
                            }
                        }
                    }
                    if (gVar.f()) {
                        ...
                        if (T(j12, gVar.f41906r) != T(j12, hVar.e)) {
                            break;
                        }
                    }
                    if (!gVar.e(hVar)) {
        ...
        if (!gVar.f() && !this.J0 && !this.f41954z0) {
            return false;
        }
        return true;
    }
    ...
    public final boolean G(long j3, long j10) {
        ...
        boolean z14;
        int i10;
        l lVar = this.f41931b0;
        lVar.getClass();
        int i11 = this.f41948t0;
        ...
        if (i11 < 0) {
            ...
            if (i10 < 0) {
                if (i10 == -2) {
                    this.G0 = true;
                    l lVar2 = this.f41931b0;
                    lVar2.getClass();
                    MediaFormat outputFormat = lVar2.getOutputFormat();
                    if (this.f41939j0 != 0 && outputFormat.getInteger("width") == 32 && outputFormat.getInteger("height") == 32) {
                        this.f41943o0 = true;
                        return true;
                    }
                    this.f41933d0 = outputFormat;
                    this.f41934e0 = true;
                    return true;
                }
                if (this.f41944p0 && (this.J0 || this.C0 == 2)) {
                    g0();
                }
                long j11 = this.f41945q0;
                ...
                this.f41949u0 = outputBuffer;
                if (outputBuffer != null) {
                    outputBuffer.position(bufferInfo2.offset);
                    this.f41949u0.limit(bufferInfo2.offset + bufferInfo2.size);
                }
        ...
        if (this.m0 && this.F0) {
            try {
                ByteBuffer byteBuffer = this.f41949u0;
                int i12 = this.f41948t0;
                int i13 = bufferInfo2.flags;
                boolean z15 = this.f41950v0;
                boolean z16 = this.f41951w0;
                b2.s sVar = this.T;
                sVar.getClass();
            ...
            z12 = false;
            z13 = true;
            ByteBuffer byteBuffer2 = this.f41949u0;
            int i14 = this.f41948t0;
            int i15 = bufferInfo.flags;
            boolean z17 = this.f41950v0;
            boolean z18 = this.f41951w0;
            b2.s sVar2 = this.T;
            sVar2.getClass();
        ...
        if (h02) {
            ...
            if (!z14 && this.F0 && this.f41951w0) {
                this.h.getClass();
                this.f41945q0 = System.currentTimeMillis();
            }
            this.f41948t0 = -1;
            this.f41949u0 = null;
            if (!z14) {
    ...
    public final boolean H() {
        ...
        if (i10 < 0) {
            ...
            hVar.f10079c = lVar.getInputBuffer(h);
            hVar.clear();
        }
        if (this.C0 == 1) {
            if (!this.f41944p0) {
                this.F0 = true;
                lVar.a(0L, this.f41947s0, 0, 4);
                this.f41947s0 = -1;
                hVar.f10079c = null;
            }
            this.C0 = 2;
            return false;
        } else if (this.f41942n0) {
            this.f41942n0 = false;
            ByteBuffer byteBuffer = hVar.f10079c;
            byteBuffer.getClass();
            byteBuffer.put(W0);
            lVar.a(0L, this.f41947s0, 38, 0);
            this.f41947s0 = -1;
            hVar.f10079c = null;
            this.E0 = true;
            return true;
            ...
            if (this.B0 == 1) {
                ...
                while (true) {
                    ...
                    byteBuffer2.put((byte[]) this.f41932c0.f3304u.get(i11));
                    i11++;
                }
                this.B0 = 2;
            }
            ...
            try {
                ...
                if (w10 == -3) {
                    ...
                    if (!this.E0 && !hVar.isKeyFrame()) {
                        ...
                        if (flag) {
                            ...
                            if (position == 0) {
                                ...
                                if (dVar.d == null) {
                                    int[] iArr = new int[1];
                                    dVar.d = iArr;
                                    dVar.f10075i.numBytesOfClearData = iArr;
                                }
                                int[] iArr2 = dVar.d;
                        ...
                        if (flag) {
                            lVar.b(this.f41947s0, hVar.f10078b, j3, L);
                        } else {
                            int i12 = this.f41947s0;
                            ByteBuffer byteBuffer4 = hVar.f10079c;
    ...
    public final void V(MediaCrypto mediaCrypto, boolean z10) {
        ...
        b2.s sVar = this.S;
        sVar.getClass();
        if (this.f41936g0 == null) {
            try {
                List K = K(z10);
                this.f41936g0 = new ArrayDeque();
                ArrayList arrayList = (ArrayList) K;
                if (!arrayList.isEmpty()) {
                    this.f41936g0.add((o) arrayList.get(0));
                }
                this.f41937h0 = null;
            } catch (t e) {
        ...
        if (!this.f41936g0.isEmpty()) {
            ArrayDeque arrayDeque = this.f41936g0;
            arrayDeque.getClass();
            while (this.f41931b0 == null) {
                ...
                try {
                    ...
                    String str2 = "Decoder init failed: " + oVar.f41915a + ", " + sVar;
                    ...
                    X(pVar);
                    p pVar2 = this.f41937h0;
                    if (pVar2 == null) {
                        this.f41937h0 = pVar;
                    } else {
                        this.f41937h0 = new p(pVar2.getMessage(), pVar2.getCause(), pVar2.f41924a, pVar2.f41925b, pVar2.f41926c, pVar2.d);
                    }
                    if (arrayDeque.isEmpty()) {
                        throw this.f41937h0;
                    }
    ...
    public void d0(long j3) {
        ...
        while (true) {
            ArrayDeque arrayDeque = this.Q;
            if (!arrayDeque.isEmpty() && j3 >= ((q) arrayDeque.peek()).f41927a) {
    ...
    public boolean m() {
        if (this.S != null) {
            if (!n() && this.f41948t0 < 0) {
                if (this.f41946r0 != -9223372036854775807L) {
                    this.h.getClass();
                    if (SystemClock.elapsedRealtime() < this.f41946r0) {
                        return true;
                    }
                    return false;
                }
    ...
    public final void p0(q qVar) {
        this.P0 = qVar;
        if (qVar.f41929c != -9223372036854775807L) {
            this.R0 = true;
            c0();
        }
    }
    ...
    public boolean t0() {
        boolean z10;
        int i10 = this.D0;
        if (i10 == 3 || ((this.f41940k0 && !this.G0) || (this.f41941l0 && this.F0))) {
            return true;
        }
        if (i10 == 2) {
    ...
    public final boolean w0(b2.s sVar) {
        if (Build.VERSION.SDK_INT >= 23 && this.f41931b0 != null && this.D0 != 3 && this.f10642n != 0) {
            float f7 = this.f41930a0;
            sVar.getClass();
            b2.s[] sVarArr = this.f10644s;
            sVarArr.getClass();
            float N = N(f7, sVar, sVarArr);
            float f10 = this.f41935f0;
            if (f10 != N) {
                if (N == -1.0f) {
                    if (this.E0) {
                        this.C0 = 1;
    ...
    public final void x0() {
        ...
        if (h instanceof n2.r) {
            try {
                ...
                mediaCrypto.setMediaDrmSession(((n2.r) h).f14892b);
    ...
    public final void y0(long j3) {
        ...
        if (sVar == null && this.R0 && this.f41933d0 != null) {
            sVar = (b2.s) this.P0.d.f();
        }
        if (sVar != null) {
            this.T = sVar;
        } else if (!this.f41934e0 || this.T == null) {
            return;
        }
        b2.s sVar2 = this.T;
        sVar2.getClass();
        b0(sVar2, this.f41933d0);
        this.f41934e0 = false;
        this.R0 = false;
    }
