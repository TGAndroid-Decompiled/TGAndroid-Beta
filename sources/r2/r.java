...
public abstract class r extends i2.f {
    ...
    public final long Y;
    public float Z;
    public float f42298a0;
    public l f42299b0;
    public b2.s f42300c0;
    public MediaFormat f42301d0;
    public boolean f42302e0;
    public float f42303f0;
    public ArrayDeque f42304g0;
    public p f42305h0;
    public o f42306i0;
    public int f42307j0;
    public boolean f42308k0;
    public boolean f42309l0;
    public boolean m0;
    public boolean f42310n0;
    public boolean f42311o0;
    public boolean f42312p0;
    public long f42313q0;
    public long f42314r0;
    public int f42315s0;
    public int f42316t0;
    public ByteBuffer f42317u0;
    public boolean f42318v0;
    public boolean f42319w0;
    public boolean f42320x0;
    public boolean f42321y0;
    public boolean f42322z0;
    ...
    public r(int i10, k kVar, float f7) {
        ...
        this.f42315s0 = -1;
        this.f42316t0 = -1;
        this.f42314r0 = -9223372036854775807L;
        this.H0 = -9223372036854775807L;
        this.I0 = -9223372036854775807L;
        this.Q0 = -9223372036854775807L;
        this.f42313q0 = -9223372036854775807L;
        this.C0 = 0;
        this.D0 = 0;
        this.O0 = new Object();
    ...
    public final boolean C(long j3, long j10) {
        ...
        if (gVar2.i()) {
            ...
            int i13 = this.f42316t0;
            int i14 = gVar2.f42275s;
            long j11 = gVar2.e;
            boolean T = T(this.f10692w, gVar2.f42274r);
            ...
            if (w10 != -5) {
                if (w10 != -4) {
                    ...
                    if (sVar3 != null && Objects.equals(sVar3.f3308r, "audio/opus")) {
                        ...
                        if (this.f10692w - hVar.e <= 80000) {
                            ...
                            if (hVar.f10097c.limit() - hVar.f10097c.position() != 0) {
                                if (j0Var.f13315b == 2 && (list.size() == 1 || list.size() == 3)) {
                                ...
                                if (j0Var.f13314a.capacity() < i18) {
                                    j0Var.f13314a = ByteBuffer.allocate(i18).order(ByteOrder.LITTLE_ENDIAN);
                                } else {
                                    j0Var.f13314a.clear();
                                }
                                ByteBuffer byteBuffer3 = j0Var.f13314a;
                                if (j0Var.f13315b == 2) {
                                    if (bArr != null) {
                                ...
                                int k10 = j0Var.f13316c + ((int) ((c3.b.k(b11, b10) * 48000) / 1000000));
                                j0Var.f13316c = k10;
                                j0.a(byteBuffer3, k10, j0Var.f13315b, i17, false);
                                ...
                                j0Var.f13315b++;
                                j0Var.f13314a = byteBuffer3;
                                hVar.clear();
                                hVar.c(j0Var.f13314a.remaining());
                                hVar.f10097c.put(j0Var.f13314a);
                                hVar.e();
                            }
                        }
                    }
                    if (gVar.i()) {
                        ...
                        if (T(j12, gVar.f42274r) != T(j12, hVar.e)) {
                            break;
                        }
                    }
                    if (!gVar.h(hVar)) {
        ...
        if (!gVar.i() && !this.J0 && !this.f42322z0) {
            return false;
        }
        return true;
    }
    ...
    public final boolean G(long j3, long j10) {
        ...
        boolean z14;
        int h;
        l lVar = this.f42299b0;
        lVar.getClass();
        int i10 = this.f42316t0;
        ...
        if (i10 < 0) {
            ...
            if (h < 0) {
                if (h == -2) {
                    this.G0 = true;
                    l lVar2 = this.f42299b0;
                    lVar2.getClass();
                    MediaFormat outputFormat = lVar2.getOutputFormat();
                    if (this.f42307j0 != 0 && outputFormat.getInteger("width") == 32 && outputFormat.getInteger("height") == 32) {
                        this.f42311o0 = true;
                        return true;
                    }
                    this.f42301d0 = outputFormat;
                    this.f42302e0 = true;
                    return true;
                }
                if (this.f42312p0 && (this.J0 || this.C0 == 2)) {
                    g0();
                }
                long j11 = this.f42313q0;
                ...
                this.f42317u0 = outputBuffer;
                if (outputBuffer != null) {
                    outputBuffer.position(bufferInfo2.offset);
                    this.f42317u0.limit(bufferInfo2.offset + bufferInfo2.size);
                }
        ...
        if (this.m0 && this.F0) {
            try {
                ByteBuffer byteBuffer = this.f42317u0;
                int i11 = this.f42316t0;
                int i12 = bufferInfo2.flags;
                boolean z15 = this.f42318v0;
                boolean z16 = this.f42319w0;
                b2.s sVar = this.T;
                sVar.getClass();
            ...
            z12 = false;
            z13 = true;
            ByteBuffer byteBuffer2 = this.f42317u0;
            int i13 = this.f42316t0;
            int i14 = bufferInfo.flags;
            boolean z17 = this.f42318v0;
            boolean z18 = this.f42319w0;
            b2.s sVar2 = this.T;
            sVar2.getClass();
        ...
        if (h02) {
            ...
            if (!z14 && this.F0 && this.f42319w0) {
                this.h.getClass();
                this.f42313q0 = System.currentTimeMillis();
            }
            this.f42316t0 = -1;
            this.f42317u0 = null;
            if (!z14) {
    ...
    public final boolean H() {
        ...
        if (this.C0 == 1) {
            if (!this.f42312p0) {
                this.F0 = true;
                lVar.a(0L, this.f42315s0, 0, 4);
                this.f42315s0 = -1;
                hVar.f10097c = null;
            }
            this.C0 = 2;
            return false;
        } else if (this.f42310n0) {
            this.f42310n0 = false;
            ByteBuffer byteBuffer = hVar.f10097c;
            byteBuffer.getClass();
            byteBuffer.put(W0);
            lVar.a(0L, this.f42315s0, 38, 0);
            this.f42315s0 = -1;
            hVar.f10097c = null;
            this.E0 = true;
            return true;
            ...
            if (this.B0 == 1) {
                ...
                while (true) {
                    ...
                    byteBuffer2.put((byte[]) this.f42300c0.f3311u.get(i11));
                    i11++;
                }
                this.B0 = 2;
            }
            ...
            try {
                ...
                if (w10 == -3) {
                    ...
                    if (!this.E0 && !hVar.isKeyFrame()) {
                        ...
                        if (flag) {
                            lVar.b(this.f42315s0, hVar.f10096b, j3, L);
                        } else {
                            int i12 = this.f42315s0;
    ...
    public final void V(MediaCrypto mediaCrypto, boolean z10) {
        ...
        b2.s sVar = this.S;
        sVar.getClass();
        if (this.f42304g0 == null) {
            try {
                List K = K(z10);
                this.f42304g0 = new ArrayDeque();
                ArrayList arrayList = (ArrayList) K;
                if (!arrayList.isEmpty()) {
                    this.f42304g0.add((o) arrayList.get(0));
                }
                this.f42305h0 = null;
            } catch (t e) {
        ...
        if (!this.f42304g0.isEmpty()) {
            ArrayDeque arrayDeque = this.f42304g0;
            arrayDeque.getClass();
            while (this.f42299b0 == null) {
                ...
                try {
                    ...
                    String str2 = "Decoder init failed: " + oVar.f42283a + ", " + sVar;
                    ...
                    X(pVar);
                    p pVar2 = this.f42305h0;
                    if (pVar2 == null) {
                        this.f42305h0 = pVar;
                    } else {
                        this.f42305h0 = new p(pVar2.getMessage(), pVar2.getCause(), pVar2.f42292a, pVar2.f42293b, pVar2.f42294c, pVar2.d);
                    }
                    if (arrayDeque.isEmpty()) {
                        throw this.f42305h0;
                    }
    ...
    public void d0(long j3) {
        ...
        while (true) {
            ArrayDeque arrayDeque = this.Q;
            if (!arrayDeque.isEmpty() && j3 >= ((q) arrayDeque.peek()).f42295a) {
    ...
    public boolean m() {
        if (this.S != null) {
            if (!n() && this.f42316t0 < 0) {
                if (this.f42314r0 != -9223372036854775807L) {
                    this.h.getClass();
                    if (SystemClock.elapsedRealtime() < this.f42314r0) {
                        return true;
                    }
                    return false;
                }
    ...
    public final void p0(q qVar) {
        this.P0 = qVar;
        if (qVar.f42297c != -9223372036854775807L) {
            this.R0 = true;
            c0();
        }
    }
    ...
    public boolean t0() {
        boolean z10;
        int i10 = this.D0;
        if (i10 == 3 || ((this.f42308k0 && !this.G0) || (this.f42309l0 && this.F0))) {
            return true;
        }
        if (i10 == 2) {
    ...
    public final boolean w0(b2.s sVar) {
        if (Build.VERSION.SDK_INT >= 23 && this.f42299b0 != null && this.D0 != 3 && this.f10689n != 0) {
            float f7 = this.f42298a0;
            sVar.getClass();
            b2.s[] sVarArr = this.f10691s;
            sVarArr.getClass();
            float N = N(f7, sVar, sVarArr);
            float f10 = this.f42303f0;
            if (f10 != N) {
                if (N == -1.0f) {
                    if (this.E0) {
                        this.C0 = 1;
    ...
    public final void x0() {
        ...
        if (h instanceof n2.r) {
            try {
                ...
                mediaCrypto.setMediaDrmSession(((n2.r) h).f15154b);
    ...
    public final void y0(long j3) {
        ...
        if (sVar == null && this.R0 && this.f42301d0 != null) {
            sVar = (b2.s) this.P0.d.f();
        }
        if (sVar != null) {
            this.T = sVar;
        } else if (!this.f42302e0 || this.T == null) {
            return;
        }
        b2.s sVar2 = this.T;
        sVar2.getClass();
        b0(sVar2, this.f42301d0);
        this.f42302e0 = false;
        this.R0 = false;
    }
