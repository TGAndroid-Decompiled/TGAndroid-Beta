...
public abstract class r extends i2.f {
    ...
    public final long Y;
    public float Z;
    public float f44849a0;
    public l f44850b0;
    public b2.s f44851c0;
    public MediaFormat f44852d0;
    public boolean f44853e0;
    public float f44854f0;
    public ArrayDeque f44855g0;
    public p f44856h0;
    public o f44857i0;
    public int f44858j0;
    public boolean f44859k0;
    public boolean f44860l0;
    public boolean m0;
    public boolean f44861n0;
    public boolean f44862o0;
    public boolean f44863p0;
    public long f44864q0;
    public long f44865r0;
    public int f44866s0;
    public int f44867t0;
    public ByteBuffer f44868u0;
    public boolean f44869v0;
    public boolean f44870w0;
    public boolean f44871x0;
    public boolean f44872y0;
    public boolean f44873z0;
    ...
    public r(int i10, k kVar, float f7) {
        ...
        this.f44866s0 = -1;
        this.f44867t0 = -1;
        this.f44865r0 = -9223372036854775807L;
        this.H0 = -9223372036854775807L;
        this.I0 = -9223372036854775807L;
        this.Q0 = -9223372036854775807L;
        this.f44864q0 = -9223372036854775807L;
        this.C0 = 0;
        this.D0 = 0;
        this.O0 = new Object();
    ...
    public final boolean B(long j3, long j10) {
        ...
        if (gVar2.o()) {
            ...
            int i13 = this.f44867t0;
            int i14 = gVar2.f44823w;
            long j11 = gVar2.h;
        ...
        if (!gVar.o() && !this.J0 && !this.f44873z0) {
            return false;
        }
        return true;
    }
    ...
    public final boolean F(long j3, long j10) {
        ...
        boolean z14;
        int h;
        l lVar = this.f44850b0;
        lVar.getClass();
        int i10 = this.f44867t0;
        ...
        if (i10 < 0) {
            ...
            if (h < 0) {
                if (h == -2) {
                    this.G0 = true;
                    l lVar2 = this.f44850b0;
                    lVar2.getClass();
                    MediaFormat outputFormat = lVar2.getOutputFormat();
                    if (this.f44858j0 != 0 && outputFormat.getInteger("width") == 32 && outputFormat.getInteger("height") == 32) {
                        this.f44862o0 = true;
                        return true;
                    }
                    this.f44852d0 = outputFormat;
                    this.f44853e0 = true;
                    return true;
                }
                if (this.f44863p0 && (this.J0 || this.C0 == 2)) {
                    f0();
                }
                long j11 = this.f44864q0;
                ...
                this.f44868u0 = outputBuffer;
                if (outputBuffer != null) {
                    outputBuffer.position(bufferInfo2.offset);
                    this.f44868u0.limit(bufferInfo2.offset + bufferInfo2.size);
                }
        ...
        if (this.m0 && this.F0) {
            try {
                ByteBuffer byteBuffer = this.f44868u0;
                int i11 = this.f44867t0;
                int i12 = bufferInfo2.flags;
                boolean z15 = this.f44869v0;
                boolean z16 = this.f44870w0;
                b2.s sVar = this.T;
                sVar.getClass();
            ...
            z12 = false;
            z13 = true;
            ByteBuffer byteBuffer2 = this.f44868u0;
            int i13 = this.f44867t0;
            int i14 = bufferInfo.flags;
            boolean z17 = this.f44869v0;
            boolean z18 = this.f44870w0;
            b2.s sVar2 = this.T;
            sVar2.getClass();
        ...
        if (g02) {
            ...
            if (!z14 && this.F0 && this.f44870w0) {
                this.h.getClass();
                this.f44864q0 = System.currentTimeMillis();
            }
            this.f44867t0 = -1;
            this.f44868u0 = null;
            if (!z14) {
    ...
    public final boolean G() {
        ...
        if (this.C0 == 1) {
            if (!this.f44863p0) {
                this.F0 = true;
                lVar.a(0L, this.f44866s0, 0, 4);
                this.f44866s0 = -1;
                gVar.f10847e = null;
            }
            this.C0 = 2;
            return false;
        } else if (this.f44861n0) {
            this.f44861n0 = false;
            ByteBuffer byteBuffer = gVar.f10847e;
            byteBuffer.getClass();
            byteBuffer.put(W0);
            lVar.a(0L, this.f44866s0, 38, 0);
            this.f44866s0 = -1;
            gVar.f10847e = null;
            this.E0 = true;
            return true;
            ...
            if (this.B0 == 1) {
                ...
                while (true) {
                    ...
                    byteBuffer2.put((byte[]) this.f44851c0.f2373u.get(i11));
                    i11++;
                }
                this.B0 = 2;
            }
            ...
            try {
                ...
                if (v == -3) {
                    ...
                    if (!this.E0 && !gVar.c(1)) {
                        ...
                        if (c10) {
                            lVar.b(this.f44866s0, gVar.d, j3, K);
                        } else {
                            int i12 = this.f44866s0;
    ...
    public final void U(MediaCrypto mediaCrypto, boolean z10) {
        ...
        b2.s sVar = this.S;
        sVar.getClass();
        if (this.f44855g0 == null) {
            try {
                List J = J(z10);
                this.f44855g0 = new ArrayDeque();
                ArrayList arrayList = (ArrayList) J;
                if (!arrayList.isEmpty()) {
                    this.f44855g0.add((o) arrayList.get(0));
                }
                this.f44856h0 = null;
            } catch (t e7) {
        ...
        if (!this.f44855g0.isEmpty()) {
            ArrayDeque arrayDeque = this.f44855g0;
            arrayDeque.getClass();
            while (this.f44850b0 == null) {
                ...
                try {
                    ...
                    String str2 = "Decoder init failed: " + oVar.f44832a + ", " + sVar;
                    ...
                    W(pVar);
                    p pVar2 = this.f44856h0;
                    if (pVar2 == null) {
                        this.f44856h0 = pVar;
                    } else {
                        this.f44856h0 = new p(pVar2.getMessage(), pVar2.getCause(), pVar2.f44842a, pVar2.f44843b, pVar2.f44844c, pVar2.d);
                    }
                    if (arrayDeque.isEmpty()) {
                        throw this.f44856h0;
                    }
    ...
    public void c0(long j3) {
        ...
        while (true) {
            ArrayDeque arrayDeque = this.Q;
            if (!arrayDeque.isEmpty() && j3 >= ((q) arrayDeque.peek()).f44846a) {
    ...
    public boolean m() {
        ...
        if (this.S != null) {
            ...
            if (!e7) {
                ...
                if (!z10) {
                    if (this.f44865r0 != -9223372036854775807L) {
                        this.h.getClass();
                        if (SystemClock.elapsedRealtime() < this.f44865r0) {
                        }
                    }
                }
            }
    ...
    public final void o0(q qVar) {
        this.P0 = qVar;
        if (qVar.f44848c != -9223372036854775807L) {
            this.R0 = true;
            b0();
        }
    }
    ...
    public boolean s0() {
        boolean z10;
        int i10 = this.D0;
        if (i10 == 3 || ((this.f44859k0 && !this.G0) || (this.f44860l0 && this.F0))) {
            return true;
        }
        if (i10 == 2) {
    ...
    public final boolean v0(b2.s sVar) {
        if (Build.VERSION.SDK_INT >= 23 && this.f44850b0 != null && this.D0 != 3 && this.f11499n != 0) {
            float f7 = this.f44849a0;
            sVar.getClass();
            b2.s[] sVarArr = this.f11501s;
            sVarArr.getClass();
            float M = M(f7, sVar, sVarArr);
            float f10 = this.f44854f0;
            if (f10 != M) {
                if (M == -1.0f) {
                    if (this.E0) {
                        this.C0 = 1;
    ...
    public final void x0(long j3) {
        ...
        if (sVar == null && this.R0 && this.f44852d0 != null) {
            sVar = (b2.s) this.P0.d.f();
        }
        if (sVar != null) {
            this.T = sVar;
        } else if (!this.f44853e0 || this.T == null) {
            return;
        }
        b2.s sVar2 = this.T;
        sVar2.getClass();
        a0(sVar2, this.f44852d0);
        this.f44853e0 = false;
        this.R0 = false;
    }
