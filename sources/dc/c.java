...
public enum c {
    ...
    public static final HashMap f6721c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f6723a) {
                    f6721c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f6724b) {
                    d.put(str, cVar);
                }
            }
        }
