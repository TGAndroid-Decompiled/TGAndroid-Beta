...
public enum c {
    ...
    public static final HashMap f6694c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f6696a) {
                    f6694c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f6697b) {
                    d.put(str, cVar);
                }
            }
        }
