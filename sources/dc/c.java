...
public enum c {
    ...
    public static final HashMap f7604c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f7605a) {
                    f7604c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f7606b) {
                    d.put(str, cVar);
                }
            }
        }
