...
public enum c {
    ...
    public static final HashMap f6392c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f6393a) {
                    f6392c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f6394b) {
                    d.put(str, cVar);
                }
            }
        }
