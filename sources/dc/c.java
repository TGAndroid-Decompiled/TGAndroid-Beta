...
public enum c {
    ...
    public static final HashMap f7616c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f7617a) {
                    f7616c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f7618b) {
                    d.put(str, cVar);
                }
            }
        }
