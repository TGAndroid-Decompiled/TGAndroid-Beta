...
public abstract class b {
    ...
    public static HttpURLConnection a(String str, e eVar) {
        ...
        if (httpURLConnection instanceof HttpsURLConnection) {
            ((HttpsURLConnection) httpURLConnection).setSSLSocketFactory(f4472a);
        }
    ...
    public static a5.m c(java.util.HashMap r7, com.google.android.gms.internal.clearcut.e r8) {
        throw new UnsupportedOperationException("Method not decompiled: dc.b.c(java.util.HashMap, com.google.android.gms.internal.clearcut.e):a5.m");
    }
    ...
    public static List e(Object obj, String str) {
        ...
        if (obj instanceof List) {
            ...
            throw new g(j2.h("You cannot set '", str, "' to an empty string. We interpret empty strings as null in requests. You may set '", str, "' to null to delete the property."), null, null);
        }
    }

    public static a6.a f(java.util.HashMap r7, com.google.android.gms.internal.clearcut.e r8) {
        throw new UnsupportedOperationException("Method not decompiled: dc.b.f(java.util.HashMap, com.google.android.gms.internal.clearcut.e):a6.a");
    }
    ...
    public static void g(int i9, String str, String str2) {
        ...
        try {
            ...
            j7.a(jSONObject.optString("type"));
