...
public final class h implements i {
    ...
    public int d;
    public int e;
    public final Object f12691f;
    public Object f12692g;

    public h(List list) {
        this.f12688a = 0;
        this.f12691f = list;
        this.f12692g = new h0[list.size()];
        this.f12690c = -9223372036854775807L;
    }
    ...
    public final void a(e2.v vVar) {
        ...
        switch (this.f12688a) {
            case 0:
                ...
                return;
            default:
                e2.v vVar2 = (e2.v) this.f12691f;
                e2.d.h((h0) this.f12692g);
                if (this.f12689b) {
                    int a10 = vVar.a();
                    int i11 = this.e;
                    if (i11 < 10) {
    ...
    public final void d(c3.q qVar, f0 f0Var) {
        switch (this.f12688a) {
            case 0:
                h0[] h0VarArr = (h0[]) this.f12692g;
                for (int i10 = 0; i10 < h0VarArr.length; i10++) {
                    e0 e0Var = (e0) ((List) this.f12691f).get(i10);
                    f0Var.a();
                    f0Var.b();
    ...
    public final void e(boolean z10) {
        ...
        switch (this.f12688a) {
            case 0:
                if (this.f12689b) {
                    if (this.f12690c != -9223372036854775807L) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
                    e2.d.g(z11);
                    for (h0 h0Var : (h0[]) this.f12692g) {
                        h0Var.c(this.f12690c, 1, this.e, 0, null);
                    }
                    this.f12689b = false;
                    return;
                }
            ...
            default:
                e2.d.h((h0) this.f12692g);
                if (this.f12689b && (i10 = this.d) != 0 && this.e == i10) {
                    if (this.f12690c != -9223372036854775807L) {
                        z12 = true;
                    } else {
                        z12 = false;
                    ...
                    e2.d.g(z12);
                    ((h0) this.f12692g).c(this.f12690c, 1, this.d, 0, null);
                    this.f12689b = false;
                    return;
                }
                return;
