...
public final class z implements c3.o {
    ...
    public final e2.b0 f12866a = new e2.b0(0);
    public final e2.v f12868c = new e2.v(4096);
    public final SparseArray f12867b = new SparseArray();
    ...
    public final void h(long j3, long j10) {
        ...
        h3.a aVar = this.f12871i;
        if (aVar != null) {
            aVar.d(j10);
        }
        int i10 = 0;
        while (true) {
            SparseArray sparseArray = this.f12867b;
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (i11 != 0 && !xVar.d) {
            ...
            if (!xVar.f12858f) {
                ...
                int i12 = vVar.f7930b;
                int i13 = vVar.f7931c - 4;
                while (true) {
                    if (i13 >= i12) {
                        if (x.b(i13, vVar.f7929a) == 442) {
                            vVar.J(i13 + 4);
                            long c10 = x.c(vVar);
                ...
                long j16 = xVar.f12859g;
                if (j16 == -9223372036854775807L) {
                    xVar.a(pVar);
                    return 0;
                }
                xVar.f12860i = b0Var.c(xVar.h) - b0Var.b(j16);
                xVar.a(pVar);
                return 0;
            }
        }
        if (!this.f12873k) {
            this.f12873k = true;
            long j17 = xVar.f12860i;
            if (j17 != -9223372036854775807L) {
                e2.b0 b0Var2 = xVar.f12856b;
                ?? obj = new Object();
                ...
                this.f12871i = aVar;
                this.f12872j.X1(aVar.f10108a);
            } else {
                i10 = 4;
                this.f12872j.X1(new c3.t(j17));
            }
        } else {
            i10 = 4;
        }
        h3.a aVar2 = this.f12871i;
        ...
        if (j3 == -1 || j3 >= 4) {
            e2.v vVar2 = this.f12868c;
            if (pVar.h(vVar2.f7929a, 0, i10, true)) {
                vVar2.J(0);
                int j19 = vVar2.j();
                if (j19 == 441) {
                    return -1;
                ...
                if (j19 == 442) {
                    pVar.a(0, 10, vVar2.f7929a);
                    vVar2.J(9);
                    pVar.q((vVar2.x() & 7) + 14);
                    return 0;
                } else if (j19 == 443) {
                    pVar.a(0, 2, vVar2.f7929a);
                    vVar2.J(0);
                    pVar.q(vVar2.D() + 6);
                    return 0;
                } else if (((j19 & (-256)) >> 8) != 1) {
                    ...
                    if (!this.e) {
                        if (yVar2 == null) {
                            ...
                            if (iVar != null) {
                                iVar.d(this.f12872j, new f0(i16, 256));
                                yVar2 = new y(iVar, this.f12866a);
                    ...
                    vVar2.G(D);
                    pVar.readFully(vVar2.f7929a, 0, D);
                    vVar2.J(6);
                    i iVar2 = yVar2.f12861a;
                    a4.h hVar = yVar2.f12863c;
                    ...
                    if (yVar2.d) {
                        ...
                        yVar2.f12865g = b0Var3.b(j10);
                    }
                    iVar2.f(4, yVar2.f12865g);
                    iVar2.a(vVar2);
                    iVar2.e(false);
                    vVar2.I(vVar2.f7929a.length);
                    return 0;
                }
            }
            return -1;
