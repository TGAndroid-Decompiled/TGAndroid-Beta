    ...
    public final void b(c3.q qVar, f0 f0Var) {
        ...
        switch (this.f12626a) {
            case 0:
                int i10 = 0;
                while (true) {
                    h0[] h0VarArr = this.f12628c;
                    if (i10 < h0VarArr.length) {
                        f0Var.a();
                        f0Var.b();
                        h0 Z1 = qVar.Z1(f0Var.d, 3);
                        b2.s sVar = (b2.s) this.f12627b.get(i10);
            ...
            default:
                int i11 = 0;
                while (true) {
                    h0[] h0VarArr2 = this.f12628c;
                    if (i11 < h0VarArr2.length) {
                        f0Var.a();
                        f0Var.b();
                        h0 Z12 = qVar.Z1(f0Var.d, 3);
                        b2.s sVar2 = (b2.s) this.f12627b.get(i11);
                        String str3 = sVar2.f3304r;
                        ...
                        rVar2.f3248q = r0.n(str3);
                        rVar2.e = sVar2.e;
                        rVar2.d = sVar2.d;
                        rVar2.N = sVar2.O;
                        rVar2.f3251t = sVar2.f3307u;
                        k0.u(rVar2, Z12);
                        h0VarArr2[i11] = Z12;
                        i11++;
                    } else {
