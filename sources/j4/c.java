...
public final class c implements c3.o {
    public final b f12625a = new b(0, 1, null, "audio/ac4");
    public final e2.v f12626b = new e2.v(16384);
    ...
    public final void g(c3.q qVar) {
        this.f12625a.d(qVar, new f0(0, 1));
        qVar.e1();
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        e2.v vVar = this.f12626b;
        int read = pVar.read(vVar.f7931a, 0, 16384);
        if (read == -1) {
            return -1;
        }
        vVar.J(0);
