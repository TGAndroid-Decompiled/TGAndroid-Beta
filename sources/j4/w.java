...
public final class w implements g0 {
    public final i f12850a;
    public final a4.h f12851b = new a4.h(new byte[10], 10);
    ...
    public final void a(int i10, e2.v vVar) {
        ...
        int i18 = i10;
        while (vVar.a() > 0) {
            int i19 = this.f12852c;
            if (i19 != 0) {
                a4.h hVar = this.f12851b;
                if (i19 != 1) {
                    if (i19 != i16) {
                        if (i19 == 3) {
                            int a2 = vVar.a();
                            int i20 = this.f12856j;
                            if (i20 == i15) {
                                i13 = 0;
                            } else {
                                i13 = a2 - i20;
                        ...
                        if (b(vVar, hVar.f256b, Math.min(10, this.f12855i)) && b(vVar, null, this.f12855i)) {
                            hVar.q(0);
                            this.f12858l = -9223372036854775807L;
                            if (this.f12853f) {
                                hVar.t(4);
                                hVar.t(1);
                            ...
                            i18 |= i12;
                            iVar.g(i18, this.f12858l);
                            this.f12852c = 3;
                            this.d = 0;
                        }
                    }
                } else if (b(vVar, hVar.f256b, 9)) {
                    if (e()) {
                        i11 = 2;
                    } else {
                        i11 = 0;
    ...
    public final boolean e() {
        ...
        if (i11 == 0) {
            ...
            this.f12856j = i13;
            if (i13 < 0) {
                e2.a.n("PesReader", "Found negative packet payload size: " + this.f12856j);
                this.f12856j = -1;
            }
        }
        return true;
