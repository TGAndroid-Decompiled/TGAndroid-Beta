...
public final class w implements g0 {
    ...
    public final a4.h f12849b = new a4.h(new byte[10], 10);
    ...
    public final void a(int i10, e2.v vVar) {
        ...
        if (i14 != 0) {
            ...
            if (i17 != 0 && i17 != 1) {
                if (i17 != 2) {
                    if (i17 == 3) {
                        if (this.f12854j != -1) {
                            e2.a.n("PesReader", "Unexpected start indicator: expected " + this.f12854j + " more bytes");
                        }
                        if (vVar.f7933c == 0) {
                            z10 = true;
                        } else {
        ...
        int i18 = i10;
        while (vVar.a() > 0) {
            int i19 = this.f12850c;
            if (i19 != 0) {
                a4.h hVar = this.f12849b;
                if (i19 != 1) {
                    if (i19 != i16) {
                        if (i19 == 3) {
                            int a2 = vVar.a();
                            int i20 = this.f12854j;
                            if (i20 == i15) {
                                i13 = 0;
                            } else {
                                i13 = a2 - i20;
                            ...
                            if (i13 > 0) {
                                a2 -= i13;
                                vVar.I(vVar.f7932b + a2);
                            }
                            iVar.a(vVar);
                            int i21 = this.f12854j;
                            if (i21 != i15) {
                                int i22 = i21 - a2;
                                this.f12854j = i22;
                                if (i22 == 0) {
                        ...
                        if (d(vVar, hVar.f256b, Math.min(10, this.f12853i)) && d(vVar, null, this.f12853i)) {
                            hVar.q(0);
                            this.f12856l = -9223372036854775807L;
                            if (this.f12851f) {
                                hVar.t(4);
                                hVar.t(1);
    ...
    public final boolean e() {
        ...
        if (i11 == 0) {
            ...
            this.f12854j = i13;
            if (i13 < 0) {
                e2.a.n("PesReader", "Found negative packet payload size: " + this.f12854j);
                this.f12854j = -1;
            }
        }
        return true;
