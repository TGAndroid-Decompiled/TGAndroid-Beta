...
public final class a extends j {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && a.class == obj.getClass()) {
            a aVar = (a) obj;
            if (this.d == aVar.d && d0.a(this.f8906b, aVar.f8906b) && d0.a(this.f8907c, aVar.f8907c) && Arrays.equals(this.e, aVar.e)) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        return this.f8924a + ": mimeType=" + this.f8906b + ", description=" + this.f8907c;
    }
