...
public final class a implements c3.o {
    public final b f12604a = new b("audio/ac3");
    public final e2.v f12605b = new e2.v(2786);
    ...
    public final void g(c3.q qVar) {
        this.f12604a.d(qVar, new f0(0, 1));
        qVar.e1();
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        e2.v vVar = this.f12605b;
        int read = pVar.read(vVar.f7929a, 0, 2786);
        if (read == -1) {
            return -1;
        }
        vVar.J(0);
