...
public final class d0 implements c3.o {
    ...
    public final f f12643f;
    public final z3.l f12644g;
    public final SparseArray h;
    public final SparseBooleanArray f12645i;
    public final SparseBooleanArray f12646j;
    public final x f12647k;
    public h3.a f12648l;
    public c3.q f12649m;
    public int f12650n;
    ...
    public d0(int i10, int i11, z3.l lVar, e2.b0 b0Var, f fVar) {
        ...
        if (i10 != 1 && i10 != 2) {
            ...
            this.f12642c = Collections.singletonList(b0Var);
        }
        this.d = new e2.v(new byte[9400], 0);
        SparseBooleanArray sparseBooleanArray = new SparseBooleanArray();
        this.f12645i = sparseBooleanArray;
        this.f12646j = new SparseBooleanArray();
        SparseArray sparseArray = new SparseArray();
        this.h = sparseArray;
        this.e = new SparseIntArray();
        this.f12647k = new x(1);
        this.f12649m = c3.q.f3794m;
        this.f12656t = -1;
    ...
    public final void g(c3.q qVar) {
        if ((this.f12641b & 1) == 0) {
            qVar = new com.google.firebase.messaging.m(qVar, this.f12644g);
        }
        this.f12649m = qVar;
    }
    ...
    public final void h(long j3, long j10) {
        ...
        if (j10 != 0 && (aVar = this.f12648l) != null) {
            aVar.d(j10);
        }
        this.d.G(0);
        this.e.clear();
    ...
    public final int m(c3.p pVar, c3.s sVar) {
        ...
        if (this.f12651o) {
            ...
            if (length != -1 && !z10 && !xVar.d) {
                ...
                if (i17 <= 0) {
                    ...
                    long j12 = xVar.f12861g;
                    if (j12 == -9223372036854775807L) {
                        xVar.a(pVar);
                        return 0;
                    }
                    xVar.f12862i = b0Var.c(xVar.h) - b0Var.b(j12);
                    xVar.a(pVar);
                    return 0;
                }
            }
            if (!this.f12652p) {
                this.f12652p = true;
                long j13 = xVar.f12862i;
                if (j13 != -9223372036854775807L) {
                    i10 = i16;
                    z13 = false;
                    i15 = 1;
                    h3.a aVar = new h3.a(new Object(), new a5.a(this.f12656t, xVar.f12858b), j13, j13 + 1, 0L, length, 188L, 940);
                    this.f12648l = aVar;
                    this.f12649m.X1(aVar.f10109a);
                } else {
                    i10 = i16;
                    z13 = false;
                    i15 = 1;
                    this.f12649m.X1(new c3.t(j13));
                }
            } else {
                i10 = i16;
                z13 = false;
        ...
        e2.v vVar2 = this.d;
        byte[] bArr2 = vVar2.f7931a;
        if (9400 - vVar2.f7932b < 188) {
            int a11 = vVar2.a();
            if (a11 > 0) {
                System.arraycopy(bArr2, vVar2.f7932b, bArr2, r12, a11);
            }
            vVar2.H(a11, bArr2);
        }
        while (true) {
            ...
            if (a12 < 188) {
                ...
                if (read == -1) {
                    for (int i27 = 0; i27 < sparseArray.size(); i27++) {
                        ...
                        if (g0Var instanceof w) {
                            ...
                            if (wVar.f12850c == 3 && wVar.f12854j == -1 && ((!z10 || !(wVar.f12848a instanceof k)) && z12)) {
                                wVar.a(1, new e2.v());
                            }
                        }
                    }
                ...
                int i28 = vVar2.f7932b;
                int i29 = vVar2.f7933c;
                ...
                boolean z14 = this.f12651o;
                if (i11 == i12 || z14 || !this.f12646j.get(i34, r12)) {
                    vVar2.I(i31);
                    g0Var2.a(i13, vVar2);
                    vVar2.I(i33);
                }
                if (i11 != i12 && !z14 && this.f12651o && length != -1) {
                    this.f12653q = true;
                }
                vVar2.J(i31);
                return r12;
