...
public class d implements m0, bg.a, q, q9.e, cg.a, n, q9.d, k1, r4.c, Continuation, l, xf.a, y6.d {
    ...
    public Object G(cf.c cVar) {
        switch (this.f15205a) {
            case 15:
                qb.a aVar = new qb.a();
                z9 z9Var = new z9(7);
                ReferenceQueue referenceQueue = aVar.f41253a;
                Set set = aVar.f41254b;
    ...
    public List b(ComponentRegistrar componentRegistrar) {
        ...
        for (q9.a aVar : componentRegistrar.getComponents()) {
            String str = aVar.f41196a;
            if (str != null) {
                aVar = new q9.a(str, aVar.f41197b, aVar.f41198c, aVar.d, aVar.e, new ah.b(5, str, aVar), aVar.f41200g);
            }
            arrayList.add(aVar);
        }
        return arrayList;
