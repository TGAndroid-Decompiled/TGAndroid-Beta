...
public class d implements m0, bg.a, q, q9.e, cg.a, n, q9.d, k1, r4.c, Continuation, l, xf.a, y6.d {
    ...
    public Object G(cf.c cVar) {
        switch (this.f15205a) {
            case 15:
                qb.a aVar = new qb.a();
                z9 z9Var = new z9(7);
                ReferenceQueue referenceQueue = aVar.f41258a;
                Set set = aVar.f41259b;
    ...
    public List b(ComponentRegistrar componentRegistrar) {
        ...
        for (q9.a aVar : componentRegistrar.getComponents()) {
            String str = aVar.f41201a;
            if (str != null) {
                aVar = new q9.a(str, aVar.f41202b, aVar.f41203c, aVar.d, aVar.e, new ah.b(5, str, aVar), aVar.f41205g);
            }
            arrayList.add(aVar);
        }
        return arrayList;
