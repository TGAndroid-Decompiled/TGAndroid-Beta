...
public final class m extends i {
    public final Serializable f17195a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj != null && m.class == obj.getClass()) {
                m mVar = (m) obj;
                Serializable serializable = mVar.f17195a;
                Serializable serializable2 = this.f17195a;
                if (serializable2 == null) {
                    ...
                    double q9 = mVar.q();
                    if (q6 != q9) {
                        if (Double.isNaN(q6) && Double.isNaN(q9)) {
                            return true;
                        }
                        return false;
                    }
    ...
    public final int hashCode() {
        ...
        Serializable serializable = this.f17195a;
        if (serializable == null) {
            return 31;
        }
        if (s(this)) {
    ...
    public final double q() {
        if (this.f17195a instanceof Number) {
