...
public final class f extends j3.e implements Handler.Callback {
    ...
    public final void B(c cVar) {
        ...
        e1 e1Var = f0Var.f8545e0;
        m mVar = f0Var.f8556l;
        d1 a2 = e1Var.a();
        int i10 = 0;
        while (true) {
            b[] bVarArr = cVar.f5101a;
    ...
    public final void r(n0[] n0VarArr, long j10, long j11) {
        ...
        c cVar = this.J;
        if (cVar != null) {
            long j12 = cVar.f5102b;
            long j13 = (this.K + j12) - j11;
            if (j12 != j13) {
                cVar = new c(j13, cVar.f5101a);
            }
            this.J = cVar;
        }
        this.K = j11;
    ...
    public final void t(long j10, long j11) {
        ...
        while (z4) {
            if (!this.G && this.J == null) {
                ...
                if (s6 == -4) {
                    if (eVar.e(4)) {
                        ...
                        c a2 = c7Var.a(eVar);
                        if (a2 != null) {
                            ArrayList arrayList = new ArrayList(a2.f5101a.length);
                            z(a2, arrayList);
                            if (!arrayList.isEmpty()) {
                                this.J = new c(A(eVar.f14242f), (b[]) arrayList.toArray(new b[0]));
                            }
                        }
                    }
                } else if (s6 == -5) {
            ...
            c cVar = this.J;
            if (cVar != null && cVar.f5102b <= A(j10)) {
                c cVar2 = this.J;
