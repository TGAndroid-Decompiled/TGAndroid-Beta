...
public final class a extends Binder implements j, IInterface {
    ...
    public void I(int i10, boolean z10) {
        switch (this.f8041a) {
            case 1:
                h5.a(new Status(i10, null, null, null), Boolean.valueOf(z10), this.f8042b);
                return;
            default:
                return;
        }
    ...
    public void O(Status status, v8.i iVar) {
        switch (this.f8041a) {
            case 0:
                int i10 = v8.a.f44503c;
                boolean b10 = status.b();
                TaskCompletionSource taskCompletionSource = this.f8042b;
                if (b10) {
    ...
    public void j0(Status status, boolean z10) {
        switch (this.f8041a) {
            case 1:
                h5.a(status, Boolean.valueOf(z10), this.f8042b);
                return;
            default:
                return;
        }
