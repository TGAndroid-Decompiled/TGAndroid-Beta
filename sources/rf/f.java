...
public final class f {
    ...
    public final void a(Canvas canvas, float f7) {
        ...
        Canvas canvas2;
        if (Build.VERSION.SDK_INT >= 29) {
            RenderNode renderNode = this.f42561b;
            if (renderNode != null) {
                renderNode.setAlpha(f7);
                canvas.drawRenderNode(this.f42561b);
                return;
            }
            return;
        }
        Picture picture = this.f42560a;
    ...
    public final void b() {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f42561b.discardDisplayList();
        }
    }
}
