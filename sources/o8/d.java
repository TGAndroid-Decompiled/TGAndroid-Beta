...
public final class d extends g implements NavigableMap {
    ...
    public final NavigableMap descendingMap() {
        return new d(this.f19035n, d().descendingMap());
    }
    ...
    public final v e(Iterator it) {
        ...
        List list = (List) this.f19035n.f19048f.get();
    ...
    public final NavigableMap d() {
        return (NavigableMap) ((SortedMap) this.f10166b);
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z10) {
        return new d(this.f19035n, d().headMap(obj, z10));
    }

    @Override
    public final NavigableMap subMap(Object obj, boolean z10, Object obj2, boolean z11) {
        return new d(this.f19035n, d().subMap(obj, z10, obj2, z11));
    }

    @Override
    public final NavigableMap tailMap(Object obj, boolean z10) {
        return new d(this.f19035n, d().tailMap(obj, z10));
    }
}
