...
public final class e extends b1.d {
                    ...
                    if (jVar != null) {
                        ...
                        if (kVar != null) {
                            try {
                                ...
                                jSONObject3.put("code", kVar.f4113a.f4143a);
                                String str5 = kVar.f4114b;
                                if (str5 != null) {
    ...
    public final v d(v0.e request) {
        ...
        kotlin.jvm.internal.i.e(context, "context");
        if (k6.d.d.d(context, k6.e.f13511a) == 0) {
                ...
                if (string2.length() != 0) {
                    ...
                    if (optString2.length() != 0) {
                        ...
                        if (string4.length() != 0) {
                            ...
                            return new v(yVar4, b0Var, bArr2, arrayList2, d, arrayList3, mVar, null, null, a10.f4084a, fVar2, null, null);
                        }
