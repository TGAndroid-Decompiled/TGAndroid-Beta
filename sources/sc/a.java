...
public final class a extends AsyncTask {
    ...
    public final uc.a f46012b;
    public final mo0 f46013c;
    public final n d;
    ...
    public final Object doInBackground(Object[] objArr) {
        ...
        n nVar = this.d;
        try {
            t c10 = vc.b.c(r8.a(this.f46012b), new i(this.f46011a));
    ...
    public final void onPostExecute(Object obj) {
        ...
        t tVar = bVar.f46014a;
        mo0 mo0Var = this.f46013c;
        if (tVar != null) {
            xo0 xo0Var = mo0Var.f38771a;
            if (xo0Var.Q0) {
                return;
            }
            xo0Var.f42869w0 = String.format(Locale.US, "{\"type\":\"%1$s\", \"id\":\"%2$s\"}", (String) tVar.f15845c, (String) tVar.f15844b);
            AndroidUtilities.runOnUIThread(new rl0(mo0Var, 8));
            return;
        }
        Exception exc = bVar.f46015b;
        if (exc != null) {
            mo0Var.a(exc);
        } else {
