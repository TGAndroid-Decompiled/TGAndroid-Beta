...
public final class n implements l0 {
    ...
    public final void a() {
        ...
        rVar.d();
        throw new IOException(android.support.v4.media.a.o("Unable to bind a sample queue to TrackGroup with MIME type ", rVar.V.a(this.f44528a).d[0].C, "."));
    }
    ...
    public final boolean d() {
        if (this.f44530c != -3) {
            if (c()) {
                int i10 = this.f44530c;
                r rVar = this.f44529b;
                if (rVar.n() || !rVar.I[i10].u(rVar.f44549g0)) {
                    return false;
                }
                return true;
            }
    ...
    public final int e(long j10) {
        ...
        if (c()) {
            ...
            if (!rVar.n()) {
                q qVar = rVar.I[i10];
                int s6 = qVar.s(j10, rVar.f44549g0);
                ...
                if (!arrayList.isEmpty()) {
                    ...
                    loop0: while (i13 < arrayList.size() - 1) {
                        ...
                        for (int i15 = 0; i15 < length; i15++) {
                            if (rVar.f44540a0[i15] && rVar.I[i15].y() == i14) {
                                break loop0;
                            }
                        }
                        i13++;
                    ...
                    if (!n0Var2.equals(rVar.T)) {
                        rVar.v.g(rVar.f44541b, n0Var2, kVar.e, kVar.f42732f, kVar.h);
                    }
                    rVar.T = n0Var2;
                }
                if (arrayList.isEmpty() || ((k) arrayList.get(0)).X) {
                    int z4 = rVar.I[i11].z(bVar, iVar, i10, rVar.f44549g0);
                    if (z4 == -5) {
                        n0 n0Var3 = (n0) bVar.f6013c;
                        n0Var3.getClass();
                        if (i11 == rVar.O) {
