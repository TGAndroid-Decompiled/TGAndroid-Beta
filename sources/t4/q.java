...
public final class q extends k0 {
    ...
    public final n0 m(n0 n0Var) {
        ...
        if (gVar2 != null && (gVar = (o3.g) this.H.get(gVar2.f16262c)) != null) {
            gVar2 = gVar;
        }
        ...
        if (cVar != null) {
            ...
            while (true) {
                if (i10 < length) {
                    ...
                    if ((bVar instanceof j4.m) && "com.apple.streaming.transportStreamTimestamp".equals(((j4.m) bVar).f8930b)) {
                        break;
                    }
                    i10++;
                } else {
            ...
            if (gVar2 == n0Var.F || cVar != n0Var.f8741s) {
                m0 a2 = n0Var.a();
                a2.f8687r = gVar2;
                a2.f8678i = cVar;
                n0Var = new n0(a2);
