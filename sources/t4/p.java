...
public final class p implements r3.v {
    public static final n0 f44595f;
    public static final n0 f44596g;
    public final r3.v f44597a;
    public final n0 f44598b;
    public n0 f44599c;
    public byte[] d;
    public int e;
    ...
    static {
        ...
        f44595f = new n0(m0Var);
        m0 m0Var2 = new m0();
        m0Var2.f8666o = "application/x-emsg";
        f44596g = new n0(m0Var2);
    }
    ...
    public final void b(n0 n0Var) {
        this.f44599c = n0Var;
        this.f44597a.b(this.f44598b);
    }

    @Override
    public final void c(long j10, int i10, int i11, int i12, r3.u uVar) {
        this.f44599c.getClass();
        int i13 = this.e - i12;
        w wVar = new w(Arrays.copyOfRange(this.d, i13 - i11, i13));
        byte[] bArr = this.d;
        System.arraycopy(bArr, i13, bArr, 0, i12);
        this.e = i12;
        String str = this.f44599c.C;
        n0 n0Var = this.f44598b;
        String str2 = n0Var.C;
        String str3 = n0Var.C;
        if (!d0.a(str, str2)) {
            if ("application/x-emsg".equals(this.f44599c.C)) {
                g4.a c3 = f4.b.c(wVar);
                n0 b10 = c3.b();
                ...
                h5.a.K("HlsSampleStreamWrapper", "Ignoring sample for unsupported format: " + this.f44599c.C);
                return;
            }
        }
        int a2 = wVar.a();
        r3.v vVar = this.f44597a;
        vVar.d(a2, wVar);
