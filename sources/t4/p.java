...
public final class p implements r3.v {
    public static final n0 f44533f;
    public static final n0 f44534g;
    public final r3.v f44535a;
    public final n0 f44536b;
    public n0 f44537c;
    public byte[] d;
    public int e;
    ...
    static {
        ...
        f44533f = new n0(m0Var);
        m0 m0Var2 = new m0();
        m0Var2.f8684o = "application/x-emsg";
        f44534g = new n0(m0Var2);
    }
    ...
    public final void b(n0 n0Var) {
        this.f44537c = n0Var;
        this.f44535a.b(this.f44536b);
    }

    @Override
    public final void c(long j10, int i10, int i11, int i12, r3.u uVar) {
        this.f44537c.getClass();
        int i13 = this.e - i12;
        w wVar = new w(Arrays.copyOfRange(this.d, i13 - i11, i13));
        byte[] bArr = this.d;
        System.arraycopy(bArr, i13, bArr, 0, i12);
        this.e = i12;
        String str = this.f44537c.C;
        n0 n0Var = this.f44536b;
        String str2 = n0Var.C;
        String str3 = n0Var.C;
        if (!d0.a(str, str2)) {
            if ("application/x-emsg".equals(this.f44537c.C)) {
                g4.a c3 = f4.b.c(wVar);
                n0 b10 = c3.b();
                ...
                h5.a.K("HlsSampleStreamWrapper", "Ignoring sample for unsupported format: " + this.f44537c.C);
                return;
            }
        }
        int a2 = wVar.a();
        r3.v vVar = this.f44535a;
        vVar.d(a2, wVar);
