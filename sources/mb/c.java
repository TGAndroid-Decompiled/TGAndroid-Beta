...
public enum c {
    ...
    public static final HashMap f17922c = new HashMap();
    ...
    static {
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f17924a) {
                    f17922c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f17925b) {
                    d.put(str, cVar);
                }
            }
        }
