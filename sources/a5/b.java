...
public abstract class b {
    ...
    public static void a(WebView webView, String str, Set set, v vVar) {
        if (m.f3426c.b()) {
            c(webView).f3428a.addWebMessageListener(str, (String[]) set.toArray(new String[0]), new se.a(new a6.m(vVar, 7)));
            return;
        }
    ...
    public static o c(WebView webView) {
        if (m.e.b() && f279a) {
            ...
            if (oVar == null) {
                o oVar2 = new o(n.f3427a.createWebView(webView));
                weakHashMap.put(webView, oVar2);
                return oVar2;
            }
            return oVar;
        }
        return new o(n.f3427a.createWebView(webView));
    }
}
