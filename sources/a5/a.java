...
public class a implements i, r {
    ...
    public byte[] B() {
        ...
        switch (this.f274a) {
            case 22:
                ...
                fVar.f15257a = new e8(d8Var);
                try {
                    d9.b();
                    k6 k6Var = new k6(fVar);
                    e3 e3Var = new e3(28);
                    d9Var.a(e3Var);
                    HashMap hashMap = new HashMap((HashMap) e3Var.f14165b);
                    HashMap hashMap2 = new HashMap((HashMap) e3Var.f14166c);
            ...
            default:
                zf zfVar = zf.f48737c;
                q3 q3Var = (q3) this.f276c;
                ((d8) this.d).h = false;
                d8 d8Var2 = (d8) this.d;
                d8Var2.f43948f = Boolean.FALSE;
                q3Var.f14288a = new we(d8Var2);
                try {
                    zf.b();
                    ib ibVar = new ib(q3Var);
                    r2 r2Var = new r2(11);
                    zfVar.a(r2Var);
                    HashMap hashMap3 = new HashMap((HashMap) r2Var.f44079b);
                    HashMap hashMap4 = new HashMap((HashMap) r2Var.f44080c);
                    x xVar = (x) r2Var.d;
            ...
            case 24:
                ...
                ((d8) this.d).h = false;
                d8 d8Var3 = (d8) this.d;
                d8Var3.f43948f = Boolean.FALSE;
                nVar.f7331a = new i9(d8Var3);
                try {
                    ia.b();
                    p7 p7Var = new p7(nVar);
                    r2 r2Var2 = new r2(5);
                    iaVar.a(r2Var2);
                    HashMap hashMap5 = new HashMap((HashMap) r2Var2.f44079b);
                    HashMap hashMap6 = new HashMap((HashMap) r2Var2.f44080c);
                    d0 d0Var = (d0) r2Var2.d;
    ...
    public void a(int i10, int i11) {
        ...
        this.f275b = i12;
        for (int i13 = 0; i13 < e.f46794y; i13++) {
    ...
    public h b(p pVar, long j3) {
        ...
        switch (this.f274a) {
            case 8:
                ...
                long l4 = l(pVar);
                long i10 = pVar.i();
                pVar.k(Math.max(6, ((u) this.f276c).f3799c));
                long l10 = l(pVar);
                long i11 = pVar.i();
                if (l4 <= j3 && l10 > j3) {
            ...
            default:
                ...
                while (true) {
                    if (vVar.a() >= 188) {
                        ...
                        int i14 = i13 + 188;
                        if (i14 <= i12) {
                            long a2 = t8.a(vVar, i13, this.f275b);
                            if (a2 != j10) {
    ...
    public void j(e2.h hVar) {
        ...
        while (it.hasNext()) {
            ...
            e2.d0.U(j0Var.f43397a, new p2.b(24, hVar, j0Var.f43398b));
        }
    }
    ...
    public long l(p pVar) {
        ...
        while (pVar.i() < pVar.getLength() - 6) {
            ...
            if ((((bArr[0] & 255) << 8) | (bArr[1] & 255)) != i10) {
                ...
                System.arraycopy(bArr, 0, vVar.f7929a, 0, 2);
    ...
    public void onSuccess(Object obj) {
        List list = (List) obj;
        a0 a0Var = ((l0) this.d).f14596g;
        Handler handler = a0Var.f14458l;
        m4.r rVar = (m4.r) this.f276c;
        e2.d0.U(handler, new x1(a0Var, rVar, new c9(this, this.f275b, list, rVar, 6)));
    }
    ...
    public a u(Object obj, Object obj2) {
        ...
        if (i10 > objArr.length) {
            this.f276c = Arrays.copyOf(objArr, w.h(objArr.length, i10));
        }
        if (obj != null) {
            if (obj2 != null) {
    ...
    public void w(int i10, long j3, Interpolator interpolator) {
        ...
        ((ValueAnimator) this.f276c).addListener(new gi(this, i10, iArr, 1));
