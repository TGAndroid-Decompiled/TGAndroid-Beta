...
public class a implements i, r {
    ...
    public byte[] B() {
        ...
        switch (this.f276a) {
            case 22:
                ...
                ((d8) this.d).h = false;
                d8 d8Var = (d8) this.d;
                d8Var.f43971f = Boolean.FALSE;
                fVar.f15267a = new e8(d8Var);
                try {
                    d9.b();
                    k6 k6Var = new k6(fVar);
                    lf.i iVar = new lf.i(29);
                    d9Var.a(iVar);
                    HashMap hashMap = new HashMap((HashMap) iVar.f14033b);
                    HashMap hashMap2 = new HashMap((HashMap) iVar.f14034c);
            ...
            default:
                ...
                ((d8) this.d).h = false;
                d8 d8Var2 = (d8) this.d;
                d8Var2.f43971f = Boolean.FALSE;
                p3Var.f14292a = new we(d8Var2);
                try {
                    zf.b();
                    ib ibVar = new ib(p3Var);
                    r1 r1Var = new r1(12);
                    zfVar.a(r1Var);
                    HashMap hashMap3 = new HashMap((HashMap) r1Var.f44101b);
                    HashMap hashMap4 = new HashMap((HashMap) r1Var.d);
                    x xVar = (x) r1Var.f44102c;
            ...
            case 24:
                ...
                ((d8) this.d).h = false;
                d8 d8Var3 = (d8) this.d;
                d8Var3.f43971f = Boolean.FALSE;
                nVar.f7336a = new i9(d8Var3);
                try {
                    ia.b();
                    p7 p7Var = new p7(nVar);
                    r1 r1Var2 = new r1(6);
                    iaVar.a(r1Var2);
                    HashMap hashMap5 = new HashMap((HashMap) r1Var2.f44101b);
                    HashMap hashMap6 = new HashMap((HashMap) r1Var2.d);
                    d0 d0Var = (d0) r1Var2.f44102c;
    ...
    public void a(int i10, int i11) {
        ...
        this.f277b = i12;
        for (int i13 = 0; i13 < e.f46817y; i13++) {
    ...
    public h b(p pVar, long j3) {
        ...
        switch (this.f276a) {
            case 8:
                ...
                long l4 = l(pVar);
                long i10 = pVar.i();
                pVar.k(Math.max(6, ((u) this.f278c).f3804c));
                long l10 = l(pVar);
                long i11 = pVar.i();
                if (l4 <= j3 && l10 > j3) {
    ...
    public void j(e2.h hVar) {
        ...
        while (it.hasNext()) {
            ...
            e2.d0.U(j0Var.f43420a, new p2.b(24, hVar, j0Var.f43421b));
        }
    }
