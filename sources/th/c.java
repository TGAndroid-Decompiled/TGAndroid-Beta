...
public final class c implements kl0 {
    public final e6 f43506a;
    public final Context f43507b;
    public final f f43508c;
    ...
    public final void d(int i10, View view) {
        ...
        f fVar = this.f43508c;
        f20 f20Var = fVar.f43521h0;
        HashMap hashMap = fVar.f43523j0;
        if (i10 == 0 || (tL_help_country = (TLRPC.TL_help_country) fVar.f43517d0.G(i10 - 1).G) == null) {
            return;
        }
        boolean z10 = false;
        if (hashMap.containsKey(tL_help_country.iso2)) {
            ...
            int i11 = fVar.m0;
            if (size >= i11) {
                new xc(fVar.f43526n0, this.f43506a).Q(R.raw.info, 36, AndroidUtilities.replaceTags(LocaleController.formatString(R.string.PollV2YouCanAddXCountriesOnly, Integer.valueOf(i11)))).j();
                return;
            }
            m30 m30Var = new m30(this.f43507b, tL_help_country);
