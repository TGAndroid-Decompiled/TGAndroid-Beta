...
public final class c2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, c2 c2Var) {
        if (richText != null) {
            c2Var.f48381a = v5.l(richText).length() + c2Var.f48381a;
        ...
        if (pageBlock != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                    ...
                    c2Var.f48382b = pageblockblockquoteblocks.blocks.size() + c2Var.f48382b;
                    ...
                    c2Var.f48382b = pageblockdetails.blocks.size() + c2Var.f48382b;
                    ...
                    c2Var.f48382b = pageblocklist.items.size() + c2Var.f48382b;
                    ...
                    c2Var.f48382b = pageblockorderedlist.items.size() + c2Var.f48382b;
                    ...
                    if (arrayList3 != null) {
                        c2Var.f48382b = arrayList3.size() + c2Var.f48382b;
                    ...
                    if (str != null) {
                        c2Var.f48381a = str.length() + c2Var.f48381a;
                    }
                } else {
