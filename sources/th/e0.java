...
public final class e0 extends y implements org.telegram.ui.ActionBar.x5 {
    public c0 A;
    public final int f48413n;
    public final c6 f48414r;
    public final HorizontalScrollView f48415s;
    public final LinearLayout v;
    public final t1 f48416w;
    public final TextView f48417x;
    public final ArrayList f48418y;

    public e0(Context context, int i10, c6 c6Var) {
        super(context);
        this.f48418y = new ArrayList();
        this.f48413n = i10;
        this.f48414r = c6Var;
        g(AndroidUtilities.dp(16.0f), AndroidUtilities.dp(4.0f), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(4.0f));
        HorizontalScrollView horizontalScrollView = new HorizontalScrollView(context);
        this.f48415s = horizontalScrollView;
        ...
        t1Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        e0 e0Var = this.f48346b;
                        c0 c0Var = e0Var.A;
                        if (c0Var != null && (aVar = e0Var.f48892a) != null) {
                            p3 p3Var = ((h3) c0Var).f48481a;
                            p3Var.o3(false);
                            p3Var.f48638d3.Q0(new m3(p3Var, aVar, -1), view);
                            return;
                        }
                        return;
                    default:
                        e0 e0Var2 = this.f48346b;
                        c0 c0Var2 = e0Var2.A;
                        if (c0Var2 != null && (aVar2 = e0Var2.f48892a) != null) {
                            p3 p3Var2 = ((h3) c0Var2).f48481a;
                            p3Var2.o3(false);
                            p3Var2.f48638d3.Q0(new m3(p3Var2, aVar2, -1), view);
                            return;
                        }
                        return;
                }
    ...
    public static boolean h(View view, float f9, float f10) {
        ...
        int i10 = iArr[0];
        if (f9 >= i10 && f9 <= view.getWidth() + i10) {
            int i11 = iArr[1];
    ...
    public final void i() {
        throw new UnsupportedOperationException("Method not decompiled: th.e0.i():void");
    }

    public final void j() {
        int i10 = g6.Oh;
        c6 c6Var = this.f48414r;
        int v02 = g6.v0(i10, c6Var);
        int v = g6.v(g6.v0(g6.f23062d6, c6Var), g6.l1(0.1f, v02));
        TextView textView = this.f48417x;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ArrayList arrayList = this.f48418y;
        ...
        HorizontalScrollView horizontalScrollView = this.f48415s;
        ...
        if (size2 > 0) {
            ...
            if (size3 != 0) {
                ...
                for (int i19 = 0; i19 < size3; i19++) {
                    ...
                    b0Var.getClass();
                    int max3 = Math.max(AndroidUtilities.dp(34.0f), b0Var.f48357a.getPreferredWidth());
                    iArr[i19] = max3;
                    i18 += max3;
                }
                if (i18 <= max2) {
                    ...
                    for (int i29 = 0; i29 < size3; i29++) {
                        ...
                        b0Var2.getClass();
                        i28 += i30 - Math.max(AndroidUtilities.dp(34.0f), b0Var2.f48357a.getMinWidth());
                    }
                    if (i28 <= 0) {
                        for (int i31 = 0; i31 < size3; i31++) {
                            b0 b0Var3 = (b0) arrayList.get(i31);
                            b0Var3.getClass();
                            iArr[i31] = Math.max(AndroidUtilities.dp(34.0f), b0Var3.f48357a.getMinWidth());
                        }
                    } else {
                        ...
                        while (i32 < size3) {
                            ...
                            b0Var4.getClass();
                            int max4 = i34 - Math.max(AndroidUtilities.dp(34.0f), b0Var4.f48357a.getMinWidth());
                            if (i32 == i17) {
                                i14 = min - i33;
                                i13 = min;
                            } else {
                ...
                for (int i35 = 0; i35 < size3; i35++) {
                    ...
                    int i36 = iArr[i35];
                    RichMessageLayout.RichButton richButton = b0Var5.f48357a;
        ...
        if (size2 > 0) {
            dp = ((b0) arrayList.get(0)).f48357a.getHeight();
