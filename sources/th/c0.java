...
public final class c0 extends f0 {
    ...
    public c0(i0 i0Var, Context context) {
        ...
        this.f48152c.addView(i0Var.D, c6.g());
        this.f48152c.addView(this.d, 0, c6.c(-1.0f, -1));
        this.f48152c.addView(i0Var.F, c6.g());
        ...
        this.f48150a.setTitle(LocaleController.getString(R.string.CommunityAddAChatToCommunity));
        this.f48150a.getTitleTextView().setTranslationX(-AndroidUtilities.dp(18.0f));
        this.f48150a.setActionBarMenuOnItemClick(new e(this, 3));
        this.f48152c.addView(this.f48150a, c6.e(-1, 56, 48));
        this.f48152c.addView(i0Var.B, c6.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        i0Var.f48173r = dVar;
        dVar.e();
        i0Var.f48173r.setText(LocaleController.getString(R.string.OK));
        i0Var.f48173r.setOnClickListener(new org.telegram.ui.Components.voip.o(this, 17));
        if (z4) {
            i0Var.f48173r.setVisibility(8);
        }
        this.f48152c.addView(i0Var.f48173r, c6.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }

    @Override
    public final float b() {
        return lf.l0.b(this.h.f48169c.f50541e) * super.b();
    }
