...
public final class b extends FrameLayout implements a6 {
    public final f6 f45000a;
    public final p9 f45001b;
    public final TextView f45002c;
    ...
    public final void a(int i10, TLRPC.Chat chat) {
        ...
        this.f45001b.e(chat, new z8(chat));
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Drawable drawable = j6.S0;
        p9 p9Var = this.f45001b;
    ...
    public final void e() {
        int i10 = j6.f20273z6;
        f6 f6Var = this.f45000a;
        this.e.setColorFilter(j6.v0(i10, f6Var));
        this.f45002c.setTextColor(j6.v0(j6.G6, f6Var));
    ...
    public void setTitle(CharSequence charSequence) {
        this.f45002c.setText(charSequence);
    }
}
