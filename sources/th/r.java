    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            ...
            default:
                ...
                if (ChatObject.canBlockUsers(i0Var.f48171f)) {
                    arrayList.add(h51.A(1, AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.CommunityPendingRequestsInfo), new t(i0Var, 2)), true)));
                } else {
                ...
                arrayList.add(h51.s(3, LocaleController.formatPluralString("CommunityPendingRequestsSuggestedHeader", n0Var.f48208l, new Object[0])));
                n0Var.c(arrayList);
                return;
        }
    }
