...
public final class l extends o6.a {
    ...
    public final IBinder f42377b;
    public final IBinder f42378c;
    public final PendingIntent d;
    public final String e;
    public final String f42379f;

    public l(int i10, IBinder iBinder, IBinder iBinder2, PendingIntent pendingIntent, String str, String str2) {
        this.f42376a = i10;
        this.f42377b = iBinder;
        this.f42378c = iBinder2;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        f0.f(parcel, 2, this.f42377b);
        f0.f(parcel, 3, this.f42378c);
        f0.k(parcel, 4, this.d, i10);
        f0.l(parcel, 5, this.e);
        f0.l(parcel, 6, this.f42379f);
        f0.r(parcel, q6);
    }
}
