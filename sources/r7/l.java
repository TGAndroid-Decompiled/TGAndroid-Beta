...
public final class l extends o6.a {
    ...
    public final IBinder f42349b;
    public final IBinder f42350c;
    ...
    public l(int i10, IBinder iBinder, IBinder iBinder2, PendingIntent pendingIntent, String str, String str2) {
        this.f42348a = i10;
        this.f42349b = iBinder;
        this.f42350c = iBinder2;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        f0.s(parcel, 1, 4);
        parcel.writeInt(this.f42348a);
        f0.f(parcel, 2, this.f42349b);
        f0.f(parcel, 3, this.f42350c);
        f0.k(parcel, 4, this.d, i10);
        f0.l(parcel, 5, this.e);
        f0.l(parcel, 6, this.f42351f);
        f0.r(parcel, q6);
    }
}
