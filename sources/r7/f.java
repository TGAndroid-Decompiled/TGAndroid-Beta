...
public final class f extends b8.b {
    ...
    public final TaskCompletionSource f42321c;
    ...
    public f(int i10, TaskCompletionSource taskCompletionSource) {
        ...
        switch (i10) {
            case 1:
                this.f42321c = taskCompletionSource;
    ...
    public final boolean K0(Parcel parcel, int i10) {
        switch (this.f42320b) {
            case 0:
                if (i10 == 1) {
                    d.b(parcel);
                    g5.a((Status) d.a(parcel, Status.CREATOR), (Location) d.a(parcel, Location.CREATOR), this.f42321c);
                    return true;
                }
                return false;
            default:
                if (i10 == 1) {
                    ...
                    d.b(parcel);
                    Status status = gVar.f9515a;
                    ?? obj = new Object();
                    obj.f3000a = gVar;
                    g5.a(status, obj, this.f42321c);
                    return true;
                }
                return false;
        }
