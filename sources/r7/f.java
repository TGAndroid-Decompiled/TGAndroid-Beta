...
public final class f extends b8.b {
    ...
    public final TaskCompletionSource f44966c;
    ...
    public final boolean K0(Parcel parcel, int i10) {
        switch (this.f44965b) {
            case 0:
                if (i10 == 1) {
                    d.b(parcel);
                    f5.a((Status) d.a(parcel, Status.CREATOR), (Location) d.a(parcel, Location.CREATOR), this.f44966c);
                    return true;
                }
                return false;
            default:
