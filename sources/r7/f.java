...
public final class f extends b8.b {
    ...
    public final TaskCompletionSource f42337c;
    ...
    public f(int i10, TaskCompletionSource taskCompletionSource) {
        ...
        switch (i10) {
            case 1:
                this.f42337c = taskCompletionSource;
    ...
    public final boolean K0(Parcel parcel, int i10) {
        switch (this.f42336b) {
            case 0:
                if (i10 == 1) {
                    d.b(parcel);
                    h5.a((Status) d.a(parcel, Status.CREATOR), (Location) d.a(parcel, Location.CREATOR), this.f42337c);
                    return true;
                }
                return false;
            default:
