...
public final class f extends b8.b {
    ...
    public final TaskCompletionSource f44938c;
    ...
    public f(int i10, TaskCompletionSource taskCompletionSource) {
        ...
        switch (i10) {
            case 1:
                this.f44938c = taskCompletionSource;
    ...
    public final boolean K0(Parcel parcel, int i10) {
        switch (this.f44937b) {
            case 0:
                if (i10 == 1) {
                    d.b(parcel);
                    f5.a((Status) d.a(parcel, Status.CREATOR), (Location) d.a(parcel, Location.CREATOR), this.f44938c);
                    return true;
                }
                return false;
            default:
