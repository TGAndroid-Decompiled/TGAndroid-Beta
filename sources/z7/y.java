...
public final class y implements ia.e {
    public static final Charset f48969f = Charset.forName("UTF-8");
    public static final ia.c f48970g = new ia.c("key", hg.c.m(v7.j.m(w.class, new s(1))));
    public static final ia.c h = new ia.c("value", hg.c.m(v7.j.m(w.class, new s(2))));
    public static final x f48971i = x.f48953b;
    public OutputStream f48972a;
    public final HashMap f48973b;
    public final HashMap f48974c;
    public final ia.d d;
    ...
    public y(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f48972a = byteArrayOutputStream;
        this.f48973b = hashMap;
        this.f48974c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((i(cVar) << 3) | 1);
        this.f48972a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f48969f);
                    k(bytes.length);
                    this.f48972a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f48972a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                ia.d dVar = (ia.d) this.f48973b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f48974c.get(obj.getClass());
                if (fVar != null) {
                    la.i iVar = this.e;
                    iVar.f14169b = false;
                    iVar.d = cVar;
    ...
    public final void j(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f14155b = 0L;
        try {
            OutputStream outputStream = this.f48972a;
            this.f48972a = bVar;
            dVar.a(obj, this);
    ...
    public final void k(int i10) {
        while (true) {
            int i11 = i10 & 127;
            if ((i10 & (-128)) != 0) {
                this.f48972a.write(i11 | 128);
                i10 >>>= 7;
            } else {
                this.f48972a.write(i11);
                return;
            }
        }
    }
    ...
    public final void l(long j3) {
        while (true) {
            int i10 = ((int) j3) & 127;
            if (((-128) & j3) != 0) {
                this.f48972a.write(i10 | 128);
                j3 >>>= 7;
            } else {
                this.f48972a.write(i10);
                return;
            }
        }
    }
