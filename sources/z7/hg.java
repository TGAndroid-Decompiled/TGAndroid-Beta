...
public final class hg extends o6.a {
    ...
    public final float[] f48750a;
    public final Bitmap f48751b;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        float[] fArr = this.f48750a;
        if (fArr != null) {
            int q10 = w7.f0.q(parcel, 1);
            parcel.writeFloatArray(fArr);
            w7.f0.r(parcel, q10);
        }
        w7.f0.k(parcel, 2, this.f48751b, i10);
        w7.f0.s(parcel, 3, 4);
        parcel.writeInt(this.f48752c);
        w7.f0.s(parcel, 4, 4);
        parcel.writeInt(this.d);
        w7.f0.s(parcel, 5, 4);
        parcel.writeInt(this.e);
        w7.f0.s(parcel, 6, 4);
        parcel.writeInt(this.f48753f);
        w7.f0.s(parcel, 7, 4);
