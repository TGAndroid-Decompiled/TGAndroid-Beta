...
public final class hg extends o6.a {
    ...
    public final float[] f48480a;
    public final Bitmap f48481b;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        float[] fArr = this.f48480a;
        if (fArr != null) {
            int q10 = w7.e0.q(parcel, 1);
            parcel.writeFloatArray(fArr);
            w7.e0.r(parcel, q10);
        }
        w7.e0.k(parcel, 2, this.f48481b, i10);
        w7.e0.s(parcel, 3, 4);
        parcel.writeInt(this.f48482c);
        w7.e0.s(parcel, 4, 4);
        parcel.writeInt(this.d);
        w7.e0.s(parcel, 5, 4);
        parcel.writeInt(this.e);
        w7.e0.s(parcel, 6, 4);
        parcel.writeInt(this.f48483f);
        w7.e0.s(parcel, 7, 4);
