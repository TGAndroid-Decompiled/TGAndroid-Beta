...
public final class ig extends o6.a {
    ...
    public final float[] f48529b;
    public final Bitmap f48530c;
    public final List d;

    public ig(ArrayList arrayList, float[] fArr, Bitmap bitmap, ArrayList arrayList2) {
        this.f48528a = arrayList;
        this.f48529b = fArr;
        this.f48530c = bitmap;
        this.d = arrayList2;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        w7.e0.p(parcel, 1, this.f48528a);
        float[] fArr = this.f48529b;
        if (fArr != null) {
            int q10 = w7.e0.q(parcel, 2);
            parcel.writeFloatArray(fArr);
            w7.e0.r(parcel, q10);
        }
        w7.e0.k(parcel, 3, this.f48530c, i10);
        List list = this.d;
        if (list != null) {
