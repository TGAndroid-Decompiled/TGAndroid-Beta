...
public final class e {
    ...
    public static e a(q5 q5Var, boolean z10, boolean z11) {
        ...
        obj.h = i10;
        obj.f500i = z11;
        obj.f497e = System.currentTimeMillis();
        if (z11 && LiteMode.isEnabled(4112)) {
            ImageReceiver imageReceiver = new ImageReceiver();
            obj.f501j = imageReceiver;
            if (z10) {
    ...
    public final boolean c() {
        if (System.currentTimeMillis() - this.f497e > 2500) {
            return true;
        }
        return false;
    }
    ...
    public final void d(View view) {
        this.f494a.o(view);
        ImageReceiver imageReceiver = this.f501j;
    ...
    public final void f(View view) {
        ...
        boolean z12 = this.f498f;
        int i10 = this.h;
        q5 q5Var = this.f494a;
        q5Var.a(view);
        this.d = view;
        ImageReceiver imageReceiver = this.f501j;
        if (imageReceiver != null && this.f500i) {
            imageReceiver.onAttachedToWindow();
            TLRPC.Document document2 = q5Var.f29579e;
            ...
            if (!z11) {
                ...
                if (tL_messages_stickerSet != null) {
                    if (this.f502k < 0) {
                        this.f502k = Math.abs(Utilities.fastRandom.nextInt() % tL_messages_stickerSet.documents.size());
                    }
                    if (z12) {
                        ...
                        int f10 = gz.f();
                        imageReceiver.setImage(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(this.f502k)), f10 + "_" + f10 + "_pcache_compress", null, null, tL_messages_stickerSet.documents.get(this.f502k), 0);
                    } else {
                        imageReceiver.setImage(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(this.f502k)), "60_60", null, null, tL_messages_stickerSet.documents.get(this.f502k), 0);
                    }
                    z11 = true;
                }
            }
