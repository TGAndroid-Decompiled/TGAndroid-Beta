...
public final class i {
    ...
    public final int d;
    public boolean e;
    public final RenderNode[] f454f;
    public long f455g;
    public final RectF h = new RectF();
    public final a f456i = new Object();
    public final ArrayList f457j = new ArrayList();
    public int f458k;
    public int f459l;
    public Rect f460m;
    ...
    public i(boolean z10) {
        ...
        this.d = i10;
        this.f452b = z10;
        this.f454f = new RenderNode[isEnabled ? 2 : 1];
        int i11 = 0;
        while (true) {
            RenderNode[] renderNodeArr = this.f454f;
    ...
    public final void b(Canvas canvas, int i10) {
        if (canvas.isHardwareAccelerated()) {
            ...
            if (!z10 && this.f453c) {
                canvas.drawRenderNode(this.f454f[0]);
                return;
            } else if (i10 == -2) {
                canvas.drawRenderNode(this.f454f[!z10 ? 1 : 0]);
                return;
            } else if (i10 == -4) {
                canvas.drawRenderNode(this.f454f[0]);
                return;
            } else if (i10 == -3) {
                canvas.drawRenderNode(this.f454f[1]);
                return;
            } else {
                return;
            }
    ...
    public final RenderNode d(int i10, int i11) {
        g gVar;
        h hVar = (h) this.f457j.get(i11);
        if (this.f451a && (gVar = hVar.f450c) != null) {
            if (i10 == 0) {
                return gVar.f443c[0];
            }
            return hVar.f449b.f443c[0];
        }
        RenderNode[] renderNodeArr = hVar.f449b.f443c;
    ...
    public final boolean e(bh.a aVar, int i10, int i11) {
        ...
        while (true) {
            ...
            if (i12 < i14) {
                ...
                aVar2.f414a = false;
                aVar.b(aVar2, rectF);
                boolean z10 = aVar2.f414a;
                if (z10) {
                    j3 = -1;
                } else {
                    j3 = aVar2.f415b;
                }
                if (z10 || hVar.e != j3 || !hVar.f448a.hasDisplayList()) {
                    hVar.e = j3;
                    if (this.f460m == null) {
                        ...
                        hVar2.f448a.setPosition(0, 0, i16, height);
                        RecordingCanvas beginRecording = hVar2.f448a.beginRecording(i16, height);
                        float f7 = 1.0f / i15;
                        ...
                        if (this.f460m != null) {
                            h hVar3 = (h) arrayList.get(this.f459l);
                            hVar3.f448a.endRecording();
                            g gVar = hVar3.f449b;
                            g gVar2 = hVar3.f450c;
                            if (gVar2 != null) {
                                gVar2.a(hVar3.f448a);
                                gVar.a(gVar2.f443c[0]);
                            } else {
                                gVar.a(hVar3.f448a);
                            }
                            this.f460m = null;
                ...
                if (i13 > 0) {
                    ...
                    while (true) {
                        ...
                        for (int i18 = 0; i18 < this.f458k; i18++) {
                    ...
                    if (calcHash != this.f455g || z11) {
                        this.f455g = calcHash;
                        int i19 = 0;
                        while (true) {
                            RenderNode[] renderNodeArr2 = this.f454f;
                            ...
                            for (int i20 = 0; i20 < this.f458k; i20++) {
    ...
    public final void f(float f7, float f10) {
        for (int i10 = 0; i10 < this.f458k; i10++) {
            h hVar = (h) this.f457j.get(i10);
            hVar.f449b.b(f7, f10);
            g gVar = hVar.f450c;
            if (gVar != null) {
                gVar.b(f7, f10);
    ...
    public final void g(int i10, List list) {
        ...
        while (true) {
            int i11 = this.f458k;
            arrayList = this.f457j;
            if (i11 <= arrayList.size()) {
                break;
            }
            arrayList.add(new h(this));
        }
        for (int i12 = 0; i12 < this.f458k; i12++) {
    ...
    public final void h(mi.a aVar) {
        ...
        for (int i11 = 0; i11 < this.f458k; i11++) {
