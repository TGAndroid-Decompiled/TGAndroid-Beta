        ...
        switch (this.f671a) {
            ...
            case 7:
                ...
                if (i10 == -1) {
                    ...
                    k0Var.S = null;
                    k0Var.G.Y2.N(true);
                    k0Var.E.f24523r.getText().clear();
                    k0Var.E.f24523r.requestFocus();
                    AndroidUtilities.showKeyboard(k0Var.E.f24523r);
                    return;
                } else {
                    return;
                }
            case 8:
                ...
                if (i10 == 2) {
                    ...
                    k0Var2.f10718y.f24523r.getText().clear();
                    k0Var2.f10718y.f24523r.requestFocus();
                    AndroidUtilities.showKeyboard(k0Var2.f10718y.f24523r);
                    return;
                } else {
                    return;
                }
            ...
            case 27:
                ...
                if (i10 == -1) {
                    ...
                    return;
                } else if (i10 == 1 && z9Var.f43341a.getText().length() != 0) {
                    z9.U(z9Var);
                    z9Var.finishFragment();
                    return;
                } else {
