...
public final class e1 {
    ...
    public final c1 f519b;
    public final c1 f520c;
    public final c1 d;
    public final FrameLayout f521e;
    public final e1 f522f;
    public float f523g;
    public float h;
    public final b1 f524i;
    public WindowManager f526k;
    public boolean f527l;
    public float f528m;
    public final int f529n;
    public final long f530o;
    public final j1 f531p;
    public float f532q;
    public float f533r;
    public boolean f534s;
    public final dk0 f535t;
    public boolean f536u;
    public final View v;
    public boolean f537w;
    public long f539y;
    public boolean f540z;
    public final int[] f525j = new int[2];
    public final ArrayList f538x = new ArrayList();
    ...
    public static void f() {
        ...
        if (e1Var != null) {
            ...
            if (B.f518a == 0 && System.currentTimeMillis() - E > 200) {
        ...
        if (e1Var2 != null) {
            ...
            if (view instanceof t1) {
                ((t1) view).N.b(e1Var2.f531p);
            } else if (view instanceof org.telegram.ui.Cells.w0) {
                ((org.telegram.ui.Cells.w0) view).C0.b(e1Var2.f531p);
            }
        }
    }
    ...
    public static void g() {
        e1 e1Var = C;
        if (e1Var != null && !e1Var.f534s) {
            e1Var.f534s = true;
            e1Var.f539y = System.currentTimeMillis();
            if (C.f518a == 1 && System.currentTimeMillis() - E > 200) {
                E = System.currentTimeMillis();
                View view = C.v;
                if (view != null) {
    ...
    public final void c() {
        try {
            boolean z10 = this.f537w;
            b1 b1Var = this.f524i;
            if (z10) {
                this.f526k.removeView(b1Var);
            } else {
