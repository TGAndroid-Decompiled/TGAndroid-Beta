...
public final class z extends j71 {
    public boolean f737d2;
    public final b0 f738e2;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f737d2) {
            this.f737d2 = false;
            this.f738e2.f456b.s(null);
        }
    }

    @Override
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        b0 b0Var = this.f738e2;
        int i10 = b0Var.J;
        ...
        if (linkedHashMap.containsKey(l4)) {
            ...
            try {
                ...
                z5 e7 = m1.e(document, l4, b0Var.f460n.getFontMetricsInt());
                e7.cacheType = q5.g();
                e7.setAdded();
                ...
                b0Var.f460n.getText().insert(editTextSelectionEnd, spannableString);
                b0Var.f460n.setSelection(editTextSelectionEnd + spannableString.length());
                b0Var.f456b.x(l4, true);
                b0Var.Y(true);
                b0Var.W(e7);
            } catch (Exception e10) {
