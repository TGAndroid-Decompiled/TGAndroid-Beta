...
public final class k1 {
    ...
    public int f636u;
    public final org.telegram.ui.Cells.a0 f640z;
    ...
    public static final f1 f615a0 = new Object();
    public static int f616b0 = 1;
    public static final a4.e f617c0 = new a4.e(1);
    public final ArrayList v = new ArrayList();
    public final ArrayList f637w = new ArrayList();
    public final HashMap f638x = new HashMap();
    public final HashMap f639y = new HashMap();
    public final HashMap H = new HashMap();
    public final ArrayList N = new ArrayList();
    public final RectF O = new RectF();
    public final Rect P = new Rect();
    public final int f629n = UserConfig.selectedAccount;

    public k1(org.telegram.ui.Cells.a0 a0Var) {
        this.f640z = a0Var;
        o(this.B);
        this.f635t = ViewConfiguration.get(ApplicationLoader.applicationContext).getScaledTouchSlop();
    }
    ...
    public static void o(f6 f6Var) {
        V.setColor(j6.v0(j6.f20788ie, f6Var));
    ...
    public final boolean a() {
        ...
        HashMap hashMap = this.f639y;
        hashMap.clear();
        int i11 = 0;
        while (true) {
            arrayList = this.f637w;
        ...
        while (true) {
            ...
            String str = h1Var.f583o;
            uq uqVar = h1Var.F;
            h1 h1Var2 = (h1) hashMap.get(str);
            if (h1Var2 != null && h1Var.f566b != h1Var2.f566b) {
                h1Var2 = null;
            }
            if (h1Var2 != null) {
                hashMap.remove(h1Var.f583o);
                int i13 = h1Var.f591x;
                int i14 = h1Var2.f591x;
                if (i13 == i14 && h1Var.f592y == h1Var2.f592y && h1Var.A == h1Var2.A && h1Var.f590w == h1Var2.f590w && h1Var.f584p == h1Var2.f584p && h1Var.T == null && h1Var2.T == null) {
                    h1Var.f568c = 0;
                    i12++;
                } else {
                    h1Var.d = i14;
                    h1Var.f571e = h1Var2.f592y;
                    h1Var.f573f = h1Var2.A;
                    h1Var.f577i = h1Var2.N;
                    h1Var.f575g = h1Var2.O;
                    h1Var.h = h1Var2.P;
                    h1Var.f568c = 3;
                    int i15 = h1Var.f590w;
                    int i16 = h1Var2.f590w;
                    if (i15 != i16 && uqVar != null) {
                        uqVar.c(i16, false);
                        uqVar.c(h1Var.f590w, true);
                    }
                    k9 k9Var2 = h1Var.T;
                    if (k9Var2 != null || h1Var2.T != null) {
                        ...
                        if (k9Var3 != null && (k9Var = h1Var2.T) != null) {
                            ValueAnimator valueAnimator = k9Var.f27787f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (k9Var3.f27802w) {
                                    k9Var3.f27802w = false;
                                    k9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = k9Var3.f27784b[i18].h;
                                k9Var3.l(i18, k9Var.f27784b[i18].h, i10);
                                i18++;
                            }
                            k9Var3.b(false, true);
        ...
        if (!hashMap.isEmpty()) {
            ...
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                ((h1) arrayList.get(i20)).f580l = ((h1) arrayList.get(i20)).f582n;
        ...
        if (this.f624i) {
            float f7 = this.f623g;
            if (f7 != this.f620c || this.h != this.d) {
                this.f625j = true;
                this.f621e = f7;
                this.f622f = this.h;
                z10 = true;
    ...
    public final void b(j1 j1Var) {
        ...
        if (j1Var.f610g == 0) {
            ...
            if (hashMap.get(j1Var) == null) {
                ...
                imageReceiver.setParentView(this.f640z);
                int i11 = Z;
                Z = i11 + 1;
                imageReceiver.setUniqKeyPrefix(Integer.toString(i11));
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(this.f629n).getReactionsMap().get(j1Var.f609f);
        ...
        if (!this.M || j1Var.f610g == 0) {
            return;
        }
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                if (j1Var.f(((h1) arrayList.get(i10)).f586r)) {
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        int i10 = 0;
        if (this.f634s || this.f619b || (messageObject = this.A) == null || (message = messageObject.messageOwner) == null || message.reactions == null) {
            return false;
        }
        float x10 = motionEvent.getX();
        float y3 = motionEvent.getY();
        org.telegram.ui.Cells.a0 a0Var = this.f640z;
        if (e2.u(a0Var)) {
            y3 -= a0Var.getPaddingTop();
            if (a0Var instanceof org.telegram.ui.Cells.w0) {
                x10 -= ((org.telegram.ui.Cells.w0) a0Var).f23453j0 / 2.0f;
            }
        }
        float f7 = x10 - this.f620c;
        float f10 = y3 - this.d;
        if (motionEvent.getAction() == 0) {
            ...
            while (true) {
                if (i10 >= size) {
                    break;
                } else if (f7 > ((h1) arrayList.get(i10)).f591x && f7 < ((h1) arrayList.get(i10)).f591x + ((h1) arrayList.get(i10)).A && f10 > ((h1) arrayList.get(i10)).f592y && f10 < ((h1) arrayList.get(i10)).f592y + ((h1) arrayList.get(i10)).B) {
            ...
            if (this.T && this.S != null && motionEvent.getAction() == 1) {
                TLRPC.ReactionCount reactionCount = this.S.f564a;
    ...
    public final void d(Canvas canvas, float f7, Integer num) {
        ...
        boolean z11 = this.f634s;
        ArrayList arrayList = this.f637w;
        if (!z11 || !arrayList.isEmpty()) {
            ...
            if (this.f634s) {
                ...
                float f14 = 1.0f - f7;
                f12 = (f12 * f7) + (this.f621e * f14);
                f13 = (f13 * f7) + (this.f622f * f14);
            }
            float f15 = f12;
            float f16 = f13;
            int i10 = 0;
            ...
            while (true) {
                ...
                if (!Integer.valueOf(h1Var.f586r.hashCode()).equals(this.C) && (num == null || h1Var.f586r.hashCode() == num.intValue())) {
                    canvas2.save();
                    float f17 = h1Var.f591x;
                    float f18 = h1Var.f592y;
                    int i12 = (f7 > 1.0f ? 1 : (f7 == 1.0f ? 0 : -1));
                    if (i12 != 0 && h1Var.f568c == 3) {
                        float f19 = 1.0f - f7;
                        f17 = (f17 * f7) + (h1Var.d * f19);
                        f18 = (f18 * f7) + (h1Var.f571e * f19);
                    }
                    if (i12 != 0 && h1Var.f568c == 1) {
            ...
            while (i10 < arrayList.size()) {
                ...
                canvas2.save();
                canvas2.scale(f24, f24, (h1Var2.A / 2.0f) + h1Var2.f591x + f15, (h1Var2.B / 2.0f) + h1Var2.f592y + f16);
                ((h1) arrayList.get(i10)).d(canvas2, h1Var2.f591x + f15, h1Var2.f592y + f16, 1.0f, f23, false, this.E, this.D);
                canvas.restore();
                i10++;
                canvas2 = canvas;
            }
    ...
    public final void f(um umVar, Canvas canvas, int i10, Integer num) {
        int i11;
        if (!this.f634s || !this.f637w.isEmpty()) {
            int i12 = 0;
            while (true) {
                ArrayList arrayList = this.v;
                if (i12 < arrayList.size()) {
                    h1 h1Var = (h1) arrayList.get(i12);
                    if ((num == null || h1Var.f586r.hashCode() == num.intValue()) && num != null) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(h1Var.f588t);
                        ...
                        int i13 = h1Var.V;
                        j1 j1Var = h1Var.f587s;
                        View view = h1Var.W;
                        if (h1Var.f574f0 == null && h1Var.f576g0 == null) {
                            if (view != null && (view.getParent() instanceof View)) {
                                view = (View) view.getParent();
                            }
                            if (h1Var.f586r != null && !j1Var.f605a) {
                                if (j1Var.f609f != null) {
                                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i13).getReactionsMap().get(j1Var.f609f);
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, j6.f20634a7, 1.0f);
                                        ImageReceiver imageReceiver = new ImageReceiver(view);
                                        h1Var.f574f0 = imageReceiver;
                                        imageReceiver.setLayerNum(7);
                                        h1Var.f574f0.onAttachedToWindow();
                                        h1Var.f574f0.setRoundRadius(AndroidUtilities.dp(14.0f));
                                        h1Var.f574f0.setAllowStartLottieAnimation(true);
                                        h1Var.f574f0.setAllowStartAnimation(true);
                                        h1Var.f574f0.setAutoRepeat(1);
                                        h1Var.f574f0.setAllowDecodeSingleFrame(true);
                                        h1Var.f574f0.setImage(ImageLocation.getForDocument(tL_availableReaction.activate_animation), "140_140", svgThumb, null, tL_availableReaction, 1);
                                    }
                                } else if (j1Var.f610g != 0) {
                                    q5 q5Var = new q5(24, i13, j1Var.f610g);
                                    h1Var.f576g0 = q5Var;
                                    q5Var.a(view);
                                }
                            }
                        ...
                        if (interpolation > 0.0f) {
                            ImageReceiver imageReceiver2 = h1Var.f574f0;
                            if (imageReceiver2 != null) {
                                imageReceiver2.setImageCoords(rectF2);
                                h1Var.f574f0.setAlpha(interpolation);
                                h1Var.f574f0.draw(canvas);
                            } else {
                                q5 q5Var2 = h1Var.f576g0;
                                if (q5Var2 != null) {
                                    q5Var2.setBounds((int) rectF2.left, (int) rectF2.top, (int) rectF2.right, (int) rectF2.bottom);
                                    h1Var.f576g0.setAlpha((int) (interpolation * 255.0f));
                                    h1Var.f576g0.draw(canvas);
                                }
                            }
                            umVar.invalidate();
                        }
    ...
    public final float i(float f7) {
        if (this.f627l) {
            return (this.f631p * f7) + ((1.0f - f7) * this.J);
        }
        return this.f631p;
    }
    ...
    public final float j(float f7) {
        if (this.f626k) {
            return (this.f632q * f7) + ((1.0f - f7) * this.f633r);
        }
        return this.f632q;
    }
    ...
    public final boolean n() {
        if (this.L) {
            if ((!this.f634s || !this.f637w.isEmpty()) && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
                return true;
            }
            return false;
        }
    ...
    public final void p(int i10, int i11) {
        ...
        while (true) {
            ...
            if (z10) {
                ...
                } else if (uqVar != null && h1Var.f590w > 1) {
                    h1Var.A = w1.C(8.0f, (int) Math.ceil(uqVar.f30972m), h1Var.A);
                }
            } else {
                ...
                if (h1Var.T != null && h1Var.U.size() > 0) {
                    ...
                    h1Var.T.f27795o = AndroidUtilities.dp(26.0f);
                } else if (h1Var.f589u) {
                    h1Var.A = (int) (p6Var.d + AndroidUtilities.dp(8.0f) + h1Var.A);
                } else if (((int) Math.ceil(uqVar.f30972m)) > 0) {
                    h1Var.A = w1.C(8.0f, (int) Math.ceil(uqVar.f30972m), h1Var.A);
                } else {
        ...
        if (i11 == 5 && !arrayList.isEmpty()) {
            int i18 = ((h1) arrayList.get(0)).f592y;
            int i19 = 0;
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                if (((h1) arrayList.get(i20)).f592y != i18) {
                    int i21 = i20 - 1;
                    int i22 = i10 - (((h1) arrayList.get(i21)).f591x + ((h1) arrayList.get(i21)).A);
                    while (i19 < i20) {
                        ((h1) arrayList.get(i19)).f591x += i22;
                        i19++;
                    }
                    i19 = i20;
                }
            ...
            int i23 = i10 - (((h1) arrayList.get(size)).f591x + ((h1) arrayList.get(size)).A);
            while (i19 <= size) {
                ((h1) arrayList.get(i19)).f591x += i23;
                i19++;
            }
        } else if (i11 == 1 && !arrayList.isEmpty()) {
            for (int i24 = 0; i24 < arrayList.size(); i24++) {
                h1 h1Var2 = (h1) arrayList.get(i24);
                int i25 = h1Var2.f593z;
                if (i25 >= 0 && i25 < arrayList2.size()) {
                    f7 = ((Integer) arrayList2.get(h1Var2.f593z)).intValue();
                } else {
                    f7 = 0.0f;
                }
                h1Var2.f591x = (int) e2.A(i10, f7, 2.0f, h1Var2.f591x);
            }
        }
        this.f636u = i14;
        if (i11 != 5 && i11 != 1) {
    ...
    public final void r() {
        ...
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                hashMap.put(((h1) arrayList.get(i10)).f583o, (h1) arrayList.get(i10));
                i10++;
            } else {
                this.f624i = !this.f634s;
                this.f623g = this.f620c;
                this.h = this.d;
                this.F = this.f632q;
                this.I = this.f631p;
                return;
