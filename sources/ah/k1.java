...
public final class k1 {
    ...
    public static void o(f6 f6Var) {
        V.setColor(j6.v0(j6.f20762ie, f6Var));
                ...
                if (i13 == i14 && h1Var.f580y == h1Var2.f580y && h1Var.A == h1Var2.A && h1Var.f578w == h1Var2.f578w && h1Var.f572p == h1Var2.f572p && h1Var.T == null && h1Var2.T == null) {
                    ...
                    if (k9Var2 != null || h1Var2.T != null) {
                        ...
                        if (k9Var3 != null && (k9Var = h1Var2.T) != null) {
                            ValueAnimator valueAnimator = k9Var.f27761f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (k9Var3.f27776w) {
                                    k9Var3.f27776w = false;
                                    k9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = k9Var3.f27758b[i18].h;
                                k9Var3.l(i18, k9Var.f27758b[i18].h, i10);
                                i18++;
                            }
                            k9Var3.b(false, true);
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        if (e2.u(a0Var)) {
            ...
            if (a0Var instanceof org.telegram.ui.Cells.w0) {
                x10 -= ((org.telegram.ui.Cells.w0) a0Var).f23427j0 / 2.0f;
            }
        }
                            ...
                            if (h1Var.f574r != null && !j1Var.f593a) {
                                if (j1Var.f597f != null) {
                                    ...
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, j6.f20608a7, 1.0f);
        ...
        while (true) {
            ...
            if (z10) {
                ...
                if (h1Var.f577u) {
                    ...
                    h1Var.A = w1.C(8.0f, (int) Math.ceil(uqVar.f30946m), h1Var.A);
                }
            } else {
                ...
                if (h1Var.T != null && h1Var.U.size() > 0) {
                    ...
                    h1Var.T.f27769o = AndroidUtilities.dp(26.0f);
                } else if (h1Var.f577u) {
                    h1Var.A = (int) (p6Var.d + AndroidUtilities.dp(8.0f) + h1Var.A);
                } else if (((int) Math.ceil(uqVar.f30946m)) > 0) {
                    h1Var.A = w1.C(8.0f, (int) Math.ceil(uqVar.f30946m), h1Var.A);
                } else {
