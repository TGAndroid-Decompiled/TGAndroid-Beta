...
public final class k1 {
    ...
    public static void o(f6 f6Var) {
        V.setColor(j6.v0(j6.f20789ie, f6Var));
                ...
                if (i13 == i14 && h1Var.f592y == h1Var2.f592y && h1Var.A == h1Var2.A && h1Var.f590w == h1Var2.f590w && h1Var.f584p == h1Var2.f584p && h1Var.T == null && h1Var2.T == null) {
                    ...
                    if (k9Var2 != null || h1Var2.T != null) {
                        ...
                        if (k9Var3 != null && (k9Var = h1Var2.T) != null) {
                            ValueAnimator valueAnimator = k9Var.f27788f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (k9Var3.f27803w) {
                                    k9Var3.f27803w = false;
                                    k9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = k9Var3.f27785b[i18].h;
                                k9Var3.l(i18, k9Var.f27785b[i18].h, i10);
                                i18++;
                            }
                            k9Var3.b(false, true);
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        if (e2.u(a0Var)) {
            ...
            if (a0Var instanceof org.telegram.ui.Cells.w0) {
                x10 -= ((org.telegram.ui.Cells.w0) a0Var).f23454j0 / 2.0f;
            }
        }
                            ...
                            if (h1Var.f586r != null && !j1Var.f605a) {
                                if (j1Var.f609f != null) {
                                    ...
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, j6.f20635a7, 1.0f);
        ...
        while (true) {
            ...
            if (z10) {
                ...
                if (h1Var.f589u) {
                    ...
                    h1Var.A = w1.C(8.0f, (int) Math.ceil(uqVar.f30973m), h1Var.A);
                }
            } else {
                ...
                if (h1Var.T != null && h1Var.U.size() > 0) {
                    ...
                    h1Var.T.f27796o = AndroidUtilities.dp(26.0f);
                } else if (h1Var.f589u) {
                    h1Var.A = (int) (p6Var.d + AndroidUtilities.dp(8.0f) + h1Var.A);
                } else if (((int) Math.ceil(uqVar.f30973m)) > 0) {
                    h1Var.A = w1.C(8.0f, (int) Math.ceil(uqVar.f30973m), h1Var.A);
                } else {
