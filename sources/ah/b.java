                            ...
                            if (i24 > 0) {
                                ...
                                if (chat != null) {
                                    ...
                                    if (ia.d1(iaVar, chat) > 200) {
                                        ...
                                        alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.GroupTooLarge);
                                        alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.GroupTooLargeMessage);
            ...
            default:
                ...
                if (h4Var.K == null || i21 - 1 >= 0) {
                    ...
                    if ((view instanceof o3) && adapter.E != null) {
                        o3 o3Var = (o3) view;
                        if (h4Var.G0 == 0) {
                            if ((!o3Var.f36224c || f7 >= view.getMeasuredWidth() / 2) && !o3Var.d) {
                        ...
                        if (z13 instanceof TL_iv.pageBlockChannel) {
                            ...
                            b4 b4Var = (b4) z13;
                            h4Var.Q(b4Var.f32048a.articles.get(b4Var.f32049b).url, null, null);
                            return;
                            ...
                            if (y3 instanceof l1) {
                                ...
                                if (adapter.e.indexOf(pageBlock) >= 0) {
                                    ...
                                    l1 l1Var = (l1) y3;
                                    AnimatedArrowDrawable animatedArrowDrawable = l1Var.f35411f;
    ...
    public void k(ga gaVar, boolean z10, boolean z11, boolean z12, boolean z13, TLRPC.InputPeer inputPeer, int i10, b9 b9Var, androidx.fragment.app.a0 a0Var) {
        ...
        switch (this.f419a) {
            case 1:
                ...
                tL_stories_editStory.f18360id = storyItem.f18356id;
