...
import u2.b0;
import v7.l8;
public final class b implements hh.i, k9, a2, OnFailureListener, q9.d, ll0, OnCompleteListener, Continuation, ml0, Utilities.Callback3Return, ed0, p0, zt, i4, e2.n, e2.m, j0, e1, v {
    ...
    public w70 a(i1 i1Var) {
        r rVar = (r) ((of.b) this.f420b).f15651c;
        w70 w70Var = new w70(rVar, (e6) this.f421c, i1Var, false, false, true);
        rVar.H = w70Var;
        return w70Var;
    }
        ...
        switch (this.f419a) {
            case 6:
                ...
                if (i15 >= 0 && i15 < arrayList2.size()) {
                    ...
                    int i16 = n9Var.f15672a;
                    int i17 = 0;
                    if (i16 == 3) {
                        if (n9Var.f5087n && iaVar.F) {
                            new i9(context, ia.H(iaVar), iaVar.K, iaVar.f4808c, new q9(baVar, 0), ia.I(iaVar)).show();
                            return;
                        }
                        int i18 = n9Var.f5082i;
                        if (i18 == 1) {
                            ...
                            if (i18 > 0) {
                                ...
                                if (chat != null) {
                                    ...
                                    if (ia.d1(iaVar, chat) > 200) {
                                        ...
                                        alertDialog$Builder.f18622a.R = LocaleController.getString(R.string.GroupTooLarge);
                                        alertDialog$Builder.f18622a.T = LocaleController.getString(R.string.GroupTooLargeMessage);
                        ...
                        if (view instanceof r8) {
                            ...
                            if (i19 == 0) {
                                ...
                                if (b10) {
                                    ...
                                    qc G = xcVar.G(i20, 4, LocaleController.getString(i14));
                                    G.f27550j = 5000;
                                    G.k(true);
                                    return;
                                }
                                ...
                                qc G2 = xcVar2.G(i21, 4, LocaleController.getString(i13));
                                G2.f27550j = 5000;
                                G2.k(true);
                                return;
                            } else if (i19 == 1) {
                                boolean b11 = r8Var.b();
                                iaVar.f4816y = b11;
                                boolean z11 = iaVar.f4808c instanceof TLRPC.TL_inputPeerChannel;
                                if (b11) {
                                    ...
                                    qc G3 = xcVar3.G(i22, 4, LocaleController.getString(i12));
                                    G3.f27550j = 5000;
                                    G3.k(true);
                                } else {
                                    ...
                                    qc G4 = xcVar4.G(i23, 4, LocaleController.getString(i11));
                                    G4.f27550j = 5000;
                                    G4.k(true);
                                }
                                baVar.g(true);
                        ...
                        if (i24 == 0) {
                            ...
                            w70 F = w70.F(baVar, ia.T(iaVar), view);
            ...
            default:
                ...
                if (h4Var.K == null || i15 - 1 >= 0) {
                    ...
                    if ((view instanceof o3) && adapter.E != null) {
                        o3 o3Var = (o3) view;
                        if (h4Var.G0 == 0) {
                            if ((!o3Var.f36106c || f7 >= view.getMeasuredWidth() / 2) && !o3Var.d) {
                                TLObject userOrChat = MessagesController.getInstance(h4Var.X).getUserOrChat("previews");
                                if (userOrChat instanceof TLRPC.TL_user) {
                                    h4Var.P(adapter.E.f18449id, (TLRPC.User) userOrChat);
                                    return;
                                }
                                int i25 = UserConfig.selectedAccount;
                                long j11 = adapter.E.f18449id;
                                h4Var.b0(true);
                        ...
                        if (z12 instanceof TL_iv.pageBlockChannel) {
                            ...
                            b4 b4Var = (b4) z12;
                            h4Var.Q(b4Var.f32231a.articles.get(b4Var.f32232b).url, null, null);
                            return;
                            ...
                            if (y3 instanceof l1) {
                                ...
                                if (adapter.e.indexOf(pageBlock) >= 0) {
                                    ...
                                    l1 l1Var = (l1) y3;
                                    AnimatedArrowDrawable animatedArrowDrawable = l1Var.f35216f;
    ...
    public void g(m4.r rVar) {
        switch (this.f419a) {
            case 24:
                ...
                a0 a0Var = ((k0) this.f420b).f14770g;
                if (bundle == null) {
            ...
            default:
                ...
                k0Var.getClass();
                String str = ((n4.l) this.f421c).f15145a;
    ...
    public Object i(a0 a0Var, m4.r rVar, int i10) {
        switch (this.f419a) {
            case 26:
                ...
                r0 r0Var = (r0) this.f421c;
                if (a0Var.j()) {
                    return l8.b(new p1(-100));
                }
                return d0.d0((w) e1Var.i(a0Var, rVar, i10), new ai.r5(a0Var, rVar, r0Var, 14));
            default:
                ...
                return d0.d0((w) e1Var2.i(a0Var, rVar, i10), new ai.r5(a0Var, rVar, d1Var, 15));
        }
    }
    ...
    public void k(ga gaVar, boolean z10, boolean z11, boolean z12, boolean z13, TLRPC.InputPeer inputPeer, int i10, b9 b9Var, androidx.fragment.app.a0 a0Var) {
        ...
        switch (this.f419a) {
            case 1:
                ...
                tL_stories_editStory.f18535id = storyItem.f18531id;
        ...
        switch (this.f419a) {
            ...
            default:
                ...
                if (!a1.g.a(cancellationSignal2)) {
                    Executor executor = eVar2.f7410g;
                    if (executor != null) {
