...
import u2.b0;
import v7.m8;
public final class b implements hh.i, k9, a2, OnFailureListener, q9.d, nl0, OnCompleteListener, Continuation, ol0, Utilities.Callback3Return, fd0, p0, zt, i4, e2.n, e2.m, j0, e1, v {
    ...
    public Object G(cf.c cVar) {
        ...
        q9.a aVar = (q9.a) this.f418c;
        try {
            Trace.beginSection(str);
            return aVar.f41500f.G(cVar);
        } finally {
            Trace.endSection();
        }
    }
    ...
    public y70 a(i1 i1Var) {
        r rVar = (r) ((of.b) this.f417b).f15698c;
        y70 y70Var = new y70(rVar, (f6) this.f418c, i1Var, false, false, true);
        rVar.H = y70Var;
        return y70Var;
    }
    ...
    public void c(float f7, float f10, int i10, View view) {
        ...
        switch (this.f416a) {
            case 6:
                ba baVar = (ba) this.f417b;
                Context context = (Context) this.f418c;
                ArrayList arrayList2 = baVar.L;
                a0.i iVar = baVar.f4401b;
                u9 u9Var = baVar.f4408x;
                ArrayList arrayList3 = baVar.f4402c;
                HashMap hashMap = baVar.d;
                ia iaVar = baVar.W;
                if (i15 >= 0 && i15 < arrayList2.size()) {
                    n9 n9Var = (n9) arrayList2.get(i15);
                    int i16 = n9Var.f15719a;
                    int i17 = 0;
                    if (i16 == 3) {
                        if (n9Var.f5086n && iaVar.F) {
                            new i9(context, ia.G(iaVar), iaVar.K, iaVar.f4807c, new q9(baVar, 0), ia.I(iaVar)).show();
                            return;
                        }
                        int i18 = n9Var.f5081i;
                        if (i18 == 1) {
                            ...
                            if (iaVar.N == 3 || (iaVar.f4810n.isEmpty() && iaVar.f4811r.isEmpty())) {
                                iaVar.M = 3;
                                iaVar.f4805b.E(1);
                            }
                            iaVar.N = 3;
                            ...
                            if (i18 > 0) {
                                ...
                                if (chat != null) {
                                    ...
                                    if (ia.d1(iaVar, chat) > 200) {
                                        ...
                                        alertDialog$Builder.f18669a.R = LocaleController.getString(R.string.GroupTooLarge);
                                        alertDialog$Builder.f18669a.T = LocaleController.getString(R.string.GroupTooLargeMessage);
                        ...
                        if (view instanceof s8) {
                            ...
                            n9Var.f5083k = s8Var.b();
                            int i19 = n9Var.f5078c;
                            if (i19 == 0) {
                                boolean b10 = s8Var.b();
                                iaVar.f4814x = b10;
                                if (iaVar.N == 4) {
                                ...
                                boolean b11 = s8Var.b();
                                iaVar.f4815y = b11;
                                boolean z11 = iaVar.f4807c instanceof TLRPC.TL_inputPeerChannel;
                                if (b11) {
                        ...
                        int i24 = n9Var.f5089q;
                        if (i24 == 0) {
                            ka kaVar = iaVar.f4808c0;
                            if (kaVar != null) {
                                kaVar.run();
                                return;
                            }
                            ...
                            TLRPC.InputPeer inputPeer2 = iaVar.f4807c;
                            if (inputPeer2 == null) {
                ...
                return;
            default:
                h4 h4Var = (h4) this.f417b;
                l3 l3Var = (l3) this.f418c;
                if (h4Var.K == null || i15 - 1 >= 0) {
                    ...
                    if ((view instanceof o3) && adapter.E != null) {
                        o3 o3Var = (o3) view;
                        if (h4Var.G0 == 0) {
                            if ((!o3Var.f36201c || f7 >= view.getMeasuredWidth() / 2) && !o3Var.d) {
                                TLObject userOrChat = MessagesController.getInstance(h4Var.X).getUserOrChat("previews");
                                if (userOrChat instanceof TLRPC.TL_user) {
                                    h4Var.P(adapter.E.f18496id, (TLRPC.User) userOrChat);
                                    return;
                                }
                                int i25 = UserConfig.selectedAccount;
                                long j11 = adapter.E.f18496id;
                                h4Var.b0(true);
                        ...
                        if (z12 instanceof TL_iv.pageBlockChannel) {
                            ...
                            b4 b4Var = (b4) z12;
                            h4Var.Q(b4Var.f32267a.articles.get(b4Var.f32268b).url, null, null);
                            return;
                            ...
                            if (y3 instanceof l1) {
                                ...
                                if (adapter.e.indexOf(pageBlock) >= 0) {
                                    ...
                                    l1 l1Var = (l1) y3;
                                    AnimatedArrowDrawable animatedArrowDrawable = l1Var.f35297f;
    ...
    public boolean d(int i10, View view) {
        return e4.B0((e4) this.f417b, (Context) this.f418c, view, i10);
    }

    @Override
    public void e(Object obj, q qVar) {
        ((j2.b) obj).d((b1) this.f418c, new of.b(qVar, ((j2.f) this.f417b).e));
    }
    ...
    public void f(m4.r rVar) {
        switch (this.f416a) {
            case 24:
                Bundle bundle = (Bundle) this.f418c;
                a0 a0Var = ((k0) this.f417b).f14821g;
                if (bundle == null) {
                ...
                return;
            default:
                k0 k0Var = (k0) this.f417b;
                k0Var.getClass();
                String str = ((n4.l) this.f418c).f15197a;
                ...
                for (int i10 = 0; i10 < w02.o(); i10++) {
                    if (TextUtils.equals(w02.m(i10, j1Var2, 0L).f3059c.f3076a, str)) {
                        j1Var.R(i10);
                        return;
                    }
                }
    ...
    public void g(ga gaVar, boolean z10, boolean z11, boolean z12, boolean z13, TLRPC.InputPeer inputPeer, int i10, b9 b9Var, androidx.fragment.app.a0 a0Var) {
        ...
        switch (this.f416a) {
            case 1:
                ai.f6 f6Var = (ai.f6) this.f417b;
                TL_stories.StoryItem storyItem = (TL_stories.StoryItem) this.f418c;
                TL_stories.TL_stories_editStory tL_stories_editStory = new TL_stories.TL_stories_editStory();
                tL_stories_editStory.peer = MessagesController.getInstance(f6Var.C2).getInputPeer(storyItem.dialogId);
                tL_stories_editStory.f18582id = storyItem.f18578id;
                tL_stories_editStory.flags |= 4;
                tL_stories_editStory.privacy_rules = gaVar.f4725b;
                ConnectionsManager.getInstance(f6Var.C2).sendRequest(tL_stories_editStory, new p3(f6Var, b9Var, storyItem, gaVar, 0));
                return;
            default:
                w5 w5Var = (w5) this.f417b;
                ia iaVar = (ia) this.f418c;
                ai.f6 f6Var2 = w5Var.f1655l;
                d6 d6Var = f6Var2.O1;
    ...
    public Object h(a0 a0Var, m4.r rVar, int i10) {
        switch (this.f416a) {
            case 26:
                e1 e1Var = (e1) this.f417b;
                q0 q0Var = (q0) this.f418c;
                if (a0Var.j()) {
                    return m8.b(new p1(-100));
                }
                return d0.d0((w) e1Var.h(a0Var, rVar, i10), new r5(a0Var, rVar, q0Var, 14));
            default:
                e1 e1Var2 = (e1) this.f417b;
                d1 d1Var = (d1) this.f418c;
                if (a0Var.j()) {
                    return m8.b(new p1(-100));
                }
    ...
    public void i() {
        switch (this.f416a) {
            case 17:
                ...
                return;
            default:
                o5 o5Var = (o5) this.f417b;
                ii.r5 r5Var = (ii.r5) this.f418c;
    ...
    public void invoke(Object obj) {
        switch (this.f416a) {
            case 21:
                ((j2.b) obj).e((j2.a) this.f417b, (b0) this.f418c);
                return;
            default:
                ((j2.b) obj).onRenderedFirstFrame((j2.a) this.f417b);
                return;
        }
    }
    ...
    public void j(RectF rectF, View view) {
        ((ch.d) this.f417b).t(rectF.left, rectF.top);
        ((View) this.f418c).invalidate();
    }
    ...
    public void k(b2 b2Var, int i10) {
        switch (this.f416a) {
            case 3:
                ...
                ai.f6.f0(w5Var.f1655l);
                return;
            case 10:
                e4.y0((e4) this.f417b, (TL_payments.connectedBotStarRef) this.f418c);
                return;
            case 12:
                gg.k1 k1Var = (gg.k1) this.f417b;
                k1Var.getClass();
                ((boolean[]) this.f418c)[0] = true;
                k1Var.Q();
                return;
            default:
                hg.v.Z((hg.v) this.f417b, (TL_account.TL_businessChatLink) this.f418c);
                return;
        }
    }
    ...
    public void onComplete(Task task) {
        ((com.google.firebase.messaging.g) this.f417b).a((Intent) this.f418c);
    }
    ...
    public void onFailure(Exception e) {
        ...
        switch (this.f416a) {
            case 4:
                c1.e eVar = (c1.e) this.f417b;
                CancellationSignal cancellationSignal = (CancellationSignal) this.f418c;
                ...
                return;
            default:
                d1.e eVar2 = (d1.e) this.f417b;
                CancellationSignal cancellationSignal2 = (CancellationSignal) this.f418c;
                kotlin.jvm.internal.i.e(e, "e");
                if ((e instanceof com.google.android.gms.common.api.f) && b1.d.f2893b.contains(Integer.valueOf(((com.google.android.gms.common.api.f) e).getStatusCode()))) {
    ...
    public void run(long j3) {
        ...
        ((t3) this.f417b).a((String) this.f418c, tL_inlineButtonTypeUserProfile);
    }

    @Override
    public Object then(Task task) {
        com.google.firebase.messaging.j jVar = (com.google.firebase.messaging.j) this.f417b;
        String str = (String) this.f418c;
        synchronized (jVar) {
            ((a0.f) jVar.f7321b).remove(str);
        }
        return task;
    }
    ...
    public Object run(Object obj, Object obj2, Object obj3) {
        ...
        ((s8) ((View) this.f418c)).setValueSticker(document);
        mVar.e0(true);
        return Boolean.TRUE;
    }
