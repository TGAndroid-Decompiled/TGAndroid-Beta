        ...
        switch (this.f598a) {
            case 10:
                ...
                if (i15 >= 0 && i15 < arrayList2.size()) {
                    ...
                    int i16 = m9Var.f44098a;
                    int i17 = 0;
                    if (i16 == 3) {
                        if (m9Var.f7684n && iaVar.F) {
                            new h9(context, ((f3) iaVar).currentAccount, iaVar.K, iaVar.f7420c, new p9(baVar, 0), ((f3) iaVar).resourcesProvider).show();
                            return;
                        }
                        int i18 = m9Var.f7679i;
                        if (i18 == 1) {
                            ...
                            if (i18 > 0) {
                                ...
                                if (chat != null) {
                                    ...
                                    if (ia.d1(iaVar, chat) > 200) {
                                        ...
                                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(baVar.getContext(), 0, ((f3) iaVar).resourcesProvider);
                                        alertDialog$Builder.f20225a.R = LocaleController.getString(R.string.GroupTooLarge);
                                        alertDialog$Builder.f20225a.T = LocaleController.getString(R.string.GroupTooLargeMessage);
                                        ...
                                        TLRPC.Chat chat2 = MessagesController.getInstance(((f3) iaVar).currentAccount).getChat(Long.valueOf(j3));
                                        TLRPC.ChatFull chatFull = MessagesController.getInstance(((f3) iaVar).currentAccount).getChatFull(j3);
                                        if (chatFull != null && (chatParticipants = chatFull.participants) != null && (arrayList = chatParticipants.participants) != null && !arrayList.isEmpty() && chatFull.participants.participants.size() >= chatFull.participants_count - 1) {
                                            ...
                                            baVar.H = j3;
                                            b2 b2Var2 = new b2(baVar.getContext(), 3, ((f3) iaVar).resourcesProvider);
                                            baVar.G = b2Var2;
                                            b2Var2.q(50L);
                                            MessagesStorage messagesStorage = MessagesStorage.getInstance(((f3) iaVar).currentAccount);
                        ...
                        if (view instanceof r8) {
                            ...
                            if (i19 == 0) {
                                ...
                                if (b10) {
                                    yc ycVar = new yc(iaVar.container, ((f3) iaVar).resourcesProvider);
                                ...
                                yc ycVar2 = new yc(iaVar.container, ((f3) iaVar).resourcesProvider);
                                ...
                                boolean b11 = r8Var.b();
                                iaVar.f7429y = b11;
                                boolean z11 = iaVar.f7420c instanceof TLRPC.TL_inputPeerChannel;
                                if (b11) {
                                    yc ycVar3 = new yc(iaVar.container, ((f3) iaVar).resourcesProvider);
                                    ...
                                    yc ycVar4 = new yc(iaVar.container, ((f3) iaVar).resourcesProvider);
                        ...
                        if (i24 == 0) {
                            ...
                            if (inputPeer != null) {
                                ...
                                clientUserId = UserConfig.getInstance(((f3) iaVar).currentAccount).getClientUserId();
                            }
                            n70 F = n70.F(baVar, ((f3) iaVar).resourcesProvider, view);
                            ...
                            b2 b2Var3 = new b2(baVar.getContext(), 3, ((f3) iaVar).resourcesProvider);
                            b2Var3.q(500L);
                            ...
                            ConnectionsManager.getInstance(((f3) iaVar).currentAccount).sendRequest(getgroupcallstreamrtmpurl, new c5(baVar, b2Var3, getgroupcallstreamrtmpurl, 1));
                            return;
                        } else if (i24 == 6) {
                            iaVar.G = false;
                            baVar.g(true);
            ...
            default:
                ...
                if (i4Var.K == null || i15 - 1 >= 0) {
                    ...
                    if ((view instanceof p3) && adapter.E != null) {
                        p3 p3Var = (p3) view;
                        if (i4Var.G0 == 0) {
                            if ((!p3Var.f39422c || f7 >= view.getMeasuredWidth() / 2) && !p3Var.d) {
                        ...
                        if (z12 instanceof TL_iv.pageBlockChannel) {
                            ...
                            c4 c4Var = (c4) z12;
                            i4Var.Q(c4Var.f35017a.articles.get(c4Var.f35018b).url, null, null);
                            return;
                            ...
                            if (y3 instanceof org.telegram.ui.m1) {
                                i4Var.d = null;
                                i4Var.f41464f = null;
                                if (adapter.f36577e.indexOf(pageBlock) >= 0) {
                                    ...
                                    AnimatedArrowDrawable animatedArrowDrawable = m1Var.f38566f;
    ...
    public void e(ga gaVar, boolean z10, boolean z11, boolean z12, boolean z13, TLRPC.InputPeer inputPeer, int i10, b7 b7Var, oa oaVar) {
        ...
        switch (this.f598a) {
            case 2:
                ...
                tL_stories_editStory.f20138id = storyItem.f20134id;
