        ...
        switch (i10) {
            ...
            case 2:
                if (!b0Var.K) {
                    ...
                    b0Var.f457c.animate().translationY(0.0f).withLayer().setDuration(350L).setInterpolator(pr.f29494f).setUpdateListener(new n(b0Var, 0)).setListener(new a0(0)).start();
                    return;
                }
                return;
            case 3:
