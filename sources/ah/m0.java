    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f639a) {
            case 0:
                ...
                u0Var.f695m.f37653k0.invalidate();
                return;
            case 1:
            ...
            case 7:
                ...
                return;
            case 8:
                ((org.telegram.ui.Cells.v0) this.f640b).f23355c = ((Float) valueAnimator.getAnimatedValue()).floatValue();
            ...
            case 10:
                ...
                coVar.f35187a1.setTranslationY(dp);
                coVar.f35187a1.getAvatarImageView().setTranslationY(-dp);
                float f11 = (-AndroidUtilities.dp(8.0f)) * floatValue6;
                coVar2.f35187a1.setTranslationY(f11);
                coVar2.f35187a1.getAvatarImageView().setTranslationY(-f11);
                float f12 = (floatValue6 * 0.2f) + 0.8f;
                coVar.f35187a1.getAvatarImageView().setScaleX(f12);
                coVar.f35187a1.getAvatarImageView().setScaleY(f12);
                coVar.f35187a1.getAvatarImageView().setAlpha(floatValue6);
                float f13 = (0.2f * f10) + 0.8f;
                coVar2.f35187a1.getAvatarImageView().setScaleX(f13);
                coVar2.f35187a1.getAvatarImageView().setScaleY(f13);
                coVar2.f35187a1.getAvatarImageView().setAlpha(f10);
                dh dhVar = coVar2.M0;
                if (dhVar != null) {
                    dhVar.setAlpha(f10);
                    return;
            ...
            case 15:
                ...
                if (niVar == chatAttachAlertPhotoLayout) {
                    chatAttachAlertPhotoLayout.k(viVar.f31299l2);
                    return;
                }
                return;
            case 16:
                ...
                mVar.getClass();
                ((ju) this.f641c).f27571b = ((Integer) valueAnimator.getAnimatedValue()).intValue();
            ...
            case 17:
                ...
                while (i10 < by0VarArr.length) {
                    cy0Var.f25131c[i10] = (cy0Var.d[i10] * floatValue9) + ((1.0f - floatValue9) * cy0Var.f25132e[i10]);
                    i10++;
                }
                cy0Var.invalidate();
                return;
            ...
            case 21:
                ...
                int i13 = m3Var.f31653e;
                m3Var.f31655g = (int) ((((Float) valueAnimator.getAnimatedValue()).floatValue() * (m3Var.f31652c - i13)) + i13);
                int i14 = m3Var.f31654f;
            ...
            case 24:
                ...
                dc0 dc0Var = g31Var.f36544n;
                if (dc0Var != null) {
                    dc0Var.K = 1.0f;
                    dc0Var.i();
                    g31Var.f36544n.s(1.0f - floatValue11);
                }
                ...
                if (iArr2 != null) {
                    int d = i0.a.d(floatValue11, g31Var.f36542e[0], iArr2[0]);
                    int d10 = i0.a.d(floatValue11, g31Var.f36542e[1], iArr2[1]);
                    int d11 = i0.a.d(floatValue11, g31Var.f36542e[2], iArr2[2]);
                    int d12 = i0.a.d(floatValue11, g31Var.f36542e[3], iArr2[3]);
                    a31 a31Var = g31Var.E;
                    a31Var.f34315a.n(d, d10, d11, d12);
                    a31Var.invalidate();
                }
                g31Var.f36547w.invalidate();
                return;
            case 25:
            ...
            case 27:
                ...
                if (floatValue12 < 0.5f) {
                    ...
                    c2Var.f45154z0 = ((1.0f - f16) * 0.3f) + 0.7f;
                    c2Var.invalidate();
                    return;
                }
                if (!zArr2[0]) {
