...
public final class b0 extends n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final boolean X(boolean z10) {
        ...
        if (z10 && z11) {
            ...
            alertDialog$Builder.f20226a.T = LocaleController.getString("ReactionApplyChangesDialog", R.string.ReactionApplyChangesDialog);
    ...
    public final void Z() {
        if (this.K) {
            ...
            this.f457c.animate().translationY(this.f457c.getMeasuredHeight()).setDuration(350L).withLayer().setInterpolator(pr.f29494f).setUpdateListener(new n(this, 1)).setListener(new r(this, 0)).start();
        }
    }
        ...
        if (this.S != i10 || this.f455a != z10) {
            ...
            if (z11) {
                ...
                if (linkedHashMap.isEmpty()) {
                    ...
                    this.f460n.m();
                    i61 i61Var = this.f456b.f37689p0;
                    if (i61Var != null) {
                        i61Var.l();
                    }
                    Y(false);
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11) {
            if (this.f456b == null) {
                ...
                this.f456b.setBackgroundColor(j6.w0(null, j6.f20691d6, false));
