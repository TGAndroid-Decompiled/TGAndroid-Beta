...
public final class b0 extends n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final boolean X(boolean z10) {
        ...
        if (z10 && z11) {
            ...
            alertDialog$Builder.f20199a.T = LocaleController.getString("ReactionApplyChangesDialog", R.string.ReactionApplyChangesDialog);
    ...
    public final void Z() {
        if (this.K) {
            ...
            this.f445c.animate().translationY(this.f445c.getMeasuredHeight()).setDuration(350L).withLayer().setInterpolator(pr.f29467f).setUpdateListener(new n(this, 1)).setListener(new r(this, 0)).start();
        }
    }
        ...
        if (this.S != i10 || this.f443a != z10) {
            ...
            if (z11) {
                ...
                if (linkedHashMap.isEmpty()) {
                    ...
                    this.f448n.m();
                    i61 i61Var = this.f444b.f37662p0;
                    if (i61Var != null) {
                        i61Var.l();
                    }
                    Y(false);
    ...
    public final void onTransitionAnimationEnd(boolean z10, boolean z11) {
        ...
        if (z10 && !z11) {
            if (this.f444b == null) {
                ...
                this.f444b.setBackgroundColor(j6.w0(null, j6.f20664d6, false));
