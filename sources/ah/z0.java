        ...
        if (!Objects.equals(this.f730e, j1Var)) {
            ...
            if (j1Var.f597f != null) {
                ...
                if (tL_availableReaction != null) {
                    imageReceiver.setImage(ImageLocation.getForDocument(tL_availableReaction.select_animation), str2, null, null, DocumentObject.getSvgThumb(tL_availableReaction.select_animation, j6.f20828m6, 0.2f), 0L, "tgs", j1Var, 0);
                    return;
                }
                return;
            }
