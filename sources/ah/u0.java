...
public final class u0 {
    ...
    public u0(int i10, n2 n2Var, ArrayList arrayList, HashSet hashSet, fk0 fk0Var, f6 f6Var, boolean z10) {
        ...
        boolean z14 = fk0Var.f26121f1;
        boolean z15 = fk0Var.f26123g1;
        if (o0Var.K1 != z14) {
            o0Var.K1 = z14;
            o0Var.L1 = z15;
    ...
    public static void a(u0 u0Var, boolean z10) {
        ...
        if (u0Var.E.isEmpty()) {
            ...
            g61 g61Var = o0Var.f37674h0;
            if (z10) {
                o0Var.f37664d0.m(false);
                g61Var.invalidate();
                ArrayList arrayList = g61Var.f38228a3;
                g61Var.e1();
                o0Var.f37670f0.b();
                ...
                if (fk0Var.getPullingLeftProgress() > 0.0f) {
                    ...
                    fk0Var.O0 = true;
                    ValueAnimator valueAnimator2 = fk0Var.f26149y0;
                ...
                for (int i11 = 0; i11 < arrayList.size(); i11++) {
                    ...
                    for (int i12 = 0; i12 < k61Var.O.size(); i12++) {
                        if (((s61) k61Var.O.get(i12)).f40344b) {
                            ((s61) k61Var.O.get(i12)).f40344b = false;
                ...
                g61Var.invalidate();
                for (int i13 = 0; i13 < w51Var.f38228a3.size(); i13++) {
                    k61 k61Var2 = (k61) w51Var.f38228a3.get(i13);
                    for (int i14 = 0; i14 < k61Var2.O.size(); i14++) {
                        if (((s61) k61Var2.O.get(i14)).f40344b) {
                            ((s61) k61Var2.O.get(i14)).f40344b = false;
    ...
    public final void c(boolean z10) {
        ...
        rectF.set(fk0Var.f26144w);
        this.f700e = fk0Var.f26148y;
        int[] iArr2 = new int[2];
        if (z10) {
        ...
        if (i11 == 4) {
            ...
            timeAnimator.f25128a = 0;
            timeAnimator.f25129b = 0;
        ...
        if (i11 == 4) {
            ...
            this.f717x.setInterpolator(pr.f29494f);
        }
        t0Var.invalidate();
        h(true);
        if (!z10) {
    ...
    public final void h(boolean z10) {
        ...
        o0 o0Var = this.f707m;
        o0Var.f37674h0.setLayerType(i10, null);
        o0Var.f37670f0.setLayerType(i10, null);
        if (this.f716w) {
            for (int i11 = 0; i11 < Math.min(o0Var.f37664d0.f28498b.getChildCount(), 16); i11++) {
                o0Var.f37664d0.f28498b.getChildAt(i11).setLayerType(i10, null);
            }
            return;
        }
        o0Var.f37667e0.setLayerType(i10, null);
        o0Var.f37664d0.setLayerType(i10, null);
    }
    ...
    public final void j(float f7, boolean z10) {
        ...
        int y12 = (int) (o0Var.f37664d0.getY() + d61Var.getY() + o0Var.getY());
        for (int i11 = 0; i11 < o0Var.f37664d0.f28498b.getChildCount(); i11++) {
            View childAt2 = o0Var.f37664d0.f28498b.getChildAt(i11);
    ...
    public final void k() {
        if (!this.f716w) {
            o0 o0Var = this.f707m;
            o0Var.f37670f0.setAlpha(this.f704j);
            o0Var.f37674h0.setAlpha(this.f704j);
            o0Var.f37676i0.setAlpha(this.f704j);
            o0Var.f37664d0.setAlpha(this.f704j);
            o0Var.f37667e0.setAlpha(this.f704j);
        }
    }
