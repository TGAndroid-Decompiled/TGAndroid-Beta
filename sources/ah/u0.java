...
public final class u0 {
    ...
    public int F;
    public final t0 f685a;
    public final WindowManager f686b;
    ...
    public final o0 f695m;
    public final fk0 f696n;
    public final List f697o;
    public cc0 f698p;
    public boolean f699q;
    public final n2 f700r;
    public final f6 f701s;
    public float f702t;
    public float f703u;
    public boolean v;
    public boolean f704w;
    public ValueAnimator f705x;
    public final int f706y;
    public dh.d f707z;
    public final RectF f689f = new RectF();
    public final RectF f691i = new RectF();
    ...
    public u0(int i10, n2 n2Var, ArrayList arrayList, HashSet hashSet, fk0 fk0Var, f6 f6Var, boolean z10) {
        ...
        boolean z14 = fk0Var.f26094f1;
        boolean z15 = fk0Var.f26096g1;
        if (o0Var.K1 != z14) {
            o0Var.K1 = z14;
            o0Var.L1 = z15;
    ...
    public static void a(u0 u0Var, boolean z10) {
        ...
        if (u0Var.E.isEmpty()) {
            ...
            g61 g61Var = o0Var.f37647h0;
            if (z10) {
                o0Var.f37637d0.m(false);
                g61Var.invalidate();
                ArrayList arrayList = g61Var.f38201a3;
                g61Var.e1();
                o0Var.f37643f0.b();
                ...
                if (fk0Var.getPullingLeftProgress() > 0.0f) {
                    fk0Var.O0 = false;
                    ValueAnimator valueAnimator = fk0Var.f26122y0;
                    ...
                    fk0Var.O0 = true;
                    ValueAnimator valueAnimator2 = fk0Var.f26122y0;
                ...
                for (int i11 = 0; i11 < arrayList.size(); i11++) {
                    ...
                    for (int i12 = 0; i12 < k61Var.O.size(); i12++) {
                        if (((s61) k61Var.O.get(i12)).f40317b) {
                            ((s61) k61Var.O.get(i12)).f40317b = false;
                ...
                g61Var.invalidate();
                for (int i13 = 0; i13 < w51Var.f38201a3.size(); i13++) {
                    k61 k61Var2 = (k61) w51Var.f38201a3.get(i13);
                    for (int i14 = 0; i14 < k61Var2.O.size(); i14++) {
                        if (((s61) k61Var2.O.get(i14)).f40317b) {
                            ((s61) k61Var2.O.get(i14)).f40317b = false;
    ...
    public final void c(boolean z10) {
        ...
        fk0 fk0Var = this.f696n;
        rectF.set(fk0Var.f26117w);
        this.f688e = fk0Var.f26121y;
        int[] iArr2 = new int[2];
        if (z10) {
        ...
        if (!z10) {
            this.f702t = t0Var.getTranslationY();
        } else {
            this.f702t = topOffset;
        ...
        this.h = y3;
        rectF.offset(x10, y3);
        fk0Var.setCustomEmojiEnterProgress(this.f692j);
        if (z10) {
        ...
        bwVar.m(z12);
        this.B.lock();
        ValueAnimator valueAnimator2 = this.f705x;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        this.C = true;
        float f10 = this.f692j;
        if (i11 == 4) {
            if (z10) {
                f7 = 1.0f;
            }
            ...
            timeAnimator.f25101a = 0;
            timeAnimator.f25102b = 0;
            timeAnimator.setFloatValues(new float[]{f10, f7});
            valueAnimator = timeAnimator;
        }
        this.f705x = valueAnimator;
        valueAnimator.addUpdateListener(new l0(0, this, z10));
        if (!z10) {
            i();
        }
        this.f705x.addListener(new q0(0, this, z10));
        if (i11 == 4) {
            this.f705x.setDuration(420L);
            this.f705x.setInterpolator(pr.h);
        } else if (this.f704w) {
            this.f705x.setDuration(450L);
            this.f705x.setInterpolator(new OvershootInterpolator(0.5f));
        } else {
            this.f705x.setDuration(350L);
            this.f705x.setInterpolator(pr.f29467f);
        }
        t0Var.invalidate();
        h(true);
        if (!z10) {
            fk0Var.O0 = true;
            fk0Var.invalidate();
            this.f705x.setStartDelay(30L);
            this.f705x.start();
        } else {
            fk0Var.setCustomEmojiReactionsBackground(false);
            ValueAnimator valueAnimator3 = this.f705x;
    ...
    public final void d() {
        if (!this.f699q) {
            ...
            qc.e();
            this.f699q = true;
            AndroidUtilities.hideKeyboard(this.f687c);
            c(false);
            if (this.v) {
                n2 n2Var = this.f700r;
    ...
    public final void h(boolean z10) {
        ...
        o0 o0Var = this.f695m;
        o0Var.f37647h0.setLayerType(i10, null);
        o0Var.f37643f0.setLayerType(i10, null);
        if (this.f704w) {
            for (int i11 = 0; i11 < Math.min(o0Var.f37637d0.f28471b.getChildCount(), 16); i11++) {
                o0Var.f37637d0.f28471b.getChildAt(i11).setLayerType(i10, null);
            }
            return;
        }
        o0Var.f37640e0.setLayerType(i10, null);
        o0Var.f37637d0.setLayerType(i10, null);
    }
    ...
    public final void j(float f7, boolean z10) {
        ...
        int y12 = (int) (o0Var.f37637d0.getY() + d61Var.getY() + o0Var.getY());
        for (int i11 = 0; i11 < o0Var.f37637d0.f28471b.getChildCount(); i11++) {
            View childAt2 = o0Var.f37637d0.f28471b.getChildAt(i11);
    ...
    public final void k() {
        if (!this.f704w) {
            o0 o0Var = this.f695m;
            o0Var.f37643f0.setAlpha(this.f692j);
            o0Var.f37647h0.setAlpha(this.f692j);
            o0Var.f37649i0.setAlpha(this.f692j);
            o0Var.f37637d0.setAlpha(this.f692j);
            o0Var.f37640e0.setAlpha(this.f692j);
        }
    }
    ...
    public final void l() {
        ...
        o0 o0Var = this.f695m;
        d61 d61Var = o0Var.f37629a0;
        d61 d61Var2 = o0Var.f37629a0;
        boolean z10 = this.f704w;
        t0 t0Var = this.f685a;
        if (z10) {
            f7 = 0.0f;
        } else {
        ...
        d61Var2.setPivotX(t0Var.f679r);
        d61Var2.setPivotY(t0Var.f680s);
        d61Var2.setScaleX(t0Var.f678n);
        d61Var2.setScaleY(t0Var.f678n);
    }
}
