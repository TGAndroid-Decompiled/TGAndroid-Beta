...
public final class n0 implements ob {
    ...
    public final void b(qc qcVar) {
        ...
        switch (this.f644a) {
            case 0:
                return;
            case 1:
                if (qcVar.f29672a == 2 && (h5Var = ((l4) this.f645b).f3247x.Q1) != null) {
                    pb pbVar = ((gb) h5Var).d;
                    pbVar.Y0 = true;
                    pbVar.P();
                    return;
            ...
            default:
                ...
                yh.j0 j0Var = (yh.j0) this.f645b;
                dh.d c10 = j0Var.f50339e.c(ubVar, null, true);
                f6Var = ((f3) j0Var).resourcesProvider;
                eh.e eVar = new eh.e(f6Var);
                eVar.f9113e = new w9(5);
    ...
    public final int f(int i10) {
        ...
        switch (this.f644a) {
            case 0:
                return (int) ((u0) ((w) this.f645b).f713c).f703u;
            case 1:
                if (((l4) this.f645b).f3247x.f3475x2) {
                    return 0;
                }
                return AndroidUtilities.dp(64.0f);
            case 2:
                return ((s6) this.f645b).f3696r.getPaddingBottom();
            case 3:
                return 0;
            case 4:
                editTextHeight = ((pc) this.f645b).f7850c1.getEditTextHeight();
                dp = AndroidUtilities.dp(12.0f);
                break;
            case 5:
                return ((y7) this.f645b).f32859e.E.getHeight();
            case 6:
                return ((n2) this.f645b).getBottomInset();
            case 7:
                ob obVar = (ob) this.f645b;
                if (obVar == null) {
                    return 0;
                }
                return obVar.f(i10);
            case 8:
                ...
                dp = ((dm) this.f645b).f25425c.f28753b.getBottomInset();
                break;
            case 9:
                FrameLayout frameLayout = ((ux0) this.f645b).f31017w;
                if (frameLayout != null) {
                    return frameLayout.getHeight();
                }
                return 0;
            case 10:
                org.telegram.ui.web.d1 d1Var = (org.telegram.ui.web.d1) this.f645b;
    ...
    public final int h(int i10) {
        switch (this.f644a) {
            ...
            case 2:
                return 0;
            case 3:
                return (int) (((d7) this.f645b).f2866a + AndroidUtilities.dp(58.0f));
            case 4:
                return 0;
            case 5:
                return 0;
