    ...
    public final void b(qc qcVar) {
        ...
        switch (this.f644a) {
            case 0:
                return;
            case 1:
                if (qcVar.f29673a == 2 && (h5Var = ((l4) this.f645b).f3247x.Q1) != null) {
                    pb pbVar = ((gb) h5Var).d;
                    pbVar.Y0 = true;
                    pbVar.P();
                    return;
            ...
            default:
                ...
                dh.d c10 = j0Var.f50340e.c(ubVar, null, true);
    ...
    public final int f(int i10) {
        ...
        switch (this.f644a) {
            ...
            case 4:
                ...
                break;
            case 5:
                return ((y7) this.f645b).f32860e.E.getHeight();
            case 6:
            ...
            case 8:
                ...
                dp = ((dm) this.f645b).f25426c.f28754b.getBottomInset();
                break;
            case 9:
                FrameLayout frameLayout = ((ux0) this.f645b).f31018w;
                if (frameLayout != null) {
