    ...
    public final void b(qc qcVar) {
        ...
        switch (this.f656a) {
            case 0:
                return;
            case 1:
                if (qcVar.f29700a == 2 && (h5Var = ((l4) this.f657b).f3274x.Q1) != null) {
                    pb pbVar = ((gb) h5Var).d;
                    pbVar.Y0 = true;
                    pbVar.P();
                    return;
            ...
            default:
                ...
                dh.d c10 = j0Var.f50369e.c(ubVar, null, true);
    ...
    public final int f(int i10) {
        ...
        switch (this.f656a) {
            ...
            case 4:
                ...
                break;
            case 5:
                return ((y7) this.f657b).f32887e.E.getHeight();
            case 6:
            ...
            case 8:
                ...
                dp = ((dm) this.f657b).f25453c.f28781b.getBottomInset();
                break;
            case 9:
                FrameLayout frameLayout = ((ux0) this.f657b).f31045w;
                if (frameLayout != null) {
