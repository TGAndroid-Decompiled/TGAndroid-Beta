...
public class s extends c0 {
    ...
    public final void A0(z0 z0Var, a0 a0Var, a0.h hVar) {
        ...
        for (int i11 = 0; i11 < this.J && a0Var.b(z0Var) && i10 > 0; i11++) {
            int i12 = a0Var.d;
            hVar.b(i12, Math.max(0, a0Var.f42673g));
            i10 -= this.O.i(i12);
            a0Var.d += a0Var.e;
        }
    }
    ...
    public void b0(of.e eVar, z0 z0Var) {
        ...
        if (z10) {
            ...
            for (int i10 = 0; i10 < r10; i10++) {
                ...
                int b10 = rVar.b();
                sparseIntArray2.put(b10, rVar.f42815f);
    ...
    public final void r0(Rect rect, int i10, int i11) {
        ...
        if (this.f42690o == 1) {
            ...
            int[] iArr = this.K;
            g10 = o0.g(i10, iArr[iArr.length - 1] + E, this.f42795b.getMinimumWidth());
        } else {
            int width = rect.width() + E;
            RecyclerView recyclerView2 = this.f42795b;
            WeakHashMap weakHashMap2 = r0.i0.f41870a;
            g10 = o0.g(i10, width, recyclerView2.getMinimumWidth());
            int[] iArr2 = this.K;
            g11 = o0.g(i11, iArr2[iArr2.length - 1] + C, this.f42795b.getMinimumHeight());
        }
        this.f42795b.setMeasuredDimension(g10, g11);
    }
    ...
    public void w1(View view, int i10, boolean z10) {
        ...
        int s12 = s1(rVar.e, rVar.f42815f);
        if (this.f42690o == 1) {
            i12 = o0.s(false, s12, i10, i14, ((ViewGroup.MarginLayoutParams) rVar).width);
            i11 = o0.s(true, this.f42692q.k(), this.f42802l, i13, ((ViewGroup.MarginLayoutParams) rVar).height);
        } else {
            int s10 = o0.s(false, s12, i10, i13, ((ViewGroup.MarginLayoutParams) rVar).height);
            int s11 = o0.s(true, this.f42692q.k(), this.f42801k, i14, ((ViewGroup.MarginLayoutParams) rVar).width);
            i11 = s10;
            i12 = s11;
        }
        x1(i12, i11, view, z10);
    ...
    public final void x1(int i10, int i11, View view, boolean z10) {
        ...
        if (z10) {
            if (this.f42798g && o0.N(view.getMeasuredWidth(), i10, ((ViewGroup.MarginLayoutParams) p0Var).width) && o0.N(view.getMeasuredHeight(), i11, ((ViewGroup.MarginLayoutParams) p0Var).height)) {
                u02 = false;
            } else {
                u02 = true;
            }
