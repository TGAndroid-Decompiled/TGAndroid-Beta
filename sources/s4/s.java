...
public class s extends c0 {
    ...
    public final void A0(z0 z0Var, a0 a0Var, a0.h hVar) {
        ...
        for (int i11 = 0; i11 < this.J && a0Var.b(z0Var) && i10 > 0; i11++) {
            int i12 = a0Var.d;
            hVar.b(i12, Math.max(0, a0Var.f42900g));
            i10 -= this.O.i(i12);
            a0Var.d += a0Var.e;
        }
    }
    ...
    public void V(RecyclerView recyclerView, int i10, int i11) {
        this.O.j();
        ((SparseIntArray) this.O.f9274b).clear();
    }
    ...
    public final void a1(of.e eVar, z0 z0Var, i2.l0 l0Var, int i10) {
        boolean z10;
        A1();
        if (z0Var.b() > 0 && !z0Var.f43091g) {
            if (i10 == 1) {
                z10 = true;
            } else {
                z10 = false;
            }
            int u12 = u1(l0Var.f10776b, eVar, z0Var);
            if (z10) {
                while (u12 > 0) {
    ...
    public void b0(of.e eVar, z0 z0Var) {
        ...
        if (z10) {
            ...
            for (int i10 = 0; i10 < r10; i10++) {
                ...
                int b10 = rVar.b();
                sparseIntArray2.put(b10, rVar.f43042f);
    ...
    public final void r0(Rect rect, int i10, int i11) {
        ...
        if (this.f42917o == 1) {
            ...
            int[] iArr = this.K;
            g10 = o0.g(i10, iArr[iArr.length - 1] + E, this.f43022b.getMinimumWidth());
        } else {
            int width = rect.width() + E;
            RecyclerView recyclerView2 = this.f43022b;
            WeakHashMap weakHashMap2 = r0.i0.f42096a;
            g10 = o0.g(i10, width, recyclerView2.getMinimumWidth());
            int[] iArr2 = this.K;
            g11 = o0.g(i11, iArr2[iArr2.length - 1] + C, this.f43022b.getMinimumHeight());
        }
        this.f43022b.setMeasuredDimension(g10, g11);
    }
    ...
    public void w1(View view, int i10, boolean z10) {
        ...
        int s12 = s1(rVar.e, rVar.f43042f);
        if (this.f42917o == 1) {
            i12 = o0.s(false, s12, i10, i14, ((ViewGroup.MarginLayoutParams) rVar).width);
            i11 = o0.s(true, this.f42919q.k(), this.f43029l, i13, ((ViewGroup.MarginLayoutParams) rVar).height);
        } else {
            int s10 = o0.s(false, s12, i10, i13, ((ViewGroup.MarginLayoutParams) rVar).height);
            int s11 = o0.s(true, this.f42919q.k(), this.f43028k, i14, ((ViewGroup.MarginLayoutParams) rVar).width);
            i11 = s10;
            i12 = s11;
        }
        x1(i12, i11, view, z10);
    ...
    public final void x1(int i10, int i11, View view, boolean z10) {
        ...
        if (z10) {
            if (this.f43025g && o0.N(view.getMeasuredWidth(), i10, ((ViewGroup.MarginLayoutParams) p0Var).width) && o0.N(view.getMeasuredHeight(), i11, ((ViewGroup.MarginLayoutParams) p0Var).height)) {
                u02 = false;
            } else {
                u02 = true;
            }
