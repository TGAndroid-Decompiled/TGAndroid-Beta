...
public abstract class n extends s {
    public final long d;
    public final long f46993e;
    public final List f46994f;
    ...
    public final long b(long j10, long j11) {
        ...
        return (int) (f((j11 - this.h) + this.f46996i, j10) - c(j10, j11));
    }
    ...
    public final long e(long j10, long j11) {
        long j12 = this.f47005b;
        long j13 = this.d;
        List list = this.f46994f;
        if (list != null) {
            return (((q) list.get((int) (j10 - j13))).f47002b * 1000000) / j12;
        }
        long d = d(j11);
        if (d != -1 && j10 == (j13 + d) - 1) {
            return j11 - g(j10);
        }
        return (this.f46993e * 1000000) / j12;
    }
    ...
    public final long f(long j10, long j11) {
        ...
        if (d != 0) {
            if (this.f46994f == null) {
                long j13 = (j10 / ((this.f46993e * 1000000) / this.f47005b)) + j12;
                if (j13 >= j12) {
                    if (d == -1) {
                        return j13;
                    }
    ...
    public final long g(long j10) {
        ...
        List list = this.f46994f;
        if (list != null) {
            j11 = ((q) list.get((int) (j10 - j12))).f47001a - this.f47006c;
        } else {
            j11 = (j10 - j12) * this.f46993e;
        }
        return d0.N(j11, 1000000L, this.f47005b);
    }
