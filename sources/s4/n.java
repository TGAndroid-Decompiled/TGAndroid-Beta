...
public abstract class n extends s {
    public final long d;
    public final long e;
    public final List f44026f;
    public final long f44027g;
    public final long h;
    public final long f44028i;
    ...
    public final long b(long j10, long j11) {
        ...
        return (int) (f((j11 - this.h) + this.f44028i, j10) - c(j10, j11));
    }
    ...
    public final long e(long j10, long j11) {
        ...
        if (list != null) {
            return (((q) list.get((int) (j10 - j13))).f44034b * 1000000) / j12;
        }
        long d = d(j11);
        if (d != -1 && j10 == (j13 + d) - 1) {
            return j11 - g(j10);
    ...
    public final long f(long j10, long j11) {
        ...
        if (d != 0) {
            if (this.f44026f == null) {
                long j13 = (j10 / ((this.e * 1000000) / this.f44036b)) + j12;
                if (j13 >= j12) {
                    if (d == -1) {
                        return j13;
                    }
    ...
    public final long g(long j10) {
        ...
        List list = this.f44026f;
        if (list != null) {
            j11 = ((q) list.get((int) (j10 - j12))).f44033a - this.f44037c;
        } else {
            j11 = (j10 - j12) * this.e;
        }
        return d0.N(j11, 1000000L, this.f44036b);
    }
