...
public final class e implements Runnable {
    ...
    public final void run() {
        switch (this.f45798a) {
            case 0:
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f45825a, iVar);
                        jVar.f45839w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f45838u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f45799b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f45800c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f45840x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f45799b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f45837t.remove(arrayList3);
                        return;
                    }
                }
        }
