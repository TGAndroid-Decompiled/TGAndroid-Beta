...
public final class e implements Runnable {
    ...
    public final ArrayList f42705b;
    public final j f42706c;
    ...
    public final void run() {
        switch (this.f42704a) {
            case 0:
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f42726a, iVar);
                        jVar.f42739w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f42738u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ...
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f42706c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f42740x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f42705b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f42737t.remove(arrayList3);
                        return;
                    }
                }
        }
