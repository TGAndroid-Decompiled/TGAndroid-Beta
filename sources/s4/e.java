...
public final class e implements Runnable {
    ...
    public final ArrayList f43004b;
    public final j f43005c;
    ...
    public final void run() {
        switch (this.f43003a) {
            case 0:
                ArrayList arrayList = this.f43004b;
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f43025a, iVar);
                        jVar.f43038w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f43037u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f43004b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f43005c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f43039x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f43004b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f43036t.remove(arrayList3);
                        return;
                    }
                }
        }
