...
public final class e implements Runnable {
    ...
    public final ArrayList f42990b;
    public final j f42991c;
    ...
    public final void run() {
        switch (this.f42989a) {
            case 0:
                ArrayList arrayList = this.f42990b;
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f43011a, iVar);
                        jVar.f43024w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f43023u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f42990b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f42991c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f43025x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f42990b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f43022t.remove(arrayList3);
                        return;
                    }
                }
        }
