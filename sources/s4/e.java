...
public final class e implements Runnable {
    ...
    public final void run() {
        switch (this.f45770a) {
            case 0:
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f45797a, iVar);
                        jVar.f45811w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f45810u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f45771b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f45772c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f45812x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f45771b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f45809t.remove(arrayList3);
                        return;
                    }
                }
        }
