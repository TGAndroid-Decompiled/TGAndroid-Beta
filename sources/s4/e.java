...
public final class e implements Runnable {
    ...
    public final ArrayList f43025b;
    public final j f43026c;
    ...
    public final void run() {
        switch (this.f43024a) {
            case 0:
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f43046a, iVar);
                        jVar.f43059w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f43058u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f43025b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f43026c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f43060x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f43025b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f43057t.remove(arrayList3);
                        return;
                    }
                }
        }
