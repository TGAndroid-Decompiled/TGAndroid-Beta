...
public final class e implements Runnable {
    ...
    public final ArrayList f42732b;
    public final j f42733c;

    public e(j jVar, ArrayList arrayList, int i10) {
        this.f42731a = i10;
        this.f42733c = jVar;
        this.f42732b = arrayList;
    }
    ...
    public final void run() {
        switch (this.f42731a) {
            case 0:
                ArrayList arrayList = this.f42732b;
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f42753a, iVar);
                        jVar.f42766w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f42765u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f42732b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f42733c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f42767x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f42732b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f42764t.remove(arrayList3);
                        return;
                    }
                }
        }
