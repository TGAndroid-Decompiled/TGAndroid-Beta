...
public final class e implements Runnable {
    ...
    public final ArrayList f42701b;
    public final j f42702c;

    public e(j jVar, ArrayList arrayList, int i10) {
        this.f42700a = i10;
        this.f42702c = jVar;
        this.f42701b = arrayList;
    }
    ...
    public final void run() {
        switch (this.f42700a) {
            case 0:
                ArrayList arrayList = this.f42701b;
                ...
                while (true) {
                    ...
                    if (i10 < size) {
                        ...
                        i10++;
                        i iVar = (i) obj;
                        jVar.C(iVar.f42722a, iVar);
                        jVar.f42735w.add(iVar);
                    } else {
                        arrayList.clear();
                        jVar.f42734u.remove(arrayList);
                        return;
                    }
                }
            case 1:
                ArrayList arrayList2 = this.f42701b;
                int size2 = arrayList2.size();
                int i11 = 0;
                while (true) {
                    j jVar2 = this.f42702c;
                    if (i11 < size2) {
                        Object obj2 = arrayList2.get(i11);
                        i11++;
                        h hVar = (h) obj2;
                        jVar2.B(hVar);
                        jVar2.f42736x.add(hVar);
                    } else {
                        arrayList2.clear();
            ...
            default:
                ArrayList arrayList3 = this.f42701b;
                ...
                while (true) {
                    ...
                    if (size4 >= 0) {
                        ...
                        arrayList3.clear();
                        jVar3.f42733t.remove(arrayList3);
                        return;
                    }
                }
        }
