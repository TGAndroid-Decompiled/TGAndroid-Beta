...
public final class f0 extends androidx.emoji2.text.g {
    ...
    public final int b(View view) {
        ...
        switch (this.d) {
            case 0:
                ...
                ((c0) this.f1343b).getClass();
                Rect rect = ((p0) view.getLayoutParams()).f45858b;
    ...
    public final int e() {
        switch (this.d) {
            case 0:
                return ((c0) this.f1343b).f45851m;
            default:
                return ((c0) this.f1343b).f45852n;
        }
    }
    ...
    public final int f() {
        ...
        switch (this.d) {
            case 0:
                c0 c0Var = (c0) this.f1343b;
                i10 = c0Var.f45851m;
                E = c0Var.E();
                break;
            default:
                c0 c0Var2 = (c0) this.f1343b;
                i10 = c0Var2.f45852n;
                E = c0Var2.C();
                break;
        }
    ...
    public final int g() {
        switch (this.d) {
            case 0:
                return ((c0) this.f1343b).E();
            default:
                return ((c0) this.f1343b).C();
        }
    }
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((c0) this.f1343b).f45849k;
            default:
                return ((c0) this.f1343b).f45850l;
        }
    }
    ...
    public final int j() {
        switch (this.d) {
            case 0:
                return ((c0) this.f1343b).D();
            default:
                return ((c0) this.f1343b).J();
        }
    }
    ...
    public final int k() {
        switch (this.d) {
            case 0:
                c0 c0Var = (c0) this.f1343b;
                return (c0Var.f45851m - c0Var.D()) - c0Var.E();
            default:
                return ((c0) this.f1343b).K();
        }
    }
    ...
    public final int l(View view) {
        switch (this.d) {
            case 0:
                Rect rect = (Rect) this.f1344c;
                ((c0) this.f1343b).L(view, rect);
                return rect.right;
            default:
                Rect rect2 = (Rect) this.f1344c;
                ((c0) this.f1343b).L(view, rect2);
                return rect2.bottom;
        }
    }
    ...
    public final void n(int i10) {
        switch (this.d) {
            case 0:
                RecyclerView recyclerView = ((c0) this.f1343b).f45842b;
                if (recyclerView != null) {
                    int y3 = recyclerView.f1872e.y();
                    for (int i11 = 0; i11 < y3; i11++) {
                        recyclerView.f1872e.x(i11).offsetLeftAndRight(i10);
                    }
                    return;
                }
                return;
            default:
                RecyclerView recyclerView2 = ((c0) this.f1343b).f45842b;
                if (recyclerView2 != null) {
                    int y10 = recyclerView2.f1872e.y();
                    for (int i12 = 0; i12 < y10; i12++) {
                        recyclerView2.f1872e.x(i12).offsetTopAndBottom(i10);
                    }
                    return;
                }
                return;
