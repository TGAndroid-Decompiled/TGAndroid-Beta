...
public final class f0 extends androidx.emoji2.text.g {
    ...
    public final int b(View view) {
        ...
        switch (this.d) {
            case 0:
                ...
                ((c0) this.f2323b).getClass();
                Rect rect = ((p0) view.getLayoutParams()).f43068b;
    ...
    public final int e() {
        switch (this.d) {
            case 0:
                return ((c0) this.f2323b).f43062m;
            default:
                return ((c0) this.f2323b).f43063n;
        }
    }
    ...
    public final int g() {
        switch (this.d) {
            case 0:
                return ((c0) this.f2323b).E();
            default:
                return ((c0) this.f2323b).C();
        }
    }
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((c0) this.f2323b).f43060k;
            default:
                return ((c0) this.f2323b).f43061l;
        }
    }
    ...
    public final int j() {
        switch (this.d) {
            case 0:
                return ((c0) this.f2323b).D();
            default:
                return ((c0) this.f2323b).J();
        }
    }
    ...
    public final int k() {
        switch (this.d) {
            case 0:
                c0 c0Var = (c0) this.f2323b;
                return (c0Var.f43062m - c0Var.D()) - c0Var.E();
            default:
    ...
    public final int l(View view) {
        switch (this.d) {
            case 0:
                Rect rect = (Rect) this.f2324c;
                ((c0) this.f2323b).L(view, rect);
                return rect.right;
            default:
                Rect rect2 = (Rect) this.f2324c;
                ((c0) this.f2323b).L(view, rect2);
                return rect2.bottom;
        }
    }
    ...
    public final void n(int i10) {
        switch (this.d) {
            case 0:
                RecyclerView recyclerView = ((c0) this.f2323b).f43054b;
                ...
                return;
            default:
                RecyclerView recyclerView2 = ((c0) this.f2323b).f43054b;
