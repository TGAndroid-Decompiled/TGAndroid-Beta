...
public class y extends n0 {
    ...
    public float f43105r;
    public float f43106s;
    public float v;
    public final v f43108x;
    public final ArrayList f43100a = new ArrayList();
    public final float[] f43101b = new float[2];
    public c1 f43102c = null;
    public int f43107w = -1;
    public int f43109y = 0;
    ...
    public final void c(Canvas canvas, RecyclerView recyclerView) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            c1 c1Var2 = uVar.e;
            float f12 = uVar.f43077a;
            float f13 = uVar.f43079c;
            if (f12 == f13) {
                uVar.f43082r = c1Var2.f42960a.getTranslationX();
            } else {
                uVar.f43082r = e2.z(f13, f12, uVar.f43085x, f12);
            }
            float f14 = uVar.f43078b;
            float f15 = uVar.d;
            if (f14 == f15) {
                uVar.f43083s = c1Var2.f42960a.getTranslationY();
            } else {
                uVar.f43083s = e2.z(f15, f14, uVar.f43085x, f14);
            }
            int save = canvas.save();
            vVar.m(canvas, recyclerView, uVar.e, uVar.f43082r, uVar.f43083s, uVar.f43080f, false);
    ...
    public final void d(Canvas canvas, RecyclerView recyclerView) {
        ...
        c1 c1Var = this.f43102c;
        this.f43108x.getClass();
        ArrayList arrayList = this.F;
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            int save = canvas.save();
            View view = ((u) arrayList.get(i10)).e.f42960a;
            canvas.restoreToCount(save);
        }
        if (c1Var != null) {
        ...
        if (recyclerView != wl0Var) {
            ...
            if (recyclerView != null) {
                ...
                while (true) {
                    ...
                    this.f43108x.a(this.H, ((u) arrayList2.get(0)).e);
                }
                arrayList2.clear();
                this.M = null;
            ...
            if (wl0Var != null) {
                wl0Var.getResources();
                this.f43103f = AndroidUtilities.dp(120.0f);
    ...
    public final int g(c1 c1Var, int i10) {
        ...
        if ((i10 & 12) != 0) {
            ...
            VelocityTracker velocityTracker = this.J;
            v vVar = this.f43108x;
            if (velocityTracker != null && this.f43107w > -1) {
                velocityTracker.computeCurrentVelocity(1000, vVar.h(this.h));
                float xVelocity = this.J.getXVelocity(this.f43107w);
                float yVelocity = this.J.getYVelocity(this.f43107w);
                if (xVelocity > 0.0f) {
                    i12 = 8;
                }
                float abs = Math.abs(xVelocity);
                if ((i12 & i10) != 0 && i11 == i12 && abs >= vVar.f(this.f43103f) && abs > Math.abs(yVelocity)) {
                    return i12;
                }
            }
            float g10 = vVar.g() * this.H.getWidth();
            if ((i10 & i11) != 0 && Math.abs(this.f43104n) > g10) {
                return i11;
            }
            return 0;
        }
                ...
                if (c1Var != null) {
                    ...
                    if (b10 != 0) {
                        ...
                        if (abs3 >= f12 || abs4 >= f12) {
                            ...
                            this.f43105r = 0.0f;
                            this.f43104n = 0.0f;
                            this.f43107w = motionEvent.getPointerId(0);
                            p(c1Var, 1);
                        }
                    }
                }
    ...
    public final int i(c1 c1Var, int i10) {
        ...
        if ((i10 & 3) != 0) {
            ...
            if (velocityTracker != null && this.f43107w > -1) {
                ...
                if ((i12 & i10) != 0 && i12 == i11 && abs >= vVar.f(this.f43103f) && abs > Math.abs(xVelocity)) {
                    return i12;
                }
            }
            float g10 = vVar.g() * this.H.getHeight();
            if ((i10 & i11) != 0 && Math.abs(this.f43105r) > g10) {
                return i11;
            }
            return 0;
        }
    ...
    public final View k(MotionEvent motionEvent) {
        ...
        if (c1Var != null) {
            ...
            if (m(view, x10, y3, this.f43106s + this.f43104n, this.v + this.f43105r)) {
                return view;
            }
        }
        ArrayList arrayList = this.F;
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            u uVar = (u) arrayList.get(size);
            View view2 = uVar.e.f42960a;
            if (m(view2, x10, y3, uVar.f43082r, uVar.f43083s)) {
                return view2;
            }
        }
    ...
    public final void l(float[] fArr) {
        if ((this.E & 12) != 0) {
            fArr[0] = (this.f43106s + this.f43104n) - this.f43102c.f42960a.getLeft();
        } else {
            fArr[0] = this.f43102c.f42960a.getTranslationX();
        }
        if ((this.E & 3) != 0) {
            fArr[1] = (this.v + this.f43105r) - this.f43102c.f42960a.getTop();
        } else {
            fArr[1] = this.f43102c.f42960a.getTranslationY();
        }
    }
    ...
    public final void n(c1 c1Var) {
        ...
        int i11;
        int i12;
        if (!this.H.isLayoutRequested() && this.f43109y == 2) {
            v vVar = this.f43108x;
            vVar.getClass();
            int i13 = (int) (this.f43106s + this.f43104n);
            int i14 = (int) (this.v + this.f43105r);
            ...
            if (Math.abs(i14 - view2.getTop()) >= view2.getHeight() * 0.5f || Math.abs(i13 - view2.getLeft()) >= view2.getWidth() * 0.5f) {
                ...
                int round = Math.round(this.f43106s + this.f43104n);
                int round2 = Math.round(this.v + this.f43105r);
                ...
                if (arrayList3.size() != 0) {
                    ...
                    while (i24 < size2) {
                        ...
                        if (left2 > 0 && (right = c1Var3.f42960a.getRight() - width2) < 0) {
                            arrayList = arrayList3;
                            if (c1Var3.f42960a.getRight() > view3.getRight() && (abs4 = Math.abs(right)) > i23) {
                                i23 = abs4;
                                c1Var2 = c1Var3;
                            }
                        } else {
                        ...
                        if (left2 < 0 && (left = c1Var3.f42960a.getLeft() - i22) > 0 && c1Var3.f42960a.getLeft() < view3.getLeft() && (abs3 = Math.abs(left)) > i23) {
                            i23 = abs3;
                            c1Var2 = c1Var3;
                        }
                        if (top2 < 0 && (top = c1Var3.f42960a.getTop() - i14) > 0 && c1Var3.f42960a.getTop() < view3.getTop() && (abs2 = Math.abs(top)) > i23) {
                            i23 = abs2;
                            c1Var2 = c1Var3;
                        }
                        if (top2 > 0 && (bottom = c1Var3.f42960a.getBottom() - height2) < 0 && c1Var3.f42960a.getBottom() > view3.getBottom() && (abs = Math.abs(bottom)) > i23) {
                            i23 = abs;
                            c1Var2 = c1Var3;
                        }
                        i24++;
                    ...
                    if (vVar.n(this.H, c1Var, c1Var2)) {
                        this.f43108x.o(this.H, c1Var, c1Var2, b10, i22, i14);
                    }
                }
            }
        }
    ...
    public final void r(c1 c1Var) {
        ...
        if ((vVar.b(e, recyclerView.getLayoutDirection()) & 16711680) != 0) {
            if (c1Var.f42960a.getParent() != this.H) {
    ...
    public final void s(int i10, int i11, MotionEvent motionEvent) {
        ...
        float f7 = x10 - this.d;
        this.f43104n = f7;
        this.f43105r = y3 - this.e;
        if ((i10 & 4) == 0) {
            this.f43104n = Math.max(0.0f, f7);
        }
        if ((i10 & 8) == 0) {
            this.f43104n = Math.min(0.0f, this.f43104n);
        }
        if ((i10 & 1) == 0) {
            this.f43105r = Math.max(0.0f, this.f43105r);
        }
        if ((i10 & 2) == 0) {
            this.f43105r = Math.min(0.0f, this.f43105r);
        }
    }
}
