...
public final class q implements Runnable {
    ...
    public static final fb.i f43070f = new fb.i(5);
    public ArrayList f43071a;
    public long f43072b;
    public long f43073c;
    public ArrayList d;
    ...
    public final void a(RecyclerView recyclerView, int i10, int i11) {
        if (recyclerView.G && this.f43072b == 0) {
            this.f43072b = recyclerView.getNanoTime();
    ...
    public final void b(long j3) {
        ...
        ArrayList arrayList2 = this.f43071a;
        ...
        Collections.sort(arrayList, f43070f);
        for (int i16 = 0; i16 < arrayList.size() && (recyclerView = (pVar = (p) arrayList.get(i16)).d) != null; i16++) {
            ...
            if (c10 != null && c10.f42962b != null && c10.g() && !c10.h() && (recyclerView2 = (RecyclerView) c10.f42962b.get()) != null) {
    ...
    public final void run() {
        ArrayList arrayList = this.f43071a;
        try {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if (j3 != 0) {
                    b(TimeUnit.MILLISECONDS.toNanos(j3) + this.f43073c);
                }
            }
            this.f43072b = 0L;
            Trace.endSection();
