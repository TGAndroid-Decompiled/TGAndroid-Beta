...
public final class b1 implements Runnable {
    ...
    public b1(RecyclerView recyclerView) {
        ...
        this.e = false;
        this.f42944f = false;
        this.f42943c = new OverScroller(recyclerView.getContext(), m2Var);
    }
    ...
    public final void b(int i10, int i11, int i12, Interpolator interpolator) {
        ...
        if (this.d != interpolator) {
            this.d = interpolator;
            this.f42943c = new OverScroller(recyclerView.getContext(), interpolator);
        }
        this.f42942b = 0;
        this.f42941a = 0;
        recyclerView.setScrollState(2);
        this.f42943c.startScroll(0, 0, i10, i11, i15);
        if (Build.VERSION.SDK_INT < 23) {
            this.f42943c.computeScrollOffset();
        }
        a();
    }
    ...
    public final void run() {
        ...
        if (recyclerView.f2860x == null) {
            ...
            recyclerView.removeCallbacks(this);
            this.f42943c.abortAnimation();
            return;
        }
        this.f42944f = false;
        this.e = true;
        recyclerView.p();
        OverScroller overScroller = this.f42943c;
        recyclerView.O0 = true;
        if (overScroller.computeScrollOffset()) {
            int currX = overScroller.getCurrX();
            int currY = overScroller.getCurrY();
            int i15 = currX - this.f42941a;
            int i16 = currY - this.f42942b;
            this.f42941a = currX;
            this.f42942b = currY;
