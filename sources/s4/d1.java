    ...
    public final void c(View view, s0.d dVar) {
        ...
        switch (this.d) {
            ...
            default:
                ...
                this.f42095a.onInitializeAccessibilityNodeInfo(view, accessibilityNodeInfo);
    ...
    public final boolean d(View view, int i10, Bundle bundle) {
        switch (this.d) {
            case 0:
                ...
                RecyclerView recyclerView2 = e1Var.d;
                if (!recyclerView.Z() && recyclerView2.getLayoutManager() != null) {
                    of.e eVar = recyclerView2.getLayoutManager().f43052b.f2832b;
                }
                return false;
            default:
                z4.g gVar = (z4.g) this.e;
                ...
                if (i10 != 4096) {
                    if (i10 == 8192 && gVar.canScrollHorizontally(-1)) {
                        gVar.setCurrentItem(gVar.f48403f - 1);
                        return true;
                    }
