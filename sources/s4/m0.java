...
public abstract class m0 {
    ...
    public TimeInterpolator f43045i;
    public TimeInterpolator f43046j;
    public TimeInterpolator f43047k;
    public long f43048l;

    public static int b(c1 c1Var) {
        int i10 = c1Var.f42969l;
        int i11 = i10 & 14;
        if (c1Var.h()) {
            return 4;
        }
    ...
    public final void d(c1 c1Var) {
        l.d dVar = this.f43040a;
        if (dVar != null) {
            RecyclerView recyclerView = (RecyclerView) dVar.f13924a;
            boolean z10 = true;
            c1Var.q(true);
            View view = c1Var.f42961a;
            if (c1Var.f42967j != null && c1Var.f42968k == null) {
                c1Var.f42967j = null;
            }
            c1Var.f42968k = null;
            if ((c1Var.f42969l & 16) == 0) {
    ...
    public final void e() {
        ArrayList arrayList = this.f43041b;
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            uk0 uk0Var = (uk0) arrayList.get(i10);
            uk0Var.f28807a.c(uk0Var.f28808b, uk0Var.f28809c, uk0Var.d, false);
        }
        arrayList.clear();
    }
    ...
    public long i() {
        return Math.max(this.f43043f, this.f43044g);
    }
    ...
    public final void o(TimeInterpolator timeInterpolator) {
        ...
        this.f43045i = timeInterpolator;
        this.f43046j = timeInterpolator;
        this.f43047k = timeInterpolator;
    }
}
