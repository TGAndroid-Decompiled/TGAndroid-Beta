...
public abstract class o0 {
    public lf.h f43066a;
    public RecyclerView f43067b;
    public final m5.e f43068c;
    public final m5.e d;
    public y0 e;
    ...
    public static int v(View view) {
        return view.getBottom() + ((p0) view.getLayoutParams()).f43081b.bottom;
    }

    public static void w(View view, Rect rect) {
        int[] iArr = RecyclerView.P0;
        p0 p0Var = (p0) view.getLayoutParams();
        Rect rect2 = p0Var.f43081b;
    ...
    public static int x(View view) {
        return view.getLeft() - ((p0) view.getLayoutParams()).f43081b.left;
    }
    ...
    public static int y(View view) {
        return view.getRight() + ((p0) view.getLayoutParams()).f43081b.right;
    }

    public static int z(View view) {
        return view.getTop() - ((p0) view.getLayoutParams()).f43081b.top;
    }
    ...
    public final int B() {
        h0 h0Var;
        RecyclerView recyclerView = this.f43067b;
    ...
    public int K() {
        return (this.f43076n - F()) - C();
    }

    public final void L(View view, Rect rect) {
        Matrix matrix;
        Rect rect2 = ((p0) view.getLayoutParams()).f43081b;
        rect.set(-rect2.left, -rect2.top, view.getWidth() + rect2.right, view.getHeight() + rect2.bottom);
        if (this.f43067b != null && (matrix = view.getMatrix()) != null && !matrix.isIdentity()) {
            RectF rectF = this.f43067b.v;
            rectF.set(rect);
    ...
    public final void M(View view) {
        ...
        if (parent == recyclerView && recyclerView.indexOfChild(view) != -1) {
            c1 V = RecyclerView.V(view);
            V.a(128);
            this.f43067b.f2846f.E(V);
            return;
        }
        throw new IllegalArgumentException("View should be fully attached to be ignored" + this.f43067b.D());
    }

    public void P(View view) {
        p0 p0Var = (p0) view.getLayoutParams();
        Rect X = this.f43067b.X(view);
        int i10 = X.left + X.right;
        int i11 = X.top + X.bottom;
        int s10 = s(d(), this.f43075m, this.f43073k, E() + D() + ((ViewGroup.MarginLayoutParams) p0Var).leftMargin + ((ViewGroup.MarginLayoutParams) p0Var).rightMargin + i10, ((ViewGroup.MarginLayoutParams) p0Var).width);
        int s11 = s(e(), this.f43076n, this.f43074l, C() + F() + ((ViewGroup.MarginLayoutParams) p0Var).topMargin + ((ViewGroup.MarginLayoutParams) p0Var).bottomMargin + i11, ((ViewGroup.MarginLayoutParams) p0Var).height);
    ...
    public void S(of.e eVar, z0 z0Var, s0.d dVar) {
        ...
        if (this.f43067b.canScrollVertically(-1) || this.f43067b.canScrollHorizontally(-1)) {
            dVar.a(8192);
    ...
    public final void T(View view, s0.d dVar) {
        c1 V = RecyclerView.V(view);
        if (V != null && !V.j()) {
            lf.h hVar = this.f43066a;
            if (!((ArrayList) hVar.d).contains(V.f42974a)) {
                RecyclerView recyclerView = this.f43067b;
                U(recyclerView.f2840b, recyclerView.f2863t0, view, dVar);
            }
        }
    }
    ...
    public void U(of.e eVar, z0 z0Var, View view, s0.d dVar) {
        ...
        dVar.f42923a.setCollectionItemInfo(AccessibilityNodeInfo.CollectionItemInfo.obtain(i10, 1, i11, 1, false, false));
    }
    ...
    public final void a(View view, int i10, boolean z10) {
        ...
        c1 V = RecyclerView.V(view);
        if (!z10 && !V.j()) {
            this.f43067b.f2846f.B(V);
        } else {
            a0.f fVar = (a0.f) this.f43067b.f2846f.f20269b;
        ...
        p0 p0Var = (p0) view.getLayoutParams();
        if (!V.s() && !V.k()) {
            if (view.getParent() == this.f43067b) {
                lf.h hVar = this.f43066a;
                e6.n nVar = (e6.n) hVar.f14216c;
                int indexOfChild = ((RecyclerView) ((ka.c) hVar.f14215b).f13566b).indexOfChild(view);
                if (indexOfChild == -1 || nVar.C(indexOfChild)) {
                    y3 = -1;
                } else {
                ...
                if (y3 != -1) {
                    if (y3 != i10) {
                        ...
                        if (q6 != null) {
                            ...
                            if (V2.j()) {
                                a0.f fVar2 = (a0.f) o0Var.f43067b.f2846f.f20269b;
                                i1 i1Var2 = (i1) fVar2.get(V2);
                                if (i1Var2 == null) {
                                    i1Var2 = i1.a();
                                    fVar2.put(V2, i1Var2);
                                }
                                i1Var2.f43028a = 1 | i1Var2.f43028a;
                            } else {
                                o0Var.f43067b.f2846f.B(V2);
                            }
                            o0Var.f43066a.t(q6, i10, p0Var2, V2.j());
                        } else {
                            throw new IllegalArgumentException("Cannot move a child from non-existing index:" + y3 + o0Var.f43067b.toString());
                        }
                    }
                } else {
                    throw new IllegalStateException("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:" + this.f43067b.indexOfChild(view) + this.f43067b.D());
                }
            } else {
                this.f43066a.s(view, i10, false);
                p0Var.f43082c = true;
                y0 y0Var = this.e;
                if (y0Var != null && y0Var.e) {
                    y0Var.f43125b.getClass();
                    if (RecyclerView.T(view) == y0Var.f43124a) {
                        y0Var.f43127f = view;
                    }
                }
            }
            ...
            this.f43066a.t(view, i10, view.getLayoutParams(), false);
        }
        if (p0Var.d) {
            V.f42974a.invalidate();
            p0Var.d = false;
        }
    }
    ...
    public final void h0(of.e eVar) {
        ArrayList arrayList = (ArrayList) eVar.f15696c;
        int size = ((ArrayList) eVar.f15696c).size();
        for (int i10 = size - 1; i10 >= 0; i10--) {
            View view = ((c1) arrayList.get(i10)).f42974a;
            c1 V = RecyclerView.V(view);
            if (!V.r()) {
                V.q(false);
                if (V.l()) {
                    this.f43067b.removeDetachedView(view, false);
                }
                m0 m0Var = this.f43067b.f2843c0;
                if (m0Var != null) {
                    m0Var.f(V);
                }
                V.q(true);
    ...
    public final void j0(int i10) {
        if (q(i10) != null) {
            ...
            View childAt = ((RecyclerView) cVar.f13566b).getChildAt(J);
            if (childAt != null) {
                if (((e6.n) hVar.f14216c).F(J)) {
                    hVar.Y(childAt);
                }
                cVar.h0(J);
            }
    ...
    public final void q0(int i10, int i11) {
        this.f43075m = View.MeasureSpec.getSize(i10);
        int mode = View.MeasureSpec.getMode(i10);
        this.f43073k = mode;
        if (mode == 0 && !RecyclerView.Q0) {
            this.f43075m = 0;
        }
        this.f43076n = View.MeasureSpec.getSize(i11);
    ...
    public void r0(Rect rect, int i10, int i11) {
        ...
        this.f43067b.setMeasuredDimension(g(i10, E, recyclerView.getMinimumWidth()), g(i11, C, this.f43067b.getMinimumHeight()));
    }
    ...
    public final void s0(int i10, int i11) {
        ...
        this.f43067b.f2859r.set(i14, i15, i12, i13);
        r0(this.f43067b.f2859r, i10, i11);
    }

    public int[] t(View view, Rect rect) {
        int D = D();
        int F = F();
        int E = this.f43075m - E();
        int C = this.f43076n - C();
    ...
    public final void t0(RecyclerView recyclerView) {
        if (recyclerView == null) {
            ...
            this.f43067b = recyclerView;
            this.f43066a = recyclerView.e;
            this.f43075m = recyclerView.getWidth();
            this.f43076n = recyclerView.getHeight();
        }
        this.f43073k = 1073741824;
        this.f43074l = 1073741824;
    }
    ...
    public final boolean u0(View view, int i10, int i11, p0 p0Var) {
        if (!view.isLayoutRequested() && this.f43070g && N(view.getWidth(), i10, ((ViewGroup.MarginLayoutParams) p0Var).width) && N(view.getHeight(), i11, ((ViewGroup.MarginLayoutParams) p0Var).height)) {
            return false;
        }
        return true;
    }
    ...
    public final void w0(y0 y0Var) {
        ...
        y0Var.f43125b = recyclerView;
        y0Var.f43126c = this;
        int i10 = y0Var.f43124a;
        if (i10 != -1) {
            recyclerView.f2863t0.f43132a = i10;
            y0Var.e = true;
            y0Var.d = true;
            y0Var.f43127f = recyclerView.f2868x.m(i10);
            y0Var.e();
            y0Var.f43125b.f2858q0.a();
            y0Var.h = true;
            return;
        }
