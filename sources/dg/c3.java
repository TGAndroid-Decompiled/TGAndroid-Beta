...
public abstract class c3 extends ph.d {
    public final fa f4427e0;
    public final RectF f4428f0;
    public int f4429g0;
    public final q3 f4430h0;
    public final f6 f4431i0;
    public int f4432j0;
    public boolean f4433k0;

    public c3(q3 q3Var, ContextThemeWrapper contextThemeWrapper, f6 f6Var, ba baVar) {
        super(contextThemeWrapper, f6Var, false);
        this.f4428f0 = new RectF();
        this.f4432j0 = 8;
        this.f4431i0 = f6Var;
        this.f4430h0 = q3Var;
        this.f4427e0 = new fa(baVar, this, 0, true);
        setWillNotDraw(false);
        setTextColor(-1);
        setFlickeringLoading(true);
        this.d.u(AndroidUtilities.bold());
        removeView(this.f41410r);
    ...
    public void onDraw(Canvas canvas) {
        boolean z4 = this.f41402a0;
        RectF rectF = this.f4428f0;
        if (z4) {
    ...
    public void setAlpha(float f10) {
        n3[] n3VarArr;
        q3 q3Var = this.f4430h0;
        super.setAlpha((!q3Var.f4760y || (n3VarArr = q3Var.E) == null || n3VarArr.length <= 0) ? 0.0f : 0.0f);
    }
    ...
    public void setRad(int i10) {
        this.f4432j0 = i10;
        setForeground(j6.Y(j6.v0(j6.f19996i6, this.f4431i0), i10, i10));
    }
