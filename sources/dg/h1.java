...
public final class h1 extends i {
    public final int f4553n = 2;
    public final Paint f4554r;
    public final Path f4555s;

    public h1(i1 i1Var, Context context) {
        super(i1Var, context);
        Paint paint = new Paint(1);
        this.f4554r = paint;
        this.f4555s = new Path();
        ...
        switch (this.f4553n) {
            case 0:
                ...
                if (showAlpha > 0.0f) {
                    ...
                    canvas.drawPath(path, paint);
                    float f20 = dp + f13;
                    Paint paint2 = this.f4565c;
                    canvas.drawCircle(dp, f20, dpf2, paint2);
                    Paint paint3 = this.f4564b;
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    canvas.drawPath(path2, paint5);
                    float f33 = dp3 + f26;
                    Paint paint6 = this.f4565c;
                    canvas.drawCircle(dp3, f33, dpf22, paint6);
                    Paint paint7 = this.f4564b;
            ...
            case 2:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    canvas.drawPath(path3, paint9);
                    float f46 = dp5 + f39;
                    Paint paint10 = this.f4565c;
                    canvas.drawCircle(dp5, f46, dpf23, paint10);
                    Paint paint11 = this.f4564b;
            ...
            case 3:
                ...
                if (showAlpha4 > 0.0f) {
                    ...
                    canvas.drawPath(path4, paint13);
                    float f59 = dp7 + f52;
                    Paint paint14 = this.f4565c;
                    canvas.drawCircle(dp7, f59, dpf24, paint14);
                    Paint paint15 = this.f4564b;
            ...
            case 4:
                ...
                if (showAlpha5 > 0.0f) {
                    ...
                    canvas.drawPath(path5, paint17);
                    float f72 = dp9 + f65;
                    Paint paint18 = this.f4565c;
                    canvas.drawCircle(dp9, f72, dpf25, paint18);
                    Paint paint19 = this.f4564b;
            ...
            default:
                ...
                if (showAlpha6 > 0.0f) {
                    ...
                    canvas2.drawPath(path6, paint21);
                    float f85 = dp11 + f78;
                    Paint paint22 = this.f4565c;
                    canvas2.drawCircle(dp11, f85, dpf26, paint22);
                    Paint paint23 = this.f4564b;
