...
public final class v1 extends org.telegram.ui.Cells.t1 {
    ...
    public final boolean a2(Canvas canvas) {
        ...
        w1 w1Var = this.Ie;
        o4 o4Var = w1Var.h;
        if (w1Var.f4838f && photoImage != null && (((k5Var = w1Var.e) != null && k5Var.f41859g && k5Var.d && o4Var.f4357u0) || o4Var.f4354r0 || (o4Var.f4356t0 != null && o4Var.J0.F0))) {
            int i10 = 0;
            while (true) {
            ...
            if (textureView != null && o4Var.J0.F0) {
                ...
                if (bitmap != null) {
                    ...
                    canvas.translate(photoImage.getCenterX() - ((o4Var.f4358v0 * max) / 2.0f), photoImage.getCenterY() - ((o4Var.f4359w0 * max) / 2.0f));
                    canvas.scale((o4Var.f4358v0 / o4Var.f4356t0.getWidth()) * max, (o4Var.f4359w0 / o4Var.f4356t0.getHeight()) * max);
                    int width = bitmap.getWidth();
                    int height = bitmap.getHeight();
                    Rect rect = this.Ge;
                    rect.set(0, 0, width, height);
                    RectF rectF2 = this.He;
                    rectF2.set(0.0f, 0.0f, o4Var.f4356t0.getWidth(), o4Var.f4356t0.getHeight());
    ...
    public final void onDraw(Canvas canvas) {
        ...
        w1 w1Var = this.Ie;
        k5 k5Var = w1Var.e;
        if ((k5Var != null && k5Var.f41859g && k5Var.d) || w1Var.h.f4354r0) {
            canvas2 = canvas;
