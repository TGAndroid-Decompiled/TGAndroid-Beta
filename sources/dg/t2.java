...
public final class t2 extends View {
    ...
    public boolean G;
    public s2 H;
    public final Paint f4790a;
    public final Paint f4791b;
    public final Path f4792c;
    ...
    public long f4796s;
    public boolean v;
    public final z5 f4797w;
    public final z5 f4798x;
    public final z5 f4799y;
    ...
    public t2(Context context) {
        ...
        this.f4791b = paint2;
        this.f4792c = new Path();
        this.e = new RectF();
        this.v = true;
        this.f4797w = new z5(this);
        this.f4798x = new z5(this);
        this.f4799y = new z5(this);
    ...
    public final void a(float f10, float f11, float f12, Canvas canvas, boolean z4) {
        if (z4) {
            ...
            canvas.saveLayerAlpha(rectF, (int) (this.f4795r * 255.0f), 31);
        }
        canvas.drawCircle(f10, f11, f12, this.f4791b);
        if (z4) {
            canvas.restore();
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        boolean onTouchEvent = ((GestureDetector) this.d.f21045b).onTouchEvent(motionEvent);
