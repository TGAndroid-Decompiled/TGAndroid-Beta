...
public class l1 extends View {
    ...
    public final Paint f4643f;
    public final Drawable h;
    public boolean f4644n;
    public final ImageReceiver f4645r;
    public final ImageReceiver f4646s;
    public TLRPC.Document v;
    public TLRPC.Document f4647w;
    public boolean f4648x;
    public final float f4649y;
    ...
    public l1(Context context, float f10) {
        ...
        this.f4645r = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver(this);
        this.f4646s = imageReceiver2;
        this.B = 1.0f;
        this.L = new RectF();
        new Path();
    ...
    public final void a(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, f13, f13, this.f4643f);
        boolean z4 = this.f4644n;
        float f14 = this.f4649y;
        RectF rectF2 = this.d;
        if (z4) {
            ...
            if (e > 0.0f) {
                ...
                ImageReceiver imageReceiver = this.f4646s;
            ...
            if (e < 1.0f) {
                ...
                ImageReceiver imageReceiver2 = this.f4645r;
        ...
        if (isEmpty) {
            ...
            MediaDataController.getInstance(i10).getStickerSet(tL_inputStickerSetShortName, 0, false, new Utilities.Callback(this) {
                ...
                public final void run(Object obj) {
                    switch (r3) {
                        case 0:
                            l1 l1Var = this.f4604b;
                            l1Var.getClass();
                            String str2 = str;
                            TLRPC.Document b10 = l1.b(str2, (TLRPC.TL_messages_stickerSet) obj);
                            l1Var.v = b10;
                            l1Var.f4645r.setImage(ImageLocation.getForDocument(b10), "80_80", l1.c(str2), null, null, 0);
                            l1Var.f4646s.setImage(ImageLocation.getForDocument(l1Var.f4647w), "80_80", ImageLocation.getForDocument(l1Var.v), "80_80", null, null, l1.c(str2), 0L, null, null, 0);
                            return;
                        default:
                            l1 l1Var2 = this.f4604b;
                            l1Var2.getClass();
                            String str3 = str;
                            TLRPC.Document b11 = l1.b(str3, (TLRPC.TL_messages_stickerSet) obj);
                            l1Var2.f4647w = b11;
                            if (b11 != null) {
                                l1Var2.f4646s.setImage(ImageLocation.getForDocument(b11), "80_80", ImageLocation.getForDocument(l1Var2.v), "80_80", null, null, l1.c(str3), 0L, null, null, 0);
                                return;
                            }
                            return;
                    }
            ...
            imageReceiver.setImage(ImageLocation.getForDocument(this.f4647w), "80_80", ImageLocation.getForDocument(this.v), "80_80", null, null, c(str), 0L, null, null, 0);
        }
        this.f4642c = true;
        requestLayout();
    }
    ...
    public final void f() {
        ...
        if (min < 0.4f) {
            ...
            f11 = 1.0f;
            this.C = new StaticLayout(this.f4641b, textPaint, (int) Math.ceil(measureText), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        }
        this.D = 0.0f;
    ...
    public TLRPC.Document getCodeEmojiDocument() {
        ...
        if (this.I && (document = this.f4647w) != null) {
            return document;
        }
        return this.v;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.H = true;
        if (this.I) {
            this.f4646s.onAttachedToWindow();
        } else {
            this.f4645r.onAttachedToWindow();
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.H = false;
        this.f4645r.onDetachedFromWindow();
        this.f4646s.onDetachedFromWindow();
    }
