...
public final class k0 extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f4613a) {
            case 4:
                ...
                ((k01) this.f4614b).e(canvas, ((wc0) this.f4615c).getX() - AndroidUtilities.dp(50.0f), getHeight() / 2.0f);
                return;
            case 5:
                canvas.save();
                v21 v21Var = (v21) this.f4615c;
                float e = ((z5) this.f4614b).e(v21Var.f29347w);
                if (e > 0.0f) {
                    if (v21Var.f29342c == null) {
                        v21Var.f29342c = new cp0(this);
                    }
                    canvas.translate(getWidth() / 2.0f, getHeight() / 2.0f);
                    v21Var.f29342c.a(canvas, e);
                    canvas.translate((-getWidth()) / 2.0f, (-getHeight()) / 2.0f);
                }
                super.dispatchDraw(canvas);
                canvas.restore();
                return;
            case 6:
                RectF rectF = (RectF) this.f4614b;
                rectF.set(0.0f, 0.0f, getWidth(), getHeight());
                org.telegram.ui.Components.voip.n1 n1Var = (org.telegram.ui.Components.voip.n1) this.f4615c;
                n1Var.d(getX(), getY());
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f4613a) {
            case 0:
                Paint paint = (Paint) this.f4614b;
                super.onDraw(canvas);
                e1 e1Var = (e1) this.f4615c;
                TextView textView3 = (TextView) getChildAt(e1Var.f4463d1);
                int i10 = e1Var.f4465e1;
                Layout layout = null;
                if (i10 != -1) {
                ...
                if (layout == null) {
                    ...
                    interpolation = nr.f27346f.getInterpolation(e1Var.f4467f1);
                }
                ...
                return;
            case 3:
                canvas.drawPath((Path) this.f4615c, (Paint) this.f4614b);
                super.onDraw(canvas);
                return;
            case 8:
                Paint paint2 = (Paint) this.f4614b;
                super.onDraw(canvas);
                c5 c5Var = (c5) this.f4615c;
                ...
                if (layout4 != null) {
                    ...
                    if (layout3 == null) {
                        ...
                        interpolation2 = nr.f27346f.getInterpolation(c5Var.X0);
                    }
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f4613a) {
            case 1:
                View view = (View) this.f4614b;
                org.telegram.ui.ActionBar.w0 w0Var = (org.telegram.ui.ActionBar.w0) this.f4615c;
                w0Var.f20649b.measure(i10, i11);
                if (w0Var.f20649b.getSwipeBack() != null) {
                    view.getLayoutParams().width = w0Var.f20649b.getSwipeBack().getChildAt(0).getMeasuredWidth();
                } else {
                    view.getLayoutParams().width = w0Var.f20649b.getMeasuredWidth() - AndroidUtilities.dp(16.0f);
                }
                super.onMeasure(i10, i11);
                return;
            case 3:
                super.onMeasure(i10, i11);
                Path path = (Path) this.f4615c;
                path.rewind();
    ...
    public k0(v21 v21Var, Context context) {
        ...
        this.f4613a = 5;
        this.f4615c = v21Var;
        this.f4614b = new z5(this, 360L, nr.h);
    }
