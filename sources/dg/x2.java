...
public abstract class x2 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        int i10;
        float f10;
        Rect rect = this.f4849n;
        Paint paint = this.f4846b;
        RectF rectF = this.f4850r;
        Path path = this.h;
        super.onDraw(canvas);
        float min = Math.min(getWidth(), getHeight()) * 0.2f;
        float width = this.e * getWidth();
        float height = this.f4848f * getHeight();
        int round = Math.round(this.e * this.f4845a.getWidth());
        int round2 = Math.round(this.f4848f * this.f4845a.getHeight());
        Bitmap bitmap = this.f4845a;
        int pixel = bitmap.getPixel(Utilities.clamp(round, bitmap.getWidth() - 1, 0), Utilities.clamp(round2, this.f4845a.getHeight() - 1, 0));
        this.f4851s = pixel;
        Paint paint2 = this.d;
        paint2.setColor(pixel);
        float f11 = this.f4853x;
        if (f11 != 0.0f && f11 != 1.0f) {
            RectF rectF2 = AndroidUtilities.rectTmp;
            f10 = 1.0f;
            i10 = round;
            rectF2.set(width - min, height - min, width + min, height + min);
            canvas.saveLayerAlpha(rectF2, (int) (this.f4853x * 255.0f), 31);
        } else {
            i10 = round;
            f10 = 1.0f;
            canvas.save();
        }
        float f12 = (this.f4853x * 0.5f) + 0.5f;
        ...
        canvas.drawBitmap(this.f4845a, rect, rectF, (Paint) null);
        ...
        canvas.drawPath(path, this.f4847c);
        float f18 = f13 / 2.0f;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 != 0 && i11 != 0 && i12 != 0 && i13 != 0 && isLaidOut()) {
            ...
            this.f4848f = (i13 * this.f4848f) / i11;
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                this.f4848f = motionEvent.getY() / getHeight();
                invalidate();
                return true;
            }
            a(true);
