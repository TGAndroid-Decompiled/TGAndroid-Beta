...
public final class q3 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    public static final int f4737o0 = 0;
    public n3 B;
    public float C;
    public boolean D;
    public n3[] E;
    ...
    public String W;
    public int f4738a;
    public ph.m0 f4739a0;
    public final z5 f4740b;
    public final Matrix f4741b0;
    public final z5 f4742c;
    public float f4743c0;
    public final Paint d;
    public float f4744d0;
    public final Paint e;
    public final t2 f4745e0;
    public final Paint f4746f;
    public boolean f4747f0;
    public final Matrix f4748g0;
    public final Paint h;
    public Path f4749h0;
    public Path f4750i0;
    public final RectF f4751j0;
    public float f4752k0;
    public float f4753l0;
    public final ArrayList m0;
    public final PathMeasure f4754n;
    public final Rect f4755n0;
    public final Path f4756r;
    public final Path f4757s;
    public final Path v;
    public final Path f4758w;
    public volatile boolean f4759x;
    public volatile boolean f4760y;

    public q3(ContextThemeWrapper contextThemeWrapper, f6 f6Var) {
        super(contextThemeWrapper);
        this.f4738a = -1;
        nr nrVar = nr.h;
        this.f4740b = new z5(0.0f, (View) null, 0L, 420L, nrVar);
        this.f4742c = new z5(0.0f, (View) null, 0L, 420L, nrVar);
        ...
        this.h = paint4;
        this.f4754n = new PathMeasure();
        this.f4756r = new Path();
        this.f4757s = new Path();
        this.v = new Path();
        this.f4758w = new Path();
        this.C = 2.0f;
        this.f4741b0 = new Matrix();
        this.f4748g0 = new Matrix();
        this.f4751j0 = new RectF();
        this.m0 = new ArrayList();
        this.f4755n0 = new Rect();
        this.U = f6Var;
        paint.setColor(-1);
    ...
    public final void a() {
        ...
        if (o3Var != null) {
            ...
            o3Var.f4708o = true;
            if (o3Var.f4706m != null) {
                h();
                o3Var.f4706m.run(o3Var.f4698b, o3Var.e.document);
                AndroidUtilities.runOnUIThread(new cg.n0(3), 250L);
            } else if (o3Var.f4704k != null) {
                TLRPC.TL_stickers_replaceSticker tL_stickers_replaceSticker = new TLRPC.TL_stickers_replaceSticker();
                tL_stickers_replaceSticker.sticker = MediaDataController.getInputStickerSetItem(o3Var.f4704k, o3Var.f4699c).document;
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                if (z12) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i12).isStickerPackInstalled(tL_messages_stickerSet.set.f19211id)) {
                                                        MediaDataController.getInstance(i12).toggleStickerSet(null, tLObject2, 2, null, false, false);
                                                    }
                                                    ph.m0 m0Var = q3Var2.f4739a0;
                                                    if (m0Var != null) {
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i13) {
                                                                case 0:
                                                                    ...
                                                                    TLRPC.Document document = o3Var4.f4700f.document;
                                                                    String str = o3Var4.f4705l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject3, document, str, bool);
                                                                    q3Var3.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject3, o3Var4.f4700f.document, o3Var4.f4705l, Boolean.TRUE);
                                                                    q3Var3.h();
                                                                    return;
                                                                default:
                                                                    ...
                                                                    TLRPC.Document document2 = o3Var4.f4700f.document;
                                                                    String str2 = o3Var4.f4705l;
                                                ...
                                                Utilities.Callback callback = o3Var3.f4707n;
                                                if (callback != null) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i132) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i14 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = o3Var42.f4700f.document;
                                                                    String str = o3Var42.f4705l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i14, bool, tLObject32, document, str, bool);
                                                                    q3Var32.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, o3Var42.f4700f.document, o3Var42.f4705l, Boolean.TRUE);
                                                                    q3Var32.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = o3Var42.f4700f.document;
                                                                    String str2 = o3Var42.f4705l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                ...
                                                Utilities.Callback callback2 = o3Var4.f4707n;
                                                if (callback2 != null) {
                                            ...
                                            default:
                                                ...
                                                if (z14) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i14).isStickerPackInstalled(tL_messages_stickerSet2.set.f19211id)) {
                                                        MediaDataController.getInstance(i14).toggleStickerSet(null, tLObject4, 2, null, false, false);
                                                    }
                                                    ph.m0 m0Var3 = q3Var4.f4739a0;
                                                    if (m0Var3 != null) {
                                                ...
                                                Utilities.Callback callback3 = o3Var5.f4707n;
                                                if (callback3 != null) {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                if (z12) {
                                                    ...
                                                    if (!MediaDataController.getInstance(i122).isStickerPackInstalled(tL_messages_stickerSet.set.f19211id)) {
                                                        MediaDataController.getInstance(i122).toggleStickerSet(null, tLObject2, 2, null, false, false);
                                                    }
                                                    ph.m0 m0Var = q3Var22.f4739a0;
                                                    if (m0Var != null) {
                                                        m0Var.setProgress(1.0f);
                                                    }
                                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                                ...
                                                Utilities.Callback callback = o3Var32.f4707n;
                                                if (callback != null) {
                                                    callback.run(Boolean.valueOf(z4));
                                                    o3Var32.f4707n = null;
                                                    return;
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            ...
                                            case 1:
                                                        ...
                                                        public final void run() {
                                                            ...
                                                            switch (i1322) {
                                                                case 0:
                                                                    NotificationCenter notificationCenter = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i142 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document = o3Var422.f4700f.document;
                                                                    String str = o3Var422.f4705l;
                                                                    Boolean bool = Boolean.FALSE;
                                                                    notificationCenter.postNotificationNameOnUIThread(i142, bool, tLObject32, document, str, bool);
                                                                    q3Var322.h();
                                                                    return;
                                                                case 1:
                                                                    NotificationCenter.getInstance(UserConfig.selectedAccount).postNotificationNameOnUIThread(NotificationCenter.customStickerCreated, Boolean.FALSE, tLObject32, o3Var422.f4700f.document, o3Var422.f4705l, Boolean.TRUE);
                                                                    q3Var322.h();
                                                                    return;
                                                                default:
                                                                    NotificationCenter notificationCenter2 = NotificationCenter.getInstance(UserConfig.selectedAccount);
                                                                    int i15 = NotificationCenter.customStickerCreated;
                                                                    TLRPC.Document document2 = o3Var422.f4700f.document;
                                                                    String str2 = o3Var422.f4705l;
                                                                    Boolean bool2 = Boolean.FALSE;
                                                                    notificationCenter2.postNotificationNameOnUIThread(i15, bool2, tLObject32, document2, str2, bool2);
                                                                    q3Var322.h();
                                                                    return;
                                                ...
                                                Utilities.Callback callback2 = o3Var42.f4707n;
                                                if (callback2 != null) {
                                                    callback2.run(Boolean.valueOf(z10));
                                                    o3Var42.f4707n = null;
                                                    return;
                ...
                Utilities.Callback callback = o3Var.f4707n;
                if (callback != null) {
                    callback.run(Boolean.TRUE);
                }
            } else if (o3Var.f4702i != 0) {
                SendMessagesHelper.getInstance(i10).sendSticker(o3Var.f4700f.document, null, o3Var.f4702i, null, null, null, null, null, true, 0, 0, false, null, null, 0L, 0L, null);
                ph.m0 m0Var = this.f4739a0;
                if (m0Var != null) {
                    m0Var.setProgress(1.0f);
                }
                AndroidUtilities.runOnUIThread(new af.b(this, i10, 4), 450L);
                Utilities.Callback callback2 = o3Var.f4707n;
                if (callback2 != null) {
                    callback2.run(Boolean.TRUE);
                    o3Var.f4707n = null;
                }
            } else if (o3Var.f4703j != null) {
                TLRPC.TL_stickers_addStickerToSet tL_stickers_addStickerToSet = new TLRPC.TL_stickers_addStickerToSet();
                tL_stickers_addStickerToSet.stickerset = MediaDataController.getInputStickerSet(o3Var.f4703j);
                                    ...
                                    public final void run() {
                                        ...
                                        switch (r6) {
                                            case 0:
                                                ...
                                                Utilities.Callback callback3 = o3Var32.f4707n;
                                                if (callback3 != null) {
                                            ...
                                            case 1:
                                                ...
                                                Utilities.Callback callback22 = o3Var42.f4707n;
                                                if (callback22 != null) {
                                            ...
                                            default:
                                                ...
                                                Utilities.Callback callback32 = o3Var5.f4707n;
                                                if (callback32 != null) {
        ...
        if (this.E != null) {
            ...
            while (true) {
                ...
                if (n3Var != null) {
                    ...
                    Bitmap bitmap3 = n3Var.f4672g;
                    if (bitmap3 != null) {
                        bitmap3.recycle();
                        n3Var.f4672g = null;
                    }
                    Bitmap bitmap4 = n3Var.f4671f;
                    if (bitmap4 != null) {
                        bitmap4.recycle();
                        n3Var.f4671f = null;
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.fileUploaded) {
            ...
            o3 o3Var2 = this.T;
            if (o3Var2 != null && str.equalsIgnoreCase(o3Var2.f4698b)) {
                o3 o3Var3 = this.T;
                o3Var3.f4701g = inputFile;
                TLRPC.TL_messages_uploadMedia tL_messages_uploadMedia = new TLRPC.TL_messages_uploadMedia();
                tL_messages_uploadMedia.peer = new TLRPC.TL_inputPeerSelf();
                TLRPC.TL_inputMediaUploadedDocument tL_inputMediaUploadedDocument = new TLRPC.TL_inputMediaUploadedDocument();
                tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
                tL_inputMediaUploadedDocument.file = o3Var3.f4701g;
                if (o3Var3.f4712s != null) {
                ...
                tL_documentAttributeSticker.alt = o3Var3.f4699c;
            ...
            o3 o3Var4 = this.T;
            if (o3Var4 != null && str2.equalsIgnoreCase(o3Var4.f4698b)) {
                long longValue = ((Long) objArr[1]).longValue();
                long longValue2 = ((Long) objArr[2]).longValue();
                if (longValue2 > 0) {
                    o3 o3Var5 = this.T;
                    o3Var5.f4714u = Utilities.clamp(((float) longValue) / ((float) longValue2), 1.0f, o3Var5.f4714u);
                    ph.m0 m0Var = this.f4739a0;
                    if (m0Var != null) {
            ...
            o3 o3Var6 = this.T;
            if (o3Var6 != null && str3.equalsIgnoreCase(o3Var6.f4698b)) {
                h();
            }
        } else if (i10 == NotificationCenter.filePreparingStarted) {
            o3 o3Var7 = this.T;
            if (o3Var7 != null && objArr[0] == o3Var7.f4711r) {
                FileLoader.getInstance(UserConfig.selectedAccount).uploadFile(this.T.f4698b, false, true, 67108864);
            }
        } else if (i10 == NotificationCenter.fileNewChunkAvailable) {
            o3 o3Var8 = this.T;
            if (o3Var8 != null && objArr[0] == o3Var8.f4711r) {
                String str4 = (String) objArr[1];
                long longValue3 = ((Long) objArr[2]).longValue();
                long longValue4 = ((Long) objArr[3]).longValue();
                Float f10 = (Float) objArr[4];
                float floatValue = f10.floatValue();
                this.T.f4711r.videoEditedInfo.needUpdateProgress = true;
                FileLoader.getInstance(this.f4738a).checkUploadNewDataAvailable(str4, false, Math.max(1L, longValue3), longValue4, f10);
                o3 o3Var9 = this.T;
                o3Var9.f4713t = Math.max(o3Var9.f4713t, floatValue);
                ph.m0 m0Var2 = this.f4739a0;
                if (m0Var2 != null) {
                    m0Var2.setProgress(this.T.b());
                }
            }
        } else if (i10 == NotificationCenter.filePreparingFailed && (o3Var = this.T) != null && objArr[0] == o3Var.f4711r) {
            h();
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawPath(this.f4758w, this.d);
    }
        ...
        if (n3Var != null) {
            ...
            if (n3Var.f4671f != null && this.I) {
                ...
                if (n3Var2.f4670c != 0) {
                    ...
                    n3 n3Var3 = this.B;
                    matrix.postRotate(n3Var3.f4670c, n3Var3.a().getWidth() / 2.0f, this.B.a().getHeight() / 2.0f);
                    n3 n3Var4 = this.B;
                    if ((n3Var4.f4670c / 90) % 2 != 0) {
    ...
    public final void g(Canvas canvas, boolean z4, ViewGroup viewGroup, boolean z10) {
        ...
        float f10;
        Paint paint;
        z5 z5Var = this.f4742c;
        z5Var.f31239a = viewGroup;
        boolean z12 = this.f4747f0;
        if (z12 || z5Var.f31241c > 0.0f) {
            if (viewGroup == null) {
                e = 1.0f;
            } else {
                if (z12 && !z10) {
            ...
            if (n3VarArr != null) {
                for (n3 n3Var : n3VarArr) {
                    if (n3Var != null && n3Var == this.B) {
                        if (this.C > 0.0f) {
                            if (n3Var.f4684t.f4749h0 != null) {
                                canvas.save();
                                canvas.clipPath(n3Var.f4684t.f4749h0);
                                if (n3Var.f4684t.F != null) {
                                    if (z4) {
                                        paint = n3Var.f4681q;
                                    } else {
                                        paint = n3Var.f4680p;
                                    ...
                                    canvas.drawPath(n3Var.f4676l, paint);
                                    if (n3Var.f4684t.f4749h0 != null && z4) {
                                        canvas.clipPath(n3Var.f4676l);
                                        paint.setStrokeWidth(AndroidUtilities.dp(f10 * 2.0f));
                                        canvas.drawPath(n3Var.f4684t.f4749h0, paint);
                                    }
                                }
                                canvas.restore();
                                return;
    ...
    public final n3 j(float f10, float f11) {
        ...
        while (true) {
            ...
            if (n3Var != null) {
                ...
                RectF rectF2 = this.E[i10].f4673i;
                float f12 = width;
                float f13 = this.f4743c0;
                float f14 = height;
                float f15 = this.f4744d0;
                rectF.set((rectF2.left / f12) * f13, (rectF2.top / f14) * f15, (rectF2.right / f12) * f13, (rectF2.bottom / f14) * f15);
                this.f4741b0.mapRect(rectF);
    ...
    public final void m(Bitmap bitmap, int i10, int i11, int i12, sq0 sq0Var) {
        ...
        this.Q = i13;
        this.R = i14;
        if (!this.f4760y && !this.f4759x && bitmap != null && Build.VERSION.SDK_INT >= 24) {
            this.F = bitmap;
            this.G = i10;
            this.W = null;
            ...
            if (EmuDetector.with(getContext()).detect()) {
                ...
                obj.e = min;
                obj.d = min;
                obj.f4720a = Bitmap.createBitmap(min, min, Bitmap.Config.ARGB_8888);
                new Canvas(obj.f4720a).drawRect(0.0f, 0.0f, obj.d, obj.e, j6.Jl);
                obj.f4721b = (bitmap2.getWidth() - obj.d) / 2;
                obj.f4722c = (bitmap2.getHeight() - obj.e) / 2;
                arrayList.add(obj);
                j3Var.run(arrayList);
                return;
            }
            ...
            if (this.W == null) {
                kb.b bVar = kb.b.f10280b;
                b6.m.i(bVar, "options cannot be null");
                synchronized (ib.c.class) {
                    cVar = (ib.c) cb.h.c().a(ib.c.class);
                }
                ba.b bVar2 = (ba.b) cVar.f7476a.get(kb.b.class);
                b6.m.h(bVar2);
                lb.d dVar2 = (lb.d) bVar2.get();
                dVar2.getClass();
                la laVar = dVar2.f11845c;
                ?? obj2 = new Object();
                obj2.f145c = s7.TYPE_THIN;
                cb.o.f2237a.execute(new c2.p(laVar, new b4.e0((a9.a) obj2, 1), u7.ON_DEVICE_IMAGE_LABEL_CREATE, laVar.b(), false, 6));
                new ImageLabelerImpl((cb.f) dVar2.f11843a.F(bVar), (Executor) dVar2.f11844b.f2214a.get(), new y5.c("vision.ica", 1L)).g(a10).addOnSuccessListener(new a1.c(this, 18)).addOnFailureListener(new androidx.emoji2.text.w(25));
            }
            List<TLRPC.TL_availableReaction> enabledReactionsList = MediaDataController.getInstance(this.f4738a).getEnabledReactionsList();
    ...
    public final void o() {
        Path path = this.f4749h0;
        if (path == null) {
            this.f4749h0 = new Path();
        } else {
            path.rewind();
        }
        if (this.f4750i0 == null) {
            this.f4750i0 = new Path();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set(0.0f, 0.0f, 1.0f, 1.0f);
            this.f4750i0.addRoundRect(rectF, rectF.width() * 0.12f, rectF.height() * 0.12f, Path.Direction.CW);
        }
        this.f4749h0.addPath(this.f4750i0, this.f4748g0);
        this.f4749h0.computeBounds(this.f4751j0, true);
    }

    @Override
    public final void onAttachedToWindow() {
        super.onAttachedToWindow();
        NotificationCenter.getInstance(this.f4738a).addObserver(this, NotificationCenter.fileUploaded);
        NotificationCenter.getInstance(this.f4738a).addObserver(this, NotificationCenter.fileUploadProgressChanged);
        NotificationCenter.getInstance(this.f4738a).addObserver(this, NotificationCenter.fileUploadFailed);
        NotificationCenter.getInstance(this.f4738a).addObserver(this, NotificationCenter.filePreparingFailed);
        NotificationCenter.getInstance(this.f4738a).addObserver(this, NotificationCenter.filePreparingStarted);
        NotificationCenter.getInstance(this.f4738a).addObserver(this, NotificationCenter.fileNewChunkAvailable);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        if (i10 >= 0) {
            ...
            NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
            NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.fileUploadFailed);
            NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.filePreparingFailed);
            NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.filePreparingStarted);
            NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.fileNewChunkAvailable);
        }
    }
    ...
    public final void p(final String str, final VideoEditedInfo videoEditedInfo, final String str2, final CharSequence charSequence, final boolean z4, final long j10, final TLRPC.StickerSet stickerSet, final TLRPC.Document document, final TLRPC.Document document2, final String str3, final Utilities.Callback callback, final Utilities.Callback2 callback2) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public final void run() {
                ...
                if (callback3 != null && (o3Var = q3Var.T) != null && o3Var.f4708o) {
                    z10 = false;
                } else {
                    z10 = true;
                }
                if (z10) {
                    ...
                    ?? obj = new Object();
                    obj.f4709p = new ArrayList();
                    obj.f4710q = new ArrayList();
                    obj.f4713t = 0.0f;
                    obj.f4714u = 0.0f;
                    q3Var.T = obj;
                }
                ...
                o3Var3.h = z4;
                o3Var3.f4702i = j10;
                o3Var3.f4703j = stickerSet;
                o3Var3.f4704k = document;
                VideoEditedInfo videoEditedInfo2 = videoEditedInfo;
                o3Var3.f4712s = videoEditedInfo2;
                o3Var3.f4705l = str3;
                o3Var3.f4707n = callback3;
                o3Var3.f4706m = callback2;
                ArrayList arrayList = o3Var3.f4710q;
                if (!TextUtils.isEmpty(str4)) {
                    o3Var3.f4709p.add(new File(o3Var3.f4698b));
                }
                if (!TextUtils.isEmpty(o3Var3.f4697a) && !TextUtils.equals(o3Var3.f4697a, o3Var3.f4698b)) {
                    arrayList.add(new File(o3Var3.f4697a));
                }
                if (!TextUtils.isEmpty(o3Var3.f4705l)) {
                    arrayList.add(new File(o3Var3.f4705l));
                }
                if (!z10) {
                    q3Var.a();
                } else {
                    ...
                    if (document3 != null) {
                        o3 o3Var4 = q3Var.T;
                        o3Var4.e = MediaDataController.getInputStickerSetItem(document3, o3Var4.f4699c);
                        q3Var.T.f4700f = new TLRPC.TL_messageMediaDocument();
                        TLRPC.TL_messageMediaDocument tL_messageMediaDocument = q3Var.T.f4700f;
                        ...
                        o3Var5.f4698b = absolutePath;
                        q3Var.T.f4711r = new MessageObject(UserConfig.selectedAccount, (TLRPC.Message) tL_message, (MessageObject) null, false, false);
                        q3Var.T.f4711r.videoEditedInfo = videoEditedInfo2;
                        MediaController.getInstance().scheduleVideoConvert(q3Var.T.f4711r, false, false, false);
                    } else {
                        FileLoader.getInstance(q3Var.f4738a).uploadFile(str4, false, true, 67108864);
                    }
                }
                if (callback3 == null) {
                    if (q3Var.f4739a0 == null) {
                        q3Var.f4739a0 = new ph.m0(q3Var.getContext(), LocaleController.getString(R.string.PreparingSticker));
                    }
                    q3Var.f4739a0.setOnCancelListener(new e3(q3Var, 0));
                    if (q3Var.f4739a0.getParent() == null) {
                        q3Var.addView(q3Var.f4739a0, b6.e(-1, -1, 17));
                    }
                    ph.m0 m0Var = q3Var.f4739a0;
                    m0Var.B = true;
                    m0Var.invalidate();
                }
            }
    ...
    public void setCurrentAccount(int i10) {
        ...
        if (i11 != i10) {
            if (i11 >= 0 && isAttachedToWindow()) {
                NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.fileUploaded);
                NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.fileUploadProgressChanged);
                NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.fileUploadFailed);
                NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.filePreparingFailed);
                NotificationCenter.getInstance(this.f4738a).removeObserver(this, NotificationCenter.filePreparingStarted);
    ...
    public void setOutlineVisible(boolean z4) {
        ...
        if (this.f4747f0 != z4) {
            this.f4747f0 = z4;
            ViewPropertyAnimator animate = this.f4745e0.animate();
            float f11 = 0.0f;
            if (z4) {
                f10 = 1.0f;
            } else {
            ...
            alpha.translationX(f11).setInterpolator(nr.h).setDuration(320L).start();
