...
public abstract class j extends FrameLayout {
    ...
    public boolean W;
    public final rc f4584a;
    public boolean f4585a0;
    public float f4586b;
    public final float[] f4587b0;
    public float f4588c;
    public final float[] f4589c0;
    public float d;
    public final float[] f4590d0;
    public float e;
    public float f4591e0;
    public float f4592f;
    public float f4593f0;
    public float f4594g0;
    public float h;
    public ValueAnimator f4595h0;
    public boolean f4596i0;
    public ViewGroup f4597j0;
    public float f4598k0;
    public ValueAnimator f4599l0;
    ...
    public j(Context context, PointF pointF) {
        ...
        this.f4587b0 = new float[2];
        this.f4589c0 = new float[2];
        this.f4590d0 = new float[2];
        this.f4591e0 = 1.0f;
        this.f4596i0 = false;
        this.f4598k0 = 1.0f;
    ...
    public final boolean c(float f10, float f11, boolean z4, float f12, float f13) {
        ...
        if (getParent() != null) {
            ...
            float f18 = (f14 - this.f4592f) / scaleX;
            ...
            if (hypot > f16 || z4) {
                ...
                if (z4) {
                    ...
                    float a10 = n6.a(this.f4586b, this.f4588c, this.d, this.e);
                    if (a10 > 0.0f) {
                        j(a2 / a10);
                    }
                    f(this.f4593f0 + ((float) Math.toDegrees(Math.atan2(f11 - f13, f10 - f12) - Math.atan2(this.f4588c - this.e, this.f4586b - this.d))));
                }
                this.f4586b = f10;
                this.f4588c = f11;
                this.f4592f = f14;
                ...
                if (!this.f4603w && z4 && (hVar3 = this.C) != null) {
                    this.f4603w = true;
                    hVar3.k();
                }
                if (this.f4603w && !z4 && (hVar2 = this.C) != null) {
                    this.f4603w = false;
                    hVar2.j();
                }
                if (!this.f4596i0 && !this.f4604x && (hVar = this.C) != null) {
                    hVar.w(this);
                    this.f4604x = true;
                }
                h hVar5 = this.C;
                if (hVar5 != null) {
                    ...
                    hVar5.B(z11);
                    h hVar6 = this.C;
                    if (vh.w2.c(getHeight(), 2.0f, scaleX, this.D.y) > ((View) getParent()).getHeight() - AndroidUtilities.dp(114.0f)) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
                ...
                if (this.f4605y != z10) {
                    ValueAnimator valueAnimator = this.f4599l0;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        this.f4599l0 = null;
                    }
                    float f20 = this.f4598k0;
                    if (z10) {
                        f17 = 0.5f;
                    } else {
                        f17 = 1.0f;
                    ...
                    this.f4599l0 = ofFloat;
                    ofFloat.addUpdateListener(new f(this, 1));
                    this.f4599l0.setInterpolator(mr.h);
                    this.f4599l0.setDuration(280L);
                    this.f4599l0.start();
                    this.f4605y = z10;
                    h hVar8 = this.C;
                    if (hVar8 != null) {
    ...
    public final void d(boolean z4) {
        ...
        h hVar2;
        if (this.v) {
            this.C.h(this.f4605y);
            this.v = false;
        }
        this.f4603w = false;
        if (!z4 && !this.B && !this.f4600n && !this.f4602s && !this.f4604x && (hVar2 = this.C) != null) {
            hVar2.w(this);
        }
        if (this.f4600n && (hVar = this.C) != null) {
            hVar.B(false);
            this.C.g(false);
        }
        AndroidUtilities.cancelRunOnUIThread(this.F);
    ...
    public void dispatchDraw(Canvas canvas) {
        float a2 = this.f4584a.a(getBounceScale());
        canvas.save();
        canvas.scale(a2, a2, getWidth() / 2.0f, getHeight() / 2.0f);
        if (getParent() instanceof View) {
            View view = (View) getParent();
            if (this instanceof b3) {
                float f10 = this.f4598k0;
    ...
    public final void l(ViewGroup viewGroup, boolean z4) {
        if (this.f4596i0 != z4) {
            this.f4596i0 = z4;
            ValueAnimator valueAnimator = this.f4595h0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f4595h0 = null;
            }
            ...
            this.E.b();
            float f11 = this.f4594g0;
            if (z4) {
                f10 = 1.0f;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
            this.f4595h0 = ofFloat;
            ofFloat.addUpdateListener(new f(this, 2));
            this.f4595h0.addListener(new g(this, 4));
            this.f4595h0.setDuration(280L);
            this.f4595h0.setInterpolator(mr.h);
            this.f4595h0.start();
        }
    }
