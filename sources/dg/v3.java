...
public final class v3 extends FrameLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f4836a) {
            case 6:
                ...
                j6.m(paint);
                paint.setColor(j6.v0(j6.G8, ((w8) this.f4837b).getResourceProvider()));
                paint.setAlpha((int) (getAlpha() * 255.0f));
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                Path path = (Path) this.f4838c;
                path.rewind();
            ...
            default:
                ...
                return;
            case 8:
                v21 v21Var = (v21) this.f4837b;
                float g10 = v21Var.f29359f.g();
                ...
                float max = Math.max(dp2 + dp2, v21Var.f29359f.d() + AndroidUtilities.dp(10.0f));
                if (z4) {
                    i10 = i12;
                    f11 = dp3;
                    f10 = width;
                ...
                if (z4) {
                    ...
                    float f13 = dp * g10;
                    canvas.drawRoundRect(rectF2, f13, f13, (Paint) this.f4838c);
                    canvas.restore();
                }
                if (i10 > 0) {
                    canvas.save();
                    ...
                    d6 d6Var = (d6) this.d;
                    d6Var.setColor(j6.l1(g10, d6Var.f24180b.a(j6.v0(v21Var.B, d6Var.f24179a), false)));
                    canvas.drawRoundRect(rectF3, dp2, dp2, d6Var);
                    v21Var.f29359f.m(rectF3);
                    org.telegram.ui.Components.j6 j6Var = v21Var.f29359f;
                ...
                return;
            case 9:
                Paint paint2 = (Paint) this.f4838c;
                a70 a70Var = (a70) this.f4837b;
                paint2.setColor(a70Var.getThemedColor(j6.f19881d6));
                canvas.save();
            ...
            case 10:
                ...
                super.dispatchDraw(canvas);
                Paint paint3 = (Paint) this.f4838c;
                paint3.setColor(-1);
                float width2 = getWidth() - (AndroidUtilities.dpf2(5.0f) * 2.0f);
                g5 g5Var = (g5) this.f4837b;
                float dpf2 = (width2 - AndroidUtilities.dpf2((g5Var.f41718b - 1) * 2)) / g5Var.f41718b;
                float dpf22 = AndroidUtilities.dpf2(5.0f);
                for (int i13 = 0; i13 < g5Var.f41718b; i13++) {
                    rectF5.set(dpf22, AndroidUtilities.dpf2(8.0f), dpf22 + dpf2, AndroidUtilities.dpf2(10.0f));
                    if (i13 < g5Var.f41718b - 1) {
                        i11 = 255;
                    } else {
                        i11 = 133;
                    }
    ...
    public void draw(Canvas canvas) {
        switch (this.f4836a) {
            case 0:
                canvas.save();
                canvas.clipPath((Path) this.f4838c);
                super.draw(canvas);
                canvas.restore();
                return;
            default:
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        switch (this.f4836a) {
            case 1:
                w3 w3Var = ((y3) this.f4837b).f4871f;
                if (view == w3Var) {
                    canvas.save();
                    canvas.translate(((z5) this.f4838c).d(view.getX(), false), ((z5) this.d).d(view.getY(), false));
                    w3Var.a(canvas);
                    canvas.restore();
                    return true;
                }
            ...
            case 3:
                Paint paint = (Paint) this.f4838c;
                if (((ea) this.f4837b).e > 1) {
                    paint.setColor(j6.v0(j6.f19881d6, (f6) this.d));
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                return super.drawChild(canvas, view, j10);
            case 11:
                kf.b0 b0Var = (kf.b0) this.f4838c;
                kf.b0 b0Var2 = (kf.b0) this.d;
                boolean drawChild = super.drawChild(canvas, view, j10);
                sh.n nVar = (sh.n) this.f4837b;
                if (view == nVar.d) {
                    int i10 = j6.f19827a7;
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f4836a) {
            case 5:
                super.onDraw(canvas);
                Paint paint = (Paint) this.f4838c;
                paint.setColor(j6.w0(null, j6.f20097p7, false));
                canvas.save();
                TextPaint textPaint = (TextPaint) this.f4837b;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f4836a) {
            case 8:
                if (((v21) this.f4837b).f29359f != drawable && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
    ...
    public v3(y3 y3Var, Context context, int i10) {
        ...
        switch (i10) {
            case 1:
                ...
                super(context);
                mr mrVar = mr.h;
                this.f4838c = new z5(this, 0L, 350L, mrVar);
    ...
    public v3(v21 v21Var, Context context, f6 f6Var) {
        ...
        v21Var.f29359f.setCallback(this);
    }
