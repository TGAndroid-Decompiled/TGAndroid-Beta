...
public final class j2 extends TextView {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f4606a) {
            ...
            if (LocaleController.isRTL) {
                this.f4607b.setBounds(AndroidUtilities.dp(7.0f), x10, AndroidUtilities.dp(23.0f), AndroidUtilities.dp(16.0f) + x10);
            } else {
                this.f4607b.setBounds(getWidth() - AndroidUtilities.dp(23.0f), x10, getWidth() - AndroidUtilities.dp(7.0f), AndroidUtilities.dp(16.0f) + x10);
            }
            this.f4607b.draw(canvas);
        }
    }
    ...
    public void setCurrent(boolean z4) {
        ...
        if (this.f4606a && this.f4607b == null) {
