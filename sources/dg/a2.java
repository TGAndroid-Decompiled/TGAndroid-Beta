...
public abstract class a2 extends j {
    ...
    public g5 H0;
    public g5 I0;
    public final s1 f4350n0;
    public final t1 f4351o0;
    public final ArrayList f4352p0;
    public final MessageObject.GroupedMessages f4353q0;
    public boolean f4354r0;
    public boolean f4355s0;
    public TextureView f4356t0;
    public boolean f4357u0;
    public int f4358v0;
    public int f4359w0;
    public boolean f4360x0;
    public boolean f4361y0;
    public final SparseIntArray f4362z0;
    ...
    public a2(Context context, PointF pointF, ArrayList arrayList, ba baVar, boolean z4, k5 k5Var) {
        ...
        TLRPC.Peer peer;
        this.f4352p0 = new ArrayList();
        this.f4358v0 = 1;
        this.f4359w0 = 1;
        this.f4360x0 = true;
        this.f4361y0 = j6.I.q();
        this.f4362z0 = new SparseIntArray();
        o4 o4Var = (o4) this;
        ?? obj = new Object();
        obj.f146f = o4Var;
        ...
        obj.f144b = textPaint2;
        TextPaint textPaint3 = new TextPaint();
        obj.f145c = textPaint3;
        new Paint(3);
        obj.d = new Paint(3);
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (message2 instanceof TLRPC.TL_message) {
                ...
                this.f4352p0.add(messageObject2);
            }
            tL_messageService.f19205id = message2.f19205id;
            ...
            this.f4352p0.add(messageObject22);
        }
        this.f4353q0 = null;
        if (this.f4352p0.size() > 1) {
            MessageObject.GroupedMessages groupedMessages = new MessageObject.GroupedMessages();
            this.f4353q0 = groupedMessages;
            groupedMessages.messages.addAll(this.f4352p0);
            groupedMessages.groupId = ((MessageObject) this.f4352p0.get(0)).getGroupId();
        ...
        if (k5Var != null && k5Var.f41859g) {
            ...
            k5Var.f41856b = h0Var;
            k5Var.f41857c = r1Var2;
            TextureView textureView = k5Var.f41855a;
            if (textureView != null) {
                h0Var.run(textureView);
            }
            if (k5Var.d && (r1Var = k5Var.f41857c) != null) {
                r1Var.run(Integer.valueOf(k5Var.e), Integer.valueOf(k5Var.f41858f));
            }
        }
        k();
    }
            ...
            if (i10 < t1Var.getChildCount()) {
                ...
                if (z4) {
                    ...
                    if (t1Var2.getMessageObject() != null && t1Var2.getMessageObject().isRoundVideo() && t1Var2.getPhotoImage() != null) {
                        ...
                        dp = t1Var2.getPhotoImage().getImageY() + t1Var2.getY() + s1Var.getY();
                        float y11 = s1Var.getY();
                        y10 = t1Var2.getPhotoImage().getImageY2() + t1Var2.getY() + y11;
                    } else {
                        float x10 = childAt.getX() + s1Var.getX() + t1Var2.getBackgroundDrawableLeft() + AndroidUtilities.dp(1.0f);
                        if (this.f4353q0 == null) {
                        ...
                        float y12 = childAt.getY() + s1Var.getY() + t1Var2.getBackgroundDrawableTop();
    ...
    public void setupTheme(ph.u6 r8) {
        throw new UnsupportedOperationException("Method not decompiled: dg.a2.setupTheme(ph.u6):void");
    }
}
