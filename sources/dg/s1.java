...
public final class s1 extends FrameLayout {
    ...
    public float a() {
        g5 g5Var = (g5) this.e;
        return (g5Var.V0.a(3) * g5Var.f12500x0.getMeasuredHeight()) + (g5Var.V0.a(2) * g5Var.f12498v0.getMeasuredHeight()) + (g5Var.V0.a(1) * g5Var.f12491o0.getMeasuredHeight()) + (g5Var.V0.a(0) * g5Var.f12470c0.getMeasuredHeight()) + g5Var.f12468b0.getRealHeight() + 0.0f;
    }
    ...
    public void b(boolean z4) {
        ...
        float f10;
        float f11;
        ImageView imageView = (ImageView) this.f4781b;
        if (z4) {
            i10 = 0;
        } else {
            i10 = 8;
        ...
        TextView textView = (TextView) this.f4782c;
    ...
    public void c(int i10, String str) {
        ((TextView) this.f4782c).setText(str);
        ((ImageView) this.f4781b).setImageDrawable(getContext().getDrawable(i10));
    }
    ...
    public float d() {
        ...
        while (true) {
            ...
            if (R >= 0) {
                if (R == 2) {
                    ...
                    max = childAt.getY() - g5Var.f12468b0.getRealHeight();
                    break;
                }
            }
            childCount--;
        ...
        Float f10 = g5Var.U0;
        if (f10 != null && (dVar = g5Var.V0) != null && dVar.f2084c < 1.0f) {
            return AndroidUtilities.lerp(f10.floatValue(), a2, g5Var.V0.f2084c);
        }
        return a2;
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f4780a) {
            case 1:
                f6 f6Var = (f6) this.d;
                Paint paint = (Paint) this.f4781b;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
                if (limitPreviewView.M) {
                    if (!limitPreviewView.W && !limitPreviewView.O) {
                        paint.setColor(j6.v0(j6.f19924e7, f6Var));
                    } else {
                        paint.setColor(j6.v0(j6.f19996i6, f6Var));
                    }
                } else {
                    paint.setColor(j6.v0(j6.f19852a7, f6Var));
                }
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                eg.x xVar = limitPreviewView.f23094b0;
                if (xVar != null) {
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), ((y5) ((org.telegram.ui.a1) xVar).f32428b).t0(getX() + ((ViewGroup) getParent()).getX(), getY() + ((ViewGroup) getParent()).getY()));
                } else {
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paint);
                }
                canvas.save();
                if (!limitPreviewView.M) {
                    canvas.clipRect(limitPreviewView.f23103n, 0, getMeasuredWidth(), getMeasuredHeight());
                }
                ...
                ViewGroup viewGroup = limitPreviewView.f23108y;
                if (viewGroup != null) {
                    ...
                    if (q1Var != null) {
                        ...
                        matrix.reset();
                        matrix.postScale(1.0f, limitPreviewView.f23095c / 100.0f, 0.0f, 0.0f);
                ...
                if (limitPreviewView.S && (valueAnimator2 = limitPreviewView.f23100f0) != null) {
                    e.setAlpha((int) ((1.0f - ((Float) valueAnimator2.getAnimatedValue()).floatValue()) * alpha));
                } else if (limitPreviewView.R && (valueAnimator = limitPreviewView.f23100f0) != null) {
                    e.setAlpha((int) (((Float) valueAnimator.getAnimatedValue()).floatValue() * alpha));
                }
                if (limitPreviewView.M) {
                    if (!limitPreviewView.I && !limitPreviewView.J) {
                        AndroidUtilities.rectTmp.set(0.0f, 0.0f, limitPreviewView.f23103n, getMeasuredHeight());
                    } else {
                        AndroidUtilities.rectTmp.set(limitPreviewView.f23103n, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                    }
                }
                canvas.drawRoundRect(AndroidUtilities.rectTmp, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), e);
                e.setAlpha(alpha);
                canvas.restore();
                if (limitPreviewView.B == null && limitPreviewView.f23092a0) {
                    invalidate();
                }
                super.dispatchDraw(canvas);
                return;
            case 2:
                Paint paint2 = (Paint) this.f4782c;
                ...
                eg.q1 q1Var2 = (eg.q1) this.f4781b;
                q1Var2.e(rectF2);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(15.0f), AndroidUtilities.dp(15.0f), q1Var2.f5457f);
                canvas.restore();
                super.dispatchDraw(canvas);
                return;
            case 3:
                Drawable drawable3 = (Drawable) this.f4782c;
            ...
            case 5:
                ...
                RectF rectF3 = (RectF) this.f4781b;
                rectF3.set(g5.n1(g5Var), d11, getWidth() - g5.o1(g5Var), getHeight() + dp);
                Paint paint3 = (Paint) this.f4782c;
                paint3.setColor(g5Var.getThemedColor(j6.f19977h5));
            ...
            case 8:
                ...
                v31Var.f29359x.setTranslationY(Math.max(AndroidUtilities.statusBarHeight, A));
                if (A <= AndroidUtilities.statusBarHeight / 2.0f) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                Boolean bool = (Boolean) this.f4782c;
                if (bool == null || bool.booleanValue() != z4) {
                    this.f4782c = Boolean.valueOf(z4);
                    Window window = v31Var.getWindow();
                    if (z4) {
                        v = v31Var.getThemedColor(j6.f19977h5);
                    } else {
                        v = j6.v(v31Var.getThemedColor(j6.f20176s8), 855638016);
                    }
                ...
                canvas.drawPath(path2, (Paint) this.f4781b);
                super.dispatchDraw(canvas);
                return;
            case 9:
                LinearGradient linearGradient = (LinearGradient) this.d;
                Matrix matrix2 = (Matrix) this.f4781b;
                Paint paint4 = (Paint) this.f4782c;
                PhotoViewer photoViewer = (PhotoViewer) this.e;
                if (!photoViewer.P4) {
                    if (photoViewer.f31786k0.getVisibility() == 0) {
            ...
            case 11:
                ...
                if (cd1Var.J1) {
                    ...
                    if (f11 > 0.0f) {
                        paint5.setColor(i0.a.k(-16777216, (int) (f11 * 255.0f * cd1Var.l1)));
    ...
    public boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        switch (this.f4780a) {
            case 0:
                float[] fArr = (float[]) this.f4782c;
                Path path = (Path) this.d;
                Matrix matrix = (Matrix) this.f4781b;
                o4 o4Var = (o4) this.e;
                t1 t1Var = o4Var.f4351o0;
                if (view == o4Var.f4356t0) {
                    org.telegram.ui.Cells.t1 q10 = a2.q(o4Var);
                    if (q10 == null || (photoImage = q10.getPhotoImage()) == null) {
                        return false;
                    }
                    matrix.reset();
                    float max = Math.max(photoImage.getImageWidth() / o4Var.f4358v0, photoImage.getImageHeight() / o4Var.f4359w0);
                    matrix.postScale((o4Var.f4358v0 / o4Var.f4356t0.getWidth()) * max, (o4Var.f4359w0 / o4Var.f4356t0.getHeight()) * max);
                    matrix.postTranslate((photoImage.getCenterX() + (q10.getX() + t1Var.getX())) - ((o4Var.f4358v0 * max) / 2.0f), (photoImage.getCenterY() + (q10.getY() + t1Var.getY())) - ((o4Var.f4359w0 * max) / 2.0f));
                    o4Var.f4356t0.setTransform(matrix);
                    canvas.save();
                    path.rewind();
            ...
            case 3:
                Path path2 = (Path) this.d;
                if (view == ((ScrollView) this.f4781b)) {
                    canvas.save();
                    path2.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
            ...
            case 4:
                f6 f6Var = (f6) this.d;
                lf.b0 b0Var = (lf.b0) this.f4782c;
                lf.b0 b0Var2 = (lf.b0) this.f4781b;
                boolean drawChild2 = super.drawChild(canvas, view, j10);
                gh.f fVar = (gh.f) this.e;
                int i12 = (int) fVar.U.e;
                if (view == fVar.f6843e0 && i12 > 0) {
    ...
    public void e() {
        ...
        c5 c5Var = g5Var.f12468b0;
        c5Var.setTranslationY(d);
        g5Var.f12470c0.setTranslationY(c5Var.getRealHeight() + d);
        g5Var.f12491o0.setTranslationY(c5Var.getRealHeight() + d);
        g5Var.f12498v0.setTranslationY(c5Var.getRealHeight() + d);
        g5Var.f12500x0.setTranslationY(c5Var.getRealHeight() + d);
        ...
        AndroidUtilities.updateViewVisibilityAnimated(g5Var.f12486k0, g5Var.d.canScrollVertically(1));
    }
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        switch (this.f4780a) {
            case 0:
                ...
                TextureView textureView = o4Var.f4356t0;
                if (textureView != null) {
            ...
            case 5:
                ...
                eg.g gVar = g5Var.N0;
                if (gVar != null) {
                    int finalHeight = g5Var.f12468b0.getFinalHeight();
                    int z12 = g5Var.z1();
                    if (g5Var.V0.d(1) && g5Var.f12484j0.getVisibility() == 0) {
                        i14 = g5Var.f12484j0.getMeasuredHeight();
                    } else {
                        i14 = 0;
                    }
            ...
            case 9:
                ...
                if (photoViewer.E0.getVisibility() != 8) {
                    ...
                    hb1Var.layout(measuredWidth3, hb1Var.getTop(), photoViewer.E0.getMeasuredWidth() + measuredWidth3, photoViewer.E0.getMeasuredHeight() + photoViewer.E0.getTop());
                    return;
                }
                return;
            default:
    ...
    public void onMeasure(int i10, int i11) {
        ...
        switch (this.f4780a) {
            ...
            case 1:
                f6 f6Var = (f6) this.d;
                LimitPreviewView limitPreviewView = (LimitPreviewView) this.e;
                TextView textView = limitPreviewView.f23106w;
                eg.y yVar = limitPreviewView.f23097d0;
                k6 k6Var = limitPreviewView.K;
                eg.y yVar2 = limitPreviewView.f23096c0;
                ...
                if (getChildCount() == 2) {
                    ...
                    if (limitPreviewView.M) {
                        ...
                        int i19 = -1;
                        if (f10 == 0.0f) {
                            limitPreviewView.f23103n = 0;
                            if (!limitPreviewView.R && !limitPreviewView.S) {
                                if (limitPreviewView.I || limitPreviewView.f23094b0 != null) {
                                    v03 = -1;
                                } else {
                            ...
                            limitPreviewView.f23103n = (int) ((((size - measuredWidth) - f11) * limitPreviewView.f23091a) + measuredWidth);
                            if (!limitPreviewView.R && !limitPreviewView.S) {
                                if (limitPreviewView.I || limitPreviewView.f23094b0 != null) {
                                    v02 = -1;
                                } else {
                        ...
                        int clamp = (int) Utilities.clamp(size * limitPreviewView.f23091a, size - Math.max(measuredWidth5, measuredWidth6 + i18), max);
                        limitPreviewView.f23103n = clamp;
                        yVar2.measure(View.MeasureSpec.makeMeasureSpec(clamp, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                        yVar.measure(View.MeasureSpec.makeMeasureSpec(size - limitPreviewView.f23103n, 1073741824), View.MeasureSpec.makeMeasureSpec(size2, 1073741824));
                    }
            ...
            case 3:
                eg.o1 o1Var = (eg.o1) this.e;
                o1Var.I = 0;
                ScrollView scrollView = (ScrollView) this.f4781b;
            ...
            case 5:
                ...
                g5Var.f12468b0.I.setPadding(0, 0, 0, bottomInset);
                ...
                if (gVar != null) {
                    ...
                    int z12 = g5Var.z1();
                    if (g5Var.V0.d(1) && g5Var.f12484j0.getVisibility() == 0) {
                        i20 = g5Var.f12484j0.getMeasuredHeight();
                    }
        ...
        switch (this.f4780a) {
            case 9:
                ...
                if (fs0Var != null && fs0Var.getVisibility() != 8) {
                    photoViewer.R1.setAlpha(photoViewer.f31891v7[0] * f10);
                }
                gs0 gs0Var = photoViewer.S1;
                if (gs0Var != null && gs0Var.getVisibility() != 8) {
                    photoViewer.S1.setAlpha(f10 * photoViewer.f31901w7[0]);
                    return;
                }
                return;
            default:
    ...
    public s1(o4 o4Var, Context context) {
        super(context);
        this.e = o4Var;
        this.f4781b = new Matrix();
        this.f4782c = new float[8];
        this.d = new Path();
    }
    ...
    public s1(v31 v31Var, Context context) {
        ...
        this.f4781b = paint;
        paint.setColor(v31Var.getThemedColor(j6.f19977h5));
        j6.m(paint);
    }
    ...
    public s1(eg.q0 q0Var, Context context, f6 f6Var) {
        ...
        this.e = q0Var;
        this.d = f6Var;
        this.f4781b = new eg.q1(j6.Lj, j6.Mj, -1, -1, f6Var);
        Paint paint = new Paint(1);
        this.f4782c = paint;
