...
public final class b4 extends j {
    public final z3 f4406n0;
    public cg.f2 f4407o0;
    public int f4408p0;
    public int f4409q0;
    public int f4410r0;
    public cg.t0 f4411s0;
    public int f4412t0;
    public int f4413u0;
    public Runnable f4414v0;
    public boolean f4415w0;
    public String f4416x0;

    public b4(Context context, PointF pointF, int i10, CharSequence charSequence, cg.f2 f2Var, int i11) {
        super(context, pointF);
        this.f4411s0 = cg.t0.e;
        this.f4409q0 = i10;
        ...
        z3Var.setTextSize(0, this.f4409q0);
        z3Var.setCursorSize(AndroidUtilities.dp(this.f4409q0 * 0.4f));
        z3Var.setText(charSequence);
        s();
        z3Var.setTextColor(f2Var.f2401a);
    ...
    public Paint.FontMetricsInt getFontMetricsInt() {
        return this.f4406n0.getPaint().getFontMetricsInt();
    }

    public float getFontSize() {
        return this.f4406n0.getTextSize();
    }
    ...
    public float getStickyPaddingBottom() {
        RectF rectF = this.f4406n0.f4382w;
        if (rectF == null) {
            return 0.0f;
        }
        return rectF.bottom;
    ...
    public CharSequence getText() {
        return this.f4406n0.getText();
    }

    public int getTextSize() {
        return (int) this.f4406n0.getTextSize();
    }
    ...
    public final void r() {
        ...
        int i11 = this.f4407o0.f2401a;
        int i12 = this.f4408p0;
        int i13 = -1;
        if (i12 == 0) {
            z3Var.setFrameColor(i11);
            i11 = AndroidUtilities.computePerceivedBrightness(this.f4407o0.f2401a) >= 0.721f ? -16777216 : -1;
        } else if (i12 == 1) {
    ...
    public void setMaxWidth(int i10) {
        this.f4406n0.setMaxWidth(i10);
    }

    public void setSwatch(cg.f2 f2Var) {
        this.f4407o0 = new cg.f2(f2Var.f2402b, f2Var.f2403c, f2Var.f2401a);
        r();
    }

    public void setText(CharSequence charSequence) {
        this.f4406n0.setText(charSequence);
        s();
    }
    ...
    public void setTypeface(cg.t0 t0Var) {
        this.f4411s0 = t0Var;
        if (t0Var != null) {
            this.f4406n0.setTypeface(t0Var.d());
        }
        m();
    }
    ...
    public b4(Context context, b4 b4Var, PointF pointF) {
        this(context, pointF, b4Var.f4409q0, b4Var.getText(), b4Var.getSwatch(), b4Var.f4408p0);
        ...
        int align = getAlign();
        int i10 = 2;
        this.f4406n0.setGravity(align != 1 ? align != 2 ? 19 : 21 : 17);
        int align2 = getAlign();
        if (align2 == 1) {
            i10 = 4;
        ...
        this.f4406n0.setTextAlignment(i10);
    }
}
