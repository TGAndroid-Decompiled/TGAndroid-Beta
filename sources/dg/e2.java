...
public abstract class e2 extends sl0 {
    ...
    public static final Paint f4496a3;
    public static final Path f4497b3;
    ...
    public final void y1(float f10, boolean z4) {
        ...
        float f11;
        if (z4) {
            interpolation = nr.f27347g.getInterpolation(f10);
        } else {
            interpolation = nr.f27348i.getInterpolation(f10);
        }
