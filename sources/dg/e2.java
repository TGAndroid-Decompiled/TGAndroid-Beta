...
public abstract class e2 extends rl0 {
    ...
    public static final Paint f4502a3;
    public static final Path f4503b3;
    ...
    public final void x1(float f10, boolean z4) {
        ...
        float f11;
        if (z4) {
            interpolation = mr.f27123g.getInterpolation(f10);
        } else {
            interpolation = mr.f27124i.getInterpolation(f10);
        }
