...
public final class r1 implements Utilities.Callback2 {
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i14) {
            case 0:
                o4 o4Var = (o4) obj3;
                o4Var.f4364v0 = ((Integer) obj).intValue();
                o4Var.f4365w0 = ((Integer) obj2).intValue();
            ...
            case 1:
                ...
                if (arrayList2 != null && !arrayList2.isEmpty()) {
                    ...
                    int dp2 = AndroidUtilities.dp(88.0f) + fVar.f6834i0;
                    ...
                    while (i24 < size) {
                        ...
                        for (TLRPC.TL_help_country tL_help_country : (List) fVar.W.get((String) obj4)) {
                            if (TextUtils.isEmpty(fVar.Z) || gg.f2.U(tL_help_country, AndroidUtilities.translitSafe(fVar.Z).toLowerCase())) {
                                ...
                                boolean containsKey = fVar.f6832g0.containsKey(tL_help_country.iso2);
                                int i25 = gh.e.f6824a;
                                i51 J = i51.J(gh.e.class);
                                J.f25585l = tL_help_country.iso2;
                                J.G = tL_help_country;
                                J.e = containsKey;
                                arrayList.add(J);
                            }
            ...
            case 10:
                ...
                l7 l7Var = m3Var.e;
                if (l7Var != null) {
                    if ((!l7Var.e || l7Var.f12752g != 783) && l7Var.f12756l.size() <= 0) {
                        l7 l7Var2 = m3Var.e;
                        if (l7Var2.f12754j && !l7Var2.f12753i) {
                            return;
                        }
                    }
                    l7 l7Var3 = m3Var.e;
                    if (l7Var3 != null && (i12 = l7Var3.f12758n) != 0) {
                        i10 = Math.min(3, i12);
                    } else {
                        i10 = 3;
                    }
                    ...
                    l7 l7Var4 = m3Var.e;
                    if (l7Var4 != null) {
                        ArrayList arrayList7 = l7Var4.f12756l;
                        ...
                        while (i28 < size2) {
                            ...
                            J3.f25580f = r14;
                            J3.f25591r = z15;
                            if (m3Var.f10821n && (m3Var.e != or0Var.d || savedStarGift.pinned_to_top)) {
                                z4 = true;
                            } else {
                                z4 = false;
                            }
                        ...
                        l7 l7Var5 = m3Var.e;
                        if (l7Var5.f12753i || !l7Var5.f12754j) {
                            int i30 = 0;
                            while (true) {
                                if (i27 <= 0) {
                                    i11 = 3;
                    ...
                    if (or0Var.d == m3Var.e) {
                        ...
                        if (or0Var.f11017c == UserConfig.getInstance(m3Var.f10818b).getClientUserId()) {
                            int v02 = j6.v0(j6.f20273z6, m3Var.f10819c);
                            String string = LocaleController.getString(R.string.ProfileGiftsInfo);
                            int dp3 = AndroidUtilities.dp(24.0f);
                            int i31 = kh.s3.f10924a;
                    ...
                    if (m3Var.f10820f.getSpanCount() != max) {
                        AndroidUtilities.runOnUIThread(new kh.m2(m3Var, max, 1));
                    }
                    or0Var.o();
            ...
            case 11:
                ...
                l7 l7Var6 = r3Var.V;
                if (l7Var6 != null) {
                    ArrayList arrayList9 = l7Var6.f12756l;
                    arrayList8.add(i51.C(AndroidUtilities.dp(16.0f)));
                    if (l7Var6.f12753i && arrayList9.isEmpty()) {
                        i51 o11 = i51.o(1, 34);
                        o11.f25594u = 1;
                        arrayList8.add(o11);
                        i51 o12 = i51.o(2, 34);
                        ...
                        f10 = 68.0f;
                        if (l7Var6.f12753i || !l7Var6.f12754j) {
                            while (true) {
                                if (i32 <= 0) {
                                    i13 = 3;
                                } else {
            ...
            case 12:
                ...
                if (arrayList10.isEmpty() && !a5Var.f10596t) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                if (q5Var.f10883x != z10) {
                    q5Var.f10883x = z10;
                    q5Var.f10882w.setVisibility(0);
                    ViewPropertyAnimator animate = q5Var.f10882w.animate();
                    if (z10) {
                        f12 = 1.0f;
                    }
                    ...
                    scaleX.scaleY(f13).setInterpolator(mr.h).setDuration(320L).setListener(new g4(q5Var, z10, 1)).start();
                    return;
                }
                return;
            case 13:
            ...
            case 16:
                ...
                i51 i51Var = ((lh.n0) obj3).f12812s0;
                if (i51Var != null) {
            ...
            case 17:
                ...
                ArrayList arrayList15 = j1Var.f12620a0;
                boolean z16 = j1Var.f12638t0;
                com.google.android.gms.common.api.internal.r rVar = j1Var.f12623d0;
                ArrayList arrayList16 = j1Var.Y;
                ArrayList arrayList17 = j1Var.X;
                com.google.android.gms.common.api.internal.r rVar2 = j1Var.f12622c0;
                com.google.android.gms.common.api.internal.r rVar3 = j1Var.f12621b0;
                ...
                if (arrayList18 != null && arrayList17 != null && arrayList16 != null) {
                    ...
                    rVar.f2844a = 0;
                    rVar.c();
                    int i37 = j1Var.f12626g0.f12562r;
                    if (i37 == 0) {
            ...
            case 23:
                ...
                int i39 = gaVar.f12498c;
                int i40 = gaVar.d;
                long j10 = gaVar.f12499f;
                if (j10 != 0) {
                    lh.b0 g10 = lh.b0.g(i39);
                    ArrayList arrayList20 = g10.k(j10).f12069a[i40];
                ...
                ArrayList arrayList21 = y10.f13146q[i40];
            ...
            case 25:
                ...
                org.telegram.ui.web.i iVar = kVar.f39505y;
                ArrayList arrayList24 = kVar.f39504x;
                if (!kVar.f39497b && arrayList24.isEmpty()) {
                ...
                if (string2 != null) {
                    try {
                        ...
                        for (int i45 = 0; i45 < jSONArray.length(); i45++) {
                            ...
                            jVar.f39488c = jSONObject.optDouble("rank", 0.0d);
                ...
                for (int i47 = 0; i47 < arrayList24.size(); i47++) {
                    ...
                    int i48 = org.telegram.ui.web.d.f39419a;
                ...
                if (!arrayList25.isEmpty()) {
                    ...
                    for (int i49 = 0; i49 < arrayList25.size(); i49++) {
                        ...
                        int i50 = org.telegram.ui.web.d.f39419a;
                ...
                if (iVar != null) {
                    ArrayList arrayList27 = iVar.f39473a;
                    if (!arrayList27.isEmpty()) {
                        ...
                        for (int i51 = 0; i51 < arrayList27.size(); i51++) {
                            ...
                            if (!TextUtils.isEmpty(org.telegram.ui.web.k.a(messageObject))) {
                                int i52 = org.telegram.ui.web.g.f39448a;
            ...
            case 26:
                ...
                Paint paint = kVar2.F;
                RectF rectF = kVar2.f41863w0;
                ph.f fVar2 = kVar2.f41842f;
                if (kVar2.g()) {
                    if (kVar2.D == null) {
                        runnable.run();
                        return;
                ...
                ut editText2 = fVar2.getEditText();
                if (c3 == null) {
                    i15 = -2130706433;
                }
                ...
                ut editText3 = fVar2.getEditText();
            ...
            case 27:
                ...
                y1Var.f42640b = str5;
                y1Var.f42641c = ((Integer) obj2).intValue();
                h1Var.f41736c.H(str5);
                return;
            default:
                ...
                y1Var2.f42640b = str6;
                y1Var2.f42641c = ((Integer) obj2).intValue();
                n1Var.f42036c.D(str6);
                return;
        }
    }
}
