        ...
        switch (this.f4883n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    Paint paint5 = this.f4571c;
                    canvas.drawCircle(dp2, f13, dpf22, paint5);
                    Paint paint6 = this.f4570b;
            ...
            default:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    Paint paint8 = this.f4571c;
                    canvas.drawCircle(dp3, f15, dpf23, paint8);
                    Paint paint9 = this.f4570b;
