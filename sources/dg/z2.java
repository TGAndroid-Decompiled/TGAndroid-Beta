...
public final class z2 extends i {
    ...
    public z2(j jVar, Context context, int i10) {
        super(jVar, context);
        this.f4877n = i10;
    }
        ...
        switch (this.f4877n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    Paint paint5 = this.f4565c;
                    canvas.drawCircle(dp2, f13, dpf22, paint5);
                    Paint paint6 = this.f4564b;
            ...
            default:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    Paint paint8 = this.f4565c;
                    canvas.drawCircle(dp3, f15, dpf23, paint8);
                    Paint paint9 = this.f4564b;
