...
public final class h0 implements f6, qg.c {
    ...
    public int g(f6 f6Var, boolean z4) {
        ...
        switch (this.f4551a) {
            case 1:
                if (!rg.b.c(UserConfig.selectedAccount, this.f4552b)) {
            ...
            case 2:
                ...
                return j6.l1(f11, j6.v0(j6.f19896ce, f6Var));
            default:
                if (!rg.b.c(UserConfig.selectedAccount, this.f4552b)) {
                    if (z4) {
                        i11 = j6.f20176s8;
                ...
                return j6.l1(f12, j6.v0(j6.f19896ce, f6Var));
        }
    }
