...
public class b extends EditTextBoldCursor {
    public final Canvas f4376b;
    public final TextPaint f4377c;
    ...
    public b(Context context) {
        super(context);
        this.f4376b = new Canvas();
        TextPaint textPaint = new TextPaint(1);
        this.f4377c = textPaint;
        this.d = new Paint(1);
        this.f4381s = new sq();
        this.h = 0;
    ...
    private void setFrameRoundRadius(float f10) {
        if (Math.abs(this.f4384y - f10) > 0.1f) {
            this.f4384y = f10;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.e != null && this.h != 0) {
            ...
            TextPaint textPaint = this.f4377c;
            if (z10) {
                int measuredWidth = (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight();
                int measuredHeight = getMeasuredHeight();
                Editable text = getText();
                Bitmap bitmap = this.e;
                Canvas canvas2 = this.f4376b;
    ...
    public void setFrameColor(int i10) {
        ...
        if (i10 != 0) {
            ...
            if (computePerceivedBrightness == 0.0f) {
                computePerceivedBrightness = Color.red(this.f4380r) / 255.0f;
            }
