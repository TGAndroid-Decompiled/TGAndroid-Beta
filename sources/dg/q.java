...
public final class q extends ScrollView {
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float y10 = this.f4641a.getY() + AndroidUtilities.dp(1.0f);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ((LinearLayout.LayoutParams) this.f4642b.f4502b.getLayoutParams()).height = (int) (((View.MeasureSpec.getSize(i10) - AndroidUtilities.dp(24.0f)) * 0.8333333f) + AndroidUtilities.dp(88.0f));
    }
}
