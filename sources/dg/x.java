...
public final class x extends View {
    ...
    public final Paint f4712c;
    public final LongSparseArray d;
    public long f4713e;
    public final Path f4714f;
    public final float[] h;
    public final HashMap f4715n;
    public final e0 f4716r;
    ...
    public x(e0 e0Var, Context context) {
        ...
        this.f4711b = new int[]{-16735784, -16752387, -11788361, -6804548, -4707235, -180718, -38656, -152832, -211200, -198077, -2495689, -8996289};
        Paint paint = new Paint(1);
        this.f4712c = paint;
        this.d = new LongSparseArray();
        this.f4713e = Long.MIN_VALUE;
        this.f4714f = new Path();
        this.h = new float[8];
        this.f4715n = new HashMap();
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    this.f4715n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i0.a.d(i10 / 11.0f, -1, -16777216)));
                } else {
                    if (i11 < 6) {
                        d = i0.a.d(((5 - i11) / 4.0f) * 0.5f, this.f4711b[i10], -16777216);
                    } else {
                        d = i0.a.d(y3.A(9 - i11, 5.0f, 0.5f, 0.5f), this.f4711b[i10], -1);
                    }
                    this.f4715n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(d));
                }
            }
        }
    }
    ...
    public final void a(int i10) {
        for (Map.Entry entry : this.f4715n.entrySet()) {
    ...
    public final void b(int i10, int i11) {
        ...
        if (longSparseArray.get(j10) == null) {
            longSparseArray.put(this.f4713e, Float.valueOf(0.0f));
        }
        invalidate();
    }
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        Integer num = (Integer) this.f4715n.get(Long.valueOf((x10 << 16) + y10));
        if (num != null) {
            int intValue = num.intValue();
            int i10 = e0.f4501s;
            this.f4716r.m(intValue, 3);
            b(x10, y10);
        }
    }
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r4) {
        throw new UnsupportedOperationException("Method not decompiled: dg.x.onTouchEvent(android.view.MotionEvent):boolean");
    }
}
