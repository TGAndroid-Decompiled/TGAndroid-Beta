...
public class u3 extends LinearLayout {
    public static float f4818b = 1.0f;
        ...
        switch (this.f4819a) {
            case 7:
                if (getParent() instanceof do0) {
                    ...
                    canvas.save();
                    LinearLayout linearLayout = do0Var.f24330b;
                    Path path = do0Var.f24333n;
                    if (view != null && do0.e(view)) {
                        ...
                        if (childAt != null && do0.e(childAt)) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
                        if (view2 != null && do0.e(view2)) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                        ...
                        float x10 = view.getX();
                        float max = Math.max(do0Var.getScrollY() - AndroidUtilities.dp(16.0f), view.getY() + linearLayout.getY());
                        float x11 = view.getX() + view.getWidth();
                        int height = do0Var.getHeight();
                        rectF.set(x10, max, x11, Math.min(AndroidUtilities.dp(16.0f) + do0Var.getScrollY() + height, view.getY() + linearLayout.getY() + view.getHeight()));
                        if (z4 && z10) {
