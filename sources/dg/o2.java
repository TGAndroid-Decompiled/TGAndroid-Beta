...
public final class o2 extends LinearLayout {
    public final jj0[] f4691a;
    public n2 f4692b;
    public final Paint f4693c;
    public final int d;
    public boolean e;
    public int f4694f;
    public int h;
    public float f4695n;
    public ValueAnimator f4696r;
    ...
    public o2(Context context, boolean z4) {
        ...
        float f10;
        float f11;
        List list = cg.m.f2447a;
        this.f4691a = new jj0[list.size() + 2];
        ...
        int i11 = 0;
        while (true) {
            List list2 = cg.m.f2447a;
            if (i10 < list2.size() + 2) {
                jj0[] jj0VarArr = this.f4691a;
                if (i10 == 0) {
                    z10 = true;
                } else {
                    z10 = false;
                ...
                if (i10 == 0) {
                    this.f4691a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final o2 f4651b;
                    ...
                    if (z4 || !(mVar instanceof cg.b)) {
                        this.f4691a[i11].f(mVar.e(), 28, 28, null);
                        this.f4691a[i11].setOnClickListener(new m2(this, i11, mVar, 0));
                    } else {
                        i10++;
                    }
                } else if (i10 == list2.size() + 1) {
                    this.f4691a[i11].setImageResource(R.drawable.msg_add);
                    this.f4691a[i11].setOnClickListener(new View.OnClickListener(this) {
                        public final o2 f4651b;
    ...
    public final void a(int i10) {
        if (i10 >= 0) {
            ...
            if (i10 < jj0VarArr.length) {
                if (this.f4696r == null || this.h != i10) {
                    ...
                    ValueAnimator valueAnimator = this.f4696r;
                    ...
                    if (this.f4694f != i10) {
                        ...
                        this.f4696r = duration;
                        duration.setInterpolator(nr.f27346f);
                        this.f4696r.addUpdateListener(new o1(this, 1));
                        this.f4696r.addListener(new cg.l0(this, 2));
                        this.f4696r.start();
                    }
                }
            }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.lerp(f15, f12 + f13, f10), (jj0Var2.getHeight() / 2.0f) + jj0Var2.getY(), dp, this.f4693c);
    }
    ...
    public void setSelectedIndex(int i10) {
        ...
        if (this.e) {
            this.e = false;
            AndroidUtilities.updateImageViewImageAnimated(this.f4691a[this.d + 1], R.drawable.msg_add);
        }
        invalidate();
    }
}
