...
public abstract class e1 extends rv0 implements n2, h, i2, pv0, NotificationCenter.NotificationCenterDelegate {
    ...
    public final a1 Z0;
    public pg.b Z1;
    public final y0 f4464a1;
    public final float[] a2;
    public final FrameLayout f4465b1;
    public final int[] f4466b2;
    public k0 f4467c1;
    public kz f4468c2;
    public int f4469d1;
    public boolean f4470d2;
    public int f4471e1;
    public boolean f4472e2;
    public float f4473f1;
    public boolean f4474f2;
    public ValueAnimator f4475g1;
    public int f4476g2;
    public boolean f4477h1;
    public int f4478h2;
    public final t2 f4479i1;
    public int f4480i2;
    public final o5.i f4481j1;
    public int f4482j2;
    public ArrayList f4483k1;
    public boolean f4484k2;
    public final int l1;
    public BigInteger f4485m1;
    public TextView f4486n1;
    public TextView f4487o1;
    public TextView f4488p1;
    public final o2 f4489q1;
    public final k2 f4490r1;
    public final q2 f4491s1;
    public final ImageView f4492t1;
    public final LinearLayout f4493u1;
    public final TextView f4494v1;
    public final TextView f4495w1;
    public final b2 f4496x0;
    public final TextView f4497x1;
    public final f2 f4498y0;
    public final Paint f4499y1;
    public float f4500z0;
    public final Paint f4501z1;
    ...
    public e1(Context context, Activity activity, int i10, Bitmap bitmap, Bitmap bitmap2, int i11, ArrayList arrayList, MediaController.CropState cropState, tq0 tq0Var, f6 f6Var) {
        ...
        this.f4481j1 = new o5.i(mt0Var, 12);
        this.f4499y1 = new Paint(1);
        this.f4501z1 = new Paint(1);
        this.E1 = new Paint(1);
        this.F1 = new Paint(1);
        this.G1 = new Paint(1);
        ...
        this.C0 = i2Var;
        i2Var.f2411a = new a1.c(mt0Var, 12);
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (i14 < size) {
                ...
                v2Var.setX((mediaEntity.f16673x * this.O0.f26062a) - (((1.0f - mediaEntity.scale) * mediaEntity.viewWidth) / f10));
                v2Var.setY((mediaEntity.f16674y * this.O0.f26063b) - (((1.0f - mediaEntity.scale) * mediaEntity.viewHeight) / f10));
                ...
                switch (r2) {
                    case 0:
                        ...
                        if (s0Var2 != null && (s0Var2.getCurrentBrush() instanceof cg.l)) {
                            s0Var2.b();
                            mt0Var2.f4489q1.setSelectedIndex(1);
                            mt0Var2.x((cg.m) cg.m.f2430a.get(0));
                            return;
                        }
                        mt0Var2.C0.c();
                        return;
                    case 1:
                        ...
                        if (i2Var2.a()) {
                            if (s0Var3 != null && (s0Var3.getCurrentBrush() instanceof cg.l)) {
                                s0Var3.b();
                                mt0Var3.f4489q1.setSelectedIndex(1);
                                mt0Var3.x((cg.m) cg.m.f2430a.get(0));
                            }
                            s0Var3.a();
                            i2Var2.f2413c.clear();
                            i2Var2.f2412b.clear();
        ...
        TextView h = ai.h(frameLayout2, textView2, b6.d(-2, 32.0f, 5, 0.0f, 0.0f, 4.0f, 0.0f), context);
        this.f4495w1 = h;
        ...
        h.setAlpha(0.0f);
        h.setVisibility(8);
        TextView h9 = ai.h(frameLayout2, h, b6.d(-2, 32.0f, 51, 4.0f, 0.0f, 0.0f, 0.0f), context);
        this.f4497x1 = h9;
        ...
        h9.setAlpha(0.0f);
        h9.setVisibility(8);
        frameLayout2.addView(h9, b6.d(-2, 32.0f, 5, 0.0f, 0.0f, 4.0f, 0.0f));
        ...
        Paint paint2 = this.f4499y1;
        Paint.Style style = Paint.Style.STROKE;
        paint2.setStyle(style);
        this.f4499y1.setColor(1728053247);
        this.f4499y1.setStrokeWidth(Math.max(2, AndroidUtilities.dp(1.0f)));
        this.f4501z1.setColor(j6.v0(j6.G8, this.N1));
        ...
        t2Var.setValueOverride(this.f4481j1);
        this.H1.f2386c = this.f4481j1.get();
        t2Var.setOnUpdate(new ah.b(mt0Var, i10, 2));
        addView(t2Var, b6.c(-1.0f, -1));
        FrameLayout frameLayout3 = new FrameLayout(context);
        this.f4465b1 = frameLayout3;
    ...
    public static void b0(e1 e1Var) {
        ...
        if (jVar != null) {
            ...
            if (jVar2 instanceof r3) {
                ...
                b4Var.setMaxWidth((int) (e1Var.getPaintingSize().f26062a - 20.0f));
    ...
    private jv0 getPaintingSize() {
        ...
        if (floor > f10) {
            jv0Var2.f26063b = f10;
            jv0Var2.f26062a = (float) Math.floor((f10 * width) / height);
        }
        this.O0 = jv0Var2;
        return jv0Var2;
    }
    ...
    private void setTextType(int i10) {
        ...
        this.f4490r1.setOutlineType(i10);
    }
    ...
    private void setupTabsLayout(Context context) {
        ...
        this.f4467c1.setOrientation(0);
        this.Z0.addView(this.f4467c1, b6.d(-1, 40.0f, 80, 52.0f, 0.0f, 52.0f, 0.0f));
        TextView textView = new TextView(context);
        this.f4486n1 = textView;
        textView.setText(LocaleController.getString(R.string.PhotoEditorDraw).toUpperCase());
        TextView textView2 = this.f4486n1;
        int i10 = j6.f19971i6;
        h0 h0Var = this.N1;
        textView2.setBackground(j6.f0(j6.v0(i10, h0Var), 7, -1));
        this.f4486n1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f4486n1.setTextColor(-1);
        this.f4486n1.setTextSize(1, 14.0f);
        this.f4486n1.setGravity(1);
        this.f4486n1.setTypeface(AndroidUtilities.bold());
        this.f4486n1.setSingleLine();
        this.f4486n1.setOnClickListener(new k(this, 0));
        this.f4467c1.addView(this.f4486n1, b6.l(1.0f, 0, -2));
        TextView textView3 = new TextView(context);
        this.f4487o1 = textView3;
        textView3.setText(LocaleController.getString(R.string.PhotoEditorSticker).toUpperCase());
        this.f4487o1.setBackground(j6.f0(j6.v0(i10, h0Var), 7, -1));
        this.f4487o1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f4487o1.setOnClickListener(new k(this, 1));
        this.f4487o1.setTextColor(-1);
        this.f4487o1.setTextSize(1, 14.0f);
        this.f4487o1.setGravity(1);
        this.f4487o1.setTypeface(AndroidUtilities.bold());
        this.f4487o1.setAlpha(0.6f);
        this.f4487o1.setSingleLine();
        this.f4467c1.addView(this.f4487o1, b6.l(1.0f, 0, -2));
        TextView textView4 = new TextView(context);
        this.f4488p1 = textView4;
        textView4.setText(LocaleController.getString(R.string.PhotoEditorText).toUpperCase());
        this.f4488p1.setBackground(j6.f0(j6.v0(i10, h0Var), 7, -1));
        this.f4488p1.setPadding(0, AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f));
        this.f4488p1.setTextColor(-1);
        this.f4488p1.setTextSize(1, 14.0f);
        this.f4488p1.setGravity(1);
        this.f4488p1.setTypeface(AndroidUtilities.bold());
        this.f4488p1.setAlpha(0.6f);
        this.f4488p1.setSingleLine();
        this.f4488p1.setOnClickListener(new k(this, 4));
        this.f4467c1.addView(this.f4488p1, b6.l(1.0f, 0, -2));
    }
    ...
    public final void B0(int i10) {
        ...
        boolean z4;
        if (this.f4469d1 != i10 && this.f4471e1 != i10) {
            ValueAnimator valueAnimator = this.f4475g1;
            if (valueAnimator != null) {
                valueAnimator.cancel();
            }
            int i11 = this.f4469d1;
            ViewGroup viewGroup3 = this.f4490r1;
            ViewGroup viewGroup4 = this.f4489q1;
            if (i11 == 0) {
            ...
            this.f4475g1 = duration;
            duration.setInterpolator(mr.f27122f);
            this.f4475g1.addUpdateListener(new r(this, viewGroup, viewGroup2, 0));
            this.f4475g1.addListener(new l0(this, viewGroup, viewGroup2, i10, 0));
            this.f4475g1.start();
        }
    }
        ...
        while (true) {
            ...
            if (i10 < w0Var.getChildCount()) {
                ...
                if (childAt != this.P0) {
                    if (childAt instanceof j) {
                        j jVar = (j) childAt;
                        if (!jVar.f4596i0 && jVar.f4594g0 <= 0.0f) {
                        }
                    }
                    i10++;
                }
    ...
    public final void G(int i10, boolean z4) {
        ...
        boolean z11;
        int i11;
        if (i10 > AndroidUtilities.dp(50.0f) && this.f4472e2 && !AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
            if (z4) {
                this.f4480i2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height_land3", this.f4480i2).commit();
            } else {
                this.f4478h2 = i10;
                MessagesController.getGlobalEmojiSettings().edit().putInt("kbd_height", this.f4478h2).commit();
            }
        }
        if (this.f4470d2) {
            if (z4) {
            ...
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f4468c2.getLayoutParams();
            int i12 = layoutParams.width;
            int i13 = AndroidUtilities.displaySize.x;
            if (i12 != i13 || layoutParams.height != i11) {
                layoutParams.width = i13;
                layoutParams.height = i11;
                this.f4468c2.setLayoutParams(layoutParams);
                this.f4476g2 = layoutParams.height;
                requestLayout();
                ph.i3 i3Var = ((mt0) this).f36200l2.H1;
                if (i3Var != null) {
                    i3Var.a();
                }
                getHeight();
        ...
        if (this.f4482j2 == i10 && this.f4484k2 == z4) {
            getHeight();
            return;
        }
        this.f4482j2 = i10;
        this.f4484k2 = z4;
        boolean z12 = this.f4472e2;
        j jVar = this.P0;
        if (jVar instanceof b4) {
        ...
        if (this.f4472e2 && this.f4470d2) {
            x0(0);
        }
        if (this.f4476g2 != 0 && !(z10 = this.f4472e2) && z10 != z12 && !this.f4470d2) {
            this.f4476g2 = 0;
            requestLayout();
            ph.i3 i3Var2 = ((mt0) this).f36200l2.H1;
            if (i3Var2 != null) {
                i3Var2.a();
            }
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.customTypefacesLoaded && (w0Var = this.W0) != null) {
            for (int i12 = 0; i12 < w0Var.getChildCount(); i12++) {
                ...
                if ((childAt instanceof b4) && (str = (b4Var = (b4) childAt).f4422x0) != null) {
    ...
    public final PointF g0() {
        ...
        float f10 = paintingSize.f26062a / 2.0f;
        float f11 = paintingSize.f26063b / 2.0f;
        if (this.E0 != null) {
            ...
            float a2 = (float) kf.k0.a(radians, cropState.cropPy, Math.sin(radians) * cropState.cropPx);
            f10 -= cos * paintingSize.f26062a;
            f11 -= a2 * paintingSize.f26063b;
        }
    ...
    public final b4 j0(boolean z4) {
        ((mt0) this).f36200l2.f31697d0.isFocusable();
        jv0 paintingSize = getPaintingSize();
        PointF A0 = A0(null);
        b4 b4Var = new b4(getContext(), A0, (int) (paintingSize.f26062a / 9.0f), "", this.H1, this.R0);
        ...
        b4Var.setMaxWidth((int) (paintingSize.f26062a - 20.0f));
        int i10 = this.M1;
    ...
    public final void l0(boolean z4) {
        ...
        if (z4) {
            kz kzVar = this.f4468c2;
            if (kzVar != null && kzVar.getVisibility() == 0) {
                ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, this.f4468c2.getMeasuredHeight());
    ...
    public final void m0() {
        kz kzVar;
        ph.i3 i3Var;
        if (this.f4476g2 > 0 && (i3Var = ((mt0) this).f36200l2.H1) != null) {
            i3Var.a();
        }
        if (!this.f4470d2 && (kzVar = this.f4468c2) != null && kzVar.getVisibility() != 8) {
            this.f4468c2.setVisibility(8);
        }
        this.f4476g2 = 0;
    }
    ...
    public final void n0(boolean z4) {
        ...
        if (this.f4469d1 == 0) {
            ...
            this.f4479i1.setLayerType(i10, null);
            if (z4) {
                i11 = 2;
            } else {
                i11 = 0;
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int i15 = i13 - i11;
        int i16 = 0;
        if (this.f4468c2 != null) {
            if (AndroidUtilities.isTablet()) {
                R = i15 - this.f4468c2.getMeasuredHeight();
            } else {
                R = (R() + i15) - this.f4468c2.getMeasuredHeight();
            }
            kz kzVar = this.f4468c2;
            kzVar.layout(0, R, kzVar.getMeasuredWidth(), this.f4468c2.getMeasuredHeight() + R);
        }
        if (!this.S0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f13 = f11 / this.O0.f26062a;
        this.N0 = f13;
        w0 w0Var = this.W0;
        w0Var.setScaleX(f13);
        w0Var.setScaleY(this.N0);
        w0Var.measure(View.MeasureSpec.makeMeasureSpec((int) this.O0.f26062a, 1073741824), View.MeasureSpec.makeMeasureSpec((int) this.O0.f26063b, 1073741824));
        a11 a11Var = this.X0;
        if (a11Var != null) {
            a11Var.measure(View.MeasureSpec.makeMeasureSpec((int) this.O0.f26062a, 1073741824), View.MeasureSpec.makeMeasureSpec((int) this.O0.f26063b, 1073741824));
        ...
        measureChild(this.f4479i1, i10, i11);
        measureChild(this.f4465b1, i10, i11);
        measureChild(this.f4464a1, i10, View.MeasureSpec.makeMeasureSpec(size2 - Math.max(getPKeyboardHeight(), this.f4476g2), 1073741824));
        ...
        this.M0 = false;
        if (AndroidUtilities.dp(20.0f) >= 0 && !this.f4470d2 && !this.f4474f2) {
            this.M0 = true;
            m0();
            this.M0 = false;
        }
    ...
    public final void q0(j jVar) {
        ...
        if (jVar == jVar2 && jVar2 != null) {
            ...
            if (jVar instanceof b4) {
                ValueAnimator valueAnimator = this.f4475g1;
                if (valueAnimator != null && this.f4471e1 != 0) {
                    valueAnimator.cancel();
                }
                B0(0);
            }
        ...
        t2 t2Var = this.f4479i1;
        o5.i iVar = this.f4481j1;
    ...
    public final boolean r0(j jVar, boolean z4) {
        ...
        int i11 = 2;
        if (z11 && (((i10 = this.f4471e1) == -1 && this.f4469d1 != 2) || (i10 != -1 && i10 != 2))) {
            ValueAnimator valueAnimator = this.f4475g1;
        ...
        if (z11 && z4) {
            ...
            k2Var.setTypeface(b4Var.getTypeface().f2512a);
            k2Var.e(b4Var.getType(), true);
            this.f4464a1.invalidate();
        }
        j jVar2 = this.P0;
        if (jVar2 != null) {
            if (jVar2 == jVar) {
        ...
        if (jVar5 != null) {
            ...
            if (jVar6 instanceof b4) {
                ...
                t2Var.setValueOverride(new j0(b4Var3, (int) (e1Var.O0.f26062a / 9.0f), 0));
                t2Var.setShowPreview(false);
                return true;
            }
            t2Var.setValueOverride(iVar);
            t2Var.setShowPreview(true);
            f2Var.f2386c = iVar.get();
            s0(f2Var, null);
            return true;
        }
        ValueAnimator valueAnimator2 = e1Var.f4475g1;
        if (valueAnimator2 != null && e1Var.f4471e1 != 0) {
    ...
    public final void s0(cg.f2 f2Var, Integer num) {
        ...
        s0 s0Var = this.T0;
        s0Var.setColor(i11);
        s0Var.setBrushSize(f2Var.f2386c);
        ...
        j jVar = this.P0;
        if (jVar instanceof b4) {
            ((b4) jVar).setSwatch(new cg.f2(f2Var.f2385b, f2Var.f2386c, f2Var.f2384a));
        }
    }
    ...
    public void setOffsetTranslationX(float f10) {
        if (this.f4469d1 == 0) {
            this.f4479i1.setTranslationX(f10);
        }
    }
    ...
    public final void t() {
        ...
        boolean z4 = this.f4470d2;
        if (z4 && (i3Var = ((mt0) this).f36200l2.H1) != null) {
            i3Var.e = true;
        }
        x0(!z4 ? 1 : 0);
        if (z4) {
    ...
    public final void v0(float f10, float f11, float f12, float f13, float f14) {
        ...
        for (int i10 = 0; i10 < 4; i10++) {
            ...
            float f24 = ((-this.f4476g2) / 2.0f) + f17;
            float f25 = f10 * f15;
            if (Float.isNaN(f25)) {
                f25 = 1.0f;
            }
        ...
        if (this.I1 != z4) {
            ...
            this.J1.b(new o1.g() {
                ...
                public final void a(o1.h hVar, float f12, float f13) {
                    ...
                    boolean z11 = z4;
                    z0Var.x1(f16, z11);
                    e1Var.f4498y0.setProgress(e1Var.K1);
                    e1Var.f4496x0.setProgress(e1Var.K1);
                    e1Var.f4467c1.setTranslationY(AndroidUtilities.dp(32.0f) * e1Var.K1);
                    if (zArr[0]) {
                        float f17 = e1Var.K1;
                        if (!z11) {
                            f17 = 1.0f - f17;
    ...
    public final void x(cg.m mVar) {
        ...
        f2Var.f2384a = cg.f1.e(this.M1).c();
        f2Var.f2386c = this.f4481j1.get();
    ...
    public final void x0(int i10) {
        ...
        if (i10 == 1) {
            ...
            if (this.f4468c2 == null) {
                ...
                if (AndroidUtilities.isTablet()) {
                    this.f4468c2.setForseMultiwindowLayout(true);
                }
                this.f4468c2.setDelegate(new r0(this));
                addView(this.f4468c2);
            }
            this.f4468c2.setVisibility(0);
            this.f4470d2 = true;
            kz kzVar4 = this.f4468c2;
            if (this.f4478h2 <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.f4478h2 = AndroidUtilities.dp(150.0f);
                } else {
                    this.f4478h2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height", AndroidUtilities.dp(200.0f));
                }
            }
            if (this.f4480i2 <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.f4480i2 = AndroidUtilities.dp(150.0f);
                } else {
                    this.f4480i2 = MessagesController.getGlobalEmojiSettings().getInt("kbd_height_land3", AndroidUtilities.dp(200.0f));
                }
            }
            Point point = AndroidUtilities.displaySize;
            if (point.x > point.y) {
            ...
            getHeight();
            if (!z4 && !this.f4472e2) {
                ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f4476g2, 0.0f);
