...
public final class b extends o6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        if (this.f9504a != bVar.f9504a || this.f9505b != bVar.f9505b || this.f9506c != bVar.f9506c || !n6.l.l(this.d, bVar.d) || !n6.l.l(this.e, bVar.e)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f9504a), Integer.valueOf(this.f9505b), Boolean.valueOf(this.f9506c)});
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        e0.s(parcel, 3, 4);
        parcel.writeInt(this.f9506c ? 1 : 0);
