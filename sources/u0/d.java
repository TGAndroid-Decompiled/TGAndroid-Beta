...
public final class d implements View.OnTouchListener {
    ...
    public final AccelerateInterpolator f46586b;
    public final r1 f46587c;
    public b0 d;
    public final float[] f46588e;
    public final float[] f46589f;
    public final int h;
    public final int f46590n;
    public final float[] f46591r;
    public final float[] f46592s;
    public final float[] v;
    public boolean f46593w;
    public boolean f46594x;
    public boolean f46595y;

    public d(r1 r1Var) {
        ?? obj = new Object();
        obj.f46581e = Long.MIN_VALUE;
        obj.f46583g = -1L;
        obj.f46582f = 0L;
        this.f46585a = obj;
        this.f46586b = new AccelerateInterpolator();
    ...
    public final void d() {
        ...
        a aVar = this.f46585a;
        int i11 = (int) (currentAnimationTimeMillis - aVar.f46581e);
        int i12 = aVar.f46579b;
        if (i11 > i12) {
            i10 = i12;
        } else if (i11 >= 0) {
            i10 = i11;
        ...
        aVar.f46583g = currentAnimationTimeMillis;
    }
