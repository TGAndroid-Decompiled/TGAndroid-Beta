...
public final class i implements ActionMode.Callback {
    public final ActionMode.Callback f43292a;
    public final TextView f43293b;
    public Class f43294c;
    public Method d;
    public boolean e;
    public boolean f43295f = false;

    public i(ActionMode.Callback callback, TextView textView) {
        this.f43292a = callback;
        this.f43293b = textView;
    }

    @Override
    public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f43292a.onActionItemClicked(actionMode, menuItem);
    }

    @Override
    public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f43292a.onCreateActionMode(actionMode, menu);
    }

    @Override
    public final void onDestroyActionMode(ActionMode actionMode) {
        this.f43292a.onDestroyActionMode(actionMode);
    }
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        try {
            if (this.e && this.f43294c.isInstance(menu)) {
        ...
        return this.f43292a.onPrepareActionMode(actionMode, menu);
    }
}
