...
import ld.u0;
public class x {
    public static final AtomicIntegerFieldUpdater f43076b = AtomicIntegerFieldUpdater.newUpdater(x.class, "_size$volatile");
    private volatile int _size$volatile;
    public t0[] f43077a;

    public final void a(t0 t0Var) {
        t0Var.e((u0) this);
        t0[] t0VarArr = this.f43077a;
        AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = f43076b;
        if (t0VarArr == null) {
            t0VarArr = new t0[4];
            this.f43077a = t0VarArr;
