...
public final class n {
    ...
    public static final AtomicLongFieldUpdater f43034f = AtomicLongFieldUpdater.newUpdater(n.class, "_state$volatile");
    public static final i5.c f43035g = new i5.c("REMOVE_FROZEN", 3);
    ...
    public final int a(Object obj) {
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = f43034f;
            ...
            int i12 = this.f43038c;
            if (((i11 + 2) & i12) != (i10 & i12)) {
                boolean z4 = this.f43037b;
                AtomicReferenceArray atomicReferenceArray = this.d;
                if (!z4 && atomicReferenceArray.get(i11 & i12) != null) {
                    int i13 = this.f43036a;
                    if (i13 < 1024 || ((i11 - i10) & 1073741823) > (i13 >> 1)) {
                        return 1;
                    }
                } else {
                    if (f43034f.compareAndSet(this, j10, ((-1152921503533105153L) & j10) | (((i11 + 1) & 1073741823) << 30))) {
                        ...
                        while ((atomicLongFieldUpdater.get(nVar) & 1152921504606846976L) != 0) {
                            ...
                            int i14 = nVar.f43038c & i11;
                            Object obj2 = atomicReferenceArray2.get(i14);
                            if ((obj2 instanceof m) && ((m) obj2).f43033a == i11) {
    ...
    public final boolean b() {
        ...
        long j10;
        do {
            atomicLongFieldUpdater = f43034f;
    ...
    public final n c() {
        ...
        while (true) {
            ...
            n nVar3 = new n(nVar.f43036a * 2, nVar.f43037b);
            int i10 = (int) (1073741823 & j10);
            int i11 = (int) ((1152921503533105152L & j10) >> 30);
            while (true) {
                int i12 = nVar.f43038c;
                int i13 = i10 & i12;
                if (i13 == (i12 & i11)) {
                    break;
                }
                ...
                nVar3.d.set(nVar3.f43038c & i10, obj);
                i10++;
            }
    ...
    public final Object d() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                if (f43034f.compareAndSet(nVar, j10, (j10 & (-1073741824)) | j11)) {
                ...
                if (z4) {
                    while (true) {
                        ...
                        if ((j12 & 1152921504606846976L) != 0) {
                            ...
                            n nVar2 = nVar;
                            if (f43034f.compareAndSet(nVar2, j12, (j12 & (-1073741824)) | j11)) {
                                nVar2.d.set(i14 & nVar2.f43038c, null);
                                nVar = null;
                            } else {
                                nVar = nVar2;
                            }
