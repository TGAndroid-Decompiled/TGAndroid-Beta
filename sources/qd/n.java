...
public final class n {
    public static final AtomicReferenceFieldUpdater f44843e = AtomicReferenceFieldUpdater.newUpdater(n.class, Object.class, "_next$volatile");
    public static final AtomicLongFieldUpdater f44844f = AtomicLongFieldUpdater.newUpdater(n.class, "_state$volatile");
    public static final com.google.android.gms.internal.clearcut.e f44845g = new com.google.android.gms.internal.clearcut.e("REMOVE_FROZEN", 2);
    private volatile Object _next$volatile;
    private volatile long _state$volatile;
    public final int f44846a;
    public final boolean f44847b;
    ...
    public final int a(Object obj) {
        while (true) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = f44844f;
            ...
            int i12 = this.f44848c;
            if (((i11 + 2) & i12) != (i10 & i12)) {
                boolean z4 = this.f44847b;
                AtomicReferenceArray atomicReferenceArray = this.d;
                if (!z4 && atomicReferenceArray.get(i11 & i12) != null) {
                    int i13 = this.f44846a;
                    if (i13 < 1024 || ((i11 - i10) & 1073741823) > (i13 >> 1)) {
                        return 1;
                    }
                } else {
                    if (f44844f.compareAndSet(this, j10, ((-1152921503533105153L) & j10) | (((i11 + 1) & 1073741823) << 30))) {
                        ...
                        while ((atomicLongFieldUpdater.get(nVar) & 1152921504606846976L) != 0) {
                            ...
                            int i14 = nVar.f44848c & i11;
                            Object obj2 = atomicReferenceArray2.get(i14);
                            if ((obj2 instanceof m) && ((m) obj2).f44842a == i11) {
    ...
    public final boolean b() {
        ...
        long j10;
        do {
            atomicLongFieldUpdater = f44844f;
    ...
    public final n c() {
        ...
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f44843e;
            n nVar2 = (n) atomicReferenceFieldUpdater.get(this);
            if (nVar2 != null) {
                return nVar2;
            }
            n nVar3 = new n(nVar.f44846a * 2, nVar.f44847b);
            int i10 = (int) (1073741823 & j10);
            int i11 = (int) ((1152921503533105152L & j10) >> 30);
            while (true) {
                int i12 = nVar.f44848c;
                int i13 = i10 & i12;
                if (i13 == (i12 & i11)) {
                    break;
                }
                ...
                nVar3.d.set(nVar3.f44848c & i10, obj);
                i10++;
            }
    ...
    public final Object d() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                if (f44844f.compareAndSet(nVar, j10, (j10 & (-1073741824)) | j11)) {
                ...
                if (z4) {
                    while (true) {
                        ...
                        if ((j12 & 1152921504606846976L) != 0) {
                            ...
                            n nVar2 = nVar;
                            if (f44844f.compareAndSet(nVar2, j12, (j12 & (-1073741824)) | j11)) {
                                nVar2.d.set(i14 & nVar2.f44848c, null);
                                nVar = null;
                            } else {
                                nVar = nVar2;
                            }
