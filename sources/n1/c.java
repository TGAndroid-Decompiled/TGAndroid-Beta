        ...
        switch (this.f15079a) {
            case 0:
                ...
                if (i10 != 0) {
                    ...
                    u7.b(obj);
                    this.f15080b = 1;
                    obj = this.d.invoke((b) this.f15081c, this);
                    if (obj == aVar) {
                        return aVar;
                    }
                }
                b bVar = (b) obj;
                bVar.f15078b.set(true);
                return bVar;
            default:
                ...
                u7.b(obj);
                Map unmodifiableMap = DesugarCollections.unmodifiableMap(((b) this.f15081c).f15077a);
