...
public final class c extends j implements p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f14855a) {
            case 0:
                return ((c) create(bVar, cVar)).invokeSuspend(i.f9617a);
            default:
                return ((c) create(bVar, cVar)).invokeSuspend(i.f9617a);
        }
    }
        ...
        switch (this.f14855a) {
            case 0:
                ...
                if (i10 != 0) {
                    ...
                    t7.b(obj);
                    this.f14856b = 1;
                    obj = this.d.invoke((b) this.f14857c, this);
                    if (obj == aVar) {
                        return aVar;
                    }
                }
                b bVar = (b) obj;
                bVar.f14854b.set(true);
                return bVar;
            default:
                jd.a aVar2 = jd.a.f12969a;
                int i11 = this.f14856b;
                if (i11 != 0) {
                    if (i11 == 1) {
                        b bVar2 = (b) this.f14857c;
                        t7.b(obj);
                        return bVar2;
                    }
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                ...
                t7.b(obj);
                Map unmodifiableMap = DesugarCollections.unmodifiableMap(((b) this.f14857c).f14853a);
