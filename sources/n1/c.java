...
public final class c extends j implements p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f14857a) {
            case 0:
                return ((c) create(bVar, cVar)).invokeSuspend(i.f9616a);
            default:
                return ((c) create(bVar, cVar)).invokeSuspend(i.f9616a);
        }
    }
        ...
        switch (this.f14857a) {
            case 0:
                ...
                if (i10 != 0) {
                    ...
                    t7.b(obj);
                    this.f14858b = 1;
                    obj = this.d.invoke((b) this.f14859c, this);
                    if (obj == aVar) {
                        return aVar;
                    }
                }
                b bVar = (b) obj;
                bVar.f14856b.set(true);
                return bVar;
            default:
                ...
                t7.b(obj);
                Map unmodifiableMap = DesugarCollections.unmodifiableMap(((b) this.f14859c).f14855a);
