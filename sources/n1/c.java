...
public final class c extends i implements p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f14198a) {
            case 0:
                return ((c) create(bVar, cVar)).invokeSuspend(sc.i.f44318a);
            default:
                return ((c) create(bVar, cVar)).invokeSuspend(sc.i.f44318a);
        }
    }
        ...
        switch (this.f14198a) {
            case 0:
                ...
                if (i10 != 0) {
                    ...
                    p7.b(obj);
                    this.f14199b = 1;
                    obj = this.d.invoke((b) this.f14200c, this);
                    if (obj == aVar) {
                        return aVar;
                    }
                }
                b bVar = (b) obj;
                bVar.f14197b.set(true);
                return bVar;
            default:
                ...
                p7.b(obj);
                Map unmodifiableMap = DesugarCollections.unmodifiableMap(((b) this.f14200c).f14196a);
