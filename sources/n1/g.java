...
public final class g {
    public static final g f15099a = new Object();
        ...
        try {
            ...
            if (!bVar.f15093b.get()) {
                if (pairs.length <= 0) {
                    ...
                    Map unmodifiableMap = DesugarCollections.unmodifiableMap(bVar.f15092a);
    ...
    public final void b(Object obj, l lVar) {
        w a2;
        Map unmodifiableMap = DesugarCollections.unmodifiableMap(((b) obj).f15092a);
        i.d(unmodifiableMap, "unmodifiableMap(preferencesMap)");
        m1.d k10 = m1.f.k();
        for (Map.Entry entry : unmodifiableMap.entrySet()) {
            Object value = entry.getValue();
            String str = ((d) entry.getKey()).f15097a;
            if (value instanceof Boolean) {
                m1.i y3 = k.y();
                boolean booleanValue = ((Boolean) value).booleanValue();
                y3.c();
                k.m((k) y3.f2304b, booleanValue);
                a2 = y3.a();
            } else if (value instanceof Float) {
                m1.i y10 = k.y();
                float floatValue = ((Number) value).floatValue();
                y10.c();
                k.n((k) y10.f2304b, floatValue);
                a2 = y10.a();
            } else if (value instanceof Double) {
                m1.i y11 = k.y();
                double doubleValue = ((Number) value).doubleValue();
                y11.c();
                k.l((k) y11.f2304b, doubleValue);
                a2 = y11.a();
            } else if (value instanceof Integer) {
                m1.i y12 = k.y();
                int intValue = ((Number) value).intValue();
                y12.c();
                k.o((k) y12.f2304b, intValue);
                a2 = y12.a();
            } else if (value instanceof Long) {
                m1.i y13 = k.y();
                long longValue = ((Number) value).longValue();
                y13.c();
                k.i((k) y13.f2304b, longValue);
                a2 = y13.a();
            } else if (value instanceof String) {
                m1.i y14 = k.y();
                y14.c();
                k.j((k) y14.f2304b, (String) value);
                a2 = y14.a();
            } else if (value instanceof Set) {
                m1.i y15 = k.y();
                m1.g l4 = h.l();
                l4.c();
                h.i((h) l4.f2304b, (Set) value);
                y15.c();
                k.k((k) y15.f2304b, l4);
                a2 = y15.a();
            } else {
            ...
            k10.getClass();
            k10.c();
            m1.f.i((m1.f) k10.f2304b).put(str, (k) a2);
        }
