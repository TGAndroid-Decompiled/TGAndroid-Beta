...
public final class g {
        ...
        try {
            ...
            if (!bVar.f14197b.get()) {
                if (pairs.length <= 0) {
                    ...
                    Map unmodifiableMap = DesugarCollections.unmodifiableMap(bVar.f14196a);
    ...
    public final void b(Object obj, n nVar) {
        x a2;
        Map unmodifiableMap = DesugarCollections.unmodifiableMap(((b) obj).f14196a);
        j.d(unmodifiableMap, "unmodifiableMap(preferencesMap)");
        m1.d k10 = m1.f.k();
        for (Map.Entry entry : unmodifiableMap.entrySet()) {
            Object value = entry.getValue();
            String str = ((d) entry.getKey()).f14201a;
            if (value instanceof Boolean) {
                i y10 = k.y();
                boolean booleanValue = ((Boolean) value).booleanValue();
                y10.c();
                k.m((k) y10.f755b, booleanValue);
                a2 = y10.a();
            } else if (value instanceof Float) {
                i y11 = k.y();
                float floatValue = ((Number) value).floatValue();
                y11.c();
                k.n((k) y11.f755b, floatValue);
                a2 = y11.a();
            } else if (value instanceof Double) {
                i y12 = k.y();
                double doubleValue = ((Number) value).doubleValue();
                y12.c();
                k.l((k) y12.f755b, doubleValue);
                a2 = y12.a();
            } else if (value instanceof Integer) {
                i y13 = k.y();
                int intValue = ((Number) value).intValue();
                y13.c();
                k.o((k) y13.f755b, intValue);
                a2 = y13.a();
            } else if (value instanceof Long) {
                i y14 = k.y();
                long longValue = ((Number) value).longValue();
                y14.c();
                k.i((k) y14.f755b, longValue);
                a2 = y14.a();
            } else if (value instanceof String) {
                i y15 = k.y();
                y15.c();
                k.j((k) y15.f755b, (String) value);
                a2 = y15.a();
            } else if (value instanceof Set) {
                i y16 = k.y();
                m1.g l10 = h.l();
                l10.c();
                h.i((h) l10.f755b, (Set) value);
                y16.c();
                k.k((k) y16.f755b, l10);
                a2 = y16.a();
            } else {
            ...
            k10.getClass();
            k10.c();
            m1.f.i((m1.f) k10.f755b).put(str, (k) a2);
        }
