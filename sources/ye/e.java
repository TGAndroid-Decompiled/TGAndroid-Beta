...
public final class e extends df.a {
    public final bf.h f47054a;
    public String f47055b;
    public final StringBuilder f47056c;

    public e(char c10, int i10, int i11) {
        ?? pVar = new p();
        this.f47054a = pVar;
        this.f47056c = new StringBuilder();
        pVar.f3539g = c10;
        pVar.h = i10;
        pVar.f3540i = i11;
    }
    ...
    public final void a(CharSequence charSequence) {
        if (this.f47055b == null) {
            this.f47055b = charSequence.toString();
            return;
        }
        StringBuilder sb2 = this.f47056c;
    ...
    @Override
    public final void d() {
        String a2 = af.a.a(this.f47055b.trim());
        bf.h hVar = this.f47054a;
        hVar.f3541j = a2;
        hVar.f3542k = this.f47056c.toString();
    }
    ...
    public final q3.h h(d dVar) {
        int i10 = dVar.e;
        int i11 = dVar.f47043b;
        CharSequence charSequence = dVar.f47042a;
        int i12 = dVar.f47046g;
        bf.h hVar = this.f47054a;
        if (i12 < 4) {
