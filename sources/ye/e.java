...
public final class e {
    public static final o1 f50898e = new o1(3);
    public final ze.a f50899a;
    ...
    public static String a(byte[] bArr, int i10, b bVar, boolean z4) {
        ...
        try {
            String str = new String(bArr, 0, i10, bVar.f50895a.name());
    ...
    public final String c(int i10, b bVar) {
        if (i10 <= this.f50899a.e()) {
            d dVar = (d) f50898e.get();
            byte[] bArr = dVar.f50897a;
            if (i10 > bArr.length) {
                int length = bArr.length;
                do {
                    length *= 2;
                } while (i10 > length);
                dVar.f50897a = new byte[length];
            }
            byte[] bArr2 = dVar.f50897a;
            int i11 = 0;
            while (true) {
                ai aiVar = this.d;
                if (i11 < i10) {
                    int read = ((com.google.firebase.messaging.d) aiVar.f25257b).read(bArr2, i11, i10 - i11);
                    if (read > 0) {
                        i11 += read;
                    } else {
    ...
    public final String d(int i10, b bVar) {
        int min = Math.min(i10, (int) this.f50899a.e());
        d dVar = (d) f50898e.get();
        byte[] bArr = dVar.f50897a;
        if (min > bArr.length) {
            int length = bArr.length;
