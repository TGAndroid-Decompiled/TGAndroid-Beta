...
public final class g extends df.a {
    ...
    public final Pattern f46738b;
    public final bf.j f46737a = new p();
    public boolean f46739c = false;
    public b0 d = new b0(12, (byte) 0);

    public g(Pattern pattern) {
        this.f46738b = pattern;
    }

    @Override
    public final void a(CharSequence charSequence) {
        b0 b0Var = this.d;
        StringBuilder sb2 = (StringBuilder) b0Var.f3842c;
        if (b0Var.f3841b != 0) {
            sb2.append('\n');
        }
        sb2.append(charSequence);
        b0Var.f3841b++;
        Pattern pattern = this.f46738b;
    ...
    @Override
    public final void d() {
        this.f46737a.f3540g = ((StringBuilder) this.d.f3842c).toString();
        this.d = null;
    }
