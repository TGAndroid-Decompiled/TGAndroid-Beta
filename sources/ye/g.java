...
public final class g extends df.a {
    ...
    public final Pattern f47040b;
    public final bf.j f47039a = new p();
    public boolean f47041c = false;
    public b0 d = new b0(12, (byte) 0);

    public g(Pattern pattern) {
        this.f47040b = pattern;
    }

    @Override
    public final void a(CharSequence charSequence) {
        b0 b0Var = this.d;
        StringBuilder sb2 = (StringBuilder) b0Var.f3848c;
        if (b0Var.f3847b != 0) {
            sb2.append('\n');
        }
        sb2.append(charSequence);
        b0Var.f3847b++;
        Pattern pattern = this.f47040b;
    ...
    @Override
    public final void d() {
        this.f47039a.f3545g = ((StringBuilder) this.d.f3848c).toString();
        this.d = null;
    }
