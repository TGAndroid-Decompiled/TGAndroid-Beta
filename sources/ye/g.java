...
public final class g extends df.a {
    ...
    public final Pattern f46734b;
    public final bf.j f46733a = new p();
    public boolean f46735c = false;
    public b0 d = new b0(12, (byte) 0);

    public g(Pattern pattern) {
        this.f46734b = pattern;
    }

    @Override
    public final void a(CharSequence charSequence) {
        b0 b0Var = this.d;
        StringBuilder sb2 = (StringBuilder) b0Var.f3844c;
        if (b0Var.f3843b != 0) {
            sb2.append('\n');
        }
        sb2.append(charSequence);
        b0Var.f3843b++;
        Pattern pattern = this.f46734b;
    ...
    @Override
    public final void d() {
        this.f46733a.f3542g = ((StringBuilder) this.d.f3844c).toString();
        this.d = null;
    }
