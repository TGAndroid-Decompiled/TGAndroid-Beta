...
public final class n implements ef.a {
    ...
    public int f46802b = 0;
    public final LinkedList f46803c = new LinkedList();
    ...
    public final int b(b bVar, b bVar2) {
        ef.a aVar;
        int i10 = bVar.f46742g;
        LinkedList linkedList = this.f46803c;
    ...
    public final void f(ef.a aVar) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (c10 > c11) {
                ...
                throw new IllegalArgumentException("Cannot add two delimiter processors for char '" + this.f46801a + "' and minimum length " + c10);
            }
        }
        linkedList.add(aVar);
        this.f46802b = c10;
