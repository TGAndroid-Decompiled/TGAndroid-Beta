...
public final class n implements ef.a {
    public final char f46796a;
    public int f46797b = 0;
    public final LinkedList f46798c = new LinkedList();
    ...
    public final int b(b bVar, b bVar2) {
        ...
        LinkedList linkedList = this.f46798c;
    ...
    public final void f(ef.a aVar) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (c10 > c11) {
                ...
                throw new IllegalArgumentException("Cannot add two delimiter processors for char '" + this.f46796a + "' and minimum length " + c10);
            }
        }
        linkedList.add(aVar);
        this.f46797b = c10;
