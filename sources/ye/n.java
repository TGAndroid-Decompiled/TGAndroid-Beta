...
public final class n implements ef.a {
    public final char f50043a;
    public int f50044b = 0;
    public final LinkedList f50045c = new LinkedList();
    ...
    public final int b(b bVar, b bVar2) {
        ef.a aVar;
        int i10 = bVar.f49980g;
        LinkedList linkedList = this.f50045c;
    ...
    public final void f(ef.a aVar) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (c10 > c11) {
                ...
                throw new IllegalArgumentException("Cannot add two delimiter processors for char '" + this.f50043a + "' and minimum length " + c10);
            }
        }
        linkedList.add(aVar);
        this.f50044b = c10;
