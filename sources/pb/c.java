...
public enum c {
    ...
    public static final HashMap f44258c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f44260a) {
                    f44258c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f44261b) {
                    d.put(str, cVar);
                }
            }
        }
