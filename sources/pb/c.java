...
public enum c {
    ...
    public static final HashMap f41099c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f41100a) {
                    f41099c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f41101b) {
                    d.put(str, cVar);
                }
            }
        }
