...
public enum c {
    ...
    public static final HashMap f44289c = new HashMap();
    ...
    static {
        ...
        for (c cVar : values()) {
            if (Charset.isSupported(cVar.name())) {
                for (int i10 : cVar.f44291a) {
                    f44289c.put(Integer.valueOf(i10), cVar);
                }
                d.put(cVar.name(), cVar);
                for (String str : cVar.f44292b) {
                    d.put(str, cVar);
                }
            }
        }
