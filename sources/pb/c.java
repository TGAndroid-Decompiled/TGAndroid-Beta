...
public final class c implements lv0, a0, androidx.activity.result.b, WebMessageListenerBoundaryInterface, s, o, s71, OnSuccessListener, n, f6.a, fb.o, x, b2, m, c5, h1 {
    ...
    public void D0(MessageObject messageObject) {
        ((ac) ((f6) this.f41066b).Q1).f(true);
    }

    @Override
    public void E(java.lang.String r14, long r15, int r17, java.lang.Object r18, long r19, long r21) {
        throw new UnsupportedOperationException("Method not decompiled: pb.c.E(java.lang.String, long, int, java.lang.Object, long, long):void");
    }

    @Override
    public void H(MessageObject messageObject) {
        ((ac) ((f6) this.f41066b).Q1).f(false);
    }

    @Override
    public void I(CharSequence charSequence) {
        c3 c3Var = ((o5) this.f41066b).E;
    ...
    public void J(int i10, int i11, boolean z10) {
        switch (this.f41065a) {
            case 27:
                ((ii.r) this.f41066b).I(i10, z10, i11, false, 0L);
                ii.r rVar = (ii.r) this.f41066b;
                dj0 dj0Var = rVar.O;
                if (dj0Var != null) {
                    dj0Var.i();
                    rVar.O = null;
                ...
                return;
            default:
                ((d2) this.f41066b).s0(i10, i11, z10);
                return;
        }
    }
    ...
    public boolean L(int i10) {
        switch (this.f41065a) {
            case 23:
                if (i10 == ((go0) this.f41066b).f9766d0) {
                    return true;
                }
                return false;
            default:
    ...
    @Override
    public void M(byte[] bArr, int i10, int i11, l lVar, h hVar) {
        boolean z10;
        d2.b a2;
        boolean z11;
        v vVar = (v) this.f41066b;
        vVar.H(i10 + i11, bArr);
        vVar.J(i10);
    ...
    public void O(ArrayList arrayList) {
        ...
        switch (this.f41065a) {
            case 23:
                go0 go0Var = (go0) this.f41066b;
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    go0Var.J.add(((a2) arrayList.get(i10)).f9674a);
                }
                gy gyVar = go0Var.U;
                if (gyVar != null) {
                    if (go0Var.D0 > 0) {
    ...
    public void accept(Object obj, Object obj2) {
        switch (this.f41065a) {
            case 11:
                w wVar = (w) obj;
                f fVar = (f) wVar.u();
                c6.d0 d0Var = ((e0) this.f41066b).f3979k;
                Parcel O0 = fVar.O0();
            ...
            default:
                ...
                O02.writeStringArray((String[]) this.f41066b);
                iVar.T0(O02, 5);
                return;
        }
    }
    ...
    public dc.d b(com.google.firebase.messaging.m r24) {
        throw new UnsupportedOperationException("Method not decompiled: pb.c.b(com.google.firebase.messaging.m):dc.d");
    }
    ...
    public void f(int i10) {
        ...
        switch (this.f41065a) {
            case 23:
                ...
                go0Var.D0--;
                go0Var.f9767e0 = i10;
                if (go0Var.f9769f0 != i10) {
                    go0Var.f9783s.clear();
                }
                if (go0Var.f9770g0 != i10) {
                    go0Var.I.clear();
                }
                go0Var.N = true;
                gy gyVar = go0Var.U;
    ...
    public Boolean h() {
        Bundle bundle = (Bundle) this.f41066b;
    ...
    public void j(Object obj) {
        ...
        switch (this.f41065a) {
            case 7:
                ...
                return;
            default:
                ProxyBillingActivityV2 proxyBillingActivityV2 = (ProxyBillingActivityV2) this.f41066b;
    ...
    public void n(int i10, String str) {
        ByteBuffer byteBuffer = (ByteBuffer) this.f41066b;
        C(i10, 2);
        try {
            int S = S(str.length());
            if (S == S(str.length() * 3)) {
    ...
    public void onStateChanged(boolean z10, int i10) {
        d7 d7Var = (d7) this.f41066b;
        a7 a7Var = d7Var.M;
        v71 v71Var = d7Var.f4533x;
        if (v71Var == null) {
            return;
        }
        if (v71Var.y()) {
    ...
    public void onSuccess(Object obj) {
        ...
        f2 f2Var;
        f1 b10;
        d6.a aVar = (d6.a) this.f41066b;
        Bundle bundle = (Bundle) obj;
        if (r0.f6477j) {
            Context context = aVar.f7510a;
            r rVar = aVar.f7513f;
            r0 r0Var = new r0(context, rVar, aVar.f7512c, aVar.f7516j, aVar.f7514g);
            ...
            r0Var.h = i11;
            l5.t.b(context);
            r0Var.f6482g = l5.t.a().c(j5.a.e).a("CAST_SENDER_SDK", new i5.c("proto"), b0.f6257a);
            ...
            if (i10 != 0) {
                ...
                e.f6182c = new c3.j0(rVar, new String[]{"com.google.android.gms.cast.DICTIONARY_CAST_STATUS_CODES_TO_APP_SESSION_ERROR", "com.google.android.gms.cast.DICTIONARY_CAST_STATUS_CODES_TO_APP_SESSION_CHANGE_REASON"});
            ...
            if (z10) {
                ...
                synchronized (f2.class) {
                    try {
                        if (f2.f6375k == null) {
                            f2.f6375k = new f2(sharedPreferences, r0Var, packageName);
                        }
                        f2Var = f2.f6375k;
                    } catch (Throwable th2) {
                        throw th2;
                ...
                String str = f2Var.f6378c;
                SharedPreferences sharedPreferences2 = f2Var.f6377b;
                HashSet hashSet = f2Var.f6379f;
                String string = sharedPreferences2.getString("feature_usage_sdk_version", null);
                String string2 = sharedPreferences2.getString("feature_usage_package_name", null);
                hashSet.clear();
                HashSet hashSet2 = f2Var.f6380g;
                hashSet2.clear();
                f2Var.h = 0L;
                String str2 = f2.f6374j;
    ...
    public void onVideoSizeChanged(int i10, int i11, int i12, float f7) {
        c2 c2Var = ((d7) this.f41066b).f4531w;
        if (c2Var != null) {
            float f10 = i10 / i11;
            if (Math.abs(c2Var.f41642y0 - f10) >= 1.0E-4f) {
                c2Var.f41642y0 = f10;
                c2Var.requestLayout();
            }
        }
    ...
    public boolean q(l.l lVar) {
        Window.Callback callback = ((g.s) this.f41066b).f9298f.getCallback();
        if (callback != null) {
    ...
    public c(Set set) {
        this.f41065a = 0;
        this.f41066b = new HashMap();
        Iterator it = set.iterator();
        while (it.hasNext()) {
            b bVar = (b) it.next();
            bVar.getClass();
            ((HashMap) this.f41066b).put(a.class, bVar.f41064a);
        }
    }
    ...
    public c(Context context) {
        ...
        this.f41066b = bundle == null ? Bundle.EMPTY : bundle;
    }
