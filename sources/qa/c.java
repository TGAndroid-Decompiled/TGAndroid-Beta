...
public final class c implements d {
    public static final Object f41516m = new Object();
    public final k9.h f41517a;
    public final sa.c f41518b;
    public final f3 f41519c;
    public final j d;
    public final n e;
    public final h f41520f;
    public final Object f41521g;
    public final ExecutorService h;
    public final r9.i f41522i;
    public String f41523j;
    public final HashSet f41524k;
    public final ArrayList f41525l;
    ...
    public c(k9.h hVar, pa.b bVar, ExecutorService executorService, r9.i iVar) {
        ...
        ?? obj = new Object();
        this.f41521g = new Object();
        this.f41524k = new HashSet();
        this.f41525l = new ArrayList();
        this.f41517a = hVar;
        this.f41518b = cVar;
        this.f41519c = f3Var;
        this.d = jVar;
    ...
    public final void a(i iVar) {
        synchronized (this.f41521g) {
            this.f41525l.add(iVar);
        }
    }
    ...
    public final ra.b c(ra.b bVar) {
        ...
        boolean z10;
        sa.b f7;
        k9.h hVar = this.f41517a;
        hVar.a();
        String str = hVar.f13550c.f13558a;
        String str2 = bVar.f42480a;
        hVar.a();
        String str3 = hVar.f13550c.f13562g;
        String str4 = bVar.d;
        sa.c cVar = this.f41518b;
        sa.d dVar = cVar.f43190c;
        if (dVar.b()) {
            ...
            for (int i10 = 0; i10 <= 1; i10++) {
                ...
                if (c11 != 0) {
                    ...
                    ra.a a13 = bVar.a();
                    a13.f42478f = "BAD CONFIG";
                    a13.f42476b = 5;
                    return a13.a();
                }
                String str5 = f7.f43185a;
                long j3 = f7.f43186b;
                j jVar = this.d;
                jVar.getClass();
                TimeUnit timeUnit = TimeUnit.MILLISECONDS;
                jVar.f41533a.getClass();
                long seconds = timeUnit.toSeconds(System.currentTimeMillis());
                ra.a a14 = bVar.a();
                a14.d = str5;
                a14.f42479g = Long.valueOf(j3);
    ...
    public final void f(ra.b bVar) {
        synchronized (f41516m) {
            try {
                k9.h hVar = this.f41517a;
                hVar.a();
                f3 a2 = f3.a(hVar.f13548a);
                this.f41519c.s(bVar);
                if (a2 != null) {
                    a2.z();
                }
    ...
    public final void g() {
        ...
        hVar.a();
        l.a("Please set a valid API key. A Firebase API key is required to communicate with Firebase server APIs: It authenticates your project with Google.Please refer to https://firebase.google.com/support/privacy/init-options.", j.f41532c.matcher(hVar.f13550c.f13558a).matches());
    }
    ...
    public final ra.b i(ra.b bVar) {
        int responseCode;
        boolean z10;
        String str = bVar.f42480a;
        String str2 = null;
        if (str != null && str.length() == 11) {
            ra.c cVar = (ra.c) this.e.get();
            synchronized (cVar.f42486a) {
                try {
                    String[] strArr = ra.c.f42485c;
                    int i10 = 0;
                    while (true) {
                        if (i10 < 4) {
                            String str3 = strArr[i10];
                            String str4 = cVar.f42487b;
                            String string = cVar.f42486a.getString("|T|" + str4 + "|" + str3, null);
        ...
        sa.c cVar2 = this.f41518b;
        k9.h hVar = this.f41517a;
        hVar.a();
        String str5 = hVar.f13550c.f13558a;
        String str6 = bVar.f42480a;
        k9.h hVar2 = this.f41517a;
        hVar2.a();
        String str7 = hVar2.f13550c.f13562g;
        k9.h hVar3 = this.f41517a;
        hVar3.a();
        String str8 = hVar3.f13550c.f13559b;
        sa.d dVar = cVar2.f43190c;
        if (dVar.b()) {
            ...
            while (i11 <= 1) {
                ...
                try {
                    ...
                    if (c11 != 0) {
                        if (c11 == 1) {
                            ra.a a10 = bVar.a();
                            a10.f42478f = "BAD CONFIG";
                            a10.f42476b = 5;
                            return a10.a();
                        }
                        throw new k("Firebase Installations Service is unavailable. Please try again later.");
                    }
                    String str9 = aVar.f43183b;
                    String str10 = aVar.f43184c;
                    j jVar = this.d;
                    jVar.getClass();
                    TimeUnit timeUnit = TimeUnit.MILLISECONDS;
                    jVar.f41533a.getClass();
                    long seconds = timeUnit.toSeconds(System.currentTimeMillis());
                    sa.b bVar2 = aVar.d;
                    String str11 = bVar2.f43185a;
                    long j3 = bVar2.f43186b;
                    ra.a a11 = bVar.a();
                    a11.f42477c = str9;
                    a11.f42476b = 4;
                    a11.d = str11;
                    a11.e = str10;
                    a11.f42479g = Long.valueOf(j3);
    ...
    public final void j(Exception exc) {
        synchronized (this.f41521g) {
            try {
                Iterator it = this.f41525l.iterator();
                while (it.hasNext()) {
                    if (((i) it.next()).a(exc)) {
                        it.remove();
                    }
    ...
    public final synchronized void m(ra.b bVar, ra.b bVar2) {
        try {
            if (this.f41524k.size() != 0 && !TextUtils.equals(bVar.f42480a, bVar2.f42480a)) {
                Iterator it = this.f41524k.iterator();
                if (it.hasNext()) {
                    if (it.next() == null) {
                        throw null;
                    }
