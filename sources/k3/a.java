...
public final class a implements o {
    public final int f13387a = 0;
    public final Object f13388b;

    public a(int i10) {
        if ((i10 & 1) != 0) {
            this.f13388b = new d0(65496, 2, "image/jpeg");
        } else {
            this.f13388b = new b();
        }
    }
    ...
    public final void g(q qVar) {
        switch (this.f13387a) {
            case 0:
                ((o) this.f13388b).g(qVar);
                return;
            default:
                h0 Z1 = qVar.Z1(0, 3);
                qVar.X1(new t(-9223372036854775807L));
                qVar.e1();
                s sVar = (s) this.f13388b;
                r a2 = sVar.a();
    ...
    public final int m(p pVar, c3.s sVar) {
        switch (this.f13387a) {
            case 0:
                return ((o) this.f13388b).m(pVar, sVar);
            default:
