...
public abstract class a extends c {
    public static final Logger f50533f;
    public static final f0 h;
    public ByteBuffer f50534e;
    ...
    static {
        ...
        f50533f = Logger.getLogger(a.class.getName());
    }

    @Override
    public final void _parseDetails(ByteBuffer byteBuffer) {
        Logger logger = f50533f;
        f(byteBuffer);
        this.f50534e = byteBuffer.slice();
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        i(byteBuffer);
        this.f50534e.rewind();
        byteBuffer.put(this.f50534e);
    }

    @Override
    public final long getContentSize() {
        return this.f50534e.limit() + 4;
    }
}
