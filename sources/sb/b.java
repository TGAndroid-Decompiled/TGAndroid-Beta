...
public final class b {
    public final nb.b f47696a;
    public final int f47698c;
    public final int d;
    public final int f47699e;
    public final int f47700f;
    public final float f47701g;
    public final ArrayList f47697b = new ArrayList(5);
    ...
    public final a b(int i10, int i11, int[] iArr) {
        ...
        float f9 = (i11 - i12) - (i15 / 2.0f);
        int i17 = (int) f9;
        int i18 = i15 * 2;
        nb.b bVar = this.f47696a;
        ...
        if (!Float.isNaN(f10)) {
            ...
            while (i13 < size) {
                ...
                i13++;
                a aVar = (a) obj;
                float f12 = aVar.f47695c;
                float f13 = aVar.f16969a;
                float f14 = aVar.f16970b;
                if (Math.abs(f10 - f14) <= f11 && Math.abs(f9 - f13) <= f11) {
                    float abs = Math.abs(f11 - f12);
                    if (abs <= 1.0f || abs <= f12) {
                        return new a((f13 + f9) / 2.0f, (f14 + f10) / 2.0f, (aVar.f47695c + f11) / 2.0f);
                    }
                }
            }
