...
public final class e extends cb.e {
    ...
    public static final Rect f2584f;
    public final ViewGroup f2585b;
    public int f2586c;
    ...
    public static m1 L(m1 m1Var, View view, View view2) {
        if (view != null && view2 != null && m1Var != null) {
            ...
            if (ug.i.c(view, view2, rectF)) {
                ...
                return m1Var.f43154a.m(Math.max(0, i10), Math.max(0, i11), Math.max(0, width), Math.max(0, height));
            }
            return null;
        }
        return null;
    ...
    public final m1 I(m1 m1Var, List list) {
        ...
        int i10 = 0;
        while (it.hasNext()) {
            i10 |= ((w0) it.next()).f43177a.c();
        }
        if (w8.a(i10, 8)) {
            Iterator it2 = this.d.iterator();
            while (it2.hasNext()) {
                d dVar = (d) it2.next();
                m1 L = L(m1Var, dVar.N(), this.f2585b);
                if (L != null) {
                    dVar.k(L);
                }
            }
