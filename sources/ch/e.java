...
public final class e extends d {
    ...
    public final void draw(Canvas canvas) {
        ...
        this.O = false;
        int l1 = i6.l1(this.J.getAlpha() * this.f4289p, this.d);
        if (Color.alpha(l1) != 0) {
            float f7 = this.f4287n;
            float f10 = this.f4288o;
            Paint paint = this.L;
            paint.setShadowLayer(f7, 0.0f, f10, l1);
            cVar.c(canvas, paint, this.f4286m);
        }
        canvas.save();
    ...
    public final void k() {
        b();
        c cVar = this.f4283j;
        this.M.setStrokeWidth(cVar.f4270i);
        this.N.setStrokeWidth(cVar.f4271j);
        int width = cVar.f4274m.width();
        int height = cVar.f4274m.height();
        Rect rect = this.I;
        ...
        if (!cVar.f4274m.isEmpty()) {
            this.K.setPosition(0, 0, cVar.f4274m.width(), cVar.f4274m.height());
            this.J.setPosition(0, 0, cVar.f4274m.width(), cVar.f4274m.height());
    ...
    public final void v() {
        super.v();
        this.L.setShadowLayer(this.f4287n, 0.0f, this.f4288o, this.d);
        this.M.setColor(this.f4280f);
        this.N.setColor(this.f4281g);
        this.O = true;
    }

    @Override
    public final void w() {
        float f7 = this.f4277a;
        ...
        if (this.P != null && Build.VERSION.SDK_INT >= 33) {
            ...
            float[] fArr = cVar.f4267c;
            iVar.a(width, height, fArr[0], fArr[2], fArr[4], fArr[6], max, cVar.f4269g, cVar.h, this.e);
        }
        ...
        if (this.f4280f != 0) {
            d.e(beginRecording2, rect2.width(), rect2.height(), cVar.f4266b, cVar.f4270i, true, this.M);
        }
        if (this.f4281g != 0) {
            d.e(beginRecording2, rect2.width(), rect2.height(), cVar.f4266b, cVar.f4271j, false, this.N);
        }
        this.J.endRecording();
    }
}
