    ...
    public final void getOutline(View view, Outline outline) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                } else if (chatAttachAlertPhotoLayout.f21922d0) {
                    min = AndroidUtilities.lerp(min, view.getMeasuredHeight(), chatAttachAlertPhotoLayout.f21924e0);
                }
                boolean z10 = chatAttachAlertPhotoLayout.f21922d0;
                if (z10) {
                    RectF rectF = AndroidUtilities.rectTmp;
                    float f12 = chatAttachAlertPhotoLayout.f21942n1;
                    boolean z11 = ChatAttachAlertPhotoLayout.f21911q1;
                    float f13 = 1.0f - chatAttachAlertPhotoLayout.f21924e0;
                    rectF.set((0.0f * f13) + f12, (f13 * chatAttachAlertPhotoLayout.W) + chatAttachAlertPhotoLayout.f21937k1, chatAttachAlertPhotoLayout.f21939m1, chatAttachAlertPhotoLayout.l1);
            ...
            case 5:
                s2 s2Var = (s2) obj;
                if (s2Var.f29185b < 1.0f) {
                    outline.setRect((int) s2Var.O, (int) s2Var.N, (int) (view.getMeasuredWidth() - s2Var.O), (int) (view.getMeasuredHeight() - s2Var.N));
                    return;
                } else {
                    outline.setRoundRect((int) s2Var.O, (int) s2Var.N, (int) (view.getMeasuredWidth() - s2Var.O), (int) (view.getMeasuredHeight() - s2Var.N), s2Var.f29185b);
                    return;
                }
            default:
