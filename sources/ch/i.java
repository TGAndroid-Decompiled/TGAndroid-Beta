...
public final class i implements g, f, d {
    ...
    public int f2613w;
    public e f2615y;
    public final k f2607b = new k(0.0f);
    public final l f2608c = new l();
    public final l d = new l();
    public final AnimationNotificationsLocker e = new AnimationNotificationsLocker();
    public final c f2609f = new c(new h0(this, 1));
    public int f2612s = 1;
    public final h f2614x = new h(this, 0);

    public i(Runnable runnable) {
        this.h = runnable;
        this.f2606a = new xd.c(0, new bf.b(this, runnable, false, 20), r1.f20543w, 250L);
    }
    ...
    public final void a() {
        boolean z4 = this.f2606a.f46898g;
    ...
    public final float b() {
        ...
        if (eVar != null && this.D > 0) {
            return Math.max(this.C, lVar.d.f46913a);
        }
        return lVar.d.f46913a;
    }
    ...
    public final i0.b e(int i10) {
        m1 m1Var = this.f2611r;
        if (m1Var != null) {
            return m1Var.f43130a.f(i10);
        }
        return i0.b.e;
    }

    public final void f(int i10) {
        if (this.v == i10 && this.f2612s == 0) {
            return;
        }
        AndroidUtilities.cancelRunOnUIThread(this.f2614x);
        this.f2613w = Math.max(this.v, i10);
        this.v = i10;
        this.f2612s = 0;
        i(this.f2611r);
    }
    ...
    public final void j(m1 m1Var, boolean z4) {
        ...
        i0.b bVar3 = i0.b.e;
        if (m1Var != null) {
            bVar = m1Var.f43130a.g(647);
        } else {
            bVar = bVar3;
        }
        if (m1Var != null) {
            bVar3 = m1Var.f43130a.f(8);
        }
        c cVar2 = this.f2609f;
        b bVar4 = cVar2.f2600c;
        if (bVar3.d > 0) {
            z10 = true;
        } else {
            z10 = false;
