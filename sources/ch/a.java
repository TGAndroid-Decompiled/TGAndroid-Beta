...
public final class a implements gh.f, v60 {
    ...
    public void a(Canvas canvas, RectF rectF, float[] fArr) {
        ...
        paint2.setColor(this.f4257a);
        float f10 = dVar.f4284n;
        if (f10 > 0.0f) {
            paint2.setShadowLayer(f10, 0.0f, dVar.f4285o, dVar.d);
        }
        ...
        if (this.f4258b) {
            float[] copyOf = Arrays.copyOf(cVar.f4263b, 8);
            boolean c10 = e0.c(copyOf);
            float min = Math.min(rectF.width(), rectF.height()) / 2.0f;
            Paint paint3 = new Paint(1);
            if (Color.alpha(dVar.f4277f) > 0 && copyOf[0] > 0.0f) {
                ...
                float f14 = rectF.top;
                path2.addRoundRect(f13, cVar.f4267i + f14, rectF.right, Math.min(Math.max(copyOf[0], copyOf[2]) + f14, rectF.bottom), fArr2, Path.Direction.CCW);
                paint.setColor(dVar.f4277f);
            ...
            if (Color.alpha(dVar.f4278g) > 0 && copyOf[4] > f7) {
                Arrays.fill(fArr2, 0.0f);
                fArr2[4] = copyOf[4];
                fArr2[5] = copyOf[5];
                fArr2[6] = copyOf[6];
                ...
                path3.addRoundRect(rectF.left, Math.max(rectF.bottom - Math.max(copyOf[4], copyOf[6]), rectF.top), rectF.right, rectF.bottom - cVar.f4268j, fArr2, Path.Direction.CCW);
                paint.setColor(dVar.f4278g);
    ...
    public void b(ArrayList arrayList, boolean z10, boolean z11) {
        char c10;
        PrivacyControlActivity privacyControlActivity = (PrivacyControlActivity) this.f4259c;
        boolean[] zArr = privacyControlActivity.E;
        int i10 = privacyControlActivity.T;
        int i11 = this.f4257a;
        boolean z12 = this.f4258b;
        int i12 = 0;
        boolean z13 = true;
        if (i11 == i10) {
            ...
            boolean[] zArr2 = privacyControlActivity.f31509y;
        ...
        privacyControlActivity.f31477a.l();
    }
}
