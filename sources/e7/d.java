...
public abstract class d extends a implements List, RandomAccess, j$.util.List {
    ...
    public static final b f5319b = new b(g.f5324e, 0);
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                while (bVarListIterator.hasNext()) {
                    if (it.hasNext() && ((next = bVarListIterator.next()) == (next2 = it.next()) || (next != null && next.equals(next2)))) {
                    }
                }
                if (!it.hasNext()) {
                    return true;
    ...
    public d subList(int i10, int i11) {
        ...
        return i12 == 0 ? g.f5324e : new c(this, i10, i12);
    }

    @Override
    public final b listIterator(int i10) {
        s6.b(i10, size());
        return isEmpty() ? f5319b : new b(this, i10);
    }
