...
public final class a {
    ...
    public static final Object f5311b = new Object();

    public static volatile a f5312c;

    public final ConcurrentHashMap f5313a = new ConcurrentHashMap();
    ...
    public final void b(Context context, ServiceConnection serviceConnection) {
        if (!(serviceConnection instanceof h0)) {
            ConcurrentHashMap concurrentHashMap = this.f5313a;
    ...
    public final boolean c(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i10, Executor executor) {
        ...
        if (component != null) {
            ...
            try {
                if ((b.a(context).f48802a.getPackageManager().getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
