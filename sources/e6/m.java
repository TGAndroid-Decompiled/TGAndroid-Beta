...
public final class m extends p {
    ...
    public final void n() {
        switch (this.f8009r) {
            case 0:
                g6.m mVar = this.f8011t.f7998c;
                g6.n o9 = o();
                mVar.getClass();
                double d = this.f8010s;
                if (!Double.isInfinite(d) && !Double.isNaN(d)) {
                    ...
                    mVar.f9428n.a(b10, o9);
                    return;
                }
                throw new IllegalArgumentException("Volume cannot be " + d);
            default:
                g6.m mVar2 = this.f8011t.f7998c;
                g6.n o10 = o();
                double d10 = this.f8010s;
                if (mVar2.f9421f != null) {
                    ...
                    try {
                        ...
                        n6.l.i(mVar2.f9421f, "mediaStatus should not be null");
                        jSONObject3.put("mediaSessionId", mVar2.f9421f.f4027b);
                    } catch (JSONException unused2) {
                    }
                    mVar2.c(b11, jSONObject3.toString());
                    mVar2.f9435u.a(b11, o10);
                    return;
                }
                throw new Exception();
        }
