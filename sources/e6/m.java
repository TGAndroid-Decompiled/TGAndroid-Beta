            ...
            default:
                ...
                if (mVar2.f9438f != null) {
                    ...
                    try {
                        ...
                        n6.l.i(mVar2.f9438f, "mediaStatus should not be null");
                        jSONObject3.put("mediaSessionId", mVar2.f9438f.f4035b);
                    } catch (JSONException unused2) {
                    }
                    mVar2.c(b11, jSONObject3.toString());
                    mVar2.f9452u.a(b11, o10);
                    return;
                }
                throw new Exception();
        }
