...
public final class m extends p {
    ...
    public final void n() {
        switch (this.f8010r) {
            case 0:
                g6.m mVar = this.f8012t.f7999c;
                g6.n o9 = o();
                mVar.getClass();
                double d = this.f8011s;
                if (!Double.isInfinite(d) && !Double.isNaN(d)) {
                    ...
                    mVar.f9429n.a(b10, o9);
                    return;
                }
                throw new IllegalArgumentException("Volume cannot be " + d);
            default:
                g6.m mVar2 = this.f8012t.f7999c;
                g6.n o10 = o();
                double d10 = this.f8011s;
                if (mVar2.f9422f != null) {
                    ...
                    try {
                        ...
                        n6.l.i(mVar2.f9422f, "mediaStatus should not be null");
                        jSONObject3.put("mediaSessionId", mVar2.f9422f.f4027b);
                    } catch (JSONException unused2) {
                    }
                    mVar2.c(b11, jSONObject3.toString());
                    mVar2.f9436u.a(b11, o10);
                    return;
                }
                throw new Exception();
        }
