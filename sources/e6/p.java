...
public abstract class p extends BasePendingResult {
    ...
    public final void p() {
        if (!this.f8018p) {
            Iterator it = this.f8019q.h.iterator();
            if (!it.hasNext()) {
                Iterator it2 = this.f8019q.f8001i.iterator();
                while (it2.hasNext()) {
                    ((g) it2.next()).f();
                }
            } else {
        ...
        try {
            synchronized (this.f8019q.f7996a) {
                n();
            }
        } catch (g6.k unused) {
