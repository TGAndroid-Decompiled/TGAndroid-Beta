...
public final class n implements OnFailureListener, c3.p, c3.q, l2.h, qo {
    ...
    public void m() {
        ...
        m2Var.e = profileActivity.f31580h5;
    ...
    public void n() {
        ProfileActivity profileActivity = (ProfileActivity) this.f8014c;
        boolean z10 = !profileActivity.getMessagesController().isDialogMuted(this.f8013b, profileActivity.f31569g1);
        profileActivity.getNotificationsController().muteDialog(this.f8013b, profileActivity.f31569g1, z10);
    ...
    public void o() {
        ...
        if (j3 != 0) {
            ...
            bundle.putLong("topic_id", profileActivity.f31569g1);
            profileActivity.presentFragment(new n11(bundle, profileActivity.f31697z0));
        }
    }
    ...
    public void onFailure(Exception exc) {
        ...
        switch (this.f8012a) {
            case 0:
                ...
                return;
            case 7:
                ((a9) this.f8014c).f44195b.set(this.f8013b);
                return;
            case 8:
    ...
    public void r() {
        ...
        long j3 = this.f8013b;
        boolean z10 = notificationsSettings.getBoolean(f0.i(j3, profileActivity.f31569g1, sb2), true);
        boolean z11 = !z10 ? 1 : 0;
        notificationsSettings.edit().putBoolean(f0.i(j3, profileActivity.f31569g1, new StringBuilder("sound_enabled_")), z11).apply();
        if (xc.a(profileActivity)) {
            xc.S(z10 ? 1 : 0, profileActivity, profileActivity.f31697z0).j();
        }
    }
    ...
    public void u(int i10) {
        ProfileActivity profileActivity = (ProfileActivity) this.f8014c;
        if (i10 == 0) {
            if (profileActivity.getMessagesController().isDialogMuted(this.f8013b, profileActivity.f31569g1)) {
                n();
            }
            if (xc.a(profileActivity)) {
                xc.z(profileActivity, 4, i10, profileActivity.f31697z0).j();
                return;
            }
            return;
        }
        profileActivity.getNotificationsController().muteUntil(this.f8013b, profileActivity.f31569g1, i10);
        if (xc.a(profileActivity)) {
            xc.z(profileActivity, 5, i10, profileActivity.f31697z0).j();
        }
        profileActivity.a5();
        profileActivity.g5(true);
    }
