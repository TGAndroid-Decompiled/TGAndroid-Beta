...
public final class n implements OnFailureListener, c3.p, c3.q, l2.h, no {
    ...
    public void m() {
        ...
        n2Var.f38067e = new HashSet();
        ProfileActivity profileActivity = (ProfileActivity) this.f8895c;
        n2Var.f38067e = profileActivity.f33915h5;
    ...
    public void n() {
        ProfileActivity profileActivity = (ProfileActivity) this.f8895c;
        boolean z10 = !profileActivity.getMessagesController().isDialogMuted(this.f8894b, profileActivity.f33904g1);
        profileActivity.getNotificationsController().muteDialog(this.f8894b, profileActivity.f33904g1, z10);
    ...
    public void onFailure(Exception exc) {
        ...
        switch (this.f8893a) {
            case 0:
                ...
                return;
            case 7:
                ((z8) this.f8895c).f47682b.set(this.f8894b);
                return;
            case 8:
    ...
    public void p() {
        ...
        if (j3 != 0) {
            ...
            bundle.putLong("topic_id", profileActivity.f33904g1);
            profileActivity.presentFragment(new y11(bundle, profileActivity.f34032z0));
        }
    }
    ...
    public void s() {
        ...
        long j3 = this.f8894b;
        boolean z10 = notificationsSettings.getBoolean(w1.i(j3, profileActivity.f33904g1, sb2), true);
        boolean z11 = !z10 ? 1 : 0;
        notificationsSettings.edit().putBoolean(w1.i(j3, profileActivity.f33904g1, new StringBuilder("sound_enabled_")), z11).apply();
        if (yc.a(profileActivity)) {
            yc.S(z10 ? 1 : 0, profileActivity, profileActivity.f34032z0).j();
        }
    }
    ...
    public void x(int i10) {
        ProfileActivity profileActivity = (ProfileActivity) this.f8895c;
        if (i10 == 0) {
            if (profileActivity.getMessagesController().isDialogMuted(this.f8894b, profileActivity.f33904g1)) {
                n();
            }
            if (yc.a(profileActivity)) {
                yc.z(profileActivity, 4, i10, profileActivity.f34032z0).j();
                return;
            }
            return;
        }
        profileActivity.getNotificationsController().muteUntil(this.f8894b, profileActivity.f33904g1, i10);
        if (yc.a(profileActivity)) {
            yc.z(profileActivity, 5, i10, profileActivity.f34032z0).j();
        }
        profileActivity.a5();
        profileActivity.g5(true);
    }
