...
public final class n implements OnFailureListener, c3.p, c3.q, l2.h, oo {
    ...
    public void l() {
        ...
        o2Var.e = profileActivity.f31312h5;
    ...
    public void n() {
        ProfileActivity profileActivity = (ProfileActivity) this.f8032c;
        boolean z10 = !profileActivity.getMessagesController().isDialogMuted(this.f8031b, profileActivity.f31301g1);
        profileActivity.getNotificationsController().muteDialog(this.f8031b, profileActivity.f31301g1, z10);
    ...
    public void o() {
        ...
        if (j3 != 0) {
            ...
            bundle.putLong("topic_id", profileActivity.f31301g1);
            profileActivity.presentFragment(new y11(bundle, profileActivity.f31429z0));
        }
    }
    ...
    public void onFailure(Exception exc) {
        ...
        switch (this.f8030a) {
            case 0:
                ...
                return;
            case 7:
                ((z8) this.f8032c).f44230b.set(this.f8031b);
                return;
            case 8:
    ...
    public void r() {
        ...
        long j3 = this.f8031b;
        boolean z10 = notificationsSettings.getBoolean(w1.i(j3, profileActivity.f31301g1, sb2), true);
        boolean z11 = !z10 ? 1 : 0;
        notificationsSettings.edit().putBoolean(w1.i(j3, profileActivity.f31301g1, new StringBuilder("sound_enabled_")), z11).apply();
        if (vc.a(profileActivity)) {
            vc.S(z10 ? 1 : 0, profileActivity, profileActivity.f31429z0).j();
        }
    }
    ...
    public void t(int i10) {
        ProfileActivity profileActivity = (ProfileActivity) this.f8032c;
        if (i10 == 0) {
            if (profileActivity.getMessagesController().isDialogMuted(this.f8031b, profileActivity.f31301g1)) {
                n();
            }
            if (vc.a(profileActivity)) {
                vc.z(profileActivity, 4, i10, profileActivity.f31429z0).j();
                return;
            }
            return;
        }
        profileActivity.getNotificationsController().muteUntil(this.f8031b, profileActivity.f31301g1, i10);
        if (vc.a(profileActivity)) {
            vc.z(profileActivity, 5, i10, profileActivity.f31429z0).j();
        }
        profileActivity.a5();
        profileActivity.g5(true);
    }
