...
public final class h implements c6.f {
    public static final g6.b f8013k = new g6.b("RemoteMediaClient", null);
    public final Object f8014a;
    public final c0 f8015b;
    public final g6.m f8016c;
    public final aa.a d;
    public final c e;
    public f0 f8017f;
    public TaskCompletionSource f8018g;
    public final CopyOnWriteArrayList h = new CopyOnWriteArrayList();
    public final CopyOnWriteArrayList f8019i = new CopyOnWriteArrayList();
    public final ConcurrentHashMap f8020j;
    ...
    public h(g6.m mVar) {
        ...
        this.f8020j = new ConcurrentHashMap();
        this.f8014a = new Object();
        this.f8015b = new c0(Looper.getMainLooper(), 0);
    ...
    public final c6.o c() {
        ...
        Integer num = (Integer) e.N.get(e.f4042w);
        if (num == null) {
            return null;
        }
    ...
    public final int s() {
        ...
        if (d() != null && h()) {
            ...
            if (k() && (c10 = c()) != null && c10.f4028a != null) {
                return 6;
            }
        }
        return 0;
    ...
    public final void u() {
        f0 f0Var = this.f8017f;
        if (f0Var == null) {
            return;
        }
        n6.l.e("Must be called from the main thread.");
        String str = this.f8016c.f9461b;
        e0 e0Var = (e0) f0Var;
        g6.a.b(str);
        ...
        v e = w.e();
        e.f6184c = new a0(e0Var, str, this);
        e.f6182a = 8413;
        e0Var.e(1, e.a());
        n6.l.e("Must be called from the main thread.");
        if (!w()) {
        ...
        if (f0Var != e0Var) {
            if (f0Var != null) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    v e = w.e();
                    e.f6184c = new a0(e0Var2, fVar, str);
                    e.f6182a = 8414;
                    e0Var2.e(1, e.a());
                    this.d.f359b = null;
