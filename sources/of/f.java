        ...
        if (launchActivity != null && (P = launchActivity.P()) != null) {
            if (!TextUtils.isEmpty(str)) {
                ...
                for (int i10 = 0; i10 < tabs.size(); i10++) {
                    n3Var = tabs.get(i10);
                    i4 i4Var = n3Var.J;
                    if (i4Var != null && !i4Var.f37217d0.isEmpty()) {
                        Object h = g.h(1, n3Var.J.f37217d0);
                        if (h instanceof z2) {
                            org.telegram.ui.web.z0 z0Var = ((z2) h).f21218b;
                            if (z0Var == null && (m3VarArr = n3Var.J.f37233u0) != null && (m3Var = m3VarArr[0]) != null) {
