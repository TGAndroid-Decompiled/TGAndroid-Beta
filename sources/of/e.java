...
public final class e {
    ...
    public void a(c1 c1Var, boolean z10) {
        ...
        ArrayList arrayList = c10.b(i10).f42816a;
        if (((t0) c10.f42829a.get(i10)).f42817b <= arrayList.size()) {
            return;
        }
        c1Var.o();
        arrayList.add(c1Var);
    ...
    public int b(int i10) {
        ...
        if (i10 >= 0 && i10 < recyclerView.f2863t0.b()) {
            if (!recyclerView.f2863t0.f42864g) {
                return i10;
            }
    ...
    public void i(View view) {
        ...
        } else if (V.h() && !V.j() && !recyclerView.f2866w.f42752b) {
