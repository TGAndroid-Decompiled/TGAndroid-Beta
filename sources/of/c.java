            ...
            default:
                ...
                if (webPage3 instanceof TLRPC.TL_webPage) {
                    ...
                    if (tL_webPage.cached_page != null) {
                        if (!i4Var.f37217d0.isEmpty() && i4Var.f37217d0.get(0) == webPage2) {
                            ...
                            if (z11) {
                                i4Var.f37217d0.add(tL_webPage);
                            } else {
                                i4Var.f37217d0.set(0, tL_webPage);
                            }
                        ...
                        if (i13 != i14) {
                            ...
                            while (true) {
                                ...
                                if (i10 < m3VarArr.length) {
                                    g4 g4Var = m3VarArr[i10].f38553c;
                                    if (g4Var.E == webPage2 && (K = i4Var.f37233u0[i10].f38552b.K(g4Var.h() - 1)) != null) {
                                        i4Var.f37233u0[i10].f38553c.y(K);
                                    }
                                    i10++;
