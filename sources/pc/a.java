...
public final class a {
    public final char[] f41122a;
    public final StringReader f41123b;
    public int f41124c;
    public int d;
    public int e;
    public int f41125f;
    ...
    public a(String str) {
        ...
        if (stringReader.markSupported()) {
            this.f41123b = stringReader;
            this.f41122a = new char[4096];
            b();
            return;
        }
    ...
    public final void b() {
        StringReader stringReader = this.f41123b;
        int i10 = this.e;
        if (i10 >= this.d) {
            try {
                stringReader.skip(i10);
                stringReader.mark(4096);
                int read = stringReader.read(this.f41122a);
                stringReader.reset();
                if (read != -1) {
                    this.f41124c = read;
                    this.f41125f += this.e;
    ...
    public final String f(char c3) {
        ...
        b();
        int i13 = this.e;
        String c11 = c(cArr, strArr, i13, this.f41124c - i13);
        this.e = this.f41124c;
        return c11;
    }
    ...
    public final char i() {
        ...
        return this.f41122a[i10];
    }

    public final boolean j() {
        b();
        if (this.e >= this.f41124c) {
            return true;
        }
        return false;
    }
    ...
    public final boolean k(String str) {
        ...
        if (length <= this.f41124c - this.e) {
            for (int i10 = 0; i10 < length; i10++) {
                if (str.charAt(i10) == this.f41122a[this.e + i10]) {
                }
            }
    ...
    public final boolean l(String str) {
        ...
        if (length <= this.f41124c - this.e) {
            for (int i10 = 0; i10 < length; i10++) {
                if (Character.toUpperCase(str.charAt(i10)) == Character.toUpperCase(this.f41122a[this.e + i10])) {
                }
            }
            this.e = str.length() + this.e;
            return true;
    ...
    public final int p(String str) {
        ...
        int i10 = this.e;
        while (i10 < this.f41124c) {
            char[] cArr = this.f41122a;
            if (charAt != cArr[i10]) {
                do {
                    i10++;
                    if (i10 >= this.f41124c) {
    ...
    public final String toString() {
        int i10 = this.e;
        return new String(this.f41122a, i10, this.f41124c - i10);
    }
}
