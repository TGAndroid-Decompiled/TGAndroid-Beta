...
public final class e implements s9.e, g {
    public final boolean f49158a = true;
    public final JsonWriter f49159b;
    public final Map f49160c;
    public final Map d;
    public final s9.d f49161e;
    public final boolean f49162f;

    public e(Writer writer, Map map, Map map2, s9.d dVar, boolean z10) {
        this.f49159b = new JsonWriter(writer);
        this.f49160c = map;
        this.d = map2;
        this.f49161e = dVar;
        this.f49162f = z10;
    ...
    public final s9.e a(s9.c cVar, double d) {
        String str = cVar.f47689a;
        j();
        JsonWriter jsonWriter = this.f49159b;
        jsonWriter.name(str);
        j();
        jsonWriter.value(d);
        return this;
    ...
    public final e h(Object obj) {
        ...
        if (obj == null) {
            ...
            if (obj.getClass().isArray()) {
                ...
                s9.d dVar = (s9.d) this.f49160c.get(obj.getClass());
                if (dVar != null) {
                    jsonWriter.beginObject();
                    dVar.a(obj, this);
                    jsonWriter.endObject();
