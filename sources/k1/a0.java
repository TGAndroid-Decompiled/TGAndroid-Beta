...
public final class a0 implements f {
    public static final LinkedHashSet f13150r = new LinkedHashSet();
    ...
    public List h;
    public final com.google.firebase.messaging.t f13156n;

    public a0(k0 k0Var, List list, na.d dVar, zd.c0 c0Var) {
        this.f13152a = k0Var;
        this.f13153b = dVar;
        this.h = hd.g.m(list);
        this.f13156n = new com.google.firebase.messaging.t(c0Var, new ie.g(this, 1), new m(this, null, 0));
    }
    ...
    public final Object a(rd.p pVar, kd.c cVar) {
        zd.t a2 = e0.a();
        this.f13156n.f(new j(pVar, a2, (b0) this.f13155f.c(), cVar.getContext()));
        Object h = a2.h(cVar);
