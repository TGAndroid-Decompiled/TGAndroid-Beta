...
public final class d0 {
    ...
    public d0(int i10, List list) {
        ...
        switch (i10) {
            case 1:
                this.f1346b = list;
                this.f1347c = new r3.v[list.size()];
                return;
            default:
                this.f1346b = list;
                this.f1347c = new r3.v[list.size()];
    ...
    public final void b(r3.m mVar, h0 h0Var) {
        ...
        switch (this.f1345a) {
            case 0:
                int i10 = 0;
                while (true) {
                    r3.v[] vVarArr = this.f1347c;
                    if (i10 < vVarArr.length) {
                        h0Var.a();
                        h0Var.b();
                        r3.v c22 = mVar.c2(h0Var.d, 3);
                        n0 n0Var = (n0) this.f1346b.get(i10);
                        String str = n0Var.C;
                        ...
                        m0Var.f8684o = str;
                        m0Var.d = n0Var.d;
                        m0Var.f8675c = n0Var.f8737c;
                        m0Var.G = n0Var.U;
                        m0Var.f8686q = n0Var.E;
                        c22.b(new n0(m0Var));
                        vVarArr[i10] = c22;
                        i10++;
                    } else {
            ...
            default:
                int i11 = 0;
                while (true) {
                    r3.v[] vVarArr2 = this.f1347c;
                    if (i11 < vVarArr2.length) {
                        h0Var.a();
                        h0Var.b();
                        r3.v c23 = mVar.c2(h0Var.d, 3);
                        n0 n0Var2 = (n0) this.f1346b.get(i11);
                        ...
                        m0Var2.f8684o = str3;
                        m0Var2.d = n0Var2.d;
                        m0Var2.f8675c = n0Var2.f8737c;
                        m0Var2.G = n0Var2.U;
                        m0Var2.f8686q = n0Var2.E;
                        c23.b(new n0(m0Var2));
                        vVarArr2[i11] = c23;
                        i11++;
                    } else {
