...
public final class e0 implements r3.e {
    ...
    public void B(o4.r rVar) {
        o4.v vVar = (o4.v) this.f1379c;
        vVar.getClass();
        Iterator it = ((CopyOnWriteArrayList) this.d).iterator();
        while (it.hasNext()) {
            o4.y yVar = (o4.y) it.next();
            h5.d0.K(yVar.f16415a, new androidx.car.app.utils.c(this, yVar.f16416b, vVar, rVar, 16));
        }
    }

    public void C(String str, y5.c cVar) {
        int i10 = this.f1378b + 1;
        Object[] objArr = (Object[]) this.f1379c;
        ...
        if (i11 > length) {
            if (i11 >= 0) {
                ...
                this.f1379c = Arrays.copyOf(objArr, i12);
            } else {
                throw new AssertionError("cannot store more than MAX_VALUE elements");
            }
        }
        Object[] objArr2 = (Object[]) this.f1379c;
        int i13 = this.f1378b;
        int i14 = i13 + i13;
        objArr2[i14] = str;
        objArr2[i14 + 1] = cVar;
    ...
    public byte[] E() {
        ...
        switch (this.f1377a) {
            case 10:
                h9 h9Var = h9.f9010c;
                com.google.firebase.messaging.r rVar = (com.google.firebase.messaging.r) this.f1379c;
                ((g8) this.d).h = false;
                g8 g8Var = (g8) this.d;
                g8Var.f8988f = Boolean.FALSE;
                rVar.f4004a = new h8(g8Var);
                try {
                    h9.b();
                    n6 n6Var = new n6(rVar);
                    af.d dVar4 = new af.d(20);
                    h9Var.a(dVar4);
                    HashMap hashMap = new HashMap((HashMap) dVar4.f159b);
                    HashMap hashMap2 = new HashMap((HashMap) dVar4.f160c);
            ...
            case 13:
                oa oaVar = oa.f11699c;
                a9.a aVar = (a9.a) this.f1379c;
                ((g8) this.d).h = false;
                g8 g8Var2 = (g8) this.d;
                g8Var2.f8988f = Boolean.FALSE;
                aVar.f142a = new o9(g8Var2);
                try {
                    oa.b();
                    v7 v7Var = new v7(aVar);
                    af.d dVar5 = new af.d(29);
                    oaVar.a(dVar5);
                    HashMap hashMap3 = new HashMap((HashMap) dVar5.f159b);
                    HashMap hashMap4 = new HashMap((HashMap) dVar5.f160c);
            ...
            default:
                ag agVar = ag.f14272c;
                s3 s3Var = (s3) this.f1379c;
                ((g8) this.d).h = false;
                g8 g8Var3 = (g8) this.d;
                g8Var3.f8988f = Boolean.FALSE;
                s3Var.f13625a = new xe(g8Var3);
                try {
                    ag.b();
                    jb jbVar = new jb(s3Var);
                    w0 w0Var = new w0(7);
                    agVar.a(w0Var);
                    HashMap hashMap5 = new HashMap((HashMap) w0Var.f11786b);
                    HashMap hashMap6 = new HashMap((HashMap) w0Var.f11787c);
    ...
    public void F(Bundle bundle) {
        ...
        this.f1378b = 1;
        this.d = bundle;
        for (Map.Entry entry : ((Map) this.f1379c).entrySet()) {
    ...
    public void a(int i10, int i11) {
        ...
        this.f1378b = i12;
        for (int i13 = 0; i13 < kf.g.f10427y; i13++) {
            ...
            kf.c0[] c0VarArr = (kf.c0[]) this.f1379c;
    ...
    public ea.b c() {
        if ("".isEmpty()) {
            return new ea.b((String) this.f1379c, ((Long) this.d).longValue(), this.f1378b);
        }
    ...
    public void g(String str, Object... objArr) {
        if (this.f1378b <= 3) {
            String str2 = (String) this.f1379c;
            if (objArr.length > 0) {
    ...
    public void i(o4.r rVar) {
        ...
        while (it.hasNext()) {
            o4.y yVar = (o4.y) it.next();
            h5.d0.K(yVar.f16415a, new p6(this, yVar.f16416b, rVar, 11));
        }
    }
    ...
    public long j(r3.l lVar) {
        ...
        while (lVar.g() < lVar.getLength() - 6) {
            ...
            if ((((bArr[0] & 255) << 8) | (bArr[1] & 255)) != i10) {
                ...
                System.arraycopy(bArr, 0, wVar.f6987a, 0, 2);
        ...
        return jbVar.f25932a;
    }

    public Object k(int i10) {
        SparseArray sparseArray = (SparseArray) this.f1379c;
        if (this.f1378b == -1) {
            this.f1378b = 0;
        }
        while (true) {
        ...
        while (this.f1378b < sparseArray.size() - 1 && i10 >= sparseArray.keyAt(this.f1378b + 1)) {
            this.f1378b++;
        }
        return sparseArray.valueAt(this.f1378b);
    }

    public boolean l() {
        ColorStateList colorStateList;
        if (((Shader) this.f1379c) == null && (colorStateList = (ColorStateList) this.d) != null && colorStateList.isStateful()) {
            return true;
        }
        return false;
    }
    ...
    public void o(o4.j jVar, o4.r rVar) {
        ...
        while (it.hasNext()) {
            o4.y yVar = (o4.y) it.next();
            h5.d0.K(yVar.f16415a, new o4.x(this, yVar.f16416b, jVar, rVar, 1));
        }
    }
    ...
    public void q(o4.j jVar, o4.r rVar) {
        ...
        while (it.hasNext()) {
            o4.y yVar = (o4.y) it.next();
            h5.d0.K(yVar.f16415a, new o4.x(this, yVar.f16416b, jVar, rVar, 0));
        }
    }
    ...
    public void t(o4.j jVar, o4.r rVar, IOException iOException, boolean z4) {
        ...
        while (it.hasNext()) {
            o4.y yVar = (o4.y) it.next();
            h5.d0.K(yVar.f16415a, new n1(this, yVar.f16416b, jVar, rVar, iOException, z4, 1));
        }
    }
    ...
    public void v(o4.j jVar, o4.r rVar) {
        ...
        while (it.hasNext()) {
            o4.y yVar = (o4.y) it.next();
            h5.d0.K(yVar.f16415a, new o4.x(this, yVar.f16416b, jVar, rVar, 2));
        }
    }

    public void x(Object obj, Object obj2) {
        int i10 = (this.f1378b + 1) * 2;
        Object[] objArr = (Object[]) this.f1379c;
        if (i10 > objArr.length) {
            this.f1379c = Arrays.copyOf(objArr, com.google.android.gms.common.api.internal.w.g(objArr.length, i10));
        }
        if (obj != null) {
            if (obj2 != null) {
                Object[] objArr2 = (Object[]) this.f1379c;
    ...
    public void y(int i10) {
        z(i10, 200L, mr.f27122f);
    }

    public void z(int i10, long j10, Interpolator interpolator) {
        ValueAnimator valueAnimator = (ValueAnimator) this.f1379c;
        if (valueAnimator != null) {
            valueAnimator.removeAllListeners();
            ((ValueAnimator) this.f1379c).cancel();
        }
        int[] iArr = new int[1];
        this.f1378b = 0;
        ...
        ((ValueAnimator) this.f1379c).addListener(new k3(this, i10, iArr, 2));
        ((ValueAnimator) this.f1379c).setDuration(j10);
        ((ValueAnimator) this.f1379c).setInterpolator(interpolator);
        ((ValueAnimator) this.f1379c).start();
    }
    ...
    public e0(int i10, byte b10) {
        ...
        switch (i10) {
            case 8:
                this.f1379c = new Object[8];
                this.f1378b = 0;
                return;
            case 12:
                int i11 = kf.g.f10427y;
                this.f1379c = new kf.c0[i11];
                this.d = new Bitmap[i11];
                return;
            case 18:
                this.f1379c = new tg.a();
                return;
            default:
                this.f1379c = DesugarCollections.synchronizedMap(new a0.k(0));
                this.f1378b = 0;
                return;
        }
    }
    ...
    public e0(String str, String[] strArr) {
        ...
        while (i10 <= 7 && !Log.isLoggable((String) this.f1379c, i10)) {
            i10++;
        }
        this.f1378b = i10;
    }
    ...
    public e0(o3.c cVar) {
        this.f1377a = 21;
        this.d = cVar;
        this.f1379c = r8.c.f43410a;
        this.f1378b = Integer.MAX_VALUE;
    }
