...
public final class i implements m {
    public static final byte[] f3399n = {0, 7, 8, 15};
    public static final byte[] f3400r = {0, 119, -120, -1};
    public static final byte[] f3401s = {0, 17, 34, 51, 68, 85, 102, 119, -120, -103, -86, -69, -52, -35, -18, -1};
    public final Paint f3402a;
    public final Paint f3403b;
    public final Canvas f3404c;
    public final b d;
    public final a e;
    public final h f3405f;
    public Bitmap h;
    ...
    public final void B(byte[] bArr, int i10, int i11, l lVar, e2.h hVar) {
                        ...
                        case 16:
                            if (i23 == hVar2.f3393a) {
                                ...
                                if (i26 != 0) {
                                    ...
                                    hVar2.e.clear();
                                    break;
                                } else if (dVar != null && dVar.f3379a != i25) {
                                    hVar2.f3398i = dVar2;
                                    break;
                                }
                            }
                            break;
                        case 17:
                            d dVar3 = hVar2.f3398i;
                            SparseArray sparseArray2 = hVar2.f3395c;
                            if (i23 == hVar2.f3393a && dVar3 != null) {
                                int i29 = hVar4.i(8);
                                hVar4.t(4);
                                boolean h = hVar4.h();
                                hVar4.t(3);
                                ...
                                if (dVar3.f3380b == 0 && (fVar2 = (f) sparseArray2.get(i29)) != null) {
                                    SparseArray sparseArray4 = fVar2.f3390j;
                                    for (int i43 = 0; i43 < sparseArray4.size(); i43++) {
                                        fVar3.f3390j.put(sparseArray4.keyAt(i43), (g) sparseArray4.valueAt(i43));
                                    }
                                }
                                sparseArray2.put(fVar3.f3384a, fVar3);
                                break;
                            }
                            break;
                        case 18:
                            if (i23 == hVar2.f3393a) {
                                a f10 = f(hVar4, i24);
                                hVar2.d.put(f10.f3369a, f10);
                                break;
                            } else if (i23 == hVar2.f3394b) {
                                a f11 = f(hVar4, i24);
                                hVar2.f3396f.put(f11.f3369a, f11);
                                break;
                            }
                            break;
                        case 19:
                            if (i23 == hVar2.f3393a) {
                                c g10 = g(hVar4);
                                hVar2.e.put(g10.f3376a, g10);
                                break;
                            } else if (i23 == hVar2.f3394b) {
                                c g11 = g(hVar4);
                                hVar2.f3397g.put(g11.f3376a, g11);
                                break;
                            }
                            break;
                        case 20:
        ...
        if (dVar4 == null) {
            ...
            Canvas canvas = this.f3404c;
            if (bitmap == null || bVar2.f3372a + 1 != bitmap.getWidth() || bVar2.f3373b + 1 != this.h.getHeight()) {
                Bitmap createBitmap = Bitmap.createBitmap(bVar2.f3372a + 1, bVar2.f3373b + 1, Bitmap.Config.ARGB_8888);
                this.h = createBitmap;
                canvas.setBitmap(createBitmap);
            }
            ArrayList arrayList2 = new ArrayList();
            SparseArray sparseArray5 = (SparseArray) dVar4.f3381c;
            int i47 = 0;
            while (i47 < sparseArray5.size()) {
                canvas.save();
                e eVar = (e) sparseArray5.valueAt(i47);
                f fVar4 = (f) hVar2.f3395c.get(sparseArray5.keyAt(i47));
                int i48 = eVar.f3382a + bVar2.f3374c;
                int i49 = eVar.f3383b + bVar2.e;
                int i50 = fVar4.f3386c;
                int i51 = fVar4.f3387f;
                int i52 = fVar4.d;
                int i53 = i48 + i50;
                int i54 = i49 + i52;
                SparseArray sparseArray6 = sparseArray5;
                canvas.clipRect(i48, i49, Math.min(i53, bVar2.d), Math.min(i54, bVar2.f3375f));
                a aVar2 = (a) hVar2.d.get(i51);
                if (aVar2 == null && (aVar2 = (a) hVar2.f3396f.get(i51)) == null) {
                    aVar2 = this.e;
                }
                SparseArray sparseArray7 = fVar4.f3390j;
                int i55 = i47;
                int i56 = 0;
                while (i56 < sparseArray7.size()) {
                    ...
                    if (cVar2 != null) {
                        ...
                        int i59 = fVar4.e;
                        hVar3 = hVar2;
                        int i60 = i58 + gVar.f3391a;
                        int i61 = i57 + gVar.f3392b;
                        if (i59 == 3) {
                            iArr = aVar2.d;
                        } else if (i59 == 2) {
                            iArr = aVar2.f3371c;
                        ...
                        i16 = i56;
                        i17 = i62;
                        e(cVar2.f3378c, iArr2, i59, i60, i61, paint2, canvas);
                ...
                if (fVar6.f3385b) {
                    int i67 = fVar6.e;
                    if (i67 == 3) {
                        i12 = aVar2.d[fVar6.f3388g];
                    } else if (i67 == 2) {
                        i12 = aVar2.f3371c[fVar6.h];
                    } else {
                        i12 = aVar2.f3370b[fVar6.f3389i];
                    }
                    Paint paint3 = this.f3403b;
                    paint3.setColor(i12);
                    canvas.drawRect(i64, i63, i53, i54, paint3);
                }
                Bitmap createBitmap2 = Bitmap.createBitmap(this.h, i64, i63, i65, i66);
                float f12 = bVar3.f3372a;
                float f13 = bVar3.f3373b;
