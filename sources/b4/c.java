...
public final class c implements r3.k {
    public final b f1433a = new b(null, 1);
    public final h5.w f1434b = new h5.w(16384);
    ...
    public final int h(r3.l lVar, jb jbVar) {
        h5.w wVar = this.f1434b;
        int read = ((r3.h) lVar).read(wVar.f7308a, 0, 16384);
        if (read == -1) {
            return -1;
        }
        wVar.F(0);
        wVar.E(read);
        boolean z4 = this.f1435c;
        b bVar = this.f1433a;
        if (!z4) {
            bVar.e(4, 0L);
            this.f1435c = true;
