...
public final class h extends s {
    ...
    public final void onCustomAction(String str, Bundle bundle) {
        ...
        switch (hashCode) {
            case -1699820260:
                if (str.equals("com.google.android.gms.cast.framework.action.REWIND")) {
                    long j3 = -iVar.e.f7988c;
                    e6.h hVar = iVar.f8986n;
                    if (hVar != null) {
                        long min = Math.min(hVar.g(), Math.max(0L, hVar.a() + j3));
                        e6.h hVar2 = iVar.f8986n;
                        if (hVar2 == null) {
                            return;
                        }
                        hVar2.q(new p(min));
            ...
            case 1362116196:
                if (str.equals("com.google.android.gms.cast.framework.action.FORWARD")) {
                    long j10 = iVar.e.f7988c;
                    e6.h hVar3 = iVar.f8986n;
                    if (hVar3 != null) {
                        long min2 = Math.min(hVar3.g(), Math.max(0L, hVar3.a() + j10));
                        e6.h hVar4 = iVar.f8986n;
                        if (hVar4 != null) {
                            hVar4.q(new p(min2));
                            return;
                        }
        ...
        intent.setComponent(iVar.f8980g);
        iVar.f8976a.sendBroadcast(intent);
    }
    ...
    public final boolean onMediaButtonEvent(Intent intent) {
        ...
        if (keyEvent != null) {
            if ((keyEvent.getKeyCode() == 127 || keyEvent.getKeyCode() == 126) && (hVar = this.f8975a.f8986n) != null) {
                hVar.r();
                return true;
            }
            return true;
