            ...
            case -1699820260:
                if (str.equals("com.google.android.gms.cast.framework.action.REWIND")) {
                    if (this.f8988r == null) {
                        ...
                        PendingIntent broadcast = PendingIntent.getBroadcast(context, 0, intent, a0.f6245a | 134217728);
                        g6.b bVar = j.f9010a;
                ...
                if (str.equals("com.google.android.gms.cast.framework.action.SKIP_NEXT")) {
                    ...
                    if (this.f8985o == null) {
                        if (z10) {
                            ...
                            pendingIntent = PendingIntent.getBroadcast(context, 0, intent2, a0.f6245a);
                        }
                ...
                if (str.equals("com.google.android.gms.cast.framework.action.SKIP_PREV")) {
                    ...
                    if (this.f8986p == null) {
                        if (z11) {
                            ...
                            pendingIntent = PendingIntent.getBroadcast(context, 0, intent3, a0.f6245a);
                        }
            ...
            case -668151673:
                if (str.equals("com.google.android.gms.cast.framework.action.STOP_CASTING")) {
                    if (this.f8990t == null) {
                        ...
                        this.f8990t = new e0.j(fVar.G, resources.getString(fVar.U), PendingIntent.getBroadcast(context, 0, intent4, a0.f6245a)).b();
                    }
                    return this.f8990t;
                }
                break;
            case -124479363:
                if (str.equals("com.google.android.gms.cast.framework.action.DISCONNECT")) {
                    if (this.f8989s == null) {
                        ...
                        this.f8989s = new e0.j(fVar.G, resources.getString(fVar.U, ""), PendingIntent.getBroadcast(context, 0, intent5, a0.f6245a)).b();
                    }
                    return this.f8989s;
                }
                break;
                ...
                if (str.equals("com.google.android.gms.cast.framework.action.TOGGLE_PLAYBACK")) {
                    ...
                    if (fVar2.f8969b) {
                        if (this.f8984n == null) {
                            ...
                            this.f8984n = new e0.j(i10, resources.getString(i11), PendingIntent.getBroadcast(context, 0, intent6, a0.f6245a)).b();
                        }
                        return this.f8984n;
                    }
                    if (this.f8983m == null) {
                        ...
                        this.f8983m = new e0.j(fVar.f8006n, resources.getString(fVar.L), PendingIntent.getBroadcast(context, 0, intent7, a0.f6245a)).b();
                    }
                    return this.f8983m;
                }
                break;
            case 1362116196:
                if (str.equals("com.google.android.gms.cast.framework.action.FORWARD")) {
                    if (this.f8987q == null) {
                        ...
                        PendingIntent broadcast2 = PendingIntent.getBroadcast(context, 0, intent8, a0.f6245a | 134217728);
                        g6.b bVar2 = j.f9010a;
    ...
    public final void b() {
        ...
        if (notificationManager != null && this.f8981k != null) {
                ...
                if (a11 != null) {
                    ...
                    while (i12 < size2) {
                        ...
                        if (!str.equals("com.google.android.gms.cast.framework.action.TOGGLE_PLAYBACK") && !str.equals("com.google.android.gms.cast.framework.action.SKIP_NEXT") && !str.equals("com.google.android.gms.cast.framework.action.SKIP_PREV") && !str.equals("com.google.android.gms.cast.framework.action.FORWARD") && !str.equals("com.google.android.gms.cast.framework.action.REWIND") && !str.equals("com.google.android.gms.cast.framework.action.STOP_CASTING") && !str.equals("com.google.android.gms.cast.framework.action.DISCONNECT")) {
                            ...
                            a2 = new e0.j(dVar.f8000b, dVar.f8001c, PendingIntent.getBroadcast(context, 0, intent2, a0.f6245a)).b();
                        } else {
                            a2 = a(str);
                        }
                        if (a2 != null) {
            ...
            if (mediaSessionCompat$Token != null) {
                b0Var.f48394f = mediaSessionCompat$Token;
            }
            tVar.n(b0Var);
