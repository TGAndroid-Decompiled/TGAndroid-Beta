...
public final class b extends AsyncTask {
    public static final g6.b f8962c = new g6.b("FetchBitmapTask", null);
    public final e f8963a;
    public final cf.c f8964b;
    ...
    public b(Context context, int i10, int i11, cf.c cVar) {
        ...
        g6.b bVar = com.google.android.gms.internal.cast.e.f6326a;
        try {
            ...
            e = e;
            com.google.android.gms.internal.cast.e.f6326a.a(e, "Unable to call %s on %s.", "newFetchBitmapTaskImpl", com.google.android.gms.internal.cast.g.class.getSimpleName());
            eVar = null;
            this.f8963a = eVar;
        } catch (d6.d e7) {
            e = e7;
    ...
    public final Object doInBackground(Object[] objArr) {
        ...
        if (uriArr.length == 1 && (uri = uriArr[0]) != null && (eVar = this.f8963a) != null) {
            try {
                c cVar = (c) eVar;
                Parcel O0 = cVar.O0();
                v.c(O0, uri);
                ...
                f8962c.a(e, "Unable to call %s on %s.", "doFetch", e.class.getSimpleName());
            }
        }
        return null;
    }
