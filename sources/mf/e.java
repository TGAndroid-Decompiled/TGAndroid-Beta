...
public final class e {
    public static final n1 f16232e = new n1(1);
    public final nf.a f16233a;
    public final h f16234b;
    public final f f16235c;
    public final l.d d;
    ...
    public static String a(byte[] bArr, int i10, b bVar, boolean z10) {
        ...
        try {
            String str = new String(bArr, 0, i10, bVar.f16229a.name());
    ...
    public final String c(int i10, b bVar) {
        if (i10 <= this.f16233a.e()) {
            d dVar = (d) f16232e.get();
            byte[] bArr = dVar.f16231a;
            if (i10 > bArr.length) {
                int length = bArr.length;
                do {
                    length *= 2;
                } while (i10 > length);
                dVar.f16231a = new byte[length];
            }
            byte[] bArr2 = dVar.f16231a;
            int i11 = 0;
            while (true) {
                l.d dVar2 = this.d;
                if (i11 < i10) {
                    int read = ((com.google.firebase.messaging.d) dVar2.f15098b).read(bArr2, i11, i10 - i11);
                    if (read > 0) {
                        i11 += read;
                    } else {
    ...
    public final String d(int i10, b bVar) {
        int min = Math.min(i10, (int) this.f16233a.e());
        d dVar = (d) f16232e.get();
        byte[] bArr = dVar.f16231a;
        if (min > bArr.length) {
            int length = bArr.length;
