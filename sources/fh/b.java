...
public final class b implements a {
    public final Paint f9065a;
    public final Matrix f9066b;
    public BitmapShader f9067c;
    public Bitmap d;
    public final Matrix e;
    public Bitmap f9068f;
    public int h;
    public int f9069n;
    ...
    public final void y(Canvas canvas, float f7, float f10, float f11, float f12) {
        Bitmap bitmap = this.d;
        if (bitmap != null && !bitmap.isRecycled() && this.f9067c != null) {
            Matrix matrix = this.e;
            Matrix matrix2 = this.f9066b;
            matrix.set(matrix2);
            matrix.postTranslate(f7, f10);
            this.f9067c.setLocalMatrix(matrix2);
            canvas.drawRect(f7, f10, f11, f12, this.f9065a);
        }
    }
