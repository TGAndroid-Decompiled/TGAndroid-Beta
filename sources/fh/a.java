...
public final class a implements d, f6 {
    ...
    public int f(f6 f6Var, boolean z10) {
        ...
        switch (this.f9550a) {
            case 0:
                if (!b.c(UserConfig.selectedAccount, this.f9551b)) {
            ...
            case 1:
                ...
                return j6.l1(f10, j6.v0(j6.f20679ce, f6Var));
            default:
                if (!b.c(UserConfig.selectedAccount, this.f9551b)) {
                    if (z10) {
                        i11 = j6.f20964s8;
                ...
                return j6.l1(f11, j6.v0(j6.f20679ce, f6Var));
        }
    }
