...
public final class m4 implements Utilities.Callback2 {
    public final int f6627a;
    public final g6 f6628b;
    public final String[] f6629c;
    public final ArrayList d;

    public m4(g6 g6Var, String[] strArr, ArrayList arrayList, int i9) {
        this.f6627a = i9;
        this.f6628b = g6Var;
        this.f6629c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        String[] strArr = this.f6629c;
        g6 g6Var = this.f6628b;
        switch (i9) {
            case 0:
                ...
                p5 p5Var = g6Var.d;
                boolean isEmpty = p5Var.f6710l.isEmpty();
                ...
                while (i10 < size) {
                    ...
                    boolean contains = p5Var.f6710l.contains(Long.valueOf(stargiftattributepattern.document.f22386id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.l0.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.l0.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) p5Var.f6713o.get(Long.valueOf(stargiftattributepattern.document.f22386id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            default:
                ...
                p5 p5Var3 = g6Var.d;
                boolean isEmpty3 = p5Var3.f6708j.isEmpty();
                ...
                while (i14 < size3) {
                    ...
                    boolean contains3 = p5Var3.f6708j.contains(Long.valueOf(stargiftattributemodel.document.f22386id));
                    boolean z12 = !contains3;
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.l0.w(str3, lowerCase3, stargiftattributemodel.name.toLowerCase()) && !org.telegram.messenger.l0.w(str3, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str2 = str3;
                    } else {
                        str2 = str3;
                        Integer num3 = (Integer) p5Var3.f6711m.get(Long.valueOf(stargiftattributemodel.document.f22386id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
