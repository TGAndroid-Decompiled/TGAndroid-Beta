...
public final class g implements b {
    public static final f f41182n = new f(0);
    public final l e;
    public final e h;
    public final HashMap f41183a = new HashMap();
    public final HashMap f41184b = new HashMap();
    public final HashMap f41185c = new HashMap();
    public final HashSet d = new HashSet();
    public final AtomicReference f41186f = new AtomicReference();
    ...
    public g(Executor executor, ArrayList arrayList, ArrayList arrayList2, e eVar) {
        ...
        synchronized (this) {
            ...
            while (it2.hasNext()) {
                Object[] array = ((a) it2.next()).f41175b.toArray();
            ...
            if (this.f41183a.isEmpty()) {
                ...
                ArrayList arrayList6 = new ArrayList(this.f41183a.keySet());
            ...
            while (i14 < size3) {
                ...
                i14++;
                a aVar2 = (a) obj4;
                this.f41183a.put(aVar2, new n(new k9.d(2, this, aVar2)));
            }
        ...
        Boolean bool = (Boolean) this.f41186f.get();
        if (bool != null) {
            d(this.f41183a, bool.booleanValue());
        }
    }
    ...
    public final synchronized pa.b e(r rVar) {
        ...
        return (pa.b) this.f41184b.get(rVar);
    }
    ...
    public final void g(boolean z10) {
        HashMap hashMap;
        AtomicReference atomicReference = this.f41186f;
        ...
        synchronized (this) {
            hashMap = new HashMap(this.f41183a);
        }
        d(hashMap, z10);
    }
    ...
    public final void h() {
        boolean z10;
        HashMap hashMap = this.f41184b;
        HashMap hashMap2 = this.f41185c;
        for (a aVar : this.f41183a.keySet()) {
            for (j jVar : aVar.f41176c) {
                if (jVar.f41193b == 2) {
                    z10 = true;
                } else {
                    z10 = false;
                ...
                if (z10 && !hashMap2.containsKey(rVar)) {
                    ...
                    ?? obj = new Object();
                    obj.f41202b = null;
                    obj.f41201a = Collections.newSetFromMap(new ConcurrentHashMap());
                    obj.f41201a.addAll(set);
                    hashMap2.put(rVar, obj);
                } else if (hashMap.containsKey(rVar)) {
                    continue;
                } else {
                    int i10 = jVar.f41193b;
                    if (i10 != 1) {
                        if (i10 != 2) {
                            hashMap.put(rVar, new p(p.f41203c, p.d));
                        }
                    } else {
    ...
    public final ArrayList j(ArrayList arrayList) {
        ...
        while (i10 < size) {
            ...
            a aVar = (a) obj;
            if (aVar.e == 0) {
                pa.b bVar = (pa.b) this.f41183a.get(aVar);
                for (r rVar : aVar.f41175b) {
                    HashMap hashMap = this.f41184b;
    ...
    public final ArrayList k() {
        HashMap hashMap = this.f41185c;
        ArrayList arrayList = new ArrayList();
        HashMap hashMap2 = new HashMap();
        for (Map.Entry entry : this.f41183a.entrySet()) {
        ...
        for (Map.Entry entry2 : hashMap2.entrySet()) {
            if (!hashMap.containsKey(entry2.getKey())) {
                ...
                obj.f41202b = null;
                obj.f41201a = Collections.newSetFromMap(new ConcurrentHashMap());
                obj.f41201a.addAll((Set) ((Collection) entry2.getValue()));
