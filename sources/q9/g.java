...
public final class g implements b {
    public static final f f41470n = new f(0);
    public final l e;
    public final e h;
    public final HashMap f41471a = new HashMap();
    public final HashMap f41472b = new HashMap();
    public final HashMap f41473c = new HashMap();
    public final HashSet d = new HashSet();
    public final AtomicReference f41474f = new AtomicReference();
    ...
    public g(Executor executor, ArrayList arrayList, ArrayList arrayList2, e eVar) {
        ...
        synchronized (this) {
            ...
            while (it2.hasNext()) {
                Object[] array = ((a) it2.next()).f41463b.toArray();
            ...
            if (this.f41471a.isEmpty()) {
                ...
                ArrayList arrayList6 = new ArrayList(this.f41471a.keySet());
            ...
            while (i14 < size3) {
                ...
                i14++;
                a aVar2 = (a) obj4;
                this.f41471a.put(aVar2, new n(new k9.d(2, this, aVar2)));
            }
        ...
        Boolean bool = (Boolean) this.f41474f.get();
        if (bool != null) {
            d(this.f41471a, bool.booleanValue());
        }
    }
    ...
    public final synchronized pa.b e(r rVar) {
        ...
        return (pa.b) this.f41472b.get(rVar);
    }
    ...
    public final void g(boolean z10) {
        HashMap hashMap;
        AtomicReference atomicReference = this.f41474f;
        ...
        synchronized (this) {
            hashMap = new HashMap(this.f41471a);
        }
        d(hashMap, z10);
    }
    ...
    public final void h() {
        boolean z10;
        HashMap hashMap = this.f41472b;
        HashMap hashMap2 = this.f41473c;
        for (a aVar : this.f41471a.keySet()) {
            for (j jVar : aVar.f41464c) {
                if (jVar.f41481b == 2) {
                    z10 = true;
                } else {
                    z10 = false;
                ...
                if (z10 && !hashMap2.containsKey(rVar)) {
                    ...
                    ?? obj = new Object();
                    obj.f41490b = null;
                    obj.f41489a = Collections.newSetFromMap(new ConcurrentHashMap());
                    obj.f41489a.addAll(set);
                    hashMap2.put(rVar, obj);
                } else if (hashMap.containsKey(rVar)) {
                    continue;
                } else {
                    int i10 = jVar.f41481b;
                    if (i10 != 1) {
                        if (i10 != 2) {
                            hashMap.put(rVar, new p(p.f41491c, p.d));
                        }
                    } else {
    ...
    public final ArrayList j(ArrayList arrayList) {
        ...
        while (i10 < size) {
            ...
            a aVar = (a) obj;
            if (aVar.e == 0) {
                pa.b bVar = (pa.b) this.f41471a.get(aVar);
                for (r rVar : aVar.f41463b) {
                    HashMap hashMap = this.f41472b;
    ...
    public final ArrayList k() {
        ...
        for (Map.Entry entry : this.f41471a.entrySet()) {
        ...
        for (Map.Entry entry2 : hashMap2.entrySet()) {
            if (!hashMap.containsKey(entry2.getKey())) {
                ...
                obj.f41490b = null;
                obj.f41489a = Collections.newSetFromMap(new ConcurrentHashMap());
                obj.f41489a.addAll((Set) ((Collection) entry2.getValue()));
