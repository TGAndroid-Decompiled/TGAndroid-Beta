...
public final class h extends o6.a {
    ...
    public h(String type, Bundle credentialRetrievalData, Bundle candidateQueryData, String requestMatcher, String requestType, String protocolType) {
        ...
        this.f9497a = type;
        this.f9498b = credentialRetrievalData;
        this.f9499c = candidateQueryData;
        this.d = requestMatcher;
        this.e = requestType;
        this.f9500f = protocolType;
        boolean z11 = true;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        e0.l(dest, 1, this.f9497a);
        e0.b(dest, 2, this.f9498b);
        e0.b(dest, 3, this.f9499c);
        e0.l(dest, 4, this.d);
        e0.l(dest, 5, this.e);
        e0.l(dest, 6, this.f9500f);
        e0.r(dest, q6);
    }
}
