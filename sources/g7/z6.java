...
public abstract class z6 {
    ...
    public static Method f7421b = null;
    ...
    public static boolean a(View view, KeyEvent keyEvent) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            ...
            WeakReference weakReference2 = i0Var2.f46912c;
            if (weakReference2 == null || weakReference2.get() != keyEvent) {
                i0Var2.f46912c = new WeakReference(keyEvent);
                if (i0Var2.f46911b == null) {
                    i0Var2.f46911b = new SparseArray();
                }
                SparseArray sparseArray = i0Var2.f46911b;
    ...
    public static boolean b(r0.k r7, android.view.View r8, android.view.Window.Callback r9, android.view.KeyEvent r10) {
        throw new UnsupportedOperationException("Method not decompiled: g7.z6.b(r0.k, android.view.View, android.view.Window$Callback, android.view.KeyEvent):boolean");
    }
}
