...
public final class f extends o6.a {
    ...
    public final Bundle f9479c;
    public final String d;
    public final String e;
    public final ResultReceiver f9480f;
    ...
    public f(String type, Bundle credentialData, Bundle candidateQueryData, String str, String str2, ResultReceiver resultReceiver) {
        ...
        this.f9477a = type;
        this.f9478b = credentialData;
        this.f9479c = candidateQueryData;
        this.d = str;
        this.e = str2;
        this.f9480f = resultReceiver;
    }
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        e0.l(dest, 1, this.f9477a);
        e0.b(dest, 2, this.f9478b);
        e0.b(dest, 3, this.f9479c);
        e0.l(dest, 4, this.d);
        e0.l(dest, 5, this.e);
        e0.k(dest, 6, this.f9480f, i10);
        e0.r(dest, q6);
    }
}
