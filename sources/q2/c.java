...
public final class c extends l {
    ...
    public final h2.f i(h hVar, j jVar, boolean z10) {
        ...
        e2.d.b(z11);
        try {
            int i10 = this.f41375p;
            if (i10 == -1) {
                Context context = this.f41374o;
                if (context != null) {
            ...
            aVar.f41371a = m7.a(byteBuffer.remaining(), i10, byteBuffer.array());
            aVar.timeUs = hVar.e;
            return null;
        } catch (s0 e) {
