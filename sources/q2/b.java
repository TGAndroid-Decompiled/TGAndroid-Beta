...
public final class b implements k {
    ...
    public l p(n nVar) {
        ...
        if (i10 >= 23 && (i10 >= 31 || ((context = this.f44151a) != null && i10 >= 28 && context.getPackageManager().hasSystemFeature("com.amazon.hardware.tv_screen")))) {
            int h = r0.h(((s) nVar.f6403c).f2397r);
