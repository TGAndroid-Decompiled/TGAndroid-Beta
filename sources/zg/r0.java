...
public abstract class r0 {
    ...
    public static boolean d(TLRPC.Reaction reaction, p0 p0Var) {
        if ((reaction instanceof TLRPC.TL_reactionEmoji) && p0Var.f49448g == 0 && TextUtils.equals(((TLRPC.TL_reactionEmoji) reaction).emoticon, p0Var.f49447f)) {
            return true;
        }
    ...
    public static y5 e(TLRPC.Document document, Long l4, Paint.FontMetricsInt fontMetricsInt) {
        y5 y5Var;
        if (document != null) {
            y5Var = new y5(document.f18349id, 1.0f, fontMetricsInt);
