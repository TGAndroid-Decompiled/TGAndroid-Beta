...
public final class c extends ViewGroup implements yd.a, NotificationCenter.NotificationCenterDelegate, xd.b {
    ...
    public final xd.a f51176a;
    public final xd.a f51177b;
    public final yd.b f51178c;
    public final ImageReceiver d;
    public final Paint f51179e;
    public final Paint f51180f;
    public final org.telegram.ui.Components.voip.h h;
    public final ImageReceiver f51181n;
    public l5 f51182r;
    public q0 f51183s;
    public final s v;
    public c9.a f51184w;
    public boolean f51185x;
    public final v1 f51186y;

    public c(Context context) {
        super(context);
        pr prVar = pr.h;
        this.f51176a = new xd.a(0, this, prVar, 320L, false);
        this.f51177b = new xd.a(1, this, prVar, 320L, false);
        this.f51178c = new yd.b(this);
        ...
        this.f51181n = new ImageReceiver(this);
    ...
    public final void L(int i10, float f10, float f11, xd.c cVar) {
        this.f51180f.setAlpha(Math.round(this.f51177b.f50504e * 100.0f));
        int round = Math.round(this.f51176a.f50504e * 220.0f);
    ...
    public final int a(float f10, float f11) {
        ...
        if (!((RectF) this.f51184w.f2330a).contains(f10, f11)) {
            return -1;
        }
        return 0;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        c9.a aVar = this.f51184w;
        if (aVar != null) {
            canvas.drawPath((Path) aVar.d, this.f51179e);
            if (Build.VERSION.SDK_INT >= 29 && this.B != null && canvas.isHardwareAccelerated()) {
                ...
                canvas.save();
                canvas.clipPath((Path) this.f51184w.d);
            ...
            Paint paint = this.f51180f;
            if (paint.getAlpha() > 0) {
                canvas.drawPath((Path) this.f51184w.d, paint);
            }
            if (this.f51176a.f50504e > 0.0f) {
                RectF rectF = this.H;
                rectF.set((RectF) this.f51184w.f2330a);
            ...
            this.d.draw(canvas);
            this.f51181n.draw(canvas);
            l5 l5Var = this.f51182r;
            if (l5Var != null) {
                l5Var.draw(canvas);
            }
        }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f51181n.onAttachedToWindow();
        l5 l5Var = this.f51182r;
        if (l5Var != null) {
            l5Var.a(this);
        }
        ...
        if (groupCallMessage != null) {
            groupCallMessage.subscribeToStateUpdates(this.f51186y);
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f51181n.onDetachedFromWindow();
        l5 l5Var = this.f51182r;
        if (l5Var != null) {
            l5Var.o(this);
        }
        ...
        GroupCallMessage groupCallMessage = this.E;
        if (groupCallMessage != null) {
            groupCallMessage.unsubscribeFromStateUpdates(this.f51186y);
        }
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int round2 = Math.round(((PointF) this.f51184w.f2335g).y);
        s sVar = this.v;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        c9.a aVar = this.f51184w;
        if (aVar == null || this.f51185x || aVar.f2331b != size) {
            int paddingLeft = getPaddingLeft();
            int paddingRight = getPaddingRight();
            q0 q0Var = this.f51183s;
            ...
            this.f51181n.setImageCoords((RectF) this.f51184w.f2334f);
            if (this.f51182r != null) {
                Rect rect = I;
                ((RectF) this.f51184w.f2334f).round(rect);
                this.f51182r.setBounds(rect);
            }
        }
        setMeasuredDimension(size, this.f51184w.f2332c);
        this.h.f32055f = Math.round(((RectF) this.f51184w.f2330a).width() + AndroidUtilities.dp(48.0f));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        return this.f51178c.a(motionEvent, this);
    }
    ...
    public void set(GroupCallMessage groupCallMessage) {
        ...
        if (groupCallMessage4 != null) {
            this.f51176a.a(groupCallMessage4.isSendDelayed(), false);
            this.f51177b.a(this.E.isSendError(), false);
        }
        ...
        ImageReceiver imageReceiver = this.f51181n;
        imageReceiver.setImage(null, null, null, null, null, 0);
        if (this.f51182r != null && isAttachedToWindow()) {
            this.f51182r.o(this);
        }
        this.f51182r = null;
        ...
        this.f51183s = groupCallMessage.visibleReaction;
        this.f51185x = true;
