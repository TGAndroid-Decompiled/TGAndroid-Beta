...
public final class z extends ViewOutlineProvider {
    public final Rect f49184a = new Rect();
    public final RectF f49185b = new RectF();
    public final RectF f49186c = new RectF();
    public final c0 d;
    ...
    public final void getOutline(View view, Outline outline) {
        c0 c0Var = this.d;
        float lerp = AndroidUtilities.lerp(c0Var.e, AndroidUtilities.dp(8.0f), c0Var.f48982j);
        RectF rectF = this.f49185b;
        rectF.set(0.0f, 0.0f, view.getMeasuredWidth(), view.getMeasuredHeight());
        RectF rectF2 = c0Var.f48979f;
        float f7 = c0Var.f48982j;
        RectF rectF3 = this.f49186c;
        AndroidUtilities.lerp(rectF2, rectF, f7, rectF3);
        Rect rect = this.f49184a;
        rectF3.round(rect);
