...
public final class b extends ReplacementSpan {
    public final TextPaint f48990a;
    public final RectF f48991b;
    public StaticLayout f48992c;
    public float d;
    public float e;
    public int f48993f;
    ...
    public final void a() {
        ...
        if (this.f48992c == null) {
            ...
            StaticLayout staticLayout = new StaticLayout(string, this.f48990a, i10, alignment, 1.0f, 0.0f, false);
            this.f48992c = staticLayout;
            this.d = staticLayout.getLineWidth(0);
            this.e = this.f48992c.getHeight();
        }
    }
