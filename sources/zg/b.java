...
public final class b extends za {
    public final TextView f51664a0;
    public final FrameLayout f51665b0;
    public Drawable f51666c0;
    public Drawable f51667d0;
    public TL_stories.Boost f51668e0;
    public final a f51669f0;

    public b(Context context) {
        super(context, 0, 0, false);
        int i10;
        int i11;
        this.f51669f0 = new a(getContext());
        this.f51665b0 = new FrameLayout(getContext());
        TextView textView = new TextView(getContext());
        this.f51664a0 = textView;
        textView.setTextColor(j6.v0(j6.G6, this.f23670y));
        this.f51664a0.setTypeface(AndroidUtilities.bold());
        this.f51664a0.setTextSize(12.0f);
        this.f51664a0.setGravity(17);
        this.f51665b0.addView(this.f51664a0, x5.c(22.0f, -2));
        this.f51665b0.setPadding(AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f), 0);
        FrameLayout frameLayout = this.f51665b0;
    ...
    public void setStatus(TL_stories.Boost boost) {
        ...
        FrameLayout frameLayout = this.f51665b0;
        TextView textView = this.f51664a0;
        int i11 = 0;
        j5 j5Var = this.f23661b;
