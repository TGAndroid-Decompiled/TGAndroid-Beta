...
public final class b extends za {
    public final TextView f51633a0;
    public final FrameLayout f51634b0;
    public Drawable f51635c0;
    public Drawable f51636d0;
    public TL_stories.Boost f51637e0;
    public final a f51638f0;

    public b(Context context) {
        super(context, 0, 0, false);
        int i10;
        int i11;
        this.f51638f0 = new a(getContext());
        this.f51634b0 = new FrameLayout(getContext());
        TextView textView = new TextView(getContext());
        this.f51633a0 = textView;
        textView.setTextColor(j6.v0(j6.G6, this.f23643y));
        this.f51633a0.setTypeface(AndroidUtilities.bold());
        this.f51633a0.setTextSize(12.0f);
        this.f51633a0.setGravity(17);
        this.f51634b0.addView(this.f51633a0, x5.c(22.0f, -2));
        this.f51634b0.setPadding(AndroidUtilities.dp(8.0f), 0, AndroidUtilities.dp(8.0f), 0);
        FrameLayout frameLayout = this.f51634b0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.S) {
            ...
            canvas.drawLine(dp, measuredHeight, measuredWidth - i10, getMeasuredHeight() - 1, j6.f20786k0);
        }
    }
    ...
    public void setStatus(TL_stories.Boost boost) {
        ...
        FrameLayout frameLayout = this.f51634b0;
        TextView textView = this.f51633a0;
        int i11 = 0;
        j5 j5Var = this.f23634b;
        ...
        if (i13 > 0) {
            ...
            a aVar = this.f51638f0;
            aVar.f51632f = valueOf;
            aVar.f51631e = aVar.f51628a.measureText(valueOf);
            aVar.invalidateSelf();
            j5Var.i(aVar);
        } else {
            j5Var.i(null);
