...
public final class c0 {
    ...
    public int F;
    public final b0 f49011a;
    public final WindowManager f49012b;
    public final w3 f49013c;
    public final boolean d;
    public float e;
    public float f49015g;
    public float h;
    public float f49017j;
    public boolean f49018k;
    public boolean f49019l;
    public final y f49020m;
    public final gk0 f49021n;
    public final List f49022o;
    public bc0 f49023p;
    public boolean f49024q;
    public final o2 f49025r;
    public final f6 f49026s;
    public float f49027t;
    public float f49028u;
    public boolean v;
    public boolean f49029w;
    public ValueAnimator f49030x;
    public final int f49031y;
    public ch.d f49032z;
    public final RectF f49014f = new RectF();
    public final RectF f49016i = new RectF();
    ...
    public c0(int i10, o2 o2Var, ArrayList arrayList, HashSet hashSet, gk0 gk0Var, f6 f6Var, boolean z10) {
        ...
        boolean z14 = gk0Var.f24283f1;
        boolean z15 = gk0Var.f24285g1;
        if (yVar.K1 != z14) {
            yVar.K1 = z14;
            yVar.L1 = z15;
    ...
    public static void a(c0 c0Var, boolean z10) {
        ...
        if (c0Var.E.isEmpty()) {
            ...
            f61 f61Var = yVar.f34466h0;
            if (z10) {
                yVar.f34457d0.m(false);
                f61Var.invalidate();
                ArrayList arrayList = f61Var.f35124a3;
                f61Var.g1();
                yVar.f34462f0.b();
                ...
                if (gk0Var.getPullingLeftProgress() > 0.0f) {
                    ...
                    gk0Var.O0 = true;
                    ValueAnimator valueAnimator2 = gk0Var.f24311y0;
                ...
                for (int i11 = 0; i11 < arrayList.size(); i11++) {
                    ...
                    for (int i12 = 0; i12 < j61Var.O.size(); i12++) {
                        if (((r61) j61Var.O.get(i12)).f37099b) {
                            ((r61) j61Var.O.get(i12)).f37099b = false;
                ...
                f61Var.invalidate();
                for (int i13 = 0; i13 < v51Var.f35124a3.size(); i13++) {
                    j61 j61Var2 = (j61) v51Var.f35124a3.get(i13);
                    for (int i14 = 0; i14 < j61Var2.O.size(); i14++) {
                        if (((r61) j61Var2.O.get(i14)).f37099b) {
                            ((r61) j61Var2.O.get(i14)).f37099b = false;
    ...
    public final void c(boolean z10) {
        ...
        y yVar = this.f49020m;
        int i11 = this.f49031y;
        w3 w3Var = this.f49013c;
        int[] iArr = this.A;
        b0 b0Var = this.f49011a;
        RectF rectF = this.f49014f;
        gk0 gk0Var = this.f49021n;
        rectF.set(gk0Var.f24306w);
        this.e = gk0Var.f24310y;
        int[] iArr2 = new int[2];
        if (z10) {
        ...
        if (!z10) {
            this.f49027t = b0Var.getTranslationY();
        } else {
            this.f49027t = topOffset;
        ...
        this.h = y3;
        rectF.offset(x10, y3);
        gk0Var.setCustomEmojiEnterProgress(this.f49017j);
        if (z10) {
        ...
        cwVar.m(z12);
        this.B.lock();
        ValueAnimator valueAnimator2 = this.f49030x;
        if (valueAnimator2 != null) {
            valueAnimator2.cancel();
        }
        this.C = true;
        float f10 = this.f49017j;
        if (i11 == 4) {
            if (z10) {
                f7 = 1.0f;
            }
            ...
            timeAnimator.f23680a = 0;
            timeAnimator.f23681b = 0;
            timeAnimator.setFloatValues(new float[]{f10, f7});
            valueAnimator = timeAnimator;
        }
        this.f49030x = valueAnimator;
        valueAnimator.addUpdateListener(new bb(12, this, z10));
        if (!z10) {
            i();
        }
        this.f49030x.addListener(new j70(17, this, z10));
        if (i11 == 4) {
            this.f49030x.setDuration(420L);
            this.f49030x.setInterpolator(qr.h);
        } else if (this.f49029w) {
            this.f49030x.setDuration(450L);
            this.f49030x.setInterpolator(new OvershootInterpolator(0.5f));
        } else {
            this.f49030x.setDuration(350L);
            this.f49030x.setInterpolator(qr.f27383f);
        }
        b0Var.invalidate();
        h(true);
        if (!z10) {
    ...
    public final void d() {
        if (!this.f49024q) {
            ...
            oc.e();
            this.f49024q = true;
            AndroidUtilities.hideKeyboard(this.f49013c);
            c(false);
            if (this.v) {
                o2 o2Var = this.f49025r;
    ...
    public final void h(boolean z10) {
        ...
        y yVar = this.f49020m;
        yVar.f34466h0.setLayerType(i10, null);
        yVar.f34462f0.setLayerType(i10, null);
        if (this.f49029w) {
            for (int i11 = 0; i11 < Math.min(yVar.f34457d0.f26505b.getChildCount(), 16); i11++) {
                yVar.f34457d0.f26505b.getChildAt(i11).setLayerType(i10, null);
            }
            return;
        }
        yVar.f34459e0.setLayerType(i10, null);
        yVar.f34457d0.setLayerType(i10, null);
    }
    ...
    public final void j(float f7, boolean z10) {
        ...
        int y12 = (int) (yVar.f34457d0.getY() + c61Var.getY() + yVar.getY());
        for (int i11 = 0; i11 < yVar.f34457d0.f26505b.getChildCount(); i11++) {
            View childAt2 = yVar.f34457d0.f26505b.getChildAt(i11);
    ...
    public final void k() {
        if (!this.f49029w) {
            y yVar = this.f49020m;
            yVar.f34462f0.setAlpha(this.f49017j);
            yVar.f34466h0.setAlpha(this.f49017j);
            yVar.f34468i0.setAlpha(this.f49017j);
            yVar.f34457d0.setAlpha(this.f49017j);
            yVar.f34459e0.setAlpha(this.f49017j);
        }
    }
    ...
    public final void l() {
        ...
        c61Var2.setPivotX(b0Var.f48999r);
        c61Var2.setPivotY(b0Var.f49000s);
        c61Var2.setScaleX(b0Var.f48998n);
        c61Var2.setScaleY(b0Var.f48998n);
    }
}
