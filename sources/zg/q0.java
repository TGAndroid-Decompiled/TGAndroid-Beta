...
public final class q0 {
    ...
    public boolean T;
    public v U;
    public float f49086a;
    public boolean f49087b;
    public int f49088c;
    public int d;
    public float e;
    public float f49089f;
    public float f49090g;
    public float h;
    ...
    public int f49099q;
    public int f49100r;
    public boolean f49101s;
    public final float f49102t;
    public int f49103u;
    public final org.telegram.ui.Cells.a0 f49107z;
    ...
    public static final m0 f49083a0 = new Object();
    public static int f49084b0 = 1;
    public static final cb1 f49085c0 = new cb1(25);
    public final ArrayList v = new ArrayList();
    public final ArrayList f49104w = new ArrayList();
    public final HashMap f49105x = new HashMap();
    public final HashMap f49106y = new HashMap();
    public final HashMap H = new HashMap();
    public final ArrayList N = new ArrayList();
    public final RectF O = new RectF();
    public final Rect P = new Rect();
    public final int f49096n = UserConfig.selectedAccount;

    public q0(org.telegram.ui.Cells.a0 a0Var) {
        this.f49107z = a0Var;
        o(this.B);
        this.f49102t = ViewConfiguration.get(ApplicationLoader.applicationContext).getScaledTouchSlop();
    }
    ...
    public static void o(d6 d6Var) {
        V.setColor(h6.v0(h6.f18886ie, d6Var));
    ...
    public final boolean a() {
        ...
        HashMap hashMap = this.f49106y;
        hashMap.clear();
        int i11 = 0;
        while (true) {
            arrayList = this.f49104w;
        ...
        while (true) {
            ...
            String str = n0Var.f49054o;
            wq wqVar = n0Var.F;
            n0 n0Var2 = (n0) hashMap.get(str);
            if (n0Var2 != null && n0Var.f49038b != n0Var2.f49038b) {
                n0Var2 = null;
            }
            if (n0Var2 != null) {
                hashMap.remove(n0Var.f49054o);
                int i13 = n0Var.f49062x;
                int i14 = n0Var2.f49062x;
                if (i13 == i14 && n0Var.f49063y == n0Var2.f49063y && n0Var.A == n0Var2.A && n0Var.f49061w == n0Var2.f49061w && n0Var.f49055p == n0Var2.f49055p && n0Var.T == null && n0Var2.T == null) {
                    n0Var.f49040c = 0;
                    i12++;
                } else {
                    n0Var.d = i14;
                    n0Var.e = n0Var2.f49063y;
                    n0Var.f49044f = n0Var2.A;
                    n0Var.f49048i = n0Var2.N;
                    n0Var.f49046g = n0Var2.O;
                    n0Var.h = n0Var2.P;
                    n0Var.f49040c = 3;
                    int i15 = n0Var.f49061w;
                    int i16 = n0Var2.f49061w;
                    if (i15 != i16 && wqVar != null) {
                        wqVar.c(i16, false);
                        wqVar.c(n0Var.f49061w, true);
                    }
                    j9 j9Var2 = n0Var.T;
                    if (j9Var2 != null || n0Var2.T != null) {
                        ...
                        if (j9Var3 != null && (j9Var = n0Var2.T) != null) {
                            ValueAnimator valueAnimator = j9Var.f25202f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (j9Var3.f25217w) {
                                    j9Var3.f25217w = false;
                                    j9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = j9Var3.f25200b[i18].h;
                                j9Var3.l(i18, j9Var.f25200b[i18].h, i10);
                                i18++;
                            }
                            j9Var3.b(false, true);
        ...
        if (!hashMap.isEmpty()) {
            ...
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                ((n0) arrayList.get(i20)).f49051l = ((n0) arrayList.get(i20)).f49053n;
                ((n0) arrayList.get(i20)).a();
            }
            z10 = true;
        }
        if (this.f49091i) {
            float f7 = this.f49090g;
            if (f7 != this.f49088c || this.h != this.d) {
                this.f49092j = true;
                this.e = f7;
                this.f49089f = this.h;
                z10 = true;
    ...
    public final void b(p0 p0Var) {
        ...
        if (p0Var.f49072g == 0) {
            ...
            if (hashMap.get(p0Var) == null) {
                ...
                imageReceiver.setParentView(this.f49107z);
                int i11 = Z;
                Z = i11 + 1;
                imageReceiver.setUniqKeyPrefix(Integer.toString(i11));
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(this.f49096n).getReactionsMap().get(p0Var.f49071f);
        ...
        if (!this.M || p0Var.f49072g == 0) {
            return;
        }
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                if (p0Var.f(((n0) arrayList.get(i10)).f49057r)) {
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        int i10 = 0;
        if (this.f49101s || this.f49087b || (messageObject = this.A) == null || (message = messageObject.messageOwner) == null || message.reactions == null) {
            return false;
        }
        float x10 = motionEvent.getX();
        float y3 = motionEvent.getY();
        org.telegram.ui.Cells.a0 a0Var = this.f49107z;
        if (e2.u(a0Var)) {
            y3 -= a0Var.getPaddingTop();
            if (a0Var instanceof w0) {
                x10 -= ((w0) a0Var).f21496j0 / 2.0f;
            }
        }
        float f7 = x10 - this.f49088c;
        float f10 = y3 - this.d;
        if (motionEvent.getAction() == 0) {
            ...
            while (true) {
                if (i10 >= size) {
                    break;
                } else if (f7 > ((n0) arrayList.get(i10)).f49062x && f7 < ((n0) arrayList.get(i10)).f49062x + ((n0) arrayList.get(i10)).A && f10 > ((n0) arrayList.get(i10)).f49063y && f10 < ((n0) arrayList.get(i10)).f49063y + ((n0) arrayList.get(i10)).B) {
            ...
            if (this.T && this.S != null && motionEvent.getAction() == 1) {
                TLRPC.ReactionCount reactionCount = this.S.f49036a;
    ...
    public final void d(Canvas canvas, float f7, Integer num) {
        ...
        boolean z11 = this.f49101s;
        ArrayList arrayList = this.f49104w;
        if (!z11 || !arrayList.isEmpty()) {
            float f12 = this.f49088c;
            float f13 = this.d;
            if (this.f49101s) {
                f12 = this.f49090g;
                f13 = this.h;
            } else if (this.f49092j) {
                float f14 = 1.0f - f7;
                f12 = (f12 * f7) + (this.e * f14);
                f13 = (f13 * f7) + (this.f49089f * f14);
            }
            float f15 = f12;
            float f16 = f13;
            int i10 = 0;
            ...
            while (true) {
                ...
                if (!Integer.valueOf(n0Var.f49057r.hashCode()).equals(this.C) && (num == null || n0Var.f49057r.hashCode() == num.intValue())) {
                    canvas2.save();
                    float f17 = n0Var.f49062x;
                    float f18 = n0Var.f49063y;
                    int i12 = (f7 > 1.0f ? 1 : (f7 == 1.0f ? 0 : -1));
                    if (i12 != 0 && n0Var.f49040c == 3) {
                        float f19 = 1.0f - f7;
                        f17 = (f17 * f7) + (n0Var.d * f19);
                        f18 = (f18 * f7) + (n0Var.e * f19);
                    }
                    if (i12 != 0 && n0Var.f49040c == 1) {
            ...
            while (i10 < arrayList.size()) {
                ...
                canvas2.save();
                canvas2.scale(f24, f24, (n0Var2.A / 2.0f) + n0Var2.f49062x + f15, (n0Var2.B / 2.0f) + n0Var2.f49063y + f16);
                ((n0) arrayList.get(i10)).d(canvas2, n0Var2.f49062x + f15, n0Var2.f49063y + f16, 1.0f, f23, false, this.E, this.D);
                canvas.restore();
                i10++;
                canvas2 = canvas;
            }
    ...
    public final void f(qm qmVar, Canvas canvas, int i10, Integer num) {
        int i11;
        if (!this.f49101s || !this.f49104w.isEmpty()) {
            int i12 = 0;
            while (true) {
                ArrayList arrayList = this.v;
                if (i12 < arrayList.size()) {
                    n0 n0Var = (n0) arrayList.get(i12);
                    if ((num == null || n0Var.f49057r.hashCode() == num.intValue()) && num != null) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(n0Var.f49059t);
                        ...
                        int i13 = n0Var.V;
                        p0 p0Var = n0Var.f49058s;
                        View view = n0Var.W;
                        if (n0Var.f49045f0 == null && n0Var.f49047g0 == null) {
                            if (view != null && (view.getParent() instanceof View)) {
                                view = (View) view.getParent();
                            }
                            if (n0Var.f49057r != null && !p0Var.f49068a) {
                                if (p0Var.f49071f != null) {
                                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i13).getReactionsMap().get(p0Var.f49071f);
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, h6.f18733a7, 1.0f);
                                        ImageReceiver imageReceiver = new ImageReceiver(view);
                                        n0Var.f49045f0 = imageReceiver;
                                        imageReceiver.setLayerNum(7);
                                        n0Var.f49045f0.onAttachedToWindow();
                                        n0Var.f49045f0.setRoundRadius(AndroidUtilities.dp(14.0f));
                                        n0Var.f49045f0.setAllowStartLottieAnimation(true);
                                        n0Var.f49045f0.setAllowStartAnimation(true);
                                        n0Var.f49045f0.setAutoRepeat(1);
                                        n0Var.f49045f0.setAllowDecodeSingleFrame(true);
                                        n0Var.f49045f0.setImage(ImageLocation.getForDocument(tL_availableReaction.activate_animation), "140_140", svgThumb, null, tL_availableReaction, 1);
                                    }
                                } else if (p0Var.f49072g != 0) {
                                    q5 q5Var = new q5(24, i13, p0Var.f49072g);
                                    n0Var.f49047g0 = q5Var;
                                    q5Var.a(view);
                                }
                            }
                        }
                        ...
                        if (interpolation > 0.0f) {
                            ImageReceiver imageReceiver2 = n0Var.f49045f0;
                            if (imageReceiver2 != null) {
                                imageReceiver2.setImageCoords(rectF2);
                                n0Var.f49045f0.setAlpha(interpolation);
                                n0Var.f49045f0.draw(canvas);
                            } else {
                                q5 q5Var2 = n0Var.f49047g0;
                                if (q5Var2 != null) {
                                    q5Var2.setBounds((int) rectF2.left, (int) rectF2.top, (int) rectF2.right, (int) rectF2.bottom);
                                    n0Var.f49047g0.setAlpha((int) (interpolation * 255.0f));
                                    n0Var.f49047g0.draw(canvas);
                                }
                            }
                            qmVar.invalidate();
                        }
    ...
    public final float i(float f7) {
        if (this.f49094l) {
            return (this.f49098p * f7) + ((1.0f - f7) * this.J);
        }
        return this.f49098p;
    }
    ...
    public final float j(float f7) {
        if (this.f49093k) {
            return (this.f49099q * f7) + ((1.0f - f7) * this.f49100r);
        }
        return this.f49099q;
    }

    public final n0 l(String str) {
        boolean z10 = this.f49087b;
        HashMap hashMap = this.f49105x;
        if (z10) {
    ...
    public final n0 m(p0 p0Var) {
        ...
        if (p0Var.f49068a) {
            ...
            if (str != null) {
                ...
                l4 = Long.toString(p0Var.f49072g);
            }
        }
        return l(l4);
    }
    ...
    public final boolean n() {
        if (this.L) {
            if ((!this.f49101s || !this.f49104w.isEmpty()) && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
                return true;
            }
            return false;
        }
    ...
    public final void p(int i10, int i11) {
        ...
        while (true) {
            ...
            if (z10) {
                ...
                } else if (wqVar != null && n0Var.f49061w > 1) {
                    n0Var.A = z0.C(8.0f, (int) Math.ceil(wqVar.f29781m), n0Var.A);
                }
            } else {
                ...
                if (n0Var.T != null && n0Var.U.size() > 0) {
                    ...
                    n0Var.T.f25210o = AndroidUtilities.dp(26.0f);
                } else if (n0Var.f49060u) {
                    n0Var.A = (int) (o6Var.d + AndroidUtilities.dp(8.0f) + n0Var.A);
                } else if (((int) Math.ceil(wqVar.f29781m)) > 0) {
                    n0Var.A = z0.C(8.0f, (int) Math.ceil(wqVar.f29781m), n0Var.A);
                } else {
        ...
        if (i11 == 5 && !arrayList.isEmpty()) {
            int i18 = ((n0) arrayList.get(0)).f49063y;
            int i19 = 0;
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                if (((n0) arrayList.get(i20)).f49063y != i18) {
                    int i21 = i20 - 1;
                    int i22 = i10 - (((n0) arrayList.get(i21)).f49062x + ((n0) arrayList.get(i21)).A);
                    while (i19 < i20) {
                        ((n0) arrayList.get(i19)).f49062x += i22;
                        i19++;
                    }
                    i19 = i20;
                }
            ...
            int i23 = i10 - (((n0) arrayList.get(size)).f49062x + ((n0) arrayList.get(size)).A);
            while (i19 <= size) {
                ((n0) arrayList.get(i19)).f49062x += i23;
                i19++;
            }
        } else if (i11 == 1 && !arrayList.isEmpty()) {
            for (int i24 = 0; i24 < arrayList.size(); i24++) {
                n0 n0Var2 = (n0) arrayList.get(i24);
                int i25 = n0Var2.f49064z;
                if (i25 >= 0 && i25 < arrayList2.size()) {
                    f7 = ((Integer) arrayList2.get(n0Var2.f49064z)).intValue();
                } else {
                    f7 = 0.0f;
                }
                n0Var2.f49062x = (int) e2.A(i10, f7, 2.0f, n0Var2.f49062x);
            }
        }
        this.f49103u = i14;
        if (i11 != 5 && i11 != 1) {
    ...
    public final void r() {
        ...
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                hashMap.put(((n0) arrayList.get(i10)).f49054o, (n0) arrayList.get(i10));
                i10++;
            } else {
                this.f49091i = !this.f49101s;
                this.f49090g = this.f49088c;
                this.h = this.d;
                this.F = this.f49099q;
                this.I = this.f49098p;
                return;
    ...
    public final void s(org.telegram.messenger.MessageObject r20, boolean r21, boolean r22, org.telegram.ui.ActionBar.d6 r23) {
        throw new UnsupportedOperationException("Method not decompiled: zg.q0.s(org.telegram.messenger.MessageObject, boolean, boolean, org.telegram.ui.ActionBar.d6):void");
    }
}
