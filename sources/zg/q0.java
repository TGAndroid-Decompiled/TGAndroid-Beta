...
public final class q0 {
    ...
    public float h;
    public boolean f49467i;
    public boolean f49468j;
    ...
    public int f49475q;
    public int f49476r;
    public boolean f49477s;
    public final float f49478t;
    public int f49479u;
    public final org.telegram.ui.Cells.a0 f49483z;
    ...
    public static final m0 f49459a0 = new Object();
    public static int f49460b0 = 1;
    public static final mb1 f49461c0 = new mb1(25);
    public final ArrayList v = new ArrayList();
    public final ArrayList f49480w = new ArrayList();
    public final HashMap f49481x = new HashMap();
    public final HashMap f49482y = new HashMap();
    public final HashMap H = new HashMap();
    public final ArrayList N = new ArrayList();
    public final RectF O = new RectF();
    public final Rect P = new Rect();
    public final int f49472n = UserConfig.selectedAccount;

    public q0(org.telegram.ui.Cells.a0 a0Var) {
        this.f49483z = a0Var;
        o(this.B);
        this.f49478t = ViewConfiguration.get(ApplicationLoader.applicationContext).getScaledTouchSlop();
    }
    ...
    public static void o(f6 f6Var) {
        V.setColor(j6.v0(j6.f19207ie, f6Var));
    ...
    public final boolean a() {
        ...
        HashMap hashMap = this.f49482y;
        hashMap.clear();
        int i11 = 0;
        while (true) {
            arrayList = this.f49480w;
        ...
        while (true) {
            ...
            String str = n0Var.f49430o;
            vq vqVar = n0Var.F;
            n0 n0Var2 = (n0) hashMap.get(str);
            if (n0Var2 != null && n0Var.f49414b != n0Var2.f49414b) {
                n0Var2 = null;
            }
            if (n0Var2 != null) {
                hashMap.remove(n0Var.f49430o);
                int i13 = n0Var.f49438x;
                int i14 = n0Var2.f49438x;
                if (i13 == i14 && n0Var.f49439y == n0Var2.f49439y && n0Var.A == n0Var2.A && n0Var.f49437w == n0Var2.f49437w && n0Var.f49431p == n0Var2.f49431p && n0Var.T == null && n0Var2.T == null) {
                    n0Var.f49416c = 0;
                    i12++;
                } else {
                    n0Var.d = i14;
                    n0Var.e = n0Var2.f49439y;
                    n0Var.f49420f = n0Var2.A;
                    n0Var.f49424i = n0Var2.N;
                    n0Var.f49422g = n0Var2.O;
                    n0Var.h = n0Var2.P;
                    n0Var.f49416c = 3;
                    int i15 = n0Var.f49437w;
                    int i16 = n0Var2.f49437w;
                    if (i15 != i16 && vqVar != null) {
                        vqVar.c(i16, false);
                        vqVar.c(n0Var.f49437w, true);
                    }
                    i9 i9Var2 = n0Var.T;
                    if (i9Var2 != null || n0Var2.T != null) {
                        ...
                        if (i9Var3 != null && (i9Var = n0Var2.T) != null) {
                            ValueAnimator valueAnimator = i9Var.f25038f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (i9Var3.f25053w) {
                                    i9Var3.f25053w = false;
                                    i9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = i9Var3.f25036b[i18].h;
                                i9Var3.l(i18, i9Var.f25036b[i18].h, i10);
                                i18++;
                            }
                            i9Var3.b(false, true);
        ...
        if (!hashMap.isEmpty()) {
            ...
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                ((n0) arrayList.get(i20)).f49427l = ((n0) arrayList.get(i20)).f49429n;
                ((n0) arrayList.get(i20)).a();
            }
            z10 = true;
        }
        if (this.f49467i) {
            float f7 = this.f49466g;
            if (f7 != this.f49464c || this.h != this.d) {
                this.f49468j = true;
                this.e = f7;
                this.f49465f = this.h;
                z10 = true;
    ...
    public final void b(p0 p0Var) {
        ...
        if (p0Var.f49448g == 0) {
            ...
            if (hashMap.get(p0Var) == null) {
                ...
                imageReceiver.setParentView(this.f49483z);
                int i11 = Z;
                Z = i11 + 1;
                imageReceiver.setUniqKeyPrefix(Integer.toString(i11));
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(this.f49472n).getReactionsMap().get(p0Var.f49447f);
        ...
        if (!this.M || p0Var.f49448g == 0) {
            return;
        }
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                if (p0Var.f(((n0) arrayList.get(i10)).f49433r)) {
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        int i10 = 0;
        if (this.f49477s || this.f49463b || (messageObject = this.A) == null || (message = messageObject.messageOwner) == null || message.reactions == null) {
            return false;
        }
        float x10 = motionEvent.getX();
        float y3 = motionEvent.getY();
        org.telegram.ui.Cells.a0 a0Var = this.f49483z;
        if (e2.u(a0Var)) {
            y3 -= a0Var.getPaddingTop();
            if (a0Var instanceof w0) {
                x10 -= ((w0) a0Var).f21757j0 / 2.0f;
            }
        }
        float f7 = x10 - this.f49464c;
        float f10 = y3 - this.d;
        if (motionEvent.getAction() == 0) {
            ...
            while (true) {
                if (i10 >= size) {
                    break;
                } else if (f7 > ((n0) arrayList.get(i10)).f49438x && f7 < ((n0) arrayList.get(i10)).f49438x + ((n0) arrayList.get(i10)).A && f10 > ((n0) arrayList.get(i10)).f49439y && f10 < ((n0) arrayList.get(i10)).f49439y + ((n0) arrayList.get(i10)).B) {
            ...
            if (this.T && this.S != null && motionEvent.getAction() == 1) {
                TLRPC.ReactionCount reactionCount = this.S.f49412a;
    ...
    public final void d(Canvas canvas, float f7, Integer num) {
        ...
        boolean z11 = this.f49477s;
        ArrayList arrayList = this.f49480w;
        if (!z11 || !arrayList.isEmpty()) {
            float f12 = this.f49464c;
            float f13 = this.d;
            if (this.f49477s) {
                f12 = this.f49466g;
                f13 = this.h;
            } else if (this.f49468j) {
                float f14 = 1.0f - f7;
                f12 = (f12 * f7) + (this.e * f14);
                f13 = (f13 * f7) + (this.f49465f * f14);
            }
            float f15 = f12;
            float f16 = f13;
            int i10 = 0;
            ...
            while (true) {
                ...
                if (!Integer.valueOf(n0Var.f49433r.hashCode()).equals(this.C) && (num == null || n0Var.f49433r.hashCode() == num.intValue())) {
                    canvas2.save();
                    float f17 = n0Var.f49438x;
                    float f18 = n0Var.f49439y;
                    int i12 = (f7 > 1.0f ? 1 : (f7 == 1.0f ? 0 : -1));
                    if (i12 != 0 && n0Var.f49416c == 3) {
                        float f19 = 1.0f - f7;
                        f17 = (f17 * f7) + (n0Var.d * f19);
                        f18 = (f18 * f7) + (n0Var.e * f19);
                    }
                    if (i12 != 0 && n0Var.f49416c == 1) {
            ...
            while (i10 < arrayList.size()) {
                ...
                canvas2.save();
                canvas2.scale(f24, f24, (n0Var2.A / 2.0f) + n0Var2.f49438x + f15, (n0Var2.B / 2.0f) + n0Var2.f49439y + f16);
                ((n0) arrayList.get(i10)).d(canvas2, n0Var2.f49438x + f15, n0Var2.f49439y + f16, 1.0f, f23, false, this.E, this.D);
                canvas.restore();
                i10++;
                canvas2 = canvas;
            }
    ...
    public final void f(rm rmVar, Canvas canvas, int i10, Integer num) {
        int i11;
        if (!this.f49477s || !this.f49480w.isEmpty()) {
            int i12 = 0;
            while (true) {
                ArrayList arrayList = this.v;
                if (i12 < arrayList.size()) {
                    n0 n0Var = (n0) arrayList.get(i12);
                    if ((num == null || n0Var.f49433r.hashCode() == num.intValue()) && num != null) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(n0Var.f49435t);
                        ...
                        int i13 = n0Var.V;
                        p0 p0Var = n0Var.f49434s;
                        View view = n0Var.W;
                        if (n0Var.f49421f0 == null && n0Var.f49423g0 == null) {
                            if (view != null && (view.getParent() instanceof View)) {
                                view = (View) view.getParent();
                            }
                            if (n0Var.f49433r != null && !p0Var.f49444a) {
                                if (p0Var.f49447f != null) {
                                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i13).getReactionsMap().get(p0Var.f49447f);
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, j6.f19053a7, 1.0f);
                                        ImageReceiver imageReceiver = new ImageReceiver(view);
                                        n0Var.f49421f0 = imageReceiver;
                                        imageReceiver.setLayerNum(7);
                                        n0Var.f49421f0.onAttachedToWindow();
                                        n0Var.f49421f0.setRoundRadius(AndroidUtilities.dp(14.0f));
                                        n0Var.f49421f0.setAllowStartLottieAnimation(true);
                                        n0Var.f49421f0.setAllowStartAnimation(true);
                                        n0Var.f49421f0.setAutoRepeat(1);
                                        n0Var.f49421f0.setAllowDecodeSingleFrame(true);
                                        n0Var.f49421f0.setImage(ImageLocation.getForDocument(tL_availableReaction.activate_animation), "140_140", svgThumb, null, tL_availableReaction, 1);
                                    }
                                } else if (p0Var.f49448g != 0) {
                                    p5 p5Var = new p5(24, i13, p0Var.f49448g);
                                    n0Var.f49423g0 = p5Var;
                                    p5Var.a(view);
                                }
                            }
                        }
                        ...
                        if (interpolation > 0.0f) {
                            ImageReceiver imageReceiver2 = n0Var.f49421f0;
                            if (imageReceiver2 != null) {
                                imageReceiver2.setImageCoords(rectF2);
                                n0Var.f49421f0.setAlpha(interpolation);
                                n0Var.f49421f0.draw(canvas);
                            } else {
                                p5 p5Var2 = n0Var.f49423g0;
                                if (p5Var2 != null) {
                                    p5Var2.setBounds((int) rectF2.left, (int) rectF2.top, (int) rectF2.right, (int) rectF2.bottom);
                                    n0Var.f49423g0.setAlpha((int) (interpolation * 255.0f));
                                    n0Var.f49423g0.draw(canvas);
                                }
                            }
                            rmVar.invalidate();
                        }
    ...
    public final float i(float f7) {
        if (this.f49470l) {
            return (this.f49474p * f7) + ((1.0f - f7) * this.J);
        }
        return this.f49474p;
    }
    ...
    public final float j(float f7) {
        if (this.f49469k) {
            return (this.f49475q * f7) + ((1.0f - f7) * this.f49476r);
        }
        return this.f49475q;
    }
    ...
    public final n0 m(p0 p0Var) {
        ...
        if (p0Var.f49444a) {
            ...
            if (str != null) {
                ...
                l4 = Long.toString(p0Var.f49448g);
            }
        }
        return l(l4);
    }
    ...
    public final boolean n() {
        if (this.L) {
            if ((!this.f49477s || !this.f49480w.isEmpty()) && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
                return true;
            }
            return false;
        }
    ...
    public final void p(int i10, int i11) {
        ...
        while (true) {
            ...
            if (z10) {
                ...
                } else if (vqVar != null && n0Var.f49437w > 1) {
                    n0Var.A = org.telegram.messenger.l0.C(8.0f, (int) Math.ceil(vqVar.f29767m), n0Var.A);
                }
            } else {
                ...
                if (n0Var.T != null && n0Var.U.size() > 0) {
                    ...
                    n0Var.T.f25046o = AndroidUtilities.dp(26.0f);
                } else if (n0Var.f49436u) {
                    n0Var.A = (int) (n6Var.d + AndroidUtilities.dp(8.0f) + n0Var.A);
                } else if (((int) Math.ceil(vqVar.f29767m)) > 0) {
                    n0Var.A = org.telegram.messenger.l0.C(8.0f, (int) Math.ceil(vqVar.f29767m), n0Var.A);
                } else {
            ...
            if (n0Var.A + i14 > i10) {
                ...
                i16 = org.telegram.messenger.l0.C(4.0f, n0Var.B, i16);
                i17++;
                i14 = 0;
            }
            n0Var.f49438x = i14;
            n0Var.f49439y = i16;
            n0Var.f49440z = i17;
            i14 = org.telegram.messenger.l0.C(4.0f, n0Var.A, i14);
            if (i14 > i15) {
                i15 = i14;
            }
            i13++;
        ...
        if (i11 == 5 && !arrayList.isEmpty()) {
            int i18 = ((n0) arrayList.get(0)).f49439y;
            int i19 = 0;
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                if (((n0) arrayList.get(i20)).f49439y != i18) {
                    int i21 = i20 - 1;
                    int i22 = i10 - (((n0) arrayList.get(i21)).f49438x + ((n0) arrayList.get(i21)).A);
                    while (i19 < i20) {
                        ((n0) arrayList.get(i19)).f49438x += i22;
                        i19++;
                    }
                    i19 = i20;
                }
            ...
            int i23 = i10 - (((n0) arrayList.get(size)).f49438x + ((n0) arrayList.get(size)).A);
            while (i19 <= size) {
                ((n0) arrayList.get(i19)).f49438x += i23;
                i19++;
            }
        } else if (i11 == 1 && !arrayList.isEmpty()) {
            for (int i24 = 0; i24 < arrayList.size(); i24++) {
                n0 n0Var2 = (n0) arrayList.get(i24);
                int i25 = n0Var2.f49440z;
                if (i25 >= 0 && i25 < arrayList2.size()) {
                    f7 = ((Integer) arrayList2.get(n0Var2.f49440z)).intValue();
                } else {
                    f7 = 0.0f;
                }
                n0Var2.f49438x = (int) e2.A(i10, f7, 2.0f, n0Var2.f49438x);
            }
        }
        this.f49479u = i14;
        if (i11 != 5 && i11 != 1) {
    ...
    public final void r() {
        ...
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                hashMap.put(((n0) arrayList.get(i10)).f49430o, (n0) arrayList.get(i10));
                i10++;
            } else {
                this.f49467i = !this.f49477s;
                this.f49466g = this.f49464c;
                this.h = this.d;
                this.F = this.f49475q;
                this.I = this.f49474p;
                return;
