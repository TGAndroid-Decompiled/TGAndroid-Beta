...
public final class f {
    ...
    public final SparseArray f50819a = new SparseArray();
    ...
    public final e b(int i10) {
        return (e) this.f50819a.get(i10);
    }

    public final void h(int i10) {
        SparseArray sparseArray = this.f50819a;
        ...
        for (int i11 = 0; i11 < size; i11++) {
            if (sparseArray.keyAt(i11) > i10) {
                ...
                for (int i12 = 0; i12 < size2; i12++) {
                    int iKeyAt = sparseArrayClone.keyAt(i12);
                    e eVar = (e) sparseArrayClone.valueAt(i12);
                    if (iKeyAt < i10) {
                        sparseArray.put(iKeyAt, eVar);
                    }
                    if (iKeyAt > i10) {
                        sparseArray.put(iKeyAt - 1, eVar);
                    }
                }
                return;
            }
