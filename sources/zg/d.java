...
public final class d {
    public static int f49275m;
    public q5 f49276a;
    public Rect f49277b;
    public ArrayList f49278c;
    public View d;
    public long e;
    public boolean f49279f;
    public boolean f49280g;
    public int h;
    public boolean f49281i;
    public ImageReceiver f49282j;
    public int f49283k;
    public long f49284l;
    ...
    public static d a(q5 q5Var, boolean z10, boolean z11) {
        ...
        ?? obj = new Object();
        obj.f49277b = new Rect();
        obj.f49278c = new ArrayList();
        obj.f49280g = true;
        obj.f49283k = -1;
        obj.f49276a = q5Var;
        obj.f49279f = z10;
    ...
    public final void d(View view) {
        this.f49276a.o(view);
        ImageReceiver imageReceiver = this.f49282j;
    ...
    public final void f(View view) {
        ...
        boolean z12 = this.f49279f;
        int i10 = this.h;
        q5 q5Var = this.f49276a;
        q5Var.a(view);
        this.d = view;
        ImageReceiver imageReceiver = this.f49282j;
        if (imageReceiver != null && this.f49281i) {
            ...
            if (!z11) {
                ...
                if (tL_messages_stickerSet != null) {
                    if (this.f49283k < 0) {
                        this.f49283k = Math.abs(Utilities.fastRandom.nextInt() % tL_messages_stickerSet.documents.size());
                    }
                    if (z12) {
                        ...
                        int f10 = cz.f();
                        imageReceiver.setImage(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(this.f49283k)), f10 + "_" + f10 + "_pcache_compress", null, null, tL_messages_stickerSet.documents.get(this.f49283k), 0);
                    } else {
                        imageReceiver.setImage(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(this.f49283k)), "60_60", null, null, tL_messages_stickerSet.documents.get(this.f49283k), 0);
                    }
                    z11 = true;
                }
            }
            ...
            imageReceiver.setImageBitmap(new jj0(R.raw.custom_emoji_reaction, AndroidUtilities.dp(60.0f), AndroidUtilities.dp(60.0f), false, null));
        }
    }
}
