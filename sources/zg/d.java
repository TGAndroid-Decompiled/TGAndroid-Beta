...
public final class d {
    public static int f49265m;
    public q5 f49266a;
    public Rect f49267b;
    public ArrayList f49268c;
    public View d;
    public long e;
    public boolean f49269f;
    public boolean f49270g;
    public int h;
    public boolean f49271i;
    public ImageReceiver f49272j;
    public int f49273k;
    public long f49274l;
    ...
    public static d a(q5 q5Var, boolean z10, boolean z11) {
        ...
        ?? obj = new Object();
        obj.f49267b = new Rect();
        obj.f49268c = new ArrayList();
        obj.f49270g = true;
        obj.f49273k = -1;
        obj.f49266a = q5Var;
        obj.f49269f = z10;
    ...
    public final void d(View view) {
        this.f49266a.o(view);
        ImageReceiver imageReceiver = this.f49272j;
    ...
    public final void f(View view) {
        ...
        boolean z12 = this.f49269f;
        int i10 = this.h;
        q5 q5Var = this.f49266a;
        q5Var.a(view);
        this.d = view;
        ImageReceiver imageReceiver = this.f49272j;
        if (imageReceiver != null && this.f49271i) {
            ...
            if (!z11) {
                ...
                if (tL_messages_stickerSet != null) {
                    if (this.f49273k < 0) {
                        this.f49273k = Math.abs(Utilities.fastRandom.nextInt() % tL_messages_stickerSet.documents.size());
                    }
                    if (z12) {
                        ...
                        int f10 = cz.f();
                        imageReceiver.setImage(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(this.f49273k)), f10 + "_" + f10 + "_pcache_compress", null, null, tL_messages_stickerSet.documents.get(this.f49273k), 0);
                    } else {
                        imageReceiver.setImage(ImageLocation.getForDocument(tL_messages_stickerSet.documents.get(this.f49273k)), "60_60", null, null, tL_messages_stickerSet.documents.get(this.f49273k), 0);
                    }
                    z11 = true;
                }
            }
