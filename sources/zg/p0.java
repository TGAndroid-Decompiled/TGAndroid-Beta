...
public final class p0 {
    ...
    public final float f49400t;
    public int f49401u;
    public final org.telegram.ui.Cells.a0 f49405z;
    ...
    public static final l0 f49381a0 = new Object();
    public static int f49382b0 = 1;
    public static final kb1 f49383c0 = new kb1(25);
    public final ArrayList v = new ArrayList();
    public final ArrayList f49402w = new ArrayList();
    public final HashMap f49403x = new HashMap();
    public final HashMap f49404y = new HashMap();
    public final HashMap H = new HashMap();
    public final ArrayList N = new ArrayList();
    public final RectF O = new RectF();
    public final Rect P = new Rect();
    public final int f49394n = UserConfig.selectedAccount;

    public p0(org.telegram.ui.Cells.a0 a0Var) {
        this.f49405z = a0Var;
        o(this.B);
        this.f49400t = ViewConfiguration.get(ApplicationLoader.applicationContext).getScaledTouchSlop();
    }
    ...
    public static void o(e6 e6Var) {
        V.setColor(j6.v0(j6.f19160ie, e6Var));
    ...
    public final boolean a() {
        ...
        HashMap hashMap = this.f49404y;
        hashMap.clear();
        int i11 = 0;
        while (true) {
            arrayList = this.f49402w;
        ...
        while (true) {
            ...
            String str = m0Var.f49361o;
            vq vqVar = m0Var.F;
            m0 m0Var2 = (m0) hashMap.get(str);
            if (m0Var2 != null && m0Var.f49345b != m0Var2.f49345b) {
                m0Var2 = null;
            }
            if (m0Var2 != null) {
                hashMap.remove(m0Var.f49361o);
                int i13 = m0Var.f49369x;
                int i14 = m0Var2.f49369x;
                if (i13 == i14 && m0Var.f49370y == m0Var2.f49370y && m0Var.A == m0Var2.A && m0Var.f49368w == m0Var2.f49368w && m0Var.f49362p == m0Var2.f49362p && m0Var.T == null && m0Var2.T == null) {
                    m0Var.f49347c = 0;
                    i12++;
                } else {
                    m0Var.d = i14;
                    m0Var.e = m0Var2.f49370y;
                    m0Var.f49351f = m0Var2.A;
                    m0Var.f49355i = m0Var2.N;
                    m0Var.f49353g = m0Var2.O;
                    m0Var.h = m0Var2.P;
                    m0Var.f49347c = 3;
                    int i15 = m0Var.f49368w;
                    int i16 = m0Var2.f49368w;
                    if (i15 != i16 && vqVar != null) {
                        vqVar.c(i16, false);
                        vqVar.c(m0Var.f49368w, true);
                    }
                    j9 j9Var2 = m0Var.T;
                    if (j9Var2 != null || m0Var2.T != null) {
                        ...
                        if (j9Var3 != null && (j9Var = m0Var2.T) != null) {
                            ValueAnimator valueAnimator = j9Var.f25250f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (j9Var3.f25265w) {
                                    j9Var3.f25265w = false;
                                    j9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = j9Var3.f25248b[i18].h;
                                j9Var3.l(i18, j9Var.f25248b[i18].h, i10);
                                i18++;
                            }
                            j9Var3.b(false, true);
        ...
        if (!hashMap.isEmpty()) {
            ...
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                ((m0) arrayList.get(i20)).f49358l = ((m0) arrayList.get(i20)).f49360n;
                ((m0) arrayList.get(i20)).a();
            }
            z10 = true;
        }
        if (this.f49389i) {
            float f7 = this.f49388g;
            if (f7 != this.f49386c || this.h != this.d) {
                this.f49390j = true;
                this.e = f7;
                this.f49387f = this.h;
                z10 = true;
    ...
    public final void b(o0 o0Var) {
        ...
        if (o0Var.f49378g == 0) {
            ...
            if (hashMap.get(o0Var) == null) {
                ...
                imageReceiver.setParentView(this.f49405z);
                int i11 = Z;
                Z = i11 + 1;
                imageReceiver.setUniqKeyPrefix(Integer.toString(i11));
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(this.f49394n).getReactionsMap().get(o0Var.f49377f);
        ...
        if (!this.M || o0Var.f49378g == 0) {
            return;
        }
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                if (o0Var.f(((m0) arrayList.get(i10)).f49364r)) {
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        int i10 = 0;
        if (this.f49399s || this.f49385b || (messageObject = this.A) == null || (message = messageObject.messageOwner) == null || message.reactions == null) {
            return false;
        }
        float x10 = motionEvent.getX();
        float y3 = motionEvent.getY();
        org.telegram.ui.Cells.a0 a0Var = this.f49405z;
        if (e2.u(a0Var)) {
            y3 -= a0Var.getPaddingTop();
            if (a0Var instanceof w0) {
                x10 -= ((w0) a0Var).f21710j0 / 2.0f;
            }
        }
        float f7 = x10 - this.f49386c;
        float f10 = y3 - this.d;
        if (motionEvent.getAction() == 0) {
            ...
            while (true) {
                if (i10 >= size) {
                    break;
                } else if (f7 > ((m0) arrayList.get(i10)).f49369x && f7 < ((m0) arrayList.get(i10)).f49369x + ((m0) arrayList.get(i10)).A && f10 > ((m0) arrayList.get(i10)).f49370y && f10 < ((m0) arrayList.get(i10)).f49370y + ((m0) arrayList.get(i10)).B) {
            ...
            if (this.T && this.S != null && motionEvent.getAction() == 1) {
                TLRPC.ReactionCount reactionCount = this.S.f49343a;
    ...
    public final void d(Canvas canvas, float f7, Integer num) {
        ...
        boolean z11 = this.f49399s;
        ArrayList arrayList = this.f49402w;
        if (!z11 || !arrayList.isEmpty()) {
            float f12 = this.f49386c;
            float f13 = this.d;
            if (this.f49399s) {
                f12 = this.f49388g;
                f13 = this.h;
            } else if (this.f49390j) {
                float f14 = 1.0f - f7;
                f12 = (f12 * f7) + (this.e * f14);
                f13 = (f13 * f7) + (this.f49387f * f14);
            }
            float f15 = f12;
            float f16 = f13;
            int i10 = 0;
            ...
            while (true) {
                ...
                if (!Integer.valueOf(m0Var.f49364r.hashCode()).equals(this.C) && (num == null || m0Var.f49364r.hashCode() == num.intValue())) {
                    canvas2.save();
                    float f17 = m0Var.f49369x;
                    float f18 = m0Var.f49370y;
                    int i12 = (f7 > 1.0f ? 1 : (f7 == 1.0f ? 0 : -1));
                    if (i12 != 0 && m0Var.f49347c == 3) {
                        float f19 = 1.0f - f7;
                        f17 = (f17 * f7) + (m0Var.d * f19);
                        f18 = (f18 * f7) + (m0Var.e * f19);
                    }
                    if (i12 != 0 && m0Var.f49347c == 1) {
            ...
            while (i10 < arrayList.size()) {
                ...
                canvas2.save();
                canvas2.scale(f24, f24, (m0Var2.A / 2.0f) + m0Var2.f49369x + f15, (m0Var2.B / 2.0f) + m0Var2.f49370y + f16);
                ((m0) arrayList.get(i10)).d(canvas2, m0Var2.f49369x + f15, m0Var2.f49370y + f16, 1.0f, f23, false, this.E, this.D);
                canvas.restore();
                i10++;
                canvas2 = canvas;
            }
    ...
    public final void f(rm rmVar, Canvas canvas, int i10, Integer num) {
        int i11;
        if (!this.f49399s || !this.f49402w.isEmpty()) {
            int i12 = 0;
            while (true) {
                ArrayList arrayList = this.v;
                if (i12 < arrayList.size()) {
                    m0 m0Var = (m0) arrayList.get(i12);
                    if ((num == null || m0Var.f49364r.hashCode() == num.intValue()) && num != null) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(m0Var.f49366t);
                        ...
                        int i13 = m0Var.V;
                        o0 o0Var = m0Var.f49365s;
                        View view = m0Var.W;
                        if (m0Var.f49352f0 == null && m0Var.f49354g0 == null) {
                            if (view != null && (view.getParent() instanceof View)) {
                                view = (View) view.getParent();
                            }
                            if (m0Var.f49364r != null && !o0Var.f49374a) {
                                if (o0Var.f49377f != null) {
                                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i13).getReactionsMap().get(o0Var.f49377f);
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, j6.f19006a7, 1.0f);
                                        ImageReceiver imageReceiver = new ImageReceiver(view);
                                        m0Var.f49352f0 = imageReceiver;
                                        imageReceiver.setLayerNum(7);
                                        m0Var.f49352f0.onAttachedToWindow();
                                        m0Var.f49352f0.setRoundRadius(AndroidUtilities.dp(14.0f));
                                        m0Var.f49352f0.setAllowStartLottieAnimation(true);
                                        m0Var.f49352f0.setAllowStartAnimation(true);
                                        m0Var.f49352f0.setAutoRepeat(1);
                                        m0Var.f49352f0.setAllowDecodeSingleFrame(true);
                                        m0Var.f49352f0.setImage(ImageLocation.getForDocument(tL_availableReaction.activate_animation), "140_140", svgThumb, null, tL_availableReaction, 1);
                                    }
                                } else if (o0Var.f49378g != 0) {
                                    q5 q5Var = new q5(24, i13, o0Var.f49378g);
                                    m0Var.f49354g0 = q5Var;
                                    q5Var.a(view);
                                }
                            }
                        }
                        ...
                        if (interpolation > 0.0f) {
                            ImageReceiver imageReceiver2 = m0Var.f49352f0;
                            if (imageReceiver2 != null) {
                                imageReceiver2.setImageCoords(rectF2);
                                m0Var.f49352f0.setAlpha(interpolation);
                                m0Var.f49352f0.draw(canvas);
                            } else {
                                q5 q5Var2 = m0Var.f49354g0;
                                if (q5Var2 != null) {
                                    q5Var2.setBounds((int) rectF2.left, (int) rectF2.top, (int) rectF2.right, (int) rectF2.bottom);
                                    m0Var.f49354g0.setAlpha((int) (interpolation * 255.0f));
                                    m0Var.f49354g0.draw(canvas);
                                }
                            }
                            rmVar.invalidate();
                        }
    ...
    public final float i(float f7) {
        if (this.f49392l) {
            return (this.f49396p * f7) + ((1.0f - f7) * this.J);
        }
        return this.f49396p;
    }
    ...
    public final float j(float f7) {
        if (this.f49391k) {
            return (this.f49397q * f7) + ((1.0f - f7) * this.f49398r);
        }
        return this.f49397q;
    }

    public final m0 l(String str) {
        boolean z10 = this.f49385b;
        HashMap hashMap = this.f49403x;
        if (z10) {
    ...
    public final m0 m(o0 o0Var) {
        ...
        if (o0Var.f49374a) {
            ...
            if (str != null) {
                ...
                l4 = Long.toString(o0Var.f49378g);
            }
        }
        return l(l4);
    }
    ...
    public final boolean n() {
        if (this.L) {
            if ((!this.f49399s || !this.f49402w.isEmpty()) && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
                return true;
            }
            return false;
        }
    ...
    public final void p(int i10, int i11) {
        ...
        while (true) {
            ...
            if (z10) {
                ...
                } else if (vqVar != null && m0Var.f49368w > 1) {
                    m0Var.A = org.telegram.messenger.q.D(8.0f, (int) Math.ceil(vqVar.f29698m), m0Var.A);
                }
            } else {
                ...
                if (m0Var.T != null && m0Var.U.size() > 0) {
                    ...
                    m0Var.T.f25258o = AndroidUtilities.dp(26.0f);
                } else if (m0Var.f49367u) {
                    m0Var.A = (int) (o6Var.d + AndroidUtilities.dp(8.0f) + m0Var.A);
                } else if (((int) Math.ceil(vqVar.f29698m)) > 0) {
                    m0Var.A = org.telegram.messenger.q.D(8.0f, (int) Math.ceil(vqVar.f29698m), m0Var.A);
                } else {
            ...
            if (m0Var.A + i14 > i10) {
                ...
                i16 = org.telegram.messenger.q.D(4.0f, m0Var.B, i16);
                i17++;
                i14 = 0;
            }
            m0Var.f49369x = i14;
            m0Var.f49370y = i16;
            m0Var.f49371z = i17;
            i14 = org.telegram.messenger.q.D(4.0f, m0Var.A, i14);
            if (i14 > i15) {
                i15 = i14;
            }
            i13++;
        ...
        if (i11 == 5 && !arrayList.isEmpty()) {
            int i18 = ((m0) arrayList.get(0)).f49370y;
            int i19 = 0;
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                if (((m0) arrayList.get(i20)).f49370y != i18) {
                    int i21 = i20 - 1;
                    int i22 = i10 - (((m0) arrayList.get(i21)).f49369x + ((m0) arrayList.get(i21)).A);
                    while (i19 < i20) {
                        ((m0) arrayList.get(i19)).f49369x += i22;
                        i19++;
                    }
                    i19 = i20;
                }
            ...
            int i23 = i10 - (((m0) arrayList.get(size)).f49369x + ((m0) arrayList.get(size)).A);
            while (i19 <= size) {
                ((m0) arrayList.get(i19)).f49369x += i23;
                i19++;
            }
        } else if (i11 == 1 && !arrayList.isEmpty()) {
            for (int i24 = 0; i24 < arrayList.size(); i24++) {
                m0 m0Var2 = (m0) arrayList.get(i24);
                int i25 = m0Var2.f49371z;
                if (i25 >= 0 && i25 < arrayList2.size()) {
                    f7 = ((Integer) arrayList2.get(m0Var2.f49371z)).intValue();
                } else {
                    f7 = 0.0f;
                }
                m0Var2.f49369x = (int) e2.A(i10, f7, 2.0f, m0Var2.f49369x);
            }
        }
        this.f49401u = i14;
        if (i11 != 5 && i11 != 1) {
    ...
    public final void r() {
        ...
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                hashMap.put(((m0) arrayList.get(i10)).f49361o, (m0) arrayList.get(i10));
                i10++;
            } else {
                this.f49389i = !this.f49399s;
                this.f49388g = this.f49386c;
                this.h = this.d;
                this.F = this.f49397q;
                this.I = this.f49396p;
                return;
    ...
    public final void s(org.telegram.messenger.MessageObject r20, boolean r21, boolean r22, org.telegram.ui.ActionBar.e6 r23) {
        throw new UnsupportedOperationException("Method not decompiled: zg.p0.s(org.telegram.messenger.MessageObject, boolean, boolean, org.telegram.ui.ActionBar.e6):void");
    }
}
