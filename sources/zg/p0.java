...
public final class p0 {
    ...
    public int d;
    public float e;
    public float f49405f;
    public float f49406g;
    public float h;
    public boolean f49407i;
    public boolean f49408j;
    public boolean f49409k;
    ...
    public int f49415q;
    public int f49416r;
    public boolean f49417s;
    public final float f49418t;
    public int f49419u;
    public final org.telegram.ui.Cells.a0 f49423z;
    ...
    public static final l0 f49399a0 = new Object();
    public static int f49400b0 = 1;
    public static final db1 f49401c0 = new db1(25);
    public final ArrayList v = new ArrayList();
    public final ArrayList f49420w = new ArrayList();
    public final HashMap f49421x = new HashMap();
    public final HashMap f49422y = new HashMap();
    public final HashMap H = new HashMap();
    public final ArrayList N = new ArrayList();
    public final RectF O = new RectF();
    public final Rect P = new Rect();
    public final int f49412n = UserConfig.selectedAccount;

    public p0(org.telegram.ui.Cells.a0 a0Var) {
        this.f49423z = a0Var;
        o(this.B);
        this.f49418t = ViewConfiguration.get(ApplicationLoader.applicationContext).getScaledTouchSlop();
    }
    ...
    public static void o(d6 d6Var) {
        V.setColor(h6.v0(h6.f19156ie, d6Var));
    ...
    public final boolean a() {
        ...
        HashMap hashMap = this.f49422y;
        hashMap.clear();
        int i11 = 0;
        while (true) {
            arrayList = this.f49420w;
        ...
        while (true) {
            ...
            String str = m0Var.f49379o;
            xq xqVar = m0Var.F;
            m0 m0Var2 = (m0) hashMap.get(str);
            if (m0Var2 != null && m0Var.f49363b != m0Var2.f49363b) {
                m0Var2 = null;
            }
            if (m0Var2 != null) {
                hashMap.remove(m0Var.f49379o);
                int i13 = m0Var.f49387x;
                int i14 = m0Var2.f49387x;
                if (i13 == i14 && m0Var.f49388y == m0Var2.f49388y && m0Var.A == m0Var2.A && m0Var.f49386w == m0Var2.f49386w && m0Var.f49380p == m0Var2.f49380p && m0Var.T == null && m0Var2.T == null) {
                    m0Var.f49365c = 0;
                    i12++;
                } else {
                    m0Var.d = i14;
                    m0Var.e = m0Var2.f49388y;
                    m0Var.f49369f = m0Var2.A;
                    m0Var.f49373i = m0Var2.N;
                    m0Var.f49371g = m0Var2.O;
                    m0Var.h = m0Var2.P;
                    m0Var.f49365c = 3;
                    int i15 = m0Var.f49386w;
                    int i16 = m0Var2.f49386w;
                    if (i15 != i16 && xqVar != null) {
                        xqVar.c(i16, false);
                        xqVar.c(m0Var.f49386w, true);
                    }
                    j9 j9Var2 = m0Var.T;
                    if (j9Var2 != null || m0Var2.T != null) {
                        ...
                        if (j9Var3 != null && (j9Var = m0Var2.T) != null) {
                            ValueAnimator valueAnimator = j9Var.f25334f;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                if (j9Var3.f25349w) {
                                    j9Var3.f25349w = false;
                                    j9Var3.n();
                                }
                            }
                            ...
                            while (true) {
                                ...
                                tLObjectArr[i18] = j9Var3.f25332b[i18].h;
                                j9Var3.l(i18, j9Var.f25332b[i18].h, i10);
                                i18++;
                            }
                            j9Var3.b(false, true);
        ...
        if (!hashMap.isEmpty()) {
            ...
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                ((m0) arrayList.get(i20)).f49376l = ((m0) arrayList.get(i20)).f49378n;
                ((m0) arrayList.get(i20)).a();
            }
            z10 = true;
        }
        if (this.f49407i) {
            float f7 = this.f49406g;
            if (f7 != this.f49404c || this.h != this.d) {
                this.f49408j = true;
                this.e = f7;
                this.f49405f = this.h;
                z10 = true;
    ...
    public final void b(o0 o0Var) {
        ...
        if (o0Var.f49396g == 0) {
            ...
            if (hashMap.get(o0Var) == null) {
                ...
                imageReceiver.setParentView(this.f49423z);
                int i11 = Z;
                Z = i11 + 1;
                imageReceiver.setUniqKeyPrefix(Integer.toString(i11));
                TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(this.f49412n).getReactionsMap().get(o0Var.f49395f);
        ...
        if (!this.M || o0Var.f49396g == 0) {
            return;
        }
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                if (o0Var.f(((m0) arrayList.get(i10)).f49382r)) {
    ...
    public final boolean c(MotionEvent motionEvent) {
        ...
        int i10 = 0;
        if (this.f49417s || this.f49403b || (messageObject = this.A) == null || (message = messageObject.messageOwner) == null || message.reactions == null) {
            return false;
        }
        float x10 = motionEvent.getX();
        float y3 = motionEvent.getY();
        org.telegram.ui.Cells.a0 a0Var = this.f49423z;
        if (e2.u(a0Var)) {
            y3 -= a0Var.getPaddingTop();
            if (a0Var instanceof w0) {
                x10 -= ((w0) a0Var).f21745j0 / 2.0f;
            }
        }
        float f7 = x10 - this.f49404c;
        float f10 = y3 - this.d;
        if (motionEvent.getAction() == 0) {
            ...
            while (true) {
                if (i10 >= size) {
                    break;
                } else if (f7 > ((m0) arrayList.get(i10)).f49387x && f7 < ((m0) arrayList.get(i10)).f49387x + ((m0) arrayList.get(i10)).A && f10 > ((m0) arrayList.get(i10)).f49388y && f10 < ((m0) arrayList.get(i10)).f49388y + ((m0) arrayList.get(i10)).B) {
            ...
            if (this.T && this.S != null && motionEvent.getAction() == 1) {
                TLRPC.ReactionCount reactionCount = this.S.f49361a;
    ...
    public final void d(Canvas canvas, float f7, Integer num) {
        ...
        boolean z11 = this.f49417s;
        ArrayList arrayList = this.f49420w;
        if (!z11 || !arrayList.isEmpty()) {
            float f12 = this.f49404c;
            float f13 = this.d;
            if (this.f49417s) {
                f12 = this.f49406g;
                f13 = this.h;
            } else if (this.f49408j) {
                float f14 = 1.0f - f7;
                f12 = (f12 * f7) + (this.e * f14);
                f13 = (f13 * f7) + (this.f49405f * f14);
            }
            float f15 = f12;
            float f16 = f13;
            int i10 = 0;
            ...
            while (true) {
                ...
                if (!Integer.valueOf(m0Var.f49382r.hashCode()).equals(this.C) && (num == null || m0Var.f49382r.hashCode() == num.intValue())) {
                    canvas2.save();
                    float f17 = m0Var.f49387x;
                    float f18 = m0Var.f49388y;
                    int i12 = (f7 > 1.0f ? 1 : (f7 == 1.0f ? 0 : -1));
                    if (i12 != 0 && m0Var.f49365c == 3) {
                        float f19 = 1.0f - f7;
                        f17 = (f17 * f7) + (m0Var.d * f19);
                        f18 = (f18 * f7) + (m0Var.e * f19);
                    }
                    if (i12 != 0 && m0Var.f49365c == 1) {
            ...
            while (i10 < arrayList.size()) {
                ...
                canvas2.save();
                canvas2.scale(f24, f24, (m0Var2.A / 2.0f) + m0Var2.f49387x + f15, (m0Var2.B / 2.0f) + m0Var2.f49388y + f16);
                ((m0) arrayList.get(i10)).d(canvas2, m0Var2.f49387x + f15, m0Var2.f49388y + f16, 1.0f, f23, false, this.E, this.D);
                canvas.restore();
                i10++;
                canvas2 = canvas;
            }
    ...
    public final void f(pm pmVar, Canvas canvas, int i10, Integer num) {
        int i11;
        if (!this.f49417s || !this.f49420w.isEmpty()) {
            int i12 = 0;
            while (true) {
                ArrayList arrayList = this.v;
                if (i12 < arrayList.size()) {
                    m0 m0Var = (m0) arrayList.get(i12);
                    if ((num == null || m0Var.f49382r.hashCode() == num.intValue()) && num != null) {
                        RectF rectF = AndroidUtilities.rectTmp;
                        rectF.set(m0Var.f49384t);
                        ...
                        int i13 = m0Var.V;
                        o0 o0Var = m0Var.f49383s;
                        View view = m0Var.W;
                        if (m0Var.f49370f0 == null && m0Var.f49372g0 == null) {
                            if (view != null && (view.getParent() instanceof View)) {
                                view = (View) view.getParent();
                            }
                            if (m0Var.f49382r != null && !o0Var.f49392a) {
                                if (o0Var.f49395f != null) {
                                    TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(i13).getReactionsMap().get(o0Var.f49395f);
                                    if (tL_availableReaction != null && tL_availableReaction.activate_animation != null) {
                                        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(tL_availableReaction.static_icon, h6.f19003a7, 1.0f);
                                        ImageReceiver imageReceiver = new ImageReceiver(view);
                                        m0Var.f49370f0 = imageReceiver;
                                        imageReceiver.setLayerNum(7);
                                        m0Var.f49370f0.onAttachedToWindow();
                                        m0Var.f49370f0.setRoundRadius(AndroidUtilities.dp(14.0f));
                                        m0Var.f49370f0.setAllowStartLottieAnimation(true);
                                        m0Var.f49370f0.setAllowStartAnimation(true);
                                        m0Var.f49370f0.setAutoRepeat(1);
                                        m0Var.f49370f0.setAllowDecodeSingleFrame(true);
                                        m0Var.f49370f0.setImage(ImageLocation.getForDocument(tL_availableReaction.activate_animation), "140_140", svgThumb, null, tL_availableReaction, 1);
                                    }
                                } else if (o0Var.f49396g != 0) {
                                    q5 q5Var = new q5(24, i13, o0Var.f49396g);
                                    m0Var.f49372g0 = q5Var;
                                    q5Var.a(view);
                                }
                            }
                        }
                        ...
                        if (interpolation > 0.0f) {
                            ImageReceiver imageReceiver2 = m0Var.f49370f0;
                            if (imageReceiver2 != null) {
                                imageReceiver2.setImageCoords(rectF2);
                                m0Var.f49370f0.setAlpha(interpolation);
                                m0Var.f49370f0.draw(canvas);
                            } else {
                                q5 q5Var2 = m0Var.f49372g0;
                                if (q5Var2 != null) {
                                    q5Var2.setBounds((int) rectF2.left, (int) rectF2.top, (int) rectF2.right, (int) rectF2.bottom);
                                    m0Var.f49372g0.setAlpha((int) (interpolation * 255.0f));
                                    m0Var.f49372g0.draw(canvas);
                                }
                            }
                            pmVar.invalidate();
                        }
    ...
    public final float i(float f7) {
        if (this.f49410l) {
            return (this.f49414p * f7) + ((1.0f - f7) * this.J);
        }
        return this.f49414p;
    }
    ...
    public final float j(float f7) {
        if (this.f49409k) {
            return (this.f49415q * f7) + ((1.0f - f7) * this.f49416r);
        }
        return this.f49415q;
    }

    public final m0 l(String str) {
        boolean z10 = this.f49403b;
        HashMap hashMap = this.f49421x;
        if (z10) {
    ...
    public final m0 m(o0 o0Var) {
        ...
        if (o0Var.f49392a) {
            ...
            if (str != null) {
                ...
                l4 = Long.toString(o0Var.f49396g);
            }
        }
        return l(l4);
    }
    ...
    public final boolean n() {
        if (this.L) {
            if ((!this.f49417s || !this.f49420w.isEmpty()) && LiteMode.isEnabled(8200) && LiteMode.isEnabled(131072)) {
                return true;
            }
            return false;
        }
    ...
    public final void p(int i10, int i11) {
        ...
        while (true) {
            ...
            if (z10) {
                ...
                } else if (xqVar != null && m0Var.f49386w > 1) {
                    m0Var.A = org.telegram.messenger.f0.C(8.0f, (int) Math.ceil(xqVar.f30442m), m0Var.A);
                }
            } else {
                ...
                if (m0Var.T != null && m0Var.U.size() > 0) {
                    ...
                    m0Var.T.f25342o = AndroidUtilities.dp(26.0f);
                } else if (m0Var.f49385u) {
                    m0Var.A = (int) (o6Var.d + AndroidUtilities.dp(8.0f) + m0Var.A);
                } else if (((int) Math.ceil(xqVar.f30442m)) > 0) {
                    m0Var.A = org.telegram.messenger.f0.C(8.0f, (int) Math.ceil(xqVar.f30442m), m0Var.A);
                } else {
        ...
        if (i11 == 5 && !arrayList.isEmpty()) {
            int i18 = ((m0) arrayList.get(0)).f49388y;
            int i19 = 0;
            for (int i20 = 0; i20 < arrayList.size(); i20++) {
                if (((m0) arrayList.get(i20)).f49388y != i18) {
                    int i21 = i20 - 1;
                    int i22 = i10 - (((m0) arrayList.get(i21)).f49387x + ((m0) arrayList.get(i21)).A);
                    while (i19 < i20) {
                        ((m0) arrayList.get(i19)).f49387x += i22;
                        i19++;
                    }
                    i19 = i20;
                }
            ...
            int i23 = i10 - (((m0) arrayList.get(size)).f49387x + ((m0) arrayList.get(size)).A);
            while (i19 <= size) {
                ((m0) arrayList.get(i19)).f49387x += i23;
                i19++;
            }
        } else if (i11 == 1 && !arrayList.isEmpty()) {
            for (int i24 = 0; i24 < arrayList.size(); i24++) {
                m0 m0Var2 = (m0) arrayList.get(i24);
                int i25 = m0Var2.f49389z;
                if (i25 >= 0 && i25 < arrayList2.size()) {
                    f7 = ((Integer) arrayList2.get(m0Var2.f49389z)).intValue();
                } else {
                    f7 = 0.0f;
                }
                m0Var2.f49387x = (int) e2.A(i10, f7, 2.0f, m0Var2.f49387x);
            }
        }
        this.f49419u = i14;
        if (i11 != 5 && i11 != 1) {
    ...
    public final void r() {
        ...
        while (true) {
            ArrayList arrayList = this.v;
            if (i10 < arrayList.size()) {
                hashMap.put(((m0) arrayList.get(i10)).f49379o, (m0) arrayList.get(i10));
                i10++;
            } else {
                this.f49407i = !this.f49417s;
                this.f49406g = this.f49404c;
                this.h = this.d;
                this.F = this.f49415q;
                this.I = this.f49414p;
                return;
