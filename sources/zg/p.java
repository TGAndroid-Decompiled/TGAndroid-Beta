...
public final class p extends a71 {
    public boolean f49397d2;
    public final q f49398e2;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f49397d2) {
            this.f49397d2 = false;
            this.f49398e2.f49425b.s(null);
        }
    }

    @Override
    public final void p(View view, Long l4, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        q qVar = this.f49398e2;
        int i10 = qVar.J;
        ...
        if (linkedHashMap.containsKey(l4)) {
            ...
            try {
                ...
                z5 e = q0.e(document, l4, qVar.f49428n.getFontMetricsInt());
                e.cacheType = q5.g();
                e.setAdded();
                ...
                qVar.f49428n.getText().insert(editTextSelectionEnd, spannableString);
                qVar.f49428n.setSelection(editTextSelectionEnd + spannableString.length());
                qVar.f49425b.x(l4, true);
                qVar.Y(true);
                qVar.W(e);
            } catch (Exception e7) {
