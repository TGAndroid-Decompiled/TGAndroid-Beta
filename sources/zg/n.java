...
public final class n extends q1 {
    ...
    public final void e(float f7, float f10, boolean z10) {
        ...
        if (qVar.getParentLayout() != null) {
            boolean z11 = ((ActionBarLayout) qVar.getParentLayout()).f18415n;
        }
    }
    ...
    public final void g(int i10, boolean z10) {
        float f7;
        q qVar = (q) this.f49114x.f47959c;
        qVar.f49159w.setVisibility(0);
        ViewPropertyAnimator animate = qVar.f49159w.animate();
        if (!z10) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
