...
public final class s extends rk0 {
    public float l1;
    public long f49437m1;

    @Override
    public final void draw(Canvas canvas) {
        long min = Math.min(16L, System.currentTimeMillis() - this.f49437m1);
        this.f49437m1 = System.currentTimeMillis();
