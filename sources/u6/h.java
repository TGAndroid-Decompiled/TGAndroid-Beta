...
public final class h extends c6.a {
    ...
    public h(String type, Bundle credentialRetrievalData, Bundle candidateQueryData, String requestMatcher, String requestType, String protocolType) {
        ...
        this.f48460a = type;
        this.f48461b = credentialRetrievalData;
        this.f48462c = candidateQueryData;
        this.d = requestMatcher;
        this.f48463e = requestType;
        this.f48464f = protocolType;
        boolean z10 = true;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        g5.l(dest, 1, this.f48460a);
        g5.b(dest, 2, this.f48461b);
        g5.b(dest, 3, this.f48462c);
        g5.l(dest, 4, this.d);
        g5.l(dest, 5, this.f48463e);
        g5.l(dest, 6, this.f48464f);
        g5.r(dest, q10);
    }
}
