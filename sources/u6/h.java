...
public final class h extends c6.a {
    ...
    public final Bundle f45169b;
    public final Bundle f45170c;
    ...
    public h(String type, Bundle credentialRetrievalData, Bundle candidateQueryData, String requestMatcher, String requestType, String protocolType) {
        ...
        this.f45168a = type;
        this.f45169b = credentialRetrievalData;
        this.f45170c = candidateQueryData;
        this.d = requestMatcher;
        this.e = requestType;
        this.f45171f = protocolType;
        boolean z10 = true;
    ...
    public final void writeToParcel(Parcel dest, int i10) {
        ...
        f5.l(dest, 1, this.f45168a);
        f5.b(dest, 2, this.f45169b);
        f5.b(dest, 3, this.f45170c);
        f5.l(dest, 4, this.d);
        f5.l(dest, 5, this.e);
        f5.l(dest, 6, this.f45171f);
        f5.r(dest, q10);
    }
}
