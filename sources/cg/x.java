...
public final class x extends View {
    public final Paint f2544a;
    public final int[] f2545b;
    public final Paint f2546c;
    public final LongSparseArray d;
    public long e;
    public final Path f2547f;
    public final float[] h;
    public final HashMap f2548n;
    public final e0 f2549r;
    ...
    public x(e0 e0Var, Context context) {
        ...
        this.f2545b = new int[]{-16735784, -16752387, -11788361, -6804548, -4707235, -180718, -38656, -152832, -211200, -198077, -2495689, -8996289};
        Paint paint = new Paint(1);
        this.f2546c = paint;
        this.d = new LongSparseArray();
        this.e = Long.MIN_VALUE;
        this.f2547f = new Path();
        this.h = new float[8];
        ...
        for (int i10 = 0; i10 < 12; i10++) {
            for (int i11 = 0; i11 < 10; i11++) {
                if (i11 == 0) {
                    this.f2548n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(i0.a.d(i10 / 11.0f, -1, -16777216)));
                } else {
                    if (i11 < 6) {
                        d = i0.a.d(((5 - i11) / 4.0f) * 0.5f, this.f2545b[i10], -16777216);
                    } else {
                        d = i0.a.d(y3.A(9 - i11, 5.0f, 0.5f, 0.5f), this.f2545b[i10], -1);
                    }
                    this.f2548n.put(Long.valueOf((i10 << 16) + i11), Integer.valueOf(d));
                }
            }
        }
    }
    ...
    public final void a(int i10) {
        for (Map.Entry entry : this.f2548n.entrySet()) {
    ...
    public final void c(MotionEvent motionEvent) {
        ...
        Integer num = (Integer) this.f2548n.get(Long.valueOf((x10 << 16) + y10));
        if (num != null) {
            int intValue = num.intValue();
            int i10 = e0.f2342s;
            this.f2549r.m(intValue, 3);
            b(x10, y10);
        }
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i13 < longSparseArray.size()) {
                ...
                paint2.setStrokeWidth(mr.h.getInterpolation(max) * AndroidUtilities.dp(3.0f));
                Path path2 = this.f2547f;
                path2.rewind();
