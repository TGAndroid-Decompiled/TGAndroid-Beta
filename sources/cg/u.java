...
public final class u extends LinearLayout {
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f2534a) {
            case 2:
                Path path = (Path) this.f2536c;
                if (((nh.o0) this.d).f15682a) {
                    path.rewind();
                    ...
                    if (((wa) this.f2535b) == null) {
                        this.f2535b = new wa(1, 250);
                    }
                    ((wa) this.f2535b).f(0, 0, getWidth(), getHeight());
                    wa waVar = (wa) this.f2535b;
                    waVar.h = 30.0f;
                    waVar.d();
                    ((wa) this.f2535b).b(canvas, -1, 0.85f);
                    invalidate();
                    canvas.restore();
                }
    ...
    public void onDraw(Canvas canvas) {
        ...
        switch (this.f2534a) {
            case 3:
                RectF rectF = (RectF) this.f2535b;
                Paint paint = (Paint) this.f2536c;
                kq kqVar = (kq) this.d;
                paint.setColor(j6.v0(j6.f19995i5, kqVar.f26355a0));
