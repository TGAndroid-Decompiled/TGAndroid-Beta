...
public final class c0 extends FrameLayout {
    ...
    public final EditTextBoldCursor f2306c;
    public int d;
    public boolean e;
    public final e0 f2307f;
    ...
    public c0(e0 e0Var, Context context) {
        ...
        this.f2306c = editTextBoldCursor;
    ...
    public final void b() {
        this.e = true;
        v vVar = this.f2305b;
        vVar.d = i0.a.k(vVar.e.f2345f, 255);
        vVar.a();
        vVar.invalidate();
        EditTextBoldCursor editTextBoldCursor = this.f2306c;
        int selectionStart = editTextBoldCursor.getSelectionStart();
        int selectionEnd = editTextBoldCursor.getSelectionEnd();
        int i10 = this.d;
        e0 e0Var = this.f2307f;
        if (i10 != 0) {
            if (i10 != 1) {
                if (i10 == 2) {
                    editTextBoldCursor.setText(String.valueOf(Color.blue(e0Var.f2345f)));
                }
            } else {
                editTextBoldCursor.setText(String.valueOf(Color.green(e0Var.f2345f)));
            }
        } else {
            editTextBoldCursor.setText(String.valueOf(Color.red(e0Var.f2345f)));
        }
