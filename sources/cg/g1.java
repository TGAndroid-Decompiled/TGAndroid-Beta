...
public final class g1 {
    ...
    public final PointF f2408c;
    public final PointF d;
    public final float e;
    public final PointF f2409f;
    public final PointF f2410g;
    ...
    public g1(h8.a aVar, Bitmap bitmap, jv0 jv0Var, boolean z4) {
        ...
        PointF pointF3 = null;
        PointF pointF4 = null;
        for (h8.d dVar : aVar.f7039b) {
            PointF pointF5 = dVar.f7046a;
            int i10 = dVar.f7047b;
            if (i10 != 4) {
                if (i10 != 5) {
                    if (i10 != 10) {
        ...
        if (pointF != null && pointF2 != null) {
            ...
            this.e = hypot;
            this.f2407b = (float) Math.toDegrees(Math.atan2(pointF2.y - pointF.y, pointF2.x - pointF.x) + 3.141592653589793d);
            this.f2406a = 2.35f * hypot;
            float f10 = hypot * 0.8f;
            float f11 = pointF7.x;
            double radians = (float) Math.toRadians(degrees - 90.0f);
            this.f2408c = new PointF((((float) Math.cos(radians)) * f10) + f11, (f10 * ((float) Math.sin(radians))) + pointF7.y);
        }
        if (pointF3 != null && pointF4 != null) {
            ...
            float f13 = pointF9.x;
            double radians2 = (float) Math.toRadians(this.f2407b + 90.0f);
            this.f2410g = new PointF((((float) Math.cos(radians2)) * f12) + f13, (f12 * ((float) Math.sin(radians2))) + pointF9.y);
        }
    }
    ...
    public static PointF b(PointF pointF, Bitmap bitmap, jv0 jv0Var, boolean z4) {
        ...
        return new PointF((jv0Var.f26052a * pointF.x) / f10, (jv0Var.f26053b * pointF.y) / height);
    }
