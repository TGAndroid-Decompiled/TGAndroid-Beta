...
public final class e2 {
    ...
    public final void b(Canvas canvas, jv0 jv0Var, d2 d2Var) {
        Paint paint;
        Paint paint2;
        float width = (d2Var.d / jv0Var.f26062a) * canvas.getWidth();
        float height = (d2Var.e / jv0Var.f26063b) * canvas.getHeight();
        float dp = AndroidUtilities.dp(5.0f);
        boolean z4 = d2Var.f2339a;
        if (z4) {
            paint = this.d;
        } else {
            paint = this.f2354f;
        ...
        float width2 = (d2Var.d / jv0Var.f26062a) * canvas.getWidth();
        float height2 = (d2Var.e / jv0Var.f26063b) * canvas.getHeight();
    ...
    public final void d(boolean z4) {
        ...
        if (s1Var != null) {
            float f10 = s1Var.h;
            if (f10 != 0.0f) {
                float f11 = fArr[0] - s1Var.f2500b;
                fArr[0] = f11;
                fArr[1] = fArr[1] - s1Var.f2501c;
                if (z4) {
                    i10 = -1;
                } else {
                    i10 = 1;
                ...
                s1 s1Var2 = this.h;
                fArr[0] = cos + s1Var2.f2500b;
                fArr[1] = ((float) kf.k0.a(d, fArr[1], sin)) + s1Var2.f2501c;
            }
        }
    }
    ...
    public final void e() {
        s1 s1Var;
        p1 p1Var = this.f2351a;
        if (p1Var != null && p1Var.getPainting() != null && (s1Var = this.h) != null) {
            s1Var.f2502f = p1Var.getCurrentWeight();
            d1 painting = p1Var.getPainting();
            s1 s1Var2 = this.h;
            int currentColor = p1Var.getCurrentColor();
            if (s1Var2 != null) {
                if (painting.f2331r != null) {
                    painting.f2320f.f(new ah.a(painting, s1Var2, currentColor, 1));
                }
            } else {
                painting.getClass();
            }
