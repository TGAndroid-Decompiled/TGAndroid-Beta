...
public final class x0 implements Runnable {
    ...
    public final void run() {
        ...
        boolean z11 = this.f2551b;
        Object obj = this.f2553f;
        Object obj2 = this.e;
        Object obj3 = this.d;
        switch (i10) {
            case 0:
            ...
            case 1:
                ...
                d1 d1Var = ((n1) obj3).f2468y.f2477c;
                jv0 jv0Var = d1Var.f2321g;
                af.c h = d1Var.h(new RectF(0.0f, 0.0f, jv0Var.f26062a, jv0Var.f26063b), false, z11, z10);
                if (h != null) {
                    bitmapArr[0] = (Bitmap) h.f156b;
                }
            ...
            case 2:
                ...
                SharedPreferences sharedPreferences = t6Var.f15905l;
                if (z11) {
                    t6Var.f15911r = false;
                } else {
                    t6Var.f15910q = false;
                ...
                if (tLObject instanceof TL_stories.TL_stories_allStories) {
                    ...
                    if (!z11) {
                        t6Var.f15914u = tL_stories_allStories.count;
                        t6Var.f15909p = tL_stories_allStories.has_more;
                        t6Var.f15908o = tL_stories_allStories.state;
                        sharedPreferences.edit().putString("last_stories_state", t6Var.f15908o).putBoolean("last_stories_has_more", t6Var.f15909p).putInt("total_stores", t6Var.f15914u).apply();
                    } else {
                        t6Var.v = tL_stories_allStories.count;
                        t6Var.f15918z = tL_stories_allStories.has_more;
                        t6Var.f15917y = tL_stories_allStories.state;
                        sharedPreferences.edit().putString("last_stories_state_hidden", t6Var.f15917y).putBoolean("last_stories_has_more_hidden", t6Var.f15918z).putInt("total_stores_hidden", t6Var.v).apply();
                    }
                    t6Var.Y(tL_stories_allStories, z11, false, z10);
                    return;
                } else if (tLObject instanceof TL_stories.TL_stories_allStoriesNotModified) {
                    if (!z11) {
                        t6Var.f15909p = sharedPreferences.getBoolean("last_stories_has_more", false);
                        t6Var.f15908o = ((TL_stories.TL_stories_allStoriesNotModified) tLObject).state;
                        sharedPreferences.edit().putString("last_stories_state", t6Var.f15908o).apply();
                    } else {
                        t6Var.f15918z = sharedPreferences.getBoolean("last_stories_has_more_hidden", false);
                        t6Var.f15917y = ((TL_stories.TL_stories_allStoriesNotModified) tLObject).state;
                        sharedPreferences.edit().putString("last_stories_state_hidden", t6Var.f15917y).apply();
                    }
                    if (z11) {
                        z4 = t6Var.f15918z;
                    } else {
            ...
            case 3:
                ...
                n0 n0Var = (n0) obj;
                int i12 = g7Var.f15345a;
                MessagesStorage messagesStorage = g7Var.f15346b;
                    ...
                    try {
                        ...
                        for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                            if (arrayList2.get(i14) instanceof TL_stories.TL_storyItemSkipped) {
                                TL_stories.StoryItem f10 = g7Var.f(arrayList2.get(i14).f19394id, peerDialogId);
            ...
            default:
                ...
                wk0 wk0Var = new wk0(x61Var, str, this.f2551b, arrayList4, reactionsMap, arrayList5, linkedHashSet, linkedHashSet2, arrayList7, arrayList6, this.f2552c);
                int i16 = x61Var.T;
                if (i16 == 13) {
                    ...
                    Utilities.doCallbacks(new kl(fullyConsistsOfEmojis, str, linkedHashSet, 3), new Utilities.Callback() {
                        @Override
                        public final void run(Object obj4) {
                            Runnable runnable2 = (Runnable) obj4;
                            switch (r4) {
