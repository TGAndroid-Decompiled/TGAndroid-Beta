...
public final class e0 extends g3 {
    public static final int f2359s = 0;
    public final u f2360b;
    public final ImageView f2361c;
    public final r d;
    public final Path e;
    public int f2362f;
    public q0.a h;
    ...
    public e0(Context context, f6 f6Var) {
        ...
        uVar.f2535b = xVar;
        xVar.a(this.f2362f);
        uVar.f2536c = new w(this, context);
    ...
    public final void dismiss() {
        ...
        q0.a aVar = this.h;
        if (aVar != null) {
            aVar.accept(Integer.valueOf(this.f2362f));
        }
    }
    ...
    public final void m(int i10, int i11) {
        ...
        if (i11 != 0) {
            w wVar = (w) uVar.f2536c;
            if (i11 != 1) {
                z4 = true;
            } else {
                z4 = false;
            }
            wVar.f2556n.f2362f = i10;
            float[] fArr = wVar.h;
        ...
        if (!editTextBoldCursor.isFocused()) {
            ...
            StringBuilder sb = new StringBuilder(Integer.toHexString(d0Var.f2333f.f2362f));
            while (sb.length() < 8) {
                sb.insert(0, "0");
            }
