...
public abstract class q0 {
    ...
    public static int j(int i10, TLRPC.Chat chat, Utilities.Callback callback) {
        ...
        if (chat == null) {
            HashMap map = f2808a;
            List list = null;
            if (map != null && (pair = (Pair) map.get(Integer.valueOf(i10))) != null && System.currentTimeMillis() - ((Long) pair.first).longValue() < 1800000) {
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, org.telegram.ui.ActionBar.n2 n2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (h()) {
            ...
            c9.b bVar = new c9.b();
            bVar.f2567c = "inapp";
            bVar.f2566b = tL_premiumGiftCodeOption.store_product;
        ...
        JSONObject jSONObjectP = b3.p(n2Var.getResourceProvider(), false);
        if (jSONObjectP != null) {
    ...
    public static void m(int i10, ArrayList arrayList) {
        ...
        f2808a.put(Integer.valueOf(i10), new Pair(Long.valueOf(System.currentTimeMillis()), arrayList));
    }
}
