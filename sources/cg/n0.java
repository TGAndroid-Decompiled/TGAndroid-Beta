    ...
    public final void run() {
        switch (this.f2475a) {
            ...
            case 3:
                ...
                return;
            case 4:
                int i10 = AlarmManagerSchedulerBroadcastReceiver.f2623a;
                return;
            case 5:
                float[] fArr = u2.R;
                return;
            ...
            case 8:
                ...
                if (e0Var != null) {
                    ...
                    for (int i11 = 0; i11 < lf.g.f11985y; i11++) {
            ...
            case 26:
                ...
                try {
                    if (l5.f26556q != null) {
                        for (int i15 = 0; i15 < l5.f26556q.size(); i15++) {
                            LongSparseArray longSparseArray = (LongSparseArray) l5.f26556q.valueAt(i15);
                            int i16 = 0;
                            while (i16 < longSparseArray.size()) {
                                if (!((l5) longSparseArray.valueAt(i16)).f26562a) {
