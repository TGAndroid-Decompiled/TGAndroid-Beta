...
public final class g2 {
    ...
    public static int b(jv0 jv0Var) {
        int i10 = (int) jv0Var.f26062a;
        int i11 = (int) jv0Var.f26063b;
        int[] iArr = new int[1];
    ...
    public final void a(boolean z4) {
        ...
        if (i10 != 0) {
            ...
            this.f2395b = 0;
            if (z4 && (bitmap = this.f2394a) != null && !bitmap.isRecycled()) {
                bitmap.recycle();
            }
        }
    }
    ...
    public final int c() {
        ...
        GLES20.glTexParameteri(3553, 10241, 9729);
        try {
            GLUtils.texImage2D(3553, 0, 6408, this.f2394a, 5121, 0);
        } catch (Exception e) {
            FileLog.e(e);
            ...
            this.f2394a.getPixels(iArr2, 0, width, 0, 0, width, height);
