...
public final class k0 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        int currentColor;
        o1 o1Var;
        m0 m0Var = this.f2422f;
        m0Var.f2450x = null;
        e1 e1Var = new e1(new h1[]{this.f2419a});
        p1 p1Var = m0Var.f2431a;
        e1Var.f2350c = p1Var.getCurrentColor();
        e1Var.d = this.f2420b * 1.0f;
        m mVar = this.f2421c;
        e1Var.e = mVar;
        mVar.getClass();
