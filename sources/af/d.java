...
public final class d implements Runnable {
    public final int f173a = 0;
    public final TLObject f174b;
    ...
    public final void run() {
        ...
        switch (this.f173a) {
            case 0:
                f fVar = (f) this.f176e;
                d2[] d2VarArr = (d2[]) this.f177f;
                TLObject tLObject = this.f174b;
                int i11 = this.f175c;
                Uri uri = (Uri) this.h;
                Context context = (Context) this.f178n;
                boolean z4 = this.d;
                if (fVar != null) {
                    fVar.b();
                } else {
                ...
                return;
            default:
                l4 l4Var = (l4) this.f176e;
                TLObject tLObject2 = this.f174b;
                int i12 = this.f175c;
                TLRPC.WebPage webPage2 = (TLRPC.WebPage) this.f177f;
                MessageObject messageObject = (MessageObject) this.h;
                boolean z10 = this.d;
                String str = (String) this.f178n;
