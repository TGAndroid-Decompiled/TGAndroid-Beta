        ...
        switch (this.f4752a) {
            ...
            default:
                if (hasNext()) {
                    ...
                    int i14 = i13 + 1;
                    this.f4753b = i14;
                    DataHolder dataHolder = eVar.f49280a;
                    eVar.o();
                    int n10 = eVar.n(i14);
                    int i15 = 0;
                    if (i14 >= 0 && i14 != eVar.f49282c.size()) {
                        if (i14 == eVar.f49282c.size() - 1) {
                            l.h(dataHolder);
                            intValue = dataHolder.f5163n;
                            intValue2 = ((Integer) eVar.f49282c.get(i14)).intValue();
                        } else {
                            intValue = ((Integer) eVar.f49282c.get(i13 + 2)).intValue();
                            intValue2 = ((Integer) eVar.f49282c.get(i14)).intValue();
                        }
