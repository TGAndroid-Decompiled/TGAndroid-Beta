...
public final class j0 {
    ...
    public final char[] f15370b;
    public final int f15371c;
    public final int d;
    public final int e;
    public final int f15372f;
    public final byte[] f15373g;
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof j0) {
            j0 j0Var = (j0) obj;
            if (this.h == j0Var.h && Arrays.equals(this.f15370b, j0Var.f15370b)) {
                return true;
            }
            return false;
        }
    ...
    public final int hashCode() {
        int i10;
        int hashCode = Arrays.hashCode(this.f15370b);
        if (true != this.h) {
            i10 = 1237;
        } else {
            i10 = 1231;
    ...
    public j0(String str, char[] cArr, byte[] bArr, boolean z10) {
        ...
        try {
            ...
            if (length > 0) {
                ...
                this.e = i10;
                this.f15372f = numberOfLeadingZeros >> numberOfTrailingZeros;
                this.f15371c = length - 1;
                this.f15373g = bArr;
                boolean[] zArr = new boolean[i10];
                for (int i11 = 0; i11 < this.f15372f; i11++) {
                    int i12 = this.d;
