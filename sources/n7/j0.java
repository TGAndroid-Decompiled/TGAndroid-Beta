...
public final class j0 {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof j0) {
            j0 j0Var = (j0) obj;
            if (this.h == j0Var.h && Arrays.equals(this.f15319b, j0Var.f15319b)) {
                return true;
            }
            return false;
        }
    ...
    public final int hashCode() {
        int i10;
        int hashCode = Arrays.hashCode(this.f15319b);
        if (true != this.h) {
            i10 = 1237;
        } else {
            i10 = 1231;
    ...
    public j0(String str, char[] cArr, byte[] bArr, boolean z10) {
        ...
        try {
            ...
            if (length > 0) {
                ...
                this.e = i10;
                this.f15321f = numberOfLeadingZeros >> numberOfTrailingZeros;
                this.f15320c = length - 1;
                this.f15322g = bArr;
                boolean[] zArr = new boolean[i10];
                for (int i11 = 0; i11 < this.f15321f; i11++) {
                    int i12 = this.d;
