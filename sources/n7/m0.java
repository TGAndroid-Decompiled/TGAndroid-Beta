...
public class m0 {
    ...
    public final j0 f15329a;
    public final Character f15330b;
    public volatile m0 f15331c;
    ...
    public void a(StringBuilder sb2, byte[] bArr, int i10) {
        ...
        while (i11 < i10) {
            j0 j0Var = this.f15329a;
            b(sb2, bArr, i11, Math.min(j0Var.f15321f, i10 - i11));
            i11 += j0Var.f15321f;
        }
    }
    ...
    public final void b(StringBuilder sb2, byte[] bArr, int i10, int i11) {
        ...
        if (i11 <= i12) {
            ...
            int i16 = (i11 + 1) * 8;
            while (i14 < i11 * 8) {
                sb2.append(j0Var.f15319b[((int) (j3 >>> ((i16 - i13) - i14))) & j0Var.f15320c]);
                i14 += i13;
            }
            if (this.f15330b != null) {
                while (i14 < j0Var.f15321f * 8) {
                    sb2.append('=');
                    i14 += i13;
                }
                return;
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof m0) {
            m0 m0Var = (m0) obj;
            if (this.f15329a.equals(m0Var.f15329a) && Objects.equals(this.f15330b, m0Var.f15330b)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return this.f15329a.hashCode() ^ Objects.hashCode(this.f15330b);
    }
