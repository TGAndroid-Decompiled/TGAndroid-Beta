...
public final class z extends s {
    ...
    public final transient m f15393f;

    static {
        i iVar = m.f15356b;
        h = new z(x.e, v.f15382b);
    }
    ...
    public final boolean contains(Object obj) {
        if (obj != null) {
            try {
                if (Collections.binarySearch(this.f15393f, obj, this.d) >= 0) {
                    return true;
                }
    ...
    public final boolean containsAll(Collection collection) {
        ...
        if (a.i(comparator, collection) && collection.size() > 1) {
            i listIterator = this.f15393f.listIterator(0);
    ...
    public final Iterator descendingIterator() {
        return this.f15393f.r().listIterator(0);
    }
    ...
    public final int i(Object[] objArr) {
        return this.f15393f.i(objArr);
    }

    @Override
    public final Iterator iterator() {
        return this.f15393f.listIterator(0);
    }
    ...
    public final int y(Object obj, boolean z10) {
        obj.getClass();
        int binarySearch = Collections.binarySearch(this.f15393f, obj, this.d);
        if (binarySearch >= 0) {
            if (z10) {
