...
public abstract class t extends p implements NavigableSet, d0, SortedSet {
    ...
    public final java.util.SortedSet tailSet(Object obj) {
        obj.getClass();
        a0 a0Var = (a0) this;
        return a0Var.A(a0Var.z(obj, true), a0Var.f15104f.size());
    }
    ...
    public final t descendingSet() {
        ...
        if (a0Var == null) {
            ...
            if (a0Var2.isEmpty()) {
                ...
                a0Var = new a0(a0Var2.f15104f.r(), reverseOrder);
            }
            this.e = a0Var;
            a0Var.e = this;
        }
    ...
    public final a0 subSet(Object obj, boolean z10, Object obj2, boolean z11) {
        ...
        if (this.d.compare(obj, obj2) <= 0) {
            a0 a0Var = (a0) this;
            a0 A = a0Var.A(a0Var.z(obj, z10), a0Var.f15104f.size());
    ...
    public final NavigableSet tailSet(Object obj, boolean z10) {
        obj.getClass();
        a0 a0Var = (a0) this;
        return a0Var.A(a0Var.z(obj, z10), a0Var.f15104f.size());
    }
}
