...
public final class y implements u9.e {
    public static final Charset f14800f = Charset.forName("UTF-8");
    public static final u9.c f14801g = new u9.c("key", vh.w2.h(kf.k0.p(w.class, new s(1))));
    public static final u9.c h = new u9.c("value", vh.w2.h(kf.k0.p(w.class, new s(2))));
    public static final x f14802i = x.f14769b;
    public OutputStream f14803a;
    public final HashMap f14804b;
    ...
    public y(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, u9.d dVar) {
        this.f14803a = byteArrayOutputStream;
        this.f14804b = hashMap;
        this.f14805c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void f(u9.c cVar, double d, boolean z4) {
        ...
        k((i(cVar) << 3) | 1);
        this.f14803a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z4 || charSequence.length() != 0) {
                    k((i(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f14800f);
                    k(bytes.length);
                    this.f14803a.write(bytes);
                }
                ...
                if (!z4 || floatValue != 0.0f) {
                    k((i(cVar) << 3) | 5);
                    this.f14803a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                k((i(cVar) << 3) | 2);
                k(bArr.length);
                this.f14803a.write(bArr);
            } else {
                u9.d dVar = (u9.d) this.f14804b.get(obj.getClass());
                if (dVar != null) {
                    j(dVar, cVar, obj, z4);
                    return;
                }
                u9.f fVar = (u9.f) this.f14805c.get(obj.getClass());
                if (fVar != null) {
                    j7.l lVar = this.e;
                    lVar.f9051b = false;
                    lVar.d = cVar;
    ...
    public final void j(u9.d dVar, u9.c cVar, Object obj, boolean z4) {
        ...
        fVar.f8972b = 0L;
        try {
            OutputStream outputStream = this.f14803a;
            this.f14803a = fVar;
            dVar.a(obj, this);
    ...
    public final void k(int i10) {
        while (true) {
            int i11 = i10 & 127;
            if ((i10 & (-128)) != 0) {
                this.f14803a.write(i11 | 128);
                i10 >>>= 7;
            } else {
                this.f14803a.write(i11);
                return;
            }
        }
    }
    ...
    public final void l(long j10) {
        while (true) {
            int i10 = ((int) j10) & 127;
            if (((-128) & j10) != 0) {
                this.f14803a.write(i10 | 128);
                j10 >>>= 7;
            } else {
                this.f14803a.write(i10);
                return;
            }
        }
    }
