...
public abstract class s extends o implements NavigableSet, c0, SortedSet {
    ...
    public static z x(Comparator comparator) {
        if (v.f15397b.equals(comparator)) {
            return z.h;
        }
        i iVar = m.f15371b;
    ...
    public final java.util.SortedSet tailSet(Object obj) {
        obj.getClass();
        z zVar = (z) this;
        return zVar.A(zVar.z(obj, true), zVar.f15408f.size());
    }
    ...
    public final s descendingSet() {
        ...
        if (zVar == null) {
            ...
            if (zVar2.isEmpty()) {
                ...
                zVar = new z(zVar2.f15408f.r(), reverseOrder);
            }
            this.e = zVar;
            zVar.e = this;
        }
    ...
    public final z subSet(Object obj, boolean z10, Object obj2, boolean z11) {
        ...
        if (this.d.compare(obj, obj2) <= 0) {
            z zVar = (z) this;
            z A = zVar.A(zVar.z(obj, z10), zVar.f15408f.size());
    ...
    public final NavigableSet tailSet(Object obj, boolean z10) {
        obj.getClass();
        z zVar = (z) this;
        return zVar.A(zVar.z(obj, z10), zVar.f15408f.size());
    }
}
