...
public class s0 implements Iterable, Serializable {
    public static final s0 f15395c = new s0(t0.f15400a);
    public int f15396a = 0;
    public final byte[] f15397b;
            ...
            if ((obj instanceof s0) && p() == ((s0) obj).p()) {
                if (p() != 0) {
                    if (obj instanceof s0) {
                        ...
                        int i11 = s0Var.f15396a;
                        if (i10 == 0 || i11 == 0 || i10 == i11) {
                            int p5 = p();
                            if (p5 <= s0Var.p()) {
                                if (p5 <= s0Var.p()) {
                                    byte[] bArr = s0Var.f15397b;
                                    int o9 = o() + p5;
                                    int o10 = o();
                                    int o11 = s0Var.o();
                                    while (o10 < o9) {
                                        if (this.f15397b[o10] != bArr[o11]) {
                                            return false;
                                        }
                                        o10++;
                                        o11++;
    ...
    public final int hashCode() {
        ...
        if (i10 == 0) {
            int p5 = p();
            int o9 = o();
            byte[] bArr = t0.f15400a;
            int i11 = p5;
            for (int i12 = o9; i12 < o9 + p5; i12++) {
                i11 = (i11 * 31) + this.f15397b[i12];
            }
            if (i11 == 0) {
                i11 = 1;
            }
    ...
    public void q(int i10, byte[] bArr) {
        System.arraycopy(this.f15397b, 0, bArr, 0, i10);
    }

    public final ByteArrayInputStream r() {
        return new ByteArrayInputStream(this.f15397b, o(), p());
    }
    ...
    public final String toString() {
        ...
        if (p() <= 50) {
            ...
            if (s10 == 0) {
                ...
                r0Var = new r0(this.f15397b, o(), s10);
            }
