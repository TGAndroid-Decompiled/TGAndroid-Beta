...
public class d {
    ...
    public final boolean equals(Object obj) {
        ...
        d dVar = (d) obj;
        int i10 = dVar.f50666c;
        String str = dVar.f50664a;
        int i11 = dVar.f50665b;
        int i12 = this.f50666c;
        String str2 = this.f50664a;
        int i13 = this.f50665b;
        if (i13 >= 0 && i11 >= 0) {
    ...
    public final int hashCode() {
        return Objects.hash(this.f50664a, Integer.valueOf(this.f50666c));
    }
}
