...
public final class e {
    ...
    public final mf.a f14007a;
    public final j f14008b;
    public final f f14009c;
    public final c0 d;
    ...
    public static String a(byte[] bArr, int i10, b bVar, boolean z10) {
        ...
        try {
            String str = new String(bArr, 0, i10, bVar.f14004a.name());
    ...
    public final String c(int i10, b bVar) {
        if (i10 <= this.f14007a.e()) {
            d dVar = (d) e.get();
            byte[] bArr = dVar.f14006a;
            if (i10 > bArr.length) {
                int length = bArr.length;
                do {
                    length *= 2;
                } while (i10 > length);
                dVar.f14006a = new byte[length];
            }
            byte[] bArr2 = dVar.f14006a;
            int i11 = 0;
            while (true) {
                c0 c0Var = this.d;
                if (i11 < i10) {
                    int read = ((com.google.firebase.messaging.d) c0Var.f13236b).read(bArr2, i11, i10 - i11);
                    if (read > 0) {
                        i11 += read;
                    } else {
    ...
    public final String d(int i10, b bVar) {
        int min = Math.min(i10, (int) this.f14007a.e());
        d dVar = (d) e.get();
        byte[] bArr = dVar.f14006a;
        if (min > bArr.length) {
            int length = bArr.length;
