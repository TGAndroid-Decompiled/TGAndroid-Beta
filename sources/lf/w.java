...
public final class w extends BaseController {
    public static volatile w[] f12523a = new w[4];
    ...
    public static TLRPC.TL_message b(TL_ephemeral.EphemeralMessage ephemeralMessage) {
        ...
        tL_message.f20866id = MessageObject.ephemeralMessageIdPack(ephemeralMessage.f21058id);
    ...
    public static TL_ephemeral.TL_ephemeralMessage c(TLRPC.Message message, int i10) {
        ...
        tL_ephemeralMessage.f21058id = MessageObject.ephemeralMessageIdUnpack(message.f20866id);
            ...
            if (tL_messages_sendMessage.ephemeralReceiverBotId != 0) {
                ...
                if (z4) {
                    ...
                    if (MessageObject.isEphemeralMessageId(tL_inputReplyToMessage.reply_to_msg_id)) {
                        ...
                        tL_inputReplyToEphemeralMessage2.f20911id = MessageObject.ephemeralMessageIdUnpack(tL_inputReplyToMessage.reply_to_msg_id);
            ...
            if (tL_messages_sendMedia.ephemeralReceiverBotId != 0) {
                ...
                if (z10) {
                    ...
                    if (MessageObject.isEphemeralMessageId(tL_inputReplyToMessage2.reply_to_msg_id)) {
                        ...
                        tL_inputReplyToEphemeralMessage4.f20911id = MessageObject.ephemeralMessageIdUnpack(tL_inputReplyToMessage2.reply_to_msg_id);
