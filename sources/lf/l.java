...
public final class l {
    ...
    public static final int[][] f14221i = {new int[]{0, 0, 0, 0, 0}, new int[]{32000, 32000, 32000, 32000, 8000}, new int[]{64000, 48000, 40000, 48000, 16000}, new int[]{96000, 56000, 48000, 56000, 24000}, new int[]{128000, 64000, 56000, 64000, 32000}, new int[]{160000, 80000, 64000, 80000, 40000}, new int[]{192000, 96000, 80000, 96000, 48000}, new int[]{224000, 112000, 96000, 112000, 56000}, new int[]{256000, 128000, 112000, 128000, 64000}, new int[]{288000, 160000, 128000, 144000, 80000}, new int[]{320000, 192000, 160000, 160000, 96000}, new int[]{352000, 224000, 192000, 176000, 112000}, new int[]{384000, 256000, 224000, 192000, 128000}, new int[]{416000, 320000, 256000, 224000, 144000}, new int[]{448000, 384000, 320000, 256000, 160000}, new int[]{-1, -1, -1, -1, -1}};
    public static final int[][] f14222j = {new int[]{-1, 4, 4, 3}, new int[]{-1, -1, -1, -1}, new int[]{-1, 4, 4, 3}, new int[]{-1, 2, 1, 0}};
    public static final int[][] f14223k = {new int[]{-1, 72, 144, 12}, new int[]{-1, -1, -1, -1}, new int[]{-1, 72, 144, 12}, new int[]{-1, 144, 144, 12}};
    public static final int[] f14224l = {-1, 1, 1, 4};
    public static final int[][] f14225m = {new int[]{17, -1, 17, 32}, new int[]{17, -1, 17, 32}, new int[]{17, -1, 17, 32}, new int[]{9, -1, 9, 17}};
                ...
                if (i15 != 15) {
                    if (i15 != 0) {
                        ...
                        if (i16 != 3) {
                            int i17 = (i12 >> 6) & 3;
                            this.e = i17;
                            this.f14229f = (i11 >> 1) & 1;
                            int i18 = i10 & 1;
                            this.f14230g = i18;
                            int i19 = i18 != 0 ? 4 : 6;
                            i19 = i14 == 1 ? i19 + f14225m[i17][i13] : i19;
                            if (b() >= i19) {
                                return;
                            }
    ...
    public final int a() {
        return f14221i[this.d][f14222j[this.f14226a][this.f14227b]];
    }
    ...
    public final int b() {
        ...
        return (((a() * iArr2[i11]) / h[this.f14228c][i10]) + this.f14229f) * f14224l[i11];
    }
    ...
    public final boolean d(l lVar) {
        if (this.f14227b == lVar.f14227b && this.f14226a == lVar.f14226a && this.f14228c == lVar.f14228c && this.e == lVar.e) {
            return true;
        }
        return false;
    }
