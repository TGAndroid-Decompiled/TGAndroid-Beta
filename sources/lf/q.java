...
public abstract class q {
    public static void a(s01 s01Var, StringBuilder sb) {
        if (s01Var != null) {
            if ((s01Var.f30949a & 768) > 0) {
                sb.append("<spoiler>");
            }
            if ((s01Var.f30949a & 1) > 0) {
                sb.append("<b>");
            }
            if ((s01Var.f30949a & 2) > 0) {
                sb.append("<i>");
            }
            if ((s01Var.f30949a & 16) > 0) {
                sb.append("<u>");
            }
            if ((s01Var.f30949a & 8) > 0) {
                sb.append("<s>");
            }
            if ((s01Var.f30949a & 128) > 0 && s01Var.d != null) {
                sb.append("<a href=\"");
