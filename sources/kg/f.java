...
public class f {
    ...
    public void a() {
        ...
        int i11 = aVar.f12996g;
        e6 e6Var = this.f13630p;
        if (i11 >= 0 && i6.c1(i11)) {
            this.f13627m = i6.v0(aVar.f12996g, e6Var);
        } else {
            if (i0.a.f(i6.v0(i6.f18836d6, e6Var)) < 0.5d) {
                i10 = aVar.f12997i;
            } else {
                i10 = aVar.h;
            }
