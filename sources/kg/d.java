...
public class d extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int v02 = j6.v0(j6.f19882d7, this.f10525a);
        Paint paint = this.f10528f;
        paint.setColor(v02);
    ...
    public void setBackImage(int i10) {
        this.f10526b.setImageResource(i10);
    }
    ...
    public void setCloseImageVisible(boolean z4) {
        ...
        this.f10526b.setVisibility(i10);
        ...
        this.f10527c.setLayoutParams(b6.d(-1, -2.0f, 23, f10, 0.0f, f11, 0.0f));
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f10527c.setText(charSequence);
    }
}
