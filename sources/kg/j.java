...
public final class j extends ViewGroup {
    public final int f10540a = 0;
    public AnimatorSet f10541b;
    public boolean f10542c;
    public final ArrayList d;
    public final ArrayList e;
    public final ArrayList f10543f;
    public final ArrayList h;
    public final ScrollView f10544n;
    ...
    public void a() {
        ...
        this.f10541b = animatorSet;
        animatorSet.addListener(new a8(this, arrayList2, 1));
        ArrayList arrayList4 = this.f10543f;
        arrayList4.clear();
    ...
    public final void c() {
        switch (this.f10540a) {
            case 0:
                AnimatorSet animatorSet = this.f10541b;
                if (animatorSet != null) {
                    animatorSet.cancel();
                }
                int i10 = 0;
            ...
            default:
                AnimatorSet animatorSet2 = this.f10541b;
