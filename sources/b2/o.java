...
public final class o implements Comparator, Parcelable {
    ...
    public final o a(String str) {
        if (Objects.equals(this.f3166c, str)) {
            return this;
        }
        return new o(str, false, this.f3164a);
    }
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        n nVar2 = (n) obj2;
        UUID uuid = i.f3014a;
        if (uuid.equals(nVar.f3118b)) {
            if (uuid.equals(nVar2.f3118b)) {
                return 0;
            }
            return 1;
        }
        return nVar.f3118b.compareTo(nVar2.f3118b);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && o.class == obj.getClass()) {
            o oVar = (o) obj;
            if (Objects.equals(this.f3166c, oVar.f3166c) && Arrays.equals(this.f3164a, oVar.f3164a)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        if (this.f3165b == 0) {
            ...
            this.f3165b = (hashCode * 31) + Arrays.hashCode(this.f3164a);
        }
        return this.f3165b;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeTypedArray(this.f3164a, 0);
    }
