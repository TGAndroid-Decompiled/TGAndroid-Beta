...
public final class h extends Binder {
    public static final int f3001b;
    public final e9.i0 f3002a;
    ...
    public final boolean onTransact(int i10, Parcel parcel, Parcel parcel2, int i11) {
        ...
        e9.i0 i0Var = this.f3002a;
        int size = i0Var.size();
        int readInt = parcel.readInt();
        while (readInt < size && parcel2.dataSize() < f3001b) {
            parcel2.writeInt(1);
