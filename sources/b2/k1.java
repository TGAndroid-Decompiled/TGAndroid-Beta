...
public abstract class k1 {
    public static final g1 f3076a = new Object();
    ...
    static {
        ...
        f3077b = Integer.toString(0, 36);
        f3078c = Integer.toString(1, 36);
    ...
    public final int d(int i10, h1 h1Var, j1 j1Var, int i11, boolean z10) {
        int i12 = f(i10, h1Var, false).f3009c;
        if (m(i12, j1Var, 0L).f3064o == i10) {
            int e = e(i12, i11, z10);
            if (e == -1) {
                return -1;
            }
            return m(e, j1Var, 0L).f3063n;
        }
        return i10 + 1;
    }
    ...
    public final Pair j(j1 j1Var, h1 h1Var, int i10, long j3, long j10) {
        ...
        int i11 = j1Var.f3063n;
        f(i11, h1Var, false);
        while (i11 < j1Var.f3064o && h1Var.e != j3) {
            int i12 = i11 + 1;
