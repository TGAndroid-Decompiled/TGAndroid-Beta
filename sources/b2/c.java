...
public abstract class c {
        ...
        if (supportedPerformancePoints != null && !supportedPerformancePoints.isEmpty()) {
            ...
            if (i12 == 1 && z6.f48342a == null) {
                if (Build.VERSION.SDK_INT < 35) {
                    ...
                    z6.f48342a = Boolean.valueOf(z10);
                    if (!z10) {
                    }
                }
                z10 = false;
    ...
    public static e9.a1 d(e eVar) {
        e9.f0 u10 = e9.i0.u();
        e9.k0 k0Var = k2.b.f14517e;
        e9.m0 m0Var = k0Var.f8967b;
        if (m0Var == null) {
            m0Var = k0Var.c();
            k0Var.f8967b = m0Var;
        }
        ...
        while (it.hasNext()) {
            ...
            if (Build.VERSION.SDK_INT >= e2.d0.q(intValue) && AudioTrack.isDirectPlaybackSupported(new AudioFormat.Builder().setChannelMask(12).setEncoding(intValue).setSampleRate(48000).build(), (AudioAttributes) eVar.b().f2408a)) {
                u10.b(num);
            }
        }
        u10.b(2);
    ...
    public static int e(int i10, int i11, e eVar) {
        for (int i12 = 10; i12 > 0; i12--) {
            int s10 = e2.d0.s(i12);
            if (s10 != 0 && AudioTrack.isDirectPlaybackSupported(new AudioFormat.Builder().setEncoding(i10).setSampleRate(i11).setChannelMask(s10).build(), (AudioAttributes) eVar.b().f2408a)) {
                return i12;
            }
        }
        return 0;
