...
public abstract class g implements b1 {
    ...
    public long A() {
        ...
        return e2.d0.e0(w02.m(e0Var.l0(), (j1) this.f2999a, 0L).f3066m);
    }
    ...
    public boolean M0() {
        i2.e0 e0Var = (i2.e0) this;
        k1 w02 = e0Var.w0();
        if (!w02.p() && w02.m(e0Var.l0(), (j1) this.f2999a, 0L).a()) {
            return true;
        }
        return false;
    }
    ...
    public Object O0(Object obj) {
        synchronized (((HashMap) this.f2999a)) {
            try {
                if (((HashMap) this.f2999a).containsKey(obj)) {
                    return ((HashMap) this.f2999a).get(obj);
                }
                Object N0 = N0(obj);
                ((HashMap) this.f2999a).put(obj, N0);
                return N0;
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void a(float f7) {
        i2.e0 e0Var = (i2.e0) this;
        e0Var.f(new v0(f7, e0Var.h().f3336b));
    }
    ...
    public boolean d0() {
        i2.e0 e0Var = (i2.e0) this;
        k1 w02 = e0Var.w0();
        if (!w02.p() && w02.m(e0Var.l0(), (j1) this.f2999a, 0L).h) {
            return true;
        }
        return false;
    }
    ...
    @Override
    public long p() {
        j1 j1Var = (j1) this.f2999a;
        i2.e0 e0Var = (i2.e0) this;
        k1 w02 = e0Var.w0();
        if (w02.p() || w02.m(e0Var.l0(), j1Var, 0L).f3060f == -9223372036854775807L) {
            return -9223372036854775807L;
        }
        return (e2.d0.A(j1Var.f3061g) - j1Var.f3060f) - e0Var.a0();
    }
    ...
    public boolean t0() {
        i2.e0 e0Var = (i2.e0) this;
        k1 w02 = e0Var.w0();
        if (!w02.p() && w02.m(e0Var.l0(), (j1) this.f2999a, 0L).f3062i) {
            return true;
        }
        return false;
    }
    ...
    public k0 w() {
        ...
        return w02.m(e0Var.l0(), (j1) this.f2999a, 0L).f3059c;
    }
