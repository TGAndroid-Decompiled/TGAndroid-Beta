...
public final class p0 {
    ...
    public final p0 a(o0... o0VarArr) {
        ...
        return new p0(this.f3174b, (o0[]) copyOf);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && p0.class == obj.getClass()) {
            p0 p0Var = (p0) obj;
            if (Arrays.equals(this.f3173a, p0Var.f3173a) && this.f3174b == p0Var.f3174b) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return z7.b(this.f3174b) + (Arrays.hashCode(this.f3173a) * 31);
    }

    public final String toString() {
        String str;
        StringBuilder sb2 = new StringBuilder("entries=");
        sb2.append(Arrays.toString(this.f3173a));
        long j3 = this.f3174b;
