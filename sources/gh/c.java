...
public final class c extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f10002a) {
            ...
            case 1:
                ...
                canvas.drawCircle(bounds.centerX(), bounds.centerY(), this.f10004c / 2.0f, (Paint) this.d);
                return;
            default:
                ...
                if (i12 == 7) {
                    ...
                    canvas.drawRoundRect((RectF) this.d, f7, f7, i6.f19230z);
                    return;
                }
                if (i12 != 1 && i12 != 6) {
                    if (i12 == 3) {
                ...
                canvas.drawCircle(bounds2.centerX(), bounds2.centerY(), i10, i6.f19230z);
                return;
        }
    }
    ...
    public int getIntrinsicHeight() {
        switch (this.f10002a) {
            case 1:
                return this.f10004c + this.f10003b;
            default:
