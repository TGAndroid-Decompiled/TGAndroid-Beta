...
public final class c extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f10006a) {
            ...
            case 1:
                ...
                canvas.drawCircle(bounds.centerX(), bounds.centerY(), this.f10008c / 2.0f, (Paint) this.d);
                return;
            default:
                Rect bounds2 = getBounds();
                int i11 = this.f10008c;
                int i12 = this.f10007b;
                if (i12 == 7) {
                    ...
                    canvas.drawRoundRect((RectF) this.d, f7, f7, j6.f19457z);
                    return;
                }
                if (i12 != 1 && i12 != 6) {
                    if (i12 == 3) {
                ...
                canvas.drawCircle(bounds2.centerX(), bounds2.centerY(), i10, j6.f19457z);
                return;
        }
    }
    ...
    public int getIntrinsicHeight() {
        switch (this.f10006a) {
            case 1:
                return this.f10008c + this.f10007b;
            default:
