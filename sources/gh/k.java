...
public final class k implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    public static final int[] f9147f = new int[2];
    ...
    public final boolean onPreDraw() {
        ViewTreeObserver viewTreeObserver = this.f9148a.getViewTreeObserver();
        ViewTreeObserver viewTreeObserver2 = this.f9149b;
        if (viewTreeObserver != viewTreeObserver2) {
            if (this.f9150c && viewTreeObserver2 != null && viewTreeObserver2.isAlive()) {
                this.f9149b.removeOnPreDrawListener(this);
            }
            this.f9150c = false;
            this.f9149b = null;
            a();
        ...
        if (!weakHashMap.isEmpty()) {
            for (Map.Entry entry : weakHashMap.entrySet()) {
                ...
                if (view != null && list != null) {
                    for (j jVar : list) {
                        boolean z10 = jVar.d;
                        RectF rectF = jVar.f9146c;
                        ViewGroup viewGroup = jVar.f9144a;
                        RectF rectF2 = this.e;
                        if (z10) {
                            int[] iArr = f9147f;
                        ...
                        if (!jVar.e || !rectF2.equals(rectF)) {
                            ...
                            jVar.e = true;
                            try {
                                jVar.f9145b.e(new RectF(rectF2), view);
    ...
    public final void onViewDetachedFromWindow(View view) {
        ViewTreeObserver viewTreeObserver;
        if (view == this.f9148a) {
            if (this.f9150c && (viewTreeObserver = this.f9149b) != null && viewTreeObserver.isAlive()) {
                this.f9149b.removeOnPreDrawListener(this);
            }
            this.f9150c = false;
            this.f9149b = null;
