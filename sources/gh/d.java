...
public abstract class d {
    public static final Matrix f10006a = new Matrix();
    public static final RectF f10007b = new RectF();
    public static final RectF f10008c = new RectF();
    ...
    public static void b(bh.a aVar, Canvas canvas, RectF rectF, View view, ViewGroup viewGroup, int i10) {
        boolean z10;
        if (i10 > 0 && aVar != null) {
            RectF rectF2 = f10008c;
            if (k.c(view, viewGroup, rectF2)) {
                float f7 = rectF2.left;
                float f10 = rectF2.top;
                RectF rectF3 = f10007b;
                rectF3.set(rectF);
