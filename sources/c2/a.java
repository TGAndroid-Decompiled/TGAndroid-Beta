...
public final class a implements m0, rx {
    ...
    public boolean d() {
        ...
        if (chatActivityEnterView.f22088x3) {
            if ((chatActivityEnterView.f22098z3 || (qfVar = chatActivityEnterView.E0) == null || qfVar.length() <= 0) && (czVar = chatActivityEnterView.U0.f26306y0) != null && czVar.h() > 0 && !chatActivityEnterView.f22018k3) {
                return true;
            }
            return false;
        }
