...
public final class a implements m0, qx {
    ...
    public boolean d() {
        ...
        if (chatActivityEnterView.f23819w3) {
            if ((chatActivityEnterView.y3 || (qfVar = chatActivityEnterView.E0) == null || qfVar.length() <= 0) && (bzVar = chatActivityEnterView.U0.f28031y0) != null && bzVar.h() > 0 && !chatActivityEnterView.j3) {
                return true;
            }
            return false;
        }
