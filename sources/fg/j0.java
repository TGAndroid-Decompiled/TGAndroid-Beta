    ...
    public final Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f6352a) {
            ...
            case 3:
                ...
                animatorSet4.setInterpolator(pr.f30183f);
                return animatorSet4;
            case 4:
                ...
                animatorSet5.setInterpolator(pr.f30187k);
                return animatorSet5;
            default:
                ...
                if (view instanceof l3) {
                    ...
                    view.setScaleX(0.0f);
                    view.setScaleY(0.0f);
                    ofPropertyValuesHolder.setStartDelay(((l3) view).f32184f);
                }
    ...
    public final Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f6352a) {
            ...
            case 4:
                ...
                animatorSet5.setInterpolator(pr.f30183f);
                return animatorSet5;
            default:
