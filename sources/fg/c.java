    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        switch (this.f6141a) {
            ...
            case 1:
                ...
                k0Var.f29738v0 = e2.c.w(1.0f, floatValue2, 1.0f, this.f6142b * floatValue2);
                k0Var.f29729o0 = this.f6143c * floatValue2;
                k0Var.f29730p0 = this.d * floatValue2;
                k0Var.invalidate();
                return;
            default:
                ai1 ai1Var = (ai1) this.e;
                float floatValue3 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                ai1Var.f32606c1 = e2.c.w(1.0f, floatValue3, 1.0f, this.f6142b * floatValue3);
                ai1Var.V0 = this.f6143c * floatValue3;
