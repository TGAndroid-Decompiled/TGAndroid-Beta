...
public class i extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public a f6156b;
    public SurfaceTexture f6157c;
    public EGLDisplay d;
    public EGLSurface e;
    public EGLContext f6158f;
    public EGL10 h;
    public EGLConfig f6159n;
    public GL10 f6160r;
    public int f6161s;
    public int v;
    public int f6162w;
    ...
    public i(Context context, int i10, int i11) {
        ...
        this.S = new ValueAnimator.AnimatorUpdateListener(this) {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r2) {
                    case 0:
                        this.f6140b.f6156b.e = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        return;
                    case 1:
                        this.f6140b.f6156b.d = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        return;
                    default:
                        this.f6140b.f6156b.f6121g = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        return;
                }
            }
        };
        ...
        if (eglGetDisplay != EGL10.EGL_NO_DISPLAY) {
            if (iVar.h.eglInitialize(eglGetDisplay, new int[2])) {
                ...
                if (iVar.h.eglChooseConfig(iVar.d, iArr, eGLConfigArr, 1, iArr2)) {
                    if (iArr2[0] > 0) {
                        iVar.f6159n = eGLConfigArr[0];
                    }
                    EGLConfig eGLConfig = iVar.f6159n;
                    if (eGLConfig != null) {
                        iVar.f6158f = iVar.h.eglCreateContext(iVar.d, eGLConfig, EGL10.EGL_NO_CONTEXT, new int[]{12440, 2, 12344});
                        iVar.f();
                        iVar.e = iVar.h.eglCreateWindowSurface(iVar.d, iVar.f6159n, iVar.f6157c, null);
                        iVar.f();
                        EGLSurface eGLSurface = iVar.e;
                        if (eGLSurface != null && eGLSurface != EGL10.EGL_NO_SURFACE) {
                            if (iVar.h.eglMakeCurrent(iVar.d, eGLSurface, eGLSurface, iVar.f6158f)) {
                                iVar.f();
                                iVar.f6160r = (GL10) iVar.f6158f.getGL();
                                iVar.f();
                                return;
                            }
    ...
    public static void c(i iVar, float f10) {
        synchronized (iVar) {
            try {
                ...
                if (aVar != null) {
                    aVar.D = f10;
                    aVar.onDrawFrame(iVar.f6160r);
                }
                int glGetError = iVar.f6160r.glGetError();
                if (glGetError != 0) {
    ...
    public final void e() {
        if (this.f6158f.equals(this.h.eglGetCurrentContext()) && this.e.equals(this.h.eglGetCurrentSurface(12377))) {
            return;
        }
        f();
        EGL10 egl10 = this.h;
        ...
        if (egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.f6158f)) {
            f();
            return;
        }
    ...
    public void k() {
        ...
        if (intValue == 0) {
            ...
            if (i13 == 4) {
                ...
                float f11 = 48;
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f6156b.f6121g, f11);
                ...
                float f12 = i10;
                ValueAnimator ofFloat4 = ValueAnimator.ofFloat(this.f6156b.f6121g, f12);
            ...
            this.Q = new AnimatorSet();
            ValueAnimator ofFloat6 = ValueAnimator.ofFloat(this.f6156b.d, 360.0f);
            ofFloat6.addUpdateListener(bVar2);
            ofFloat6.setDuration(8000L);
            ofFloat6.setInterpolator(mr.f27122f);
            this.Q.playTogether(ofFloat6);
            this.Q.addListener(new g(this, 0));
            this.Q.start();
        } else if (intValue == 2) {
            this.Q = new AnimatorSet();
            ValueAnimator ofFloat7 = ValueAnimator.ofFloat(this.f6156b.d, 184.0f);
            ofFloat7.addUpdateListener(bVar2);
            ofFloat7.setDuration(600L);
            mr mrVar = mr.f27123g;
            ofFloat7.setInterpolator(mrVar);
            ValueAnimator ofFloat8 = ValueAnimator.ofFloat(this.f6156b.f6121g, 50.0f);
            ...
            this.Q = new AnimatorSet();
            ValueAnimator ofFloat12 = ValueAnimator.ofFloat(this.f6156b.d, 180.0f);
            ofFloat12.addUpdateListener(bVar2);
            ofFloat12.setDuration(600L);
            mr mrVar2 = mr.f27122f;
            ofFloat12.setInterpolator(mrVar2);
            ...
            ofFloat13.setInterpolator(mrVar2);
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        this.D = new h(this);
        this.f6157c = surfaceTexture;
        this.f6162w = i10;
        this.v = i11;
        this.f6161s = Math.max(0, ((int) ((1.0f / this.E) * 1000.0f)) - 1);
        this.D.start();
    }
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        a aVar = this.f6156b;
        if (aVar != null) {
            aVar.onSurfaceChanged(this.f6160r, i10, i11);
        }
    }
