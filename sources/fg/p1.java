...
public final class p1 extends ul0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final eo f8170f;
    public int h;
    public int f8171n;
    public final f6 f8173s;
    public final int v;
    ...
    public final int f8172r = UserConfig.selectedAccount;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storiesListUpdated && objArr[0] == this.f8176y) {
            l();
        }
    }
    ...
    @Override
    public final int h() {
        return this.e.size() + this.f8171n;
    }
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        if (i13 == 0) {
            ...
            if (this.f8174w) {
                ...
                if (messageObject.isOutOwner() || ChatObject.isMonoForum(this.f8172r, dialogId)) {
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        a10 a10Var;
        if (i10 != 0) {
            f6 f6Var = this.f8173s;
            Context context = this.f8169c;
            if (i10 != 1) {
                if (i10 != 2) {
                    r2Var = null;
                } else {
                    a10Var = new o1(context, f6Var);
                }
            } else {
                a10 a10Var2 = new a10(context, f6Var);
                a10Var2.setIsSingleCell(true);
                a10Var2.setViewType(7);
                a10Var = a10Var2;
            }
            r2Var = a10Var;
        } else {
            r2Var = new r2(null, this.f8169c, true, this.f8172r, this.f8173s);
        }
