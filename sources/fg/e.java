...
public final class e implements GestureDetector.OnGestureListener {
    ...
    public final boolean onFling(MotionEvent motionEvent, MotionEvent motionEvent2, float f10, float f11) {
        switch (this.f6147a) {
            ...
            default:
                f5 f5Var = (f5) this.f6148b;
                f5Var.d.fling((int) f5Var.e, 0, (int) (-f10), 0, (int) f5Var.f15411f, (int) f5Var.h, 0, 0);
                f5Var.invalidate();
                return false;
        }
    }
        ...
        switch (this.f6147a) {
            ...
            default:
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    ...
                    if (((h4) arrayList.get(i10)).f15378a.getDrawRegion().contains(motionEvent.getX(), motionEvent.getY())) {
                        int i11 = f5Var.H;
                        int i12 = h4Var.f15379b;
                        if (i11 != i12) {
