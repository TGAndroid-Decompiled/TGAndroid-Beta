...
public final class t1 extends HorizontalScrollView {
    public final g20 f46177a;
    public final org.telegram.ui.Components.z5 f46178b;
    public final org.telegram.ui.Components.z5 f46179c;
    public final y1 d;

    public t1(y1 y1Var, Context context) {
        super(context);
        this.d = y1Var;
        this.f46177a = new g20();
        nr nrVar = nr.h;
        this.f46178b = new org.telegram.ui.Components.z5(this, 300L, nrVar);
        this.f46179c = new org.telegram.ui.Components.z5(this, 300L, nrVar);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f46178b.e(canScrollHorizontally(-1));
        float e6 = this.f46179c.e(canScrollHorizontally(1));
