...
public final class y extends z implements org.telegram.ui.ActionBar.a6, k9, j0, NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public final f6 f46368r;
    public final Paint f46369s;
    public final TextPaint v;
    public final RadialProgress2 f46370w;
    public final fo0 f46371x;
    public final int f46372y;

    public y(Context context, int i10, f6 f6Var) {
        super(context);
        this.f46369s = new Paint(1);
        ...
        this.f46372y = DownloadController.getInstance(i10).generateObserverTag();
        RadialProgress2 radialProgress2 = new RadialProgress2(this, f6Var);
        this.f46370w = radialProgress2;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (messageObject != null && i11 == this.f46367n) {
    ...
    @Override
    public final void e() {
        this.f46369s.setColor(j6.v0(j6.f20191uf, this.f46368r));
        i0 i0Var = this.R;
        if (i0Var != null) {
            i0Var.a();
        }
    ...
    public final void f(int i10) {
        ...
        int i12 = this.D;
        int i13 = this.C;
        this.f46370w.q(i11, i13, i11 + i12, i12 + i13);
        requestLayout();
        invalidate();
    }
    ...
    public final void i(a aVar, m3 m3Var) {
        ...
        this.f46414a = aVar;
        this.L = m3Var;
        if (aVar != null && aVar.f45856g == null) {
            aVar.f45856g = new t();
        }
        ...
        if (j() && this.M == null && displayDocument != null) {
            ...
            tL_message.out = true;
            tL_message.f19180id = -Long.valueOf(displayDocument.f19165id).hashCode();
            tL_message.peer_id = new TLRPC.TL_peerUser();
            TLRPC.TL_peerUser tL_peerUser = new TLRPC.TL_peerUser();
            tL_message.from_id = tL_peerUser;
            TLRPC.Peer peer = tL_message.peer_id;
            int i10 = this.f46367n;
            ...
            if (aVar2 != null && (tVar = aVar2.f45856g) != null && !TextUtils.isEmpty(tVar.e)) {
                tL_message.attachPath = this.f46414a.f45856g.e;
            }
    ...
    public final boolean j() {
        t tVar;
        a aVar = this.f46414a;
        if (aVar != null && (tVar = aVar.f45856g) != null && tVar.b()) {
            return true;
        }
        return false;
    }
    ...
    public final void l() {
        ...
        this.f46371x.j(this.H, AndroidUtilities.dp(30.0f));
    }
    ...
    public final void m(boolean z4) {
        ...
        int i12 = j6.f20188uc;
        int i13 = j6.f20206vc;
        RadialProgress2 radialProgress2 = this.f46370w;
        radialProgress2.g(i10, i11, i12, i13);
        radialProgress2.d = j6.v0(j6.Bd, this.f46368r);
        boolean k10 = k();
        int i14 = this.f46367n;
        if (k10) {
            DownloadController.getInstance(i14).removeLoadingFileObserver(this);
            radialProgress2.o(this.f46414a.f45856g.f46250f, z4);
            radialProgress2.setIcon(3, false, z4);
            n();
            return;
        }
        if (j()) {
            document = this.f46414a.f45856g.h;
        } else {
            document = null;
        }
        ...
        a aVar = this.f46414a;
        int i15 = 1;
        if (aVar != null && (tVar = aVar.f45856g) != null && !TextUtils.isEmpty(tVar.e) && new File(this.f46414a.f45856g.e).exists()) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getDisplayDocument() != null) {
            this.f46370w.draw(canvas);
            int i11 = j6.f20189ud;
            f6 f6Var = this.f46368r;
            int v02 = j6.v0(i11, f6Var);
            int v03 = j6.v0(j6.f20207vd, f6Var);
            int i12 = j6.f20245xd;
            int v04 = j6.v0(i12, f6Var);
            int v05 = j6.v0(i12, f6Var);
            int v06 = j6.v0(j6.f20226wd, f6Var);
            fo0 fo0Var = this.f46371x;
            ...
            int v07 = j6.v0(j6.f20066nd, f6Var);
            TextPaint textPaint = this.v;
            ...
            m3 m3Var = this.L;
            if (m3Var != null && (textSelectionHelper = m3Var.f46100a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
                ...
                if (R >= 0 && R > textSelectionHelper.f21331u0 && R <= textSelectionHelper.f21334x0) {
                    ...
                    canvas.drawRoundRect(dp, dp2, (width - i13) - AndroidUtilities.dp(8.0f), AndroidUtilities.dp(64.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f46369s);
                }
            }
        }
    }
    ...
    public final void onProgressDownload(String str, long j10, long j11) {
        ...
        this.f46370w.o(Math.min(1.0f, f10), true);
        if (this.O != 3) {
            m(true);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!k()) {
            if (this.f46371x.f(x10 - this.F, y10 - this.G, actionMasked)) {
                if (actionMasked == 0) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.P) {
                ...
                if (k()) {
                    ...
                    if (m3Var != null) {
                        a aVar = this.f46414a;
                        s3 s3Var = m3Var.f46100a;
                        ArrayList arrayList = s3Var.f46217i3;
                        v4 v4Var = (v4) s3Var.W3.remove(aVar.f45856g);
                        if (v4Var != null) {
                            v4Var.b();
                        }
