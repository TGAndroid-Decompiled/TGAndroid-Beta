...
public abstract class x3 {
    public static void A(java.util.ArrayList r31, java.util.ArrayList r32, java.util.Map r33) {
        throw new UnsupportedOperationException("Method not decompiled: vh.x3.A(java.util.ArrayList, java.util.ArrayList, java.util.Map):void");
    }
    ...
    public static a B(w3 w3Var, boolean z4) {
        ...
        while (i10 < size) {
            ...
            w3 w3Var2 = (w3) obj;
            if (!w3Var2.f46261b) {
                if ("figcaption".equals(w3Var2.f46260a)) {
                    charSequence = w(w3Var2);
                } else {
                    boolean equals = "video".equals(w3Var2.f46260a);
                    if (equals || "img".equals(w3Var2.f46260a)) {
    ...
    public static void D(w3 w3Var, ArrayList arrayList, int i10, boolean z4) {
        ...
        while (i15 < size) {
            ...
            i15++;
            w3 w3Var2 = (w3) obj;
            if (!w3Var2.f46261b && "li".equals(w3Var2.f46260a)) {
                ...
                while (i16 < size2) {
                    ...
                    if (!w3Var3.f46261b && ("ul".equals(w3Var3.f46260a) || "ol".equals(w3Var3.f46260a))) {
                        arrayList4.add(w3Var3);
                    } else if (w3Var3.f46261b) {
                        spannableStringBuilder.append((CharSequence) q(w3Var3.f46262c));
                    } else {
                ...
                aVar.e = z10;
                aVar.f45777f = w3Var2.b("data-checked");
                arrayList.add(aVar);
                ...
                while (i18 < size3) {
                    ...
                    i18++;
                    w3 w3Var4 = (w3) obj2;
                    D(w3Var4, arrayList, i13, "ol".equals(w3Var4.f46260a));
                }
                i14++;
            }
        }
    ...
    public static void F(StringBuilder sb, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, p1 p1Var, boolean z4, int i15, Map map) {
        ...
        p1 p1Var2 = p1Var;
        int i18 = i15;
        ArrayList arrayList = (ArrayList) p1Var2.f46065a;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
            ...
            if (!aVar.f45779i) {
                if (aVar.f45781k.size() > i18) {
                    p1Var2.b(sb2);
                    Long l10 = (Long) ((a) list3.get(iArr[0])).f45781k.get(i18);
                    ...
                    while (true) {
                        ...
                        if (aVar2.f45781k.size() <= i18 || ((Long) aVar2.f45781k.get(i18)).longValue() != longValue) {
                            break;
                        }
                        i20 = i21;
                    }
                    ...
                    if (r3.x3(aVar)) {
                        ...
                        sb2.append(((TL_iv.pageBlockDetails) aVar3.f45775b).open ? "<details open>" : "<details>");
                        sb2.append("<summary>");
                        ...
                        p1Var4.b(sb2);
                        int i22 = iArr[0];
                        if (i22 <= i16 && i22 < list2.size() && ((a) list2.get(iArr[0])).f45779i) {
                            iArr[0] = iArr[0] + 1;
                        }
                        sb2.append("</details>");
                    } else {
                        i16 = i10;
                        list2 = list3;
                        if (aVar.f45776c > 0 && l(aVar.f45775b) != null) {
                            int i23 = aVar.f45776c;
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) kh.a2.i(1, arrayList)).booleanValue() != z10) {
                                p1Var2.a(sb2);
                            ...
                            if (pageBlock instanceof TL_iv.pageBlockDivider) {
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockPhoto) {
                                    G(sb2, "img", ((TL_iv.pageBlockPhoto) pageBlock).photo_id, aVar.f45778g, pageBlock);
                                    sb2 = sb;
                                } else if (pageBlock instanceof TL_iv.pageBlockVideo) {
                                    sb2 = sb;
                                    G(sb2, "video", ((TL_iv.pageBlockVideo) pageBlock).video_id, aVar.f45778g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockAudio) {
                                    sb2 = sb;
                                    G(sb2, "audio", ((TL_iv.pageBlockAudio) pageBlock).audio_id, aVar.f45778g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockDocument) {
                                    sb2 = sb;
                                    G(sb2, "document", ((TL_iv.pageBlockDocument) pageBlock).document_id, aVar.f45778g, pageBlock);
                                } else {
                                    sb2 = sb;
                                    ...
                                    if (r3.B3(pageBlock)) {
                                        ...
                                        if (g32 != null) {
                                            ...
                                            while (i26 < g32.size()) {
                                                ...
                                                if (pageBlock2 instanceof TL_iv.pageBlockVideo) {
                                                    ...
                                                    if (j10 != 0) {
                                                        str = str3;
                                                        i(sb2, "video", j10, sVar, pageBlock2);
                                                    } else {
                                                        str = str3;
                                                    }
                                                } else {
                                        ...
                                        if (pageblockmap.f19405w != 0) {
                                            sb2.append(" w=\"");
                                            sb2.append(pageblockmap.f19405w);
                                            sb2.append('\"');
                                        }
                                        if (pageblockmap.h != 0) {
                                            sb2.append(" h=\"");
    ...
    public static CharSequence K(a aVar, int i10, int i11, int i12, int i13, int i14) {
        ...
        int i16;
        if (r3.x3(aVar)) {
            A = x5.r(((TL_iv.pageBlockDetails) aVar.f45775b).title, null, true);
        } else {
            A = v5.A(aVar.f45775b);
        }
        if (A == null) {
    ...
    public static void e(SpannableStringBuilder spannableStringBuilder, w3 w3Var, int i10, String str, long j10) {
        ...
        while (i12 < size) {
            ...
            if (w3Var2.f46261b) {
                ...
                str2 = str;
                j11 = j10;
                j(spannableStringBuilder2, q(w3Var2.f46262c), i11, str2, j11);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                i11 = i10;
                str2 = str;
    ...
    public static void f(SpannableStringBuilder spannableStringBuilder, w3 w3Var) {
        ...
        while (i10 < size) {
            ...
            if (w3Var2.f46261b) {
                spannableStringBuilder2 = spannableStringBuilder;
                j(spannableStringBuilder2, q(w3Var2.f46262c), 0, null, 0L);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                if (!"cite".equals(w3Var2.f46260a)) {
    ...
    public static void g(java.lang.StringBuilder r22, java.lang.CharSequence r23) {
        throw new UnsupportedOperationException("Method not decompiled: vh.x3.g(java.lang.StringBuilder, java.lang.CharSequence):void");
    }
    ...
    public static void h(SpannableStringBuilder spannableStringBuilder, w3 w3Var, int i10, String str, long j10) {
        ...
        if ("button".equals(w3Var.f46260a) && (v = v(w3Var)) != null) {
        ...
        if (w3Var.e.isEmpty() && !w3Var.f46261b) {
            return;
        }
    ...
    public static void i(StringBuilder sb, String str, long j10, s sVar, TL_iv.PageBlock pageBlock) {
        ...
        if (sVar != null) {
            if (sVar.f46156j > 0) {
                sb.append(" width=\"");
                sb.append(sVar.f46156j);
                sb.append('\"');
            }
            if (sVar.f46157k > 0) {
                sb.append(" height=\"");
                sb.append(sVar.f46157k);
                sb.append('\"');
            }
        }
    ...
    public static vh.a m(vh.w3 r8) {
        throw new UnsupportedOperationException("Method not decompiled: vh.x3.m(vh.w3):vh.a");
    }
                ...
                switch (c3) {
                    case 0:
                        ...
                        while (i12 < size2) {
                            ...
                            w3 w3Var3 = (w3) obj2;
                            if (!w3Var3.f46261b) {
                                if ("td".equals(w3Var3.f46260a) || "th".equals(w3Var3.f46260a)) {
                                    ...
                                    if (!"th".equals(w3Var3.f46260a) && !w3Var3.b("header")) {
                                        z4 = false;
                                    } else {
                                        z4 = true;
                                    }
    ...
    public static java.util.ArrayList z(java.lang.String r16, java.util.HashMap r17) {
        throw new UnsupportedOperationException("Method not decompiled: vh.x3.z(java.lang.String, java.util.HashMap):java.util.ArrayList");
    }
}
