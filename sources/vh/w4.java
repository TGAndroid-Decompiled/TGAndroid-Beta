...
public abstract class w4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i14 < size) {
            ...
            if (spanned != null && span == null) {
                zi0Var = (zi0) a(spanned, i15, i10, zi0.class);
            } else {
                zi0Var = null;
            }
            if (span == null && zi0Var == null) {
                ...
                while (true) {
                    if (i14 < size) {
                        ...
                        if (span != null) {
                            ...
                            a2 = a(spanned, i16, length, zi0.class);
                        }
                        if (a2 != zi0Var2) {
                            break;
                        }
                                ...
                                if (arrayList6 != null && !arrayList6.isEmpty()) {
                                    ...
                                    while (i10 < size2) {
                                        ...
                                        if (spannableStringBuilder != null) {
                                            ...
                                            SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder(v2.k(valueOf, ".  "));
        ...
        if (arrayList != null) {
            ...
            while (i10 < size) {
                ...
                if (aVar == null) {
                    ...
                    if (!aVar.f45779i && aVar.f45776c <= 0) {
    ...
    public static SpannableStringBuilder i(a aVar, boolean z4) {
        ...
        if (aVar.f45775b instanceof TL_iv.pageBlockPreformatted) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(r10);
            spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, ((TL_iv.pageBlockPreformatted) aVar.f45775b).language, spannableStringBuilder.toString()), 0, spannableStringBuilder.length(), 33);
            return spannableStringBuilder;
        }
        return r10;
    }
    ...
    public static SpannableStringBuilder j(List list, boolean z4) {
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (!aVar.f45781k.isEmpty()) {
                long longValue = ((Long) aVar.f45781k.get(0)).longValue();
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                int i11 = i10;
                while (i11 < list.size() && !((a) list.get(i11)).f45781k.isEmpty() && ((Long) ((a) list.get(i11)).f45781k.get(0)).longValue() == longValue) {
                    if (i11 > i10) {
                        spannableStringBuilder.append('\n');
                    }
                ...
                if (spannableStringBuilder.length() > 0) {
                    zi0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), false);
                }
                ...
                if (!(pageBlock instanceof TL_iv.pageBlockBlockquote) && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    if (spannableStringBuilder2.length() > 0) {
                        zi0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), z10);
                    }
