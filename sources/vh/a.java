...
public final class a extends Path {
    ...
    public final Layout f44393b;
    public final Stack f44394c;
    public final List d;
    public final int e;
    public final int f44395f;
    public final ArrayList f44396g;
    ...
    public final void addRect(float f7, float f10, float f11, float f12, Path.Direction direction) {
        ...
        hVar.f44447y = false;
        ArrayList arrayList = this.f44396g;
        if (arrayList != null) {
            ...
            while (true) {
                ...
                if (f14 >= pi0Var.f27052b && f14 <= pi0Var.f27053c) {
                    hVar.f44447y = true;
                    break;
                }
                i10++;
        ...
        hVar.f44437n = -1.0f;
        ValueAnimator valueAnimator = hVar.f44441r;
