...
public final class o4 extends y implements a6, l9, i0 {
    ...
    public boolean V;
    public float W;
    public float f46043a0;
    public int f46044b0;
    public int f46045c0;
    public int f46046d0;
    public VelocityTracker f46047e0;
    public ValueAnimator f46048f0;
    public final Path f46049g0;
    public final f6 f46050n;
    public final Paint f46051r;
    public final Paint f46052s;
    public final h0 v;
    public final ImageView f46053w;
    public final ImageView f46054x;
    public final ArrayList f46055y;

    public o4(Context context, f6 f6Var) {
        super(context);
        boolean z4;
        this.f46051r = new Paint(1);
        this.f46052s = new Paint(1);
        this.f46055y = new ArrayList();
    ...
    private void settle(float f10) {
        ...
        if (f10 >= 0.0f || this.T >= size - 1) {
            ...
            this.f46048f0 = ofFloat;
            ofFloat.setDuration(220L);
            this.f46048f0.setInterpolator(nr.h);
            this.f46048f0.addUpdateListener(new nh.e5(this, 26));
            this.f46048f0.addListener(new org.telegram.ui.Cells.b4(this, i12, 11));
            this.f46048f0.start();
        }
        i10 = 1;
        int i112 = this.T;
        ...
        this.f46048f0 = ofFloat2;
        ofFloat2.setDuration(220L);
        this.f46048f0.setInterpolator(nr.h);
        this.f46048f0.addUpdateListener(new nh.e5(this, 26));
        this.f46048f0.addListener(new org.telegram.ui.Cells.b4(this, i122, 11));
        this.f46048f0.start();
    }
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (this.B.contains(view)) {
            ...
            if (aVar == null) {
                ...
                size = aVar.f45781k.size();
            }
            if (size > 0) {
                canvas.save();
                Path path = this.f46049g0;
                path.rewind();
    ...
    public final void e() {
        int i10 = j6.Gd;
        f6 f6Var = this.f46050n;
        this.f46051r.setColor(j6.v0(i10, f6Var));
        this.f46052s.setColor(j6.v0(j6.f20216uf, f6Var));
        h0 h0Var = this.v;
        if (h0Var != null) {
            h0Var.a();
        }
    ...
    public final ImageView h() {
        ...
        if (this.E && Build.VERSION.SDK_INT >= 31) {
            ...
            int i11 = j6.f19906d6;
            imageView.setBackground(new x1(j6.Z(j6.v0(i11, f6Var), j6.v(j6.v0(i11, f6Var), j6.v0(j6.f19996i6, f6Var)), 20, 20)));
        }
        d6.a(imageView);
    ...
    public final void j(Canvas canvas) {
        ...
        a aVar2 = o4Var.f46283a;
        if (aVar2 == null) {
            size2 = 0;
        } else {
            size2 = aVar2.f45781k.size();
        }
        if (size2 > 0) {
        ...
        if (size3 == 1 && arrayList2.size() == 1) {
            ...
            if (rectF.left > 0.5f || rectF.right < max - 0.5f) {
                ...
                ImageReceiver imageReceiver = r4Var.f46147b;
                if (r4Var.b()) {
                    imageReceiver.setImageCoords(rectF2);
                    imageReceiver.setAlpha(r4Var.f46146a.getCurrentAlpha());
        ...
        while (i18 < arrayList.size() && i18 < arrayList2.size()) {
            ...
            if (z4) {
                ...
                r4Var2.f46146a.setRoundRadius(i11, i12, i13, i14);
                r4Var2.f46147b.setRoundRadius(i11, i12, i13, i14);
            } else {
                r4Var2.f46146a.setRoundRadius(i16, i16, i16, i16);
                r4Var2.f46147b.setRoundRadius(i16, i16, i16, i16);
            }
            boolean c3 = r4Var2.c();
            ImageReceiver imageReceiver2 = r4Var2.f46146a;
            if (!c3) {
            ...
            if (sVar != null && sVar.a()) {
                ...
                radialProgress2.o(r4Var2.e.f46153f, true);
                radialProgress2.draw(canvas2);
            }
            s sVar2 = r4Var2.e;
            if (sVar2 != null && sVar2.f46160n && r4Var2.c()) {
                ih.j spoilerEffect = o4Var.getSpoilerEffect();
                ImageReceiver imageReceiver3 = r4Var2.f46147b;
                canvas2.save();
    ...
    public final void k(int i10) {
        if (this.K != null && this.f46283a != null) {
            List m9 = m();
            if (!m9.isEmpty() && (m9.size() != 1 || ((s) m9.get(0)).f46150a != 0)) {
                if (i10 >= 0 && i10 < m9.size() && ((s) m9.get(i10)).a()) {
                    r3.N1(this.f46283a, (s) m9.get(i10), this.K.f45978a);
                    return;
                }
                return;
            }
    ...
    public final boolean l() {
        a aVar = this.f46283a;
        if (aVar != null && (aVar.f45775b instanceof TL_iv.pageBlockSlideshow)) {
            return true;
        }
        return false;
    }
    ...
    public final void n() {
        ...
        List m9 = m();
        while (true) {
            arrayList = this.f46055y;
            if (arrayList.size() >= m9.size()) {
                break;
            }
            r4 r4Var = new r4(this, this.f46050n);
            if (this.L) {
                r4Var.f46146a.onAttachedToWindow();
                r4Var.f46147b.onAttachedToWindow();
                r4Var.a();
            }
            arrayList.add(r4Var);
        }
        while (arrayList.size() > m9.size()) {
            ...
            r4Var2.f46146a.onDetachedFromWindow();
            r4Var2.f46147b.onDetachedFromWindow();
            r4Var2.f46148c = null;
        }
        ...
        this.f46053w.bringToFront();
        this.f46054x.bringToFront();
    ...
    public final void o(boolean z4) {
        ...
        ImageView imageView = this.f46054x;
    ...
    public final void onAttachedToWindow() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.f46055y;
    ...
    public final void onDetachedFromWindow() {
        ...
        VelocityTracker velocityTracker = this.f46047e0;
        ...
        while (true) {
            ...
            r4 r4Var = (r4) arrayList.get(i10);
            r4Var.f46146a.onDetachedFromWindow();
            r4Var.f46147b.onDetachedFromWindow();
            r4Var.f46148c = null;
            i10++;
        }
        ih.j jVar = this.J;
        ...
        ValueAnimator valueAnimator = this.f46048f0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (arrayList.size() >= 2 && f13 > 0.001f) {
            if (f46042h0 == null) {
                ...
                f46042h0 = paint;
                paint.setColor(-1);
                f46042h0.setShadowLayer(AndroidUtilities.dpf2(3.0f), 0.0f, AndroidUtilities.dpf2(1.0f), Integer.MIN_VALUE);
            }
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                f46042h0.setAlpha((int) e2.c.y(max2, 95.0f, 160.0f, f13));
                canvas.drawCircle(AndroidUtilities.dp(f12) + dp2 + (AndroidUtilities.dp(f10) * i10), dp3, (AndroidUtilities.dp(1.0f) * max2) + AndroidUtilities.dp(2.0f), f46042h0);
            }
            canvas.restore();
        }
        k3 k3Var = this.K;
        if (k3Var != null && (textSelectionHelper = k3Var.f45978a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
            ((RecyclerView) getParent()).getClass();
            int R = RecyclerView.R(this);
            if (R >= 0 && R > textSelectionHelper.f21401u0 && R <= textSelectionHelper.f21404x0) {
                canvas.drawRect(getPaddingLeft(), paddingTop, getWidth() - getPaddingRight(), paddingTop + this.M, this.f46052s);
            }
        }
        if (this.E && (dVar = this.F) != null && Build.VERSION.SDK_INT >= 31) {
            ...
            if (width > 0 && height > 0) {
                if (canvas.isHardwareAccelerated() && !dVar.f44314n) {
                    try {
                ...
                while (true) {
                    ...
                    imageView = this.f46054x;
                    imageView2 = this.f46053w;
                    if (i11 >= size2) {
                        break;
                    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        while (true) {
            ...
            if (i19 < arrayList.size()) {
                ...
                int i20 = 8;
                if (i19 < m9.size() && ((s) m9.get(i19)).f46150a != 0) {
    ...
    public final void onMeasure(int r30, int r31) {
        throw new UnsupportedOperationException("Method not decompiled: vh.o4.onMeasure(int, int):void");
    }
            ...
            if (arrayList.size() >= 2) {
                if (actionMasked == 0) {
                    ...
                    if (this.f46044b0 == 0) {
                        ...
                        this.f46044b0 = viewConfiguration.getScaledTouchSlop();
                        this.f46045c0 = viewConfiguration.getScaledMinimumFlingVelocity();
                        this.f46046d0 = viewConfiguration.getScaledMaximumFlingVelocity();
                    }
                    this.W = x10;
                    this.f46043a0 = y10;
                    this.V = false;
                    VelocityTracker velocityTracker2 = this.f46047e0;
                    if (velocityTracker2 == null) {
                        this.f46047e0 = VelocityTracker.obtain();
                    } else {
                        velocityTracker2.clear();
                    }
                    this.f46047e0.addMovement(motionEvent);
                    if (getParent() != null) {
                ...
                float f10 = 0.0f;
                if (actionMasked == 2) {
                    VelocityTracker velocityTracker3 = this.f46047e0;
                    if (velocityTracker3 != null) {
                        velocityTracker3.addMovement(motionEvent);
                    }
                    float f11 = x10 - this.W;
                    float f12 = y10 - this.f46043a0;
                    if (!this.V && Math.abs(f11) > this.f46044b0 && Math.abs(f11) > Math.abs(f12)) {
                        this.V = true;
                        this.Q = -1;
                    }
                    if (this.V) {
                    ...
                    if (actionMasked == 1 && (velocityTracker = this.f46047e0) != null) {
                        velocityTracker.addMovement(motionEvent);
                        this.f46047e0.computeCurrentVelocity(1000, this.f46046d0);
                        float xVelocity = this.f46047e0.getXVelocity();
                        float yVelocity = this.f46047e0.getYVelocity();
                        if (Math.abs(xVelocity) >= this.f46045c0 && Math.abs(xVelocity) > Math.abs(yVelocity)) {
                            f10 = xVelocity;
                        }
                    }
                    VelocityTracker velocityTracker4 = this.f46047e0;
