...
public class o extends TextView implements aa {
    ...
    public final ArrayList f44402b;
    public final Stack f44403c;
    public boolean d;
    public final Path e;
    ...
    public final a90 f44407s;
    public final d6 v;
    public CharacterStyle f44408w;
    public c90 f44409x;
    public c90 f44410y;
    ...
    public final void b() {
        int i10;
        ArrayList arrayList = this.f44402b;
        if (arrayList == null) {
            return;
        }
        Stack stack = this.f44403c;
    ...
    public final void c(boolean z10) {
        ...
        this.f44405n = z5.update(this.h, this, this.f44405n, getLayout());
        this.K = getLayout();
        this.L = i10;
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (a90Var != null) {
            ...
            if (motionEvent.getAction() == 1) {
                a90Var.d(true);
                e90 e90Var2 = this.E;
                if (e90Var2 != null && (characterStyle = e90Var2.f23625i) == a2) {
                    c90 c90Var = this.f44409x;
                    if (c90Var != null) {
        ...
        if (this.E != null || (this.f44404f && ((GestureDetector) this.f44401a.f44396a.f13371b).onTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.restore();
        ArrayList arrayList2 = this.f44402b;
        ...
        if (isEmpty) {
            ...
            Emoji.emojiDrawingUseAlpha = this.f44406r;
            super.onDraw(canvas);
            Emoji.emojiDrawingUseAlpha = true;
            canvas.restore();
            h hVar = (h) arrayList2.get(0);
            if (hVar.f44363m > 0.0f && hVar.f44364n > 0.0f) {
                canvas.save();
        ...
        if (this.f44405n != null) {
            ...
            z5.drawAnimatedEmojis(canvas, getLayout(), this.f44405n, 0.0f, arrayList2, 0.0f, getHeight(), 0.0f, 1.0f, this.F);
        ...
        if (!arrayList.isEmpty()) {
            if (((h) arrayList.get(0)).f44364n == -1.0f) {
                z10 = false;
            }
            if (z10) {
                canvas2 = canvas;
    ...
    public void setLoading(CharacterStyle characterStyle) {
        if (this.f44408w != characterStyle) {
            a90 a90Var = this.f44407s;
            a90Var.e();
            this.f44408w = characterStyle;
    ...
    public o(Context context, d6 d6Var, boolean z10) {
        ...
        this.G = true;
        this.K = null;
        this.f44407s = new a90(this);
        this.v = d6Var;
        this.f44401a = new m(this, arrayList, new ai.k(12, this, z10));
    }
