...
public class o extends TextView implements z9 {
    ...
    public final ArrayList f44448b;
    public final Stack f44449c;
    public boolean d;
    public final Path e;
    public boolean f44450f;
    public int h;
    public t5 f44451n;
    public boolean f44452r;
    public final z80 f44453s;
    public final e6 v;
    public CharacterStyle f44454w;
    public b90 f44455x;
    public b90 f44456y;
    ...
    public final void b() {
        int i10;
        ArrayList arrayList = this.f44448b;
        if (arrayList == null) {
            return;
        }
        Stack stack = this.f44449c;
    ...
    public final void c(boolean z10) {
        ...
        this.f44451n = x5.update(this.h, this, this.f44451n, getLayout());
        this.K = getLayout();
        this.L = i10;
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (z80Var != null) {
            ...
            if (a2 != null && motionEvent.getAction() == 0) {
                ...
                int spanStart = spannableString.getSpanStart(this.E.f23247i);
                int spanEnd = spannableString.getSpanEnd(this.E.f23247i);
                w80 b10 = this.E.b();
                if (this.G) {
                    paddingTop = 0.0f;
                } else {
        ...
        if (this.E != null || (this.f44450f && ((GestureDetector) this.f44447a.f44442a.f13384b).onTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.restore();
        ArrayList arrayList2 = this.f44448b;
        ...
        if (isEmpty) {
            ...
            Emoji.emojiDrawingUseAlpha = this.f44452r;
            super.onDraw(canvas);
            Emoji.emojiDrawingUseAlpha = true;
            canvas.restore();
            h hVar = (h) arrayList2.get(0);
            if (hVar.f44409m > 0.0f && hVar.f44410n > 0.0f) {
                canvas.save();
        ...
        c(false);
        if (this.f44451n != null) {
            canvas.save();
            canvas.translate(paddingLeft, paddingTop);
            x5.drawAnimatedEmojis(canvas, getLayout(), this.f44451n, 0.0f, arrayList2, 0.0f, getHeight(), 0.0f, 1.0f, this.F);
        ...
        if (!arrayList.isEmpty()) {
            if (((h) arrayList.get(0)).f44410n == -1.0f) {
                z10 = false;
            }
            if (z10) {
                canvas2 = canvas;
    ...
    public void setLoading(CharacterStyle characterStyle) {
        if (this.f44454w != characterStyle) {
            z80 z80Var = this.f44453s;
            z80Var.e();
            this.f44454w = characterStyle;
            ...
            if (i10 != null) {
                ...
                i10.f24276w.setStrokeWidth(AndroidUtilities.dpf2(1.25f));
                z80Var.b(i10, null);
            }
        }
    }
    ...
    public o(Context context, e6 e6Var, boolean z10) {
        ...
        this.G = true;
        this.K = null;
        this.f44453s = new z80(this);
        this.v = e6Var;
        this.f44447a = new m(this, arrayList, new ai.k(11, this, z10));
    }
