...
public class o extends TextView implements aa {
    ...
    public boolean M;
    public Object N;
    public final m f44748a;
    public final ArrayList f44749b;
    public final Stack f44750c;
    public boolean d;
    public final Path e;
    ...
    public final h90 f44754s;
    public final f6 v;
    public CharacterStyle f44755w;
    public j90 f44756x;
    public j90 f44757y;
    ...
    public final void b() {
        int i10;
        ArrayList arrayList = this.f44749b;
        if (arrayList == null) {
            return;
        }
        Stack stack = this.f44750c;
    ...
    public final void c(boolean z10) {
        ...
        this.f44752n = y5.update(this.h, this, this.f44752n, getLayout());
        this.K = getLayout();
        this.L = i10;
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.E != null || (this.f44751f && ((GestureDetector) this.f44748a.f44743a.f15112b).onTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.restore();
        ArrayList arrayList2 = this.f44749b;
        ...
        if (isEmpty) {
            ...
            Emoji.emojiDrawingUseAlpha = this.f44753r;
            super.onDraw(canvas);
            Emoji.emojiDrawingUseAlpha = true;
            canvas.restore();
            h hVar = (h) arrayList2.get(0);
            if (hVar.f44710m > 0.0f && hVar.f44711n > 0.0f) {
                canvas.save();
        ...
        if (this.f44752n != null) {
            ...
            y5.drawAnimatedEmojis(canvas, getLayout(), this.f44752n, 0.0f, arrayList2, 0.0f, getHeight(), 0.0f, 1.0f, this.F);
        ...
        if (!arrayList.isEmpty()) {
            if (((h) arrayList.get(0)).f44711n == -1.0f) {
                z10 = false;
            }
            if (z10) {
                canvas2 = canvas;
    ...
    public void setLoading(CharacterStyle characterStyle) {
        if (this.f44755w != characterStyle) {
            h90 h90Var = this.f44754s;
            h90Var.e();
            this.f44755w = characterStyle;
    ...
    public o(Context context, f6 f6Var, boolean z10) {
        ...
        this.G = true;
        this.K = null;
        this.f44754s = new h90(this);
        this.v = f6Var;
        this.f44748a = new m(this, arrayList, new ai.k(11, this, z10));
    }
