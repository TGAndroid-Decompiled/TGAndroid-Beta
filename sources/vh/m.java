...
public final class m implements xj {
    public final li f46008a;
    public final p f46009b;
    ...
    public final void x() {
        try {
            ...
            intent.setType("*/*");
            this.f46009b.f24278b.f26689c0.startActivityForResult(intent, 21);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
