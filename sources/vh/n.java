...
public class n extends TextView implements aa {
    ...
    public boolean M;
    public Object N;
    public final l f44769a;
    public final ArrayList f44770b;
    public final Stack f44771c;
    public boolean d;
    public final Path e;
    ...
    public final k90 f44775s;
    public final f6 v;
    public CharacterStyle f44776w;
    public m90 f44777x;
    public m90 f44778y;
    ...
    public final void c(boolean z10) {
        ...
        this.f44773n = y5.update(this.h, this, this.f44773n, getLayout());
        this.K = getLayout();
        this.L = i10;
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (k90Var != null) {
            ...
            if (motionEvent.getAction() == 1) {
                k90Var.d(true);
                o90 o90Var2 = this.E;
                if (o90Var2 != null && (characterStyle = o90Var2.f27022i) == a2) {
                    m90 m90Var = this.f44777x;
                    if (m90Var != null) {
        ...
        if (this.E != null || (this.f44772f && ((GestureDetector) this.f44769a.f44764a.f13912b).onTouchEvent(motionEvent))) {
            return true;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.restore();
        ArrayList arrayList2 = this.f44770b;
        ...
        if (isEmpty) {
            ...
            Emoji.emojiDrawingUseAlpha = this.f44774r;
            super.onDraw(canvas);
            Emoji.emojiDrawingUseAlpha = true;
            canvas.restore();
            g gVar = (g) arrayList2.get(0);
            if (gVar.f44731m > 0.0f && gVar.f44732n > 0.0f) {
                canvas.save();
        ...
        c(false);
        if (this.f44773n != null) {
            canvas.save();
            canvas.translate(paddingLeft, paddingTop);
            y5.drawAnimatedEmojis(canvas, getLayout(), this.f44773n, 0.0f, arrayList2, 0.0f, getHeight(), 0.0f, 1.0f, this.F);
        ...
        if (!arrayList.isEmpty()) {
            if (((g) arrayList.get(0)).f44732n == -1.0f) {
                z10 = false;
            }
            if (z10) {
                canvas2 = canvas;
    ...
    public void setLoading(CharacterStyle characterStyle) {
        if (this.f44776w != characterStyle) {
            k90 k90Var = this.f44775s;
            k90Var.e();
            this.f44776w = characterStyle;
    ...
    public n(Context context, f6 f6Var, boolean z10) {
        ...
        this.f44770b = arrayList;
        this.f44771c = new Stack();
        this.e = new Path();
        this.f44772f = true;
        this.h = 0;
        this.f44774r = true;
        this.G = true;
        this.K = null;
        this.f44775s = new k90(this);
        this.v = f6Var;
        this.f44769a = new l(this, arrayList, new ai.k(11, this, z10));
    }
