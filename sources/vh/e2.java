...
public final class e2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, e2 e2Var) {
        if (richText != null) {
            e2Var.f45950a = y5.l(richText).length() + e2Var.f45950a;
        ...
        if (pageBlock != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                    ...
                    e2Var.f45951b = pageblockblockquoteblocks.blocks.size() + e2Var.f45951b;
                    ...
                    e2Var.f45951b = pageblockdetails.blocks.size() + e2Var.f45951b;
                    ...
                    e2Var.f45951b = pageblocklist.items.size() + e2Var.f45951b;
                    ...
                    e2Var.f45951b = pageblockorderedlist.items.size() + e2Var.f45951b;
                    ...
                    if (arrayList3 != null) {
                        e2Var.f45951b = arrayList3.size() + e2Var.f45951b;
                    ...
                    if (str != null) {
                        e2Var.f45950a = str.length() + e2Var.f45950a;
                    }
                } else {
