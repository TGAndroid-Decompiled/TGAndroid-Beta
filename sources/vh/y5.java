...
public abstract class y5 {
    public static final int[] f46413a = {1, 2, 16, 8, 4, 256, 16384, 32768, 65536};
    ...
    public static int d(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: vh.y5.d(java.lang.CharSequence):int");
    }
    ...
    public static int e(Spanned spanned, int i10, int i11) {
        ...
        for (t01 t01Var : t01VarArr) {
            int i13 = t01Var.f28862b.f28632a;
            if ((i13 & 512) != 0) {
                i13 |= 256;
            }
            i12 |= i13;
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText f(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: vh.y5.f(java.lang.CharSequence):org.telegram.tgnet.tl.TL_iv$RichText");
    }
    ...
    public static void o(Spannable spannable, int i10, int i11, int i12, boolean z4, TL_iv.PageBlock pageBlock) {
        ...
        if (max < max2) {
            for (t01 t01Var : (t01[]) spannable.getSpans(max, max2, t01.class)) {
                ...
                int i14 = t01Var.f28862b.f28632a;
    ...
    public static TL_iv.RichText s(String str, x5 x5Var) {
        ...
        f4 f4Var = x5Var.f46366f;
        if (f4Var != null) {
            return f4Var.f45975a;
        }
        if (x5Var.e != null) {
        ...
        if (x5Var.f46364b != null) {
            TL_iv.RichText texturl = new TL_iv.textUrl();
            texturl.text = richText9;
            texturl.url = x5Var.f46364b;
            richText10 = texturl;
        }
        i10 i10Var = x5Var.f46365c;
        if (i10Var != null) {
