...
public abstract class x4 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i14 < size) {
            ...
            if (spanned != null && span == null) {
                aj0Var = (aj0) a(spanned, i15, i10, aj0.class);
            } else {
                aj0Var = null;
            }
            if (span == null && aj0Var == null) {
                ...
                while (true) {
                    if (i14 < size) {
                        ...
                        if (span != null) {
                            ...
                            a2 = a(spanned, i16, length, aj0.class);
                        }
                        if (a2 != aj0Var2) {
                            break;
                        }
            ...
            while (it.hasNext()) {
                ...
                if (pageBlock != null) {
                    ...
                    if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                        SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(y5.r(pageBlock.text, pageBlock, true));
                        ...
                        if (!z4 && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                            if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                                ...
                                if (arrayList4 != null && !arrayList4.isEmpty()) {
                                    ...
                                    while (i10 < size) {
                                        ...
                                        if (pageListItem2 instanceof TL_iv.TL_pageListItemText) {
                                            spannableStringBuilder2 = y5.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true);
                                ...
                                if (arrayList6 != null && !arrayList6.isEmpty()) {
                                    ...
                                    while (i10 < size2) {
                                        ...
                                        if (pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemText) {
                                            spannableStringBuilder = y5.r(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem2).text, null, true);
                                        ...
                                        if (spannableStringBuilder != null) {
                                            ...
                                            SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder(w2.k(valueOf, ".  "));
                                ...
                                SpannableStringBuilder r11 = y5.r(pageblocktable.title, null, true);
                                    ...
                                    while (i12 < size3) {
                                        ...
                                        if (arrayList10 != null && !arrayList10.isEmpty()) {
                                            ...
                                            for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                                ...
                                                spannableStringBuilder7.append((CharSequence) y5.r(pagetablerow2.cells.get(i13).text, null, true));
                                            }
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockAuthorDate) {
                                    spannableStringBuilder3 = y5.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                                    ...
                                    if (pageBlock.caption != null) {
                                        ...
                                        SpannableStringBuilder r12 = y5.r(pageBlock.caption.text, null, true);
                                        if (!TextUtils.isEmpty(r12)) {
                                            spannableStringBuilder8.append((CharSequence) r12);
                                        }
                                        SpannableStringBuilder r13 = y5.r(pageBlock.caption.credit, null, true);
                                    ...
                                    spannableStringBuilder3 = y5.r(pageBlock.text, pageBlock, true);
                                }
                            } else {
                            ...
                            spannableStringBuilder3 = h(y5.r(pageBlock.text, pageBlock, true), richText);
                        }
                    }
                }
        ...
        if (arrayList != null) {
            ...
            while (i10 < size) {
                ...
                if (aVar == null) {
                    ...
                    if (!aVar.f45857i && aVar.f45854c <= 0) {
    ...
    public static SpannableStringBuilder i(a aVar, boolean z4) {
        ...
        if (z4) {
            ...
            r10 = y5.r(richText, pageBlock, false);
        } else {
            TL_iv.PageBlock pageBlock2 = aVar.f45853b;
            if (pageBlock2 != null) {
                richText = pageBlock2.text;
            }
            r10 = y5.r(richText, pageBlock2, true);
        }
        if (aVar.f45853b instanceof TL_iv.pageBlockPreformatted) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(r10);
            spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, ((TL_iv.pageBlockPreformatted) aVar.f45853b).language, spannableStringBuilder.toString()), 0, spannableStringBuilder.length(), 33);
            return spannableStringBuilder;
        }
        return r10;
    }
    ...
    public static SpannableStringBuilder j(List list, boolean z4) {
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (!aVar.f45859k.isEmpty()) {
                long longValue = ((Long) aVar.f45859k.get(0)).longValue();
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                int i11 = i10;
                while (i11 < list.size() && !((a) list.get(i11)).f45859k.isEmpty() && ((Long) ((a) list.get(i11)).f45859k.get(0)).longValue() == longValue) {
                    if (i11 > i10) {
                        spannableStringBuilder.append('\n');
                    }
                ...
                if (spannableStringBuilder.length() > 0) {
                    aj0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), false);
                }
                ...
                if (!(pageBlock instanceof TL_iv.pageBlockBlockquote) && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    boolean z10 = true;
                    if (z4) {
                        r10 = y5.r(pageBlock.text, pageBlock, false);
                    } else {
                        r10 = y5.r(pageBlock.text, pageBlock, true);
                    }
                    ...
                    if (spannableStringBuilder2.length() > 0) {
                        aj0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), z10);
                    }
