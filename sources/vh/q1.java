...
public final class q1 implements ky {
    ...
    public final void t(ArrayList arrayList) {
        this.f46162a.presentFragment(new StickersActivity(5, arrayList));
    }

    @Override
    public final void w() {
        this.f46162a.presentFragment(new StickersActivity(0, null));
    }
