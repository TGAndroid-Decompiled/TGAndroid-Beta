...
public final class v3 extends FrameLayout {
    ...
    public int V;
    public boolean W;
    public final k f46227a;
    public final f6 f46228b;
    public final View f46229c;
    public final View d;
    public final FrameLayout e;
    public final ImageView f46230f;
    public final LinearLayout h;
    public final ImageView f46231n;
    public final ImageView f46232r;
    public final FrameLayout f46233s;
    public final FrameLayout v;
    public final LinearLayout f46234w;
    public final qg f46235x;
    public final LinearLayout f46236y;
            ...
            public final void onClick(View view3) {
                switch (r2) {
                    case 0:
                        ...
                        return;
                    case 1:
                        kVar.f45961a.f46059r.Z3(view3);
                        return;
                    case 2:
                        kVar.f45961a.f46059r.a4();
                        return;
                    case 3:
                        kVar.f45961a.f46059r.X3();
                        return;
                    case 4:
                        kVar.f45961a.f46059r.b4();
                        return;
                    case 5:
                        p pVar2 = kVar.f45961a;
                        i3 h22 = pVar2.f46059r.h2();
                        if (h22 != null) {
                            TL_iv.RichMessage a2 = h22.a();
                            if (!a2.blocks.isEmpty()) {
                                org.telegram.ui.Components.f0 f0Var = new org.telegram.ui.Components.f0(pVar2.getContext(), pVar2.f24277a);
                                f0Var.n0(a2);
                        ...
                        return;
                    case 6:
                        kVar.f45961a.H(0, true, 0, false, 0L);
                        return;
                    case 7:
                        c2 c2Var = kVar.f45961a.f46059r.G3;
                        if (c2Var != null) {
                            c2Var.k();
                            return;
                        }
                        return;
                    case 8:
                        c2 c2Var2 = kVar.f45961a.f46059r.G3;
                        if (c2Var2 != null) {
                            c2Var2.i();
                            return;
                        }
                    ...
                    case 9:
                        k kVar2 = kVar;
                        p pVar3 = kVar2.f45961a;
                        Context context2 = pVar3.getContext();
                        new v(pVar3.f46058n, context2, new org.telegram.ui.web.y0(kVar2, 24), pVar3.f24277a).show();
                        return;
                    case 10:
                        p.K(kVar.f45961a);
                        return;
                    default:
                        p pVar4 = kVar.f45961a;
                        pVar4.f46059r.Y3 = null;
                        p.O(pVar4, 90, 0);
                        return;
                }
            }
    ...
    public final void a(int i10, int i11, boolean z4) {
        int i12;
        LinearLayout linearLayout = this.f46236y;
        u1 u1Var = new u1(linearLayout.getContext(), i10, this.f46228b);
        u1Var.c(j6.f19906d6);
        if (z4) {
            u1Var.d();
            this.S.add(u1Var);
    ...
    public final void b(int i10, int i11, boolean z4) {
        int i12;
        u1 u1Var = new u1(getContext(), i10, this.f46228b);
        u1Var.c(j6.Yk);
        if (z4) {
            u1Var.d();
            this.S.add(u1Var);
    ...
    public final void e(boolean z4, boolean z10) {
        ...
        if (this.W != z4 || !z10) {
            ...
            jj0Var.setColorFilter(new PorterDuffColorFilter(j6.v0(i10, this.f46228b), PorterDuff.Mode.SRC_IN));
    ...
    public final void f(int i10, boolean z4) {
        ...
        int i13 = 0;
        hb1 hb1Var = this.D;
        LinearLayout linearLayout = this.f46234w;
        float f24 = 0.0f;
        float f25 = 0.8f;
        if (z4) {
            ...
            duration.setInterpolator(nrVar).withEndAction(new Runnable(this) {
                ...
                public final void run() {
                    switch (r2) {
                        case 0:
                            v3 v3Var = this.f46184b;
                            if (v3Var.U != 0) {
                                v3Var.f46234w.setVisibility(8);
                                return;
                            }
                            return;
                        case 1:
                            v3 v3Var2 = this.f46184b;
                            if (v3Var2.U != 1) {
            ...
            ViewPropertyAnimator animate2 = hb1Var.animate();
            if (i10 == 1) {
                f20 = 1.0f;
            } else {
                f20 = 0.0f;
            ...
            scaleY2.translationY(dp4).setDuration(420L).setInterpolator(nrVar).withEndAction(new Runnable(this) {
                public final v3 f46184b;
            ...
            scaleX3.scaleY(f25).setDuration(420L).setInterpolator(nrVar).withEndAction(new Runnable(this) {
                public final v3 f46184b;
        ...
        hb1Var.setScaleX(f14);
        if (i10 == 1) {
            f15 = 1.0f;
        } else {
            f15 = 0.8f;
        }
        hb1Var.setScaleY(f15);
        if (i10 == 1) {
            dp2 = 0.0f;
        } else {
            dp2 = AndroidUtilities.dp(30.0f);
        }
        hb1Var.setTranslationY(dp2);
        if (i10 != 2) {
            i13 = 8;
        }
    ...
    public void setBackVisible(boolean z4) {
        ...
        this.f46230f.setVisibility(i10);
    }
    ...
    public void setTopButtonsOffset(int i10) {
        ...
        ImageView imageView = this.f46230f;
    ...
    public void setTopGradientVisible(boolean z4) {
        ...
        this.f46229c.setVisibility(i10);
    }
    ...
    public void setTopPanelVisible(boolean z4) {
        ...
        this.f46229c.setVisibility(i11);
    }
}
