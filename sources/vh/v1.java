...
public final class v1 extends Drawable {
    public final Paint f46294a;
    public final org.telegram.ui.Components.z5 f46295b;
    ...
    public v1(int i10) {
        ...
        this.f46294a = paint;
        this.f46295b = new org.telegram.ui.Components.z5(new ga(this, 29), 420L, mr.h, 0);
        this.d = 255;
        paint.setColor(i10);
    }
    ...
    public final void draw(Canvas canvas) {
        float e = this.f46295b.e(this.f46296c);
        if (e <= 0.0f) {
            return;
        }
        Paint paint = this.f46294a;
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f46294a.setColorFilter(colorFilter);
    }
}
