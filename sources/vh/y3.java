...
public abstract class y3 {
    public static void A(java.util.ArrayList r31, java.util.ArrayList r32, java.util.Map r33) {
        throw new UnsupportedOperationException("Method not decompiled: vh.y3.A(java.util.ArrayList, java.util.ArrayList, java.util.Map):void");
    }
    ...
    public static a B(x3 x3Var, boolean z4) {
        ...
        ArrayList f32 = s3.f3(pageblockcollage);
        ...
        while (i10 < size) {
            ...
            x3 x3Var2 = (x3) obj;
            if (!x3Var2.f46361b) {
                if ("figcaption".equals(x3Var2.f46360a)) {
                    charSequence = w(x3Var2);
                } else {
                    boolean equals = "video".equals(x3Var2.f46360a);
                    if (equals || "img".equals(x3Var2.f46360a)) {
    ...
    public static void D(x3 x3Var, ArrayList arrayList, int i10, boolean z4) {
        ...
        while (i15 < size) {
            ...
            i15++;
            x3 x3Var2 = (x3) obj;
            if (!x3Var2.f46361b && "li".equals(x3Var2.f46360a)) {
                ...
                while (i16 < size2) {
                    int i17 = i16 + 1;
                    x3 x3Var3 = (x3) arrayList5.get(i16);
                    if (!x3Var3.f46361b && ("ul".equals(x3Var3.f46360a) || "ol".equals(x3Var3.f46360a))) {
                        arrayList4.add(x3Var3);
                    } else if (x3Var3.f46361b) {
                        spannableStringBuilder.append((CharSequence) q(x3Var3.f46362c));
                    } else {
                ...
                if (!x3Var2.b("data-checkbox") && ((a2 = x3Var2.a("class")) == null || !a2.toLowerCase().contains("checkbox"))) {
                    z10 = false;
                } else {
                    z10 = true;
                }
                aVar.e = z10;
                aVar.f45855f = x3Var2.b("data-checked");
                arrayList.add(aVar);
                ...
                while (i18 < size3) {
                    ...
                    i18++;
                    x3 x3Var4 = (x3) obj2;
                    D(x3Var4, arrayList, i13, "ol".equals(x3Var4.f46360a));
                }
                i14++;
            }
        }
    ...
    public static void F(StringBuilder sb, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, c2.v vVar, boolean z4, int i15, Map map) {
        ...
        c2.v vVar2 = vVar;
        int i18 = i15;
        ArrayList arrayList = vVar2.f2038a;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
            ...
            if (!aVar.f45857i) {
                if (aVar.f45859k.size() > i18) {
                    vVar2.c(sb2);
                    Long l10 = (Long) ((a) list3.get(iArr[0])).f45859k.get(i18);
                    ...
                    while (true) {
                        ...
                        if (aVar2.f45859k.size() <= i18 || ((Long) aVar2.f45859k.get(i18)).longValue() != longValue) {
                            break;
                        }
                        i20 = i21;
                    }
                    ...
                    if (s3.w3(aVar)) {
                        ...
                        sb2.append(((TL_iv.pageBlockDetails) aVar3.f45853b).open ? "<details open>" : "<details>");
                        sb2.append("<summary>");
                        ...
                        vVar4.c(sb2);
                        int i22 = iArr[0];
                        if (i22 <= i16 && i22 < list2.size() && ((a) list2.get(iArr[0])).f45857i) {
                            iArr[0] = iArr[0] + 1;
                        }
                        sb2.append("</details>");
                    } else {
                        i16 = i10;
                        list2 = list3;
                        if (aVar.f45854c > 0 && l(aVar.f45853b) != null) {
                            int i23 = aVar.f45854c;
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) kf.k0.i(1, arrayList)).booleanValue() != z10) {
                                vVar2.b(sb2);
                            ...
                            if (pageBlock instanceof TL_iv.pageBlockDivider) {
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockPhoto) {
                                    G(sb2, "img", ((TL_iv.pageBlockPhoto) pageBlock).photo_id, aVar.f45856g, pageBlock);
                                    sb2 = sb;
                                } else if (pageBlock instanceof TL_iv.pageBlockVideo) {
                                    sb2 = sb;
                                    G(sb2, "video", ((TL_iv.pageBlockVideo) pageBlock).video_id, aVar.f45856g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockAudio) {
                                    sb2 = sb;
                                    G(sb2, "audio", ((TL_iv.pageBlockAudio) pageBlock).audio_id, aVar.f45856g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockDocument) {
                                    sb2 = sb;
                                    G(sb2, "document", ((TL_iv.pageBlockDocument) pageBlock).document_id, aVar.f45856g, pageBlock);
                                } else {
                                    sb2 = sb;
                                    ...
                                    if (s3.A3(pageBlock)) {
                                        ...
                                        if (pageblockmap.f19380w != 0) {
                                            sb2.append(" w=\"");
                                            sb2.append(pageblockmap.f19380w);
                                            sb2.append('\"');
                                        }
                                        if (pageblockmap.h != 0) {
                                            sb2.append(" h=\"");
    ...
    public static void H(StringBuilder sb, TL_iv.pageBlockTable pageblocktable) {
        ...
        if (richText != null) {
            spannableStringBuilder = y5.r(richText, null, true);
        } else {
    ...
    public static CharSequence K(a aVar, int i10, int i11, int i12, int i13, int i14) {
        ...
        int i16;
        if (s3.w3(aVar)) {
            A = y5.r(((TL_iv.pageBlockDetails) aVar.f45853b).title, null, true);
        } else {
            A = w5.A(aVar.f45853b);
        }
        if (A == null) {
    ...
    public static void e(SpannableStringBuilder spannableStringBuilder, x3 x3Var, int i10, String str, long j10) {
        ...
        while (i12 < size) {
            ...
            if (x3Var2.f46361b) {
                ...
                str2 = str;
                j11 = j10;
                j(spannableStringBuilder2, q(x3Var2.f46362c), i11, str2, j11);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                i11 = i10;
                str2 = str;
    ...
    public static void f(SpannableStringBuilder spannableStringBuilder, x3 x3Var) {
        ...
        while (i10 < size) {
            ...
            if (x3Var2.f46361b) {
                spannableStringBuilder2 = spannableStringBuilder;
                j(spannableStringBuilder2, q(x3Var2.f46362c), 0, null, 0L);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                if (!"cite".equals(x3Var2.f46360a)) {
    ...
    public static void g(java.lang.StringBuilder r22, java.lang.CharSequence r23) {
        throw new UnsupportedOperationException("Method not decompiled: vh.y3.g(java.lang.StringBuilder, java.lang.CharSequence):void");
    }
    ...
    public static void h(SpannableStringBuilder spannableStringBuilder, x3 x3Var, int i10, String str, long j10) {
        ...
        if ("button".equals(x3Var.f46360a) && (v = v(x3Var)) != null) {
        ...
        if (x3Var.e.isEmpty() && !x3Var.f46361b) {
            return;
        }
    ...
    public static void i(StringBuilder sb, String str, long j10, t tVar, TL_iv.PageBlock pageBlock) {
        ...
        if (tVar != null) {
            if (tVar.f46253j > 0) {
                sb.append(" width=\"");
                sb.append(tVar.f46253j);
                sb.append('\"');
            }
            if (tVar.f46254k > 0) {
                sb.append(" height=\"");
                sb.append(tVar.f46254k);
                sb.append('\"');
            }
        }
    ...
    public static vh.a m(vh.x3 r8) {
        throw new UnsupportedOperationException("Method not decompiled: vh.y3.m(vh.x3):vh.a");
    }
                ...
                switch (c3) {
                    case 0:
                        ...
                        while (i12 < size2) {
                            ...
                            x3 x3Var3 = (x3) obj2;
                            if (!x3Var3.f46361b) {
                                if ("td".equals(x3Var3.f46360a) || "th".equals(x3Var3.f46360a)) {
                                    ...
                                    if (!"th".equals(x3Var3.f46360a) && !x3Var3.b("header")) {
                                        z4 = false;
                                    } else {
                                        z4 = true;
                                    }
                                    a6.l(pagetablecell, z4);
    ...
    public static java.util.ArrayList z(java.lang.String r16, java.util.HashMap r17) {
        throw new UnsupportedOperationException("Method not decompiled: vh.y3.z(java.lang.String, java.util.HashMap):java.util.ArrayList");
    }
}
