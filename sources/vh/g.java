...
public final class g extends Drawable {
    ...
    public final Paint[] f44683a;
    public final float[] f44684b;
    public final Stack f44685c;
    public int d;
    public final float[] e;
    public final int[] f44686f;
    public RectF f44687g;
    public final ArrayList h;
    public View f44688i;
    public long f44689j;
    public float f44690k;
    public float f44691l;
    public float f44692m;
    public float f44693n;
    public boolean f44694o;
    public boolean f44695p;
    public Runnable f44696q;
    public ValueAnimator f44697r;
    public int f44698s;
    public TimeInterpolator f44699t;
    public boolean f44700u;
    public PorterDuffColorFilter v;
    public int f44701w;
    public int f44702x;
    public boolean f44703y;
    public final RectF f44704z;
    ...
    public g() {
        float[] fArr = C;
        this.f44683a = new Paint[fArr.length];
        this.f44684b = new float[fArr.length];
        this.f44685c = new Stack();
        this.e = new float[14];
        this.f44686f = new int[fArr.length];
        this.h = new ArrayList();
        this.f44693n = -1.0f;
        this.f44698s = 255;
        this.f44699t = new gd(1);
        this.f44704z = new RectF();
        for (int i10 = 0; i10 < fArr.length; i10++) {
            this.f44683a[i10] = new Paint();
            if (i10 == 0) {
                this.f44683a[i10].setStrokeWidth(AndroidUtilities.dp(1.4f));
                this.f44683a[i10].setStyle(Paint.Style.STROKE);
                this.f44683a[i10].setStrokeCap(Paint.Cap.ROUND);
            } else {
                this.f44683a[i10].setStrokeWidth(AndroidUtilities.dp(1.2f));
                this.f44683a[i10].setStyle(Paint.Style.STROKE);
                this.f44683a[i10].setStrokeCap(Paint.Cap.ROUND);
            }
            this.f44684b[i10] = this.f44683a[i10].getStrokeWidth() * 0.5f;
        }
    ...
    public static void g(View view, boolean z10, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z11) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!list.isEmpty()) {
                ...
                int i16 = 0;
                if (!list.isEmpty() && ((g) list.get(0)).f44693n != -1.0f) {
                    canvas.save();
                ...
                if (((g) list.get(i16)).f44693n != -1.0f) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                while (it2.hasNext()) {
                    g gVar = (g) it2.next();
                    gVar.f44700u = z10;
                    if (gVar.f44688i != view) {
                        gVar.f44688i = view;
                    }
                    boolean z13 = gVar.f44695p;
                    gVar.f44695p = false;
                    if (z13) {
                        if (i12 == 1) {
                        ...
                        gVar.h(i0.a.d(Math.max(0.0f, gVar.f44693n), i10, textPaint.getColor()));
                    } else {
                        gVar.h(i10);
                    }
                    gVar.draw(canvas);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty()) {
            ...
            i iVar = i.f44708q;
            int i11 = iVar.f44716k;
            o0.a[] aVarArr = iVar.f44711c;
            if (aVarArr[0] == null) {
                aVarArr[0] = new o0.a(i11);
                iVar.f44713g = new Paint();
                iVar.f44714i = new ArrayList(100);
                float f7 = i11;
                ...
                iVar.f44713g.setShader((BitmapShader) aVarArr[0].f15483c);
                iVar.h = System.currentTimeMillis();
            } else {
                i10 = 128;
                if (iVar.f44721p && !LiteMode.isEnabled(128)) {
                    iVar.d = 0;
                    iVar.a(new Canvas((Bitmap) aVarArr[0].f15482b), new Rect(0, 0, i11, i11));
                    iVar.f44713g.setShader((BitmapShader) aVarArr[0].f15483c);
                    iVar.h = System.currentTimeMillis();
            ...
            if (LiteMode.isEnabled(i10)) {
                ...
                if (!iVar2.f44717l && !rect.isEmpty()) {
                    iVar2.f44717l = true;
                    Choreographer.getInstance().postFrameCallback(iVar2.f44719n);
                }
            }
        }
    }
    ...
    public final void e(Path path) {
        path.addCircle(this.f44690k, this.f44691l, q.a(this.f44693n, 0.0f, 1.0f) * this.f44692m, Path.Direction.CW);
    }
    ...
    public final void h(int i10) {
        if (this.f44701w != i10) {
            ...
            while (true) {
                float[] fArr = C;
                if (i11 < fArr.length) {
                    this.f44683a[i11].setColor(i0.a.k(i10, (int) (this.f44698s * fArr[i11])));
                    i11++;
                } else {
    ...
    public final void invalidateSelf() {
        ...
        View view = this.f44688i;
        if (view != null) {
            if (view.getParent() != null && this.f44700u) {
    ...
    public final void j(float f7, float f10, float f11, boolean z10) {
        ...
        this.f44693n = f12;
        this.f44694o = z10;
        ValueAnimator valueAnimator = this.f44697r;
        ...
        if (this.f44694o) {
            ...
            alpha = this.f44683a[C.length - 1].getAlpha();
        }
        float f14 = this.f44693n;
        if (!z10) {
            f13 = 1.0f;
        }
        ValueAnimator duration = ValueAnimator.ofFloat(f14, f13).setDuration(q.a(this.f44692m * 0.3f, 250.0f, 550.0f));
        this.f44697r = duration;
        duration.setInterpolator(this.f44699t);
        this.f44697r.addUpdateListener(new p2(this, alpha, 6));
        this.f44697r.addListener(new d0(this, 8));
        this.f44697r.start();
        invalidateSelf();
    }
    ...
    public final void setAlpha(int i10) {
        ...
        while (true) {
            float[] fArr = C;
            if (i11 < fArr.length) {
                this.f44683a[i11].setAlpha((int) (fArr[i11] * i10));
                i11++;
            } else {
                return;
            }
    ...
    public final void setBounds(int i10, int i11, int i12, int i13) {
        ...
        while (it.hasNext()) {
            c cVar = (c) it.next();
            if (!getBounds().contains((int) cVar.f44655a, (int) cVar.f44656b)) {
                it.remove();
            }
            Stack stack = this.f44685c;
