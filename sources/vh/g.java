...
public final class g extends Drawable {
    ...
    public final Paint[] f44722a;
    public final float[] f44723b;
    public final Stack f44724c;
    public int d;
    public final float[] e;
    public final int[] f44725f;
    public RectF f44726g;
    public final ArrayList h;
    public View f44727i;
    public long f44728j;
    public float f44729k;
    public float f44730l;
    public float f44731m;
    public float f44732n;
    public boolean f44733o;
    public boolean f44734p;
    public Runnable f44735q;
    public ValueAnimator f44736r;
    public int f44737s;
    public TimeInterpolator f44738t;
    public boolean f44739u;
    public PorterDuffColorFilter v;
    public int f44740w;
    public int f44741x;
    public boolean f44742y;
    public final RectF f44743z;
    ...
    public g() {
        float[] fArr = C;
        this.f44722a = new Paint[fArr.length];
        this.f44723b = new float[fArr.length];
        this.f44724c = new Stack();
        this.e = new float[14];
        this.f44725f = new int[fArr.length];
        this.h = new ArrayList();
        this.f44732n = -1.0f;
        this.f44737s = 255;
        this.f44738t = new gd(1);
        this.f44743z = new RectF();
        for (int i10 = 0; i10 < fArr.length; i10++) {
            this.f44722a[i10] = new Paint();
            if (i10 == 0) {
                this.f44722a[i10].setStrokeWidth(AndroidUtilities.dp(1.4f));
                this.f44722a[i10].setStyle(Paint.Style.STROKE);
                this.f44722a[i10].setStrokeCap(Paint.Cap.ROUND);
            } else {
                this.f44722a[i10].setStrokeWidth(AndroidUtilities.dp(1.2f));
                this.f44722a[i10].setStyle(Paint.Style.STROKE);
                this.f44722a[i10].setStrokeCap(Paint.Cap.ROUND);
            }
            this.f44723b[i10] = this.f44722a[i10].getStrokeWidth() * 0.5f;
        }
    ...
    public static void a(View view, Layout layout, int i10, int i11, Spanned spanned, Stack stack, List list, ArrayList arrayList) {
        ...
        int i13;
        if (layout != null) {
            Object[] objArr = (f11[]) spanned.getSpans(0, layout.getText().length(), f11.class);
    ...
    public static void g(View view, boolean z10, int i10, int i11, AtomicReference atomicReference, int i12, Layout layout, List list, Canvas canvas, boolean z11) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (!list.isEmpty()) {
                ...
                int i16 = 0;
                if (!list.isEmpty() && ((g) list.get(0)).f44732n != -1.0f) {
                    canvas.save();
                ...
                if (((g) list.get(i16)).f44732n != -1.0f) {
                    z12 = true;
                } else {
                    z12 = false;
                }
                ...
                while (it2.hasNext()) {
                    g gVar = (g) it2.next();
                    gVar.f44739u = z10;
                    if (gVar.f44727i != view) {
                        gVar.f44727i = view;
                    }
                    boolean z13 = gVar.f44734p;
                    gVar.f44734p = false;
                    if (z13) {
                        if (i12 == 1) {
                            textPaint = layout.getPaint();
                        } else {
                            textPaint = j6.f19307o2;
                        }
                        gVar.h(i0.a.d(Math.max(0.0f, gVar.f44732n), i10, textPaint.getColor()));
                    } else {
                        gVar.h(i10);
                    }
                    gVar.draw(canvas);
    ...
    public final void draw(Canvas canvas) {
        ...
        if (!bounds.isEmpty()) {
            ...
            i iVar = i.f44747q;
            int i11 = iVar.f44755k;
            m5.e[] eVarArr = iVar.f44750c;
            if (eVarArr[0] == null) {
                eVarArr[0] = new m5.e(i11);
                iVar.f44752g = new Paint();
                iVar.f44753i = new ArrayList(100);
                float f7 = i11;
                ...
                while (true) {
                    ...
                    for (int i15 = 10; i14 < i15; i15 = 10) {
                        ...
                        gVar.h(-1);
                        iVar.f44753i.add(gVar);
                        i14++;
                    }
                    i13++;
                }
                i10 = 128;
                iVar.a(new Canvas((Bitmap) eVarArr[0].f14968b), new Rect(0, 0, i11, i11));
                iVar.f44752g.setShader((BitmapShader) eVarArr[0].f14969c);
                iVar.h = System.currentTimeMillis();
            } else {
                i10 = 128;
                if (iVar.f44760p && !LiteMode.isEnabled(128)) {
                    iVar.d = 0;
                    iVar.a(new Canvas((Bitmap) eVarArr[0].f14968b), new Rect(0, 0, i11, i11));
                    iVar.f44752g.setShader((BitmapShader) eVarArr[0].f14969c);
                    iVar.h = System.currentTimeMillis();
            ...
            if (LiteMode.isEnabled(i10)) {
                ...
                if (!iVar2.f44756l && !rect.isEmpty()) {
                    iVar2.f44756l = true;
                    Choreographer.getInstance().postFrameCallback(iVar2.f44758n);
                }
            }
        }
    }
    ...
    public final void e(Path path) {
        path.addCircle(this.f44729k, this.f44730l, q.a(this.f44732n, 0.0f, 1.0f) * this.f44731m, Path.Direction.CW);
    }
    ...
    public final void h(int i10) {
        if (this.f44740w != i10) {
            ...
            while (true) {
                float[] fArr = C;
                if (i11 < fArr.length) {
                    this.f44722a[i11].setColor(i0.a.k(i10, (int) (this.f44737s * fArr[i11])));
                    i11++;
                } else {
    ...
    public final void i(float f7, float f10, float f11) {
        if (this.f44726g == null) {
            this.f44726g = new RectF();
        }
        RectF rectF = this.f44726g;
    ...
    public final void invalidateSelf() {
        ...
        View view = this.f44727i;
        if (view != null) {
            if (view.getParent() != null && this.f44739u) {
    ...
    public final void j(float f7, float f10, float f11, boolean z10) {
        ...
        this.f44732n = f12;
        this.f44733o = z10;
        ValueAnimator valueAnimator = this.f44736r;
        ...
        if (this.f44733o) {
            ...
            alpha = this.f44722a[C.length - 1].getAlpha();
        }
        float f14 = this.f44732n;
        if (!z10) {
            f13 = 1.0f;
        }
        ValueAnimator duration = ValueAnimator.ofFloat(f14, f13).setDuration(q.a(this.f44731m * 0.3f, 250.0f, 550.0f));
        this.f44736r = duration;
        duration.setInterpolator(this.f44738t);
        this.f44736r.addUpdateListener(new q2(this, alpha, 6));
        this.f44736r.addListener(new d0(this, 8));
        this.f44736r.start();
        invalidateSelf();
    }
    ...
    public final void setAlpha(int i10) {
        ...
        while (true) {
            float[] fArr = C;
            if (i11 < fArr.length) {
                this.f44722a[i11].setAlpha((int) (fArr[i11] * i10));
                i11++;
            } else {
                return;
            }
    ...
    public final void setBounds(int i10, int i11, int i12, int i13) {
        ...
        while (it.hasNext()) {
            c cVar = (c) it.next();
            if (!getBounds().contains((int) cVar.f44694a, (int) cVar.f44695b)) {
                it.remove();
            }
            Stack stack = this.f44724c;
