...
public final class f4 extends ReplacementSpan {
    public final TL_iv.textButton f45975a;
    public RichMessageLayout.RichButtonSpan f45976b;
    public View f45977c;
    public int d = UserConfig.selectedAccount;
    public f6 e;

    public f4(TL_iv.textButton textbutton) {
        this.f45975a = textbutton;
    }
    ...
    public final void a(int i10, View view, f6 f6Var) {
        View view2;
        RichMessageLayout.RichButtonSpan richButtonSpan = this.f45976b;
        if (richButtonSpan != null && (view2 = this.f45977c) != null) {
    ...
    public final RichMessageLayout.RichButtonSpan b() {
        if (this.f45976b == null) {
            RichMessageLayout.RichButtonSpan createEditorButtonSpan = RichMessageLayout.createEditorButtonSpan(this.d, AndroidUtilities.dp(240.0f), this.e, this.f45975a);
            this.f45976b = createEditorButtonSpan;
            View view = this.f45977c;
            if (view != null) {
