...
public final class x0 extends z implements org.telegram.ui.ActionBar.a6, k9, j0, DownloadController.FileDownloadProgressListener {
    ...
    public final int f46349n;
    public final f6 f46350r;
    public final Paint f46351s;
    public final Paint v;
    public final TextPaint f46352w;
    public final TextPaint f46353x;
    public final RadialProgress2 f46354y;

    public x0(Context context, int i10, f6 f6Var) {
        super(context);
        this.f46351s = new Paint(1);
        this.v = new Paint(1);
        this.f46352w = new TextPaint(1);
        this.f46353x = new TextPaint(1);
    ...
    @Override
    public final void e() {
        this.f46351s.setColor(j6.v0(j6.f20191uf, this.f46350r));
        i0 i0Var = this.C;
        if (i0Var != null) {
            i0Var.a();
        }
    ...
    public final void f(int i10) {
        ...
        int i13 = this.G;
        int i14 = this.F;
        this.f46354y.q(i13, i11, i13 + i14, i14 + i11);
        requestLayout();
    }
    ...
    public final void h(TLRPC.Document document) {
        ...
        if (aVar != null && (tVar = aVar.f45856g) != null) {
            str = tVar.e;
        } else {
            str = null;
        }
        ...
        if (z4) {
            ...
            if (n3Var == null) {
                ...
                messageObject = n3Var.f46111a.f46211f3;
            }
            imageReceiver.setImageCoords(this.H, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(86.0f), AndroidUtilities.dp(86.0f));
    ...
    public final boolean j() {
        t tVar;
        a aVar = this.f46414a;
        if (aVar != null && (tVar = aVar.f45856g) != null && tVar.a()) {
            return true;
        }
        return false;
    }
    ...
    public final void k() {
        ...
        TextPaint textPaint = this.f46352w;
        textPaint.setTextSize(AndroidUtilities.dp(15.0f));
        textPaint.setTypeface(AndroidUtilities.bold());
        TextPaint textPaint2 = this.f46353x;
        textPaint2.setTextSize(AndroidUtilities.dp(13.0f));
        String documentFileName = FileLoader.getDocumentFileName(i13);
        if (TextUtils.isEmpty(documentFileName) && (tVar = this.f46414a.f45856g) != null && !TextUtils.isEmpty(tVar.e)) {
            documentFileName = new File(this.f46414a.f45856g.e).getName();
        }
        ...
        long j10 = i13.size;
        if (j10 <= 0) {
            t tVar2 = this.f46414a.f45856g;
            if (tVar2 != null && !TextUtils.isEmpty(tVar2.e)) {
                j10 = new File(this.f46414a.f45856g.e).length();
            } else {
                j10 = 0;
            }
        }
    ...
    public final void l(boolean r10) {
        throw new UnsupportedOperationException("Method not decompiled: vh.x0.l(boolean):void");
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(this.f46349n).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i() != null) {
            ...
            int dp = AndroidUtilities.dp(f10) + i10;
            this.f46352w.setColor(j6.v0(j6.Dd, f6Var));
            ...
            this.f46353x.setColor(j6.v0(j6.f20066nd, f6Var));
            ...
            if (this.P != null && (getParent() instanceof RecyclerView) && (textSelectionHelper = this.P.f46111a.getTextSelectionHelper()) != null && textSelectionHelper.y()) {
                ((RecyclerView) getParent()).getClass();
                int R = RecyclerView.R(this);
                if (R > textSelectionHelper.f21331u0 && R <= textSelectionHelper.f21334x0) {
                    if (this.J) {
                        i11 = 0;
                    } else {
                        i11 = this.f46416c;
                    ...
                    canvas.drawRoundRect(dp4, dp5, dp6, AndroidUtilities.dp(f11), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f46351s);
                }
            }
        }
    }
    ...
    public final void onProgressDownload(String str, long j10, long j11) {
        ...
        this.f46354y.o(min, true);
    }

    @Override
    public final void onSuccessDownload(String str) {
        this.f46354y.o(1.0f, true);
        l(true);
    }

    @Override
    public final boolean onTouchEvent(android.view.MotionEvent r8) {
        throw new UnsupportedOperationException("Method not decompiled: vh.x0.onTouchEvent(android.view.MotionEvent):boolean");
    }
