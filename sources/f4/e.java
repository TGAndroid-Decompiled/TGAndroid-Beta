...
public final class e implements m {
    public static final Pattern f8878b = Pattern.compile("^([0-9][0-9]+):([0-9][0-9]):([0-9][0-9])(?:(\\.[0-9]+)|:([0-9][0-9])(?:\\.([0-9]+))?)?$");
    public static final Pattern f8879c = Pattern.compile("^([0-9]+(?:\\.[0-9]+)?)(h|m|s|ms|f|t)$");
    public static final Pattern d = Pattern.compile("^(([0-9]*.)?[0-9]+)(px|em|%)$");
    public static final Pattern e = Pattern.compile("^([-+]?\\d+\\.?\\d*?)%$");
    public static final Pattern f8880f = Pattern.compile("^([-+]?\\d+\\.?\\d*?)% ([-+]?\\d+\\.?\\d*?)%$");
    public static final Pattern h = Pattern.compile("^([-+]?\\d+\\.?\\d*?)px ([-+]?\\d+\\.?\\d*?)px$");
    public static final Pattern f8881n = Pattern.compile("^(\\d+) (\\d+)$");
    public static final d f8882r = new d(30.0f, 1, 1);
    public final XmlPullParserFactory f8883a;

    public e() {
        try {
            XmlPullParserFactory newInstance = XmlPullParserFactory.newInstance();
            this.f8883a = newInstance;
    ...
    public static int c(XmlPullParser xmlPullParser) {
        ...
        Matcher matcher = f8881n.matcher(attributeValue);
        if (!matcher.matches()) {
    ...
    public static void d(String str, g gVar) {
        ...
        if (matcher.matches()) {
            ...
            group2.getClass();
            gVar.f8898k = Float.parseFloat(group2);
            return;
        }
    ...
    public final z3.d r(int i10, int i11, byte[] bArr) {
        try {
            XmlPullParser newPullParser = this.f8883a.newPullParser();
                                ...
                                try {
                                    ...
                                    if (cVar2 != null) {
                                        if (cVar2.f8874m == null) {
                                            cVar2.f8874m = new ArrayList();
                                        }
                                        cVar2.f8874m.add(g10);
                                    }
                                } catch (z3.f e7) {
