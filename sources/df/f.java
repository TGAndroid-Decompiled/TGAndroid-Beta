...
public final class f extends Drawable {
    ...
    public final void draw(Canvas canvas) {
        ...
        switch (this.f4346a) {
            case 0:
                Bitmap bitmap = (Bitmap) this.f4347b;
                if (!bitmap.isRecycled()) {
                    canvas.drawBitmap(bitmap, (Rect) null, (Rect) this.f4348c, (Paint) null);
                    return;
                }
                return;
            case 1:
                ImageReceiver imageReceiver = (ImageReceiver) this.f4347b;
                imageReceiver.draw(canvas);
                Drawable drawable = (Drawable) this.f4348c;
                ...
                return;
            case 2:
                xc xcVar = (xc) this.f4348c;
                if (xcVar.f30586c > 1) {
                    xcVar.c(canvas, xcVar.f30595o);
                    return;
                } else {
                    xcVar.c(canvas, (Paint) this.f4347b);
                    return;
                }
            case 3:
                Paint paint = (Paint) this.f4347b;
                ChatActivityEnterView chatActivityEnterView = (ChatActivityEnterView) this.f4348c;
                if (chatActivityEnterView.R0 != null) {
                    paint.setAlpha(Math.round(chatActivityEnterView.f22841y3 * 102.0f));
                    float width = chatActivityEnterView.getWidth();
                    float y10 = (chatActivityEnterView.R0.getY() - chatActivityEnterView.getHeight()) + j6.f19968i3.getIntrinsicHeight();
                ...
                return;
            case 4:
                Paint paint2 = (Paint) this.f4348c;
                canvas.drawRect(getBounds(), (Paint) this.f4347b);
                ...
                return;
            default:
                org.telegram.ui.Components.j6 j6Var = (org.telegram.ui.Components.j6) this.f4347b;
                Paint paint3 = (Paint) this.f4348c;
                if (paint3 != null) {
                ...
                j6Var.f25846a.setStrokeWidth(AndroidUtilities.dpf2(0.3f));
    ...
    public int getAlpha() {
        switch (this.f4346a) {
            case 1:
                return (int) (((ImageReceiver) this.f4347b).getAlpha() * 255.0f);
            default:
    ...
    public void l(float f10, boolean z4) {
        org.telegram.ui.Components.j6 j6Var = (org.telegram.ui.Components.j6) this.f4347b;
        String str = a(f10) + "X";
        if (z4 && TextUtils.equals(j6Var.f25850g, str)) {
            return;
        }
        j6Var.b();
        j6Var.q(str, z4, true);
    ...
    public void onBoundsChange(Rect rect) {
        switch (this.f4346a) {
            case 1:
                ((ImageReceiver) this.f4347b).setImageCoords(AndroidUtilities.dp(2.0f) + rect.left, AndroidUtilities.dp(2.0f) + rect.top, org.telegram.ui.b.t(2.0f, rect.left, rect.right - AndroidUtilities.dp(2.0f)), org.telegram.ui.b.t(2.0f, rect.top, rect.bottom - AndroidUtilities.dp(2.0f)));
                return;
            default:
    ...
    public final void setAlpha(int i10) {
        switch (this.f4346a) {
            case 0:
                return;
            case 1:
                ((ImageReceiver) this.f4347b).setAlpha(i10 / 255.0f);
                return;
            case 2:
            case 3:
            case 4:
                return;
            default:
                ((org.telegram.ui.Components.j6) this.f4347b).f25864w = i10;
                Paint paint = (Paint) this.f4348c;
                if (paint != null) {
                    paint.setAlpha(i10);
                    return;
                }
        ...
        switch (this.f4346a) {
            case 0:
                ...
                if (bitmap != null && !bitmap.isRecycled()) {
                    ...
                    ((Rect) this.f4348c).set(i16, i17, round + i16, round2 + i17);
                    return;
                }
                return;
            default:
    ...
    public f(ImageReceiver imageReceiver, Drawable drawable) {
        this.f4346a = 1;
        this.f4347b = imageReceiver;
        this.f4348c = drawable;
    }

    public f(ChatActivityEnterView chatActivityEnterView) {
        this.f4346a = 3;
        this.f4348c = chatActivityEnterView;
        Paint paint = new Paint();
        this.f4347b = paint;
        paint.setColor(0);
    }
