...
public final class g {
    public final Picture f4349a;
    public final RenderNode f4350b;
    ...
    public final void a(Canvas canvas, float f10) {
        ...
        Canvas canvas2;
        if (Build.VERSION.SDK_INT >= 29) {
            RenderNode renderNode = this.f4350b;
            if (renderNode != null) {
                renderNode.setAlpha(f10);
                canvas.drawRenderNode(this.f4350b);
                return;
            }
            return;
        }
        Picture picture = this.f4349a;
    ...
    public final void b() {
        if (Build.VERSION.SDK_INT >= 29) {
            this.f4350b.discardDisplayList();
        }
    }
}
