...
public final class w extends b6.g {
    public static final b f45204k0 = new b("CastClientImpl", null);
    public static final Object f45205l0 = new Object();
    ...
    public String Y;
    public boolean Z;
    public boolean f45206a0;
    public boolean f45207b0;
    public double f45208c0;
    public q5.x f45209d0;
    public int f45210e0;
    public int f45211f0;
    public String f45212g0;
    public String f45213h0;
    public Bundle f45214i0;
    public final HashMap f45215j0;
    ...
    public static void G(w wVar, long j10, int i10) {
        ...
        synchronized (wVar.f45215j0) {
            fVar = (com.google.android.gms.common.api.internal.f) wVar.f45215j0.remove(Long.valueOf(j10));
        }
        if (fVar != null) {
    ...
    public final void B(int i10, IBinder iBinder, Bundle bundle, int i11) {
        f45204k0.b("in onPostInitHandler; statusCode=%d", Integer.valueOf(i10));
        if (i10 == 0 || i10 == 2300) {
            this.f45206a0 = true;
            this.f45207b0 = true;
        }
    ...
    public final void H() {
        f45204k0.b("removing all MessageReceivedCallbacks", new Object[0]);
        synchronized (this.U) {
            this.U.clear();
        }
    }
    ...
    public final void disconnect() {
        ...
        this.X = null;
        if (vVar != null) {
            w wVar2 = (w) vVar.f45202b.getAndSet(null);
            if (wVar2 != null) {
                wVar2.f45210e0 = -1;
                wVar2.f45211f0 = -1;
                wVar2.R = null;
    ...
    public final Bundle t() {
        ...
        f45204k0.b("getRemoteService(): mLastApplicationId=%s, mLastSessionId=%s", this.f45212g0, this.f45213h0);
        CastDevice castDevice = this.S;
        castDevice.getClass();
        ...
        String str = this.f45212g0;
        if (str != null) {
            bundle.putString("last_application_id", str);
            String str2 = this.f45213h0;
            if (str2 != null) {
