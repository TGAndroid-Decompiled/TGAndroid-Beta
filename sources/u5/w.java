...
public final class w extends b6.g {
    public static final b f48397k0 = new b("CastClientImpl", null);
    public static final Object f48398l0 = new Object();
    ...
    public String Y;
    public boolean Z;
    public boolean f48399a0;
    public boolean f48400b0;
    public double f48401c0;
    public q5.x f48402d0;
    public int f48403e0;
    public int f48404f0;
    public String f48405g0;
    public String f48406h0;
    public Bundle f48407i0;
    public final HashMap f48408j0;
    ...
    public static void G(w wVar, long j10, int i10) {
        ...
        synchronized (wVar.f48408j0) {
            fVar = (com.google.android.gms.common.api.internal.f) wVar.f48408j0.remove(Long.valueOf(j10));
        }
        if (fVar != null) {
    ...
    public final void B(int i10, IBinder iBinder, Bundle bundle, int i11) {
        f48397k0.b("in onPostInitHandler; statusCode=%d", Integer.valueOf(i10));
        if (i10 == 0 || i10 == 2300) {
            this.f48399a0 = true;
            this.f48400b0 = true;
        }
    ...
    public final void H() {
        f48397k0.b("removing all MessageReceivedCallbacks", new Object[0]);
        synchronized (this.U) {
            this.U.clear();
        }
    }
    ...
    public final void disconnect() {
        ...
        this.X = null;
        if (vVar != null) {
            w wVar2 = (w) vVar.f48395b.getAndSet(null);
            if (wVar2 != null) {
                wVar2.f48403e0 = -1;
                wVar2.f48404f0 = -1;
                wVar2.R = null;
    ...
    public final Bundle t() {
        ...
        f48397k0.b("getRemoteService(): mLastApplicationId=%s, mLastSessionId=%s", this.f48405g0, this.f48406h0);
        CastDevice castDevice = this.S;
        castDevice.getClass();
        ...
        String str = this.f48405g0;
        if (str != null) {
            bundle.putString("last_application_id", str);
            String str2 = this.f48406h0;
            if (str2 != null) {
