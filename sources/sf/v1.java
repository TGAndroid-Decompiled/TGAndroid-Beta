...
public final class v1 {
    public static volatile v1[] f47980e = new v1[4];
    public static final Object[] f47981f = new Object[4];
    ...
    public static v1 b(int i10) {
        v1 v1Var;
        v1 v1Var2 = f47980e[i10];
        if (v1Var2 == null) {
            synchronized (f47981f[i10]) {
                try {
                    v1Var = f47980e[i10];
                    if (v1Var == null) {
                        v1[] v1VarArr = f47980e;
    ...
    public final TLRPC.TL_timezone a(String str) {
        ...
        while (true) {
            ...
            if (TextUtils.equals(tL_timezone.f22530id, str)) {
                return tL_timezone;
            }
            i10++;
        }
    ...
    public final java.lang.String c() {
        throw new UnsupportedOperationException("Method not decompiled: sf.v1.c():java.lang.String");
    }
