...
public final class q {
    public TL_account.TL_businessChatLink f47927a;

    public final boolean equals(Object obj) {
        TL_account.TL_businessChatLink tL_businessChatLink = this.f47927a;
        if (this == obj) {
            return true;
        }
        if (obj != null && q.class == obj.getClass()) {
            TL_account.TL_businessChatLink tL_businessChatLink2 = ((q) obj).f47927a;
