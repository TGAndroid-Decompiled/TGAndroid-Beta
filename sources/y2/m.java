...
public final class m implements n {
    ...
    public static final k4.d f46596f = new k4.d(3, -9223372036854775807L, false);
    public final z2.a f46597a;
    public i f46598b;
    public IOException f46599c;
    ...
    @Override
    public final void a() {
        IOException iOException = this.f46599c;
        if (iOException == null) {
            i iVar = this.f46598b;
            if (iVar != null) {
                int i10 = iVar.f46589a;
                IOException iOException2 = iVar.e;
                if (iOException2 != null && iVar.f46592f > i10) {
                    throw iOException2;
                }
                return;
            }
    ...
    public final void e(k kVar) {
        ...
        z2.a aVar = this.f46597a;
        if (kVar != null) {
            aVar.execute(new p8.b(kVar, 10));
        }
        aVar.f48375b.accept(aVar.f48374a);
    }
