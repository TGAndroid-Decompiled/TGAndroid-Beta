...
public final class m implements n {
    ...
    public static final k4.d f46317f = new k4.d(3, -9223372036854775807L, false);
    public final z2.a f46318a;
    public i f46319b;
    public IOException f46320c;
    ...
    @Override
    public final void a() {
        IOException iOException = this.f46320c;
        if (iOException == null) {
            i iVar = this.f46319b;
            if (iVar != null) {
                int i10 = iVar.f46310a;
                IOException iOException2 = iVar.e;
                if (iOException2 != null && iVar.f46313f > i10) {
                    throw iOException2;
                }
                return;
            }
    ...
    public final void e(k kVar) {
        ...
        z2.a aVar = this.f46318a;
        if (kVar != null) {
            aVar.execute(new b0(kVar, 8));
        }
        aVar.f48099b.accept(aVar.f48098a);
    }
