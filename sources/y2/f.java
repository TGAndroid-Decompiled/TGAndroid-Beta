...
public final class f implements c, c0 {
    public static final a1 f46549p = i0.y(4300000L, 3200000L, 2400000L, 1700000L, 860000L);
    public static final a1 f46550q = i0.y(1500000L, 980000L, 750000L, 520000L, 290000L);
    public static final a1 f46551r = i0.y(2000000L, 1300000L, 1000000L, 860000L, 610000L);
    public static final a1 f46552s = i0.y(2500000L, 1700000L, 1200000L, 970000L, 680000L);
    public static final a1 f46553t = i0.y(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
    public static final a1 f46554u = i0.y(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);
    public static f v;
    public final Context f46555a;
    public final k0 f46556b;
    public final n2.e f46557c;
    public final x d;
    public final boolean e;
    public final q f46558f;
    public int f46559g;
    public long h;
    public long f46560i;
    public long f46561j;
    public long f46562k;
    public volatile long f46563l;
    public long f46564m;
    public int f46565n;
    ...
    public f(Context context, HashMap hashMap) {
        ...
        this.f46555a = applicationContext;
        this.f46556b = k0.a(hashMap);
        this.f46557c = new n2.e(26);
        this.f46558f = new q();
        this.d = xVar;
        this.e = true;
        if (context != null) {
                            ...
                            if (i10 != 7) {
                                if (i10 != 9) {
                                    if (i10 != 10) {
                                        ...
                                        longValue = ((Long) f46553t.get(iArr[4])).longValue();
                                    }
                                } else {
                                    longValue = ((Long) f46554u.get(iArr[5])).longValue();
                                }
                            }
                        } else {
                            longValue = ((Long) f46552s.get(iArr[3])).longValue();
                        }
                    } else {
                        longValue = ((Long) f46551r.get(iArr[2])).longValue();
                    }
                } else {
                    longValue = ((Long) f46550q.get(iArr[1])).longValue();
                }
                l4 = Long.valueOf(longValue);
            }
            longValue = ((Long) f46549p.get(iArr[0])).longValue();
            l4 = Long.valueOf(longValue);
        }
        if (l4 == null) {
            l4 = 1000000L;
    ...
    public final void c(int i10, long j3, long j10) {
        ...
        long j11;
        long j12;
        if (i10 != 0 || j3 != 0 || j10 != this.f46564m) {
            this.f46564m = j10;
            Iterator it = ((CopyOnWriteArrayList) this.f46557c.f15116b).iterator();
            while (it.hasNext()) {
                b bVar = (b) it.next();
                if (!bVar.f46543c) {
                    i11 = i10;
                    j11 = j3;
                    j12 = j10;
                    bVar.f46541a.post(new k2.i(bVar, i11, j11, j12, 1));
                } else {
                    i11 = i10;
                    j11 = j3;
                    j12 = j10;
    ...
    public final synchronized void d(long j3, long j10) {
        try {
            ...
            this.f46561j += (int) (elapsedRealtime - this.h);
            this.f46562k += j3;
            if (j10 > 0 && j3 > 0) {
                this.f46558f.a((((float) j3) * 8000.0f) / ((float) j10), (int) Math.sqrt(j3));
                if (this.f46561j < 2000) {
                    if (this.f46562k >= 524288) {
                    }
                    c((int) j10, j3, this.f46563l);
                    this.h = elapsedRealtime;
                    this.f46560i = 0L;
                }
                this.f46563l = this.f46558f.b();
                c((int) j10, j3, this.f46563l);
                this.h = elapsedRealtime;
                this.f46560i = 0L;
            }
