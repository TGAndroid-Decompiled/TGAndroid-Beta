...
public final class f implements c, c0 {
    public static final a1 f49515p = i0.y(4300000L, 3200000L, 2400000L, 1700000L, 860000L);
    public static final a1 f49516q = i0.y(1500000L, 980000L, 750000L, 520000L, 290000L);
    public static final a1 f49517r = i0.y(2000000L, 1300000L, 1000000L, 860000L, 610000L);
    public static final a1 f49518s = i0.y(2500000L, 1700000L, 1200000L, 970000L, 680000L);
    public static final a1 f49519t = i0.y(4700000L, 2800000L, 2100000L, 1700000L, 980000L);
    public static final a1 f49520u = i0.y(2700000L, 2000000L, 1600000L, 1300000L, 1000000L);
    public static f v;
    public final Context f49521a;
    public final k0 f49522b;
    public final u4 f49523c;
    public final x d;
    public final boolean f49524e;
    public final r f49525f;
    public int f49526g;
    public long h;
    public long f49527i;
    public long f49528j;
    public long f49529k;
    public volatile long f49530l;
    public long f49531m;
    public int f49532n;
    public String f49533o;
    ...
    public f(Context context, HashMap hashMap) {
        ...
        this.f49521a = applicationContext;
        this.f49522b = k0.a(hashMap);
        this.f49523c = new u4(29);
        this.f49525f = new r();
        this.d = xVar;
        this.f49524e = true;
        if (context != null) {
                            ...
                            if (i10 != 7) {
                                if (i10 != 9) {
                                    if (i10 != 10) {
                                        ...
                                        longValue = ((Long) f49519t.get(iArr[4])).longValue();
                                    }
                                } else {
                                    longValue = ((Long) f49520u.get(iArr[5])).longValue();
                                }
                            }
                        } else {
                            longValue = ((Long) f49518s.get(iArr[3])).longValue();
                        }
                    } else {
                        longValue = ((Long) f49517r.get(iArr[2])).longValue();
                    }
                } else {
                    longValue = ((Long) f49516q.get(iArr[1])).longValue();
                }
                l4 = Long.valueOf(longValue);
            }
            longValue = ((Long) f49515p.get(iArr[0])).longValue();
            l4 = Long.valueOf(longValue);
        }
        if (l4 == null) {
            l4 = 1000000L;
    ...
    public final void c(int i10, long j3, long j10) {
        ...
        long j11;
        long j12;
        if (i10 != 0 || j3 != 0 || j10 != this.f49531m) {
            this.f49531m = j10;
            Iterator it = ((CopyOnWriteArrayList) this.f49523c.f14247b).iterator();
            while (it.hasNext()) {
                b bVar = (b) it.next();
                if (!bVar.f49508c) {
                    i11 = i10;
                    j11 = j3;
                    j12 = j10;
                    bVar.f49506a.post(new k2.i(bVar, i11, j11, j12, 1));
                } else {
                    i11 = i10;
                    j11 = j3;
                    j12 = j10;
    ...
    public final synchronized void d(long j3, long j10) {
        try {
            ...
            this.f49528j += (int) (elapsedRealtime - this.h);
            this.f49529k += j3;
            if (j10 > 0 && j3 > 0) {
                this.f49525f.a((((float) j3) * 8000.0f) / ((float) j10), (int) Math.sqrt(j3));
                if (this.f49528j < 2000) {
                    if (this.f49529k >= 524288) {
                    }
                    c((int) j10, j3, this.f49530l);
                    this.h = elapsedRealtime;
                    this.f49527i = 0L;
                }
                this.f49530l = this.f49525f.b();
                c((int) j10, j3, this.f49530l);
                this.h = elapsedRealtime;
                this.f49527i = 0L;
            }
