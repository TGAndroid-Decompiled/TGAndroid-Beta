...
public final class b extends f implements Handler.Callback {
    ...
    public final void E(p0 p0Var) {
        b0 b0Var = this.J;
        e0 e0Var = b0Var.f10621a;
        n0 n0Var = e0Var.f10657i0;
        p pVar = e0Var.f10664m;
        m0 a2 = n0Var.a();
        int i10 = 0;
        while (true) {
            o0[] o0VarArr = p0Var.f3173a;
    ...
    public final void v(s[] sVarArr, long j3, long j10, f0 f0Var) {
        ...
        p0 p0Var = this.Q;
        if (p0Var != null) {
            long j11 = p0Var.f3174b;
            long j12 = (this.R + j11) - j10;
            if (j11 != j12) {
                p0Var = new p0(j12, p0Var.f3173a);
            }
            this.Q = p0Var;
        }
        this.R = j10;
            ...
            if (!this.N && this.Q == null) {
                ...
                if (w10 == -4) {
                    if (aVar.isEndOfStream()) {
                        ...
                        p0 a2 = lVar.a(aVar);
                        if (a2 != null) {
                            ArrayList arrayList = new ArrayList(a2.f3173a.length);
                            C(a2, arrayList);
                    ...
                    s sVar = (s) yVar.f14995c;
                    sVar.getClass();
                    this.P = sVar.f3308w;
                }
            }
            p0 p0Var = this.Q;
            if (p0Var != null && p0Var.f3174b <= D(j3)) {
                p0 p0Var2 = this.Q;
