...
public final class o extends com.googlecode.mp4parser.c {
    public static final bb.b f44001n;
    public static final bb.b f44002r;
    public static final bb.b f44003s;
    ...
    static {
        ...
        f44001n = aVar.e(aVar.d("getSampleSize", "com.coremedia.iso.boxes.SampleSizeBox", "", "", "long"));
        ...
        f44002r = aVar.e(aVar.d("getSampleCount", "com.coremedia.iso.boxes.SampleSizeBox", "", "", "long"));
        aVar.e(aVar.d("getSampleSizes", "com.coremedia.iso.boxes.SampleSizeBox", "", "", "[J"));
        f44003s = aVar.e(aVar.d("setSampleSizes", "com.coremedia.iso.boxes.SampleSizeBox", "[J", "sampleSizes", "void"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.h = a2;
        if (this.e == 0) {
            this.f44004f = new long[a2];
            for (int i10 = 0; i10 < this.h; i10++) {
                this.f44004f[i10] = r2.b.i(byteBuffer);
            }
        }
    }
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        ...
        if (this.e == 0) {
            byteBuffer.putInt(this.f44004f.length);
            for (long j10 : this.f44004f) {
    ...
    public final String toString() {
        ...
        ai.x(de.a.b(f44001n, this, this));
        sb.append(this.e);
        sb.append(";sampleCount=");
        ai.x(de.a.b(f44002r, this, this));
        if (this.e > 0) {
            length = this.h;
        } else {
            length = this.f44004f.length;
        }
