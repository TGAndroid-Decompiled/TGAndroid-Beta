...
public final class f {
    ...
    public final int d;
    public final RenderNode[] f2712e;
    public long f2713f;
    public final RectF f2714g = new RectF();
    ...
    public f(boolean z10) {
        ...
        this.d = i10;
        this.f2710b = z10;
        this.f2712e = new RenderNode[isEnabled ? 2 : 1];
        int i11 = 0;
        while (true) {
            RenderNode[] renderNodeArr = this.f2712e;
    ...
    public final void b(Canvas canvas, int i10) {
        if (canvas.isHardwareAccelerated()) {
            ...
            if (!z10 && this.f2711c) {
                canvas.drawRenderNode(this.f2712e[0]);
                return;
            } else if (i10 == -2) {
                canvas.drawRenderNode(this.f2712e[!z10 ? 1 : 0]);
                return;
            } else if (i10 == -4) {
                canvas.drawRenderNode(this.f2712e[0]);
                return;
            } else if (i10 == -3) {
                canvas.drawRenderNode(this.f2712e[1]);
                return;
            } else {
                return;
            }
    ...
    public final RenderNode d(int i10, int i11) {
        d dVar;
        e eVar = (e) this.f2715i.get(i11);
        if (this.f2709a && (dVar = eVar.f2707c) != null) {
            if (i10 == 0) {
                return dVar.f2699c[0];
            }
            return eVar.f2706b.f2699c[0];
        }
        RenderNode[] renderNodeArr = eVar.f2706b.f2699c;
    ...
    public final boolean e(ch.a aVar, int i10, int i11) {
        ...
        while (true) {
            int i14 = this.f2716j;
            ArrayList arrayList = this.f2715i;
            if (i12 < i14) {
                e eVar = (e) arrayList.get(i12);
                Rect rect = eVar.d;
                RectF rectF = this.f2714g;
                rectF.set(rect);
                a aVar2 = this.h;
                aVar2.f2676b = 0L;
                aVar2.f2675a = false;
                aVar.e(aVar2, rectF);
                boolean z10 = aVar2.f2675a;
                if (z10) {
                    j3 = -1;
                } else {
                    j3 = aVar2.f2676b;
                }
                if (z10 || eVar.f2708e != j3 || !eVar.f2705a.hasDisplayList()) {
                    eVar.f2708e = j3;
                    if (this.f2718l == null) {
                        ...
                        eVar2.f2705a.setPosition(0, 0, i16, height);
                        RecordingCanvas beginRecording = eVar2.f2705a.beginRecording(i16, height);
                        float f7 = 1.0f / i15;
                        ...
                        if (this.f2718l != null) {
                            e eVar3 = (e) arrayList.get(this.f2717k);
                            eVar3.f2705a.endRecording();
                            d dVar = eVar3.f2706b;
                            d dVar2 = eVar3.f2707c;
                            if (dVar2 != null) {
                                dVar2.a(eVar3.f2705a);
                                dVar.a(dVar2.f2699c[0]);
                            } else {
                                dVar.a(eVar3.f2705a);
                            }
                            this.f2718l = null;
                ...
                if (i13 > 0) {
                    ...
                    while (true) {
                        ...
                        for (int i18 = 0; i18 < this.f2716j; i18++) {
                    ...
                    if (calcHash != this.f2713f || z11) {
                        this.f2713f = calcHash;
                        int i19 = 0;
                        while (true) {
                            RenderNode[] renderNodeArr2 = this.f2712e;
                            ...
                            for (int i20 = 0; i20 < this.f2716j; i20++) {
    ...
    public final void f(float f7, float f10) {
        for (int i10 = 0; i10 < this.f2716j; i10++) {
            e eVar = (e) this.f2715i.get(i10);
            eVar.f2706b.b(f7, f10);
            d dVar = eVar.f2707c;
            if (dVar != null) {
                dVar.b(f7, f10);
            }
    ...
    public final void g(int i10, List list) {
        ...
        while (true) {
            int i11 = this.f2716j;
            arrayList = this.f2715i;
            if (i11 <= arrayList.size()) {
                break;
            }
            arrayList.add(new e(this));
        }
        for (int i12 = 0; i12 < this.f2716j; i12++) {
