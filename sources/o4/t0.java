...
public final class t0 implements j3.g {
    ...
    public static final String f16575e;
    public final int f16576a;
    public final s8.i0 f16577b;
    public int f16578c;

    static {
        int i10 = h5.d0.f7237a;
        f16575e = Integer.toString(0, 36);
    }

    public t0(s0... s0VarArr) {
        s8.i0 u10 = s8.v.u(s0VarArr);
        this.f16577b = u10;
        this.f16576a = s0VarArr.length;
        int i10 = 0;
        while (i10 < u10.d) {
            int i11 = i10 + 1;
    ...
    public final s0 a(int i10) {
        return (s0) this.f16577b.get(i10);
    }

    public final int b(s0 s0Var) {
        int indexOf = this.f16577b.indexOf(s0Var);
        if (indexOf >= 0) {
            return indexOf;
        }
        return -1;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj != null && t0.class == obj.getClass()) {
                t0 t0Var = (t0) obj;
                if (this.f16576a == t0Var.f16576a && this.f16577b.equals(t0Var.f16577b)) {
                    return true;
                }
                return false;
            }
