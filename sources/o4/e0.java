...
public final class e0 implements t, r3.m, g5.h0, g5.k0, j0 {
    ...
    public static final j3.n0 f16298a0;
    public s D;
    public i4.b E;
    public boolean H;
    public boolean I;
    ...
    public final g5.m f16300b;
    public final o3.p f16301c;
    public final z9.d d;
    public final b4.e0 e;
    public final o3.m f16302f;
    public final f0 h;
    public final g5.q f16303n;
    public final String f16304r;
    public final long f16305s;
    public final w0 f16306w;
    public final g5.m0 v = new g5.m0("ProgressiveMediaPeriod");
    public final h5.c f16307x = new Object();
    public final a0 f16308y = new a0(this, 0);
    ...
    static {
        ...
        m0Var.f8655a = "icy";
        m0Var.f8666o = "application/x-icy";
        f16298a0 = new j3.n0(m0Var);
    }
    ...
    @Override
    public final c4.e X(g5.j0 r15, java.io.IOException r16, int r17) {
        throw new UnsupportedOperationException("Method not decompiled: o4.e0.X(g5.j0, java.io.IOException, int):c4.e");
    }
    ...
    public final long Y(f5.c[] cVarArr, boolean[] zArr, l0[] l0VarArr, boolean[] zArr2, long j10) {
        ...
        t0 t0Var = (t0) rVar.f4004a;
        boolean[] zArr3 = (boolean[]) rVar.f4006c;
        int i10 = this.R;
        int i11 = 0;
        for (int i12 = 0; i12 < cVarArr.length; i12++) {
            l0 l0Var = l0VarArr[i12];
            if (l0Var != null && (cVarArr[i12] == null || !zArr[i12])) {
                int i13 = ((c0) l0Var).f16288a;
                h5.a.i(zArr3[i13]);
                this.R--;
                zArr3[i13] = false;
                l0VarArr[i12] = null;
    ...
    public final void c() {
        ...
        w0 w0Var = this.f16306w;
        r3.k kVar = (r3.k) w0Var.f11787c;
        if (kVar != null) {
            kVar.release();
            w0Var.f11787c = null;
        }
    ...
    public final int e() {
        ...
        int i10 = 0;
        for (k0 k0Var : this.F) {
            i10 += k0Var.f16352q + k0Var.f16351p;
        }
        return i10;
    }
        ...
        if (!this.Y && !this.I && this.H && this.L != null) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                if (bVar != null) {
                    ...
                    if (h && t6.f8720f == -1 && t6.h == -1 && i11 != -1) {
                        j3.m0 a11 = t6.a();
                        a11.f8658f = i11;
                        t6 = new j3.n0(a11);
                    }
                }
                int z10 = this.f16301c.z(t6);
                j3.m0 a12 = t6.a();
                a12.J = z10;
            ...
            obj.f4004a = t0Var;
            obj.f4005b = zArr;
            int i12 = t0Var.f16403a;
            obj.f4006c = new boolean[i12];
    ...
    public final void i(int i10) {
        ...
        if (!zArr[i10]) {
            j3.n0 n0Var = ((t0) rVar.f4004a).a(i10).d[0];
    ...
    public final void j(int i10) {
        d();
        boolean[] zArr = (boolean[]) this.K.f4005b;
    ...
    public final k0 k(d0 d0Var) {
        ...
        o3.p pVar = this.f16301c;
        pVar.getClass();
        k0 k0Var = new k0(this.f16303n, pVar, this.f16302f);
        k0Var.f16342f = this;
        int i11 = length + 1;
    ...
    public final void k1(g5.j0 j0Var, long j10, long j11) {
        ...
        Uri uri = b0Var.f16277b.f6458c;
        ?? obj = new Object();
        this.d.getClass();
        this.e.p(obj, 1, -1, null, 0, null, b0Var.f16281r, this.M);
        this.X = true;
        s sVar2 = this.D;
        sVar2.getClass();
        sVar2.X1(this);
    ...
    public final void l() {
        b0 b0Var = new b0(this, this.f16299a, this.f16300b, this.f16306w, this, this.f16307x);
        if (this.I) {
            h5.a.i(g());
            long j10 = this.M;
            ...
            r3.s sVar = this.L;
            sVar.getClass();
            long j11 = sVar.f(this.U).f43270a.f43274b;
            long j12 = this.U;
            b0Var.f16279f.f25932a = j11;
            b0Var.f16281r = j12;
            b0Var.f16280n = true;
            b0Var.f16283w = false;
            for (k0 k0Var : this.F) {
                k0Var.f16355t = this.U;
            }
            this.U = -9223372036854775807L;
        }
        this.W = e();
        this.v.f(b0Var, this, this.d.p(this.O));
        this.e.u(new j(b0Var.f16282s), 1, -1, null, 0, null, b0Var.f16281r, this.M);
    }
    ...
    public final void m0(long j10) {
        d();
        if (!g()) {
            boolean[] zArr = (boolean[]) this.K.f4006c;
            int length = this.F.length;
            for (int i10 = 0; i10 < length; i10++) {
    ...
    public final void x0(g5.j0 j0Var, long j10, long j11, boolean z4) {
        ...
        ?? obj = new Object();
        this.d.getClass();
        this.e.m(obj, 1, -1, null, 0, null, b0Var.f16281r, this.M);
        if (!z4) {
            for (k0 k0Var : this.F) {
                k0Var.A(false);
            }
    ...
    public final long y1() {
        ...
        if (this.J) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                com.google.firebase.messaging.r rVar = this.K;
                if (((boolean[]) rVar.f4005b)[i10] && ((boolean[]) rVar.f4006c)[i10]) {
                    k0 k0Var = this.F[i10];
                    synchronized (k0Var) {
                        z4 = k0Var.f16357w;
                    }
    ...
    public final long z(long j10, h2 h2Var) {
        ...
        return h2Var.a(j10, f10.f43270a.f43273a, f10.f43271b.f43273a);
    }
