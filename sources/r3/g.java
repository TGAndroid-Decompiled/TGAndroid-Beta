...
public class g implements s {
    ...
    public final long d;
    public final int e;
    public final long f43242f;
    public final boolean f43243g;

    public g(long j10, int i10, int i11, boolean z4, long j11) {
        this.f43239a = j10;
        this.f43240b = j11;
        this.f43241c = i11 == -1 ? 1 : i11;
        this.e = i10;
        this.f43243g = z4;
        if (j10 == -1) {
            this.d = -1L;
            this.f43242f = -9223372036854775807L;
            return;
        }
        long j12 = j10 - j11;
        this.d = j12;
        this.f43242f = (Math.max(0L, j12) * 8000000) / i10;
    }

    @Override
    public final boolean c() {
        if (this.d == -1 && !this.f43243g) {
            return false;
        }
        return true;
    }
    ...
    public final r f(long j10) {
        ...
        if (i10 == 0 && !this.f43243g) {
            t tVar = new t(0L, j11);
            return new r(tVar, tVar);
        }
        int i11 = this.e;
        long j13 = this.f43241c;
