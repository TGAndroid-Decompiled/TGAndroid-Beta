...
public final class h implements l {
    public final g5.j f46586b;
    public final long f46587c;
    public long d;
    public int f46589f;
    public int h;
    public byte[] f46588e = new byte[65536];
    public final byte[] f46585a = new byte[4096];
    ...
    public final boolean a(int i10, boolean z4) {
        d(i10);
        int i11 = this.h - this.f46589f;
        while (i11 < i10) {
            int i12 = i10;
            boolean z10 = z4;
            i11 = h(this.f46588e, this.f46589f, i12, i11, z10);
            if (i11 == -1) {
                return false;
            }
            this.h = this.f46589f + i11;
            i10 = i12;
            z4 = z10;
        }
        this.f46589f += i10;
    ...
    public final boolean c(byte[] bArr, int i10, int i11, boolean z4) {
        ...
        if (i12 == 0) {
            ...
            System.arraycopy(this.f46588e, 0, bArr, i10, min);
            j(min);
        }
        int i13 = min;
        while (i13 < i11 && i13 != -1) {
    ...
    public final void d(int i10) {
        int i11 = this.f46589f + i10;
        byte[] bArr = this.f46588e;
        if (i11 > bArr.length) {
            this.f46588e = Arrays.copyOf(this.f46588e, d0.h(bArr.length * 2, 65536 + i11, i11 + 524288));
        }
    }
    ...
    public final int e(int i10, int i11, byte[] bArr) {
        ...
        d(i11);
        int i12 = this.h;
        int i13 = this.f46589f;
        int i14 = i12 - i13;
        if (i14 == 0) {
            hVar = this;
            min = hVar.h(this.f46588e, i13, i11, 0, true);
            if (min == -1) {
                return -1;
            }
            hVar.h += min;
        ...
        System.arraycopy(hVar.f46588e, hVar.f46589f, bArr, i10, min);
        hVar.f46589f += min;
        return min;
    }
    ...
    public final boolean f(byte[] bArr, int i10, int i11, boolean z4) {
        ...
        System.arraycopy(this.f46588e, this.f46589f - i11, bArr, i10, i11);
        return true;
    }

    @Override
    public final long g() {
        return this.d + this.f46589f;
    }
    ...
    public final int h(byte[] bArr, int i10, int i11, int i12, boolean z4) {
        if (!Thread.interrupted()) {
            int read = this.f46586b.read(bArr, i10 + i12, i11 - i12);
            if (read == -1) {
                if (i12 == 0 && z4) {
                    return -1;
                }
