...
public final class g extends kl0 {
    ...
    public long i(int i10) {
        switch (this.f16762c) {
            case 1:
                return ((e81) ((h81) this.f16763e).h.get(i10)).f25630a;
            default:
                return super.i(i10);
        }
    }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        switch (this.f16762c) {
            case 0:
                ...
                x1 x1Var = (x1) view;
                x1Var.setTextColor(j6.w0(null, j6.f20798j5, false));
                x1Var.a(0, charSequence);
                return;
            default:
                f81 f81Var = (f81) c1Var.f45767a;
                h81 h81Var = (h81) this.f16763e;
                e81 e81Var = (e81) h81Var.h.get(i10);
                f81Var.f25983a = e81Var;
                f81Var.setContentDescription(e81Var.f25631b);
                f81Var.setAlpha(1.0f);
                f81Var.requestLayout();
                if (h81Var.m0 && (g81Var = h81Var.f26687y) != null && ((g0) g81Var).i(i10)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
