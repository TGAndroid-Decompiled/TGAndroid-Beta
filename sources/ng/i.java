...
public final class i extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void c(final boolean z10) {
        ...
        if (z10) {
            ...
            if (getContext() instanceof LaunchActivity) {
                ...
                ActionBarLayout actionBarLayout = ((LaunchActivity) getContext()).f33485s0;
                if (actionBarLayout != null) {
                    arrayList.addAll(actionBarLayout.A());
                }
                ActionBarLayout actionBarLayout2 = ((LaunchActivity) getContext()).f33483r0;
    ...
    public final void d() {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f20762h5, false), mode));
        this.f16778w.setBackground(drawable);
        this.f16779x.setTextColor(j6.w0(null, j6.f20798j5, false));
        invalidate();
    }
