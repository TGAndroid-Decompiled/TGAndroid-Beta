...
public final class s extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public f d;
    public s8 f16210e;
    public LinearLayout f16211f;
    public s3 h;
    public p f16212n;
    public x7 f16213r;
    public s8 f16214s;
    public t0 v;
    public FrameLayout f16215w;
    public ImageView f16216x;
    public fo0 f16217y;
    ...
    public final void W(u5 u5Var) {
        Editable text = this.f16212n.getText();
        Layout layout = this.f16212n.getLayout();
        ...
        if (z4 && z10) {
            ...
            alertDialog$Builder.k(LocaleController.getString("ApplyTheme", R.string.ApplyTheme), new c2(this) {
                ...
                public final void j(d2 d2Var, int i10) {
                    switch (r2) {
                        case 0:
                            this.f16066b.v.performClick();
                            return;
                        default:
                            this.f16066b.finishFragment();
                            return;
                    }
                }
            });
    ...
    public final void Z() {
        if (this.H) {
            ...
            if (Build.MODEL.toLowerCase().startsWith("zte") && Build.VERSION.SDK_INT <= 28) {
                this.f16211f.setFocusableInTouchMode(true);
                this.f16211f.requestFocus();
            } else {
                this.f16212n.clearFocus();
            }
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f16217y.getLayoutParams();
            marginLayoutParams.bottomMargin = 0;
            this.f16217y.setLayoutParams(marginLayoutParams);
            NotificationCenter.getGlobalInstance().lambda$postNotificationNameOnUIThread$1(NotificationCenter.stopAllHeavyOperations, 512);
            this.f16209c.animate().setListener(null).cancel();
            this.f16209c.animate().translationY(this.f16209c.getMeasuredHeight()).setDuration(350L).withLayer().setInterpolator(pr.f30183f).setUpdateListener(new j(this, 1)).setListener(new m(this, 0)).start();
        }
    }

    public final boolean a0() {
        int editTextSelectionEnd = this.f16212n.getEditTextSelectionEnd();
        int editTextSelectionStart = this.f16212n.getEditTextSelectionStart();
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(this.f16212n.getText());
        if (!this.f16212n.hasSelection()) {
            return false;
        }
        ...
        for (u5 u5Var : u5VarArr) {
            ...
            this.f16208b.A(Long.valueOf(u5Var.documentId));
        }
        this.f16212n.dispatchKeyEvent(new KeyEvent(0, 67));
        Y(false);
        return true;
    }
            ...
            if (l10.longValue() != -1) {
                ...
                while (true) {
                    if (i11 < size2) {
                        ...
                        if (l10.longValue() == tL_availableReaction.activate_animation.f20849id) {
    ...
    public final void c0(int i10, boolean z4, boolean z10) {
        ...
        if (this.P != i10 || this.f16207a != z4) {
            ...
            if (z10) {
                if (z11) {
                    this.f16210e.b(w02, true);
                } else {
                    this.f16210e.setBackgroundColorAnimatedReverse(w02);
                }
            } else {
                this.f16210e.setBackgroundColor(w02);
            }
            this.P = i10;
            if (i10 != 1 && i10 != 0 && !z4) {
                if (z10) {
                    Z();
                    this.f16215w.animate().setListener(null).cancel();
                    this.f16211f.animate().setListener(null).cancel();
                    ViewPropertyAnimator duration = this.f16215w.animate().alpha(0.0f).setDuration(350L);
                    pr prVar = pr.f30183f;
                    duration.setInterpolator(prVar).setListener(new m(this, 2)).start();
                    this.f16211f.animate().alpha(0.0f).setDuration(350L).setInterpolator(prVar).setListener(new m(this, 3)).start();
                    return;
                }
                this.f16211f.setVisibility(4);
                this.f16215w.setVisibility(4);
                return;
            }
            this.f16211f.setVisibility(0);
            this.f16215w.setVisibility(0);
            if (z10) {
                this.f16215w.animate().setListener(null).cancel();
                this.f16211f.animate().setListener(null).cancel();
                ViewPropertyAnimator duration2 = this.f16211f.animate().alpha(1.0f).setDuration(350L);
                pr prVar2 = pr.f30183f;
                duration2.setInterpolator(prVar2).setListener(new m(this, 1)).start();
                this.f16215w.animate().alpha(1.0f).setDuration(350L).setInterpolator(prVar2).start();
                LinkedHashMap linkedHashMap = this.B;
                if (linkedHashMap.isEmpty()) {
                    this.f16208b.H.clear();
                    this.f16212n.setText("");
                    ...
                    while (i13 < size) {
                        int i14 = i13 + 1;
                        s0.a((TLRPC.TL_availableReaction) arrayList.get(i13), linkedHashMap, this.C, spannableStringBuilder, this.f16208b, this.f16212n.getFontMetricsInt());
                        i12++;
                        if (i12 >= this.G) {
                            break;
                        }
                    ...
                    this.f16212n.append(spannableStringBuilder);
                    this.f16212n.m();
                    q51 q51Var = this.f16208b.m0;
                    if (q51Var != null) {
                        q51Var.l();
                    }
                    Y(false);
    ...
    public final void d0() {
        ...
        if (z4) {
            ...
            W(u5Var);
            this.f16208b.x(-1L, true);
            Y(false);
            this.f16212n.setMaxLength(i10);
            c0(this.P, this.f16207a, true);
        } else {
            s8Var.setChecked(true);
            try {
                this.f16212n.setMaxLength(i10 + 1);
                ...
                this.f16212n.getText().insert(0, spannableString);
                this.f16208b.x(-1L, true);
                Y(true);
                W(nVar);
            } catch (Exception e6) {
        ...
        this.f16212n.updateAnimatedEmoji(true);
    }
    ...
    public final void onPause() {
        this.Q = true;
        this.f16212n.setFocusable(false);
        super.onPause();
    }
    ...
    public final void onResume() {
        ...
        if (this.Q) {
            this.Q = false;
            this.f16212n.setFocusable(true);
            this.f16212n.setFocusableInTouchMode(true);
            if (this.H) {
                this.f16212n.n(false);
    ...
    public final void onTransitionAnimationEnd(boolean z4, boolean z10) {
        ...
        if (z4 && !z10) {
            if (this.f16208b == null) {
                ...
                this.f16208b.setClipChildren(false);
                this.f16208b.setBackgroundColor(k6.w0(null, k6.f21659d6, false));
                this.f16209c.addView(this.f16208b, c6.e(-1, -2, 80));
                f fVar = new f(getParentActivity(), getResourceProvider());
                this.d = fVar;
                fVar.setOnBackspace(new k(this, 0));
                this.f16209c.addView(this.d, c6.d(-1, -2.0f, 85, 0.0f, 0.0f, 8.0f, 8.0f));
                ArrayList arrayList = this.C;
                int size = arrayList.size();
                int i10 = 0;
                while (i10 < size) {
