...
public final class o extends r1 {
    ...
    public final void e(float f10, float f11, boolean z4) {
        ...
        if (sVar.getParentLayout() != null) {
            boolean z10 = ((ActionBarLayout) sVar.getParentLayout()).f21136n;
        }
    }
    ...
    public final void g(int i10, boolean z4) {
        float f10;
        s sVar = (s) this.f16141x.f213c;
        sVar.f16215w.setVisibility(0);
        ViewPropertyAnimator animate = sVar.f16215w.animate();
        if (!z4) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
