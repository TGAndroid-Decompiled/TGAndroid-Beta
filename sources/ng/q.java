...
public final class q extends r61 {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.a2) {
            this.a2 = false;
            this.f16173b2.f16208b.s(null);
        }
    }

    @Override
    public final void p(View view, Long l10, TLRPC.Document document, TL_stars.TL_starGiftUnique tL_starGiftUnique, Integer num) {
        s sVar = this.f16173b2;
        int i10 = sVar.G;
        ...
        if (linkedHashMap.containsKey(l10)) {
            ...
            try {
                ...
                u5 e6 = s0.e(document, l10, sVar.f16212n.getFontMetricsInt());
                e6.cacheType = l5.g();
                e6.setAdded();
                ...
                sVar.f16212n.getText().insert(editTextSelectionEnd, spannableString);
                sVar.f16212n.setSelection(editTextSelectionEnd + spannableString.length());
                sVar.f16208b.x(l10, true);
                sVar.Y(true);
                sVar.W(e6);
            } catch (Exception e10) {
