...
public class a implements bg.a, q, e, cg.a, n, d, k1, c, Continuation, l, xf.a, y6.d {
    ...
    public Object D(cf.c cVar) {
        switch (this.f16988a) {
            case 15:
                ...
                ReferenceQueue referenceQueue = aVar.f44270a;
                Set set = aVar.f44271b;
    ...
    public List b(ComponentRegistrar componentRegistrar) {
        ...
        for (q9.a aVar : componentRegistrar.getComponents()) {
            String str = aVar.f44210a;
            if (str != null) {
                aVar = new q9.a(str, aVar.f44211b, aVar.f44212c, aVar.d, aVar.f44213e, new i0(6, str, aVar), aVar.f44215g);
            }
            arrayList.add(aVar);
        }
        return arrayList;
