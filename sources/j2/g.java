    ...
    public final boolean a(a aVar) {
        ...
        if (j3 != -1) {
            if (f0Var.d <= j3) {
                f0 f0Var2 = this.d;
                if (f0Var2 != null) {
                    int i10 = f0Var2.f46697b;
                    int b10 = k1Var.b(f0Var.f46696a);
                    int b11 = k1Var.b(f0Var2.f46696a);
                    if (f0Var.d >= f0Var2.d && b10 >= b11) {
                        if (b10 <= b11) {
                            if (f0Var.b()) {
                                int i11 = f0Var.f46697b;
                                int i12 = f0Var.f46698c;
                                if (i11 <= i10) {
                                    if (i11 == i10 && i12 > f0Var2.f46698c) {
                                        return true;
                                    }
                                    return false;
                                }
