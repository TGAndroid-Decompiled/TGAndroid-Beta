...
public final class g {
    ...
    public final boolean a(a aVar) {
        ...
        if (f0Var == null) {
            if (this.f12582b != aVar.f12565c) {
                return true;
            }
            return false;
        }
        long j3 = this.f12583c;
        if (j3 != -1) {
            if (f0Var.d <= j3) {
                f0 f0Var2 = this.d;
                if (f0Var2 != null) {
                    int i10 = f0Var2.f43381b;
                    int b10 = k1Var.b(f0Var.f43380a);
                    int b11 = k1Var.b(f0Var2.f43380a);
                    if (f0Var.d >= f0Var2.d && b10 >= b11) {
                        if (b10 <= b11) {
                            if (f0Var.b()) {
                                int i11 = f0Var.f43381b;
                                int i12 = f0Var.f43382c;
                                if (i11 <= i10) {
                                    if (i11 == i10 && i12 > f0Var2.f43382c) {
                                        return true;
                                    }
                                    return false;
                                }
