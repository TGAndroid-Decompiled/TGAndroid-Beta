...
public final class h {
    ...
    public final synchronized String d(k1 k1Var, f0 f0Var) {
        return c(k1Var.g(f0Var.f46696a, this.f13217b).f2083c, f0Var).f13209a;
    }
    ...
    public final void e(a aVar) {
        ...
        if (f0Var2 != null) {
            long j3 = f0Var2.d;
            if (f0Var2.b()) {
                if (gVar2 == null || gVar2.f13211c != j3 || (f0Var = gVar2.d) == null || f0Var.f46697b != f0Var2.f46697b || f0Var.f46698c != f0Var2.f46698c) {
                    c(i10, new f0(f0Var2.f46696a, j3));
                    this.d.getClass();
                }
            }
        }
