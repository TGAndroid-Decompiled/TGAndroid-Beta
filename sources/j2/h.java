...
public final class h {
    ...
    public final synchronized String d(k1 k1Var, f0 f0Var) {
        return c(k1Var.g(f0Var.f43287a, this.f12577b).f3006c, f0Var).f12570a;
    }
    ...
    public final void e(a aVar) {
        ...
        if (f0Var2 != null) {
            long j3 = f0Var2.d;
            if (f0Var2.b()) {
                if (gVar2 == null || gVar2.f12572c != j3 || (f0Var = gVar2.d) == null || f0Var.f43288b != f0Var2.f43288b || f0Var.f43289c != f0Var2.f43289c) {
                    c(i10, new f0(f0Var2.f43287a, j3));
                    this.d.getClass();
                }
            }
        }
