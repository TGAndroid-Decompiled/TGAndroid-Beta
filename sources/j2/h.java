...
public final class h {
    ...
    public final synchronized String d(k1 k1Var, f0 f0Var) {
        return c(k1Var.g(f0Var.f43627a, this.f12577b).f3006c, f0Var).f12570a;
    }
    ...
    public final void e(a aVar) {
        ...
        if (f0Var2 != null) {
            long j3 = f0Var2.d;
            if (f0Var2.b()) {
                if (gVar2 == null || gVar2.f12572c != j3 || (f0Var = gVar2.d) == null || f0Var.f43628b != f0Var2.f43628b || f0Var.f43629c != f0Var2.f43629c) {
                    c(i10, new f0(f0Var2.f43627a, j3));
                    this.d.getClass();
                }
            }
        }
