...
public final class h {
    ...
    public final synchronized String d(k1 k1Var, f0 f0Var) {
        return c(k1Var.g(f0Var.f46668a, this.f13191b).f2056c, f0Var).f13183a;
    }
    ...
    public final void e(a aVar) {
        ...
        if (f0Var2 != null) {
            long j3 = f0Var2.d;
            if (f0Var2.b()) {
                if (gVar2 == null || gVar2.f13185c != j3 || (f0Var = gVar2.d) == null || f0Var.f46669b != f0Var2.f46669b || f0Var.f46670c != f0Var2.f46670c) {
                    c(i10, new f0(f0Var2.f46668a, j3));
                    this.d.getClass();
                }
            }
        }
