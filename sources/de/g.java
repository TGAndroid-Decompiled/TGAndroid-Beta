...
public final class g extends kd.c implements ce.c {
    public final ce.c f6491a;
    public final id.h f6492b;
    public final int f6493c;
    public id.h d;
    public kd.c e;

    public g(ce.c cVar, id.h hVar) {
        super(d.f6488a, id.i.f10565a);
        this.f6491a = cVar;
        this.f6492b = hVar;
        this.f6493c = ((Number) hVar.fold(0, f.f6490b)).intValue();
    }
    ...
    public final Object d(kd.c cVar, Object obj) {
        ...
        if (hVar != context) {
            ...
            if (hVar instanceof c) {
                String str2 = "\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + ((c) hVar).f6486a + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ";
                    ...
                    if (i11 >= 0) {
                        ...
                        if ((i11 == 0 || i11 == a10) && xd.j.e(str4)) {
                            ...
                            if (i10 >= 0) {
                                ...
                                throw new IllegalArgumentException(hc.b.k(i10, "Requested character count ", " is less than zero.").toString());
                            }
                        }
                        if (str != null) {
                            arrayList3.add(str);
            ...
            } else if (((Number) context.fold(0, new j(this))).intValue() == this.f6493c) {
                this.d = context;
            } else {
                throw new IllegalStateException(("Flow invariant is violated:\n\t\tFlow was collected in " + this.f6492b + ",\n\t\tbut emission happened in " + context + ".\n\t\tPlease refer to 'flow' documentation or use 'flowOn' instead").toString());
            }
        }
        this.e = cVar;
        q qVar = i.f6495a;
        ce.c cVar2 = this.f6491a;
        ...
        if (!kotlin.jvm.internal.i.a(c10, jd.a.f11861a)) {
            this.e = null;
        }
        return c10;
    }
