...
public final class g extends kd.c implements ce.c {
    public final ce.c f7703a;
    public final id.h f7704b;
    public final int f7705c;
    public id.h d;
    public kd.c e;

    public g(ce.c cVar, id.h hVar) {
        super(d.f7700a, id.i.f11071a);
        this.f7703a = cVar;
        this.f7704b = hVar;
        this.f7705c = ((Number) hVar.fold(0, f.f7702b)).intValue();
    }
    ...
    public final Object d(kd.c cVar, Object obj) {
        ...
        if (hVar != context) {
            ...
            if (hVar instanceof c) {
                String str2 = "\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + ((c) hVar).f7698a + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ";
                    ...
                    if (i11 >= 0) {
                        ...
                        if ((i11 == 0 || i11 == a10) && xd.j.e(str4)) {
                            ...
                            if (i10 >= 0) {
                                ...
                                throw new IllegalArgumentException(hg.c.j(i10, "Requested character count ", " is less than zero.").toString());
                            }
                        }
                        if (str != null) {
                            arrayList3.add(str);
            ...
            } else if (((Number) context.fold(0, new j(this))).intValue() == this.f7705c) {
                this.d = context;
            } else {
                throw new IllegalStateException(("Flow invariant is violated:\n\t\tFlow was collected in " + this.f7704b + ",\n\t\tbut emission happened in " + context + ".\n\t\tPlease refer to 'flow' documentation or use 'flowOn' instead").toString());
            }
        }
        this.e = cVar;
        q qVar = i.f7707a;
        ce.c cVar2 = this.f7703a;
        ...
        if (!kotlin.jvm.internal.i.a(c10, jd.a.f12959a)) {
            this.e = null;
        }
        return c10;
    }
