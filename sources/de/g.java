...
public final class g extends kd.c implements ce.c {
    public final ce.c f7717a;
    public final id.h f7718b;
    public final int f7719c;
    public id.h d;
    public kd.c e;

    public g(ce.c cVar, id.h hVar) {
        super(d.f7714a, id.i.f11083a);
        this.f7717a = cVar;
        this.f7718b = hVar;
        this.f7719c = ((Number) hVar.fold(0, f.f7716b)).intValue();
    }
    ...
    public final Object d(kd.c cVar, Object obj) {
        ...
        if (hVar != context) {
            ...
            if (hVar instanceof c) {
                String str2 = "\n            Flow exception transparency is violated:\n                Previous 'emit' call has thrown exception " + ((c) hVar).f7712a + ", but then emission attempt of value '" + obj + "' has been detected.\n                Emissions from 'catch' blocks are prohibited in order to avoid unspecified behaviour, 'Flow.catch' operator can be used instead.\n                For a more detailed explanation, please refer to Flow documentation.\n            ";
            ...
            } else if (((Number) context.fold(0, new j(this))).intValue() == this.f7719c) {
                this.d = context;
            } else {
                throw new IllegalStateException(("Flow invariant is violated:\n\t\tFlow was collected in " + this.f7718b + ",\n\t\tbut emission happened in " + context + ".\n\t\tPlease refer to 'flow' documentation or use 'flowOn' instead").toString());
            }
        }
        this.e = cVar;
        q qVar = i.f7721a;
        ce.c cVar2 = this.f7717a;
        ...
        if (!kotlin.jvm.internal.i.a(c10, jd.a.f12969a)) {
            this.e = null;
        }
        return c10;
    }
