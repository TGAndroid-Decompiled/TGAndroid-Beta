...
public final class j extends h8 {
    ...
    public static FontFamily h(o0.i[] iVarArr, ContentResolver contentResolver) {
        ...
        for (o0.i iVar : iVarArr) {
            try {
                openFileDescriptor = contentResolver.openFileDescriptor(iVar.f15318a, "r", null);
            } catch (IOException e) {
            ...
            if (openFileDescriptor == null) {
                ...
                Font build = new Font.Builder(openFileDescriptor).setWeight(iVar.f15320c).setSlant(iVar.d ? 1 : 0).setTtcIndex(iVar.f15319b).build();
                if (builder == null) {
