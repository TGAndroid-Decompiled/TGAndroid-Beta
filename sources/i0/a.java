...
public abstract class a {
    public static final ThreadLocal f8184a = new ThreadLocal();
    ...
    public static void b(float[] fArr, int i10, int i11, int i12) {
        ...
        float min3 = Math.min(f9, Math.min(f10, f11));
        float f12 = max - min3;
        ...
        if (max == min3) {
            ...
            if (max == f9) {
                ...
                A = com.google.android.recaptcha.internal.a.A(f11, f9, f12, 2.0f);
            } else {
                A = com.google.android.recaptcha.internal.a.A(f9, f10, f12, 4.0f);
            }
    ...
    public static double f(int i10) {
        ...
        double pow2;
        double pow3;
        ThreadLocal threadLocal = f8184a;
