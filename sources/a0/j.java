...
public abstract class j {
    ...
    public static final Object f21b = new Object();
    ...
    public static final int b(g gVar, Object obj, int i10) {
        ...
        try {
            ...
            if (a2 < 0 || kotlin.jvm.internal.i.a(obj, gVar.f12b[a2])) {
                return a2;
            }
            int i12 = a2 + 1;
            while (i12 < i11 && gVar.f11a[i12] == i10) {
                if (kotlin.jvm.internal.i.a(obj, gVar.f12b[i12])) {
                    return i12;
                }
                i12++;
            }
            for (int i13 = a2 - 1; i13 >= 0 && gVar.f11a[i13] == i10; i13--) {
                if (kotlin.jvm.internal.i.a(obj, gVar.f12b[i13])) {
                    return i13;
                }
            }
            return ~i12;
