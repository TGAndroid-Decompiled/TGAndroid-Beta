...
public final class h {
    ...
    public String L() {
        ...
        if (s10 > 0) {
            ...
            int i11 = hVar.f2225g;
            if (s10 <= i10 - i11) {
                String str = new String(bArr, i11, s10, z.f2305a);
                hVar.f2225g += s10;
                return str;
            }
        }
        ...
        if (s10 <= hVar.e) {
            hVar.D(s10);
            String str2 = new String(bArr, hVar.f2225g, s10, z.f2305a);
            hVar.f2225g += s10;
            return str2;
        }
        return new String(hVar.n(s10), z.f2305a);
    }
    ...
    public String N() {
        ...
        return u1.f2299a.e(i10, s10, bArr);
    }
    ...
    public void c(RecyclerView recyclerView, boolean z10) {
        ...
        if (recyclerView.f2858w != null && o0Var != null && o0Var.h) {
            if (z10) {
                if (!recyclerView.d.h()) {
                    int h = recyclerView.f2858w.h();
                    c0 c0Var = (c0) o0Var;
                    s4.b0 b0Var = c0Var.B;
                    if (b0Var != null && (i10 = b0Var.f42940a) >= 0) {
                        z11 = b0Var.f42942c;
                    } else {
                        c0Var.f1();
                        z11 = c0Var.v;
                ...
                if (c0Var2.r() != 0 && i13 != 0) {
                    ...
                    c0Var2.A0(z0Var, c0Var2.f42950p, this);
                }
            }
            int i15 = this.d;
            if (i15 > o0Var.f43058i) {
                o0Var.f43058i = i15;
                o0Var.f43059j = z10;
    ...
    public androidx.datastore.preferences.protobuf.g h() {
        ...
        if (s10 <= i10 - i11 && s10 > 0) {
            ...
            return androidx.datastore.preferences.protobuf.g.f2215c;
        } else {
            byte[] o9 = hVar.o(s10);
            if (o9 != null) {
            ...
            androidx.datastore.preferences.protobuf.g gVar = androidx.datastore.preferences.protobuf.g.f2215c;
