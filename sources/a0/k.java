...
public class k {
    ...
    public final void clear() {
        if (this.f28c > 0) {
            this.f26a = b0.a.f1875a;
            this.f27b = b0.a.f1877c;
            this.f28c = 0;
        }
        if (this.f28c <= 0) {
            return;
    ...
    public final Object f(int i10) {
        ...
        if (i10 >= 0 && i10 < (i11 = this.f28c)) {
            ...
            if (iArr.length > 8 && i11 < iArr.length / 3) {
                ...
                if (i11 == this.f28c) {
                    if (i10 > 0) {
                        rc.f.b(0, 0, i10, iArr, this.f26a);
                        rc.f.c(0, 0, i12, objArr, this.f27b);
                    }
                    if (i10 < i13) {
                        int i15 = i10 + 1;
                        rc.f.b(i10, i15, i11, iArr, this.f26a);
                        rc.f.c(i12, i15 << 1, i11 << 1, objArr, this.f27b);
                    }
                } else {
                    throw new ConcurrentModificationException();
                }
                ...
                if (i10 < i13) {
                    int i16 = i10 + 1;
                    rc.f.b(i10, i16, i11, iArr, iArr);
                    Object[] objArr2 = this.f27b;
                    rc.f.c(i12, i16 << 1, i11 << 1, objArr2, objArr2);
                }
    ...
    public final Object put(Object obj, Object obj2) {
        ...
        if (i13 < i11) {
            int[] iArr2 = this.f26a;
            int i15 = i13 + 1;
            rc.f.b(i15, i13, i11, iArr2, iArr2);
            Object[] objArr2 = this.f27b;
            rc.f.c(i15 << 1, i13 << 1, this.f28c << 1, objArr2, objArr2);
        }
        int i16 = this.f28c;
        if (i11 == i16) {
            int[] iArr3 = this.f26a;
