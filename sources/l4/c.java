...
public final class c extends c7 {
    public final w f11306a = new w();
    public final v f11307b = new v();
    public c0 f11308c;
    ...
    public final e4.c b(e4.e eVar, ByteBuffer byteBuffer) {
        ...
        boolean z26;
        long j18;
        c0 c0Var = this.f11308c;
        if (c0Var == null || eVar.f5104s != c0Var.d()) {
            c0 c0Var2 = new c0(eVar.f14242f);
            this.f11308c = c0Var2;
            c0Var2.a(eVar.f14242f - eVar.f5104s);
        }
                ...
                if (i20 != 4) {
                    if (i20 != 5) {
                        if (i20 != 6) {
                            ...
                            c0 c0Var3 = this.f11308c;
                            long a2 = k.a(i18, wVar);
                            obj = new k(a2, c0Var3.b(a2));
                        }
                    } else {
                        c0 c0Var4 = this.f11308c;
                        long v = wVar.v();
                        if ((wVar.u() & 128) != 0) {
                            z17 = true;
                        } else {
