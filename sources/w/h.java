...
public abstract class h {
    public static final ArrayMap f49351a;
    public static final ArrayMap f49352b;
    ...
    public static Object f(Bundle bundle, f fVar) {
        ...
        String str2 = (String) f49352b.get(Integer.valueOf(bundle.getInt("tag_class_type")));
        if (str2 == null) {
            str2 = "unknown";
        }
        f fVar2 = new f(bundle, str2, fVar.f49350b);
        try {
            switch (i10) {
                case 0:
    ...
    public static String i(Class cls) {
        String str = (String) f49351a.get(cls);
        if (str == null) {
    ...
    public static Bundle o(Object obj, String str, f fVar) {
        ArrayDeque arrayDeque = fVar.f49350b;
        if (obj != null) {
            Iterator it = arrayDeque.iterator();
            while (it.hasNext()) {
                if (((e) it.next()).f49347a == obj) {
