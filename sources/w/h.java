...
public abstract class h {
    public static final ArrayMap f44495a;
    public static final ArrayMap f44496b;
    ...
    public static Object f(Bundle bundle, e eVar) {
        ...
        String str2 = (String) f44496b.get(Integer.valueOf(bundle.getInt("tag_class_type")));
        if (str2 == null) {
            str2 = "unknown";
        }
        e eVar2 = new e(bundle, str2, eVar.f44494b);
        try {
            switch (i10) {
                case 0:
    ...
    public static String i(Class cls) {
        String str = (String) f44495a.get(cls);
        if (str == null) {
    ...
    public static Bundle o(Object obj, String str, e eVar) {
        ArrayDeque arrayDeque = eVar.f44494b;
        if (obj != null) {
            Iterator it = arrayDeque.iterator();
            while (it.hasNext()) {
                if (((d) it.next()).f44491a == obj) {
