...
public final class f implements AutoCloseable {
    ...
    public final ArrayDeque f49313b;

    public f(Object obj, String str, ArrayDeque arrayDeque) {
        this.f49313b = arrayDeque;
        if (obj != null) {
            ...
            if (Log.isLoggable("CarApp.Bun", 2)) {
                ...
                if (this.f49312a == null) {
                    this.f49312a = new String[12];
                }
                String str2 = this.f49312a[min];
                if (str2 == null) {
    ...
    public final String a() {
        StringBuilder sb = new StringBuilder();
        ArrayDeque arrayDeque = this.f49313b;
