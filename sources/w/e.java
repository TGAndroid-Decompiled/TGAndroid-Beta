...
public final class e implements AutoCloseable {
    ...
    public final ArrayDeque f44489b;

    public e(Object obj, String str, ArrayDeque arrayDeque) {
        this.f44489b = arrayDeque;
        if (obj != null) {
            ...
            if (Log.isLoggable("CarApp.Bun", 2)) {
                ...
                if (this.f44488a == null) {
                    this.f44488a = new String[12];
                }
                String str2 = this.f44488a[min];
                if (str2 == null) {
    ...
    public final String a() {
        StringBuilder sb2 = new StringBuilder();
        ArrayDeque arrayDeque = this.f44489b;
