...
public final class e implements AutoCloseable {
    ...
    public final ArrayDeque f44746b;

    public e(Object obj, String str, ArrayDeque arrayDeque) {
        this.f44746b = arrayDeque;
        if (obj != null) {
            ...
            if (Log.isLoggable("CarApp.Bun", 2)) {
                ...
                if (this.f44745a == null) {
                    this.f44745a = new String[12];
                }
                String str2 = this.f44745a[min];
                if (str2 == null) {
    ...
    public final String a() {
        StringBuilder sb2 = new StringBuilder();
        ArrayDeque arrayDeque = this.f44746b;
