...
public final class h implements Iterable {
    ...
    public final void i(float f10) {
        ...
        boolean z17;
        g gVar = this.d;
        boolean a2 = gVar.f50518b.a(f10);
        if (!gVar.d.a(f10) && !a2) {
            z4 = false;
        } else {
            z4 = true;
        }
        if (!gVar.f50520e.a(f10) && !z4) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (!gVar.f50521f.a(f10) && !z10) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (!gVar.f50522g.a(f10) && !z11) {
            z12 = false;
        } else {
            z12 = true;
        }
        if (!gVar.f50519c.a(f10) && !z12) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!gVar.f50517a.l(f10) && !z13) {
            z14 = false;
        } else {
            z14 = true;
        }
        ...
        while (i10 < size) {
            ...
            i10++;
            e eVar = (e) obj;
            boolean a10 = eVar.f50514c.a(f10);
            if (!eVar.d.a(f10) && !a10) {
                z15 = false;
            } else {
                z15 = true;
            }
            if (!eVar.f50515e.a(f10) && !z15) {
                z16 = false;
            } else {
                z16 = true;
            }
            if (!eVar.f50516f.a(f10) && !z16) {
                z17 = false;
            } else {
                z17 = true;
            }
            Object obj2 = eVar.f50512a;
    ...
    public final Iterator iterator() {
        return this.f50524b.iterator();
    }

    public final e n(int i10) {
        return (e) this.f50524b.get(i10);
    }

    public final void o(boolean z4) {
        ArrayList arrayList;
        boolean z10;
        ArrayList arrayList2 = this.f50526e;
        ...
        ArrayList arrayList3 = this.f50524b;
        if (z4) {
        ...
        while (i18 < size3) {
            ...
            i18++;
            Object obj6 = ((e) obj5).f50512a;
        }
        g gVar = this.d;
        if (z4) {
            k kVar2 = gVar.f50521f;
            d dVar = gVar.f50517a;
            k kVar3 = gVar.f50520e;
            k kVar4 = gVar.d;
            k kVar5 = gVar.f50522g;
            float f15 = i10;
            if (kVar2.b(f15)) {
                p();
                gVar.f50521f.f50531c = f15;
            }
            float f16 = i11;
            if (kVar5.b(f16)) {
                p();
    ...
    public final void r(List list, boolean z4) {
        ...
        c cVar = this.f50525c;
        g gVar = this.d;
        ArrayList arrayList = this.f50526e;
        ArrayList arrayList2 = this.f50524b;
        if (!z4) {
            if (cVar != null) {
                cVar.b();
                q(false);
            ...
            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                Object obj = ((e) arrayList2.get(size)).f50512a;
                if (obj instanceof ae.a) {
                    ((ae.a) obj).a();
                }
            }
        ...
        if (!isEmpty) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    Object obj3 = eVar2.f50512a;
                    k kVar = eVar2.d;
                    k kVar2 = eVar2.f50514c;
                    ...
                    if (indexOf != -1) {
                        ...
                        if (eVar2.f50513b != indexOf) {
                            eVar2.f50513b = indexOf;
                            if (!z13 && eVar2.h) {
                                z13 = false;
                            } else {
                                z13 = true;
            ...
            if (this.f50527f) {
                ...
                while (i20 < size6) {
                    ...
                    e eVar5 = (e) obj9;
                    k kVar3 = eVar5.d;
                    kVar3.f50530b = kVar3.f50529a;
                    k kVar4 = eVar5.f50514c;
                    kVar4.f50530b = kVar4.f50529a;
                }
            }
        }
    }
