...
public final class h implements Iterable {
    ...
    public final c f46910c;
    public final g d;
    public boolean f46911f;
    public final ArrayList f46909b = new ArrayList();
    ...
    public h(d dVar, Interpolator interpolator, long j10) {
        ...
        if (interpolator != null && j10 > 0) {
            this.f46910c = new c(0, new p1(this), interpolator, j10);
        } else {
            this.f46910c = null;
        }
    }
    ...
    public final void i(float f10) {
        ...
        if (!gVar.f46906f.a(f10) && !z10) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (!gVar.f46907g.a(f10) && !z11) {
            z12 = false;
        } else {
            z12 = true;
        }
        if (!gVar.f46905c.a(f10) && !z12) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!gVar.f46903a.j(f10) && !z13) {
            z14 = false;
        } else {
            z14 = true;
        }
        ArrayList arrayList = this.f46909b;
        ...
        while (i10 < size) {
            ...
            i10++;
            e eVar = (e) obj;
            boolean a10 = eVar.f46901c.a(f10);
            if (!eVar.d.a(f10) && !a10) {
                z15 = false;
            } else {
                z15 = true;
            ...
            if (!eVar.f46902f.a(f10) && !z16) {
                z17 = false;
            } else {
                z17 = true;
            }
            Object obj2 = eVar.f46899a;
    ...
    public final Iterator iterator() {
        return this.f46909b.iterator();
    }

    public final e n(int i10) {
        return (e) this.f46909b.get(i10);
    }
    ...
    public final void o(boolean z4) {
        ...
        ArrayList arrayList3 = this.f46909b;
        if (z4) {
        ...
        while (i18 < size3) {
            ...
            i18++;
            Object obj6 = ((e) obj5).f46899a;
        }
        g gVar = this.d;
        if (z4) {
            k kVar2 = gVar.f46906f;
            d dVar = gVar.f46903a;
            k kVar3 = gVar.e;
            k kVar4 = gVar.d;
            k kVar5 = gVar.f46907g;
            float f15 = i10;
            if (kVar2.b(f15)) {
                p();
                gVar.f46906f.f46915c = f15;
            }
            float f16 = i11;
            if (kVar5.b(f16)) {
                p();
    ...
    public final void r(List list, boolean z4) {
        ...
        ArrayList arrayList2 = this.f46909b;
        if (!z4) {
            if (cVar != null) {
                cVar.b();
                q(false);
            ...
            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                Object obj = ((e) arrayList2.get(size)).f46899a;
                if (obj instanceof ae.a) {
                    ((ae.a) obj).a();
                }
            }
        ...
        if (!isEmpty) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    Object obj3 = eVar2.f46899a;
                    k kVar = eVar2.d;
                    k kVar2 = eVar2.f46901c;
                    ...
                    if (indexOf != -1) {
                        ...
                        if (eVar2.f46900b != indexOf) {
                            eVar2.f46900b = indexOf;
                            if (!z13 && eVar2.h) {
                                z13 = false;
                            } else {
                                z13 = true;
            ...
            if (this.f46911f) {
                ...
                while (i20 < size6) {
                    ...
                    e eVar5 = (e) obj9;
                    k kVar3 = eVar5.d;
                    kVar3.f46914b = kVar3.f46913a;
                    k kVar4 = eVar5.f46901c;
                    kVar4.f46914b = kVar4.f46913a;
                }
            }
        }
    }
