...
public final class c {
    ...
    public final b f50507b;
    public final Interpolator f50508c;
    public final long d;
    public float f50509e;
    public float f50510f;
    public boolean f50511g;
    public ValueAnimator h;

    public c(int i10, b bVar, Interpolator interpolator, long j10) {
        this.f50506a = i10;
        this.f50507b = bVar;
        this.f50508c = interpolator;
        this.d = j10;
    }
    ...
    public final void a(float f10) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            this.h.setInterpolator(this.f50508c);
    ...
    public final void c(float f10) {
        ...
        this.f50507b.z(f10, this.f50506a);
    }

    public final boolean d(float f10, float f11) {
        if (this.f50509e != f10) {
            this.f50509e = f10;
            this.f50507b.L(this.f50506a, f10, f11, this);
            return true;
        }
        return false;
    }
