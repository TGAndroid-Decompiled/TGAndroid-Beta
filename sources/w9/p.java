...
public final class p {
    public static final HashMap f48432f;
    public static final String f48433g;
    public final Context f48434a;
    public final u f48435b;
    public final a f48436c;
    public final y d;
    public final da.b f48437e;
    ...
    static {
        ...
        f48433g = "Crashlytics Android SDK/18.6.0";
    }
    ...
    public final List a() {
        a aVar = this.f48436c;
        String str = aVar.f48372e;
        if (str != null) {
            return Collections.singletonList(new o0(str, 0L, 0L, aVar.f48370b));
        }
