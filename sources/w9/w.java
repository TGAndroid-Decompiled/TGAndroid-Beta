...
public final class w implements Continuation {
    ...
    public final TaskCompletionSource f45017b;

    public w(int i10, TaskCompletionSource taskCompletionSource) {
        this.f45016a = i10;
        this.f45017b = taskCompletionSource;
    }
    ...
    public final Object then(Task task) {
        switch (this.f45016a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f45017b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f45017b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f45017b;
                if (isSuccessful3) {
