...
public final class v implements Continuation {
    ...
    public final TaskCompletionSource f45266b;

    public v(int i10, TaskCompletionSource taskCompletionSource) {
        this.f45265a = i10;
        this.f45266b = taskCompletionSource;
    }
    ...
    public final Object then(Task task) {
        switch (this.f45265a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f45266b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f45266b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f45266b;
                if (isSuccessful3) {
