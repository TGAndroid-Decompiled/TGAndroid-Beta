...
public final class v implements Continuation {
    ...
    public final TaskCompletionSource f48488b;

    public v(int i10, TaskCompletionSource taskCompletionSource) {
        this.f48487a = i10;
        this.f48488b = taskCompletionSource;
    }
    ...
    public final Object then(Task task) {
        switch (this.f48487a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f48488b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f48488b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f48488b;
                if (isSuccessful3) {
