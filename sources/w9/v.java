    ...
    public final Object then(Task task) {
        switch (this.f45252a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f45253b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f45253b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f45253b;
                if (isSuccessful3) {
