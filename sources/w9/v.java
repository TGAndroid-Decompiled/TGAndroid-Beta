...
public final class v implements Continuation {
    ...
    public final TaskCompletionSource f45268b;

    public v(int i10, TaskCompletionSource taskCompletionSource) {
        this.f45267a = i10;
        this.f45268b = taskCompletionSource;
    }
    ...
    public final Object then(Task task) {
        switch (this.f45267a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f45268b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f45268b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f45268b;
                if (isSuccessful3) {
