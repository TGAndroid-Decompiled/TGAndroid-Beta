...
public final class v implements Continuation {
    ...
    public final TaskCompletionSource f48459b;

    public v(int i10, TaskCompletionSource taskCompletionSource) {
        this.f48458a = i10;
        this.f48459b = taskCompletionSource;
    }
    ...
    public final Object then(Task task) {
        switch (this.f48458a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f48459b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f48459b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f48459b;
                if (isSuccessful3) {
