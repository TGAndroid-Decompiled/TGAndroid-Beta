...
public final class v implements Continuation {
    ...
    public final TaskCompletionSource f48458b;

    public v(int i10, TaskCompletionSource taskCompletionSource) {
        this.f48457a = i10;
        this.f48458b = taskCompletionSource;
    }
    ...
    public final Object then(Task task) {
        switch (this.f48457a) {
            case 0:
                ...
                TaskCompletionSource taskCompletionSource = this.f48458b;
                if (isSuccessful) {
            ...
            case 1:
                ...
                TaskCompletionSource taskCompletionSource2 = this.f48458b;
                if (isSuccessful2) {
            ...
            default:
                ...
                TaskCompletionSource taskCompletionSource3 = this.f48458b;
                if (isSuccessful3) {
