...
public final class k implements Callable {
    ...
    public final Throwable f44954b;
    public final Thread f44955c;
    public final da.b d;
    public final m e;
    ...
    public final Object call() {
        ...
        nVar.v(this.f44954b, this.f44955c, e, "crash", j10, true);
        try {
            cVar = mVar.f44963g;
            str = ".ae" + j3;
            cVar.getClass();
        ...
        mVar.c(false, bVar);
        new f(mVar.f44962f);
        m.a(mVar, f.f44943b, Boolean.FALSE);
        if (!mVar.f44960b.a()) {
            return Tasks.forResult(null);
        }
