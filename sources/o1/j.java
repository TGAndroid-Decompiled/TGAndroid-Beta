...
public final class j extends h {
    ...
    public final void f() {
        k kVar = this.f16178u;
        if (kVar != null) {
            double d = (float) kVar.f16184i;
            if (d <= this.f16173g) {
                if (d >= this.h) {
                    double abs = Math.abs(this.f16175j * 0.75f);
                    kVar.d = abs;
                    kVar.e = abs * 62.5d;
                    if (Looper.myLooper() == Looper.getMainLooper()) {
                        boolean z4 = this.f16172f;
                        if (!z4 && !z4) {
                            this.f16172f = true;
                            if (!this.f16171c) {
                                this.f16170b = this.e.a(this.d);
                            }
                            float f10 = this.f16170b;
                            if (f10 <= this.f16173g && f10 >= this.h) {
