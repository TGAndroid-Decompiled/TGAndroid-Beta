...
public final class o0 extends n1 {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof n1) {
            o0 o0Var = (o0) ((n1) obj);
            String str2 = o0Var.d;
            if (this.f10212a == o0Var.f10212a && this.f10213b == o0Var.f10213b && this.f10214c.equals(o0Var.f10214c) && ((str = this.d) != null ? str.equals(str2) : str2 == null)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        ...
        long j11 = this.f10213b;
        int hashCode2 = (((((((int) (j10 ^ (j10 >>> 32))) ^ 1000003) * 1000003) ^ ((int) (j11 ^ (j11 >>> 32)))) * 1000003) ^ this.f10214c.hashCode()) * 1000003;
        String str = this.d;
        if (str == null) {
            hashCode = 0;
        } else {
