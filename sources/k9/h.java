...
public final class h {
    public static final Object f13546k = new Object();
    public static final a0.f f13547l = new m(0);
    public final Context f13548a;
    public final String f13549b;
    public final j f13550c;
    public final q9.g d;
    public final AtomicBoolean e;
    public final AtomicBoolean f13551f;
    public final n f13552g;
    public final pa.b h;
    public final CopyOnWriteArrayList f13553i;
    public final CopyOnWriteArrayList f13554j;

    public h(Context context, String str, j jVar) {
        boolean z10;
        AtomicBoolean atomicBoolean = new AtomicBoolean(false);
        this.e = atomicBoolean;
        this.f13551f = new AtomicBoolean();
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        this.f13553i = copyOnWriteArrayList;
        this.f13554j = new CopyOnWriteArrayList();
        this.f13548a = context;
        l.f(str);
        this.f13549b = str;
        this.f13550c = jVar;
        a aVar = FirebaseInitProvider.f7367a;
        ...
        if (z10 && FirebaseInitProvider.f7368b.get()) {
        ...
        if (atomicBoolean.get()) {
            com.google.android.gms.common.api.internal.d.e.f6060a.get();
        }
    ...
    public static h c() {
        h hVar;
        synchronized (f13546k) {
            try {
                hVar = (h) f13547l.get("[DEFAULT]");
                if (hVar != null) {
                    ((na.c) hVar.h.get()).c();
                } else {
    ...
    public static h f(Context context) {
        synchronized (f13546k) {
            try {
                if (f13547l.containsKey("[DEFAULT]")) {
                    return c();
                }
                j a2 = j.a(context);
                if (a2 == null) {
    ...
    public static h g(Context context, j jVar) {
        h hVar;
        AtomicReference atomicReference = f.f13543a;
        if (context.getApplicationContext() instanceof Application) {
            Application application = (Application) context.getApplicationContext();
            AtomicReference atomicReference2 = f.f13543a;
    ...
    public final void a() {
        l.j("FirebaseApp was deleted", !this.f13551f.get());
    }
    ...
    public final String d() {
        ...
        a();
        sb2.append(u6.b.c(this.f13549b.getBytes(Charset.defaultCharset())));
        sb2.append("+");
        a();
        sb2.append(u6.b.c(this.f13550c.f13559b.getBytes(Charset.defaultCharset())));
        return sb2.toString();
    }
    ...
    public final void e() {
        ...
        if (!z10) {
            ...
            AtomicReference atomicReference = g.f13544b;
    ...
    public final boolean equals(Object obj) {
        ...
        h hVar = (h) obj;
        hVar.a();
        return this.f13549b.equals(hVar.f13549b);
    }
    ...
    public final String toString() {
        y yVar = new y(this);
        yVar.e(this.f13549b, "name");
        yVar.e(this.f13550c, "options");
