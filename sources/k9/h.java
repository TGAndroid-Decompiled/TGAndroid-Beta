...
public final class h {
    ...
    public static h c() {
        h hVar;
        synchronized (f13534k) {
            try {
                hVar = (h) f13535l.get("[DEFAULT]");
                if (hVar != null) {
                    ((na.c) hVar.h.get()).c();
                } else {
    ...
    public static h f(Context context) {
        synchronized (f13534k) {
            try {
                if (f13535l.containsKey("[DEFAULT]")) {
                    return c();
                }
                j a2 = j.a(context);
                if (a2 == null) {
    ...
    public static h g(Context context, j jVar) {
        h hVar;
        AtomicReference atomicReference = f.f13531a;
        if (context.getApplicationContext() instanceof Application) {
            Application application = (Application) context.getApplicationContext();
            AtomicReference atomicReference2 = f.f13531a;
    ...
    public final void a() {
        l.j("FirebaseApp was deleted", !this.f13539f.get());
    }
    ...
    public final String d() {
        ...
        a();
        sb2.append(u6.b.c(this.f13537b.getBytes(Charset.defaultCharset())));
        sb2.append("+");
        a();
        sb2.append(u6.b.c(this.f13538c.f13547b.getBytes(Charset.defaultCharset())));
        return sb2.toString();
    }
    ...
    public final void e() {
        ...
        if (!z10) {
            ...
            AtomicReference atomicReference = g.f13532b;
    ...
    public final boolean equals(Object obj) {
        ...
        h hVar = (h) obj;
        hVar.a();
        return this.f13537b.equals(hVar.f13537b);
    }

    public final boolean h() {
        boolean z10;
        a();
        ua.a aVar = (ua.a) this.f13540g.get();
        synchronized (aVar) {
            z10 = aVar.f43596a;
        }
        return z10;
    ...
    public final String toString() {
        y yVar = new y(this);
        yVar.e(this.f13537b, "name");
        yVar.e(this.f13538c, "options");
