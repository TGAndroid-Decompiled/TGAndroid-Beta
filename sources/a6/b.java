...
public final class b {
    ...
    public final void c(GoogleSignInAccount googleSignInAccount, GoogleSignInOptions googleSignInOptions) {
        ...
        String str = googleSignInAccount.f5957r;
        e("defaultGoogleSignInAccount", str);
        String f7 = f("googleSignInAccount", str);
        JSONObject jSONObject = new JSONObject();
        try {
            String str2 = googleSignInAccount.f5953b;
            if (str2 != null) {
                jSONObject.put("id", str2);
            }
            String str3 = googleSignInAccount.f5954c;
            if (str3 != null) {
            ...
            String str7 = googleSignInAccount.f5959w;
            if (str7 != null) {
                jSONObject.put("familyName", str7);
            }
            Uri uri = googleSignInAccount.f5955f;
            if (uri != null) {
            ...
            jSONObject.put("expirationTime", googleSignInAccount.f5956n);
            jSONObject.put("obfuscatedIdentifier", str);
            JSONArray jSONArray = new JSONArray();
            List list = googleSignInAccount.f5958s;
            Scope[] scopeArr = (Scope[]) list.toArray(new Scope[list.size()]);
            Arrays.sort(scopeArr, z5.c.f48183b);
            int i10 = 0;
            for (Scope scope : scopeArr) {
                jSONArray.put(scope.f6018b);
            }
            jSONObject.put("grantedScopes", jSONArray);
            jSONObject.remove("serverAuthCode");
            e(f7, jSONObject.toString());
            String f10 = f("googleSignInOptions", str);
            String str9 = googleSignInOptions.f5968n;
            String str10 = googleSignInOptions.h;
            ArrayList arrayList = googleSignInOptions.f5965b;
            ...
            try {
                ...
                while (i10 < size) {
                    ...
                    i10++;
                    jSONArray2.put(((Scope) obj).f6018b);
                }
                jSONObject2.put("scopes", jSONArray2);
                Account account = googleSignInOptions.f5966c;
                if (account != null) {
                    jSONObject2.put("accountName", account.name);
                }
                jSONObject2.put("idTokenRequested", googleSignInOptions.d);
                jSONObject2.put("forceCodeForRefreshToken", googleSignInOptions.f5967f);
