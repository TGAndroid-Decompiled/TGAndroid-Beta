...
public final class e extends n6.g {
    ...
    public e(Context context, Looper looper, p3 p3Var, GoogleSignInOptions googleSignInOptions, com.google.android.gms.common.api.k kVar, com.google.android.gms.common.api.l lVar) {
        ...
        if (googleSignInOptions != null) {
            ?? obj = new Object();
            obj.f48095a = new HashSet();
            obj.h = new HashMap();
            obj.f48095a = new HashSet(googleSignInOptions.f5948b);
            obj.f48096b = googleSignInOptions.e;
            obj.f48097c = googleSignInOptions.f5950f;
            obj.d = googleSignInOptions.d;
            obj.e = googleSignInOptions.h;
            obj.f48098f = googleSignInOptions.f5949c;
            obj.f48099g = googleSignInOptions.f5951n;
            obj.h = GoogleSignInOptions.c(googleSignInOptions.f5952r);
            obj.f48100i = googleSignInOptions.f5953s;
            aVar = obj;
        } else {
            ?? obj2 = new Object();
            obj2.f48095a = new HashSet();
            obj2.h = new HashMap();
            aVar = obj2;
        }
        aVar.f48100i = i7.e.a();
        if (!set.isEmpty()) {
            for (Scope scope : set) {
                HashSet hashSet = aVar.f48095a;
                hashSet.add(scope);
                hashSet.addAll(Arrays.asList(new Scope[0]));
            }
        }
        HashSet hashSet2 = aVar.f48095a;
        ...
        if (aVar.d && (aVar.f48098f == null || !hashSet2.isEmpty())) {
            hashSet2.add(GoogleSignInOptions.f5945x);
        }
        this.U = new GoogleSignInOptions(3, new ArrayList(hashSet2), aVar.f48098f, aVar.d, aVar.f48096b, aVar.f48097c, aVar.e, aVar.f48099g, aVar.h, aVar.f48100i);
    }
    ...
    public final Intent o() {
        return h.a(this.f15009n, this.U);
    }
