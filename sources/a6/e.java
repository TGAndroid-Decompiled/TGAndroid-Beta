...
public final class e extends n6.g {
    ...
    public e(Context context, Looper looper, p3 p3Var, GoogleSignInOptions googleSignInOptions, com.google.android.gms.common.api.k kVar, com.google.android.gms.common.api.l lVar) {
        ...
        if (googleSignInOptions != null) {
            ?? obj = new Object();
            obj.f48406a = new HashSet();
            obj.h = new HashMap();
            obj.f48406a = new HashSet(googleSignInOptions.f5965b);
            obj.f48407b = googleSignInOptions.e;
            obj.f48408c = googleSignInOptions.f5967f;
            obj.d = googleSignInOptions.d;
            obj.e = googleSignInOptions.h;
            obj.f48409f = googleSignInOptions.f5966c;
            obj.f48410g = googleSignInOptions.f5968n;
            obj.h = GoogleSignInOptions.c(googleSignInOptions.f5969r);
            obj.f48411i = googleSignInOptions.f5970s;
            aVar = obj;
        } else {
            ?? obj2 = new Object();
            obj2.f48406a = new HashSet();
            obj2.h = new HashMap();
            aVar = obj2;
        }
        aVar.f48411i = i7.e.a();
        if (!set.isEmpty()) {
            for (Scope scope : set) {
                HashSet hashSet = aVar.f48406a;
                hashSet.add(scope);
                hashSet.addAll(Arrays.asList(new Scope[0]));
            }
        }
        HashSet hashSet2 = aVar.f48406a;
        ...
        if (aVar.d && (aVar.f48409f == null || !hashSet2.isEmpty())) {
            hashSet2.add(GoogleSignInOptions.f5962x);
        }
        this.U = new GoogleSignInOptions(3, new ArrayList(hashSet2), aVar.f48409f, aVar.d, aVar.f48407b, aVar.f48408c, aVar.e, aVar.f48410g, aVar.h, aVar.f48411i);
    }
    ...
    public final Intent o() {
        return h.a(this.f15219n, this.U);
    }
