...
public final class e extends n6.g {
    ...
    public e(Context context, Looper looper, p3 p3Var, GoogleSignInOptions googleSignInOptions, com.google.android.gms.common.api.k kVar, com.google.android.gms.common.api.l lVar) {
        ...
        if (googleSignInOptions != null) {
            ?? obj = new Object();
            obj.f48412a = new HashSet();
            obj.h = new HashMap();
            obj.f48412a = new HashSet(googleSignInOptions.f5948b);
            obj.f48413b = googleSignInOptions.e;
            obj.f48414c = googleSignInOptions.f5950f;
            obj.d = googleSignInOptions.d;
            obj.e = googleSignInOptions.h;
            obj.f48415f = googleSignInOptions.f5949c;
            obj.f48416g = googleSignInOptions.f5951n;
            obj.h = GoogleSignInOptions.c(googleSignInOptions.f5952r);
            obj.f48417i = googleSignInOptions.f5953s;
            aVar = obj;
        } else {
            ?? obj2 = new Object();
            obj2.f48412a = new HashSet();
            obj2.h = new HashMap();
            aVar = obj2;
        }
        aVar.f48417i = i7.e.a();
        if (!set.isEmpty()) {
            for (Scope scope : set) {
                HashSet hashSet = aVar.f48412a;
                hashSet.add(scope);
                hashSet.addAll(Arrays.asList(new Scope[0]));
            }
        }
        HashSet hashSet2 = aVar.f48412a;
        ...
        if (aVar.d && (aVar.f48415f == null || !hashSet2.isEmpty())) {
            hashSet2.add(GoogleSignInOptions.f5945x);
        }
        this.U = new GoogleSignInOptions(3, new ArrayList(hashSet2), aVar.f48415f, aVar.d, aVar.f48413b, aVar.f48414c, aVar.e, aVar.f48416g, aVar.h, aVar.f48417i);
    }
    ...
    public final Intent o() {
        return h.a(this.f15247n, this.U);
    }
