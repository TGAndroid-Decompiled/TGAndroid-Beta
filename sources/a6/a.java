...
public final class a extends c6.a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof a)) {
            a aVar = (a) obj;
            if (m.l(this.f120b, aVar.f120b) && this.f121c == aVar.f121c && this.d == aVar.d) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{this.f120b, Integer.valueOf(this.f121c), Integer.valueOf(this.d)});
    }

    public final String toString() {
        Locale locale = Locale.US;
        String uri = this.f120b.toString();
        StringBuilder m9 = c.m("Image ", this.f121c, "x", this.d, " ");
        m9.append(uri);
        return m9.toString();
    }
