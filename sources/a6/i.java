...
public final class i implements m0, s, fc, a0, androidx.activity.result.b, p, ka0, d71, k0, v0, OnCompleteListener, n, r0.n, db.n, he.b, ii.k0, u3 {
    ...
    public n70 D(View view) {
        return n70.H((d2) this.f301b, view);
    }
    ...
    public q9 E() {
        switch (this.f300a) {
            case 26:
                q3 q3Var = ((z) this.f301b).O;
                if (q3Var != null) {
                    return q3Var.f11570a.getTextSelectionHelper();
                }
                return null;
            default:
                p3 p3Var = ((u4) this.f301b).N;
                if (p3Var != null) {
                    return p3Var.f11559a.getTextSelectionHelper();
                }
                return null;
        }
    }
    ...
    public void H(t3 t3Var, View view) {
        ...
        H.Q = true;
        d2Var.f11326x0 = j4.c(H, d2Var, d2Var.getParentActivity(), d2Var.getResourceProvider(), t3Var, false);
    }
        ...
        switch (this.f300a) {
            case 26:
                ...
                if (q3Var != null) {
                    ...
                    if (charSequence != null && charSequence.length() > 0) {
                        q3Var.f11570a.t4(charSequence.toString());
                        return;
                    }
                    return;
                }
            ...
            default:
                ...
                if (p3Var != null) {
                    p3Var.getClass();
                    if (charSequence != null && charSequence.length() > 0) {
                        p3Var.f11559a.t4(charSequence.toString());
                        return;
                    }
                    return;
                }
    ...
    public ii.a N() {
        switch (this.f300a) {
            case 26:
                return ((z) this.f301b).f11217a;
            default:
                return ((u4) this.f301b).f11217a;
        }
    }
    ...
    public boolean P() {
        switch (this.f300a) {
            case 26:
                ...
                return false;
            default:
                u4 u4Var = (u4) this.f301b;
                p3 p3Var = u4Var.N;
                if (p3Var != null) {
                    ii.a aVar2 = u4Var.f11217a;
                    if (p3Var.f11559a.S4()) {
                        return true;
                    }
                }
    ...
    public da.a Q(JSONObject jSONObject) {
        ...
        return bVar.s2((na.d) this.f301b, jSONObject);
    }
    ...
    public l1 Q0(View view, l1 l1Var) {
        ...
        int d10 = l1Var.d();
        ActionBarContextView actionBarContextView = sVar.f9309y;
        int i10 = 8;
        if (actionBarContextView != null && (actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) sVar.f9309y.getLayoutParams();
            boolean z12 = true;
            if (sVar.f9309y.isShown()) {
                if (sVar.f9300l0 == null) {
                    sVar.f9300l0 = new Rect();
                    sVar.m0 = new Rect();
                }
                Rect rect = sVar.f9300l0;
                Rect rect2 = sVar.m0;
                rect.set(l1Var.b(), l1Var.d(), l1Var.c(), l1Var.a());
                ViewGroup viewGroup = sVar.J;
                Method method = m.t3.f14314a;
                if (method != null) {
                    try {
            ...
            if (z12) {
                sVar.f9309y.setLayoutParams(marginLayoutParams);
            }
        } else {
            z10 = false;
        }
    ...
    public db.i R(Object obj) {
        db.g gVar = ((gb.a0) this.f301b).f9530b;
        gVar.getClass();
        if (obj == null) {
            return db.k.f7604a;
        }
    ...
    public void a0() {
        switch (this.f300a) {
            ...
            default:
                ...
                if (p3Var != null) {
                    ii.a aVar2 = u4Var.f11217a;
                    w3 w3Var2 = p3Var.f11559a;
                    h2 h2Var2 = w3Var2.J3;
                    if (h2Var2 != null) {
                        h2Var2.g();
                    }
                    w3Var2.f11711h3.onContentChanged();
                    return;
                }
                return;
        }
    ...
    public void accept(Object obj, Object obj2) {
        switch (this.f300a) {
            ...
            case 22:
                ...
                q7.a.b(obtain2, (g7.f) this.f301b);
                q7.a.b(obtain2, gVar);
            ...
            default:
                ...
                Parcel K0 = iVar.K0();
                int i12 = i7.f.f11018a;
                K0.writeStrongBinder(lVar);
                i7.f.c(K0, (x5.e) this.f301b);
                iVar.L0(K0, 1);
                return;
        }
    }
    ...
    public WebViewProviderBoundaryInterface createWebView(WebView webView) {
        return (WebViewProviderBoundaryInterface) se.b.a(WebViewProviderBoundaryInterface.class, ((WebViewProviderFactoryBoundaryInterface) this.f301b).createWebView(webView));
    }
    ...
    public void d(v3 v3Var, View view) {
        ...
        d2Var.f11326x0 = j4.b(H, d2Var, v3Var, false);
    }
    ...
    public boolean e(float f7) {
        boolean z10;
        d2 d2Var = (d2) this.f301b;
        FrameLayout frameLayout = d2Var.f11322v0;
        if (frameLayout != null) {
            int[] iArr = new int[2];
    ...
    public boolean f1(long j3, int i10, int i11, int i12, gc gcVar) {
        ...
        gcVar.f911b = null;
        gcVar.f912c = null;
        rz0 rz0Var = (rz0) this.f301b;
        m01 m01Var = rz0Var.h;
        ArrayList arrayList = rz0Var.f31543w;
        if (rz0Var.N < 0.2f) {
            gcVar.f911b = m01Var.getImageReceiver();
            gcVar.f912c = null;
            gcVar.f910a = m01Var;
            gcVar.h = 0.0f;
            gcVar.f915i = AndroidUtilities.displaySize.y;
            gcVar.f914g = (View) rz0Var.getParent();
            gcVar.d = rz0Var.f31545y;
            gcVar.f920n = true;
            return true;
        }
        int i13 = 0;
        while (true) {
            if (i13 < arrayList.size()) {
                ...
                if (i6Var5.e >= 1.0f && i6Var5.f979a == i11) {
                    int i14 = i13 - 1;
                    if (i14 >= 0) {
        ...
        if (i6Var != null && i6Var2 != null) {
            gcVar.f913f = new h6(this, new RectF(i6Var.f988m), i6Var, new RectF(i6Var2.f988m), i6Var2);
            return true;
        }
        gcVar.f913f = null;
        return true;
    ...
    public void g(d6 d6Var, String str) {
        d2 d2Var = (d2) this.f301b;
        if (d2Var.f11329z0 == null) {
            d2Var.f11329z0 = new m.q3(new d5(this, 16), d2Var.getResourceProvider());
        }
        d2Var.f11329z0.f(d6Var, str);
    }

    @Override
    public StaticsBoundaryInterface getStatics() {
        return (StaticsBoundaryInterface) se.b.a(StaticsBoundaryInterface.class, ((WebViewProviderFactoryBoundaryInterface) this.f301b).getStatics());
    }

    @Override
    public void h(int i10) {
        ((d2) this.f301b).o0(74, i10);
    }
    ...
    public void i() {
        switch (this.f300a) {
            case 26:
                ...
                q3 q3Var = zVar.O;
                if (q3Var != null) {
                    w3.P1(q3Var.f11570a, zVar.f11217a);
                    return;
                }
                return;
            default:
                ...
                p3 p3Var = u4Var.N;
                if (p3Var != null) {
                    w3.P1(p3Var.f11559a, u4Var.f11217a);
                    return;
                }
                return;
        }
    ...
    @Override
    public void j() {
        com.google.android.gms.common.api.internal.m0 m0Var = (com.google.android.gms.common.api.internal.m0) this.f301b;
        m0Var.f6120a.lock();
        try {
    ...
    public void k(Object obj) {
        ...
        switch (this.f300a) {
            case 5:
                Map map = (Map) obj;
                androidx.fragment.app.k0 k0Var = (androidx.fragment.app.k0) this.f301b;
            ...
            default:
                ...
                int i13 = u.e("ProxyBillingActivityV2", intent).f3889a;
    ...
    public void l() {
        ...
        if (j3Var != null && j3Var.y() && d2Var.P.C4()) {
            i10 = 1;
        } else {
            i10 = 0;
        }
    ...
    @Override
    public String[] n() {
        return ((WebViewProviderFactoryBoundaryInterface) this.f301b).getSupportedFeatures();
    }
    ...
    public void onComplete(Task task) {
        switch (this.f300a) {
            case 15:
                d6.c.h((d6.c) ((d6.j) this.f301b).f7545c, "launchApplication", task);
                return;
            default:
                zd.m mVar = (zd.m) this.f301b;
    ...
    public void onContentChanged() {
        d2 d2Var = (d2) this.f301b;
        if (d2Var.f11328y0 != null) {
            boolean m32 = d2Var.P.m3();
            d2Var.L0 = m32;
            d2Var.f11328y0.h(m32);
            d2Var.f11328y0.invalidate();
        }
        d2Var.C0();
    ...
    public void onStateChanged(boolean z10, int i10) {
        d7 d7Var = (d7) this.f301b;
        a7 a7Var = d7Var.L;
        AndroidUtilities.cancelRunOnUIThread(a7Var);
        g71 g71Var = d7Var.f4531y;
    ...
    @Override
    public Object p2() {
        Class cls = (Class) this.f301b;
        try {
            return fb.s.f9048a.a(cls);
        } catch (Exception e) {
    ...
    public void q(ii.a aVar) {
        d2 d2Var = (d2) this.f301b;
        if (aVar != null && (aVar.f11201b instanceof TL_iv.pageBlockMap) && AndroidUtilities.isMapsInstalled(d2Var)) {
            ...
            viVar.f28795t2 = new r5(d2Var, aVar, viVar, 11);
            viVar.r1();
            viVar.show();
        }
    }
    ...
    public Paint.FontMetricsInt w() {
        return ((ci.m) this.f301b).f4990f.getEditText().getPaint().getFontMetricsInt();
    }
    ...
    public i(int i10) {
        ...
        switch (i10) {
            case 8:
                ...
                return;
            default:
                this.f301b = new LinkedHashMap(0, 0.75f, true);
                return;
        }
    }
