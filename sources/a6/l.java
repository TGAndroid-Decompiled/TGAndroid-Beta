...
public final class l extends b8.b {
        ...
        switch (i11) {
            case 0:
                ...
                if (i10 != 1) {
                    ...
                    if (b10 != null) {
                        t0 t0Var = a10.h;
                        Context context = a10.f6208a;
                        if (a10.h() == 3) {
                            z10 = true;
                        } else {
                            z10 = false;
                        }
                        h.f299a.i("Revoking access", new Object[0]);
                        ...
                        if (z10) {
                            if (d11 == null) {
                                ...
                                basePendingResult = cVar.f288b;
                            }
                        } else {
                            g gVar = new g(t0Var, 1);
                            t0Var.f6176b.d(1, gVar);
    ...
    public void L0() {
        if (u6.b.e((RevocationBoundService) this.f304c, Binder.getCallingUid())) {
            return;
        }
    ...
    public l(TaskCompletionSource taskCompletionSource) {
        ...
        this.f304c = taskCompletionSource;
    }
}
