...
public final class g0 implements n, l.j, l2.h, k1.f, d5, bh.h, d71, g81, com.google.android.gms.common.api.internal.s, com.google.android.gms.common.api.internal.o, n5.b, OnCompleteListener, wp0 {
    ...
    public void A(float f7) {
        ...
        if (f7 == 1.0f) {
            ...
            i81Var.z(i81Var.f27043b);
            return;
        }
        View[] viewArr3 = i81Var.f27045e;
        View[] viewArr4 = i81Var.f27045e;
    ...
    public void k(Canvas canvas) {
        switch (this.f14603a) {
            case 9:
                ...
                canvas.drawColor(viVar.getThemedColor(j6.f20691d6));
            ...
            default:
                ...
                canvas.drawColor(hq0Var.getThemedColor(j6.f20691d6));
                if (SharedConfig.chatBlurEnabled()) {
    ...
    public StringBuilder r() {
        ...
        if (aVar instanceof ye.m) {
            StringBuilder sb2 = ((ye.m) aVar).f50072b.f50057b;
            if (sb2.length() != 0) {
                return sb2;
            }
            return null;
    ...
    public void v(bh.a aVar) {
        switch (this.f14603a) {
            case 9:
                aVar.a(((vi) this.f14604b).getThemedColor(j6.f20691d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                return;
            default:
                aVar.a(((hq0) this.f14604b).getThemedColor(j6.f20691d6));
                aVar.b(SharedConfig.chatBlurEnabled());
                return;
        }
    }
