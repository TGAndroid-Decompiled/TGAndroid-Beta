...
public final class m0 extends c2.i {
    ...
    public final void c(ByteBuffer byteBuffer) {
        ...
        f71 f71Var = this.f13336i;
        float[] fArr = f71Var.f23842b;
        ByteBuffer byteBuffer2 = f71Var.f23843c;
        FourierTransform.FFT fft = f71Var.f23841a;
        g71 g71Var = f71Var.f23844f;
        z61 z61Var = g71Var.K;
        Handler handler = g71Var.f24225a0;
        if (z61Var != null) {
            if (order != c2.h.f3669a && g71Var.I) {
    ...
    public final void k() {
        if (isActive()) {
            int i10 = this.f3670b.f3666a;
            this.f13336i.getClass();
        }
    }
