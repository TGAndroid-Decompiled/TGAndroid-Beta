...
public final class g implements Runnable {
    ...
    public final n4.y f13254b;
    public final i2.g f13255c;
    ...
    public final void run() {
        switch (this.f13253a) {
            case 0:
                n4.y yVar = this.f13254b;
                i2.g gVar = this.f13255c;
                synchronized (gVar) {
                }
                ...
                return;
            default:
                n4.y yVar2 = this.f13254b;
                i2.g gVar2 = this.f13255c;
                String str2 = e2.d0.f7888a;
                j2.f fVar2 = ((i2.b0) ((j) yVar2.f15005c)).f10624a.f10674s;
                j2.a p5 = fVar2.p();
