...
public final class l0 extends c2.i {
    public static final int f12174i = Float.floatToIntBits(Float.NaN);

    public static void k(int i10, ByteBuffer byteBuffer) {
        int floatToIntBits = Float.floatToIntBits((float) (i10 * 4.656612875245797E-10d));
        if (floatToIntBits == f12174i) {
    ...
    public final c2.f f(c2.f fVar) {
        ...
        if (i10 != 4) {
            return new c2.f(fVar.f4083a, fVar.f4084b, 4);
        }
        return c2.f.e;
    }
}
