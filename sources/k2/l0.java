...
public final class l0 extends c2.i {
    ...
    public int f13332u = 0;
    public final long f13323l = 100000;
    public final float f13320i = 0.2f;
    public final long f13324m = 2000000;
    public final int f13322k = 10;
    public final short f13321j = 1024;
    ...
    public final void c(ByteBuffer byteBuffer) {
        ...
        boolean z12;
        int position;
        while (byteBuffer.hasRemaining() && !this.f3673g.hasRemaining()) {
            int i10 = this.f13327p;
            short s10 = this.f13321j;
            boolean z13 = true;
            if (i10 != 0) {
                if (i10 == 1) {
                    if (this.f13331t < this.f13330s.length) {
                        z10 = true;
                    } else {
                        z10 = false;
                    }
                    ...
                    byteBuffer.get(this.f13330s, i14, min);
                    int i16 = this.f13332u + min;
                    this.f13332u = i16;
                    if (i16 <= this.f13330s.length) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
    ...
    public final void g() {
        if (isActive()) {
            c2.f fVar = this.f3670b;
            int i10 = fVar.f3667b * 2;
            this.f13325n = i10;
            int i11 = ((((int) ((this.f13323l * fVar.f3666a) / 1000000)) / 2) / i10) * i10 * 2;
            if (this.f13330s.length != i11) {
                this.f13330s = new byte[i11];
                this.v = new byte[i11];
            }
        }
        this.f13327p = 0;
    ...
    public final boolean isActive() {
        if (super.isActive() && this.f13326o) {
            return true;
        }
        return false;
    }
    ...
    public final int k(int i10) {
        boolean z10;
        int length = ((((int) ((this.f13324m * this.f3670b.f3666a) / 1000000)) - this.f13329r) * this.f13325n) - (this.f13330s.length / 2);
        if (length >= 0) {
            z10 = true;
        } else {
            z10 = false;
        ...
        e2.d.g(z10);
        int i11 = this.f13325n;
        return (((int) Math.min((i10 * this.f13320i) + 0.5f, length)) / i11) * i11;
    }
    ...
    public final void l(boolean z10) {
        ...
        if (this.f13329r == 0) {
            ...
            int k11 = k(length2) + (this.f13330s.length / 2);
            m(k11, 2);
            k10 = k11;
            length = length3;
        } else {
        ...
        e2.d.g(z13);
        this.f13332u -= length;
        int i12 = this.f13331t + length;
        this.f13331t = i12;
        this.f13331t = i12 % this.f13330s.length;
        this.f13329r = (k10 / this.f13325n) + this.f13329r;
        this.f13328q += (length - k10) / i10;
    }
        ...
        if (i11 == 2) {
            ...
            if (i14 <= bArr.length) {
                ...
                if (length >= i10) {
                    ...
                    System.arraycopy(this.f13330s, 0, this.v, i15, length);
                }
            }
        } else {
            int i16 = this.f13331t;
            int i17 = i16 + i10;
            ...
            if (i17 <= bArr2.length) {
                ...
                System.arraycopy(this.f13330s, 0, this.v, length2, i10 - length2);
            }
        }
        if (i10 % this.f13325n == 0) {
            z11 = true;
        } else {
            z11 = false;
        }
