...
public final class j0 extends r2.r implements s0 {
    ...
    public final p Z0;
    public final r2.j f13300a1;
    public int f13301b1;
    public boolean f13302c1;
    public boolean f13303d1;
    public b2.s f13304e1;
    public b2.s f13305f1;
    public long f13306g1;
    public boolean f13307h1;
    public boolean f13308i1;
    public boolean f13309j1;
    public int f13310k1;
    public boolean l1;
    public long f13311m1;
    ...
    public j0(Context context, r2.k kVar, Handler handler, i2.b0 b0Var, p pVar) {
        ...
        this.f13311m1 = -9223372036854775807L;
        ((g0) pVar).f13287t = new a4.m(this, 23);
    }

    public final int A0(r2.o oVar, b2.s sVar) {
        int i10;
        if ("OMX.google.raw.decoder".equals(oVar.f41959a) && (i10 = Build.VERSION.SDK_INT) < 24 && (i10 != 23 || !e2.d0.N(this.X0))) {
            return -1;
        }
        return sVar.f3307s;
    }
    ...
    public final void B0() {
        ...
        if (i10 != Long.MIN_VALUE) {
            if (!this.f13307h1) {
                i10 = Math.max(this.f13306g1, i10);
            }
            this.f13306g1 = i10;
            this.f13307h1 = false;
        }
    ...
    public final i2.h D(r2.o oVar, b2.s sVar, b2.s sVar2) {
        ...
        if (A0(oVar, sVar2) > this.f13301b1) {
            i11 |= 64;
        }
        int i12 = i11;
    ...
    public final long P(long j3, long j10) {
        boolean z10;
        float f7;
        if (this.f13311m1 != -9223372036854775807L) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (!this.l1) {
            ...
            if (z10 && h != -9223372036854775807L) {
                float min = (float) Math.min(h, this.f13311m1 - j3);
                if (h() != null) {
                    f7 = h().f3333a;
                } else {
                    f7 = 1.0f;
    ...
    public final void R(h2.h hVar) {
        b2.s sVar;
        if (Build.VERSION.SDK_INT >= 29 && (sVar = hVar.f10091a) != null && Objects.equals(sVar.f3306r, "audio/opus") && this.f41996x0) {
            ByteBuffer byteBuffer = hVar.f10094f;
            byteBuffer.getClass();
            b2.s sVar2 = hVar.f10091a;
            sVar2.getClass();
            int i10 = sVar2.M;
    ...
    public final i2.h a0(n4.y yVar) {
        ...
        n4.y yVar2 = this.Y0;
        Handler handler = (Handler) yVar2.f14992b;
        if (handler != null) {
    ...
    public final void b0(b2.s sVar, MediaFormat mediaFormat) {
        int i10;
        b2.s sVar2 = this.f13305f1;
        boolean z10 = true;
        int[] iArr = null;
        if (sVar2 != null) {
            sVar = sVar2;
        } else if (this.f41975b0 != null) {
            ...
            rVar.L = sVar.M;
            rVar.M = sVar.N;
            rVar.f3244k = sVar.f3300l;
            rVar.f3237a = sVar.f3292a;
            rVar.f3238b = sVar.f3293b;
            rVar.f3239c = e9.i0.v(sVar.f3294c);
            rVar.d = sVar.d;
            rVar.e = sVar.e;
            rVar.f3240f = sVar.f3295f;
            rVar.I = mediaFormat.getInteger("channel-count");
            rVar.J = mediaFormat.getInteger("sample-rate");
            sVar = new b2.s(rVar);
            boolean z11 = this.f13302c1;
            int i12 = sVar.J;
            if (z11 && i12 == 6 && i11 < 6) {
                iArr = new int[i11];
    ...
    public final void c(int i10, Object obj) {
                    ...
                    if (i10 != 12) {
                        if (i10 != 16) {
                            if (i10 != 9) {
                                ...
                                ((g0) pVar).A(intValue);
                                if (Build.VERSION.SDK_INT >= 35 && (jVar = this.f13300a1) != null) {
                                    jVar.d(intValue);
                                    return;
                                }
                                return;
                        ...
                        obj.getClass();
                        this.f13310k1 = ((Integer) obj).intValue();
                        r2.l lVar = this.f41975b0;
                        if (lVar != null && Build.VERSION.SDK_INT >= 35) {
                            Bundle bundle = new Bundle();
                            bundle.putInt("importance", Math.max(0, -this.f13310k1));
        ...
        if (g0Var2.Q != floatValue) {
            g0Var2.Q = floatValue;
            if (g0Var2.q()) {
                g0Var2.f13290x.setVolume(g0Var2.Q);
            }
        }
    }
    ...
    public final boolean h0(long j3, long j10, r2.l lVar, ByteBuffer byteBuffer, int i10, int i11, int i12, long j11, boolean z10, boolean z11, b2.s sVar) {
        ...
        try {
            ...
            b2.s sVar2 = this.f13304e1;
            if (this.f41996x0) {
                m1 m1Var = this.d;
                m1Var.getClass();
                if (m1Var.f10789a != 0) {
                    i14 = 5004;
                    throw d(e, sVar2, e.f13334b, i14);
                }
            }
            i14 = 5001;
            throw d(e, sVar2, e.f13334b, i14);
            ...
            if (this.f41996x0) {
                ...
                if (m1Var2.f10789a != 0) {
                    i13 = 5003;
                    throw d(e7, sVar, e7.f13339b, i13);
                }
            }
            i13 = 5002;
            throw d(e7, sVar, e7.f13339b, i13);
    ...
    public final void k0() {
        ...
        try {
            ...
            throw d(e, e.f13340c, e.f13339b, i10);
        }
    }
    ...
    public final void p(boolean z10, boolean z11) {
        ...
        if (z12) {
            ...
            g0 g0Var2 = (g0) pVar;
            if (g0Var2.f13264d0) {
                g0Var2.f13264d0 = false;
                g0Var2.g();
            }
        }
        j2.k kVar = this.f10686f;
        kVar.getClass();
        g0 g0Var3 = (g0) pVar;
        g0Var3.f13286s = kVar;
        e2.x xVar = this.h;
    ...
    public final void r() {
        r2.j jVar;
        c cVar;
        g7 g7Var = ((g0) this.Z0).f13292z;
        if (g7Var != null) {
            Context context = (Context) g7Var.f4690b;
            if (g7Var.f4689a) {
                g7Var.h = null;
                if (Build.VERSION.SDK_INT >= 23 && (cVar = (c) g7Var.e) != null) {
                    e0.b.K(context, cVar);
                }
                context.unregisterReceiver((androidx.mediarouter.app.g) g7Var.f4692f);
                d dVar = (d) g7Var.f4693g;
                if (dVar != null) {
                    dVar.f13237a.unregisterContentObserver(dVar);
                }
                g7Var.f4689a = false;
            }
        }
    ...
    public final boolean u0(b2.s sVar) {
        ...
        if (m1Var.f10789a != 0) {
            ...
            if ((z02 & 512) != 0) {
                m1 m1Var2 = this.d;
                m1Var2.getClass();
                if (m1Var2.f10789a != 2 && (z02 & 1024) == 0) {
