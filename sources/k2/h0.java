...
public final class h0 extends r2.r implements s0 {
    ...
    public final void Q(h2.g gVar) {
        b2.s sVar;
        if (Build.VERSION.SDK_INT >= 29 && (sVar = gVar.f10846c) != null && Objects.equals(sVar.f2370r, "audio/opus") && this.f44871x0) {
    ...
    public final int z0(r2.o oVar, b2.s sVar) {
        int i10;
        if ("OMX.google.raw.decoder".equals(oVar.f44832a) && (i10 = Build.VERSION.SDK_INT) < 24 && (i10 != 23 || !e2.d0.N(this.X0))) {
            return -1;
        }
        return sVar.f2371s;
    }
