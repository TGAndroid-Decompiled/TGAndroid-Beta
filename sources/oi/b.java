...
public final class b {
    public static final Pattern f15730g = Pattern.compile("[A-Za-z0-9][A-Za-z0-9_-]*(/[A-Za-z0-9][A-Za-z0-9_-]*)*");
    public static final Pattern h = Pattern.compile("[A-Za-z0-9_-]+");
    public static final b f15731i = a().a();
    ...
    public b(a aVar) {
        int i10 = aVar.f15726a;
        this.f15732a = i10;
        this.f15733b = aVar.f15727b;
        if (i10 == 3) {
            this.f15735f = aVar.f15729f;
            this.f15734c = 0;
            this.d = "";
            this.e = "";
        } else if (i10 == 2) {
            this.f15735f = aVar.f15729f;
            this.f15734c = aVar.f15728c;
            this.d = "";
            this.e = "";
        } else if (i10 == 1) {
            this.f15735f = "";
    ...
    public static oi.b d(android.net.Uri r9) {
        throw new UnsupportedOperationException("Method not decompiled: oi.b.d(android.net.Uri):oi.b");
    }
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                if (this.f15734c == bVar.f15734c && this.f15732a == bVar.f15732a && Objects.equals(this.f15733b, bVar.f15733b) && Objects.equals(this.d, bVar.d) && Objects.equals(this.e, bVar.e) && Objects.equals(this.f15735f, bVar.f15735f)) {
                    return true;
                }
                return false;
            }
        ...
        if (!TextUtils.isEmpty(str3)) {
            if (this.f15732a == 3) {
                if (!TextUtils.isEmpty(str3)) {
                    ...
                    if (!TextUtils.isEmpty(str) && str.indexOf(58) < 0 && str.indexOf(63) < 0 && str.indexOf(35) < 0 && (str2 == null || (str2.length() <= 128 && f15730g.matcher(str2).matches()))) {
                        try {
                            equals = str.equals(IDN.toASCII(str, 3).toLowerCase(Locale.US));
                        } catch (IllegalArgumentException unused) {
                        }
                        if (!equals && g(this.f15735f)) {
                            return true;
                        }
                    }
                }
    ...
    public final void h(SharedPreferences.Editor editor) {
        ...
        editor.putString("proxy_ip", this.f15733b);
        int c11 = m1.j.c(i11);
        int i12 = this.f15734c;
        if (c11 != 0) {
    ...
    public final int hashCode() {
        return Objects.hash(m1.j.a(this.f15732a), this.f15733b, Integer.valueOf(this.f15734c), this.d, this.e, this.f15735f);
    }
}
