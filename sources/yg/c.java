...
public final class c extends ViewGroup implements yd.a, NotificationCenter.NotificationCenterDelegate, xd.b {
    ...
    public final xd.a f47320a;
    public final xd.a f47321b;
    public final yd.b f47322c;
    public final ImageReceiver d;
    public final Paint e;
    public final Paint f47323f;
    public final org.telegram.ui.Components.voip.h h;
    public final ImageReceiver f47324n;
    public l5 f47325r;
    public q0 f47326s;
    public final s v;
    public c9.a f47327w;
    public boolean f47328x;
    public final z1 f47329y;

    public c(Context context) {
        super(context);
        mr mrVar = mr.h;
        this.f47320a = new xd.a(0, this, mrVar, 320L, false);
        this.f47321b = new xd.a(1, this, mrVar, 320L, false);
        this.f47322c = new yd.b(this);
        ...
        hVar.f29627c.setStrokeWidth(AndroidUtilities.dp(1.0f));
        this.f47324n = new ImageReceiver(this);
    ...
    public final void L(int i10, float f10, float f11, xd.c cVar) {
        this.f47323f.setAlpha(Math.round(this.f47321b.e * 100.0f));
        int round = Math.round(this.f47320a.e * 220.0f);
        org.telegram.ui.Components.voip.h hVar = this.h;
        hVar.f29625a.setAlpha(round);
        hVar.f29627c.setAlpha(round);
        invalidate();
    }

    public final int a(float f10, float f11) {
        c9.a aVar = this.f47327w;
        if (aVar == null) {
            return -1;
        }
        RectF rectF = this.H;
        ...
        if (!((RectF) this.f47327w.f2166a).contains(f10, f11)) {
            return -1;
        }
        return 0;
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (aVar != null) {
            ...
            if (Build.VERSION.SDK_INT >= 29 && this.B != null && canvas.isHardwareAccelerated()) {
                ...
                canvas.save();
                canvas.clipPath((Path) this.f47327w.d);
            ...
            Paint paint = this.f47323f;
            if (paint.getAlpha() > 0) {
                canvas.drawPath((Path) this.f47327w.d, paint);
            }
            if (this.f47320a.e > 0.0f) {
                RectF rectF = this.H;
                rectF.set((RectF) this.f47327w.f2166a);
            ...
            this.d.draw(canvas);
            this.f47324n.draw(canvas);
            l5 l5Var = this.f47325r;
            if (l5Var != null) {
                l5Var.draw(canvas);
            }
        }
    ...
    public float getReactionCenterX() {
        c9.a aVar = this.f47327w;
        if (aVar != null) {
            return ((RectF) aVar.f2169f).centerX();
        }
        return 0.0f;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f47324n.onAttachedToWindow();
        l5 l5Var = this.f47325r;
        if (l5Var != null) {
            l5Var.a(this);
        }
        ...
        if (groupCallMessage != null) {
            groupCallMessage.subscribeToStateUpdates(this.f47329y);
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f47324n.onDetachedFromWindow();
        l5 l5Var = this.f47325r;
        if (l5Var != null) {
            l5Var.o(this);
        }
        ...
        GroupCallMessage groupCallMessage = this.E;
        if (groupCallMessage != null) {
            groupCallMessage.unsubscribeFromStateUpdates(this.f47329y);
        }
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int round = Math.round(((PointF) aVar.f2170g).x);
        int round2 = Math.round(((PointF) this.f47327w.f2170g).y);
        s sVar = this.v;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        c9.a aVar = this.f47327w;
        if (aVar == null || this.f47328x || aVar.f2167b != size) {
            int paddingLeft = getPaddingLeft();
            int paddingRight = getPaddingRight();
            q0 q0Var = this.f47326s;
            ...
            ?? obj = new Object();
            obj.f2166a = new RectF();
            obj.d = new Path();
            obj.e = new RectF();
            obj.f2169f = new RectF();
            obj.f2170g = new PointF();
            RectF rectF = (RectF) obj.e;
            PointF pointF = (PointF) obj.f2170g;
            RectF rectF2 = (RectF) obj.f2169f;
            RectF rectF3 = (RectF) obj.f2166a;
            obj.f2167b = size;
            obj.f2168c = b10;
            ...
            this.f47324n.setImageCoords((RectF) this.f47327w.f2169f);
            if (this.f47325r != null) {
                Rect rect = I;
                ((RectF) this.f47327w.f2169f).round(rect);
                this.f47325r.setBounds(rect);
            }
        }
        setMeasuredDimension(size, this.f47327w.f2168c);
        this.h.f29628f = Math.round(((RectF) this.f47327w.f2166a).width() + AndroidUtilities.dp(48.0f));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        return this.f47322c.a(motionEvent, this);
    }
    ...
    public void set(GroupCallMessage groupCallMessage) {
        ...
        if (groupCallMessage4 != null) {
            this.f47320a.a(groupCallMessage4.isSendDelayed(), false);
            this.f47321b.a(this.E.isSendError(), false);
        }
        ...
        ImageReceiver imageReceiver = this.f47324n;
        imageReceiver.setImage(null, null, null, null, null, 0);
        if (this.f47325r != null && isAttachedToWindow()) {
            this.f47325r.o(this);
        }
        this.f47325r = null;
        ...
        if (q0Var == null) {
            ...
            TLRPC.TL_availableReaction tL_availableReaction = MediaDataController.getInstance(groupCallMessage.currentAccount).getReactionsMap().get(groupCallMessage.visibleReaction.f14095f);
            ...
            l5 l5Var = new l5(0, groupCallMessage.currentAccount, groupCallMessage.visibleReaction.f14096g);
            this.f47325r = l5Var;
        ...
        this.f47326s = groupCallMessage.visibleReaction;
        this.f47328x = true;
