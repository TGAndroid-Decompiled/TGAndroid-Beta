...
public final class h extends RecyclerView {
    ...
    public h(LaunchActivity launchActivity) {
        ...
        this.f47332a1 = Integer.MIN_VALUE;
    ...
    public final void C0(int i10, TLRPC.InputGroupCall inputGroupCall) {
        int i11;
        e eVar = this.R0;
        if (eVar.d && (i11 = eVar.e) != -1 && eVar.f47331f != null) {
            GroupCallMessagesController.getInstance(i11).unsubscribeFromCallMessages(eVar.f47331f.f19176id, eVar);
        }
        eVar.e = i10;
        eVar.f47331f = inputGroupCall;
        if (eVar.d) {
            eVar.f47330c = GroupCallMessagesController.getInstance(i10).getCallMessages(eVar.f47331f.f19176id);
            eVar.l();
            GroupCallMessagesController.getInstance(i10).subscribeToCallMessages(eVar.f47331f.f19176id, eVar);
        }
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        this.Z0 = i10;
        this.f47332a1 = getMeasuredHeight();
        super.dispatchDraw(canvas);
        canvas.restore();
        this.Z0 = Integer.MIN_VALUE;
        this.f47332a1 = Integer.MIN_VALUE;
                ...
                if (i10 < childCount) {
                    ...
                    if (childAt instanceof c) {
                        ...
                        if (cVar.getVisibility() == 0) {
                            ...
                            c9.a aVar = cVar.f47327w;
                            if (aVar == null) {
                                contains = false;
                            } else {
                                contains = ((RectF) aVar.f2166a).contains(x11, y11);
                            }
                            if (contains) {
                                z4 = true;
                                break;
    ...
    public final boolean drawChild(Canvas canvas, View view, long j10) {
        ...
        if (this.f47332a1 != Integer.MIN_VALUE && view.getY() > this.f47332a1) {
            return true;
        }
    ...
    public final void onAttachedToWindow() {
        ...
        eVar.d = true;
        int i10 = eVar.e;
        if (i10 != -1 && eVar.f47331f != null) {
            eVar.f47330c = GroupCallMessagesController.getInstance(i10).getCallMessages(eVar.f47331f.f19176id);
            eVar.l();
            GroupCallMessagesController.getInstance(eVar.e).subscribeToCallMessages(eVar.f47331f.f19176id, eVar);
        }
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        int i10 = eVar.e;
        if (i10 != -1 && eVar.f47331f != null) {
            GroupCallMessagesController.getInstance(i10).unsubscribeFromCallMessages(eVar.f47331f.f19176id, eVar);
        }
    }
