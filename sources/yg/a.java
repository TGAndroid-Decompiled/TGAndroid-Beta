...
public final class a extends Drawable {
    public final TextPaint f46831a;
    public final TextPaint f46832b;
    public final RectF f46833c;
    public final Drawable d;
    public float e;
    public String f46834f;

    public a(Context context) {
        TextPaint textPaint = new TextPaint(1);
        this.f46831a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f46832b = textPaint2;
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f46833c;
        rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f46832b);
        ...
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.dp(16.5f) + bounds.left, AndroidUtilities.dp(13.0f) + bounds.top, this.f46831a);
        }
    }
