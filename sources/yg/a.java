...
public final class a extends Drawable {
    public final TextPaint f46880a;
    public final TextPaint f46881b;
    ...
    public a(Context context) {
        ...
        this.f46880a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f46881b = textPaint2;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f46881b);
        ...
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.dp(16.5f) + bounds.left, AndroidUtilities.dp(13.0f) + bounds.top, this.f46880a);
        }
    }
