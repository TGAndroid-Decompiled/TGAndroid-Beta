...
public final class a extends Drawable {
    public final TextPaint f47145a;
    public final TextPaint f47146b;
    public final RectF f47147c;
    ...
    public a(Context context) {
        ...
        this.f47145a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f47146b = textPaint2;
        this.f47147c = new RectF();
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f47147c;
        rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f47146b);
        ...
        String str = this.f47148f;
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.dp(16.5f) + bounds.left, AndroidUtilities.dp(13.0f) + bounds.top, this.f47145a);
        }
    }
