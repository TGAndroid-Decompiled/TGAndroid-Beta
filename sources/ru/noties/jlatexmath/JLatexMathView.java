...
public class JLatexMathView extends View {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        try {
            int resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.JLatexMathView_jlmv_background, 0);
            if (resourceId != 0) {
                String resourceTypeName = context.getResources().getResourceTypeName(resourceId);
                if ("drawable".equals(resourceTypeName)) {
                    colorDrawable = typedArrayObtainStyledAttributes.getDrawable(R.styleable.JLatexMathView_jlmv_background);
                } else {
                    ...
                    colorDrawable = new ColorDrawable(typedArrayObtainStyledAttributes.getColor(R.styleable.JLatexMathView_jlmv_background, 0));
                }
            } else {
                colorDrawable = null;
            }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int i12 = (int) ((intrinsicWidth * fMin) + 0.5f);
        int i13 = (int) ((intrinsicHeight * fMin) + 0.5f);
        if (1073741824 != mode) {
        ...
        float fAlignment = alignment(this.alignHorizontal, ((size - paddingLeft) - getPaddingRight()) - i12);
        float fAlignment2 = alignment(this.alignVertical, ((size2 - paddingTop) - getPaddingBottom()) - i13);
        this.scale = fMin;
