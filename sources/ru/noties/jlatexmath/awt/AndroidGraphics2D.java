...
public class AndroidGraphics2D implements Graphics2D {
    ...
    public void draw(Rectangle2D.Float r92) {
        ...
        float f7 = r92.f45700x;
        float f10 = r92.f45701y;
        canvas.drawRect(f7, f10, f7 + r92.f45699w, f10 + r92.h, this.paint);
    }
    ...
    public void draw(Line2D.Float r92) {
        this.paint.setStyle(Paint.Style.STROKE);
        this.canvas.drawLine((float) r92.f45693x1, (float) r92.f45695y1, (float) r92.f45694x2, (float) r92.f45696y2, this.paint);
    }
    ...
    public void draw(RoundRectangle2D.Float r62) {
        ...
        float f7 = r62.f45702x;
        float f10 = r62.f45703y;
