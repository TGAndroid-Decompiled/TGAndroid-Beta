...
public class AndroidGraphics2D implements Graphics2D {
    ...
    public void draw(Rectangle2D.Float r92) {
        ...
        float f7 = r92.f45672x;
        float f10 = r92.f45673y;
        canvas.drawRect(f7, f10, f7 + r92.f45671w, f10 + r92.h, this.paint);
    }
    ...
    public void draw(Line2D.Float r92) {
        this.paint.setStyle(Paint.Style.STROKE);
        this.canvas.drawLine((float) r92.f45665x1, (float) r92.f45667y1, (float) r92.f45666x2, (float) r92.f45668y2, this.paint);
    }
    ...
    public void draw(RoundRectangle2D.Float r62) {
        ...
        float f7 = r62.f45674x;
        float f10 = r62.f45675y;
