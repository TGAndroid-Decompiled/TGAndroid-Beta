...
public class AndroidGraphics2D implements Graphics2D {
    ...
    public void draw(Rectangle2D.Float r92) {
        ...
        float f7 = r92.f42895x;
        float f10 = r92.f42896y;
        canvas.drawRect(f7, f10, f7 + r92.f42894w, f10 + r92.h, this.paint);
    }
    ...
    public void draw(Line2D.Float r92) {
        this.paint.setStyle(Paint.Style.STROKE);
        this.canvas.drawLine((float) r92.f42888x1, (float) r92.f42890y1, (float) r92.f42889x2, (float) r92.f42891y2, this.paint);
    }
    ...
    public void draw(RoundRectangle2D.Float r62) {
        ...
        float f7 = r62.f42897x;
        float f10 = r62.f42898y;
