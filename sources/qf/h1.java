...
public final class h1 extends EditTextBoldCursor {
    ...
    public final b5 f46317b;

    public int f46318c;
    public final i6 d;

    public final c6 f46319e;

    public h1(Context context, c6 c6Var) {
        super(context);
        this.f46319e = c6Var;
        this.f46317b = new b5(this);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int iA = this.f46317b.a(g6.v0(this.f46318c < 0 ? g6.f23269p7 : g6.P5, this.f46319e), false);
        i6 i6Var = this.d;
        i6Var.r(iA);
    ...
    public final void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        ...
        i6 i6Var = this.d;
        if (i6Var != null) {
            this.f46318c = 32 - charSequence.length();
            i6Var.b();
            String str = "";
            if (this.f46318c <= 4) {
                str = "" + this.f46318c;
