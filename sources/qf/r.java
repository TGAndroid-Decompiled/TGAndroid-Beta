...
public final class r {
    ...
    public TL_account.TL_businessChatLink f46438a;

    public final boolean equals(Object obj) {
        TL_account.TL_businessChatLink tL_businessChatLink = this.f46438a;
        if (this == obj) {
            return true;
        }
        if (obj != null && r.class == obj.getClass()) {
            TL_account.TL_businessChatLink tL_businessChatLink2 = ((r) obj).f46438a;
