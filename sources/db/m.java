...
public final class m extends i {
    public final Serializable f7606a;
    ...
    public static boolean s(m mVar) {
        Serializable serializable = mVar.f7606a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj != null && m.class == obj.getClass()) {
                m mVar = (m) obj;
                Serializable serializable = mVar.f7606a;
                Serializable serializable2 = this.f7606a;
    ...
    public final int hashCode() {
        ...
        Serializable serializable = this.f7606a;
        if (serializable == null) {
            return 31;
        }
        if (s(this)) {
    ...
    public final double q() {
        if (this.f7606a instanceof Number) {
