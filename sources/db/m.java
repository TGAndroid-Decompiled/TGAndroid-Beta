...
public final class m extends i {
    public final Serializable f7594a;
    ...
    public static boolean s(m mVar) {
        Serializable serializable = mVar.f7594a;
    ...
    public final boolean equals(Object obj) {
        ...
        if (this != obj) {
            if (obj != null && m.class == obj.getClass()) {
                m mVar = (m) obj;
                Serializable serializable = mVar.f7594a;
                Serializable serializable2 = this.f7594a;
    ...
    public final int hashCode() {
        ...
        Serializable serializable = this.f7594a;
        if (serializable == null) {
            return 31;
        }
        if (s(this)) {
    ...
    public final double q() {
        if (this.f7594a instanceof Number) {
