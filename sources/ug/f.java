...
public final class f extends FrameLayout {
    ...
    public boolean I;
    public ch.g f45582a;
    public final nw0 f45583b;
    public final FrameLayout f45584c;
    public final q9 d;
    public boolean e;
    public pg.b f45585f;
    public pg.b h;
    public final Path f45586n;
    public int f45587r;
    public float f45588s;
    public float v;
    public boolean f45589w;
    public float f45590x;
    public float f45591y;

    public f(Context context) {
        super(context);
        this.e = true;
        this.f45586n = new Path();
        this.D = new Rect();
        this.E = new RectF();
        FrameLayout frameLayout = new FrameLayout(context);
        this.f45584c = frameLayout;
        addView(frameLayout, b6.e(-1, -2, 80));
        q9 q9Var = new q9(this, context, 3);
        this.d = q9Var;
        addView(q9Var, b6.e(-1, -2, 80));
        this.f45583b = new nw0(this, context, 11);
    }

    public final void a(boolean z4) {
        e();
        int round = Math.round(this.f45588s) + AndroidUtilities.dp(9.0f) + this.C;
        if (this.f45587r == round && !z4) {
            return;
        }
        this.f45587r = round;
    ...
    public final void b() {
        ...
        if (bVar != null && (i10 = bVar.getBounds().top) != (measuredHeight = getMeasuredHeight() - Math.round(this.G))) {
            ...
            this.f45583b.invalidate(0, Math.max(0, Math.min(i10, measuredHeight)), getMeasuredWidth(), getMeasuredHeight());
    ...
    public final void c() {
        int i10;
        m1 m1Var = ((ch.i) this.f45582a).f2594r;
        if (m1Var != null) {
            i10 = m1Var.f43154a.f(2).d;
        } else {
            i10 = 0;
        }
        float b10 = ((ch.i) this.f45582a).b();
        q9 q9Var = this.d;
    ...
    public final void d() {
        ...
        int i11;
        this.f45588s = ((ch.i) this.f45582a).c();
        this.v = ((ch.i) this.f45582a).b();
        int i12 = 0;
        boolean z10 = true;
        if (((ch.i) this.f45582a).f2595s != 1) {
            z4 = true;
        } else {
            z4 = false;
        }
        ...
        int i14 = ((ch.i) this.f45582a).f2596w;
        if (i13 != i14) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int measuredHeight = getMeasuredHeight() - this.f45587r;
        int round = Math.round(this.f45590x);
        int measuredWidth = getMeasuredWidth() - Math.round(this.f45591y);
        int i10 = this.C;
        Rect rect = this.D;
        rect.set(round, 0, measuredWidth, i10);
        rect.inset(0, -AndroidUtilities.dp(7.0f));
        rect.offset(0, measuredHeight + ((int) this.H));
        this.f45585f.setBounds(rect);
        if (this.e) {
            this.f45585f.draw(canvas);
        }
        if (this.f45589w) {
            this.h.draw(canvas);
        }
    ...
    public final void e() {
        this.f45584c.setTranslationY((-this.f45588s) - AndroidUtilities.dp(9.0f));
        q9 q9Var = this.d;
    ...
    public float getInputBubbleBottom() {
        return (getMeasuredHeight() - this.f45588s) - AndroidUtilities.dp(9.0f);
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            pg.b bVar2 = this.f45585f;
            if ((bVar2 != null && bVar2.f41248j == 255 && bVar2.getBounds().contains(x10, y10)) || ((bVar = this.h) != null && bVar.getBounds().contains(x10, y10))) {
                z4 = true;
            } else {
                z4 = false;
            }
    ...
    public void setInputIslandBubbleDrawable(pg.b bVar) {
        ...
        this.f45585f.p(AndroidUtilities.dp(22.0f));
    }
