...
public final class b extends og.b {
    ...
    public final HashMap f43714w = new HashMap();
    ...
    public final int j(int i10) {
        return ((a) this.e.get(i10)).f15533a;
    }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (i13 != 0) {
                    ...
                    if (i13 != 6) {
                        if (i13 != 7) {
                            ...
                            switch (i13) {
                                case 9:
                                    ...
                                    if (inputPeer != null) {
                                        if (inputPeer instanceof TLRPC.TL_inputPeerChat) {
                                            ...
                                            gVar.f(chat, aVar.f43705i, aVar.f43704g, F(chat));
                                            ...
                                            gVar.f(chat2, aVar.f43705i, aVar.f43704g, F(chat2));
                                        }
                                    } else {
                                        TLRPC.Chat chat3 = aVar.e;
                                        gVar.f(chat3, aVar.f43705i, aVar.f43704g, F(chat3));
                                    }
                                    gVar.setChatDeleteListener(this.f43711n);
                                    return;
                                case 10:
                                ...
                                case 11:
                                    u uVar = (u) view;
                                    int i14 = aVar.f43708l;
                                    boolean z12 = aVar.f15534b;
                                    boolean z13 = aVar.f43704g;
                                    List list = (List) aVar.f43703f;
                                    ...
                                    uVar.f44310f.a(z12, false);
                                    uVar.setDivider(z13);
                                    uVar.e.setTextColor(i6.v0(i6.f19020n5, uVar.f44307a));
                                    if (list.size() == 0) {
                                ...
                                case 12:
                                    i iVar = (i) view;
                                    TLObject tLObject = aVar.f43709m;
                                    int i15 = aVar.f43705i;
                                    int i16 = aVar.f43706j;
                                    long j10 = aVar.h;
                                    CharSequence charSequence = aVar.f43702c;
                                    boolean z14 = aVar.f43704g;
                                    boolean z15 = aVar.f15534b;
                                    a6 a6Var2 = iVar.d;
                                    iVar.f44330s = tLObject;
                                    if (i15 >= 12) {
                                    ...
                                    iVar.setDivider(z14);
                                    iVar.f44310f.a(z15, false);
                                    return;
                                case 13:
                                    x xVar = (x) view;
                                    xVar.setText(aVar.f43702c);
                                    int i17 = aVar.f43705i;
                                    n6 n6Var = xVar.f44365r;
                                    if (i17 > 0) {
                                    ...
                                    return;
                                case 14:
                                    ((vg.e) view).setGiveaway((TL_stories.PrepaidGiveaway) aVar.f43703f);
                                    return;
                                case 15:
                                    y yVar = (y) view;
                                    CharSequence charSequence2 = aVar.f43702c;
                                    boolean z16 = aVar.f15534b;
                                    boolean z17 = aVar.f43704g;
                                    yVar.K = aVar.f43708l;
                                    yVar.f(charSequence2, z16, z17);
                                    return;
                                case 16:
                                    l lVar = (l) view;
                                    lVar.setCount(aVar.f43705i);
                                    lVar.setAfterTextChangedListener(this.f43713s);
                                    return;
                                case 17:
                                    w wVar = (w) view;
                                    TLObject tLObject2 = aVar.f43709m;
                                    if (tLObject2 != null) {
                                        tL_starsGiveawayOption = (TL_stars.TL_starsGiveawayOption) tLObject2;
                                    }
                                    int i18 = aVar.f43705i;
                                    long j11 = aVar.h;
                                    boolean z18 = aVar.f15534b;
                                    TextView textView = wVar.f44361f;
                                    n6 n6Var2 = wVar.d;
                                    n6 n6Var3 = wVar.e;
                                    if (wVar.f44363r == tL_starsGiveawayOption) {
                                        z11 = true;
                                    } else {
                                        z11 = false;
                                    }
                                    wVar.f44358a.a(z18, z11);
                                    wVar.f44363r = tL_starsGiveawayOption;
                                    if (z11) {
                                        n6Var3.a();
                                    }
                                    if (tL_starsGiveawayOption == null) {
                                        n6Var2.c(wVar.h, false, true);
                                        n6Var3.c(wVar.f44362n, z11, true);
                                        textView.setText("");
                                    } else {
                        ...
                        d0 d0Var = (d0) view;
                        d0Var.setText(aVar.f43702c);
                        d0Var.setBackground(aVar.f43704g);
                        return;
                    }
                    ((l4) view).setText(aVar.f43702c);
                    return;
                }
                vg.v vVar = (vg.v) view;
                List list2 = aVar.f43707k;
                int i20 = aVar.f43705i;
                vVar.getClass();
                String[] strArr = new String[list2.size()];
                for (int i21 = 0; i21 < list2.size(); i21++) {
                    strArr[i21] = String.valueOf((Integer) list2.get(i21));
                }
                vVar.f44357a.b(i20, null, strArr);
                vVar.setCallBack(this.h);
                return;
            }
            vg.d dVar = (vg.d) view;
            int i22 = aVar.f43708l;
            int i23 = aVar.f43705i;
            TLRPC.User user = (TLRPC.User) aVar.f43703f;
            boolean z19 = aVar.f15534b;
            u9 u9Var = dVar.f44309c;
            e6 e6Var = dVar.f44307a;
            a6 a6Var3 = dVar.d;
            j5 j5Var2 = dVar.e;
            f9 f9Var = dVar.f44308b;
            if (dVar.f44323r == i22) {
                z10 = true;
            } else {
                z10 = false;
            ...
            if (i22 == 0) {
                ...
                j5Var2.setTextColor(i6.v0(i6.f19091r5, e6Var));
                f9Var.g(16);
                f9Var.i(-15292942, -15630089);
                dVar.setDivider(true);
                dVar.setBackground(i6.V0(dVar.getContext(), R.drawable.greydivider_bottom, i6.f18800b7));
            } else if (i22 == 1) {
                ...
                j5Var2.setTextColor(i6.v0(i6.f19020n5, e6Var));
                f9Var.g(6);
                f9Var.i(-3905294, -6923014);
                dVar.setDivider(false);
                dVar.setBackground(i6.V0(dVar.getContext(), R.drawable.greydivider_top, i6.f18800b7));
            } else if (i22 == 2) {
        ...
        this.f43712r.setStars(aVar.f43704g);
    }
    ...
    public final c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 2:
                h7Var = new vg.d(context, e6Var);
                break;
            case 3:
                h7Var = new View(context);
                break;
            case 4:
                h7Var = new a7(context, i6.v0(i6.f18780a7, e6Var), 0);
                break;
            case 5:
                h7Var = new vg.v(context, e6Var);
                break;
            case 6:
                View l4Var = new l4(context, i6.L6, 21, 15, 3, false, false, this.d);
                l4Var.setBackgroundColor(i6.v0(i6.f18907h5, e6Var));
                h7Var = l4Var;
                break;
            case 7:
                h7Var = new d0(context, e6Var);
                break;
            case 8:
                h7Var = new vg.b(context, e6Var);
                break;
            case 9:
                h7Var = new vg.g(context, e6Var);
                break;
            case 10:
                h7Var = new h(context, e6Var);
                break;
            case 11:
                vg.c cVar = new vg.c(context, e6Var);
                cVar.f44309c.setVisibility(8);
                h7Var = cVar;
                break;
            case 12:
                h7Var = new i(context, e6Var);
                break;
            case 13:
                View xVar = new x(context, e6Var);
                xVar.setBackgroundColor(i6.v0(i6.f18907h5, e6Var));
                h7Var = xVar;
                break;
            case 14:
                h7Var = new vg.d(context, e6Var);
            ...
            case 15:
                ...
                break;
            case 16:
                h7Var = new l(context, e6Var);
                break;
            case 17:
                h7Var = new w(context, e6Var);
                break;
            case 18:
