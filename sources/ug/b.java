...
public final class b extends og.b {
    ...
    public final HashMap f43742w = new HashMap();
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (i13 != 0) {
                    ...
                    if (i13 != 6) {
                        if (i13 != 7) {
                            ...
                            switch (i13) {
                                case 9:
                                    ...
                                    if (inputPeer != null) {
                                        if (inputPeer instanceof TLRPC.TL_inputPeerChat) {
                                            ...
                                            gVar.f(chat, aVar.f43733i, aVar.f43732g, F(chat));
                                            ...
                                            gVar.f(chat2, aVar.f43733i, aVar.f43732g, F(chat2));
                                        }
                                    } else {
                                        TLRPC.Chat chat3 = aVar.e;
                                        gVar.f(chat3, aVar.f43733i, aVar.f43732g, F(chat3));
                                    }
                                    gVar.setChatDeleteListener(this.f43739n);
                                    return;
                                case 10:
                                ...
                                case 11:
                                    u uVar = (u) view;
                                    int i14 = aVar.f43736l;
                                    boolean z12 = aVar.f15544b;
                                    boolean z13 = aVar.f43732g;
                                    List list = (List) aVar.f43731f;
                                    ...
                                    uVar.f44338f.a(z12, false);
                                    uVar.setDivider(z13);
                                    uVar.e.setTextColor(j6.v0(j6.f19047n5, uVar.f44335a));
                                    if (list.size() == 0) {
                                ...
                                case 12:
                                    i iVar = (i) view;
                                    TLObject tLObject = aVar.f43737m;
                                    int i15 = aVar.f43733i;
                                    int i16 = aVar.f43734j;
                                    long j10 = aVar.h;
                                    CharSequence charSequence = aVar.f43730c;
                                    boolean z14 = aVar.f43732g;
                                    boolean z15 = aVar.f15544b;
                                    a6 a6Var2 = iVar.d;
                                    iVar.f44358s = tLObject;
                                    if (i15 >= 12) {
                                    ...
                                    iVar.setDivider(z14);
                                    iVar.f44338f.a(z15, false);
                                    return;
                                case 13:
                                    x xVar = (x) view;
                                    xVar.setText(aVar.f43730c);
                                    int i17 = aVar.f43733i;
                                    n6 n6Var = xVar.f44393r;
                                    if (i17 > 0) {
                                    ...
                                    return;
                                case 14:
                                    ((vg.e) view).setGiveaway((TL_stories.PrepaidGiveaway) aVar.f43731f);
                                    return;
                                case 15:
                                    y yVar = (y) view;
                                    CharSequence charSequence2 = aVar.f43730c;
                                    boolean z16 = aVar.f15544b;
                                    boolean z17 = aVar.f43732g;
                                    yVar.K = aVar.f43736l;
                                    yVar.f(charSequence2, z16, z17);
                                    return;
                                case 16:
                                    l lVar = (l) view;
                                    lVar.setCount(aVar.f43733i);
                                    lVar.setAfterTextChangedListener(this.f43741s);
                                    return;
                                case 17:
                                    w wVar = (w) view;
                                    TLObject tLObject2 = aVar.f43737m;
                                    if (tLObject2 != null) {
                                        tL_starsGiveawayOption = (TL_stars.TL_starsGiveawayOption) tLObject2;
                                    }
                                    int i18 = aVar.f43733i;
                                    long j11 = aVar.h;
                                    boolean z18 = aVar.f15544b;
                                    TextView textView = wVar.f44389f;
                                    n6 n6Var2 = wVar.d;
                                    n6 n6Var3 = wVar.e;
                                    if (wVar.f44391r == tL_starsGiveawayOption) {
                                        z11 = true;
                                    } else {
                                        z11 = false;
                                    }
                                    wVar.f44386a.a(z18, z11);
                                    wVar.f44391r = tL_starsGiveawayOption;
                                    if (z11) {
                                        n6Var3.a();
                                    }
                                    if (tL_starsGiveawayOption == null) {
                                        n6Var2.c(wVar.h, false, true);
                                        n6Var3.c(wVar.f44390n, z11, true);
                                        textView.setText("");
                                    } else {
                        ...
                        d0 d0Var = (d0) view;
                        d0Var.setText(aVar.f43730c);
                        d0Var.setBackground(aVar.f43732g);
                        return;
                    }
                    ((l4) view).setText(aVar.f43730c);
                    return;
                }
                vg.v vVar = (vg.v) view;
                List list2 = aVar.f43735k;
                int i20 = aVar.f43733i;
                vVar.getClass();
                String[] strArr = new String[list2.size()];
                for (int i21 = 0; i21 < list2.size(); i21++) {
                    strArr[i21] = String.valueOf((Integer) list2.get(i21));
                }
                vVar.f44385a.b(i20, null, strArr);
                vVar.setCallBack(this.h);
                return;
            }
            vg.d dVar = (vg.d) view;
            int i22 = aVar.f43736l;
            int i23 = aVar.f43733i;
            TLRPC.User user = (TLRPC.User) aVar.f43731f;
            boolean z19 = aVar.f15544b;
            u9 u9Var = dVar.f44337c;
            f6 f6Var = dVar.f44335a;
            a6 a6Var3 = dVar.d;
            k5 k5Var2 = dVar.e;
            f9 f9Var = dVar.f44336b;
            if (dVar.f44351r == i22) {
                z10 = true;
            } else {
                z10 = false;
            ...
            if (i22 == 0) {
                ...
                k5Var2.setTextColor(j6.v0(j6.f19118r5, f6Var));
                f9Var.g(16);
                f9Var.i(-15292942, -15630089);
                dVar.setDivider(true);
                dVar.setBackground(j6.V0(dVar.getContext(), R.drawable.greydivider_bottom, j6.f18827b7));
            } else if (i22 == 1) {
                ...
                k5Var2.setTextColor(j6.v0(j6.f19047n5, f6Var));
                f9Var.g(6);
                f9Var.i(-3905294, -6923014);
                dVar.setDivider(false);
                dVar.setBackground(j6.V0(dVar.getContext(), R.drawable.greydivider_top, j6.f18827b7));
            } else if (i22 == 2) {
        ...
        this.f43740r.setStars(aVar.f43732g);
    }
    ...
    public final c1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 3:
                ...
                break;
            case 4:
                h7Var = new a7(context, j6.v0(j6.f18807a7, f6Var), 0);
                break;
            case 5:
            ...
            case 6:
                ...
                l4Var.setBackgroundColor(j6.v0(j6.f18934h5, f6Var));
                h7Var = l4Var;
                break;
            case 7:
            ...
            case 13:
                ...
                xVar.setBackgroundColor(j6.v0(j6.f18934h5, f6Var));
                h7Var = xVar;
                break;
            case 14:
                h7Var = new vg.d(context, f6Var);
