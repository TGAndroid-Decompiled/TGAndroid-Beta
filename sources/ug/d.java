...
public final class d extends View implements ViewTreeObserver.OnPreDrawListener, ViewTreeObserver.OnScrollChangedListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public final RectF f45508b;
    public final RectF f45509c;
    public long d;
    public int e;
    public ViewGroup f45510f;
    public ViewGroup h;
    public long f45511n;
    public b f45512r;
    public long f45513s;
    public final ArrayList v;
    public final LongSparseArray f45514w;
    public final LongSparseArray f45515x;
    public final b f45516y;

    public d(Context context) {
        super(context);
        this.f45508b = new RectF();
        this.f45509c = new RectF();
        this.v = new ArrayList();
        this.f45514w = new LongSparseArray();
        this.f45515x = new LongSparseArray();
        this.f45516y = new b(this, 1);
        this.f45507a = SharedConfig.debugViewMetrics;
    }
    ...
    public final void b(int i10, long j10, ViewGroup viewGroup, qj qjVar) {
        this.d = j10;
        this.e = i10;
        this.f45510f = viewGroup;
        this.h = qjVar;
    }

    public final void c() {
        throw new UnsupportedOperationException("Method not decompiled: ug.d.c():void");
    }
    ...
    public final void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(this.f45516y, 400L);
    ...
    public final void onDetachedFromWindow() {
        ...
        this.B = null;
        this.f45513s = 0L;
        AndroidUtilities.cancelRunOnUIThread(this.f45516y);
        if (BuildVars.LOGS_ENABLED) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.f45507a) {
            ...
            super.onDraw(canvas);
            Paint paint = j6.Ll;
            RectF rectF = this.f45509c;
            canvas.drawRect(rectF, paint);
            LongSparseArray longSparseArray = this.f45514w;
            int size = longSparseArray.size();
            for (int i10 = 0; i10 < size; i10++) {
                c cVar = (c) longSparseArray.valueAt(i10);
                RectF rectF2 = cVar.f45499c;
                ...
                canvas.save();
                canvas.drawText("time_in_view_ms: " + cVar.f45501g, 0.0f, 0.0f, this.D);
                ...
                float f10 = cVar.f45504k;
                if (f10 == 0.0f) {
                    round = 1000;
                } else {
                    round = Math.round((cVar.f45503j / f10) * 1000.0f);
                }
                sb.append(round);
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        RectF rectF = this.f45508b;
        this.f45509c.set(rectF.left, rectF.top, getMeasuredWidth() - rectF.right, getMeasuredHeight() - rectF.bottom);
    }
