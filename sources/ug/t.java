...
public abstract class t {
    ...
    public static ArrayList e(long j3) {
        ...
        for (int i10 = 0; i10 < allDialogs.size(); i10++) {
            ...
            if (DialogObject.isChatDialog(dialog.f19873id) && ChatObject.isBoostSupported(messagesController.getChat(Long.valueOf(-dialog.f19873id)))) {
    ...
    public static int j(int i10, TLRPC.Chat chat, Utilities.Callback callback) {
        ...
        if (chat != null) {
            ...
            tL_payments_getPremiumGiftCodeOptions.boost_peer = messagesController.getInputPeer(-chat.f19869id);
        }
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, n2 n2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (!h()) {
            ...
            if (chat != null) {
                ...
                tL_inputStorePaymentPremiumGiftCode.boost_peer = messagesController.getInputPeer(-chat.f19869id);
            }
        ...
        if (chat != null) {
            ...
            tL_inputStorePaymentPremiumGiftCode2.boost_peer = messagesController2.getInputPeer(-chat.f19869id);
        }
        if (tL_textWithEntities != null && !TextUtils.isEmpty(tL_textWithEntities.text)) {
        ...
        ?? obj3 = new Object();
        obj3.f4342b = "inapp";
        obj3.f4341a = tL_premiumGiftCodeOption.store_product;
    ...
    public static void m(int i10, ArrayList arrayList) {
        ...
        f47208a.put(Integer.valueOf(i10), new Pair(Long.valueOf(System.currentTimeMillis()), arrayList));
    }
}
