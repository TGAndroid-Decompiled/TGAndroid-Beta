...
public final class a extends ReplacementSpan {
    public final Drawable f47067a;
    public final Drawable f47068b;
    public boolean f47069c;
    public boolean d;
    public final p6 f47070e;
    public final TextPaint f47071f;
    public final int h;

    public a(t1 t1Var, TextPaint textPaint, int i10) {
        this.f47071f = textPaint;
    ...
    public final int b() {
        ...
        return (int) (this.f47070e.e() + AndroidUtilities.dp(i10 + 16));
    }

    @Override
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f7, int i12, int i13, int i14, Paint paint) {
        int i15;
        TextPaint textPaint = this.f47071f;
        int color = textPaint.getColor();
        p6 p6Var = this.f47070e;
        int color2 = p6Var.f29312a.getColor();
        Drawable drawable = this.f47068b;
        Drawable drawable2 = this.f47067a;
        if (color != color2) {
            p6Var.r(textPaint.getColor());
            int color3 = p6Var.f29312a.getColor();
            PorterDuff.Mode mode = PorterDuff.Mode.MULTIPLY;
            drawable2.setColorFilter(new PorterDuffColorFilter(color3, mode));
            drawable.setColorFilter(new PorterDuffColorFilter(p6Var.f29312a.getColor(), mode));
        }
        canvas.save();
        if (this.d && !this.f47069c) {
        ...
        rect.set(0, 0, (int) p6Var.d(), (int) p6Var.f29315e);
