...
public final class i implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    public static final int[] f45531f = new int[2];
    public static final RectF h = new RectF();
    public final View f45532a;
    public ViewTreeObserver f45533b;
    ...
    public final boolean onPreDraw() {
        ViewTreeObserver viewTreeObserver = this.f45532a.getViewTreeObserver();
        ViewTreeObserver viewTreeObserver2 = this.f45533b;
        if (viewTreeObserver != viewTreeObserver2) {
            if (this.f45534c && viewTreeObserver2 != null && viewTreeObserver2.isAlive()) {
                this.f45533b.removeOnPreDrawListener(this);
            }
            this.f45534c = false;
            this.f45533b = null;
            a();
        ...
        if (!weakHashMap.isEmpty()) {
            for (Map.Entry entry : weakHashMap.entrySet()) {
                ...
                if (view != null && list != null) {
                    for (h hVar : list) {
                        boolean z4 = hVar.d;
                        RectF rectF = hVar.f45530c;
                        ViewGroup viewGroup = hVar.f45528a;
                        RectF rectF2 = this.e;
                        if (z4) {
                            int[] iArr = f45531f;
                        ...
                        if (!hVar.e || !rectF2.equals(rectF)) {
                            ...
                            hVar.e = true;
                            try {
                                hVar.f45529b.d(new RectF(rectF2), view);
    ...
    public final void onViewDetachedFromWindow(View view) {
        ViewTreeObserver viewTreeObserver;
        if (view == this.f45532a) {
            if (this.f45534c && (viewTreeObserver = this.f45533b) != null && viewTreeObserver.isAlive()) {
                this.f45533b.removeOnPreDrawListener(this);
            }
            this.f45534c = false;
            this.f45533b = null;
