...
public final class i implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    public static final int[] f45595f = new int[2];
    public static final RectF h = new RectF();
    public final View f45596a;
    public ViewTreeObserver f45597b;
    ...
    public final boolean onPreDraw() {
        ViewTreeObserver viewTreeObserver = this.f45596a.getViewTreeObserver();
        ViewTreeObserver viewTreeObserver2 = this.f45597b;
        if (viewTreeObserver != viewTreeObserver2) {
            if (this.f45598c && viewTreeObserver2 != null && viewTreeObserver2.isAlive()) {
                this.f45597b.removeOnPreDrawListener(this);
            }
            this.f45598c = false;
            this.f45597b = null;
            a();
        ...
        if (!weakHashMap.isEmpty()) {
            for (Map.Entry entry : weakHashMap.entrySet()) {
                ...
                if (view != null && list != null) {
                    for (h hVar : list) {
                        boolean z4 = hVar.d;
                        RectF rectF = hVar.f45594c;
                        ViewGroup viewGroup = hVar.f45592a;
                        RectF rectF2 = this.e;
                        if (z4) {
                            int[] iArr = f45595f;
                        ...
                        if (!hVar.e || !rectF2.equals(rectF)) {
                            ...
                            hVar.e = true;
                            try {
                                hVar.f45593b.e(new RectF(rectF2), view);
    ...
    public final void onViewDetachedFromWindow(View view) {
        ViewTreeObserver viewTreeObserver;
        if (view == this.f45596a) {
            if (this.f45598c && (viewTreeObserver = this.f45597b) != null && viewTreeObserver.isAlive()) {
                this.f45597b.removeOnPreDrawListener(this);
            }
            this.f45598c = false;
            this.f45597b = null;
