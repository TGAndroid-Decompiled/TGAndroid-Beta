...
public final class i0 extends View {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        TextPaint textPaint = this.f47132a;
        ...
        canvas.drawText("+" + this.f47133b, measuredWidth, (int) (measuredHeight - ((textPaint.ascent() + descent) / 2.0f)), textPaint);
    }
}
