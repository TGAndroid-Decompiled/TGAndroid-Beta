...
public abstract class c {
    public static final Matrix f48827a = new Matrix();
    public static final RectF f48828b = new RectF();
    public static final RectF f48829c = new RectF();

    public static void a(pg.a aVar, Canvas canvas, RectF rectF, View view, ViewGroup viewGroup, int i10) {
        boolean z4;
        if (i10 > 0) {
            RectF rectF2 = f48829c;
            if (i.c(view, viewGroup, rectF2)) {
                float f10 = rectF2.left;
                float f11 = rectF2.top;
                RectF rectF3 = f48828b;
                rectF3.set(rectF);
