...
public abstract class j0 {
    public static WeakHashMap f43142a = null;
    public static Field f43143b = null;
    public static boolean f43144c = false;
    public static final w d = new Object();
    public static final y e = new y();

    public static m0 a(View view) {
        if (f43142a == null) {
            f43142a = new WeakHashMap();
        }
        m0 m0Var = (m0) f43142a.get(view);
        if (m0Var == null) {
            m0 m0Var2 = new m0(view);
            f43142a.put(view, m0Var2);
            return m0Var2;
        }
        return m0Var;
    }
    ...
    public static boolean c(View view, KeyEvent keyEvent) {
        if (Build.VERSION.SDK_INT < 28) {
            ...
            if (keyEvent.getAction() == 0) {
                WeakHashMap weakHashMap = i0Var2.f43137a;
                if (weakHashMap != null) {
                    weakHashMap.clear();
                }
                ...
                if (!arrayList2.isEmpty()) {
                    synchronized (arrayList2) {
                        try {
                            if (i0Var2.f43137a == null) {
                                i0Var2.f43137a = new WeakHashMap();
                            }
                            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                                ...
                                if (view2 == null) {
                                    ...
                                    i0Var2.f43137a.put(view2, Boolean.TRUE);
                                    for (ViewParent parent = view2.getParent(); parent instanceof View; parent = parent.getParent()) {
                                        i0Var2.f43137a.put((View) parent, Boolean.TRUE);
                                    }
                                }
                            }
                        } finally {
            ...
            if (keyEvent.getAction() == 0) {
                ...
                if (a2 != null && !KeyEvent.isModifierKey(keyCode)) {
                    ...
                    i0Var2.f43138b.put(keyCode, new WeakReference(a2));
                }
            }
            if (a2 != null) {
                return true;
    ...
    public static void l(View view, CharSequence charSequence) {
        ...
        if (charSequence != null) {
            WeakHashMap weakHashMap = yVar.f43181a;
