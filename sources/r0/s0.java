...
public final class s0 extends WindowInsetsAnimation.Callback {
    public final ph.e f41820a;
    public List f41821b;
    public ArrayList f41822c;
    ...
    public final v0 a(WindowInsetsAnimation windowInsetsAnimation) {
        ...
        if (v0Var == null) {
            ...
            if (Build.VERSION.SDK_INT >= 30) {
                v0Var.f41830a = new t0(windowInsetsAnimation);
            }
    ...
    public final WindowInsets onProgress(WindowInsets windowInsets, List list) {
        ...
        if (arrayList == null) {
            ...
            this.f41822c = arrayList2;
            this.f41821b = DesugarCollections.unmodifiableList(arrayList2);
        } else {
            arrayList.clear();
        }
        for (int size = list.size() - 1; size >= 0; size--) {
            ...
            a2.f41830a.d(windowInsetsAnimation.getFraction());
            this.f41822c.add(a2);
        }
        ph.e eVar = this.f41820a;
        l1 h = l1.h(null, windowInsets);
        eVar.T0(h, this.f41821b);
        return h.g();
    }
