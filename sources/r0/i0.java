...
public abstract class i0 {
    public static WeakHashMap f41865a = null;
    public static Field f41866b = null;
    public static boolean f41867c = false;
    public static final v d = new Object();
    public static final x e = new x();

    public static l0 a(View view) {
        if (f41865a == null) {
            f41865a = new WeakHashMap();
        }
        l0 l0Var = (l0) f41865a.get(view);
        if (l0Var == null) {
            l0 l0Var2 = new l0(view);
            f41865a.put(view, l0Var2);
            return l0Var2;
        }
        return l0Var;
    }
    ...
    public static boolean c(View view, KeyEvent keyEvent) {
        if (Build.VERSION.SDK_INT < 28) {
            ...
            if (keyEvent.getAction() == 0) {
                WeakHashMap weakHashMap = h0Var2.f41860a;
                if (weakHashMap != null) {
                    weakHashMap.clear();
                }
                ...
                if (!arrayList2.isEmpty()) {
                    synchronized (arrayList2) {
                        try {
                            if (h0Var2.f41860a == null) {
                                h0Var2.f41860a = new WeakHashMap();
                            }
                            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                                ...
                                if (view2 == null) {
                                    ...
                                    h0Var2.f41860a.put(view2, Boolean.TRUE);
                                    for (ViewParent parent = view2.getParent(); parent instanceof View; parent = parent.getParent()) {
                                        h0Var2.f41860a.put((View) parent, Boolean.TRUE);
                                    }
                                }
                            }
                        } finally {
            ...
            if (keyEvent.getAction() == 0) {
                ...
                if (a2 != null && !KeyEvent.isModifierKey(keyCode)) {
                    if (h0Var2.f41861b == null) {
                        h0Var2.f41861b = new SparseArray();
                    }
                    h0Var2.f41861b.put(keyCode, new WeakReference(a2));
                }
            }
            if (a2 != null) {
                return true;
    ...
    public static void l(View view, CharSequence charSequence) {
        ...
        if (charSequence != null) {
            WeakHashMap weakHashMap = xVar.f41904a;
