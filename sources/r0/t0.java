...
public final class t0 extends u0 {
    public final WindowInsetsAnimation f44759e;

    public t0(WindowInsetsAnimation windowInsetsAnimation) {
        super(0, 0L, null);
        this.f44759e = windowInsetsAnimation;
    }
    ...
    @Override
    public final long a() {
        return this.f44759e.getDurationMillis();
    }

    @Override
    public final float b() {
        return this.f44759e.getInterpolatedFraction();
    }

    @Override
    public final int c() {
        return this.f44759e.getTypeMask();
    }

    @Override
    public final void d(float f7) {
        this.f44759e.setFraction(f7);
    }
}
