...
public final class k {
    public ViewParent f42134a;
    public ViewParent f42135b;
    public final ViewGroup f42136c;
    public boolean d;
    public int[] e;

    public k(ViewGroup viewGroup) {
        this.f42136c = viewGroup;
    }
    ...
    public final boolean a(float f7, float f10, boolean z10) {
        ...
        if (this.d && (e = e(0)) != null) {
            try {
                return e.onNestedFling(this.f42136c, f7, f10, z10);
    ...
    public final boolean b(float f7, float f10) {
        ...
        if (this.d && (e = e(0)) != null) {
            try {
                return e.onNestedPreFling(this.f42136c, f7, f10);
            } catch (AbstractMethodError e7) {
    ...
    public final boolean c(int i10, int i11, int i12, int[] iArr, int[] iArr2) {
        ...
        ViewGroup viewGroup = this.f42136c;
        if (iArr2 != null) {
