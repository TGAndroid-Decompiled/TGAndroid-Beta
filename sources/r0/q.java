...
public final class q implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    ...
    public ViewTreeObserver f46458b;
    public final Runnable f46459c;

    public q(View view, Runnable runnable) {
        this.f46457a = view;
        this.f46458b = view.getViewTreeObserver();
        this.f46459c = runnable;
    }
    ...
    public final boolean onPreDraw() {
        boolean isAlive = this.f46458b.isAlive();
        View view = this.f46457a;
        if (isAlive) {
            this.f46458b.removeOnPreDrawListener(this);
        } else {
