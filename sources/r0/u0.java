...
public final class u0 extends v0 {
    public final WindowInsetsAnimation f46948e;

    public u0(WindowInsetsAnimation windowInsetsAnimation) {
        super(0, 0L, null);
        this.f46948e = windowInsetsAnimation;
    }
    ...
    @Override
    public final long a() {
        return this.f46948e.getDurationMillis();
    }

    @Override
    public final float b() {
        return this.f46948e.getInterpolatedFraction();
    }

    @Override
    public final int c() {
        return this.f46948e.getTypeMask();
    }

    @Override
    public final void d(float f10) {
        this.f46948e.setFraction(f10);
    }
}
