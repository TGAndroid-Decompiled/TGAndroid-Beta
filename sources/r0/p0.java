...
public final class p0 implements View.OnApplyWindowInsetsListener {
    ...
    public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
        ...
        boolean z11;
        if (!view.isLaidOut()) {
            this.f44721b = l1.h(view, windowInsets);
        ...
        if (this.f44721b == null) {
            ...
            if (i10 != null && Objects.equals((l1) i10.f2041a, h)) {
                ...
                int[] iArr2 = new int[1];
                int[] iArr3 = new int[1];
                l1 l1Var = this.f44721b;
                int i11 = 1;
                while (i11 <= 512) {
                    i0.c f7 = i1Var.f(i11);
                    i0.c f10 = l1Var.f44712a.f(i11);
                    int i12 = f7.f11425a;
                    int i13 = f7.d;
                    int i14 = f7.f11427c;
                    int i15 = f7.f11426b;
                ...
                if (i22 == 0) {
                    ...
                    l1 l1Var2 = this.f44721b;
                    if ((i20 & 8) != 0) {
                        interpolator = q0.f44723e;
                    } else if ((i21 & 8) != 0) {
                        interpolator = q0.f44724f;
                    } else if ((i20 & 519) != 0) {
                        interpolator = q0.f44725g;
                    } else if ((i21 & 519) != 0) {
                        interpolator = q0.h;
                    } else {
                        interpolator = null;
                    ...
                    v0Var.f44739a.d(0.0f);
                    ValueAnimator duration = ValueAnimator.ofFloat(0.0f, 1.0f).setDuration(v0Var.f44739a.a());
                    i0.c f11 = i1Var.f(i22);
                    i0.c f12 = l1Var2.f44712a.f(i22);
