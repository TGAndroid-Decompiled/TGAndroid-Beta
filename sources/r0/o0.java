...
public final class o0 implements ValueAnimator.AnimatorUpdateListener {
    public final v0 f44713a;
    public final l1 f44714b;
    public final l1 f44715c;
    public final int d;
    public final View f44716e;
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        v0 v0Var = this.f44713a;
        u0 u0Var = v0Var.f44739a;
        u0Var.d(animatedFraction);
        l1 l1Var = this.f44714b;
        ...
        for (int i11 = 1; i11 <= 512; i11 <<= 1) {
            if ((this.d & i11) == 0) {
                ...
                i0.c f7 = i1Var.f(i11);
                i0.c f10 = this.f44715c.f44712a.f(i11);
                float f11 = 1.0f - b10;
        ...
        q0.g(this.f44716e, x0Var.b(), Collections.singletonList(v0Var));
    }
}
