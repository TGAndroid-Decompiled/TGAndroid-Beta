...
public final class l1 {
    public static final l1 f41850b;
    public final i1 f41851a;
    ...
    public l1(WindowInsets windowInsets) {
        int i10 = Build.VERSION.SDK_INT;
        if (i10 >= 34) {
            this.f41851a = new h1(this, windowInsets);
        } else if (i10 >= 30) {
            this.f41851a = new g1(this, windowInsets);
        } else if (i10 >= 29) {
            this.f41851a = new f1(this, windowInsets);
        } else if (i10 >= 28) {
            this.f41851a = new e1(this, windowInsets);
        } else {
            this.f41851a = new d1(this, windowInsets);
        }
    }
    ...
    public final int a() {
        return this.f41851a.k().d;
    }

    public final int b() {
        return this.f41851a.k().f10590a;
    }

    public final int c() {
        return this.f41851a.k().f10592c;
    }

    public final int d() {
        return this.f41851a.k().f10591b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Objects.equals(this.f41851a, ((l1) obj).f41851a);
    }
    ...
    public final WindowInsets g() {
        i1 i1Var = this.f41851a;
        if (i1Var instanceof c1) {
            return ((c1) i1Var).f41816c;
        }
        return null;
    }
