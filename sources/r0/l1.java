...
public final class l1 {
    public static final l1 f42138b;
    public final i1 f42139a;
    ...
    public l1(WindowInsets windowInsets) {
        int i10 = Build.VERSION.SDK_INT;
        if (i10 >= 34) {
            this.f42139a = new h1(this, windowInsets);
        } else if (i10 >= 30) {
            this.f42139a = new g1(this, windowInsets);
        } else if (i10 >= 29) {
            this.f42139a = new f1(this, windowInsets);
        } else if (i10 >= 28) {
            this.f42139a = new e1(this, windowInsets);
        } else {
            this.f42139a = new d1(this, windowInsets);
        }
    }
    ...
    public final int a() {
        return this.f42139a.k().d;
    }

    public final int b() {
        return this.f42139a.k().f10576a;
    }

    public final int c() {
        return this.f42139a.k().f10578c;
    }

    public final int d() {
        return this.f42139a.k().f10577b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Objects.equals(this.f42139a, ((l1) obj).f42139a);
    }
    ...
    public final WindowInsets g() {
        i1 i1Var = this.f42139a;
        if (i1Var instanceof c1) {
            return ((c1) i1Var).f42104c;
        }
        return null;
    }
