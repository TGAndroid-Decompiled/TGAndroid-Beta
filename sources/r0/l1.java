...
public final class l1 {
    public static final l1 f44711b;
    public final i1 f44712a;
    ...
    public l1(WindowInsets windowInsets) {
        int i10 = Build.VERSION.SDK_INT;
        if (i10 >= 34) {
            this.f44712a = new h1(this, windowInsets);
        } else if (i10 >= 30) {
            this.f44712a = new g1(this, windowInsets);
        } else if (i10 >= 29) {
            this.f44712a = new f1(this, windowInsets);
        } else if (i10 >= 28) {
            this.f44712a = new e1(this, windowInsets);
        } else {
            this.f44712a = new d1(this, windowInsets);
        }
    }
    ...
    public final int a() {
        return this.f44712a.k().d;
    }

    public final int b() {
        return this.f44712a.k().f11425a;
    }

    public final int c() {
        return this.f44712a.k().f11427c;
    }

    public final int d() {
        return this.f44712a.k().f11426b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Objects.equals(this.f44712a, ((l1) obj).f44712a);
    }
    ...
    public final WindowInsets g() {
        i1 i1Var = this.f44712a;
        if (i1Var instanceof c1) {
            return ((c1) i1Var).f44672c;
        }
        return null;
    }
