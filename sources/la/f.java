...
public final class f implements ia.e {
    public static final Charset f14147f = Charset.forName("UTF-8");
    public static final ia.c f14148g = new ia.c("key", k0.n(k0.m(e.class, new a(1))));
    public static final ia.c h = new ia.c("value", k0.n(k0.m(e.class, new a(2))));
    public static final ka.a f14149i = new ka.a(1);
    public OutputStream f14150a;
    ...
    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap hashMap, HashMap hashMap2, ia.d dVar) {
        this.f14150a = byteArrayOutputStream;
        this.f14151b = hashMap;
        this.f14152c = hashMap2;
        this.d = dVar;
    }
    ...
    public final void b(ia.c cVar, double d, boolean z10) {
        ...
        k((j(cVar) << 3) | 1);
        this.f14150a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d).array());
    }
        ...
        if (obj != null) {
            if (obj instanceof CharSequence) {
                ...
                if (!z10 || charSequence.length() != 0) {
                    k((j(cVar) << 3) | 2);
                    byte[] bytes = charSequence.toString().getBytes(f14147f);
                    k(bytes.length);
                    this.f14150a.write(bytes);
                }
                ...
                if (!z10 || floatValue != 0.0f) {
                    k((j(cVar) << 3) | 5);
                    this.f14150a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(floatValue).array());
                }
                ...
                ia.d dVar = (ia.d) this.f14151b.get(obj.getClass());
                if (dVar != null) {
                    i(dVar, cVar, obj, z10);
                    return;
                }
                ia.f fVar = (ia.f) this.f14152c.get(obj.getClass());
                if (fVar != null) {
                    h hVar = this.e;
                    hVar.f14155b = false;
                    hVar.d = cVar;
    ...
    public final void i(ia.d dVar, ia.c cVar, Object obj, boolean z10) {
        ...
        bVar.f14144b = 0L;
        try {
            OutputStream outputStream = this.f14150a;
            this.f14150a = bVar;
            dVar.a(obj, this);
    ...
    public final void k(int i10) {
        while ((i10 & (-128)) != 0) {
            this.f14150a.write((i10 & 127) | 128);
            i10 >>>= 7;
        }
        this.f14150a.write(i10 & 127);
    }

    public final void l(long j3) {
        while (((-128) & j3) != 0) {
            this.f14150a.write((((int) j3) & 127) | 128);
            j3 >>>= 7;
        }
        this.f14150a.write(((int) j3) & 127);
    }
}
