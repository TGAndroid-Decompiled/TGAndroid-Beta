...
public final class b {
    public static final u4 f51378a;

    static {
        d dVar = new d();
        y9.d dVar2 = y9.d.f49723a;
        ...
        y9.b bVar = y9.b.f49694a;
        dVar.j(g1.class, bVar);
        dVar.j(b0.class, bVar);
        y9.a aVar = y9.a.f49681a;
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        switch (c13) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                str12 = new String(Base64.decode(jsonReader.nextString(), 2), e2.f49746a);
                                break;
                            case 3:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c10) {
                ...
                case 1:
                    String nextString = jsonReader.nextString();
                    if (nextString != null) {
                        obj.f47407a = nextString;
                        break;
                    } else {
                        throw new NullPointerException("Null sdkVersion");
                    }
                case 2:
                    obj.f47410e = jsonReader.nextString();
                    break;
                case 3:
                    obj.f47414j = c(jsonReader);
                    break;
                case 4:
                    String nextString2 = jsonReader.nextString();
                    if (nextString2 != null) {
                        obj.f47415k = nextString2;
                        break;
                    } else {
                ...
                case 7:
                    ...
                    break;
                case '\b':
                    obj.f47413i = Integer.valueOf(jsonReader.nextInt());
                    break;
                case '\t':
                    String nextString5 = jsonReader.nextString();
                    if (nextString5 != null) {
                        obj.f47411f = nextString5;
                        break;
                    } else {
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        switch (c11) {
                            case 0:
                                ...
                                break;
                            case 1:
                                obj2.f49760c = jsonReader.nextString();
                                break;
                            case 2:
                                obj2.f49759b = new String(Base64.decode(jsonReader.nextString(), 2), e2.f49746a);
                                break;
                            case 3:
                                obj2.f49761e = Long.valueOf(jsonReader.nextLong());
                                break;
                            case 4:
                                ?? obj3 = new Object();
                                jsonReader.beginObject();
                            ...
                            case 5:
                                ...
                                jsonReader.endArray();
                                obj2.f49766k = DesugarCollections.unmodifiableList(arrayList);
                                break;
                            case 6:
                                ?? obj4 = new Object();
                                jsonReader.beginObject();
                            ...
                            case 7:
                                ...
                                if (str.isEmpty()) {
                                    obj2.f49763g = new i0(str6, str7, str8, str9, str10, str11);
                                    break;
                                } else {
                                    throw new IllegalStateException("Missing required properties:".concat(str));
                                }
                            ...
                            case '\t':
                                ...
                                if (nextString11 != null) {
                                    obj2.f49758a = nextString11;
                                    break;
                                } else {
                                    throw new NullPointerException("Null generator");
                                }
                            case '\n':
                                obj2.f49762f = Boolean.valueOf(jsonReader.nextBoolean());
                                break;
                            case 11:
                                obj2.f49767l = Integer.valueOf(jsonReader.nextInt());
                                break;
                            default:
                                jsonReader.skipValue();
                                break;
