...
public final class a {
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        switch (c13) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                str12 = new String(Base64.decode(jsonReader.nextString(), 2), e2.f46786a);
                                break;
                            case 3:
    ...
    public static t0 g(JsonReader jsonReader) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c10) {
                case 0:
                    obj.f15760b = Integer.valueOf(jsonReader.nextInt());
                    break;
                case 1:
                    String nextString = jsonReader.nextString();
                    if (nextString != null) {
                        obj.f15759a = nextString;
                        break;
                    } else {
                        throw new NullPointerException("Null processName");
                    }
                case 2:
                    ...
                    break;
                case 3:
                    obj.f15761c = Integer.valueOf(jsonReader.nextInt());
                    break;
                default:
                    jsonReader.skipValue();
                    break;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c10) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    obj.f44240j = c(jsonReader);
                    break;
                case 4:
                    String nextString2 = jsonReader.nextString();
                    if (nextString2 != null) {
                        obj.f44241k = nextString2;
                        break;
                    } else {
                ...
                case 7:
                    ...
                    break;
                case '\b':
                    obj.f44239i = Integer.valueOf(jsonReader.nextInt());
                    break;
                case '\t':
                    String nextString5 = jsonReader.nextString();
                    if (nextString5 != null) {
                        obj.f44237f = nextString5;
                        break;
                    } else {
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        switch (c11) {
                            case 0:
                                ...
                                break;
                            case 1:
                                obj2.f46799c = jsonReader.nextString();
                                break;
                            case 2:
                                obj2.f46798b = new String(Base64.decode(jsonReader.nextString(), 2), e2.f46786a);
                                break;
                            case 3:
                                obj2.e = Long.valueOf(jsonReader.nextLong());
                                break;
                            ...
                            case 5:
                                ...
                                jsonReader.endArray();
                                obj2.f46804k = DesugarCollections.unmodifiableList(arrayList);
                                break;
                            case 6:
                                ?? obj4 = new Object();
                                jsonReader.beginObject();
                                    ...
                                    switch (c13) {
                                        ...
                                        case 2:
                                            ...
                                            if (nextString10 != null) {
                                                obj4.f15760b = nextString10;
                                                break;
                                            } else {
                                                throw new NullPointerException("Null version");
                                            }
                                        case 3:
                                            obj4.f15759a = Integer.valueOf(jsonReader.nextInt());
                                            break;
                                        default:
                                            jsonReader.skipValue();
                                            break;
                            ...
                            case 7:
                                ...
                                if (str.isEmpty()) {
                                    obj2.f46801g = new i0(str6, str7, str8, str9, str10, str11);
                                    break;
                                } else {
                                    throw new IllegalStateException("Missing required properties:".concat(str));
                                }
                            ...
                            case '\t':
                                ...
                                if (nextString11 != null) {
                                    obj2.f46797a = nextString11;
                                    break;
                                } else {
                                    throw new NullPointerException("Null generator");
                                }
                            case '\n':
                                obj2.f46800f = Boolean.valueOf(jsonReader.nextBoolean());
                                break;
                            case 11:
                                obj2.f46805l = Integer.valueOf(jsonReader.nextInt());
                                break;
                            default:
                                jsonReader.skipValue();
                                break;
