...
public final class b implements rd.a {
    ...
    public final Object invoke() {
        ...
        switch (this.f2886a) {
            case 0:
                this.f2887b.execute(new ba(5, this.f2888c, this.d));
                break;
            case 1:
                this.f2887b.execute(new ba(6, this.f2888c, (p) this.d));
                break;
            case 2:
                this.f2887b.execute(new h(this.f2888c, (w0.i) this.d, 0));
                break;
            default:
                ...
                if (exc instanceof com.google.android.gms.common.api.f) {
                    ...
                    } else if (d.f2893b.contains(Integer.valueOf(statusCode))) {
                ...
                this.f2887b.execute(new b9(8, this.f2888c, cVar));
                break;
        }
        return gd.i.f9621a;
    }
