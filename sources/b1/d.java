...
public abstract class d {
    public static final a f1586a = new Object();
    public static final LinkedHashSet f1587b;
    ...
    public static void a(ResultReceiver resultReceiver, Intent intent, String str) {
        ...
        intent.putExtra("ACTIVITY_REQUEST_CODE", f1588c);
    ...
    public static final boolean c(int i10, p pVar, l lVar, CancellationSignal cancellationSignal) {
        if (i10 != -1) {
            ?? obj = new Object();
            obj.f12576a = new w0.c(hc.b.k(i10, "activity with result code: ", " indicating not RESULT_OK"), 2);
            if (i10 == 0) {
                obj.f12576a = new w0.b("activity is cancelled by the user.");
            }
