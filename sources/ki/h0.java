...
public final class h0 implements z0 {
    ...
    public final void onPlaybackStateChanged(int i10) {
        ...
        switch (this.f13739a) {
            case 0:
                r0 r0Var = (r0) this.f13740b;
                l lVar = r0Var.f13840l;
                lVar.b("preview playback state=" + i10);
    ...
    public final void onPlayerError(u0 u0Var) {
        switch (this.f13739a) {
            case 0:
                r0 r0Var = (r0) this.f13740b;
                l lVar = r0Var.f13840l;
                lVar.b("preview player error: code=" + u0Var.f3324a);
                r0Var.g(u0Var);
                return;
            default:
                return;
    ...
    public final void onRenderedFirstFrame() {
        switch (this.f13739a) {
            case 0:
                r0 r0Var = (r0) this.f13740b;
                if (r0Var.V == 5) {
                    b60.l((b60) r0Var.f13834c.f13909a);
                    return;
                }
                return;
            default:
