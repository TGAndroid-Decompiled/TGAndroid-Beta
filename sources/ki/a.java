    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (i10) {
            ...
            case 1:
                q0 q0Var = (q0) obj;
                q0Var.getClass();
                q0Var.f31757i = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 2:
                ni1 ni1Var = (ni1) obj;
            ...
            case 5:
                k2 k2Var = (k2) obj;
                k2Var.getClass();
                k2Var.f31612s = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                k2Var.f31606b.invalidate();
                return;
            case 6:
                y3 y3Var = (y3) obj;
                ((i5) y3Var.f4038b).f32504a.setAlpha(((Float) valueAnimator.getAnimatedValue()).floatValue());
                y3Var.invalidate();
                return;
            case 7:
                w1 w1Var = (w1) obj;
            ...
            case 8:
                ...
                k0Var.f42303a0 = floatValue2;
                k0Var.j(floatValue2);
                k0Var.f42305b0.setAlpha(k0Var.f42303a0);
            ...
            case 9:
                ...
                return;
            case 10:
                ((yt0) ((y0) obj)).K.f33577e0.invalidate();
                return;
            case 11:
                t1 t1Var = (t1) obj;
                t1Var.getClass();
                t1Var.f45525n = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                t1Var.invalidate();
                return;
            case 12:
                a2 a2Var = (a2) obj;
                a2Var.getClass();
                a2Var.f45153x = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                a2Var.invalidate();
                return;
            case 13:
                qg.n nVar = (qg.n) obj;
                nVar.f45153x = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                nVar.invalidate();
                return;
            case 14:
                o2 o2Var = (o2) obj;
            ...
            case 15:
                ...
                v2Var.f45563y = floatValue3;
                yd ydVar = v2Var.f45555c;
                ydVar.setAlpha(floatValue3);
                ydVar.setScaleX(AndroidUtilities.lerp(0.9f, 1.0f, v2Var.f45563y));
                ydVar.setScaleY(AndroidUtilities.lerp(0.9f, 1.0f, v2Var.f45563y));
                v2Var.f45554b.invalidate();
                return;
            case 16:
                LimitPreviewView limitPreviewView = (LimitPreviewView) obj;
                int i11 = LimitPreviewView.f24072l0;
            ...
            case 17:
                ...
                return;
            case 18:
                ((z1) obj).f46405a.f46385o = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                return;
            case 19:
                ug.b bVar = (ug.b) obj;
                bVar.getClass();
                bVar.f47094b = Math.max(1.0f, ((Float) valueAnimator.getAnimatedValue()).floatValue());
                bVar.invalidate();
                return;
            case 20:
                yg.i iVar = (yg.i) obj;
            ...
            case 23:
                ...
                q2Var.E = floatValue5;
                if (floatValue5 >= 0.8f && (p2Var = q2Var.H) != null && (z10 = p2Var.f52445l) && z10) {
                    p2Var.f52445l = false;
                    p2Var.b();
                }
                q2Var.invalidate();
            ...
            case 25:
                a4 a4Var = (a4) obj;
                a4Var.getClass();
                a4Var.f51720y = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                a4Var.invalidate();
                return;
            case 26:
                float floatValue6 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                s00 s00Var = ((j7) obj).f52144c;
            ...
            default:
                k8 k8Var = (k8) obj;
                k8Var.getClass();
                k8Var.f52187c0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                k8Var.invalidate();
                return;
        }
    }
