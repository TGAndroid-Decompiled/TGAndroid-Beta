...
public final class w extends u {
    ...
    public w() {
        ...
        int glGetUniformLocation = GLES20.glGetUniformLocation(this.f13850a, "nTexture");
        int glGetUniformLocation2 = GLES20.glGetUniformLocation(this.f13850a, "obTexture");
        int glGetUniformLocation3 = GLES20.glGetUniformLocation(this.f13850a, "nbTexture");
        int glGetUniformLocation4 = GLES20.glGetUniformLocation(this.f13850a, "oldBackground");
        int glGetUniformLocation5 = GLES20.glGetUniformLocation(this.f13850a, "newBackground");
        int glGetUniformLocation6 = GLES20.glGetUniformLocation(this.f13850a, "maskTexture");
        this.e = GLES20.glGetUniformLocation(this.f13850a, "oldBlur");
        this.f13855f = GLES20.glGetUniformLocation(this.f13850a, "newBlur");
        this.f13856g = GLES20.glGetUniformLocation(this.f13850a, "mixValue");
        this.h = GLES20.glGetUniformLocation(this.f13850a, "outsideEffect");
