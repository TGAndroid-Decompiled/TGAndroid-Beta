...
public final class o {
    ...
    public HandlerThread f13790j;
    public Handler f13791k;
    public SurfaceTexture f13792l;
    public Surface f13793m;
    public int f13797q;
    public int f13798r;
    public int f13799s;
    public x v;
    ...
    public int f13803x;
    public long f13804y;
    public EGLDisplay f13794n = EGL14.EGL_NO_DISPLAY;
    public EGLContext f13795o = EGL14.EGL_NO_CONTEXT;
    public EGLSurface f13796p = EGL14.EGL_NO_SURFACE;
    public final int[] f13800t = new int[1];
    public final float[] f13801u = new float[16];
    public long f13805z = -1;
    public long B = -1;
    public final m Z = new m(this, 0);
    public volatile long f13788g = 0;
    public volatile boolean V = false;

    public o(Size size, Surface surface, int i10, int i11, boolean z10, k kVar, j jVar, a aVar) {
        this.f13784a = size;
        this.f13785b = surface;
        this.f13786c = i10;
        this.f13787f = i11;
        this.d = z10;
        this.e = kVar;
    ...
    public final long b() {
        ...
        if (this.f13788g == 0) {
            ...
            max = Math.max(0L, System.nanoTime() - this.f13788g);
        }
    ...
    public final void c() {
        ...
        this.f13794n = eglGetDisplay;
        if (eglGetDisplay != EGL14.EGL_NO_DISPLAY) {
            int[] iArr = new int[2];
            if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                EGLConfig[] eGLConfigArr = new EGLConfig[1];
                int[] iArr2 = new int[1];
                if (EGL14.eglChooseConfig(this.f13794n, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12610, 1, 12344}, 0, eGLConfigArr, 0, 1, iArr2, 0) && iArr2[0] != 0) {
                    EGLContext eglCreateContext = EGL14.eglCreateContext(this.f13794n, eGLConfigArr[0], EGL14.EGL_NO_CONTEXT, new int[]{12440, 2, 12344}, 0);
                    this.f13795o = eglCreateContext;
                    ...
                    EGLSurface eglCreateWindowSurface = EGL14.eglCreateWindowSurface(this.f13794n, eGLConfigArr[0], this.f13785b, new int[]{12344}, 0);
                    this.f13796p = eglCreateWindowSurface;
                    ...
                    EGLDisplay eGLDisplay = this.f13794n;
                    EGLSurface eGLSurface = this.f13796p;
                    if (EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.f13795o)) {
                        ...
                        SurfaceTexture surfaceTexture = new SurfaceTexture(this.f13797q);
                        this.f13792l = surfaceTexture;
                        surfaceTexture.setDefaultBufferSize(this.f13784a.getWidth(), this.f13784a.getHeight());
                        this.f13792l.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() {
                            @Override
                        ...
                        this.f13793m = new Surface(this.f13792l);
                        Size size = this.f13784a;
    ...
    public final void d() {
        ...
        Handler handler = this.f13791k;
        if (handler != null) {
            handler.removeCallbacks(this.Z);
        }
        EGLDisplay eGLDisplay = this.f13794n;
        if (eGLDisplay != EGL14.EGL_NO_DISPLAY && (eGLSurface = this.f13796p) != EGL14.EGL_NO_SURFACE && (eGLContext = this.f13795o) != EGL14.EGL_NO_CONTEXT) {
            EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eGLContext);
        }
        SurfaceTexture surfaceTexture = this.f13792l;
        if (surfaceTexture != null) {
            surfaceTexture.setOnFrameAvailableListener(null);
        }
        Surface surface = this.f13793m;
        if (surface != null) {
            surface.release();
            this.f13793m = null;
        }
        SurfaceTexture surfaceTexture2 = this.f13792l;
        ...
        if (xVar != null) {
            ...
            int[] iArr = xVar.f13869p;
            GLES20.glDeleteTextures(iArr.length, iArr, 0);
            int[] iArr2 = xVar.f13868o;
            GLES20.glDeleteFramebuffers(iArr2.length, iArr2, 0);
            this.v = null;
        }
        int i13 = this.f13797q;
        if (i13 != 0) {
            GLES20.glDeleteTextures(1, new int[]{i13}, 0);
            this.f13797q = 0;
        }
        EGLDisplay eGLDisplay2 = this.f13794n;
        if (eGLDisplay2 != EGL14.EGL_NO_DISPLAY) {
            EGLSurface eGLSurface2 = EGL14.EGL_NO_SURFACE;
            EGL14.eglMakeCurrent(eGLDisplay2, eGLSurface2, eGLSurface2, EGL14.EGL_NO_CONTEXT);
            EGLSurface eGLSurface3 = this.f13796p;
            if (eGLSurface3 != EGL14.EGL_NO_SURFACE) {
                EGL14.eglDestroySurface(this.f13794n, eGLSurface3);
            }
            EGLContext eGLContext2 = this.f13795o;
            if (eGLContext2 != EGL14.EGL_NO_CONTEXT) {
                EGL14.eglDestroyContext(this.f13794n, eGLContext2);
            }
            EGL14.eglReleaseThread();
            EGL14.eglTerminate(this.f13794n);
        }
        this.f13794n = EGL14.EGL_NO_DISPLAY;
        this.f13795o = EGL14.EGL_NO_CONTEXT;
        this.f13796p = EGL14.EGL_NO_SURFACE;
    }

    public final void e() {
        int i10;
        GLES20.glBindTexture(36197, this.f13797q);
        if (this.f13787f == this.f13786c) {
            i10 = 9728;
        } else {
            i10 = 9729;
        }
    ...
    public final Surface g() {
        ...
        sb2.append(this.d);
        kVar.b(sb2.toString());
        Handler handler = new Handler(this.f13790j.getLooper());
        this.f13791k = handler;
    ...
    public final void h() {
        Handler handler = this.f13791k;
        HandlerThread handlerThread = this.f13790j;
        if (handler != null) {
            handler.removeCallbacks(this.Z);
        }
        this.f13791k = null;
    ...
    public final void i(long j3) {
        this.B = j3;
        EGLExt.eglPresentationTimeANDROID(this.f13794n, this.f13796p, j3);
        long nanoTime = System.nanoTime();
        if (EGL14.eglSwapBuffers(this.f13794n, this.f13796p)) {
            ...
            j jVar = this.h;
            if (jVar != null) {
                long j11 = jVar.f13758r;
                int i10 = (int) (j11 % 256);
                jVar.f13749i[i10] = j3 / 1000;
                jVar.f13750j[i10] = nanoTime2;
                jVar.f13758r = j11 + 1;
                return;
            }
            return;
    ...
    public final void k() {
        EGLDisplay eGLDisplay = this.f13794n;
        EGLSurface eGLSurface = this.f13796p;
        int[] iArr = this.f13800t;
        if (EGL14.eglQuerySurface(eGLDisplay, eGLSurface, 12375, iArr, 0)) {
            int i10 = iArr[0];
            if (EGL14.eglQuerySurface(this.f13794n, this.f13796p, 12374, iArr, 0)) {
                int i11 = iArr[0];
                if (i10 > 0 && i11 > 0) {
                    if (i10 != this.f13798r || i11 != this.f13799s) {
                        this.f13798r = i10;
                        this.f13799s = i11;
