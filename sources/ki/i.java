    ...
    public final void c(View view) {
        ...
        if (view2 != view) {
            ...
            if (view2 != null && (dVar = (tf.d) view2.getTag(R.id.tag_view_on_post_draw_state)) != null) {
                ArrayList arrayList = dVar.f43084a;
                if (arrayList.remove(cVar)) {
                    tf.b bVar = dVar.f43085b;
                    if (bVar != null) {
                        ((pe.b) bVar.f43083a.f1286b).remove(cVar);
                    }
                    if (arrayList.isEmpty()) {
                        dVar.f43085b = null;
                        view2.removeOnAttachStateChangeListener(dVar.f43086c);
            ...
            if (view != null) {
                ...
                if (dVar2 == null) {
                    ...
                    view.addOnAttachStateChangeListener(dVar2.f43086c);
                }
                ArrayList arrayList2 = dVar2.f43084a;
                if (!arrayList2.contains(cVar)) {
                    arrayList2.add(cVar);
                    if (view.isAttachedToWindow() && (a2 = tf.e.a(view, dVar2)) != null) {
                        ((pe.b) a2.f43083a.f1286b).add(cVar);
                    }
                }
            }
            this.h = view;
