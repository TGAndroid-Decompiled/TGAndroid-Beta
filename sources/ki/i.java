    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f15031a) {
            case 0:
                ...
                co coVar = oVar.F;
                h0 h0Var = (h0) this.d;
                float measuredHeight = ((((oVar.G.getMeasuredHeight() - coVar.f35446s9) - coVar.Aa) / 2.0f) - (h0Var.getMeasuredHeight() / 2.0f)) + oVar.F.f35446s9;
            ...
            default:
                ...
                co coVar2 = oVar2.F;
                bb bbVar = (bb) this.d;
                float measuredHeight2 = ((((oVar2.G.getMeasuredHeight() - coVar2.f35446s9) - coVar2.Aa) / 2.0f) - (bbVar.getMeasuredHeight() / 2.0f)) + oVar2.F.f35446s9;
