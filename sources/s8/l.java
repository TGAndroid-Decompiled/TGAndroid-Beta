    ...
    public static r0 f(Set set, r8.f fVar) {
        if (set instanceof SortedSet) {
            ...
            if (sortedSet instanceof r0) {
                ...
                r8.f fVar2 = r0Var.f44217b;
                fVar2.getClass();
                return new r0((SortedSet) r0Var.f44216a, new r8.g(Arrays.asList(fVar2, fVar)));
            }
            return new r0(sortedSet, fVar);
        } else if (set instanceof r0) {
            r0 r0Var2 = (r0) set;
            r8.f fVar3 = r0Var2.f44217b;
            fVar3.getClass();
            return new r0(r0Var2.f44216a, new r8.g(Arrays.asList(fVar3, fVar)));
        } else {
            set.getClass();
