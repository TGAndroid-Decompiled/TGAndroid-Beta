...
public final class g implements Closeable {
    public final f f46717a;
    public final String f46718b;
    public final InputStream f46719c;
    public final long d;
    public final wg e = new wg(this, 1);
    public final HashMap f46720f = new HashMap();
    public int h;
    public boolean f46721n;
    public boolean f46722r;
    public boolean f46723s;
    ...
    public final String a(String str) {
        return (String) this.f46720f.get(str.toLowerCase());
    }
    ...
    public final void d(OutputStream outputStream) {
        ...
        try {
            if (fVar != null) {
                String str3 = new b(str2).f46698c;
                if (str3 == null) {
                    str3 = "US-ASCII";
                }
                ...
                append.append((CharSequence) ("" + fVar.f46715a + " " + fVar.f46716b)).append((CharSequence) " \r\n");
                if (str2 != null) {
                ...
                if (this.h != 5 && this.f46721n) {
                    c(printWriter, "Transfer-Encoding", "chunked");
                } else if (!this.f46722r) {
                    j3 = f(printWriter, j3);
                }
    ...
    public final void e(OutputStream outputStream, long j3) {
        ...
        while (true) {
            if (j3 > 0 || z10) {
                ...
                int read = this.f46719c.read(bArr, 0, (int) min);
                if (read <= 0) {
                    return;
                }
