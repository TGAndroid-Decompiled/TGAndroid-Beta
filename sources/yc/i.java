...
public abstract class i {
    ...
    public volatile ServerSocket f46976a;
    public Thread f46977b;
    public n f46978c;
    ...
    public static g c(f fVar, String str, String str2) {
        ...
        return new g(fVar, bVar.f46947a, new ByteArrayInputStream(bArr), bArr.length);
    }
    ...
    public final void f() {
        this.f46976a = new ServerSocket();
        this.f46976a.setReuseAddress(true);
        ji.g gVar = new ji.g(this);
        Thread thread = new Thread(gVar);
        this.f46977b = thread;
        thread.setDaemon(true);
        this.f46977b.setName("NanoHttpd Main Listener");
        this.f46977b.start();
