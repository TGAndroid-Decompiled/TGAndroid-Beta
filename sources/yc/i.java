...
public abstract class i {
    ...
    public volatile ServerSocket f46697a;
    public Thread f46698b;
    public n f46699c;
    ...
    public static g c(f fVar, String str, String str2) {
        ...
        return new g(fVar, bVar.f46668a, new ByteArrayInputStream(bArr), bArr.length);
    }
    ...
    public final void f() {
        this.f46697a = new ServerSocket();
        this.f46697a.setReuseAddress(true);
        ji.g gVar = new ji.g(this);
        Thread thread = new Thread(gVar);
        this.f46698b = thread;
        thread.setDaemon(true);
        this.f46698b.setName("NanoHttpd Main Listener");
        this.f46698b.start();
        while (!gVar.f13065b && ((IOException) gVar.f13066c) == null) {
            try {
                Thread.sleep(10L);
            } catch (Throwable unused) {
            }
        }
        IOException iOException = (IOException) gVar.f13066c;
        if (iOException == null) {
            return;
        }
        throw iOException;
