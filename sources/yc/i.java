...
public abstract class i {
    ...
    public volatile ServerSocket f47020a;
    public Thread f47021b;
    public n f47022c;
    ...
    public static g c(f fVar, String str, String str2) {
        ...
        return new g(fVar, bVar.f46991a, new ByteArrayInputStream(bArr), bArr.length);
    }
    ...
    public final void f() {
        this.f47020a = new ServerSocket();
        this.f47020a.setReuseAddress(true);
        ji.g gVar = new ji.g(this);
        Thread thread = new Thread(gVar);
        this.f47021b = thread;
        thread.setDaemon(true);
        this.f47021b.setName("NanoHttpd Main Listener");
        this.f47021b.start();
