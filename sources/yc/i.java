...
public abstract class i {
    ...
    public volatile ServerSocket f46725a;
    public Thread f46726b;
    public n f46727c;
    ...
    public static g c(f fVar, String str, String str2) {
        ...
        return new g(fVar, bVar.f46696a, new ByteArrayInputStream(bArr), bArr.length);
    }
    ...
    public final void f() {
        this.f46725a = new ServerSocket();
        this.f46725a.setReuseAddress(true);
        ji.g gVar = new ji.g(this);
        Thread thread = new Thread(gVar);
        this.f46726b = thread;
        thread.setDaemon(true);
        this.f46726b.setName("NanoHttpd Main Listener");
        this.f46726b.start();
