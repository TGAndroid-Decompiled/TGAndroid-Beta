...
public abstract class i {
    ...
    public volatile ServerSocket f46720a;
    public Thread f46721b;
    public n f46722c;
    ...
    public static g c(f fVar, String str, String str2) {
        ...
        return new g(fVar, bVar.f46691a, new ByteArrayInputStream(bArr), bArr.length);
    }
    ...
    public final void f() {
        this.f46720a = new ServerSocket();
        this.f46720a.setReuseAddress(true);
        ji.g gVar = new ji.g(this);
        Thread thread = new Thread(gVar);
        this.f46721b = thread;
        thread.setDaemon(true);
        this.f46721b.setName("NanoHttpd Main Listener");
        this.f46721b.start();
