...
public final class d {
    public final m f46952a;
    public final OutputStream f46953b;
    public final BufferedInputStream f46954c;
    public int d;
    public int e;
    public String f46955f;
    public int f46956g;
    public HashMap h;
    public HashMap f46957i;
    public c f46958j;
    public final String f46959k;
    public String f46960l;
    public final i f46961m;

    public d(i iVar, m mVar, InputStream inputStream, OutputStream outputStream, InetAddress inetAddress) {
        String str;
        this.f46961m = iVar;
        this.f46952a = mVar;
        this.f46954c = new BufferedInputStream(inputStream, 8192);
        this.f46953b = outputStream;
        ...
        try {
            ...
            if (stringTokenizer.hasMoreTokens()) {
                ...
                if (stringTokenizer.hasMoreTokens()) {
                    ...
                    if (stringTokenizer.hasMoreTokens()) {
                        this.f46960l = stringTokenizer.nextToken();
                    } else {
                        this.f46960l = "HTTP/1.1";
    ...
    public final void c() {
        ...
        i iVar = this.f46961m;
        m mVar = this.f46952a;
        BufferedInputStream bufferedInputStream = this.f46954c;
        OutputStream outputStream = this.f46953b;
        try {
            try {
                try {
                    try {
                        ...
                        try {
                            ...
                            a(bufferedReader, hashMap2, this.h, this.f46957i);
                            String str = this.f46959k;
                            if (str != null) {
                                this.f46957i.put("remote-addr", str);
                                this.f46957i.put("http-client-ip", str);
                            }
                            int b10 = j.b((String) hashMap2.get("method"));
                            this.f46956g = b10;
                            if (b10 != 0) {
                                this.f46955f = (String) hashMap2.get("uri");
                                this.f46958j = new c(this.f46957i);
                                String str2 = (String) this.f46957i.get("connection");
                                if ("HTTP/1.1".equals(this.f46960l) && (str2 == null || !str2.matches("(?i).*close.*"))) {
                                    z10 = true;
                                } else {
                                    z10 = false;
                                }
                                g e = iVar.e(this);
                                String str3 = (String) this.f46957i.get("accept-encoding");
                                this.f46958j.i();
                                e.i(this.f46956g);
