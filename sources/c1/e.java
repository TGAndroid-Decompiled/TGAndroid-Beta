...
public final class e extends ResultReceiver {
    ...
    public final void onReceiveResult(int i10, Bundle resultData) {
        ...
        i b10;
        int i11 = this.f1871a;
        b1.d dVar2 = this.f1872b;
        switch (i11) {
            case 0:
                j.e(resultData, "resultData");
                final f fVar = (f) dVar2;
                if (!b1.d.b(resultData, new d(2, b1.d.f1275a, b1.a.class, "getCredentialExceptionTypeToException", "getCredentialExceptionTypeToException$credentials_play_services_auth_release(Ljava/lang/String;Ljava/lang/String;)Landroidx/credentials/exceptions/GetCredentialException;", 0, 0), fVar.f(), fVar.e(), fVar.h)) {
                    ...
                    if (i12 != i13) {
                        ...
                        try {
                            ...
                            ?? obj = new Object();
                            obj.f10990a = new h(e.getMessage(), 2);
                            if (e.getStatusCode() == 16) {
                                obj.f10990a = new g(e.getMessage());
                            } else if (b1.d.f1276b.contains(Integer.valueOf(e.getStatusCode()))) {
                                obj.f10990a = new w0.j(e.getMessage());
                            }
            ...
            case 1:
                j.e(resultData, "resultData");
                d dVar3 = new d(2, b1.d.f1275a, b1.a.class, "createCredentialExceptionTypeToException", "createCredentialExceptionTypeToException$credentials_play_services_auth_release(Ljava/lang/String;Ljava/lang/String;)Landroidx/credentials/exceptions/CreateCredentialException;", 0, 1);
                d1.e eVar = (d1.e) dVar2;
                Executor executor = eVar.f4096g;
                if (executor != null) {
                    v0.i iVar = eVar.f4095f;
                    if (iVar != null) {
                            ...
                            if (i14 != i15) {
                                ...
                                if (bArr == null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal4)) {
                                        Executor executor2 = eVar.f4096g;
                                        if (executor2 != null) {
                                ...
                                if (parcelable3 != null || (parcelable3 = uVar.e) != null || (parcelable3 = uVar.f42963f) != null) {
                                    if (parcelable3 instanceof k) {
                                        k kVar = (k) parcelable3;
                                        r rVar = kVar.f42925a;
                                        j.d(rVar, "getErrorCode(...)");
                                        x0.a aVar = (x0.a) d1.g.f4101a.get(rVar);
                                        String str = kVar.f42926b;
                                        if (aVar == null) {
                                            dVar = new y0.a(new x0.a(26), v2.e("unknown fido gms exception - ", str));
                                    ...
                                    if (dVar != null) {
                                        ...
                                        if (!a1.g.a(cancellationSignal5)) {
                                            Executor executor3 = eVar.f4096g;
                                            if (executor3 != null) {
                                    ...
                                    try {
                                        ...
                                        if (!a1.g.a(cancellationSignal6)) {
                                            Executor executor4 = eVar.f4096g;
                                            if (executor4 != null) {
                                        ...
                                        if (!a1.g.a(cancellationSignal7)) {
                                            Executor executor5 = eVar.f4096g;
                                            if (executor5 != null) {
                                        ...
                                        if (!a1.g.a(cancellationSignal8)) {
                                            Executor executor6 = eVar.f4096g;
                                            if (executor6 != null) {
            ...
            case 2:
                j.e(resultData, "resultData");
                d dVar4 = new d(2, b1.d.f1275a, b1.a.class, "createCredentialExceptionTypeToException", "createCredentialExceptionTypeToException$credentials_play_services_auth_release(Ljava/lang/String;Ljava/lang/String;)Landroidx/credentials/exceptions/CreateCredentialException;", 0, 2);
                e1.d dVar5 = (e1.d) dVar2;
                Executor executor7 = dVar5.f5052g;
                if (executor7 != null) {
                    v0.i iVar2 = dVar5.f5051f;
                    if (iVar2 != null) {
                            ...
                            if (i16 != i18) {
                                ...
                                if (intent3 == null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal9)) {
                                        Executor executor8 = dVar5.f5052g;
                                        if (executor8 != null) {
                                ...
                                if (cVar != null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal10)) {
                                        Executor executor9 = dVar5.f5052g;
                                        if (executor9 != null) {
                                ...
                                if (!a1.g.a(cancellationSignal11)) {
                                    Executor executor10 = dVar5.f5052g;
                                    if (executor10 != null) {
            ...
            default:
                j.e(resultData, "resultData");
                d dVar6 = new d(2, b1.d.f1275a, b1.a.class, "getCredentialExceptionTypeToException", "getCredentialExceptionTypeToException$credentials_play_services_auth_release(Ljava/lang/String;Ljava/lang/String;)Landroidx/credentials/exceptions/GetCredentialException;", 0, 3);
                f1.b bVar = (f1.b) dVar2;
                Executor executor11 = bVar.f5652g;
                if (executor11 != null) {
                    v0.i iVar3 = bVar.f5651f;
                    if (iVar3 != null) {
                        if (!b1.d.b(resultData, dVar6, executor11, iVar3, bVar.h)) {
                            ...
                            final Executor executor12 = bVar.f5652g;
                            if (executor12 != null) {
                                final v0.i iVar4 = bVar.f5651f;
                                if (iVar4 != null) {
