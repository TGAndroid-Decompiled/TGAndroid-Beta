                ...
                if (!b1.d.b(resultData, cVar2, eVar.f(), eVar.e(), eVar.h)) {
                    ...
                    if (i11 != i12) {
                        ...
                        try {
                            ...
                            ?? obj3 = new Object();
                            obj3.f13881a = new w0.h(e.getMessage(), 2);
                            if (e.getStatusCode() == 16) {
                                obj3.f13881a = new g(e.getMessage());
                            } else if (b1.d.f2894b.contains(Integer.valueOf(e.getStatusCode()))) {
                                obj3.f13881a = new j(e.getMessage());
                            }
                        ...
                        if (!b1.d.b(resultData, cVar3, executor, iVar2, eVar2.h)) {
                            ...
                            if (i13 != i14) {
                                ...
                                if (parcelable == null) {
                                    ...
                                    if (parcelable3 == null) {
                                        Parcelable parcelable4 = uVar.f4152f;
                                ...
                                if (parcelable2 instanceof k) {
                                    ...
                                    String str = kVar.f4115b;
                                    if (aVar == null) {
                                        dVar = new y0.a(new x0.a(26), j0.g("unknown fido gms exception - ", str));
                            ...
                            if (i15 != i17) {
                                ...
                                if (i16 >= 34) {
                                    ...
                                    if (bundleExtra2 == null) {
                                        ...
                                        if (string3 != null) {
                                            a2 = d9.a(bundleExtra2.getCharSequence("androidx.credentials.provider.extra.CREATE_CREDENTIAL_EXCEPTION_MESSAGE"), string3);
                                        } else {
                                    ...
                                    if (i19 != i21) {
                                        ...
                                        if (i20 >= 34) {
                                            ...
                                            if (bundleExtra3 == null || (string2 = bundleExtra3.getString("androidx.credentials.provider.extra.EXTRA_CREDENTIAL_TYPE")) == null || (bundle2 = bundleExtra3.getBundle("androidx.credentials.provider.extra.EXTRA_CREDENTIAL_DATA")) == null) {
                                                ...
                                                oVar = new o(x7.a(string2, bundle2));
                                            }
                                        }
                                        if (oVar != null) {
