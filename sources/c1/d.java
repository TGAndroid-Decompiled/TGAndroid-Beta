    ...
    public final void onReceiveResult(int i10, Bundle resultData) {
        ...
        switch (this.f3643a) {
                ...
                if (!b1.d.b(resultData, cVar2, eVar.f(), eVar.e(), eVar.h)) {
                    ...
                    if (i11 != i12) {
                        ...
                        try {
                            ...
                            ?? obj3 = new Object();
                            obj3.f13672a = new w0.h(e.getMessage(), 2);
                            if (e.getStatusCode() == 16) {
                                obj3.f13672a = new g(e.getMessage());
                            } else if (b1.d.f2886b.contains(Integer.valueOf(e.getStatusCode()))) {
                                obj3.f13672a = new j(e.getMessage());
                            }
                            ...
                            if (i13 != i14) {
                                ...
                                if (bArr == null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal4)) {
                                        Executor executor2 = eVar2.f7394g;
                                        if (executor2 != null) {
                                ...
                                LinkedHashMap linkedHashMap = d1.f.f7396a;
                                ...
                                if (parcelable2 instanceof k) {
                                    ...
                                    x0.a aVar = (x0.a) d1.f.f7396a.get(rVar);
                                ...
                                if (dVar != null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal5)) {
                                        Executor executor3 = eVar2.f7394g;
                                        if (executor3 != null) {
                                ...
                                try {
                                    ...
                                    if (!a1.g.a(cancellationSignal6)) {
                                        Executor executor4 = eVar2.f7394g;
                                        if (executor4 != null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal7)) {
                                        Executor executor5 = eVar2.f7394g;
                                        if (executor5 != null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal8)) {
                                        Executor executor6 = eVar2.f7394g;
                                        if (executor6 != null) {
            ...
            case 2:
                ...
                Executor executor7 = dVar2.f7853g;
                if (executor7 != null) {
                    v0.i iVar3 = dVar2.f7852f;
                    if (iVar3 != null) {
                            ...
                            if (i15 != i17) {
                                ...
                                if (intent3 == null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal9)) {
                                        Executor executor8 = dVar2.f7853g;
                                        if (executor8 != null) {
                                ...
                                if (cVar != null) {
                                    ...
                                    if (!a1.g.a(cancellationSignal10)) {
                                        Executor executor9 = dVar2.f7853g;
                                        if (executor9 != null) {
                                ...
                                if (!a1.g.a(cancellationSignal11)) {
                                    Executor executor10 = dVar2.f7853g;
                                    if (executor10 != null) {
            ...
            case 3:
                ...
                Executor executor11 = aVar2.f8778g;
                if (executor11 != null) {
                    v0.i iVar4 = aVar2.f8777f;
                    if (iVar4 != null) {
                        if (!b1.d.b(resultData, cVar5, executor11, iVar4, aVar2.h)) {
                            ...
                            final Executor executor12 = aVar2.f8778g;
                            if (executor12 != null) {
                                final v0.i iVar5 = aVar2.f8777f;
                                if (iVar5 != null) {
