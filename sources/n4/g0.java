...
public final class g0 implements Parcelable {
    ...
    public final CharSequence f15155b;
    ...
    public g0(Parcel parcel) {
        ...
        readString.getClass();
        this.f15154a = readString;
        CharSequence charSequence = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
        charSequence.getClass();
        this.f15155b = charSequence;
    ...
    public final String toString() {
        return "Action:mName='" + ((Object) this.f15155b) + ", mIcon=" + this.f15156c + ", mExtras=" + this.d;
    }

    @Override
    public final void writeToParcel(Parcel parcel, int i10) {
        parcel.writeString(this.f15154a);
        TextUtils.writeToParcel(this.f15155b, parcel, i10);
