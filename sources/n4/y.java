...
public final class y implements OnCompleteListener, ce.b, ea.a, g6.n, h1, c3.i, le.f, n5.b {
    ...
    public Object f14992b;
    public Object f14993c;
    ...
    public static String c0(y yVar) {
        Collection<String> collection = (Collection) yVar.f14993c;
        ...
        if (collection != null) {
            if (!collection.isEmpty()) {
                ...
                for (String str2 : collection) {
                    ...
                    if (!g6.a.f9425a.matcher(str2).matches()) {
    ...
    public void A(androidx.fragment.app.s f7, boolean z10) {
        ...
        androidx.fragment.app.s sVar = ((k0) this.f14992b).f2442y;
        if (sVar != null) {
            sVar.p().f2433o.A(f7, true);
        }
        Iterator it = ((CopyOnWriteArrayList) this.f14993c).iterator();
        if (it.hasNext()) {
            if (it.next() == null) {
                if (z10) {
                    throw null;
    ...
    public void B(androidx.fragment.app.s f7, boolean z10) {
        kotlin.jvm.internal.i.e(f7, "f");
        k0 k0Var = (k0) this.f14992b;
        androidx.fragment.app.v vVar = k0Var.f2440w.f2528b;
        androidx.fragment.app.s sVar = k0Var.f2442y;
        if (sVar != null) {
            sVar.p().f2433o.B(f7, true);
        }
        Iterator it = ((CopyOnWriteArrayList) this.f14993c).iterator();
        if (it.hasNext()) {
            if (it.next() == null) {
    ...
    public StackTraceElement[] C(StackTraceElement[] stackTraceElementArr) {
        ...
        ea.a[] aVarArr = (ea.a[]) this.f14992b;
        ...
        if (stackTraceElementArr2.length > 1024) {
            return ((rb.a) this.f14993c).C(stackTraceElementArr2);
        }
    ...
    public void D(i1 i1Var, int i10, int i11) {
        q9 E;
        ii.k0 k0Var = (ii.k0) this.f14992b;
        if (!((l0) this.f14993c).d && i10 != i11 && (E = k0Var.E()) != null) {
            if (!E.y() || E.W != k0Var.K()) {
    ...
    @Override
    public void E() {
        ((le.k) this.f14992b).c((le.l) this.f14993c);
    }
    ...
    public void I(androidx.fragment.app.s f7, Bundle bundle, boolean z10) {
        ...
        androidx.fragment.app.s sVar = ((k0) this.f14992b).f2442y;
        if (sVar != null) {
            sVar.p().f2433o.I(f7, bundle, true);
        }
        Iterator it = ((CopyOnWriteArrayList) this.f14993c).iterator();
        if (it.hasNext()) {
            if (it.next() == null) {
    ...
    public void M(CharSequence charSequence) {
        ((ii.k0) this.f14992b).I(charSequence);
    }

    public byte[] N(n3.a aVar) {
        DataOutputStream dataOutputStream = (DataOutputStream) this.f14993c;
        ByteArrayOutputStream byteArrayOutputStream = (ByteArrayOutputStream) this.f14992b;
        byteArrayOutputStream.reset();
        try {
            dataOutputStream.writeBytes(aVar.f14922a);
            dataOutputStream.writeByte(0);
            dataOutputStream.writeBytes(aVar.f14923b);
            dataOutputStream.writeByte(0);
            dataOutputStream.writeLong(aVar.f14924c);
    ...
    public c3.o P(Object... objArr) {
        Constructor a2;
        synchronized (((AtomicBoolean) this.f14993c)) {
            if (!((AtomicBoolean) this.f14993c).get()) {
                try {
                    a2 = ((w1) this.f14992b).a();
                } catch (ClassNotFoundException unused) {
                    ((AtomicBoolean) this.f14993c).set(true);
                } catch (Exception e) {
    ...
    public synchronized Map Q() {
        try {
            if (((Map) this.f14993c) == null) {
                this.f14993c = DesugarCollections.unmodifiableMap(new HashMap((HashMap) this.f14992b));
            }
        } catch (Throwable th2) {
            throw th2;
        }
        return (Map) this.f14993c;
    }

    public android.support.v4.media.session.l R() {
        MediaController.TransportControls transportControls = ((android.support.v4.media.session.h) this.f14992b).f1849a.getTransportControls();
    ...
    public void T(k.a aVar) {
        ni.f fVar = (ni.f) this.f14992b;
        ((ActionMode.Callback) fVar.f15255a).onDestroyActionMode(fVar.o(aVar));
        g.s sVar = (g.s) this.f14993c;
        if (sVar.E != null) {
            sVar.f9295f.getDecorView().removeCallbacks(sVar.F);
        }
        if (sVar.f9311y != null) {
            r0.l0 l0Var = sVar.G;
            if (l0Var != null) {
    ...
    public boolean U(k.a aVar, Menu menu) {
        ViewGroup viewGroup = ((g.s) this.f14993c).J;
        WeakHashMap weakHashMap = r0.i0.f41839a;
        r0.y.c(viewGroup);
        ni.f fVar = (ni.f) this.f14992b;
        ActionMode.Callback callback = (ActionMode.Callback) fVar.f15255a;
        k.e o9 = fVar.o(aVar);
        a0.m mVar = (a0.m) fVar.d;
        Menu menu2 = (Menu) mVar.get(menu);
        if (menu2 == null) {
            menu2 = new l.a0((Context) fVar.f15256b, (l.k) menu);
            mVar.put(menu, menu2);
        }
    ...
    public void V(androidx.mediarouter.app.r rVar) {
        if (rVar != null) {
            if (!((Set) this.f14993c).add(rVar)) {
                Log.w("MediaControllerCompat", "the callback has already been registered");
                return;
            }
            Handler handler = new Handler();
            rVar.f(handler);
            android.support.v4.media.session.h hVar = (android.support.v4.media.session.h) this.f14992b;
            hVar.f1849a.registerCallback(rVar.f2792a, handler);
            synchronized (hVar.f1850b) {
                if (hVar.e.a() != null) {
    ...
    public void W(Editable editable) {
        ((l0) this.f14993c).i();
        ((ii.k0) this.f14992b).a0();
    }

    public void X(p pVar, Handler handler) {
        r rVar = (r) this.f14992b;
        synchronized (rVar.d) {
            rVar.f14982m = pVar;
            rVar.f14973a.setCallback(pVar.f14969b, handler);
            pVar.C(rVar, handler);
        }
    }
    ...
    public void Y(h0 h0Var) {
        ...
        synchronized (rVar.d) {
            for (int beginBroadcast = rVar.f14976f.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    ((f) rVar.f14976f.getBroadcastItem(beginBroadcast)).t(h0Var);
        ...
        MediaSession mediaSession = rVar.f14973a;
        if (h0Var.f14949w == null) {
            PlaybackState.Builder builder = new PlaybackState.Builder();
            builder.setState(h0Var.f14942a, h0Var.f14943b, h0Var.d, h0Var.f14946n);
            builder.setBufferedPosition(h0Var.f14944c);
            builder.setActions(h0Var.e);
            builder.setErrorMessage(h0Var.h);
            for (g0 g0Var : h0Var.f14947r) {
                g0Var.getClass();
                PlaybackState.CustomAction.Builder builder2 = new PlaybackState.CustomAction.Builder(g0Var.f14939a, g0Var.f14940b, g0Var.f14941c);
            ...
            builder.setActiveQueueItemId(h0Var.f14948s);
            if (Build.VERSION.SDK_INT >= 22) {
                f0.a(builder, h0Var.v);
            }
            h0Var.f14949w = builder.build();
        }
        mediaSession.setPlaybackState(h0Var.f14949w);
    }

    public void Z(androidx.mediarouter.app.r rVar) {
        if (rVar != null) {
            if (!((Set) this.f14993c).remove(rVar)) {
                Log.w("MediaControllerCompat", "the callback has never been registered");
                return;
            }
            try {
                ((android.support.v4.media.session.h) this.f14992b).b(rVar);
                return;
            } finally {
                rVar.f(null);
            }
    ...
    public int a0(Context context, com.google.android.gms.common.api.c cVar) {
        SparseIntArray sparseIntArray = (SparseIntArray) this.f14992b;
        n6.l.h(context);
        n6.l.h(cVar);
        int i10 = 0;
        if (!cVar.k()) {
        ...
        if (i10 == -1) {
            i10 = ((k6.e) this.f14993c).d(context, l4);
        }
    ...
    public c3.h b(c3.p pVar, long j3) {
        ...
        int i11 = -1;
        while (vVar.a() >= 4) {
            if (h3.a.a(vVar.f7932b, vVar.f7931a) != 442) {
                vVar.K(1);
            } else {
                vVar.K(4);
                long c10 = j4.x.c(vVar);
                if (c10 != -9223372036854775807L) {
                    long b10 = ((e2.b0) this.f14992b).b(c10);
                    if (b10 > j3) {
                        ...
                        return new c3.h(0, -9223372036854775807L, position + vVar.f7932b);
                    } else {
                        j10 = b10;
                        i11 = vVar.f7932b;
                    }
                ...
                if (vVar.a() < 10) {
                    ...
                    if (vVar.a() < x10) {
                        ...
                        if (vVar.a() < 4) {
                            ...
                            if (h3.a.a(vVar.f7932b, vVar.f7931a) == 443) {
                                vVar.K(4);
                                int D = vVar.D();
                                if (vVar.a() < D) {
                                    vVar.J(i12);
                            ...
                            while (true) {
                                ...
                                int a2 = h3.a.a(vVar.f7932b, vVar.f7931a);
                                ...
                                vVar.J(Math.min(vVar.f7933c, vVar.f7932b + vVar.D()));
                            }
                        }
                    }
                }
    ...
    public void e(Object obj, String str) {
        ((ArrayList) this.f14992b).add(a4.a.D(str, "=", String.valueOf(obj)));
    }

    @Override
    public boolean f() {
        return ((ii.k0) this.f14992b).P();
    }

    @Override
    public Object mo28get() {
        return new m5.d((Context) ((a9.r) this.f14992b).f353a, (lf.i) ((k2.c0) this.f14993c).mo28get());
    }
    ...
    public void m(i1 i1Var) {
        ((ii.k0) this.f14992b).i();
    }

    public i9.w n(byte[] bArr) {
        byte[] bArr2;
        lf.i iVar = (lf.i) this.f14993c;
        if (iVar != null && (bArr2 = (byte[]) iVar.f14021b) != null && Arrays.equals(bArr2, bArr)) {
            i9.w wVar = (i9.w) ((lf.i) this.f14993c).d;
            e2.d.h(wVar);
            return wVar;
        }
        g2.i iVar2 = (g2.i) this.f14992b;
        i9.w a2 = ((i9.y) iVar2.f9363a).a(new com.google.firebase.messaging.h(1, iVar2, bArr));
        this.f14993c = new lf.i(bArr, a2);
        return a2;
    }

    @Override
    public void onComplete(Task task) {
        a9.e eVar = (a9.e) this.f14992b;
        TaskCompletionSource taskCompletionSource = (TaskCompletionSource) this.f14993c;
    ...
    public void r(i2.g gVar) {
        ...
        Handler handler = (Handler) this.f14992b;
        if (handler != null) {
    ...
    public String toString() {
        switch (this.f14991a) {
            case 28:
                ...
                sb2.append(this.f14993c.getClass().getSimpleName());
                sb2.append('{');
                ArrayList arrayList = (ArrayList) this.f14992b;
    ...
    public void y(String str, long j3, int i10, Object obj, long j10, long j11) {
        int i11;
        g6.m mVar = (g6.m) this.f14993c;
        if (((g6.n) this.f14992b) != null) {
            if (i10 == 2001) {
                Object[] objArr = {Integer.valueOf(mVar.f9438i)};
                g6.b bVar = mVar.f9457a;
                Log.w(bVar.f9427a, bVar.d("Possibility of local queue out of sync with receiver queue. Refetching sequence number. Current Local Sequence Number = %d", objArr));
                Iterator it = ((e6.h) mVar.h.f45733b).f8016i.iterator();
                while (it.hasNext()) {
                    ((e6.g) it.next()).o();
                }
                i11 = 2001;
            ...
            ((g6.n) this.f14992b).y(str, j3, i11, obj, j10, j11);
        }
    }
    ...
    public y(int i10) {
        ...
        switch (i10) {
            ...
            case 27:
                ...
                this.f14992b = byteArrayOutputStream;
                this.f14993c = new DataOutputStream(byteArrayOutputStream);
                return;
            default:
                this.f14992b = new ConcurrentHashMap(16, 0.75f, 10);
                this.f14993c = new ReferenceQueue();
                return;
        }
    }
    ...
    public y(IBinder iBinder) {
        ...
        if (interfaceDescriptor != "android.os.IMessenger" && (interfaceDescriptor == null || !interfaceDescriptor.equals("android.os.IMessenger"))) {
            ...
            this.f14993c = new j6.f(iBinder);
            this.f14992b = null;
            return;
        }
        this.f14992b = new Messenger(iBinder);
        this.f14993c = null;
    }
    ...
    public y(m6.a aVar) {
        this.f14991a = 13;
        this.f14992b = aVar == null ? null : aVar.f14733b;
    }
    ...
    public y(k6.e eVar) {
        this.f14991a = 29;
        this.f14992b = new SparseIntArray();
        n6.l.h(eVar);
        this.f14993c = eVar;
    }
    ...
    public y(k0 k0Var) {
        this.f14991a = 5;
        this.f14992b = k0Var;
        this.f14993c = new CopyOnWriteArrayList();
    }
    ...
    public y(ea.a[] aVarArr) {
        this.f14991a = 12;
        this.f14992b = aVarArr;
        this.f14993c = new rb.a(7);
    }

    public y(e2.b0 b0Var) {
        this.f14991a = 20;
        this.f14992b = b0Var;
        this.f14993c = new e2.v();
    }
    ...
    public y(Context context, MediaSessionCompat$Token mediaSessionCompat$Token) {
        ...
        if (mediaSessionCompat$Token != null) {
            this.f14993c = DesugarCollections.synchronizedSet(new HashSet());
            if (Build.VERSION.SDK_INT >= 29) {
                this.f14992b = new android.support.v4.media.session.h(context, mediaSessionCompat$Token);
                return;
            } else {
                this.f14992b = new android.support.v4.media.session.h(context, mediaSessionCompat$Token);
                return;
    ...
    public y(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (i11 >= 29) {
                this.f14992b = new r(context, str, bundle);
            } else if (i11 >= 28) {
                this.f14992b = new r(context, str, bundle);
            } else if (i11 >= 22) {
                this.f14992b = new r(context, str, bundle);
            ...
            ((r) this.f14992b).f14973a.setMediaButtonReceiver(pendingIntent);
            this.f14993c = new k2.u(context, this);
            return;
        }
    ...
    public y(w1 w1Var) {
        this.f14991a = 6;
        this.f14992b = w1Var;
        this.f14993c = new AtomicBoolean(false);
    }
}
