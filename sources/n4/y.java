...
public final class y implements OnCompleteListener, ce.b, ea.a, g6.n, h1, c3.i, le.g, n5.b {
    ...
    public static String c0(y yVar) {
        Collection<String> collection = (Collection) yVar.f15223c;
    ...
    public void A(androidx.fragment.app.s f7, boolean z10) {
        ...
        androidx.fragment.app.s sVar = ((k0) this.f15222b).f2437y;
        if (sVar != null) {
            sVar.p().f2428o.A(f7, true);
        }
        Iterator it = ((CopyOnWriteArrayList) this.f15223c).iterator();
        if (it.hasNext()) {
            if (it.next() == null) {
                if (z10) {
                    throw null;
    ...
    public void B(i1 i1Var, int i10, int i11) {
        q9 C;
        ii.k0 k0Var = (ii.k0) this.f15222b;
        if (!((l0) this.f15223c).d && i10 != i11 && (C = k0Var.C()) != null) {
            if (!C.y() || C.W != k0Var.I()) {
    ...
    public StackTraceElement[] C(StackTraceElement[] stackTraceElementArr) {
        ...
        ea.a[] aVarArr = (ea.a[]) this.f15222b;
        ...
        if (stackTraceElementArr2.length > 1024) {
            return ((rb.a) this.f15223c).C(stackTraceElementArr2);
        }
    ...
    public void K(CharSequence charSequence) {
        ((ii.k0) this.f15222b).E(charSequence);
    }
    ...
    public byte[] N(n3.a aVar) {
        DataOutputStream dataOutputStream = (DataOutputStream) this.f15223c;
        ByteArrayOutputStream byteArrayOutputStream = (ByteArrayOutputStream) this.f15222b;
        byteArrayOutputStream.reset();
        try {
            dataOutputStream.writeBytes(aVar.f15152a);
            dataOutputStream.writeByte(0);
            dataOutputStream.writeBytes(aVar.f15153b);
            dataOutputStream.writeByte(0);
            dataOutputStream.writeLong(aVar.f15154c);
    ...
    public c3.o P(Object... objArr) {
        Constructor a2;
        synchronized (((AtomicBoolean) this.f15223c)) {
            if (!((AtomicBoolean) this.f15223c).get()) {
                try {
                    a2 = ((w1) this.f15222b).a();
                } catch (ClassNotFoundException unused) {
                    ((AtomicBoolean) this.f15223c).set(true);
                } catch (Exception e) {
    ...
    public synchronized Map Q() {
        try {
            if (((Map) this.f15223c) == null) {
                this.f15223c = DesugarCollections.unmodifiableMap(new HashMap((HashMap) this.f15222b));
            }
        } catch (Throwable th2) {
            throw th2;
        }
        return (Map) this.f15223c;
    }

    public android.support.v4.media.session.l R() {
        MediaController.TransportControls transportControls = ((android.support.v4.media.session.h) this.f15222b).f1844a.getTransportControls();
    ...
    public void T(k.a aVar) {
        ...
        ((ActionMode.Callback) fVar.f15759a).onDestroyActionMode(fVar.o(aVar));
        g.s sVar = (g.s) this.f15223c;
        if (sVar.E != null) {
    ...
    public boolean V(k.a aVar, Menu menu) {
        ...
        if (menu2 == null) {
            menu2 = new l.b0((Context) fVar.f15760b, (l.l) menu);
            mVar.put(menu, menu2);
        }
    ...
    public void W(androidx.mediarouter.app.r rVar) {
        if (rVar != null) {
            if (!((Set) this.f15223c).add(rVar)) {
                Log.w("MediaControllerCompat", "the callback has already been registered");
                return;
            }
            Handler handler = new Handler();
            rVar.f(handler);
            android.support.v4.media.session.h hVar = (android.support.v4.media.session.h) this.f15222b;
    ...
    public void Y(p pVar, Handler handler) {
        r rVar = (r) this.f15222b;
        synchronized (rVar.d) {
            rVar.f15212m = pVar;
            rVar.f15203a.setCallback(pVar.f15199b, handler);
            pVar.C(rVar, handler);
        }
    }
    ...
    public void Z(h0 h0Var) {
        ...
        synchronized (rVar.d) {
            for (int beginBroadcast = rVar.f15206f.beginBroadcast() - 1; beginBroadcast >= 0; beginBroadcast--) {
                try {
                    ((f) rVar.f15206f.getBroadcastItem(beginBroadcast)).t(h0Var);
        ...
        if (h0Var.f15179w == null) {
            PlaybackState.Builder builder = new PlaybackState.Builder();
            builder.setState(h0Var.f15172a, h0Var.f15173b, h0Var.d, h0Var.f15176n);
            builder.setBufferedPosition(h0Var.f15174c);
            builder.setActions(h0Var.e);
            builder.setErrorMessage(h0Var.h);
            for (g0 g0Var : h0Var.f15177r) {
                g0Var.getClass();
                PlaybackState.CustomAction.Builder builder2 = new PlaybackState.CustomAction.Builder(g0Var.f15169a, g0Var.f15170b, g0Var.f15171c);
            ...
            builder.setActiveQueueItemId(h0Var.f15178s);
            if (Build.VERSION.SDK_INT >= 22) {
                f0.a(builder, h0Var.v);
            }
            h0Var.f15179w = builder.build();
        }
        mediaSession.setPlaybackState(h0Var.f15179w);
    }
    ...
    public void a0(androidx.mediarouter.app.r rVar) {
        if (rVar != null) {
            if (!((Set) this.f15223c).remove(rVar)) {
                Log.w("MediaControllerCompat", "the callback has never been registered");
                return;
            }
            try {
                ((android.support.v4.media.session.h) this.f15222b).b(rVar);
                return;
            } finally {
                rVar.f(null);
            }
        ...
        while (vVar.a() >= 4) {
            if (h3.a.a(vVar.f7917b, vVar.f7916a) != 442) {
                ...
                if (c10 != -9223372036854775807L) {
                    long b10 = ((e2.b0) this.f15222b).b(c10);
                    if (b10 > j3) {
    ...
    public int b0(Context context, com.google.android.gms.common.api.c cVar) {
        SparseIntArray sparseIntArray = (SparseIntArray) this.f15222b;
        n6.l.h(context);
        n6.l.h(cVar);
        int i10 = 0;
        if (!cVar.k()) {
        ...
        if (i10 == -1) {
            i10 = ((k6.e) this.f15223c).d(context, l4);
        }
    ...
    public Object mo28get() {
        return new m5.d((Context) ((a9.r) this.f15222b).f353a, (la.h) ((a4.m) this.f15223c).mo28get());
    }
    ...
    public void j(int i10, int i11) {
        ((ii.k0) this.f15222b).Q(i10, i11);
    }

    public void k(Object obj, String str) {
        ((ArrayList) this.f15222b).add(a4.a.D(str, "=", String.valueOf(obj)));
    }
    ...
    public i9.w o(byte[] bArr) {
        byte[] bArr2;
        la.h hVar = (la.h) this.f15223c;
        if (hVar != null && (bArr2 = (byte[]) hVar.f14166b) != null && Arrays.equals(bArr2, bArr)) {
            i9.w wVar = (i9.w) ((la.h) this.f15223c).d;
            e2.d.h(wVar);
            return wVar;
        }
        g2.i iVar = (g2.i) this.f15222b;
        i9.w a2 = ((i9.y) iVar.f9348a).a(new com.google.firebase.messaging.h(1, iVar, bArr));
        this.f15223c = new la.h(bArr, a2);
        return a2;
    }

    @Override
    public void onComplete(Task task) {
        a9.e eVar = (a9.e) this.f15222b;
        TaskCompletionSource taskCompletionSource = (TaskCompletionSource) this.f15223c;
    ...
    public void s(i2.g gVar) {
        ...
        Handler handler = (Handler) this.f15222b;
        if (handler != null) {
    ...
    public String toString() {
        switch (this.f15221a) {
            case 28:
                ...
                sb2.append(this.f15223c.getClass().getSimpleName());
                sb2.append('{');
                ArrayList arrayList = (ArrayList) this.f15222b;
    ...
    @Override
    public void u() {
        ((le.l) this.f15222b).c((le.m) this.f15223c);
    }
    ...
    public void w(String str, long j3, int i10, Object obj, long j10, long j11) {
        int i11;
        g6.m mVar = (g6.m) this.f15223c;
        if (((g6.n) this.f15222b) != null) {
            if (i10 == 2001) {
                ...
                Iterator it = ((e6.h) mVar.h.f46016b).f8001i.iterator();
                while (it.hasNext()) {
                    ((e6.g) it.next()).o();
                }
                i11 = 2001;
            ...
            ((g6.n) this.f15222b).w(str, j3, i11, obj, j10, j11);
        }
    }
    ...
    public y(int i10) {
        ...
        switch (i10) {
            ...
            case 27:
                ...
                this.f15222b = byteArrayOutputStream;
                this.f15223c = new DataOutputStream(byteArrayOutputStream);
                return;
            default:
                this.f15222b = new ConcurrentHashMap(16, 0.75f, 10);
                this.f15223c = new ReferenceQueue();
                return;
        }
    }
    ...
    public y(IBinder iBinder) {
        ...
        if (interfaceDescriptor != "android.os.IMessenger" && (interfaceDescriptor == null || !interfaceDescriptor.equals("android.os.IMessenger"))) {
            ...
            this.f15223c = new j6.f(iBinder);
            this.f15222b = null;
            return;
        }
        this.f15222b = new Messenger(iBinder);
        this.f15223c = null;
    }
    ...
    public y(m6.a aVar) {
        this.f15221a = 13;
        this.f15222b = aVar == null ? null : aVar.f14960b;
    }
    ...
    public y(k6.e eVar) {
        this.f15221a = 29;
        this.f15222b = new SparseIntArray();
        n6.l.h(eVar);
        this.f15223c = eVar;
    }
    ...
    public y(k0 k0Var) {
        this.f15221a = 5;
        this.f15222b = k0Var;
        this.f15223c = new CopyOnWriteArrayList();
    }
    ...
    public y(ea.a[] aVarArr) {
        this.f15221a = 12;
        this.f15222b = aVarArr;
        this.f15223c = new rb.a(7);
    }

    public y(e2.b0 b0Var) {
        this.f15221a = 20;
        this.f15222b = b0Var;
        this.f15223c = new e2.v();
    }
    ...
    public y(Context context, MediaSessionCompat$Token mediaSessionCompat$Token) {
        ...
        if (mediaSessionCompat$Token != null) {
            this.f15223c = DesugarCollections.synchronizedSet(new HashSet());
            if (Build.VERSION.SDK_INT >= 29) {
                this.f15222b = new android.support.v4.media.session.h(context, mediaSessionCompat$Token);
                return;
            } else {
                this.f15222b = new android.support.v4.media.session.h(context, mediaSessionCompat$Token);
                return;
    ...
    public y(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (i11 >= 29) {
                this.f15222b = new r(context, str, bundle);
            } else if (i11 >= 28) {
                this.f15222b = new r(context, str, bundle);
            } else if (i11 >= 22) {
                this.f15222b = new r(context, str, bundle);
            ...
            ((r) this.f15222b).f15203a.setMediaButtonReceiver(pendingIntent);
            this.f15223c = new k2.u(context, this);
            return;
        }
