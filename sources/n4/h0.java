...
public final class h0 implements Parcelable {
    ...
    public final AbstractCollection f14947r;
    public final long f14948s;
    public final Bundle v;
    public PlaybackState f14949w;
    ...
    public h0(int i10, long j3, long j10, float f7, long j11, int i11, CharSequence charSequence, long j12, ArrayList arrayList, long j13, Bundle bundle) {
        ...
        this.h = charSequence;
        this.f14946n = j12;
        this.f14947r = new ArrayList(arrayList);
        this.f14948s = j13;
        this.v = bundle;
    }
    ...
    public final String toString() {
        ...
        return a4.a.s(sb2, this.f14948s, "}");
    }

    @Override
    public final void writeToParcel(Parcel parcel, int i10) {
        parcel.writeInt(this.f14942a);
        parcel.writeLong(this.f14943b);
        parcel.writeFloat(this.d);
        parcel.writeLong(this.f14946n);
        parcel.writeLong(this.f14944c);
        parcel.writeLong(this.e);
        TextUtils.writeToParcel(this.h, parcel, i10);
        parcel.writeTypedList(this.f14947r);
        parcel.writeLong(this.f14948s);
        parcel.writeBundle(this.v);
        parcel.writeInt(this.f14945f);
    }

    public h0(Parcel parcel) {
        this.f14942a = parcel.readInt();
        this.f14943b = parcel.readLong();
        this.d = parcel.readFloat();
        this.f14946n = parcel.readLong();
        this.f14944c = parcel.readLong();
        ...
        this.f14947r = createTypedArrayList;
        this.f14948s = parcel.readLong();
