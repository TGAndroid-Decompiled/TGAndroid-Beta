...
public class j {
    public final MediaController f14955a;
    ...
    public j(Context context, x xVar) {
        this.e = xVar;
        MediaController mediaController = new MediaController(context, xVar.f14989b);
        this.f14955a = mediaController;
        if (xVar.a() == null) {
    ...
    public final void a() {
        ...
        ArrayList arrayList = this.f14957c;
