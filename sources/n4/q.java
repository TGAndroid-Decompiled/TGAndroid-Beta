...
public final class q extends Binder implements h {
    public static final int f14973b = 0;
    public final WeakReference f14974a;

    public q(r rVar) {
        attachInterface(this, "android.support.v4.media.session.IMediaSession");
        this.f14974a = new WeakReference(rVar);
    }

    public final void G0(f fVar) {
        r rVar = (r) this.f14974a.get();
        if (rVar != null && fVar != null) {
            rVar.f14978f.register(fVar, new a0("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
            synchronized (rVar.d) {
            }
        }
    }
