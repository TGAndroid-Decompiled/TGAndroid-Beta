...
public abstract class s extends o implements NavigableSet, c0, SortedSet {
    ...
    public static z x(Comparator comparator) {
        ...
        i iVar = m.f49036b;
        return new z(x.f49070e, comparator);
    }
    ...
    public final java.util.SortedSet tailSet(Object obj) {
        obj.getClass();
        z zVar = (z) this;
        return zVar.A(zVar.z(obj, true), zVar.f49078f.size());
    }
    ...
    public final s descendingSet() {
        ...
        if (zVar == null) {
            ...
            if (zVar2.isEmpty()) {
                ...
                zVar = new z(zVar2.f49078f.r(), reverseOrder);
            }
            this.f49056e = zVar;
            zVar.f49056e = this;
        }
    ...
    public final z subSet(Object obj, boolean z10, Object obj2, boolean z11) {
        ...
        if (this.d.compare(obj, obj2) <= 0) {
            z zVar = (z) this;
            z A = zVar.A(zVar.z(obj, z10), zVar.f49078f.size());
    ...
    public final NavigableSet tailSet(Object obj, boolean z10) {
        obj.getClass();
        z zVar = (z) this;
        return zVar.A(zVar.z(obj, z10), zVar.f49078f.size());
    }
}
