...
public final class d implements vf {
    ...
    public void b() {
        ...
        while (i10 < size) {
            ...
            if (interpolator != null && (view = (View) l0Var.f44710a.get()) != null) {
                view.animate().setInterpolator(interpolator);
            }
            if (((m0) this.f2580e) != null) {
                l0Var.d((i) this.f2581f);
            }
            View view2 = (View) l0Var.f44710a.get();
            if (view2 != null) {
                view2.animate().start();
            }
        }
    ...
    public a5.a zza() {
        ...
        a6Var.f47379b = Long.valueOf(j3 & Long.MAX_VALUE);
        a6Var.f47380c = (gb) this.d;
        a6Var.d = Boolean.valueOf(z10);
        obj.f4796a = new va(a6Var);
        int i11 = aVar.f47772e;
        f.f2586l.getClass();
        int i12 = aVar.f47772e;
        if (i12 == -1) {
        ...
        if (igVar != null) {
            ...
            List<hg> list2 = igVar.f51119a;
            if (!list2.isEmpty()) {
                Object[] objArr = new Object[4];
                int i13 = 0;
                for (hg hgVar : list2) {
                    s sVar = new s(14, false);
                    sVar.f6391b = Integer.valueOf(hgVar.f51099c & Integer.MAX_VALUE);
                    sVar.f6392c = Integer.valueOf(hgVar.d & Integer.MAX_VALUE);
                    sVar.d = Integer.valueOf(hgVar.f51100e & Integer.MAX_VALUE);
                    sVar.f6393e = Integer.valueOf(hgVar.f51101f & Integer.MAX_VALUE);
