...
public final class f extends qb.e {
    public static final k6.c[] f2585k = {j.f44289c};
    public static final wb.a f2586l = wb.a.f48479a;
    ...
    public final synchronized void b() {
        ...
        try {
            ...
            try {
                if (this.f2591j == null) {
                    IBinder b10 = y6.e.c(this.d, y6.e.f49546b, "com.google.android.gms.mlkit_subject_segmentation").b("com.google.android.gms.mlkit.segmentation.subject.SubjectSegmenterCreator");
                    int i10 = fg.f50865a;
                    if (b10 == null) {
                        aVar = null;
                    } else {
    ...
    public final synchronized void c() {
        ...
        if (wfVar.d(hbVar, elapsedRealtime)) {
            wfVar.f51313i.put(hbVar, Long.valueOf(elapsedRealtime));
            ?? obj = new Object();
            obj.f15636c = fb.TYPE_THIN;
            m.f44294a.execute(new p(wfVar, new a5.a((p3) obj, 0), hbVar, wfVar.c(), 8));
        }
    }
        ...
        synchronized (this) {
            try {
                try {
                    ...
                    dg dgVar = this.f2591j;
                    l.h(dgVar);
                    ag agVar = new ag(aVar.f47772e, aVar.f47770b, aVar.f47771c, SystemClock.elapsedRealtime(), c8.a(aVar.d));
                    int i10 = aVar.f47772e;
                    try {
                        if (i10 != -1) {
                            if (i10 != 17) {
                                if (i10 != 35) {
                                    if (i10 != 842094169) {
                                        int i11 = aVar.f47772e;
                        ...
                        try {
                            ...
                            if (this.f2587e.f400b) {
                                for (hg hgVar : W0.f51119a) {
                                    float[] fArr = hgVar.f51097a;
                                    if (fArr != null) {
                                        FloatBuffer allocate = FloatBuffer.allocate(fArr.length);
                                        allocate.put(fArr);
                                        allocate.rewind();
                                    }
                                    arrayList.add(new ac.a(hgVar.f51098b, hgVar.f51099c, hgVar.d, hgVar.f51100e, hgVar.f51101f));
                                }
                            }
                            fVar = this;
                            aVar2 = aVar;
    ...
    public final void f(final gb gbVar, final long j3) {
        this.f2588f.b(new vf() {
            ...
            public final a5.a zza() {
                ...
                a6Var.f47380c = gbVar;
                a6Var.f47379b = Long.valueOf((SystemClock.elapsedRealtime() - j3) & Long.MAX_VALUE);
    ...
    public final void g(gb gbVar, long j3, boolean z10, vb.a aVar, ig igVar) {
        ...
        a6Var.f47380c = this.f2587e.a();
        a6Var.f47379b = gbVar;
        a6Var.d = Boolean.valueOf(z10);
        m.f44294a.execute(new da(this.f2588f, new i1(a6Var), elapsedRealtime));
        long currentTimeMillis = System.currentTimeMillis();
        long j10 = currentTimeMillis - elapsedRealtime;
        z8 z8Var = this.f2589g;
        int i10 = gbVar.f50951a;
        synchronized (z8Var) {
            AtomicLong atomicLong = z8Var.f47682b;
            long elapsedRealtime2 = SystemClock.elapsedRealtime();
            if (atomicLong.get() != -1 && elapsedRealtime2 - z8Var.f47682b.get() <= TimeUnit.MINUTES.toMillis(30L)) {
                return;
            }
            z8Var.f47681a.f(new o(0, Arrays.asList(new n6.j(24336, i10, 0, j10, currentTimeMillis, null, null, 0, -1)))).addOnFailureListener(new n(z8Var, elapsedRealtime2, 10));
        }
    }
}
