...
public final class b extends n8 {
    public final Method f11067a = Class.class.getMethod("isRecord", null);
    public final Method f11068b = Class.class.getMethod("getRecordComponents", null);
    public final Method f11069c;
    public final Method d;

    public b() {
        Class<?> cls = Class.forName("java.lang.reflect.RecordComponent");
        this.f11069c = cls.getMethod("getName", null);
    ...
    public final Constructor b(Class cls) {
        try {
            Object[] objArr = (Object[]) this.f11068b.invoke(cls, null);
    ...
    public final String[] c(Class cls) {
        try {
            ...
            for (int i10 = 0; i10 < objArr.length; i10++) {
                strArr[i10] = (String) this.f11069c.invoke(objArr[i10], null);
            }
            return strArr;
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException("Unexpected ReflectiveOperationException occurred (Gson 2.11.0). To support Java records, reflection is utilized to read out information about records. All these invocations happens after it is established that records exist in the JVM. This exception is unexpected behavior.", e);
    ...
    public final boolean d(Class cls) {
        try {
            return ((Boolean) this.f11067a.invoke(cls, null)).booleanValue();
        } catch (ReflectiveOperationException e) {
            throw new RuntimeException("Unexpected ReflectiveOperationException occurred (Gson 2.11.0). To support Java records, reflection is utilized to read out information about records. All these invocations happens after it is established that records exist in the JVM. This exception is unexpected behavior.", e);
        }
    }
