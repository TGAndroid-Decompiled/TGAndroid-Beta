...
public abstract class n extends s4.j {
    ...
    public final void B(s4.h hVar) {
        ...
        if (view != null) {
            ...
            duration.translationX(hVar.e - hVar.f41657c);
            duration.translationY(hVar.f41658f - hVar.d);
            hVar2 = hVar;
    ...
    public final void T(final s4.c1 r22, s4.i r23, boolean r24) {
        throw new UnsupportedOperationException("Method not decompiled: ii.n.T(s4.c1, s4.i, boolean):void");
    }
    ...
    public final void U() {
        ...
        if (!this.K.isEmpty() && (k11Var = (k11) this.U.run()) != null) {
            ArrayList arrayList2 = k11Var.f24564c;
            if (!k11Var.e) {
                k11Var.e = true;
        ...
        if (transitionParams.top == 0 && transitionParams.bottom == 0 && transitionParams.left == 0 && transitionParams.right == 0) {
            ...
            while (true) {
                ...
                if (childAt instanceof t1) {
                    ...
                    if (t1Var.getTransitionParams().f20008v0 && groupedMessages.messages.contains(messageObject)) {
    ...
    public final void X(View view) {
        ...
        if (z10) {
            ...
            transitionParams.f20533b = false;
            transitionParams.f20534c = 1.0f;
        } else {
    ...
    public final boolean Z(View view) {
        ...
        if (!this.N && (T = this.G.T(view)) != null) {
            if (this.f41669q.contains(T) || this.f41676y.contains(T)) {
                return true;
            }
            return false;
        }
        ...
        if (a2 && this.N) {
            ...
            if (z10) {
                ...
                for (int i12 = 0; i12 < arrayList.size(); i12++) {
                    i10 += ((c1) arrayList.get(i12)).f41610a.getHeight();
                }
            } else {
                i10 = 0;
            }
            for (int i13 = 0; i13 < arrayList.size(); i13++) {
                ((c1) arrayList.get(i13)).f41610a.setTranslationY(i10);
            }
        }
        return a2;
    }
    ...
    public final boolean a0(View view) {
        c1 T = this.G.T(view);
        if (T != null) {
            if (this.f41668p.contains(T) || this.A.contains(T)) {
                return true;
            }
            return false;
        }
    ...
    public void g() {
        ...
        for (int size2 = arrayList2.size() - 1; size2 >= 0; size2--) {
            ...
            X(iVar.f41661a.f41610a);
            v(iVar.f41661a);
            arrayList2.remove(size2);
        }
        ArrayList arrayList3 = this.f41668p;
        ...
        ArrayList arrayList5 = this.f41671s;
        ...
        ArrayList arrayList8 = this.f41672t;
    ...
    public final q0 l(z0 z0Var, c1 c1Var, int i10, List list) {
        ...
        if (view instanceof t1) {
            ?? obj = new Object();
            obj.f1896a = l4.f1896a;
            obj.f1897b = l4.f1897b;
            s1 transitionParams = ((t1) view).getTransitionParams();
            obj.f10669c = transitionParams.f19918a;
            obj.d = transitionParams.f19922b;
            obj.e = transitionParams.f19927c;
            obj.f10670f = transitionParams.d;
            return obj;
        }
        return l4;
    }
    ...
    @Override
    public final void m() {
        throw new UnsupportedOperationException("Method not decompiled: ii.n.m():void");
    }
    ...
    public final boolean q(c1 c1Var, c1 c1Var2, q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        view2.setAlpha(0.0f);
        this.f41671s.add(new s4.h(c1Var, c1Var2, i10, i11, i12, i13));
        F();
        return true;
    }
    ...
    public final boolean r(c1 c1Var, q0 q0Var, int i10, int i11, int i12, int i13) {
        ...
        if (view2 instanceof t1) {
            ...
            if (t1Var2.getTransitionParams().f19999s2 != t1Var2.getTopMediaOffset()) {
                i14 = (t1Var2.getTransitionParams().f19999s2 - t1Var2.getTopMediaOffset()) + i11;
            } else {
                i14 = i11;
            }
            t1Var = t1Var2;
        ...
        if (t1Var != null) {
            ...
            int[] iArr2 = transitionParams.f20001t0;
            ...
            if (z14) {
                ...
                l lVar = (l) q0Var;
                i15 = i20;
                if (transitionParams.f20008v0 && lVar.f10670f != f7 && lVar.e != f7) {
                    z13 = true;
                } else {
                    z13 = false;
                }
                ...
                if (z13) {
                    ...
                    vl0Var.invalidate();
                    transitionParams.f19941f0 = true;
                    if (t1Var.getMessageObject().isRoundVideo()) {
                        transitionParams.m0 = f12;
                        transitionParams.f19977n0 = f13;
                        transitionParams.f19981o0 = f18;
                        transitionParams.f19985p0 = f17;
                        transitionParams.A0 = iArr;
                    } else {
                        transitionParams.m0 = photoImage.getImageX();
                        transitionParams.f19977n0 = photoImage.getImageY();
                        transitionParams.f19981o0 = photoImage.getImageWidth();
                        transitionParams.f19985p0 = photoImage.getImageHeight();
                    ...
                    float f20 = lVar.f10669c;
                    if (f19 == f20 && transitionParams.f19977n0 == lVar.d && transitionParams.f19985p0 == lVar.f10670f && transitionParams.f19981o0 == lVar.e && !transitionParams.B0) {
                        transitionParams.f19941f0 = false;
                        iVar.f10678n = false;
                    } else {
                        iVar.f10679o = f20;
                        iVar.f10680p = lVar.d;
                        iVar.f10681q = lVar.e;
                        iVar.f10682r = lVar.f10670f;
                        ...
                        t1Var.U3(iVar.f10679o, iVar.f10680p, iVar.f10681q, iVar.f10682r);
                    }
                }
                if (currentMessagesGroup == null && transitionParams.f20008v0 && (((isOutOwner = t1Var.getMessageObject().isOutOwner()) && rect.left != t1Var.getBackgroundDrawableLeft()) || ((!isOutOwner && rect.right != t1Var.getBackgroundDrawableRight()) || rect.top != t1Var.getBackgroundDrawableTop() || rect.bottom != t1Var.getBackgroundDrawableBottom()))) {
                    iVar.v = t1Var.getBackgroundDrawableBottom() - rect.bottom;
                    iVar.f10685u = t1Var.getBackgroundDrawableTop() - rect.top;
                    if (t1Var.G8 != transitionParams.E0) {
                        iVar.f10683s = t1Var.getBackgroundDrawableLeft() - rect.left;
                        iVar.f10684t = t1Var.getBackgroundDrawableRight() - rect.right;
                    } else if (isOutOwner) {
                        iVar.f10683s = t1Var.getBackgroundDrawableLeft() - rect.left;
                    } else {
                        iVar.f10684t = t1Var.getBackgroundDrawableRight() - rect.right;
                    ...
                    iVar.f10676l = true;
                    transitionParams.f20012w0 = true;
                    transitionParams.f19946g0 = -iVar.f10683s;
                    transitionParams.f19950h0 = -iVar.f10684t;
                    transitionParams.f19960j0 = -iVar.f10685u;
                    transitionParams.f19955i0 = -iVar.v;
                    vl0Var.setClipChildren(false);
                    vl0Var.invalidate();
                }
            } else {
            ...
            if (currentMessagesGroup != null) {
                ...
                if (arrayList.contains(currentMessagesGroup)) {
                    ...
                    int i27 = 0;
                    int i28 = 0;
                    while (i24 < vl0Var2.getChildCount()) {
                        View childAt = vl0Var2.getChildAt(i24);
                        if (childAt instanceof t1) {
                            ...
                            if (t1Var3.getCurrentMessagesGroup() == currentMessagesGroup && !t1Var3.getMessageObject().deleted) {
                                ...
                                if (t1Var3.getTransitionParams().f20008v0 || transitionParams3.isNewGroup) {
            ...
            if (groupedMessages2 != null) {
                ...
                if (transitionParams.f20008v0) {
                    ...
                    iVar.f10686w = true;
                    transitionParams.f20012w0 = true;
                    iVar.f10683s = backgroundDrawableLeft2 - transitionParams4.left;
                    iVar.f10684t = backgroundDrawableRight2 - transitionParams4.right;
                    iVar.f10685u = backgroundDrawableTop2 - transitionParams4.top;
                    iVar.v = backgroundDrawableBottom2 - transitionParams4.bottom;
                    iVar.f10676l = false;
                    transitionParams.f19946g0 = (int) ((-i16) - t1Var.getAnimationOffsetX());
                    transitionParams.f19950h0 = (int) ((-iVar.f10684t) - t1Var.getAnimationOffsetX());
                    transitionParams.f19960j0 = (int) ((-iVar.f10685u) - t1Var.getTranslationY());
                    transitionParams.f19955i0 = (int) ((-iVar.v) - t1Var.getTranslationY());
            ...
            if (!t1Var.f20202k8 && !t1Var.J && !z10) {
                z11 = false;
            } else {
                z11 = true;
            }
            if (transitionParams.f20020y0 != z11) {
                z12 = true;
                iVar.f10675k = true;
                f14 = 0.0f;
                transitionParams.f20024z0 = 0.0f;
            } else {
                f14 = 0.0f;
                z12 = true;
            }
            ...
            iVar.f10677m = f21;
            if (f21) {
                transitionParams.f19945g = z12;
                transitionParams.K1 = f14;
            }
            if (i15 == 0 && i21 == 0 && !iVar.f10678n && !iVar.f10686w && !iVar.f10674j && !iVar.f10675k && !iVar.f10676l && !f21) {
                v(c1Var);
                return false;
            }
        } else if (w0Var2 != null) {
            ...
            iVar.f10677m = a2;
            if (a2) {
                transitionParams5.f20533b = true;
                transitionParams5.f20534c = 0.0f;
            }
            if (i20 == 0 && i21 == 0 && !a2) {
                v(c1Var);
                return false;
    ...
    public final void s(c1 c1Var, q0 q0Var) {
        ...
        View view = c1Var.f41610a;
        if (q0Var != null) {
            int i10 = q0Var.f1897b;
            int top = view.getTop();
            int left = view.getLeft() - q0Var.f1896a;
            int i11 = top - i10;
            if (i11 != 0) {
            ...
            if (view instanceof t1) {
                ...
                if (q0Var instanceof l) {
                    l lVar = (l) q0Var;
                    t1Var.U3(lVar.f10669c, lVar.d, lVar.e, lVar.f10670f);
                }
            } else if (left != 0) {
