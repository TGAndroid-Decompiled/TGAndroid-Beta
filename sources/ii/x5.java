...
public final class x5 implements h1 {
    ...
    public final void D(i1 i1Var, int i10, int i11) {
        ...
        d6 d6Var = this.f11767a;
        if (!d6Var.F && i10 != i11 && (a6Var = d6Var.f11343y) != null && (textSelectionHelper = ((e3) a6Var).f11354a.getTextSelectionHelper()) != null) {
    ...
    public final void M(CharSequence charSequence) {
        a6 a6Var = this.f11767a.f11343y;
        if (a6Var != null) {
            e3 e3Var = (e3) a6Var;
            if (charSequence != null && charSequence.length() > 0) {
                e3Var.f11354a.t4(charSequence.toString());
            }
        }
    }
    ...
    public final void W(Editable editable) {
        a aVar;
        d6 d6Var = this.f11767a;
        if (d6Var.f11342x != null) {
            d6Var.E(editable);
            d6Var.J();
            d6.d(d6Var.f11342x.f11201b, editable);
            d6Var.C();
            d6Var.G();
            int i10 = 0;
            if (d6Var.o() && !d6Var.l()) {
                ((TL_iv.pageBlockBlockquote) d6Var.f11342x.f11201b).collapsed = false;
            }
            d6Var.H();
            ...
            a6 a6Var2 = d6Var.f11343y;
            if (a6Var2 != null) {
                ((e3) a6Var2).f11354a.f11711h3.g(d6Var, d6.b(editable.toString()));
            }
            String obj = editable.toString();
            a aVar2 = d6Var.f11342x;
            if (aVar2 != null && obj != null && aVar2.f11202c == 0 && (aVar2.f11201b instanceof TL_iv.pageBlockParagraph) && obj.equals("> ")) {
                i10 = 6;
            }
            if (i10 != 0 && d6Var.f11343y != null) {
                d6Var.post(new ai.s1(this, d6Var.f11342x, i10, 15));
            } else {
                c6 s10 = d6.s(d6Var.f11342x, editable.toString());
                if (s10 != null && d6Var.f11343y != null) {
                    d6Var.post(new gg.t(this, d6Var.f11342x, s10, 18));
                }
            }
            if (!d6Var.T && ((aVar = d6Var.f11342x) == null || !(aVar.f11201b instanceof TL_iv.pageBlockPullquote))) {
                return;
            }
            d6Var.invalidate();
        }
    ...
    public final boolean b0(boolean z10) {
        ...
        d6 d6Var = this.f11767a;
        a6 a6Var = d6Var.f11343y;
        if (a6Var != null && (aVar = d6Var.f11342x) != null) {
            return ((e3) a6Var).f11354a.W3(aVar, z10);
        }
        return false;
    }
    ...
    public final boolean f() {
        d6 d6Var = this.f11767a;
        a6 a6Var = d6Var.f11343y;
        if (a6Var != null && d6Var.f11342x != null) {
            return ((e3) a6Var).f11354a.S4();
        }
        return false;
    }
    ...
    public final void j(int i10, int i11) {
        ...
        d6 d6Var = this.f11767a;
        a6 a6Var = d6Var.f11343y;
        if (a6Var != null && d6Var.f11342x != null && (h2Var = ((e3) a6Var).f11354a.J3) != null) {
            h2Var.f(i10, i11);
        }
    }
    ...
    public final void m(i1 i1Var) {
        ...
        Editable text;
        d6 d6Var = this.f11767a;
        if (d6Var.f11343y != null && d6Var.f11342x != null) {
            String obj = i1Var.getText().toString();
            ((e3) d6Var.f11343y).f11354a.f11711h3.g(d6Var, null);
            String b10 = d6.b(obj);
            if (b10 != null) {
            ...
            if (q6 != 0) {
                ((e3) d6Var.f11343y).c(d6Var.f11342x, q6);
                return;
            }
            c6 r10 = d6.r(d6Var.f11342x, i1Var.getText().toString());
            if (r10 != null) {
                ((e3) d6Var.f11343y).d(d6Var.f11342x, r10.f11287a, r10.f11288b, r10.f11289c, r10.d, r10.e);
            } else if ((d6Var.f11342x.f11201b instanceof TL_iv.pageBlockPullquote) && d6Var.f11337f.length() > 0) {
                d6Var.i();
            } else {
                a6 a6Var = d6Var.f11343y;
                a aVar = d6Var.f11342x;
                w3 w3Var = ((e3) a6Var).f11354a;
                ArrayList arrayList = w3Var.f11726p4;
                w51 w51Var = w3Var.Y2;
                ...
                if (indexOf >= 0) {
                    ...
                    if (z11) {
                        ...
                        SpannableStringBuilder A = d6.A(aVar.f11201b);
                        length = A.length();
                    ...
                    if (spannableStringBuilder.length() == 0) {
                        if (!aVar.f11207k.isEmpty()) {
                            ArrayList arrayList3 = aVar.f11207k;
                    ...
                    ArrayList arrayList4 = aVar.f11207k;
                    if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
                        long a10 = q0.a();
                        TL_iv.RichText richText = ((TL_iv.pageBlockBlockquote) aVar.f11201b).caption;
                        if (richText != null && !(richText instanceof TL_iv.textEmpty)) {
                            w3Var.f11719m3.put(Long.valueOf(a10), richText);
                        }
                    ...
                    a aVar2 = new a(pageblockparagraph, aVar.f11202c, i11);
                    aVar2.e = aVar.e;
                    aVar2.f11207k.addAll(arrayList4);
                    int i12 = indexOf + 1;
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(htmlText)) {
                        ...
                        try {
                            ...
                            if (!w42.isEmpty() && ((w42.size() != 1 || !w3.F3((a) w42.get(0))) && (indexOf = w3Var.f11718l3.indexOf(aVar)) >= 0)) {
    ...
    public final boolean t(i1 i1Var) {
        ...
        return w3.Q1(((e3) a6Var).f11354a, aVar, false);
    }
    ...
    public final void x() {
        ...
        a6 a6Var = d6Var.f11343y;
        if (a6Var != null && (aVar = d6Var.f11342x) != null) {
            w3.Q1(((e3) a6Var).f11354a, aVar, true);
        }
    }
}
