...
public abstract class d4 {
    ...
    public static a B(c4 c4Var, boolean z10) {
        ...
        ArrayList g32 = w3.g3(pageblockcollage);
        ...
        while (i10 < size) {
            ...
            c4 c4Var2 = (c4) obj;
            if (!c4Var2.f11287b) {
                if ("figcaption".equals(c4Var2.f11286a)) {
                    charSequence = w(c4Var2);
                } else {
                    boolean equals = "video".equals(c4Var2.f11286a);
                    if (equals || "img".equals(c4Var2.f11286a)) {
    ...
    public static void D(c4 c4Var, ArrayList arrayList, int i10, boolean z10) {
        ...
        while (i15 < size) {
            ...
            i15++;
            c4 c4Var2 = (c4) obj;
            if (!c4Var2.f11287b && "li".equals(c4Var2.f11286a)) {
                ...
                while (i16 < size2) {
                    ...
                    if (!c4Var3.f11287b && ("ul".equals(c4Var3.f11286a) || "ol".equals(c4Var3.f11286a))) {
                        arrayList4.add(c4Var3);
                    } else if (c4Var3.f11287b) {
                        spannableStringBuilder.append((CharSequence) q(c4Var3.f11288c));
                    } else {
                ...
                aVar.e = z11;
                aVar.f11205f = c4Var2.b("data-checked");
                arrayList.add(aVar);
                ...
                while (i18 < size3) {
                    ...
                    i18++;
                    c4 c4Var4 = (c4) obj2;
                    D(c4Var4, arrayList, i13, "ol".equals(c4Var4.f11286a));
                }
                i14++;
            }
        }
    ...
    public static void F(StringBuilder sb2, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, d7.c cVar, boolean z10, int i15, Map map) {
        ...
        d7.c cVar2 = cVar;
        int i18 = i15;
        ArrayList arrayList = cVar2.f7556a;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
            ...
            if (!aVar.f11207i) {
                if (aVar.f11209k.size() > i18) {
                    cVar2.b(sb3);
                    Long l4 = (Long) ((a) list3.get(iArr[0])).f11209k.get(i18);
                    ...
                    while (true) {
                        ...
                        if (aVar2.f11209k.size() <= i18 || ((Long) aVar2.f11209k.get(i18)).longValue() != longValue) {
                            break;
                        }
                        i20 = i21;
                    }
                    ...
                    if (w3.x3(aVar)) {
                        ...
                        sb3.append(((TL_iv.pageBlockDetails) aVar3.f11203b).open ? "<details open>" : "<details>");
                        sb3.append("<summary>");
                        ...
                        cVar4.b(sb3);
                        int i22 = iArr[0];
                        if (i22 <= i16 && i22 < list2.size() && ((a) list2.get(iArr[0])).f11207i) {
                            iArr[0] = iArr[0] + 1;
                        }
                        sb3.append("</details>");
                    } else {
                        i16 = i10;
                        list2 = list3;
                        if (aVar.f11204c > 0 && l(aVar.f11203b) != null) {
                            int i23 = aVar.f11204c;
                            ...
                            if (!arrayList.isEmpty() && ((Boolean) hg.c.h(1, arrayList)).booleanValue() != z11) {
                                cVar2.a(sb3);
                            ...
                            if (pageBlock instanceof TL_iv.pageBlockDivider) {
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockPhoto) {
                                    G(sb3, "img", ((TL_iv.pageBlockPhoto) pageBlock).photo_id, aVar.f11206g, pageBlock);
                                    sb3 = sb2;
                                } else if (pageBlock instanceof TL_iv.pageBlockVideo) {
                                    sb3 = sb2;
                                    G(sb3, "video", ((TL_iv.pageBlockVideo) pageBlock).video_id, aVar.f11206g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockAudio) {
                                    sb3 = sb2;
                                    G(sb3, "audio", ((TL_iv.pageBlockAudio) pageBlock).audio_id, aVar.f11206g, pageBlock);
                                } else if (pageBlock instanceof TL_iv.pageBlockDocument) {
                                    sb3 = sb2;
                                    G(sb3, "document", ((TL_iv.pageBlockDocument) pageBlock).document_id, aVar.f11206g, pageBlock);
                                } else {
                                    sb3 = sb2;
                                    ...
                                    if (w3.B3(pageBlock)) {
                                        ...
                                        if (pageblockmap.f18330w != 0) {
                                            sb3.append(" w=\"");
                                            sb3.append(pageblockmap.f18330w);
                                            sb3.append('\"');
                                        }
                                        if (pageblockmap.h != 0) {
                                            sb3.append(" h=\"");
    ...
    public static void H(StringBuilder sb2, TL_iv.pageBlockTable pageblocktable) {
        ...
        if (richText != null) {
            spannableStringBuilder = f6.r(richText, null, true);
        } else {
    ...
    public static CharSequence K(a aVar, int i10, int i11, int i12, int i13, int i14) {
        ...
        int i16;
        if (w3.x3(aVar)) {
            A = f6.r(((TL_iv.pageBlockDetails) aVar.f11203b).title, null, true);
        } else {
            A = d6.A(aVar.f11203b);
        }
        if (A == null) {
    ...
    public static void e(SpannableStringBuilder spannableStringBuilder, c4 c4Var, int i10, String str, long j3) {
        ...
        while (i12 < size) {
            ...
            if (c4Var2.f11287b) {
                ...
                str2 = str;
                j10 = j3;
                j(spannableStringBuilder2, q(c4Var2.f11288c), i11, str2, j10);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                i11 = i10;
                str2 = str;
    ...
    public static void f(SpannableStringBuilder spannableStringBuilder, c4 c4Var) {
        ...
        while (i10 < size) {
            ...
            if (c4Var2.f11287b) {
                spannableStringBuilder2 = spannableStringBuilder;
                j(spannableStringBuilder2, q(c4Var2.f11288c), 0, null, 0L);
            } else {
                spannableStringBuilder2 = spannableStringBuilder;
                if (!"cite".equals(c4Var2.f11286a)) {
    ...
    public static void g(java.lang.StringBuilder r22, java.lang.CharSequence r23) {
        throw new UnsupportedOperationException("Method not decompiled: ii.d4.g(java.lang.StringBuilder, java.lang.CharSequence):void");
    }
    ...
    public static void h(SpannableStringBuilder spannableStringBuilder, c4 c4Var, int i10, String str, long j3) {
        ...
        if ("button".equals(c4Var.f11286a) && (v = v(c4Var)) != null) {
        ...
        if (c4Var.e.isEmpty() && !c4Var.f11287b) {
            return;
        }
    ...
    public static void i(StringBuilder sb2, String str, long j3, u uVar, TL_iv.PageBlock pageBlock) {
        ...
        if (uVar != null) {
            if (uVar.f11643j > 0) {
                sb2.append(" width=\"");
                sb2.append(uVar.f11643j);
                sb2.append('\"');
            }
            if (uVar.f11644k > 0) {
                sb2.append(" height=\"");
                sb2.append(uVar.f11644k);
                sb2.append('\"');
            }
        }
    ...
    public static void j(SpannableStringBuilder spannableStringBuilder, String str, int i10, String str2, long j3) {
        if (str != null && str.length() != 0) {
            ...
            if (i10 != 0) {
                ?? obj = new Object();
                obj.f26642a = i10 & 114975;
                spannableStringBuilder.setSpan(new p01(obj, AndroidUtilities.dp(SharedConfig.fontSize)), length, length2, 33);
            }
            if (str2 != null) {
    ...
    public static ii.a m(ii.c4 r8) {
        throw new UnsupportedOperationException("Method not decompiled: ii.d4.m(ii.c4):ii.a");
    }
                ...
                switch (c10) {
                    case 0:
                        ...
                        while (i12 < size2) {
                            ...
                            c4 c4Var3 = (c4) obj2;
                            if (!c4Var3.f11287b) {
                                if ("td".equals(c4Var3.f11286a) || "th".equals(c4Var3.f11286a)) {
                                    ...
                                    if (!"th".equals(c4Var3.f11286a) && !c4Var3.b("header")) {
                                        z10 = false;
                                    } else {
                                        z10 = true;
                                    }
                                    h6.l(pagetablecell, z10);
    ...
    public static java.util.ArrayList z(java.lang.String r16, java.util.HashMap r17) {
        throw new UnsupportedOperationException("Method not decompiled: ii.d4.z(java.lang.String, java.util.HashMap):java.util.ArrayList");
    }
}
