...
public final class t0 extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        if (pageBlock instanceof TL_iv.pageBlockDetails) {
            ...
            AnimatedArrowDrawable animatedArrowDrawable = u0Var.f11648c;
            ...
            if (!aVar.f11215s) {
                aVar.f11215s = true;
                aVar.f11214r = (r10.length() == 0 || (f6.q(0, r10.length(), r10) & 1) != 0) ? true : true;
            }
            i1Var.setAutoBold(aVar.f11214r);
