...
public final class h2 {
    public final a4.m f11404a;
    public boolean e;
    public boolean f11407f;
    public final ArrayDeque f11405b = new ArrayDeque();
    public final ArrayDeque f11406c = new ArrayDeque();
    public final i2.g0 f11408g = new i2.g0(this, 6);
    public g2 d = b();
    ...
    public final g2 b() {
        ...
        ArrayList arrayList;
        f2[] f2VarArr;
        a4.m mVar = this.f11404a;
        ArrayList arrayList2 = ((w3) mVar.f273b).f11718l3;
        HashMap hashMap = new HashMap();
        g2 g2Var = this.d;
        if (g2Var != null) {
            for (f2 f2Var : g2Var.f11384a) {
                hashMap.put(Long.valueOf(f2Var.f11365a), f2Var);
            }
        }
        ...
        for (int i11 = 0; i11 < arrayList2.size(); i11++) {
            ...
            f2 f2Var2 = (f2) hashMap.get(Long.valueOf(aVar.f11200a));
            if (f2Var2 != null && f2Var2.f11367c == aVar.f11202c && f2Var2.d == aVar.d && f2Var2.e == aVar.e && f2Var2.f11368f == aVar.f11203f && f2Var2.f11369g == aVar.f11205i && f2Var2.h == aVar.f11204g) {
                ArrayList arrayList4 = f2Var2.f11370i;
                ...
                if (f2Var2.f11371j.equals(arrayList3) && Arrays.equals(f2Var2.f11366b, byteArray)) {
                    f2VarArr2[i11] = f2Var2;
                }
            }
            long j3 = aVar.f11200a;
            int i13 = aVar.f11202c;
            int i14 = aVar.d;
            boolean z10 = aVar.e;
            boolean z11 = aVar.f11203f;
            boolean z12 = aVar.f11205i;
            u uVar = aVar.f11204g;
            if (aVar.h != null) {
        ...
        View findFocus = ((w3) mVar.f273b).findFocus();
        if (findFocus instanceof i1) {
            ...
            if (U2 != null && U2.getRow() != null) {
                if (i1Var == U2.getTitleEditText()) {
                    e2Var = new e2(U2.getRow().f11200a, 0, selectionStart, selectionEnd);
                } else {
                    r5 o9 = U2.o(i1Var);
                    if (o9 != null) {
                        i10 = U2.k(o9.f11604b);
                    ...
                    e2Var = new e2(U2.getRow().f11200a, i10, selectionStart, selectionEnd);
                }
            } else {
                ...
                if (m0Var != null && m0Var.getRow() != null) {
                    e2Var = new e2(m0Var.getRow().f11200a, -1, selectionStart, selectionEnd);
                } else {
                    ...
                    if (i1Var instanceof d6) {
                        ...
                        if (d6Var.getRow() != null) {
                            e2Var = new e2(d6Var.getRow().f11200a, -1, selectionStart, selectionEnd);
                        }
                    }
                }
            }
    ...
    public final void c() {
        AndroidUtilities.cancelRunOnUIThread(this.f11408g);
        if (this.e && !this.f11407f) {
            g2 b10 = b();
            this.e = false;
            g2 g2Var = this.d;
            if (g2Var != null) {
                f2[] f2VarArr = g2Var.f11384a;
                f2[] f2VarArr2 = b10.f11384a;
            ...
            g2 g2Var2 = this.d;
            ArrayDeque arrayDeque = this.f11405b;
            ...
            this.f11406c.clear();
            this.d = b10;
            ((w3) this.f11404a.f273b).f11711h3.F();
        }
    }
    ...
    public final void i() {
        d();
        ArrayDeque arrayDeque = this.f11406c;
        if (arrayDeque.isEmpty()) {
            return;
        }
        this.f11405b.addLast(this.d);
