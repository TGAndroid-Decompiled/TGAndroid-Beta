...
public final class y5 implements h1 {
    ...
    public final void D(i1 i1Var, int i10, int i11) {
        ...
        d6 d6Var = this.f11783a;
        if (!d6Var.f11340n && i10 != i11 && (a6Var = d6Var.f11345y) != null && (textSelectionHelper = ((e3) a6Var).f11356a.getTextSelectionHelper()) != null) {
    ...
    public final void W(Editable editable) {
        ...
        if (d6Var.f11344x != null) {
            ...
            TL_iv.PageBlock pageBlock = d6Var.f11344x.f11203b;
            if (pageBlock instanceof TL_iv.pageBlockPullquote) {
                ...
                if (measuredWidth > 0) {
                    if (d6Var.h(measuredWidth, d6Var.getPaddingBottom() + d6Var.h.getMeasuredHeight() + d6Var.f11337b.getMeasuredHeight() + d6Var.getPaddingTop()) == d6Var.O) {
                        return;
                    }
                }
                d6Var.requestLayout();
