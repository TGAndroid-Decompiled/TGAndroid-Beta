...
public abstract class c5 {
    ...
    public static ArrayList b(CharSequence charSequence) {
        ...
        while (i14 < size) {
            ...
            if (spanned != null && span == null) {
                ti0Var = (ti0) a(spanned, i15, i10, ti0.class);
            } else {
                ti0Var = null;
            }
            if (span == null && ti0Var == null) {
                ...
                while (true) {
                    if (i14 < size) {
                        ...
                        if (span != null) {
                            ...
                            a2 = a(spanned, i16, length, ti0.class);
                        }
                        if (a2 != ti0Var2) {
                            break;
                        }
            ...
            while (it.hasNext()) {
                ...
                if (pageBlock != null) {
                    ...
                    if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                        SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(f6.r(pageBlock.text, pageBlock, true));
                        ...
                        if (!z10 && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                            if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                                ...
                                if (arrayList4 != null && !arrayList4.isEmpty()) {
                                    ...
                                    while (i10 < size) {
                                        ...
                                        if (pageListItem2 instanceof TL_iv.TL_pageListItemText) {
                                            spannableStringBuilder2 = f6.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true);
                                ...
                                if (arrayList6 != null && !arrayList6.isEmpty()) {
                                    ...
                                    while (i10 < size2) {
                                        ...
                                        if (pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemText) {
                                            spannableStringBuilder = f6.r(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem2).text, null, true);
                                        ...
                                        if (spannableStringBuilder != null) {
                                            ...
                                            SpannableStringBuilder spannableStringBuilder6 = new SpannableStringBuilder(p6.t(valueOf, ".  "));
                                ...
                                SpannableStringBuilder r11 = f6.r(pageblocktable.title, null, true);
                                    ...
                                    while (i12 < size3) {
                                        ...
                                        if (arrayList10 != null && !arrayList10.isEmpty()) {
                                            ...
                                            for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                                ...
                                                spannableStringBuilder7.append((CharSequence) f6.r(pagetablerow2.cells.get(i13).text, null, true));
                                            }
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockAuthorDate) {
                                    spannableStringBuilder3 = f6.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                                    ...
                                    if (pageBlock.caption != null) {
                                        ...
                                        SpannableStringBuilder r12 = f6.r(pageBlock.caption.text, null, true);
                                        if (!TextUtils.isEmpty(r12)) {
                                            spannableStringBuilder8.append((CharSequence) r12);
                                        }
                                        SpannableStringBuilder r13 = f6.r(pageBlock.caption.credit, null, true);
                                    ...
                                    spannableStringBuilder3 = f6.r(pageBlock.text, pageBlock, true);
                                }
                            } else {
                            ...
                            spannableStringBuilder3 = h(f6.r(pageBlock.text, pageBlock, true), richText);
                        }
                    }
                }
        ...
        if (arrayList != null) {
            ...
            while (i10 < size) {
                ...
                if (aVar == null) {
                    ...
                    if (!aVar.f11208i && aVar.f11205c <= 0) {
    ...
    public static SpannableStringBuilder i(a aVar, boolean z10) {
        ...
        if (z10) {
            ...
            TL_iv.PageBlock pageBlock2 = aVar.f11204b;
            if (pageBlock2 != null) {
                richText = pageBlock2.text;
            }
            r10 = f6.r(richText, pageBlock2, true);
        }
        if (aVar.f11204b instanceof TL_iv.pageBlockPreformatted) {
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(r10);
            spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, ((TL_iv.pageBlockPreformatted) aVar.f11204b).language, spannableStringBuilder.toString()), 0, spannableStringBuilder.length(), 33);
            return spannableStringBuilder;
        }
        return r10;
    }
    ...
    public static SpannableStringBuilder j(List list, boolean z10) {
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (!aVar.f11210k.isEmpty()) {
                long longValue = ((Long) aVar.f11210k.get(0)).longValue();
                SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
                int i11 = i10;
                while (i11 < list.size() && !((a) list.get(i11)).f11210k.isEmpty() && ((Long) ((a) list.get(i11)).f11210k.get(0)).longValue() == longValue) {
                    if (i11 > i10) {
                        spannableStringBuilder.append('\n');
                    }
                ...
                if (spannableStringBuilder.length() > 0) {
                    ti0.b(spannableStringBuilder, 0, spannableStringBuilder.length(), false);
                }
                ...
                if (!(pageBlock instanceof TL_iv.pageBlockBlockquote) && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    boolean z11 = true;
                    if (z10) {
                        r10 = f6.r(pageBlock.text, pageBlock, false);
                    } else {
                    ...
                    if (spannableStringBuilder2.length() > 0) {
                        ti0.b(spannableStringBuilder2, 0, spannableStringBuilder2.length(), z11);
                    }
    ...
    public static CharSequence l(int i10, SpannableStringBuilder spannableStringBuilder) {
        ...
        ?? obj = new Object();
        obj.f26908a = i10;
        spannableStringBuilder2.setSpan(new q01(obj, 0), 0, spannableStringBuilder2.length(), 33);
        return spannableStringBuilder2;
    }
}
