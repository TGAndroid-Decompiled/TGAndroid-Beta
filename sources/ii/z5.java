...
public final class z5 extends CharacterStyle {
    ...
    public final void updateDrawState(TextPaint textPaint) {
        switch (this.f11804a) {
            case 0:
                textPaint.setColor(i6.v(i6.l1(0.55f, textPaint.getColor()), i6.l1(0.4f, i6.v0(i6.Oh, ((d6) this.f11805b).f11336a))));
                return;
            case 1:
                textPaint.setTypeface(AndroidUtilities.bold());
                int alpha = textPaint.getAlpha();
                int i10 = i6.f19018n6;
                ((ta0) this.f11805b).getClass();
                textPaint.setColor(i6.w0(null, i10, false));
                textPaint.setAlpha(alpha);
                return;
            default:
                textPaint.setColor(i6.v(i6.l1(0.55f, textPaint.getColor()), i6.l1(0.4f, ((si0) this.f11805b).I)));
                return;
        }
    }
