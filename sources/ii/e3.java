...
public final class e3 implements a6 {
    ...
    public final int a(a aVar) {
        float f7;
        int i10;
        w3 w3Var = this.f11356a;
        int indexOf = w3Var.f11720l3.indexOf(aVar);
        if (indexOf >= 0 && (i10 = indexOf + 1) < w3Var.f11720l3.size() && ((a) w3Var.f11720l3.get(i10)).f11204c > 0) {
            f7 = 5.0f;
        } else {
            f7 = 11.0f;
        }
    ...
    public final int b(a aVar) {
        ...
        w3 w3Var = this.f11356a;
        int indexOf = w3Var.f11720l3.indexOf(aVar);
        if (indexOf > 0 && ((a) w3Var.f11720l3.get(indexOf - 1)).f11204c > 0) {
            f7 = 2.0f;
        } else {
            f7 = 8.0f;
        }
    ...
    public final void c(a aVar, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                return;
            case 3:
                r.U(w3Var.getContext(), "", new ai.y1(w3Var, 28), w3Var.f11711g3);
                return;
            case 4:
            case 5:
                u3Var.h(1);
    ...
    public final void d(a aVar, TL_iv.PageBlock pageBlock, int i10, int i11, boolean z10, boolean z11) {
        ...
        if (z13) {
            ...
            if (aVar != null) {
                ...
                if (w3Var.f11720l3.indexOf(aVar) >= 0 && !w3.x3(aVar) && !aVar.f11207i) {
                    h2 h2Var = w3Var.J3;
                    if (h2Var != null) {
                        h2Var.d();
                    }
                    if (arrayList.isEmpty() && !d6.p(aVar.f11203b)) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
