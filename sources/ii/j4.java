...
public abstract class j4 {
    public static EditTextBoldCursor a(Context context, org.telegram.ui.ActionBar.e6 e6Var, String str, String str2) {
        ...
        editTextBoldCursor.setTextColor(i6.v0(i6.f18943j5, e6Var));
        ...
        editTextBoldCursor.setLineColors(i6.v0(i6.f18964k6, e6Var), i6.v0(i6.f18982l6, e6Var), i6.v0(i6.f19056p7, e6Var));
        editTextBoldCursor.setImeOptions(5);
        editTextBoldCursor.setBackgroundDrawable(null);
        editTextBoldCursor.setPadding(0, 0, 0, 0);
        editTextBoldCursor.setHighlightColor(i6.v0(i6.f19157uf, e6Var));
        editTextBoldCursor.setHandlesColor(i6.v0(i6.f19174vf, e6Var));
    ...
    public static void f(org.telegram.ui.ActionBar.n2 n2Var, Context context, org.telegram.ui.ActionBar.e6 e6Var, t3 t3Var, boolean z10) {
        ...
        if (c10) {
            ...
            b2Var.f18482p0 = string3;
            b2Var.f18483q0 = e4Var;
    ...
    public static void h(v3 v3Var, boolean z10) {
        ...
        String str = l4;
        v3Var.f11691f.o3(false);
        if (z11) {
            i10 = R.string.RichEditorEditCopyButton;
        } else {
            i10 = R.string.RichEditorCreateCopyButton;
        }
        v3Var.f11688a.showInputDialog(LocaleController.getString(i10), LocaleController.getString(R.string.RichEditorButtonCopyText), str, false, !z10, new g4(v3Var, 1));
    }
    ...
    public static void i(v3 v3Var, boolean z10) {
        ...
        v3Var.f11688a.showInputDialog(LocaleController.getString(i10), LocaleController.getString(R.string.RichEditorButtonURL), str2, true, !z10, new g4(v3Var, 0));
    }
    ...
    public static void j(AlertDialog$Builder alertDialog$Builder, EditTextBoldCursor editTextBoldCursor, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        if (i10 != 0 && (b2Var.d(i10) instanceof TextView)) {
            ((TextView) b2Var.d(i10)).setTextColor(i6.v0(i6.f19074q7, e6Var));
        }
    }
