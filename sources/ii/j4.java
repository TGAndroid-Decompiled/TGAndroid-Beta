...
public abstract class j4 {
    public static EditTextBoldCursor a(Context context, org.telegram.ui.ActionBar.f6 f6Var, String str, String str2) {
        ...
        editTextBoldCursor.setTextColor(j6.v0(j6.f18969j5, f6Var));
        ...
        editTextBoldCursor.setLineColors(j6.v0(j6.f18990k6, f6Var), j6.v0(j6.f19008l6, f6Var), j6.v0(j6.f19082p7, f6Var));
        editTextBoldCursor.setImeOptions(5);
        editTextBoldCursor.setBackgroundDrawable(null);
        editTextBoldCursor.setPadding(0, 0, 0, 0);
        editTextBoldCursor.setHighlightColor(j6.v0(j6.f19183uf, f6Var));
        editTextBoldCursor.setHandlesColor(j6.v0(j6.f19200vf, f6Var));
    ...
    public static void f(org.telegram.ui.ActionBar.o2 o2Var, Context context, org.telegram.ui.ActionBar.f6 f6Var, t3 t3Var, boolean z10) {
        ...
        if (c10) {
            ...
            c2Var.f18511p0 = string3;
            c2Var.f18512q0 = e4Var;
    ...
    public static void h(v3 v3Var, boolean z10) {
        ...
        String str = l4;
        v3Var.f11694f.p3(false);
        if (z11) {
            i10 = R.string.RichEditorEditCopyButton;
        } else {
            i10 = R.string.RichEditorCreateCopyButton;
        }
        v3Var.f11691a.showInputDialog(LocaleController.getString(i10), LocaleController.getString(R.string.RichEditorButtonCopyText), str, false, !z10, new g4(v3Var, 1));
    }
    ...
    public static void j(AlertDialog$Builder alertDialog$Builder, EditTextBoldCursor editTextBoldCursor, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        if (i10 != 0 && (c2Var.d(i10) instanceof TextView)) {
            ((TextView) c2Var.d(i10)).setTextColor(j6.v0(j6.f19100q7, f6Var));
        }
    }
