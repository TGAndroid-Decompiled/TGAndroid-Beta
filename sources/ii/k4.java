...
public final class k4 extends ReplacementSpan {
    ...
    public final void a(int i10, View view, org.telegram.ui.ActionBar.e6 e6Var) {
        View view2;
        RichMessageLayout.RichButtonSpan richButtonSpan = this.f11474b;
        if (richButtonSpan != null && (view2 = this.f11475c) != null) {
    ...
    public final RichMessageLayout.RichButtonSpan b() {
        if (this.f11474b == null) {
            RichMessageLayout.RichButtonSpan createEditorButtonSpan = RichMessageLayout.createEditorButtonSpan(this.d, AndroidUtilities.dp(240.0f), this.e, this.f11473a);
            this.f11474b = createEditorButtonSpan;
            View view = this.f11475c;
            if (view != null) {
