...
public final class a2 extends Drawable {
    ...
    public final org.telegram.ui.Components.d6 f11232b;
    ...
    public a2(int i10) {
        ...
        this.f11231a = paint;
        this.f11232b = new org.telegram.ui.Components.d6(new i2.g0(this, 5), 420L, qr.h, 0);
        this.d = 255;
        paint.setColor(i10);
    }
    ...
    public final void draw(Canvas canvas) {
        float e = this.f11232b.e(this.f11233c);
        if (e <= 0.0f) {
            return;
        }
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f11231a.setColorFilter(colorFilter);
    }
}
