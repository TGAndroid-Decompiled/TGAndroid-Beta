...
public final class x1 extends HorizontalScrollView {
    public final l20 f11757a;
    public final org.telegram.ui.Components.d6 f11758b;
    public final org.telegram.ui.Components.d6 f11759c;
    public final d2 d;

    public x1(d2 d2Var, Context context) {
        super(context);
        this.d = d2Var;
        this.f11757a = new l20();
        qr qrVar = qr.h;
        this.f11758b = new org.telegram.ui.Components.d6(this, 300L, qrVar);
        this.f11759c = new org.telegram.ui.Components.d6(this, 300L, qrVar);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f11758b.e(canScrollHorizontally(-1));
        float e7 = this.f11759c.e(canScrollHorizontally(1));
