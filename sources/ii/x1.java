...
public final class x1 extends HorizontalScrollView {
    public final l20 f11753a;
    public final org.telegram.ui.Components.c6 f11754b;
    public final org.telegram.ui.Components.c6 f11755c;
    public final d2 d;

    public x1(d2 d2Var, Context context) {
        super(context);
        this.d = d2Var;
        this.f11753a = new l20();
        qr qrVar = qr.h;
        this.f11754b = new org.telegram.ui.Components.c6(this, 300L, qrVar);
        this.f11755c = new org.telegram.ui.Components.c6(this, 300L, qrVar);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Canvas canvas2;
        float e = this.f11754b.e(canScrollHorizontally(-1));
        float e7 = this.f11755c.e(canScrollHorizontally(1));
