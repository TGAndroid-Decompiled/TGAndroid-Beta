...
public final class r0 implements h1 {
    ...
    public final void D(i1 i1Var, int i10, int i11) {
        ...
        u0 u0Var = this.f11593a;
        if (!u0Var.f11650n && i10 != i11 && (d3Var = u0Var.h) != null && (textSelectionHelper = d3Var.f11330a.getTextSelectionHelper()) != null) {
    ...
    public final void M(CharSequence charSequence) {
        d3 d3Var = this.f11593a.h;
        if (d3Var != null && charSequence != null && charSequence.length() > 0) {
            d3Var.f11330a.t4(charSequence.toString());
        }
    }
    ...
    public final void W(Editable editable) {
        u0 u0Var = this.f11593a;
        a aVar = u0Var.f11649f;
        if (aVar != null) {
            aVar.f11215s = true;
            aVar.f11214r = u0Var.d.E;
        }
        if (aVar != null) {
    ...
    public final void m(i1 i1Var) {
        ...
        u0 u0Var = this.f11593a;
        d3 d3Var = u0Var.h;
        if (d3Var != null && (aVar = u0Var.f11649f) != null && (indexOf = (arrayList = (w3Var = d3Var.f11330a).f11718l3).indexOf(aVar)) >= 0) {
            ...
            int i10 = indexOf + 1;
            if (i10 < arrayList.size() && !((a) arrayList.get(i10)).f11205i && !w3.x3((a) arrayList.get(i10))) {
    ...
    public final boolean t(i1 i1Var) {
        u0 u0Var = this.f11593a;
        if (u0Var.h != null && u0Var.f11649f != null && i1Var.length() == 0) {
            u0Var.h.a(u0Var.f11649f);
            return true;
        }
        return false;
    }
