...
public final class a5 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TLRPC.Document f11240r;
    public final z4 f11241s;
    public boolean v;
    ...
    public final void a(String str) {
        int i10;
        boolean z10;
        if (!this.f11242w && !this.f11243x) {
            this.E = str;
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f11235a);
            ...
            FileLoader fileLoader = FileLoader.getInstance(this.f11235a);
            String str2 = this.E;
            if (!this.f11237c && !this.d && !this.e) {
                z10 = true;
            } else {
                z10 = false;
            }
    ...
    public final void b() {
        if (!this.f11243x && !this.f11242w) {
            this.f11242w = true;
            try {
                if (this.E != null) {
                    FileLoader.getInstance(this.f11235a).cancelFileUpload(this.E, false);
                }
            } catch (Throwable unused) {
            }
            if (this.f11244y != 0) {
                ConnectionsManager.getInstance(this.f11235a).cancelRequest(this.f11244y, true);
                this.f11244y = 0;
            }
            e();
        }
    ...
    public final void c(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2) {
        ...
        if (this.f11237c) {
            ...
            tL_documentAttributeVideo.duration = this.f11239n;
            tL_documentAttributeVideo.f18116w = this.f11238f;
            ...
            if (!z10 && !z11) {
                ...
                TLRPC.Document document = this.f11240r;
                if (z11) {
        ...
        this.f11244y = ConnectionsManager.getInstance(this.f11235a).sendRequest(tL_messages_uploadMedia, new m8(this, 17));
    }

    public final void d() {
        int i10;
        int i11;
        if (!this.v && !this.f11242w && !this.f11243x) {
            this.v = true;
            if (this.f11237c) {
                z4 z4Var = this.f11241s;
                ...
                try {
                    ...
                    BitmapFactory.decodeFile(this.f11236b, options);
                    int i13 = options.outWidth;
                    if (i13 > 0 && (i10 = options.outHeight) > 0) {
                        this.f11241s.a(i13, i10);
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i11 == this.f11235a && !this.f11242w && !this.f11243x) {
            ...
            if (this.E != null && this.E.equals(str)) {
                if (i10 == NotificationCenter.fileUploaded) {
                    ...
                    if (this.e && !this.H && !TextUtils.isEmpty(this.F)) {
                        ...
                        this.H = true;
                        this.E = this.F;
                        FileLoader.getInstance(this.f11235a).uploadFile(this.E, false, true, 16777216);
