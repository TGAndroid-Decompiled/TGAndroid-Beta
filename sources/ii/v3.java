...
public final class v3 {
    ...
    public final void a(TL_keyboard.InlineButtonType inlineButtonType) {
        ...
        int i10;
        TL_iv.textButton textbutton;
        if (k4.c(inlineButtonType) && (text = (i1Var = this.f11690a).getText()) != null && (i10 = this.f11691b) >= 0) {
            int length = text.length();
            int i11 = this.f11692c;
            if (i11 <= length && i10 < i11) {
                w3 w3Var = this.f11693f;
                h2 h2Var = w3Var.J3;
                if (h2Var != null) {
                    h2Var.d();
                }
                ...
                f6.m(text, i10, i11);
                k4 k4Var2 = this.d;
                if (k4Var2 == null || (textbutton = k4Var2.f11475a) == null) {
                ...
                k4Var3.a(w3Var.f11709f3, i1Var, w3Var.f11711g3);
