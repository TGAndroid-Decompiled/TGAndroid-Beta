...
public abstract class e4 {
    ...
    public static void D(d4 d4Var, ArrayList arrayList, int i10, boolean z10) {
        ...
        while (i15 < size) {
            ...
            if (!d4Var2.f11295b && "li".equals(d4Var2.f11294a)) {
                ...
                if (!d4Var2.b("data-checkbox") && ((a2 = d4Var2.a("class")) == null || !a2.toLowerCase().contains("checkbox"))) {
                    z11 = false;
                } else {
                    z11 = true;
                }
    ...
    public static void F(StringBuilder sb2, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, d7.c cVar, boolean z10, int i15, Map map) {
        ...
        d7.c cVar2 = cVar;
        int i18 = i15;
        ArrayList arrayList = cVar2.f7542a;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
                            ...
                            if (pageBlock instanceof TL_iv.pageBlockDivider) {
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockPhoto) {
                                    ...
                                    if (x3.B3(pageBlock)) {
                                        ...
                                        if (pageblockmap.f18304w != 0) {
                                            sb3.append(" w=\"");
                                            sb3.append(pageblockmap.f18304w);
                                            sb3.append('\"');
                                        }
                                        if (pageblockmap.h != 0) {
                                            sb3.append(" h=\"");
    ...
    public static void H(StringBuilder sb2, TL_iv.pageBlockTable pageblocktable) {
        ...
        if (richText != null) {
            spannableStringBuilder = g6.r(richText, null, true);
        } else {
    ...
    public static void g(java.lang.StringBuilder r22, java.lang.CharSequence r23) {
        throw new UnsupportedOperationException("Method not decompiled: ii.e4.g(java.lang.StringBuilder, java.lang.CharSequence):void");
    }
    ...
    public static ii.a m(ii.d4 r8) {
        throw new UnsupportedOperationException("Method not decompiled: ii.e4.m(ii.d4):ii.a");
    }
    ...
    public static java.util.ArrayList z(java.lang.String r16, java.util.HashMap r17) {
        throw new UnsupportedOperationException("Method not decompiled: ii.e4.z(java.lang.String, java.util.HashMap):java.util.ArrayList");
    }
}
