...
public final class o implements fk {
    public final vi f11521a;
    public final r f11522b;
    ...
    public final void w() {
        try {
            ...
            intent.setType("*/*");
            this.f11522b.f26462b.f28750f0.startActivityForResult(intent, 21);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
