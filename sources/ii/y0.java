...
public final class y0 extends a0 implements org.telegram.ui.ActionBar.a6, p9 {
    ...
    public final void e() {
        ...
        this.f11774s.setColor(j6.v0(j6.f19183uf, f6Var));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (s2Var != null && (textSelectionHelper = s2Var.f11616a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
            ...
            if (S >= 0 && S >= textSelectionHelper.f20628u0 && S <= textSelectionHelper.f20631x0) {
                ...
                canvas2.drawRoundRect(rectF, AndroidUtilities.dp(0.5f), AndroidUtilities.dp(0.5f), this.f11773r);
            }
        }
        canvas2 = canvas;
        ...
        canvas2.drawRoundRect(rectF2, AndroidUtilities.dp(0.5f), AndroidUtilities.dp(0.5f), this.f11773r);
    }
