    ...
    public final void onFocusChange(View view, boolean z10) {
        ...
        switch (this.f11697a) {
            case 0:
                ...
                return;
            case 1:
                EditTextBoldCursor editTextBoldCursor = ((pg.v) this.f11698b).f41042c;
            ...
            case 4:
                ...
                a0Var.f46922c0.c(z10, !TextUtils.isEmpty(a0Var.f46923d0.getText()));
                return;
            case 5:
                yh.e0 e0Var = (yh.e0) this.f11698b;
                e0Var.f47116f.c(z10, !TextUtils.isEmpty(e0Var.h.getText()));
                return;
            case 6:
                yh.i0 i0Var = (yh.i0) this.f11698b;
                i0Var.f47290b.c(z10, !TextUtils.isEmpty(i0Var.f47291c.getText()));
                return;
            default:
