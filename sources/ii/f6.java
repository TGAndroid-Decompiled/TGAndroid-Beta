...
public abstract class f6 {
    public static final int[] f11382a = {1, 2, 16, 8, 4, 256, 16384, 32768, 65536};
        ...
        if (richText instanceof TL_iv.textConcat) {
            ...
            if (j3) {
                ...
                if (spannableStringBuilder.length() > length) {
                    ?? obj = new Object();
                    obj.f26905a = 8192;
                    spannableStringBuilder.setSpan(new q01(obj, 0), length, spannableStringBuilder.length(), 33);
                    return;
                }
                return;
            }
            ...
            if (j10) {
                if (spannableStringBuilder.length() > length) {
                    ?? obj2 = new Object();
                    obj2.f26905a = 4096;
                    spannableStringBuilder.setSpan(new q01(obj2, 0), length, spannableStringBuilder.length(), 33);
                }
    ...
    public static int d(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: ii.f6.d(java.lang.CharSequence):int");
    }
    ...
    public static int e(Spanned spanned, int i10, int i11) {
        ...
        for (q01 q01Var : q01VarArr) {
            int i13 = q01Var.f27185b.f26905a;
            if ((i13 & 512) != 0) {
                i13 |= 256;
            }
            i12 |= i13;
    ...
    public static org.telegram.tgnet.tl.TL_iv.RichText f(java.lang.CharSequence r14) {
        throw new UnsupportedOperationException("Method not decompiled: ii.f6.f(java.lang.CharSequence):org.telegram.tgnet.tl.TL_iv$RichText");
    }
    ...
    public static void o(Spannable spannable, int i10, int i11, int i12, boolean z10, TL_iv.PageBlock pageBlock) {
        ...
        if (max < max2) {
            for (q01 q01Var : (q01[]) spannable.getSpans(max, max2, q01.class)) {
                ...
                int i14 = q01Var.f27185b.f26905a;
    ...
    public static TL_iv.RichText s(String str, e6 e6Var) {
        ...
        k4 k4Var = e6Var.f11363f;
        if (k4Var != null) {
            return k4Var.f11476a;
        }
        if (e6Var.e != null) {
        ...
        if (e6Var.f11361b != null) {
            TL_iv.RichText texturl = new TL_iv.textUrl();
            texturl.text = richText9;
            texturl.url = e6Var.f11361b;
            richText10 = texturl;
        }
        h10 h10Var = e6Var.f11362c;
        if (h10Var != null) {
