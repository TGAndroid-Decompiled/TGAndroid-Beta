...
public final class s1 implements ti {
    public final vi f11611a;
    public final d2 f11612b;
    ...
    public final void x0(fh fhVar) {
        NotificationCenter.getInstance(this.f11612b.getCurrentAccount()).doOnIdle(fhVar);
    }
