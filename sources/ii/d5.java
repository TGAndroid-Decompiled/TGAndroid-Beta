...
public abstract class d5 {
            ...
            while (it.hasNext()) {
                ...
                if (pageBlock != null) {
                    ...
                    if (pageBlock instanceof TL_iv.pageBlockPreformatted) {
                        SpannableStringBuilder spannableStringBuilder4 = new SpannableStringBuilder(g6.r(pageBlock.text, pageBlock, true));
                        ...
                        if (!z10 && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                            if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                                ...
                                if (arrayList4 != null && !arrayList4.isEmpty()) {
                                    ...
                                    while (i10 < size) {
                                        ...
                                        if (pageListItem2 instanceof TL_iv.TL_pageListItemText) {
                                            spannableStringBuilder2 = g6.r(((TL_iv.TL_pageListItemText) pageListItem2).text, null, true);
                                ...
                                if (arrayList6 != null && !arrayList6.isEmpty()) {
                                    ...
                                    while (i10 < size2) {
                                        ...
                                        if (pageListOrderedItem2 instanceof TL_iv.TL_pageListOrderedItemText) {
                                            spannableStringBuilder = g6.r(((TL_iv.TL_pageListOrderedItemText) pageListOrderedItem2).text, null, true);
                                ...
                                SpannableStringBuilder r11 = g6.r(pageblocktable.title, null, true);
                                    ...
                                    while (i12 < size3) {
                                        ...
                                        if (arrayList10 != null && !arrayList10.isEmpty()) {
                                            ...
                                            for (int i13 = 0; i13 < pagetablerow2.cells.size(); i13++) {
                                                ...
                                                spannableStringBuilder7.append((CharSequence) g6.r(pagetablerow2.cells.get(i13).text, null, true));
                                            }
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockAuthorDate) {
                                    spannableStringBuilder3 = g6.r(((TL_iv.pageBlockAuthorDate) pageBlock).author, null, true);
                                    ...
                                    if (pageBlock.caption != null) {
                                        ...
                                        SpannableStringBuilder r12 = g6.r(pageBlock.caption.text, null, true);
                                        if (!TextUtils.isEmpty(r12)) {
                                            spannableStringBuilder8.append((CharSequence) r12);
                                        }
                                        SpannableStringBuilder r13 = g6.r(pageBlock.caption.credit, null, true);
                                    ...
                                    spannableStringBuilder3 = g6.r(pageBlock.text, pageBlock, true);
                                }
                            } else {
                            ...
                            spannableStringBuilder3 = h(g6.r(pageBlock.text, pageBlock, true), richText);
                        }
                    }
                }
        ...
        while (list != null && i10 < list.size()) {
            ...
            if (!aVar.f11197k.isEmpty()) {
                ...
                if (!(pageBlock instanceof TL_iv.pageBlockBlockquote) && !(pageBlock instanceof TL_iv.pageBlockPullquote)) {
                    ...
                    boolean z11 = true;
                    if (z10) {
                        r10 = g6.r(pageBlock.text, pageBlock, false);
                    } else {
    ...
    public static CharSequence l(int i10, SpannableStringBuilder spannableStringBuilder) {
        ...
        ?? obj = new Object();
        obj.f26312a = i10;
        spannableStringBuilder2.setSpan(new o01(obj, 0), 0, spannableStringBuilder2.length(), 33);
        return spannableStringBuilder2;
    }
}
