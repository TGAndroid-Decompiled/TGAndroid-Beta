...
public final class e2 extends org.telegram.ui.ActionBar.m2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(e2 e2Var, View view) {
        ...
        if (wnVar != null && e2Var.f11328r == null && !wnVar.c() && e2Var.P.k3() && !e2Var.P.m3()) {
            ...
            if (!Z2.isEmpty()) {
                ...
                long a2 = e2Var.J.a();
                MessageObject messageObject = e2Var.J.f39574n5;
    ...
    public static void Z(e2 e2Var, boolean z10, boolean z11) {
        ...
        if (e2Var.J0 != z10 || !z11) {
            ...
            if (animatedDrawable != null) {
                if (z10) {
                    if (animatedDrawable.f25068a0 > 34) {
    ...
    public final void n0() {
        ...
        if (h22 != null) {
            ...
            e0Var.n0(a2);
            e0Var.f23787k0 = new ai.y1(h22, 28);
            e0Var.show();
        }
    }
    ...
    public final void o0(int i10, int i11) {
        ...
        wiVar.f30017j0.setIncludeVideosInGallery(true);
        wiVar.f30017j0.f0();
        wiVar.J1(1, true);
        wiVar.h1(i10);
        wiVar.f30050t2 = new s1(this, wiVar);
    ...
    public final boolean q0() {
        ...
        if (j22 != null && !this.M) {
            ...
            if (x3Var.k3() && !d5.f(x3Var.f11735l3, x3Var.f11736m3) && jkVar != null) {
                ...
                if (wnVar != null) {
                    ...
                    MediaDataController.getInstance(jkVar.Q).saveDraft(wnVar.a(), wnVar.B7(wnVar.f39574n5), charSequenceArr[0], MediaDataController.getInstance(jkVar.Q).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.J.a();
        wn wnVar2 = this.J;
        mediaDataController.saveDraft(a2, wnVar2.B7(wnVar2.f39574n5), "", null, null, null, null, 0L, false, false, j22);
    ...
    public final void s0(final int i10, final int i11, final boolean z10) {
        if (m0()) {
            ...
            if (!this.P.M3()) {
                ...
                wn wnVar = this.J;
                final MessageObject messageObject = wnVar.f39574n5;
