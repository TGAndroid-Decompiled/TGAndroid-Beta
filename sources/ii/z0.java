...
public final class z0 extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        if (a1Var.U != i10) {
            ...
            if (i10 == null) {
                ...
                tL_message.out = true;
                tL_message.f18133id = -Long.valueOf(i10.f18118id).hashCode();
                tL_message.peer_id = new TLRPC.TL_peerUser();
                TLRPC.TL_peerUser tL_peerUser = new TLRPC.TL_peerUser();
                tL_message.from_id = tL_peerUser;
                TLRPC.Peer peer = tL_message.peer_id;
                int i11 = a1Var.f11221n;
                ...
                a aVar2 = a1Var.f11217a;
                if (aVar2 != null && (uVar = aVar2.f11204g) != null && !TextUtils.isEmpty(uVar.e)) {
                    tL_message.attachPath = a1Var.f11217a.f11204g.e;
                }
    ...
    public final View createView(Context context, ll0 ll0Var, int i10, int i11, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        a1Var.setBackground(new a2(i6.v0(i6.f18836d6, e6Var)));
        return a1Var;
    }
