...
public final class z3 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f11801a) {
            case 0:
                this.f11802b.f11257a.f11495a.f11590r.Y3(this.f11803c);
                return;
            default:
                final r rVar = this.f11802b.f11257a.f11495a;
                org.telegram.ui.ActionBar.e6 e6Var = rVar.f26460a;
                w3 w3Var = rVar.f11590r;
                a Q2 = w3Var.Q2();
                int i10 = this.f11803c;
                if (i10 != 1) {
                    if (i10 != 2) {
                    ...
                    if (Q2 != null && (Q2.f11203b instanceof TL_iv.pageBlockDetails)) {
                        z21 = true;
                    } else {
                        z21 = false;
                    }
                        ...
                        if (m22) {
                            F.c(R.drawable.iv_list_tab, LocaleController.getString(R.string.ArticleIndent), new Runnable() {
                                ...
                                public final void run() {
                                    switch (r3) {
                                        case 0:
                                            rVar.f11590r.r3(false);
                                            F.u();
                                            return;
                                        default:
                                            rVar.f11590r.r3(true);
                                            F.u();
                                            return;
                                    }
                                }
