...
public final class a1 extends a0 implements org.telegram.ui.ActionBar.z5, q9, m0, DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.ActionBar.f6 f11226r;
    public final Paint f11227s;
    public final Paint v;
    public final TextPaint f11228w;
    public final TextPaint f11229x;
    public final RadialProgress2 f11230y;

    public a1(Context context, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        super(context);
        this.f11227s = new Paint(1);
        this.v = new Paint(1);
        this.f11228w = new TextPaint(1);
        this.f11229x = new TextPaint(1);
    ...
    public final void f(int i10) {
        ...
        int i13 = this.J;
        int i14 = this.I;
        this.f11230y.q(i13, i11, i13 + i14, i14 + i11);
        requestLayout();
    }
    ...
    public final void h(TLRPC.Document document) {
        ...
        if (z10) {
            ...
            if (r3Var == null) {
                ...
                messageObject = r3Var.f11604a.f11717i3;
            }
            imageReceiver.setImageCoords(this.K, AndroidUtilities.dp(10.0f), AndroidUtilities.dp(86.0f), AndroidUtilities.dp(86.0f));
    ...
    public final void k() {
        ...
        TextPaint textPaint = this.f11228w;
        textPaint.setTextSize(AndroidUtilities.dp(15.0f));
        textPaint.setTypeface(AndroidUtilities.bold());
        TextPaint textPaint2 = this.f11229x;
        textPaint2.setTextSize(AndroidUtilities.dp(13.0f));
        String documentFileName = FileLoader.getDocumentFileName(i13);
        if (TextUtils.isEmpty(documentFileName) && (uVar = this.f11221a.f11208g) != null && !TextUtils.isEmpty(uVar.e)) {
            documentFileName = new File(this.f11221a.f11208g.e).getName();
        }
        ...
        long j3 = i13.size;
        if (j3 <= 0) {
            u uVar2 = this.f11221a.f11208g;
            if (uVar2 != null && !TextUtils.isEmpty(uVar2.e)) {
                j3 = new File(this.f11221a.f11208g.e).length();
            } else {
                j3 = 0;
            }
        }
    ...
    public final void onDetachedFromWindow() {
        ...
        DownloadController.getInstance(this.f11225n).removeLoadingFileObserver(this);
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i() != null) {
            boolean z10 = this.L;
            org.telegram.ui.ActionBar.f6 f6Var = this.f11226r;
            ...
            int dp = AndroidUtilities.dp(f7) + i10;
            this.f11228w.setColor(j6.v0(j6.Dd, f6Var));
            ...
            if (this.S != null && (getParent() instanceof RecyclerView) && (textSelectionHelper = this.S.f11604a.getTextSelectionHelper()) != null && textSelectionHelper.y()) {
                ...
                if (S > textSelectionHelper.f20904u0 && S <= textSelectionHelper.f20907x0) {
                    ...
                    canvas.drawRoundRect(dp4, dp5, dp6, AndroidUtilities.dp(f10), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f11227s);
                }
            }
        }
    }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        ...
        this.f11230y.o(min, true);
    }

    @Override
    public final void onSuccessDownload(String str) {
        this.f11230y.o(1.0f, true);
        l(true);
    }
