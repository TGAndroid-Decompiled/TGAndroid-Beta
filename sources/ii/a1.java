...
public final class a1 extends a0 implements org.telegram.ui.ActionBar.y5, q9, m0, DownloadController.FileDownloadProgressListener {
    ...
    @Override
    public final void e() {
        this.f11213s.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f19109uf, this.f11212r));
        l0 l0Var = this.F;
        if (l0Var != null) {
            l0Var.a();
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (i() != null) {
            ...
            this.f11215x.setColor(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18978nd, d6Var));
            ...
            if (this.S != null && (getParent() instanceof RecyclerView) && (textSelectionHelper = this.S.f11613a.getTextSelectionHelper()) != null && textSelectionHelper.y()) {
                ...
                if (R > textSelectionHelper.f20771u0 && R <= textSelectionHelper.f20774x0) {
                    if (this.M) {
                        i11 = 0;
                    } else {
                        i11 = this.f11209c;
