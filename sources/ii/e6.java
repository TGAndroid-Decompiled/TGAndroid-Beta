...
public final class e6 extends FrameLayout implements org.telegram.ui.ActionBar.y5, q9 {
        ...
        if (aVar != null && aVar.f11192c > 0 && (b6Var = this.f11355y) != null) {
            ...
            if (aVar2.f11200n) {
                ...
                if (i10 <= 0) {
                    ...
                    b10 = AndroidUtilities.dp(hg.c.g(i10, 1, 16, 10));
                }
            }
            ...
            if (aVar3.f11201o) {
                ...
                if (i11 <= 0) {
                    ...
                    a2 = AndroidUtilities.dp(hg.c.g(i11, 1, 16, 10));
                }
            }
    ...
    public final void I(TL_iv.PageBlock pageBlock, boolean z10) {
        ...
        if (linearLayout3 == null) {
            ...
            this.f11352s.setBackground(org.telegram.ui.ActionBar.h6.Y(org.telegram.ui.ActionBar.h6.v0(org.telegram.ui.ActionBar.h6.f18878i6, d6Var), AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f)));
            ...
            addView(this.f11352s, w7.x5.d(-2, -2.0f, 53, 0.0f, -15.0f, -5.0f, 0.0f));
            TextView textView = new TextView(getContext());
            this.v = textView;
            textView.setTextSize(1, 12.0f);
            this.v.setGravity(17);
            this.f11352s.addView(this.v, w7.x5.t(-2, -2, 16, 0, 0, 0, 0));
            ImageView imageView = new ImageView(getContext());
            this.f11353w = imageView;
            imageView.setImageResource(R.drawable.arrows_select);
            this.f11352s.addView(this.f11353w, w7.x5.r(16, 16, 16, 0.0f, 0.66f, 0.0f, 0.0f));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (aVar != null && (aVar.f11191b instanceof TL_iv.pageBlockPreformatted)) {
            ...
            int c10 = o8.c(this.f11354x);
            int d = o8.d(this.f11354x);
            int width = getWidth();
            if (c10 <= 0 && d <= 0) {
                i10 = 0;
            } else {
            ...
            if (aVar != null && (aVar.f11191b instanceof TL_iv.pageBlockBlockquote)) {
                if (this.J == null) {
                    ...
                    this.J = tl0Var;
                    tl0Var.a(null, null, null, this.f11346a, 1);
                    o8.a(this.J, d6Var);
                }
                ...
                if (aVar != null && (aVar.f11191b instanceof TL_iv.pageBlockPullquote)) {
                    if (this.J == null) {
                        ...
                        this.J = tl0Var2;
                        tl0Var2.a(null, null, null, this.f11346a, 1);
                        o8.a(this.J, d6Var);
                    }
                    if (this.K == null) {
        ...
        b6 b6Var = this.f11355y;
        if (b6Var != null) {
            r9Var = ((f3) b6Var).f11363a.getTextSelectionHelper();
        } else {
            r9Var = null;
        }
        if (r9Var != null) {
        ...
        float B = org.telegram.messenger.z0.B(8.0f, getHeight(), AndroidUtilities.dp(3.333f));
        this.L.a(canvas2, this.M, org.telegram.messenger.z0.B(16.0f, getWidth(), dp), B, v02, ((TL_iv.pageBlockBlockquote) this.f11354x.f11191b).collapsed, l());
    }
    ...
    public final int h(int i10, int i11) {
        ...
        if (l()) {
            ...
            if (i1Var.getVisibility() == 0 && (layout = i1Var.getLayout()) != null && layout.getLineCount() > 0) {
                ...
                this.L.getClass();
                float B = org.telegram.messenger.z0.B(16.0f, i10, dp2) - org.telegram.messenger.z0.D(3.333f, 2, AndroidUtilities.dp(23.66f) + li0Var.f25902c);
                this.L.getClass();
                int i12 = i11 - dp2;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable)) {
            li0 li0Var = this.L;
            if (li0Var != null) {
                if (drawable != li0Var.f25901b && drawable != li0Var.e) {
                    return false;
                }
                return true;
            }
