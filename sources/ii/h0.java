...
public final class h0 extends a0 implements org.telegram.ui.ActionBar.z5 {
    ...
    public final org.telegram.ui.ActionBar.e6 f11401r;
    public final HorizontalScrollView f11402s;
    public final LinearLayout v;
    public final z1 f11403w;
    ...
    public h0(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        ...
        z1Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                ...
                switch (r2) {
                    case 0:
                        h0 h0Var = this.f11295b;
                        f0 f0Var = h0Var.E;
                        if (f0Var != null && (aVar = h0Var.f11219a) != null) {
                            w3 w3Var = ((o3) f0Var).f11534a;
                            w3Var.o3(false);
                            w3Var.f11713h3.H(new t3(w3Var, aVar, -1), view);
                            return;
                        }
                        return;
                    default:
                        h0 h0Var2 = this.f11295b;
                        f0 f0Var2 = h0Var2.E;
                        if (f0Var2 != null && (aVar2 = h0Var2.f11219a) != null) {
                            w3 w3Var2 = ((o3) f0Var2).f11534a;
                            w3Var2.o3(false);
                            w3Var2.f11713h3.H(new t3(w3Var2, aVar2, -1), view);
                            return;
                        }
                        return;
                }
    ...
    public final void j() {
        int i10 = i6.Oh;
        org.telegram.ui.ActionBar.e6 e6Var = this.f11401r;
        int v02 = i6.v0(i10, e6Var);
        int v = i6.v(i6.v0(i6.f18834d6, e6Var), i6.l1(0.1f, v02));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        ArrayList arrayList = this.f11405y;
        ...
        HorizontalScrollView horizontalScrollView = this.f11402s;
        ...
        if (size2 > 0) {
            ...
            if (size3 != 0) {
                ...
                for (int i19 = 0; i19 < size3; i19++) {
                    ...
                    e0Var.getClass();
                    int max3 = Math.max(AndroidUtilities.dp(34.0f), e0Var.f11348a.getPreferredWidth());
                    iArr[i19] = max3;
                    i18 += max3;
                }
                if (i18 <= max2) {
                    ...
                    for (int i29 = 0; i29 < size3; i29++) {
                        ...
                        e0Var2.getClass();
                        i28 += i30 - Math.max(AndroidUtilities.dp(34.0f), e0Var2.f11348a.getMinWidth());
                    }
                    if (i28 <= 0) {
                        for (int i31 = 0; i31 < size3; i31++) {
                            e0 e0Var3 = (e0) arrayList.get(i31);
                            e0Var3.getClass();
                            iArr[i31] = Math.max(AndroidUtilities.dp(34.0f), e0Var3.f11348a.getMinWidth());
                        }
                    } else {
                        ...
                        while (i32 < size3) {
                            ...
                            e0Var4.getClass();
                            int max4 = i34 - Math.max(AndroidUtilities.dp(34.0f), e0Var4.f11348a.getMinWidth());
                            if (i32 == i17) {
                                i14 = min - i33;
                                i13 = min;
                            } else {
                ...
                for (int i35 = 0; i35 < size3; i35++) {
                    ...
                    int i36 = iArr[i35];
                    RichMessageLayout.RichButton richButton = e0Var5.f11348a;
        ...
        if (size2 > 0) {
            dp = ((e0) arrayList.get(0)).f11348a.getHeight();
