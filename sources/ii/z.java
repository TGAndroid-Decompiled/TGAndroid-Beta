...
public final class z extends a0 implements org.telegram.ui.ActionBar.z5, p9, m0, NotificationCenter.NotificationCenterDelegate, DownloadController.FileDownloadProgressListener {
    ...
    public final org.telegram.ui.ActionBar.e6 f11785r;
    public final Paint f11786s;
    public final TextPaint v;
    public final RadialProgress2 f11787w;
    public final bo0 f11788x;
    public final int f11789y;

    public z(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f11786s = new Paint(1);
        ...
        this.f11789y = DownloadController.getInstance(i10).generateObserverTag();
        RadialProgress2 radialProgress2 = new RadialProgress2(this, e6Var);
        this.f11787w = radialProgress2;
        ...
        this.U = l0Var;
        addView(l0Var.f11485a, w7.x5.e(-2, -2, 51));
        e();
    }
    ...
    private TLRPC.Document getDisplayDocument() {
        u uVar;
        a aVar = this.f11219a;
        if (aVar != null && (uVar = aVar.f11206g) != null) {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (messageObject != null && i11 == this.f11784n) {
    ...
    @Override
    public final void e() {
        this.f11786s.setColor(i6.v0(i6.f19154uf, this.f11785r));
        l0 l0Var = this.U;
        if (l0Var != null) {
            l0Var.a();
        }
    ...
    public final void f(int i10) {
        ...
        int i12 = this.G;
        int i13 = this.F;
        this.f11787w.q(i11, i13, i11 + i12, i12 + i13);
        requestLayout();
        invalidate();
    }
    ...
    public final void i(a aVar, q3 q3Var) {
        ...
        this.f11219a = aVar;
        this.O = q3Var;
        if (aVar != null && aVar.f11206g == null) {
            aVar.f11206g = new u();
        }
        ...
        if (j() && this.P == null && displayDocument != null) {
            ...
            tL_message.out = true;
            tL_message.f18130id = -Long.valueOf(displayDocument.f18115id).hashCode();
            ...
            if (aVar2 != null && (uVar = aVar2.f11206g) != null && !TextUtils.isEmpty(uVar.e)) {
                tL_message.attachPath = this.f11219a.f11206g.e;
            }
    ...
    public final boolean j() {
        u uVar;
        a aVar = this.f11219a;
        if (aVar != null && (uVar = aVar.f11206g) != null && uVar.b()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean k() {
        u uVar;
        a aVar = this.f11219a;
        if (aVar != null && (uVar = aVar.f11206g) != null && uVar.a()) {
            return true;
        }
        return false;
    }
    ...
    public final void l() {
        ...
        this.f11788x.j(this.K, AndroidUtilities.dp(30.0f));
    }
    ...
    public final void m(boolean z10) {
        ...
        int i12 = i6.f19151uc;
        int i13 = i6.f19168vc;
        RadialProgress2 radialProgress2 = this.f11787w;
        radialProgress2.g(i10, i11, i12, i13);
        radialProgress2.d = i6.v0(i6.Bd, this.f11785r);
        boolean k10 = k();
        int i14 = this.f11784n;
        if (k10) {
            DownloadController.getInstance(i14).removeLoadingFileObserver(this);
            radialProgress2.o(this.f11219a.f11206g.f11640f, z10);
            radialProgress2.setIcon(3, false, z10);
            n();
            return;
        }
        if (j()) {
            document = this.f11219a.f11206g.h;
        } else {
            document = null;
        }
        ...
        a aVar = this.f11219a;
        int i15 = 1;
        if (aVar != null && (uVar = aVar.f11206g) != null && !TextUtils.isEmpty(uVar.e) && new File(this.f11219a.f11206g.e).exists()) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getDisplayDocument() != null) {
            this.f11787w.draw(canvas);
            int i11 = i6.f19152ud;
            org.telegram.ui.ActionBar.e6 e6Var = this.f11785r;
            int v02 = i6.v0(i11, e6Var);
            int v03 = i6.v0(i6.f19169vd, e6Var);
            int i12 = i6.f19204xd;
            int v04 = i6.v0(i12, e6Var);
            int v05 = i6.v0(i12, e6Var);
            int v06 = i6.v0(i6.f19187wd, e6Var);
            bo0 bo0Var = this.f11788x;
            ...
            int v07 = i6.v0(i6.f19023nd, e6Var);
            TextPaint textPaint = this.v;
            ...
            if (q3Var != null && (textSelectionHelper = q3Var.f11572a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
                ...
                if (R >= 0 && R > textSelectionHelper.f20616u0 && R <= textSelectionHelper.f20619x0) {
                    ...
                    canvas.drawRoundRect(dp, dp2, (width - i13) - AndroidUtilities.dp(8.0f), AndroidUtilities.dp(64.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), this.f11786s);
                }
            }
        }
    }
    ...
    public final void onProgressDownload(String str, long j3, long j10) {
        ...
        this.f11787w.o(Math.min(1.0f, f7), true);
        if (this.R != 3) {
            m(true);
        }
    }
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!k()) {
            if (this.f11788x.f(x10 - this.I, y3 - this.J, actionMasked)) {
                if (actionMasked == 0) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.S) {
                ...
                if (k()) {
                    ...
                    if (q3Var != null) {
                        a aVar = this.f11219a;
                        w3 w3Var = q3Var.f11572a;
                        ArrayList arrayList = w3Var.f11720l3;
                        a5 a5Var = (a5) w3Var.Z3.remove(aVar.f11206g);
                        if (a5Var != null) {
                            a5Var.b();
                        }
