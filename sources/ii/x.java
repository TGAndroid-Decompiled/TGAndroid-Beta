...
public final class x extends bb {
    ...
    public final org.telegram.ui.Cells.i3 f11711e0;
    ...
    public x(int i10, Context context, Utilities.Callback callback, org.telegram.ui.ActionBar.d6 d6Var) {
        ...
        imageView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    default:
                        x xVar = this.f11659b;
                        org.telegram.ui.Cells.i3 i3Var = xVar.f11711e0;
                        if (!xVar.f11713g0) {
        ...
        g3Var.setMaxLines(5);
        i3Var.setBackground(org.telegram.ui.ActionBar.h6.b0(AndroidUtilities.dp(20.0f), org.telegram.ui.ActionBar.h6.v0(i13, d6Var)));
        ...
        g10.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    ...
                    default:
                        x xVar = this.f11659b;
                        org.telegram.ui.Cells.i3 i3Var2 = xVar.f11711e0;
                        if (!xVar.f11713g0) {
                            TL_iv.RichMessage richMessage = xVar.f11715i0;
                            if (richMessage != null) {
                                Utilities.Callback callback2 = xVar.Y;
                            ...
                            String trim = i3Var2.f20177b.getText().toString().trim();
                            if (!TextUtils.isEmpty(trim)) {
                                xVar.f11713g0 = true;
                                xVar.f11712f0.setLoading(true);
                                TLRPC.TL_messages_composeRichMessageWithAI tL_messages_composeRichMessageWithAI = new TLRPC.TL_messages_composeRichMessageWithAI();
                                ...
                                tL_messages_composeRichMessageWithAI.tone = inputaicomposetonesingleuse;
                                xVar.f11714h0 = ConnectionsManager.getInstance(xVar.X).sendRequest(tL_messages_composeRichMessageWithAI, new n8(xVar, 16));
                                AndroidUtilities.hideKeyboard(i3Var2.f20177b);
                                return;
                            }
                            return;
                        }
    ...
    public final void P() {
        ...
        if (richMessage != null) {
            ...
            dVar.setEnabled(!TextUtils.isEmpty(this.f11711e0.f20177b.getText().toString().trim()));
        }
    }
    ...
    public final void dismiss() {
        ...
        AndroidUtilities.hideKeyboard(this.f11711e0.f20177b);
        super.dismiss();
    }
