...
public final class o4 extends a0 implements org.telegram.ui.ActionBar.z5, p9, m0 {
    ...
    public final org.telegram.ui.ActionBar.e6 f11534r;
    public final Paint f11535s;
    public final Paint v;
    public final Paint f11536w;
    public final TextPaint f11537x;
    public final ImageReceiver f11538y;

    public o4(Context context, int i10, org.telegram.ui.ActionBar.e6 e6Var) {
        super(context);
        this.f11535s = new Paint(1);
        this.v = new Paint(1);
        this.f11536w = new Paint(1);
        TextPaint textPaint = new TextPaint(1);
        this.f11537x = textPaint;
        this.f11533n = i10;
        this.f11534r = e6Var;
        setWillNotDraw(false);
        textPaint.setTextSize(AndroidUtilities.dp(15.0f));
        textPaint.setTextAlign(Paint.Align.CENTER);
        this.f11538y = new ImageReceiver(this);
    ...
    public final void e() {
        int i10 = i6.f19063pe;
        org.telegram.ui.ActionBar.e6 e6Var = this.f11534r;
        this.f11535s.setColor(i6.v0(i10, e6Var));
        this.v.setColor(i6.v0(i6.Gd, e6Var));
        this.f11536w.setColor(i6.v0(i6.f19157uf, e6Var));
        int i11 = i6.G6;
        this.f11537x.setColor(i6.l1(0.5f, i6.v0(i11, e6Var)));
    ...
    public final void i() {
        ...
        ImageReceiver imageReceiver = this.f11538y;
        if (map != null && (map.geo instanceof TLRPC.TL_geoPoint)) {
            ...
            if (measuredWidth > 0 && i10 > 0) {
                ...
                if (!str.equals(this.I)) {
                    this.I = str;
                    int i13 = MessagesController.getInstance(this.f11533n).mapProvider;
                    this.H = i13;
                    if (i13 == 2) {
                    ...
                    imageReceiver.setImage(AndroidUtilities.formapMapUrl(this.f11533n, geoPoint.lat, geoPoint._long, i11, i12, true, 15, -1), null, null, null, 0L);
                    return;
                }
                return;
            }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f11538y.onAttachedToWindow();
        this.I = null;
        i();
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f11538y.onDetachedFromWindow();
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (getMap() != null) {
            ImageReceiver imageReceiver = this.f11538y;
            canvas2 = canvas;
            canvas2.drawRect(imageReceiver.getImageX(), imageReceiver.getImageY(), imageReceiver.getImageX2(), imageReceiver.getImageY2(), this.f11535s);
        ...
        m4 m4Var = this.G;
        if (m4Var != null && (textSelectionHelper = ((s3) m4Var).f11614a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
            ((RecyclerView) getParent()).getClass();
            int R = RecyclerView.R(this);
            if (R >= 0 && R > textSelectionHelper.f20618u0 && R <= textSelectionHelper.f20621x0) {
                canvas2.drawRect(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getPaddingTop() + this.K, this.f11536w);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        this.f11538y.setImageCoords(paddingLeft, getPaddingTop(), max, this.K);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        TL_iv.pageBlockMap map = getMap();
        if (map != null && map.f18334w > 0 && map.h > 0) {
            this.K = Math.max(Math.min((int) (((max - AndroidUtilities.dp(32.0f)) * map.h) / map.f18334w), AndroidUtilities.dp(420.0f)), AndroidUtilities.dp(120.0f));
        } else {
