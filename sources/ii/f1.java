...
public final class f1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        Editable editable2;
        i1 i1Var = this.f11367a;
        if (!i1Var.h && i1Var.f11433c != null) {
            ...
            if (!i1Var.f11438w && !i1Var.f11435n && !i1Var.f11436r) {
                i1Var.h = true;
                boolean z10 = false;
                ...
                i1Var.h = false;
                if (z10) {
                    i1Var.f11433c.m(i1Var);
                    return;
                } else {
                    i1Var.f11433c.U(editable2);
                    return;
                }
            }
            i1Var.f11433c.U(editable2);
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        h1 h1Var;
        i1 i1Var = this.f11367a;
        if (!i1Var.h && (h1Var = i1Var.f11433c) != null) {
            h1Var.j(i11, i12);
        }
    }
