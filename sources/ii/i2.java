...
public final class i2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, i2 i2Var) {
        if (richText != null) {
            i2Var.f11438a = f6.l(richText).length() + i2Var.f11438a;
            int c10 = c(richText) + i10;
            if (c10 > i2Var.f11440c) {
                i2Var.f11440c = c10;
            }
        }
    }
        ...
        if (pageBlock != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                    ...
                    i2Var.f11439b = pageblockblockquoteblocks.blocks.size() + i2Var.f11439b;
                    ...
                    i2Var.f11439b = pageblockdetails.blocks.size() + i2Var.f11439b;
                    ...
                    i2Var.f11439b = pageblocklist.items.size() + i2Var.f11439b;
                    ...
                    i2Var.f11439b = pageblockorderedlist.items.size() + i2Var.f11439b;
                    ...
                    if (arrayList3 != null) {
                        i2Var.f11439b = arrayList3.size() + i2Var.f11439b;
                    ...
                    if (str != null) {
                        i2Var.f11438a = str.length() + i2Var.f11438a;
                    }
                } else {
