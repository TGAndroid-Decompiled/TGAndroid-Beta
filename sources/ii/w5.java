    ...
    public final void onFocusChange(View view, boolean z10) {
        ...
        switch (this.f11705a) {
            case 0:
                ...
                return;
            case 1:
                EditTextBoldCursor editTextBoldCursor = ((pg.v) this.f11706b).f40971c;
            ...
            case 4:
                ...
                a0Var.f46850c0.c(z10, !TextUtils.isEmpty(a0Var.f46851d0.getText()));
                return;
            case 5:
                yh.e0 e0Var = (yh.e0) this.f11706b;
                e0Var.f47004f.c(z10, !TextUtils.isEmpty(e0Var.h.getText()));
                return;
            case 6:
                yh.i0 i0Var = (yh.i0) this.f11706b;
                i0Var.f47187b.c(z10, !TextUtils.isEmpty(i0Var.f47188c.getText()));
                return;
            default:
