...
public final class d2 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final CharSequence f11295a;
    public LinearLayout f11296a0;
    public final TL_iv.RichMessage f11297b;
    public zg f11298b0;
    public int f11299c;
    ...
    public w1 f11301d0;
    public boolean e;
    public LinearLayout f11302e0;
    public final String f11303f;
    public final ArrayList f11304f0;
    public ImageView f11305g0;
    public CharSequence h;
    public bc1 f11306h0;
    public LinearLayout f11307i0;
    public x1 f11308j0;
    public int f11309k0;
    public final ArrayList f11310l0;
    public LinearLayout m0;
    public CharSequence f11311n;
    public LinearLayout f11312n0;
    public LinearLayout f11313o0;
    public z1 f11314p0;
    public z1 f11315q0;
    public MessageObject f11316r;
    public z1 f11317r0;
    public hh.g f11318s;
    public z1 f11319s0;
    public z1 f11320t0;
    public z1 f11321u0;
    public mk v;
    public FrameLayout f11322v0;
    public final Rect f11323w;
    public aj0 f11324w0;
    public ch.d f11325x;
    public n70 f11326x0;
    public RectF f11327y;
    public y1 f11328y0;
    public m.q3 f11329z0;

    public d2(Editable editable) {
        super(null);
        this.f11299c = -1;
        this.d = -1;
        this.f11323w = new Rect();
        this.F = new int[2];
        this.I = 1.0f;
        this.N = new ArrayList();
        this.f11304f0 = new ArrayList();
        this.f11309k0 = Integer.MAX_VALUE;
        this.f11310l0 = new ArrayList();
        this.I0 = 0;
        this.K0 = -1;
        this.M0 = new j1(this, 0);
        this.f11295a = editable;
    }

    public static void U(d2 d2Var) {
        j3 j3Var = d2Var.P.f11721n3;
    ...
    public static boolean W(d2 d2Var, View view) {
        int i10;
        bo boVar = d2Var.J;
        if (boVar != null && d2Var.f11316r == null && !boVar.c() && d2Var.P.k3() && !d2Var.P.m3()) {
            if (!d2Var.P.M3()) {
                d2Var.B0();
                return false;
            }
            ...
            if (!Z2.isEmpty()) {
                ...
                long a2 = d2Var.J.a();
                MessageObject messageObject = d2Var.J.f32403n5;
                ...
                d2Var.f11328y0.setScaleX(1.0f);
                d2Var.f11328y0.setScaleY(1.0f);
                tg r10 = d2Var.O0.r(d2Var.f11328y0, true, new k1(d2Var, 10));
                if (r10 != null) {
                ...
                n70 H = n70.H(d2Var, d2Var.f11328y0);
    ...
    public static void Y(final d2 d2Var, Context context, View view) {
        ...
        J.j(z11, R.drawable.iv_h1, null, LocaleController.getString(R.string.ArticleHeading1), new Runnable(d2Var) {
            ...
            public final void run() {
                switch (r4) {
                    case 0:
                        this.f11527b.P.V4(Q2, new TL_iv.pageBlockHeading1());
                        I.u();
                        return;
                    case 1:
                        this.f11527b.P.V4(Q2, new TL_iv.pageBlockHeading2());
                        I.u();
                        return;
                    case 2:
                        this.f11527b.P.V4(Q2, new TL_iv.pageBlockHeading3());
                        I.u();
                        return;
                    case 3:
                        this.f11527b.P.V4(Q2, new TL_iv.pageBlockHeading4());
                        I.u();
                        return;
                    case 4:
                        this.f11527b.P.V4(Q2, new TL_iv.pageBlockHeading5());
                        I.u();
                        return;
                    default:
                        this.f11527b.P.V4(Q2, new TL_iv.pageBlockHeading6());
                        I.u();
                        return;
                }
            }
        });
        J.y().f18623a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18623a.setTextSize(1, SharedConfig.fontSize + 2);
        if (Q2 != null && (Q2.f11201b instanceof TL_iv.pageBlockHeading2)) {
            z12 = true;
        } else {
            z12 = false;
        }
        ...
        J.y().f18623a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18623a.setTextSize(1, SharedConfig.fontSize + 1);
        if (Q2 != null && (Q2.f11201b instanceof TL_iv.pageBlockHeading3)) {
            z13 = true;
        } else {
            z13 = false;
        }
        ...
        J.y().f18623a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18623a.setTextSize(1, SharedConfig.fontSize);
        if (Q2 != null && (Q2.f11201b instanceof TL_iv.pageBlockHeading4)) {
            z14 = true;
        } else {
            z14 = false;
        }
        ...
        J.y().f18623a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18623a.setTextSize(1, SharedConfig.fontSize - 1);
        if (Q2 != null && (Q2.f11201b instanceof TL_iv.pageBlockHeading5)) {
            z15 = true;
        } else {
            z15 = false;
        }
        ...
        J.y().f18623a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18623a.setTextSize(1, SharedConfig.fontSize - 2);
        if (Q2 != null && (Q2.f11201b instanceof TL_iv.pageBlockHeading6)) {
            z16 = true;
        } else {
            z16 = false;
        }
        ...
        J.y().f18623a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18623a.setTextSize(1, SharedConfig.fontSize - 3);
        ...
        I.y().f18623a.setTypeface(AndroidUtilities.bold());
    ...
    public static void Z(d2 d2Var, boolean z10, boolean z11) {
        ...
        if (d2Var.J0 != z10 || !z11) {
            ...
            if (z11) {
                d2Var.f11324w0.animate().scaleX(f7).scaleY(f7).setDuration(180L).setInterpolator(qr.h).start();
            } else {
                d2Var.f11324w0.animate().cancel();
                d2Var.f11324w0.setScaleX(f7);
                d2Var.f11324w0.setScaleY(f7);
            }
            aj0 aj0Var = d2Var.f11324w0;
            if (z10) {
                i10 = i6.f19074q7;
            } else {
                i10 = i6.G6;
            ...
            xi0 animatedDrawable = d2Var.f11324w0.getAnimatedDrawable();
            if (animatedDrawable != null) {
                if (z10) {
                    if (animatedDrawable.f29948b0 > 34) {
    ...
    public static void p0(Context context, final Runnable runnable, final Runnable runnable2, org.telegram.ui.ActionBar.e6 e6Var) {
        final org.telegram.ui.ActionBar.f3 i10 = wl.i(1, context, e6Var, false);
        ...
        ci.d g10 = wl.g(24, context, e6Var, true);
        ...
        ci.d g11 = wl.g(24, context, e6Var, false);
    ...
    public final void B0() {
        float f7;
        if (this.f11328y0 == null) {
            return;
        }
        boolean M3 = this.P.M3();
        this.f11328y0.setEnabled(M3);
        ViewPropertyAnimator animate = this.f11328y0.animate();
        if (M3) {
            f7 = 1.0f;
        } else {
            f7 = 0.5f;
    ...
    public final z1 c0(int i10, int i11, boolean z10) {
        int i12;
        z1 z1Var = new z1(this.f11302e0.getContext(), i10, getResourceProvider());
        if (z10) {
            z1Var.d();
            this.N.add(z1Var);
        }
        ...
        this.f11304f0.add(z1Var);
        LinearLayout linearLayout = this.f11302e0;
    ...
    public final View createView(Context context) {
        ...
        this.H0 = g2Var;
        this.O.f27179r.add(g2Var);
        w3 w3Var = new w3(context, this.currentAccount, getResourceProvider(), new a6.i(this, 27));
        this.P = w3Var;
        w3Var.setFileRefParentObject(this.f11316r);
        this.O.addView(this.P, w7.x5.e(-1, -1, 119));
        this.O.addView(this.P.getOverlayView(), w7.x5.c(-1.0f, -1));
        TL_iv.RichMessage richMessage = this.f11297b;
        if (richMessage != null) {
            w3 w3Var2 = this.P;
            ArrayList arrayList2 = w3Var2.f11718l3;
            w3Var2.f11716k3 = richMessage;
            w3.W2(arrayList2, richMessage.blocks, w3Var2.f11719m3);
            w3Var2.V3();
            ...
            if (str != null) {
                ...
                CharSequence charSequence2 = this.f11311n;
                HashMap hashMap = w3Var3.f11719m3;
                ArrayList arrayList3 = w3Var3.f11718l3;
                ...
                CharSequence charSequence3 = this.f11295a;
        ...
        this.f11296a0 = linearLayout2;
        linearLayout2.setClipToPadding(false);
        this.f11296a0.setClipChildren(false);
        this.f11296a0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        this.Z.addView(this.f11296a0, w7.x5.e(-1, 60, 87));
        FrameLayout frameLayout4 = new FrameLayout(context);
        this.X = frameLayout4;
        this.Z.addView(frameLayout4, w7.x5.d(-1, 100.0f, 87, 0.0f, 0.0f, 0.0f, 60.0f));
        ImageView imageView7 = new ImageView(context);
        this.f11300c0 = imageView7;
        imageView7.setImageDrawable(new org.telegram.ui.Components.i0(context));
        this.f11300c0.setScaleType(scaleType);
        this.f11300c0.setColorFilter(new PorterDuffColorFilter(getThemedColor(i16), mode));
        this.f11300c0.setBackground(new c2(i6.Z(getThemedColor(i14), i6.v(getThemedColor(i14), getThemedColor(i15)), AndroidUtilities.dp(22.0f), AndroidUtilities.dp(22.0f))));
        this.f11296a0.addView(this.f11300c0, w7.x5.p(44, 44, 0.0f, 19, 0, 0, 8, 0));
        w7.z5.a(this.f11300c0);
        this.f11300c0.setContentDescription(LocaleController.getString(R.string.AIEditor));
        this.f11300c0.setOnClickListener(new k1(this, 4));
        ...
        this.f11301d0.setOutlineProvider(new ai.k2(3));
        LinearLayout linearLayout3 = new LinearLayout(context);
        this.f11302e0 = linearLayout3;
        linearLayout3.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.f11302e0.setOrientation(0);
        this.f11301d0.addView(this.f11302e0);
        frameLayout6.addView(this.f11301d0, w7.x5.c(-1.0f, -1));
        ...
        this.f11298b0.setColorFilter(new PorterDuffColorFilter(getThemedColor(i16), mode));
        this.f11298b0.setBackground(i6.Z(getThemedColor(i14), getThemedColor(i15), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f)));
        this.f11298b0.j(xg.e, false);
        this.f11302e0.addView(this.f11298b0, w7.x5.q(38, 38, 16));
        w7.z5.a(this.f11298b0);
        this.f11298b0.setContentDescription(LocaleController.getString(R.string.AccDescrEmojiButton));
        this.f11298b0.setOnClickListener(new k1(this, 5));
        ...
        this.f11305g0 = imageView8;
        imageView8.setImageResource(R.drawable.outline_poll_attach_24);
        this.f11305g0.setScaleType(scaleType);
        this.f11305g0.setColorFilter(new PorterDuffColorFilter(getThemedColor(i16), mode));
        this.f11305g0.setBackground(i6.Z(getThemedColor(i14), getThemedColor(i15), AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f)));
        this.f11302e0.addView(this.f11305g0, w7.x5.t(38, 38, 16, 2, 0, 0, 0));
        w7.z5.a(this.f11305g0);
        this.f11305g0.setContentDescription(LocaleController.getString(R.string.AccDescrAttachButton));
        this.f11305g0.setOnClickListener(new k1(this, 9));
        this.f11296a0.addView(frameLayout5, w7.x5.l(1.0f, 0, 44));
        bc1 bc1Var = new bc1(this, context, 2);
        this.f11306h0 = bc1Var;
        bc1Var.setOrientation(0);
        this.f11306h0.setClipToPadding(false);
        this.f11306h0.setClipChildren(false);
        this.f11306h0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        this.Y.addView(this.f11306h0, w7.x5.e(-2, 60, 81));
        FrameLayout frameLayout7 = new FrameLayout(context);
        this.f11322v0 = frameLayout7;
        frameLayout7.setClipChildren(false);
        this.f11322v0.setClipToPadding(false);
        this.f11322v0.setPadding(AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f));
        this.Y.addView(this.f11322v0, w7.x5.e(80, 60, 81));
        ?? imageView9 = new ImageView(context);
        this.f11324w0 = imageView9;
        imageView9.f(R.raw.group_pip_delete_icon, AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f), null);
        xi0 animatedDrawable = this.f11324w0.getAnimatedDrawable();
        if (animatedDrawable != null) {
            animatedDrawable.h = true;
            animatedDrawable.K(0);
            animatedDrawable.P(0);
        }
        this.f11324w0.setScaleType(scaleType);
        this.f11324w0.setColorFilter(new PorterDuffColorFilter(getThemedColor(i16), mode));
        this.f11324w0.setBackground(new c2(i6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i14))));
        this.f11322v0.addView(this.f11324w0, w7.x5.e(-1, -1, 119));
        FrameLayout frameLayout8 = new FrameLayout(context);
        frameLayout8.setBackground(new c2(i6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i14))));
        this.f11306h0.addView(frameLayout8, w7.x5.c(44.0f, -2));
        x1 x1Var = new x1(this, context);
        this.f11308j0 = x1Var;
        x1Var.setHorizontalScrollBarEnabled(false);
        this.f11308j0.setClipToOutline(true);
        this.f11308j0.setOutlineProvider(new ai.k2(4));
        frameLayout8.addView(this.f11308j0, w7.x5.c(-1.0f, -1));
        LinearLayout linearLayout4 = new LinearLayout(context);
        this.f11307i0 = linearLayout4;
        linearLayout4.setOrientation(0);
        this.f11307i0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.f11308j0.addView(this.f11307i0, new FrameLayout.LayoutParams(-2, -1));
        ...
        this.f11321u0.setOnClickListener(new k1(this, 11));
        LinearLayout linearLayout5 = this.f11307i0;
        z1 z1Var2 = this.f11321u0;
        ...
        this.f11317r0 = z1Var3;
        z1Var3.setContentDescription(LocaleController.getString(R.string.RichEditorButton));
        this.f11317r0.setOnClickListener(new k1(this, 12));
        LinearLayout linearLayout6 = this.f11307i0;
        z1 z1Var4 = this.f11317r0;
        ...
        this.f11312n0 = linearLayout7;
        linearLayout7.setOrientation(0);
        this.f11312n0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.f11312n0.setBackground(new c2(i6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i14))));
        this.f11306h0.addView(this.f11312n0, w7.x5.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        z1 z1Var5 = new z1(context, R.drawable.media_link_24, getResourceProvider());
        this.f11315q0 = z1Var5;
        z1Var5.setContentDescription(LocaleController.getString(R.string.CreateLink));
        this.f11315q0.setOnClickListener(new k1(this, 13));
        this.f11312n0.addView(this.f11315q0, w7.x5.q(38, 38, 16));
        z1 z1Var6 = new z1(context, R.drawable.msg_calendar2, getResourceProvider());
        this.f11319s0 = z1Var6;
        z1Var6.setContentDescription(LocaleController.getString(R.string.AccDescrIVInsertDate));
        this.f11319s0.setOnClickListener(new k1(this, 14));
        this.f11312n0.addView(this.f11319s0, w7.x5.q(38, 38, 16));
        LinearLayout linearLayout8 = new LinearLayout(context);
        this.f11313o0 = linearLayout8;
        linearLayout8.setOrientation(0);
        this.f11313o0.setPadding(AndroidUtilities.dp(2.0f), 0, AndroidUtilities.dp(2.0f), 0);
        this.f11313o0.setBackground(new c2(i6.b0(AndroidUtilities.dp(22.0f), getThemedColor(i14))));
        this.f11306h0.addView(this.f11313o0, w7.x5.d(-2, 44.0f, 80, 8.0f, 0.0f, 0.0f, 0.0f));
        z1 z1Var7 = new z1(context, R.drawable.iv_math, getResourceProvider());
        this.f11320t0 = z1Var7;
        z1Var7.d();
        arrayList.add(this.f11320t0);
        this.f11320t0.setContentDescription(LocaleController.getString(R.string.AccDescrIVFormula));
        this.f11320t0.setOnClickListener(new k1(this, 15));
        this.f11313o0.addView(this.f11320t0, w7.x5.q(38, 38, 16));
        ...
        this.f11306h0.addView(this.m0, 0, w7.x5.d(-2, 44.0f, 80, 0.0f, 0.0f, 8.0f, 0.0f));
        z1 z1Var8 = new z1(context, 0, getResourceProvider());
        this.f11314p0 = z1Var8;
        z1Var8.setImageDrawable(new org.telegram.ui.Components.i0(context));
        this.f11314p0.setContentDescription(LocaleController.getString(R.string.AIEditor));
        this.f11314p0.setOnClickListener(new k1(this, 16));
        this.m0.addView(this.f11314p0, w7.x5.q(38, 38, 16));
        ...
        w7.z5.a(this.f11328y0);
        this.f11296a0.addView(this.f11328y0, w7.x5.p(44, 44, 0.0f, 5, 8, 0, 0, 0));
        this.f11328y0.setContentDescription(LocaleController.getString(R.string.Send));
        this.f11328y0.setOnClickListener(new k1(this, 0));
        this.f11328y0.setOnLongClickListener(new ci.n5(this, 3));
        C0();
    ...
    public final void d0(Context context, int i10, int i11, boolean z10) {
        ...
        this.f11310l0.add(z1Var);
        LinearLayout linearLayout = this.f11307i0;
        if (linearLayout.getChildCount() > 0) {
            i12 = 2;
        } else {
            i12 = 0;
    ...
    public final boolean isSwipeBackEnabled(MotionEvent motionEvent) {
        w3 w3Var = this.P;
        if (w3Var != null && w3Var.f11721n3.y()) {
            return false;
        }
    ...
    public final boolean l0() {
        bo boVar;
        if (this.f11316r == null && (boVar = this.J) != null && boVar.c()) {
            return true;
        }
        return false;
    }
    ...
    public final boolean m0() {
        if (!MessagesController.getInstance(this.currentAccount).richEditorAllowed() && !UserConfig.getInstance(this.currentAccount).isPremium()) {
            w3 w3Var = this.P;
            if (c5.f(w3Var.f11718l3, w3Var.f11719m3)) {
                return true;
            }
            return false;
        }
    ...
    public final void n0() {
        ...
        if (h22 != null) {
            ...
            e0Var.n0(a2);
            e0Var.f23464k0 = new ai.y1(h22, 25);
            e0Var.show();
        }
    }
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z10, Runnable runnable) {
        ...
        if (!AndroidUtilities.isTablet() && this.f11318s != null && this.v != null) {
            AnimatorSet animatorSet = new AnimatorSet();
            hh.g gVar = this.f11318s;
            this.f11325x = gVar.f10522f;
            gVar.e = false;
            gVar.invalidate();
            this.v.setAlpha(0.0f);
            this.v.f21874z1.setVisibility(4);
            v0();
            float f10 = 1.0f;
            if (z10) {
                f7 = 0.0f;
    ...
    public final r0.l1 onInsetsInternal(View view, r0.l1 l1Var) {
        ...
        if (!this.G0 && z11 && (n70Var = this.f11326x0) != null) {
            n70Var.u();
            this.f11326x0 = null;
        }
        onInsets(f7.f10588a, f7.f10589b, f7.f10590c, f7.d);
    ...
    public final void onTransitionAnimationStart(boolean z10, boolean z11) {
        ...
        if (z10 && !z11 && (i10 = this.f11299c) >= 0 && (w3Var2 = this.P) != null) {
            int i11 = this.d;
            this.d = -1;
            this.f11299c = -1;
            ...
            if ((this.f11297b != null || this.f11303f != null) && (w3Var = this.P) != null && !w3Var.a3()) {
    ...
    public final boolean q0() {
        ...
        Runnable runnable;
        if (this.J == null || this.f11316r != null || !this.P.r2()) {
            return false;
        }
        if (this.M) {
            j22 = null;
        ...
        if (j22 != null && !this.M) {
            w3 w3Var = this.P;
            if (w3Var.k3() && !c5.f(w3Var.f11718l3, w3Var.f11719m3) && mkVar != null) {
                SpannableStringBuilder k10 = c5.k(this.P.f11718l3);
                bo boVar = mkVar.O2;
                if (mkVar.E0 == null) {
                    return true;
                }
                ...
                if (boVar != null) {
                    ...
                    MediaDataController.getInstance(mkVar.Q).saveDraft(boVar.a(), boVar.B7(boVar.f32403n5), charSequenceArr[0], MediaDataController.getInstance(mkVar.Q).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.J.a();
        bo boVar2 = this.J;
        mediaDataController.saveDraft(a2, boVar2.B7(boVar2.f32403n5), "", null, null, null, null, 0L, false, false, j22);
        ...
        if (m0()) {
            ...
            if (!this.P.M3()) {
                ...
                if (mkVar != null) {
                    ...
                    mkVar.R0(c5.k(this.P.f11718l3), z10, i10, i11);
                    finishFragment();
                }
            } else {
                this.M = true;
    ...
    public final void t0(boolean z10) {
        ArrayList arrayList = this.f11310l0;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
            Object obj = arrayList.get(i10);
    ...
    public final void u0(boolean z10, boolean z11) {
        z1 z1Var = this.f11315q0;
        if (z1Var != null) {
            z1Var.setEnabled(z10);
        }
        z1 z1Var2 = this.f11317r0;
        if (z1Var2 != null) {
            z1Var2.setEnabled(z11);
        }
        z1 z1Var3 = this.f11319s0;
        if (z1Var3 != null) {
            z1Var3.setEnabled(z10);
        }
        z1 z1Var4 = this.f11320t0;
        if (z1Var4 != null) {
    ...
    public final void v0() {
        ...
        if (this.f11327y == null) {
            this.f11327y = new RectF();
        }
        RectF rectF = new RectF(this.f11325x.getBounds());
        this.f11327y = rectF;
    ...
    public final void x0(int i10, boolean z10) {
        ...
        if (z10) {
            ...
            ViewPropertyAnimator animate = this.f11296a0.animate();
            if (this.K0 == 0) {
                f16 = 1.0f;
            } else {
                f16 = 0.0f;
            ...
            this.f11306h0.setVisibility(0);
            ViewPropertyAnimator animate2 = this.f11306h0.animate();
            if (this.K0 == 1) {
                f19 = 1.0f;
            } else {
                f19 = 0.0f;
            ...
            this.f11322v0.setVisibility(0);
            ViewPropertyAnimator animate3 = this.f11322v0.animate();
            if (this.K0 == 2) {
                f23 = 1.0f;
            }
        ...
        LinearLayout linearLayout = this.f11296a0;
        if (i10 == 0) {
            i11 = 0;
        } else {
            i11 = 8;
        ...
        LinearLayout linearLayout2 = this.f11296a0;
        if (i10 == 0) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
        ...
        LinearLayout linearLayout3 = this.f11296a0;
        if (i10 == 0) {
            f10 = 1.0f;
        } else {
            f10 = 0.8f;
        ...
        LinearLayout linearLayout4 = this.f11296a0;
        if (i10 == 0) {
            f11 = 1.0f;
        } else {
            f11 = 0.8f;
        ...
        LinearLayout linearLayout5 = this.f11296a0;
        if (i10 == 0) {
            dp = 0.0f;
        } else {
        ...
        bc1 bc1Var2 = this.f11306h0;
        if (i10 == 1) {
            f12 = 1.0f;
        } else {
            f12 = 0.0f;
        }
        bc1Var2.setAlpha(f12);
        bc1 bc1Var3 = this.f11306h0;
        if (i10 == 1) {
            f13 = 1.0f;
        } else {
            f13 = 0.8f;
        }
        bc1Var3.setScaleX(f13);
        bc1 bc1Var4 = this.f11306h0;
        if (i10 == 1) {
            f14 = 1.0f;
        } else {
            f14 = 0.8f;
        }
        bc1Var4.setScaleY(f14);
        bc1 bc1Var5 = this.f11306h0;
        if (i10 == 1) {
            dp2 = 0.0f;
        } else {
            dp2 = AndroidUtilities.dp(30.0f);
        }
        bc1Var5.setTranslationY(dp2);
        FrameLayout frameLayout = this.f11322v0;
        if (i10 != 2) {
            i13 = 8;
        }
        frameLayout.setVisibility(i13);
        FrameLayout frameLayout2 = this.f11322v0;
        if (i10 == 2) {
            f23 = 1.0f;
        }
        frameLayout2.setAlpha(f23);
        FrameLayout frameLayout3 = this.f11322v0;
        if (i10 == 2) {
            f15 = 1.0f;
        } else {
            f15 = 0.8f;
        ...
        FrameLayout frameLayout4 = this.f11322v0;
        if (i10 == 2) {
            f24 = 1.0f;
        }
    ...
    public final void y0() {
        ...
        if (!arrayList.isEmpty() && textSelectionHelper != null && textSelectionHelper.y()) {
            ...
            if (this.P.L3()) {
                ...
                int i10 = textSelectionHelper2.f20618u0;
                int i11 = textSelectionHelper2.f20619v0;
                int i12 = textSelectionHelper2.f20622y0;
                int i13 = textSelectionHelper2.f20620w0;
                int i14 = textSelectionHelper2.f20623z0;
                int size = arrayList.size();
                int i15 = 0;
                while (i15 < size) {
                ...
                i1 s22 = this.P.s2(textSelectionHelper3.f20618u0);
                int i16 = textSelectionHelper3.f20620w0;
                int i17 = textSelectionHelper3.f20623z0;
                if (s22 == null) {
                    max = 0;
                } else {
                ...
                int i19 = textSelectionHelper.f20618u0;
                int i20 = textSelectionHelper.f20621x0;
                int i21 = textSelectionHelper.f20620w0;
                int i22 = textSelectionHelper.f20623z0;
                if (i19 >= 0 && i20 >= 0 && i20 >= i19 && i20 < this.P.f11726p4.size()) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void z0() {
        ...
        h2 h2Var = this.P.J3;
        if (h2Var != null && !h2Var.f11406c.isEmpty()) {
            z10 = true;
        } else {
            z10 = false;
        }
