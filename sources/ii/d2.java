...
public final class d2 extends org.telegram.ui.ActionBar.o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static boolean W(d2 d2Var, View view) {
        ...
        if (boVar != null && d2Var.f11319r == null && !boVar.c() && d2Var.P.l3() && !d2Var.P.n3()) {
            ...
            if (!a32.isEmpty()) {
                ...
                long a2 = d2Var.J.a();
                MessageObject messageObject = d2Var.J.f32381n5;
    ...
    public static void Y(final d2 d2Var, Context context, View view) {
        ...
        J.y().f18652a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18652a.setTextSize(1, SharedConfig.fontSize + 2);
        ...
        J.y().f18652a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18652a.setTextSize(1, SharedConfig.fontSize + 1);
        ...
        J.y().f18652a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18652a.setTextSize(1, SharedConfig.fontSize);
        ...
        J.y().f18652a.setTypeface(AndroidUtilities.getTypeface("fonts/mw_bold.ttf"));
        J.y().f18652a.setTextSize(1, SharedConfig.fontSize - 3);
        ...
        I.y().f18652a.setTypeface(AndroidUtilities.bold());
    ...
    public final void o0(int i10, int i11) {
        ...
        viVar.f28754j0.setIncludeVideosInGallery(true);
        viVar.f28754j0.f0();
        viVar.J1(1, true);
        viVar.h1(i10);
        viVar.f28787t2 = new r1(this, viVar);
    ...
    public final AnimatorSet onCustomTransitionAnimation(boolean z10, Runnable runnable) {
        ...
        if (!AndroidUtilities.isTablet() && this.f11321s != null && this.v != null) {
            ...
            this.v.f21884z1.setVisibility(4);
            v0();
            float f10 = 1.0f;
            if (z10) {
                f7 = 0.0f;
    ...
    public final boolean q0() {
        ...
        if (k22 != null && !this.M) {
            ...
            if (w3Var.l3() && !c5.f(w3Var.f11721l3, w3Var.f11722m3) && nkVar != null) {
                ...
                if (boVar != null) {
                    ...
                    MediaDataController.getInstance(nkVar.Q).saveDraft(boVar.a(), boVar.B7(boVar.f32381n5), charSequenceArr[0], MediaDataController.getInstance(nkVar.Q).getEntities(charSequenceArr, true, false), null, null, null, 0L, false, false, null);
                }
        ...
        long a2 = this.J.a();
        bo boVar2 = this.J;
        mediaDataController.saveDraft(a2, boVar2.B7(boVar2.f32381n5), "", null, null, null, null, 0L, false, false, k22);
        ...
        if (m0()) {
            ...
            if (!this.P.N3()) {
                ...
                if (nkVar != null) {
                    ...
                    nkVar.R0(c5.k(this.P.f11721l3), z10, i10, i11);
                    finishFragment();
                }
            } else {
                this.M = true;
                ...
                bo boVar = this.J;
                final MessageObject messageObject = boVar.f32381n5;
    ...
    public final void y0() {
        ...
        if (!arrayList.isEmpty() && textSelectionHelper != null && textSelectionHelper.y()) {
            ...
            if (this.P.M3()) {
                ...
                int i10 = textSelectionHelper2.f20628u0;
                int i11 = textSelectionHelper2.f20629v0;
                int i12 = textSelectionHelper2.f20632y0;
                int i13 = textSelectionHelper2.f20630w0;
                int i14 = textSelectionHelper2.f20633z0;
                int size = arrayList.size();
                int i15 = 0;
                while (i15 < size) {
                ...
                i1 t22 = this.P.t2(textSelectionHelper3.f20628u0);
                int i16 = textSelectionHelper3.f20630w0;
                int i17 = textSelectionHelper3.f20633z0;
                if (t22 == null) {
                    max = 0;
                } else {
                ...
                int i19 = textSelectionHelper.f20628u0;
                int i20 = textSelectionHelper.f20631x0;
                int i21 = textSelectionHelper.f20630w0;
                int i22 = textSelectionHelper.f20633z0;
