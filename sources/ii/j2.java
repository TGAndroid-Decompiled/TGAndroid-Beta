...
public final class j2 {
    ...
    public static void a(TL_iv.RichText richText, int i10, j2 j2Var) {
        if (richText != null) {
            j2Var.f11450a = g6.l(richText).length() + j2Var.f11450a;
            int c10 = c(richText) + i10;
            if (c10 > j2Var.f11452c) {
                j2Var.f11452c = c10;
            }
        }
    }
        ...
        if (pageBlock != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
                ...
                if (pageBlock instanceof TL_iv.pageBlockBlockquoteBlocks) {
                    ...
                    j2Var.f11451b = pageblockblockquoteblocks.blocks.size() + j2Var.f11451b;
                    ...
                    j2Var.f11451b = pageblockdetails.blocks.size() + j2Var.f11451b;
                    ...
                    j2Var.f11451b = pageblocklist.items.size() + j2Var.f11451b;
                    ...
                    j2Var.f11451b = pageblockorderedlist.items.size() + j2Var.f11451b;
                    ...
                    if (arrayList3 != null) {
                        j2Var.f11451b = arrayList3.size() + j2Var.f11451b;
                    ...
                    if (str != null) {
                        j2Var.f11450a = str.length() + j2Var.f11450a;
                    }
                } else {
