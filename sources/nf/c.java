            ...
            default:
                ...
                if (webPage3 instanceof TLRPC.TL_webPage) {
                    ...
                    if (tL_webPage.cached_page != null) {
                        if (!h4Var.f34157d0.isEmpty() && h4Var.f34157d0.get(0) == webPage2) {
                            ...
                            if (z11) {
                                h4Var.f34157d0.add(tL_webPage);
                            } else {
                                h4Var.f34157d0.set(0, tL_webPage);
                            }
                        ...
                        if (i13 != i14) {
                            ...
                            while (true) {
                                ...
                                if (i10 < l3VarArr.length) {
                                    f4 f4Var = l3VarArr[i10].f35436c;
                                    if (f4Var.E == webPage2 && (L = h4Var.f34173u0[i10].f35435b.L(f4Var.h() - 1)) != null) {
                                        h4Var.f34173u0[i10].f35436c.y(L);
                                    }
                                    i10++;
