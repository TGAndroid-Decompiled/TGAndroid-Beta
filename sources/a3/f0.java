...
public final class f0 {
    ...
    public final void a(long j3, long j10) {
        ...
        while (true) {
            ...
            if (i10 != 0) {
                long j12 = ((long[]) qVar.e)[qVar.f7917a];
                ...
                if (a2 != 0 && a2 != 1) {
                    ...
                    if (x1Var != null && !x1Var.equals(x1.d) && !x1Var.equals(this.f107j)) {
                        this.f107j = x1Var;
                        b2.r rVar = new b2.r();
                        rVar.f3254x = x1Var.f3347a;
                        rVar.f3255y = x1Var.f3348b;
                        rVar.f3248q = r0.n("video/raw");
                        yVar.f14994b = new b2.s(rVar);
                    ...
                    b2.s sVar2 = (b2.s) yVar.f14994b;
                    if (sVar2 == null) {
                        sVar = new b2.s(new b2.r());
                    } else {
                        sVar = sVar2;
                    }
                    fVar.f100i.b(d, j14, sVar, null);
