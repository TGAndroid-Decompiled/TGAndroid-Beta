...
public abstract class a extends i2.f {
    ...
    public final void G() {
        ...
        if (this.P == null) {
            ...
            try {
                ...
                Handler handler2 = (Handler) bVar.f15511b;
                if (handler2 != null) {
    ...
    public final void J(VideoDecoderOutputBuffer videoDecoderOutputBuffer, long j3, b2.s sVar) {
        ...
        if (videoDecoderOutputBuffer.mode == 1 && this.U != null) {
            ...
            x1 x1Var = this.f51g0;
            of.b bVar = this.K;
            if (x1Var == null || x1Var.f3347a != i10 || x1Var.f3348b != i11) {
    ...
    public final void M(int i10, int i11) {
        ...
        this.f54j0 = i14;
        gVar.f10708i = Math.max(i14, gVar.f10708i);
        int i15 = this.J;
