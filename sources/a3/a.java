...
public abstract class a extends i2.f {
    ...
    public final void G() {
        ...
        if (this.P == null) {
            ...
            try {
                ...
                Handler handler2 = (Handler) bVar.f15682b;
                if (handler2 != null) {
    ...
    public final void J(VideoDecoderOutputBuffer videoDecoderOutputBuffer, long j3, b2.s sVar) {
        ...
        if (videoDecoderOutputBuffer.mode == 1 && this.U != null) {
            ...
            x1 x1Var = this.f53g0;
            of.b bVar = this.K;
            if (x1Var == null || x1Var.f3352a != i10 || x1Var.f3353b != i11) {
    ...
    public final void M(int i10, int i11) {
        ...
        this.f56j0 = i14;
        gVar.f10712i = Math.max(i14, gVar.f10712i);
        int i15 = this.J;
