...
public final class o extends HandlerThread implements Handler.Callback {
    ...
    public final void a(int i10) {
        ...
        EGLContext eglCreateContext = EGL14.eglCreateContext(jVar.f7909c, eGLConfig, EGL14.EGL_NO_CONTEXT, i10 == 0 ? new int[]{12440, 2, 12344} : new int[]{12440, 2, 12992, 1, 12344}, 0);
        ...
        EGLDisplay eGLDisplay = jVar.f7909c;
        if (i10 == 1) {
        ...
        jVar.f7910f = surfaceTexture;
        surfaceTexture.setOnFrameAvailableListener(jVar);
        SurfaceTexture surfaceTexture2 = this.f174a.f7910f;
    ...
    public final void b() {
        this.f174a.getClass();
        e2.j jVar = this.f174a;
        jVar.f7907a.removeCallbacks(jVar);
        try {
            SurfaceTexture surfaceTexture = jVar.f7910f;
            if (surfaceTexture != null) {
                surfaceTexture.release();
                GLES20.glDeleteTextures(1, jVar.f7908b, 0);
            }
        } finally {
            EGLDisplay eGLDisplay = jVar.f7909c;
            if (eGLDisplay != null && !eGLDisplay.equals(EGL14.EGL_NO_DISPLAY)) {
                EGLDisplay eGLDisplay2 = jVar.f7909c;
                EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                EGL14.eglMakeCurrent(eGLDisplay2, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            }
            EGLSurface eGLSurface2 = jVar.e;
            if (eGLSurface2 != null && !eGLSurface2.equals(EGL14.EGL_NO_SURFACE)) {
                EGL14.eglDestroySurface(jVar.f7909c, jVar.e);
            }
            EGLContext eGLContext = jVar.d;
            if (eGLContext != null) {
                EGL14.eglDestroyContext(jVar.f7909c, eGLContext);
            }
            EGL14.eglReleaseThread();
            EGLDisplay eGLDisplay3 = jVar.f7909c;
            if (eGLDisplay3 != null && !eGLDisplay3.equals(EGL14.EGL_NO_DISPLAY)) {
                EGL14.eglTerminate(jVar.f7909c);
            }
            jVar.f7909c = null;
            jVar.d = null;
            jVar.e = null;
