...
public final class o extends HandlerThread implements Handler.Callback {
    ...
    public final void a(int i10) {
        ...
        EGLContext eglCreateContext = EGL14.eglCreateContext(jVar.f7892c, eGLConfig, EGL14.EGL_NO_CONTEXT, i10 == 0 ? new int[]{12440, 2, 12344} : new int[]{12440, 2, 12992, 1, 12344}, 0);
        ...
        EGLDisplay eGLDisplay = jVar.f7892c;
        if (i10 == 1) {
        ...
        jVar.f7893f = surfaceTexture;
        surfaceTexture.setOnFrameAvailableListener(jVar);
        SurfaceTexture surfaceTexture2 = this.f174a.f7893f;
    ...
    public final void b() {
        this.f174a.getClass();
        e2.j jVar = this.f174a;
        jVar.f7890a.removeCallbacks(jVar);
        try {
            SurfaceTexture surfaceTexture = jVar.f7893f;
            if (surfaceTexture != null) {
                surfaceTexture.release();
                GLES20.glDeleteTextures(1, jVar.f7891b, 0);
            }
        } finally {
            EGLDisplay eGLDisplay = jVar.f7892c;
            if (eGLDisplay != null && !eGLDisplay.equals(EGL14.EGL_NO_DISPLAY)) {
                EGLDisplay eGLDisplay2 = jVar.f7892c;
                EGLSurface eGLSurface = EGL14.EGL_NO_SURFACE;
                EGL14.eglMakeCurrent(eGLDisplay2, eGLSurface, eGLSurface, EGL14.EGL_NO_CONTEXT);
            }
            EGLSurface eGLSurface2 = jVar.e;
            if (eGLSurface2 != null && !eGLSurface2.equals(EGL14.EGL_NO_SURFACE)) {
                EGL14.eglDestroySurface(jVar.f7892c, jVar.e);
            }
            EGLContext eGLContext = jVar.d;
            if (eGLContext != null) {
                EGL14.eglDestroyContext(jVar.f7892c, eGLContext);
            }
            EGL14.eglReleaseThread();
            EGLDisplay eGLDisplay3 = jVar.f7892c;
            if (eGLDisplay3 != null && !eGLDisplay3.equals(EGL14.EGL_NO_DISPLAY)) {
                EGL14.eglTerminate(jVar.f7892c);
            }
            jVar.f7892c = null;
            jVar.d = null;
            jVar.e = null;
