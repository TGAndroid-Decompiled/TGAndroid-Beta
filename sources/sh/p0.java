...
public final class p0 extends Drawable implements s6 {
    public final Paint f47574a;
    public final Paint f47575b;
    public final Paint f47576c;
    public final ImageReceiver d;
    public final ImageReceiver f47577e;
    public final Drawable f47578f;

    public p0(Context context, TLRPC.User user, TLRPC.User user2) {
        Paint paint = new Paint(1);
        this.f47574a = paint;
        this.f47575b = new Paint(1);
        Paint paint2 = new Paint(1);
        this.f47576c = paint2;
        ImageReceiver imageReceiver = new ImageReceiver();
        this.d = imageReceiver;
        ImageReceiver imageReceiver2 = new ImageReceiver();
        this.f47577e = imageReceiver2;
        new RectF();
        paint.setColor(-1);
    ...
    public final void a(lj0 lj0Var) {
        this.f47577e.setParentView(lj0Var);
    ...
    public final void b(ImageReceiver imageReceiver) {
        ...
        this.f47577e.onDetachedFromWindow();
    }

    @Override
    public final void c(ImageReceiver imageReceiver) {
        this.d.onAttachedToWindow();
        this.f47577e.onAttachedToWindow();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, dp2, AndroidUtilities.dp(12.0f), this.f47576c);
        int dp3 = (int) (dp2 + AndroidUtilities.dp(9.0f));
        Drawable drawable = this.f47578f;
        ...
        ImageReceiver imageReceiver2 = this.f47577e;
