...
public final class y extends rl0 {
    public ArrayList f47820c;
    public ArrayList d;
    public ArrayList f47821e;
    ...
    public final void E(a0.h hVar) {
        ArrayList arrayList = this.f47820c;
        arrayList.clear();
        ArrayList arrayList2 = this.d;
        arrayList2.clear();
        ArrayList arrayList3 = this.f47821e;
        arrayList3.clear();
    ...
    @Override
    public final int h() {
        return this.f47820c.size();
    }

    @Override
    public final void v(f2.m1 m1Var, int i10) {
        x xVar = (x) m1Var.f5875a;
        String str = (String) this.f47820c.get(i10);
        if (((Boolean) this.f47821e.get(i10)).booleanValue()) {
            ...
            xVar.f47805a.setText(spannableStringBuilder);
        } else {
            xVar.f47805a.setText(str);
        }
        xVar.f47806b.setText((CharSequence) this.d.get(i10));
        xVar.f47807c = str;
    }
