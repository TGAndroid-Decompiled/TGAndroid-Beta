...
public final class c0 extends f0 {
    ...
    public c0(i0 i0Var, Context context) {
        ...
        this.f44337c.addView(i0Var.D, b6.g());
        this.f44337c.addView(this.d, 0, b6.c(-1.0f, -1));
        this.f44337c.addView(i0Var.F, b6.g());
        ...
        org.telegram.ui.ActionBar.k kVar2 = this.f44335a;
        boolean z4 = i0Var.K;
        if (z4) {
        ...
        this.f44335a.setTitle(LocaleController.getString(R.string.CommunityAddAChatToCommunity));
        this.f44335a.getTitleTextView().setTranslationX(-AndroidUtilities.dp(18.0f));
        this.f44335a.setActionBarMenuOnItemClick(new e(this, 3));
        this.f44337c.addView(this.f44335a, b6.e(-1, 56, 48));
        this.f44337c.addView(i0Var.B, b6.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        i0Var.f44355r = dVar;
        dVar.e();
        i0Var.f44355r.setText(LocaleController.getString(R.string.OK));
        i0Var.f44355r.setOnClickListener(new oh.n(this, 17));
        if (z4) {
            i0Var.f44355r.setVisibility(8);
        }
        this.f44337c.addView(i0Var.f44355r, b6.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }

    @Override
    public final float b() {
        return lf.l0.b(this.h.f44352c.e) * super.b();
    }
