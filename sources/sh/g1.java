...
public final class g1 extends FrameLayout {
    ...
    public final RadioButton f47440b;
    public final boolean f47441c;

    public g1(h1 h1Var, boolean z4, Context context) {
        super(context);
        this.f47439a = h1Var.f47451a;
        RadioButton radioButton = new RadioButton(context);
        this.f47440b = radioButton;
        ...
        b10.setText(h1Var.f47453c);
        addView(b10, c6.t(-1, -2, 7, 62, 9, 8, 0));
        TextView b11 = g6.b(context, 14.0f, k6.f22036y6, false, null);
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f47441c) {
            canvas.drawLine(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, k6.f21779k0);
        }
    }
}
