...
public final class e2 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        m2 m2Var = p2Var.T;
        g2 g2Var = p2Var.v;
        p2Var.f47589e0 = false;
        boolean z4 = this.f47402a;
        if (!z4) {
            p2Var.D();
            p2Var.G();
            float f11 = this.f47403b;
        ...
        g2Var.setTranslationX(AndroidUtilities.lerp(this.f47404c, 0.0f, p2Var.f47587d0));
        p2Var.f47594i0.setTranslationX(0.0f);
