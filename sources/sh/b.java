...
public final class b implements RequestDelegate {
    ...
    public final j f47362b;
    public final org.telegram.ui.ActionBar.d2 f47363c;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f47361a) {
            case 0:
                final j jVar = this.f47362b;
                final org.telegram.ui.ActionBar.d2 d2Var = this.f47363c;
                ...
                return;
            default:
                final j jVar2 = this.f47362b;
                final org.telegram.ui.ActionBar.d2 d2Var2 = this.f47363c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
