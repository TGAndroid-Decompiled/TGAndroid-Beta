...
public final class b extends Drawable implements DownloadController.FileDownloadProgressListener {
    ...
    public int K;
    public int L;
    public final o6 f43263a;
    public final m9 f43264b;
    public final ImageReceiver f43265c;
    public final u1 d;
    public final int e;
    public boolean f43266f;
    public boolean h;
    public boolean f43267n;
    public boolean f43268r;
    public Drawable f43269s;
    public boolean v;
    public final Paint f43270w;
    public final Paint f43271x;
    public final le.c f43272y;

    public b(int i10, u1 u1Var) {
        Paint paint = new Paint(1);
        this.f43270w = paint;
        this.f43271x = new Paint(1);
        this.G = new a5.a((char) 0, 14);
        this.e = i10;
        this.d = u1Var;
        this.f43272y = new le.c(u1Var, sr.h, 380L);
        o6 o6Var = new o6(false, false, false, false);
        this.f43263a = o6Var;
        o6Var.f26962b = 21;
        o6Var.t(AndroidUtilities.dp(11.0f));
        o6Var.setCallback(u1Var);
        this.f43264b = new m9(i10, u1Var, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(8.33f), AndroidUtilities.dpf2(1.0f));
        ImageReceiver imageReceiver = new ImageReceiver(u1Var);
        this.f43265c = imageReceiver;
    ...
    public final void a(TLRPC.Photo photo, Object obj) {
        ...
        this.f43265c.setImage(forObject, "36_36", forObject2, "36_36_b", null, j3, null, obj, 1);
    }
    ...
    public final void c(Canvas canvas) {
        ...
        if (this.f43272y.e > 0.0f) {
            j jVar = this.f43264b.f26338c.d;
        ...
        if (this.h) {
            ...
            this.f43265c.setImageCoords(rect);
            if (!this.f43267n || this.f43268r) {
                this.f43265c.draw(canvas);
            }
            if (this.v || this.f43267n) {
                if (this.f43267n && !this.f43268r) {
                    Paint paint = this.f43271x;
                    ...
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), this.f43271x);
                } else {
                    canvas.drawRoundRect(rectF, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), this.f43270w);
                }
            }
            if (this.f43267n) {
                if (this.f43269s == null) {
                    this.f43269s = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.media_link_24).mutate();
                }
                Drawable drawable = this.f43269s;
                a5.a aVar = this.G;
                if (this.f43268r) {
                    w02 = -1;
                } else {
                ...
                p.e(this.f43269s, rectF.centerX(), rectF.centerY(), AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), 17);
                this.f43269s.draw(canvas);
            }
            b(true);
            if (this.J) {
                this.E.draw(canvas);
    ...
    public final float d(float f7) {
        m9 m9Var = this.f43264b;
        float d = this.f43263a.d() + m9Var.f26338c.d.f14217f.f14224a;
        float dp = m9Var.f26338c.d.f14216c.f14224a * AndroidUtilities.dp(4.0f);
        float f10 = this.f43272y.e;
