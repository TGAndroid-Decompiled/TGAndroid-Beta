...
public final class a3 extends FrameLayout {
    ...
    public final g6 f47390b;
    public final p9 f47391c;
    public final View d;
    public final View f47392e;
    public final ImageView f47393f;
    public final TextView h;
    public final TextView f47394n;
    public final ImageView f47395r;
    ...
    public a3(Context context, int i10, g6 g6Var) {
        ...
        this.d = view;
        view.setBackground(k6.K(AndroidUtilities.dp(11.0f), k6.v0(k6.f21661d6, g6Var)));
        ...
        i11.setTextColor(k6.v0(k6.f22055z6, g6Var));
        linearLayout.addView(i11, c6.t(-1, -2, 55, 6, 1, 24, 0));
        ImageView imageView2 = new ImageView(context);
        this.f47395r = imageView2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f47396s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), k6.f21781k0);
        }
    }
