...
public final class x0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final NotificationCenter.NotificationCenterDelegate[] f47773b;
    ...
    public x0(long j10, NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr, int i10, w0 w0Var) {
        this.f47772a = j10;
        this.f47773b = notificationCenterDelegateArr;
        this.f47774c = i10;
        this.d = w0Var;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12 && (hVar = (a0.h) objArr[0]) != null) {
            long j10 = this.f47772a;
            if (hVar.d(j10)) {
                TLRPC.WebPage webPage = (TLRPC.WebPage) hVar.f(j10);
                NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = this.f47773b;
                if (notificationCenterDelegateArr[0] != null) {
                    NotificationCenter.getInstance(this.f47774c).addObserver(notificationCenterDelegateArr[0], i12);
