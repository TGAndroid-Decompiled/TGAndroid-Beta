...
public abstract class f0 extends FrameLayout {
    public org.telegram.ui.ActionBar.k f44400a;
    public final wg.f f44401b;
    public final FrameLayout f44402c;
    public g61 d;
    public boolean e;
    public final i0 f44403f;

    public f0(i0 i0Var, Context context) {
        super(context);
        this.f44403f = i0Var;
        FrameLayout frameLayout = new FrameLayout(context);
        this.f44402c = frameLayout;
        frameLayout.setPadding(0, 0, 0, 0);
        frameLayout.setClipToPadding(true);
        addView(frameLayout, b6.e(-1, -1, 119));
        ?? view = new View(getContext());
        this.f44401b = view;
        view.setupColorKey(j6.f19827a7);
        ...
        view.f46633a.b(-AndroidUtilities.dp(20.0f), false);
    ...
    public float b() {
        ...
        for (int i10 = 0; i10 < this.d.getChildCount(); i10++) {
            ...
            if (T != null) {
                ...
                if (G != null && G.d != 99) {
                    f10 = Math.min(childAt.getY() + this.f44402c.getPaddingTop(), f10);
                }
            }
        }
        return f10;
    ...
    public void c() {
        float b10 = b();
        org.telegram.ui.ActionBar.k kVar = this.f44400a;
        if (kVar != null) {
