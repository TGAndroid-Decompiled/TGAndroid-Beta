...
public final class p2 extends Dialog implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.u3 {
    ...
    public boolean Z;
    public int f47617a;
    public boolean f47618a0;
    public float f47619b;
    public boolean f47620b0;
    public o1.j f47621c;
    public float f47622c0;
    public Boolean d;
    public float f47623d0;
    public final o2 f47624e;
    public boolean f47625e0;
    public final Rect f47626f;
    public int f47627f0;
    public int f47628g0;
    public final Rect h;
    public Activity f47629h0;
    public final l2 f47630i0;
    public final BotFullscreenButtons f47631j0;
    public ic f47632k0;
    public f0 f47633l0;
    public final FrameLayout m0;
    public int f47634n;
    public final FrameLayout.LayoutParams f47635n0;
    public boolean f47636o0;
    public final xd0 f47637p0;
    public final q1 f47638q0;
    public final org.telegram.ui.ActionBar.o3 f47639r;
    public int f47640r0;
    public final c5.j f47641s;
    public y3 f47642s0;
    public boolean f47643t0;
    public boolean f47644u0;
    public final g2 v;
    public boolean f47645v0;
    public final FrameLayout.LayoutParams f47646w;
    public Boolean f47647w0;
    public final h2 f47648x;
    public boolean f47649x0;
    public final n2 f47650y;
    public u0 f47651y0;
    public boolean f47652z0;
    ...
    public p2(Context context, g6 g6Var) {
        ...
        this.S0 = false;
        this.B = g6Var;
        this.f47617a = k6.w0(null, k6.Ii, false);
        ...
        int v02 = k6.v0(k6.f21607a7, g6Var);
        this.O = v02;
        ...
        this.f47631j0 = botFullscreenButtons;
    ...
    public static WindowInsets e(p2 p2Var, View view, WindowInsets windowInsets) {
        r0.j1 j1Var = r0.m1.h(view, windowInsets).f46483a;
        i0.b f10 = j1Var.f(2);
        p2Var.f47626f.set(f10.f7757a, f10.f7758b, f10.f7759c, f10.d);
    ...
    public static JSONObject p(g6 g6Var, final boolean z4) {
        try {
            ...
            final int v = k6.v(-16777216, k6.v0(k6.f21733h5, g6Var));
            ...
            jSONObject.put("section_bg_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.f21661d6, g6Var))));
            int i10 = k6.f21607a7;
            ...
            jSONObject.put("header_bg_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.f21932s8, g6Var))));
            jSONObject.put("accent_text_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.f21896q6, g6Var))));
            jSONObject.put("section_header_text_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.L6, g6Var))));
            jSONObject.put("subtitle_text_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.f22055z6, g6Var))));
            jSONObject.put("destructive_text_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.f21878p7, g6Var))));
            jSONObject.put("section_separator_color", callbackReturn.run(Integer.valueOf(k6.v0(k6.f21662d7, g6Var))));
    ...
    public final void A() {
        if (!this.R) {
            ...
            m2Var.B(k6.v0(k6.f21965u8, g6Var), false);
        ...
        this.f47648x.setFlickerViewColor(this.M.getColor());
    }
    ...
    public final void B() {
        ...
        ArrayList arrayList = c3.f47485e;
        g0 g0Var = c3.f47486f;
        boolean z10 = true;
        if (g0Var == null) {
            ic icVar2 = this.f47632k0;
            if (icVar2 != null) {
                icVar2.b();
                this.f47632k0 = null;
            }
        } else if ((g0Var.c() && !g0Var.f47472l) || g0Var.f47471k) {
            if (this.I0 != g0Var && (icVar = this.f47632k0) != null) {
                icVar.b();
                this.f47632k0 = null;
            }
            ic icVar3 = this.f47632k0;
            if (icVar3 == null || !icVar3.f27780l) {
                this.I0 = g0Var;
            ...
            if (this.f47633l0.c(g0Var)) {
                this.f47632k0 = null;
            }
            g0Var.f47471k = false;
            g0Var.f47472l = true;
        } else {
            f0 f0Var2 = this.f47633l0;
            if (f0Var2 != null) {
                this.I0 = g0Var;
                if (f0Var2.c(g0Var)) {
                    this.f47632k0 = null;
        ...
        for (Map.Entry entry : this.G0.entrySet()) {
            ...
            g1Var.setText(g0Var2.f47465c);
            if (!g0Var2.c()) {
                g1Var.setSubtext(AndroidUtilities.formatFileSize(g0Var2.f47468g));
            } else {
                Pair b10 = g0Var2.b();
            ...
            if (g0Var2.c()) {
                ...
                g1Var.f21376b.setPadding(0, 0, AndroidUtilities.dp(32.0f), 0);
            } else if (g0Var2.f47469i) {
                g1Var.setVisibility(8);
            } else {
                g1Var.setRightIcon(0);
                g1Var.f21376b.setPadding(0, 0, 0, 0);
            }
        ...
        this.f47631j0.setDownloading(z10);
    }

    public final void C() {
        f0 f0Var = this.f47633l0;
        if (f0Var == null) {
            return;
        }
        if (this.f47618a0) {
            f0Var.setArrow(AndroidUtilities.lerp(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(26.0f), this.f47622c0));
        } else if (this.f47619b > 0.5f) {
    ...
    public final void D() {
        ...
        int i14;
        int i15;
        BotFullscreenButtons botFullscreenButtons = this.f47631j0;
        Rect rect = this.h;
        botFullscreenButtons.setInsets(rect);
        boolean z4 = this.f47618a0;
        h2 h2Var = this.f47648x;
        o2 o2Var = this.f47624e;
        l2 l2Var = this.f47630i0;
        int i16 = 0;
        if (z4) {
            ...
            int i18 = rect.top;
            int i19 = rect.right;
            if (this.f47634n > i14 || (l2Var != null && l2Var.getTotalHeight() > 0)) {
                i15 = 0;
            } else {
                i15 = rect.bottom;
            }
            ...
            h2Var.K(rect2, false);
            h2Var.J(dp, false);
            o2Var.setPadding(0, 0, 0, Math.max(this.f47634n, i14));
        } else {
            h2Var.K(new Rect(0, 0, 0, 0), false);
            h2Var.J(0, false);
            int i20 = rect.left;
            int i21 = rect.right;
            int i22 = this.f47634n;
            org.telegram.ui.ActionBar.o3 o3Var = this.f47639r;
            if (o3Var != null) {
                i10 = o3Var.E;
            } else {
                i10 = 0;
        ...
        this.f47646w.topMargin = AndroidUtilities.dp(24.0f);
        boolean z10 = this.f47618a0;
        if (!z10) {
            i11 = 0;
        } else {
            i11 = rect.left;
        ...
        FrameLayout.LayoutParams layoutParams2 = this.f47635n0;
    ...
    public final void E() {
        ...
        if (this.R) {
            ...
            z4 = (AndroidUtilities.isTablet() || i0.a.f(k6.w0(null, k6.f21661d6, true)) < 0.7210000157356262d || this.f47619b < 0.85f) ? false : false;
        }
        Boolean bool = this.d;
    ...
    public final void G() {
        ...
        try {
            ...
            o2 o2Var = this.f47624e;
            if (z4 && (((l2Var = this.f47630i0) == null || l2Var.getTotalHeight() <= 0) && !o2Var.f47593u0)) {
    ...
    public final org.telegram.ui.ActionBar.n3 a() {
        ...
        n3Var.f22174o = this.N;
        n3Var.f22173n = this.f47640r0;
        n3Var.f22171l = this.R;
        n3Var.f22172m = this.S;
        n3Var.f22175p = this.M.getColor();
        n3Var.f22162a = this.f47642s0;
        boolean z11 = false;
        h2 h2Var = this.f47648x;
        ...
        n3Var.v = str;
        g2 g2Var = this.v;
        if ((g2Var == null || g2Var.getSwipeOffsetY() >= 0.0f) && !this.f47644u0 && !m() && !this.f47618a0) {
            z10 = false;
        } else {
            z10 = true;
        }
        n3Var.h = z10;
        n3Var.f22182x = this.f47618a0;
        n3Var.f22183y = this.f47620b0;
        Boolean bool = this.f47647w0;
        if (bool == null) {
            booleanValue = this.f47645v0;
        } else {
            booleanValue = bool.booleanValue();
        }
        n3Var.f22184z = booleanValue;
        if (g2Var != null) {
        ...
        n3Var.f22168i = f10;
        n3Var.A = this.f47649x0;
        n3Var.f22178s = this.f47643t0;
        n3Var.f22181w = this.f47636o0;
        n3Var.f22179t = this.Y;
        n3Var.f22169j = (g2Var == null || g2Var.J) ? true : true;
        n3Var.f22180u = this.f47630i0.f47738e;
        n3Var.f22176q = this.O;
        u0 u0Var = this.f47651y0;
        if (u0Var != null) {
            u0Var.b();
        }
        n3Var.I = this.f47651y0;
        if (h2Var != null) {
        ...
        if (x0Var != null) {
            ...
            n3Var.f22165e = x0Var.getWidth();
            n3Var.f22166f = x0Var.getHeight();
            x0Var.onPause();
        }
        boolean z12 = this.P0;
        n3Var.E = z12;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.webViewResultSent) {
            ...
            this.f47624e.invalidate();
            this.f47648x.f42446n.b(k6.v0(k6.f21661d6, this.B), 153);
            A();
            E();
    ...
    public final void k(boolean z4) {
        ...
        this.Z = true;
        z(false);
        AndroidUtilities.cancelRunOnUIThread(this.f47638q0);
        ...
        if (z4) {
            o1.j jVar = this.f47621c;
            if (jVar != null) {
                jVar.f16338u.f16345i = 0.0f;
                jVar.f();
            }
            ...
            int i12 = height + i10;
            Rect rect = this.h;
            int R = this.f47624e.R() + i12 + rect.top + rect.bottom;
            if (m()) {
    ...
    public final void n() {
        boolean z4;
        if (this.f47642s0 != null) {
            long max = Math.max(0L, 60000 - (System.currentTimeMillis() - this.f47642s0.f47839r));
            String str = null;
            this.f47647w0 = null;
            TLObject tLObject = this.f47642s0.f47838q;
            if (tLObject instanceof TLRPC.TL_webViewResultUrl) {
                ...
                this.f47647w0 = Boolean.valueOf(tL_webViewResultUrl.fullsize);
                boolean z10 = this.B0;
                if (!z10) {
                    x(tL_webViewResultUrl.fullscreen, !z10, this.f47620b0);
                }
            } else {
            ...
            if (str != null && !this.B0) {
                MediaDataController.getInstance(this.D).increaseWebappRating(this.f47642s0.f47826c);
                h2Var.r(this.D, str);
            }
            AndroidUtilities.runOnUIThread(this.f47638q0, max);
            g2 g2Var = this.v;
            if (g2Var != null) {
                g2Var.setFullSize(m());
            }
    ...
    public final void onBackPressed() {
        if (this.f47637p0.getVisibility() == 0) {
            if (getOwnerActivity() != null) {
                getOwnerActivity().finish();
            }
        } else if (this.f47648x.z()) {
        } else {
            k(true);
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.f47618a0 && ((l2Var = this.f47630i0) == null || l2Var.getTotalHeight() <= 0)) {
            o2Var.setSystemUiVisibility(o2Var.getSystemUiVisibility() | 2);
        } else {
            o2Var.setSystemUiVisibility(o2Var.getSystemUiVisibility() & (-3));
        }
    ...
    public final void onStart() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).f34182y0.add(this.f47637p0);
        }
    }
    ...
    public final void onStop() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).f34182y0.remove(this.f47637p0);
        }
    }
    ...
    public final boolean q() {
        ...
        if (this.f47636o0) {
            ...
            org.telegram.ui.ActionBar.d2 d2Var = alertDialog$Builder.f21168a;
            d2Var.show();
            ((TextView) d2Var.d(-1)).setTextColor(k6.v0(k6.f21897q7, this.B));
            return false;
        }
        k(false);
        return true;
    ...
    public final void r() {
        ...
        q70 G = q70.G(this.f47624e, this.B, view, true);
        this.H0 = G;
        ArrayList arrayList3 = h0.c(getContext(), this.D, this.E).f47485e;
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i13 < size2) {
                ...
                i13++;
                g0 g0Var = (g0) obj;
                String str = g0Var.f47465c;
                sj0 sj0Var = new sj0(17);
                g6 g6Var = J.d;
                if (J.f30308e == null) {
                    arrayList = arrayList3;
                } else {
                    org.telegram.ui.ActionBar.g1 g1Var = new org.telegram.ui.ActionBar.g1(0, J.f30308e, J.d, false, false);
                    arrayList = arrayList3;
                    g1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
                    g1Var.setText(str);
                    g1Var.setSubtext("");
                    Integer num = J.f30318j0;
                    if (num != null) {
                        v02 = num.intValue();
                    } else {
                        v02 = k6.v0(k6.E8, g6Var);
                    }
                    Integer num2 = J.f30320k0;
                    if (num2 != null) {
                        v03 = num2.intValue();
                    } else {
        ...
        if (this.N != k6.w0(null, k6.f21661d6, false)) {
    ...
    public final void s(org.telegram.ui.ActionBar.p2 p2Var, y3 y3Var) {
        ...
        boolean z11;
        this.f47642s0 = y3Var;
        int i10 = y3Var.f47824a;
        this.D = i10;
        this.F = y3Var.f47825b;
        this.E = y3Var.f47826c;
        this.H = y3Var.h;
        this.I = y3Var.f47830i;
        this.J = y3Var.f47827e;
        ...
        TLRPC.User user4 = y3Var.f47834m;
        ...
        if (y3Var.f47838q != null) {
            n();
            return;
        }
        int i12 = y3Var.f47829g;
        if (i12 != 0) {
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        if (i12 != 4) {
                            if (i12 == 5) {
                                ...
                                ConnectionsManager.getInstance(this.D).sendRequestTyped(tL_messages_requestChatJoinWebView, new Object(), new c4(this, 11), 66);
                                return;
                            }
                            return;
                        }
                        TLRPC.TL_messages_requestMainWebView tL_messages_requestMainWebView = new TLRPC.TL_messages_requestMainWebView();
                        tL_messages_requestMainWebView.bot = MessagesController.getInstance(this.D).getInputUser(y3Var.f47826c);
                        ...
                        if (p2Var instanceof xn) {
                            ...
                            if (xnVar.i() != null) {
                                ...
                                inputPeer2 = MessagesController.getInputPeer(xnVar.f43143e);
                            }
                        } else {
                            inputPeer2 = MessagesController.getInstance(this.D).getInputPeer(y3Var.f47825b);
                        }
                        tL_messages_requestMainWebView.peer = inputPeer2;
                        tL_messages_requestMainWebView.compact = y3Var.f47836o;
                        tL_messages_requestMainWebView.fullscreen = y3Var.f47837p;
                        if (!TextUtils.isEmpty(y3Var.f47833l)) {
                            tL_messages_requestMainWebView.start_param = y3Var.f47833l;
                    ...
                    TLRPC.BotApp botApp = y3Var.f47831j;
                    tL_inputBotAppID.f20903id = botApp.f20842id;
                    tL_inputBotAppID.access_hash = botApp.access_hash;
                    tL_messages_requestAppWebView.app = tL_inputBotAppID;
                    tL_messages_requestAppWebView.write_allowed = y3Var.f47832k;
                    ...
                    if (p2Var instanceof xn) {
                        ...
                        if (xnVar2.i() != null) {
                            ...
                            inputPeer = MessagesController.getInputPeer(xnVar2.f43143e);
                        }
                    } else {
                        inputPeer = MessagesController.getInputPeer(y3Var.f47834m);
                    }
                    tL_messages_requestAppWebView.peer = inputPeer;
                    tL_messages_requestAppWebView.compact = y3Var.f47836o;
                    tL_messages_requestAppWebView.fullscreen = y3Var.f47837p;
                    if (!TextUtils.isEmpty(y3Var.f47833l)) {
                        tL_messages_requestAppWebView.start_param = y3Var.f47833l;
                ...
                tL_messages_requestWebView.compact = y3Var.f47836o;
                tL_messages_requestWebView.fullscreen = y3Var.f47837p;
                tL_messages_requestWebView.url = y3Var.f47828f;
            ...
            if ((y3Var.f47835n & 2) != 0) {
                z12 = true;
            }
            tL_messages_requestSimpleWebView.from_side_menu = z12;
            tL_messages_requestSimpleWebView.compact = y3Var.f47836o;
            tL_messages_requestSimpleWebView.fullscreen = y3Var.f47837p;
            if (p10 != null) {
            ...
            if (!TextUtils.isEmpty(y3Var.f47828f)) {
                tL_messages_requestSimpleWebView.flags |= 8;
                tL_messages_requestSimpleWebView.url = y3Var.f47828f;
            }
            if (!TextUtils.isEmpty(y3Var.f47833l)) {
                tL_messages_requestSimpleWebView.start_param = y3Var.f47833l;
        ...
        tL_messages_requestWebView2.compact = y3Var.f47836o;
        tL_messages_requestWebView2.fullscreen = y3Var.f47837p;
        String str = y3Var.f47828f;
        if (str != null) {
    ...
    public final void t(final int i10, boolean z4, boolean z10) {
        ...
        SparseIntArray sparseIntArray = o1Var.f47589a;
        g6 g6Var = this.B;
        ...
        o1Var.c(o1Var.f47590b, i13, g6Var);
        if (z10) {
    ...
    public final void x(boolean z4, boolean z10, boolean z11) {
        ...
        this.f47627f0 = g2Var.getWidth();
        this.f47628g0 = g2Var.getHeight();
        this.N0 = false;
        l2 l2Var = this.f47630i0;
        h2 h2Var = this.f47648x;
        m2 m2Var = this.T;
        if (z10) {
            ...
            m2Var.setTranslationY((-org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) * this.f47622c0);
            g2Var.setTranslationY(AndroidUtilities.lerp(f13, f15, this.f47623d0));
            g2Var.setTranslationX(AndroidUtilities.lerp(f12, 0.0f, this.f47623d0));
            l2Var.setTranslationX(AndroidUtilities.lerp(f11, 0.0f, this.f47623d0));
            botFullscreenButtons.setAlpha(this.f47622c0);
            this.f47624e.invalidate();
        ...
        m2Var.setAlpha(1.0f - this.f47622c0);
        m2Var.setTranslationY((-org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) * this.f47622c0);
