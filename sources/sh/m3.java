...
public abstract class m3 extends FrameLayout {
    ...
    public float T;
    public float U;
    public Object f47563a;
    public final org.telegram.ui.Cells.f1 f47564b;
    public boolean f47565c;
    public boolean d;
    public float f47566e;
    public float f47567f;
    public float h;
    public float f47568n;
    public float f47569r;
    public boolean f47570s;
    public o1.j v;
    public boolean f47571w;
    public org.telegram.ui.web.x0 f47572x;
    public Runnable f47573y;

    public m3(Context context) {
        super(context);
        float f10;
        this.f47566e = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.f47567f = 0.0f;
        this.h = -1.0f;
        this.f47568n = -2.1474836E9f;
        this.F = new sg.a(9);
        this.J = true;
        this.O = 0.0f;
        this.P = false;
        ...
        this.R = true;
        this.f47564b = new org.telegram.ui.Cells.f1(context, new sr(this, ViewConfiguration.get(context).getScaledTouchSlop(), 2));
    ...
    public final boolean b(boolean z4) {
        org.telegram.ui.web.x0 x0Var = this.f47572x;
    ...
    public final void c() {
        setTranslationY(Math.max(this.f47566e, this.f47567f + this.f47569r));
        AndroidUtilities.cancelRunOnUIThread(new u9(this, 15));
        AndroidUtilities.runOnUIThread(new u9(this, 15));
        Runnable runnable = this.f47573y;
        if (runnable != null) {
            runnable.run();
        }
        ic icVar = ic.f27770w;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f47565c || motionEvent.getActionIndex() == 0) {
            ...
            boolean onTouchEvent = ((GestureDetector) this.f47564b.f22790b).onTouchEvent(obtain);
            obtain.recycle();
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                boolean z4 = this.f47565c;
                this.d = false;
                this.f47565c = false;
                if (!this.G || this.I) {
                    if (this.f47571w) {
                        this.f47571w = false;
                    } else if (this.J && (!this.K || (this.f47569r != (-this.f47567f) + this.f47566e && b(false)))) {
                        float f10 = this.f47569r;
                        int i10 = this.E;
                        float f11 = -i10;
                        boolean z10 = this.R;
                        if (f10 <= f11) {
                            if (z10) {
                                e((-this.f47567f) + this.f47566e);
                            }
    ...
    public final void f(float f10, boolean z4, Runnable runnable) {
        ...
        if (this.f47569r != f10 && ((jVar = this.D) == null || ((float) jVar.f16338u.f16345i) != f10)) {
            this.f47568n = f10;
            o1.j jVar2 = this.v;
            if (jVar2 != null) {
                jVar2.c();
            ...
            jVar4.f16338u = yh.n(f10, 1200.0f, 1.0f);
    ...
    public Object getRenderNode() {
        if (this.f47563a == null && Build.VERSION.SDK_INT >= 31) {
            this.f47563a = android.support.v4.media.session.y.j();
        }
        return this.f47563a;
    }
    ...
    public void setOffsetY(final float f10) {
        ...
        final float f11 = this.f47567f;
        final float f12 = f10 - f11;
        if (Math.abs((this.f47569r + f11) - this.f47566e) <= AndroidUtilities.dp(1.0f)) {
            z4 = true;
        } else {
            z4 = false;
        }
        if (!this.f47570s) {
            ...
            jVar3.f16338u = yh.n(f10, 1400.0f, 1.0f);
            jVar3.b(new o1.g() {
                @Override
                public final void a(o1.h hVar, float f13, float f14) {
                    ...
                    if (z4) {
                        m3Var.f47569r = k7.o.a(m3Var.f47569r - (Math.max(0.0f, f16) * f15), (-m3Var.f47567f) + m3Var.f47566e, (m3Var.getHeight() - m3Var.f47567f) + m3Var.f47566e);
                    }
                    o1.j jVar4 = m3Var.D;
                    if (jVar4 != null) {
                        o1.k kVar = jVar4.f16338u;
                        float f18 = (float) kVar.f16345i;
                        float f19 = m3Var.f47566e;
                        if (f18 == (-f17) + f19) {
                            kVar.f16345i = (-f10) + f19;
                        }
                    }
                    m3Var.c();
                }
        ...
        this.f47567f = f10;
        if (z4) {
            this.f47569r = k7.o.a(this.f47569r - Math.max(0.0f, f12), (-this.f47567f) + this.f47566e, (getHeight() - this.f47567f) + this.f47566e);
        }
        c();
    }
