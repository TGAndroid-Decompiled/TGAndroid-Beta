...
public final class s2 implements Utilities.Callback {
    ...
    public final Object f47677b;
    public final Context f47678c;
    public final int d;
    public final long f47679e;
    public final g6 f47680f;
    ...
    public final void run(Object obj) {
        switch (this.f47676a) {
            case 0:
                final org.telegram.ui.ActionBar.h3 h3Var = (org.telegram.ui.ActionBar.h3) this.f47677b;
                final TLRPC.UserFull userFull = (TLRPC.UserFull) obj;
                final Context context = this.f47678c;
                final int i10 = this.d;
                final long j10 = this.f47679e;
                final g6 g6Var = this.f47680f;
                ...
                return;
            case 1:
                final org.telegram.ui.ActionBar.h3 h3Var2 = (org.telegram.ui.ActionBar.h3) this.f47677b;
                final TLRPC.UserFull userFull2 = (TLRPC.UserFull) obj;
                final Context context2 = this.f47678c;
                final int i11 = this.d;
                final long j11 = this.f47679e;
                final g6 g6Var2 = this.f47680f;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r8) {
                ...
                return;
            default:
                ((org.telegram.ui.ActionBar.h3[]) this.f47677b)[0].dismiss();
                d3.H0(this.f47678c, this.d, (TL_payments.connectedBotStarRef) obj, this.f47679e, this.f47680f);
                return;
        }
    }
}
