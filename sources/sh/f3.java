...
public final class f3 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f47420a) {
            case 0:
                this.f47421b.f47542n.L();
                return;
            case 1:
                this.f47421b.K();
                return;
            case 2:
                n3 n3Var = this.f47421b;
                if (!n3Var.Q) {
                    TLRPC.TL_messages_prolongWebView tL_messages_prolongWebView = new TLRPC.TL_messages_prolongWebView();
                    tL_messages_prolongWebView.bot = MessagesController.getInstance(n3Var.C).getInputUser(n3Var.v);
                    tL_messages_prolongWebView.peer = MessagesController.getInstance(n3Var.C).getInputPeer(n3Var.f47545w);
                    tL_messages_prolongWebView.query_id = n3Var.f47546x;
                    tL_messages_prolongWebView.silent = false;
                    if (n3Var.f47547y != 0) {
                        TLRPC.InputReplyTo createReplyInput = SendMessagesHelper.getInstance(n3Var.C).createReplyInput(n3Var.f47547y);
                    ...
                    if (n3Var.f47545w < 0 && (chatFull = MessagesController.getInstance(n3Var.C).getChatFull(-n3Var.f47545w)) != null && (peer = chatFull.default_send_as) != null) {
                ...
                return;
            case 3:
                n3 n3Var2 = this.f47421b;
                n3Var2.f26546b.X1(n3Var2, 0);
                n3Var2.f47542n.n(false, false);
                System.currentTimeMillis();
                return;
            default:
                this.f47421b.f47542n.n(true, false);
                return;
        }
    }
}
