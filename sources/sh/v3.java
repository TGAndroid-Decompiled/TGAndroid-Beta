...
public final class v3 extends Drawable implements s6, NotificationCenter.NotificationCenterDelegate {
    public final Paint f47749a;
    public final Paint f47750b;
    public final ImageReceiver f47751c;
    public final ImageReceiver d;
    public int f47752e;
    public final l5[] f47753f;
    public final l01 h;
    public final RectF f47754n;
    public final boolean f47755r;
    public final z5 f47756s;
    public boolean v;
    public boolean f47757w;
    public View f47758x;
    ...
    public v3(TLRPC.User user) {
        ...
        this.f47751c = imageReceiver;
        this.d = new ImageReceiver();
        this.f47752e = 1;
        this.f47753f = new l5[2];
        this.f47754n = new RectF();
        this.f47756s = new z5(new u3(this, 1), 320L, pr.h, 0);
        this.f47755r = false;
        int i10 = k6.f21659d6;
    ...
    public final void a(lj0 lj0Var) {
        ...
        this.f47751c.setParentView(lj0Var);
    }

    @Override
    public final void b(ImageReceiver imageReceiver) {
        this.f47757w = false;
        this.f47751c.onDetachedFromWindow();
        ...
        l5[] l5VarArr = this.f47753f;
        l5 l5Var = l5VarArr[0];
        if (l5Var != null) {
            l5Var.o(this.f47758x);
        }
        l5 l5Var2 = l5VarArr[1];
        if (l5Var2 != null) {
            l5Var2.o(this.f47758x);
        }
    }
    ...
    public final void c(ImageReceiver imageReceiver) {
        this.f47757w = true;
        this.f47751c.onAttachedToWindow();
        ...
        l5 l5Var = l5VarArr[0];
        if (l5Var != null) {
            l5Var.a(this.f47758x);
        }
        l5 l5Var2 = l5VarArr[1];
        if (l5Var2 != null) {
            l5Var2.a(this.f47758x);
        }
    }
    ...
    public final void d() {
        ...
        if (stickerSet != null && !stickerSet.documents.isEmpty()) {
            ...
            l5VarArr[this.f47752e] = l5.m(UserConfig.selectedAccount, 9, document);
            l5VarArr[this.f47752e].setColorFilter(new PorterDuffColorFilter(k6.w0(null, k6.Oh, false), PorterDuff.Mode.SRC_IN));
            if (this.f47757w && (l5Var = l5VarArr[this.f47752e]) != null) {
                l5Var.a(this.f47758x);
            }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad && this.v && this.f47757w) {
            this.v = false;
            d();
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z4 = this.f47755r;
        if (z4) {
            i10 = 48;
        } else {
            i10 = 28;
        }
        float dp = (AndroidUtilities.dp((i10 + 38) + 6.66f) + this.h.f28521c) / 2.0f;
        float dp2 = AndroidUtilities.dp(32.0f) / 2.0f;
        RectF rectF = this.f47754n;
        rectF.set(bounds.centerX() - dp, bounds.centerY() - dp2, bounds.centerX() + dp, bounds.centerY() + dp2);
        canvas.drawRoundRect(rectF, dp2, dp2, this.f47749a);
        ImageReceiver imageReceiver = this.f47751c;
        ...
        if (z4) {
            ...
            canvas.drawCircle(dp3, rectF.centerY(), AndroidUtilities.dp(24.0f), this.f47750b);
        ...
        float d = this.f47756s.d(this.f47752e, false);
        canvas.save();
    ...
    public v3(TLRPC.User user, TLRPC.Document document) {
        ...
        imageReceiver2.setImage(ImageLocation.getForDocument(document), "120_120", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "120_120", DocumentObject.getSvgThumb(document.thumbs, k6.f21605a7, 0.35f), 0L, null, null, 0);
        this.h = new l01(UserObject.getUserName(user), 14.0f, null);
    }
