...
public final class i extends o {
    ...
    public final void n() {
        switch (this.f47053r) {
            case 0:
                u5.n nVar = this.f47054s.f47047c;
                u5.o o10 = o();
                nVar.getClass();
                ...
                try {
                    ...
                    q5.q qVar = nVar.f48363f;
                    if (qVar != null) {
                        jSONObject.put("mediaSessionId", qVar.f44604b);
                    }
                } catch (JSONException unused) {
                }
                nVar.c(b10, jSONObject.toString());
                nVar.f48372p.a(b10, o10);
                return;
            case 1:
                this.f47054s.f47047c.d(o(), -1, null);
                return;
            case 2:
                this.f47054s.f47047c.d(o(), 1, null);
                return;
            case 3:
                this.f47054s.f47047c.d(o(), 0, 2);
                return;
            case 4:
                u5.n nVar2 = this.f47054s.f47047c;
                u5.o o11 = o();
                nVar2.getClass();
                ...
                nVar2.f48374r.a(b11, o11);
                return;
            case 5:
                u5.n nVar3 = this.f47054s.f47047c;
                u5.o o12 = o();
                nVar3.getClass();
                ...
                nVar3.f48367k.a(b12, o12);
                return;
            default:
                u5.n nVar4 = this.f47054s.f47047c;
                u5.o o13 = o();
                nVar4.getClass();
