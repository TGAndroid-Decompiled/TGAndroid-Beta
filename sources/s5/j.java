...
public final class j extends SQLiteOpenHelper {
    public static final String f43145c = "INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + ")";
            ...
            while (i10 < i11) {
                switch (((i) list.get(i10)).f43144a) {
                    ...
                    default:
                        ...
                        sQLiteDatabase.execSQL(f43145c);
                        break;
                }
                i10++;
            }
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        a(sQLiteDatabase, 0, this.f43146a);
    }
