...
public final class h implements d, t5.c, c {
    public static final i5.c f43127f = new i5.c("proto");
    public final j f43128a;
    public final u5.a f43129b;
    public final u5.a f43130c;
    public final a d;
    public final fd.a e;
    ...
    public static Long b(SQLiteDatabase sQLiteDatabase, l5.i iVar) {
        ...
        ArrayList arrayList = new ArrayList(Arrays.asList(iVar.f14104a, String.valueOf(v5.a.a(iVar.f14106c))));
    ...
    public final SQLiteDatabase a() {
        ...
        u5.a aVar = this.f43130c;
        long q6 = aVar.q();
        while (true) {
            try {
                return jVar.getWritableDatabase();
            } catch (SQLiteDatabaseLockedException e) {
                if (aVar.q() < this.d.f43118c + q6) {
