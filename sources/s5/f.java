...
public final class f extends c6.a {
    ...
    public final int f47039r;
    public final int f47040s;
    public final int v;
    public final int f47041w;
    public final int f47042x;
    public final int f47043y;
    ...
    public f(List list, int[] iArr, long j10, String str, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20, int i21, int i22, int i23, int i24, int i25, int i26, int i27, int i28, int i29, int i30, int i31, int i32, int i33, int i34, int i35, int i36, IBinder iBinder, boolean z4, boolean z10) {
        p aVar;
        this.f47033a = new ArrayList(list);
        this.f47034b = Arrays.copyOf(iArr, iArr.length);
        this.f47035c = j10;
        this.d = str;
        this.f47036e = i10;
        this.f47037f = i11;
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        g5.n(parcel, 2, this.f47033a);
        int[] iArr = this.f47034b;
        g5.g(parcel, 3, Arrays.copyOf(iArr, iArr.length));
        g5.s(parcel, 4, 8);
        parcel.writeLong(this.f47035c);
        g5.l(parcel, 5, this.d);
        g5.s(parcel, 6, 4);
        parcel.writeInt(this.f47036e);
        g5.s(parcel, 7, 4);
        parcel.writeInt(this.f47037f);
        g5.s(parcel, 8, 4);
        parcel.writeInt(this.h);
        g5.s(parcel, 9, 4);
        parcel.writeInt(this.f47038n);
        g5.s(parcel, 10, 4);
        parcel.writeInt(this.f47039r);
        g5.s(parcel, 11, 4);
        parcel.writeInt(this.f47040s);
        g5.s(parcel, 12, 4);
        parcel.writeInt(this.v);
        g5.s(parcel, 13, 4);
        parcel.writeInt(this.f47041w);
        g5.s(parcel, 14, 4);
        parcel.writeInt(this.f47042x);
        g5.s(parcel, 15, 4);
        parcel.writeInt(this.f47043y);
        g5.s(parcel, 16, 4);
