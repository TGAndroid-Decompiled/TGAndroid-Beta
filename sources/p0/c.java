...
public final class c {
    public final TextPaint f40952a;
    public final TextDirectionHeuristic f40953b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40952a = textPaint;
        this.f40953b = textDirectionHeuristic;
        this.f40954c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40954c == cVar.f40954c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40952a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40952a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40953b;
        int i11 = this.d;
        int i12 = this.f40954c;
        TextPaint textPaint = this.f40952a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb.append(", textDir=" + this.f40953b);
        sb.append(", breakStrategy=" + this.f40954c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40952a = params.getTextPaint();
        this.f40953b = params.getTextDirection();
        this.f40954c = params.getBreakStrategy();
