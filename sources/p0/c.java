...
public final class c {
    public final TextPaint f40655a;
    public final TextDirectionHeuristic f40656b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40655a = textPaint;
        this.f40656b = textDirectionHeuristic;
        this.f40657c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40657c == cVar.f40657c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40655a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40655a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40656b;
        int i11 = this.d;
        int i12 = this.f40657c;
        TextPaint textPaint = this.f40655a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40656b);
        sb2.append(", breakStrategy=" + this.f40657c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40655a = params.getTextPaint();
        this.f40656b = params.getTextDirection();
        this.f40657c = params.getBreakStrategy();
