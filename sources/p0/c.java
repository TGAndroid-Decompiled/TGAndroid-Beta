...
public final class c {
    public final TextPaint f43631a;
    public final TextDirectionHeuristic f43632b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f43631a = textPaint;
        this.f43632b = textDirectionHeuristic;
        this.f43633c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f43633c == cVar.f43633c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f43631a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f43631a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f43632b;
        int i11 = this.d;
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f43632b);
        sb2.append(", breakStrategy=" + this.f43633c);
    ...
    public c(PrecomputedText.Params params) {
        this.f43631a = params.getTextPaint();
        this.f43632b = params.getTextDirection();
        this.f43633c = params.getBreakStrategy();
