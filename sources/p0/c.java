...
public final class c {
    public final TextPaint f44110a;
    public final TextDirectionHeuristic f44111b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f44110a = textPaint;
        this.f44111b = textDirectionHeuristic;
        this.f44112c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f44112c == cVar.f44112c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f44110a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f44110a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f44111b;
        int i11 = this.d;
        int i12 = this.f44112c;
        TextPaint textPaint = this.f44110a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb.append(", textDir=" + this.f44111b);
        sb.append(", breakStrategy=" + this.f44112c);
    ...
    public c(PrecomputedText.Params params) {
        this.f44110a = params.getTextPaint();
        this.f44111b = params.getTextDirection();
        this.f44112c = params.getBreakStrategy();
