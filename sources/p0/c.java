...
public final class c {
    public final TextPaint f40412a;
    public final TextDirectionHeuristic f40413b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40413b = textDirectionHeuristic;
        this.f40414c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40414c == cVar.f40414c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40412a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40412a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40413b;
        int i11 = this.d;
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40413b);
        sb2.append(", breakStrategy=" + this.f40414c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40412a = params.getTextPaint();
        this.f40413b = params.getTextDirection();
        this.f40414c = params.getBreakStrategy();
