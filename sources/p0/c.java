...
public final class c {
    public final TextPaint f40703a;
    public final TextDirectionHeuristic f40704b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40703a = textPaint;
        this.f40704b = textDirectionHeuristic;
        this.f40705c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40705c == cVar.f40705c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40703a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40703a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40704b;
        int i11 = this.d;
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40704b);
        sb2.append(", breakStrategy=" + this.f40705c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40703a = params.getTextPaint();
        this.f40704b = params.getTextDirection();
        this.f40705c = params.getBreakStrategy();
