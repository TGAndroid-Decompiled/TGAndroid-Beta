...
public final class c {
    public final TextPaint f40336a;
    public final TextDirectionHeuristic f40337b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40336a = textPaint;
        this.f40337b = textDirectionHeuristic;
        this.f40338c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40338c == cVar.f40338c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40336a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40336a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40337b;
        int i11 = this.d;
        int i12 = this.f40338c;
        TextPaint textPaint = this.f40336a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40337b);
        sb2.append(", breakStrategy=" + this.f40338c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40336a = params.getTextPaint();
        this.f40337b = params.getTextDirection();
        this.f40338c = params.getBreakStrategy();
