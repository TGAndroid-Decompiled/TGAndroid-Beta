...
public final class c {
    public final TextPaint f40407a;
    public final TextDirectionHeuristic f40408b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40407a = textPaint;
        this.f40408b = textDirectionHeuristic;
        this.f40409c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40409c == cVar.f40409c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40407a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40407a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40408b;
        int i11 = this.d;
        int i12 = this.f40409c;
        TextPaint textPaint = this.f40407a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40408b);
        sb2.append(", breakStrategy=" + this.f40409c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40407a = params.getTextPaint();
        this.f40408b = params.getTextDirection();
        this.f40409c = params.getBreakStrategy();
