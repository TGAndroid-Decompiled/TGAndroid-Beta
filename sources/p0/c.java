...
public final class c {
    public final TextPaint f40654a;
    public final TextDirectionHeuristic f40655b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40654a = textPaint;
        this.f40655b = textDirectionHeuristic;
        this.f40656c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40656c == cVar.f40656c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40654a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40654a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40655b;
        int i11 = this.d;
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40655b);
        sb2.append(", breakStrategy=" + this.f40656c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40654a = params.getTextPaint();
        this.f40655b = params.getTextDirection();
        this.f40656c = params.getBreakStrategy();
