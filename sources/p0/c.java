...
public final class c {
    public final TextPaint f40381a;
    public final TextDirectionHeuristic f40382b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40381a = textPaint;
        this.f40382b = textDirectionHeuristic;
        this.f40383c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40383c == cVar.f40383c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40381a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40381a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40382b;
        int i11 = this.d;
        int i12 = this.f40383c;
        TextPaint textPaint = this.f40381a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40382b);
        sb2.append(", breakStrategy=" + this.f40383c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40381a = params.getTextPaint();
        this.f40382b = params.getTextDirection();
        this.f40383c = params.getBreakStrategy();
