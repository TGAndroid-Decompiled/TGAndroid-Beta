...
public final class c {
    public final TextPaint f43658a;
    public final TextDirectionHeuristic f43659b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f43658a = textPaint;
        this.f43659b = textDirectionHeuristic;
        this.f43660c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f43660c == cVar.f43660c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f43658a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f43658a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f43659b;
        int i11 = this.d;
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f43659b);
        sb2.append(", breakStrategy=" + this.f43660c);
    ...
    public c(PrecomputedText.Params params) {
        this.f43658a = params.getTextPaint();
        this.f43659b = params.getTextDirection();
        this.f43660c = params.getBreakStrategy();
