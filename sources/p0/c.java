...
public final class c {
    public final TextPaint f43657a;
    public final TextDirectionHeuristic f43658b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f43657a = textPaint;
        this.f43658b = textDirectionHeuristic;
        this.f43659c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f43659c == cVar.f43659c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f43657a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f43657a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f43658b;
        int i11 = this.d;
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f43658b);
        sb2.append(", breakStrategy=" + this.f43659c);
    ...
    public c(PrecomputedText.Params params) {
        this.f43657a = params.getTextPaint();
        this.f43658b = params.getTextDirection();
        this.f43659c = params.getBreakStrategy();
