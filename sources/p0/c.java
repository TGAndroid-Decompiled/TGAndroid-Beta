...
public final class c {
    public final TextPaint f40385a;
    public final TextDirectionHeuristic f40386b;
    ...
    public c(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i10, int i11) {
        ...
        this.f40385a = textPaint;
        this.f40386b = textDirectionHeuristic;
        this.f40387c = i10;
        this.d = i11;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != this) {
            if (obj instanceof c) {
                ...
                if (i10 < 23 || (this.f40387c == cVar.f40387c && this.d == cVar.d)) {
                    TextPaint textPaint = this.f40385a;
                    float textSize = textPaint.getTextSize();
                    TextPaint textPaint2 = cVar.f40385a;
    ...
    public final int hashCode() {
        int i10 = Build.VERSION.SDK_INT;
        TextDirectionHeuristic textDirectionHeuristic = this.f40386b;
        int i11 = this.d;
        int i12 = this.f40387c;
        TextPaint textPaint = this.f40385a;
        if (i10 >= 24) {
    ...
    public final String toString() {
        ...
        sb2.append(", textDir=" + this.f40386b);
        sb2.append(", breakStrategy=" + this.f40387c);
    ...
    public c(PrecomputedText.Params params) {
        this.f40385a = params.getTextPaint();
        this.f40386b = params.getTextDirection();
        this.f40387c = params.getBreakStrategy();
