...
public final class d0 extends AtomicReference implements Runnable {
    public static final z9 f11032c = new z9(2);
    public static final z9 d = new z9(2);
    public final Callable f11033a;
    public final e0 f11034b;
    ...
    public final void run() {
        ...
        if (compareAndSet(null, currentThread)) {
            e0 e0Var = this.f11034b;
            boolean isDone = e0Var.isDone();
            z9 z9Var = f11032c;
            if (!isDone) {
                try {
                    obj = this.f11033a.call();
                } catch (Throwable th2) {
                    try {
    ...
    public final String toString() {
        ...
        g10.append(this.f11033a.toString());
        return g10.toString();
    }
}
