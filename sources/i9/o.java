...
public abstract class o extends j9.a implements w {
    ...
    public static void g(o oVar, boolean z10) {
        c cVar = null;
        while (true) {
            for (n e7 = f11035f.e(oVar); e7 != null; e7 = e7.f11034b) {
                Thread thread = e7.f11033a;
                if (thread != null) {
                    e7.f11033a = null;
            ...
            while (cVar3 != null) {
                cVar = cVar3.f11018c;
                Runnable runnable = cVar3.f11016a;
                Objects.requireNonNull(runnable);
                if (runnable instanceof e) {
                    e eVar = (e) runnable;
                    oVar = eVar.f11025a;
                    if (oVar.f11036a == eVar) {
                        if (f11035f.b(oVar, eVar, j(eVar.f11026b))) {
                            break;
                        }
                    } else {
                        continue;
                    ...
                    Executor executor = cVar3.f11017b;
    ...
    public static Object i(Object obj) {
        if (!(obj instanceof a)) {
            ...
            throw new ExecutionException(((b) obj).f11014a);
        }
        Throwable th2 = ((a) obj).f11011b;
    ...
    public void a(Runnable runnable, Executor executor) {
        c cVar;
        c cVar2 = c.d;
        if (!isDone() && (cVar = this.f11037b) != cVar2) {
            c cVar3 = new c(runnable, executor);
            do {
                cVar3.f11018c = cVar;
                if (f11035f.a(this, cVar, cVar3)) {
                    return;
                }
                cVar = this.f11037b;
            } while (cVar != cVar2);
    ...
    public final void l(n nVar) {
        nVar.f11033a = null;
        while (true) {
            n nVar2 = this.f11038c;
            if (nVar2 != n.f11032c) {
                n nVar3 = null;
                while (nVar2 != null) {
                    n nVar4 = nVar2.f11034b;
                    if (nVar2.f11033a != null) {
                        nVar3 = nVar2;
                    } else if (nVar3 != null) {
                        nVar3.f11034b = nVar4;
                        if (nVar3.f11033a == null) {
                            break;
                        }
                    } else if (!f11035f.c(this, nVar2, nVar4)) {
                        break;
                    }
                    nVar2 = nVar4;
                }
    ...
    public boolean n(Throwable th2) {
        if (!f11035f.b(this, null, new b(th2))) {
            return false;
        }
        g(this, false);
        return true;
    ...
    public Object get() {
        ...
        if (!Thread.interrupted()) {
            ...
            if (nVar2 != nVar) {
                ...
                Object obj3 = this.f11036a;
                Objects.requireNonNull(obj3);
                return i(obj3);
            }
            Object obj32 = this.f11036a;
