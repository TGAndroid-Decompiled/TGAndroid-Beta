...
public class y extends AbstractExecutorService implements x, AutoCloseable {
    public final ExecutorService f11058a;

    public y(ExecutorService executorService) {
        executorService.getClass();
        this.f11058a = executorService;
    }
    ...
    public final boolean awaitTermination(long j3, TimeUnit timeUnit) {
        return this.f11058a.awaitTermination(j3, timeUnit);
    }
    ...
    public final void execute(Runnable runnable) {
        this.f11058a.execute(runnable);
    }

    @Override
    public final boolean isShutdown() {
        return this.f11058a.isShutdown();
    }

    @Override
    public final boolean isTerminated() {
        return this.f11058a.isTerminated();
    }
    ...
    public final void shutdown() {
        this.f11058a.shutdown();
    }

    @Override
    public final List shutdownNow() {
        return this.f11058a.shutdownNow();
    }
    ...
    public final String toString() {
        return super.toString() + "[" + this.f11058a + "]";
    }
