...
public final class s implements Runnable {
    ...
    private final void b() {
        try {
            ...
            synchronized (((r9.j) this.f11924c).f45056b) {
                ((r9.j) this.f11924c).f45057c = 1;
                throw e7;
            }
        }
    }
    ...
    public final void run() {
        ...
        switch (this.f11922a) {
            ...
            case 19:
                ...
                e2.a0 a0Var2 = (e2.a0) ((xa.c) this.f11923b).f49332b;
                if (a0Var2 != null) {
                    a0Var2.e(typeface);
                    return;
                }
            ...
            case 20:
                ...
                return;
            case 21:
                co coVar = ((sm) this.f11924c).f40474c;
                if (this == coVar.J5) {
            ...
            case 22:
                ...
                AndroidUtilities.updateVisibleRows(vrVar.f41636c);
                pr w02 = vrVar.w0();
                vrVar.B0();
                vrVar.A0(w02);
                return;
            ...
            case 24:
                ...
                while (!((Set) this.f11924c).isEmpty()) {
                    try {
                        ...
                        if (lVar.f44292a.remove(lVar)) {
                            lVar.clear();
                            lVar.f44293b.getClass();
                        }
            ...
            case 26:
                ...
                int decrementAndGet = iVar2.f44285b.decrementAndGet();
                ...
                if (recyclerView != null && recyclerView.G && !uVar.v && c1Var.b() != -1) {
                    ...
                    if (itemAnimator == null || !itemAnimator.k()) {
                        ...
                        for (int i16 = 0; i16 < size2; i16++) {
                            if (((s4.u) arrayList2.get(i16)).f45879w) {
                            }
                        }
                        yVar2.f45905x.q(c1Var);
                        return;
                    }
                    yVar2.H.post(this);
                    return;
    ...
    public String toString() {
        ...
        switch (this.f11922a) {
            case 0:
                ...
                ((pf.b) aVar.d).f44048c = bVar;
                aVar.d = bVar;
                bVar.f44047b = (r) this.f11924c;
            ...
            case 28:
                ...
                int i10 = ((r9.j) this.f11924c).f45057c;
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            if (i10 != 4) {
