...
public final class s implements Runnable {
    ...
    private final void b() {
        try {
            ...
            synchronized (((r9.j) this.f11056c).f42198b) {
                ((r9.j) this.f11056c).f42199c = 1;
                throw e;
            }
        }
    }
    ...
    public final void run() {
        ...
        switch (this.f11054a) {
            ...
            case 20:
                ...
                return;
            case 21:
                bo boVar = ((rm) this.f11056c).f37265c;
                if (this == boVar.J5) {
            ...
            case 22:
                ...
                AndroidUtilities.updateVisibleRows(urVar.f38128c);
                or w02 = urVar.w0();
                urVar.B0();
                urVar.A0(w02);
                return;
            ...
            case 24:
                ...
                while (!((Set) this.f11056c).isEmpty()) {
                    try {
                        ...
                        if (lVar.f41279a.remove(lVar)) {
                            lVar.clear();
                            lVar.f41280b.getClass();
                        }
            ...
            case 26:
                ...
                int decrementAndGet = iVar2.f41272b.decrementAndGet();
                ...
                if (recyclerView != null && recyclerView.G && !uVar.v && c1Var.b() != -1) {
                    ...
                    if (itemAnimator == null || !itemAnimator.k()) {
                        ...
                        for (int i16 = 0; i16 < size2; i16++) {
                            if (((s4.u) arrayList2.get(i16)).f42826w) {
                            }
                        }
                        yVar.f42850x.q(c1Var);
                        return;
                    }
                    yVar.H.post(this);
                    return;
    ...
    public String toString() {
        ...
        switch (this.f11054a) {
            ...
            case 28:
                ...
                int i10 = ((r9.j) this.f11056c).f42199c;
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            if (i10 != 4) {
