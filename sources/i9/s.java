...
public final class s implements Runnable {
    ...
    private final void b() {
        try {
            ...
            synchronized (((r9.j) this.f11950c).f45084b) {
                ((r9.j) this.f11950c).f45085c = 1;
                throw e7;
            }
        }
    }
    ...
    public final void run() {
        ...
        switch (this.f11948a) {
            ...
            case 19:
                ...
                e2.a0 a0Var2 = (e2.a0) ((xa.c) this.f11949b).f49361b;
                if (a0Var2 != null) {
                    a0Var2.e(typeface);
                    return;
                }
            ...
            case 20:
                ...
                return;
            case 21:
                co coVar = ((sm) this.f11950c).f40501c;
                if (this == coVar.J5) {
            ...
            case 22:
                ...
                AndroidUtilities.updateVisibleRows(vrVar.f41663c);
                pr w02 = vrVar.w0();
                vrVar.B0();
                vrVar.A0(w02);
                return;
            ...
            case 24:
                ...
                while (!((Set) this.f11950c).isEmpty()) {
                    try {
                        ...
                        if (lVar.f44320a.remove(lVar)) {
                            lVar.clear();
                            lVar.f44321b.getClass();
                        }
            ...
            case 26:
                ...
                int decrementAndGet = iVar2.f44313b.decrementAndGet();
                ...
                if (recyclerView != null && recyclerView.G && !uVar.v && c1Var.b() != -1) {
                    ...
                    if (itemAnimator == null || !itemAnimator.k()) {
                        ...
                        for (int i16 = 0; i16 < size2; i16++) {
                            if (((s4.u) arrayList2.get(i16)).f45907w) {
                            }
                        }
                        yVar2.f45933x.q(c1Var);
                        return;
                    }
                    yVar2.H.post(this);
                    return;
    ...
    public String toString() {
        ...
        switch (this.f11948a) {
            case 0:
                ...
                ((pf.b) aVar.d).f44075c = bVar;
                aVar.d = bVar;
                bVar.f44074b = (r) this.f11950c;
            ...
            case 28:
                ...
                int i10 = ((r9.j) this.f11950c).f45085c;
                if (i10 != 1) {
                    if (i10 != 2) {
                        if (i10 != 3) {
                            if (i10 != 4) {
