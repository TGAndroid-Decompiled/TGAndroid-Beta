...
public abstract class h implements v8.a {
    ...
    public static final h0 f1874f;
    public static final Object h;
    public volatile Object f1875a;
    public volatile d f1876b;
    public volatile g f1877c;
    ...
    public static void e(h hVar) {
        ...
        do {
            gVar = hVar.f1877c;
        } while (!f1874f.c(hVar, gVar, g.f1871c));
        while (true) {
            dVar = null;
            if (gVar == null) {
                break;
            }
            Thread thread = gVar.f1872a;
            if (thread != null) {
                gVar.f1872a = null;
        ...
        while (dVar3 != null) {
            d dVar4 = dVar3.f1867c;
            f(dVar3.f1865a, dVar3.f1866b);
            dVar3 = dVar4;
        }
    }
    ...
    public static Object g(Object obj) {
        if (!(obj instanceof a)) {
            ...
            throw new ExecutionException(((c) obj).f1864a);
        }
        Throwable th2 = ((a) obj).f1862b;
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos >= 1000) {
                ...
                if (gVar2 != gVar) {
                    ...
                    return g(this.f1875a);
                }
                return g(this.f1875a);
            }
            while (nanos > 0) {
                Object obj3 = this.f1875a;
                if (obj3 != null) {
                    return g(obj3);
                }
                if (!Thread.interrupted()) {
    ...
    public final boolean isCancelled() {
        return this.f1875a instanceof a;
    }
    ...
    public final void j(g gVar) {
        ...
        while (true) {
            ...
            if (gVar2 != g.f1871c) {
                g gVar3 = null;
                while (gVar2 != null) {
                    g gVar4 = gVar2.f1873b;
                    if (gVar2.f1872a != null) {
                        gVar3 = gVar2;
                    } else if (gVar3 != null) {
                        gVar3.f1873b = gVar4;
                        if (gVar3.f1872a == null) {
                            break;
                        }
                    } else if (!f1874f.c(this, gVar2, gVar4)) {
                        break;
                    }
                    gVar2 = gVar4;
                }
    ...
    public boolean l(Throwable th2) {
        if (f1874f.b(this, null, new c(th2))) {
            e(this);
            return true;
        }
        return false;
