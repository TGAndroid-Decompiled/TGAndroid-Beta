...
public final class c implements b1 {
    ...
    public final boolean e() {
        if (!this.f43624c.a() && this.f43622a.e()) {
            return true;
        }
        return false;
    }
    ...
    public final int f(n4.y yVar, h2.h hVar, int i10) {
        ...
        long s10 = dVar.s();
        int f7 = this.f43622a.f(yVar, hVar, i10);
        if (f7 == -5) {
            ...
            if (dVar.f43628f != Long.MIN_VALUE) {
                i11 = 0;
            }
            b2.r a2 = sVar.a();
            a2.L = i12;
