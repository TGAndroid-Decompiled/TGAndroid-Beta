...
public final class e1 implements g1 {
    ...
    public final g1 a(int i10, int i11) {
        ...
        return new e1(iArr2, new Random(this.f43374a.nextLong()));
    }
    ...
    public final int c(int i10) {
        int i11 = this.f43376c[i10] - 1;
        if (i11 < 0) {
            return -1;
        }
        return this.f43375b[i11];
    }
    ...
    public final int getLength() {
        return this.f43375b.length;
    }

    @Override
    public final g1 h() {
        return new e1(new Random(this.f43374a.nextLong()));
    }

    public e1(int[] iArr, Random random) {
        this.f43375b = iArr;
        this.f43374a = random;
        this.f43376c = new int[iArr.length];
        for (int i10 = 0; i10 < iArr.length; i10++) {
            this.f43376c[iArr[i10]] = i10;
        }
    }
