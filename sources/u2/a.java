...
public abstract class a {
    public final ArrayList f46633a = new ArrayList(1);
    public final HashSet f46634b = new HashSet(1);
    public final a5.a f46635c = new a5.a(new CopyOnWriteArrayList(), 0, null, 20);
    public final n2.j d = new n2.j(new CopyOnWriteArrayList(), 0, null);
    public Looper f46636e;
    public b2.k1 f46637f;
    public j2.k f46638g;
    ...
    public final a5.a b(f0 f0Var) {
        return new a5.a((CopyOnWriteArrayList) this.f46635c.d, 0, f0Var, 20);
    }

    public abstract d0 c(f0 f0Var, y2.d dVar, long j3);

    public final void d(g0 g0Var) {
        HashSet hashSet = this.f46634b;
    ...
    public final void l(g0 g0Var, g2.c0 c0Var, j2.k kVar) {
        ...
        e2.d.b(z10);
        this.f46638g = kVar;
        b2.k1 k1Var = this.f46637f;
        this.f46633a.add(g0Var);
        if (this.f46636e == null) {
            this.f46636e = myLooper;
            this.f46634b.add(g0Var);
            m(c0Var);
        } else if (k1Var != null) {
            f(g0Var);
            g0Var.a(this, k1Var);
    ...
    public final void n(b2.k1 k1Var) {
        this.f46637f = k1Var;
        ArrayList arrayList = this.f46633a;
    ...
    public final void s(k0 k0Var) {
        CopyOnWriteArrayList copyOnWriteArrayList = (CopyOnWriteArrayList) this.f46635c.d;
        Iterator it = copyOnWriteArrayList.iterator();
        while (it.hasNext()) {
            j0 j0Var = (j0) it.next();
            if (j0Var.f46740b == k0Var) {
