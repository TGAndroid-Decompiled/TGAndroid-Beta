...
public final class n implements d1 {
    ...
    public final boolean c() {
        int i10 = 0;
        while (true) {
            e9.a1 a1Var = this.f43466a;
            if (i10 >= a1Var.d) {
                return false;
            }
            if (((m) a1Var.get(i10)).f43455a.c()) {
                return true;
            }
            i10++;
        }
    ...
    public final long d() {
        ...
        while (true) {
            ...
            long d = ((m) a1Var.get(i10)).f43455a.d();
            if (d != Long.MIN_VALUE) {
                j3 = Math.min(j3, d);
            }
            i10++;
    ...
    public final boolean m(i2.r0 r0Var) {
        ...
        do {
            ...
            while (true) {
                e9.a1 a1Var = this.f43466a;
                if (i10 < a1Var.d) {
                    long d10 = ((m) a1Var.get(i10)).f43455a.d();
                    ...
                    if (d10 == d || z11) {
                        z10 |= ((m) a1Var.get(i10)).f43455a.m(r0Var);
                    }
                    i10++;
                } else {
                    z12 |= z10;
    ...
    public final long s() {
        ...
        while (true) {
            ...
            long s10 = mVar.f43455a.s();
            e9.i0 i0Var = mVar.f43456b;
