...
public final class n implements d1 {
    ...
    public n(List list, List list2) {
        ...
        this.f43722a = u10.i();
        this.f43723b = -9223372036854775807L;
    }
    ...
    public final boolean c() {
        int i10 = 0;
        while (true) {
            e9.a1 a1Var = this.f43722a;
            if (i10 >= a1Var.d) {
                return false;
            }
            if (((m) a1Var.get(i10)).f43716a.c()) {
                return true;
            }
            i10++;
        }
    ...
    public final long d() {
        ...
        while (true) {
            ...
            long d = ((m) a1Var.get(i10)).f43716a.d();
            if (d != Long.MIN_VALUE) {
                j3 = Math.min(j3, d);
            }
            i10++;
    ...
    public final boolean p(i2.s0 s0Var) {
        ...
        do {
            ...
            while (true) {
                e9.a1 a1Var = this.f43722a;
                if (i10 < a1Var.d) {
                    long d10 = ((m) a1Var.get(i10)).f43716a.d();
                    ...
                    if (d10 == d || z11) {
                        z10 |= ((m) a1Var.get(i10)).f43716a.p(s0Var);
                    }
                    i10++;
                } else {
                    z12 |= z10;
    ...
    public final long s() {
        ...
        while (true) {
            ...
            long s10 = mVar.f43716a.s();
            e9.i0 i0Var = mVar.f43717b;
