...
public final class n implements d1 {
    ...
    public n(List list, List list2) {
        ...
        this.f46782a = u10.i();
        this.f46783b = -9223372036854775807L;
    }
    ...
    public final boolean c() {
        int i10 = 0;
        while (true) {
            e9.a1 a1Var = this.f46782a;
            if (i10 >= a1Var.d) {
                return false;
            }
            if (((m) a1Var.get(i10)).f46770a.c()) {
                return true;
            }
            i10++;
        }
    ...
    public final long d() {
        ...
        while (true) {
            ...
            long d = ((m) a1Var.get(i10)).f46770a.d();
            if (d != Long.MIN_VALUE) {
                j3 = Math.min(j3, d);
            }
            i10++;
    ...
    public final boolean p(i2.r0 r0Var) {
        ...
        do {
            ...
            while (true) {
                e9.a1 a1Var = this.f46782a;
                if (i10 < a1Var.d) {
                    long d10 = ((m) a1Var.get(i10)).f46770a.d();
                    ...
                    if (d10 == d || z11) {
                        z10 |= ((m) a1Var.get(i10)).f46770a.p(r0Var);
                    }
                    i10++;
                } else {
                    z12 |= z10;
    ...
    public final long s() {
        ...
        while (true) {
            ...
            long s10 = mVar.f46770a.s();
            e9.i0 i0Var = mVar.f46771b;
