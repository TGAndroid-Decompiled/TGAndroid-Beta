...
public final class j implements l0, n2.l {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f43691b = lVar.b(null);
        this.f43692c = new n2.k(lVar.d.f15131c, 0, null);
        this.f43690a = obj;
    }
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        if (aVar.f277b != w10 || !Objects.equals((f0) aVar.f278c, f0Var2)) {
            this.f43691b = new a5.a((CopyOnWriteArrayList) lVar.f43600c.d, w10, f0Var2, 20);
        }
        n2.k kVar = this.f43692c;
        if (kVar.f15129a != w10 || !Objects.equals(kVar.f15130b, f0Var2)) {
            this.f43692c = new n2.k(lVar.d.f15131c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f43614f;
        l lVar = this.d;
        Object obj = this.f43690a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f43615g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f43611a, b0Var.f43612b, b0Var.f43613c, b0Var.d, b0Var.e, v, v9);
    }
}
