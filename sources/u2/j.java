...
public final class j implements k0, n2.k {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f43391b = lVar.b(null);
        this.f43392c = new n2.j(lVar.d.f14905c, 0, null);
        this.f43390a = obj;
    }
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        if (aVar.f277b != w10 || !Objects.equals((f0) aVar.f278c, f0Var2)) {
            this.f43391b = new a5.a((CopyOnWriteArrayList) lVar.f43297c.d, w10, f0Var2, 20);
        }
        n2.j jVar = this.f43392c;
        if (jVar.f14903a != w10 || !Objects.equals(jVar.f14904b, f0Var2)) {
            this.f43392c = new n2.j(lVar.d.f14905c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f43333f;
        l lVar = this.d;
        Object obj = this.f43390a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f43334g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f43330a, b0Var.f43331b, b0Var.f43332c, b0Var.d, b0Var.e, v, v9);
    }
}
