...
public final class j implements k0, n2.k {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f46708b = lVar.b(null);
        this.f46709c = new n2.j(lVar.d.f16402c, 0, null);
        this.f46707a = obj;
    }
    ...
    public final void c(int i10, f0 f0Var, b0 b0Var) {
        if (l(i10, f0Var)) {
            a5.a aVar = this.f46708b;
            b0 m10 = m(b0Var, f0Var);
            f0 f0Var2 = (f0) aVar.f286c;
            f0Var2.getClass();
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        a5.a aVar = this.f46708b;
        if (aVar.f285b != w10 || !Objects.equals((f0) aVar.f286c, f0Var2)) {
            this.f46708b = new a5.a((CopyOnWriteArrayList) lVar.f46606c.d, w10, f0Var2, 20);
        }
        n2.j jVar = this.f46709c;
        if (jVar.f16400a != w10 || !Objects.equals(jVar.f16401b, f0Var2)) {
            this.f46709c = new n2.j(lVar.d.f16402c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f46645f;
        l lVar = this.d;
        Object obj = this.f46707a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f46646g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f46641a, b0Var.f46642b, b0Var.f46643c, b0Var.d, b0Var.f46644e, v, v9);
    }
}
