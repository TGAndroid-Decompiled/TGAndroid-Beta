...
public final class j implements k0, n2.k {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f43418b = lVar.b(null);
        this.f43419c = new n2.j(lVar.d.f14917c, 0, null);
        this.f43417a = obj;
    }
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        if (aVar.f277b != w10 || !Objects.equals((f0) aVar.f278c, f0Var2)) {
            this.f43418b = new a5.a((CopyOnWriteArrayList) lVar.f43324c.d, w10, f0Var2, 20);
        }
        n2.j jVar = this.f43419c;
        if (jVar.f14915a != w10 || !Objects.equals(jVar.f14916b, f0Var2)) {
            this.f43419c = new n2.j(lVar.d.f14917c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f43360f;
        l lVar = this.d;
        Object obj = this.f43417a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f43361g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f43357a, b0Var.f43358b, b0Var.f43359c, b0Var.d, b0Var.e, v, v9);
    }
}
