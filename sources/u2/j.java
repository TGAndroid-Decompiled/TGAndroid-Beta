...
public final class j implements k0, n2.k {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f46737b = lVar.b(null);
        this.f46738c = new n2.j(lVar.d.f16429c, 0, null);
        this.f46736a = obj;
    }
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        if (aVar.f297b != w10 || !Objects.equals((f0) aVar.f298c, f0Var2)) {
            this.f46737b = new a5.a((CopyOnWriteArrayList) lVar.f46635c.d, w10, f0Var2, 20);
        }
        n2.j jVar = this.f46738c;
        if (jVar.f16427a != w10 || !Objects.equals(jVar.f16428b, f0Var2)) {
            this.f46738c = new n2.j(lVar.d.f16429c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f46674f;
        l lVar = this.d;
        Object obj = this.f46736a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f46675g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f46670a, b0Var.f46671b, b0Var.f46672c, b0Var.d, b0Var.f46673e, v, v9);
    }
}
