...
public final class j implements k0, n2.k {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f46709b = lVar.b(null);
        this.f46710c = new n2.j(lVar.d.f16402c, 0, null);
        this.f46708a = obj;
    }
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        if (aVar.f285b != w10 || !Objects.equals((f0) aVar.f286c, f0Var2)) {
            this.f46709b = new a5.a((CopyOnWriteArrayList) lVar.f46607c.d, w10, f0Var2, 20);
        }
        n2.j jVar = this.f46710c;
        if (jVar.f16400a != w10 || !Objects.equals(jVar.f16401b, f0Var2)) {
            this.f46710c = new n2.j(lVar.d.f16402c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f46646f;
        l lVar = this.d;
        Object obj = this.f46708a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f46647g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f46642a, b0Var.f46643b, b0Var.f46644c, b0Var.d, b0Var.f46645e, v, v9);
    }
}
