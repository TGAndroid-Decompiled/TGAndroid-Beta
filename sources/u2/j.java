...
public final class j implements l0, n2.k {
    ...
    public j(l lVar, Object obj) {
        this.d = lVar;
        this.f43712b = lVar.b(null);
        this.f43713c = new n2.j(lVar.d.f15144c, 0, null);
        this.f43711a = obj;
    }
    ...
    public final void c(int i10, f0 f0Var, b0 b0Var) {
        if (l(i10, f0Var)) {
            a5.a aVar = this.f43712b;
            b0 m10 = m(b0Var, f0Var);
            f0 f0Var2 = (f0) aVar.f277c;
            f0Var2.getClass();
    ...
    public final boolean l(int i10, f0 f0Var) {
        ...
        a5.a aVar = this.f43712b;
        if (aVar.f276b != w10 || !Objects.equals((f0) aVar.f277c, f0Var2)) {
            this.f43712b = new a5.a((CopyOnWriteArrayList) lVar.f43621c.d, w10, f0Var2, 20);
        }
        n2.j jVar = this.f43713c;
        if (jVar.f15142a != w10 || !Objects.equals(jVar.f15143b, f0Var2)) {
            this.f43713c = new n2.j(lVar.d.f15144c, w10, f0Var2);
            return true;
        }
        return true;
    }
    ...
    public final b0 m(b0 b0Var, f0 f0Var) {
        long j3 = b0Var.f43635f;
        l lVar = this.d;
        Object obj = this.f43711a;
        long v = lVar.v(obj, j3);
        long j10 = b0Var.f43636g;
        long v9 = lVar.v(obj, j10);
        if (v == j3 && v9 == j10) {
            return b0Var;
        }
        return new b0(b0Var.f43632a, b0Var.f43633b, b0Var.f43634c, b0Var.d, b0Var.e, v, v9);
    }
}
