...
public final class k1 implements d0, y2.h {
    public final g2.m f43401a;
    public final g2.g f43402b;
    public final g2.c0 f43403c;
    public final qb.b d;
    public final a5.a e;
    public final o1 f43404f;
    public final ArrayList h = new ArrayList();
    public final long f43405n;
    public final y2.m f43406r;
    public final b2.s f43407s;
    public final boolean v;
    public boolean f43408w;
    public byte[] f43409x;
    public int f43410y;
    ...
    public k1(g2.m mVar, g2.g gVar, g2.c0 c0Var, b2.s sVar, long j3, qb.b bVar, a5.a aVar, boolean z10, z2.a aVar2) {
        ...
        this.e = aVar;
        this.v = z10;
        this.f43404f = new o1(new b2.l1("", sVar));
        if (aVar2 != null) {
    ...
    public final void V(y2.j jVar, long j3, long j10, boolean z10) {
        Uri uri = ((j1) jVar).f43396b.f9349c;
        t tVar = new t(j10);
        this.d.getClass();
        this.e.o(tVar, 1, -1, null, 0, null, 0L, this.f43405n);
    }

    @Override
    public final boolean c() {
        return this.f43406r.d();
    }

    @Override
    public final long d() {
        if (!this.f43408w && !this.f43406r.d()) {
            return 0L;
        }
    ...
    public final boolean m(i2.r0 r0Var) {
        if (!this.f43408w) {
            y2.m mVar = this.f43406r;
            if (!mVar.d() && !mVar.c()) {
                g2.h createDataSource = this.f43402b.createDataSource();
                g2.c0 c0Var = this.f43403c;
                if (c0Var != null) {
                    createDataSource.addTransferListener(c0Var);
                }
                j1 j1Var = new j1(createDataSource, this.f43401a);
                this.d.getClass();
                mVar.f(j1Var, this, 3);
                return true;
            }
    ...
    public final void o(y2.j jVar, long j3, long j10, int i10) {
        t tVar;
        j1 j1Var = (j1) jVar;
        g2.b0 b0Var = j1Var.f43396b;
        if (i10 == 0) {
            tVar = new t(j1Var.f43395a);
        } else {
            Uri uri = b0Var.f9349c;
            tVar = new t(j10);
        }
        this.e.s(tVar, 1, -1, this.f43407s, 0, null, 0L, this.f43405n, i10);
    }
    ...
    public final void q(y2.j jVar, long j3, long j10) {
        j1 j1Var = (j1) jVar;
        this.f43410y = (int) j1Var.f43396b.f9348b;
        byte[] bArr = j1Var.f43397c;
        bArr.getClass();
        this.f43409x = bArr;
        this.f43408w = true;
        Uri uri = j1Var.f43396b.f9349c;
        t tVar = new t(j10);
        this.d.getClass();
        this.e.p(tVar, 1, -1, this.f43407s, 0, null, 0L, this.f43405n);
    }
