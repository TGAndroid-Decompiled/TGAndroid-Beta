...
public final class k1 implements d0, y2.h {
    public final g2.m f46718a;
    public final g2.g f46719b;
    public final g2.c0 f46720c;
    public final rb.a d;
    public final a5.a f46721e;
    public final o1 f46722f;
    public final ArrayList h = new ArrayList();
    public final long f46723n;
    public final y2.m f46724r;
    public final b2.s f46725s;
    public final boolean v;
    public boolean f46726w;
    public byte[] f46727x;
    public int f46728y;
    ...
    public k1(g2.m mVar, g2.g gVar, g2.c0 c0Var, b2.s sVar, long j3, rb.a aVar, a5.a aVar2, boolean z10, z2.a aVar3) {
        ...
        this.f46721e = aVar2;
        this.v = z10;
        this.f46722f = new o1(new b2.l1("", sVar));
        if (aVar3 != null) {
    ...
    public final boolean c() {
        return this.f46724r.d();
    }

    @Override
    public final long d() {
        if (!this.f46726w && !this.f46724r.d()) {
            return 0L;
        }
    ...
    public final void h(y2.j jVar, long j3, long j10, int i10) {
        t tVar;
        j1 j1Var = (j1) jVar;
        g2.b0 b0Var = j1Var.f46713b;
        if (i10 == 0) {
            tVar = new t(j1Var.f46712a);
        } else {
            Uri uri = b0Var.f10298c;
            tVar = new t(j10);
        }
        this.f46721e.r(tVar, 1, -1, this.f46725s, 0, null, 0L, this.f46723n, i10);
    }

    @Override
    public final void i(y2.j jVar, long j3, long j10) {
        j1 j1Var = (j1) jVar;
        this.f46728y = (int) j1Var.f46713b.f10297b;
        byte[] bArr = j1Var.f46714c;
        bArr.getClass();
        this.f46727x = bArr;
        this.f46726w = true;
        Uri uri = j1Var.f46713b.f10298c;
        t tVar = new t(j10);
        this.d.getClass();
        this.f46721e.o(tVar, 1, -1, this.f46725s, 0, null, 0L, this.f46723n);
    }
    ...
    public final boolean p(i2.r0 r0Var) {
        if (!this.f46726w) {
            y2.m mVar = this.f46724r;
            if (!mVar.d() && !mVar.c()) {
                g2.h createDataSource = this.f46719b.createDataSource();
                g2.c0 c0Var = this.f46720c;
                if (c0Var != null) {
                    createDataSource.addTransferListener(c0Var);
                }
                j1 j1Var = new j1(createDataSource, this.f46718a);
                this.d.getClass();
                mVar.f(j1Var, this, 3);
                return true;
            }
    ...
    public final void w(y2.j jVar, long j3, long j10, boolean z10) {
        Uri uri = ((j1) jVar).f46713b.f10298c;
        t tVar = new t(j10);
        this.d.getClass();
        this.f46721e.n(tVar, 1, -1, null, 0, null, 0L, this.f46723n);
    }
