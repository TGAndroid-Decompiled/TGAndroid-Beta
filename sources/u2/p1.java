...
public final class p1 {
    ...
    public final b2.l1 a(int i10) {
        return (b2.l1) this.f43737b.get(i10);
    }

    public final int b(b2.l1 l1Var) {
        int indexOf = this.f43737b.indexOf(l1Var);
        if (indexOf >= 0) {
            return indexOf;
        }
        return -1;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj != null && p1.class == obj.getClass()) {
                p1 p1Var = (p1) obj;
                if (this.f43736a == p1Var.f43736a && this.f43737b.equals(p1Var.f43737b)) {
                    return true;
                }
                return false;
            }
    ...
    public final int hashCode() {
        if (this.f43738c == 0) {
            this.f43738c = this.f43737b.hashCode();
        }
        return this.f43738c;
    }
