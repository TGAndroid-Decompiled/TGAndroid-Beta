...
public final class d implements d0, c0 {
    public final d0 f43370a;
    public c0 f43371b;
    public c[] f43372c = new c[0];
    public long d;
    public long e;
    public long f43373f;
    public g h;
    ...
    @Override
    public final long d() {
        long d = this.f43370a.d();
        if (d != Long.MIN_VALUE) {
            long j3 = this.f43373f;
    ...
    public final long h(long j3) {
        ...
        for (c cVar : this.f43372c) {
            if (cVar != null) {
                cVar.f43368b = false;
            }
        }
        long h = this.f43370a.h(j3);
        long j10 = this.e;
        long j11 = this.f43373f;
    ...
    @Override
    public final o1 r() {
        return this.f43370a.r();
    }

    @Override
    public final long s() {
        long s10 = this.f43370a.s();
    ...
    public final long t(long j3, i2.p1 p1Var) {
        ...
        return this.f43370a.t(j3, p1Var);
    }
