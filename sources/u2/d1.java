...
public final class d1 implements f1 {
    ...
    public final f1 a(int i10, int i11) {
        ...
        return new d1(iArr2, new Random(this.f43275a.nextLong()));
    }
    ...
    public final int c(int i10) {
        int i11 = this.f43277c[i10] - 1;
        if (i11 < 0) {
            return -1;
        }
        return this.f43276b[i11];
    }
    ...
    public final int getLength() {
        return this.f43276b.length;
    }

    @Override
    public final f1 h() {
        return new d1(new Random(this.f43275a.nextLong()));
    }

    public d1(int[] iArr, Random random) {
        this.f43276b = iArr;
        this.f43275a = random;
        this.f43277c = new int[iArr.length];
        for (int i10 = 0; i10 < iArr.length; i10++) {
            this.f43277c[iArr[i10]] = i10;
        }
    }
