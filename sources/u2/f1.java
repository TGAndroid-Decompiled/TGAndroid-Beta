...
public final class f1 implements h1 {
    public final Random f43656a;
    public final int[] f43657b;
    public final int[] f43658c;
    ...
    public final h1 a(int i10, int i11) {
        ...
        return new f1(iArr2, new Random(this.f43656a.nextLong()));
    }
    ...
    @Override
    public final h1 h() {
        return new f1(new Random(this.f43656a.nextLong()));
    }

    public f1(int[] iArr, Random random) {
        this.f43657b = iArr;
        this.f43656a = random;
        this.f43658c = new int[iArr.length];
        for (int i10 = 0; i10 < iArr.length; i10++) {
            this.f43658c[iArr[i10]] = i10;
        }
    }
