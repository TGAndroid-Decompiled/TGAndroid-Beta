...
public final class n1 implements d0, c0 {
    ...
    public final long h(long j3) {
        ...
        return this.f43733a.h(j3 - j10) + j10;
    }

    @Override
    public final void i(long j3) {
        this.f43733a.i(j3 - this.f43734b);
    }

    @Override
    public final void k(c0 c0Var, long j3) {
        this.f43735c = c0Var;
        this.f43733a.k(this, j3 - this.f43734b);
    }

    @Override
    public final long l() {
        long l4 = this.f43733a.l();
        if (l4 == -9223372036854775807L) {
            return -9223372036854775807L;
        }
        return l4 + this.f43734b;
    }
    ...
    public final boolean p(i2.s0 s0Var) {
        ...
        obj.f10854a = j3 - this.f43734b;
        return this.f43733a.p(new i2.s0(obj));
    }
    ...
    public final long q(x2.r[] rVarArr, boolean[] zArr, b1[] b1VarArr, boolean[] zArr2, long j3) {
        ...
        for (int i11 = 0; i11 < b1VarArr.length; i11++) {
            ...
            if (b1Var2 == null) {
                ...
                if (b1Var3 == null || ((m1) b1Var3).f43720a != b1Var2) {
    ...
    @Override
    public final p1 r() {
        return this.f43733a.r();
    }

    @Override
    public final long s() {
        long s10 = this.f43733a.s();
        if (s10 == Long.MIN_VALUE) {
            return Long.MIN_VALUE;
        }
        return s10 + this.f43734b;
    }

    @Override
    public final long t(long j3, i2.q1 q1Var) {
        long j10 = this.f43734b;
        return this.f43733a.t(j3 - j10, q1Var) + j10;
    }

    @Override
    public final void u(long j3) {
        this.f43733a.u(j3 - this.f43734b);
    }
}
