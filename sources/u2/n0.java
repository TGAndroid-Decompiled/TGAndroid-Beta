...
public final class n0 implements d0, c0 {
    public final d0[] f43733a;
    public final boolean[] f43734b;
    public final IdentityHashMap f43735c;
    public final ob.a d;
    public final ArrayList e = new ArrayList();
    public final HashMap f43736f = new HashMap();
    public c0 h;
    public p1 f43737n;
    public d0[] f43738r;
    public n f43739s;
    ...
    public n0(ob.a aVar, long[] jArr, d0... d0VarArr) {
        this.d = aVar;
        this.f43733a = d0VarArr;
        aVar.getClass();
        e9.g0 g0Var = e9.i0.f8084b;
        e9.a1 a1Var = e9.a1.e;
        this.f43739s = new n(a1Var, a1Var);
        this.f43735c = new IdentityHashMap();
        this.f43738r = new d0[0];
        this.f43734b = new boolean[d0VarArr.length];
        for (int i10 = 0; i10 < d0VarArr.length; i10++) {
            long j3 = jArr[i10];
            if (j3 != 0) {
                this.f43734b[i10] = true;
                this.f43733a[i10] = new o1(d0VarArr[i10], j3);
            }
        }
    }
    ...
    public final void b(d0 d0Var) {
        ...
        d0[] d0VarArr = this.f43733a;
        int i10 = 0;
        for (d0 d0Var2 : d0VarArr) {
            i10 += d0Var2.r().f43765a;
        }
        ...
        for (int i12 = 0; i12 < d0VarArr.length; i12++) {
            ...
            while (i14 < i13) {
                ...
                this.f43736f.put(l1Var, a2);
                l1VarArr[i11] = l1Var;
                i14++;
                i11++;
            }
        }
        this.f43737n = new p1(l1VarArr);
        c0 c0Var = this.h;
        c0Var.getClass();
        c0Var.b(this);
    }
    ...
    public final boolean c() {
        return this.f43739s.c();
    }

    @Override
    public final long d() {
        return this.f43739s.d();
    }

    @Override
    public final void g() {
        for (d0 d0Var : this.f43733a) {
            d0Var.g();
        }
    }
    ...
    public final long h(long j3) {
        long h = this.f43738r[0].h(j3);
        int i10 = 1;
        while (true) {
            d0[] d0VarArr = this.f43738r;
    ...
    public final long q(x2.s[] sVarArr, boolean[] zArr, c1[] c1VarArr, boolean[] zArr2, long j3) {
        ...
        while (i11 < d0VarArr.length) {
            ...
            while (i12 < sVarArr.length) {
                ...
                if (iArr3[i12] == i11) {
                    ...
                    sVar2.getClass();
                    iArr = iArr2;
                    b2.l1 l1Var = (b2.l1) this.f43736f.get(sVar2.b());
                    l1Var.getClass();
        ...
        this.f43738r = (d0[]) arrayList.toArray(new d0[0]);
        AbstractList w10 = e9.q.w(arrayList, new s0.b(17));
        this.d.getClass();
        this.f43739s = new n(arrayList, w10);
        return j10;
    }

    @Override
    public final p1 r() {
        p1 p1Var = this.f43737n;
        p1Var.getClass();
        return p1Var;
    }
