...
public final class o1 {
    ...
    public static final String f46801e;
    public final int f46802a;
    public final e9.a1 f46803b;
    public int f46804c;

    static {
        String str = e2.d0.f8765a;
        f46801e = Integer.toString(0, 36);
    }

    public o1(b2.l1... l1VarArr) {
        e9.a1 w10 = e9.i0.w(l1VarArr);
        this.f46803b = w10;
        this.f46802a = l1VarArr.length;
        int i10 = 0;
        while (i10 < w10.d) {
            int i11 = i10 + 1;
    ...
    public final b2.l1 a(int i10) {
        return (b2.l1) this.f46803b.get(i10);
    }

    public final int b(b2.l1 l1Var) {
        int indexOf = this.f46803b.indexOf(l1Var);
        if (indexOf >= 0) {
            return indexOf;
        }
        return -1;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj != null && o1.class == obj.getClass()) {
                o1 o1Var = (o1) obj;
                if (this.f46802a == o1Var.f46802a && this.f46803b.equals(o1Var.f46803b)) {
                    return true;
                }
                return false;
            }
    ...
    public final int hashCode() {
        if (this.f46804c == 0) {
            this.f46804c = this.f46803b.hashCode();
        }
        return this.f46804c;
    }

    public final String toString() {
        return this.f46803b.toString();
    }
}
