...
public final class o1 {
    ...
    public final b2.l1 a(int i10) {
        return (b2.l1) this.f43486b.get(i10);
    }

    public final int b(b2.l1 l1Var) {
        int indexOf = this.f43486b.indexOf(l1Var);
        if (indexOf >= 0) {
            return indexOf;
        }
        return -1;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj != null && o1.class == obj.getClass()) {
                o1 o1Var = (o1) obj;
                if (this.f43485a == o1Var.f43485a && this.f43486b.equals(o1Var.f43486b)) {
                    return true;
                }
                return false;
            }
    ...
    public final int hashCode() {
        if (this.f43487c == 0) {
            this.f43487c = this.f43486b.hashCode();
        }
        return this.f43487c;
    }

    public final String toString() {
        return this.f43486b.toString();
    }
}
