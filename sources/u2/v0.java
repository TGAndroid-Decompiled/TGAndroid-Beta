...
public final class v0 implements d0, c3.q, y2.h, y2.k, a1 {
    ...
    public final y2.m f43831x;
    public final lf.h f43832y;
    ...
    static {
        ...
        b2.r rVar = new b2.r();
        rVar.f3239a = "icy";
        rVar.f3252q = b2.r0.n("application/x-icy");
    ...
    public final void B() {
        s0 s0Var = new s0(this, this.f43817a, this.f43819b, this.f43832y, this, this.E);
        if (this.N) {
            e2.d.g(l());
            long j3 = this.S;
            ...
            c3.b0 b0Var = this.R;
            b0Var.getClass();
            long j10 = b0Var.j(this.f43820b0).f3710a.f3740b;
            long j11 = this.f43820b0;
            s0Var.f43799f.f3797a = j10;
            s0Var.f43801r = j11;
            s0Var.f43800n = true;
            s0Var.f43803w = false;
            for (b1 b1Var : this.K) {
                b1Var.f43653t = this.f43820b0;
            }
            this.f43820b0 = -9223372036854775807L;
        }
        this.f43823d0 = f();
        this.f43831x.f(s0Var, this, this.d.L3(this.U));
    }
    ...
    public final void S(y2.j jVar, long j3, long j10, boolean z10) {
        s0 s0Var = (s0) jVar;
        Uri uri = s0Var.f43797b.f9352c;
        t tVar = new t(j10);
        this.d.getClass();
        this.e.o(tVar, 1, -1, null, 0, null, s0Var.f43801r, this.S);
        if (!z10) {
            for (b1 b1Var : this.K) {
                b1Var.D(false);
            }
    ...
    public final void b() {
        ...
        lf.h hVar = this.f43832y;
        c3.o oVar = (c3.o) hVar.f14231c;
        if (oVar != null) {
            oVar.release();
            hVar.f14231c = null;
        }
    ...
    public final int f() {
        ...
        int i10 = 0;
        for (b1 b1Var : this.K) {
            i10 += b1Var.f43650q + b1Var.f43649p;
        }
        return i10;
    }
    ...
    public final k4.d n(y2.j r15, long r16, long r18, java.io.IOException r20, int r21) {
        throw new UnsupportedOperationException("Method not decompiled: u2.v0.n(y2.j, long, long, java.io.IOException, int):k4.d");
    }
    ...
    public final void o(y2.j jVar, long j3, long j10, int i10) {
        t tVar;
        s0 s0Var = (s0) jVar;
        g2.b0 b0Var = s0Var.f43797b;
        if (i10 == 0) {
            tVar = new t(s0Var.f43802s);
        } else {
            Uri uri = b0Var.f9352c;
            tVar = new t(j10);
        }
        this.e.s(tVar, 1, -1, null, 0, null, s0Var.f43801r, this.S, i10);
    }
    ...
    public final void p(y2.j jVar, long j3, long j10) {
        ...
        t tVar = new t(j10);
        this.d.getClass();
        this.e.p(tVar, 1, -1, null, 0, null, s0Var.f43801r, this.S);
        this.f43824e0 = true;
        c0 c0Var = this.I;
        c0Var.getClass();
        c0Var.l(this);
    ...
    public final long t() {
        ...
        if (this.O) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                com.google.firebase.messaging.t tVar = this.Q;
                if (((boolean[]) tVar.f7345c)[i10] && ((boolean[]) tVar.d)[i10]) {
                    b1 b1Var = this.K[i10];
                    synchronized (b1Var) {
                        z10 = b1Var.f43655w;
                    }
    ...
    public final long u(long j3, i2.p1 p1Var) {
        ...
        return p1Var.a(j3, j10.f3710a.f3739a, j10.f3711b.f3739a);
    }
    ...
    public final void w() {
        ...
        if (!this.f43826f0 && !this.N && this.M && this.R != null) {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                p3.b bVar = this.J;
                if (bVar != null) {
                    int i12 = bVar.f40852a;
                    if (i11 || this.L[i10].f43811b) {
                        b2.p0 p0Var = w10.f3302l;
                        if (p0Var == null) {
                            a2 = new b2.p0(bVar);
                        } else {
                            a2 = p0Var.a(bVar);
                    ...
                    if (i11 && w10.h == -1 && w10.f3299i == -1 && i12 != -1) {
                        b2.r a11 = w10.a();
                        a11.h = i12;
                        w10 = new b2.s(a11);
                    }
                }
                int M0 = this.f43821c.M0(w10);
                b2.r a12 = w10.a();
                a12.R = M0;
                b2.s sVar = new b2.s(a12);
                l1VarArr[i10] = new b2.l1(Integer.toString(i10), sVar);
                this.X = sVar.f3313x | this.X;
            }
    ...
    public final void x(int i10) {
        ...
        if (!zArr[i10]) {
            b2.s sVar = ((p1) tVar.f7344b).a(i10).d[0];
            this.e.k(b2.r0.h(sVar.f3308r), sVar, 0, null, this.f43818a0);
            zArr[i10] = true;
        }
    }
    ...
    public final void y(int i10) {
        e();
        if (this.f43822c0) {
            if ((!this.O || ((boolean[]) this.Q.f7345c)[i10]) && !this.K[i10].x(false)) {
                this.f43820b0 = 0L;
                this.f43822c0 = false;
                this.W = true;
                this.f43818a0 = 0L;
    ...
    public final c3.h0 z(u0 u0Var) {
        ...
        if (this.M) {
            e2.a.n("ProgressiveMediaPeriod", "Extractor added new track (id=" + u0Var.f43810a + ") after finishing tracks.");
            return new c3.n();
        }
        n2.m mVar = this.f43821c;
        mVar.getClass();
        b1 b1Var = new b1(this.f43827n, mVar, this.f43825f);
        b1Var.f43640f = this;
        int i11 = length + 1;
