    ...
    public static SpannableStringBuilder a(String str) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 24) {
                fromHtml = Html.fromHtml("<inject>" + str + "</inject>", 63, null, new m(new d7.u(8)));
            } else {
                fromHtml = Html.fromHtml("<inject>" + str + "</inject>", null, new m(new d7.u(8)));
            }
            if (fromHtml == null) {
                return null;
            }
            ...
            for (Object obj : spans) {
                ...
                if (obj instanceof StyleSpan) {
                    ...
                    if (i9 == 0) {
                        ...
                        if (!TextUtils.isEmpty(nVar.f6241b)) {
                            arrayList2.add(nVar);
                        } else {
            ...
            for (int i10 = 0; i10 < arrayList2.size(); i10++) {
                ...
                spannableStringBuilder.setSpan(new CodeHighlighting.Span(true, 0, null, nVar2.f6241b, spannableStringBuilder.subSequence(spanStart3, spanEnd3).toString()), spanStart3, spanEnd3, 33);
            }
            for (int i11 = 0; i11 < arrayList3.size(); i11++) {
                n nVar3 = (n) arrayList3.get(i11);
                int spanStart4 = fromHtml.getSpanStart(nVar3);
                int spanEnd4 = fromHtml.getSpanEnd(nVar3);
                if (nVar3.f6240a == 3) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                fi0.c(spannableStringBuilder, spanStart4, spanEnd4, z10);
            }
