    ...
    public final void run() {
        switch (this.f29a) {
            case 0:
                ...
                return;
            case 1:
                CredentialProviderPlayServicesImpl.m1$r8$lambda$AHEPAGD45gIS5fVQxoF8ULIdY(this.f30b);
                return;
            case 2:
                CredentialProviderPlayServicesImpl.m2$r8$lambda$CzTvhVIglA1BRk85Mc5RmIPn9A(this.f30b);
                return;
            case 3:
                CredentialProviderPlayServicesImpl.$r8$lambda$5b_NZniORttBMkbFQZx_nT7Z9tM(this.f30b);
                return;
            case 4:
                CredentialProviderPlayServicesImpl.m4$r8$lambda$VaWGKHMq8i7ItapkClFK107fk(this.f30b);
                return;
            case 5:
