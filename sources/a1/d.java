...
public final class d implements OnFailureListener, oy, a2, d5, tc0, MediaDataController.KeywordResultCallback, MessagesStorage.LongCallback, Utilities.Callback2Return, m, BillingController.ProductDetailsResponseListenerLegacy {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        switch (this.f39a) {
            ...
            case 8:
                ...
                tnVar.f30670j0.d((TLRPC.TL_messageMediaPoll) this.f40b, tnVar.O, tnVar.l1, (ArrayList) this.f41c, z10, i10, ((Long) this.d).longValue());
    ...
    public void g(b2 b2Var, int i10) {
        ...
        switch (i11) {
            ...
            case 14:
                ...
                notificationsCustomSettingsActivity.getNotificationsController().updateServerNotificationsSettings(notificationsCustomSettingsActivity.f33508s);
                return;
            default:
                eg1 eg1Var = (eg1) obj4;
    ...
    public Object run(Object obj, Object obj2) {
        ...
        textView.setTextColor(j6.v0(j6.f20798j5, f6Var));
