...
import yh.v5;
import zg.p0;
public final class d implements OnFailureListener, oy, a2, b5, sc0, MediaDataController.KeywordResultCallback, MessagesStorage.LongCallback, Utilities.Callback2Return, m, BillingController.ProductDetailsResponseListenerLegacy {
    ...
    public void J(int i10, int i11, boolean z10) {
        ...
        switch (this.f36a) {
            case 4:
                bo.y0((bo) this.e, (TLRPC.TL_document) this.f37b, (String) this.f38c, this.d, z10, i10);
                return;
            case 8:
                un unVar = (un) this.e;
                unVar.f28451j0.e((TLRPC.TL_messageMediaPoll) this.f37b, unVar.O, unVar.l1, (ArrayList) this.f38c, z10, i10, ((Long) this.d).longValue());
                unVar.f26462b.dismiss(true);
                return;
            case 9:
                qt qtVar = (qt) this.e;
                ...
                return;
            default:
                ((qt) this.e).m((TLRPC.Document) this.f37b, (String) this.f38c, this.d, z10, i10, i11);
                return;
        }
    }
    ...
    public void f(b2 b2Var, int i10) {
        ...
        switch (i11) {
            ...
            case 14:
                ...
                notificationsCustomSettingsActivity.getNotificationsController().updateServerNotificationsSettings(notificationsCustomSettingsActivity.f30870s);
                return;
            default:
                dg1 dg1Var = (dg1) obj4;
                ...
                vc.a0(dg1Var).U(LocaleController.getPluralString("TopicsDeleted", hashSet.size()), false, new bf1(dg1Var, 4), new xd1(dg1Var, (ArrayList) obj2, (Runnable) obj, 4)).j();
                dg1Var.C0();
                b2Var.dismiss();
                return;
        }
    ...
    public void onFailure(Exception e) {
        switch (this.f36a) {
            case 0:
                CredentialProviderPlayServicesImpl.runFallbackClearCredFlow$lambda$27((CredentialProviderPlayServicesImpl) this.e, (CancellationSignal) this.f37b, (Executor) this.f38c, (i) this.d, e);
                return;
            default:
                kotlin.jvm.internal.i.e(e, "e");
                b1.b bVar = new b1.b((e1.d) this.e, e, (Executor) this.f38c, (i) this.d);
    ...
    public void onProductDetailsResponse(h hVar, List list) {
        switch (this.f36a) {
            case 21:
                AndroidUtilities.runOnUIThread(new u(list, (Utilities.Callback2) this.e, (TLRPC.TL_inputStorePaymentStarsTopup) this.f37b, (TL_stars.TL_starsTopupOption) this.f38c, (Activity) this.d, 7));
                return;
            default:
                AndroidUtilities.runOnUIThread(new z8((v5) this.e, list, (m0) this.f37b, (TLRPC.TL_inputStorePaymentStarsGiveaway) this.f38c, hVar, (Activity) this.d, 18));
                return;
        }
    }
    ...
    public void q(uc0 uc0Var, int i10) {
        ...
        uc0 uc0Var2 = (uc0) this.f37b;
        n40 n40Var = (n40) this.f38c;
    ...
    public void run(long j3) {
        q71.P((q71) this.e, (TLRPC.User) this.f37b, (TLRPC.InputCheckPasswordSRP) this.f38c, (TwoStepVerificationActivity) this.d, j3);
    }
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, dg1 dg1Var) {
        switch (this.f36a) {
            case 2:
                ...
                Activity activity = k3Var.f8435k0;
                if (activity instanceof LaunchActivity) {
                    ...
                    if (MessagesController.getInstance(k3Var.G).checkCanOpenChat(i12, lastFragment)) {
                        zc0Var.dismiss();
                        k3Var.f8426c0 = true;
                        AndroidUtilities.cancelRunOnUIThread(k3Var.f8446t0);
                        k3Var.f8451x.i();
                ...
                return true;
            case 6:
                h8.t((h8) this.e, (ArrayList) this.f37b, (TLRPC.TL_document) this.f38c, (MessageObject) this.d, uyVar, arrayList, charSequence, z11, i10);
                return true;
            default:
    ...
    public Object run(Object obj, Object obj2) {
        ...
        textView.setTextColor(i6.v0(i6.f18943j5, e6Var));
                        ...
                        try {
                            if (!((MediaDataController.KeywordResult) arrayList.get(i10)).emoji.startsWith("animated_")) {
                                ...
                                for (int i11 = 0; i11 < availableEffects.effects.size(); i11++) {
                                    ...
                                    if (!hashSet.contains(Long.valueOf(tL_availableEffect.f18143id)) && (tL_availableEffect.emoticon.contains(fixEmoji) || fixEmoji.contains(tL_availableEffect.emoticon))) {
                                        (tL_availableEffect.effect_animation_id == 0 ? arrayList2 : arrayList3).add(p0.e(tL_availableEffect));
                                        hashSet.add(Long.valueOf(tL_availableEffect.f18143id));
                                    }
                                }
                            }
                        } catch (Exception unused) {
