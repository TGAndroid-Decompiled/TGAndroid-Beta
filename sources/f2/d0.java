    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f5747a) {
            ...
            case 3:
                ...
                k4Var.f17353e = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                k4Var.invalidate();
                return;
            case 4:
                r7 r7Var = (r7) this.f5748b;
                r7Var.f23591y0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                r7Var.invalidate();
                return;
            case 5:
                ...
                return;
            case 6:
                mh.d1 d1Var = ((d70) this.f5748b).f26207e.d;
                int i10 = d1Var.B1;
            ...
            case 7:
                ...
                if (m81Var.f28993x) {
                    ...
                    c81 c81Var = m81Var.J;
                    if (c81Var != null) {
                        c81Var.e(abs, m81Var.d, m81Var.f28985b);
                    }
                }
                m81Var.w(false);
                return;
            case 8:
                ...
                t1Var.G = floatValue;
                s1 s1Var = t1Var.f32338f0;
                if (s1Var != null) {
                    ((kh1) s1Var).f38416b.f35819a0.d(floatValue, t1Var.M);
                }
                t1Var.invalidate();
                return;
            case 9:
                ph.l lVar = (ph.l) this.f5748b;
                lVar.f44393c = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                lVar.f44395f.invalidate();
                return;
            case 10:
                qh.x xVar = (qh.x) this.f5748b;
                xVar.f46253l = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                xVar.f46257p.invalidate();
                return;
            case 11:
                uf.x0 x0Var = (uf.x0) this.f5748b;
                x0Var.f48737e = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                x0Var.invalidate();
                for (int i11 = 0; i11 < 2; i11++) {
                    x0Var.f48736c[i11].setTranslationX(AndroidUtilities.lerp(0, -AndroidUtilities.dp(62.0f), x0Var.f48737e));
                    x0Var.f48736c[i11].setVisibility(0);
                    TextView textView = x0Var.f48736c[i11];
                    float f13 = 0.0f;
                    if (i11 == 0) {
                        f10 = 1.0f;
                    } else {
                    ...
                    textView.setAlpha(AndroidUtilities.lerp(f10, f11, x0Var.f48737e));
                    x0Var.d[i11].setTranslationX(AndroidUtilities.lerp(0, -AndroidUtilities.dp(62.0f), x0Var.f48737e));
                    ...
                    textView2.setAlpha(AndroidUtilities.lerp(f12, f13, x0Var.f48737e));
                }
                return;
            case 12:
