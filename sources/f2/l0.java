...
public final class l0 extends androidx.emoji2.text.g {
    ...
    public final int b(View view) {
        ...
        switch (this.d) {
            case 0:
                ...
                ((i0) this.f773b).getClass();
                Rect rect = ((w0) view.getLayoutParams()).f5848b;
    ...
    public final int e() {
        switch (this.d) {
            case 0:
                return ((i0) this.f773b).f5845m;
            default:
                return ((i0) this.f773b).f5846n;
        }
    }
    ...
    public final int f() {
        ...
        switch (this.d) {
            case 0:
                i0 i0Var = (i0) this.f773b;
                i10 = i0Var.f5845m;
                E = i0Var.E();
                break;
            default:
                i0 i0Var2 = (i0) this.f773b;
                i10 = i0Var2.f5846n;
                E = i0Var2.C();
                break;
        }
    ...
    public final int g() {
        switch (this.d) {
            case 0:
                return ((i0) this.f773b).E();
            default:
                return ((i0) this.f773b).C();
        }
    }
    ...
    public final int h() {
        switch (this.d) {
            case 0:
                return ((i0) this.f773b).f5843k;
            default:
                return ((i0) this.f773b).f5844l;
        }
    }
    ...
    public final int j() {
        switch (this.d) {
            case 0:
                return ((i0) this.f773b).D();
            default:
                return ((i0) this.f773b).J();
        }
    }
    ...
    public final int k() {
        switch (this.d) {
            case 0:
                i0 i0Var = (i0) this.f773b;
                return (i0Var.f5845m - i0Var.D()) - i0Var.E();
            default:
                return ((i0) this.f773b).K();
        }
    }
    ...
    public final int l(View view) {
        switch (this.d) {
            case 0:
                Rect rect = (Rect) this.f774c;
                ((i0) this.f773b).L(view, rect);
                return rect.right;
            default:
                Rect rect2 = (Rect) this.f774c;
                ((i0) this.f773b).L(view, rect2);
                return rect2.bottom;
        }
    }
    ...
    public final void n(int i10) {
        switch (this.d) {
            case 0:
                RecyclerView recyclerView = ((i0) this.f773b).f5837b;
                ...
                return;
            default:
                RecyclerView recyclerView2 = ((i0) this.f773b).f5837b;
