...
public abstract class p {
    ...
    public static f2.i f(a4.h r19, boolean r20, int r21, f2.i r22) {
        throw new UnsupportedOperationException("Method not decompiled: f2.p.f(a4.h, boolean, int, f2.i):f2.i");
    }
    ...
    public static f2.l h(byte[] r32, int r33, int r34, fg.f r35) {
        throw new UnsupportedOperationException("Method not decompiled: f2.p.h(byte[], int, int, fg.f):f2.l");
    }

    public static fg.f i(int r40, int r41, byte[] r42) {
        throw new UnsupportedOperationException("Method not decompiled: f2.p.i(int, int, byte[]):fg.f");
    }

    public static f2.o j(int r30, int r31, byte[] r32) {
        throw new UnsupportedOperationException("Method not decompiled: f2.p.j(int, int, byte[]):f2.o");
    }
