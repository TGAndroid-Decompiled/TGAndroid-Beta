...
public abstract class o {
    public static final byte[] f8845a = {0, 0, 0, 1};
    public static final float[] f8846b = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};
    ...
    public static boolean c(byte[] bArr, int i10, b2.s sVar) {
        int i11;
        if (Objects.equals(sVar.f3304r, "video/avc")) {
            byte b10 = bArr[4];
            if (((b10 & 96) >> 5) == 0 && ((i11 = b10 & 31) == 1 || i11 == 9 || i11 == 14)) {
                return false;
            }
        } else if (Objects.equals(sVar.f3304r, "video/hevc")) {
    ...
    public static int d(b2.s sVar) {
        ...
        if (!Objects.equals(sVar.f3304r, "video/hevc") && r0.b(sVar.f3297k, "video/hevc") == null) {
            return 0;
        }
        return 2;
    }
