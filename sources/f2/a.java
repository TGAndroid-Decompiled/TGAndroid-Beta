...
public final class a implements o0 {
    ...
    public final ArrayList d() {
        e2.d.f("Metadata is not an auxiliary tracks map", this.f8792a.equals("auxiliary.tracks.map"));
        byte[] bArr = this.f8793b;
        byte b10 = bArr[1];
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && a.class == obj.getClass()) {
            a aVar = (a) obj;
            if (this.f8792a.equals(aVar.f8792a) && Arrays.equals(this.f8793b, aVar.f8793b) && this.f8794c == aVar.f8794c && this.d == aVar.d) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return ((((Arrays.hashCode(this.f8793b) + a4.a.h(527, 31, this.f8792a)) * 31) + this.f8794c) * 31) + this.d;
    }
