...
public abstract class v0 {
    ...
    public static int s(boolean r4, int r5, int r6, int r7, int r8) {
        throw new UnsupportedOperationException("Method not decompiled: f2.v0.s(boolean, int, int, int, int):int");
    }

    public static int v(View view) {
        return view.getBottom() + ((w0) view.getLayoutParams()).f5848b.bottom;
    }

    public static void w(View view, Rect rect) {
        int[] iArr = RecyclerView.M0;
        w0 w0Var = (w0) view.getLayoutParams();
        Rect rect2 = w0Var.f5848b;
    ...
    public static int x(View view) {
        return view.getLeft() - ((w0) view.getLayoutParams()).f5848b.left;
    }
    ...
    public static int y(View view) {
        return view.getRight() + ((w0) view.getLayoutParams()).f5848b.right;
    }

    public static int z(View view) {
        return view.getTop() - ((w0) view.getLayoutParams()).f5848b.top;
    }
    ...
    public int I(af.h hVar, i1 i1Var) {
        RecyclerView recyclerView = this.f5837b;
        if (recyclerView != null && recyclerView.f1259w != null && e()) {
            return this.f5837b.f1259w.h();
        }
        return 1;
    }
    ...
    public int K() {
        return (this.f5846n - F()) - C();
    }

    public final void L(View view, Rect rect) {
        Matrix matrix;
        Rect rect2 = ((w0) view.getLayoutParams()).f5848b;
        rect.set(-rect2.left, -rect2.top, view.getWidth() + rect2.right, view.getHeight() + rect2.bottom);
        if (this.f5837b != null && (matrix = view.getMatrix()) != null && !matrix.isIdentity()) {
            RectF rectF = this.f5837b.v;
            rectF.set(rect);
    ...
    public final void M(View view) {
        ...
        if (parent == recyclerView && recyclerView.indexOfChild(view) != -1) {
            l1 U = RecyclerView.U(view);
            U.a(128);
            this.f5837b.f1239f.c0(U);
            return;
        }
        throw new IllegalArgumentException("View should be fully attached to be ignored" + this.f5837b.C());
    }

    public void P(View view) {
        w0 w0Var = (w0) view.getLayoutParams();
        Rect W = this.f5837b.W(view);
        int i10 = W.left + W.right;
        int i11 = W.top + W.bottom;
        int s6 = s(d(), this.f5845m, this.f5843k, E() + D() + ((ViewGroup.MarginLayoutParams) w0Var).leftMargin + ((ViewGroup.MarginLayoutParams) w0Var).rightMargin + i10, ((ViewGroup.MarginLayoutParams) w0Var).width);
        int s9 = s(e(), this.f5846n, this.f5844l, C() + F() + ((ViewGroup.MarginLayoutParams) w0Var).topMargin + ((ViewGroup.MarginLayoutParams) w0Var).bottomMargin + i11, ((ViewGroup.MarginLayoutParams) w0Var).height);
    ...
    public void S(af.h hVar, i1 i1Var, s0.d dVar) {
        ...
        if (this.f5837b.canScrollVertically(-1) || this.f5837b.canScrollHorizontally(-1)) {
            dVar.a(8192);
    ...
    public void T(af.h hVar, i1 i1Var, View view, s0.d dVar) {
        ...
        dVar.f43969a.setCollectionItemInfo(AccessibilityNodeInfo.CollectionItemInfo.obtain(i10, 1, i11, 1, false, false));
    }

    public final void U(View view, s0.d dVar) {
        l1 U = RecyclerView.U(view);
        if (U != null && !U.j()) {
            af.d dVar2 = this.f5836a;
            if (!((ArrayList) dVar2.d).contains(U.f5774a)) {
                RecyclerView recyclerView = this.f5837b;
                T(recyclerView.f1233b, recyclerView.f1251q0, view, dVar);
            }
        }
    }
    ...
    public final void a(View view, int i10, boolean z4) {
        ...
        l1 U = RecyclerView.U(view);
        if (!z4 && !U.j()) {
            this.f5837b.f1239f.b0(U);
        } else {
            a0.f fVar = (a0.f) this.f5837b.f1239f.f156b;
        ...
        w0 w0Var = (w0) view.getLayoutParams();
        if (!U.s() && !U.k()) {
            if (view.getParent() == this.f5837b) {
                af.d dVar = this.f5836a;
                c cVar = (c) dVar.f160c;
                int indexOfChild = ((RecyclerView) ((bb.b) dVar.f159b).f1772b).indexOfChild(view);
                if (indexOfChild == -1 || cVar.x(indexOfChild)) {
                    u10 = -1;
                } else {
                    u10 = indexOfChild - cVar.u(indexOfChild);
                }
                if (i10 == -1) {
                    i10 = this.f5836a.p();
                }
                if (u10 != -1) {
                    if (u10 != i10) {
                        ...
                        if (q10 != null) {
                            ...
                            if (U2.j()) {
                                a0.f fVar2 = (a0.f) v0Var.f5837b.f1239f.f156b;
                                q1 q1Var2 = (q1) fVar2.get(U2);
                                if (q1Var2 == null) {
                                    q1Var2 = q1.a();
                                    fVar2.put(U2, q1Var2);
                                }
                                q1Var2.f5813a = 1 | q1Var2.f5813a;
                            } else {
                                v0Var.f5837b.f1239f.b0(U2);
                            }
                            v0Var.f5836a.g(q10, i10, w0Var2, U2.j());
                        } else {
                            throw new IllegalArgumentException("Cannot move a child from non-existing index:" + u10 + v0Var.f5837b.toString());
                        }
                    }
                } else {
                    throw new IllegalStateException("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:" + this.f5837b.indexOfChild(view) + this.f5837b.C());
                }
            } else {
                this.f5836a.f(view, i10, false);
                w0Var.f5849c = true;
                h1 h1Var = this.e;
                if (h1Var != null && h1Var.e) {
                    h1Var.f5713b.getClass();
                    if (RecyclerView.S(view) == h1Var.f5712a) {
                        h1Var.f5715f = view;
                    }
                }
            }
            ...
            this.f5836a.g(view, i10, view.getLayoutParams(), false);
        }
        if (w0Var.d) {
            U.f5774a.invalidate();
            w0Var.d = false;
    ...
    public final void h0(af.h hVar) {
        ArrayList arrayList = (ArrayList) hVar.f175c;
        int size = ((ArrayList) hVar.f175c).size();
        for (int i10 = size - 1; i10 >= 0; i10--) {
            View view = ((l1) arrayList.get(i10)).f5774a;
            l1 U = RecyclerView.U(view);
            if (!U.r()) {
                U.q(false);
                if (U.l()) {
                    this.f5837b.removeDetachedView(view, false);
                }
                t0 t0Var = this.f5837b.W;
                if (t0Var != null) {
                    t0Var.f(U);
                }
                U.q(true);
        ...
        arrayList.clear();
        ArrayList arrayList2 = (ArrayList) hVar.d;
        if (arrayList2 != null) {
            arrayList2.clear();
        }
        if (size > 0) {
            this.f5837b.invalidate();
        }
    }
    ...
    public final void j0(int i10) {
        if (q(i10) != null) {
            ...
            View childAt = ((RecyclerView) bVar.f1772b).getChildAt(t6);
            if (childAt != null) {
                if (((c) dVar.f160c).z(t6)) {
                    dVar.C(childAt);
                }
                bVar.Q(t6);
            }
    ...
    public final boolean k0(androidx.recyclerview.widget.RecyclerView r8, android.view.View r9, android.graphics.Rect r10, boolean r11, boolean r12) {
        throw new UnsupportedOperationException("Method not decompiled: f2.v0.k0(androidx.recyclerview.widget.RecyclerView, android.view.View, android.graphics.Rect, boolean, boolean):boolean");
    }
    ...
    public final void q0(int i10, int i11) {
        this.f5845m = View.MeasureSpec.getSize(i10);
        int mode = View.MeasureSpec.getMode(i10);
        this.f5843k = mode;
        if (mode == 0 && !RecyclerView.N0) {
            this.f5845m = 0;
        }
        this.f5846n = View.MeasureSpec.getSize(i11);
    ...
    public void r0(Rect rect, int i10, int i11) {
        ...
        this.f5837b.setMeasuredDimension(g(i10, E, recyclerView.getMinimumWidth()), g(i11, C, this.f5837b.getMinimumHeight()));
    }
    ...
    public final void s0(int i10, int i11) {
        ...
        this.f5837b.f1252r.set(i14, i15, i12, i13);
        r0(this.f5837b.f1252r, i10, i11);
    }
    ...
    public final void t0(RecyclerView recyclerView) {
        if (recyclerView == null) {
            ...
            this.f5836a = recyclerView.e;
            this.f5845m = recyclerView.getWidth();
            this.f5846n = recyclerView.getHeight();
        }
        this.f5843k = 1073741824;
        this.f5844l = 1073741824;
    }

    public int u(af.h hVar, i1 i1Var) {
        RecyclerView recyclerView = this.f5837b;
        if (recyclerView != null && recyclerView.f1259w != null && d()) {
            return this.f5837b.f1259w.h();
        }
        return 1;
    }
    ...
    public final boolean u0(View view, int i10, int i11, w0 w0Var) {
        if (!view.isLayoutRequested() && this.f5840g && N(view.getWidth(), i10, ((ViewGroup.MarginLayoutParams) w0Var).width) && N(view.getHeight(), i11, ((ViewGroup.MarginLayoutParams) w0Var).height)) {
            return false;
        }
        return true;
    }
    ...
    public final void w0(h1 h1Var) {
        ...
        h1Var.f5713b = recyclerView;
        h1Var.f5714c = this;
        int i10 = h1Var.f5712a;
        if (i10 != -1) {
            recyclerView.f1251q0.f5731a = i10;
            h1Var.e = true;
            h1Var.d = true;
            h1Var.f5715f = recyclerView.f1261x.m(i10);
            h1Var.e();
            h1Var.f5713b.f1248n0.a();
            h1Var.h = true;
            return;
        }
