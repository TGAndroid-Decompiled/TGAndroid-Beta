...
public final class s implements Runnable {
    ...
    public static final b7.r f5830f = new b7.r(3);
    ...
    public final void a(RecyclerView recyclerView, int i10, int i11) {
        if (recyclerView.D && this.f5832b == 0) {
    ...
    public final void b(long j10) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            androidx.datastore.preferences.protobuf.i iVar = recyclerView3.f1239p0;
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            if (recyclerView4.getWindowVisibility() == 0) {
                androidx.datastore.preferences.protobuf.i iVar2 = recyclerView4.f1239p0;
                int abs = Math.abs(iVar2.f672b) + Math.abs(iVar2.f671a);
                for (int i14 = 0; i14 < iVar2.f673c * 2; i14 += 2) {
        ...
        for (int i16 = 0; i16 < arrayList.size() && (recyclerView = (rVar = (r) arrayList.get(i16)).d) != null; i16++) {
            ...
            if (c3 != null && c3.f5786b != null && c3.g() && !c3.h() && (recyclerView2 = (RecyclerView) c3.f5786b.get()) != null) {
                if (recyclerView2.N && recyclerView2.e.v() != 0) {
                    recyclerView2.o0();
                }
                androidx.datastore.preferences.protobuf.i iVar3 = recyclerView2.f1239p0;
                iVar3.b(recyclerView2, true);
                if (iVar3.f673c != 0) {
                    try {
                        int i17 = n0.g.f14206a;
                        Trace.beginSection("RV Nested Prefetch");
                        i1 i1Var = recyclerView2.f1240q0;
                        o0 o0Var = recyclerView2.f1248w;
                        i1Var.d = 1;
                        i1Var.e = o0Var.h();
                        i1Var.f5746g = false;
                        i1Var.h = false;
                        i1Var.f5747i = false;
                        for (int i18 = 0; i18 < iVar3.f673c * 2; i18 += 2) {
    ...
    public final void run() {
        ...
        try {
            ...
            if (!arrayList.isEmpty()) {
                ...
                if (j10 != 0) {
                    b(TimeUnit.MILLISECONDS.toNanos(j10) + this.f5833c);
                }
            }
            this.f5832b = 0L;
            Trace.endSection();
