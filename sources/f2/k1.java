...
public final class k1 implements Runnable {
    ...
    public k1(RecyclerView recyclerView) {
        ...
        this.e = false;
        this.f5761f = false;
        this.f5760c = new OverScroller(recyclerView.getContext(), a0Var);
    }
    ...
    public final void b(int i10, int i11, int i12, Interpolator interpolator) {
        ...
        if (this.d != interpolator) {
            this.d = interpolator;
            this.f5760c = new OverScroller(recyclerView.getContext(), interpolator);
        }
        this.f5759b = 0;
        this.f5758a = 0;
        recyclerView.setScrollState(2);
        this.f5760c.startScroll(0, 0, i10, i11, i15);
        if (Build.VERSION.SDK_INT < 23) {
            this.f5760c.computeScrollOffset();
        }
        a();
    }
    ...
    public final void run() {
        ...
        if (recyclerView.f1261x == null) {
            recyclerView.K0 = true;
            recyclerView.removeCallbacks(this);
            this.f5760c.abortAnimation();
            return;
        }
        this.f5761f = false;
        this.e = true;
        recyclerView.p();
        OverScroller overScroller = this.f5760c;
        recyclerView.L0 = true;
        if (overScroller.computeScrollOffset()) {
            int currX = overScroller.getCurrX();
            int currY = overScroller.getCurrY();
            int i15 = currX - this.f5758a;
            int i16 = currY - this.f5759b;
            this.f5758a = currX;
            this.f5759b = currY;
            ...
            if (recyclerView.f1259w != null) {
                ...
                i10 -= i12;
                i11 -= i13;
                h1 h1Var = recyclerView.f1261x.e;
                if (h1Var != null && !h1Var.d && h1Var.e) {
                    int b10 = recyclerView.f1251q0.b();
                    if (b10 == 0) {
                        h1Var.h();
                    } else if (h1Var.f5712a >= b10) {
                        h1Var.f5712a = b10 - 1;
                        h1Var.c(i12, i13);
                    } else {
                        h1Var.c(i12, i13);
            ...
            if (!recyclerView.f1263y.isEmpty()) {
            ...
            h1 h1Var2 = recyclerView.f1261x.e;
        ...
        h1 h1Var3 = recyclerView.f1261x.e;
