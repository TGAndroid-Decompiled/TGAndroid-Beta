...
public class w extends i0 {
    ...
    public final void A0(i1 i1Var, g0 g0Var, androidx.datastore.preferences.protobuf.i iVar) {
        ...
        for (int i11 = 0; i11 < this.J && g0Var.b(i1Var) && i10 > 0; i11++) {
            int i12 = g0Var.d;
            iVar.a(i12, Math.max(0, g0Var.f5695g));
            i10 -= this.O.i(i12);
            g0Var.d += g0Var.e;
        }
    }
    ...
    @Override
    public final android.view.View R(android.view.View r23, int r24, af.h r25, f2.i1 r26) {
        throw new UnsupportedOperationException("Method not decompiled: f2.w.R(android.view.View, int, af.h, f2.i1):android.view.View");
    }
    ...
    public void V(RecyclerView recyclerView, int i10, int i11) {
        this.O.j();
        ((SparseIntArray) this.O.f5835b).clear();
    }
    ...
    @Override
    public void Z0(af.h r18, f2.i1 r19, f2.g0 r20, f2.f0 r21) {
        throw new UnsupportedOperationException("Method not decompiled: f2.w.Z0(af.h, f2.i1, f2.g0, f2.f0):void");
    }
    ...
    public final void a1(af.h hVar, i1 i1Var, b4.v vVar, int i10) {
        boolean z4;
        A1();
        if (i1Var.b() > 0 && !i1Var.f5735g) {
            if (i10 == 1) {
                z4 = true;
            } else {
                z4 = false;
            }
            int u12 = u1(vVar.f1539b, hVar, i1Var);
            if (z4) {
                while (u12 > 0) {
                    int i11 = vVar.f1539b;
                    if (i11 <= 0) {
    ...
    public void b0(af.h hVar, i1 i1Var) {
        ...
        if (z4) {
            ...
            for (int i10 = 0; i10 < r10; i10++) {
                ...
                int b10 = uVar.b();
                sparseIntArray2.put(b10, uVar.f5833f);
    ...
    public final void r0(Rect rect, int i10, int i11) {
        ...
        if (this.f5720o == 1) {
            ...
            int[] iArr = this.K;
            g10 = v0.g(i10, iArr[iArr.length - 1] + E, this.f5837b.getMinimumWidth());
        } else {
            ...
            int[] iArr2 = this.K;
            g11 = v0.g(i11, iArr2[iArr2.length - 1] + C, this.f5837b.getMinimumHeight());
        }
        this.f5837b.setMeasuredDimension(g10, g11);
    }
    ...
    public void w1(View view, int i10, boolean z4) {
        ...
        int s12 = s1(uVar.e, uVar.f5833f);
        if (this.f5720o == 1) {
            i12 = v0.s(false, s12, i10, i14, ((ViewGroup.MarginLayoutParams) uVar).width);
            i11 = v0.s(true, this.f5722q.k(), this.f5844l, i13, ((ViewGroup.MarginLayoutParams) uVar).height);
        } else {
            int s6 = v0.s(false, s12, i10, i13, ((ViewGroup.MarginLayoutParams) uVar).height);
            int s9 = v0.s(true, this.f5722q.k(), this.f5843k, i14, ((ViewGroup.MarginLayoutParams) uVar).width);
            i11 = s6;
            i12 = s9;
        }
        x1(i12, i11, view, z4);
    ...
    public final void x1(int i10, int i11, View view, boolean z4) {
        ...
        if (z4) {
            if (this.f5840g && v0.N(view.getMeasuredWidth(), i10, ((ViewGroup.MarginLayoutParams) w0Var).width) && v0.N(view.getMeasuredHeight(), i11, ((ViewGroup.MarginLayoutParams) w0Var).height)) {
                u02 = false;
            } else {
                u02 = true;
            }
