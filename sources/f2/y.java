...
public final class y implements z0 {
    ...
    public final void a(RecyclerView recyclerView, MotionEvent motionEvent) {
        switch (this.f5955a) {
            case 0:
                ...
                ((GestureDetector) f0Var.K.f22788b).onTouchEvent(motionEvent);
    ...
    public final boolean b(RecyclerView recyclerView, MotionEvent motionEvent) {
        ...
        switch (this.f5955a) {
            ...
            default:
                ...
                tl0 tl0Var = (tl0) this.f5956b;
                Rect rect = tl0Var.D1;
                if (tl0Var.getScrollState() == 0) {
                    z4 = true;
                } else {
                    z4 = false;
                }
                if ((actionMasked2 == 0 || actionMasked2 == 5) && tl0Var.K1 == null && z4) {
                    ...
                    if ((tl0Var.f31373h1 || itemAnimator == null || !itemAnimator.k()) && tl0Var.E0(y10) && (E = tl0Var.E(x10, y10)) != null && tl0Var.F0(E)) {
                        tl0Var.K1 = E;
                    }
                ...
                if (actionMasked2 != 0 && actionMasked2 != 5) {
                    if ((actionMasked2 == 1 || actionMasked2 == 6 || actionMasked2 == 3 || !z4) && tl0Var.K1 != null) {
    ...
    public y(tl0 tl0Var, Context context) {
        ...
        tl0Var.J1 = aiVar;
        ((m20) aiVar.f25265b).f28913t = false;
    }
