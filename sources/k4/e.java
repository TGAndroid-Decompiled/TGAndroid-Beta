...
public abstract class e {
    public static final byte[] f13437a = {0, 0, 0, 0, 16, 0, Byte.MIN_VALUE, 0, 0, -86, 0, 56, -101, 113};
    public static final byte[] f13438b = {0, 0, 33, 7, -45, 17, -122, 68, -56, -63, -54, 0, 0, 0};

    public static boolean a(p pVar) {
        v vVar = new v(8);
        int i10 = d.b(pVar, vVar).f13435a;
