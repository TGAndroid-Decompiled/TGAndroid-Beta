...
public final class a implements b {
    public static final int[] f13406m = {-1, -1, -1, -1, 2, 4, 6, 8, -1, -1, -1, -1, 2, 4, 6, 8};
    public static final int[] f13407n = {7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, 118, 130, 143, 157, 173, 190, 209, 230, 253, 279, 307, 337, 371, 408, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
    public final q f13408a;
    public final h0 f13409b;
    public final e2.q f13410c;
    public final int d;
    public final byte[] e;
    public final v f13411f;
    ...
    public final void c(int i10, long j3) {
        this.f13408a.X1(new f(this.f13410c, this.d, i10, j3));
        this.f13409b.b(this.h);
    }

    public final void d(int i10) {
        long j3 = this.f13414j;
        long j10 = this.f13416l;
        e2.q qVar = this.f13410c;
        long j11 = qVar.f7906b;
        String str = d0.f7871a;
        long Y = j3 + d0.Y(j10, 1000000L, j11, RoundingMode.DOWN);
        int i11 = i10 * 2 * qVar.f7905a;
        this.f13409b.c(Y, 1, i11, this.f13415k - i11, null);
        this.f13416l += i10;
        this.f13415k -= i11;
    }
}
