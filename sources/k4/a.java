...
public final class a implements b {
    public static final int[] f12262m = {-1, -1, -1, -1, 2, 4, 6, 8, -1, -1, -1, -1, 2, 4, 6, 8};
    public static final int[] f12263n = {7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, 118, 130, 143, 157, 173, 190, 209, 230, 253, 279, 307, 337, 371, 408, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
    public final q f12264a;
    public final h0 f12265b;
    public final e2.q f12266c;
    public final int d;
    public final byte[] e;
    ...
    public final void c(int i10, long j3) {
        this.f12264a.G(new f(this.f12266c, this.d, i10, j3));
        this.f12265b.b(this.h);
    }

    public final void d(int i10) {
        long j3 = this.f12270j;
        long j10 = this.f12272l;
        e2.q qVar = this.f12266c;
        long j11 = qVar.f7223b;
        String str = d0.f7188a;
        long Y = j3 + d0.Y(j10, 1000000L, j11, RoundingMode.DOWN);
        int i11 = i10 * 2 * qVar.f7222a;
        this.f12265b.c(Y, 1, i11, this.f12271k - i11, null);
        this.f12272l += i10;
        this.f12271k -= i11;
    }
}
