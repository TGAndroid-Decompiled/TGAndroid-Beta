...
public final class a implements b {
    ...
    public final void c(int i10, long j3) {
        this.f13406a.X1(new f(this.f13408c, this.d, i10, j3));
        this.f13407b.b(this.h);
    }

    public final void d(int i10) {
        long j3 = this.f13412j;
        long j10 = this.f13414l;
        e2.q qVar = this.f13408c;
        long j11 = qVar.f7905b;
        String str = d0.f7870a;
        long Y = j3 + d0.Y(j10, 1000000L, j11, RoundingMode.DOWN);
        int i11 = i10 * 2 * qVar.f7904a;
        this.f13407b.c(Y, 1, i11, this.f13413k - i11, null);
        this.f13414l += i10;
        this.f13413k -= i11;
    }
}
