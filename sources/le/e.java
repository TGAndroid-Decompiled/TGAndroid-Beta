...
public final class e {
    ...
    public final Interpolator f13981c;
    public final long d;
    public float e;
    ...
    public final void a(float f7) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            this.h.setInterpolator(this.f13981c);
    ...
    public final void c(float f7) {
        ...
        this.f13980b.C(f7, this.f13979a);
    }

    public final boolean d(float f7, float f10) {
        if (this.e != f7) {
            this.e = f7;
            this.f13980b.D(this.f13979a, f7, f10, this);
            return true;
        }
        return false;
    }
