...
public final class j implements Iterable {
    ...
    public final e f15419c;
    public final i d;
    public boolean f15421f;
    public final ArrayList f15418b = new ArrayList();
    public final ArrayList f15420e = new ArrayList();

    public j(f fVar, Interpolator interpolator, long j3) {
        this.f15417a = fVar;
        this.d = new i(this, fVar);
        if (interpolator != null && j3 > 0) {
            this.f15419c = new e(0, new l.d(this, 2), interpolator, j3);
        } else {
            this.f15419c = null;
        }
    }
    ...
    public final void i(float f7) {
        ...
        boolean z18;
        i iVar = this.d;
        boolean a2 = iVar.f15412b.a(f7);
        if (!iVar.d.a(f7) && !a2) {
            z10 = false;
        } else {
            z10 = true;
        }
        if (!iVar.f15414e.a(f7) && !z10) {
            z11 = false;
        } else {
            z11 = true;
        }
        if (!iVar.f15415f.a(f7) && !z11) {
            z12 = false;
        } else {
            z12 = true;
        }
        if (!iVar.f15416g.a(f7) && !z12) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!iVar.f15413c.a(f7) && !z13) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (!iVar.f15411a.j(f7) && !z14) {
            z15 = false;
        } else {
            z15 = true;
        }
        ArrayList arrayList = this.f15418b;
        ...
        while (i10 < size) {
            ...
            i10++;
            g gVar = (g) obj;
            boolean a10 = gVar.f15408c.a(f7);
            if (!gVar.d.a(f7) && !a10) {
                z16 = false;
            } else {
                z16 = true;
            }
            if (!gVar.f15409e.a(f7) && !z16) {
                z17 = false;
            } else {
                z17 = true;
            }
            if (!gVar.f15410f.a(f7) && !z17) {
                z18 = false;
            } else {
                z18 = true;
            }
            Object obj2 = gVar.f15406a;
    ...
    public final Iterator iterator() {
        return this.f15418b.iterator();
    }

    public final g n(int i10) {
        return (g) this.f15418b.get(i10);
    }

    public final void o(boolean z10) {
        ArrayList arrayList;
        boolean z11;
        ArrayList arrayList2 = this.f15420e;
        ...
        ArrayList arrayList3 = this.f15418b;
        if (z10) {
        ...
        while (i18 < size3) {
            ...
            i18++;
            Object obj6 = ((g) obj5).f15406a;
        }
        i iVar = this.d;
        if (z10) {
            m mVar2 = iVar.f15415f;
            f fVar = iVar.f15411a;
            m mVar3 = iVar.f15414e;
            m mVar4 = iVar.d;
            m mVar5 = iVar.f15416g;
            float f14 = i10;
            if (mVar2.b(f14)) {
                p();
                iVar.f15415f.f15425c = f14;
            }
            float f15 = i11;
            if (mVar5.b(f15)) {
                p();
    ...
    public final void r(List list, boolean z10) {
        ...
        e eVar = this.f15419c;
        i iVar = this.d;
        ArrayList arrayList = this.f15420e;
        ArrayList arrayList2 = this.f15418b;
        if (!z10) {
            if (eVar != null) {
                eVar.b();
                q(false);
            ...
            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                Object obj = ((g) arrayList2.get(size)).f15406a;
                if (obj instanceof oe.a) {
                    ((oe.a) obj).a();
                }
            }
        ...
        if (!isEmpty) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    Object obj3 = gVar2.f15406a;
                    m mVar = gVar2.d;
                    m mVar2 = gVar2.f15408c;
                    ...
                    if (indexOf != -1) {
                        ...
                        if (gVar2.f15407b != indexOf) {
                            gVar2.f15407b = indexOf;
                            if (!z14 && gVar2.h) {
                                z14 = false;
                            } else {
                                z14 = true;
            ...
            if (this.f15421f) {
                ...
                while (i20 < size6) {
                    ...
                    g gVar5 = (g) obj9;
                    m mVar3 = gVar5.d;
                    mVar3.f15424b = mVar3.f15423a;
                    m mVar4 = gVar5.f15408c;
                    mVar4.f15424b = mVar4.f15423a;
                }
            }
        }
    }
