...
public final class j implements Iterable {
    ...
    public final ArrayList f13994b = new ArrayList();
    ...
    public j(f fVar, Interpolator interpolator, long j3) {
        ...
        if (interpolator != null && j3 > 0) {
            this.f13995c = new e(0, new u(this, 3), interpolator, j3);
        } else {
            this.f13995c = null;
        }
    }
    ...
    public final void i(float f7) {
        ...
        if (!iVar.f13991f.a(f7) && !z11) {
            z12 = false;
        } else {
            z12 = true;
        }
        if (!iVar.f13992g.a(f7) && !z12) {
            z13 = false;
        } else {
            z13 = true;
        }
        if (!iVar.f13990c.a(f7) && !z13) {
            z14 = false;
        } else {
            z14 = true;
        }
        if (!iVar.f13988a.k(f7) && !z14) {
            z15 = false;
        } else {
            z15 = true;
        }
        ...
        while (i10 < size) {
            ...
            if (!gVar.f13987f.a(f7) && !z17) {
                z18 = false;
            } else {
                z18 = true;
            }
            Object obj2 = gVar.f13984a;
    ...
    public final Iterator iterator() {
        return this.f13994b.iterator();
    }

    public final g n(int i10) {
        return (g) this.f13994b.get(i10);
    }
    ...
    public final void o(boolean z10) {
        ...
        ArrayList arrayList3 = this.f13994b;
        if (z10) {
        ...
        while (i18 < size3) {
            ...
            i18++;
            Object obj6 = ((g) obj5).f13984a;
        }
        i iVar = this.d;
        if (z10) {
            m mVar2 = iVar.f13991f;
            f fVar = iVar.f13988a;
            m mVar3 = iVar.e;
            m mVar4 = iVar.d;
            m mVar5 = iVar.f13992g;
            float f14 = i10;
            if (mVar2.b(f14)) {
                p();
                iVar.f13991f.f14000c = f14;
            }
            float f15 = i11;
            if (mVar5.b(f15)) {
                p();
    ...
    public final void r(List list, boolean z10) {
        ...
        if (!z10) {
            ...
            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                Object obj = ((g) arrayList2.get(size)).f13984a;
                if (obj instanceof oe.a) {
                    ((oe.a) obj).a();
                }
            }
        ...
        if (!isEmpty) {
            ...
            if (list != null && !list.isEmpty()) {
                ...
                for (int i14 = 0; i14 < arrayList2.size(); i14++) {
                    ...
                    Object obj3 = gVar2.f13984a;
                    m mVar = gVar2.d;
                    m mVar2 = gVar2.f13986c;
                    ...
                    if (indexOf != -1) {
                        ...
                        if (gVar2.f13985b != indexOf) {
                            gVar2.f13985b = indexOf;
                            if (!z14 && gVar2.h) {
                                z14 = false;
                            } else {
                                z14 = true;
            ...
            if (this.f13996f) {
                ...
                while (i20 < size6) {
                    ...
                    g gVar5 = (g) obj9;
                    m mVar3 = gVar5.d;
                    mVar3.f13999b = mVar3.f13998a;
                    m mVar4 = gVar5.f13986c;
                    mVar4.f13999b = mVar4.f13998a;
                }
            }
        }
    }
