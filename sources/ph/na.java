...
public final class na extends Path {
    public final int f42069a = AndroidUtilities.dp(10.0f);
    public final float[] f42070b;
    public ArrayList f42071c;
    public ArrayList d;
    public float e;
    ...
    public final void a(float f10, float f11, float f12, float f13, float f14, float f15, ArrayList arrayList) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            if (Math.abs(this.e - f13) <= 1.0f && Math.abs(this.f42072f - f14) <= 0.01f && Math.abs(this.f42073g - 0.0f) <= 0.1f && Math.abs(this.h - f15) <= 1.0f && Math.abs(this.f42074i - f18) <= 1.0f && Math.abs(this.f42075j - f11) <= 1.0f && Math.abs(this.f42076k - f19) <= 1.0f) {
                ArrayList arrayList2 = this.f42071c;
                if (arrayList2 != null && arrayList2.size() == arrayList.size()) {
                    for (int i12 = 0; i12 < arrayList2.size(); i12++) {
                        ...
                        if (arrayList.get(i12) == null) {
                            ...
                            i11 = ((ha) arrayList.get(i12)).f41757b;
                        }
                        if (intValue == i11) {
                        }
                    }
                ...
                if (arrayList3 != null && arrayList3.size() == arrayList.size()) {
                    for (int i13 = 0; i13 < arrayList3.size(); i13++) {
                        ...
                        if (arrayList.get(i13) == null) {
                            ...
                            d10 = ((ha) arrayList.get(i13)).f41756a.d(((ha) arrayList.get(i13)).f41758c, false);
                        }
                        if (floatValue != d10) {
                            return;
                        }
            ...
            ArrayList arrayList4 = this.f42071c;
            if (arrayList4 == null) {
            ...
            while (i14 < arrayList.size()) {
                ArrayList arrayList5 = this.f42071c;
                if (arrayList.get(i14) == null) {
                    i10 = 0;
                } else {
                    i10 = ((ha) arrayList.get(i14)).f41757b;
                }
                i14 = ai.d(i10, i14, 1, arrayList5);
            }
            ...
            for (int i15 = 0; i15 < arrayList.size(); i15++) {
                ...
                if (arrayList.get(i15) == null) {
                    ...
                    d = ((ha) arrayList.get(i15)).f41756a.d(((ha) arrayList.get(i15)).f41758c, false);
                }
            ...
            for (int i17 = 0; i17 < arrayList.size(); i17++) {
                if (arrayList.get(i17) != null) {
                    i16 = Math.max(i16, ((ha) arrayList.get(i17)).f41757b);
                }
            }
            int max = Math.max(0, (int) (((f11 - this.f42069a) - f18) / round));
            ...
            while (max <= min) {
                ...
                for (int i19 = 0; i19 < arrayList.size(); i19++) {
                    if (arrayList.get(i19) != null && max < ((ha) arrayList.get(i19)).f41757b) {
                ...
                addRoundRect(rectF, this.f42070b, Path.Direction.CW);
                max++;
                f18 = f10;
                f19 = f12;
            }
    ...
    public final void b(float f10, float f11, float f12, float f13, long j10, float f14, float f15, float f16, ha haVar) {
        ...
        int i10 = haVar.f41757b;
        org.telegram.ui.Components.z5 z5Var = haVar.f41756a;
        float d = z5Var.d(haVar.f41758c, false);
        if (0 == j10 && Math.abs(this.e - f14) <= 1.0f && Math.abs(this.f42072f - f15) <= 0.01f && Math.abs(this.f42073g - f13) <= 0.1f && Math.abs(this.h - f16) <= 1.0f && Math.abs(this.f42074i - f20) <= 1.0f && Math.abs(this.f42075j - f21) <= 1.0f && Math.abs(this.f42076k - f22) <= 1.0f && (arrayList = this.f42071c) != null && arrayList.size() == 1) {
        ...
        ArrayList arrayList3 = this.f42071c;
        if (arrayList3 == null) {
            this.f42071c = new ArrayList();
        } else {
            arrayList3.clear();
        }
        this.f42071c.add(Integer.valueOf(i10));
        ...
        this.e = f14;
        this.h = f16;
        float d10 = z5Var.d(haVar.f41758c, false);
        rewind();
        float round = Math.round(AndroidUtilities.dpf2(3.3333f));
        int max = Math.max(0, (int) (((f21 - this.f42069a) - f20) / round));
