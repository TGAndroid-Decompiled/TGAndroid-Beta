...
public final class g5 extends FrameLayout {
    ...
    public g5(Activity activity, int i10, nh.b bVar) {
        ...
        z3Var.f16092a.getAvatarDrawable().m(i10, currentUser);
        nh.y3 y3Var = z3Var.f16092a;
        y3Var.e(currentUser, y3Var.getAvatarDrawable());
        z3Var.f16093b.l(Emoji.replaceEmoji(UserObject.getUserName(currentUser), z3Var.f16093b.getPaint().getFontMetricsInt(), false), false);
