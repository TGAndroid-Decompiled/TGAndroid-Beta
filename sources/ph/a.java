...
public final class a extends View {
    public final ImageReceiver f41237a;
    public final String f41238b;
    public final String f41239c;
    public final TextPaint d;
    public StaticLayout e;
    public float f41240f;
    public float h;
    public final TextPaint f41241n;
    public StaticLayout f41242r;
    public float f41243s;
    public float v;
    ...
    public a(Context context, MediaController.PhotoEntry photoEntry, String str, int i10, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f41237a = imageReceiver;
        TextPaint textPaint = new TextPaint(1);
        this.d = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f41241n = textPaint2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f41237a;
        ...
        if (this.e != null) {
            ...
            this.e.draw(canvas);
            dp = dp + this.f41240f + AndroidUtilities.dp(6.0f);
            canvas.restore();
        }
        if (this.f41242r != null) {
            canvas.save();
            canvas.translate(dp - this.v, AndroidUtilities.dpf2(1.6f) + ((getMeasuredHeight() - this.f41242r.getHeight()) / 2.0f));
            this.f41242r.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f41237a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f41237a.onDetachedFromWindow();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (staticLayout == null || staticLayout.getWidth() != size) {
            ...
            TextPaint textPaint2 = this.f41241n;
            StaticLayout staticLayout3 = new StaticLayout(TextUtils.ellipsize(this.f41239c, textPaint2, dp, truncateAt), textPaint2, Math.max(0, dp), alignment, 1.0f, 0.0f, false);
            this.f41242r = staticLayout3;
            if (staticLayout3.getLineCount() > 0) {
                f12 = this.f41242r.getLineLeft(0);
            } else {
                f12 = 0.0f;
            }
            this.v = f12;
            if (this.f41242r.getLineCount() > 0) {
                f13 = this.f41242r.getLineWidth(0);
            }
            this.f41243s = f13;
        }
        if (View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
            setMeasuredDimension((int) Math.min(AndroidUtilities.dp(12.0f) + AndroidUtilities.dp(30.0f) + getPaddingLeft() + this.f41240f + AndroidUtilities.dp(8.0f) + this.f41243s + getPaddingRight(), View.MeasureSpec.getSize(i10)), AndroidUtilities.dp(48.0f));
