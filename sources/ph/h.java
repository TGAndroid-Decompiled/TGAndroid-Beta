...
public final class h {
    ...
    public final TLRPC.TL_messageMediaPoll f40428b;
    public final TLRPC.TL_inputMediaPoll f40429c;
    public final long d;
        ...
        if (fVar != null) {
            ...
            for (int i11 = 0; i11 < size2; i11++) {
                ...
                if (eVar instanceof qh.e) {
                    ...
                    f.k(tL_inputMediaPoll, keyAt, yf.d.h(((qh.f) eVar).f41023b));
                } else if (eVar instanceof qh.h) {
                    TLRPC.TL_inputMediaDocument tL_inputMediaDocument = new TLRPC.TL_inputMediaDocument();
                    TLRPC.TL_inputDocument tL_inputDocument = new TLRPC.TL_inputDocument();
                    TLRPC.Document document = ((qh.h) eVar).f41026b;
