...
public final class o0 extends View {
    public final Paint f42084a;
    public final TextPaint f42085b;
    public final StaticLayout f42086c;
    public final float d;
    public final float e;
    public final Path f42087f;
    public org.telegram.ui.web.q0 h;
    public boolean f42088n;
    public final org.telegram.ui.Components.z5 f42089r;
    ...
    public o0(Context context) {
        ...
        this.f42085b = textPaint;
        this.f42087f = new Path();
    ...
    public final void dispatchDraw(Canvas canvas) {
        float f10;
        float e = this.f42089r.e(this.f42088n);
        if (e <= 0.0f) {
            return;
        }
        canvas.save();
        if (this.f42088n) {
            f10 = mr.f27126k.getInterpolation(e);
        } else {
            f10 = 1.0f;
        }
        ...
        path.close();
        Paint paint = this.f42084a;
        paint.setAlpha((int) (204.0f * interpolation));
        canvas.drawPath(path, paint);
        canvas.save();
        StaticLayout staticLayout = this.f42086c;
        ...
        this.f42085b.setAlpha((int) (interpolation * 255.0f));
