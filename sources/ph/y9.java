...
public abstract class y9 {
    public float f42672b;
    public org.telegram.ui.Cells.c7 d;
    public ImageReceiver e;
    public nh.i3 f42674f;
    public int f42671a = 0;
    public final RectF f42673c = new RectF();
    ...
    public static w9 b(org.telegram.ui.Cells.d7 d7Var) {
        ...
        w9Var.f42673c.set(iArr[0], iArr[1], imageView.getWidth() + i10, imageView.getHeight() + iArr[1]);
        w9Var.d = new org.telegram.ui.Cells.c7(imageView.getContext(), null, false, d7Var.f20946y);
        w9Var.f42672b = Math.max(w9Var.f42673c.width(), w9Var.f42673c.height()) / 2.0f;
        return w9Var;
    }

    public static x9 c(nh.p pVar) {
        if (pVar != null) {
            ImageReceiver imageReceiver = pVar.f15711r;
            if (pVar.getRootView() != null) {
                ...
                x9Var.f42673c.set(imageX, imageY, imageX + imageWidth, imageWidth + imageY);
                x9Var.e = imageReceiver;
                x9Var.f42672b = Math.max(x9Var.f42673c.width(), x9Var.f42673c.height()) / 2.0f;
                return x9Var;
            }
            return null;
        }
