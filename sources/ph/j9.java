...
public final class j9 extends org.telegram.ui.ActionBar.p2 {
    ...
    public j9(da daVar, int i10) {
        ...
        switch (i10) {
            case 1:
                this.f41824b = daVar;
                super(null);
                this.currentAccount = daVar.f41517c;
                return;
            default:
                this.f41824b = daVar;
                return;
    ...
    public final org.telegram.ui.ActionBar.f6 getResourceProvider() {
        switch (this.f41823a) {
            case 0:
                return new nh.m2(8, this.f41824b.f41510a);
            default:
                return new nh.m2(9, this.f41824b.f41510a);
        }
    }
