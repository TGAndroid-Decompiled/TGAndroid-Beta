...
public abstract class b8 extends ScrollView {
    ...
    public int G;
    public boolean H;
    public final kg.f f41332a;
    public final int f41333b;
    public final kg.j f41334c;
    public final ArrayList d;
    public o30 e;
    public final q7 f41335f;
    public boolean h;
    public Utilities.Callback f41336n;
    public final org.telegram.ui.Components.z5 f41337r;
    public final LinearGradient f41338s;
    public final Paint v;
    public final Matrix f41339w;
    public final org.telegram.ui.Components.z5 f41340x;
    public final LinearGradient f41341y;
    ...
    public b8(Context context, org.telegram.ui.ActionBar.f6 f6Var, q7 q7Var) {
        ...
        mr mrVar = mr.h;
        this.f41337r = new org.telegram.ui.Components.z5(this, 0L, 300L, mrVar);
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{-16777216, 0}, new float[]{0.0f, 1.0f}, tileMode);
        this.f41338s = linearGradient;
        Paint paint = new Paint(1);
        this.v = paint;
        this.f41339w = new Matrix();
        this.f41340x = new org.telegram.ui.Components.z5(this, 0L, 300L, mrVar);
        LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{0, -16777216}, new float[]{0.0f, 1.0f}, tileMode);
        this.f41341y = linearGradient2;
        ...
        AndroidUtilities.setScrollViewEdgeEffectColor(this, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19881d6, false));
        ...
        this.f41333b = (int) fVar.getPaint().measureText(LocaleController.getString(R.string.Search));
    ...
    public void setOnSearchTextChange(Utilities.Callback<String> callback) {
        this.f41336n = callback;
    }

    public void setText(CharSequence charSequence) {
        this.h = true;
        this.f41332a.setText(charSequence);
        this.h = false;
    }
}
