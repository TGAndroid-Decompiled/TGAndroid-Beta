...
public abstract class z2 extends ql0 {
    ...
    public String h;
    public TLRPC.User f42688n;
    public boolean f42689r;
    public final a3 f42691w;
    public final ArrayList f42686c = new ArrayList();
    public int e = -1;
    public final ColorDrawable f42690s = new ColorDrawable(285212671);
        ...
        if (!this.d) {
            ...
            if (this.f42688n == null) {
                ...
                if (userOrChat instanceof TLRPC.User) {
                    this.f42688n = (TLRPC.User) userOrChat;
                }
            }
            TLRPC.User user = this.f42688n;
            if (user == null && !this.f42689r) {
                ...
                tL_messages_getInlineBotResults.bot = messagesController.getInputUser(this.f42688n);
                String str2 = this.f42687f;
                String str3 = "";
                if (str2 == null) {
                    str2 = "";
                }
    ...
    @Override
    public final int h() {
        return this.f42686c.size();
    }

    @Override
    public final void v(f2.l1 l1Var, int i10) {
        org.telegram.ui.Components.p9 p9Var = (org.telegram.ui.Components.p9) l1Var.f5774a;
        TLObject tLObject = (TLObject) this.f42686c.get(i10);
        boolean z4 = tLObject instanceof TLRPC.Document;
        ColorDrawable colorDrawable = this.f42690s;
        if (z4) {
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        return new f2.l1(new lh.z4(this.f42691w.getContext(), 1));
    }
}
