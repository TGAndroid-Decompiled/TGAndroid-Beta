...
public abstract class c8 extends ScrollView {
    ...
    public int G;
    public boolean H;
    public final kg.f f41381a;
    public final int f41382b;
    public final kg.j f41383c;
    public final ArrayList d;
    public n30 e;
    public final r7 f41384f;
    public boolean h;
    public Utilities.Callback f41385n;
    public final org.telegram.ui.Components.z5 f41386r;
    public final LinearGradient f41387s;
    public final Paint v;
    public final Matrix f41388w;
    public final org.telegram.ui.Components.z5 f41389x;
    public final LinearGradient f41390y;
    ...
    public c8(Context context, org.telegram.ui.ActionBar.f6 f6Var, r7 r7Var) {
        ...
        nr nrVar = nr.h;
        this.f41386r = new org.telegram.ui.Components.z5(this, 0L, 300L, nrVar);
        Shader.TileMode tileMode = Shader.TileMode.CLAMP;
        LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{-16777216, 0}, new float[]{0.0f, 1.0f}, tileMode);
        this.f41387s = linearGradient;
        Paint paint = new Paint(1);
        this.v = paint;
        this.f41388w = new Matrix();
        this.f41389x = new org.telegram.ui.Components.z5(this, 0L, 300L, nrVar);
        LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.dp(8.0f), new int[]{0, -16777216}, new float[]{0.0f, 1.0f}, tileMode);
        this.f41390y = linearGradient2;
        ...
        AndroidUtilities.setScrollViewEdgeEffectColor(this, org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19906d6, false));
        ...
        this.f41382b = (int) fVar.getPaint().measureText(LocaleController.getString(R.string.Search));
    ...
    public void setOnSearchTextChange(Utilities.Callback<String> callback) {
        this.f41385n = callback;
    }

    public void setText(CharSequence charSequence) {
        this.h = true;
        this.f41381a.setText(charSequence);
        this.h = false;
    }
}
