...
public final class oa extends View {
    ...
    public long Z0;
    public ia f42119a;
    public final org.telegram.ui.Components.z5 f42120a0;
    public gg.y1 f42121a1;
    public Runnable f42122b;
    public final org.telegram.ui.Components.z5 f42123b0;
    public long f42124b1;
    public int f42125c;
    public final org.telegram.ui.Components.z5 f42126c0;
    public long f42127c1;
    public Runnable d;
    public final org.telegram.ui.Components.z5 f42128d0;
    public float f42129d1;
    public long e;
    public final org.telegram.ui.Components.z5 f42130e0;
    public int f42131e1;
    public long f42132f;
    public final org.telegram.ui.Components.z5 f42133f0;
    public int f42134f1;
    public boolean f42135g0;
    public int f42136g1;
    public ja h;
    public final org.telegram.ui.Components.ba f42137h0;
    public int f42138h1;
    public final org.telegram.ui.Components.fa f42139i0;
    public boolean f42140i1;
    public final org.telegram.ui.Components.fa f42141j0;
    public boolean f42142j1;
    public final org.telegram.ui.Components.fa f42143k0;
    public float f42144k1;
    public final RectF f42145l0;
    public boolean l1;
    public final Path m0;
    public VelocityTracker f42146m1;
    public int f42147n;
    public final k01 f42148n0;
    public boolean f42149n1;
    public final Drawable f42150o0;
    public boolean f42151o1;
    public final na f42152p0;
    public int f42153p1;
    public final RectF f42154q0;
    public final float[] f42155q1;
    public final ArrayList f42156r;
    public final Paint f42157r0;
    public int f42158r1;
    public final ArrayList f42159s;
    public final Path f42160s0;
    public int f42161s1;
    public final Path f42162t0;
    public int f42163t1;
    public final RectF f42164u0;
    public int f42165u1;
    public ja v;
    public final Path f42166v0;
    public int f42167v1;
    public final Paint f42168w;
    public final Paint f42169w0;
    public int f42170w1;
    public final Path f42171x;
    public final Paint f42172x0;
    public final Path f42173y;
    public final Paint f42174y0;
    public final Paint f42175z0;
    ...
    public oa(Context context, ViewGroup viewGroup, p9 p9Var, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ba baVar) {
        super(context);
        this.f42147n = 0;
        this.f42156r = new ArrayList();
        this.f42159s = new ArrayList();
        this.f42168w = new Paint(3);
        this.f42171x = new Path();
        this.f42173y = new Path();
        this.V = 1;
        mr mrVar = mr.h;
        this.W = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.f42120a0 = new org.telegram.ui.Components.z5(this, 360L, mrVar);
        this.f42123b0 = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.f42126c0 = new org.telegram.ui.Components.z5(this, 360L, mrVar);
        this.f42128d0 = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.f42130e0 = new org.telegram.ui.Components.z5(this, 0L, 360L, mrVar);
        this.f42133f0 = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
        this.f42135g0 = true;
        this.f42145l0 = new RectF();
        this.m0 = new Path();
        this.f42152p0 = new na();
        this.f42154q0 = new RectF();
        this.f42157r0 = new Paint(3);
        this.f42160s0 = new Path();
        this.f42162t0 = new Path();
        this.f42164u0 = new RectF();
        this.f42166v0 = new Path();
        Paint paint = new Paint(1);
        this.f42169w0 = paint;
        Paint paint2 = new Paint(1);
        this.f42172x0 = paint2;
        Paint paint3 = new Paint(1);
        this.f42174y0 = paint3;
        Paint paint4 = new Paint(1);
        this.f42175z0 = paint4;
        ...
        this.f42148n0 = new k01(LocaleController.getString(R.string.StoryTimeline), 12.0f, AndroidUtilities.bold());
        Drawable mutate = getContext().getResources().getDrawable(R.drawable.timeline).mutate();
        this.f42150o0 = mutate;
        ...
        this.f42137h0 = baVar;
        this.f42139i0 = new org.telegram.ui.Components.fa(baVar, this, 0, false);
        this.f42141j0 = new org.telegram.ui.Components.fa(baVar, this, 3, false);
        this.f42143k0 = new org.telegram.ui.Components.fa(baVar, this, 4, false);
    ...
    public static void a(final oa oaVar, ViewGroup viewGroup, org.telegram.ui.ActionBar.f6 f6Var, org.telegram.ui.Components.ba baVar, View view) {
        int i10;
        ArrayList arrayList = oaVar.f42159s;
        int i11 = oaVar.f42136g1;
        try {
            if (i11 == 2 && oaVar.K) {
                ...
                n6Var.f42054c = 1.5f;
                n6Var.d(oaVar.S);
                n6Var.h = new Utilities.Callback(oaVar) {
                    public final oa f41709b;
                    ...
                    public final void run(Object obj) {
                        ...
                        switch (r2) {
                            case 0:
                                ...
                                oa oaVar2 = this.f41709b;
                                oaVar2.S = floatValue;
                                ia iaVar = oaVar2.f42119a;
                                if (iaVar != null) {
                            ...
                            case 1:
                                ...
                                oa oaVar3 = this.f41709b;
                                oaVar3.I = floatValue2;
                                ia iaVar2 = oaVar3.f42119a;
                                if (iaVar2 != null) {
                                ...
                                return;
                            default:
                                oa oaVar4 = this.f41709b;
                                oaVar4.h.f41830i = f10.floatValue();
                                ia iaVar3 = oaVar4.f42119a;
                                if (iaVar3 != null) {
                ...
                int i12 = oaVar.f42161s1;
                int i13 = oaVar.f42167v1;
                int i14 = oaVar.f42165u1;
                float min2 = Math.min((i12 - i13) - i14, ((((AndroidUtilities.lerp(oaVar.Q, 1.0f, oaVar.f42126c0.f31253c) * ((float) oaVar.O)) + ((float) (oaVar.N - oaVar.f42132f))) / ((float) min)) * oaVar.f42158r1) + i13 + i14);
                ...
                F.V(5);
                F.U = true;
                F.a0((-(oaVar.f42161s1 - min2)) + AndroidUtilities.dp(18.0f), oaVar.C0.top);
                F.Z();
                ...
                n6Var2.f42054c = 1.5f;
                n6Var2.d(oaVar.I);
                n6Var2.h = new Utilities.Callback(oaVar) {
                    public final oa f41709b;
                ...
                int i15 = oaVar.f42161s1;
                int i16 = oaVar.f42167v1;
                int i17 = oaVar.f42165u1;
                float min4 = Math.min((i15 - i16) - i17, ((((AndroidUtilities.lerp(oaVar.H, 1.0f, oaVar.f42120a0.f31253c) * ((float) oaVar.E)) + ((float) (oaVar.F - oaVar.f42132f))) / ((float) min3)) * oaVar.f42158r1) + i16 + i17);
                ...
                F2.V(5);
                F2.U = true;
                F2.a0((-(oaVar.f42161s1 - min4)) + AndroidUtilities.dp(18.0f), oaVar.f42164u0.top);
                F2.Z();
                ...
                n6Var3.f42053b = 0.0f;
                n6Var3.f42054c = 1.5f;
                n6Var3.d(oaVar.h.f41830i);
                n6Var3.h = new Utilities.Callback(oaVar) {
                    public final oa f41709b;
                ...
                F3.V(5);
                F3.U = true;
                F3.a0(AndroidUtilities.dp(18.0f), oaVar.f42154q0.top);
                F3.Z();
                F3.R(baVar, -view.getX(), -view.getY());
                oaVar.performHapticFeedback(0, 1);
            } else if (i11 == 3 && (i10 = oaVar.f42138h1) >= 0 && i10 < arrayList.size()) {
                ja jaVar = (ja) arrayList.get(oaVar.f42138h1);
                n6 n6Var4 = new n6(oaVar.getContext(), 0);
                n6Var4.f42053b = 0.0f;
                n6Var4.f42054c = 1.5f;
                n6Var4.d(jaVar.f41830i);
                n6Var4.h = new s1(7, oaVar, jaVar);
                p70 F4 = p70.F(viewGroup, f6Var, oaVar);
                F4.q(n6Var4);
                F4.V(5);
                F4.U = true;
                F4.a0(AndroidUtilities.dp(18.0f), jaVar.f41831j.top);
                F4.Z();
    ...
    private float getAudioHeight() {
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), this.f42126c0.e(this.M));
    }
    ...
    private float getCollageHeight() {
        ArrayList arrayList = this.f42159s;
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            f10 += AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), ((ja) arrayList.get(i10)).f41832k.f31253c);
        }
        return f10;
    }
    ...
    private float getRoundHeight() {
        ...
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), this.f42120a0.e(this.D));
    }
    ...
    private float getVideoHeight() {
        ...
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(38.0f), jaVar.f41832k.f31253c);
    }
    ...
    public final void computeScroll() {
        um0 um0Var = this.T0;
        if (um0Var.b()) {
            int i10 = um0Var.f29255j;
            long min = Math.min(getBaseDuration(), getMaxScrollDuration());
            if (this.f42149n1) {
                this.f42132f = Math.max(0.0f, (((i10 - this.f42167v1) - this.f42165u1) / this.f42158r1) * ((float) min));
            } else if (!this.M) {
                um0Var.a();
                return;
            } else {
                int i11 = this.f42167v1;
                int i12 = this.f42165u1;
                float f10 = this.f42158r1;
                float f11 = (float) min;
                h(((((i10 - i11) - i12) / f10) * f11) - ((((this.f42153p1 - i11) - i12) / f10) * f11));
            }
            invalidate();
            this.f42153p1 = i10;
        } else if (this.f42151o1) {
            this.f42151o1 = false;
            ia iaVar = this.f42119a;
            if (iaVar != null) {
                iaVar.o0(false);
            }
        }
    ...
    public final void d(Canvas canvas, float f10, float f11, long j10, float f12) {
        ...
        ja jaVar = this.v;
        if (jaVar != null) {
            f13 = (jaVar.f41829g * ((float) jaVar.e)) + ((float) jaVar.f41828f);
        } else {
            if (this.h == null) {
                j11 = this.N;
            } else {
        ...
        float f14 = (this.f42158r1 * (((clamp + f13) - ((float) this.f42132f)) / ((float) min))) + this.f42167v1 + this.f42165u1;
        float f15 = (1.0f - f12) * (((f11 - f10) / 2.0f) / 2.0f);
        float f16 = f10 + f15;
        float f17 = f11 - f15;
        Paint paint = this.f42175z0;
    ...
    public final void e(Canvas canvas, Paint paint, float f10, float f11, float f12, float f13, float f14) {
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.f42161s1, this.f42163t1, 255, 31);
        int i10 = (int) (255.0f * f14);
        Paint paint3 = this.f42169w0;
        paint3.setAlpha(i10);
        ...
        rectF.set(x10, f21, kf.k0.b(AndroidUtilities.dp(f19), dp, 2.0f, f13), f22);
        if (!this.U0) {
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(1.0f), AndroidUtilities.dp(1.0f), paint2);
            if (paint != null) {
                paint5.setAlpha((int) (f14 * 48.0f));
    ...
    public int getContentHeight() {
        ...
        return (int) (f16 + f13 + this.f42170w1);
    }
    ...
    public int getTimelineHeight() {
        return AndroidUtilities.lerp(AndroidUtilities.dp(28.0f) + this.f42170w1 + this.f42170w1, getContentHeight(), this.f42133f0.f31253c);
    }
    ...
    public final void h(float f10) {
        ...
        if (jaVar == null && !this.B) {
            ...
            ia iaVar2 = this.f42119a;
            if (iaVar2 != null) {
                iaVar2.v1(this.P);
                this.f42119a.j1(this.Q);
            }
        } else if (this.M) {
            if (jaVar != null) {
                f11 = jaVar.f41829g;
            ...
            if (jaVar != null) {
                f13 = (jaVar.h - jaVar.f41829g) * ((float) jaVar.e);
            } else {
        ...
        invalidate();
        ia iaVar5 = this.f42119a;
        if (iaVar5 != null) {
            iaVar5.i2(this.N + (this.P * ((float) this.O)));
        }
        boolean z4 = this.f42142j1;
        if (!z4 && (iaVar = this.f42119a) != null) {
            iaVar.o0(true);
            ja jaVar2 = this.h;
            if (jaVar2 != null) {
                ...
                clamp = Utilities.clamp(j28, f24 * f25, jaVar2.f41829g * f25);
            } else if (this.B) {
            ...
            ia iaVar6 = this.f42119a;
            this.e = clamp;
            iaVar6.C(clamp, false);
        } else if (z4 || this.f42151o1) {
            ja jaVar3 = this.h;
            if (jaVar3 != null) {
                long j30 = this.N + (this.P * ((float) this.O));
                float f29 = jaVar3.h;
                float f30 = (float) jaVar3.e;
                this.e = Utilities.clamp(j30, f29 * f30, jaVar3.f41829g * f30);
    ...
    public final void i(ja jaVar, float f10) {
        ...
        if (jaVar != null) {
            ...
            if (jaVar2 != jaVar && jaVar2 != null) {
                if (this.f42147n == this.f42159s.indexOf(jaVar)) {
                    ja jaVar3 = this.v;
                    float f11 = (float) jaVar3.e;
                    float f12 = jaVar.h;
                    float f13 = (float) jaVar.e;
                    float f14 = jaVar.f41829g;
                    long j16 = (f11 * 0.0f) - (f14 * f13);
                    float min = Math.min(f12 - f14, ((jaVar3.h - jaVar3.f41829g) * f11) / f13);
                    long j17 = jaVar.f41828f;
                    long j18 = f10;
                    long j19 = j17 + j18;
                    if (j19 > (f11 * 1.0f) - (f12 * f13)) {
                        ...
                        long j21 = (jaVar5.f41829g * f16) - (clamp3 * f18);
                        if (j20 < j21) {
                            j15 = j21;
                            j14 = j20;
                        } else {
                        ...
                        jaVar.f41828f = Utilities.clamp(jaVar.f41828f + j18, j15, j14);
                        ia iaVar2 = this.f42119a;
                        if (iaVar2 != null) {
                            iaVar2.i1(jaVar.f41829g, jaVar.f41825a);
                            this.f42119a.A1(jaVar.h, jaVar.f41825a);
                        }
                    } else if (j19 < j16) {
                        ja jaVar6 = this.v;
                        float clamp4 = Utilities.clamp((((jaVar6.f41829g * ((float) jaVar6.e)) - ((float) j17)) - ((float) j18)) / ((float) jaVar.e), 1.0f - min, 0.0f);
                        jaVar.f41829g = clamp4;
                        ...
                        long j23 = (jaVar7.f41829g * f20) - (jaVar.f41829g * f21);
                        if (j22 < j23) {
                            j13 = j23;
                            j12 = j22;
                        } else {
                        ...
                        jaVar.f41828f = Utilities.clamp(jaVar.f41828f + j18, j13, j12);
                        ia iaVar3 = this.f42119a;
                        if (iaVar3 != null) {
                            iaVar3.i1(jaVar.f41829g, jaVar.f41825a);
                            this.f42119a.A1(jaVar.h, jaVar.f41825a);
                        }
                    } else {
                        jaVar.f41828f = j19;
                    ...
                    long j24 = jaVar.f41828f + f10;
                    float f22 = (float) jaVar.e;
                    jaVar.f41828f = Utilities.clamp(j24, ((float) getBaseDuration()) - (jaVar.h * f22), (-jaVar.f41829g) * f22);
                }
            }
            invalidate();
            ia iaVar4 = this.f42119a;
            if (iaVar4 != null) {
                iaVar4.b2(jaVar.f41825a, jaVar.f41828f);
            }
            boolean z4 = this.f42142j1;
            if (!z4 && (iaVar = this.f42119a) != null) {
                iaVar.o0(true);
                ...
                if (jaVar8 != jaVar && jaVar8 != null) {
                    long j25 = jaVar.f41828f + (jaVar.f41829g * ((float) jaVar.e));
                    float f23 = jaVar8.h;
                    float f24 = (float) jaVar8.e;
                    clamp = Utilities.clamp(j25, f23 * f24, jaVar8.f41829g * f24);
                } else {
                    float f25 = jaVar.f41829g;
                ...
                if (jaVar10 != jaVar && jaVar10 != null) {
                    long j26 = jaVar.f41828f + (jaVar.f41829g * ((float) jaVar.e));
                    float f26 = jaVar10.h;
                    float f27 = (float) jaVar10.e;
                    this.e = Utilities.clamp(j26, f26 * f27, jaVar10.f41829g * f27);
                } else {
                    float f28 = jaVar.f41829g;
    ...
    public final void j(float f10) {
        ...
        if (jaVar == null) {
            ...
            if (j21 > j17) {
                ...
                long j23 = (jaVar3.f41829g * f19) - (clamp4 * f21);
                if (j22 < j23) {
                    j13 = j23;
                    j12 = j22;
                } else {
                ...
                ja jaVar4 = this.h;
                float clamp5 = Utilities.clamp((((jaVar4.f41829g * ((float) jaVar4.e)) - ((float) j19)) - ((float) j20)) / ((float) this.E), 1.0f - min, 0.0f);
                this.G = clamp5;
                float clamp6 = Utilities.clamp(clamp5 + min, 1.0f, 0.0f);
                this.H = clamp6;
                ja jaVar5 = this.h;
                ...
                long j25 = (jaVar5.f41829g * f23) - (this.G * f24);
                if (j24 < j25) {
                    j11 = j25;
                    j10 = j24;
                } else {
        ...
        ia iaVar5 = this.f42119a;
        if (iaVar5 != null) {
            iaVar5.P0(this.F + (this.G * ((float) this.E)));
        }
        boolean z4 = this.f42142j1;
        if (!z4 && (iaVar = this.f42119a) != null) {
            iaVar.o0(true);
            ...
            if (jaVar6 != null) {
                ...
                clamp = Utilities.clamp(j27, f26 * f27, jaVar6.f41829g * f27);
            } else {
                float f28 = this.G;
            ...
            if (jaVar7 != null) {
                ...
                this.e = Utilities.clamp(j28, f29 * f30, jaVar7.f41829g * f30);
            } else {
                float f31 = this.G;
    ...
    public final void k() {
        ...
        ja jaVar = this.h;
        long j10 = jaVar.e;
        this.f42132f = Utilities.clamp((((jaVar.h + jaVar.f41829g) / 2.0f) * ((float) j10)) - (((float) min) / 2.0f), j10 - min, 0L);
        invalidate();
    }
    ...
    public final boolean m(float f10, boolean z4) {
        ...
        if (jaVar2 != null || this.K || !arrayList.isEmpty()) {
            long min = Math.min(getBaseDuration(), getMaxScrollDuration());
            float f11 = ((f10 - this.f42167v1) - this.f42165u1) / this.f42158r1;
            ja jaVar3 = this.v;
            if (jaVar3 != null) {
                j10 = (jaVar3.f41829g * ((float) jaVar3.e)) + ((float) jaVar3.f41828f);
            } else {
                j10 = 0;
            }
            ...
            long clamp = Utilities.clamp((f12 - ((float) j10)) + ((float) this.f42132f), (float) getBaseDuration(), 0.0f);
            ja jaVar4 = this.h;
            if (jaVar4 != null) {
                float f13 = ((float) clamp) / ((float) jaVar4.e);
                if (f13 < jaVar4.f41829g || f13 > jaVar4.h) {
                    return false;
                }
            }
            if (this.v == null || (clamp >= 0 && clamp < (jaVar.h - jaVar.f41829g) * ((float) jaVar.e))) {
    ...
    public final void n(String str, long j10, long j11, float f10, float f11, float f12, boolean z4) {
        ...
        if (!z4) {
            this.f42120a0.f(this.D, z10);
            this.f42126c0.f(this.M, z10);
            this.W.f(this.B, z10);
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f42165u1 = dp4;
        this.f42158r1 = (this.f42161s1 - (dp4 * 2)) - (this.f42167v1 * 2);
        ja jaVar = this.h;
        if (jaVar != null && jaVar.d != null && jaVar.f41827c == null) {
            ja.a(jaVar, false);
        }
        ArrayList arrayList = this.f42159s;
        if (!arrayList.isEmpty()) {
            ...
            while (i12 < size2) {
                ...
                i12++;
                ja jaVar2 = (ja) obj;
                if (jaVar2.d != null && jaVar2.f41827c == null) {
                    ja.a(jaVar2, false);
                    ja.b(jaVar2);
                }
            }
    ...
    public void setCollage(ArrayList<t6> arrayList) {
        ...
        int i10 = 0;
        while (true) {
            arrayList2 = this.f42159s;
            if (i10 >= arrayList2.size()) {
                break;
            }
            ja jaVar = (ja) arrayList2.get(i10);
            if (jaVar != null && (maVar = jaVar.f41827c) != null) {
                maVar.b();
            }
            i10++;
        }
        ...
        if (arrayList != null) {
            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                ...
                if (t6Var.K) {
                    ...
                    jaVar2.f41825a = i12;
                    jaVar2.f41826b = false;
                    jaVar2.d = t6Var.L.getAbsolutePath();
                    jaVar2.e = t6Var.f42416h0;
                    jaVar2.f41828f = t6Var.X;
                    jaVar2.f41830i = t6Var.P;
                    jaVar2.f41829g = t6Var.V;
                    jaVar2.h = t6Var.W;
                    ja.a(jaVar2, false);
                    ja.b(jaVar2);
