...
public final class e extends b2.g {
    ...
    public static final Rect f41320f;
    public final ViewGroup f41321b;
    public int f41322c;
    ...
    public static m1 Z0(m1 m1Var, View view, View view2) {
        if (view != null && view2 != null && m1Var != null) {
            ...
            if (k.c(view, view2, rectF)) {
                ...
                return m1Var.f42109a.m(Math.max(0, i10), Math.max(0, i11), Math.max(0, width), Math.max(0, height));
            }
            return null;
        }
        return null;
    ...
    public final m1 T0(m1 m1Var, List list) {
        ...
        int i10 = 0;
        while (it.hasNext()) {
            i10 |= ((w0) it.next()).f42133a.c();
        }
        if (d0.a(i10, 8)) {
            Iterator it2 = this.d.iterator();
            while (it2.hasNext()) {
                d dVar = (d) it2.next();
                m1 Z0 = Z0(m1Var, dVar.N(), this.f41321b);
                if (Z0 != null) {
                    dVar.j(Z0);
                }
            }
