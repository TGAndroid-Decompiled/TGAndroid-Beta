...
public final class e extends b2.g {
    ...
    public static final Rect f41087f;
    public final ViewGroup f41088b;
    public int f41089c;
    ...
    public static l1 Z0(l1 l1Var, View view, View view2) {
        if (view != null && view2 != null && l1Var != null) {
            ...
            if (k.c(view, view2, rectF)) {
                ...
                return l1Var.f41882a.m(Math.max(0, i10), Math.max(0, i11), Math.max(0, width), Math.max(0, height));
            }
            return null;
        }
        return null;
    ...
    public final l1 T0(l1 l1Var, List list) {
        ...
        int i10 = 0;
        while (it.hasNext()) {
            i10 |= ((v0) it.next()).f41905a.c();
        }
        if (c0.a(i10, 8)) {
            Iterator it2 = this.d.iterator();
            while (it2.hasNext()) {
                d dVar = (d) it2.next();
                l1 Z0 = Z0(l1Var, dVar.N(), this.f41088b);
                if (Z0 != null) {
                    dVar.j(Z0);
                }
            }
