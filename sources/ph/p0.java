...
public final class p0 implements Runnable {
    ...
    public final MessagesStorage f42202b;
    public final ArrayList f42203c;

    public p0(int i10, ArrayList arrayList, MessagesStorage messagesStorage) {
        this.f42201a = i10;
        this.f42202b = messagesStorage;
        this.f42203c = arrayList;
    }
    ...
    public final void run() {
        switch (this.f42201a) {
            case 0:
                MessagesStorage messagesStorage = this.f42202b;
                ArrayList arrayList = this.f42203c;
                try {
            ...
            case 1:
                MessagesStorage messagesStorage2 = this.f42202b;
                ArrayList arrayList2 = this.f42203c;
            ...
            default:
                MessagesStorage messagesStorage3 = this.f42202b;
                ArrayList arrayList3 = this.f42203c;
                try {
