...
public final class e5 extends View {
    public final Paint f41605a;
    public final Paint f41606b;
    public final StaticLayout f41607c;
    public final float d;
    public final float e;
    public final int f41608f;
    public final int h;
    public final boolean f41609n;
    public final org.telegram.ui.Components.z5 f41610r;
    public boolean f41611s;
    public float v;
    public ValueAnimator f41612w;
    public final f5 f41613x;
    ...
    public e5(f5 f5Var, Context context, String str, boolean z4) {
        ...
        this.f41606b = paint2;
        this.f41610r = new org.telegram.ui.Components.z5(this, 0L, 220L, mr.h);
        this.f41611s = true;
        this.f41609n = z4;
        ...
        this.f41608f = dp;
        if (!z4) {
            this.f41608f = Math.max(AndroidUtilities.dp(80.0f), dp);
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d = this.f41610r.d(f10, false);
        ...
        canvas.drawRect(AndroidUtilities.dp(25.0f), AndroidUtilities.dp(4.0f), getWidth() - AndroidUtilities.dp(25.0f), getHeight() - AndroidUtilities.dp(4.0f), this.f41606b);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f), this.f41605a);
        canvas.save();
        float f14 = (this.f41608f - this.e) / 2.0f;
        if (this.f41609n) {
            f11 = 3.0f;
        }
        float dp = (f14 + AndroidUtilities.dp(f11)) - this.d;
        int height = getHeight();
        StaticLayout staticLayout = this.f41607c;
    ...
    public final void onMeasure(int i10, int i11) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(this.f41608f, 1073741824), View.MeasureSpec.makeMeasureSpec(this.h, 1073741824));
    }
    ...
    public final void setPressed(boolean z4) {
        ...
        if (isPressed() != z4) {
            super.setPressed(z4);
            invalidate();
            if (z4 && (valueAnimator = this.f41612w) != null) {
            ...
            if (!z4) {
                ...
                if (f10 != 0.0f) {
                    ...
                    this.f41612w = ofFloat;
                    ofFloat.addUpdateListener(new nh.e5(this, 19));
                    this.f41612w.addListener(new j2(this, 3));
                    this.f41612w.setInterpolator(new OvershootInterpolator(1.5f));
                    this.f41612w.setDuration(350L);
                    this.f41612w.start();
                }
            }
        }
