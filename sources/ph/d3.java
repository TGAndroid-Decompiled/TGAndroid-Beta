...
public final class d3 extends org.telegram.ui.ActionBar.g3 {
    public final c3 f41487b;
    public ValueAnimator f41488c;
    public o1.j d;
    public Boolean e;
    public Utilities.Callback f41489f;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0 && motionEvent.getY() < this.f41487b.g()) {
            dismiss();
            return true;
        }
    ...
    public final void n(boolean z4, b3 b3Var) {
        ...
        if (z4) {
            o1.j jVar = new o1.j(c3Var, o1.h.f16162n, height);
            this.d = jVar;
            jVar.f16178u.a(0.75f);
            this.d.f16178u.b(350.0f);
            this.d.a(new org.telegram.messenger.q(this, height, b3Var));
            this.d.f();
            return;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(translationY, height);
        this.f41488c = ofFloat;
        ofFloat.addUpdateListener(new nh.e5(this, 15));
        this.f41488c.addListener(new ex0(16, this, b3Var));
        this.f41488c.setDuration(450L);
        this.f41488c.setInterpolator(mr.h);
        this.f41488c.start();
    }
