...
public class n6 extends View {
    ...
    public float d;
    public boolean e;
    public final org.telegram.ui.Components.z5 f42055f;
    public Utilities.Callback h;
    public final Paint f42056n;
    public final Paint f42057r;
    public final Paint f42058s;
    public final Paint v;
    public final Paint f42059w;
    public final org.telegram.ui.Components.j6 f42060x;
    public final org.telegram.ui.Components.j6 f42061y;
    ...
    public n6(Context context, int i10) {
        ...
        this.f42054c = 1.0f;
        mr mrVar = mr.h;
        this.f42055f = new org.telegram.ui.Components.z5(this, 0L, 320L, mrVar);
    ...
    public final void a(float f10) {
        this.e = true;
        float f11 = this.f42053b;
        this.d = (f10 - f11) / (this.f42054c - f11);
        e(f10);
    }
    ...
    public final void d(float f10) {
        float f11 = this.f42053b;
        float f12 = (f10 - f11) / (this.f42054c - f11);
        this.d = f12;
        this.f42055f.d(f12, true);
        e(f10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean z10 = false;
        if (this.e) {
            f10 = this.f42055f.d(this.d, false);
        } else {
            f10 = this.d;
        }
        float f13 = f10;
        ...
        org.telegram.ui.Components.j6 j6Var = this.f42060x;
        if (i10 == 0) {
            ...
            org.telegram.ui.Components.j6 j6Var2 = this.f42061y;
        ...
        if (i10 == 0) {
            canvas.drawPath(this.C, this.f42057r);
            canvas.drawPath(this.D, this.f42058s);
            float f14 = this.f42054c;
            float f15 = this.f42053b;
            float f16 = f14 - f15;
            if (f16 != 0.0f) {
                f11 = (f16 * this.d) + f15;
            } else {
            ...
            Paint paint2 = this.f42059w;
            paint2.setAlpha((int) (e6 * 255.0f));
            canvas.drawPath(this.F, paint2);
            canvas.restore();
        }
        canvas.save();
        canvas.drawRect(0.0f, 0.0f, this.L * f13, this.M, this.f42056n);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float f11 = this.f42054c;
            float f12 = this.f42053b;
            float f13 = 0.0f;
            if (f11 - f12 != 0.0f) {
    ...
    public final void e(float f10) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.f42060x;
        if (!TextUtils.equals(j6Var.f25850g, str)) {
            j6Var.b();
            if (this.e) {
                j10 = 320;
            } else {
            ...
            j6Var.k(0.3f, j10, mr.h);
            j6Var.q(str, true, true);
        }
        if (this.f42052a == 1) {
            this.f42056n.setColor(d2.f(f10));
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f42060x.t(AndroidUtilities.dp(15.0f));
        int i12 = this.O;
        int i13 = this.f42052a;
        if (i12 > 0) {
            this.L = i12;
        ...
        if (i13 == 0) {
            ...
            this.f42057r.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            Path path = this.C;
            path.rewind();
            ...
            path.close();
            this.f42058s.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(2.66f)));
            Path path2 = this.D;
            path2.rewind();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f42060x && drawable != this.f42061y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
