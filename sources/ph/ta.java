...
public final class ta extends View implements c2 {
    public Paint f42372a;
    public Paint f42373b;
    public org.telegram.ui.Components.j6 f42374c;
    public boolean d;
    ...
    public final void onDraw(Canvas canvas) {
        float f10;
        Paint paint = this.f42373b;
        org.telegram.ui.Components.j6 j6Var = this.f42374c;
        super.onDraw(canvas);
        org.telegram.ui.Components.z5 z5Var = this.e;
        if (this.d) {
            f10 = 1.0f;
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(18.0f), AndroidUtilities.dp(18.0f), this.f42372a);
        if (d > 0.0f) {
    ...
    public void setInvert(float f10) {
        this.f42372a.setColor(i0.a.d(f10, 1056964608, 268435456));
        this.f42374c.r(i0.a.d(f10, -1, -16777216));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f42374c != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
