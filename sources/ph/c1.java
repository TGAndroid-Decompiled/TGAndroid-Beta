...
public final class c1 extends View {
    ...
    public org.telegram.ui.Components.l5 f41357c;
    public final d1 d;
    public ImageReceiver e;
    public long f41358f;
    public final ImageReceiver.BackgroundThreadDrawHolder[] h;
    public ImageReceiver f41359n;
    public final rc f41360r;
    public boolean f41361s;

    public c1(Context context, d1 d1Var) {
        super(context);
        this.f41356b = UserConfig.selectedAccount;
        this.h = new ImageReceiver.BackgroundThreadDrawHolder[2];
        this.f41360r = new rc(this);
    ...
    public final void a(TLRPC.Document document, boolean z4) {
        ...
        if (j11 != j10) {
            org.telegram.ui.Components.l5 l5Var = this.f41357c;
            if (l5Var != null) {
                l5Var.o(this);
            }
            if (document != null) {
                int i11 = 1;
                this.f41355a = true;
                this.f41358f = document.f19165id;
                int i12 = y1.D;
                if (!z4) {
                    i11 = 16388;
                }
                ...
                org.telegram.ui.Components.l5 m9 = org.telegram.ui.Components.l5.m(this.f41356b, i10, document);
                this.f41357c = m9;
                if (this.f41361s) {
                    m9.a(this);
                    return;
    ...
    public void setSticker(TLRPC.Document document) {
        ...
        this.f41355a = false;
        if (document != null) {
            long j10 = this.f41358f;
            long j11 = document.f19165id;
            if (j10 != j11) {
                this.f41358f = j11;
                if (this.e == null) {
                    ImageReceiver imageReceiver = new ImageReceiver();
