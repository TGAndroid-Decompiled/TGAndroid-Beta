...
public class o6 extends View {
    ...
    public float f42056c;
    public float d;
    public boolean e;
    public final org.telegram.ui.Components.z5 f42057f;
    public Utilities.Callback h;
    public final Paint f42058n;
    public final Paint f42059r;
    public final Paint f42060s;
    public final Paint v;
    public final Paint f42061w;
    public final org.telegram.ui.Components.j6 f42062x;
    public final org.telegram.ui.Components.j6 f42063y;
    ...
    public o6(Context context, int i10) {
        ...
        this.f42056c = 1.0f;
        nr nrVar = nr.h;
        this.f42057f = new org.telegram.ui.Components.z5(this, 0L, 320L, nrVar);
    ...
    public final void a(float f10) {
        this.e = true;
        float f11 = this.f42055b;
        this.d = (f10 - f11) / (this.f42056c - f11);
        e(f10);
    }
    ...
    public final void d(float f10) {
        float f11 = this.f42055b;
        float f12 = (f10 - f11) / (this.f42056c - f11);
        this.d = f12;
        this.f42057f.d(f12, true);
        e(f10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean z10 = false;
        if (this.e) {
            f10 = this.f42057f.d(this.d, false);
        } else {
            f10 = this.d;
        }
        float f13 = f10;
        ...
        org.telegram.ui.Components.j6 j6Var = this.f42062x;
        if (i10 == 0) {
            ...
            org.telegram.ui.Components.j6 j6Var2 = this.f42063y;
        ...
        if (i10 == 0) {
            canvas.drawPath(this.C, this.f42059r);
            canvas.drawPath(this.D, this.f42060s);
            float f14 = this.f42056c;
            float f15 = this.f42055b;
            float f16 = f14 - f15;
            if (f16 != 0.0f) {
                f11 = (f16 * this.d) + f15;
            } else {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float f11 = this.f42056c;
            float f12 = this.f42055b;
            float f13 = 0.0f;
            if (f11 - f12 != 0.0f) {
    ...
    public final void e(float f10) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.f42062x;
        if (!TextUtils.equals(j6Var.f25887g, str)) {
            j6Var.b();
            if (this.e) {
                j10 = 320;
            } else {
            ...
            j6Var.k(0.3f, j10, nr.h);
            j6Var.q(str, true, true);
        }
        if (this.f42054a == 1) {
            this.f42058n.setColor(d2.f(f10));
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f42062x.t(AndroidUtilities.dp(15.0f));
        int i12 = this.O;
        int i13 = this.f42054a;
        if (i12 > 0) {
            this.L = i12;
        ...
        if (i13 == 0) {
            ...
            this.f42059r.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            Path path = this.C;
            path.rewind();
            ...
            path.close();
            this.f42060s.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(2.66f)));
            Path path2 = this.D;
            path2.rewind();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f42062x && drawable != this.f42063y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
