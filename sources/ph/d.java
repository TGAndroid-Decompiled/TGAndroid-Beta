...
public class d extends FrameLayout implements h90 {
    ...
    public rp V;
    public int W;
    public org.telegram.ui.ActionBar.f6 f41401a;
    public boolean f41402a0;
    public int f41403b;
    public int f41404b0;
    public final Paint f41405c;
    public boolean f41406c0;
    public final org.telegram.ui.Components.j6 d;
    public int f41407d0;
    public final org.telegram.ui.Components.j6 e;
    public final org.telegram.ui.Components.j6 f41408f;
    public float h;
    public final org.telegram.ui.Components.z5 f41409n;
    public final View f41410r;
    public boolean f41411s;
    public boolean v;
    public boolean f41412w;
    public boolean f41413x;
    public int f41414y;
    ...
    private int getWrapWidth() {
        float f10;
        float d = this.f41409n.d(this.h, false);
        if (this.Q) {
            f10 = AndroidUtilities.dp(12.0f);
        } else {
            f10 = 0.0f;
        }
        return getPaddingRight() + getPaddingLeft() + ((int) (a(this.f41408f.d() + AndroidUtilities.dp(15.66f), d) + this.d.d() + f10));
    }
    ...
    public final void c(int i10, boolean z4) {
        float f10;
        int i11;
        org.telegram.ui.Components.j6 j6Var = this.f41408f;
        if (z4) {
            j6Var.b();
        }
    ...
    public final void d() {
        this.f41412w = true;
        setFilled(true);
        setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20267xa, this.f41401a));
        j();
    }
    ...
    public final void f(CharSequence charSequence, boolean z4) {
        ...
        if (this.G && !z10) {
            ...
            this.F.setInterpolator(nr.f27346f);
            this.F.start();
        } else {
    ...
    public final void j() {
        ...
        if (!this.f41413x) {
            if (this.f41412w) {
                i12 = org.telegram.ui.ActionBar.j6.f20267xa;
            } else {
                i12 = org.telegram.ui.ActionBar.j6.Oh;
            }
            this.f41414y = org.telegram.ui.ActionBar.j6.v0(i12, this.f41401a);
        }
        if (this.f41411s) {
            if (this.f41412w) {
                i10 = org.telegram.ui.ActionBar.j6.f20285ya;
            } else {
        ...
        int v02 = org.telegram.ui.ActionBar.j6.v0(i10, this.f41401a);
        org.telegram.ui.Components.j6 j6Var = this.d;
        j6Var.r(v02);
        boolean z4 = this.f41411s;
        View view = this.f41410r;
        if (z4) {
            int v03 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19996i6, this.f41401a);
            int i13 = this.f41403b;
            view.setBackground(org.telegram.ui.ActionBar.j6.Y(v03, i13, i13));
        } else {
            int l1 = org.telegram.ui.ActionBar.j6.l1(0.1f, j6Var.f25883a.getColor());
            int i14 = this.f41403b;
            view.setBackground(org.telegram.ui.ActionBar.j6.Y(l1, i14, i14));
        }
        if (this.f41411s) {
            if (this.f41412w) {
                i11 = org.telegram.ui.ActionBar.j6.f20285ya;
            } else {
        ...
        this.e.r(org.telegram.ui.ActionBar.j6.v0(i11, this.f41401a));
        this.f41408f.r(this.f41414y);
        this.f41405c.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.Sh, this.f41401a));
    }
    ...
    public final void k() {
        ...
        this.R = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(this.f41414y, PorterDuff.Mode.SRC_IN));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f13;
        float f14;
        this.f41410r.draw(canvas);
        int i11 = 0;
        if (this.I) {
            if (this.K) {
                if (this.H == null) {
                    i90 i90Var = new i90(this.f41401a);
                    this.H = i90Var;
                    i90Var.setCallback(this);
                    i90 i90Var2 = this.H;
                    i90Var2.f25648t = 2.0f;
                    i90Var2.C = true;
                    i90Var2.f25650w.setStrokeWidth(0.0f);
        ...
        if (f15 > 0.0f) {
            if (this.V == null) {
                this.V = new rp(j6Var.f25883a.getColor());
            }
        ...
        if (f16 < 1.0f) {
            ...
            float d = j6Var.d();
            float d10 = this.f41409n.d(this.h, false);
            if (this.Q) {
                f10 = AndroidUtilities.dp(12.0f);
            } else {
                f10 = 0.0f;
            }
            org.telegram.ui.Components.j6 j6Var2 = this.f41408f;
            ...
            j6Var.f25901w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.S) * (1.0f - this.J) * this.W);
            ...
            if (this.G) {
                ...
                j6Var3.f25901w = (int) (AndroidUtilities.lerp(0.5f, 1.0f, this.S) * (1.0f - this.J) * 200.0f * this.E);
            ...
            CharSequence charSequence = j6Var2.f25887g;
            if (charSequence != null) {
        ...
        if (this.v && this.f41407d0 != (wrapWidth = getWrapWidth())) {
            this.f41407d0 = wrapWidth;
            requestLayout();
        }
    }
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (this.f41411s && isClickable() && getParent() != null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        } else if (this.f41406c0) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec((int) Math.min(Math.max(this.d.d() + getPaddingLeft() + getPaddingRight(), this.f41404b0), View.MeasureSpec.getSize(i10)), 1073741824), i11);
        } else {
    ...
    public void setColor(int i10) {
        if (this.f41411s) {
            this.f41413x = true;
            int dp = AndroidUtilities.dp(this.f41403b);
            this.f41414y = i10;
        ...
        this.f41410r.setBackground(org.telegram.ui.ActionBar.j6.Y(l1, i11, i11));
    }
    ...
    public void setFilled(boolean z4) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.d;
        if (z4) {
            setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(this.f41403b), this.f41414y));
    ...
    public void setRoundRadius(int i10) {
        this.f41403b = i10;
        if (this.f41411s) {
            setBackground(org.telegram.ui.ActionBar.j6.b0(AndroidUtilities.dp(i10), this.f41414y));
        } else {
            setBackground(null);
        }
        j();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.H != drawable && this.d != drawable && this.e != drawable && this.f41408f != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
    ...
    public d(Context context, org.telegram.ui.ActionBar.f6 f6Var, boolean z4) {
        ...
        this.f41403b = 8;
        nr nrVar = nr.h;
        this.f41409n = new org.telegram.ui.Components.z5(350L, nrVar);
        this.B = true;
        this.C = 0;
        this.E = 0.0f;
        this.J = 0.0f;
