...
public final class v2 extends bl0 {
    ...
    public final String F(int i10) {
        ...
        ArrayList arrayList = a3Var.f41286c0;
        if (arrayList == null || i11 < 0 || i11 >= arrayList.size() || (photoEntry = (MediaController.PhotoEntry) a3Var.f41286c0.get(i11)) == null) {
            return null;
        }
    ...
    public final void G(rl0 rl0Var, float f10, int[] iArr) {
        ...
        m2 m2Var = a3Var.e;
        float f11 = m2Var.J;
        int width = (int) (((int) (((rl0Var.getWidth() - rl0Var.getPaddingLeft()) - rl0Var.getPaddingRight()) / f11)) * a3Var.L);
        int ceil = (int) Math.ceil(k10 / f11);
        float lerp = (AndroidUtilities.lerp(0, Math.max(0, i10 - ((AndroidUtilities.displaySize.y - rl0Var.getPaddingTop()) - rl0Var.getPaddingBottom())), f10) / (ceil * width)) * ceil;
        int round = Math.round(lerp);
        iArr[0] = Math.max(0, m2Var.J * round) + 2;
        iArr[1] = rl0Var.getPaddingTop() + ((int) ((lerp - round) * width));
    }
    ...
    public final float H(rl0 rl0Var) {
        a3 a3Var;
        int k10 = k();
        float f10 = this.f42506c.e.J;
        return (Math.max(0, rl0Var.computeVerticalScrollOffset() - a3Var.getPadding()) - rl0Var.getPaddingTop()) / ((((int) Math.ceil(k10 / f10)) * ((int) (((int) (((rl0Var.getWidth() - rl0Var.getPaddingLeft()) - rl0Var.getPaddingRight()) / f10)) * a3Var.L))) - (AndroidUtilities.displaySize.y - rl0Var.getPaddingTop()));
    }
        ...
        if (i11 == 0) {
            ...
            if (a3Var.W) {
                ...
                if (i13 >= 0 && i13 < arrayList2.size()) {
                    x2Var.f(-1, false, false);
                    x2Var.e(0, (t6) arrayList2.get(i13));
                    return;
                }
                i13 -= arrayList2.size();
            }
            ArrayList arrayList3 = a3Var.f41286c0;
            if (arrayList3 != null && i13 >= 0 && i13 < arrayList3.size()) {
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) a3Var.f41286c0.get(i13);
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        a3 a3Var = this.f42506c;
        if (i10 == 0) {
            h51Var = new y2(a3Var, a3Var.getContext());
        } else if (i10 == 1) {
            ...
            h51Var2.addView(textView, k7.b6.d(-1, -1.0f, 119, 0.0f, 0.0f, f11, 0.0f));
            a3Var.f41290f0 = h51Var2;
            h51Var = h51Var2;
        } else {
            h51Var = new x2(a3Var.getContext(), a3Var.f41283b, a3Var.L, a3Var.J);
        }
        return new f2.l1(h51Var);
    }
