...
public final class v2 extends cl0 {
    ...
    public final String F(int i10) {
        ...
        ArrayList arrayList = a3Var.f41259c0;
        if (arrayList == null || i11 < 0 || i11 >= arrayList.size() || (photoEntry = (MediaController.PhotoEntry) a3Var.f41259c0.get(i11)) == null) {
            return null;
        }
    ...
    public final void G(sl0 sl0Var, float f10, int[] iArr) {
        ...
        m2 m2Var = a3Var.e;
        float f11 = m2Var.J;
        int width = (int) (((int) (((sl0Var.getWidth() - sl0Var.getPaddingLeft()) - sl0Var.getPaddingRight()) / f11)) * a3Var.L);
    ...
    public final float H(sl0 sl0Var) {
        a3 a3Var;
        int k10 = k();
        float f10 = this.f42474c.e.J;
        return (Math.max(0, sl0Var.computeVerticalScrollOffset() - a3Var.getPadding()) - sl0Var.getPaddingTop()) / ((((int) Math.ceil(k10 / f10)) * ((int) (((int) (((sl0Var.getWidth() - sl0Var.getPaddingLeft()) - sl0Var.getPaddingRight()) / f10)) * a3Var.L))) - (AndroidUtilities.displaySize.y - sl0Var.getPaddingTop()));
    }
        ...
        if (i11 == 0) {
            ...
            if (a3Var.W) {
                ...
                if (i13 >= 0 && i13 < arrayList2.size()) {
                    x2Var.f(-1, false, false);
                    x2Var.e(0, (u6) arrayList2.get(i13));
                    return;
                }
                i13 -= arrayList2.size();
            }
            ArrayList arrayList3 = a3Var.f41259c0;
            if (arrayList3 != null && i13 >= 0 && i13 < arrayList3.size()) {
                MediaController.PhotoEntry photoEntry = (MediaController.PhotoEntry) a3Var.f41259c0.get(i13);
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        a3 a3Var = this.f42474c;
        if (i10 == 0) {
            a51Var = new y2(a3Var, a3Var.getContext());
        } else if (i10 == 1) {
            Context context = a3Var.getContext();
            boolean z4 = a3Var.I;
            a51 a51Var2 = new a51(context, 8);
            if (z4) {
                f10 = 14.0f;
            } else {
                f10 = 16.0f;
            }
            a51Var2.setPadding(AndroidUtilities.dp(f10), AndroidUtilities.dp(16.0f), AndroidUtilities.dp(8.0f), AndroidUtilities.dp(10.0f));
            ...
            a51Var2.addView(textView, k7.b6.d(-1, -1.0f, 119, 0.0f, 0.0f, f11, 0.0f));
            a3Var.f41263f0 = a51Var2;
            a51Var = a51Var2;
        } else {
            a51Var = new x2(a3Var.getContext(), a3Var.f41256b, a3Var.L, a3Var.J);
        }
        return new f2.l1(a51Var);
    }
