...
public final class t9 extends p {
    ...
    public final boolean e() {
        ic icVar;
        if (MessagesController.getInstance(this.R).premiumFeaturesBlocked() || ((icVar = ic.f25665w) != null && icVar.f25666a == 2)) {
            return false;
        }
        ...
        if (indexOf >= 0) {
            ...
            if (indexOf2 >= 0) {
                ...
                replaceTags.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, this.f41801a)), indexOf, indexOf2, 33);
                replaceTags.setSpan(new eg.l0(this, 8), indexOf, indexOf2, 33);
            }
        }
        ic M = new qc(this.P1.f41499i0, this.f41801a).M(LocaleController.getString(R.string.CaptionPremiumTitle), replaceTags, R.raw.caption_limit);
        M.f25666a = 2;
        M.f25672j = 5000;
        M.k(false);
        return true;
    ...
    public final void i(Bitmap bitmap) {
        this.P1.f41512n.Z(bitmap, 12.0f);
    ...
    public final boolean l(float f10, float f11) {
        ...
        if (h9Var != null && h9Var.O0 != null) {
            ...
            if (!t9Var.m0) {
                ...
                float x11 = daVar.f41499i0.getX() + x10;
                float y11 = daVar.f41499i0.getY() + y10;
                float x12 = x11 - daVar.f41486e0.getX();
                float y12 = y11 - daVar.f41486e0.getY();
                for (int i10 = 0; i10 < daVar.f41531s1.O0.getChildCount(); i10++) {
                    ...
                    if (childAt instanceof dg.j) {
                        ...
                        float f12 = selectionBounds.f28722a;
                        float f13 = selectionBounds.f28723b;
                        rectF.set(f12, f13, selectionBounds.f28724c + f12, selectionBounds.d + f13);
    ...
    public final void q(boolean z4) {
        ...
        if (!daVar.K1 && !z4) {
            ...
            if (o10 == null || !o10.a(storiesController.f15917a, B) || ((u6Var = daVar.H1) != null && u6Var.f42413g)) {
                z10 = true;
