...
public final class i1 {
        ...
        try {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    ?? obj = new Object();
                    obj.f45826a = next;
                    obj.f45827b = jSONObject2.getLong("user_id");
                    obj.f45828c = jSONObject2.getString("user_name");
                    obj.d = jSONObject2.getLong("created_at");
                    obj.f45829e = jSONObject2.getLong("edited_at");
    ...
    public static void k(HashMap hashMap) {
        try {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                jSONObject2.put("user_id", ((h1) entry.getValue()).f45827b);
                jSONObject2.put("user_name", ((h1) entry.getValue()).f45828c);
                jSONObject2.put("created_at", ((h1) entry.getValue()).d);
                jSONObject2.put("edited_at", ((h1) entry.getValue()).f45829e);
    ...
    public final File c() {
        long j10;
        if (this.d && TextUtils.isEmpty(this.f45837e)) {
            HashMap i10 = i();
            ...
            while (true) {
                ...
                if (((h1) entry.getValue()).f45827b == j10) {
                    this.f45837e = (String) entry.getKey();
                    break;
                }
            }
            if (TextUtils.isEmpty(this.f45837e)) {
                String uuid = UUID.randomUUID().toString();
                this.f45837e = uuid;
                ?? obj = new Object();
                obj.f45826a = uuid;
                obj.f45827b = j10;
                obj.f45828c = DialogObject.getName(UserConfig.getInstance(this.f45834a).getCurrentUser());
                long currentTimeMillis = System.currentTimeMillis();
                obj.f45829e = currentTimeMillis;
                obj.d = currentTimeMillis;
                i10.put(this.f45837e, obj);
                k(i10);
            }
        }
        return d(this.f45837e);
    }
    ...
    public final void j(String str) {
        ...
        if (!e(c()).keys().hasNext()) {
            ...
            if (h1Var != null) {
                h1Var.f45827b = this.f45836c;
                h1Var.f45828c = DialogObject.getName(UserConfig.getInstance(this.f45834a).getCurrentUser());
                h1Var.f45829e = System.currentTimeMillis();
                k(i11);
                this.f45837e = h1Var.f45826a;
                return;
            }
        ...
        if (str2.length() + str.length() <= 5242880) {
            ...
            try {
                ...
                if (z10) {
                    try {
                        HashMap i10 = i();
                        h1 h1Var = (h1) i10.get(this.f45837e);
                        if (h1Var != null) {
                            h1Var.f45829e = System.currentTimeMillis();
                            k(i10);
                            return;
