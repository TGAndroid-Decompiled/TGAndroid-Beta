...
public final class d8 extends FrameLayout {
    public Path B;
    public Paint C;
    public final org.telegram.ui.ActionBar.f6 f41498a;
    public final org.telegram.ui.Components.z8 f41499b;
    public final org.telegram.ui.Components.p9 f41500c;
    public final org.telegram.ui.ActionBar.k5 d;
    public final org.telegram.ui.ActionBar.k5 e;
    public final kp f41501f;
    public final RadioButton h;
    public final Paint f41502n;
    public boolean f41503r;
    public boolean f41504s;
    public boolean v;
    public final boolean[] f41505w;
    public long f41506x;
    public boolean f41507y;
    ...
    public d8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f41499b = z8Var;
        this.f41502n = new Paint(1);
        this.f41503r = false;
        this.f41504s = true;
        this.v = true;
        this.f41505w = new boolean[1];
        this.f41498a = f6Var;
        z8Var.f31295r = AndroidUtilities.dp(40.0f);
        ...
        int i13 = org.telegram.ui.ActionBar.j6.f19989j7;
        kpVar.b(i12, i13, org.telegram.ui.ActionBar.j6.C5);
    ...
    public final void a(int i10, TLRPC.Chat chat) {
        ...
        this.f41506x = j10;
        org.telegram.ui.Components.z8 z8Var = this.f41499b;
        z8Var.q(chat);
        ...
        if (zArr[0]) {
            i11 = org.telegram.ui.ActionBar.j6.f20059n5;
        } else {
            i11 = org.telegram.ui.ActionBar.j6.f20131r5;
        }
        this.e.setTextColor(org.telegram.ui.ActionBar.j6.v0(i11, this.f41498a));
        if (this.f41504s) {
            i12 = 0;
        } else {
            i12 = 8;
        }
        this.f41501f.setVisibility(i12);
    ...
    public final void d(boolean z4, boolean z10) {
        ...
        if (!this.f41504s) {
            this.h.setVisibility(8);
            this.f41501f.setVisibility(8);
        }
        if (!this.f41507y && (this.f41504s || !this.f41503r)) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void e(int i10, TLRPC.User user, int i11) {
        org.telegram.ui.ActionBar.f6 f6Var = this.f41498a;
        org.telegram.ui.ActionBar.k5 k5Var = this.d;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.e;
        org.telegram.ui.Components.z8 z8Var = this.f41499b;
        int i12 = 0;
        if (i10 == 4) {
            ...
            k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20059n5, f6Var));
            z8Var.g(7);
    ...
    public final void f() {
        ...
        this.f41500c.setLayoutParams(k7.b6.d(40, 40.0f, i18, f10, 0.0f, f11, 0.0f));
        ...
        this.f41501f.setLayoutParams(k7.b6.d(24, 24.0f, i15 | 16, 13.0f, 0.0f, 14.0f, 0.0f));
        if (LocaleController.isRTL) {
            i17 = 5;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        if (this.f41507y) {
            int v02 = org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19882d7, this.f41498a);
            Paint paint2 = this.f41502n;
            paint2.setColor(v02);
            if (LocaleController.isRTL) {
                canvas2 = canvas;
        ...
        Path path = this.B;
        if (path != null && (paint = this.C) != null && !this.f41504s && this.f41503r && this.v) {
    ...
    public final void onInitializeAccessibilityNodeInfo(android.view.accessibility.AccessibilityNodeInfo r7) {
        throw new UnsupportedOperationException("Method not decompiled: ph.d8.onInitializeAccessibilityNodeInfo(android.view.accessibility.AccessibilityNodeInfo):void");
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (!this.f41504s && this.f41503r) {
            ...
            this.C.setColor(org.telegram.ui.ActionBar.j6.l1(0.3f, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.G6, this.f41498a)));
        }
    }
    ...
    public void setDivider(boolean z4) {
        boolean z10;
        this.f41507y = z4;
        if (!z4 && (this.f41504s || !this.f41503r)) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public void setRedCheckbox(boolean z4) {
        ...
        this.f41501f.b(i10, org.telegram.ui.ActionBar.j6.f19989j7, org.telegram.ui.ActionBar.j6.C5);
    }
    ...
    public void setUser(TLRPC.User user) {
        ...
        boolean[] zArr = this.f41505w;
        zArr[0] = false;
        boolean z4 = this.f41503r;
        org.telegram.ui.ActionBar.f6 f6Var = this.f41498a;
        org.telegram.ui.ActionBar.k5 k5Var2 = this.e;
        if (z4) {
            setSubtitle(LocaleController.getString(R.string.VoipGroupPersonalAccount));
            k5Var2.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20131r5, f6Var));
        } else {
            setSubtitle(LocaleController.formatUserStatus(UserConfig.selectedAccount, user, zArr));
            if (zArr[0]) {
                i10 = org.telegram.ui.ActionBar.j6.f20059n5;
            } else {
                i10 = org.telegram.ui.ActionBar.j6.f20131r5;
            }
