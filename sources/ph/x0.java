...
public final class x0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final NotificationCenter.NotificationCenterDelegate[] f46148b;
    ...
    public x0(long j10, NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr, int i10, w0 w0Var) {
        this.f46147a = j10;
        this.f46148b = notificationCenterDelegateArr;
        this.f46149c = i10;
        this.d = w0Var;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == i12 && (hVar = (a0.h) objArr[0]) != null) {
            ...
            if (hVar.d(j10)) {
                ...
                NotificationCenter.NotificationCenterDelegate[] notificationCenterDelegateArr = this.f46148b;
                if (notificationCenterDelegateArr[0] != null) {
                    NotificationCenter.getInstance(this.f46149c).addObserver(notificationCenterDelegateArr[0], i12);
