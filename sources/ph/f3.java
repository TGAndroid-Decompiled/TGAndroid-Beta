...
public class f3 extends View {
    ...
    public gj0 W;
    public int f41605a;
    public float f41606a0;
    public float f41607b;
    public int f41608b0;
    public float f41609c;
    public int f41610c0;
    public long d;
    public int f41611d0;
    public boolean e;
    public boolean f41612e0;
    public final boolean f41613f;
    public float f41614f0;
    public float f41615g0;
    public int h;
    public int f41616h0;
    public Runnable f41617i0;
    public final el0 f41618j0;
    public ValueAnimator f41619k0;
    public float f41620l0;
    public final rc m0;
    public Drawable f41621n;
    public final Rect f41622n0;
    public final RectF f41623o0;
    public final RectF f41624p0;
    public final Path f41625q0;
    public boolean f41626r;
    public float f41627r0;
    public boolean f41628s;
    public float f41629s0;
    public float f41630t0;
    public float f41631u0;
    public float v;
    public boolean f41632v0;
    public final RectF f41633w;
    public boolean f41634w0;
    public float f41635x;
    public boolean f41636x0;
    public float f41637y;
    public Path f41638y0;
    public float f41639z0;
    ...
    public f3(Context context, int i10) {
        ...
        this.f41633w = new RectF(AndroidUtilities.dp(11.0f), AndroidUtilities.dp(6.0f), AndroidUtilities.dp(11.0f), AndroidUtilities.dp(7.0f));
        this.f41635x = AndroidUtilities.dp(2.0f);
        this.f41637y = AndroidUtilities.dp(7.0f);
        ...
        this.f41608b0 = AndroidUtilities.dp(2.0f);
        this.f41618j0 = new el0(this, 27);
        this.f41620l0 = 1.0f;
        this.m0 = new rc(this, 2.0f, 5.0f);
        this.f41622n0 = new Rect();
        this.f41623o0 = new RectF();
        this.f41624p0 = new RectF();
        this.f41625q0 = new Path();
        this.f41634w0 = true;
        this.G0 = new RectF();
        this.f41605a = i10;
    ...
    public static java.lang.CharSequence b(java.lang.CharSequence r12, android.text.TextPaint r13) {
        throw new UnsupportedOperationException("Method not decompiled: ph.f3.b(java.lang.CharSequence, android.text.TextPaint):java.lang.CharSequence");
    }
    ...
    public static float g(CharSequence charSequence, TextPaint textPaint) {
        ...
        if (f51VarArr != null && f51VarArr.length != 0) {
            ...
            for (int i13 = 0; i13 < f51VarArr.length; i13++) {
                int spanStart2 = spanned.getSpanStart(f51VarArr[i13]);
                int spanEnd2 = spanned.getSpanEnd(f51VarArr[i13]);
                ...
                if (i12 - max > 0) {
                    ...
                    textPaint3.setTypeface(f51VarArr[i13].f24789a);
    ...
    public void c(Canvas canvas, float f10) {
        int i10 = this.f41616h0;
        Paint paint = this.C;
        if (i10 != 0) {
            paint.setShadowLayer(this.f41614f0, 0.0f, this.f41615g0, org.telegram.ui.ActionBar.j6.l1(f10, i10));
        }
        int alpha = paint.getAlpha();
        paint.setAlpha((int) (alpha * f10));
        Path path = this.f41625q0;
        canvas.drawPath(path, paint);
        paint.setAlpha(alpha);
        if (this.f41636x0) {
            int dp = AndroidUtilities.dp(64.0f);
            this.D0.reset();
            this.D0.postTranslate(this.f41623o0.left + (((this.f41630t0 * 4.0f) + (dp * 2)) * (((float) ((System.currentTimeMillis() - this.F0) % 4000)) / 4000.0f)) + (-dp), 0.0f);
            this.C0.setLocalMatrix(this.D0);
            this.E0.setLocalMatrix(this.D0);
            canvas.drawPath(path, this.A0);
            canvas.drawPath(this.f41638y0, this.B0);
            invalidate();
        }
    }
    ...
    public final void d(Path path, float f10, float f11, float f12, RectF rectF, Rect rect) {
        ...
        if (i10 != 1 && i10 != 3) {
            float clamp = Utilities.clamp(AndroidUtilities.lerp(getPaddingTop(), getMeasuredHeight() - getPaddingBottom(), this.f41607b) + this.f41609c, getMeasuredHeight() - getPaddingBottom(), getPaddingTop());
            float min2 = Math.min(Math.max(getPaddingTop(), clamp - f15) + f11, getMeasuredHeight() - getPaddingBottom());
            float f16 = min2 - f11;
            float f17 = this.f41637y;
            ...
            float clamp2 = Utilities.clamp(AndroidUtilities.lerp(getPaddingLeft(), getMeasuredWidth() - getPaddingRight(), this.f41607b) + this.f41609c, getMeasuredWidth() - getPaddingRight(), getPaddingLeft());
            float min3 = Math.min(Math.max(getPaddingLeft(), clamp2 - f14) + f10, getMeasuredWidth() - getPaddingRight());
            float f18 = min3 - f10;
            float f19 = this.f41637y;
        ...
        if (this.f41605a == 0) {
            path.lineTo(rectF.left, this.f41637y + f13 + AndroidUtilities.dp(2.0f));
            path.lineTo(rectF.left, this.f41637y + f13);
            ...
            path.lineTo(rectF.left, f13 - this.f41637y);
            path.lineTo(rectF.left, (f13 - this.f41637y) - AndroidUtilities.dp(2.0f));
            if (rect != null) {
        ...
        if (this.f41605a == 1) {
            path.lineTo((f13 - this.f41637y) - AndroidUtilities.dp(2.0f), rectF.top);
            path.lineTo(f13 - this.f41637y, rectF.top);
            path.lineTo(f13 - AndroidUtilities.dp(1.0f), rectF.top - this.B);
            this.f41627r0 = f13;
            this.f41629s0 = rectF.top - this.B;
            path.lineTo(AndroidUtilities.dp(1.0f) + f13, rectF.top - this.B);
            path.lineTo(this.f41637y + f13, rectF.top);
            path.lineTo(this.f41637y + f13 + AndroidUtilities.dp(2.0f), rectF.top);
            if (rect != null) {
        ...
        if (this.f41605a == 2) {
            path.lineTo(rectF.right, (f13 - this.f41637y) - AndroidUtilities.dp(2.0f));
            path.lineTo(rectF.right, f13 - this.f41637y);
            ...
            path.lineTo(rectF.right, this.f41637y + f13);
            path.lineTo(rectF.right, this.f41637y + f13 + AndroidUtilities.dp(2.0f));
            if (rect != null) {
        ...
        if (this.f41605a == 3) {
            path.lineTo(this.f41637y + f13 + AndroidUtilities.dp(2.0f), rectF.bottom);
            path.lineTo(this.f41637y + f13, rectF.bottom);
            path.lineTo(AndroidUtilities.dp(1.0f) + f13, rectF.bottom + this.B);
            this.f41627r0 = f13;
            this.f41629s0 = rectF.bottom + this.B;
            path.lineTo(f13 - AndroidUtilities.dp(1.0f), rectF.bottom + this.B);
            path.lineTo(f13 - this.f41637y, rectF.bottom);
            path.lineTo((f13 - this.f41637y) - AndroidUtilities.dp(2.0f), rectF.bottom);
            if (rect != null) {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (!this.F || this.I != null) {
            ...
            if (this.f41626r) {
                ...
                d += this.f41635x + this.f41621n.getIntrinsicWidth();
                f10 = Math.max(this.f41621n.getIntrinsicHeight(), f10);
            }
            if (this.W != null) {
                d += this.f41610c0 + this.f41608b0;
                f10 = Math.max(this.f41611d0, f10);
            }
            float f15 = d;
            RectF rectF2 = this.f41633w;
            float f16 = rectF2.left + f15 + rectF2.right;
            float f17 = rectF2.top + f10 + rectF2.bottom;
            boolean z11 = this.f41632v0;
            RectF rectF3 = this.f41623o0;
            if (z11 && Math.abs(f16 - this.f41630t0) <= 0.1f && Math.abs(f17 - this.f41631u0) <= 0.1f) {
                rectF = rectF3;
            } else {
                this.f41630t0 = f16;
                this.f41631u0 = f17;
                d(this.f41625q0, f16, f17, 0.0f, rectF3, this.f41622n0);
                rectF = rectF3;
                if (this.f41636x0) {
                    d(this.f41638y0, f16, f17, this.f41639z0, this.f41624p0, null);
                }
            }
            if (this.f41613f) {
                f11 = e;
            ...
            if (e < 1.0f && this.e) {
                ...
                canvas.scale(lerp, lerp, this.f41627r0, this.f41629s0);
            }
            float a2 = this.m0.a(0.025f);
            if (a2 != 1.0f) {
                canvas.scale(a2, a2, this.f41627r0, this.f41629s0);
            }
            if (this.f41620l0 != 1.0f) {
                int i10 = this.f41605a;
                int i11 = -1;
                if (i10 != 3 && i10 != 1) {
                    if (i10 == 0) {
                    ...
                    float max = (this.f41620l0 - 1.0f) * Math.max(paddingRight, AndroidUtilities.dp(24.0f));
                    if (this.f41605a != 0) {
                        i11 = 1;
                    }
                    ...
                    float max2 = (this.f41620l0 - 1.0f) * Math.max(paddingTop, AndroidUtilities.dp(24.0f));
                    if (this.f41605a != 1) {
                        i11 = 1;
                    }
            ...
            if (zVar != null) {
                ...
                this.U.setBounds(this.f41622n0);
                this.U.draw(canvas);
            }
            ...
            if (gj0Var != null) {
                if (this.f41612e0) {
                    ...
                    float f21 = this.f41606a0 + f19;
                    f12 = 255.0f;
                    float f22 = this.f41611d0 / 2.0f;
                    gj0Var.setBounds((int) f20, (int) (f21 - f22), (int) (f20 + this.f41610c0), (int) (f22 + f21));
                    f13 = this.f41610c0 + this.f41608b0 + 0.0f;
                } else {
                    f12 = 255.0f;
                    float f23 = (0.0f + rectF.right) - (rectF2.right / 2.0f);
                    float f24 = this.f41606a0 + f19;
                    float f25 = this.f41611d0 / 2.0f;
                    gj0Var.setBounds((int) (f23 - this.f41610c0), (int) (f24 - f25), (int) f23, (int) (f25 + f24));
                    f13 = 0.0f;
                }
            ...
            if (this.F) {
                ...
                j6Var.f25901w = (int) (f14 * f12);
                j6Var.draw(canvas2);
            }
            if (f3Var.f41626r) {
                if (f3Var.f41621n == null) {
                    Drawable mutate2 = f3Var.getContext().getResources().getDrawable(R.drawable.msg_mini_close_tooltip).mutate();
                    f3Var.f41621n = mutate2;
                    mutate2.setColorFilter(new PorterDuffColorFilter(2113929215, PorterDuff.Mode.MULTIPLY));
                }
                f3Var.f41621n.setAlpha((int) (f14 * f12));
                Drawable drawable = f3Var.f41621n;
                drawable.setBounds((int) ((rectF.right - (rectF2.right * 0.66f)) - drawable.getIntrinsicWidth()), (int) (rectF.centerY() - (f3Var.f41621n.getIntrinsicHeight() / 2.0f)), (int) (rectF.right - (rectF2.right * 0.66f)), (int) ((f3Var.f41621n.getIntrinsicHeight() / 2.0f) + rectF.centerY()));
                f3Var.f41621n.draw(canvas2);
            }
            canvas2.restore();
        }
    }
    ...
    public final void e(boolean z4) {
        AndroidUtilities.cancelRunOnUIThread(this.f41618j0);
        Runnable runnable = this.f41617i0;
        if (runnable != null) {
        ...
        invalidate();
        Runnable runnable2 = this.f41617i0;
        if (runnable2 != null) {
            AndroidUtilities.runOnUIThread(runnable2, z5Var.f31241c * ((float) z5Var.f31243g));
        }
        this.N.d(true);
    }
    ...
    public final void i() {
        ...
        if (!this.F) {
            ...
            this.f41633w.set(dp, dp2, AndroidUtilities.dp(f10), AndroidUtilities.dp(7.0f));
        }
    }
    ...
    public final void k(gj0 gj0Var) {
        ...
        gj0 gj0Var4 = this.W;
        this.f41610c0 = gj0Var4.f25148b;
        this.f41611d0 = gj0Var4.f25150c;
        this.f41612e0 = true;
    }

    public final void l(float f10, float f11, float f12, float f13) {
        this.f41633w.set(AndroidUtilities.dpf2(f10), AndroidUtilities.dpf2(f11), AndroidUtilities.dpf2(f12), AndroidUtilities.dpf2(f13));
    }

    public final void m(float f10, float f11) {
        if (Math.abs(this.f41607b - f10) >= 1.0f || Math.abs(this.f41609c - AndroidUtilities.dp(f11)) >= 1.0f) {
            this.f41632v0 = false;
            invalidate();
        }
        this.f41607b = f10;
        this.f41609c = AndroidUtilities.dp(f11);
    }

    public final void n(float f10, float f11) {
        if (Math.abs(this.f41607b - f10) >= 1.0f || Math.abs(this.f41609c - f11) >= 1.0f) {
            this.f41632v0 = false;
            invalidate();
        }
        this.f41607b = f10;
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r15) {
        throw new UnsupportedOperationException("Method not decompiled: ph.f3.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public final void q(boolean z4) {
        ...
        if (z4) {
            ...
            this.f41635x = AndroidUtilities.dp(6.0f);
            return;
        }
        float dp = AndroidUtilities.dp(11.0f);
        float dp2 = AndroidUtilities.dp(6.0f);
    ...
    public final void v() {
        if (this.S && this.R) {
            ValueAnimator valueAnimator = this.f41619k0;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f41619k0 = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.f41619k0 = ofFloat;
            ofFloat.addUpdateListener(new nh.e5(this, 16));
            this.f41619k0.addListener(new j2(this, 1));
            this.f41619k0.setInterpolator(nr.f27350k);
            this.f41619k0.setDuration(300L);
            this.f41619k0.start();
        }
        AndroidUtilities.makeAccessibilityAnnouncement(getText());
        this.S = true;
        invalidate();
        el0 el0Var = this.f41618j0;
