...
public final class b1 extends dt {
    ...
    public final void a(Canvas canvas, long j10, int i10, int i11, float f10) {
        ...
        boolean z10 = true;
        if ((t0Var == null || !t0Var.k()) && this.L.size() > 4 && this.N) {
            z4 = false;
        } else {
            z4 = true;
        }
    ...
    public final void c(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (l5Var != null) {
                    l5Var.setColorFilter(this.O.f41470e3);
                }
                c1Var.f41359n.draw(canvas, c1Var.h[this.H]);
                i10++;
            } else {
                return;
            }
    ...
    public final void d(Canvas canvas, float f10) {
        ...
        if (this.L != null) {
            ...
            for (int i10 = 0; i10 < this.L.size(); i10++) {
                ...
                org.telegram.ui.Components.l5 l5Var2 = c1Var.f41357c;
                if (l5Var2 != null) {
                ...
                PorterDuffColorFilter porterDuffColorFilter = this.O.f41470e3;
                if (porterDuffColorFilter != null && (l5Var = c1Var.f41357c) != null) {
    ...
    public final void i(long r14) {
        throw new UnsupportedOperationException("Method not decompiled: ph.b1.i(long):void");
    }
}
