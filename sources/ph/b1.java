    ...
    public final void c(Canvas canvas) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (l5Var != null) {
                    l5Var.setColorFilter(this.O.f41420e3);
                }
                c1Var.f41319n.draw(canvas, c1Var.h[this.H]);
                i10++;
            } else {
                return;
            }
    ...
    public final void d(Canvas canvas, float f10) {
        ...
        if (this.L != null) {
            ...
            for (int i10 = 0; i10 < this.L.size(); i10++) {
                ...
                org.telegram.ui.Components.l5 l5Var2 = c1Var.f41317c;
                if (l5Var2 != null) {
                ...
                PorterDuffColorFilter porterDuffColorFilter = this.O.f41420e3;
                if (porterDuffColorFilter != null && (l5Var = c1Var.f41317c) != null) {
