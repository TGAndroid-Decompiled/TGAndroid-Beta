...
public final class m0 extends View {
    ...
    public l0 M;
    public Runnable N;
    public final Paint f41987a;
    public final TextPaint f41988b;
    public final TextPaint f41989c;
    public final Paint d;
    public final Paint e;
    public final Paint f41990f;
    public final rc h;
    public gj0 f41991n;
    public final StaticLayout f41992r;
    public final float f41993s;
    public final float v;
    public StaticLayout f41994w;
    public float f41995x;
    public float f41996y;
    ...
    public final void b(int i10, int i11, CharSequence charSequence) {
        float f10;
        gj0 gj0Var = this.f41991n;
        if (gj0Var != null) {
            gj0Var.setCallback(null);
            this.f41991n.A(true);
        }
        gj0 gj0Var2 = new gj0(i10, AndroidUtilities.dp(36.0f), AndroidUtilities.dp(36.0f));
        this.f41991n = gj0Var2;
        gj0Var2.setCallback(this);
        this.f41991n.start();
        StaticLayout staticLayout = new StaticLayout(charSequence, this.f41989c, AndroidUtilities.displaySize.x, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        this.f41994w = staticLayout;
        float f11 = 0.0f;
        if (staticLayout.getLineCount() > 0) {
            f10 = this.f41994w.getLineWidth(0);
        } else {
            f10 = 0.0f;
        }
        this.f41995x = f10;
        if (this.f41994w.getLineCount() > 0) {
            f11 = this.f41994w.getLineLeft(0);
        }
        this.f41996y = f11;
        this.D = false;
        invalidate();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f14 = 1.0f - d10;
        Paint paint = this.f41987a;
        paint.setAlpha((int) (90.0f * f14 * d));
        Canvas canvas2 = canvas;
        canvas2.drawRect(0.0f, 0.0f, getWidth(), getHeight(), paint);
        float max = Math.max(this.f41993s, AndroidUtilities.dp(54.0f)) + AndroidUtilities.dp(42.0f);
        int dp = AndroidUtilities.dp(111.0f);
        StaticLayout staticLayout = this.f41992r;
        ...
        float dp2 = AndroidUtilities.dp(74.0f) + this.f41995x;
        ...
        if (d10 > 0.0f) {
            ...
            gj0 gj0Var = this.f41991n;
            if (gj0Var != null) {
                gj0Var.setAlpha((int) (f16 * f13));
                this.f41991n.setBounds((int) (rectF.left + AndroidUtilities.dp(9.0f)), (int) (rectF.top + AndroidUtilities.dp(6.0f)), (int) (rectF.left + AndroidUtilities.dp(45.0f)), (int) (rectF.top + AndroidUtilities.dp(f12)));
                this.f41991n.draw(canvas2);
            }
            if (this.f41994w != null) {
                canvas2.save();
                canvas2.translate((rectF.left + AndroidUtilities.dp(52.0f)) - this.f41996y, rectF.centerY() - (this.f41994w.getHeight() / 2.0f));
                this.f41989c.setAlpha((int) (f16 * f13));
                this.f41994w.draw(canvas2);
                canvas2.restore();
            }
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f41991n && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
    ...
    public m0(Context context, String str) {
        ...
        this.f41988b = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f41989c = textPaint2;
        ...
        this.f41992r = staticLayout;
        this.f41993s = staticLayout.getLineCount() > 0 ? staticLayout.getLineWidth(0) : 0.0f;
