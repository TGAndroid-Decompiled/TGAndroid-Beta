...
public final class k2 extends org.telegram.ui.ActionBar.h5 {
    ...
    public final void m() {
        ...
        l2 l2Var = a3Var.d;
        r2 r2Var = a3Var.C;
        AnimatorSet animatorSet = this.f41842f;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
        ...
        this.f41842f = animatorSet2;
        animatorSet2.setDuration(320L);
        this.f41842f.setInterpolator(nr.h);
        this.f41842f.playTogether(arrayList);
        this.f41842f.addListener(new ex0(15, this, searchField));
        this.f41842f.start();
    }
    ...
    public final void n() {
        ...
        this.f41842f.setInterpolator(nr.h);
        this.f41842f.playTogether(arrayList);
        this.f41842f.addListener(new j2(this, 0));
        this.f41842f.start();
    }
    ...
    public final void q(EditText editText) {
        ...
        s2 s2Var = this.h.f41265r;
        org.telegram.ui.web.o0 o0Var = s2Var.v;
        if (!TextUtils.equals(s2Var.f42647f, obj)) {
            if (s2Var.e != -1) {
                ConnectionsManager.getInstance(s2Var.f42651w.f41254a).cancelRequest(s2Var.e, true);
                s2Var.e = -1;
            }
            s2Var.d = false;
            s2Var.h = null;
