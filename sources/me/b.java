...
public final class b {
    ...
    public final boolean a(MotionEvent motionEvent, View view) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action != 2) {
                    if (action == 3 && (this.f14798c & 1) != 0) {
                        b(view, x10, y3);
                        return true;
                    }
                } else if ((this.f14798c & 1) != 0) {
                    aVar.onClickTouchMove(view, x10, y3);
                    if ((this.f14798c & 4) != 0) {
                        aVar.onLongPressMove(view, motionEvent, x10, y3, this.f14799f, this.f14800g);
                        return true;
                    }
                ...
                if ((i10 & 1) != 0) {
                    if ((i10 & 4) != 0) {
                        ...
                        if ((this.f14798c & 256) == 0 && view != null) {
