...
public final class r extends n implements NavigableMap, Map {
    public static final r f50752f;
    public final transient z f50753c;
    public final transient m d;
    public final transient r f50754e;

    static {
        z x4 = s.x(v.f50765b);
        i iVar = m.f50736b;
        f50752f = new r(x4, x.f50770e, null);
    }
    ...
    public static r b(TreeMap treeMap) {
        ...
        Map.Entry[] entryArr = (Map.Entry[]) entrySet.toArray(n.f50742b);
                ...
                if (equals) {
                    ...
                    while (i10 < length) {
                        ...
                        if (vVar.compare(key2, key3) != 0) {
                            ...
                            throw new IllegalArgumentException(j7.l1.n("Multiple entries with same key: ", String.valueOf(entry3), " and ", String.valueOf(entry4)));
                        }
                    }
                }
    ...
    public static r c(Comparator comparator) {
        ...
        z x4 = s.x(comparator);
        i iVar = m.f50736b;
        return new r(x4, x.f50770e, null);
    }
    ...
    public final r headMap(Object obj, boolean z10) {
        obj.getClass();
        return g(0, this.f50753c.y(obj, z10));
    }

    @Override
    public final NavigableSet descendingKeySet() {
        return this.f50753c.descendingSet();
    }
    ...
    public final r subMap(Object obj, boolean z10, Object obj2, boolean z11) {
        obj.getClass();
        obj2.getClass();
        if (this.f50753c.d.compare(obj, obj2) <= 0) {
    ...
    public final r tailMap(Object obj, boolean z10) {
        obj.getClass();
        return g(this.f50753c.z(obj, z10), this.d.size());
    }
    ...
    public final java.lang.Object get(java.lang.Object r4) {
        throw new UnsupportedOperationException("Method not decompiled: z6.r.get(java.lang.Object):java.lang.Object");
    }
