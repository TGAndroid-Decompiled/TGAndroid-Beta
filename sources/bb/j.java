...
public final class j extends kd.j implements p {
    ...
    public final id.c create(Object obj, id.c cVar) {
        switch (this.f2556a) {
            ...
            case 3:
                return new j((p) this.f2558c, this.d, cVar, 3);
            case 4:
                return new j((za.l) this.f2558c, (id.h) this.d, cVar, 4);
            case 5:
                return new j((y) this.f2558c, (String) this.d, cVar, 5);
            default:
                return new j((fg.f) this.f2558c, (ArrayList) this.d, cVar, 6);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        switch (this.f2556a) {
            case 0:
                return ((j) create((c0) obj, (id.c) obj2)).invokeSuspend(gd.i.f10588a);
            case 1:
                return ((j) create((t) obj, (id.c) obj2)).invokeSuspend(gd.i.f10588a);
            case 2:
                return ((j) create((c0) obj, (id.c) obj2)).invokeSuspend(gd.i.f10588a);
            case 3:
                return ((j) create((c0) obj, (id.c) obj2)).invokeSuspend(gd.i.f10588a);
