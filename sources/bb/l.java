...
public final class l {
    public static final n1.d f3480c = new n1.d("firebase_sessions_enabled");
    ...
    public static final n1.d f3481f = new n1.d("firebase_sessions_cache_duration");
    public static final n1.d f3482g = new n1.d("firebase_sessions_cache_updated_time");
    public final k1.f f3483a;
    public e f3484b;
    ...
    public l(k1.f fVar) {
        ...
        if (!booleanValue) {
            ...
            id.i iVar2 = id.i.f11081a;
            if (booleanValue) {
                obj = a2.fold(iVar2, x.f48944c);
            } else {
                obj = a2;
            }
            hVar = (id.h) obj;
        ...
        ge.e eVar = m0.f48908a;
        if (hVar != eVar && hVar.get(id.d.f11080a) == null) {
            hVar = hVar.plus(eVar);
        }
        zd.h hVar2 = new zd.h(hVar, currentThread, a2);
        hVar2.L(d0.f48876a, hVar2, iVar);
        w0 w0Var = hVar2.e;
        if (w0Var != null) {
            int i10 = w0.f48941f;
            w0Var.h(false);
    ...
    public static final void a(l lVar, n1.b bVar) {
        lVar.getClass();
        lVar.f3484b = new e((Boolean) bVar.a(f3480c), (Double) bVar.a(d), (Integer) bVar.a(e), (Integer) bVar.a(f3481f), (Long) bVar.a(f3482g));
    }
