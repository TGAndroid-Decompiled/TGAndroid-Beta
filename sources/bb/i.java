...
public final class i extends kd.j implements p {
    ...
    public final id.c create(Object obj, id.c cVar) {
        switch (this.f3471a) {
            ...
            case 3:
                return new i((p) this.f3473c, this.d, cVar, 3);
            case 4:
                return new i((za.l) this.f3473c, (id.h) this.d, cVar, 4);
            case 5:
                return new i((y) this.f3473c, (String) this.d, cVar, 5);
            default:
                return new i((ni.f) this.f3473c, (ArrayList) this.d, cVar, 6);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        switch (this.f3471a) {
            case 0:
                return ((i) create((c0) obj, (id.c) obj2)).invokeSuspend(gd.i.f9616a);
            case 1:
                return ((i) create((k1.t) obj, (id.c) obj2)).invokeSuspend(gd.i.f9616a);
            case 2:
                return ((i) create((c0) obj, (id.c) obj2)).invokeSuspend(gd.i.f9616a);
            case 3:
                return ((i) create((c0) obj, (id.c) obj2)).invokeSuspend(gd.i.f9616a);
