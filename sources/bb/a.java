...
public final class a {
    ...
    public a(Context context) {
        ...
        this.f2558a = bundle == null ? Bundle.EMPTY : bundle;
    }

    public Boolean a() {
        Bundle bundle = this.f2558a;
    ...
    public void b(String str, Bitmap bitmap) {
        ...
        this.f2558a.putParcelable(str, bitmap);
    }
            ...
            if (i0Var.b()) {
                ...
                switch (i10) {
                    case 1:
                        ...
                        i0Var.f16481c = Rating.newHeartRating(z10);
                        break;
                    case 2:
                        if (i10 != 2 || f7 != 1.0f) {
                            z10 = false;
                        }
                        i0Var.f16481c = Rating.newThumbRating(z10);
                        break;
                    case 3:
                    case 4:
                    case 5:
                        i0Var.f16481c = Rating.newStarRating(i10, i0Var.a());
                        break;
                    case 6:
                        i0Var.f16481c = Rating.newPercentageRating((i10 == 6 && i0Var.b()) ? -1.0f : -1.0f);
                        break;
                    default:
                        rating = null;
                        break;
                }
                this.f2558a.putParcelable(str, rating);
            }
            i0Var.f16481c = Rating.newUnratedRating(i10);
        }
        rating = i0Var.f16481c;
        this.f2558a.putParcelable(str, rating);
    }
    ...
    public void e(String str, String str2) {
        ...
        this.f2558a.putCharSequence(str, str2);
    }
    ...
    public void f(CharSequence charSequence, String str) {
        ...
        this.f2558a.putCharSequence(str, charSequence);
    }

    public a() {
        this.f2558a = new Bundle();
    }
}
