...
public final class a extends Thread {
    public static final AtomicIntegerFieldUpdater f9621r = AtomicIntegerFieldUpdater.newUpdater(a.class, "workerCtl$volatile");
    ...
    public a(c cVar, int i10) {
        ...
        this.f9622a = new m();
        this.f9623b = new Object();
        this.f9624c = b.d;
        this.nextParkedWorker = c.v;
        int nanoTime = (int) System.nanoTime();
        this.f9625f = nanoTime == 0 ? 42 : nanoTime;
        g(i10);
    }
    ...
    public final i a(boolean z10) {
        ...
        m mVar = this.f9622a;
        if (bVar != bVar2) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = c.f9632r;
            do {
                j3 = atomicLongFieldUpdater.get(cVar);
                if (((int) ((9223367638808264704L & j3) >> 42)) == 0) {
                    mVar.getClass();
                    loop1: while (true) {
                        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = m.f9650b;
                        i iVar2 = (i) atomicReferenceFieldUpdater.get(mVar);
                        if (iVar2 != null && iVar2.f9642b.f6245a == 1) {
            ...
            } while (!c.f9632r.compareAndSet(cVar, j3, j3 - 4398046511104L));
            this.f9624c = b.f9627a;
        }
        if (z10) {
            if (e(cVar.f9634a * 2) != 0) {
                z11 = false;
            }
            if (z11 && (f10 = f()) != null) {
                return f10;
            ...
            mVar.getClass();
            i iVar4 = (i) m.f9650b.getAndSet(mVar, null);
            if (iVar4 == null) {
                iVar4 = mVar.a();
            }
            if (iVar4 != null) {
    ...
    public final i f() {
        ...
        if (e == 0) {
            ...
            return (i) cVar.f9637f.d();
        }
        i iVar2 = (i) cVar.f9637f.d();
        if (iVar2 != null) {
            return iVar2;
        }
        return (i) cVar.e.d();
    ...
    public final boolean i(b bVar) {
        ...
        if (z10) {
            c.f9632r.addAndGet(this.f9626n, 4398046511104L);
        }
        if (bVar2 != bVar) {
            this.f9624c = bVar;
        }
            ...
            if (aVar != null && aVar != this) {
                ...
                if (iVar != null) {
                    ...
                    while (true) {
                        ...
                        k.f9647f.getClass();
                        m mVar2 = mVar;
                        long nanoTime = System.nanoTime() - iVar4.f9641a;
                        long j13 = k.f9645b;
                        if (nanoTime < j13) {
                            j11 = j13 - nanoTime;
                            iVar2 = null;
