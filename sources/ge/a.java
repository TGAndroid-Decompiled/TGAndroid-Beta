...
public final class a extends Thread {
    public static final AtomicIntegerFieldUpdater f9618r = AtomicIntegerFieldUpdater.newUpdater(a.class, "workerCtl$volatile");
    public final m f9619a;
    ...
    public a(c cVar, int i10) {
        ...
        this.f9622f = nanoTime == 0 ? 42 : nanoTime;
        g(i10);
    }
    ...
    public final i a(boolean z10) {
        ...
        m mVar = this.f9619a;
        if (bVar != bVar2) {
            AtomicLongFieldUpdater atomicLongFieldUpdater = c.f9629r;
            do {
                j3 = atomicLongFieldUpdater.get(cVar);
                if (((int) ((9223367638808264704L & j3) >> 42)) == 0) {
                    mVar.getClass();
                    loop1: while (true) {
                        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = m.f9647b;
                        i iVar2 = (i) atomicReferenceFieldUpdater.get(mVar);
                        if (iVar2 != null && iVar2.f9639b.f6242a == 1) {
            ...
            } while (!c.f9629r.compareAndSet(cVar, j3, j3 - 4398046511104L));
            this.f9621c = b.f9624a;
        }
        if (z10) {
            if (e(cVar.f9631a * 2) != 0) {
                z11 = false;
            }
            if (z11 && (f10 = f()) != null) {
                return f10;
            ...
            mVar.getClass();
            i iVar4 = (i) m.f9647b.getAndSet(mVar, null);
            if (iVar4 == null) {
                iVar4 = mVar.a();
            }
            if (iVar4 != null) {
    ...
    public final i f() {
        ...
        if (e == 0) {
            ...
            return (i) cVar.f9634f.d();
        }
        i iVar2 = (i) cVar.f9634f.d();
        if (iVar2 != null) {
            return iVar2;
        }
        return (i) cVar.e.d();
    ...
    public final boolean i(b bVar) {
        ...
        if (z10) {
            c.f9629r.addAndGet(this.f9623n, 4398046511104L);
        }
        if (bVar2 != bVar) {
            this.f9621c = bVar;
        }
            ...
            if (aVar != null && aVar != this) {
                ...
                if (iVar != null) {
                    ...
                    while (true) {
                        ...
                        k.f9644f.getClass();
                        m mVar2 = mVar;
                        long nanoTime = System.nanoTime() - iVar4.f9638a;
                        long j13 = k.f9642b;
                        if (nanoTime < j13) {
                            j11 = j13 - nanoTime;
                            iVar2 = null;
