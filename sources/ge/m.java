...
public final class m {
    public static final AtomicReferenceFieldUpdater f8778b = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "lastScheduledTask$volatile");
    public static final AtomicIntegerFieldUpdater f8779c = AtomicIntegerFieldUpdater.newUpdater(m.class, "producerIndex$volatile");
    ...
    public final AtomicReferenceArray f8780a = new AtomicReferenceArray(128);
    ...
    public final i a() {
        ...
        while (true) {
            ...
            if (i10 - f8779c.get(this) == 0) {
                return null;
            }
            int i11 = i10 & 127;
            if (atomicIntegerFieldUpdater.compareAndSet(this, i10, i10 + 1) && (iVar = (i) this.f8780a.getAndSet(i11, null)) != null) {
                if (iVar.f8770b.f5019a == 1) {
    ...
    public final i b(int i10, boolean z10) {
        int i11 = i10 & 127;
        AtomicReferenceArray atomicReferenceArray = this.f8780a;
