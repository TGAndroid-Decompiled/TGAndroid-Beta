...
public final class m {
    public static final AtomicReferenceFieldUpdater f9633b = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "lastScheduledTask$volatile");
    public static final AtomicIntegerFieldUpdater f9634c = AtomicIntegerFieldUpdater.newUpdater(m.class, "producerIndex$volatile");
    ...
    public final AtomicReferenceArray f9635a = new AtomicReferenceArray(128);
    ...
    public final i a() {
        ...
        while (true) {
            ...
            if (i10 - f9634c.get(this) == 0) {
                return null;
            }
            int i11 = i10 & 127;
            if (atomicIntegerFieldUpdater.compareAndSet(this, i10, i10 + 1) && (iVar = (i) this.f9635a.getAndSet(i11, null)) != null) {
                if (iVar.f9625b.f6228a == 1) {
    ...
    public final i b(int i10, boolean z10) {
        int i11 = i10 & 127;
        AtomicReferenceArray atomicReferenceArray = this.f9635a;
