...
public final class m {
    public static final AtomicReferenceFieldUpdater f9651b = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "lastScheduledTask$volatile");
    public static final AtomicIntegerFieldUpdater f9652c = AtomicIntegerFieldUpdater.newUpdater(m.class, "producerIndex$volatile");
    ...
    public final AtomicReferenceArray f9653a = new AtomicReferenceArray(128);
    ...
    public final i b(int i10, boolean z10) {
        int i11 = i10 & 127;
        AtomicReferenceArray atomicReferenceArray = this.f9653a;
