...
public final class k implements ef.a {
    public final char f8163a;
    public int f8164b = 0;
    public final LinkedList f8165c = new LinkedList();
    ...
    public final int b(ye.b bVar, ye.b bVar2) {
        ...
        LinkedList linkedList = this.f8165c;
    ...
    public final void f(ef.a aVar) {
        ...
        while (listIterator.hasNext()) {
            ...
            if (c10 > c11) {
                ...
                throw new IllegalArgumentException("Cannot add two delimiter processors for char '" + this.f8163a + "' and minimum length " + c10);
            }
        }
        linkedList.add(aVar);
        this.f8164b = c10;
