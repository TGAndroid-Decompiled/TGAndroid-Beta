...
public final class i implements cf.a {
    public static final Pattern f8140j = Pattern.compile("^[!\"#\\$%&'\\(\\)\\*\\+,\\-\\./:;<=>\\?@\\[\\\\\\]\\^_`\\{\\|\\}~\\p{Pc}\\p{Pd}\\p{Pe}\\p{Pf}\\p{Pi}\\p{Po}\\p{Ps}]");
    public static final Pattern f8141k = Pattern.compile("^ *(?:\n *)?");
    public static final Pattern f8142l = Pattern.compile("^[\\p{Zs}\t\r\n\f]");
    public static final Pattern f8143m = Pattern.compile("^[!\"#$%&'()*+,./:;<=>?@\\[\\\\\\]^_`{|}~-]");
    public static final Pattern f8144n = Pattern.compile("\\s+");
    public final a1 f8145a;
    public final BitSet f8146b;
    ...
    public i(a1 a1Var, List list, List list2) {
        ...
        this.d = hashMap2;
        Set<Character> keySet = this.f8147c.keySet();
    ...
    public final String c(Pattern pattern) {
        if (this.f8149g >= this.f8148f.length()) {
            return null;
        }
        Matcher matcher = pattern.matcher(this.f8148f);
        matcher.region(this.f8149g, this.f8148f.length());
        if (!matcher.find()) {
            return null;
        }
        this.f8149g = matcher.end();
        return matcher.group();
    }

    public final char d() {
        if (this.f8149g < this.f8148f.length()) {
            return this.f8148f.charAt(this.f8149g);
        }
        return (char) 0;
    }
