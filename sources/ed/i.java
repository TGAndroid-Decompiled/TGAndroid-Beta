...
public final class i implements cf.a {
    public static final Pattern f9044j = Pattern.compile("^[!\"#\\$%&'\\(\\)\\*\\+,\\-\\./:;<=>\\?@\\[\\\\\\]\\^_`\\{\\|\\}~\\p{Pc}\\p{Pd}\\p{Pe}\\p{Pf}\\p{Pi}\\p{Po}\\p{Ps}]");
    public static final Pattern f9045k = Pattern.compile("^ *(?:\n *)?");
    public static final Pattern f9046l = Pattern.compile("^[\\p{Zs}\t\r\n\f]");
    public static final Pattern f9047m = Pattern.compile("^[!\"#$%&'()*+,./:;<=>?@\\[\\\\\\]^_`{|}~-]");
    public static final Pattern f9048n = Pattern.compile("\\s+");
    public final z0 f9049a;
    public final BitSet f9050b;
    public final HashMap f9051c;
    ...
    public i(z0 z0Var, List list, List list2) {
        ...
        this.d = hashMap2;
        Set<Character> keySet = this.f9051c.keySet();
    ...
    public final String c(Pattern pattern) {
        if (this.f9054g >= this.f9053f.length()) {
            return null;
        }
        Matcher matcher = pattern.matcher(this.f9053f);
        matcher.region(this.f9054g, this.f9053f.length());
        if (!matcher.find()) {
            return null;
        }
        this.f9054g = matcher.end();
        return matcher.group();
    }

    public final char d() {
        if (this.f9054g < this.f9053f.length()) {
            return this.f9053f.charAt(this.f9054g);
        }
        return (char) 0;
    }
        ...
        while (bVar2 != null) {
            ...
            if (bVar2.d && aVar != null) {
                ...
                if (!z11) {
                    ...
                    ye.b bVar5 = bVar2.f49978e;
                    while (bVar5 != null && bVar5 != bVar4) {
                        ye.b bVar6 = bVar5.f49978e;
                        f(bVar5);
                        bVar5 = bVar6;
                    }
                    if (sVar2 != sVar && (pVar = (p) sVar2.f2641f) != sVar) {
                        a7.b(pVar, (p) sVar.f2640e);
                    }
    ...
    public final void f(ye.b bVar) {
        ye.b bVar2 = bVar.f49978e;
        if (bVar2 != null) {
            bVar2.f49979f = bVar.f49979f;
        }
        ye.b bVar3 = bVar.f49979f;
        if (bVar3 == null) {
            this.h = bVar2;
        } else {
            bVar3.f49978e = bVar2;
