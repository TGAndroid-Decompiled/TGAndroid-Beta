...
public final class i implements cf.a {
        ...
        while (bVar2 != null) {
            ...
            if (bVar2.d && aVar != null) {
                ...
                if (!z11) {
                    ...
                    ye.b bVar5 = bVar2.f49979e;
                    while (bVar5 != null && bVar5 != bVar4) {
                        ye.b bVar6 = bVar5.f49979e;
                        f(bVar5);
                        bVar5 = bVar6;
                    }
    ...
    public final void f(ye.b bVar) {
        ye.b bVar2 = bVar.f49979e;
        if (bVar2 != null) {
            bVar2.f49980f = bVar.f49980f;
        }
        ye.b bVar3 = bVar.f49980f;
        if (bVar3 == null) {
            this.h = bVar2;
        } else {
            bVar3.f49979e = bVar2;
