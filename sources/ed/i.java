...
public final class i implements cf.a {
        ...
        while (bVar2 != null) {
            ...
            if (bVar2.d && aVar != null) {
                ...
                if (!z11) {
                    ...
                    ye.b bVar5 = bVar2.f50008e;
                    while (bVar5 != null && bVar5 != bVar4) {
                        ye.b bVar6 = bVar5.f50008e;
                        f(bVar5);
                        bVar5 = bVar6;
                    }
    ...
    public final void f(ye.b bVar) {
        ye.b bVar2 = bVar.f50008e;
        if (bVar2 != null) {
            bVar2.f50009f = bVar.f50009f;
        }
        ye.b bVar3 = bVar.f50009f;
        if (bVar3 == null) {
            this.h = bVar2;
        } else {
            bVar3.f50008e = bVar2;
