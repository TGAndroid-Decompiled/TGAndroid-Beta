...
public final class a {
    ...
    public final RectF a(float f7, float f10, float f11, float f12) {
        ...
        if (i10 < arrayList.size()) {
            rectF = (RectF) arrayList.get(this.f15046b);
    ...
    public final RectF b(int i10) {
        if (i10 >= 0 && i10 < this.f15046b) {
            return (RectF) this.f15045a.get(i10);
        }
        StringBuilder j3 = c.j(i10, "index=", ", size=");
        j3.append(this.f15046b);
        throw new IndexOutOfBoundsException(j3.toString());
    }

    public final void c(int i10) {
        int i11;
        if (i10 >= 0 && i10 < (i11 = this.f15046b)) {
            int i12 = i11 - 1;
            ArrayList arrayList = this.f15045a;
    ...
    public final boolean equals(Object obj) {
        ...
        a aVar = (a) obj;
        if (this.f15046b != aVar.f15046b) {
            return false;
        }
        for (int i10 = 0; i10 < this.f15046b; i10++) {
            if (!((RectF) this.f15045a.get(i10)).equals(aVar.f15045a.get(i10))) {
                return false;
            }
        }
        return true;
    ...
    public final int hashCode() {
        int i10 = 1;
        for (int i11 = 0; i11 < this.f15046b; i11++) {
            i10 = (i10 * 31) + ((RectF) this.f15045a.get(i11)).hashCode();
        }
        return i10;
    }
}
