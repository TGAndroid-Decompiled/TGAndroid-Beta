...
public final class k extends FrameLayout {
    ...
    public k(Context context, f6 f6Var, boolean z10) {
        ...
        this.f8413c = h;
        wl.n(j6.f19264z6, f6Var, h, 1, 14.0f);
        linearLayout.addView(h, x5.t(-1, -2, 55, 0, 0, 0, 0));
    }

    public final void a(CharSequence charSequence, CharSequence charSequence2, int i10) {
        this.f8411a.setImageResource(i10);
        this.f8412b.setText(charSequence);
        this.f8413c.setText(charSequence2);
    }

    public void setText(CharSequence charSequence) {
        this.f8413c.setText(charSequence);
    }
}
