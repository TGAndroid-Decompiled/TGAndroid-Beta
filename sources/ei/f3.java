...
public final class f3 implements org.telegram.ui.web.h0 {
    ...
    public final void a() {
        ...
        aVar.f15439b = new c3(this, 0);
        qc V = new xc(k3Var.f8444p0, k3Var.E).V(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.BotEmojiStatusPermissionRequestGranted, UserObject.getUserName(user))), null, aVar);
        V.f27550j = 5000;
        V.k(true);
    }
    ...
    public final void n(TLRPC.InputInvoice inputInvoice, String str, TLObject tLObject) {
        ...
        if (xo0Var != null) {
            ...
            AndroidUtilities.hideKeyboard(j3Var);
            jd0 jd0Var = new jd0(this.f8333b);
            jd0Var.show();
    ...
    public final void q(boolean z10, boolean z11, String str, long j3, int i10, int i11, boolean z12, boolean z13) {
        ...
        if (obj.f8693f != 0) {
            ...
            spannableStringBuilder.setSpan(new z5(obj.f8693f, 1.4f, vVarArr[0].f8664l.f26867a.getFontMetricsInt()), 0, 1, 33);
