...
public final class a4 extends h51 {
    ...
    public final void bindView(View view, i51 i51Var, boolean z10, w51 w51Var, e61 e61Var) {
        ...
        if (obj instanceof TL_payments.connectedBotStarRef) {
            ...
            boolean z11 = i51Var.f24900r;
            View view2 = b4Var.e;
            ImageView imageView = b4Var.f8249f;
            TLRPC.User user = MessagesController.getInstance(b4Var.f8246a).getUser(Long.valueOf(connectedbotstarref.bot_id));
            f9 f9Var = new f9((e6) null);
            f9Var.r(user);
            b4Var.f8248c.e(user, f9Var);
            ...
            if (connectedbotstarref.commission_permille > 0) {
                ...
                d10 d10Var = new d10();
                d10Var.f32894f = i6.w0(null, i6.uj, false);
                d10Var.f32895n = l.G0(connectedbotstarref.commission_permille);
                if (d10Var.f32893c != null) {
                    d10Var.f32893c = null;
                    d10Var.a();
                }
            ...
            b4Var.f8250n.setText(spannableStringBuilder);
            ImageView imageView2 = b4Var.f8251r;
            if (z11) {
                i10 = 0;
            } else {
                i10 = 8;
            ...
            view2.setBackground(i6.K(dp, i6.v0(i11, b4Var.f8247b)));
            if (connectedbotstarref.revoked) {
            ...
            TLRPC.User user2 = MessagesController.getInstance(b4Var2.f8246a).getUser(Long.valueOf(starrefprogram.bot_id));
            f9 f9Var2 = new f9((e6) null);
            f9Var2.r(user2);
            b4Var2.f8248c.e(user2, f9Var2);
            b4Var2.h.setText(UserObject.getUserName(user2));
            SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder();
            if (starrefprogram.commission_permille > 0) {
                spannableStringBuilder2.append((CharSequence) " d");
                d10 d10Var2 = new d10();
                d10Var2.f32894f = i6.w0(null, i6.uj, false);
                d10Var2.f32895n = l.G0(starrefprogram.commission_permille);
                if (d10Var2.f32893c != null) {
                    d10Var2.f32893c = null;
                    d10Var2.a();
                }
            ...
            b4Var2.f8250n.setText(spannableStringBuilder2);
            ImageView imageView3 = b4Var2.f8251r;
            if (!z12) {
                i13 = 8;
            }
            imageView3.setVisibility(i13);
            b4Var2.d.setVisibility(8);
            b4Var2.f8249f.setVisibility(8);
