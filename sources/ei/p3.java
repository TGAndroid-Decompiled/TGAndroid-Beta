...
public final class p3 implements Runnable {
    ...
    public p3(int i10, long j3, Context context, TL_payments.connectedBotStarRef connectedbotstarref, org.telegram.ui.ActionBar.g3 g3Var, f6 f6Var) {
        this.f8542a = 0;
        this.f8544c = i10;
        this.d = context;
        this.f8543b = j3;
    ...
    public final void run() {
        ...
        switch (this.f8542a) {
            case 0:
                ...
                yh.o.g(i10).f(context, j10, connectedbotstarref.bot_id, new s3(i10, j10, context, connectedbotstarref, (org.telegram.ui.ActionBar.g3) this.f8545f, (f6) this.h));
                return;
            case 1:
                ((TopicsController) this.d).lambda$loadTopics$5((TLRPC.TL_messages_forumTopics) this.e, this.f8543b, (TLRPC.TL_messages_forumTopics) this.f8545f, (a0.i) this.h, this.f8544c);
                return;
            case 2:
                org.telegram.ui.Cells.f6.a((org.telegram.ui.Cells.f6) this.d, (TLObject) this.e, (MessagesStorage) this.f8545f, this.f8543b, this.f8544c, (ArrayList) this.h);
                return;
            case 3:
                TLObject tLObject = (TLObject) this.d;
                int i11 = this.f8544c;
                ci.d dVar = (ci.d) this.e;
                org.telegram.ui.ActionBar.g3 g3Var = (org.telegram.ui.ActionBar.g3) this.f8545f;
            ...
            case 4:
                ...
                TLObject tLObject2 = (TLObject) this.f8545f;
                long j12 = this.f8543b;
                final int i13 = this.f8544c;
                ...
                if (tL_error2 == null && (tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList3.size(); i16++) {
                            ...
                            hi0Var.f34282a.add((Long) pair.first);
                            hi0Var.f34283b.add((Integer) pair.second);
                            hi0Var.f34284c.add((TLObject) hashMap.get(pair.first));
                        }
                        hi0Var.b();
                        return;
                        ...
                        tL_channels_getParticipants.channel = MessagesController.getInstance(i13).getInputChannel(chat.f18121id);
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap3.put(Long.valueOf(user.f18268id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i18 < arrayList5.size()) {
                                                                            ...
                                                                            hi0Var3.f34282a.add((Long) pair2.first);
                                                                            hi0Var3.f34283b.add((Integer) pair2.second);
                                                                            hi0Var3.f34284c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i18++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject5 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i21 < size4) {
                                                                    ...
                                                                    hashMap4.put(Long.valueOf(user2.f18268id), user2);
                                                                    i21++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            hi0Var4.f34282a.add((Long) pair3.first);
                                                                            hi0Var4.f34283b.add((Integer) pair3.second);
                                                                            hi0Var4.f34284c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap32.put(Long.valueOf(user.f18268id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i182 < arrayList52.size()) {
                                                                            ...
                                                                            hi0Var32.f34282a.add((Long) pair2.first);
                                                                            hi0Var32.f34283b.add((Integer) pair2.second);
                                                                            hi0Var32.f34284c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i182++;
                                                                        }
                                                                    }
                                                                }
            ...
            default:
                ...
                int i17 = this.f8544c;
                long j15 = this.f8543b;
                dVar2.mo17run(arrayList4, Integer.valueOf(i17), Long.valueOf(j15), (ArrayList) this.f8545f, (ArrayList) this.h);
                return;
        }
    }
    ...
    public p3(TopicsController topicsController, TLRPC.TL_messages_forumTopics tL_messages_forumTopics, long j3, TLRPC.TL_messages_forumTopics tL_messages_forumTopics2, a0.i iVar, int i10) {
        ...
        this.f8543b = j3;
        this.f8545f = tL_messages_forumTopics2;
        this.h = iVar;
        this.f8544c = i10;
    }
