                ...
                if (tL_error2 == null && (tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList3.size(); i16++) {
                            ...
                            hi0Var.f34277a.add((Long) pair.first);
                            hi0Var.f34278b.add((Integer) pair.second);
                            hi0Var.f34279c.add((TLObject) hashMap.get(pair.first));
                        }
                        hi0Var.b();
                        return;
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i18 < arrayList5.size()) {
                                                                            ...
                                                                            hi0Var3.f34277a.add((Long) pair2.first);
                                                                            hi0Var3.f34278b.add((Integer) pair2.second);
                                                                            hi0Var3.f34279c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i18++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i21 < size4) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            hi0Var4.f34277a.add((Long) pair3.first);
                                                                            hi0Var4.f34278b.add((Integer) pair3.second);
                                                                            hi0Var4.f34279c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i182 < arrayList52.size()) {
                                                                            ...
                                                                            hi0Var32.f34277a.add((Long) pair2.first);
                                                                            hi0Var32.f34278b.add((Integer) pair2.second);
                                                                            hi0Var32.f34279c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i182++;
                                                                        }
                                                                    }
                                                                }
