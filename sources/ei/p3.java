...
public final class p3 implements Runnable {
    ...
    public final void run() {
        ...
        switch (this.f8541a) {
            case 0:
                ...
                long j10 = this.f8542b;
                TL_payments.connectedBotStarRef connectedbotstarref = (TL_payments.connectedBotStarRef) this.e;
                yh.o.g(i10).f(context, j10, connectedbotstarref.bot_id, new s3(i10, j10, context, connectedbotstarref, (org.telegram.ui.ActionBar.f3) this.f8544f, (f6) this.h));
                return;
            case 1:
                ((TopicsController) this.d).lambda$loadTopics$5((TLRPC.TL_messages_forumTopics) this.e, this.f8542b, (TLRPC.TL_messages_forumTopics) this.f8544f, (a0.i) this.h, this.f8543c);
                return;
            case 2:
                h6.a((h6) this.d, (TLObject) this.e, (MessagesStorage) this.f8544f, this.f8542b, this.f8543c, (ArrayList) this.h);
                return;
            case 3:
                TLObject tLObject = (TLObject) this.d;
                int i11 = this.f8543c;
                ci.d dVar = (ci.d) this.e;
                org.telegram.ui.ActionBar.f3 f3Var = (org.telegram.ui.ActionBar.f3) this.f8544f;
            ...
            case 4:
                ...
                TLObject tLObject2 = (TLObject) this.f8544f;
                long j12 = this.f8542b;
                final int i13 = this.f8543c;
                ...
                if (tL_error2 == null && (tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList3.size(); i16++) {
                            ...
                            hi0Var.f34236a.add((Long) pair.first);
                            hi0Var.f34237b.add((Integer) pair.second);
                            hi0Var.f34238c.add((TLObject) hashMap.get(pair.first));
                        }
                        hi0Var.b();
                        return;
                        ...
                        tL_channels_getParticipants.channel = MessagesController.getInstance(i13).getInputChannel(chat.f18343id);
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap3.put(Long.valueOf(user.f18490id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i18 < arrayList5.size()) {
                                                                            ...
                                                                            hi0Var3.f34236a.add((Long) pair2.first);
                                                                            hi0Var3.f34237b.add((Integer) pair2.second);
                                                                            hi0Var3.f34238c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i18++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject5 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i21 < size4) {
                                                                    ...
                                                                    hashMap4.put(Long.valueOf(user2.f18490id), user2);
                                                                    i21++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            hi0Var4.f34236a.add((Long) pair3.first);
                                                                            hi0Var4.f34237b.add((Integer) pair3.second);
                                                                            hi0Var4.f34238c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap32.put(Long.valueOf(user.f18490id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i182 < arrayList52.size()) {
                                                                            ...
                                                                            hi0Var32.f34236a.add((Long) pair2.first);
                                                                            hi0Var32.f34237b.add((Integer) pair2.second);
                                                                            hi0Var32.f34238c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i182++;
                                                                        }
                                                                    }
                                                                }
                        ...
                        tL_messages_getFullChat.chat_id = chat.f18343id;
            ...
            default:
                ...
                int i17 = this.f8543c;
                long j15 = this.f8542b;
                dVar2.mo17run(arrayList4, Integer.valueOf(i17), Long.valueOf(j15), (ArrayList) this.f8544f, (ArrayList) this.h);
                return;
        }
    }
    ...
    public p3(TopicsController topicsController, TLRPC.TL_messages_forumTopics tL_messages_forumTopics, long j3, TLRPC.TL_messages_forumTopics tL_messages_forumTopics2, a0.i iVar, int i10) {
        ...
        this.f8542b = j3;
        this.f8544f = tL_messages_forumTopics2;
        this.h = iVar;
        this.f8543c = i10;
    }
