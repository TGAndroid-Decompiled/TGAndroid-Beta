...
public final class n extends FrameLayout {
    public static final int f8490n = 0;
    public final e6 f8491a;
    public final u9 f8492b;
    ...
    public n(Activity activity, e6 e6Var) {
        ...
        this.f8493c = imageView;
        imageView.setBackground(i6.f0(5, i6.l1(0.2f, i6.v0(i6.W5, e6Var)), -1));
        z5.a(imageView);
        imageView.setImageResource(R.drawable.msg_close);
        imageView.setScaleType(ImageView.ScaleType.CENTER);
        imageView.setColorFilter(new PorterDuffColorFilter(i6.v0(i6.f18844de, e6Var), PorterDuff.Mode.SRC_IN));
