...
public final class i extends r20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public di.d f9132b0;
    public di.d f9133c0;
    public boolean f9134d0;
    public boolean f9135e0;
    public e f9136f0;
    ...
    public final void D0() {
        ...
        animate.alpha(f7).withEndAction(new Runnable(this) {
            ...
            public final void run() {
                switch (r3) {
                    case 0:
                        if (z10) {
                            this.f9122b.Y.setVisibility(8);
                            return;
                        }
                        return;
                    default:
                        if (!z10) {
                            this.f9122b.f9131a0.setVisibility(8);
                            return;
                        }
                        return;
                }
        ...
        ViewPropertyAnimator animate2 = this.f9131a0.animate();
        if (!z10) {
            f10 = 0.0f;
        }
    ...
    public final View createView(Context context) {
        ...
        this.f40041c.setOnItemClickListener(new bi.d(this, 6));
        this.f40046s.addView(new r00(getParentActivity()), x5.c(-1.0f, -1));
        ...
        this.X.setText(LocaleController.getString(R.string.YourTonBalance));
        this.X.setTextColor(j6.v0(j6.f21061z6, this.resourceProvider));
        ...
        if (z10) {
            ...
            this.Z.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            of.f.u(this.f9120b.getParentActivity(), LocaleController.getString(R.string.TopUpViaFragmentLink));
                            return;
                        case 1:
                            of.f.u(this.f9120b.getParentActivity(), LocaleController.getString(R.string.TopUpViaFragmentLink));
                            return;
        ...
        this.f9132b0.g(spannableStringBuilder, false, true);
        this.f9132b0.setOnClickListener(new View.OnClickListener(this) {
            public final i f9120b;
        ...
        if (z10) {
            this.f9131a0.addView(this.f9132b0, x5.p(-1, 48, 17.0f, 1, 0, 0, 8, 0));
        }
        ...
        this.f9133c0.g(spannableStringBuilder2, false, true);
        this.f9133c0.setOnClickListener(new View.OnClickListener(this) {
            public final i f9120b;
        ...
        this.f9131a0.addView(this.f9133c0, x5.p(-1, 48, 17.0f, 1, 0, 0, 0, 0));
        this.U.addView(frameLayout2, x5.d(-1, 48.0f, 17, 20.0f, 6.0f, 20.0f, 4.0f));
        this.Y.animate().cancel();
        this.f9131a0.animate().cancel();
        cc1 cc1Var2 = this.f9131a0;
        if (this.f9135e0) {
            f7 = 1.0f;
        } else {
            f7 = 0.0f;
    ...
    public final int getNavigationBarColor() {
        return j6.w0(null, j6.f20752i5, false);
    }

    @Override
    public final h0 n0() {
        e eVar = new e(this, this.f40041c, getParentActivity(), this.currentAccount, this.classGuid, new u(this, 10), getResourceProvider());
        this.f9136f0 = eVar;
        eVar.f31135r = false;
        return eVar;
    }
    ...
    public final boolean q0() {
        ...
        if (u7Var != null && (u7Var.getParent() instanceof View)) {
            if (this.f40041c.getHeight() - ((View) this.R.getParent()).getBottom() >= 0) {
                z10 = true;
            }
        }
        return !z10;
