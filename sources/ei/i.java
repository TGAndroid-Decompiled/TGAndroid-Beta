...
public final class i extends r20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final View createView(Context context) {
        ...
        this.f40069c.setOnItemClickListener(new bi.d(this, 6));
        this.f40074s.addView(new r00(getParentActivity()), x5.c(-1.0f, -1));
        ...
        this.X.setText(LocaleController.getString(R.string.YourTonBalance));
        this.X.setTextColor(j6.v0(j6.f21089z6, this.resourceProvider));
    ...
    public final int getNavigationBarColor() {
        return j6.w0(null, j6.f20780i5, false);
    }

    @Override
    public final h0 n0() {
        e eVar = new e(this, this.f40069c, getParentActivity(), this.currentAccount, this.classGuid, new u(this, 10), getResourceProvider());
        this.f9164f0 = eVar;
        eVar.f31163r = false;
        return eVar;
    }
    ...
    public final boolean q0() {
        ...
        if (u7Var != null && (u7Var.getParent() instanceof View)) {
            if (this.f40069c.getHeight() - ((View) this.R.getParent()).getBottom() >= 0) {
                z10 = true;
            }
        }
        return !z10;
