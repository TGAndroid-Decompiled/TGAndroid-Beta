    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f8659a) {
            ...
            case 4:
                ...
                return;
            case 5:
                ((d8) this.f8661c).f23517a[this.f8660b].setVisibility(8);
                return;
            case 6:
                ((rp) this.f8661c).f28011a[this.f8660b].animate().scaleX(1.0f).scaleY(1.0f).setInterpolator(rr.f28023g).setStartDelay(0L).setDuration(100L).start();
                return;
            case 7:
                ...
                TextView textView2 = dyVar.f23729f;
                if (i13 == 3) {
                    i12 = 0;
                }
            ...
            case 8:
                ...
                th0Var.H = null;
                th0Var.P.f30877d1.delete(this.f8660b);
                return;
            case 9:
                wq wqVar = (wq) this.f8661c;
                ((bl0) wqVar.d).f23014b.remove(this.f8660b);
