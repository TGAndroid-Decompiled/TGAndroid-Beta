    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f8677a) {
            ...
            case 4:
                ...
                return;
            case 5:
                ((b8) this.f8679c).f22650a[this.f8678b].setVisibility(8);
                return;
            case 6:
                ((qp) this.f8679c).f27370a[this.f8678b].animate().scaleX(1.0f).scaleY(1.0f).setInterpolator(qr.f27384g).setStartDelay(0L).setDuration(100L).start();
                return;
            case 7:
            ...
            case 8:
                ...
                jh0Var.H = null;
                jh0Var.P.f27035d1.delete(this.f8678b);
                return;
            case 9:
                br brVar = (br) this.f8679c;
                ((rk0) brVar.d).f27637b.remove(this.f8678b);
