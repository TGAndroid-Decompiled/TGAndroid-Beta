...
public final class b1 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        int i10 = this.f8242a;
        Object obj = this.h;
        Object obj2 = this.f8246g;
        Object obj3 = this.e;
        Object obj4 = this.f8245f;
        Object obj5 = this.d;
        switch (i10) {
            case 0:
                org.telegram.tgnet.e eVar = (org.telegram.tgnet.e) obj;
                AndroidUtilities.runOnUIThread(new e1(tLObject, this.f8244c, (org.telegram.ui.ActionBar.b2) obj5, (Context) obj3, this.f8243b, (f6) obj4, (org.telegram.ui.web.t) obj2, eVar));
                return;
            case 1:
                i60.v((i60) obj5, this.f8243b, (HashSet) obj3, (AtomicInteger) obj4, this.f8244c, (ChatObject.Call) obj2, (String) obj, tLObject, tL_error);
                return;
            case 2:
                Pattern pattern = LaunchActivity.B1;
                AndroidUtilities.runOnUIThread(new e1((LaunchActivity) obj5, tLObject, this.f8244c, (String) obj3, (String) obj4, (TLRPC.User) obj2, (String) obj, this.f8243b));
                return;
            default:
                ...
                if (tLObject != null) {
                    if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) {
                        AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.e(tLObject, activity, f6Var, this.f8243b, bArr, znVar, messageObject));
                        return;
                    } else if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultReported) {
                        AndroidUtilities.runOnUIThread(new o31(znVar, activity, f6Var, messageObject, 0), 200L);
                        return;
                    } else if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultAdsHidden) {
                        AndroidUtilities.runOnUIThread(new bi(znVar, this.f8244c, messageObject), 200L);
                        return;
                    } else {
                        return;
                    }
