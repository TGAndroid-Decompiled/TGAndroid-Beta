    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (i10) {
            case 0:
                ...
                AndroidUtilities.runOnUIThread(new e1(tLObject, this.f8244c, (org.telegram.ui.ActionBar.b2) obj5, (Context) obj3, this.f8243b, (e6) obj4, (org.telegram.ui.web.t) obj2, eVar));
                return;
            case 1:
            ...
            default:
                ...
                if (tLObject != null) {
                    if (tLObject instanceof TLRPC.TL_channels_sponsoredMessageReportResultChooseOption) {
                        AndroidUtilities.runOnUIThread(new org.telegram.messenger.voip.e(tLObject, activity, e6Var, this.f8243b, bArr, znVar, messageObject));
                        return;
