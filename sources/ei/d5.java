...
import w7.f6;
public final class d5 implements Utilities.Callback5, OnSuccessListener, c3.g, org.telegram.ui.ActionBar.b2, e2.m, zt, ii.p0, qy, p5, f2.s {
    ...
    public n70 a(ii.i1 i1Var) {
        return n70.H((ii.d2) ((a6.i) this.f8304b).f303b, i1Var);
    }
    ...
    public void b(long j3, e2.v vVar) {
        switch (this.f8303a) {
            case 27:
                c3.b.d(j3, vVar, ((j4.c0) this.f8304b).f12631c);
                return;
            default:
                c3.b.e(j3, vVar, ((j4.c0) this.f8304b).f12631c);
                return;
        }
    }
    ...
    public ii.b0 c(aa.a aVar) {
        ...
        try {
            ...
            try {
                ...
                ka.e eVar = (ka.e) cVar.f13567b;
                ka.f fVar = new ka.f(bufferedWriter, eVar.f13571a, eVar.f13572b, eVar.f13573c, eVar.d);
                fVar.h((k5.i) aVar.d);
                fVar.j();
                fVar.f13575b.flush();
                ...
                if (responseCode != 302 && responseCode != 301 && responseCode != 307) {
                    ...
                    try {
                        ...
                        ii.b0 b0Var = new ii.b0(responseCode, null, k5.m.a(new BufferedReader(new InputStreamReader(inputStream))).f13490a);
                        if (inputStream != null) {
                            inputStream.close();
                        }
    ...
    public void f(org.telegram.ui.ActionBar.c2 c2Var, int i10) {
        switch (this.f8303a) {
            case 5:
                hg.y1 y1Var = ((hg.p1) this.f8304b).f10389a;
    ...
    public void invoke(Object obj) {
        switch (this.f8303a) {
            ...
            case 10:
                ...
                return;
            case 11:
                ((b2.z0) obj).onMediaMetadataChanged(((i2.b0) this.f8304b).f10624a.O);
                return;
            case 12:
        ...
        switch (this.f8303a) {
            ...
            case 3:
                ...
                if (i12 == -1) {
                    ...
                    o2Var.f10280n = g1Var.f10304r;
                    o2Var.f10278c = new ci.m2(17, g1Var, view3);
                    g1Var.presentFragment((org.telegram.ui.ActionBar.o2) o2Var);
                    return;
                } else if (j51Var2.f15543a == 5 && i12 >= 0 && i12 < g1Var.h.length) {
                    if (!LocaleController.isRTL ? floatValue >= view3.getMeasuredWidth() - AndroidUtilities.dp(76.0f) : floatValue <= AndroidUtilities.dp(76.0f)) {
                        if (g1Var.h[j51Var2.d].isEmpty()) {
                            ((i5) view3).setChecked(true);
                            g1Var.h[j51Var2.d].add(new hg.f1(0, 1439));
                            g1Var.X(j51Var2.d);
                        } else {
                            g1Var.h[j51Var2.d].clear();
                            ((i5) view3).setChecked(false);
                        }
                        ((i5) view3).setValue(hg.g1.a0(g1Var.h[j51Var2.d]));
                        g1Var.Y(true);
                        return;
                    }
                    ...
                    int i19 = i17 + 1439;
                    CharSequence charSequence = j51Var2.f25127l;
                    ArrayList arrayList = g1Var.h[j51Var2.d];
                    int i20 = 0;
                    ...
                    i1Var.h = new gg.x1(5, g1Var, j51Var2);
            ...
            case 4:
                ...
                if (i24 == -1) {
                    ...
                    if (!arrayList3.isEmpty() && !i1Var2.U()) {
                        int i25 = ((hg.f1) hg.k0.h(1, arrayList3)).f10290b;
                    ...
                    i1Var2.f10320n.Y2.N(true);
                    return;
                } else if (j51Var3.f15543a == 3 && (i10 = i24 / 3) >= 0 && i10 < arrayList3.size()) {
                    int i26 = i10 - 1;
                    if (i26 >= 0) {
                    ...
                    if (i28 == 0) {
                        ...
                        org.telegram.ui.Components.c5.X(parentActivity, string, i29, i22, f1Var3.f10290b - 1, new Utilities.Callback() {
                            @Override
            ...
            case 6:
                ...
                ((Float) obj4).getClass();
                ((Float) obj5).getClass();
                hg.e2.U((hg.e2) this.f8304b, (j51) obj, (View) obj2);
                return;
        }
    }
