...
public abstract class p0 extends LinearLayout implements ph.a, le.k {
    ...
    public int getKeyboardHeight() {
        ...
        return org.telegram.messenger.w1.D(4.0f, this.f8529c.rows.size() - 1, AndroidUtilities.dp(16.0f) + (AndroidUtilities.dp(this.h) * tL_replyKeyboardMarkup.rows.size()));
    }
    ...
    public void setPanelHeight(int i10) {
        ...
        if (this.f8530f && (tL_replyKeyboardMarkup = this.f8529c) != null && !tL_replyKeyboardMarkup.rows.isEmpty()) {
            if (!this.f8530f) {
                ...
                max = (int) Math.max(44.0f, (wl.A(4.0f, this.f8529c.rows.size() - 1, this.e - AndroidUtilities.dp(16.0f)) / this.f8529c.rows.size()) / AndroidUtilities.density);
            }
            this.h = max;
            ...
            while (it.hasNext()) {
                le.g gVar = (le.g) it.next();
                int childCount = ((o0) gVar.f13994a).getChildCount();
                for (int i11 = 0; i11 < childCount; i11++) {
                    View childAt = ((o0) gVar.f13994a).getChildAt(i11);
