...
public final class u3 implements View.OnClickListener {
    public final int f8645a = 1;
    public final int f8646b;
    public final org.telegram.ui.ActionBar.f3 f8647c;
    public final e6 d;
    public final long e;
        ...
        switch (this.f8645a) {
            case 0:
                ...
                if (connectedbotstarref.revoked) {
                    ...
                    if (user != null) {
                        MessagesController.getInstance(i10).loadFullUser(user, 0, true, new q3(this.f8647c, this.f8648f, i10, this.e, this.d, 0));
                        return;
                    }
                    return;
                }
                ...
                return;
            default:
                LinearLayout linearLayout = (LinearLayout) this.f8649n;
                int i11 = this.f8646b;
                yh.o g10 = yh.o.g(i11);
                g10.n();
                g10.o();
                ArrayList arrayList = new ArrayList();
                ArrayList arrayList2 = g10.f47506j;
                if (arrayList2 != null) {
                    arrayList.addAll(arrayList2);
                }
                ArrayList arrayList3 = g10.f47508l;
                if (arrayList3 != null) {
                    arrayList.addAll(arrayList3);
                }
                arrayList.add(0, UserConfig.getInstance(i11).getCurrentUser());
                org.telegram.ui.ActionBar.f3 f3Var = this.f8647c;
                ...
                while (i12 < size) {
                    ...
                    F.g(tLObject, z10, new p3(i11, j3, this.f8648f, this.h, f3Var, e6Var));
                    i12 = i13;
                }
                F.f26368t = false;
                F.f26367s = 0;
