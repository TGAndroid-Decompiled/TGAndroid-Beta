...
public final class j3 extends pv0 implements org.telegram.ui.ActionBar.u3 {
    public final k3 A0;
    public final Paint f8390w0;
    public boolean f8391x0;
    public final RectF f8392y0;
    public final Path f8393z0;
    ...
    public j3(k3 k3Var, Context context) {
        ...
        this.f8390w0 = new Paint(1);
        this.f8392y0 = new RectF();
        this.f8393z0 = new Path();
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f7;
        k3 k3Var = this.A0;
        sd0 sd0Var = k3Var.f8433s0;
        Rect rect = k3Var.h;
        Rect rect2 = k3Var.f8417f;
        if (!this.f8391x0) {
            int visibility = sd0Var.getVisibility();
            Paint paint2 = this.f8390w0;
            if (visibility != 0) {
                float f10 = k3Var.f8418f0;
            ...
            if (k3Var.f8432s != null && !AndroidUtilities.isTablet()) {
                canvas.save();
                canvas.translate((1.0f - k3Var.f8418f0) * rect.left, 0.0f);
                cf.c cVar = k3Var.f8432s;
                int lerp = AndroidUtilities.lerp((getWidth() - rect.left) - rect.right, getWidth(), k3Var.f8418f0);
                getHeight();
                cVar.r(canvas, true, false, lerp, 1.0f - k3Var.f8418f0);
                canvas.translate((1.0f - k3Var.f8418f0) * (-rect.left), 0.0f);
                z10 = true;
            } else {
                z10 = false;
            ...
            if (sd0Var.getVisibility() != 0) {
                ...
                if (i11 > 0) {
                    paint = paint2;
                    canvas.drawRect(0.0f, 0.0f, (1.0f - k3Var.f8418f0) * i11, getHeight(), paint);
                } else {
                    paint = paint2;
                }
                if (rect2.top > 0) {
                    canvas.drawRect(0.0f, 0.0f, getWidth(), (1.0f - k3Var.f8418f0) * rect2.top, paint);
                }
                if (rect2.bottom > 0) {
                    ...
                    if (g3Var != null && g3Var.getTotalHeight() > 0) {
                        ...
                        f7 = 1.0f - k3Var.f8418f0;
                    }
                    canvas.drawRect(0.0f, height - (f11 * f7), getWidth(), getHeight(), paint);
                }
                if (rect2.right > 0) {
                    canvas.drawRect(com.google.android.gms.internal.vision.e2.b(1.0f, k3Var.f8418f0, rect2.right, getWidth()), 0.0f, getWidth(), getHeight(), paint);
                }
            }
        }
    }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (n3Var != null && rect != null) {
            int i10 = (int) ((1.0f - k3Var.f8418f0) * ((int) n3Var.G));
    ...
    public final void draw(Canvas canvas) {
        ...
        paint.setColor(k3Var.f8409a);
        paint.setAlpha((int) ((1.0f - k3Var.f8418f0) * (1.0f - (Math.min(0.5f, f7) / 0.5f)) * paint.getAlpha()));
        canvas.save();
        float f10 = 1.0f - f7;
        if (AndroidUtilities.isTablet()) {
            lerp = AndroidUtilities.lerp(a3Var.getTranslationY() + AndroidUtilities.dp(12.0f), AndroidUtilities.statusBarHeight / 2.0f, k3Var.f8411b);
        } else {
    ...
    public final boolean drawChild(Canvas canvas, View view, long j3) {
        boolean z10;
        k3 k3Var = this.A0;
        if (view == k3Var.v && k3Var.f8420h0 && k3Var.f8422j0 > 0 && k3Var.f8421i0 > 0) {
            canvas.save();
            canvas.clipRect(view.getX(), view.getY(), view.getX() + AndroidUtilities.lerp(k3Var.f8421i0, view.getWidth(), k3Var.f8419g0), view.getY() + AndroidUtilities.lerp(k3Var.f8422j0, view.getHeight(), k3Var.f8419g0));
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (!this.f8391x0) {
            super.onDraw(canvas);
            if (k3Var.f8433s0.getVisibility() != 0) {
                canvas.save();
                cf.c cVar = k3Var.f8432s;
                float f7 = 1.0f;
                if (cVar != null) {
                    ...
                    getHeight();
                    canvas2 = canvas;
                    cVar.r(canvas2, false, false, width, 1.0f - k3Var.f8418f0);
                } else {
                    canvas2 = canvas;
                }
                if (!k3Var.V) {
                    int v02 = h6.v0(h6.f18789d6, k3Var.E);
                    paint2.setColor(v02);
                    k3Var.f8439x.setFlickerViewColor(v02);
                ...
                org.telegram.ui.ActionBar.n3 n3Var = k3Var.f8430r;
                if (n3Var != null) {
                    i10 = (int) n3Var.G;
                } else {
                    i10 = 0;
                ...
                if (!AndroidUtilities.isTablet()) {
                    f7 = 1.0f - k3Var.f8411b;
                }
                float f10 = dp * f7;
                rectF.set(AndroidUtilities.lerp(a3Var.getLeft(), 0, k3Var.f8418f0), AndroidUtilities.lerp(a3Var.getTranslationY(), 0.0f, k3Var.f8411b), a3Var.getRight(), a3Var.getTranslationY() + AndroidUtilities.dp(24.0f) + f10);
                canvas2.drawRoundRect(rectF, f10, f10, paint);
                rectF.set(AndroidUtilities.lerp(a3Var.getLeft(), 0, k3Var.f8418f0), a3Var.getTranslationY() + AndroidUtilities.dp(24.0f), AndroidUtilities.lerp(a3Var.getRight(), getWidth(), k3Var.f8418f0), getHeight() - i10);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        k3 k3Var = this.A0;
        a3 a3Var = k3Var.v;
        if (motionEvent.getAction() == 0 && (motionEvent.getY() <= AndroidUtilities.lerp(a3Var.getTranslationY() + AndroidUtilities.dp(24.0f), 0.0f, k3Var.f8411b) || motionEvent.getX() > a3Var.getRight() || motionEvent.getX() < a3Var.getLeft())) {
            k3Var.k(true);
            return true;
        }
    ...
    public void setDrawingFromOverlay(boolean z10) {
        if (this.f8391x0 != z10) {
            ...
            k3Var.G();
            LaunchActivity launchActivity = LaunchActivity.G1;
            if (launchActivity != null && k3Var.f8415d0) {
    ...
    public final float x(Canvas canvas, RectF rectF, float f7, RectF rectF2, float f10) {
        ...
        canvas.save();
        Path path = this.f8393z0;
        path.rewind();
        float dp = AndroidUtilities.dp(16.0f);
        float f11 = 1.0f;
        if (!AndroidUtilities.isTablet()) {
            f11 = 1.0f - k3Var.f8411b;
        }
