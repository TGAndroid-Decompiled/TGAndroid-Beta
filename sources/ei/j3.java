...
public final class j3 extends aw0 implements org.telegram.ui.ActionBar.v3 {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (!this.f8408x0) {
            ...
            if (k3Var.f8449s != null && !AndroidUtilities.isTablet()) {
                ...
                getHeight();
                cVar.p(canvas, true, false, lerp, 1.0f - k3Var.f8435f0);
                canvas.translate((1.0f - k3Var.f8435f0) * (-rect.left), 0.0f);
                z10 = true;
            } else {
                z10 = false;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (o3Var != null && rect != null) {
            int i10 = (int) ((1.0f - k3Var.f8435f0) * ((int) o3Var.G));
        ...
        if (!this.f8408x0) {
            ...
            if (k3Var.f8450s0.getVisibility() != 0) {
                ...
                if (cVar != null) {
                    ...
                    getHeight();
                    canvas2 = canvas;
                    cVar.p(canvas2, false, false, width, 1.0f - k3Var.f8435f0);
                } else {
                    canvas2 = canvas;
                }
                if (!k3Var.V) {
                    int v02 = j6.v0(j6.f19094d6, k3Var.E);
                    paint2.setColor(v02);
                ...
                org.telegram.ui.ActionBar.o3 o3Var = k3Var.f8447r;
                if (o3Var != null) {
                    i10 = (int) o3Var.G;
                } else {
                    i10 = 0;
