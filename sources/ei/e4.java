...
public final class e4 extends r20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void A0(e4 e4Var, TLObject tLObject, org.telegram.ui.ActionBar.b2 b2Var) {
        ...
        if (tLObject instanceof TL_payments.connectedStarRefBots) {
                ...
                while (true) {
                    if (i12 >= arrayList.size()) {
                        ...
                        if (connectedbotstarref.revoked) {
                            ...
                            d.f47392c = Math.max(d.f47392c - 1, 0);
                        } else {
            ...
            NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelConnectedBotsUpdate, Long.valueOf(d.f47391b));
            d.a();
    ...
    public static org.telegram.ui.ActionBar.f3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j3, e6 e6Var) {
        ...
        org.telegram.ui.ActionBar.f3 i18 = wl.i(1, context, e6Var, false);
        ...
        if (connectedbotstarref.participants > 0) {
            ...
            frameLayout2.setBackground(i6.b0(AndroidUtilities.dp(50.0f), i6.v0(i6.f18907h5, e6Var)));
        ...
        int i19 = i6.G6;
        wl.n(i19, e6Var, textView2, 1, 20.0f);
        ...
        int i20 = i6.f18780a7;
        linearLayout3.setBackground(i6.b0(dp3, i6.v0(i20, e6Var)));
        ...
        textView3.setTextColor(i6.v0(i19, e6Var));
        ...
        wl.n(i19, e6Var, textView4, 1, 14.0f);
        ...
        if (!connectedbotstarref.revoked) {
            ...
            wl.n(i19, e6Var, textView5, 1, 14.0f);
            ...
            linearLayout4.setBackground(i6.b0(AndroidUtilities.dp(28.0f), i6.v0(i20, e6Var)));
            ...
            textView6.setTextColor(i6.v0(i19, e6Var));
            if (j3 >= 0) {
        ...
        int v03 = i6.v0(i20, e6Var);
        int v = i6.v(i6.v0(i20, e6Var), i6.v0(i6.f18926i6, e6Var));
        ...
        i18.fixNavigationBar(i6.v0(i6.f18907h5, e6Var2));
    ...
    public final void F0(java.util.ArrayList r18, org.telegram.ui.Components.w51 r19) {
        throw new UnsupportedOperationException("Method not decompiled: ei.e4.F0(java.util.ArrayList, org.telegram.ui.Components.w51):void");
    }
    ...
    public final View createView(Context context) {
        ...
        this.S = knVar;
        knVar.setBackgroundColor(i6.w0(null, i6.f18925i5, false));
        super.createView(context);
        this.Q = new FrameLayout(context);
        sg.e eVar = new sg.e(context, 1, 3);
        this.R = eVar;
        eVar.setImportantForAccessibility(4);
        sg.a aVar = this.R.f42937b;
        aVar.f42925w = i6.fk;
        aVar.f42926x = i6.gk;
        aVar.b();
        ...
        this.f36998c.setOnItemClickListener(new o6(2, this, context));
        this.f36998c.setOnItemLongClickListener(new ah.b(11, this, context));
        s4.j jVar = new s4.j();
        jVar.f42710m = false;
        jVar.C = false;
        jVar.o(qr.h);
        ...
        this.f36998c.setOnScrollListener(new ai.r(this, 5));
    ...
    public final s4.h0 n0() {
        w3 w3Var = new w3(this, this.f36998c, getParentActivity(), this.currentAccount, this.classGuid, new bi.v(this, 17), getResourceProvider());
        this.T = w3Var;
        return w3Var;
    }
