...
public final class e4 extends t20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void A0(e4 e4Var, TLObject tLObject, org.telegram.ui.ActionBar.c2 c2Var) {
        ...
        if (tLObject instanceof TL_payments.connectedStarRefBots) {
                ...
                while (true) {
                    if (i12 >= arrayList.size()) {
                        ...
                        if (connectedbotstarref.revoked) {
                            ...
                            d.f47420c = Math.max(d.f47420c - 1, 0);
                        } else {
            ...
            NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelConnectedBotsUpdate, Long.valueOf(d.f47419b));
            d.a();
    ...
    public static org.telegram.ui.ActionBar.g3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j3, f6 f6Var) {
        ...
        org.telegram.ui.ActionBar.g3 i18 = wl.i(1, context, f6Var, false);
        ...
        if (connectedbotstarref.participants > 0) {
            ...
            frameLayout2.setBackground(j6.b0(AndroidUtilities.dp(50.0f), j6.v0(j6.f18934h5, f6Var)));
        ...
        int v = j6.v(j6.v0(i20, f6Var), j6.v0(j6.f18953i6, f6Var));
        ...
        c90Var.setTextSize(i15, 12.0f);
        c90Var.setTextColor(j6.v0(j6.B6, f6Var));
        c90Var.setLinkTextColor(j6.v0(j6.gc, f6Var));
        f11.addView(c90Var, x5.t(-1, -2, 49, 14, 12, 14, 2));
        i18.customView = f11;
        i5 i5Var = new i5(connectedbotstarref, i18, f6Var, user, 8);
        if (!connectedbotstarref.revoked) {
            textView7.setOnClickListener(new ai.v0(i5Var, 16));
        }
        dVar.setOnClickListener(new u3(connectedbotstarref, i10, i18, context, j10, f6Var, i5Var));
        ...
        i18.fixNavigationBar(j6.v0(j6.f18934h5, f6Var2));
    ...
    public final void F0(java.util.ArrayList r18, org.telegram.ui.Components.x51 r19) {
        throw new UnsupportedOperationException("Method not decompiled: ei.e4.F0(java.util.ArrayList, org.telegram.ui.Components.x51):void");
    }
    ...
    public final View createView(Context context) {
        ...
        this.S = knVar;
        knVar.setBackgroundColor(j6.w0(null, j6.f18952i5, false));
        super.createView(context);
        this.Q = new FrameLayout(context);
        sg.e eVar = new sg.e(context, 1, 3);
        this.R = eVar;
        eVar.setImportantForAccessibility(4);
        sg.a aVar = this.R.f42964b;
        aVar.f42952w = j6.fk;
        aVar.f42953x = j6.gk;
        aVar.b();
        ...
        this.f37628c.setOnItemClickListener(new o6(2, this, context));
        this.f37628c.setOnItemLongClickListener(new ah.b(11, this, context));
        s4.j jVar = new s4.j();
        jVar.f42737m = false;
        jVar.C = false;
        jVar.o(qr.h);
        ...
        this.f37628c.setOnScrollListener(new ai.r(this, 5));
    ...
    public final s4.h0 n0() {
        w3 w3Var = new w3(this, this.f37628c, getParentActivity(), this.currentAccount, this.classGuid, new bi.v(this, 17), getResourceProvider());
        this.T = w3Var;
        return w3Var;
    }
