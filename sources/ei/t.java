        ...
        switch (i11) {
            ...
            case 6:
                ...
                if (i10 == -1) {
                    ...
                    k0Var.S = null;
                    k0Var.G.Y2.N(true);
                    k0Var.E.f23160r.getText().clear();
                    k0Var.E.f23160r.requestFocus();
                    AndroidUtilities.showKeyboard(k0Var.E.f23160r);
                    return;
                } else {
                    return;
                }
            case 7:
                ...
                if (i10 == 2) {
                    ...
                    k0Var2.f9115y.f23160r.getText().clear();
                    k0Var2.f9115y.f23160r.requestFocus();
                    AndroidUtilities.showKeyboard(k0Var2.f9115y.f23160r);
                    return;
                } else {
                    return;
                }
            ...
            case 26:
                ...
                if (i10 == -1) {
                    ...
                    return;
                } else if (i10 == 1 && z9Var.f40420a.getText().length() != 0) {
                    z9.U(z9Var);
                    z9Var.finishFragment();
                    return;
                } else {
            ...
            default:
                ad adVar = (ad) obj;
                if (i10 == -1) {
                    if (adVar.f32101b >= adVar.S0() && adVar.Q0()) {
                        adVar.V0();
                        return;
                    } else {
                    ...
                    adVar.f32117o0 = ofFloat;
                    ofFloat.addUpdateListener(new ci.ub(adVar, 1));
                    adVar.f32117o0.addListener(new org.telegram.ui.t4(adVar, 17));
                    adVar.f32117o0.setDuration(400L);
                    adVar.f32117o0.setInterpolator(lt.e);
                    adVar.f32117o0.start();
