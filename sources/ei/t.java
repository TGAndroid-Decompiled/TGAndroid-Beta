        ...
        switch (i11) {
            ...
            case 6:
                ...
                if (i10 == -1) {
                    ...
                    k0Var.S = null;
                    k0Var.G.Y2.N(true);
                    k0Var.E.f23161r.getText().clear();
                    k0Var.E.f23161r.requestFocus();
                    AndroidUtilities.showKeyboard(k0Var.E.f23161r);
                    return;
                } else {
                    return;
                }
            case 7:
                ...
                if (i10 == 2) {
                    ...
                    k0Var2.f9115y.f23161r.getText().clear();
                    k0Var2.f9115y.f23161r.requestFocus();
                    AndroidUtilities.showKeyboard(k0Var2.f9115y.f23161r);
                    return;
                } else {
                    return;
                }
            ...
            default:
                ...
                if (i10 == -1) {
                    ...
                    adVar.f32118o0.setInterpolator(lt.e);
