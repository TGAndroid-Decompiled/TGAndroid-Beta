...
public final class l2 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        switch (this.f8471a) {
            case 0:
                k3 k3Var = this.f8472b;
                Paint paint = k3Var.P;
                paint.setColor(i0.a.d(((Float) valueAnimator.getAnimatedValue()).floatValue(), this.f8473c, this.d));
                k3Var.A();
                k3Var.e.invalidate();
                ...
                return;
            default:
                k3 k3Var2 = this.f8472b;
                k3Var2.getClass();
                k3Var2.R = i0.a.d(((Float) valueAnimator.getAnimatedValue()).floatValue(), this.f8473c, this.d);
                k3Var2.h();
                return;
        }
    }
