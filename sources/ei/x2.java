...
public final class x2 extends AnimatorListenerAdapter {
    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        a3Var.setTranslationX(AndroidUtilities.lerp(this.f8730c, 0.0f, k3Var.f8435g0));
        k3Var.f8440l0.setTranslationX(0.0f);
        k3Var.e.invalidate();
