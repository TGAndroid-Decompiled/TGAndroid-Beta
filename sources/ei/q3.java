...
public final class q3 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f8549a) {
            case 0:
                final org.telegram.ui.ActionBar.f3 f3Var = (org.telegram.ui.ActionBar.f3) this.f8550b;
                final TLRPC.UserFull userFull = (TLRPC.UserFull) obj;
                final Context context = this.f8551c;
                final int i10 = this.d;
                final long j3 = this.e;
                final d6 d6Var = this.f8552f;
                ...
                return;
            case 1:
                final org.telegram.ui.ActionBar.f3 f3Var2 = (org.telegram.ui.ActionBar.f3) this.f8550b;
                final TLRPC.UserFull userFull2 = (TLRPC.UserFull) obj;
                final Context context2 = this.f8551c;
                final int i11 = this.d;
                final long j10 = this.e;
                final d6 d6Var2 = this.f8552f;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r8) {
                ...
                return;
            default:
                ((org.telegram.ui.ActionBar.f3[]) this.f8550b)[0].dismiss();
                e4.H0(this.f8551c, this.d, (TL_payments.connectedBotStarRef) obj, this.e, this.f8552f);
                return;
        }
    }
}
