...
public final class k3 extends Dialog implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.u3 {
    ...
    public int f8421a;
    public BotFullscreenButtons.OptionsIcon f8422a0;
    public float f8423b;
    ...
    public final Rect f8429f;
    public float f8430f0;
    public float f8431g0;
    public final Rect h;
    public boolean f8432h0;
    public int f8433i0;
    public int f8434j0;
    public Activity f8435k0;
    public final g3 f8436l0;
    public final BotFullscreenButtons m0;
    public int f8437n;
    public oc f8438n0;
    public j0 f8439o0;
    public final FrameLayout f8440p0;
    public final FrameLayout.LayoutParams f8441q0;
    public final org.telegram.ui.ActionBar.o3 f8442r;
    public boolean f8443r0;
    public final cf.c f8444s;
    public final sd0 f8445s0;
    public final e2 f8446t0;
    public int f8447u0;
    public final a3 v;
    public f5 f8448v0;
    public final FrameLayout.LayoutParams f8449w;
    public boolean f8450w0;
    public final b3 f8451x;
    public boolean f8452x0;
    public final i3 f8453y;
    public boolean f8454y0;
    public Boolean f8455z0;

    static {
        iv0 iv0Var = new iv0(new d2.c(17), new d2.c(18));
    ...
    public k3(Context context, e6 e6Var) {
        ...
        this.V0 = false;
        this.E = e6Var;
        this.f8421a = i6.w0(null, i6.Ii, false);
        ...
        int v02 = i6.v0(i6.f18780a7, e6Var);
        this.R = v02;
    ...
    public static WindowInsets e(k3 k3Var, View view, WindowInsets windowInsets) {
        r0.i1 i1Var = r0.l1.h(view, windowInsets).f41855a;
        i0.b f7 = i1Var.f(2);
        k3Var.f8429f.set(f7.f10588a, f7.f10589b, f7.f10590c, f7.d);
        i0.b f10 = i1Var.f(647);
        Rect rect = k3Var.h;
        rect.set(Math.max(f10.f10588a, windowInsets.getStableInsetLeft()), Math.max(f10.f10589b, windowInsets.getStableInsetTop()), Math.max(f10.f10590c, windowInsets.getStableInsetRight()), Math.max(f10.d, windowInsets.getStableInsetBottom()));
    ...
    public static JSONObject p(e6 e6Var, final boolean z10) {
        try {
            ...
            final int v = i6.v(-16777216, i6.v0(i6.f18907h5, e6Var));
            ...
            jSONObject.put("section_bg_color", callbackReturn.run(Integer.valueOf(i6.v0(i6.f18836d6, e6Var))));
            int i10 = i6.f18780a7;
            ...
            jSONObject.put("header_bg_color", callbackReturn.run(Integer.valueOf(i6.v0(i6.f19113s8, e6Var))));
            ...
            jSONObject.put("subtitle_text_color", callbackReturn.run(Integer.valueOf(i6.v0(i6.f19237z6, e6Var))));
            jSONObject.put("destructive_text_color", callbackReturn.run(Integer.valueOf(i6.v0(i6.f19056p7, e6Var))));
            jSONObject.put("section_separator_color", callbackReturn.run(Integer.valueOf(i6.v0(i6.f18837d7, e6Var))));
    ...
    public final void A() {
        if (!this.U) {
            ...
            h3Var.A(i6.v0(i6.f19150u8, e6Var), false);
        ...
        this.f8451x.setFlickerViewColor(this.P.getColor());
    }
    ...
    public final void B() {
        ...
        boolean z11 = true;
        if (k0Var == null) {
            oc ocVar2 = this.f8438n0;
            if (ocVar2 != null) {
                ocVar2.b();
                this.f8438n0 = null;
            }
        } else if ((k0Var.c() && !k0Var.f8417l) || k0Var.f8416k) {
            if (this.L0 != k0Var && (ocVar = this.f8438n0) != null) {
                ocVar.b();
                this.f8438n0 = null;
            }
            oc ocVar3 = this.f8438n0;
            if (ocVar3 == null || !ocVar3.f26756l) {
                this.L0 = k0Var;
                j0 j0Var = new j0(getContext(), this.E);
                this.f8439o0 = j0Var;
                oc f7 = oc.f(this.f8440p0, j0Var, 5000);
                this.f8438n0 = f7;
                f7.k(true);
            }
            if (this.f8439o0.c(k0Var)) {
                this.f8438n0 = null;
            }
            k0Var.f8416k = false;
            k0Var.f8417l = true;
        } else {
            j0 j0Var2 = this.f8439o0;
            if (j0Var2 != null) {
                this.L0 = k0Var;
                if (j0Var2.c(k0Var)) {
                    this.f8438n0 = null;
        ...
        for (Map.Entry entry : this.J0.entrySet()) {
            ...
            f1Var.setText(k0Var2.f8411c);
            if (!k0Var2.c()) {
                f1Var.setSubtext(AndroidUtilities.formatFileSize(k0Var2.f8413g));
            } else {
                Pair b10 = k0Var2.b();
            ...
            if (k0Var2.c()) {
                ...
                f1Var.f18624b.setPadding(0, 0, AndroidUtilities.dp(32.0f), 0);
            } else if (k0Var2.f8414i) {
                f1Var.setVisibility(8);
            } else {
                f1Var.setRightIcon(0);
                f1Var.f18624b.setPadding(0, 0, 0, 0);
            }
            f1Var.setOnClickListener(new ai.f2(8, this, k0Var2));
        }
        BotFullscreenButtons.OptionsIcon optionsIcon = this.f8422a0;
        int size = arrayList.size();
        int i10 = 0;
        while (true) {
            if (i10 < size) {
    ...
    public final void C() {
        j0 j0Var = this.f8439o0;
        if (j0Var == null) {
            return;
        }
        if (this.f8427d0) {
            j0Var.setArrow(AndroidUtilities.lerp(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(26.0f), this.f8430f0));
        } else if (this.f8423b > 0.5f) {
    ...
    public final void D() {
        ...
        boolean z10 = this.f8427d0;
        b3 b3Var = this.f8451x;
        j3 j3Var = this.e;
        g3 g3Var = this.f8436l0;
        int i16 = 0;
        if (z10) {
            ...
            int i18 = rect.top;
            int i19 = rect.right;
            if (this.f8437n > i14 || (g3Var != null && g3Var.getTotalHeight() > 0)) {
                i15 = 0;
            } else {
                i15 = rect.bottom;
            }
            ...
            b3Var.Q(rect2, false);
            b3Var.P(dp, false);
            j3Var.setPadding(0, 0, 0, Math.max(this.f8437n, i14));
        } else {
            ...
            int i21 = rect.right;
            int i22 = this.f8437n;
            org.telegram.ui.ActionBar.o3 o3Var = this.f8442r;
            if (o3Var != null) {
                i10 = o3Var.H;
            } else {
                i10 = 0;
        ...
        this.f8449w.topMargin = AndroidUtilities.dp(24.0f);
        boolean z11 = this.f8427d0;
        if (!z11) {
            i11 = 0;
        } else {
            i11 = rect.left;
        ...
        FrameLayout.LayoutParams layoutParams2 = this.f8441q0;
    ...
    public final void E() {
        ...
        if (this.U) {
            ...
            z10 = (AndroidUtilities.isTablet() || i0.a.f(i6.w0(null, i6.f18836d6, true)) < 0.7210000157356262d || this.f8423b < 0.85f) ? false : false;
        }
        Boolean bool = this.d;
    ...
    public final void G() {
        ...
        try {
            ...
            j3 j3Var = this.e;
            if (z10 && (((g3Var = this.f8436l0) == null || g3Var.getTotalHeight() <= 0) && !j3Var.f8403x0)) {
    ...
    public final org.telegram.ui.ActionBar.n3 a() {
        ...
        n3Var.f19439q = this.Q;
        n3Var.f19438p = this.f8447u0;
        n3Var.f19436n = this.U;
        n3Var.f19437o = this.V;
        n3Var.f19440r = this.P.getColor();
        n3Var.f19426a = this.f8448v0;
        boolean z13 = false;
        b3 b3Var = this.f8451x;
        ...
        n3Var.f19429f = str2;
        a3 a3Var = this.v;
        if ((a3Var == null || a3Var.getSwipeOffsetY() >= 0.0f) && !this.f8452x0 && !m() && !this.f8427d0) {
            z12 = false;
        } else {
            z12 = true;
        }
        n3Var.f19432j = z12;
        n3Var.f19447z = this.f8427d0;
        n3Var.A = this.f8428e0;
        Boolean bool = this.f8455z0;
        if (bool == null) {
            booleanValue = this.f8454y0;
        } else {
        ...
        n3Var.f19433k = f7;
        n3Var.C = this.A0;
        n3Var.f19443u = this.f8450w0;
        n3Var.f19446y = this.f8443r0;
        n3Var.v = this.f8424b0;
        n3Var.f19434l = (a3Var == null || a3Var.M) ? true : true;
        n3Var.f19444w = this.f8436l0.e;
        n3Var.f19441s = this.R;
        a1 a1Var = this.B0;
        if (a1Var != null) {
            a1Var.b();
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.webViewResultSent) {
            ...
            this.e.invalidate();
            this.f8451x.f38909n.b(i6.v0(i6.f18836d6, this.E), 153);
            A();
            E();
    ...
    public final void k(boolean z10) {
        ...
        this.f8426c0 = true;
        z(false);
        AndroidUtilities.cancelRunOnUIThread(this.f8446t0);
        ...
        if (z10 && ((launchActivity = LaunchActivity.G1) == null || launchActivity.f30860y0 == null)) {
            z10 = false;
        }
        if (z10) {
            o1.k kVar = this.f8425c;
            if (kVar != null) {
                kVar.f15351u.f15357i = 0.0f;
                kVar.f();
            }
    ...
    public final void n() {
        boolean z10;
        if (this.f8448v0 != null) {
            long max = Math.max(0L, 60000 - (System.currentTimeMillis() - this.f8448v0.f8349r));
            String str = null;
            this.f8455z0 = null;
            TLObject tLObject = this.f8448v0.f8348q;
            if (tLObject instanceof TLRPC.TL_webViewResultUrl) {
                ...
                this.f8455z0 = Boolean.valueOf(tL_webViewResultUrl.fullsize);
                boolean z11 = this.E0;
                if (!z11) {
                    x(tL_webViewResultUrl.fullscreen, !z11, this.f8428e0);
                }
            } else {
            ...
            if (str != null && !this.E0) {
                MediaDataController.getInstance(this.G).increaseWebappRating(this.f8448v0.f8337c);
                this.f8451x.u(this.G, str, z10);
            }
            AndroidUtilities.runOnUIThread(this.f8446t0, max);
            a3 a3Var = this.v;
            if (a3Var != null) {
                a3Var.setFullSize(m());
            }
    ...
    public final void onBackPressed() {
        if (this.f8445s0.getVisibility() == 0) {
            if (getOwnerActivity() != null) {
                getOwnerActivity().finish();
            }
        } else if (this.f8451x.D()) {
        } else {
            k(true);
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (this.f8427d0 && ((g3Var = this.f8436l0) == null || g3Var.getTotalHeight() <= 0)) {
            j3Var.setSystemUiVisibility(j3Var.getSystemUiVisibility() | 2);
        } else {
            j3Var.setSystemUiVisibility(j3Var.getSystemUiVisibility() & (-3));
        }
    ...
    public final void onStart() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.add(this.f8445s0);
        }
    }
    ...
    public final void onStop() {
        ...
        if (context instanceof LaunchActivity) {
            ((LaunchActivity) context).B0.remove(this.f8445s0);
        }
    }
    ...
    public final boolean q() {
        ...
        if (this.f8443r0) {
            ...
            alertDialog$Builder.f18437a.T = LocaleController.getString(R.string.BotWebViewChangesMayNotBeSaved);
            alertDialog$Builder.k(LocaleController.getString(R.string.BotWebViewCloseAnyway), new f2(this));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f18437a;
            b2Var.show();
            ((TextView) b2Var.d(-1)).setTextColor(i6.v0(i6.f19074q7, this.E));
            return false;
        }
        k(false);
        return true;
    ...
    public final void r() {
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i13 < size2) {
                ...
                if (J.e == null) {
                    ...
                    f1Var.setText(str);
                    f1Var.setSubtext("");
                    Integer num = J.f26353j0;
                    if (num != null) {
                        v02 = num.intValue();
                    } else {
                        v02 = i6.v0(i6.E8, e6Var);
                    }
                    Integer num2 = J.f26355k0;
                    if (num2 != null) {
                        v03 = num2.intValue();
                    } else {
                        v03 = i6.v0(i6.F8, e6Var);
                    }
                    f1Var.c(v02, v03);
                    Integer num3 = J.f26357l0;
                    if (num3 != null) {
                        l1 = num3.intValue();
                    } else {
                        l1 = i6.l1(0.12f, i6.v0(i6.E8, e6Var));
                    }
        ...
        if (this.Q != i6.w0(null, i6.f18836d6, false)) {
    ...
    public final void s(org.telegram.ui.ActionBar.n2 n2Var, f5 f5Var) {
        ...
        if (f5Var.f8348q != null) {
            n();
            return;
        }
        int i12 = f5Var.f8339g;
        if (i12 != 0) {
            if (i12 != 1) {
                if (i12 != 2) {
                    if (i12 != 3) {
                        ...
                        tL_messages_requestMainWebView.bot = MessagesController.getInstance(this.G).getInputUser(f5Var.f8337c);
                        ...
                        if (n2Var instanceof bo) {
                            ...
                            inputPeer2 = MessagesController.getInstance(this.G).getInputPeer(f5Var.f8336b);
                        }
                        tL_messages_requestMainWebView.peer = inputPeer2;
                        tL_messages_requestMainWebView.compact = f5Var.f8346o;
                        tL_messages_requestMainWebView.fullscreen = f5Var.f8347p;
                        if (!TextUtils.isEmpty(f5Var.f8343l)) {
                            tL_messages_requestMainWebView.start_param = f5Var.f8343l;
                    ...
                    TLRPC.BotApp botApp = f5Var.f8341j;
                    tL_inputBotAppID.f18170id = botApp.f18109id;
                    tL_inputBotAppID.access_hash = botApp.access_hash;
                    tL_messages_requestAppWebView.app = tL_inputBotAppID;
                    tL_messages_requestAppWebView.write_allowed = f5Var.f8342k;
                    ...
                    if (n2Var instanceof bo) {
                        ...
                        inputPeer = MessagesController.getInputPeer(f5Var.f8344m);
                    }
                    tL_messages_requestAppWebView.peer = inputPeer;
                    tL_messages_requestAppWebView.compact = f5Var.f8346o;
                    tL_messages_requestAppWebView.fullscreen = f5Var.f8347p;
                    if (!TextUtils.isEmpty(f5Var.f8343l)) {
                        tL_messages_requestAppWebView.start_param = f5Var.f8343l;
                ...
                tL_messages_requestWebView.compact = f5Var.f8346o;
                tL_messages_requestWebView.fullscreen = f5Var.f8347p;
                tL_messages_requestWebView.url = f5Var.f8338f;
            ...
            tL_messages_requestSimpleWebView.compact = f5Var.f8346o;
            tL_messages_requestSimpleWebView.fullscreen = f5Var.f8347p;
            if (p5 != null) {
            ...
            if (!TextUtils.isEmpty(f5Var.f8338f)) {
                tL_messages_requestSimpleWebView.flags |= 8;
                tL_messages_requestSimpleWebView.url = f5Var.f8338f;
            }
            if (!TextUtils.isEmpty(f5Var.f8343l)) {
                tL_messages_requestSimpleWebView.start_param = f5Var.f8343l;
        ...
        tL_messages_requestWebView2.compact = f5Var.f8346o;
        tL_messages_requestWebView2.fullscreen = f5Var.f8347p;
        String str = f5Var.f8338f;
        if (str != null) {
    ...
    public final void t(final int i10, boolean z10, boolean z11) {
        ...
        SparseIntArray sparseIntArray = c2Var.f8277a;
        e6 e6Var = this.E;
        ...
        c2Var.c(c2Var.f8278b, i13, e6Var);
        if (z11) {
    ...
    public final void x(boolean z10, boolean z11, boolean z12) {
        ...
        this.f8433i0 = a3Var.getWidth();
        this.f8434j0 = a3Var.getHeight();
        this.Q0 = false;
        g3 g3Var = this.f8436l0;
        b3 b3Var = this.f8451x;
        h3 h3Var = this.W;
        if (z11) {
            ...
            h3Var.setTranslationY((-org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) * this.f8430f0);
            a3Var.setTranslationY(AndroidUtilities.lerp(f12, f14, this.f8431g0));
            a3Var.setTranslationX(AndroidUtilities.lerp(f11, 0.0f, this.f8431g0));
            g3Var.setTranslationX(AndroidUtilities.lerp(f10, 0.0f, this.f8431g0));
            botFullscreenButtons.setAlpha(this.f8430f0);
            this.e.invalidate();
        ...
        h3Var.setAlpha(1.0f - this.f8430f0);
        h3Var.setTranslationY((-org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) * this.f8430f0);
