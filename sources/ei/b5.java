...
public final class b5 extends Drawable implements v6, NotificationCenter.NotificationCenterDelegate {
    ...
    public final void draw(Canvas canvas) {
        ...
        float dp = (AndroidUtilities.dp((i10 + 38) + 6.66f) + this.h.f24439c) / 2.0f;
    ...
    public b5(TLRPC.User user, TLRPC.Document document) {
        ...
        imageReceiver2.setImage(ImageLocation.getForDocument(document), "120_120", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "120_120", DocumentObject.getSvgThumb(document.thumbs, j6.f18806a7, 0.35f), 0L, null, null, 0);
        this.h = new h01(UserObject.getUserName(user), 14.0f, null);
    }
