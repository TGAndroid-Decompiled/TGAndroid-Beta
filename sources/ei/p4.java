...
public abstract class p4 extends FrameLayout {
    public static final uv0 f8545b0 = new uv0(new d2.c(21), new d2.c(22));
    public Runnable E;
    public o4 F;
    public o1.k G;
    public int H;
    ...
    public p4(Context context) {
        ...
        this.U = true;
        this.f8548b = new n2.e(context, new n4(this, ViewConfiguration.get(context).getScaledTouchSlop(), 0));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f8549c || motionEvent.getActionIndex() == 0) {
            ...
            boolean onTouchEvent = ((GestureDetector) this.f8548b.f15073b).onTouchEvent(obtain);
            obtain.recycle();
    ...
    public final void f(float f7, boolean z10, Runnable runnable) {
        ...
        if (this.f8552r != f7 && ((kVar = this.G) == null || ((float) kVar.f15490u.f15496i) != f7)) {
            this.f8551n = f7;
            o1.k kVar2 = this.v;
            if (kVar2 != null) {
                kVar2.c();
            ...
            kVar4.f15490u = org.telegram.ui.Cells.c1.j(f7, 1200.0f, 1.0f);
    ...
    public void setOffsetY(final float f7) {
        ...
        if (!this.f8553s) {
            ...
            kVar3.f15490u = org.telegram.ui.Cells.c1.j(f7, 1400.0f, 1.0f);
            kVar3.b(new o1.g() {
                @Override
                public final void a(o1.h hVar, float f12, float f13) {
                    ...
                    o1.k kVar4 = p4Var.G;
                    if (kVar4 != null) {
                        o1.l lVar = kVar4.f15490u;
                        float f17 = (float) lVar.f15496i;
                        float f18 = p4Var.e;
                        if (f17 == (-f16) + f18) {
                            lVar.f15496i = (-f7) + f18;
                        }
