...
public abstract class p4 extends FrameLayout {
    public static final tv0 f8546b0 = new tv0(new d2.c(21), new d2.c(22));
    public Runnable E;
    public o4 F;
    public o1.k G;
    public int H;
    ...
    public float f8548a0;
    public final n2.e f8549b;
    ...
    public org.telegram.ui.web.z0 f8556x;
    public Runnable f8557y;
    ...
    public p4(Context context) {
        ...
        this.U = true;
        this.f8549b = new n2.e(context, new n4(this, ViewConfiguration.get(context).getScaledTouchSlop(), 0));
    ...
    public final boolean b(boolean z10) {
        org.telegram.ui.web.z0 z0Var = this.f8556x;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f8550c || motionEvent.getActionIndex() == 0) {
            if (motionEvent.getAction() == 0) {
                this.V = motionEvent.getEventTime();
                this.W = motionEvent.getX();
                this.f8548a0 = motionEvent.getY();
                this.S = false;
                this.R = 0.0f;
                if (this.N) {
                    this.O = false;
            ...
            boolean onTouchEvent = ((GestureDetector) this.f8549b.f15112b).onTouchEvent(obtain);
            obtain.recycle();
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                ...
                if (!this.J || this.L) {
                    if (this.f8555w) {
                        this.f8555w = false;
                    } else if (this.M && (!this.N || (this.f8553r != (-this.f8551f) + this.e && b(false)))) {
                        float f7 = this.f8553r;
                        int i10 = this.H;
                        float f10 = -i10;
                        boolean z11 = this.U;
                        if (f7 <= f10) {
                            if (z11) {
                                e((-this.f8551f) + this.e);
                            }
                            ...
                            float distance = AndroidUtilities.distance(motionEvent.getX(), motionEvent.getY(), this.W, this.f8548a0);
    ...
    public final void f(float f7, boolean z10, Runnable runnable) {
        ...
        if (this.f8553r != f7 && ((kVar = this.G) == null || ((float) kVar.f15522u.f15528i) != f7)) {
            this.f8552n = f7;
            o1.k kVar2 = this.v;
            if (kVar2 != null) {
                kVar2.c();
            ...
            o1.k kVar4 = new o1.k(this, f8546b0, f7);
            kVar4.f15522u = org.telegram.ui.Cells.c1.m(f7, 1200.0f, 1.0f);
    ...
    public Object getRenderNode() {
        if (this.f8547a == null && Build.VERSION.SDK_INT >= 31) {
            this.f8547a = ah.f.k();
        }
        return this.f8547a;
    }
    ...
    public void setOffsetY(final float f7) {
        ...
        final float f10 = this.f8551f;
        final float f11 = f7 - f10;
        if (Math.abs((this.f8553r + f10) - this.e) <= AndroidUtilities.dp(1.0f)) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (!this.f8554s) {
            ...
            kVar3.f15522u = org.telegram.ui.Cells.c1.m(f7, 1400.0f, 1.0f);
            kVar3.b(new o1.g() {
                @Override
                public final void a(o1.h hVar, float f12, float f13) {
                    ...
                    if (z10) {
                        p4Var.f8553r = w7.q.a(p4Var.f8553r - (Math.max(0.0f, f15) * f14), (-p4Var.f8551f) + p4Var.e, (p4Var.getHeight() - p4Var.f8551f) + p4Var.e);
                    }
                    o1.k kVar4 = p4Var.G;
                    if (kVar4 != null) {
                        o1.l lVar = kVar4.f15522u;
                        float f17 = (float) lVar.f15528i;
                        float f18 = p4Var.e;
                        if (f17 == (-f16) + f18) {
                            lVar.f15528i = (-f7) + f18;
                        }
        ...
        this.f8551f = f7;
        if (z10) {
            this.f8553r = w7.q.a(this.f8553r - Math.max(0.0f, f11), (-this.f8551f) + this.e, (getHeight() - this.f8551f) + this.e);
        }
        c();
    }
