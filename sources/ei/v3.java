...
public final class v3 implements View.OnClickListener {
    ...
    public final int e;
    public final org.telegram.ui.ActionBar.g3 f8683f;
    ...
    public v3(ci.d dVar, c01 c01Var, MessagesController messagesController, long j3, TLRPC.User user, String[] strArr, int i10, org.telegram.ui.ActionBar.g3 g3Var, boolean z10, f6 f6Var) {
        this.f8681b = dVar;
        this.f8685r = c01Var;
        ...
        switch (this.f8680a) {
            case 0:
                ...
                if (!dVar.N) {
                    ...
                    final org.telegram.ui.ActionBar.g3 g3Var = this.f8683f;
            ...
            default:
                ...
                if (!dVar2.N) {
                    ...
                    if (textView.getText().toString().trim().length() <= 16) {
                        ...
                        ?? obj = new Object();
                        final org.telegram.ui.ActionBar.g3 g3Var2 = this.f8683f;
    ...
    public v3(ci.d dVar, long[] jArr, int i10, TL_payments.starRefProgram starrefprogram, org.telegram.ui.ActionBar.g3 g3Var, long j3, boolean z10, Context context, f6 f6Var, TLRPC.User user) {
        this.f8681b = dVar;
        this.f8685r = jArr;
        this.e = i10;
