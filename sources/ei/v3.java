...
public final class v3 implements View.OnClickListener {
    public final int f8675a = 1;
    public final ci.d f8676b;
    public final long f8677c;
    public final TLRPC.User d;
    public final int e;
    public final org.telegram.ui.ActionBar.f3 f8678f;
    public final boolean h;
    public final e6 f8679n;
    public final Object f8680r;
    ...
    public v3(ci.d dVar, b01 b01Var, MessagesController messagesController, long j3, TLRPC.User user, String[] strArr, int i10, org.telegram.ui.ActionBar.f3 f3Var, boolean z10, e6 e6Var) {
        this.f8676b = dVar;
        this.f8680r = b01Var;
        this.f8681s = messagesController;
        this.f8677c = j3;
        this.d = user;
        this.v = strArr;
        this.e = i10;
    ...
    public final void onClick(View view) {
        switch (this.f8675a) {
            case 0:
                long[] jArr = (long[]) this.f8680r;
                final TL_payments.starRefProgram starrefprogram = (TL_payments.starRefProgram) this.f8681s;
                final Context context = (Context) this.v;
                final ci.d dVar = this.f8676b;
                if (!dVar.N) {
                    ...
                    final org.telegram.ui.ActionBar.f3 f3Var = this.f8678f;
                    final long j10 = this.f8677c;
                    final boolean z10 = this.h;
                    final e6 e6Var = this.f8679n;
                ...
                return;
            default:
                b01 b01Var = (b01) this.f8680r;
                c6 c6Var = b01Var.h;
                final MessagesController messagesController = (MessagesController) this.f8681s;
                String[] strArr = (String[]) this.v;
                final ci.d dVar2 = this.f8676b;
                if (!dVar2.N) {
                    ...
                    if (textView.getText().toString().trim().length() <= 16) {
                        ...
                        ?? obj = new Object();
                        final org.telegram.ui.ActionBar.f3 f3Var2 = this.f8678f;
                        final boolean z11 = this.h;
                        final e6 e6Var2 = this.f8679n;
                        connectionsManager2.sendRequestTyped(tL_messages_editChatParticipantRank, obj, new Utilities.Callback2() {
                            ...
                            public final void run(Object obj2, Object obj3) {
                                ...
                                if (updates != null) {
                                    ...
                                    org.telegram.ui.Cells.p6.q(f3Var3.topBulletinContainer, e6Var2, tL_error, false);
