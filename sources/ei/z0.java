...
public final class z0 implements SensorEventListener {
    ...
    public final void a() {
        if (this.f8753b != null) {
            a1 a1Var = this.e;
            if (a1Var.f8219k != null) {
                this.f8752a = System.currentTimeMillis();
                if (this.f8754c == null) {
                    this.f8754c = new float[9];
                }
                if (this.d == null) {
                    this.d = new float[4];
                }
                ...
                if (fArr.length > 4) {
                    ...
                    SensorManager.getRotationMatrixFromVector(this.f8754c, this.d);
                } else {
                    SensorManager.getRotationMatrixFromVector(this.f8754c, fArr);
                }
                float[] fArr2 = new float[3];
                SensorManager.getOrientation(this.f8754c, fArr2);
                try {
                    ...
                    org.telegram.ui.web.z0 z0Var = a1Var.f8219k;
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        a1 a1Var = this.e;
        uc ucVar = a1Var.f8227s;
        if (ucVar != null) {
            AndroidUtilities.cancelRunOnUIThread(ucVar);
            a1Var.f8227s = null;
        }
        if (!a1Var.f8220l && a1Var.f8219k != null) {
            long currentTimeMillis = System.currentTimeMillis() - this.f8752a;
            long j3 = a1Var.f8218j;
            ...
            if (sensorEvent.sensor.getType() == 15) {
                this.f8753b = sensorEvent.values;
            }
            a();
        }
    }
