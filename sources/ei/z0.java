...
public final class z0 implements SensorEventListener {
    ...
    public final void a() {
        if (this.f8755b != null) {
            ...
            if (a1Var.f8221k != null) {
                this.f8754a = System.currentTimeMillis();
                if (this.f8756c == null) {
                    this.f8756c = new float[9];
                }
                if (this.d == null) {
                    this.d = new float[4];
                }
                float[] fArr = this.f8755b;
                if (fArr.length > 4) {
                    System.arraycopy(fArr, 0, this.d, 0, 4);
                    SensorManager.getRotationMatrixFromVector(this.f8756c, this.d);
                } else {
                    SensorManager.getRotationMatrixFromVector(this.f8756c, fArr);
                }
                float[] fArr2 = new float[3];
                SensorManager.getOrientation(this.f8756c, fArr2);
                try {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        a1 a1Var = this.e;
        uc ucVar = a1Var.f8229s;
        if (ucVar != null) {
            AndroidUtilities.cancelRunOnUIThread(ucVar);
            a1Var.f8229s = null;
        }
        if (!a1Var.f8222l && a1Var.f8221k != null) {
            long currentTimeMillis = System.currentTimeMillis() - this.f8754a;
            long j3 = a1Var.f8220j;
            ...
            if (sensorEvent.sensor.getType() == 15) {
                this.f8755b = sensorEvent.values;
            }
            a();
        }
    }
