...
public final class v0 extends Drawable implements w6 {
    public final Paint f8670a;
    public final Paint f8671b;
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, dp2, AndroidUtilities.dp(12.0f), this.f8672c);
        int dp3 = (int) (dp2 + AndroidUtilities.dp(9.0f));
        Drawable drawable = this.f8673f;
