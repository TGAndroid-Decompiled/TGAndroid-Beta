...
public final class h1 implements Utilities.Callback2 {
    ...
    public h1(int i10, org.telegram.ui.ActionBar.o2 o2Var, nf.e eVar, org.telegram.ui.ActionBar.c2 c2Var) {
        this.f8374a = 7;
        this.f8375b = i10;
        this.f8376c = o2Var;
        this.d = eVar;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f8374a) {
            case 0:
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.c2[] c2VarArr = (org.telegram.ui.ActionBar.c2[]) this.f8376c;
                ...
                if (tL_error2 != null) {
                    vc.a0(o2Var).d0(tL_error2, false);
                    return;
                    ...
                    if (arrayList.isEmpty()) {
                        ...
                        o2Var.showDialog(new fi.k0(o2Var, 0L, arrayList, new r4(o2Var, chat, this.f8375b, 1)));
                        return;
                    } else {
            ...
            case 2:
                org.telegram.ui.c1 c1Var = (org.telegram.ui.c1) this.f8376c;
                ...
                int i11 = this.f8375b;
                if (tL_error3 != null) {
                    AndroidUtilities.runOnUIThread(new c9(c1Var, i11, tL_error3, tL_channels_joinChannel, 9));
                    return;
                }
                boolean z11 = false;
                ...
                if (!z11) {
                    MessagesController.getInstance(i11).generateJoinMessage(chat2.f18121id, true);
                }
                ...
                return;
            case 3:
                org.telegram.ui.Components.e0.Z((org.telegram.ui.Components.e0) this.f8376c, (k5) this.d, this.f8375b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 4:
                org.telegram.ui.Components.e0.V((org.telegram.ui.Components.e0) this.f8376c, (k5) this.d, this.f8375b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 5:
                boolean[] zArr = (boolean[]) this.f8376c;
                ...
                if (!zArr[0]) {
                    if (str != null) {
                        arrayList2.set(this.f8375b, str);
            ...
            case 6:
                ...
                ((ci.d) this.f8376c).setLoading(false);
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context);
                        alertDialog$Builder.f18447a.R = LocaleController.getString(R.string.PasskeyNoOptionsTitle);
                        alertDialog$Builder.f18447a.T = LocaleController.getString(R.string.PasskeyNoOptionsText);
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        alertDialog$Builder.f18447a.setOnDismissListener(new r5(g3Var, 10));
                    ...
                    if (U != null) {
                        if (str2 != null) {
                            ...
                            if (U instanceof PasskeysActivity) {
                                ...
                                ConnectionsManager.getInstance(i14).sendRequestTyped(new TL_account.getPasskeys(), new Object(), new n6(g3Var, passkey, str2, 3));
                                return;
                            }
                        } else {
                            return;
                ...
                return;
            default:
                org.telegram.ui.ActionBar.o2 o2Var2 = (org.telegram.ui.ActionBar.o2) this.f8376c;
                ...
                if (updates2 != null && tL_error4 == null) {
                    MessagesController.getInstance(this.f8375b).processUpdates(updates2, false);
                }
                AndroidUtilities.runOnUIThread(new hs0(o2Var2, tL_error4, eVar, c2Var2, 27));
                return;
        }
    }
