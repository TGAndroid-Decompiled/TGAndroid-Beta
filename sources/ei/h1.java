    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f8373a) {
            case 0:
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.b2[] b2VarArr = (org.telegram.ui.ActionBar.b2[]) this.f8375c;
                ...
                if (tL_error2 != null) {
                    ...
                    if (arrayList.isEmpty()) {
                        ...
                        n2Var.showDialog(new fi.k0(n2Var, 0L, arrayList, new r4(n2Var, chat, this.f8374b, 1)));
                        return;
                    } else {
            ...
            case 2:
                org.telegram.ui.c1 c1Var = (org.telegram.ui.c1) this.f8375c;
                ...
                if (!z11) {
                    MessagesController.getInstance(i11).generateJoinMessage(chat2.f18343id, true);
                }
                ...
                return;
            case 3:
                org.telegram.ui.Components.e0.Z((org.telegram.ui.Components.e0) this.f8375c, (j5) this.d, this.f8374b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 4:
                org.telegram.ui.Components.e0.V((org.telegram.ui.Components.e0) this.f8375c, (j5) this.d, this.f8374b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 5:
                boolean[] zArr = (boolean[]) this.f8375c;
                ...
                if (!zArr[0]) {
                    if (str != null) {
                        arrayList2.set(this.f8374b, str);
            ...
            case 6:
                ...
                ((ci.d) this.f8375c).setLoading(false);
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context);
                        alertDialog$Builder.f18669a.R = LocaleController.getString(R.string.PasskeyNoOptionsTitle);
                        alertDialog$Builder.f18669a.T = LocaleController.getString(R.string.PasskeyNoOptionsText);
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        alertDialog$Builder.f18669a.setOnDismissListener(new r5(f3Var, 10));
                ...
                return;
            default:
                org.telegram.ui.ActionBar.n2 n2Var2 = (org.telegram.ui.ActionBar.n2) this.f8375c;
                ...
                if (updates2 != null && tL_error4 == null) {
                    MessagesController.getInstance(this.f8374b).processUpdates(updates2, false);
                }
