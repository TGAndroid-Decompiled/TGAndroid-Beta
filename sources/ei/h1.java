    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f8357a) {
            case 0:
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.b2[] b2VarArr = (org.telegram.ui.ActionBar.b2[]) this.f8359c;
                ...
                if (tL_error2 != null) {
                    ...
                    if (arrayList.isEmpty()) {
                        ...
                        n2Var.showDialog(new fi.k0(n2Var, 0L, arrayList, new r4(n2Var, chat, this.f8358b, 1)));
                        return;
                    } else {
            ...
            case 2:
                org.telegram.ui.d1 d1Var = (org.telegram.ui.d1) this.f8359c;
                ...
                if (!z11) {
                    MessagesController.getInstance(i11).generateJoinMessage(chat2.f18083id, true);
                }
                ...
                return;
            case 3:
                org.telegram.ui.Components.e0.Z((org.telegram.ui.Components.e0) this.f8359c, (i5) this.d, this.f8358b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 4:
                org.telegram.ui.Components.e0.V((org.telegram.ui.Components.e0) this.f8359c, (i5) this.d, this.f8358b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 5:
                boolean[] zArr = (boolean[]) this.f8359c;
                ...
                if (!zArr[0]) {
                    if (str != null) {
                        arrayList2.set(this.f8358b, str);
            ...
            case 6:
                ...
                ((ci.d) this.f8359c).setLoading(false);
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        ...
                        alertDialog$Builder.f18409a.setOnDismissListener(new s5(f3Var, 10));
                ...
                return;
            default:
                org.telegram.ui.ActionBar.n2 n2Var2 = (org.telegram.ui.ActionBar.n2) this.f8359c;
                ...
                if (updates2 != null && tL_error4 == null) {
                    MessagesController.getInstance(this.f8358b).processUpdates(updates2, false);
                }
                AndroidUtilities.runOnUIThread(new yr0(n2Var2, tL_error4, eVar, b2Var2, 27));
                return;
        }
    }
