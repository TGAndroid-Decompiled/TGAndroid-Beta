    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f8373a) {
            ...
            case 2:
                ...
                if (!z11) {
                    MessagesController.getInstance(i11).generateJoinMessage(chat2.f18296id, true);
                }
            ...
            case 6:
                ...
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        ...
                        alertDialog$Builder.f18622a.setOnDismissListener(new r5(f3Var, 10));
