...
public final class h1 implements Utilities.Callback2 {
    ...
    public h1(int i10, org.telegram.ui.ActionBar.n2 n2Var, nf.e eVar, org.telegram.ui.ActionBar.b2 b2Var) {
        this.f8369a = 7;
        this.f8370b = i10;
        this.f8371c = n2Var;
        this.d = eVar;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (this.f8369a) {
            case 0:
                ...
                return;
            case 1:
                org.telegram.ui.ActionBar.b2[] b2VarArr = (org.telegram.ui.ActionBar.b2[]) this.f8371c;
                ...
                if (tL_error2 != null) {
                    vc.a0(n2Var).d0(tL_error2, false);
                    return;
                } else if (arrayList != null) {
                    if (arrayList.isEmpty()) {
                        org.telegram.messenger.w1.o(R.string.CommunityNoChatsToAdd, vc.a0(n2Var), R.raw.info, 36);
                        return;
                    } else if (!arrayList.isEmpty()) {
                        n2Var.showDialog(new fi.k0(n2Var, 0L, arrayList, new r4(n2Var, chat, this.f8370b, 1)));
                        return;
                    } else {
            ...
            case 2:
                org.telegram.ui.c1 c1Var = (org.telegram.ui.c1) this.f8371c;
                ...
                if (!z11) {
                    MessagesController.getInstance(i11).generateJoinMessage(chat2.f18112id, true);
                }
                ...
                return;
            case 3:
                org.telegram.ui.Components.e0.Z((org.telegram.ui.Components.e0) this.f8371c, (j5) this.d, this.f8370b, (TLRPC.TL_messages_composeMessageWithAI) this.e, (TLRPC.TL_composedMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 4:
                org.telegram.ui.Components.e0.V((org.telegram.ui.Components.e0) this.f8371c, (j5) this.d, this.f8370b, (TLRPC.TL_messages_composeRichMessageWithAI) this.e, (TLRPC.TL_composedRichMessageWithAI) obj, (TLRPC.TL_error) obj2);
                return;
            case 5:
                boolean[] zArr = (boolean[]) this.f8371c;
                ...
                if (!zArr[0]) {
                    if (str != null) {
                        arrayList2.set(this.f8370b, str);
            ...
            case 6:
                ...
                ((ci.d) this.f8371c).setLoading(false);
                if (!"CANCELLED".equalsIgnoreCase(str2)) {
                    if ("EMPTY".equalsIgnoreCase(str2)) {
                        AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(context);
                        alertDialog$Builder.f18437a.R = LocaleController.getString(R.string.PasskeyNoOptionsTitle);
                        alertDialog$Builder.f18437a.T = LocaleController.getString(R.string.PasskeyNoOptionsText);
                        alertDialog$Builder.k(LocaleController.getString(R.string.OK), null);
                        alertDialog$Builder.f18437a.setOnDismissListener(new r5(f3Var, 10));
                ...
                return;
            default:
                org.telegram.ui.ActionBar.n2 n2Var2 = (org.telegram.ui.ActionBar.n2) this.f8371c;
                ...
                if (updates2 != null && tL_error4 == null) {
                    MessagesController.getInstance(this.f8370b).processUpdates(updates2, false);
                }
                AndroidUtilities.runOnUIThread(new fs0(n2Var2, tL_error4, eVar, b2Var2, 27));
                return;
        }
    }
