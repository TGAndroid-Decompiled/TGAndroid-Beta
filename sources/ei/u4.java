...
public final class u4 implements org.telegram.ui.ActionBar.a2, nj0, sc0 {
    public final int f8650a;
    public final int f8651b;
    public final Object f8652c;
    public final Object d;
    public final Object e;
    public final Object f8653f;
    ...
    public void a(pj0 pj0Var, int i10) {
        ...
        int[] iArr = (int[]) this.f8653f;
        int i11 = this.f8651b + i10;
        int i12 = this.f8650a;
        ((SparseIntArray) this.f8652c).put(i12, i11);
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        boolean[] zArr = (boolean[]) this.f8652c;
        TLRPC.Document document = (TLRPC.Document) this.e;
        boolean[] zArr2 = (boolean[]) this.d;
        Utilities.Callback callback = (Utilities.Callback) this.f8653f;
        int i11 = this.f8650a;
    ...
    public void q(uc0 uc0Var, int i10) {
        org.telegram.ui.Components.a4 a4Var = (org.telegram.ui.Components.a4) this.f8652c;
        tg.i iVar = (tg.i) this.d;
        tg.j jVar = (tg.j) this.e;
        uc0 uc0Var2 = (uc0) this.f8653f;
        try {
        ...
        if (uc0Var.getTag() != null && uc0Var.getTag().equals("DAY")) {
            if (uc0Var.getValue() == uc0Var.getMinValue()) {
                ...
                iVar.setMaxValue(this.f8650a);
                jVar.setMaxValue(Math.min(this.f8651b / 5, 11));
            } else {
                iVar.setMinValue(0);
                jVar.setMinValue(0);
                iVar.setMaxValue(23);
