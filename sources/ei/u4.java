...
public final class u4 implements org.telegram.ui.ActionBar.a2, nj0, sc0 {
    ...
    public void a(pj0 pj0Var, int i10) {
        ...
        int[] iArr = (int[]) this.f8651f;
        int i11 = this.f8649b + i10;
        int i12 = this.f8648a;
        ((SparseIntArray) this.f8650c).put(i12, i11);
    ...
    public void f(org.telegram.ui.ActionBar.b2 b2Var, int i10) {
        boolean[] zArr = (boolean[]) this.f8650c;
        TLRPC.Document document = (TLRPC.Document) this.e;
        boolean[] zArr2 = (boolean[]) this.d;
        Utilities.Callback callback = (Utilities.Callback) this.f8651f;
        int i11 = this.f8648a;
    ...
    public void q(uc0 uc0Var, int i10) {
        org.telegram.ui.Components.a4 a4Var = (org.telegram.ui.Components.a4) this.f8650c;
        tg.i iVar = (tg.i) this.d;
        tg.j jVar = (tg.j) this.e;
        uc0 uc0Var2 = (uc0) this.f8651f;
        try {
        ...
        if (uc0Var.getTag() != null && uc0Var.getTag().equals("DAY")) {
            if (uc0Var.getValue() == uc0Var.getMinValue()) {
                ...
                iVar.setMaxValue(this.f8648a);
                jVar.setMaxValue(Math.min(this.f8649b / 5, 11));
            } else {
                iVar.setMinValue(0);
                jVar.setMinValue(0);
                iVar.setMaxValue(23);
