...
public final class f extends q20 {
    ...
    public final void E(ViewGroup viewGroup, int i10, int i11, int[] iArr, int i12) {
        ...
        switch (this.K0) {
            case 0:
                i iVar = (i) this.M0;
                if (viewGroup == iVar.f40042c && iVar.R.isAttachedToWindow()) {
                    ...
                    boolean z11 = false;
                    if (i11 < 0) {
                        if (iVar.f40042c.getHeight() - bottom >= 0) {
                        ...
                        if (iVar.f40042c.getHeight() - bottom >= 0 && currentListView3 != null && !currentListView3.canScrollVertically(1)) {
                            iArr[1] = i11;
                            iVar.f40042c.B0();
                            return;
                        }
            ...
            default:
                v7 v7Var = (v7) this.M0;
                if (viewGroup == v7Var.f40042c && v7Var.R.isAttachedToWindow()) {
                    kVar2 = ((n2) v7Var).actionBar;
                    boolean z12 = kVar2.f21104n0;
                    ...
                    boolean z13 = false;
                    if (i11 < 0) {
                        if ((v7Var.f40042c.getHeight() - v7Var.f40042c.getPaddingBottom()) - bottom2 >= 0) {
                        ...
                        if ((v7Var.f40042c.getHeight() - v7Var.f40042c.getPaddingBottom()) - bottom2 >= 0 && currentListView6 != null && !currentListView6.canScrollVertically(1)) {
                            iArr[1] = i11;
                            v7Var.f40042c.B0();
                            return;
                        }
        ...
        switch (this.K0) {
            case 0:
                ...
                try {
                    if (viewGroup == iVar.f40042c && iVar.R.isAttachedToWindow()) {
                        ll0 currentListView = iVar.R.getCurrentListView();
                        if (iVar.f40042c.getHeight() - ((View) iVar.R.getParent()).getBottom() >= 0) {
                            iArr[1] = i13;
            ...
            default:
                ...
                try {
                    if (viewGroup == v7Var.f40042c && v7Var.R.isAttachedToWindow()) {
                        ...
                        if ((v7Var.f40042c.getHeight() - v7Var.f40042c.getPaddingBottom()) - ((View) v7Var.R.getParent()).getBottom() >= 0) {
                            iArr[1] = i13;
                            currentListView2.scrollBy(0, i13);
                            return;
                        }
