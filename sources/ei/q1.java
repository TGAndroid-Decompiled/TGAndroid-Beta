        ...
        switch (this.f8562a) {
            ...
            default:
                ...
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    z10 = q1Var.f46105b0.disallow_unique_stargifts;
                } else {
                    q1Var.getClass();
                    if (starGift.limited) {
                        TLRPC.DisallowedGiftsSettings disallowedGiftsSettings = q1Var.f46105b0;
                    ...
                    z10 = q1Var.f46105b0.disallow_unlimited_stargifts;
                }
                return true ^ z10;
        }
        return !contains;
