...
public final class q1 implements Predicate {
    ...
    public final boolean test(Object obj) {
        ...
        switch (this.f8544a) {
            case 0:
                contains = ((HashSet) this.f8545b).contains(Long.valueOf(((s1) obj).f8587b));
                break;
            case 1:
                contains = ((HashSet) this.f8545b).contains(Long.valueOf(((s1) obj).f8587b));
                break;
            default:
                ...
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    z10 = r1Var.f46368b0.disallow_unique_stargifts;
                } else {
                    r1Var.getClass();
                    if (starGift.limited) {
                        TLRPC.DisallowedGiftsSettings disallowedGiftsSettings = r1Var.f46368b0;
                    ...
                    z10 = r1Var.f46368b0.disallow_unlimited_stargifts;
                }
                return true ^ z10;
        }
        return !contains;
