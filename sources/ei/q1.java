    ...
    public final boolean test(Object obj) {
        ...
        switch (this.f8562a) {
            ...
            case 1:
                ...
                break;
            default:
                xh.r1 r1Var = (xh.r1) this.f8563b;
                TL_stars.StarGift starGift = (TL_stars.StarGift) obj;
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    z10 = r1Var.f46388b0.disallow_unique_stargifts;
                } else {
                    r1Var.getClass();
                    if (starGift.limited) {
                        TLRPC.DisallowedGiftsSettings disallowedGiftsSettings = r1Var.f46388b0;
                    ...
                    z10 = r1Var.f46388b0.disallow_unlimited_stargifts;
                }
                return true ^ z10;
        }
        return !contains;
