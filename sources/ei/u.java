...
public final class u extends org.telegram.ui.ActionBar.n2 {
    public e61 f8634a;
    public final ArrayList f8635b;
    public final HashMap f8636c;
    ...
    public static void U(u uVar, ArrayList arrayList) {
        HashMap hashMap = uVar.f8636c;
        ArrayList arrayList2 = uVar.f8635b;
        for (int i10 = 0; i10 < arrayList2.size(); i10++) {
            ...
            if (spannableStringBuilder == null) {
                ...
                spannableStringBuilder.append((CharSequence) UserObject.getUserName(qVar.f8555a));
    ...
    public static void V(u uVar, i51 i51Var) {
        int i10;
        w51 w51Var;
        ArrayList arrayList = uVar.f8635b;
        if (i51Var.f15531a == 4 && (i10 = i51Var.d) >= 0 && i10 < arrayList.size()) {
            q qVar = (q) arrayList.get(i51Var.d);
            qVar.f8556b = !qVar.f8556b;
            Activity parentActivity = uVar.getParentActivity();
            int i11 = uVar.currentAccount;
            long j3 = qVar.f8555a.f18256id;
            boolean z10 = qVar.f8556b;
            WeakHashMap weakHashMap = r.f8573k;
    ...
    public final View createView(Context context) {
        ...
        frameLayout.setBackgroundColor(i6.v0(i6.f18778a7, this.resourceProvider));
