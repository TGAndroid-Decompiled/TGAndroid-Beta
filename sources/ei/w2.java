...
public final class w2 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        k3 k3Var = this.f8705f;
        b3 b3Var = k3Var.f8453x;
        h3 h3Var = k3Var.W;
        a3 a3Var = k3Var.v;
        float floatValue = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        k3Var.f8433g0 = floatValue;
        if (!this.f8702a) {
            floatValue = 1.0f - floatValue;
        }
        k3Var.f8432f0 = floatValue;
        h3Var.setAlpha(1.0f - floatValue);
        h3Var.setTranslationY((-org.telegram.ui.ActionBar.k.getCurrentActionBarHeight()) * k3Var.f8432f0);
        float f7 = this.f8703b;
        float f10 = k3Var.f8433g0;
        float f11 = this.f8704c;
        a3Var.setTranslationY(AndroidUtilities.lerp(f7, f11, f10));
        a3Var.setTranslationX(AndroidUtilities.lerp(this.d, 0.0f, k3Var.f8433g0));
        k3Var.f8438l0.setTranslationX(AndroidUtilities.lerp(this.e, 0.0f, k3Var.f8433g0));
