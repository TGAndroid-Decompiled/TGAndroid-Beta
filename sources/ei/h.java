...
public final class h extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public h(Context context, f6 f6Var, zf.a aVar, boolean z10, Runnable runnable) {
        ...
        this.Y = v0Var;
        ((TextView) v0Var.f3911c).setText(LocaleController.formatString(R.string.TonNeededTitle, zf.a.i(aVar.f51655b - s5.y(this.currentAccount, true).s().f51655b, zf.b.f51657b).d()));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.starOptionsLoaded || i10 == NotificationCenter.starBalanceUpdated) {
            ...
            zf.a aVar = this.X;
            ((TextView) this.Y.f3911c).setText(LocaleController.formatString(i12, zf.a.i(aVar.f51655b - s10.f51655b, zf.b.f51657b).d()));
            xa xaVar = this.f24675e;
            if (xaVar != null) {
                xaVar.setTitle(y());
            }
            if (s10.f51655b >= aVar.f51655b && (runnable = this.f9157a0) != null) {
                runnable.run();
                this.f9157a0 = null;
                dismiss();
            }
    ...
    public final void show() {
        mk mkVar;
        if (s5.y(this.currentAccount, true).s().f51655b >= this.X.f51655b) {
