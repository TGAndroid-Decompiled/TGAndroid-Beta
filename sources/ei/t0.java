    ...
    public final void onDismiss(DialogInterface dialogInterface) {
        switch (this.f8617a) {
            ...
            case 2:
                ...
                return;
            case 3:
                ((Utilities.Callback) this.f8619c).run(Integer.valueOf(((org.telegram.ui.Components.r3) this.d).getValue() + (((org.telegram.ui.Components.p3) this.f8618b).getValue() * 60)));
                return;
            case 4:
            ...
            default:
                ...
                AndroidUtilities.requestAdjustResize((Activity) this.d, ((xh.s2) this.f8619c).f46437a.getClassGuid());
                return;
        }
    }
