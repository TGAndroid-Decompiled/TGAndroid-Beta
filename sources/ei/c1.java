        ...
        switch (this.f8277a) {
                        ...
                        public final boolean u(uy uyVar, ArrayList arrayList2, CharSequence charSequence, boolean z10, boolean z11, int i12, int i13, fg1 fg1Var) {
                            ...
                            while (i14 < size2) {
                                ...
                                if (!DialogObject.isEncryptedDialog(j10)) {
                                    ...
                                    hashMap.put("id", "" + tL_messages_preparedInlineMessage4.result.f18341id);
                                    hashMap.put("bot", "" + j3);
                                    long j12 = j10;
            ...
            default:
                ...
                if (e0Var.f47382s.W) {
                    ...
                    u5 x10 = u5.x(i12, e0Var.H.f49272a);
                    if (x10.e) {
                        aVar = zf.a.l(x10.p());
                    } else {
                        aVar = null;
                    }
                    if (!e0Var.f47378c && (aVar == null || aVar.f49273b < e0Var.H.f49273b)) {
                        zf.a aVar2 = e0Var.H;
                        zf.b bVar = aVar2.f49272a;
