...
public final class x0 implements SensorEventListener {
    ...
    public final void c() {
        switch (this.f8714a) {
            case 0:
                a1 a1Var = this.d;
                if (a1Var.f8219k != null && this.f8716c != null) {
                    this.f8715b = System.currentTimeMillis();
                    try {
                        JSONObject jSONObject = new JSONObject();
                        jSONObject.put("x", -this.f8716c[0]);
                        jSONObject.put("y", -this.f8716c[1]);
                        jSONObject.put("z", -this.f8716c[2]);
                ...
                return;
            default:
                float[] fArr = this.f8716c;
                a1 a1Var2 = this.d;
                if (a1Var2.f8219k != null) {
                    this.f8715b = System.currentTimeMillis();
                    try {
                        ...
                        org.telegram.ui.web.z0 z0Var2 = a1Var2.f8219k;
        ...
        switch (this.f8714a) {
            case 0:
                ...
                if (!a1Var.f8220l && a1Var.f8219k != null) {
                    ...
                    this.f8716c = sensorEvent.values;
                    long j3 = a1Var.f8214c;
            ...
            default:
                a1 a1Var2 = this.d;
                uc ucVar3 = a1Var2.f8223o;
                if (ucVar3 != null) {
                    AndroidUtilities.cancelRunOnUIThread(ucVar3);
                    a1Var2.f8223o = null;
                }
                if (!a1Var2.f8220l && a1Var2.f8219k != null) {
                    float[] fArr = this.f8716c;
                    float f7 = fArr[0];
                    ...
                    long currentTimeMillis2 = System.currentTimeMillis() - this.f8715b;
                    long j10 = a1Var2.e;
                    if (currentTimeMillis2 < j10) {
                        uc ucVar4 = new uc(this, 10);
                        a1Var2.f8223o = ucVar4;
