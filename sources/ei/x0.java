...
public final class x0 implements SensorEventListener {
    ...
    public final void c() {
        switch (this.f8716a) {
            case 0:
                a1 a1Var = this.d;
                if (a1Var.f8221k != null && this.f8718c != null) {
                    this.f8717b = System.currentTimeMillis();
                    try {
                        JSONObject jSONObject = new JSONObject();
                        jSONObject.put("x", -this.f8718c[0]);
                        jSONObject.put("y", -this.f8718c[1]);
                        jSONObject.put("z", -this.f8718c[2]);
                ...
                return;
            default:
                float[] fArr = this.f8718c;
                a1 a1Var2 = this.d;
                if (a1Var2.f8221k != null) {
                    this.f8717b = System.currentTimeMillis();
                    try {
                        ...
                        org.telegram.ui.web.z0 z0Var2 = a1Var2.f8221k;
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        switch (this.f8716a) {
            case 0:
                a1 a1Var = this.d;
                uc ucVar = a1Var.f8223m;
                if (ucVar != null) {
                    AndroidUtilities.cancelRunOnUIThread(ucVar);
                    a1Var.f8223m = null;
                }
                if (!a1Var.f8222l && a1Var.f8221k != null) {
                    long currentTimeMillis = System.currentTimeMillis() - this.f8717b;
                    this.f8718c = sensorEvent.values;
                    long j3 = a1Var.f8216c;
            ...
            default:
                a1 a1Var2 = this.d;
                uc ucVar3 = a1Var2.f8225o;
                if (ucVar3 != null) {
                    AndroidUtilities.cancelRunOnUIThread(ucVar3);
                    a1Var2.f8225o = null;
                }
                if (!a1Var2.f8222l && a1Var2.f8221k != null) {
                    float[] fArr = this.f8718c;
                    float f7 = fArr[0];
                    ...
                    long currentTimeMillis2 = System.currentTimeMillis() - this.f8717b;
                    long j10 = a1Var2.e;
                    if (currentTimeMillis2 < j10) {
                        uc ucVar4 = new uc(this, 10);
                        a1Var2.f8225o = ucVar4;
