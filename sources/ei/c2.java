...
public final class c2 {
    public final SparseIntArray f8277a = new SparseIntArray();
    public final SparseIntArray f8278b = new SparseIntArray();
    public final int[] f8279c = {i6.G6, i6.f19150u8, i6.G8, i6.E8, i6.F8, i6.I5, i6.Ii};
    public float d;

    public final int a(int i10) {
        return i0.a.d(this.d, this.f8277a.get(i10), this.f8278b.get(i10));
    }
    ...
    public final void c(SparseIntArray sparseIntArray, int i10, e6 e6Var) {
        ...
        while (i13 < iArr.length) {
            ...
            if (i15 != i6.G8 && i15 != i6.E8 && i15 != i6.F8 && i15 != (i12 = i6.I5)) {
                ...
                } else if (i15 != i6.f19150u8 && i15 != i12) {
