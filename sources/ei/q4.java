...
public final class q4 extends ni implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final boolean K() {
        ...
        if (this.S) {
            ...
            b2Var.show();
            ((TextView) b2Var.d(-1)).setTextColor(j6.v0(j6.f19348q7, this.f26785a));
            return false;
        }
        this.f26786b.dismiss();
        return true;
    }
    ...
    public final void L() {
        ...
        if ((n2Var instanceof zn) && ((zn) n2Var).X0.R() > AndroidUtilities.dp(20.0f)) {
            AndroidUtilities.hideKeyboard(viVar.f29096f0.getFragmentView());
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.webViewResultSent) {
            ...
            j4Var.f38888n.b(j6.v0(j6.f19180h5, this.f26785a), 153);
        }
    }
    ...
    public final void m() {
        ...
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = v0Var.f19812b;
    ...
    public final void t(int i10) {
        ...
        if (i10 == i11) {
            ...
            viVar.f29096f0.presentFragment(new zn(bundle));
            viVar.dismiss();
            return;
        }
        int i12 = 0;
        if (i10 == R.id.menu_reload_page) {
            ...
            xc xcVar = new xc(kb.a(getContext()), this.f26785a);
            long j3 = this.v;
            int i14 = c41.v;
    ...
    public final void w(int i10, boolean z10) {
        ...
        if (z10) {
            ...
            int R = this.f26786b.f29133r1.R() + i10;
