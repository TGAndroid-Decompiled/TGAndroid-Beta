...
public final class q4 extends oi implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final boolean K() {
        ...
        if (this.S) {
            ...
            a2Var.show();
            ((TextView) a2Var.d(-1)).setTextColor(h6.v0(h6.f19284q7, this.f27082a));
            return false;
        }
    ...
    public final void L() {
        ...
        if ((m2Var instanceof wn) && ((wn) m2Var).X0.R() > AndroidUtilities.dp(20.0f)) {
            AndroidUtilities.hideKeyboard(wiVar.f29985f0.getFragmentView());
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.webViewResultSent) {
            ...
            j4Var.f38998n.b(h6.v0(h6.f19115h5, this.f27082a), 153);
        }
    }
    ...
    public final void m() {
        ...
        ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = u0Var.f19774b;
    ...
    public final void t(int i10) {
        ...
        if (i10 == i11) {
            ...
            wiVar.f29985f0.presentFragment(new wn(bundle));
            wiVar.dismiss();
            return;
        }
        int i12 = 0;
        if (i10 == R.id.menu_reload_page) {
            ...
            yc ycVar = new yc(lb.a(getContext()), this.f27082a);
            long j3 = this.v;
            int i14 = t31.v;
    ...
    public final void w(int i10, boolean z10) {
        ...
        if (z10) {
            ...
            int R = this.f27083b.f30022r1.R() + i10;
