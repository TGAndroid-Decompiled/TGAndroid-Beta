...
public final class y0 implements SensorEventListener {
    ...
    public final void a() {
        if (this.f8740b != null && this.f8741c != null) {
            a1 a1Var = this.d;
            if (a1Var.f8219k != null) {
                this.f8739a = System.currentTimeMillis();
                float[] fArr = new float[9];
                if (SensorManager.getRotationMatrix(fArr, new float[9], this.f8740b, this.f8741c)) {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (!a1Var.f8220l && a1Var.f8219k != null) {
            ...
            if (sensorEvent.sensor.getType() == 2) {
                this.f8741c = sensorEvent.values;
            }
            long j3 = a1Var.h;
