...
public final class t1 {
        ...
        try {
            ...
            try {
                ...
                while (keys.hasNext()) {
                    ...
                    ?? obj = new Object();
                    obj.f8601a = next;
                    obj.f8602b = jSONObject2.getLong("user_id");
                    obj.f8603c = jSONObject2.getString("user_name");
    ...
    public static void k(HashMap hashMap) {
        try {
            ...
            for (Map.Entry entry : hashMap.entrySet()) {
                ...
                jSONObject2.put("user_id", ((s1) entry.getValue()).f8602b);
                jSONObject2.put("user_name", ((s1) entry.getValue()).f8603c);
    ...
    public final File c() {
        ...
        if (this.d && TextUtils.isEmpty(this.e)) {
            ...
            while (true) {
                ...
                if (((s1) entry.getValue()).f8602b == j3) {
            ...
            if (TextUtils.isEmpty(this.e)) {
                ...
                obj.f8601a = uuid;
                obj.f8602b = j3;
                obj.f8603c = DialogObject.getName(UserConfig.getInstance(this.f8618a).getCurrentUser());
    ...
    public final void j(String str) {
        ...
        if (!e(c()).keys().hasNext()) {
            ...
            if (s1Var != null) {
                s1Var.f8602b = this.f8620c;
                s1Var.f8603c = DialogObject.getName(UserConfig.getInstance(this.f8618a).getCurrentUser());
