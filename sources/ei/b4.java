...
public final class b4 extends FrameLayout {
    ...
    public b4(Context context, int i10, f6 f6Var) {
        ...
        this.d = view;
        view.setBackground(j6.K(AndroidUtilities.dp(11.0f), j6.v0(j6.f18863d6, f6Var)));
        ...
        h.setTextColor(j6.v0(j6.f19264z6, f6Var));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f8257s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), j6.f18985k0);
        }
    }
