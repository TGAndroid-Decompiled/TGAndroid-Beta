...
public final class b4 extends FrameLayout {
    ...
    public b4(Context context, int i10, d6 d6Var) {
        ...
        this.d = view;
        view.setBackground(h6.K(AndroidUtilities.dp(11.0f), h6.v0(h6.f19045d6, d6Var)));
        ...
        h.setTextColor(h6.v0(h6.f19447z6, d6Var));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f8239s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), h6.f19166k0);
        }
    }
