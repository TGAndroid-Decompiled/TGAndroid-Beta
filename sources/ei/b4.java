...
public final class b4 extends FrameLayout {
    ...
    public final e6 f8251b;
    public final w9 f8252c;
    public final View d;
    public final View e;
    ...
    public b4(Context context, int i10, e6 e6Var) {
        ...
        this.d = view;
        view.setBackground(j6.K(AndroidUtilities.dp(11.0f), j6.v0(j6.f19062d6, e6Var)));
        ...
        h.setTextColor(j6.v0(j6.f19464z6, e6Var));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f8256s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), j6.f19184k0);
        }
    }
