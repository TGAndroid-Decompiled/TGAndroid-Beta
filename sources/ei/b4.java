...
public final class b4 extends FrameLayout {
    ...
    public final f6 f8252b;
    public final u9 f8253c;
    public final View d;
    public final View e;
    public final ImageView f8254f;
    public final TextView h;
    public final TextView f8255n;
    public final ImageView f8256r;
    ...
    public b4(Context context, int i10, f6 f6Var) {
        ...
        this.d = view;
        view.setBackground(j6.K(AndroidUtilities.dp(11.0f), j6.v0(j6.f18862d6, f6Var)));
        ...
        h.setTextColor(j6.v0(j6.f19263z6, f6Var));
        linearLayout.addView(h, x5.t(-1, -2, 55, 6, 1, 24, 0));
        ImageView imageView2 = new ImageView(context);
        this.f8256r = imageView2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f8257s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), j6.f18984k0);
        }
    }
