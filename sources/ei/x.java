...
public abstract class x extends FrameLayout {
    ...
    public x(Context context, f6 f6Var) {
        ...
        a5.a aVar2 = this.e;
        int v02 = j6.v0(j6.f18863d6, f6Var);
        aVar2.f277b = v02;
        paint.setColor(v02);
    ...
    public static void b(m6 m6Var, w wVar, boolean z10) {
        ...
        if (wVar.f8694f != 0) {
            ...
            spannableStringBuilder.setSpan(new x5(wVar.f8694f, 1.4f, m6Var.f26069a.getFontMetricsInt()), 0, 1, 33);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        v[] vVarArr = this.f8716f;
        int i14 = 1;
        if (vVarArr[1].f8658b.f22940c < vVarArr[0].f8658b.f22940c) {
            i10 = 1;
        } else {
            i10 = 0;
        }
