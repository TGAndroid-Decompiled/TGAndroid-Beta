...
public final class r1 extends FrameLayout {
    ...
    public r1(s1 s1Var, boolean z10, Context context) {
        ...
        b10.setText(s1Var.f8603c);
        addView(b10, x5.t(-1, -2, 7, 62, 9, 8, 0));
        TextView b11 = b6.b(context, 14.0f, i6.f19215y6, false, null);
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f8587c) {
            canvas.drawLine(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, i6.f18955k0);
        }
    }
}
