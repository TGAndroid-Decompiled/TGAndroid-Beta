...
public final class r1 extends FrameLayout {
    ...
    public r1(s1 s1Var, boolean z10, Context context) {
        ...
        TextView b11 = d6.b(context, 14.0f, j6.f19477y6, false, null);
    ...
    public final void onDraw(Canvas canvas) {
        if (this.f8590c) {
            canvas.drawLine(AndroidUtilities.dp(62.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, j6.f19216k0);
        }
    }
}
