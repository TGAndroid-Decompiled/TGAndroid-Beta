...
public final class e1 implements Runnable {
    public final int f8307a = 0;
    public final TLObject f8308b;
    public final int f8309c;
    public final long d;
    public final Object e;
    public final Object f8310f;
    public final Object h;
    public final Object f8311n;
    public final Object f8312r;
    ...
    public final void run() {
        ...
        switch (this.f8307a) {
            case 0:
                ...
                Context context = (Context) this.f8310f;
                e6 e6Var = (e6) this.h;
                org.telegram.ui.web.t tVar = (org.telegram.ui.web.t) this.f8311n;
                org.telegram.tgnet.e eVar = (org.telegram.tgnet.e) this.f8312r;
                TLObject tLObject2 = this.f8308b;
            ...
            default:
                ...
                String str3 = (String) this.f8310f;
                String str4 = (String) this.h;
                final TLRPC.User user = (TLRPC.User) this.f8311n;
                final String str5 = (String) this.f8312r;
                ArrayList arrayList = launchActivity.f30821f0;
                ArrayList arrayList2 = launchActivity.f30817d0;
                ArrayList arrayList3 = launchActivity.E0;
                TLObject tLObject3 = this.f8308b;
                    ...
                    if (!tL_attachMenuBot.inactive) {
                        if (uyVar != null) {
                            ...
                            if (!MediaDataController.canShowAttachMenuBot(tL_attachMenuBot, tLObject)) {
                                ...
                                boVar.W9(user.f18256id, str5, false);
                                return;
                            }
                        } else {
                            a02 = vc.a0(n2Var);
                        ...
                        u6Var.setColor(i6.w0(null, i6.f18927ia, false));
