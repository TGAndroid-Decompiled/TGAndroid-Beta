...
public final class b implements RequestDelegate {
    ...
    public final org.telegram.ui.ActionBar.b2 f8241c;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f8239a) {
            case 0:
                ...
                final org.telegram.ui.ActionBar.b2 b2Var = this.f8241c;
            ...
            default:
                ...
                final org.telegram.ui.ActionBar.b2 b2Var2 = this.f8241c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
