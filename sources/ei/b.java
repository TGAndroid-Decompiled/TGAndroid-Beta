...
public final class b implements RequestDelegate {
    ...
    public final l f8235b;
    public final org.telegram.ui.ActionBar.b2 f8236c;
    ...
    public final void run(final TLObject tLObject, final TLRPC.TL_error tL_error) {
        switch (this.f8234a) {
            case 0:
                final l lVar = this.f8235b;
                final org.telegram.ui.ActionBar.b2 b2Var = this.f8236c;
                ...
                return;
            default:
                final l lVar2 = this.f8235b;
                final org.telegram.ui.ActionBar.b2 b2Var2 = this.f8236c;
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public final void run() {
                        switch (r5) {
