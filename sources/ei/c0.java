...
public final class c0 extends View {
    ...
    public c0(Context context) {
        ...
        this.E = true;
        paint.setColor(j6.w0(null, j6.f19052cf, false));
        int w02 = j6.w0(null, j6.f19088ef, false);
        zVar.f18799k = w02;
        zVar.f18798j = w02;
        ...
        zVar.f18792a.setStrokeCap(Paint.Cap.ROUND);
        zVar.f18800l = true;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.f8270f) {
            dp = org.telegram.messenger.q.D(4.0f, (int) this.f8273s, dp);
        }
