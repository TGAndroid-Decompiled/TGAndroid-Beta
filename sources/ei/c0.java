...
public final class c0 extends View {
    public boolean E;
    public int F;
    public final RectF f8265a;
    public final Paint f8266b;
    public final TextPaint f8267c;
    public final z d;
    public final xi0 e;
    public boolean f8268f;
    public float h;
    public String f8269n;
    public StaticLayout f8270r;
    public float f8271s;
    public boolean v;
    public boolean f8272w;
    public boolean f8273x;
    public final org.telegram.ui.Cells.z f8274y;

    public c0(Context context) {
        super(context);
        this.f8265a = new RectF();
        Paint paint = new Paint(1);
        this.f8266b = paint;
        TextPaint textPaint = new TextPaint(1);
        this.f8267c = textPaint;
        z zVar = new z(this);
        this.d = zVar;
        xi0 xi0Var = new xi0(R.raw.bot_webview_sheet_to_cross, AndroidUtilities.dp(20.0f), AndroidUtilities.dp(20.0f));
        this.e = xi0Var;
        this.f8269n = LocaleController.getString(R.string.BotsMenuTitle);
        this.E = true;
        paint.setColor(i6.w0(null, i6.f18824cf, false));
        int w02 = i6.w0(null, i6.f18860ef, false);
        zVar.f18612k = w02;
        zVar.f18611j = w02;
        ...
        zVar.f18605a.setStrokeCap(Paint.Cap.ROUND);
        zVar.f18613l = true;
    ...
    public final void drawableStateChanged() {
        ...
        this.f8274y.setState(getDrawableState());
    }

    @Override
    public final void jumpDrawablesToCurrentState() {
        super.jumpDrawablesToCurrentState();
        this.f8274y.jumpToCurrentState();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.F != size || this.f8270r == null) {
            this.d.setBounds(0, 0, getMeasuredWidth(), getMeasuredHeight());
            TextPaint textPaint = this.f8267c;
            textPaint.setTextSize(AndroidUtilities.dp(15.0f));
            this.F = size;
            CharSequence replaceEmoji = Emoji.replaceEmoji(this.f8269n, textPaint.getFontMetricsInt(), false);
        ...
        if (this.f8268f) {
            dp = org.telegram.messenger.y0.C(4.0f, (int) this.f8271s, dp);
        }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && this.f8274y != drawable) {
            return false;
        }
        return true;
    }
