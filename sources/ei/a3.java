...
public final class a3 extends p4 {
    public final int f8234c0;
    public final Object f8235d0;
        ...
        switch (this.f8234c0) {
            case 0:
                ...
                if (frameLayout != null) {
                    ...
                    int i10 = k3Var.h.top;
                    frameLayout.setTranslationY(k3Var.v.getTranslationY() + AndroidUtilities.lerp(currentActionBarHeight, AndroidUtilities.dp(70.0f) + i10, k3Var.f8435f0));
                    return;
                }
                return;
            default:
