...
public final class p0 extends p implements n0 {
    ...
    public int f40901k;
    public m0 f40902l;
    public final r0 f40904n;
    public int f40900j = -1;
    public int f40903m = -1;
    ...
    public final void a(m0 m0Var) {
        ...
        bundle.putString("memberRouteId", this.f40897f);
        m0Var.b(11, i11, i10, null, bundle);
        m0Var.h.put(i11, o0Var);
        this.f40903m = i10;
        if (this.f40899i) {
            m0Var.a(i10);
            int i12 = this.f40900j;
            if (i12 >= 0) {
                m0Var.c(this.f40903m, i12);
                this.f40900j = -1;
            }
            int i13 = this.f40901k;
            if (i13 != 0) {
                m0Var.d(this.f40903m, i13);
                this.f40901k = 0;
            }
        }
    }
    ...
    @Override
    public final void c() {
        m0 m0Var = this.f40902l;
        if (m0Var != null) {
            int i10 = this.f40903m;
            int i11 = m0Var.d;
            m0Var.d = i11 + 1;
