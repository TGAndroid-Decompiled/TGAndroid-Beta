...
public final class p0 extends p implements n0 {
    ...
    public int f40927k;
    public m0 f40928l;
    public final r0 f40930n;
    public int f40926j = -1;
    public int f40929m = -1;
    ...
    public final void a(m0 m0Var) {
        ...
        bundle.putString("memberRouteId", this.f40923f);
        m0Var.b(11, i11, i10, null, bundle);
        m0Var.h.put(i11, o0Var);
        this.f40929m = i10;
        if (this.f40925i) {
            m0Var.a(i10);
            int i12 = this.f40926j;
            if (i12 >= 0) {
                m0Var.c(this.f40929m, i12);
                this.f40926j = -1;
            }
            int i13 = this.f40927k;
            if (i13 != 0) {
                m0Var.d(this.f40929m, i13);
                this.f40927k = 0;
            }
        }
    }
    ...
    @Override
    public final void c() {
        m0 m0Var = this.f40928l;
        if (m0Var != null) {
            int i10 = this.f40929m;
            int i11 = m0Var.d;
            m0Var.d = i11 + 1;
