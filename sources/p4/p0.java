...
public final class p0 extends p implements n0 {
    ...
    public int f40584k;
    public m0 f40585l;
    public final r0 f40587n;
    public int f40583j = -1;
    public int f40586m = -1;
    ...
    public final void a(m0 m0Var) {
        ...
        bundle.putString("memberRouteId", this.f40580f);
        m0Var.b(11, i11, i10, null, bundle);
        m0Var.h.put(i11, o0Var);
        this.f40586m = i10;
        if (this.f40582i) {
            m0Var.a(i10);
            int i12 = this.f40583j;
            if (i12 >= 0) {
                m0Var.c(this.f40586m, i12);
                this.f40583j = -1;
            }
            int i13 = this.f40584k;
            if (i13 != 0) {
                m0Var.d(this.f40586m, i13);
                this.f40584k = 0;
            }
        }
    }
    ...
    @Override
    public final void c() {
        m0 m0Var = this.f40585l;
        if (m0Var != null) {
            int i10 = this.f40586m;
            int i11 = m0Var.d;
            m0Var.d = i11 + 1;
