...
public class j0 extends k0 implements b0 {
    ...
    public final e f40851r;
    public final MediaRouter f40852s;
    public final a0 v;
    public final MediaRouter.VolumeCallback f40853w;
    public final MediaRouter.RouteCategory f40854x;
    public int f40855y;
    ...
    public j0(Context context, e eVar) {
        ...
        this.f40852s = mediaRouter;
        this.v = new a0(this);
        this.f40853w = d0.a(this);
        this.f40854x = mediaRouter.createRouteCategory((CharSequence) context.getResources().getString(2131689666), false);
        B();
    }
    ...
    public void A() {
        boolean z10 = this.F;
        a0 a0Var = this.v;
        MediaRouter mediaRouter = this.f40852s;
        if (z10) {
            mediaRouter.removeCallback(a0Var);
        }
        this.F = true;
        mediaRouter.addCallback(this.f40855y, a0Var, (this.E ? 1 : 0) | 2);
    }
    ...
    public void C(i0 i0Var) {
        int i10;
        MediaRouter.UserRouteInfo userRouteInfo = i0Var.f40849b;
        v vVar = i0Var.f40848a;
        userRouteInfo.setName(vVar.d);
        userRouteInfo.setPlaybackType(vVar.f40924l);
        userRouteInfo.setPlaybackStream(vVar.f40925m);
        userRouteInfo.setVolume(vVar.f40928p);
        userRouteInfo.setVolumeMax(vVar.f40929q);
        if (vVar.e() && !x.g()) {
            i10 = 0;
        } else {
            i10 = vVar.f40927o;
    ...
    public final q d(String str) {
        int p5 = p(str);
        if (p5 >= 0) {
            return new g0(((h0) this.G.get(p5)).f40843a);
        }
        return null;
    }
    ...
    public final void f(n nVar) {
        ...
        if (this.f40855y == i10 && this.E == z10) {
            return;
        }
        this.f40855y = i10;
        this.E = z10;
    ...
    public final int o(MediaRouter.RouteInfo routeInfo) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (((h0) arrayList.get(i10)).f40843a == routeInfo) {
                return i10;
            }
        }
        return -1;
    ...
    public final int p(String str) {
        ...
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (((h0) arrayList.get(i10)).f40844b.equals(str)) {
                return i10;
            }
        }
        return -1;
    ...
    public final int q(v vVar) {
        ...
        int size = arrayList.size();
        for (int i10 = 0; i10 < size; i10++) {
            if (((i0) arrayList.get(i10)).f40848a == vVar) {
                return i10;
            }
        }
        return -1;
    ...
    public MediaRouter.RouteInfo r() {
        return this.f40852s.getDefaultRoute();
    }

    public boolean t(h0 h0Var) {
        return h0Var.f40843a.isConnecting();
    }

    public void u(h0 h0Var, l lVar) {
        boolean z10;
        MediaRouter.RouteInfo routeInfo = h0Var.f40843a;
        ...
        Bundle bundle = lVar.f40861a;
        Bundle bundle2 = lVar.f40861a;
    ...
    public final void v(v vVar) {
        ...
        MediaRouter mediaRouter = this.f40852s;
        if (c10 != this) {
            MediaRouter.UserRouteInfo createUserRoute = mediaRouter.createUserRoute(this.f40854x);
            i0 i0Var = new i0(vVar, createUserRoute);
            createUserRoute.setTag(i0Var);
            createUserRoute.setVolumeCallback(this.f40853w);
            C(i0Var);
            this.H.add(i0Var);
        ...
        if (o9 >= 0 && ((h0) this.G.get(o9)).f40844b.equals(vVar.f40917b)) {
            vVar.l();
        }
    }
    ...
    public final void w(v vVar) {
        ...
        if (vVar.c() != this && (q6 = q(vVar)) >= 0) {
            MediaRouter.UserRouteInfo userRouteInfo = ((i0) this.H.remove(q6)).f40849b;
            userRouteInfo.setTag(null);
            userRouteInfo.setVolumeCallback(null);
            try {
                this.f40852s.removeUserRoute(userRouteInfo);
    ...
    public final void x(v vVar) {
        if (vVar.g()) {
            if (vVar.c() != this) {
                int q6 = q(vVar);
                if (q6 >= 0) {
                    z(((i0) this.H.get(q6)).f40849b);
                    return;
                }
                return;
            }
            int p5 = p(vVar.f40917b);
            if (p5 >= 0) {
                z(((h0) this.G.get(p5)).f40843a);
            }
        }
    }
    ...
    public final void y() {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            m mVar = ((h0) arrayList2.get(i10)).f40845c;
            if (mVar != null) {
    ...
    public void z(MediaRouter.RouteInfo routeInfo) {
        this.f40852s.selectRoute(8388611, routeInfo);
    }
}
