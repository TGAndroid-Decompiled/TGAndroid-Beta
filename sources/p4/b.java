...
public final class b extends Handler {
    ...
    public final ArrayList f40568b = new ArrayList();
    public final e f40569c;
    ...
    public static void a(t tVar, int i10, Object obj, int i11) {
        ...
        if (i10 != 264 && i10 != 262) {
            ...
            vVar = (v) ((q0.b) obj).f41098b;
        }
        if (i10 != 264 && i10 != 262) {
            vVar2 = null;
        } else {
            vVar2 = (v) ((q0.b) obj).f41097a;
        }
        if (vVar != null) {
            boolean z11 = true;
            if ((tVar.d & 2) == 0 && !vVar.h(tVar.f40679c)) {
                z zVar = x.c().f40591u;
                if (zVar == null) {
                    z10 = false;
                } else {
    ...
    public final void handleMessage(Message message) {
        ...
        e eVar = this.f40569c;
        ArrayList arrayList2 = eVar.f40579i;
        j0 j0Var = eVar.f40589s;
        int i10 = message.what;
        Object obj = message.obj;
        int i11 = message.arg1;
        if (i10 == 259 && eVar.e().f40687c.equals(((v) obj).f40687c)) {
            eVar.o(true);
        }
        int i12 = 0;
        ArrayList arrayList3 = this.f40568b;
        if (i10 != 262) {
            if (i10 != 264) {
                switch (i10) {
                    case 257:
                ...
                v vVar2 = (v) ((q0.b) obj).f41098b;
                arrayList3.add(vVar2);
                j0Var.v(vVar2);
                j0Var.x(vVar2);
            }
        } else {
            v vVar3 = (v) ((q0.b) obj).f41098b;
            j0Var.x(vVar3);
