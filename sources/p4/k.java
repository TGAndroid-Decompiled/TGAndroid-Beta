...
public final class k extends h3 {
    ...
    public final MediaRouter2 f43884r;
    public final mg.n f43885s;
    public final ArrayMap v;
    public final MediaRouter2.RouteCallback f43886w;
    public final j f43887x;
    public final f f43888y;
    ...
    public k(Context context, mg.n nVar) {
        super(context, null);
        this.v = new ArrayMap();
        this.f43887x = new j(this);
        this.f43888y = new f(this);
        this.F = new ArrayList();
        this.G = new ArrayMap();
        this.f43884r = MediaRouter2.getInstance(context);
        this.f43885s = nVar;
        this.E = new k2.a0(new Handler(Looper.getMainLooper()), 0);
        if (Build.VERSION.SDK_INT >= 34) {
            this.f43886w = new i(this, 1);
        } else {
            this.f43886w = new i(this, 0);
        }
    }
    ...
    public static String p(q qVar) {
        ...
        if (!(qVar instanceof g) || (routingController = ((g) qVar).f43859g) == null) {
            return null;
        }
    ...
    public final p c(String str) {
        for (Map.Entry entry : this.v.entrySet()) {
            ...
            if (TextUtils.equals(str, gVar.f43858f)) {
                return gVar;
            }
        }
        return null;
    ...
    public final void f(n nVar) {
        ...
        if (i10 > 0) {
            ...
            if (rVar != null) {
                ...
                bundle2.putBundle("selector", rVar.f43928a);
                bundle2.putBoolean("activeScan", b10);
                MediaRouter2 mediaRouter2 = this.f43884r;
                MediaRouter2.RouteCallback routeCallback = this.f43886w;
                rVar.a();
                if (rVar.f43929b.contains(null)) {
                ...
                this.f43884r.registerTransferCallback(a0Var, jVar);
                this.f43884r.registerControllerCallback(a0Var, fVar);
                return;
            }
            throw new IllegalArgumentException("selector must not be null");
        }
        this.f43884r.unregisterRouteCallback(this.f43886w);
        this.f43884r.unregisterTransferCallback(jVar);
        this.f43884r.unregisterControllerCallback(fVar);
    }
    ...
    public final void q() {
        ...
        for (MediaRoute2Info mediaRoute2Info : this.f43884r.getRoutes()) {
    ...
    public final void r(MediaRouter2.RoutingController routingController) {
        ...
        Bundle controlHints = routingController.getControlHints();
        String string = this.f5992a.getString(2131689662);
        m mVar = null;
        if (controlHints != null) {
            try {
        ...
        lVar.f43891c.clear();
        lVar.a(w10.b());
        ArrayList arrayList = lVar.f43890b;
        arrayList.clear();
        if (!h.isEmpty()) {
            int size = h.size();
            while (i11 < size) {
