...
public final class k extends h3 {
    ...
    public final MediaRouter2 f40554r;
    public final ja f40555s;
    public final ArrayMap v;
    public final MediaRouter2.RouteCallback f40556w;
    public final j f40557x;
    public final f f40558y;
    ...
    public k(Context context, ja jaVar) {
        super(context, null);
        this.v = new ArrayMap();
        this.f40557x = new j(this);
        this.f40558y = new f(this);
        this.F = new ArrayList();
        this.G = new ArrayMap();
        this.f40554r = MediaRouter2.getInstance(context);
        this.f40555s = jaVar;
        this.E = new k2.c0(new Handler(Looper.getMainLooper()), 0);
        if (Build.VERSION.SDK_INT >= 34) {
            this.f40556w = new i(this, 1);
        } else {
            this.f40556w = new i(this, 0);
        }
    }
    ...
    public static String p(q qVar) {
        ...
        if (!(qVar instanceof g) || (routingController = ((g) qVar).f40529g) == null) {
            return null;
        }
    ...
    public final p c(String str) {
        for (Map.Entry entry : this.v.entrySet()) {
            ...
            if (TextUtils.equals(str, gVar.f40528f)) {
                return gVar;
            }
        }
        return null;
    ...
    public final void f(n nVar) {
        ...
        if (i10 > 0) {
            ...
            if (rVar != null) {
                ...
                bundle2.putBundle("selector", rVar.f40594a);
                bundle2.putBoolean("activeScan", b10);
                MediaRouter2 mediaRouter2 = this.f40554r;
                MediaRouter2.RouteCallback routeCallback = this.f40556w;
                rVar.a();
                if (rVar.f40595b.contains(null)) {
                ...
                this.f40554r.registerTransferCallback(c0Var, jVar);
                this.f40554r.registerControllerCallback(c0Var, fVar);
                return;
            }
            throw new IllegalArgumentException("selector must not be null");
        }
        this.f40554r.unregisterRouteCallback(this.f40556w);
        this.f40554r.unregisterTransferCallback(jVar);
        this.f40554r.unregisterControllerCallback(fVar);
    }
    ...
    public final void q() {
        ...
        for (MediaRoute2Info mediaRoute2Info : this.f40554r.getRoutes()) {
            MediaRoute2Info c10 = rs.c(mediaRoute2Info);
    ...
    public final void r(MediaRouter2.RoutingController routingController) {
        ...
        lVar.f40561c.clear();
        lVar.a(w10.b());
        ArrayList arrayList = lVar.f40560b;
        arrayList.clear();
        if (!h.isEmpty()) {
            int size = h.size();
            while (i11 < size) {
