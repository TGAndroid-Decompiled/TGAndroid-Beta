...
public final class v {
    ...
    public int f43964p;
    public int f43965q;
    public Bundle f43967s;
    public IntentSender f43968t;
    public m f43969u;
    public a0.f f43970w;
    public final ArrayList f43959k = new ArrayList();
    public int f43966r = -1;
    ...
    public final mg.n b(v vVar) {
        if (vVar != null) {
            String str = vVar.f43953c;
            a0.f fVar = this.f43970w;
            if (fVar != null && fVar.containsKey(str)) {
                return new mg.n((o) this.f43970w.get(str), 11);
            }
            return null;
        }
    ...
    public final boolean f() {
        if (this.f43969u != null && this.f43956g) {
            return true;
        }
        return false;
    }
    ...
    public final boolean h(r rVar) {
        if (rVar != null) {
            x.b();
            ArrayList arrayList = this.f43959k;
            if (arrayList != null) {
                rVar.a();
                if (!rVar.f43929b.isEmpty()) {
    ...
    public final void j(int i10) {
        ...
        x.b();
        e c10 = x.c();
        int min = Math.min(this.f43965q, Math.max(0, i10));
        HashMap hashMap = c10.f43833b;
        if (this == c10.d && (qVar2 = c10.f43835e) != null) {
            qVar2.f(min);
        } else if (!hashMap.isEmpty() && (qVar = (q) hashMap.get(this.f43953c)) != null) {
            qVar.f(min);
        }
    }
    ...
    public final void n(Collection collection) {
        ...
        if (this.f43970w == null) {
            this.f43970w = new a0.l(0);
        }
        this.f43970w.clear();
        Iterator it = collection.iterator();
        while (it.hasNext()) {
            o oVar = (o) it.next();
            v a2 = this.f43951a.a(oVar.f43904a.d());
            if (a2 != null) {
                this.f43970w.put(a2.f43953c, oVar);
                int i10 = oVar.f43905b;
                if (i10 == 2 || i10 == 3) {
                    this.v.add(a2);
                }
            }
        }
        x.c().f43832a.b(259, this);
    }
    ...
    public final String toString() {
        ...
        sb2.append(((ComponentName) this.f43951a.d.f14247b).getPackageName());
        if (e()) {
            sb2.append(", members=[");
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (this.v.get(i10) != this) {
                    sb2.append(((v) this.v.get(i10)).f43953c);
                }
            }
            sb2.append(']');
        }
