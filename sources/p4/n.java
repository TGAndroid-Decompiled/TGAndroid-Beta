...
public abstract class n extends s {
    ...
    public final List f45585f;
    public final long f45586g;
    public final long h;
    public final long f45587i;
    ...
    public final long b(long j10, long j11) {
        ...
        return (int) (f((j11 - this.h) + this.f45587i, j10) - c(j10, j11));
    }
    ...
    public final long e(long j10, long j11) {
        long j12 = this.f45596b;
        long j13 = this.d;
        List list = this.f45585f;
        if (list != null) {
            return (((q) list.get((int) (j10 - j13))).f45593b * 1000000) / j12;
        }
        long d = d(j11);
        if (d != -1 && j10 == (j13 + d) - 1) {
            return j11 - g(j10);
        }
        return (this.f45584e * 1000000) / j12;
    }
    ...
    public final long f(long j10, long j11) {
        ...
        if (d != 0) {
            if (this.f45585f == null) {
                long j13 = (j10 / ((this.f45584e * 1000000) / this.f45596b)) + j12;
                if (j13 >= j12) {
                    if (d == -1) {
                        return j13;
                    }
    ...
    public final long g(long j10) {
        ...
        List list = this.f45585f;
        if (list != null) {
            j11 = ((q) list.get((int) (j10 - j12))).f45592a - this.f45597c;
        } else {
            j11 = (j10 - j12) * this.f45584e;
        }
        return d0.O(j11, 1000000L, this.f45596b);
    }
