...
public final class m {
    ...
    public final String d() {
        return this.f40880a.getString("id");
    }

    public final boolean e() {
        if (!TextUtils.isEmpty(d()) && !TextUtils.isEmpty(this.f40880a.getString("name")) && !b().contains(null)) {
            return true;
        }
        return false;
    }
