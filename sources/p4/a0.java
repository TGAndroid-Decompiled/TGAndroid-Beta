...
public final class a0 extends MediaRouter.Callback {
    ...
    public final void onRouteChanged(MediaRouter mediaRouter, MediaRouter.RouteInfo routeInfo) {
        ...
        if (j0.s(routeInfo) == null && (o9 = j0Var.o(routeInfo)) >= 0) {
            ...
            String str2 = h0Var.f40858b;
            CharSequence name = h0Var.f40857a.getName(j0Var.f6940a);
            if (name != null) {
                str = name.toString();
            } else {
                str = "";
    ...
    public final void onRoutePresentationDisplayChanged(MediaRouter mediaRouter, MediaRouter.RouteInfo routeInfo) {
        ...
        if (o9 >= 0) {
            ...
            if (i10 != h0Var.f40859c.f40880a.getInt("presentationDisplayId", -1)) {
                m mVar = h0Var.f40859c;
                new ArrayList();
                new ArrayList();
                new HashSet();
                if (mVar != null) {
                    Bundle bundle = new Bundle(mVar.f40880a);
    ...
    public final void onRouteSelected(MediaRouter mediaRouter, int i10, MediaRouter.RouteInfo routeInfo) {
        v a2;
        j0 j0Var = this.f40811a;
        if (routeInfo == j0Var.f40866s.getSelectedRoute(8388611)) {
            ...
            int o9 = j0Var.o(routeInfo);
            if (o9 >= 0) {
                e eVar = j0Var.f40865r;
                String str = ((h0) j0Var.G.get(o9)).f40858b;
                eVar.f40819a.removeMessages(262);
                u d = eVar.d(eVar.f40834s);
    ...
    public final void onRouteVolumeChanged(MediaRouter mediaRouter, MediaRouter.RouteInfo routeInfo) {
        ...
        if (j0.s(routeInfo) == null && (o9 = j0Var.o(routeInfo)) >= 0) {
            ...
            if (volume != h0Var.f40859c.f40880a.getInt("volume")) {
                m mVar = h0Var.f40859c;
                new ArrayList();
                new ArrayList();
                new HashSet();
