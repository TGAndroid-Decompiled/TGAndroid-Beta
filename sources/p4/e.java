...
public final class e extends DefaultHandler implements s0 {
    public static final Pattern f45556b = Pattern.compile("(\\d+)(?:/(\\d+))?");
    public static final Pattern f45557c = Pattern.compile("CC([1-4])=.*");
    public static final Pattern d = Pattern.compile("([1-9]|[1-5][0-9]|6[0-3])=.*");
    public static final int[] f45558e = {-1, 1, 2, 3, 4, 5, 6, 8, 2, 3, 4, 7, 8, 24, 8, 12, 10, 12, 14, 12, 14};
    public final XmlPullParserFactory f45559a;

    public e() {
        try {
            this.f45559a = XmlPullParserFactory.newInstance();
    ...
    public static int c(org.xmlpull.v1.XmlPullParser r9) {
        throw new UnsupportedOperationException("Method not decompiled: p4.e.c(org.xmlpull.v1.XmlPullParser):int");
    }
    ...
    public static ArrayList f(XmlPullParser xmlPullParser, ArrayList arrayList, boolean z10) {
        ...
        if (str2 != null && f5.a.u(str2)[0] != -1) {
            if (attributeValue3 == null) {
                attributeValue3 = str2;
            }
            return q8.l.k(new b(i10, i11, str2, attributeValue3));
        }
        ArrayList arrayList2 = new ArrayList();
        for (int i12 = 0; i12 < arrayList.size(); i12++) {
            b bVar = (b) arrayList.get(i12);
            String G = f5.a.G(bVar.f45536a, str2);
            if (attributeValue3 == null) {
                str = G;
            } else {
                str = attributeValue3;
    ...
    public static android.util.Pair g(org.xmlpull.v1.XmlPullParser r13) {
        throw new UnsupportedOperationException("Method not decompiled: p4.e.g(org.xmlpull.v1.XmlPullParser):android.util.Pair");
    }
    ...
    public static float k(XmlPullParser xmlPullParser, float f9) {
        ...
        if (attributeValue != null) {
            Matcher matcher = f45556b.matcher(attributeValue);
            if (matcher.matches()) {
    ...
    public static p4.c l(org.xmlpull.v1.XmlPullParser r156, android.net.Uri r157) {
        throw new UnsupportedOperationException("Method not decompiled: p4.e.l(org.xmlpull.v1.XmlPullParser, android.net.Uri):p4.c");
    }
    ...
    public static int o(ArrayList arrayList) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (n6.a("http://dashif.org/guidelines/trickmode", ((f) arrayList.get(i11)).f45560a)) {
                i10 = 16384;
            }
        }
        return i10;
    ...
    public static o q(XmlPullParser xmlPullParser, o oVar, long j10, long j11, long j12, long j13, long j14) {
        ...
        return new o(jVar, j21, j22, j24, j23, list2, j19, list, d0.H(j14), d0.H(j10));
    }
    ...
    public static p r(XmlPullParser xmlPullParser, p pVar, List list, long j10, long j11, long j12, long j13, long j14) {
        ...
        while (true) {
            if (i10 < list.size()) {
                ...
                if (n6.a("http://dashif.org/guidelines/last-segment-number", fVar.f45560a)) {
                    j18 = Long.parseLong(fVar.f45561b);
                    break;
                }
                i10++;
            } else {
        ...
        v5.l t10 = t(xmlPullParser, "media", lVar);
        if (pVar != null) {
            lVar2 = pVar.f45589j;
        } else {
            lVar2 = null;
        }
        v5.l t11 = t(xmlPullParser, "initialization", lVar2);
        List list2 = null;
        do {
            xmlPullParser.next();
            if (f5.a.z(xmlPullParser, "Initialization")) {
        ...
        return new p(jVar, j22, j23, j25, j26, j24, list2, j20, t11, t10, d0.H(j14), d0.H(j10));
    }
    ...
    public final Object d(Uri uri, com.google.android.exoplayer2.upstream.o oVar) {
        try {
            XmlPullParser newPullParser = this.f45559a.newPullParser();
