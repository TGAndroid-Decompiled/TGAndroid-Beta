...
public final class d extends b {
    public static final Logger f14999m = Logger.getLogger(d.class.getName());
    public int d;
    public int e;
    public int f15000f;
    public int f15001g;
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        this.e = a10 >>> 2;
        this.f15000f = (a10 >> 1) & 1;
        this.f15001g = e5.b.a(byteBuffer.get()) + (e5.b.h(byteBuffer) << 8);
        this.h = e5.b.i(byteBuffer);
        this.f15002i = e5.b.i(byteBuffer);
        int remaining = byteBuffer.remaining();
        Logger logger = f14999m;
        if (remaining > 2) {
