...
public final class d extends b {
    public static final Logger f14778m = Logger.getLogger(d.class.getName());
    public int d;
    public int e;
    public int f14779f;
    public int f14780g;
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        this.e = a10 >>> 2;
        this.f14779f = (a10 >> 1) & 1;
        this.f14780g = e5.b.a(byteBuffer.get()) + (e5.b.h(byteBuffer) << 8);
        this.h = e5.b.i(byteBuffer);
        this.f14781i = e5.b.i(byteBuffer);
        int remaining = byteBuffer.remaining();
        Logger logger = f14778m;
        if (remaining > 2) {
