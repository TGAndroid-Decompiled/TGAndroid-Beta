...
public final class d extends b {
    public static final Logger f14753m = Logger.getLogger(d.class.getName());
    public int d;
    public int e;
    public int f14754f;
    public int f14755g;
    ...
    public final void b(ByteBuffer byteBuffer) {
        ...
        this.e = a10 >>> 2;
        this.f14754f = (a10 >> 1) & 1;
        this.f14755g = e5.b.a(byteBuffer.get()) + (e5.b.h(byteBuffer) << 8);
        this.h = e5.b.i(byteBuffer);
        this.f14756i = e5.b.i(byteBuffer);
        int remaining = byteBuffer.remaining();
        Logger logger = f14753m;
        if (remaining > 2) {
    ...
    public final String toString() {
        ...
        sb2.append(this.f14757j);
        sb2.append(", configDescriptorDeadBytes=");
        byte[] bArr = this.f14759l;
        if (bArr == null) {
            bArr = new byte[0];
        }
        sb2.append(e5.b.c(0, bArr));
        sb2.append(", profileLevelIndicationDescriptors=");
        ArrayList arrayList = this.f14758k;
        if (arrayList == null) {
            obj = "null";
        } else {
