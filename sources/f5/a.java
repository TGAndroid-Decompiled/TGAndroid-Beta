...
public abstract class a {
    public static final byte[] f6558a = {0, 0, 0, 1};
    public static final String[] f6559b = {"", "A", "B", "C"};
    public static final Object f6560c = new Object();
    public static final byte[] d = {0, 0, 0, 1};
    public static final float[] f6561e = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};
    public static final Object f6562f = new Object();
    public static int[] f6563g = new int[10];
    public static final Object h = new Object();
    public static final Object f6564i = new Object();
    public static boolean f6565j;
    public static long f6566k;
    ...
    public static p B(int i10, int i11, byte[] bArr) {
        ...
        while (i36 < l18) {
            if (i36 != 0 && vVar.h()) {
                int i37 = i34 + i35;
                int l19 = (1 - ((vVar.h() ? 1 : 0) * 2)) * (vVar.l() + 1);
                i13 = l18;
                int i38 = i37 + 1;
                int[] iArr4 = iArr2;
                ...
                int i40 = 0;
                for (int i41 = i35 - 1; i41 >= 0; i41--) {
                    int i42 = iArr3[i41] + l19;
                ...
                for (int i44 = 0; i44 < i34; i44++) {
                    int i45 = iArr4[i44] + l19;
                    if (i45 < 0 && zArr[i44]) {
                        iArr5[i43] = i45;
                        i43++;
                    }
                }
                iArr2 = Arrays.copyOf(iArr5, i43);
                int i46 = 0;
                for (int i47 = i34 - 1; i47 >= 0; i47--) {
                    int i48 = iArr4[i47] + l19;
                    if (i48 > 0 && zArr[i47]) {
                        iArr6[i46] = i48;
                        i46++;
                    }
                ...
                for (int i51 = 0; i51 < i35; i51++) {
                    int i52 = iArr3[i51] + l19;
                    if (i52 > 0 && zArr[i34 + i51]) {
                        iArr6[i50] = i52;
                        i50++;
                    }
                }
                iArr3 = Arrays.copyOf(iArr6, i50);
                i35 = i50;
                i34 = i49;
            } else {
                i13 = l18;
                ...
                for (int i53 = 0; i53 < l20; i53++) {
                    iArr7[i53] = vVar.l() + 1;
                    vVar.r();
                }
                int[] iArr8 = new int[l21];
                for (int i54 = 0; i54 < l21; i54++) {
                    iArr8[i54] = vVar.l() + 1;
                    vVar.r();
                }
                i34 = l20;
        ...
        if (vVar.h()) {
            if (vVar.h()) {
                ...
                if (i57 == 255) {
                    ...
                    com.google.android.recaptcha.internal.a.s(i57, "Unexpected aspect_ratio_idc value: ", "NalUnitUtil");
                }
            }
            if (vVar.h()) {
                vVar.r();
        ...
        return new p(i20, h10, i21, i26, iArr, i27, l11, l12, f9);
    }

    public static f5.r C(int r23, int r24, byte[] r25) {
        throw new UnsupportedOperationException("Method not decompiled: f5.a.C(int, int, byte[]):f5.r");
    }
    ...
    public static String G(String str, String str2) {
        ...
        if (u10[3] == 0) {
            ...
            if (i11 != 0) {
                ...
                sb2.append(str2);
                return F(sb2, u10[1] + i12, i12 + u10[2]);
            } else if (str2.charAt(i11) == '/') {
                sb2.append((CharSequence) str, 0, u11[1]);
                sb2.append(str2);
                int i13 = u11[1];
                return F(sb2, i13, u10[2] + i13);
            } else {
                int i14 = u11[0] + 2;
                int i15 = u11[1];
        ...
        synchronized (f6562f) {
            ...
            while (i12 < i10) {
                ...
                if (i12 < i10) {
                    int[] iArr = f6563g;
                    if (iArr.length <= i13) {
                        f6563g = Arrays.copyOf(iArr, iArr.length * 2);
                    }
                    f6563g[i13] = i12;
                    i12 += 3;
                    i13++;
    ...
    public static int w(java.lang.String r23) {
        throw new UnsupportedOperationException("Method not decompiled: f5.a.w(java.lang.String):int");
    }
