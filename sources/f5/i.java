...
public final class i extends com.googlecode.mp4parser.a {
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        this.f7795a = e5.b.d(byteBuffer);
        this.f7796b = e5.b.i(byteBuffer);
        int remaining = byteBuffer.remaining() / 4;
        this.f7797c = new LinkedList();
        for (int i10 = 0; i10 < remaining; i10++) {
            this.f7797c.add(e5.b.d(byteBuffer));
        }
    }

    @Override
    public final void getContent(ByteBuffer byteBuffer) {
        byteBuffer.put(e5.c.d(this.f7795a));
        byteBuffer.putInt((int) this.f7796b);
        for (String str : this.f7797c) {
