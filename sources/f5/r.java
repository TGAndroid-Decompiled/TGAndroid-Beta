...
public final class r extends com.googlecode.mp4parser.c {
    ...
    static {
        ...
        f8941f = aVar.e(aVar.d("getEntries", "com.coremedia.iso.boxes.SampleToChunkBox", "", "", "java.util.List"));
        h = aVar.e(aVar.d("setEntries", "com.coremedia.iso.boxes.SampleToChunkBox", "java.util.List", "entries", "void"));
        f8942n = aVar.e(aVar.d("toString", "com.coremedia.iso.boxes.SampleToChunkBox", "", "", "java.lang.String"));
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        ...
        for (q qVar : this.e) {
            byteBuffer.putInt((int) qVar.f8938a);
            byteBuffer.putInt((int) qVar.f8939b);
            byteBuffer.putInt((int) qVar.f8940c);
        }
    }
    ...
    public final String toString() {
        com.google.firebase.messaging.t b10 = re.a.b(f8942n, this, this);
