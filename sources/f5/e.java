...
public final class e extends com.googlecode.mp4parser.c {
    ...
    static {
        ...
        f8908f = aVar.e(aVar.d("setEntries", "com.coremedia.iso.boxes.CompositionTimeToSample", "java.util.List", "entries", "void"));
    }
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        ...
        for (d dVar : this.e) {
            byteBuffer.putInt(dVar.f8906a);
            byteBuffer.putInt(dVar.f8907b);
        }
    }
