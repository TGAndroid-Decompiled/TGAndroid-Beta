...
public final class k extends com.googlecode.mp4parser.c {
    ...
    public static final c0 f8918s;
    public static final c0 v;
    public static final c0 f8919w;
    public static final c0 f8920x;
    public static final c0 f8921y;
    public Date e;
    public Date f8922f;
    public long h;
    public long f8923n;
    ...
    static {
        ...
        f8918s = aVar.e(aVar.d("getCreationTime", "com.coremedia.iso.boxes.MediaHeaderBox", "", "", "java.util.Date"));
        ...
        f8919w = aVar.e(aVar.d("getTimescale", "com.coremedia.iso.boxes.MediaHeaderBox", "", "", "long"));
        f8920x = aVar.e(aVar.d("getDuration", "com.coremedia.iso.boxes.MediaHeaderBox", "", "", "long"));
        f8921y = aVar.e(aVar.d("getLanguage", "com.coremedia.iso.boxes.MediaHeaderBox", "", "", "java.lang.String"));
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        ...
        if (e() == 1) {
            ...
            this.f8922f = t6.b(e5.b.j(byteBuffer));
            this.h = e5.b.i(byteBuffer);
            this.f8923n = e5.b.j(byteBuffer);
        } else {
            this.e = t6.b(e5.b.i(byteBuffer));
            this.f8922f = t6.b(e5.b.i(byteBuffer));
            this.h = e5.b.i(byteBuffer);
            this.f8923n = e5.b.i(byteBuffer);
        }
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        ...
        if (e() == 1) {
            ...
            byteBuffer.putLong(t6.a(this.f8922f));
            byteBuffer.putInt((int) this.h);
            byteBuffer.putLong(this.f8923n);
        } else {
            byteBuffer.putInt((int) t6.a(this.e));
            byteBuffer.putInt((int) t6.a(this.f8922f));
            byteBuffer.putInt((int) this.h);
            byteBuffer.putInt((int) this.f8923n);
        }
    ...
    public final String toString() {
        ...
        e2.q(re.a.b(f8918s, this, this));
        sb2.append(this.e);
        sb2.append(";modificationTime=");
        e2.q(re.a.b(v, this, this));
        sb2.append(this.f8922f);
        sb2.append(";timescale=");
        e2.q(re.a.b(f8919w, this, this));
        sb2.append(this.h);
        sb2.append(";duration=");
        e2.q(re.a.b(f8920x, this, this));
        sb2.append(this.f8923n);
        sb2.append(";language=");
        e2.q(re.a.b(f8921y, this, this));
        return a4.a.s(sb2, this.f8924r, "]");
    }
}
