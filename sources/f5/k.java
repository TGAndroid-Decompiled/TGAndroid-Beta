...
public final class k extends com.googlecode.mp4parser.c {
    ...
    public static final ka.c f8923s;
    public static final ka.c v;
    public static final ka.c f8924w;
    public static final ka.c f8925x;
    public static final ka.c f8926y;
    public Date e;
    public Date f8927f;
    public long h;
    public long f8928n;
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        ...
        if (e() == 1) {
            ...
            this.f8927f = v6.b(e5.b.j(byteBuffer));
            this.h = e5.b.i(byteBuffer);
            this.f8928n = e5.b.j(byteBuffer);
        } else {
            this.e = v6.b(e5.b.i(byteBuffer));
            this.f8927f = v6.b(e5.b.i(byteBuffer));
            this.h = e5.b.i(byteBuffer);
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        ...
        if (e() == 1) {
            ...
            byteBuffer.putLong(v6.a(this.f8927f));
            byteBuffer.putInt((int) this.h);
            byteBuffer.putLong(this.f8928n);
        } else {
            byteBuffer.putInt((int) v6.a(this.e));
            byteBuffer.putInt((int) v6.a(this.f8927f));
            byteBuffer.putInt((int) this.h);
