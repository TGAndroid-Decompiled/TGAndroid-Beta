...
public final class m extends com.googlecode.mp4parser.c {
    ...
    public final void _parseDetails(ByteBuffer byteBuffer) {
        ...
        if (e() == 1) {
            ...
            this.f8925f = t6.b(e5.b.j(byteBuffer));
            this.h = e5.b.i(byteBuffer);
            this.f8926n = e5.b.j(byteBuffer);
        } else {
            this.e = t6.b(e5.b.i(byteBuffer));
            this.f8925f = t6.b(e5.b.i(byteBuffer));
            this.h = e5.b.i(byteBuffer);
            this.f8926n = e5.b.i(byteBuffer);
        }
        this.f8927r = e5.b.f(byteBuffer);
        this.f8928s = e5.b.g(byteBuffer);
        e5.b.h(byteBuffer);
        e5.b.i(byteBuffer);
        e5.b.i(byteBuffer);
        this.v = qc.d.a(byteBuffer);
        this.f8930x = byteBuffer.getInt();
        this.f8931y = byteBuffer.getInt();
        this.E = byteBuffer.getInt();
        this.F = byteBuffer.getInt();
        this.G = byteBuffer.getInt();
        this.H = byteBuffer.getInt();
        this.f8929w = e5.b.i(byteBuffer);
    }
    ...
    public final void getContent(ByteBuffer byteBuffer) {
        ...
        if (e() == 1) {
            ...
            byteBuffer.putLong(t6.a(this.f8925f));
            byteBuffer.putInt((int) this.h);
            byteBuffer.putLong(this.f8926n);
        } else {
            byteBuffer.putInt((int) t6.a(this.e));
            byteBuffer.putInt((int) t6.a(this.f8925f));
            byteBuffer.putInt((int) this.h);
            byteBuffer.putInt((int) this.f8926n);
        }
        e5.b.n(byteBuffer, this.f8927r);
        e5.b.o(byteBuffer, this.f8928s);
        e5.b.p(0, byteBuffer);
        int i10 = (int) 0;
        byteBuffer.putInt(i10);
        byteBuffer.putInt(i10);
        this.v.b(byteBuffer);
        byteBuffer.putInt(this.f8930x);
        byteBuffer.putInt(this.f8931y);
        byteBuffer.putInt(this.E);
        byteBuffer.putInt(this.F);
        byteBuffer.putInt(this.G);
        byteBuffer.putInt(this.H);
        byteBuffer.putInt((int) this.f8929w);
    }
    ...
    public final String toString() {
        ...
        sb2.append(this.f8927r);
        sb2.append(";volume=");
        e2.q(re.a.b(N, this, this));
        sb2.append(this.f8928s);
        sb2.append(";matrix=");
        sb2.append(this.v);
        sb2.append(";nextTrackId=");
        e2.q(re.a.b(O, this, this));
        return a4.a.r(sb2, this.f8929w, "]");
    }
}
