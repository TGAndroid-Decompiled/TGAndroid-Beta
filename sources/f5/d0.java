...
public abstract class d0 {
    public static final int f6579a;
    public static final String f6580b;
    public static final String f6581c;
    public static final String d;
    public static final String f6582e;
    public static final byte[] f6583f;
    public static final Pattern f6584g;
    public static final Pattern h;
    public static final Pattern f6585i;
    public static HashMap f6586j;
    public static final String[] f6587k;
    public static final String[] f6588l;
    public static final int[] f6589m;
    public static final int[] f6590n;
    ...
    public static String I(String str) {
        ...
        String str4 = (String) f6586j.get(str2);
        if (str4 != null) {
    ...
    public static long K(String str) {
        Matcher matcher = f6584g.matcher(str);
        if (matcher.matches()) {
            int i10 = 0;
    ...
    public static String l(byte[] bArr) {
        return new String(bArr, p8.d.f45658c);
    }
    ...
    public static Point p(Context context) {
        ...
        if (display.getDisplayId() == 0 && F(context)) {
            ...
            if ("Sony".equals(f6581c) && d.startsWith("BRAVIA") && context.getPackageManager().hasSystemFeature("com.sony.dtv.hardware.panel.qfhd")) {
