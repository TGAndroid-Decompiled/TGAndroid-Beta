...
public final class b extends vg.c {
    public final np f45781r;
    public TLRPC.TL_help_country f45782s;
    public final TextPaint v;
    public final w1 f45783w;
    ...
    public final void d() {
        ...
        this.f44338f.setLayoutParams(x5.d(22, 22.0f, i15, f13, 0.0f, f14, 0.0f));
    }

    public final void f() {
        TLRPC.TL_help_country tL_help_country = this.f45782s;
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        CharSequence replaceWithRestrictedEmoji = Emoji.replaceWithRestrictedEmoji(LocaleController.getLanguageFlag(tL_help_country.iso2), this.v.getFontMetricsInt(), 0, this.f45783w);
