...
public final class a extends Drawable {
    public final TextPaint f45195a;
    public final TextPaint f45196b;
    public final RectF f45197c;
    public final Drawable d;
    public float e;
    public String f45198f;

    public a(Context context) {
        TextPaint textPaint = new TextPaint(1);
        this.f45195a = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f45196b = textPaint2;
        this.f45197c = new RectF();
    ...
    public final void draw(Canvas canvas) {
        ...
        RectF rectF = this.f45197c;
        rectF.set(bounds.left, bounds.top, bounds.right, bounds.bottom);
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f), this.f45196b);
        ...
        if (str != null) {
            canvas.drawText(str, AndroidUtilities.dp(16.5f) + bounds.left, AndroidUtilities.dp(13.0f) + bounds.top, this.f45195a);
        }
    }
