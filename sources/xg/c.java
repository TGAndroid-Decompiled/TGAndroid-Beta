...
public class c extends FrameLayout {
    public final f6 f45779a;
    public final ImageView f45780b;
    public final TextView f45781c;
    public Runnable d;
    public final h2 e;
    public final Paint f45782f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int v02 = j6.v0(j6.f18863d7, this.f45779a);
        Paint paint = this.f45782f;
        paint.setColor(v02);
    ...
    public void setBackImage(int i10) {
        this.f45780b.setImageResource(i10);
    }
    ...
    public void setCloseImageVisible(boolean z10) {
        ...
        this.f45780b.setVisibility(i10);
        ...
        this.f45781c.setLayoutParams(x5.d(-1, -2.0f, 23, f7, 0.0f, f10, 0.0f));
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f45781c.setText(charSequence);
    }
}
