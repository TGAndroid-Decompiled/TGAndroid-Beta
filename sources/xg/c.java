...
public class c extends FrameLayout {
    public final d6 f46020a;
    public final ImageView f46021b;
    public final TextView f46022c;
    public Runnable d;
    public final f2 e;
    public final Paint f46023f;
    ...
    public c(Context context, d6 d6Var) {
        ...
        float f7;
        float f10;
        this.f46023f = new Paint(1);
        this.f46020a = d6Var;
        TextView textView = new TextView(context);
        this.f46022c = textView;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int v02 = h6.v0(h6.f19046d7, this.f46020a);
        Paint paint = this.f46023f;
        paint.setColor(v02);
    ...
    public void setBackImage(int i10) {
        this.f46021b.setImageResource(i10);
    }
    ...
    public void setCloseImageVisible(boolean z10) {
        ...
        this.f46021b.setVisibility(i10);
        ...
        this.f46022c.setLayoutParams(y5.d(-1, -2.0f, 23, f7, 0.0f, f10, 0.0f));
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f46022c.setText(charSequence);
    }
}
