...
public class c extends FrameLayout {
    public final d6 f46035a;
    public final ImageView f46036b;
    public final TextView f46037c;
    public Runnable d;
    public final f2 e;
    public final Paint f46038f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int v02 = h6.v0(h6.f19061d7, this.f46035a);
        Paint paint = this.f46038f;
        paint.setColor(v02);
    ...
    public void setBackImage(int i10) {
        this.f46036b.setImageResource(i10);
    }
    ...
    public void setCloseImageVisible(boolean z10) {
        ...
        this.f46036b.setVisibility(i10);
        ...
        this.f46037c.setLayoutParams(y5.d(-1, -2.0f, 23, f7, 0.0f, f10, 0.0f));
    }
    ...
    public void setText(CharSequence charSequence) {
        this.f46037c.setText(charSequence);
    }
}
