...
public final class i extends h7.m {
    public static final ThreadLocal f2245b = new ThreadLocal();
    public final ThreadPoolExecutor f2246a;
    ...
    public i() {
        ...
        this.f2246a = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
    }

    @Override
    public final void execute(Runnable runnable) {
        Deque deque = (Deque) f2245b.get();
        ...
        this.f2246a.execute(new p(0, runnable));
    }
}
