...
public final class q3 {
    public final e1 f49944a;
    public final int f49945b;
    public final int f49946c;
    public final e4 d;
    public final TL_iv.RichText f49947e;
    public final r3 f49948f;
    ...
    public q3(r3 r3Var, e1 e1Var, int i10, int i11, e4 e4Var) {
        ...
        if (e4Var != null && (textbutton = e4Var.f49725a) != null) {
            this.f49947e = textbutton.text;
        } else {
            this.f49947e = x5.f(new SpannableStringBuilder(e1Var.getText().subSequence(i10, i11)));
        }
    }
    ...
    public final void a(TL_keyboard.InlineButtonType inlineButtonType) {
        ...
        int i10;
        TL_iv.textButton textbutton;
        if (e4.c(inlineButtonType) && (text = (e1Var = this.f49944a).getText()) != null && (i10 = this.f49945b) >= 0) {
            int length = text.length();
            int i11 = this.f49946c;
            if (i11 <= length && i10 < i11) {
                r3 r3Var = this.f49948f;
                d2 d2Var = r3Var.G3;
                if (d2Var != null) {
                    d2Var.d();
                }
                ...
                x5.m(text, i10, i11);
                e4 e4Var2 = this.d;
                if (e4Var2 == null || (textbutton = e4Var2.f49725a) == null) {
                    textbutton = new TL_iv.textButton();
                }
                textbutton.text = this.f49947e;
                ...
                e4Var3.a(r3Var.c3, e1Var, r3Var.f49977d3);
