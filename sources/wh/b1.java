...
public final class b1 implements TextWatcher {
    ...
    public final void afterTextChanged(Editable editable) {
        Editable editable2;
        e1 e1Var = this.f49652a;
        if (!e1Var.h && e1Var.f49710c != null) {
            ...
            if (!e1Var.f49716w && !e1Var.f49713n && !e1Var.f49714r) {
                e1Var.h = true;
                boolean z4 = false;
                ...
                e1Var.h = false;
                if (z4) {
                    e1Var.f49710c.o(e1Var);
                    return;
                } else {
                    e1Var.f49710c.O(editable2);
                    return;
                }
            }
            e1Var.f49710c.O(editable2);
    ...
    public final void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
        d1 d1Var;
        e1 e1Var = this.f49652a;
        if (!e1Var.h && (d1Var = e1Var.f49710c) != null) {
            d1Var.j(i11, i12);
        }
    }
