...
public final class n implements Runnable {
    ...
    public final void run() {
        ...
        Object obj = this.d;
        Object obj2 = this.f48691c;
        Object obj3 = this.f48690b;
        switch (i10) {
            case 0:
                p pVar = (p) obj3;
                e90 e90Var = (e90) obj2;
                ClickableSpan clickableSpan = (ClickableSpan) obj;
                c90 c90Var = pVar.f48704y;
            ...
            case 2:
                ...
                nr0Var.f50547e.k(m2Var.f50471e.d, savedStarGift);
                ((n70) obj).u();
                nr0Var.n();
                TL_stars.TL_starGiftCollection c11 = nr0Var.f50547e.c(m2Var.f50471e.d);
                if (c11 != null) {
                    yc.a0(nr0Var.f50544a).R(savedStarGift.gift.getDocument(), AndroidUtilities.replaceTags(LocaleController.formatString(R.string.Gift2RemovedFromCollection, w3.D1(savedStarGift.gift), c11.title))).j();
                    return;
                }
                return;
            case 3:
                ...
                if (!m2Var2.d && savedStarGift2.pinned_to_top && !savedStarGift2.unsaved) {
                    z10 = true;
                    h1Var.c(false, true);
                    m2Var2.f50471e.m(savedStarGift2, false, false);
                } else {
                    z10 = true;
                }
                savedStarGift2.unsaved ^= z10;
                h1Var.h(savedStarGift2, z10, m2Var2.d);
                m2Var2.f50468a.f50547e.m(savedStarGift2, savedStarGift2.unsaved);
                TL_stars.saveStarGift savestargift = new TL_stars.saveStarGift();
                savestargift.stargift = m2Var2.f50471e.g(savedStarGift2);
                savestargift.unsave = savedStarGift2.unsaved;
                ConnectionsManager.getInstance(m2Var2.f50469b).sendRequest(savestargift, null);
                return;
            case 4:
                t3 t3Var = (t3) obj3;
                TLObject tLObject = (TLObject) obj2;
                TL_stars.getResaleStarGifts getresalestargifts = (TL_stars.getResaleStarGifts) obj;
                HashMap hashMap = t3Var.f50595m;
                HashMap hashMap2 = t3Var.f50597o;
                HashMap hashMap3 = t3Var.f50596n;
                ArrayList arrayList = t3Var.h;
                ArrayList arrayList2 = t3Var.f50590g;
                ArrayList arrayList3 = t3Var.f50589f;
                int i11 = t3Var.f50585a;
                ...
                if (tLObject instanceof TL_stars.resaleStarGifts) {
                    ...
                    t3Var.f50588e = resalestargifts.count;
                    ...
                    if (arrayList4.size() < t3Var.f50588e && !TextUtils.isEmpty(resalestargifts.next_offset)) {
                        z12 = false;
                    } else {
                        z12 = true;
                    }
                    t3Var.f50603u = z12;
                    t3Var.f50599q = resalestargifts.next_offset;
                    t3Var.f50602t = false;
                    ...
                    if (arrayList6 != null && !arrayList6.isEmpty()) {
                        ...
                        t3Var.f50591i = resalestargifts.attributes_hash;
                    }
                    ...
                    Utilities.Callback callback = t3Var.f50587c;
                    if (callback != null) {
            ...
            case 9:
                ...
                w3Var2.f52794e0.setResellPrice(zf.a.i(0L, zf.b.f51655a));
                b2 b2Var = w3Var2.f52793d1;
                if (b2Var != null) {
                    b2Var.run();
                }
            ...
            case 15:
                ...
                boolean[] zArr = s5Var.f52612r;
                ArrayList[] arrayListArr = s5Var.f52611q;
                int i14 = s5Var.f52597a;
                boolean z18 = !s5Var.f52600e;
                s5Var.f52599c = System.currentTimeMillis();
                if (tLObject4 instanceof TL_stars.StarsStatus) {
                    ...
                    if (arrayListArr[0].isEmpty()) {
                        ...
                        for (int i16 = 0; i16 < 3; i16++) {
                            ...
                            zArr2[i16] = z17;
                            if (z17) {
                                s5Var.f52614t[i16] = false;
                            }
                            String[] strArr = s5Var.f52613s;
                            if (zArr2[i16]) {
                                str2 = null;
                            } else {
                    ...
                    if (arrayList8.isEmpty()) {
                        ...
                        s5Var.f52617x = false;
                        s5Var.f52616w = starsStatus.subscriptions_next_offset;
