...
public final class k1 extends xq {
    ...
    public k1(View view) {
        ...
        this.e = 1.0f;
        c(path, 1.0f, false);
        this.f29125a.setColor(-698031);
        this.f29125a.setPathEffect(new CornerPathEffect(AndroidUtilities.dp(2.33f)));
        paint.setColor(0);
    ...
    public final void draw(Canvas canvas) {
        ...
        Path path = this.f44172c;
        if (alpha > 0) {
            paint.setStrokeWidth(AndroidUtilities.dp(1.33f) * 2);
            canvas.drawPath(path, paint);
        }
        canvas.drawPath(path, this.f29125a);
        if (this.f44173f != null) {
            canvas.clipPath(path);
            this.f44173f.f(0, 0, AndroidUtilities.dp(48.0f), AndroidUtilities.dp(48.0f));
            this.f44173f.d();
            this.f44173f.a(canvas, -1);
            invalidateSelf();
        }
        if (this.f44171b != null) {
            ...
            float min = Math.min(1.0f, AndroidUtilities.dp(40.0f) / this.f44171b.f27247c);
            ...
            t01 t01Var = this.f44171b;
            float width3 = getBounds().width() / 2.0f;
            if (!this.f44174g) {
                f14 = 6.0f;
            }
            float dp3 = (width3 + AndroidUtilities.dp(f14)) - (this.f44171b.l() / 2.0f);
    ...
    public final void e(int i10, CharSequence charSequence, boolean z10) {
        ...
        this.f44171b = new t01(charSequence, f7, typeface);
    }
}
