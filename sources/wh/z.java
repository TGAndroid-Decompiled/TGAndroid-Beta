...
public abstract class z extends FrameLayout implements f4 {
    ...
    public final void c(a aVar) {
        this.f50175b.a(aVar, new sf.g(this, 12));
    }
    ...
    public void f(int i10) {
        ...
        a aVar = this.f50174a;
        if (aVar != null && aVar.f49626n) {
            int i13 = aVar.f49624l;
            if (i13 <= 0) {
                i11 = 0;
            } else {
        ...
        if (aVar2 != null && aVar2.f49627o) {
            int i14 = aVar2.f49625m;
            if (i14 > 0) {
