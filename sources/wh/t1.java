...
public final class t1 extends HorizontalScrollView {
    public final h20 f50081a;
    public final org.telegram.ui.Components.z5 f50082b;
    public final org.telegram.ui.Components.z5 f50083c;
    public final z1 d;

    public t1(z1 z1Var, Context context) {
        super(context);
        this.d = z1Var;
        this.f50081a = new h20();
        pr prVar = pr.h;
        this.f50082b = new org.telegram.ui.Components.z5(this, 300L, prVar);
        this.f50083c = new org.telegram.ui.Components.z5(this, 300L, prVar);
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Canvas canvas2;
        float e6 = this.f50082b.e(canScrollHorizontally(-1));
        float e10 = this.f50083c.e(canScrollHorizontally(1));
