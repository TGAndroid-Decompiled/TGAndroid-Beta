...
public final class g extends ll0 {
    ...
    public final void E(List list) {
        n nVar = this.f45118c;
        ArrayList arrayList = nVar.f45141c;
    ...
    public final int h() {
        n nVar = this.f45118c;
        int i10 = 1;
        return ((nVar.f45141c.isEmpty() || !nVar.f45158x) ? 0 : 0) + nVar.f45141c.size() + (!nVar.B ? 1 : 0);
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == h() - 1 && !nVar.f45141c.isEmpty() && nVar.f45158x) {
            return 4;
        }
        return 0;
    }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            if (i12 == arrayList.size() - 1 && !nVar.f45158x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            f9 f9Var = f5Var.f20092a;
            f9Var.r(user);
            f5Var.f20093b.e(user, f9Var);
            f5Var.f20094c.l(UserObject.getUserName(user), false);
            ...
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        ...
                        if (nVar.B) {
                            yq0Var.setBackgroundColor(j6.v0(j6.f18863d6, o2Var.getResourceProvider()));
                        }
                        yq0Var.f(j6.f18863d6, j6.f18807a7, -1);
