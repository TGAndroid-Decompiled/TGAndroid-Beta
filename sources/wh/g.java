...
public final class g extends vl0 {
    ...
    public final void E(List list) {
        n nVar = this.f45354c;
        ArrayList arrayList = nVar.f45377c;
    ...
    public final int h() {
        n nVar = this.f45354c;
        int i10 = 1;
        return ((nVar.f45377c.isEmpty() || !nVar.f45394x) ? 0 : 0) + nVar.f45377c.size() + (!nVar.B ? 1 : 0);
    }
    ...
    public final int j(int i10) {
        ...
        if (i10 == h() - 1 && !nVar.f45377c.isEmpty() && nVar.f45394x) {
            return 4;
        }
        return 0;
    }
    ...
    public final void v(c1 c1Var, int i10) {
        ...
        if (i11 == 0) {
            ...
            if (i12 == arrayList.size() - 1 && !nVar.f45394x) {
                z10 = false;
            } else {
                z10 = true;
            }
            ...
            h9 h9Var = g5Var.f20331a;
            h9Var.r(user);
            g5Var.f20332b.e(user, h9Var);
            g5Var.f20333c.l(UserObject.getUserName(user), false);
            ...
            if (i10 != 2) {
                if (i10 != 3) {
                    if (i10 != 4) {
                        ...
                        if (nVar.B) {
                            pq0Var.setBackgroundColor(h6.v0(h6.f19045d6, m2Var.getResourceProvider()));
                        }
                        pq0Var.f(h6.f19045d6, h6.f18989a7, -1);
