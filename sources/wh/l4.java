...
public final class l4 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (this.f49864a) {
            case 0:
                final o4 o4Var = this.f49865b;
                ArrayList arrayList = o4Var.B;
                int indexOf = arrayList.indexOf(view);
                if (o4Var.K != null && o4Var.f50174a != null) {
                    List m9 = o4Var.m();
                    if (indexOf >= 0 && indexOf < m9.size() && indexOf < arrayList.size()) {
                        final t tVar = (t) m9.get(indexOf);
                        q70 P = o4Var.K.f49827a.f49979e3.P((View) arrayList.get(indexOf));
                        boolean z4 = tVar.f50040n;
                        if (z4) {
                            ...
                            public final void run() {
                                ...
                                switch (r3) {
                                    case 0:
                                        o4 o4Var2 = o4Var;
                                        k3 k3Var = o4Var2.K;
                                        if (k3Var != null && (aVar3 = o4Var2.f50174a) != null) {
                                            r3 r3Var = k3Var.f49827a;
                                            r3Var.getClass();
                                            t tVar2 = tVar;
                                            if (tVar2 != null) {
                                                d2 d2Var = r3Var.G3;
                                                ...
                                                tVar2.f50040n = !tVar2.f50040n;
                                                TL_iv.PageBlock N3 = r3.N3(aVar3, tVar2);
                                                if (N3 instanceof TL_iv.pageBlockPhoto) {
                                                    ((TL_iv.pageBlockPhoto) N3).spoiler = tVar2.f50040n;
                                                } else if (N3 instanceof TL_iv.pageBlockVideo) {
                                                    ((TL_iv.pageBlockVideo) N3).spoiler = tVar2.f50040n;
                                                }
                                                r3Var.n4(aVar3);
                                                d2 d2Var2 = r3Var.G3;
                                                if (d2Var2 != null) {
                                    ...
                                    default:
                                        o4 o4Var3 = o4Var;
                                        k3 k3Var2 = o4Var3.K;
                                        if (k3Var2 != null && (aVar4 = o4Var3.f50174a) != null) {
                                            r3.N1(aVar4, tVar, k3Var2.f49827a);
                                            return;
                                        }
                                        return;
                                }
                ...
                return;
            case 1:
                o4 o4Var2 = this.f49865b;
                k3 k3Var = o4Var2.K;
                if (k3Var != null && (aVar = o4Var2.f50174a) != null) {
                    r3 r3Var = k3Var.f49827a;
                    r3Var.Y3 = aVar;
                    r3Var.f49979e3.p(0);
                    return;
                ...
                return;
            default:
                o4 o4Var3 = this.f49865b;
                k3 k3Var2 = o4Var3.K;
                if (k3Var2 != null && (aVar2 = o4Var3.f50174a) != null) {
                    r3 r3Var2 = k3Var2.f49827a;
                    r3Var2.getClass();
                    if (r3.B3(aVar2.f49616b)) {
                        d2 d2Var = r3Var2.G3;
                        if (d2Var != null) {
                            d2Var.d();
                        }
                        ArrayList<TL_iv.PageBlock> g32 = r3.g3(aVar2.f49616b);
                        TL_iv.PageBlock pageBlock = aVar2.f49616b;
                        ...
                        aVar2.f49616b = pageblockslideshow;
                        d2 d2Var2 = r3Var2.G3;
                        if (d2Var2 != null) {
                            d2Var2.h();
                        }
                        ...
                        if (z12 instanceof o4) {
                            o4 o4Var4 = (o4) z12;
                            ValueAnimator valueAnimator = o4Var4.f49907f0;
                            if (valueAnimator != null) {
                                valueAnimator.cancel();
                                o4Var4.f49907f0 = null;
                            }
                            if (o4Var4.getParent() != null) {
                                o4Var4.getParent().requestDisallowInterceptTouchEvent(false);
                            }
                            VelocityTracker velocityTracker = o4Var4.f49906e0;
                            if (velocityTracker != null) {
                                velocityTracker.recycle();
                                o4Var4.f49906e0 = null;
                            }
                            o4Var4.T = 0;
                            o4Var4.U = 0.0f;
                            o4Var4.o(true);
