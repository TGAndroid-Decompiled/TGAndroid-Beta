...
public final class m extends Dialog {
    ...
    public final Drawable f45103c;
    public final TextView d;
    public final TextView e;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f45104f;
    public final oh0 h;
    public final j f45105n;
    public TLRPC.TL_chatInviteImporter f45106r;
    public ValueAnimator f45107s;
    public u9 v;
    public BitmapDrawable f45108w;
    public float f45109x;
    public final l f45110y;
    ...
    public m(n nVar, Activity activity, ll0 ll0Var, e6 e6Var, boolean z10) {
        ...
        this.f45101a = rect.top;
        this.f45102b = rect.left;
        ...
        this.f45104f = actionBarPopupWindow$ActionBarPopupWindowLayout;
        ...
        textView2.setTextColor(i6.v0(i6.f19218y6, n2Var.getResourceProvider()));
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        m mVar = this.f45096b;
                        n nVar2 = mVar.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter = mVar.f45106r;
                        if (tL_chatInviteImporter != null) {
                            nVar2.d(tL_chatInviteImporter, true);
                        }
                        nVar2.f45126s.e(false);
                        nVar2.f45125r = null;
                        return;
                    case 1:
                        m.a(this.f45096b);
                        return;
                    default:
                        m mVar2 = this.f45096b;
                        n nVar3 = mVar2.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter2 = mVar2.f45106r;
                        if (tL_chatInviteImporter2 != null) {
                            nVar3.d(tL_chatInviteImporter2, false);
                        }
                        nVar3.f45126s.e(false);
                        nVar3.f45125r = null;
                        return;
                }
            }
        ...
        f1Var3.c(i6.v0(i6.f19074q7, e6Var), i6.v0(i6.f19056p7, e6Var));
    ...
    public static void a(m mVar) {
        n nVar = mVar.E;
        if (mVar.f45106r != null) {
            nVar.f45112b = true;
            n2 n2Var = nVar.f45115g;
            super.dismiss();
            n2Var.dismissCurrentDialog();
            Bundle bundle = new Bundle();
            bundle.putLong("user_id", mVar.f45106r.user_id);
    ...
    public final int d() {
        ...
        return this.f45104f.getMeasuredHeight() + AndroidUtilities.dp(12.0f) + measuredHeight;
    }
    ...
    public final void e(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f45107s;
        ...
        final int i10 = (-this.f45104f.getTop()) / 2;
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
        ...
        this.f45107s = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                float floatValue = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                m mVar = m.this;
                mVar.f45109x = floatValue;
                float f12 = width;
                float z11 = e2.z(1.0f, f12, floatValue, f12);
                l lVar = mVar.f45110y;
                lVar.setScaleX(z11);
                lVar.setScaleY(z11);
                lVar.setTranslationX((1.0f - mVar.f45109x) * left);
                lVar.setTranslationY((1.0f - mVar.f45109x) * top);
                int i11 = (int) ((1.0f - mVar.f45109x) * width2);
                mVar.h.N(i11, i11);
                float a2 = p.a((mVar.f45109x * 2.0f) - 1.0f, 0.0f, 1.0f);
                mVar.f45103c.setAlpha((int) (a2 * 255.0f));
                mVar.d.setAlpha(a2);
                mVar.e.setAlpha(a2);
                ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = mVar.f45104f;
                actionBarPopupWindow$ActionBarPopupWindowLayout.setTranslationY((1.0f - mVar.f45109x) * i10);
                actionBarPopupWindow$ActionBarPopupWindowLayout.setAlpha(a2);
                BitmapDrawable bitmapDrawable = mVar.f45108w;
                if (bitmapDrawable != null) {
                    bitmapDrawable.setAlpha((int) (mVar.f45109x * 255.0f));
                }
                mVar.f45105n.setAlpha(a2);
            }
        });
        this.f45107s.addListener(new fm0(this, z10, width, 1));
        this.f45107s.setDuration(220L);
        this.f45107s.setInterpolator(qr.f27423f);
        this.f45107s.start();
    }

    public final void f() {
        int i10;
        BitmapDrawable bitmapDrawable = this.f45108w;
        if (bitmapDrawable != null) {
        ...
        this.f45108w = bitmapDrawable2;
        bitmapDrawable2.setAlpha(i10);
        getWindow().setBackgroundDrawable(this.f45108w);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f45110y, new ViewGroup.LayoutParams(-1, -1));
