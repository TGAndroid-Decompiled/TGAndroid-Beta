...
public final class m extends Dialog {
    ...
    public final Drawable f45419c;
    public final TextView d;
    public final TextView e;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f45420f;
    public final bi0 h;
    public final j f45421n;
    public TLRPC.TL_chatInviteImporter f45422r;
    public ValueAnimator f45423s;
    public v9 v;
    public BitmapDrawable f45424w;
    public float f45425x;
    public final l f45426y;
    ...
    public m(n nVar, Activity activity, yl0 yl0Var, f6 f6Var, boolean z10) {
        ...
        this.f45417a = rect.top;
        this.f45418b = rect.left;
        ...
        this.f45420f = actionBarPopupWindow$ActionBarPopupWindowLayout;
        ...
        this.f45421n = q4Var;
        bi0 bi0Var = new bi0(activity, n2Var.getActionBar(), yl0Var, q4Var);
        this.h = bi0Var;
        ...
        textView2.setTextColor(j6.v0(j6.f19492y6, n2Var.getResourceProvider()));
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        m mVar = this.f45412b;
                        n nVar2 = mVar.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter = mVar.f45422r;
                        if (tL_chatInviteImporter != null) {
                            nVar2.d(tL_chatInviteImporter, true);
                        }
                        nVar2.f45442s.e(false);
                        nVar2.f45441r = null;
                        return;
                    case 1:
                        m.a(this.f45412b);
                        return;
                    default:
                        m mVar2 = this.f45412b;
                        n nVar3 = mVar2.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter2 = mVar2.f45422r;
                        if (tL_chatInviteImporter2 != null) {
                            nVar3.d(tL_chatInviteImporter2, false);
                        }
                        nVar3.f45442s.e(false);
                        nVar3.f45441r = null;
                        return;
                }
            }
        ...
        f1Var3.c(j6.v0(j6.f19348q7, f6Var), j6.v0(j6.f19330p7, f6Var));
    ...
    public static void a(m mVar) {
        n nVar = mVar.E;
        if (mVar.f45422r != null) {
            nVar.f45428b = true;
            n2 n2Var = nVar.f45431g;
            super.dismiss();
            n2Var.dismissCurrentDialog();
            Bundle bundle = new Bundle();
            bundle.putLong("user_id", mVar.f45422r.user_id);
    ...
    public final int d() {
        ...
        return this.f45420f.getMeasuredHeight() + AndroidUtilities.dp(12.0f) + measuredHeight;
    }
    ...
    public final void e(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f45423s;
        ...
        final int i10 = (-this.f45420f.getTop()) / 2;
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
        ...
        this.f45423s = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                float floatValue = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                m mVar = m.this;
                mVar.f45425x = floatValue;
                float f12 = width;
                float z11 = e2.z(1.0f, f12, floatValue, f12);
                l lVar = mVar.f45426y;
                lVar.setScaleX(z11);
                lVar.setScaleY(z11);
                lVar.setTranslationX((1.0f - mVar.f45425x) * left);
                lVar.setTranslationY((1.0f - mVar.f45425x) * top);
                int i11 = (int) ((1.0f - mVar.f45425x) * width2);
                mVar.h.N(i11, i11);
                float a2 = q.a((mVar.f45425x * 2.0f) - 1.0f, 0.0f, 1.0f);
                mVar.f45419c.setAlpha((int) (a2 * 255.0f));
                mVar.d.setAlpha(a2);
                mVar.e.setAlpha(a2);
                ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = mVar.f45420f;
                actionBarPopupWindow$ActionBarPopupWindowLayout.setTranslationY((1.0f - mVar.f45425x) * i10);
                actionBarPopupWindow$ActionBarPopupWindowLayout.setAlpha(a2);
                BitmapDrawable bitmapDrawable = mVar.f45424w;
                if (bitmapDrawable != null) {
                    bitmapDrawable.setAlpha((int) (mVar.f45425x * 255.0f));
                }
                mVar.f45421n.setAlpha(a2);
            }
        });
        this.f45423s.addListener(new tm0(this, z10, width, 1));
        this.f45423s.setDuration(220L);
        this.f45423s.setInterpolator(qr.f27653f);
        this.f45423s.start();
    }

    public final void f() {
        int i10;
        BitmapDrawable bitmapDrawable = this.f45424w;
        if (bitmapDrawable != null) {
        ...
        this.f45424w = bitmapDrawable2;
        bitmapDrawable2.setAlpha(i10);
        getWindow().setBackgroundDrawable(this.f45424w);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f45426y, new ViewGroup.LayoutParams(-1, -1));
