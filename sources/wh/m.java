...
public final class m extends Dialog {
    ...
    public final Drawable f45131c;
    public final TextView d;
    public final TextView e;
    public final ActionBarPopupWindow$ActionBarPopupWindowLayout f45132f;
    public final ph0 h;
    public final j f45133n;
    public TLRPC.TL_chatInviteImporter f45134r;
    public ValueAnimator f45135s;
    public u9 v;
    public BitmapDrawable f45136w;
    public float f45137x;
    public final l f45138y;
    ...
    public m(n nVar, Activity activity, ml0 ml0Var, f6 f6Var, boolean z10) {
        ...
        this.f45129a = rect.top;
        this.f45130b = rect.left;
        ...
        this.f45132f = actionBarPopupWindow$ActionBarPopupWindowLayout;
        ...
        textView2.setTextColor(j6.v0(j6.f19245y6, o2Var.getResourceProvider()));
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        m mVar = this.f45124b;
                        n nVar2 = mVar.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter = mVar.f45134r;
                        if (tL_chatInviteImporter != null) {
                            nVar2.d(tL_chatInviteImporter, true);
                        }
                        nVar2.f45154s.e(false);
                        nVar2.f45153r = null;
                        return;
                    case 1:
                        m.a(this.f45124b);
                        return;
                    default:
                        m mVar2 = this.f45124b;
                        n nVar3 = mVar2.E;
                        TLRPC.TL_chatInviteImporter tL_chatInviteImporter2 = mVar2.f45134r;
                        if (tL_chatInviteImporter2 != null) {
                            nVar3.d(tL_chatInviteImporter2, false);
                        }
                        nVar3.f45154s.e(false);
                        nVar3.f45153r = null;
                        return;
                }
            }
        ...
        g1Var3.c(j6.v0(j6.f19101q7, f6Var), j6.v0(j6.f19083p7, f6Var));
    ...
    public static void a(m mVar) {
        n nVar = mVar.E;
        if (mVar.f45134r != null) {
            nVar.f45140b = true;
            o2 o2Var = nVar.f45143g;
            super.dismiss();
            o2Var.dismissCurrentDialog();
            Bundle bundle = new Bundle();
            bundle.putLong("user_id", mVar.f45134r.user_id);
    ...
    public final int d() {
        ...
        return this.f45132f.getMeasuredHeight() + AndroidUtilities.dp(12.0f) + measuredHeight;
    }
    ...
    public final void e(boolean z10) {
        float f7;
        ValueAnimator valueAnimator = this.f45135s;
        ...
        final int i10 = (-this.f45132f.getTop()) / 2;
        if (z10) {
            f7 = 0.0f;
        } else {
            f7 = 1.0f;
        ...
        this.f45135s = ofFloat;
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                float floatValue = ((Float) valueAnimator2.getAnimatedValue()).floatValue();
                m mVar = m.this;
                mVar.f45137x = floatValue;
                float f12 = width;
                float z11 = e2.z(1.0f, f12, floatValue, f12);
                l lVar = mVar.f45138y;
                lVar.setScaleX(z11);
                lVar.setScaleY(z11);
                lVar.setTranslationX((1.0f - mVar.f45137x) * left);
                lVar.setTranslationY((1.0f - mVar.f45137x) * top);
                int i11 = (int) ((1.0f - mVar.f45137x) * width2);
                mVar.h.N(i11, i11);
                float a2 = p.a((mVar.f45137x * 2.0f) - 1.0f, 0.0f, 1.0f);
                mVar.f45131c.setAlpha((int) (a2 * 255.0f));
                mVar.d.setAlpha(a2);
                mVar.e.setAlpha(a2);
                ActionBarPopupWindow$ActionBarPopupWindowLayout actionBarPopupWindow$ActionBarPopupWindowLayout = mVar.f45132f;
                actionBarPopupWindow$ActionBarPopupWindowLayout.setTranslationY((1.0f - mVar.f45137x) * i10);
                actionBarPopupWindow$ActionBarPopupWindowLayout.setAlpha(a2);
                BitmapDrawable bitmapDrawable = mVar.f45136w;
                if (bitmapDrawable != null) {
                    bitmapDrawable.setAlpha((int) (mVar.f45137x * 255.0f));
                }
                mVar.f45133n.setAlpha(a2);
            }
        });
        this.f45135s.addListener(new gm0(this, z10, width, 1));
        this.f45135s.setDuration(220L);
        this.f45135s.setInterpolator(qr.f27383f);
        this.f45135s.start();
    }

    public final void f() {
        int i10;
        BitmapDrawable bitmapDrawable = this.f45136w;
        if (bitmapDrawable != null) {
        ...
        this.f45136w = bitmapDrawable2;
        bitmapDrawable2.setAlpha(i10);
        getWindow().setBackgroundDrawable(this.f45136w);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        setContentView(this.f45138y, new ViewGroup.LayoutParams(-1, -1));
