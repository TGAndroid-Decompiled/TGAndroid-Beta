...
public final class o0 implements d1 {
    ...
    public final boolean D(e1 e1Var) {
        r0 r0Var = this.f49931a;
        if (r0Var.h != null && r0Var.f50001f != null && e1Var.length() == 0) {
            r0Var.h.a(r0Var.f50001f);
            return true;
        }
        return false;
    }
    ...
    public final void H(CharSequence charSequence) {
        z2 z2Var = this.f49931a.h;
        if (z2Var != null && charSequence != null && charSequence.length() > 0) {
            z2Var.f50254a.s4(charSequence.toString());
        }
    }
    ...
    public final void O(Editable editable) {
        r0 r0Var = this.f49931a;
        a aVar = r0Var.f50001f;
        if (aVar != null) {
            aVar.f49668s = true;
            aVar.f49667r = r0Var.d.B;
        }
        if (aVar != null) {
    ...
    public final void o(e1 e1Var) {
        ...
        r0 r0Var = this.f49931a;
        z2 z2Var = r0Var.h;
        if (z2Var != null && (aVar = r0Var.f50001f) != null && (indexOf = (arrayList = (r3Var = z2Var.f50254a).f50024i3).indexOf(aVar)) >= 0) {
            ...
            int i10 = indexOf + 1;
            if (i10 < arrayList.size() && !((a) arrayList.get(i10)).f49658i && !r3.w3((a) arrayList.get(i10))) {
    ...
    public final void s(e1 e1Var, int i10, int i11) {
        ...
        r0 r0Var = this.f49931a;
        if (!r0Var.f50002n && i10 != i11 && (z2Var = r0Var.h) != null && (textSelectionHelper = z2Var.f50254a.getTextSelectionHelper()) != null) {
