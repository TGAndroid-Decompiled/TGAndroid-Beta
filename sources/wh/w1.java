...
public final class w1 extends Drawable {
    public final Paint f50127a;
    public final org.telegram.ui.Components.z5 f50128b;
    ...
    public w1(int i10) {
        ...
        this.f50127a = paint;
        this.f50128b = new org.telegram.ui.Components.z5(new v1(this, 0), 420L, pr.h, 0);
        this.d = 255;
        paint.setColor(i10);
    }
    ...
    public final void draw(Canvas canvas) {
        float e6 = this.f50128b.e(this.f50129c);
        if (e6 <= 0.0f) {
            return;
        }
        Paint paint = this.f50127a;
    ...
    public final void setColorFilter(ColorFilter colorFilter) {
        this.f50127a.setColorFilter(colorFilter);
    }
}
