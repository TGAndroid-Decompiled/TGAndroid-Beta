...
public final class i5 extends z implements b6, l9 {
    ...
    public f5 F;
    public final i G;
    public final g6 f49797n;
    public final e1 f49798r;
    public final org.telegram.ui.g2 f49799s;
    public final k5 v;
    public final h5 f49800w;
    public final ArrayList f49801x;
    public boolean f49802y;

    public i5(Context context, g6 g6Var) {
        super(context);
        this.f49801x = new ArrayList();
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.C != null) {
            y2 y2Var = this.B;
            if (y2Var != null) {
                m9Var = y2Var.f50171a.getTextSelectionHelper();
            } else {
                m9Var = null;
            }
            if (m9Var != null) {
                ArrayList arrayList = this.f49801x;
                arrayList.clear();
    ...
    @Override
    public final void e() {
        e1 e1Var = this.f49798r;
        e1Var.t();
        int v02 = k6.v0(k6.G6, this.f49797n);
    ...
    public final void fillTextLayoutBlocks(ArrayList arrayList) {
        ...
        if (this.C != null) {
            ...
            int size = this.C.f50228g.size();
            for (int i10 = 0; i10 < size; i10++) {
                TL_iv.pageTableCell pagetablecell = (TL_iv.pageTableCell) this.C.f50228g.get(i10);
                k5 k5Var = this.v;
                l5 m9 = k5Var.m(pagetablecell);
                if (m9 != null && (layout = (e1Var = m9.f49867a).getLayout()) != null) {
                    org.telegram.ui.g2 g2Var = this.f49799s;
                    int left = g2Var.getLeft();
                    h5 h5Var = this.f49800w;
    ...
    public final TL_iv.pageTableCell h(int i10) {
        int i11;
        z5 z5Var = this.C;
        if (z5Var == null || i10 <= 0 || i10 - 1 >= z5Var.f50228g.size()) {
            return null;
        }
        return (TL_iv.pageTableCell) this.C.f50228g.get(i11);
    }
    ...
    public final void i(boolean z4) {
        ...
        if (this.C != null) {
            ...
            if (!linkedHashSet.isEmpty()) {
                ...
                linkedHashSet.clear();
                z5 z5Var = this.C;
                if (z5Var.f50224b != 0 && (i11 = z5Var.f50225c) != 0) {
                    if (i10 < 0) {
                        i12 = 0;
                    } else {
                        i12 = i10;
                    ...
                    boolean[] zArr = new boolean[z5Var.f50224b];
                    ArrayList arrayList = z5Var.f50228g;
                    ...
                    while (i15 < size) {
                        ...
                        if (a2 < i11 && a2 + i16 > i11) {
                            i16++;
                            for (int i17 = b10; i17 < b10 + o10 && i17 < z5Var.f50224b; i17++) {
                                zArr[i17] = true;
                            }
                        }
                    ...
                    TL_iv.pageBlockTable pageblocktable = z5Var.f50223a;
    ...
    public final void j(boolean z4) {
        ...
        if (this.C != null) {
            ...
            if (!linkedHashSet.isEmpty()) {
                ...
                linkedHashSet.clear();
                z5 z5Var = this.C;
                int i13 = z5Var.f50224b;
                if (i13 != 0 && z5Var.f50225c != 0) {
                    if (i10 < 0) {
                        i11 = 0;
                    } else {
                        i11 = i10;
                    ...
                    IdentityHashMap identityHashMap = new IdentityHashMap();
                    boolean[] zArr = new boolean[z5Var.f50225c];
                    ArrayList arrayList = z5Var.f50228g;
                    int size = arrayList.size();
                    int i14 = 0;
                    while (i14 < size) {
                        ...
                        if (b10 < i13 && b10 + o10 > i13) {
                            o10++;
                            for (int i16 = a2; i16 < a2 + i15 && i16 < z5Var.f50225c; i16++) {
                                zArr[i16] = true;
                            }
                        }
                        identityHashMap.put(pagetablecell2, new int[]{i12, a2, o10, i15});
                    }
                    for (int i17 = 0; i17 < z5Var.f50225c; i17++) {
                        if (!zArr[i17]) {
                            identityHashMap.put(z5.f(), new int[]{i13, i17, 1, 1});
                        }
                    }
                    z5Var.j(identityHashMap, z5Var.f50224b + 1);
                    z5Var.i();
                } else {
                    TL_iv.pageTableRow pagetablerow = new TL_iv.pageTableRow();
                    pagetablerow.cells = new ArrayList<>();
                    int max = Math.max(z5Var.f50225c, 1);
                    for (int i18 = 0; i18 < max; i18++) {
                        pagetablerow.cells.add(z5.f());
                    }
                    z5Var.f50223a.rows.add(pagetablerow);
                    z5Var.i();
                }
                v();
                q(i10, 0);
    ...
    public final int k(TL_iv.pageTableCell pagetablecell) {
        int indexOf;
        z5 z5Var = this.C;
        if (z5Var == null || (indexOf = z5Var.f50228g.indexOf(pagetablecell)) < 0) {
            return -1;
        }
        return indexOf + 1;
    }
    ...
    public final int n(int i10, int i11) {
        ...
        if (this.C != null) {
            ...
            int scrollX = g2Var.getScrollX() + (left2 - k5Var.getLeft());
            int top = ((i11 - g2Var.getTop()) - h5Var.getTop()) - k5Var.getTop();
            z5 z5Var = k5Var.f49835a;
            if (z5Var != null && top >= (i12 = k5Var.f49839f[z5Var.f50224b])) {
                if (top < AndroidUtilities.dp(4.0f) + AndroidUtilities.dp(16.0f) + i12) {
                    ...
                    if (a10 != null && (a2 = k5Var.f49835a.a(a10)) >= 0) {
                        int i14 = a10.colspan;
                        if (i14 != 0) {
                            i13 = i14;
                        }
                        int[] iArr2 = k5Var.f49838e;
                        int i15 = iArr2[a2];
                        int i16 = iArr2[Math.min(i13 + a2, k5Var.f49835a.f50225c)];
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        int i15;
        int i16 = i12 - i10;
        int i17 = this.f50177c;
        int d = l8.d(this.f50175a);
        boolean z10 = this.f49802y;
        if (z10) {
            i14 = d;
        } else {
            i14 = i17;
        ...
        a aVar = this.f50175a;
        int i18 = 0;
        if (aVar != null && (i15 = aVar.f49625l) > 0) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int i14 = 0;
        int max = Math.max(0, (size - this.f50177c) - l8.d(this.f50175a));
        ...
        a aVar = this.f50175a;
        if (aVar == null || (i12 = aVar.f49625l) <= 0) {
            dp = 0;
        } else {
            dp = AndroidUtilities.dp(e2.c.e(i12, 1, 16, 10));
        }
        a aVar2 = this.f50175a;
        if (aVar2 != null && (i13 = aVar2.f49626m) > 0) {
    ...
    public final int p(int i10, int i11) {
        ...
        if (this.C != null) {
            ...
            int scrollX = g2Var.getScrollX() + (left2 - k5Var.getLeft());
            int top = ((i11 - g2Var.getTop()) - h5Var.getTop()) - k5Var.getTop();
            if (k5Var.f49835a != null && scrollX >= (k5Var.f49838e[0] - AndroidUtilities.dp(16.0f)) - AndroidUtilities.dp(4.0f) && scrollX < k5Var.f49838e[0]) {
                int i12 = 1;
                if (k5Var.v()) {
                    int k10 = k5Var.k();
                    int r10 = k5Var.r();
                    if (k10 >= 0) {
                        int[] iArr = k5Var.f49839f;
                ...
                if (a2 != null && (b10 = k5Var.f49835a.b(a2)) >= 0) {
                    int i13 = a2.rowspan;
                    if (i13 != 0) {
                        i12 = i13;
                    }
                    int[] iArr2 = k5Var.f49839f;
                    int i14 = iArr2[b10];
                    int i15 = iArr2[Math.min(i12 + b10, k5Var.f49835a.f50224b)];
                    if (top >= i14 && top < i15) {
                        return b10;
                    }
                    return -1;
    ...
    public final void q(int i10, int i11) {
        int i12;
        z5 z5Var = this.C;
        if (z5Var != null && (i12 = z5Var.f50224b) != 0 && z5Var.f50225c != 0) {
            TL_iv.pageTableCell pagetablecell = this.C.d[Math.max(0, Math.min(i10, i12 - 1))][Math.max(0, Math.min(i11, this.C.f50225c - 1))];
    ...
    public final boolean r() {
        z5 z5Var = this.C;
        if (z5Var == null || z5Var.f50228g.isEmpty()) {
            return false;
        }
        l5 m9 = this.v.m((TL_iv.pageTableCell) this.C.f50228g.get(0));
        if (m9 == null) {
            return false;
        }
        e1 e1Var = m9.f49867a;
    ...
    public final boolean s(l5 l5Var, boolean z4) {
        ...
        int i10;
        z5 z5Var = this.C;
        if (z5Var != null && (indexOf = z5Var.f50228g.indexOf(l5Var.f49868b)) >= 0) {
            if (z4) {
                i10 = indexOf - 1;
            } else {
                i10 = indexOf + 1;
            }
            if (i10 >= 0 && i10 < this.C.f50228g.size()) {
                l5 m9 = this.v.m((TL_iv.pageTableCell) this.C.f50228g.get(i10));
                if (m9 != null) {
                    e1 e1Var = m9.f49867a;
                    e1Var.r();
    ...
    public final void t() {
        ...
        f5 f5Var = this.F;
        if (f5Var != null) {
            r3 r3Var = ((o2) f5Var).f49898a;
            if (this == r3Var.f49983f4) {
                if (this.E.isEmpty()) {
                    r3Var.M2();
                } else if (!r3Var.f50011y3) {
                    r3Var.F4(this);
                }
            }
        }
    ...
    public final void u() {
        ...
        if (aVar != null) {
            ...
            if (pageBlock instanceof TL_iv.pageBlockTable) {
                ((TL_iv.pageBlockTable) pageBlock).title = x5.f(this.f49798r.getText());
            }
        }
    }
    ...
    public final void v() {
        ...
        y();
        y2 y2Var = this.B;
        if (y2Var != null && this.f50175a != null) {
            y2Var.a();
        }
    }
                ...
                while (true) {
                    ...
                    while (min <= min3) {
                        ...
                        while (min2 <= min4) {
                            ...
                            int i20 = z5Var2.f50226e[min][min2];
                            int i21 = z5Var2.f50227f[min][min2];
                            int min5 = Math.min(z5Var2.f50224b - 1, (z5.o(pagetablecell3) + i20) - 1);
                            int i22 = this.C.f50225c - 1;
