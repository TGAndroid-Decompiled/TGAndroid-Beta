...
public final class s extends ReplacementSpan {
    ...
    public static s a(String str, int i10, float f10) {
        ...
        if (str != null && !str.isEmpty() && (a2 = r.a(str, f10, true)) != null) {
            return new s(str, a2.f49957a, a2.f49958b, a2.f49959c, i10, a2.d);
        }
        return null;
    }
    ...
    public final void draw(Canvas canvas, CharSequence charSequence, int i10, int i11, float f10, int i12, int i13, int i14, Paint paint) {
        Bitmap bitmap = this.f50019b;
        if (bitmap == null) {
            return;
        }
        int color = paint.getColor();
        Paint paint2 = this.f50022f;
        paint2.setColor(color);
        canvas.drawBitmap(bitmap, f10, i13 - (this.d - this.f50021e), paint2);
    }
