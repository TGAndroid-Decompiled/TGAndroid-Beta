...
public final class q5 implements d1 {
    ...
    public final boolean D(e1 e1Var) {
        a aVar;
        v5 v5Var = this.f49956a;
        s5 s5Var = v5Var.f50120y;
        if (s5Var == null || (aVar = v5Var.f50119x) == null) {
            return false;
        }
        return r3.Q1(((a3) s5Var).f49641a, aVar, false);
    }

    @Override
    public final void H(CharSequence charSequence) {
        s5 s5Var = this.f49956a.f50120y;
        if (s5Var != null) {
            a3 a3Var = (a3) s5Var;
    ...
    public final void O(Editable editable) {
        ...
        if (v5Var.f50119x != null) {
            v5Var.E(editable);
            v5Var.J();
            v5.d(v5Var.f50119x.f49617b, editable);
            v5Var.C();
            v5Var.G();
            int i10 = 0;
            if (v5Var.o() && !v5Var.l()) {
                ((TL_iv.pageBlockBlockquote) v5Var.f50119x.f49617b).collapsed = false;
            }
            v5Var.H();
            s5 s5Var = v5Var.f50120y;
            if (s5Var != null) {
            ...
            s5 s5Var2 = v5Var.f50120y;
            if (s5Var2 != null) {
                ((a3) s5Var2).f49641a.f49980e3.F(v5Var, v5.b(editable.toString()));
            }
            String obj = editable.toString();
            a aVar2 = v5Var.f50119x;
            if (aVar2 != null && obj != null && aVar2.f49618c == 0 && (aVar2.f49617b instanceof TL_iv.pageBlockParagraph) && obj.equals("> ")) {
                i10 = 6;
            }
            if (i10 != 0 && v5Var.f50120y != null) {
                v5Var.post(new bu0(this, v5Var.f50119x, i10, 20));
            } else {
                u5 s6 = v5.s(editable.toString(), v5Var.f50119x);
                if (s6 != null && v5Var.f50120y != null) {
                    v5Var.post(new uf.h1(this, v5Var.f50119x, s6, 13));
                }
            }
            if (!v5Var.Q && ((aVar = v5Var.f50119x) == null || !(aVar.f49617b instanceof TL_iv.pageBlockPullquote))) {
                return;
            }
            v5Var.invalidate();
        }
    ...
    public final boolean T(boolean z4) {
        ...
        s5 s5Var = v5Var.f50120y;
        if (s5Var != null && (aVar = v5Var.f50119x) != null) {
            return ((a3) s5Var).f49641a.W3(aVar, z4);
        }
        return false;
    }
    ...
    public final void o(e1 e1Var) {
        ...
        Editable text;
        v5 v5Var = this.f49956a;
        if (v5Var.f50120y != null && v5Var.f50119x != null) {
            String obj = e1Var.getText().toString();
            ((a3) v5Var.f50120y).f49641a.f49980e3.F(v5Var, null);
            String b10 = v5.b(obj);
            if (b10 != null) {
            ...
            if (q10 != 0) {
                ((a3) v5Var.f50120y).c(v5Var.f50119x, q10);
                return;
            }
            u5 r10 = v5.r(e1Var.getText().toString(), v5Var.f50119x);
            if (r10 != null) {
                ((a3) v5Var.f50120y).d(v5Var.f50119x, r10.f50085a, r10.f50086b, r10.f50087c, r10.d, r10.f50088e);
            } else if ((v5Var.f50119x.f49617b instanceof TL_iv.pageBlockPullquote) && v5Var.f50114f.length() > 0) {
                v5Var.i();
            } else {
                s5 s5Var = v5Var.f50120y;
                a aVar = v5Var.f50119x;
                r3 r3Var = ((a3) s5Var).f49641a;
                ArrayList arrayList = r3Var.f49997m4;
                x51 x51Var = r3Var.V2;
                ...
                if (indexOf >= 0) {
                    ...
                    if (z10) {
                        ...
                        SpannableStringBuilder A = v5.A(aVar.f49617b);
                        length = A.length();
                    ...
                    if (pageBlock instanceof TL_iv.pageBlockBlockquote) {
                        long a10 = n0.a();
                        TL_iv.RichText richText = ((TL_iv.pageBlockBlockquote) aVar.f49617b).caption;
                        if (richText != null && !(richText instanceof TL_iv.textEmpty)) {
                            r3Var.f49990j3.put(Long.valueOf(a10), richText);
                        }
                    ...
                    a aVar2 = new a(pageblockparagraph, aVar.f49618c, i11);
                    aVar2.f49619e = aVar.f49619e;
                    aVar2.f49624k.addAll(arrayList4);
                    int i12 = indexOf + 1;
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(htmlText)) {
                        ...
                        try {
                            ...
                            if (!w42.isEmpty() && ((w42.size() != 1 || !r3.F3((a) w42.get(0))) && (indexOf = r3Var.f49988i3.indexOf(aVar)) >= 0)) {
    ...
    public final void s(e1 e1Var, int i10, int i11) {
        ...
        v5 v5Var = this.f49956a;
        if (!v5Var.C && i10 != i11 && (s5Var = v5Var.f50120y) != null && (textSelectionHelper = ((a3) s5Var).f49641a.getTextSelectionHelper()) != null) {
    ...
    public final void v() {
        ...
        s5 s5Var = v5Var.f50120y;
        if (s5Var != null && (aVar = v5Var.f50119x) != null) {
            r3.Q1(((a3) s5Var).f49641a, aVar, true);
        }
    }
}
