...
public final class q1 implements my {
    ...
    public final void t(ArrayList arrayList) {
        this.f49972a.presentFragment(new StickersActivity(5, arrayList));
    }

    @Override
    public final void w() {
        this.f49972a.presentFragment(new StickersActivity(0, null));
    }
