...
public final class o4 extends z implements b6, l9, j0 {
    ...
    public boolean V;
    public float W;
    public float f49902a0;
    public int f49903b0;
    public int f49904c0;
    public int f49905d0;
    public VelocityTracker f49906e0;
    public ValueAnimator f49907f0;
    public final Path f49908g0;
    public final g6 f49909n;
    public final Paint f49910r;
    public final Paint f49911s;
    public final i0 v;
    public final ImageView f49912w;
    public final ImageView f49913x;
    public final ArrayList f49914y;

    public o4(Context context, g6 g6Var) {
        super(context);
        boolean z4;
        this.f49910r = new Paint(1);
        this.f49911s = new Paint(1);
        this.f49914y = new ArrayList();
    ...
    private void settle(float f10) {
        ...
        if (f10 >= 0.0f || this.T >= size - 1) {
            ...
            this.f49907f0 = ofFloat;
            ofFloat.setDuration(220L);
            this.f49907f0.setInterpolator(pr.h);
            this.f49907f0.addUpdateListener(new oh.f5(this, 26));
            this.f49907f0.addListener(new org.telegram.ui.Cells.b4(this, i12, 11));
            this.f49907f0.start();
        }
        i10 = 1;
        int i112 = this.T;
        ...
        this.f49907f0 = ofFloat2;
        ofFloat2.setDuration(220L);
        this.f49907f0.setInterpolator(pr.h);
        this.f49907f0.addUpdateListener(new oh.f5(this, 26));
        this.f49907f0.addListener(new org.telegram.ui.Cells.b4(this, i122, 11));
        this.f49907f0.start();
    }
    ...
    public final void e() {
        int i10 = k6.Gd;
        g6 g6Var = this.f49909n;
        this.f49910r.setColor(k6.v0(i10, g6Var));
        this.f49911s.setColor(k6.v0(k6.f21970uf, g6Var));
        i0 i0Var = this.v;
        if (i0Var != null) {
            i0Var.a();
        }
    ...
    public final void j(Canvas canvas) {
        ...
        a aVar2 = o4Var.f50174a;
        if (aVar2 == null) {
            size2 = 0;
        } else {
            size2 = aVar2.f49623k.size();
        }
        if (size2 > 0) {
        ...
        if (size3 == 1 && arrayList2.size() == 1) {
            ...
            if (rectF.left > 0.5f || rectF.right < max - 0.5f) {
                ...
                ImageReceiver imageReceiver = r4Var.f50014b;
                if (r4Var.b()) {
                    imageReceiver.setImageCoords(rectF2);
                    imageReceiver.setAlpha(r4Var.f50013a.getCurrentAlpha());
        ...
        while (i18 < arrayList.size() && i18 < arrayList2.size()) {
            ...
            if (z4) {
                ...
                r4Var2.f50013a.setRoundRadius(i11, i12, i13, i14);
                r4Var2.f50014b.setRoundRadius(i11, i12, i13, i14);
            } else {
                r4Var2.f50013a.setRoundRadius(i16, i16, i16, i16);
                r4Var2.f50014b.setRoundRadius(i16, i16, i16, i16);
            }
            boolean c3 = r4Var2.c();
            ImageReceiver imageReceiver2 = r4Var2.f50013a;
            if (!c3) {
            ...
            if (tVar != null && tVar.a()) {
                ...
                radialProgress2.o(r4Var2.f50016e.f50033f, true);
                radialProgress2.draw(canvas2);
            }
            t tVar2 = r4Var2.f50016e;
            if (tVar2 != null && tVar2.f50040n && r4Var2.c()) {
                jh.j spoilerEffect = o4Var.getSpoilerEffect();
                ImageReceiver imageReceiver3 = r4Var2.f50014b;
                canvas2.save();
    ...
    public final void k(int i10) {
        if (this.K != null && this.f50174a != null) {
            List m9 = m();
            if (!m9.isEmpty() && (m9.size() != 1 || ((t) m9.get(0)).f50029a != 0)) {
                if (i10 >= 0 && i10 < m9.size() && ((t) m9.get(i10)).a()) {
                    r3.N1(this.f50174a, (t) m9.get(i10), this.K.f49827a);
                    return;
                }
                return;
            }
    ...
    public final boolean l() {
        a aVar = this.f50174a;
        if (aVar != null && (aVar.f49616b instanceof TL_iv.pageBlockSlideshow)) {
            return true;
        }
        return false;
    }
    ...
    public final void n() {
        ...
        List m9 = m();
        while (true) {
            arrayList = this.f49914y;
            if (arrayList.size() >= m9.size()) {
                break;
            }
            r4 r4Var = new r4(this, this.f49909n);
            if (this.L) {
                r4Var.f50013a.onAttachedToWindow();
                r4Var.f50014b.onAttachedToWindow();
                r4Var.a();
            }
            arrayList.add(r4Var);
        }
        while (arrayList.size() > m9.size()) {
            ...
            r4Var2.f50013a.onDetachedFromWindow();
            r4Var2.f50014b.onDetachedFromWindow();
            r4Var2.f50015c = null;
        }
        for (int i10 = 0; i10 < m9.size(); i10++) {
            r4 r4Var3 = (r4) arrayList.get(i10);
            r4Var3.f50016e = (t) m9.get(i10);
            r4Var3.a();
        }
        while (true) {
            arrayList2 = this.B;
        ...
        this.f49912w.bringToFront();
        this.f49913x.bringToFront();
        ...
        if (this.J != null) {
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                t tVar = ((r4) arrayList.get(i11)).f50016e;
                if (tVar != null && tVar.f50040n) {
                    return;
                }
            }
            this.J.b(this);
    ...
    public final void o(boolean z4) {
        ...
        ImageView imageView = this.f49913x;
    ...
    public final void onAttachedToWindow() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList = this.f49914y;
    ...
    public final void onDetachedFromWindow() {
        ...
        VelocityTracker velocityTracker = this.f49906e0;
        ...
        while (true) {
            ...
            r4 r4Var = (r4) arrayList.get(i10);
            r4Var.f50013a.onDetachedFromWindow();
            r4Var.f50014b.onDetachedFromWindow();
            r4Var.f50015c = null;
            i10++;
        }
        jh.j jVar = this.J;
        ...
        ValueAnimator valueAnimator = this.f49907f0;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (arrayList.size() >= 2 && f13 > 0.001f) {
            if (f49901h0 == null) {
                ...
                f49901h0 = paint;
                paint.setColor(-1);
                f49901h0.setShadowLayer(AndroidUtilities.dpf2(3.0f), 0.0f, AndroidUtilities.dpf2(1.0f), Integer.MIN_VALUE);
            }
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                f49901h0.setAlpha((int) e2.c.y(max2, 95.0f, 160.0f, f13));
                canvas.drawCircle(AndroidUtilities.dp(f12) + dp2 + (AndroidUtilities.dp(f10) * i10), dp3, (AndroidUtilities.dp(1.0f) * max2) + AndroidUtilities.dp(2.0f), f49901h0);
            }
            canvas.restore();
        }
        k3 k3Var = this.K;
        if (k3Var != null && (textSelectionHelper = k3Var.f49827a.getTextSelectionHelper()) != null && textSelectionHelper.y() && (getParent() instanceof RecyclerView)) {
            ((RecyclerView) getParent()).getClass();
            int R = RecyclerView.R(this);
            if (R >= 0 && R > textSelectionHelper.f23175u0 && R <= textSelectionHelper.f23178x0) {
                canvas.drawRect(getPaddingLeft(), paddingTop, getWidth() - getPaddingRight(), paddingTop + this.M, this.f49911s);
            }
        }
        if (this.E && (dVar = this.F) != null && Build.VERSION.SDK_INT >= 31) {
            ...
            if (width > 0 && height > 0) {
                ...
                while (true) {
                    ...
                    imageView = this.f49913x;
                    imageView2 = this.f49912w;
                    if (i11 >= size2) {
                        break;
                    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        while (true) {
            ...
            if (i19 < arrayList.size()) {
                ...
                int i20 = 8;
                if (i19 < m9.size() && ((t) m9.get(i19)).f50029a != 0) {
            ...
            if (arrayList.size() >= 2) {
                if (actionMasked == 0) {
                    ...
                    if (this.f49903b0 == 0) {
                        ...
                        this.f49903b0 = viewConfiguration.getScaledTouchSlop();
                        this.f49904c0 = viewConfiguration.getScaledMinimumFlingVelocity();
                        this.f49905d0 = viewConfiguration.getScaledMaximumFlingVelocity();
                    }
                    this.W = x10;
                    this.f49902a0 = y10;
                    this.V = false;
                    VelocityTracker velocityTracker2 = this.f49906e0;
                    if (velocityTracker2 == null) {
                        this.f49906e0 = VelocityTracker.obtain();
                    } else {
                        velocityTracker2.clear();
                    }
                    this.f49906e0.addMovement(motionEvent);
                    if (getParent() != null) {
                ...
                float f10 = 0.0f;
                if (actionMasked == 2) {
                    VelocityTracker velocityTracker3 = this.f49906e0;
                    if (velocityTracker3 != null) {
                        velocityTracker3.addMovement(motionEvent);
                    }
                    float f11 = x10 - this.W;
                    float f12 = y10 - this.f49902a0;
                    if (!this.V && Math.abs(f11) > this.f49903b0 && Math.abs(f11) > Math.abs(f12)) {
                        this.V = true;
                        this.Q = -1;
                    }
                    if (this.V) {
                    ...
                    if (actionMasked == 1 && (velocityTracker = this.f49906e0) != null) {
                        velocityTracker.addMovement(motionEvent);
                        this.f49906e0.computeCurrentVelocity(1000, this.f49905d0);
                        float xVelocity = this.f49906e0.getXVelocity();
                        float yVelocity = this.f49906e0.getYVelocity();
                        if (Math.abs(xVelocity) >= this.f49904c0 && Math.abs(xVelocity) > Math.abs(yVelocity)) {
                            f10 = xVelocity;
                        }
                    }
                    VelocityTracker velocityTracker4 = this.f49906e0;
