...
public abstract class x3 {
    ...
    public static void F(StringBuilder sb, List list, int[] iArr, int i10, int i11, int i12, int i13, int i14, oh.h4 h4Var, boolean z4, int i15, Map map) {
        ...
        oh.h4 h4Var2 = h4Var;
        int i18 = i15;
        ArrayList arrayList = (ArrayList) h4Var2.f17180b;
        while (true) {
            int i19 = iArr[0];
            if (i19 > i17) {
                return;
                            ...
                            if (pageBlock instanceof TL_iv.pageBlockDivider) {
                                ...
                                if (pageBlock instanceof TL_iv.pageBlockPhoto) {
                                    ...
                                    if (r3.B3(pageBlock)) {
                                        ...
                                        if (pageblockmap.f21066w != 0) {
                                            sb2.append(" w=\"");
                                            sb2.append(pageblockmap.f21066w);
                                            sb2.append('\"');
                                        }
                                        if (pageblockmap.h != 0) {
                                            sb2.append(" h=\"");
    ...
    public static void j(SpannableStringBuilder spannableStringBuilder, String str, int i10, String str2, long j10) {
        if (str != null && str.length() != 0) {
            ...
            if (i10 != 0) {
                ?? obj = new Object();
                obj.f31225a = i10 & 114975;
                spannableStringBuilder.setSpan(new u01(obj, AndroidUtilities.dp(SharedConfig.fontSize)), length, length2, 33);
            }
            if (str2 != null) {
