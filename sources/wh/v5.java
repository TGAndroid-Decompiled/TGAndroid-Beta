...
public final class v5 extends FrameLayout implements b6, l9 {
    ...
    public final g6 f50146a;
    public final LinearLayout f50147b;
    public final View f50148c;
    public final fg.s0 d;
    public final nw0 f50149e;
    public final e1 f50150f;
    public final e1 h;
    public boolean f50151n;
    public final ArrayList f50152r;
    public LinearLayout f50153s;
    public TextView v;
    public ImageView f50154w;
    public a f50155x;
    public s5 f50156y;

    public v5(Context context, g6 g6Var) {
        super(context);
        this.f50152r = new ArrayList();
        this.J = new RectF();
        this.N = -1;
        this.O = -1;
        this.R = new Paint(1);
        ...
        e1Var.setDelegate(new vt(this) {
            ...
            public final void b0() {
                switch (r2) {
                    case 0:
                        v5 v5Var = this.f49953b;
                        if (!v5Var.P && v5Var.f50155x != null) {
                            v5Var.J();
                            v5.d(v5Var.f50155x.f49653b, v5Var.f50150f.getText());
                            s5 s5Var = v5Var.f50156y;
                            if (s5Var != null) {
                                r3.N1(((a3) s5Var).f49677a);
                                return;
                            }
                            return;
                        }
                        return;
                    default:
                        v5 v5Var2 = this.f49953b;
                        if (v5Var2.f50155x != null) {
                            v5Var2.w();
                            s5 s5Var2 = v5Var2.f50156y;
                            if (s5Var2 != null) {
                                r3.N1(((a3) s5Var2).f49677a);
                                return;
                            }
                            return;
                        }
    ...
    public static void a(v5 v5Var, boolean z4) {
        s5 s5Var;
        v5Var.f50150f.setHint(v5Var.getHint());
        if (!z4 && (s5Var = v5Var.f50156y) != null) {
            ((a3) s5Var).f49677a.f50016e3.F(v5Var, null);
        }
    }
    ...
    public static u5 r(String str, a aVar) {
        ...
        if (str != null && aVar != null) {
            ...
            if (lowerCase.length() == 3 && lowerCase.charAt(0) == '/' && lowerCase.charAt(1) == 'h' && (charAt = lowerCase.charAt(2)) >= '1' && charAt <= '6') {
                return new u5(v(charAt - '0'), aVar.f49654c, aVar.d);
            }
        ...
        if (aVar != null && str != null && (length = str.length()) >= 2) {
            ...
            if (str.charAt(i10) == ' ') {
                ...
                if (str.charAt(0) == '#' && (z10 || z4)) {
                    ...
                    if (i11 >= 1 && i11 <= 6) {
                        return new u5(v(i11), aVar.f49654c, aVar.d);
                    }
                    return null;
                } else if (z10) {
                    if (aVar.f49654c == 0 && length == 2) {
                    ...
                    if (aVar.f49654c == 0 && length == 3 && str.charAt(0) == '[' && str.charAt(1) == ']') {
                        return t(false);
                    }
                    if (aVar.f49654c == 0 && length == 4 && str.charAt(0) == '[' && str.charAt(2) == ']') {
                    ...
                    if (aVar.f49654c == 0 && length == 3 && Character.isDigit(str.charAt(0)) && ((charAt = str.charAt(1)) == '.' || charAt == ')')) {
                        TL_iv.pageBlockParagraph pageblockparagraph2 = new TL_iv.pageBlockParagraph();
                        f(pageblockparagraph2, "");
                        return new u5(pageblockparagraph2, 1, 1);
                    } else if (aVar.f49654c == 0 && length == 4) {
    ...
    public final void C() {
        ...
        this.F++;
        Editable text = this.f50150f.getText();
        if (text != null) {
    ...
    public final void D(l0 l0Var) {
        if (this.f50156y != null && this.f50155x != null && l0Var != null) {
            List<String> list = l0Var.f49885c;
            if (!list.isEmpty()) {
                for (String str : list) {
                    int q10 = q(str);
                    if (q10 != 0) {
                        ((a3) this.f50156y).c(this.f50155x, q10);
                        return;
                    }
                    u5 r10 = r(str, this.f50155x);
                    if (r10 == null) {
                        r10 = s(w.c.e(str, " "), this.f50155x);
                        continue;
                    }
                    if (r10 != null) {
                        ((a3) this.f50156y).d(this.f50155x, r10.f50121a, r10.f50122b, r10.f50123c, r10.d, r10.f50124e);
                        return;
                    }
                }
            }
    ...
    public final void E(Editable editable) {
        ...
        a aVar = this.f50155x;
        if (aVar != null && r3.B3(aVar.f49653b) && e2.c.s(editable)) {
            e1 e1Var = this.f50150f;
    ...
    public final void F() {
        s5 s5Var;
        a aVar = this.f50155x;
        if (aVar != null && aVar.f49654c > 0 && (s5Var = this.f50156y) != null) {
            int b10 = ((a3) s5Var).b(aVar);
            int a2 = ((a3) this.f50156y).a(this.f50155x);
            a aVar2 = this.f50155x;
            if (aVar2.f49663n) {
                int i10 = aVar2.f49661l;
                if (i10 <= 0) {
                    b10 = 0;
                } else {
            ...
            a aVar3 = this.f50155x;
            if (aVar3.f49664o) {
                int i11 = aVar3.f49662m;
                if (i11 <= 0) {
                    a2 = 0;
                } else {
    ...
    public final void G() {
        ...
        e1 e1Var = this.f50150f;
        e1 e1Var2 = this.h;
        if (aVar != null && p(aVar.f49653b) && (e1Var.length() > 0 || e1Var2.length() > 0)) {
    ...
    public final void H() {
        ...
        if (e1Var.getText() != null) {
            ...
            int i11 = -1;
            if (!o() || !((TL_iv.pageBlockBlockquote) this.f50155x.f49653b).collapsed || (layout = e1Var.getLayout()) == null || layout.getLineCount() <= 3 || (lineStart = layout.getLineStart(3)) >= (i10 = text.length())) {
                i10 = -1;
            } else {
                i11 = lineStart;
            }
    ...
    public final void I(TL_iv.PageBlock pageBlock, boolean z4) {
        float f10;
        if (!(pageBlock instanceof TL_iv.pageBlockPreformatted)) {
            LinearLayout linearLayout = this.f50153s;
        ...
        LinearLayout linearLayout2 = this.f50153s;
        if (linearLayout2 != null && z4) {
            AndroidUtilities.removeFromParent(linearLayout2);
            this.f50153s = null;
        }
        LinearLayout linearLayout3 = this.f50153s;
        g6 g6Var = this.f50146a;
        if (linearLayout3 == null) {
            LinearLayout linearLayout4 = new LinearLayout(getContext());
            this.f50153s = linearLayout4;
            linearLayout4.setOrientation(0);
            this.f50153s.setBackground(k6.Y(k6.v0(k6.f21752i6, g6Var), AndroidUtilities.dp(3.0f), AndroidUtilities.dp(3.0f)));
            this.f50153s.setPadding(AndroidUtilities.dp(6.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f), AndroidUtilities.dp(2.0f));
            addView(this.f50153s, c6.d(-2, -2.0f, 53, 0.0f, -15.0f, -5.0f, 0.0f));
            TextView textView = new TextView(getContext());
            this.v = textView;
            textView.setTextSize(1, 12.0f);
            this.v.setGravity(17);
            this.f50153s.addView(this.v, c6.t(-2, -2, 16, 0, 0, 0, 0));
            ImageView imageView = new ImageView(getContext());
            this.f50154w = imageView;
            imageView.setImageResource(R.drawable.arrows_select);
            this.f50153s.addView(this.f50154w, c6.r(16, 16, 16, 0.0f, 0.66f, 0.0f, 0.0f));
            CodeHighlighting.prepare();
            this.f50153s.setOnClickListener(new n5(this, 1));
            this.f50153s.setOnLongClickListener(new Object());
        }
        ...
        this.f50154w.setColorFilter(new PorterDuffColorFilter(l1, PorterDuff.Mode.SRC_IN));
    ...
    public final void c(a aVar) {
        ...
        nw0 nw0Var = this.f50149e;
        View view = this.f50148c;
        fg.s0 s0Var = this.d;
        if (i13 <= 0) {
        ...
        if (aVar.f49655e) {
            ...
            ((CheckBoxBase) nw0Var.f39471b).f(-1, aVar.f49656f, false);
            return;
        }
        nw0Var.setVisibility(8);
        ...
        if (aVar.d == 0) {
            ...
            s5 s5Var = this.f50156y;
            if (s5Var != null) {
                TextPaint paint = s0Var.getPaint();
                ArrayList arrayList = ((a3) s5Var).f49677a.f50024i3;
                int indexOf = arrayList.indexOf(aVar);
                if (indexOf >= 0 && (i11 = aVar.f49654c) > 0 && aVar.d > 0) {
                    int i14 = indexOf;
                    while (i14 > 0) {
                        a aVar3 = (a) arrayList.get(i14 - 1);
                        int i15 = aVar3.f49654c;
                    ...
                    int i16 = indexOf + 1;
                    while (i16 < arrayList.size() && (i12 = (aVar2 = (a) arrayList.get(i16)).f49654c) >= i11 && (i12 != i11 || aVar2.d > 0)) {
                        i16++;
                    }
                    ...
                    while (i14 < i16) {
                        ...
                        if (aVar4.f49654c == i11 && aVar4.d > 0) {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int dp2;
        a aVar = this.f50155x;
        LinearLayout linearLayout = this.f50147b;
        Paint paint = this.R;
        g6 g6Var = this.f50146a;
        e1 e1Var2 = this.f50150f;
        if (aVar != null && (aVar.f49653b instanceof TL_iv.pageBlockPreformatted)) {
            paint.setColor(k6.v0(k6.xk, g6Var));
            int c3 = l8.c(this.f50155x);
            int d = l8.d(this.f50155x);
            int width = getWidth();
            if (c3 <= 0 && d <= 0) {
                i10 = 0;
            } else {
            ...
            e1Var = e1Var2;
            if (aVar != null && (aVar.f49653b instanceof TL_iv.pageBlockBlockquote)) {
                if (this.G == null) {
                    am0 am0Var = new am0(this);
                    this.G = am0Var;
                    am0Var.a(null, null, null, this.f50146a, 1);
                    l8.a(this.G, g6Var);
                }
                ...
                canvas2 = canvas;
                if (aVar != null && (aVar.f49653b instanceof TL_iv.pageBlockPullquote)) {
                    if (this.G == null) {
                        am0 am0Var2 = new am0(this);
                        this.G = am0Var2;
                        am0Var2.a(null, null, null, this.f50146a, 1);
                        l8.a(this.G, g6Var);
                    }
                    if (this.H == null) {
        ...
        s5 s5Var = this.f50156y;
        if (s5Var != null) {
            m9Var = ((a3) s5Var).f49677a.getTextSelectionHelper();
        } else {
            m9Var = null;
        }
        if (m9Var != null) {
            ArrayList arrayList = this.f50152r;
            arrayList.clear();
        ...
        this.I.a(canvas2, this.J, org.telegram.messenger.y3.B(16.0f, getWidth(), dp), B, v02, ((TL_iv.pageBlockBlockquote) this.f50155x.f49653b).collapsed, l());
    }
        ...
        if (l() && this.I != null) {
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    ...
                    this.I.b(false);
                    if (contains && o()) {
                        TL_iv.pageBlockBlockquote pageblockblockquote = (TL_iv.pageBlockBlockquote) this.f50155x.f49653b;
    ...
    public final int h(int i10, int i11) {
        ...
        if (l()) {
            ...
            if (e1Var.getVisibility() == 0 && (layout = e1Var.getLayout()) != null && layout.getLineCount() > 0) {
                ...
                int measuredHeight = this.f50147b.getMeasuredHeight() + getPaddingTop();
                ...
                this.I.getClass();
                float B = org.telegram.messenger.y3.B(16.0f, i10, dp2) - org.telegram.messenger.y3.D(3.333f, 2, AndroidUtilities.dp(23.66f) + ti0Var.f31360c);
                this.I.getClass();
                int i12 = i11 - dp2;
    ...
    public final boolean l() {
        Layout layout;
        if (!o() || (layout = this.f50150f.getLayout()) == null || layout.getLineCount() <= 3) {
            return false;
        }
        return true;
    }
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable)) {
            ti0 ti0Var = this.I;
            if (ti0Var != null) {
                if (drawable != ti0Var.f31359b && drawable != ti0Var.f31361e) {
                    return false;
                }
                return true;
            }
    ...
    public final void w() {
        a aVar = this.f50155x;
        if (aVar != null && p(aVar.f49653b)) {
            TL_iv.PageBlock pageBlock = this.f50155x.f49653b;
    ...
    public final void x() {
        a aVar = this.f50155x;
        if (aVar != null) {
            d(aVar.f49653b, this.f50150f.getText());
        }
    }
}
