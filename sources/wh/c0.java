...
public final class c0 extends View {
    public final RichMessageLayout.RichButton f49679a;
    public final int f49680b;
    public boolean f49681c;
    public boolean d;
    public final e8 f49682e;
    public final f0 f49683f;

    public c0(f0 f0Var, Context context, TL_keyboard.PageButton pageButton, int i10) {
        super(context);
        this.f49683f = f0Var;
        this.f49680b = i10;
        RichMessageLayout.RichButton createEditorPageButton = RichMessageLayout.createEditorPageButton(f0Var.f49735n, l.d.c(32.0f, AndroidUtilities.displaySize.x, AndroidUtilities.dp(240.0f)), f0Var.f49736r, pageButton, new v9(this, 28));
        this.f49679a = createEditorPageButton;
        this.f49682e = new e8(this, i10, 5);
    ...
    public final void onAttachedToWindow() {
        ...
        this.f49679a.attach(this);
    }

    @Override
    public final void onDetachedFromWindow() {
        AndroidUtilities.cancelRunOnUIThread(this.f49682e);
        this.f49679a.detach(this);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        RichMessageLayout.RichButton richButton = this.f49679a;
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                richButton.setPressed(false);
                AndroidUtilities.cancelRunOnUIThread(e8Var);
                if (z4 && (d0Var = (f0Var = this.f49683f).B) != null && (aVar = f0Var.f50174a) != null) {
