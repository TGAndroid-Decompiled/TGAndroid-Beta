...
public final class t2 implements Utilities.Callback2 {
    ...
    public final h4 f44357b;
    public final String[] f44358c;
    public final ArrayList d;

    public t2(h4 h4Var, String[] strArr, ArrayList arrayList, int i10) {
        this.f44356a = i10;
        this.f44357b = h4Var;
        this.f44358c = strArr;
        this.d = arrayList;
    ...
    public final void run(Object obj, Object obj2) {
        ...
        String[] strArr = this.f44358c;
        h4 h4Var = this.f44357b;
        switch (i10) {
            case 0:
                ...
                u3 u3Var = h4Var.d;
                boolean isEmpty = u3Var.f44376l.isEmpty();
                ...
                while (i11 < size) {
                    ...
                    boolean contains = u3Var.f44376l.contains(Long.valueOf(stargiftattributepattern.document.f17201id));
                    ...
                    if (TextUtils.isEmpty(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(lowerCase) || stargiftattributepattern.name.toLowerCase().startsWith(translitSafe) || org.telegram.messenger.a2.w(" ", lowerCase, stargiftattributepattern.name.toLowerCase()) || org.telegram.messenger.a2.w(" ", translitSafe, stargiftattributepattern.name.toLowerCase())) {
                        Integer num = (Integer) u3Var.f44379o.get(Long.valueOf(stargiftattributepattern.document.f17201id));
                        if (num == null) {
                            intValue = 0;
                        } else {
            ...
            default:
                ...
                u3 u3Var3 = h4Var.d;
                boolean isEmpty3 = u3Var3.f44374j.isEmpty();
                ...
                while (i15 < size3) {
                    ...
                    boolean contains3 = u3Var3.f44374j.contains(Long.valueOf(stargiftattributemodel.document.f17201id));
                    boolean z12 = !contains3;
                    if (!TextUtils.isEmpty(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(lowerCase3) && !stargiftattributemodel.name.toLowerCase().startsWith(translitSafe3) && !org.telegram.messenger.a2.w(str3, lowerCase3, stargiftattributemodel.name.toLowerCase()) && !org.telegram.messenger.a2.w(str3, translitSafe3, stargiftattributemodel.name.toLowerCase())) {
                        str2 = str3;
                    } else {
                        str2 = str3;
                        Integer num3 = (Integer) u3Var3.f44377m.get(Long.valueOf(stargiftattributemodel.document.f17201id));
                        if (num3 == null) {
                            intValue3 = 0;
                        } else {
