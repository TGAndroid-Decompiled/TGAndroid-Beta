...
public final class u4 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final TLRPC.Document f50079r;
    public final t4 f50080s;
    public boolean v;
    public boolean f50081w;
    public boolean f50082x;
    public int f50083y;
    ...
    public final void a(String str) {
        int i10;
        boolean z4;
        if (!this.f50081w && !this.f50082x) {
            this.B = str;
            NotificationCenter notificationCenter = NotificationCenter.getInstance(this.f50073a);
            ...
            if (this.f50075c) {
                ...
                i10 = 50331648;
            } else if (this.f50076e) {
                i10 = 67108864;
            } else {
                i10 = 16777216;
            }
            FileLoader fileLoader = FileLoader.getInstance(this.f50073a);
            String str2 = this.B;
            if (!this.f50075c && !this.d && !this.f50076e) {
                z4 = true;
            } else {
                z4 = false;
            }
    ...
    public final void b() {
        if (!this.f50082x && !this.f50081w) {
            this.f50081w = true;
            try {
                if (this.B != null) {
                    FileLoader.getInstance(this.f50073a).cancelFileUpload(this.B, false);
                }
            } catch (Throwable unused) {
            }
            if (this.f50083y != 0) {
                ConnectionsManager.getInstance(this.f50073a).cancelRequest(this.f50083y, true);
                this.f50083y = 0;
            }
            e();
        }
    ...
    public final void c(TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2) {
        ...
        if (this.f50075c) {
            ...
            tL_documentAttributeVideo.duration = this.f50078n;
            tL_documentAttributeVideo.f20850w = this.f50077f;
            tL_documentAttributeVideo.h = this.h;
            tL_inputMediaUploadedDocument.attributes.add(tL_documentAttributeVideo);
            tL_messages_uploadMedia.media = tL_inputMediaUploadedDocument;
        } else {
            boolean z4 = this.d;
            boolean z10 = this.f50076e;
            if (!z4 && !z10) {
                ...
                TLRPC.Document document = this.f50079r;
                if (z10) {
        ...
        this.f50083y = ConnectionsManager.getInstance(this.f50073a).sendRequest(tL_messages_uploadMedia, new gf.a(this, 29));
    }

    public final void d() {
        int i10;
        int i11;
        if (!this.v && !this.f50081w && !this.f50082x) {
            this.v = true;
            if (this.f50075c) {
                t4 t4Var = this.f50080s;
                int i12 = this.f50077f;
                ...
                try {
                    ...
                    BitmapFactory.decodeFile(this.f50074b, options);
                    int i13 = options.outWidth;
                    if (i13 > 0 && (i10 = options.outHeight) > 0) {
                        this.f50080s.a(i13, i10);
                    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i11 == this.f50073a && !this.f50081w && !this.f50082x) {
            String str = (String) objArr[0];
            if (this.B != null && this.B.equals(str)) {
                if (i10 == NotificationCenter.fileUploaded) {
                    TLRPC.InputFile inputFile2 = (TLRPC.InputFile) objArr[1];
                    if (this.f50076e && !this.E && !TextUtils.isEmpty(this.C)) {
                        this.D = inputFile2;
                        this.E = true;
                        this.B = this.C;
                        FileLoader.getInstance(this.f50073a).uploadFile(this.B, false, true, 16777216);
                    } else if (this.f50076e && this.E) {
                        c(this.D, inputFile2);
                    } else {
                        c(inputFile2, null);
                    }
                } else if (i10 == NotificationCenter.fileUploadFailed) {
                    if (this.f50076e && this.E && (inputFile = this.D) != null) {
                        c(inputFile, null);
                        return;
                    }
                    this.f50082x = true;
                    e();
                    this.f50080s.onError();
