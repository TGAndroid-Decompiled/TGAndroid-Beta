...
public final class y0 extends x0 implements j0 {
    public final Executor f51648c;

    public y0(Executor executor) {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor;
        Method method;
        this.f51648c = executor;
    ...
    public final o0 a(long j3, e2 e2Var, id.h hVar) {
        ...
        Executor executor = this.f51648c;
        ...
        return f0.f51581s.a(j3, e2Var, hVar);
    }
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof y0) && ((y0) obj).f51648c == this.f51648c) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return System.identityHashCode(this.f51648c);
    }

    @Override
    public final String toString() {
        return this.f51648c.toString();
    }
}
