...
public final class y0 extends x0 implements j0 {
    public final Executor f48947c;

    public y0(Executor executor) {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor;
        Method method;
        this.f48947c = executor;
        Method method2 = ee.c.f8171a;
        try {
            ...
            if (scheduledThreadPoolExecutor != null && (method = ee.c.f8171a) != null) {
    ...
    public final o0 a(long j3, e2 e2Var, id.h hVar) {
        ...
        Executor executor = this.f48947c;
        ...
        return f0.f48892s.a(j3, e2Var, hVar);
    }
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof y0) && ((y0) obj).f48947c == this.f48947c) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return System.identityHashCode(this.f48947c);
    }

    @Override
    public final String toString() {
        return this.f48947c.toString();
    }
}
