...
public final class y0 extends x0 implements j0 {
    public final Executor f51618c;

    public y0(Executor executor) {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor;
        Method method;
        this.f51618c = executor;
        Method method2 = ee.c.f9066a;
        try {
            ...
            if (scheduledThreadPoolExecutor != null && (method = ee.c.f9066a) != null) {
    ...
    public final o0 a(long j3, e2 e2Var, id.h hVar) {
        ...
        Executor executor = this.f51618c;
        ...
        return f0.f51551s.a(j3, e2Var, hVar);
    }
    ...
    public final void c(id.h hVar, Runnable runnable) {
        try {
            this.f51618c.execute(runnable);
        } catch (RejectedExecutionException e7) {
            CancellationException cancellationException = new CancellationException("The task was rejected");
            cancellationException.initCause(e7);
            e0.e(hVar, cancellationException);
            m0.f51572b.c(hVar, runnable);
        }
    }
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof y0) && ((y0) obj).f51618c == this.f51618c) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return System.identityHashCode(this.f51618c);
    }

    @Override
    public final String toString() {
        return this.f51618c.toString();
    }
}
