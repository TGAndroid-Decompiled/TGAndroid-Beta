...
public final class y0 extends x0 implements j0 {
    public final Executor f49219c;

    public y0(Executor executor) {
        ScheduledThreadPoolExecutor scheduledThreadPoolExecutor;
        Method method;
        this.f49219c = executor;
        Method method2 = ee.c.f8158a;
        try {
            ...
            if (scheduledThreadPoolExecutor != null && (method = ee.c.f8158a) != null) {
    ...
    public final o0 a(long j3, e2 e2Var, id.h hVar) {
        ...
        Executor executor = this.f49219c;
        ...
        return f0.f49164s.a(j3, e2Var, hVar);
    }
    ...
    public final void c(id.h hVar, Runnable runnable) {
        try {
            this.f49219c.execute(runnable);
        } catch (RejectedExecutionException e) {
            CancellationException cancellationException = new CancellationException("The task was rejected");
            cancellationException.initCause(e);
            e0.e(hVar, cancellationException);
            m0.f49181b.c(hVar, runnable);
        }
    }
    ...
    public final boolean equals(Object obj) {
        if ((obj instanceof y0) && ((y0) obj).f49219c == this.f49219c) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return System.identityHashCode(this.f49219c);
    }

    @Override
    public final String toString() {
        return this.f49219c.toString();
    }
}
