...
public abstract class v0 extends w0 implements j0 {
    ...
    public static final AtomicReferenceFieldUpdater f51640n = AtomicReferenceFieldUpdater.newUpdater(v0.class, Object.class, "_delayed$volatile");
    public static final AtomicIntegerFieldUpdater f51641r = AtomicIntegerFieldUpdater.newUpdater(v0.class, "_isCompleted$volatile");
    ...
    public o0 a(long j3, e2 e2Var, id.h hVar) {
        return g0.f51587a.a(j3, e2Var, hVar);
    }
    ...
    public final void o(long j3, t0 t0Var) {
        int c10;
        Thread g10;
        int i10 = f51641r.get(this);
        t0 t0Var2 = null;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f51640n;
        if (i10 != 0) {
            c10 = 1;
        } else {
