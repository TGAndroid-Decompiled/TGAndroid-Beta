...
public abstract class v0 extends w0 implements j0 {
    ...
    public static final AtomicReferenceFieldUpdater f48932n = AtomicReferenceFieldUpdater.newUpdater(v0.class, Object.class, "_delayed$volatile");
    public static final AtomicIntegerFieldUpdater f48933r = AtomicIntegerFieldUpdater.newUpdater(v0.class, "_isCompleted$volatile");
    ...
    public o0 a(long j3, e2 e2Var, id.h hVar) {
        return g0.f48890a.a(j3, e2Var, hVar);
    }
    ...
    public final void o(long j3, t0 t0Var) {
        int c10;
        Thread g10;
        int i10 = f48933r.get(this);
        t0 t0Var2 = null;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f48932n;
        if (i10 != 0) {
            c10 = 1;
        } else {
    ...
    public void shutdown() {
        ...
        long nanoTime = System.nanoTime();
        while (true) {
            u0 u0Var = (u0) f48932n.get(this);
            if (u0Var != null) {
                synchronized (u0Var) {
                    if (ee.y.f8203b.get(u0Var) > 0) {
                        t0Var = u0Var.d(0);
                    } else {
                        t0Var = null;
                    }
