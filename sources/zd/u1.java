...
public class u1 implements f1, r, y1 {
    public static final AtomicReferenceFieldUpdater f48928a = AtomicReferenceFieldUpdater.newUpdater(u1.class, Object.class, "_state$volatile");
    public static final AtomicReferenceFieldUpdater f48929b = AtomicReferenceFieldUpdater.newUpdater(u1.class, Object.class, "_parentHandle$volatile");
    ...
    public static q D(ee.k kVar) {
        while (kVar.h()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = ee.k.f8185b;
            ee.k d = kVar.d();
            if (d == null) {
    ...
    public final void H(k1 k1Var) {
        ...
        ee.k kVar = new ee.k();
        k1Var.getClass();
        ee.k.f8185b.set(kVar, k1Var);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = ee.k.f8184a;
        ...
        ee.k g10 = k1Var.g();
        do {
            atomicReferenceFieldUpdater = f48928a;
    ...
    public final int I(Object obj) {
        ...
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f48928a;
        if (z10) {
            if (!((q0) obj).f48913a) {
                q0 q0Var = e0.f48880j;
    ...
    public final Object K(Object obj, Object obj2) {
        ...
        synchronized (n1Var) {
            ...
            n1.f48907b.set(n1Var, 1);
            if (n1Var != a1Var2) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f48928a;
            ...
            if (qVar2 != null) {
                while (e0.n(qVar2.e, false, new m1(this, n1Var, qVar2, obj2), 1) == w1.f48936a) {
                    qVar2 = D(qVar2);
                    if (qVar2 == null) {
                        return o(n1Var, obj2);
                    }
    ...
    public final void m(a1 a1Var, Object obj) {
        v vVar;
        Throwable th2;
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f48929b;
    ...
    public final Object o(n1 n1Var, Object obj) {
        ...
        if (q6 != null && (j(q6) || v(q6))) {
            ...
            v.f48930b.compareAndSet((v) obj, 0, 1);
        }
        F(obj);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f48928a;
        if (obj instanceof a1) {
