...
public class m extends l0 implements l, kd.d, i2 {
    public static final AtomicIntegerFieldUpdater f51599f = AtomicIntegerFieldUpdater.newUpdater(m.class, "_decisionAndIndex$volatile");
    ...
    public static final AtomicReferenceFieldUpdater f51600n = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "_parentHandle$volatile");
    ...
    public final id.c d;
    public final id.h f51601e;

    public m(int i10, id.c cVar) {
        super(i10);
        this.d = cVar;
        this.f51601e = cVar.getContext();
        this._decisionAndIndex$volatile = 536870911;
        this._state$volatile = b.f51552a;
    }
    ...
    public final void C(Object obj, int i10, rd.l lVar) {
        while (true) {
            ...
            if (obj2 instanceof n) {
                n nVar = (n) obj2;
                if (n.f51607c.compareAndSet(nVar, 0, 1)) {
                    if (lVar != null) {
                        l(lVar, nVar.f51639a);
                        return;
                    }
    ...
    public final void D(a0 a0Var) {
        ...
        C(gd.i.f10616a, i10, null);
    }

    public final d9.f F(rd.l lVar, Object obj) {
        d9.f fVar = e0.f51567a;
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = h;
            Object obj2 = atomicReferenceFieldUpdater.get(this);
            if (obj2 instanceof x1) {
                Object E = E((x1) obj2, obj, this.f51597c, lVar);
                while (!atomicReferenceFieldUpdater.compareAndSet(this, obj2, E)) {
                    if (atomicReferenceFieldUpdater.get(this) != obj2) {
                        break;
                    }
    ...
    public final void a(ee.t tVar, int i10) {
        ...
        int i11;
        do {
            atomicIntegerFieldUpdater = f51599f;
    ...
    public final void k(k kVar, Throwable th2) {
        try {
            ...
            e0.m(this.f51601e, new RuntimeException("Exception in invokeOnCancellation handler for " + this, th3));
        }
    }
    ...
    public final void l(rd.l lVar, Throwable th2) {
        try {
            ...
            e0.m(this.f51601e, new RuntimeException("Exception in resume onCancellation handler for " + this, th3));
        }
    }

    public final void m(ee.t tVar, Throwable th2) {
        id.h hVar = this.f51601e;
        int i10 = f51599f.get(this) & 536870911;
        if (i10 != 536870911) {
            try {
                tVar.h(i10, hVar);
                return;
    ...
    public final void o() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f51600n;
        o0 o0Var = (o0) atomicReferenceFieldUpdater.get(this);
        if (o0Var == null) {
            return;
        }
        o0Var.dispose();
        atomicReferenceFieldUpdater.set(this, w1.f51645a);
    }
            ...
            if (i12 != 0) {
                if (i12 == 1) {
                    ...
                    if (!z10 && (cVar instanceof ee.h)) {
                        ...
                        int i13 = this.f51597c;
                        if (z11 == ((i13 == 1 || i13 == 2) ? true : true)) {
                            ee.h hVar = (ee.h) cVar;
                            a0 a0Var = hVar.d;
                            id.h context = hVar.f9101e.getContext();
                            if (a0Var.e()) {
                                a0Var.c(context, this);
                                return;
                            }
                            w0 a2 = c2.a();
                            if (a2.f51643c >= 4294967296L) {
                                hd.e eVar = a2.f51644e;
                                if (eVar == null) {
                                    eVar = new hd.e();
                                    a2.f51644e = eVar;
                                }
            ...
            if (i11 != 0) {
                if (i11 == 2) {
                    ...
                    if (!(obj instanceof v)) {
                        ...
                        if ((i12 == 1 || i12 == 2) && (f1Var = (f1) this.f51601e.get(b0.f51554b)) != null && !f1Var.isActive()) {
    ...
    public final void s() {
        ...
        if (t10 != null && !(h.get(this) instanceof x1)) {
            t10.dispose();
            f51600n.set(this, w1.f51645a);
        }
    }

    public final o0 t() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        f1 f1Var = (f1) this.f51601e.get(b0.f51554b);
        if (f1Var == null) {
            return null;
        }
        o0 n10 = e0.n(f1Var, true, new o(this), 2);
        do {
            atomicReferenceFieldUpdater = f51600n;
    ...
    public final void v(x1 x1Var) {
        ...
        while (true) {
            ...
            if (!z10) {
                if (obj instanceof v) {
                    v vVar = (v) obj;
                    if (v.f51638b.compareAndSet(vVar, 0, 1)) {
                        if (obj instanceof n) {
                            Throwable th2 = vVar.f51639a;
                            if (x1Var instanceof k) {
                                k((k) x1Var, th2);
                                return;
                            } else {
                    ...
                    u uVar = (u) obj;
                    if (uVar.f51632b == null) {
                        if (!(x1Var instanceof ee.t)) {
                            k kVar = (k) x1Var;
                            Throwable th3 = uVar.f51634e;
                            if (th3 != null) {
                                z11 = true;
                            } else {
                                z11 = false;
    ...
    public final boolean x() {
        if (this.f51597c == 2) {
            ...
            if (ee.h.f9100n.get((ee.h) cVar) != null) {
                return true;
            }
            return false;
        }
