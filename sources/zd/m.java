...
public class m extends l0 implements l, kd.d, i2 {
    public static final AtomicIntegerFieldUpdater f48906f = AtomicIntegerFieldUpdater.newUpdater(m.class, "_decisionAndIndex$volatile");
    ...
    public static final AtomicReferenceFieldUpdater f48907n = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "_parentHandle$volatile");
    ...
    public m(int i10, id.c cVar) {
        ...
        this._state$volatile = b.f48867a;
    }
    ...
    public final void C(Object obj, int i10, rd.l lVar) {
        while (true) {
            ...
            if (obj2 instanceof n) {
                n nVar = (n) obj2;
                if (n.f48912c.compareAndSet(nVar, 0, 1)) {
                    if (lVar != null) {
                        l(lVar, nVar.f48938a);
                        return;
                    }
    ...
    public final void D(a0 a0Var) {
        ...
        C(gd.i.f9616a, i10, null);
    }

    public final ee.v F(rd.l lVar, Object obj) {
        ee.v vVar = e0.f48881a;
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = h;
            Object obj2 = atomicReferenceFieldUpdater.get(this);
            if (obj2 instanceof x1) {
                Object E = E((x1) obj2, obj, this.f48904c, lVar);
                while (!atomicReferenceFieldUpdater.compareAndSet(this, obj2, E)) {
                    if (atomicReferenceFieldUpdater.get(this) != obj2) {
                        break;
                    }
    ...
    public final void a(ee.t tVar, int i10) {
        ...
        int i11;
        do {
            atomicIntegerFieldUpdater = f48906f;
    ...
    public final void m(ee.t tVar, Throwable th2) {
        id.h hVar = this.e;
        int i10 = f48906f.get(this) & 536870911;
        if (i10 != 536870911) {
            try {
                tVar.h(i10, hVar);
                return;
    ...
    public final void o() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f48907n;
        o0 o0Var = (o0) atomicReferenceFieldUpdater.get(this);
        if (o0Var == null) {
            return;
        }
        o0Var.dispose();
        atomicReferenceFieldUpdater.set(this, w1.f48943a);
    }
        ...
        do {
            ...
            if (i11 != 0) {
                if (i11 == 2) {
                    ...
                    if (!(obj instanceof v)) {
                        int i12 = this.f48904c;
                        if ((i12 == 1 || i12 == 2) && (f1Var = (f1) this.e.get(b0.f48869b)) != null && !f1Var.isActive()) {
    ...
    public final void s() {
        ...
        if (t10 != null && !(h.get(this) instanceof x1)) {
            t10.dispose();
            f48907n.set(this, w1.f48943a);
        }
    }

    public final o0 t() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        f1 f1Var = (f1) this.e.get(b0.f48869b);
        if (f1Var == null) {
            return null;
        }
        o0 n10 = e0.n(f1Var, true, new o(this), 2);
        do {
            atomicReferenceFieldUpdater = f48907n;
    ...
    public final void v(x1 x1Var) {
        ...
        while (true) {
            ...
            if (!z10) {
                if (obj instanceof v) {
                    v vVar = (v) obj;
                    if (v.f48937b.compareAndSet(vVar, 0, 1)) {
                        if (obj instanceof n) {
                            Throwable th2 = vVar.f48938a;
                            if (x1Var instanceof k) {
                                k((k) x1Var, th2);
                                return;
                            } else {
    ...
    public final boolean x() {
        if (this.f48904c == 2) {
            ...
            if (ee.h.f8177n.get((ee.h) cVar) != null) {
                return true;
            }
            return false;
        }
