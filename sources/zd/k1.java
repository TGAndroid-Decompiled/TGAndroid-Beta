    ...
    public final void dispose() {
        ...
        while (true) {
            ...
            if (u10 instanceof k1) {
                if (u10 == this) {
                    AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = u1.f48963a;
                    q0 q0Var = e0.f48915j;
                ...
                while (true) {
                    ...
                    if (!(f7 instanceof ee.q)) {
                        ...
                        ee.k kVar2 = (ee.k) f7;
                        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater3 = ee.k.f8189c;
                        ...
                        do {
                            atomicReferenceFieldUpdater = ee.k.f8187a;
