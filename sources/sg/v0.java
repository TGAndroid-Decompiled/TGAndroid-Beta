...
public final class v0 extends FrameLayout {
    public final int f46326a = 2;
    public Object f46327b;
    public KeyEvent.Callback f46328c;
    ...
    public void a(int i10, CharSequence charSequence, boolean z10) {
        ImageView imageView = (ImageView) this.f46327b;
        if (z10) {
            AndroidUtilities.updateImageViewImageAnimated(imageView, i10);
        } else {
            imageView.setImageResource(i10);
        }
        ((TextView) this.f46328c).setText(charSequence);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        switch (this.f46326a) {
            case 0:
                ((c1) this.f46327b).d(0, 0.0f, 0, getMeasuredWidth(), 0.0f, getMeasuredHeight());
                RectF rectF = AndroidUtilities.rectTmp;
                rectF.set(0.0f, AndroidUtilities.dp(2.0f), getMeasuredWidth(), AndroidUtilities.dp(18.0f) + getMeasuredHeight());
                canvas.save();
                canvas.clipRect(0, 0, getMeasuredWidth(), getMeasuredHeight());
                c1 c1Var = (c1) this.f46327b;
                c1Var.f46064f.setAlpha(((a1) this.f46328c).K);
                canvas.drawRoundRect(rectF, AndroidUtilities.dp(24.0f) - 1, AndroidUtilities.dp(24.0f) - 1, c1Var.f46064f);
                canvas.restore();
    ...
    public void onMeasure(int i10, int i11) {
        switch (this.f46326a) {
            case 0:
                super.onMeasure(i10, vl.C(2.0f, ((a1) this.f46328c).f46046s, 1073741824));
                return;
            default:
