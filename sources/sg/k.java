...
public final class k {
    public final TLRPC.TL_premiumGiftOption f46124a;
    public final TLRPC.TL_premiumGiftCodeOption f46125b;
    public final TLRPC.TL_premiumGiftOption f46126c;
    ...
    public k(TLRPC.TL_premiumGiftOption tL_premiumGiftOption) {
        this.f46124a = tL_premiumGiftOption;
        this.f46125b = null;
        this.f46126c = null;
        this.d = null;
    }
    ...
    public final String a() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f46124a;
        if (tL_premiumGiftOption != null) {
            ...
            TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption = this.f46125b;
    ...
    public final int b() {
        if (this.f46127e == 0) {
            ...
            if (this.f46129g != 0) {
                int f7 = (int) ((1.0d - (f() / this.f46129g)) * 100.0d);
                this.f46127e = f7;
                if (f7 == 0) {
                    this.f46127e = -1;
                }
    ...
    public final String c() {
        ...
        if (!BuildVars.useInvoiceBilling() && (((tL_premiumGiftOption = this.f46124a) == null || tL_premiumGiftOption.store_product != null) && ((tL_premiumGiftCodeOption = this.f46125b) == null || tL_premiumGiftCodeOption.store_product != null))) {
            if (this.h == null) {
                return "";
            }
    ...
    public final long g() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f46126c;
        if (tL_premiumGiftOption != null) {
            return tL_premiumGiftOption.amount;
        }
    ...
    public k(TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption2) {
        this.f46124a = null;
        this.f46125b = tL_premiumGiftCodeOption;
        this.f46126c = null;
