...
public final class k {
    public final TLRPC.TL_premiumGiftOption f46125a;
    public final TLRPC.TL_premiumGiftCodeOption f46126b;
    public final TLRPC.TL_premiumGiftOption f46127c;
    ...
    public k(TLRPC.TL_premiumGiftOption tL_premiumGiftOption) {
        this.f46125a = tL_premiumGiftOption;
        this.f46126b = null;
        this.f46127c = null;
        this.d = null;
    }
    ...
    public final String a() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f46125a;
        if (tL_premiumGiftOption != null) {
            ...
            TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption = this.f46126b;
    ...
    public final int b() {
        if (this.f46128e == 0) {
            ...
            if (this.f46130g != 0) {
                int f7 = (int) ((1.0d - (f() / this.f46130g)) * 100.0d);
                this.f46128e = f7;
                if (f7 == 0) {
                    this.f46128e = -1;
                }
    ...
    public final String c() {
        ...
        if (!BuildVars.useInvoiceBilling() && (((tL_premiumGiftOption = this.f46125a) == null || tL_premiumGiftOption.store_product != null) && ((tL_premiumGiftCodeOption = this.f46126b) == null || tL_premiumGiftCodeOption.store_product != null))) {
            if (this.h == null) {
                return "";
            }
    ...
    public final long g() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f46127c;
        if (tL_premiumGiftOption != null) {
            return tL_premiumGiftOption.amount;
        }
    ...
    public k(TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption2) {
        this.f46125a = null;
        this.f46126b = tL_premiumGiftCodeOption;
        this.f46127c = null;
