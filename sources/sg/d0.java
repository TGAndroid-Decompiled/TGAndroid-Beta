...
public final class d0 extends kl0 {
    ...
    public final boolean D(s4.c1 c1Var) {
        k0 k0Var = this.f46064c;
        int i10 = k0Var.f46138h0;
    ...
    public final int j(int i10) {
        int i11;
        k0 k0Var = this.f46064c;
        if (k0Var.f46142l0 == i10) {
            return 0;
        }
        if (k0Var.m0 == i10) {
            return 2;
        }
        if (k0Var.f46143n0 == i10) {
            return 3;
        }
        if (k0Var.f46146q0 == i10) {
            return 5;
        }
        if (k0Var.f46147r0 == i10) {
            return 6;
        }
        if (k0Var.Z == i10) {
            return 7;
        }
        if (k0Var.f46148s0 == i10) {
            return 8;
        }
        ArrayList arrayList = k0Var.f46150u0;
        if (arrayList != null && i10 >= (i11 = k0Var.f46149t0) && i10 <= arrayList.size() + i11) {
            return 9;
        }
        int i12 = k0Var.f46138h0;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        k0 k0Var = this.f46064c;
        int i12 = k0Var.f46138h0;
        HashSet hashSet = k0Var.f46154y0;
        ...
        if (i13 != 1) {
            if (i13 != 9) {
                if (i13 != 3) {
                    if (i13 == 4) {
                        f4 f4Var = (f4) view;
                        if (i12 == 5) {
                            TLRPC.Chat chat = (TLRPC.Chat) k0Var.f46155z0.get(i10 - k0Var.f46144o0);
                            String str2 = (String) k0Var.A0.get(i10 - k0Var.f46144o0);
                            String str3 = chat.title;
                            if (i10 == k0Var.f46145p0 - 1.0f) {
                                z12 = false;
                            }
                            ...
                            TLRPC.User user = (TLRPC.User) k0Var.B0.get(i10 - k0Var.f46144o0);
                            ArrayList arrayList = k0Var.C0;
                            if (arrayList != null && arrayList.contains(Long.valueOf(user.f20016id))) {
                                z10 = true;
                            } else {
                                z10 = false;
                            }
            ...
            int i14 = i10 - k0Var.f46149t0;
            ArrayList arrayList2 = k0Var.f46150u0;
            if (arrayList2 != null && i14 >= 0 && i14 < arrayList2.size()) {
                g0 g0Var = (g0) view;
                f0 f0Var = (f0) k0Var.f46150u0.get(i14);
                t5 t5Var = g0Var.f46102c;
                ImageView imageView = g0Var.f46100a;
                j5 j5Var = g0Var.f46101b;
                if (f0Var instanceof e0) {
                    g0Var.f46104f = (e0) f0Var;
                    g0Var.f46103e = null;
                    imageView.setVisibility(8);
                    j5Var.setVisibility(8);
                    t5Var.setVisibility(0);
                    j5 j5Var2 = g0Var.d;
                    e0 e0Var = g0Var.f46104f;
                    if (e0Var.h) {
                        str = "BoostLevelUnlocks";
                    } else {
                        str = "BoostLevel";
                    }
                    j5Var2.l(LocaleController.formatPluralString(str, e0Var.f46077g, new Object[0]), false);
                    return;
                } else if (f0Var != null) {
                    g0Var.f46104f = null;
                    g0Var.f46103e = f0Var;
                    imageView.setVisibility(0);
                    imageView.setImageResource(g0Var.f46103e.f46092a);
                    j5Var.setVisibility(0);
                    f0 f0Var2 = g0Var.f46103e;
                    String str4 = "";
                    if (f0Var2.d != null) {
                        String string = LocaleController.getString(g0Var.f46103e.d + "_" + LocaleController.getStringParamForNumber(g0Var.f46103e.f46095e));
                        if (string == null || string.startsWith("LOC_ERR")) {
                            string = LocaleController.getString(g0Var.f46103e.d + "_other");
                        }
                        if (string == null) {
                            string = "";
                        }
                        ...
                        if (indexOf >= 0) {
                            ...
                            SpannableString spannableString = new SpannableString(a4.a.n(g0Var.f46103e.f46095e, "", new StringBuilder()));
                        ...
                        String string2 = LocaleController.getString(f0Var2.f46093b);
                        if (string2 != null) {
                            str4 = string2;
                        }
                        if (g0Var.f46103e.f46094c != null) {
                            SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(str4);
                            int indexOf2 = str4.indexOf("%s");
                            if (indexOf2 >= 0) {
                                spannableStringBuilder2 = new SpannableStringBuilder(str4);
                                SpannableString spannableString2 = new SpannableString(g0Var.f46103e.f46094c);
        ...
        TLRPC.Chat chat2 = (TLRPC.Chat) k0Var.f46139i0.get(i10 - k0Var.f46144o0);
            ...
            case 7:
                ...
                textView.setOnClickListener(new View.OnClickListener(this) {
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                k0 k0Var2 = this.f46027b.f46064c;
                                n2 n2Var = k0Var2.f24650n;
                                long j3 = k0Var2.f46131a0;
                                f6Var13 = ((f3) k0Var2).resourcesProvider;
                                ug.n.m(n2Var, f6Var13, j3, null);
                                return;
                            case 1:
                                k0 k0Var3 = this.f46027b.f46064c;
                                AndroidUtilities.addToClipboard(k0Var3.p1());
                                k0Var3.dismiss();
                                return;
                            case 2:
                                AndroidUtilities.addToClipboard(this.f46027b.f46064c.p1());
                                return;
                            default:
                                k0 k0Var4 = this.f46027b.f46064c;
                                k0Var4.Q0.run();
                                k0Var4.dismiss();
                                return;
                        }
