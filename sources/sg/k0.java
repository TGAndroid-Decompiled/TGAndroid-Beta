...
public class k0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean Y;
    public int Z;
    public long f46159a0;
    public TL_stories.TL_premium_boostsStatus f46160b0;
    public ChannelBoostsController.CanApplyBoost f46161c0;
    public j0 f46162d0;
    public boolean f46163e0;
    public boolean f46164f0;
    public org.telegram.ui.Cells.t1 f46165g0;
    public final int f46166h0;
    public final ArrayList f46167i0;
    public boolean f46168j0;
    public int f46169k0;
    public int f46170l0;
    public int m0;
    public int f46171n0;
    ...
    public int f46176s0;
    public int f46177t0;
    public ArrayList f46178u0;
    public boolean f46179v0;
    public int f46180w0;
    public i0 f46181x0;
    public final HashSet f46182y0;
    public final ArrayList f46183z0;

    public k0(int i10, int i11, Context context, n2 n2Var, f6 f6Var) {
        super(context, n2Var, false, v1(i10), f6Var);
        this.Z = -1;
        this.f46164f0 = false;
        this.f46167i0 = new ArrayList();
        this.f46170l0 = -1;
        this.m0 = -1;
        this.f46171n0 = -1;
        this.f46172o0 = -1;
        ...
        this.f46177t0 = -1;
        this.f46180w0 = -1;
        this.f46182y0 = new HashSet();
        this.f46183z0 = new ArrayList();
        ...
        this.R0 = 0;
        this.T0 = -4;
        fixNavigationBar(j6.v0(j6.f20762h5, this.resourcesProvider));
        this.K0 = n2Var;
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.a.k(j6.v0(j6.f20691d6, f6Var), 120);
    ...
    public static void R(k0 k0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        ...
        arrayList2.clear();
        ArrayList arrayList3 = k0Var.f46183z0;
        arrayList3.clear();
        ...
        k0Var.M1();
        if (k0Var.f46170l0 >= 0 && i11 != 0) {
            ((s4.c0) ll0Var.getLayoutManager()).h1(k0Var.f46170l0 + 1, i11);
        }
        if (k0Var.M0 == null) {
            k0Var.M0 = u1(k0Var.f46166h0, k0Var.currentAccount);
        }
        int max = Math.max(arrayList3.size(), k0Var.M0.f1375b);
        i0 i0Var = k0Var.f46181x0;
        if (i0Var != null) {
            i0Var.g(max, false);
            k0Var.f46181x0.setBagePosition(max / k0Var.M0.f1376c);
            i0 i0Var2 = k0Var.f46181x0;
            i0Var2.H = true;
    ...
    public static void S(k0 k0Var) {
        ...
        if (k0Var.f46168j0) {
            ...
            ChannelBoostsController.CanApplyBoost canApplyBoost = k0Var.f46161c0;
            if (canApplyBoost.canApply) {
                k0Var.E0.f46270r.callOnClick();
                ChannelBoostsController.CanApplyBoost canApplyBoost2 = k0Var.f46161c0;
                ...
                return;
            } else if (canApplyBoost.alreadyActive && ug.t.i() && !k0Var.f46161c0.isMaxLvl) {
                ug.j.i(k0Var.f46159a0, k0Var);
                return;
            } else {
                k0Var.dismiss();
                return;
        ...
        if (i10 != 11 && i10 != 34) {
            if (!hashSet.isEmpty()) {
                if (i10 == 2) {
                    ...
                    while (it.hasNext()) {
                        k0Var.f46167i0.add((TLRPC.Chat) it.next());
                    }
                    k0Var.D1(arrayList);
                } else if (i10 == 5) {
                    ...
                    if (textView != null) {
                        textView.setTextColor(j6.v0(j6.f20926q7, k0Var.resourcesProvider));
                    }
                }
            }
        ...
        if (i11 != 11 && i11 != 34) {
            ...
            if (z10 && canApplyBoost.replaceDialogId == 0) {
                if (canApplyBoost.needSelector && ug.t.i()) {
                    k0Var.f46164f0 = true;
                    k0Var.f46181x0.f24079d0 = false;
                    n2 n2Var2 = k0Var.f24677n;
                    ChannelBoostsController.CanApplyBoost canApplyBoost2 = k0Var.f46161c0;
                ...
                paint.setColor(j6.w0(null, j6.f20762h5, false));
                ...
                imageView.setColorFilter(j6.w0(null, j6.f20855m6, false));
                ...
                TLRPC.Chat chat = MessagesController.getInstance(k0Var.currentAccount).getChat(Long.valueOf(-k0Var.f46161c0.replaceDialogId));
                i9Var.k(k0Var.currentAccount, chat);
                x9Var.e(chat, i9Var);
                i9 i9Var2 = new i9((f6) null);
                TLRPC.Chat chat2 = MessagesController.getInstance(k0Var.currentAccount).getChat(Long.valueOf(-k0Var.f46159a0));
    ...
    public static void W(k0 k0Var, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n) {
            ...
            nVar.f22342r.a(hashSet.contains(currentChannel), true);
            k0Var.K1();
        } else if (view instanceof f4) {
            if (k0Var.Y || ((i10 = k0Var.f46166h0) != 11 && i10 != 34)) {
                f4 f4Var = (f4) view;
    ...
    public final boolean B1() {
        ...
        int i21;
        int i22;
        NotificationCenter.getInstance(this.currentAccount).postNotificationNameOnUIThread(NotificationCenter.chatWasBoostedByUser, this.f46160b0, this.f46161c0.copy(), Long.valueOf(this.f46159a0));
        di.d dVar = this.S0;
        if (dVar != null) {
        ...
        TransitionManager.beginDelayedTransition(this.f46162d0, transitionSet);
        j0 j0Var = this.f46162d0;
        ug.b bVar = j0Var.f46151c;
        int indexOfChild = j0Var.indexOfChild(j0Var.f46150b);
        k0 k0Var = j0Var.f46152e;
        if (k0Var.f46163e0) {
            int indexOfChild2 = j0Var.indexOfChild(j0Var.d);
            j0Var.removeView(j0Var.d);
            j0Var.d.removeView(j0Var.f46149a);
            ...
            j0Var.d.addView(j0Var.f46149a, x5.o(-2, -2, 1.0f, 0));
            j0Var.d.addView(bVar, x5.t(-2, -2, 48, 0, 2, 0, 0));
            j0Var.addView(j0Var.d, indexOfChild2, x5.t(-2, -2, 1, 25, 22, 12, 9));
        } else {
            int indexOfChild3 = j0Var.indexOfChild(j0Var.f46149a);
            j0Var.removeView(j0Var.f46149a);
            TextView textView = new TextView(j0Var.getContext());
            j0Var.f46149a = textView;
            textView.setTypeface(AndroidUtilities.bold());
            j0Var.f46149a.setTextSize(1, 20.0f);
            j0Var.f46149a.setTextColor(j6.v0(j6.G6, k0Var.resourcesProvider));
            j0Var.f46149a.setGravity(17);
            j0Var.addView(j0Var.f46149a, indexOfChild3, x5.t(-2, -2, 1, 0, 22, 0, 0));
        }
        j0Var.removeView(j0Var.f46150b);
        TextView textView2 = new TextView(j0Var.getContext());
        j0Var.f46150b = textView2;
        textView2.setTextSize(1, 14.0f);
        TextView textView3 = j0Var.f46150b;
        textView3.setLineSpacing(textView3.getLineSpacingExtra(), j0Var.f46150b.getLineSpacingMultiplier() * 1.1f);
        j0Var.f46150b.setGravity(1);
        j0Var.f46150b.setTextColor(j6.v0(j6.G6, k0Var.resourcesProvider));
        j0Var.addView(j0Var.f46150b, indexOfChild, x5.t(-2, -2, 1, 24, -2, 24, 17));
        this.f46162d0.f46149a.setText(r1());
        TextView textView4 = this.f46162d0.f46150b;
        MessagesController messagesController = MessagesController.getInstance(this.currentAccount);
        boolean x12 = x1();
        int i23 = this.f46166h0;
        if (i23 == 20) {
            if (x12) {
        ...
        this.f46162d0.f46151c.a(this.f46161c0.boostCount, true);
        this.d.x0(0);
        if (i23 == 32) {
            this.f46162d0.f46151c.setVisibility(8);
        }
        return true;
    }
    ...
    public final void D1(ArrayList arrayList) {
        ...
        TextView textView = (TextView) b2Var.d(-1);
        if (textView != null) {
            textView.setTextColor(j6.v0(j6.f20926q7, this.resourcesProvider));
        }
    }
    ...
    public final void F1(TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, boolean z10) {
        this.f46160b0 = tL_premium_boostsStatus;
        this.f46163e0 = z10;
        M1();
    }
    ...
    public final void G(ov0 ov0Var) {
        ...
        if (!this.f24678r && (i10 = this.f46166h0) != 18 && i10 != 20 && i10 != 24 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 22 && i10 != 23 && i10 != 21 && i10 != 27 && i10 != 28 && i10 != 30 && i10 != 35) {
            t50 t50Var = new t50(this, context, 11);
            this.L0 = t50Var;
            t50Var.setBackgroundColor(j6.v0(j6.f20762h5, this.resourcesProvider));
        ...
        this.E0.f46270r.setOnClickListener(new wy0(16, this, context));
        this.E0.f46267e.setOnClickListener(new u(this, 3));
        this.J0 = new qk0(ll0Var, true);
    }

    public final void G1(ChannelBoostsController.CanApplyBoost canApplyBoost) {
        this.f46161c0 = canApplyBoost;
        K1();
        L1();
    }
    ...
    public final void J1() {
        ...
        int i15;
        int i16;
        this.f46178u0 = new ArrayList();
        TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = this.f46160b0;
        ...
        while (i10 <= i17) {
            ...
            if (arrayList != null && arrayList.size() == arrayList2.size()) {
                for (int i22 = 0; i22 < arrayList.size(); i22++) {
                    ...
                    int i23 = f0Var.f46123e;
                    if (f0Var2 != null && ((f0Var.f46124f && i23 > 2) || (f0Var.f46120a == f0Var2.f46120a && f0Var.f46121b == f0Var2.f46121b && TextUtils.equals(f0Var.f46122c, f0Var2.f46122c) && TextUtils.equals(f0Var.d, f0Var2.d) && i23 == f0Var2.f46123e))) {
                    }
                }
                i10++;
            }
            ArrayList arrayList3 = this.f46178u0;
            arrayList3.add(new e0(i10, arrayList3.isEmpty()));
            this.f46178u0.addAll(arrayList2);
            arrayList = arrayList2;
            i10++;
        }
    }
    ...
    public final void K1() {
        ...
        if (i11 != 19 && i11 != 32 && !y1()) {
            ...
            vq vqVar3 = this.E0.G;
            vqVar3.f31990a.c(hashSet.size(), true);
            this.E0.invalidate();
            return;
        }
        ChannelBoostsController.CanApplyBoost canApplyBoost = this.f46161c0;
        boolean z10 = canApplyBoost.canApply;
    ...
    public final void L1() {
        ...
        if (i12 != 19 && i12 != 32 && !y1()) {
            if (i12 != 18 && i12 != 20 && i12 != 24 && i12 != 25 && i12 != 26 && i12 != 29 && i12 != 22 && i12 != 23 && i12 != 21 && i12 != 27 && i12 != 28 && i12 != 30 && i12 != 35) {
                if (!UserConfig.getInstance(this.currentAccount).isPremium() && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() && !this.N0) {
                    ...
                    if (pVar != null) {
                        ...
                        a0 a0Var = this.E0;
                        a0Var.f46272w.f31540p = null;
                        a0Var.f46274y.setVisibility(8);
                        return;
                    }
                    a0 a0Var2 = this.E0;
                    a0Var2.f46272w.f31540p = null;
                    a0Var2.f46274y.setVisibility(8);
                    return;
                }
                this.E0.d.setText(LocaleController.getString(R.string.OK));
                a0 a0Var3 = this.E0;
                a0Var3.f46272w.f31540p = null;
                a0Var3.f46274y.setVisibility(8);
                return;
            }
            ...
            ChannelBoostsController.CanApplyBoost canApplyBoost2 = this.f46161c0;
    ...
    public final void M1() {
        ...
        if (i10 != 19 && i10 != 18 && i10 != 20 && i10 != 24 && i10 != 27 && i10 != 28 && i10 != 22 && i10 != 23 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 21 && i10 != 30 && i10 != 35) {
            if (i10 != 31 && i10 != 32) {
                if (!v1(i10)) {
                    ...
                    if (this.I0) {
                        ...
                        if (i10 != 11 || MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() || ((((arrayList = this.D0) == null || arrayList.isEmpty()) && ((arrayList2 = this.C0) == null || arrayList2.size() < this.B0.size())) || (arrayList3 = this.D0) == null || arrayList3.size() != 1 || (arrayList4 = this.C0) == null || arrayList4.size() != 1 || !this.Y)) {
                            int i13 = this.f46169k0;
                            this.f46172o0 = i13;
                            if (i10 != 11 && i10 != 34) {
                                if (i10 == 5) {
                                    this.f46169k0 = this.f46183z0.size() + i13;
                                } else {
                                    this.f46169k0 = this.f46167i0.size() + i13;
                                }
                            } else {
                                this.f46169k0 = this.B0.size() + i13;
                            }
                            this.f46173p0 = this.f46169k0;
                        }
                        if (this.f46173p0 - this.f46172o0 > 1) {
                            int i14 = this.f46169k0;
                            this.f46169k0 = i14 + 1;
                            this.f46175r0 = i14;
                        }
                    }
                ...
                this.v = 0.24f;
                J1();
                int i15 = this.f46169k0;
                this.f46172o0 = i15;
                int i16 = i15 + 1;
                this.f46169k0 = i16;
                this.f46177t0 = i15;
                int size = (this.f46178u0.size() - 1) + i16;
                this.f46169k0 = size;
                this.f46173p0 = size;
            }
        } else {
            if (i10 != 19 || ChatObject.hasAdminRights(s1())) {
                this.v = 0.24f;
                int i17 = this.f46169k0;
                this.f46169k0 = i17 + 1;
                this.Z = i17;
                if (MessagesController.getInstance(this.currentAccount).giveawayGiftsPurchaseAvailable) {
                    int i18 = this.f46169k0;
                    this.f46169k0 = i18 + 1;
                    this.f46176s0 = i18;
                }
            }
            J1();
            int i19 = this.f46169k0;
            int i20 = i19 + 1;
            this.f46169k0 = i20;
            this.f46177t0 = i19;
            this.f46169k0 = (this.f46178u0.size() - 1) + i20;
        }
        this.d.getAdapter().l();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.boostByChannelCreated) {
            ...
            if (tL_premium_boostsStatus != null && this.f46161c0 != null) {
                this.f46160b0.boosts += intValue;
                if (this.f46166h0 == 32 && (t12 = t1()) != null) {
                    t12.boosts_applied += intValue;
                }
                z1();
                F1(tL_premium_boostsStatus, this.f46163e0);
                ChannelBoostsController.CanApplyBoost canApplyBoost = this.f46161c0;
                if (this.f46160b0.next_level_boosts <= 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void m1(final g90 g90Var, boolean z10) {
        ...
        MessagesController.getInstance(this.currentAccount).getBoostsController().applyBoost(this.f46159a0, this.f46161c0.slot, new Utilities.Callback(this) {
            public final k0 f46397b;
            ...
            public final void run(Object obj) {
                switch (r3) {
                    case 0:
                        MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.f46159a0, new s7(this.f46397b, g90Var, (TL_stories.TL_premium_myBoosts) obj, 2));
                        return;
                    default:
                        ...
                        if (startsWith) {
                            ...
                            if (intValue <= 5) {
                                AndroidUtilities.runOnUIThread(new org.telegram.ui.web.g1(19, this.f46397b, g90Var2), intValue * 1000);
                                return;
                            }
                            ug.j.g(intValue);
                        }
    ...
    public final String p1() {
        ...
        if (tL_premium_boostsStatus != null && !TextUtils.isEmpty(tL_premium_boostsStatus.boost_url)) {
            return this.f46160b0.boost_url;
        }
        int i10 = this.currentAccount;
        long j3 = -this.f46159a0;
    ...
    public final String q1(boolean z10) {
        ...
        TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46159a0));
        if (chat == null) {
            if (x1()) {
        ...
        if (y1() && this.f46160b0.next_level_boosts != 0 && z10) {
            if (x1()) {
                i18 = R.string.GroupNeedBoostsDescriptionForNewFeatures;
            } else {
                i18 = R.string.ChannelNeedBoostsDescriptionForNewFeatures;
            }
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus2 = this.f46160b0;
        ...
        } else if (z11 && this.f46161c0.alreadyActive) {
            if (this.f46160b0.level == 1) {
                if (x1()) {
            ...
            return LocaleController.formatString(i16, Integer.valueOf(this.f46160b0.level), LocaleController.formatPluralString("BoostStories", this.f46160b0.level, new Object[0]));
        } else if (this.f46161c0.alreadyActive) {
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus3 = this.f46160b0;
            if (tL_premium_boostsStatus3.level == 0) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus4 = this.f46160b0;
                ...
                return LocaleController.formatString(i14, Integer.valueOf(this.f46160b0.level), LocaleController.formatPluralString("BoostStories", this.f46160b0.level + 1, new Object[0]));
            } else {
                if (x1()) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus5 = this.f46160b0;
            ...
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus6 = this.f46160b0;
            if (tL_premium_boostsStatus6.level == 0) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus7 = this.f46160b0;
                ...
                return LocaleController.formatString(i11, Integer.valueOf(this.f46160b0.level), LocaleController.formatPluralString("BoostStories", this.f46160b0.level + 1, new Object[0]));
            } else {
                if (x1()) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus8 = this.f46160b0;
    ...
    public final String r1() {
        ...
        if (tL_premium_boostsStatus.level > 0 && !this.f46161c0.alreadyActive) {
            if (x1()) {
        ...
        boolean z10 = this.f46163e0;
        int i16 = this.f46166h0;
        if (z10) {
            if (i16 == 32) {
                if (x1()) {
            ...
            TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46159a0));
            if (this.f46161c0.alreadyActive) {
    ...
    public final TLRPC.Chat s1() {
        return MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46159a0));
    }

    public final TLRPC.ChatFull t1() {
        return MessagesController.getInstance(this.currentAccount).getChatFull(-this.f46159a0);
    }
    ...
    public final boolean x1() {
        return !ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46159a0)));
    }
    ...
    public final void z1() {
        ...
        i0Var.f24075b++;
        i0Var.f24073a = w7.p.a((i11 - i10) / i12, 0.0f, 1.0f);
        i0Var.W = true;
        i0Var.f24074a0 = i0Var.f24089n;
        i0Var.g(i11, true);
