...
public class k0 extends bb implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean Y;
    public int Z;
    public long f46131a0;
    public TL_stories.TL_premium_boostsStatus f46132b0;
    public ChannelBoostsController.CanApplyBoost f46133c0;
    public j0 f46134d0;
    public boolean f46135e0;
    public boolean f46136f0;
    public org.telegram.ui.Cells.t1 f46137g0;
    public final int f46138h0;
    public final ArrayList f46139i0;
    public boolean f46140j0;
    public int f46141k0;
    public int f46142l0;
    public int m0;
    public int f46143n0;
    ...
    public int f46148s0;
    public int f46149t0;
    public ArrayList f46150u0;
    public boolean f46151v0;
    public int f46152w0;
    public i0 f46153x0;
    public final HashSet f46154y0;
    public final ArrayList f46155z0;

    public k0(int i10, int i11, Context context, n2 n2Var, f6 f6Var) {
        super(context, n2Var, false, v1(i10), f6Var);
        this.Z = -1;
        this.f46136f0 = false;
        this.f46139i0 = new ArrayList();
        this.f46142l0 = -1;
        this.m0 = -1;
        this.f46143n0 = -1;
        this.f46144o0 = -1;
        ...
        this.f46149t0 = -1;
        this.f46152w0 = -1;
        this.f46154y0 = new HashSet();
        this.f46155z0 = new ArrayList();
        ...
        this.R0 = 0;
        this.T0 = -4;
        fixNavigationBar(j6.v0(j6.f20735h5, this.resourcesProvider));
        this.K0 = n2Var;
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.a.k(j6.v0(j6.f20664d6, f6Var), 120);
    ...
    public static void P(k0 k0Var, ArrayList arrayList, TLRPC.User user) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            MessagesController.getInstance(k0Var.currentAccount).deleteParticipantFromChat(chat.f19869id, user);
        }
    }
    ...
    public static void R(k0 k0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        ...
        arrayList2.clear();
        ArrayList arrayList3 = k0Var.f46155z0;
        arrayList3.clear();
        ...
        k0Var.M1();
        if (k0Var.f46142l0 >= 0 && i11 != 0) {
            ((s4.c0) ll0Var.getLayoutManager()).h1(k0Var.f46142l0 + 1, i11);
        }
        if (k0Var.M0 == null) {
            k0Var.M0 = u1(k0Var.f46138h0, k0Var.currentAccount);
        }
        int max = Math.max(arrayList3.size(), k0Var.M0.f1363b);
        i0 i0Var = k0Var.f46153x0;
        if (i0Var != null) {
            i0Var.g(max, false);
            k0Var.f46153x0.setBagePosition(max / k0Var.M0.f1364c);
            i0 i0Var2 = k0Var.f46153x0;
            i0Var2.H = true;
    ...
    public static void S(k0 k0Var) {
        ...
        if (k0Var.f46140j0) {
            ...
            ChannelBoostsController.CanApplyBoost canApplyBoost = k0Var.f46133c0;
            if (canApplyBoost.canApply) {
                k0Var.E0.f46242r.callOnClick();
                ChannelBoostsController.CanApplyBoost canApplyBoost2 = k0Var.f46133c0;
                ...
                return;
            } else if (canApplyBoost.alreadyActive && ug.t.i() && !k0Var.f46133c0.isMaxLvl) {
                ug.j.i(k0Var.f46131a0, k0Var);
                return;
            } else {
                k0Var.dismiss();
                return;
        ...
        if (i10 != 11 && i10 != 34) {
            if (!hashSet.isEmpty()) {
                if (i10 == 2) {
                    ...
                    while (it.hasNext()) {
                        k0Var.f46139i0.add((TLRPC.Chat) it.next());
                    }
                    k0Var.D1(arrayList);
                } else if (i10 == 5) {
                    ...
                    if (textView != null) {
                        textView.setTextColor(j6.v0(j6.f20899q7, k0Var.resourcesProvider));
                    }
                }
            }
        ...
        if (i11 != 11 && i11 != 34) {
            ...
            if (z10 && canApplyBoost.replaceDialogId == 0) {
                if (canApplyBoost.needSelector && ug.t.i()) {
                    k0Var.f46136f0 = true;
                    k0Var.f46153x0.f24052d0 = false;
                    n2 n2Var2 = k0Var.f24650n;
                    ChannelBoostsController.CanApplyBoost canApplyBoost2 = k0Var.f46133c0;
                ...
                paint.setColor(j6.w0(null, j6.f20735h5, false));
                ...
                imageView.setColorFilter(j6.w0(null, j6.f20828m6, false));
                ...
                TLRPC.Chat chat = MessagesController.getInstance(k0Var.currentAccount).getChat(Long.valueOf(-k0Var.f46133c0.replaceDialogId));
                i9Var.k(k0Var.currentAccount, chat);
                x9Var.e(chat, i9Var);
                i9 i9Var2 = new i9((f6) null);
                TLRPC.Chat chat2 = MessagesController.getInstance(k0Var.currentAccount).getChat(Long.valueOf(-k0Var.f46131a0));
    ...
    public static void W(k0 k0Var, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n) {
            ...
            nVar.f22315r.a(hashSet.contains(currentChannel), true);
            k0Var.K1();
        } else if (view instanceof f4) {
            if (k0Var.Y || ((i10 = k0Var.f46138h0) != 11 && i10 != 34)) {
                f4 f4Var = (f4) view;
                Object object = f4Var.getObject();
                if (f4Var.O) {
                    if (object instanceof TLRPC.User) {
                        long j3 = ((TLRPC.User) object).f20016id;
                        int i11 = -k0Var.T0;
                        k0Var.T0 = i11;
    ...
    public static androidx.emoji2.text.p u1(int i10, int i11) {
        ...
        obj.f1364c = 0;
        if (i10 == 0) {
            obj.f1363b = MessagesController.getInstance(i11).dialogFiltersPinnedLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).dialogFiltersPinnedLimitPremium;
            obj.f1362a = R.drawable.msg_limit_pin;
            obj.d = LocaleController.formatString("LimitReachedPinDialogs", R.string.LimitReachedPinDialogs, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedPinDialogsPremium", R.string.LimitReachedPinDialogsPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedPinDialogsLocked", R.string.LimitReachedPinDialogsLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 33) {
            obj.f1363b = MessagesController.getInstance(i11).savedDialogsPinnedLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).savedDialogsPinnedLimitPremium;
            obj.f1362a = R.drawable.msg_limit_pin;
            obj.d = LocaleController.formatString(R.string.LimitReachedPinSavedDialogs, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 2) {
            obj.f1363b = MessagesController.getInstance(i11).publicLinksLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).publicLinksLimitPremium;
            obj.f1362a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedPublicLinks", R.string.LimitReachedPublicLinks, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedPublicLinksPremium", R.string.LimitReachedPublicLinksPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedPublicLinksLocked", R.string.LimitReachedPublicLinksLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 12) {
            obj.f1363b = MessagesController.getInstance(i11).chatlistInvitesLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).chatlistInvitesLimitPremium;
            obj.f1362a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedFolderLinks", R.string.LimitReachedFolderLinks, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedFolderLinksPremium", R.string.LimitReachedFolderLinksPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedFolderLinksLocked", R.string.LimitReachedFolderLinksLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 13) {
            obj.f1363b = MessagesController.getInstance(i11).chatlistJoinedLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).chatlistJoinedLimitPremium;
            obj.f1362a = R.drawable.msg_limit_folder;
            obj.d = LocaleController.formatString("LimitReachedSharedFolders", R.string.LimitReachedSharedFolders, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedSharedFoldersPremium", R.string.LimitReachedSharedFoldersPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedSharedFoldersLocked", R.string.LimitReachedSharedFoldersLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 3) {
            obj.f1363b = MessagesController.getInstance(i11).dialogFiltersLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).dialogFiltersLimitPremium;
            obj.f1362a = R.drawable.msg_limit_folder;
            obj.d = LocaleController.formatString("LimitReachedFolders", R.string.LimitReachedFolders, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedFoldersPremium", R.string.LimitReachedFoldersPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedFoldersLocked", R.string.LimitReachedFoldersLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 4) {
            obj.f1363b = MessagesController.getInstance(i11).dialogFiltersChatsLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).dialogFiltersChatsLimitPremium;
            obj.f1362a = R.drawable.msg_limit_chats;
            obj.d = LocaleController.formatString("LimitReachedChatInFolders", R.string.LimitReachedChatInFolders, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedChatInFoldersPremium", R.string.LimitReachedChatInFoldersPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedChatInFoldersLocked", R.string.LimitReachedChatInFoldersLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 5) {
            obj.f1363b = MessagesController.getInstance(i11).channelsLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).channelsLimitPremium;
            obj.f1362a = R.drawable.msg_limit_groups;
            obj.d = LocaleController.formatString("LimitReachedCommunities", R.string.LimitReachedCommunities, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedCommunitiesPremium", R.string.LimitReachedCommunitiesPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedCommunitiesLocked", R.string.LimitReachedCommunitiesLocked, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 6) {
            obj.f1363b = 100;
            obj.f1364c = 200;
            ...
            obj.f1365e = LocaleController.formatString("LimitReachedFileSizePremium", R.string.LimitReachedFileSizePremium, "4 GB");
            obj.f1366f = LocaleController.formatString("LimitReachedFileSizeLocked", R.string.LimitReachedFileSizeLocked, "2 GB");
            return obj;
        } else if (i10 == 7) {
            obj.f1363b = 3;
            obj.f1364c = 4;
            obj.f1362a = R.drawable.msg_limit_accounts;
            obj.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 3, Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 11) {
            obj.f1363b = 0;
            obj.f1364c = 0;
            obj.f1362a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 0, Integer.valueOf(obj.f1364c));
            obj.f1365e = "";
            obj.f1366f = "";
            return obj;
        } else if (i10 == 14) {
            obj.f1363b = MessagesController.getInstance(i11).storyExpiringLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).storyExpiringLimitPremium;
            obj.f1362a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2First", obj.f1363b) + "\n" + LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Second", obj.f1364c);
            obj.f1365e = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", obj.f1364c);
            obj.f1366f = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", obj.f1363b);
            return obj;
        } else if (i10 == 15) {
            obj.f1363b = MessagesController.getInstance(i11).storiesSentWeeklyLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).storiesSentWeeklyLimitPremium;
            obj.f1362a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatString("LimitReachedStoriesWeekly", R.string.LimitReachedStoriesWeekly, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(obj.f1363b));
            return obj;
        } else if (i10 == 16) {
            obj.f1363b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            obj.f1362a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f1363b));
            return obj;
            ...
            obj.f1363b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            obj.f1364c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            obj.f1362a = R.drawable.filled_limit_boost;
            obj.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(obj.f1363b), Integer.valueOf(obj.f1364c));
            obj.f1365e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f1364c));
            obj.f1366f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f1363b));
            return obj;
    ...
    public final boolean B1() {
        ...
        int i21;
        int i22;
        NotificationCenter.getInstance(this.currentAccount).postNotificationNameOnUIThread(NotificationCenter.chatWasBoostedByUser, this.f46132b0, this.f46133c0.copy(), Long.valueOf(this.f46131a0));
        di.d dVar = this.S0;
        if (dVar != null) {
        ...
        TransitionManager.beginDelayedTransition(this.f46134d0, transitionSet);
        j0 j0Var = this.f46134d0;
        ug.b bVar = j0Var.f46123c;
        int indexOfChild = j0Var.indexOfChild(j0Var.f46122b);
        k0 k0Var = j0Var.f46124e;
        if (k0Var.f46135e0) {
            int indexOfChild2 = j0Var.indexOfChild(j0Var.d);
            j0Var.removeView(j0Var.d);
            j0Var.d.removeView(j0Var.f46121a);
            ...
            j0Var.d.addView(j0Var.f46121a, x5.o(-2, -2, 1.0f, 0));
            j0Var.d.addView(bVar, x5.t(-2, -2, 48, 0, 2, 0, 0));
            j0Var.addView(j0Var.d, indexOfChild2, x5.t(-2, -2, 1, 25, 22, 12, 9));
        } else {
            int indexOfChild3 = j0Var.indexOfChild(j0Var.f46121a);
            j0Var.removeView(j0Var.f46121a);
            TextView textView = new TextView(j0Var.getContext());
            j0Var.f46121a = textView;
            textView.setTypeface(AndroidUtilities.bold());
            j0Var.f46121a.setTextSize(1, 20.0f);
            j0Var.f46121a.setTextColor(j6.v0(j6.G6, k0Var.resourcesProvider));
            j0Var.f46121a.setGravity(17);
            j0Var.addView(j0Var.f46121a, indexOfChild3, x5.t(-2, -2, 1, 0, 22, 0, 0));
        }
        j0Var.removeView(j0Var.f46122b);
        TextView textView2 = new TextView(j0Var.getContext());
        j0Var.f46122b = textView2;
        textView2.setTextSize(1, 14.0f);
        TextView textView3 = j0Var.f46122b;
        textView3.setLineSpacing(textView3.getLineSpacingExtra(), j0Var.f46122b.getLineSpacingMultiplier() * 1.1f);
        j0Var.f46122b.setGravity(1);
        j0Var.f46122b.setTextColor(j6.v0(j6.G6, k0Var.resourcesProvider));
        j0Var.addView(j0Var.f46122b, indexOfChild, x5.t(-2, -2, 1, 24, -2, 24, 17));
        this.f46134d0.f46121a.setText(r1());
        TextView textView4 = this.f46134d0.f46122b;
        MessagesController messagesController = MessagesController.getInstance(this.currentAccount);
        boolean x12 = x1();
        int i23 = this.f46138h0;
        if (i23 == 20) {
            if (x12) {
        ...
        this.f46134d0.f46123c.a(this.f46133c0.boostCount, true);
        this.d.x0(0);
        if (i23 == 32) {
            this.f46134d0.f46123c.setVisibility(8);
        }
        return true;
    }
    ...
    public final void D1(ArrayList arrayList) {
        ...
        TextView textView = (TextView) b2Var.d(-1);
        if (textView != null) {
            textView.setTextColor(j6.v0(j6.f20899q7, this.resourcesProvider));
        }
    }
    ...
    public final void E1(HashMap hashMap) {
        ...
        if (!TextUtils.isEmpty(this.U0)) {
            ...
            TLRPC.ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.O0.f19869id);
            if (chatFull == null) {
                dismiss();
                return;
        ...
        HashSet hashSet = this.f46154y0;
        Iterator it = hashSet.iterator();
        while (it.hasNext()) {
            TLRPC.User user = (TLRPC.User) it.next();
            long sendPaidMessagesStars = MessagesController.getInstance(this.currentAccount).getSendPaidMessagesStars(user.f20016id);
            if (sendPaidMessagesStars <= 0) {
                sendPaidMessagesStars = DialogObject.getMessagesStarsPrice(MessagesController.getInstance(this.currentAccount).isUserContactBlocked(user.f20016id));
            }
            if (sendPaidMessagesStars >= 0) {
        ...
        if (hashMap2 == null && !arrayList2.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                i10++;
                arrayList4.add(Long.valueOf(((TLRPC.User) obj).f20016id));
            }
        ...
        while (it2.hasNext()) {
            ...
            if (hashMap2 == null) {
                ...
                longValue = ((Long) hashMap2.get(Long.valueOf(user2.f20016id))).longValue();
            }
            Iterator it3 = it2;
            SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(str2, user2.f20016id, null, null, null, true, null, null, null, false, 0, 0, null, false);
    ...
    public final void F1(TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus, boolean z10) {
        this.f46132b0 = tL_premium_boostsStatus;
        this.f46135e0 = z10;
        M1();
    }
    ...
    public final void G(ov0 ov0Var) {
        ...
        if (!this.f24651r && (i10 = this.f46138h0) != 18 && i10 != 20 && i10 != 24 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 22 && i10 != 23 && i10 != 21 && i10 != 27 && i10 != 28 && i10 != 30 && i10 != 35) {
            t50 t50Var = new t50(this, context, 11);
            this.L0 = t50Var;
            t50Var.setBackgroundColor(j6.v0(j6.f20735h5, this.resourcesProvider));
        ...
        this.E0.f46242r.setOnClickListener(new wy0(16, this, context));
        this.E0.f46239e.setOnClickListener(new u(this, 3));
        this.J0 = new qk0(ll0Var, true);
    }

    public final void G1(ChannelBoostsController.CanApplyBoost canApplyBoost) {
        this.f46133c0 = canApplyBoost;
        K1();
        L1();
    }
    ...
    public final void I1(TLRPC.Chat chat, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, String str) {
        ...
        if (this.Y) {
            ...
            while (i10 < size) {
                ...
                if (arrayList2 == null || !arrayList2.contains(Long.valueOf(user.f20016id))) {
                    hashSet.add(user);
                }
            }
        }
    ...
    public final void J1() {
        ...
        int i15;
        int i16;
        this.f46150u0 = new ArrayList();
        TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus = this.f46132b0;
        ...
        while (i10 <= i17) {
            ...
            if (arrayList != null && arrayList.size() == arrayList2.size()) {
                for (int i22 = 0; i22 < arrayList.size(); i22++) {
                    ...
                    int i23 = f0Var.f46095e;
                    if (f0Var2 != null && ((f0Var.f46096f && i23 > 2) || (f0Var.f46092a == f0Var2.f46092a && f0Var.f46093b == f0Var2.f46093b && TextUtils.equals(f0Var.f46094c, f0Var2.f46094c) && TextUtils.equals(f0Var.d, f0Var2.d) && i23 == f0Var2.f46095e))) {
                    }
                }
                i10++;
            }
            ArrayList arrayList3 = this.f46150u0;
            arrayList3.add(new e0(i10, arrayList3.isEmpty()));
            this.f46150u0.addAll(arrayList2);
            arrayList = arrayList2;
            i10++;
        }
    }
    ...
    public final void K1() {
        ...
        if (i11 != 19 && i11 != 32 && !y1()) {
            ...
            vq vqVar3 = this.E0.G;
            vqVar3.f31963a.c(hashSet.size(), true);
            this.E0.invalidate();
            return;
        }
        ChannelBoostsController.CanApplyBoost canApplyBoost = this.f46133c0;
        boolean z10 = canApplyBoost.canApply;
    ...
    public final void L1() {
        ...
        if (i12 != 19 && i12 != 32 && !y1()) {
            if (i12 != 18 && i12 != 20 && i12 != 24 && i12 != 25 && i12 != 26 && i12 != 29 && i12 != 22 && i12 != 23 && i12 != 21 && i12 != 27 && i12 != 28 && i12 != 30 && i12 != 35) {
                if (!UserConfig.getInstance(this.currentAccount).isPremium() && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() && !this.N0) {
                    ...
                    if (pVar != null) {
                        ...
                        a0 a0Var = this.E0;
                        a0Var.f46244w.f31513p = null;
                        a0Var.f46246y.setVisibility(8);
                        return;
                    }
                    a0 a0Var2 = this.E0;
                    a0Var2.f46244w.f31513p = null;
                    a0Var2.f46246y.setVisibility(8);
                    return;
                }
                this.E0.d.setText(LocaleController.getString(R.string.OK));
                a0 a0Var3 = this.E0;
                a0Var3.f46244w.f31513p = null;
                a0Var3.f46246y.setVisibility(8);
                return;
            }
            ...
            ChannelBoostsController.CanApplyBoost canApplyBoost2 = this.f46133c0;
    ...
    public final void M1() {
        ...
        if (i10 != 19 && i10 != 18 && i10 != 20 && i10 != 24 && i10 != 27 && i10 != 28 && i10 != 22 && i10 != 23 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 21 && i10 != 30 && i10 != 35) {
            if (i10 != 31 && i10 != 32) {
                if (!v1(i10)) {
                    ...
                    if (this.I0) {
                        ...
                        if (i10 != 11 || MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() || ((((arrayList = this.D0) == null || arrayList.isEmpty()) && ((arrayList2 = this.C0) == null || arrayList2.size() < this.B0.size())) || (arrayList3 = this.D0) == null || arrayList3.size() != 1 || (arrayList4 = this.C0) == null || arrayList4.size() != 1 || !this.Y)) {
                            int i13 = this.f46141k0;
                            this.f46144o0 = i13;
                            if (i10 != 11 && i10 != 34) {
                                if (i10 == 5) {
                                    this.f46141k0 = this.f46155z0.size() + i13;
                                } else {
                                    this.f46141k0 = this.f46139i0.size() + i13;
                                }
                            } else {
                                this.f46141k0 = this.B0.size() + i13;
                            }
                            this.f46145p0 = this.f46141k0;
                        }
                        if (this.f46145p0 - this.f46144o0 > 1) {
                            int i14 = this.f46141k0;
                            this.f46141k0 = i14 + 1;
                            this.f46147r0 = i14;
                        }
                    }
                ...
                this.v = 0.24f;
                J1();
                int i15 = this.f46141k0;
                this.f46144o0 = i15;
                int i16 = i15 + 1;
                this.f46141k0 = i16;
                this.f46149t0 = i15;
                int size = (this.f46150u0.size() - 1) + i16;
                this.f46141k0 = size;
                this.f46145p0 = size;
            }
        } else {
            if (i10 != 19 || ChatObject.hasAdminRights(s1())) {
                this.v = 0.24f;
                int i17 = this.f46141k0;
                this.f46141k0 = i17 + 1;
                this.Z = i17;
                if (MessagesController.getInstance(this.currentAccount).giveawayGiftsPurchaseAvailable) {
                    int i18 = this.f46141k0;
                    this.f46141k0 = i18 + 1;
                    this.f46148s0 = i18;
                }
            }
            J1();
            int i19 = this.f46141k0;
            int i20 = i19 + 1;
            this.f46141k0 = i20;
            this.f46149t0 = i19;
            this.f46141k0 = (this.f46150u0.size() - 1) + i20;
        }
        this.d.getAdapter().l();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.boostByChannelCreated) {
            ...
            if (tL_premium_boostsStatus != null && this.f46133c0 != null) {
                this.f46132b0.boosts += intValue;
                if (this.f46138h0 == 32 && (t12 = t1()) != null) {
                    t12.boosts_applied += intValue;
                }
                z1();
                F1(tL_premium_boostsStatus, this.f46135e0);
                ChannelBoostsController.CanApplyBoost canApplyBoost = this.f46133c0;
                if (this.f46132b0.next_level_boosts <= 0) {
                    z10 = true;
                } else {
                    z10 = false;
                }
    ...
    public final void m1(final g90 g90Var, boolean z10) {
        ...
        MessagesController.getInstance(this.currentAccount).getBoostsController().applyBoost(this.f46131a0, this.f46133c0.slot, new Utilities.Callback(this) {
            ...
            public final void run(Object obj) {
                switch (r3) {
                    case 0:
                        MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.f46131a0, new s7(this.f46369b, g90Var, (TL_stories.TL_premium_myBoosts) obj, 2));
                        return;
                    default:
                        ...
                        if (startsWith) {
                            ...
                            if (intValue <= 5) {
                                AndroidUtilities.runOnUIThread(new org.telegram.ui.web.g1(19, this.f46369b, g90Var2), intValue * 1000);
                                return;
                            }
                            ug.j.g(intValue);
                        }
    ...
    public final String p1() {
        ...
        if (tL_premium_boostsStatus != null && !TextUtils.isEmpty(tL_premium_boostsStatus.boost_url)) {
            return this.f46132b0.boost_url;
        }
        int i10 = this.currentAccount;
        long j3 = -this.f46131a0;
    ...
    public final String q1(boolean z10) {
        ...
        TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46131a0));
        if (chat == null) {
            if (x1()) {
        ...
        if (y1() && this.f46132b0.next_level_boosts != 0 && z10) {
            if (x1()) {
                i18 = R.string.GroupNeedBoostsDescriptionForNewFeatures;
            } else {
                i18 = R.string.ChannelNeedBoostsDescriptionForNewFeatures;
            }
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus2 = this.f46132b0;
        ...
        } else if (z11 && this.f46133c0.alreadyActive) {
            if (this.f46132b0.level == 1) {
                if (x1()) {
            ...
            return LocaleController.formatString(i16, Integer.valueOf(this.f46132b0.level), LocaleController.formatPluralString("BoostStories", this.f46132b0.level, new Object[0]));
        } else if (this.f46133c0.alreadyActive) {
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus3 = this.f46132b0;
            if (tL_premium_boostsStatus3.level == 0) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus4 = this.f46132b0;
                ...
                return LocaleController.formatString(i14, Integer.valueOf(this.f46132b0.level), LocaleController.formatPluralString("BoostStories", this.f46132b0.level + 1, new Object[0]));
            } else {
                if (x1()) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus5 = this.f46132b0;
            ...
            TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus6 = this.f46132b0;
            if (tL_premium_boostsStatus6.level == 0) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus7 = this.f46132b0;
                ...
                return LocaleController.formatString(i11, Integer.valueOf(this.f46132b0.level), LocaleController.formatPluralString("BoostStories", this.f46132b0.level + 1, new Object[0]));
            } else {
                if (x1()) {
                ...
                TL_stories.TL_premium_boostsStatus tL_premium_boostsStatus8 = this.f46132b0;
    ...
    public final String r1() {
        ...
        if (tL_premium_boostsStatus.level > 0 && !this.f46133c0.alreadyActive) {
            if (x1()) {
        ...
        boolean z10 = this.f46135e0;
        int i16 = this.f46138h0;
        if (z10) {
            if (i16 == 32) {
                if (x1()) {
            ...
            TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46131a0));
            if (this.f46133c0.alreadyActive) {
    ...
    public final TLRPC.Chat s1() {
        return MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46131a0));
    }

    public final TLRPC.ChatFull t1() {
        return MessagesController.getInstance(this.currentAccount).getChatFull(-this.f46131a0);
    }
    ...
    public final boolean x1() {
        return !ChatObject.isChannelAndNotMegaGroup(MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(-this.f46131a0)));
    }
    ...
    public final void z1() {
        ...
        i0Var.f24048b++;
        i0Var.f24046a = w7.p.a((i11 - i10) / i12, 0.0f, 1.0f);
        i0Var.W = true;
        i0Var.f24047a0 = i0Var.f24062n;
        i0Var.g(i11, true);
