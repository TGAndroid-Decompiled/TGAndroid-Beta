...
public final class o0 extends FrameLayout implements m0 {
    public final f6 f46190a;
    public final ArrayList f46191b;
    public final n0 f46192c;
    public final n0 d;
    public final n0 f46193e;
    public final boolean f46194f;

    public o0(Context context, f6 f6Var) {
        super(context);
        lb0[] values;
        this.f46191b = new ArrayList();
        this.f46190a = f6Var;
        for (lb0 lb0Var : lb0.values()) {
            if (lb0Var.f38265e) {
                this.f46191b.add(lb0Var);
            }
            if (this.f46191b.size() == 3) {
                break;
            }
        }
        if (this.f46191b.size() < 3) {
        ...
        this.f46192c = a(context, 0);
        this.d = a(context, 1);
        this.f46193e = a(context, 2);
        setClipChildren(false);
    }

    public final n0 a(Context context, int i10) {
        lb0 lb0Var = (lb0) this.f46191b.get(i10);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f46192c.getLayoutParams();
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f46193e.getLayoutParams();
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = pr.f29469i.getInterpolation(abs);
        int right = getRight();
        n0 n0Var = this.f46193e;
        ...
        float interpolation2 = pr.f29468g.getInterpolation(abs);
        int left = getLeft();
        n0 n0Var3 = this.d;
