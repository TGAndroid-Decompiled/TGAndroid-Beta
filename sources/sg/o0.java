...
public final class o0 extends FrameLayout implements m0 {
    ...
    public o0(Context context, f6 f6Var) {
        ...
        this.f46220c = a(context, 0);
        this.d = a(context, 1);
        this.f46221e = a(context, 2);
        setClipChildren(false);
    }

    public final n0 a(Context context, int i10) {
        lb0 lb0Var = (lb0) this.f46219b.get(i10);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f46220c.getLayoutParams();
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f46221e.getLayoutParams();
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = pr.f29496i.getInterpolation(abs);
        int right = getRight();
        n0 n0Var = this.f46221e;
        ...
        float interpolation2 = pr.f29495g.getInterpolation(abs);
        int left = getLeft();
        n0 n0Var3 = this.d;
