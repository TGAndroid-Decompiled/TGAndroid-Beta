...
public final class o0 extends FrameLayout implements m0 {
    public final f6 f46217a;
    public final ArrayList f46218b;
    public final n0 f46219c;
    public final n0 d;
    public final n0 f46220e;
    public final boolean f46221f;

    public o0(Context context, f6 f6Var) {
        super(context);
        lb0[] values;
        this.f46218b = new ArrayList();
        this.f46217a = f6Var;
        for (lb0 lb0Var : lb0.values()) {
            if (lb0Var.f38291e) {
                this.f46218b.add(lb0Var);
            }
            if (this.f46218b.size() == 3) {
                break;
            }
        }
        if (this.f46218b.size() < 3) {
        ...
        this.f46219c = a(context, 0);
        this.d = a(context, 1);
        this.f46220e = a(context, 2);
        setClipChildren(false);
    }

    public final n0 a(Context context, int i10) {
        lb0 lb0Var = (lb0) this.f46218b.get(i10);
        ...
        y1Var.O = this.f46217a;
        y1Var.P = j6.Zj;
        y1Var.c();
        paint.setColor(-1);
        qVar.setLayoutParams(x5.d(-2, -2.0f, 17, 0.0f, 52.0f, 0.0f, 0.0f));
        qVar.setForeground(lb0Var.f38290c);
        qVar.setBackgroundResource(lb0Var.f38289b);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f46219c.getLayoutParams();
        ...
        FrameLayout.LayoutParams layoutParams3 = (FrameLayout.LayoutParams) this.f46220e.getLayoutParams();
    ...
    public void setOffset(float f7) {
        ...
        float interpolation = pr.f29495i.getInterpolation(abs);
        int right = getRight();
        n0 n0Var = this.f46220e;
        ...
        float interpolation2 = pr.f29494g.getInterpolation(abs);
        int left = getLeft();
        n0 n0Var3 = this.d;
