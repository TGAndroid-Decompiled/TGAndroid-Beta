...
public final class g extends FrameLayout {
    public final x9 f46096a;
    public final o20 f46097b;
    ...
    public g(j jVar, Context context) {
        ...
        o20 o20Var = new o20();
        this.f46097b = o20Var;
        int i10 = jVar.f46119f;
        f6 f6Var = jVar.f46022a;
        if (i10 == 0) {
            this.f46098c = AndroidUtilities.dp(150.0f);
            ...
            o20Var.f28930c.setStrokeWidth(AndroidUtilities.dpf2(3.3f));
        } else if (i10 == 1) {
            ...
            int i11 = j6.Mj;
            canvas.drawColor(i0.a.d(0.5f, j6.v0(i11, f6Var), j6.v0(j6.f20734h5, f6Var)));
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.d.f46119f == 0) {
            ...
            for (int i10 = 0; i10 < 7; i10++) {
                ...
                float f11 = 5;
                float f12 = f10 + f11;
                canvas.drawArc(AndroidUtilities.rectTmp, f12, ((f10 + f7) - f11) - f12, false, o20Var.f28930c);
            }
        }
