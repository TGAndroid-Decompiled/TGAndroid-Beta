...
public final class n1 extends kl0 {
    ...
    @Override
    public final int h() {
        return this.f46185c.f46199f0;
    }

    @Override
    public final int j(int i10) {
        o1 o1Var = this.f46185c;
        if (i10 != o1Var.f46200g0) {
            if (i10 >= o1Var.f46201h0 && i10 < o1Var.f46202i0) {
                return o1Var.X();
            }
            if (i10 >= o1Var.f46203j0 && i10 < o1Var.f46204k0) {
                return 1;
            }
            if (i10 == o1Var.f46205l0) {
                return 2;
            }
            if (i10 == o1Var.m0) {
                return 3;
    ...
    public final void v(s4.c1 c1Var, int i10) {
        ...
        o1 o1Var = this.f46185c;
        int i11 = o1Var.f46203j0;
        if (i10 >= i11 && i10 < o1Var.f46204k0) {
            uw0 uw0Var = (uw0) view;
            kx0 kx0Var = (kx0) o1Var.X.get(i10 - i11);
            boolean z10 = true;
            if (i10 == o1Var.f46204k0 - 1) {
                z10 = false;
            }
            uw0Var.a(kx0Var, z10);
        } else if (i10 >= o1Var.f46201h0 && i10 < o1Var.f46202i0) {
            o1Var.Y(view);
        }
    }
    ...
    public final s4.c1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 != 0) {
            if (i10 != 2) {
                        ...
                        if (i10 != 5) {
                            ...
                            d0Var.setText(AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceSingleTag(string, i12, 0, new Runnable(this) {
                                ...
                                public final void run() {
                                    switch (r2) {
                                        case 0:
                                            of.f.s(this.f46156b.f46185c.f46212t0.getParentActivity(), LocaleController.getString(R.string.TermsOfServiceUrl));
                                            return;
                                        default:
                                            of.f.s(this.f46156b.f46185c.f46212t0.getParentActivity(), LocaleController.getString(R.string.PrivacyPolicyUrl));
                                            return;
                                    }
                                }
                ...
                bx0Var = new a7(context, o1Var.getThemedColor(j6.f20607a7), 0);
            }
        } else {
            cc1 cc1Var = new cc1(this, context, 17);
            o1Var.f46211s0 = cc1Var;
            cc1Var.setOrientation(1);
            View view = o1Var.B0;
            if (view == null) {
                o1Var.f46210r0 = new eg0(context, 1, 0, 2);
                Bitmap createBitmap = Bitmap.createBitmap(50, 50, Bitmap.Config.ARGB_8888);
                Canvas canvas = new Canvas(createBitmap);
                int i13 = j6.Mj;
                canvas.drawColor(i0.a.d(0.5f, o1Var.getThemedColor(i13), o1Var.getThemedColor(j6.f20734h5)));
                o1Var.f46210r0.setBackgroundBitmap(createBitmap);
                tg.a aVar = o1Var.f46210r0.f46519b;
                aVar.f46507w = i13;
                aVar.f46508x = j6.Lj;
                aVar.b();
                cc1Var.addView(o1Var.f46210r0, x5.q(160, 160, 1));
            } else {
            ...
            if (o1Var.N0 == null) {
                ...
                Integer num = o1Var.f46213u0;
                if (num == null) {
                    intValue = o1Var.getThemedColor(j6.f20990v6);
                } else {
            ...
            o1Var.a0(false);
            o1Var.f46209q0 = new fi.g(context, 5);
            l1 l1Var = new l1(this, context, 0);
            l1Var.setClipChildren(false);
            l1Var.addView(o1Var.f46209q0);
            l1Var.addView(cc1Var);
            eg0 eg0Var = o1Var.f46210r0;
            bx0Var = l1Var;
            if (eg0Var != null) {
                eg0Var.setStarParticlesView(o1Var.f46209q0);
                bx0Var = l1Var;
            }
        }
