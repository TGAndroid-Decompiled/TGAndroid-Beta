...
public final class y0 implements z4.e {
    public final sa f46342a;
    public final a1 f46343b;
    ...
    public final void a(float f7, int i10, int i11) {
        int i12;
        sa saVar = this.f46342a;
        saVar.f30238b = f7;
        saVar.f30239c = i10;
        saVar.invalidate();
        a1 a1Var = this.f46343b;
        a1Var.G = i10;
        if (i11 > 0) {
            i12 = i10 + 1;
        } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if (!a1Var.f46018w || !(z0Var.f46374f instanceof o0)) {
                int i13 = z0Var.f46370a;
                m0 m0Var = z0Var.f46373e;
                if (i13 == a1Var.G) {
            ...
            if (z0Var.f46374f instanceof o0) {
                z0Var.setTranslationX(-f7);
                z0Var.f46371b.setTranslationX(f7);
                z0Var.f46372c.setTranslationX(f7);
            }
            i12++;
        }
        int i14 = a1Var.G;
        if (i14 >= 0 && i14 < arrayList.size() && ((i11 = ((kx0) arrayList.get(a1Var.G)).f38147a) == 0 || i11 == 14 || i11 == 28)) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i15 = a1Var.H;
        if (i15 >= 0 && i15 < arrayList.size() && ((i10 = ((kx0) arrayList.get(a1Var.H)).f38147a) == 0 || i10 == 14 || i10 == 28)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        int i16 = (int) ((1.0f - a1Var.f46013e) * 255.0f);
        if (i16 != a1Var.K) {
            a1Var.K = i16;
            a1Var.f46016r.invalidate();
