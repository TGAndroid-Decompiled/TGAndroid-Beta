...
public final class y0 implements z4.e {
    public final sa f46371a;
    public final a1 f46372b;
    ...
    public final void a(float f7, int i10, int i11) {
        int i12;
        sa saVar = this.f46371a;
        saVar.f30266b = f7;
        saVar.f30267c = i10;
        saVar.invalidate();
        a1 a1Var = this.f46372b;
        a1Var.G = i10;
        if (i11 > 0) {
            i12 = i10 + 1;
        } else {
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if (!a1Var.f46047w || !(z0Var.f46403f instanceof o0)) {
                int i13 = z0Var.f46399a;
                m0 m0Var = z0Var.f46402e;
                if (i13 == a1Var.G) {
            ...
            if (z0Var.f46403f instanceof o0) {
                z0Var.setTranslationX(-f7);
                z0Var.f46400b.setTranslationX(f7);
                z0Var.f46401c.setTranslationX(f7);
            }
            i12++;
        }
        int i14 = a1Var.G;
        if (i14 >= 0 && i14 < arrayList.size() && ((i11 = ((kx0) arrayList.get(a1Var.G)).f38175a) == 0 || i11 == 14 || i11 == 28)) {
            z10 = true;
        } else {
            z10 = false;
        }
        int i15 = a1Var.H;
        if (i15 >= 0 && i15 < arrayList.size() && ((i10 = ((kx0) arrayList.get(a1Var.H)).f38175a) == 0 || i10 == 14 || i10 == 28)) {
            z11 = true;
        } else {
            z11 = false;
        }
        ...
        int i16 = (int) ((1.0f - a1Var.f46042e) * 255.0f);
        if (i16 != a1Var.K) {
            a1Var.K = i16;
            a1Var.f46045r.invalidate();
