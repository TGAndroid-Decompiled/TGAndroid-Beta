...
public class e extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public final b f43225a0;
    public a f43226b;
    public SurfaceTexture f43227c;
    public EGLDisplay d;
    public EGLSurface e;
    public EGLContext f43228f;
    public EGL10 h;
    public EGLConfig f43229n;
    public GL10 f43230r;
    public int f43231s;
    public int v;
    public int f43232w;
    public boolean f43233x;
    public boolean f43234y;
    ...
    public e(Context context, int i10, int i11) {
        ...
        this.V = new ValueAnimator.AnimatorUpdateListener(this) {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                switch (r2) {
                    case 0:
                        this.f43219b.f43226b.e = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        return;
                    case 1:
                        this.f43219b.f43226b.d = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        return;
                    default:
                        this.f43219b.f43226b.f43200g = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                        return;
                }
            }
        };
        ...
        this.f43225a0 = new ValueAnimator.AnimatorUpdateListener(this) {
            public final e f43219b;
        ...
        if (eglGetDisplay != EGL10.EGL_NO_DISPLAY) {
            if (eVar.h.eglInitialize(eglGetDisplay, new int[2])) {
                ...
                if (eVar.h.eglChooseConfig(eVar.d, iArr, eGLConfigArr, 1, iArr2)) {
                    if (iArr2[0] > 0) {
                        eVar.f43229n = eGLConfigArr[0];
                    }
                    EGLConfig eGLConfig = eVar.f43229n;
                    if (eGLConfig != null) {
                        eVar.f43228f = eVar.h.eglCreateContext(eVar.d, eGLConfig, EGL10.EGL_NO_CONTEXT, new int[]{12440, 2, 12344});
                        eVar.f();
                        eVar.e = eVar.h.eglCreateWindowSurface(eVar.d, eVar.f43229n, eVar.f43227c, null);
                        eVar.f();
                        EGLSurface eGLSurface = eVar.e;
                        if (eGLSurface != null && eGLSurface != EGL10.EGL_NO_SURFACE) {
                            if (eVar.h.eglMakeCurrent(eVar.d, eGLSurface, eGLSurface, eVar.f43228f)) {
                                eVar.f();
                                eVar.f43230r = (GL10) eVar.f43228f.getGL();
                                eVar.f();
                                return;
                            }
    ...
    public static void c(e eVar, float f7) {
        synchronized (eVar) {
            try {
                ...
                if (aVar != null) {
                    aVar.D = f7;
                    aVar.onDrawFrame(eVar.f43230r);
                }
                int glGetError = eVar.f43230r.glGetError();
                if (glGetError != 0) {
    ...
    public final void e() {
        if (this.f43228f.equals(this.h.eglGetCurrentContext()) && this.e.equals(this.h.eglGetCurrentSurface(12377))) {
            return;
        }
        f();
        EGL10 egl10 = this.h;
        ...
        if (egl10.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, this.f43228f)) {
            f();
            return;
        }
    ...
    public void k() {
        ...
        if (intValue == 0) {
            ...
            if (i13 == 4) {
                ...
                float f10 = 48;
                ValueAnimator ofFloat2 = ValueAnimator.ofFloat(this.f43226b.f43200g, f10);
                ...
                float f11 = i10;
                ValueAnimator ofFloat4 = ValueAnimator.ofFloat(this.f43226b.f43200g, f11);
            ...
            this.T = new AnimatorSet();
            ValueAnimator ofFloat6 = ValueAnimator.ofFloat(this.f43226b.d, 360.0f);
            ofFloat6.addUpdateListener(bVar2);
            ofFloat6.setDuration(8000L);
            ofFloat6.setInterpolator(rr.f28031f);
            this.T.playTogether(ofFloat6);
            this.T.addListener(new d(this, 0));
            this.T.start();
        } else if (intValue == 2) {
            this.T = new AnimatorSet();
            ValueAnimator ofFloat7 = ValueAnimator.ofFloat(this.f43226b.d, 184.0f);
            ofFloat7.addUpdateListener(bVar2);
            ofFloat7.setDuration(600L);
            rr rrVar = rr.f28032g;
            ofFloat7.setInterpolator(rrVar);
            ValueAnimator ofFloat8 = ValueAnimator.ofFloat(this.f43226b.f43200g, 50.0f);
            ...
            this.T = new AnimatorSet();
            ValueAnimator ofFloat12 = ValueAnimator.ofFloat(this.f43226b.d, 180.0f);
            ofFloat12.addUpdateListener(bVar2);
            ofFloat12.setDuration(600L);
            rr rrVar2 = rr.f28031f;
            ofFloat12.setInterpolator(rrVar2);
            ...
            ofFloat13.setInterpolator(rrVar2);
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i10, int i11) {
        this.G = new k(this);
        this.f43227c = surfaceTexture;
        this.f43232w = i10;
        this.v = i11;
        this.f43231s = Math.max(0, ((int) ((1.0f / this.H) * 1000.0f)) - 1);
        this.G.start();
    }
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i10, int i11) {
        ...
        a aVar = this.f43226b;
        if (aVar != null) {
            aVar.onSurfaceChanged(this.f43230r, i10, i11);
        }
    }
