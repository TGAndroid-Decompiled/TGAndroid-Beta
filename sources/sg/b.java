...
public abstract class b extends FrameLayout implements m0 {
    public final f6 f46051a;
    public final ll0 f46052b;
    public final s4.c0 f46053c;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        Paint T0 = j6.T0("paintDivider", this.f46051a);
        if (T0 == null) {
            T0 = j6.f20813k0;
        }
    ...
    public void setOffset(float f7) {
        if (Math.abs(f7 / getMeasuredWidth()) == 1.0f) {
            ll0 ll0Var = this.f46052b;
            if (ll0Var.K(0) == null || ll0Var.K(0).f45767a.getTop() != ll0Var.getPaddingTop()) {
                ll0Var.u0(0);
            }
        }
    }
    ...
    public void setTopOffset(int i10) {
        this.f46052b.setPadding(0, i10, 0, 0);
    }
}
