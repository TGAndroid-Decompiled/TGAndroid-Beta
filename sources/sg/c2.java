...
public final class c2 extends FrameLayout implements m0, NotificationCenter.NotificationCenterDelegate {
    ...
    public int S;
    public long T;
    public final SvgHelper.SvgDrawable f46075a;
    public final Paint f46076b;
    public final Paint f46077c;
    public final boolean d;
    public File f46078e;
    public float f46079f;
    public final String h;
    public final ImageReceiver f46080n;
    public p0 f46081r;
    public final int f46082s;
    public final int v;
        ...
        if ((file != null && file.exists()) || SharedConfig.streamMedia) {
            ...
            if (file2 != null && file2.exists()) {
                ...
                try {
                    ...
                    mediaMetadataRetriever.setDataSource(ApplicationLoader.applicationContext, Uri.fromFile(this.f46078e));
                    int parseInt = Integer.parseInt(mediaMetadataRetriever.extractMetadata(18));
                    int parseInt2 = Integer.parseInt(mediaMetadataRetriever.extractMetadata(19));
                    mediaMetadataRetriever.release();
                    this.f46079f = parseInt / parseInt2;
    ...
    public final void b() {
        Uri uri;
        int i10 = this.f46082s;
        if ((this.f46078e != null || SharedConfig.streamMedia) && this.H == null) {
            this.I.a(this.f46079f, 0);
            ...
            if (file != null && file.exists()) {
                uri = Uri.fromFile(this.f46078e);
            } else {
                try {
                    StringBuilder sb2 = new StringBuilder("?account=");
                    sb2.append(i10);
                    sb2.append("&id=");
                    sb2.append(this.R.f19902id);
                    sb2.append("&hash=");
    ...
    public final void c() {
        ...
        if (this.f46085y != z10) {
            this.f46085y = z10;
            ImageReceiver imageReceiver = this.f46080n;
            if (z10) {
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f46082s).addObserver(this, NotificationCenter.fileLoaded);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f46084x = false;
        c();
        NotificationCenter.getInstance(this.f46082s).removeObserver(this, NotificationCenter.fileLoaded);
        org.telegram.ui.Cells.u0 u0Var = this.P;
        if (u0Var != null) {
            HashMap hashMap = (HashMap) u0Var.f23335f;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.S != measuredWidth) {
            ...
            ra.a aVar = this.Q;
            if (aVar != null) {
                RectF rectF = (RectF) aVar.f45093c;
                ((Rect) aVar.f45094e).set(0, 0, getMeasuredWidth(), getMeasuredHeight());
                rectF.set(AndroidUtilities.rectTmp);
                rectF.inset(AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
            }
            y1 y1Var = this.N;
            if (y1Var != null) {
                RectF rectF2 = y1Var.f46375c;
                RectF rectF3 = y1Var.f46373a;
                int i14 = this.v;
                if (i14 != 6 && i14 != 9 && i14 != 3 && i14 != 7 && i14 != 24 && i14 != 43 && i14 != 11 && i14 != 4) {
                    ...
                    y1Var.f46374b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                } else {
            ...
            org.telegram.ui.Cells.u0 u0Var = this.P;
            if (u0Var != null) {
                ((RectF) u0Var.f23336g).set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                ((RectF) this.P.h).set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                ((RectF) this.P.f23336g).inset(AndroidUtilities.dp(0.0f), getMeasuredHeight() * 0.1f);
                ArrayList arrayList2 = this.P.f23333c;
