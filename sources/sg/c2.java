...
public final class c2 extends FrameLayout implements m0, NotificationCenter.NotificationCenterDelegate {
    ...
    public int S;
    public long T;
    public final SvgHelper.SvgDrawable f46047a;
    public final Paint f46048b;
    public final Paint f46049c;
    public final boolean d;
    public File f46050e;
    public float f46051f;
    public final String h;
    public final ImageReceiver f46052n;
    public p0 f46053r;
    public final int f46054s;
    public final int v;
    public boolean f46055w;
        ...
        if ((file != null && file.exists()) || SharedConfig.streamMedia) {
            ...
            if (file2 != null && file2.exists()) {
                ...
                try {
                    ...
                    mediaMetadataRetriever.setDataSource(ApplicationLoader.applicationContext, Uri.fromFile(this.f46050e));
                    int parseInt = Integer.parseInt(mediaMetadataRetriever.extractMetadata(18));
                    int parseInt2 = Integer.parseInt(mediaMetadataRetriever.extractMetadata(19));
                    mediaMetadataRetriever.release();
                    this.f46051f = parseInt / parseInt2;
    ...
    public final void b() {
        Uri uri;
        int i10 = this.f46054s;
        if ((this.f46050e != null || SharedConfig.streamMedia) && this.H == null) {
            this.I.a(this.f46051f, 0);
    ...
    public final void c() {
        ...
        if (this.f46057y != z10) {
            this.f46057y = z10;
            ImageReceiver imageReceiver = this.f46052n;
            if (z10) {
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f46054s).addObserver(this, NotificationCenter.fileLoaded);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f46056x = false;
        c();
        NotificationCenter.getInstance(this.f46054s).removeObserver(this, NotificationCenter.fileLoaded);
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.S != measuredWidth) {
            ...
            ra.a aVar = this.Q;
            if (aVar != null) {
                RectF rectF = (RectF) aVar.f45065c;
                ((Rect) aVar.f45066e).set(0, 0, getMeasuredWidth(), getMeasuredHeight());
                rectF.set(AndroidUtilities.rectTmp);
                rectF.inset(AndroidUtilities.dp(16.0f), AndroidUtilities.dp(16.0f));
            }
            y1 y1Var = this.N;
            if (y1Var != null) {
                RectF rectF2 = y1Var.f46347c;
                RectF rectF3 = y1Var.f46345a;
                int i14 = this.v;
                if (i14 != 6 && i14 != 9 && i14 != 3 && i14 != 7 && i14 != 24 && i14 != 43 && i14 != 11 && i14 != 4) {
                    ...
                    y1Var.f46346b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                } else {
            ...
            org.telegram.ui.Cells.u0 u0Var = this.P;
            if (u0Var != null) {
                ((RectF) u0Var.f23309g).set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                ((RectF) this.P.h).set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                ((RectF) this.P.f23309g).inset(AndroidUtilities.dp(0.0f), getMeasuredHeight() * 0.1f);
                ArrayList arrayList2 = this.P.f23306c;
