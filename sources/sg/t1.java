...
public class t1 extends ViewGroup {
    ...
    public final int h;
    public lx0 f46316n;
    public final TextView f46317r;
    public final int f46318s;
    public final int v;
    public int f46319w;
    public LinearGradient f46320x;
    public final Paint f46321y;
    ...
    public t1(Context context) {
        ...
        this.f46315f = 12;
        this.h = 8;
        this.f46318s = j6.f20691d6;
        this.v = j6.f20635a7;
        this.f46321y = new Paint();
        this.H = new Matrix();
        mp mpVar = new mp(context, 24, null);
        this.f46311a = mpVar;
        mpVar.setDrawBackgroundAsArc(10);
        int i13 = j6.f20747g7;
        mpVar.b(i13, i13, j6.f20820k7);
        addView(mpVar);
    ...
    public final void d() {
        ...
        int w02 = j6.w0(null, this.f46318s, false);
        ...
        this.f46320x = linearGradient;
        this.f46321y.setShader(linearGradient);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.L) {
            ...
            drawChild(canvas, this.f46311a, getDrawingTime());
            d();
            e();
            RectF rectF = AndroidUtilities.rectTmp;
            TextView textView = this.f46313c;
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint);
            TextView textView3 = this.f46312b;
    ...
    public final void e() {
        ...
        if (i10 >= measuredWidth * 4) {
            this.J = (-this.f46319w) * 2;
        }
        Matrix matrix = this.H;
        matrix.setTranslate(this.J + this.K, 0.0f);
        LinearGradient linearGradient = this.f46320x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.M) {
            ...
            TextView textView = this.f46312b;
            if (z10) {
                canvas.drawLine(0.0f, getHeight() - 1, textView.getRight(), getHeight() - 1, j6.f20813k0);
            } else {
                canvas.drawLine(textView.getLeft(), getHeight() - 1, getWidth(), getHeight() - 1, j6.f20813k0);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView3 = this.f46314e;
        ...
        TextView textView4 = this.f46317r;
        ...
        TextView textView5 = this.f46312b;
        if (visibility == 8) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f46312b.measure(View.MeasureSpec.makeMeasureSpec((size - mpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
        TextView textView2 = this.f46317r;
        int i12 = 0;
        if (textView2.getVisibility() == 0) {
        ...
        TextView textView4 = this.f46314e;
    ...
    public void setCirclePaintProvider(GenericProvider<Void, Paint> genericProvider) {
        this.f46311a.setCirclePaintProvider(genericProvider);
    }
    ...
    public void setEnabled(boolean z10) {
        ...
        this.f46312b.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.6f;
        }
        this.f46313c.setAlpha(f10);
        if (z10) {
            f11 = 1.0f;
        }
        this.f46311a.setAlpha(f11);
    }
    ...
    public void setProgressDelegate(np npVar) {
        this.f46311a.setProgressDelegate(npVar);
    }
}
