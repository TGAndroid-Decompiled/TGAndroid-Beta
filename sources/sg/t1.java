...
public class t1 extends ViewGroup {
    ...
    public boolean L;
    public boolean M;
    public final mp f46283a;
    public final TextView f46284b;
    public final TextView f46285c;
    public final TextView d;
    public final TextView f46286e;
    public final int f46287f;
    public final int h;
    public lx0 f46288n;
    public final TextView f46289r;
    public final int f46290s;
    public final int v;
    public int f46291w;
    public LinearGradient f46292x;
    public final Paint f46293y;
    ...
    public t1(Context context) {
        ...
        this.f46287f = 12;
        this.h = 8;
        this.f46290s = j6.f20664d6;
        this.v = j6.f20608a7;
        this.f46293y = new Paint();
        this.H = new Matrix();
        mp mpVar = new mp(context, 24, null);
        this.f46283a = mpVar;
        mpVar.setDrawBackgroundAsArc(10);
        int i13 = j6.f20720g7;
        mpVar.b(i13, i13, j6.f20793k7);
        addView(mpVar);
        TextView textView = new TextView(context);
        this.f46284b = textView;
    ...
    public final void d() {
        ...
        int w02 = j6.w0(null, this.f46290s, false);
        ...
        this.f46292x = linearGradient;
        this.f46293y.setShader(linearGradient);
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.L) {
            ...
            drawChild(canvas, this.f46283a, getDrawingTime());
            d();
            e();
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.dp(8.0f), AndroidUtilities.dp(8.0f), paint);
            TextView textView3 = this.f46284b;
    ...
    public final void e() {
        ...
        if (i10 >= measuredWidth * 4) {
            this.J = (-this.f46291w) * 2;
        }
        Matrix matrix = this.H;
        matrix.setTranslate(this.J + this.K, 0.0f);
        LinearGradient linearGradient = this.f46292x;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.M) {
            ...
            TextView textView = this.f46284b;
            if (z10) {
                canvas.drawLine(0.0f, getHeight() - 1, textView.getRight(), getHeight() - 1, j6.f20786k0);
            } else {
                canvas.drawLine(textView.getLeft(), getHeight() - 1, getWidth(), getHeight() - 1, j6.f20786k0);
            }
        }
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        TextView textView3 = this.f46286e;
        ...
        TextView textView4 = this.f46289r;
        ...
        TextView textView5 = this.f46284b;
        if (visibility == 8) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f46284b.measure(View.MeasureSpec.makeMeasureSpec((size - mpVar.getMeasuredWidth()) - textView.getMeasuredWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(dp, Integer.MIN_VALUE));
        TextView textView2 = this.f46289r;
        int i12 = 0;
        if (textView2.getVisibility() == 0) {
        ...
        TextView textView4 = this.f46286e;
    ...
    public void setCirclePaintProvider(GenericProvider<Void, Paint> genericProvider) {
        this.f46283a.setCirclePaintProvider(genericProvider);
    }
    ...
    public void setEnabled(boolean z10) {
        ...
        this.f46284b.setAlpha(f7);
        if (z10) {
            f10 = 1.0f;
        } else {
            f10 = 0.6f;
        }
        this.f46285c.setAlpha(f10);
        if (z10) {
            f11 = 1.0f;
        }
        this.f46283a.setAlpha(f11);
    }
    ...
    public void setProgressDelegate(np npVar) {
        this.f46283a.setProgressDelegate(npVar);
    }
}
