...
public final class f {
    public static final String[] f43248a0 = {"models/star.binobj"};
    public static final String[] f43249b0 = {"models/diamond_outer_2.binobj", "models/diamond_outer.binobj", "models/diamond.binobj"};
    public static final String[] f43250c0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/coin_logo.binobj", "models/coin_stars.binobj"};
    public static final String[] f43251d0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/deal_logo.binobj", "models/coin_stars.binobj"};
    public boolean D;
    public final int E;
    public final int F;
    public final int G;
    ...
    public final FloatBuffer[] f43255f;
    ...
    public final int f43262n;
    public final int f43263o;
    public final int f43264p;
    public final int f43265q;
    public final int f43266r;
    public float f43267s;
    public final int[] f43268t;
    public int f43272y;
    public int f43273z;
    public float f43269u = 0.0f;
    public float v = 2.0f;
    public float f43270w = 0.13f;
    public float f43271x = 1.0f;
    public float A = 0.2f;
    public int B = -1;
    public int C = -1;
    public float Z = 0.0f;
    ...
    public final void a(int i10, boolean z10) {
        ...
        GLES20.glVertexAttribPointer(this.f43260l, 2, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 1]);
        GLES20.glVertexAttribPointer(this.f43261m, 3, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 2]);
        GLES20.glVertexAttribPointer(this.f43259k, 3, 5126, false, 0, 0);
        ...
        GLES20.glDrawArrays(4, 0, this.f43268t[i10] / 3);
    }
}
