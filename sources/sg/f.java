...
public final class f {
    public static final String[] f42898a0 = {"models/star.binobj"};
    public static final String[] f42899b0 = {"models/diamond_outer_2.binobj", "models/diamond_outer.binobj", "models/diamond.binobj"};
    public static final String[] f42900c0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/coin_logo.binobj", "models/coin_stars.binobj"};
    public static final String[] f42901d0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/deal_logo.binobj", "models/coin_stars.binobj"};
    public boolean D;
    public final int E;
    public final int F;
    public final int G;
    ...
    public final FloatBuffer[] f42905f;
    ...
    public final int f42916r;
    public float f42917s;
    public final int[] f42918t;
    public int f42922y;
    public int f42923z;
    public float f42919u = 0.0f;
    public float v = 2.0f;
    public float f42920w = 0.13f;
    public float f42921x = 1.0f;
    public float A = 0.2f;
    public int B = -1;
    public int C = -1;
    public float Z = 0.0f;
    ...
    public final void a(int i10, boolean z10) {
        ...
        GLES20.glVertexAttribPointer(this.f42910l, 2, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 1]);
        GLES20.glVertexAttribPointer(this.f42911m, 3, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 2]);
        GLES20.glVertexAttribPointer(this.f42909k, 3, 5126, false, 0, 0);
        ...
        GLES20.glDrawArrays(4, 0, this.f42918t[i10] / 3);
    }
}
