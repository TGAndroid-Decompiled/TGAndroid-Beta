...
public final class f extends LinearLayout {
    public final TextView f46116a;
    public final TextView f46117b;
    public final LimitPreviewView f46118c;
    ...
    public f(Context context, f6 f6Var) {
        ...
        this.f46118c = limitPreviewView;
        addView(limitPreviewView, x5.p(-1, -2, 0.0f, 0, 0, 8, 0, 21));
    }

    public final void a(e eVar) {
        this.f46116a.setText(eVar.f46100a);
        this.f46117b.setText(eVar.f46101b);
        LimitPreviewView limitPreviewView = this.f46118c;
        limitPreviewView.v.setText(String.format("%d", Integer.valueOf(eVar.d)));
        limitPreviewView.f24091w.setText(String.format("%d", Integer.valueOf(eVar.f46102c)));
    }
}
