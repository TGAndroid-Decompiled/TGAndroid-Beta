...
public final class f {
    public static final String[] f43235a0 = {"models/star.binobj"};
    public static final String[] f43236b0 = {"models/diamond_outer_2.binobj", "models/diamond_outer.binobj", "models/diamond.binobj"};
    public static final String[] f43237c0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/coin_logo.binobj", "models/coin_stars.binobj"};
    public static final String[] f43238d0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/deal_logo.binobj", "models/coin_stars.binobj"};
    public boolean D;
    public final int E;
    public final int F;
    public final int G;
    ...
    public final void a(int i10, boolean z10) {
        ...
        GLES20.glVertexAttribPointer(this.f43247l, 2, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 1]);
        GLES20.glVertexAttribPointer(this.f43248m, 3, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 2]);
        GLES20.glVertexAttribPointer(this.f43246k, 3, 5126, false, 0, 0);
        ...
        GLES20.glDrawArrays(4, 0, this.f43255t[i10] / 3);
    }
}
