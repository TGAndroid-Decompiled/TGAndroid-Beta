...
public final class f {
    public static final String[] f43269a0 = {"models/star.binobj"};
    public static final String[] f43270b0 = {"models/diamond_outer_2.binobj", "models/diamond_outer.binobj", "models/diamond.binobj"};
    public static final String[] f43271c0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/coin_logo.binobj", "models/coin_stars.binobj"};
    public static final String[] f43272d0 = {"models/coin_outer.binobj", "models/coin_inner.binobj", "models/deal_logo.binobj", "models/coin_stars.binobj"};
    public boolean D;
    public final int E;
    public final int F;
    public final int G;
    ...
    public final FloatBuffer[] f43276f;
    public final int f43277g;
    public final int h;
    public final int f43278i;
    public final int f43279j;
    public final int f43280k;
    public final int f43281l;
    public final int f43282m;
    public final int f43283n;
    public final int f43284o;
    public final int f43285p;
    public final int f43286q;
    public final int f43287r;
    public float f43288s;
    public final int[] f43289t;
    public int f43293y;
    public int f43294z;
    public float f43290u = 0.0f;
    public float v = 2.0f;
    public float f43291w = 0.13f;
    public float f43292x = 1.0f;
    public float A = 0.2f;
    public int B = -1;
    public int C = -1;
    public float Z = 0.0f;
    ...
    public final void a(int i10, boolean z10) {
        ...
        GLES20.glVertexAttribPointer(this.f43281l, 2, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 1]);
        GLES20.glVertexAttribPointer(this.f43282m, 3, 5126, false, 0, 0);
        GLES20.glBindBuffer(34962, this.Y[i11 + 2]);
        GLES20.glVertexAttribPointer(this.f43280k, 3, 5126, false, 0, 0);
        ...
        GLES20.glDrawArrays(4, 0, this.f43289t[i10] / 3);
    }
}
