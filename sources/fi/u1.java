...
public final class u1 implements oy, org.telegram.ui.ActionBar.a2, ResultCallback {
    ...
    public void onComplete(Object obj) {
        ...
        kp kpVar = (kp) this.f9994e;
        Pair pair = (Pair) obj;
        if (pair != null && ((Long) pair.first).longValue() == this.f9993c) {
    ...
    public boolean u(uy uyVar, ArrayList arrayList, CharSequence charSequence, boolean z10, boolean z11, int i10, int i11, eg1 eg1Var) {
        ...
        frameLayout.setBackground(j6.c0(AndroidUtilities.dp(28.0f), AndroidUtilities.dp(28.0f), j6.w0(null, j6.f20657ci, false)));
        ...
        x9Var2.setEmojiColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f21065z9, false), PorterDuff.Mode.SRC_IN));
        ...
        j5Var.setTextColor(j6.w0(null, j6.f20771j5, false));
        ...
        editTextBoldCursor.setHighlightColor(j6.w0(null, j6.f20982uf, false));
        editTextBoldCursor.setHandlesColor(j6.w0(null, j6.f20999vf, false));
    ...
    public u1(uy uyVar, int i10, long j3, TL_bots.botVerifierSettings botverifiersettings) {
        ...
        this.f9992b = i10;
        this.f9993c = j3;
        this.f9994e = botverifiersettings;
    }
}
