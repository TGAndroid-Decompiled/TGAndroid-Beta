...
public final class b4 extends FrameLayout {
    ...
    public final f6 f9593b;
    public final x9 f9594c;
    public final View d;
    public final View f9595e;
    public final ImageView f9596f;
    public final TextView h;
    public final TextView f9597n;
    public final ImageView f9598r;
    ...
    public b4(Context context, int i10, f6 f6Var) {
        ...
        this.d = view;
        view.setBackground(j6.K(AndroidUtilities.dp(11.0f), j6.v0(j6.f20691d6, f6Var)));
        ...
        h.setTextColor(j6.v0(j6.f21089z6, f6Var));
        linearLayout.addView(h, x5.t(-1, -2, 55, 6, 1, 24, 0));
        ImageView imageView2 = new ImageView(context);
        this.f9598r = imageView2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (this.f9599s) {
            canvas.drawRect(AndroidUtilities.dp(72.0f), getHeight() - 1, getWidth(), getHeight(), j6.f20813k0);
        }
    }
