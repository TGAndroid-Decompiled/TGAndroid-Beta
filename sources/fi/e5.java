...
public final class e5 extends org.telegram.ui.ActionBar.n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.ActionBar.g2 f9669b;
    public d61 f9670c;
    ...
    public final void U(ArrayList arrayList, v51 v51Var) {
        zh.m e7 = zh.o.g(this.currentAccount).e(this.f9668a);
        ArrayList arrayList2 = e7.f52274e;
    ...
    public final void V(h51 h51Var) {
        ...
        if (obj instanceof TL_payments.starRefProgram) {
            e4.G0(getParentActivity(), this.currentAccount, (TL_payments.starRefProgram) obj, this.f9668a, this.resourceProvider, false);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        d61 d61Var;
        if (i10 == NotificationCenter.channelSuggestedBotsUpdate && ((Long) objArr[0]).longValue() == this.f9668a && (d61Var = this.f9670c) != null && (d61Var.getAdapter() instanceof v51)) {
            ((v51) this.f9670c.getAdapter()).N(true);
        }
    }
