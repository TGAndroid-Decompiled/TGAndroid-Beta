...
public final class f implements org.telegram.ui.ActionBar.a2, Utilities.Callback5, c3.g, e2.m, f2.t, xt, ji.o0, oy {
    ...
    public n70 i(ji.h1 h1Var) {
        return n70.H((ji.c2) ((z2.b) this.f9644b).f50679a, h1Var);
    }
        ...
        switch (this.f9643a) {
            ...
            case 11:
                ...
                if (i12 == -1) {
                    ...
                    return;
                } else if (h51Var.f44072a == 5 && i12 >= 0 && i12 < g1Var.h.length) {
            ...
            case 12:
                ...
                if (i24 == -1) {
                    ...
                    i1Var2.f12102n.Y2.N(true);
                    return;
                } else if (h51Var2.f44072a == 3 && (i10 = i24 / 3) >= 0 && i10 < arrayList3.size()) {
                    int i26 = i10 - 1;
                    if (i26 >= 0) {
