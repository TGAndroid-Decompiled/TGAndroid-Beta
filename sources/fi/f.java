...
public final class f extends n2 implements NotificationCenter.NotificationCenterDelegate {
    public long f9093a;
    public TLRPC.Chat f9094b;
    public TLRPC.User f9095c;
    public FrameLayout d;
    public e61 e;
    public e f9096f;
    public ArrayList h;
    public NotificationCenter.ObserversGroup f9097n;
    ...
    public static void U(f fVar, i51 i51Var) {
        ...
        if (obj instanceof TLRPC.Chat) {
            ...
            fVar2.getMessagesController().getChat(Long.valueOf(-fVar2.f9093a));
            fVar2.showDialog(new hi.b(fVar2.getParentActivity(), chat, fVar2.f9093a, new m2(12, fVar2, chat)));
        }
    }

    public final void V(String str, boolean z10) {
        if (!ChatObject.isChannel(this.f9094b) && this.f9095c == null) {
            b2 b2Var = new b2(getParentActivity(), 3, null);
            b2Var.q(250L);
            getMessagesController().convertToMegaGroup(getParentActivity(), -this.f9093a, this, new ca.b(this, b2Var, str, z10, 1));
            return;
        }
        getMessagesController().createCommunity(str, this.f9093a, z10, new b(this, 1));
    }
    ...
    public final void W(long j3, boolean z10) {
        if (!ChatObject.isChannel(this.f9094b) && this.f9095c == null) {
            b2 b2Var = new b2(getParentActivity(), 3, null);
            b2Var.q(250L);
            getMessagesController().convertToMegaGroup(getParentActivity(), -this.f9093a, this, new d(this, b2Var, j3, z10, 0));
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        fh.c cVar = new fh.c();
        cVar.a(getThemedColor(i6.f18836d6));
        ...
        } else if (ChatObject.isChannelAndNotMegaGroup(this.f9094b)) {
        ...
        this.f9096f.setTag(-33024);
        TLRPC.User user = this.f9095c;
        if (user != null) {
            this.f9096f.f9090a.e(user, new f9(0, this.f9095c));
        } else {
            TLRPC.Chat chat = this.f9094b;
            if (chat != null) {
                this.f9096f.f9090a.e(chat, new f9(this.f9094b));
            }
        }
    ...
    public final boolean onFragmentCreate() {
        this.f9093a = this.arguments.getLong("dialog_id", 0L);
        this.f9094b = getMessagesController().getChat(Long.valueOf(-this.f9093a));
        this.f9095c = getMessagesController().getUser(Long.valueOf(this.f9093a));
        ...
        this.f9097n = getNotificationCenter().createObserversGroup(this).add(NotificationCenter.chatInfoDidLoad);
        return super.onFragmentCreate();
    }

    @Override
    public final void onFragmentDestroy() {
        NotificationCenter.ObserversGroup observersGroup = this.f9097n;
