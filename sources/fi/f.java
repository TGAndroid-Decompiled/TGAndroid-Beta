...
public final class f extends n2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final void V(String str, boolean z10) {
        if (!ChatObject.isChannel(this.f9099b) && this.f9100c == null) {
            ...
            b2Var.q(250L);
            getMessagesController().convertToMegaGroup(getParentActivity(), -this.f9098a, this, new ca.b(this, b2Var, str, z10, 1));
            return;
        }
    ...
    public final void W(long j3, boolean z10) {
        if (!ChatObject.isChannel(this.f9099b) && this.f9100c == null) {
            b2 b2Var = new b2(getParentActivity(), 3, null);
            b2Var.q(250L);
            getMessagesController().convertToMegaGroup(getParentActivity(), -this.f9098a, this, new d(this, b2Var, j3, z10, 0));
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        if (user != null) {
            this.f9101f.f9095a.e(user, new g9(0, this.f9100c));
        } else {
