...
public final class f extends o2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(f fVar, j51 j51Var) {
        ...
        if (obj instanceof TLRPC.Chat) {
            ...
            fVar2.showDialog(new hi.b(fVar2.getParentActivity(), chat, fVar2.f9098a, new m2(12, fVar2, chat)));
        }
    }

    public final void V(String str, boolean z10) {
        if (!ChatObject.isChannel(this.f9099b) && this.f9100c == null) {
            c2 c2Var = new c2(getParentActivity(), 3, null);
            c2Var.q(250L);
            getMessagesController().convertToMegaGroup(getParentActivity(), -this.f9098a, this, new ca.b(this, c2Var, str, z10, 1));
            return;
        }
        getMessagesController().createCommunity(str, this.f9098a, z10, new b(this, 1));
    }
    ...
    public final void W(long j3, boolean z10) {
        if (!ChatObject.isChannel(this.f9099b) && this.f9100c == null) {
            c2 c2Var = new c2(getParentActivity(), 3, null);
            c2Var.q(250L);
            getMessagesController().convertToMegaGroup(getParentActivity(), -this.f9098a, this, new d(this, c2Var, j3, z10, 0));
            return;
        }
    ...
    public final View createView(Context context) {
        ...
        } else if (ChatObject.isChannelAndNotMegaGroup(this.f9099b)) {
        ...
        this.f9101f.setTag(-33024);
        TLRPC.User user = this.f9100c;
        if (user != null) {
            this.f9101f.f9095a.e(user, new f9(0, this.f9100c));
        } else {
            TLRPC.Chat chat = this.f9099b;
            if (chat != null) {
                this.f9101f.f9095a.e(chat, new f9(this.f9099b));
            }
        }
    ...
    public final boolean onFragmentCreate() {
        this.f9098a = this.arguments.getLong("dialog_id", 0L);
        this.f9099b = getMessagesController().getChat(Long.valueOf(-this.f9098a));
        this.f9100c = getMessagesController().getUser(Long.valueOf(this.f9098a));
        ...
        this.f9102n = getNotificationCenter().createObserversGroup(this).add(NotificationCenter.chatInfoDidLoad);
        return super.onFragmentCreate();
    }

    @Override
    public final void onFragmentDestroy() {
        NotificationCenter.ObserversGroup observersGroup = this.f9102n;
