...
public final class s4 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f9988a) {
            case 0:
                AndroidUtilities.runOnUIThread(new k8((TLRPC.UserFull) obj, (org.telegram.ui.web.s) this.f9990c, this.f9989b, (TLRPC.User) this.d, 2));
                return;
            case 1:
                org.telegram.ui.ActionBar.n2 n2Var = (org.telegram.ui.ActionBar.n2) this.f9990c;
                TLRPC.Chat chat = (TLRPC.Chat) this.d;
                TLRPC.Chat chat2 = (TLRPC.Chat) obj;
                n2Var.showDialog(new ii.b(n2Var.getContext(), chat, -chat2.f19896id, new gi.m0(n2Var, this.f9989b, chat2, chat, 0)));
                return;
            case 2:
                float f7 = this.f9989b;
                ((m6) this.f9990c).run(Float.valueOf((w7.p.a(((Float) obj).floatValue(), 0.0f, 1.0f) * (1.0f / f7)) + (((int[]) this.d)[0] / f7)), Boolean.FALSE);
                return;
            case 3:
                c10 c10Var = (c10) this.f9990c;
                int i10 = this.f9989b;
                c10Var.getClass();
                ...
                return;
            case 4:
                Utilities.themeQueue.postRunnable(new l3((rg.o2) this.f9990c, this.f9989b, (List) obj, new ArrayList(), (or0) this.d, 28));
                return;
            default:
                yh.q2 q2Var = (yh.q2) this.f9990c;
                int i11 = this.f9989b;
                ArrayList arrayList = (ArrayList) obj;
                org.telegram.ui.ActionBar.n2 n2Var2 = q2Var.f50544a;
                i5 i5Var = q2Var.f50547e;
