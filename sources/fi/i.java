        ...
        switch (this.f9114a) {
            ...
            default:
                ...
                if (ChatObject.canUserDoAdminAction(pVar2.H, 1)) {
                    ...
                    w51 c10 = w51.c(141, i12, LocaleController.getString(i10));
                    c10.f29953q = true;
                    arrayList2.add(c10);
                    ...
                    arrayList2.add(w51.j(7, pVar2.f9156n));
                ...
                if (ChatObject.canBlockUsers(pVar2.H)) {
                    ...
                    w51 x10 = w51.x(150, LocaleController.getString(R.string.CommunityWhoCanAddChatsAllMembers), LocaleController.getString(R.string.CommunityWhoCanAddChatsAllMembersInfo));
                    x10.K(pVar2.h);
                    arrayList2.add(x10);
                ...
                if (ChatObject.hasAdminRights(pVar2.H)) {
                    ...
                    arrayList2.add(w51.d(142, i13, string, str));
                    ...
                    arrayList2.add(w51.d(143, i14, string2, str2));
                    ...
                    arrayList2.add(w51.d(144, i15, string3, str3));
                }
