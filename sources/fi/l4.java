...
public class l4 extends View {
    public final hv0 f9839a;
    public final Paint f9840b;
    public float f9841c;
    public o1.k d;
    ...
    public final void draw(Canvas canvas) {
        super.draw(canvas);
        if (this.f9841c > 0.0f) {
            Paint paint = this.f9840b;
            float height = getHeight() - (paint.getStrokeWidth() / 2.0f);
            canvas.drawLine(0.0f, height, getWidth() * this.f9841c, height, paint);
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        o1.k kVar = new o1.k(this, this.f9839a);
        o1.l lVar = new o1.l();
        lVar.b(400.0f);
        lVar.a(1.0f);
        kVar.f16852u = lVar;
    ...
    public void setLoadProgressAnimated(float f7) {
        ...
        kVar.f16852u.f16859i = f7 * 100.0f;
        kVar.f();
    }
}
