...
public final class c extends FrameLayout implements a6 {
    public final f6 f8302a;
    public final w9 f8303b;
    ...
    public final void a(int i10, TLRPC.Chat chat) {
        ...
        this.f8303b.e(chat, new g9(chat));
    }

    @Override
    public final void dispatchDraw(Canvas canvas) {
        Drawable drawable = j6.S0;
        w9 w9Var = this.f8303b;
    ...
    public final void e() {
        int i10 = j6.f18325z6;
        f6 f6Var = this.f8302a;
        this.e.setColorFilter(j6.v0(i10, f6Var));
        this.f8304c.setTextColor(j6.v0(j6.G6, f6Var));
    ...
    public void setTitle(CharSequence charSequence) {
        this.f8304c.setText(charSequence);
    }
}
