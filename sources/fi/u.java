...
public final class u extends org.telegram.ui.ActionBar.n2 {
    ...
    public static void U(u uVar, ArrayList arrayList) {
        HashMap hashMap = uVar.f10015c;
        ArrayList arrayList2 = uVar.f10014b;
        for (int i10 = 0; i10 < arrayList2.size(); i10++) {
            ...
            if (spannableStringBuilder == null) {
                ...
                spannableStringBuilder.append((CharSequence) UserObject.getUserName(rVar.f9943a));
    ...
    public static void V(u uVar, h51 h51Var) {
        int i10;
        v51 v51Var;
        ArrayList arrayList = uVar.f10014b;
        if (h51Var.f44098a == 4 && (i10 = h51Var.d) >= 0 && i10 < arrayList.size()) {
            r rVar = (r) arrayList.get(h51Var.d);
            rVar.f9944b = !rVar.f9944b;
            Activity parentActivity = uVar.getParentActivity();
            int i11 = uVar.currentAccount;
            long j3 = rVar.f9943a.f20043id;
            boolean z10 = rVar.f9944b;
            WeakHashMap weakHashMap = s.f9964k;
    ...
    public final View createView(Context context) {
        ...
        frameLayout.setBackgroundColor(j6.v0(j6.f20634a7, this.resourceProvider));
