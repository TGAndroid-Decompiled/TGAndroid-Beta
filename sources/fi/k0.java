...
public final class k0 extends f3 implements NotificationCenter.NotificationCenterDelegate, le.d, n2 {
    ...
    public i0.b T;
    public i0.b U;
    public final le.b f9122b;
    public final le.b f9123c;
    public final i1 d;
    public final long e;
    public TLRPC.Chat f9124f;
    public boolean h;
    public ci.d f9125n;
    public ci.d f9126r;
    public final org.telegram.ui.ActionBar.n2 f9127s;
    public final f0 v;
    public final j0 f9128w;
    public final e0 f9129x;
    public final b20 f9130y;
    ...
    public static void y(k0 k0Var, i51 i51Var, View view) {
        ...
        TLRPC.Chat chat;
        int i10;
        org.telegram.ui.ActionBar.n2 n2Var = k0Var.f9127s;
        if (!k0Var.T(i51Var)) {
            int i11 = i51Var.d;
            boolean z10 = false;
            if (i11 == 101) {
                ...
                if (b10 != 1 && b10 != 2) {
                    if (b10 == 3) {
                        g80 g80Var = new g80(k0Var.getContext(), chat2, null, k0Var.f9127s, k0Var.resourcesProvider);
                        g80Var.f24250n = new vc((FrameLayout) k0Var.containerView, k0Var.resourcesProvider);
                        g80Var.show();
                        return;
                    } else if (b10 == 4) {
                ...
                if (n2Var instanceof bo) {
                    ...
                    if ((chat3 != null && chat3.f18109id == (-j3)) || (i13 != null && i13.f18256id == j3)) {
                        k0Var.dismiss();
                        return;
                    }
                }
                ...
                if (ChatObject.isForum(chat2)) {
                    if (ChatObject.areTabsEnabled(chat2)) {
                        ...
                        ng.d.a(boVar2, MessagesStorage.TopicKey.of(j3, MessagesController.getInstance(k0Var.currentAccount).getForumLastTopicId(chat2.f18109id)));
    ...
    public static void z(k0 k0Var, ArrayList arrayList) {
        ...
        t0 t0Var = k0Var.M;
        boolean z11 = true;
        if (t0Var.f9186n && t0Var.f9184l == 1 && (arrayList2 = t0Var.f9182j) != null && arrayList2.size() == 1) {
            ...
            int i11 = t0Var.f9184l;
            if (i11 > 0) {
                int i12 = t0Var.f9188p;
                ...
                int i14 = gi.i.f10037a;
                i51 J = i51.J(gi.i.class);
                J.d = 100;
                J.f24899k = i13;
                J.f24900l = formatPluralString;
                J.f24902n = str;
    ...
    public final void D(int i10, float f7, float f10, le.e eVar) {
        ...
        if (i10 == 1) {
            ...
            f0 f0Var = this.v;
            f0Var.f9107a.setAlpha(b10);
            f0Var.f9107a.setScaleX(lerp);
            f0Var.f9107a.setScaleY(lerp);
            org.telegram.ui.ActionBar.k kVar = f0Var.f9107a;
            ...
            this.f9125n.setAlpha(b10);
            this.f9125n.setScaleX(AndroidUtilities.lerp(0.95f, 1.0f, b10));
            this.f9125n.setScaleY(AndroidUtilities.lerp(0.95f, 1.0f, b10));
            ci.d dVar = this.f9125n;
            if (i21 > 0) {
                i18 = 0;
            } else {
                i18 = 8;
        ...
        if (i10 == 2) {
            ...
            e0 e0Var = this.f9129x;
            e0Var.f9107a.setAlpha(b11);
            e0Var.f9107a.setScaleX(lerp3);
            e0Var.f9107a.setScaleY(lerp3);
            org.telegram.ui.ActionBar.k kVar2 = e0Var.f9107a;
            ...
            if (!this.N) {
                this.f9126r.setAlpha(b11);
                this.f9126r.setScaleX(AndroidUtilities.lerp(0.95f, 1.0f, b11));
                this.f9126r.setScaleY(AndroidUtilities.lerp(0.95f, 1.0f, b11));
                ci.d dVar2 = this.f9126r;
                if (i23 > 0) {
                    i14 = 0;
                } else {
                    i14 = 8;
    ...
    public final boolean T(i51 i51Var) {
        ...
        if (obj instanceof gi.f) {
            ...
            org.telegram.ui.ActionBar.n2 n2Var = this.f9127s;
            if (user != null) {
                n2Var.presentFragment(bo.R9(user.f18256id));
                return true;
            } else if (!ChatObject.isPublic(chat) && !ChatObject.isInChat(chat)) {
                new hi.c(getContext(), chat, new b9(24, this, fVar)).show();
                return true;
            } else {
                n2Var.presentFragment(bo.R9(-chat.f18109id));
                return true;
            }
        }
        return false;
    ...
    public final void W(i51 i51Var) {
        ...
        if (obj instanceof TLRPC.Chat) {
            ...
            new hi.b(getContext(), this.f9124f, -chat.f18109id, new m2(14, this, chat)).show();
        }
    }
    ...
    public final boolean canDismissWithSwipe() {
        if (!this.f9122b.f13973f && !this.f9123c.f13973f) {
    ...
    public final void d(r2 r2Var) {
        ...
        if (r2Var.getMessage() != null && (findTopic = MessagesController.getInstance(this.currentAccount).getTopicsController().findTopic(-r2Var.getDialogId(), MessageObject.getTopicId(this.currentAccount, r2Var.getMessage().messageOwner, true))) != null) {
            ng.d.m(this.f9127s, -r2Var.getDialogId(), findTopic, 0);
        }
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        f0 f0Var = this.v;
        if (i10 == i12) {
            if (((TLRPC.ChatFull) objArr[0]).f18110id == j3) {
                f0Var.d.Y2.N(true);
            }
            ...
            if ((num.intValue() & MessagesController.UPDATE_MASK_CHAT) != 0 || (num.intValue() & MessagesController.UPDATE_MASK_AVATAR) != 0 || (num.intValue() & MessagesController.UPDATE_MASK_CHAT_AVATAR) != 0 || (num.intValue() & MessagesController.UPDATE_MASK_CHAT_NAME) != 0) {
                TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3));
                this.f9124f = chat;
                f0Var.f9107a.setTitle(DialogObject.getName(chat));
                f0Var.h.e(this.f9124f, f0Var.f9100n);
            }
        }
    }
    ...
    public final void onBackPressed() {
        if (this.d.getCurrentPosition() > 0) {
            if (this.d.getCurrentPosition() == 2) {
                le.b bVar = this.f9123c;
                if (bVar.f13973f) {
                    this.f9129x.d.X2.h1(1, this.U.f10591b);
                    bVar.a(false, true);
    ...
    public k0(org.telegram.ui.ActionBar.n2 n2Var, long j3, ArrayList arrayList, r4 r4Var) {
        ...
        qr qrVar = qr.h;
        this.f9122b = new le.b(1, this, qrVar, 350L, false);
        this.f9123c = new le.b(2, this, qrVar, 350L, false);
        this.J = new yf.y(2);
        this.K = new yf.y(8);
        ...
        x10Var.f39437b.setClipToPadding(false);
        ...
        this.e = j3;
        this.f9124f = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(j3));
        MessagesController.getInstance(this.currentAccount).getChatFull(j3);
        TLRPC.Chat chat = this.f9124f;
        ...
        this.f9128w = new j0(this, context);
        this.v = new f0(this, context);
        this.f9129x = new e0(this, context);
