...
public final class b0 extends kl0 {
    ...
    public final void E(a0.i iVar) {
        ArrayList arrayList = this.f9553c;
        arrayList.clear();
        ArrayList arrayList2 = this.d;
        arrayList2.clear();
        ArrayList arrayList3 = this.f9554e;
        arrayList3.clear();
    ...
    public final void v(s4.c1 c1Var, int i10) {
        a0 a0Var = (a0) c1Var.f45738a;
        String str = (String) this.f9553c.get(i10);
        if (((Boolean) this.f9554e.get(i10)).booleanValue()) {
            ...
            a0Var.f9526a.setText(spannableStringBuilder);
        } else {
            a0Var.f9526a.setText(str);
        }
        a0Var.f9527b.setText((CharSequence) this.d.get(i10));
        a0Var.f9528c = str;
    }
