...
public final class f0 extends h0 {
    ...
    public f0(k0 k0Var, Context context) {
        ...
        this.f9112c.addView(k0Var.F, x5.g());
        this.f9112c.addView(this.d, x5.g());
        this.f9112c.addView(k0Var.H, x5.g());
        ...
        f9 f9Var = new f9(k0Var.f9127f);
        this.f9103n = f9Var;
        u9 u9Var = new u9(getContext());
        this.h = u9Var;
        u9Var.setRoundRadius(AndroidUtilities.dp(9.0f));
        u9Var.e(k0Var.f9127f, f9Var);
        this.f9110a.addView(u9Var, x5.b(27.33f, 27.33f, 83, 14.33f, 0.0f, 0.0f, 14.33f));
        this.f9112c.addView(this.f9110a, x5.e(-1, 56, 48));
        this.f9112c.addView(k0Var.f9133y, x5.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        this.f9112c.addView(dVar, x5.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }
