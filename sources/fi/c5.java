...
public final class c5 extends Drawable implements y6, NotificationCenter.NotificationCenterDelegate {
    public final Paint f9597a;
    public final Paint f9598b;
    public final ImageReceiver f9599c;
    public final ImageReceiver d;
    public int f9600e;
    public final q5[] f9601f;
    public final f01 h;
    public final RectF f9602n;
    public final boolean f9603r;
    public final e6 f9604s;
    public boolean v;
    ...
    public c5(TLRPC.User user) {
        ...
        this.f9599c = imageReceiver;
        this.d = new ImageReceiver();
        this.f9600e = 1;
        this.f9601f = new q5[2];
        this.f9602n = new RectF();
        this.f9604s = new e6(new b5(this, 1), 320L, pr.h, 0);
        this.f9603r = false;
        int i10 = j6.f20663d6;
    ...
    public final void a(aj0 aj0Var) {
        ...
        this.f9599c.setParentView(aj0Var);
    }

    @Override
    public final void b(ImageReceiver imageReceiver) {
        this.f9605w = false;
        this.f9599c.onDetachedFromWindow();
    ...
    public final void c(ImageReceiver imageReceiver) {
        this.f9605w = true;
        this.f9599c.onAttachedToWindow();
    ...
    public final void d() {
        ...
        if (stickerSet != null && !stickerSet.documents.isEmpty()) {
            ...
            q5VarArr[this.f9600e] = q5.m(UserConfig.selectedAccount, 9, document);
            q5VarArr[this.f9600e].setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.Oh, false), PorterDuff.Mode.SRC_IN));
            if (this.f9605w && (q5Var = q5VarArr[this.f9600e]) != null) {
                q5Var.a(this.f9606x);
            }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.groupStickersDidLoad && this.v && this.f9605w) {
            this.v = false;
            d();
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        boolean z10 = this.f9603r;
        if (z10) {
            i10 = 48;
        } else {
            i10 = 28;
        }
        float dp = (AndroidUtilities.dp((i10 + 38) + 6.66f) + this.h.f25847c) / 2.0f;
        float dp2 = AndroidUtilities.dp(32.0f) / 2.0f;
        RectF rectF = this.f9602n;
        rectF.set(bounds.centerX() - dp, bounds.centerY() - dp2, bounds.centerX() + dp, bounds.centerY() + dp2);
        canvas.drawRoundRect(rectF, dp2, dp2, this.f9597a);
        ImageReceiver imageReceiver = this.f9599c;
        ...
        if (z10) {
            ...
            canvas.drawCircle(dp3, rectF.centerY(), AndroidUtilities.dp(24.0f), this.f9598b);
        ...
        float d = this.f9604s.d(this.f9600e, false);
        canvas.save();
    ...
    public c5(TLRPC.User user, TLRPC.Document document) {
        ...
        imageReceiver2.setImage(ImageLocation.getForDocument(document), "120_120", ImageLocation.getForDocument(closestPhotoSizeWithSize, document), "120_120", DocumentObject.getSvgThumb(document.thumbs, j6.f20607a7, 0.35f), 0L, null, null, 0);
        this.h = new f01(UserObject.getUserName(user), 14.0f, null);
    }
