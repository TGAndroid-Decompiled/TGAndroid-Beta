    ...
    public final void run(Object obj, Object obj2) {
        switch (this.f9167a) {
            case 0:
                ...
                t0Var.f9191q.dismiss();
                t0Var.f9191q = null;
                t0Var.f9192r = 0;
                if (tL_error != null) {
                    t0Var.f9180c.d0(tL_error, false);
                    return;
                }
                s0 s0Var = t0Var.h;
                if (s0Var != null) {
            ...
            case 1:
                ...
                t0 t0Var2 = this.f9168b;
                boolean z10 = false;
                t0Var2.f9187m = false;
                if (peerLinkRequests != null) {
                    ArrayList arrayList = t0Var2.f9184j;
                    if (arrayList == null) {
                        t0Var2.f9184j = new ArrayList(peerLinkRequests.requests);
                    } else {
                        arrayList.addAll(peerLinkRequests.requests);
                    }
                    String str = peerLinkRequests.next_offset;
                    t0Var2.f9185k = str;
                    t0Var2.f9186l = peerLinkRequests.total_count;
                    if (str == null) {
                        z10 = true;
                    }
                    t0Var2.f9188n = z10;
            ...
            default:
                ...
                t0 t0Var3 = this.f9168b;
                if (tL_error3 != null) {
                    t0Var3.f9180c.d0(tL_error3, false);
                    return;
                } else {
                    t0Var3.getClass();
                    return;
