...
public final class e0 extends h0 {
    ...
    public e0(k0 k0Var, Context context) {
        ...
        this.f9109c.addView(k0Var.G, x5.g());
        this.f9109c.addView(this.d, 0, x5.c(-1.0f, -1));
        this.f9109c.addView(k0Var.I, x5.g());
        ...
        this.f9107a.setTitle(LocaleController.getString(R.string.CommunityAddAChatToCommunity));
        this.f9107a.getTitleTextView().setTranslationX(-AndroidUtilities.dp(18.0f));
        this.f9107a.setActionBarMenuOnItemClick(new ei.t(this, 6));
        this.f9109c.addView(this.f9107a, x5.e(-1, 56, 48));
        this.f9109c.addView(k0Var.E, x5.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        k0Var.f9126r = dVar;
        dVar.e();
        k0Var.f9126r.setText(LocaleController.getString(R.string.OK));
        k0Var.f9126r.setOnClickListener(new v0(this, 18));
        if (z10) {
            k0Var.f9126r.setVisibility(8);
        }
        this.f9109c.addView(k0Var.f9126r, x5.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }

    @Override
    public final float b() {
        return yf.e0.b(this.h.f9123c.e) * super.b();
    }
