...
public final class e0 extends h0 {
    ...
    public e0(k0 k0Var, Context context) {
        ...
        this.f9095c.addView(k0Var.G, x5.g());
        this.f9095c.addView(this.d, 0, x5.c(-1.0f, -1));
        this.f9095c.addView(k0Var.I, x5.g());
        ...
        this.f9093a.setTitle(LocaleController.getString(R.string.CommunityAddAChatToCommunity));
        this.f9093a.getTitleTextView().setTranslationX(-AndroidUtilities.dp(18.0f));
        this.f9093a.setActionBarMenuOnItemClick(new ei.t(this, 6));
        this.f9095c.addView(this.f9093a, x5.e(-1, 56, 48));
        this.f9095c.addView(k0Var.E, x5.d(-1, 40.0f, 48, 11.0f, 0.0f, 11.0f, 0.0f));
        ...
        k0Var.f9112r = dVar;
        dVar.e();
        k0Var.f9112r.setText(LocaleController.getString(R.string.OK));
        k0Var.f9112r.setOnClickListener(new v0(this, 18));
        if (z10) {
            k0Var.f9112r.setVisibility(8);
        }
        this.f9095c.addView(k0Var.f9112r, x5.f(48.0f, 80, AndroidUtilities.dp(12.0f), 0, AndroidUtilities.dp(12.0f), AndroidUtilities.dp(12.0f) + AndroidUtilities.navigationBarHeight));
        a();
    }

    @Override
    public final float b() {
        return yf.e0.b(this.h.f9109c.e) * super.b();
    }
