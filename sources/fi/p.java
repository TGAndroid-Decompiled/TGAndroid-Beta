...
public final class p extends n2 implements t40, NotificationCenter.NotificationCenterDelegate, le.d {
    ...
    public s6 f9157s;
    public w9 v;
    public AnimatorSet f9158w;
    public RadialProgressView f9159x;
    public h9 f9160y;

    public p(Bundle bundle) {
        super(bundle);
        this.f9151a = new le.b(0, this, qr.h, 320L, false);
        this.J = new b2[1];
        this.K = new m(this);
    }
    ...
    public static boolean U(p pVar, x51 x51Var, View view) {
        ...
        if (z13 || z12) {
            w70 F = w70.F(pVar.f9153c, null, view);
    ...
    public static void V(p pVar, x51 x51Var) {
        ...
        int i10 = x51Var.d;
        if (i10 == 140) {
            if (!pVar.E.h() && (chatPhoto = (chat = pVar.getMessagesController().getChat(Long.valueOf(pVar.f9152b))).photo) != null && chatPhoto.photo_big != null) {
        ...
        if (i10 == 141) {
            ...
            bundle.putLong("chat_id", pVar.f9152b);
            ...
            bundle2.putLong("chat_id", pVar.f9152b);
            ...
            bundle3.putLong("community_id", pVar.f9152b);
            ...
            Object obj = x51Var.G;
            if (obj instanceof TLRPC.Chat) {
                pVar.presentFragment(zn.R9(-((TLRPC.Chat) obj).f18296id));
            } else if (obj instanceof TLRPC.User) {
                pVar.presentFragment(zn.R9(((TLRPC.User) obj).f18443id));
            }
        }
    }
    ...
    public static void W(p pVar) {
        pVar.F = null;
        MessagesController.getInstance(pVar.currentAccount).changeChatAvatar(pVar.f9152b, null, null, null, null, 0.0d, null, null, null, null);
        pVar.a0(false, true);
        pVar.v.h(null, null, pVar.f9160y, pVar.H);
    }

    @Override
    public final void B(float f7) {
        RadialProgressView radialProgressView = this.f9159x;
    ...
    public final void Y() {
        boolean z10;
        if (this.f9154f == this.h && TextUtils.equals(((o) this.f9155n.f785b).getText().toString(), this.e)) {
            z10 = false;
        } else {
            z10 = true;
        }
        this.f9151a.a(z10, true);
    }
    ...
    public final void a0(boolean z10, boolean z11) {
        ...
        AnimatorSet animatorSet = this.f9158w;
        if (animatorSet != null) {
            animatorSet.cancel();
            this.f9158w = null;
        }
        if (z11) {
            ...
            this.f9158w = animatorSet2;
            if (z10) {
                this.f9159x.setVisibility(0);
                this.f9157s.setVisibility(0);
                AnimatorSet animatorSet3 = this.f9158w;
                RadialProgressView radialProgressView = this.f9159x;
                Property property = View.ALPHA;
                animatorSet3.playTogether(ObjectAnimator.ofFloat(radialProgressView, property, 1.0f), ObjectAnimator.ofFloat(this.f9157s, property, 1.0f));
            } else {
                RadialProgressView radialProgressView2 = this.f9159x;
                Property property2 = View.ALPHA;
                animatorSet2.playTogether(ObjectAnimator.ofFloat(radialProgressView2, property2, 0.0f), ObjectAnimator.ofFloat(this.f9157s, property2, 0.0f));
            }
            this.f9158w.setDuration(180L);
            this.f9158w.addListener(new ai.n(15, this, z10));
            this.f9158w.start();
        } else if (z10) {
            this.f9159x.setAlpha(1.0f);
            this.f9159x.setVisibility(0);
            this.f9157s.setAlpha(1.0f);
            this.f9157s.setVisibility(0);
        } else {
            this.f9159x.setAlpha(0.0f);
            this.f9159x.setVisibility(4);
            this.f9157s.setAlpha(0.0f);
            this.f9157s.setVisibility(4);
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f9160y = new h9(this.H);
        n nVar = new n(context);
        this.f9156r = nVar;
        nVar.f9143a.e(this.H, this.f9160y);
        this.v = this.f9156r.f9143a;
        ...
        this.f9155n = f0Var;
        oVar.setText(name);
        ((o) this.f9155n.f785b).setSelection(name.length());
        ((o) this.f9155n.f785b).addTextChangedListener(new i2(this, 1));
        ...
        this.f9157s = s6Var;
        this.f9156r.addView(s6Var, y5.d(72, 72.0f, 81, 0.0f, 0.0f, 0.0f, 28.0f));
        RadialProgressView radialProgressView = new RadialProgressView(context, null);
        this.f9159x = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.dp(30.0f));
        this.f9159x.setProgressColor(-1);
        this.f9159x.setNoProgress(false);
        this.f9156r.addView(this.f9159x, y5.d(64, 64.0f, 81, 0.0f, 0.0f, 0.0f, 32.0f));
        a0(false, false);
        ...
        this.f9153c.addView(this.d, y5.c(-1.0f, -1));
        this.f9153c.addView(this.actionBar, y5.e(-1, -2, 48));
        v7 v7Var2 = this.f9153c;
        j jVar = new j(this);
        WeakHashMap weakHashMap = r0.i0.f42096a;
        r0.a0.j(v7Var2, jVar);
        v7 v7Var3 = this.f9153c;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.chatInfoDidLoad) {
            ...
            if (chatFull.f18297id == this.f9152b) {
                this.I = chatFull;
                this.d.Y2.N(true);
            }
        }
    ...
    public final boolean dismissDialogOnPause(Dialog dialog) {
        if (dialog != this.E.f28556c && super.dismissDialogOnPause(dialog)) {
            return true;
        }
        return false;
    }
    ...
    public final String getInitialSearchString() {
        return ((o) this.f9155n.f785b).getText().toString();
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        this.f9152b = this.arguments.getLong("community_id", 0L);
        TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(this.f9152b));
        this.H = chat;
        ...
        this.f9154f = z10;
        this.h = z10;
        this.I = getMessagesController().getChatFull(this.f9152b);
