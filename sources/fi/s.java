...
public final class s extends n2 implements le.d {
    ...
    public static void U(s sVar, y51 y51Var) {
        ...
        if (obj instanceof gi.f) {
            ...
            if (user != null) {
                sVar.presentFragment(zn.R9(user.f18490id));
            } else if (!ChatObject.isPublic(chat) && !ChatObject.isInChat(chat)) {
                new hi.c(sVar.getParentActivity(), chat, new b9(23, sVar, fVar)).show();
            } else {
                sVar.presentFragment(zn.R9(-chat.f18343id));
            }
        }
    }
    ...
    public final View createView(Context context) {
        ...
        this.f9174n = dVar;
        dVar.d();
        this.f9174n.setColor(i0.a.d(0.125f, getThemedColor(j6.f19109d6), getThemedColor(j6.G6)));
