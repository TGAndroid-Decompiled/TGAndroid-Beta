        ...
        switch (this.f9119a) {
            ...
            case 1:
                ...
                if (inputFile3 == null && inputFile4 == null) {
                    ...
                    ndVar.f36067x = fileLocation2;
                    ndVar.f36068y = this.f9123n.location;
                    ndVar.e.h(ImageLocation.getForLocal(fileLocation2), "50_50", ndVar.f36060s, null);
                    ndVar.e0(true, false);
                    return;
                }
                ndVar.f36052l0 = inputFile3;
                ndVar.m0 = inputFile4;
                ndVar.f36054n0 = this.d;
                ndVar.f36055o0 = this.e;
                ndVar.f36056p0 = this.f9122f;
                if (ndVar.f36057q0) {
                    c2 c2Var = ndVar.f36063u0;
                    if (c2Var != null) {
                        try {
                            c2Var.dismiss();
                            ndVar.f36063u0 = null;
            ...
            case 2:
                ...
                if (inputFile5 == null && inputFile6 == null && videoSize2 == null) {
                    ...
                    f9 f9Var = woVar.f39103r;
                    Object obj = woVar.D0;
                    if (obj == null) {
                        obj = woVar.f39113x0;
                    }
                    z5Var.h(forLocal, "50_50", f9Var, obj);
                    woVar.f39085b0.m(R.drawable.msg_addphoto, LocaleController.getString("ChatSetNewPhoto", R.string.ChatSetNewPhoto), true);
                    if (woVar.R0 == null) {
            ...
            case 3:
                ...
                if (inputFile7 == null && inputFile8 == null && videoSize3 == null) {
                    r50Var.f37083c = photoSize4.location;
                    TLRPC.FileLocation fileLocation6 = photoSize5.location;
                    r50Var.f37082b = fileLocation6;
                    ImageLocation forLocal2 = ImageLocation.getForLocal(fileLocation6);
                    r50Var.d = forLocal2;
                    k60Var.f35014b.A(forLocal2, ImageLocation.getForLocal(r50Var.f37083c));
            ...
            case 4:
                ...
                if (inputFile9 == null && inputFile10 == null && videoSize4 == null) {
                    ...
                    n70Var.f35965y = fileLocation7;
                    n70Var.E = this.f9123n.location;
                    n70Var.d.h(ImageLocation.getForLocal(fileLocation7), "50_50", n70Var.f35961r, null);
                    n70Var.Z(true, false);
                    return;
                }
                n70Var.F = inputFile9;
                ...
                if (n70Var.L) {
                    n70Var.getMessagesController().createChat(n70Var.f35958c.getText().toString(), n70Var.K, null, n70Var.P, n70Var.S, n70Var.U, n70Var.T, n70Var.W, n70Var);
                }
                n70Var.Z(false, true);
                n70Var.f35959f.setImageDrawable(null);
                return;
            case 5:
