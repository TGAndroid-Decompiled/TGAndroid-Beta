...
public final class k implements Runnable {
    ...
    public final TLRPC.InputFile f9117b;
    public final TLRPC.InputFile f9118c;
    public final TLRPC.VideoSize d;
    public final String e;
    public final double f9119f;
    public final TLRPC.PhotoSize h;
    public final TLRPC.PhotoSize f9120n;
    public final t40 f9121r;
    ...
    public k(p pVar, TLRPC.PhotoSize photoSize, TLRPC.InputFile inputFile, TLRPC.InputFile inputFile2, TLRPC.VideoSize videoSize, double d, String str, TLRPC.PhotoSize photoSize2) {
        ...
        this.f9121r = pVar;
        this.h = photoSize;
        this.f9117b = inputFile;
        this.f9118c = inputFile2;
        this.d = videoSize;
        this.f9119f = d;
        this.e = str;
        this.f9120n = photoSize2;
    }
    ...
    public final void run() {
        ...
        switch (this.f9116a) {
            case 0:
                p pVar = (p) this.f9121r;
                pVar.getClass();
                TLRPC.PhotoSize photoSize = this.h;
                TLRPC.FileLocation fileLocation = photoSize.location;
                pVar.F = fileLocation;
                TLRPC.InputFile inputFile = this.f9117b;
                TLRPC.InputFile inputFile2 = this.f9118c;
                TLRPC.VideoSize videoSize = this.d;
                if (inputFile == null && inputFile2 == null && videoSize == null) {
                    pVar.v.h(ImageLocation.getForLocal(fileLocation), "50_50", pVar.f9158y, pVar.H);
                    pVar.a0(true, false);
                    z10 = true;
                } else {
                    z10 = true;
                    pVar.getMessagesController().changeChatAvatar(pVar.f9150b, null, inputFile, inputFile2, videoSize, this.f9119f, this.e, photoSize.location, this.f9120n.location, null);
                    pVar.a0(false, true);
                }
                pVar.d.Y2.N(z10);
                return;
            case 1:
                ld ldVar = (ld) this.f9121r;
                TLRPC.InputFile inputFile3 = this.f9117b;
                TLRPC.InputFile inputFile4 = this.f9118c;
                if (inputFile3 == null && inputFile4 == null) {
                    TLRPC.FileLocation fileLocation2 = this.h.location;
                    ldVar.f35437x = fileLocation2;
                    ldVar.f35438y = this.f9120n.location;
                    ldVar.e.h(ImageLocation.getForLocal(fileLocation2), "50_50", ldVar.f35430s, null);
                    ldVar.e0(true, false);
                    return;
                }
                ldVar.f35422l0 = inputFile3;
                ldVar.m0 = inputFile4;
                ldVar.f35424n0 = this.d;
                ldVar.f35425o0 = this.e;
                ldVar.f35426p0 = this.f9119f;
                if (ldVar.f35427q0) {
                    b2 b2Var = ldVar.f35433u0;
                    if (b2Var != null) {
                        try {
                            b2Var.dismiss();
                            ldVar.f35433u0 = null;
                    ...
                    ldVar.f35407a.performClick();
                }
                ldVar.e0(false, true);
                ldVar.h.setImageDrawable(null);
                return;
            case 2:
                wo woVar = (wo) this.f9121r;
                TLRPC.PhotoSize photoSize2 = this.h;
                TLRPC.FileLocation fileLocation3 = photoSize2.location;
                woVar.f39292v0 = fileLocation3;
                TLRPC.InputFile inputFile5 = this.f9117b;
                TLRPC.InputFile inputFile6 = this.f9118c;
                ...
                if (inputFile5 == null && inputFile6 == null && videoSize2 == null) {
                    ...
                    f9 f9Var = woVar.f39286r;
                    Object obj = woVar.D0;
                    if (obj == null) {
                        obj = woVar.f39296x0;
                    }
                    z5Var.h(forLocal, "50_50", f9Var, obj);
                    woVar.f39268b0.m(R.drawable.msg_addphoto, LocaleController.getString("ChatSetNewPhoto", R.string.ChatSetNewPhoto), true);
                    if (woVar.R0 == null) {
                ...
                long j3 = woVar.C0;
                TLRPC.PhotoSize photoSize3 = this.f9120n;
                double d = this.f9119f;
                long j10 = 0;
                if (j3 != 0) {
                    ...
                    if (user != null) {
                        ...
                        if (inputFile5 != null) {
                            j10 = inputFile5.f18123id;
                        } else if (inputFile6 != null) {
                            j10 = inputFile6.f18123id;
                        }
                ...
                if (woVar.M0) {
                    ...
                    woVar.N0 = z11;
                    woVar.f39265a.performClick();
                }
                woVar.n0(z11, true);
                return;
            case 3:
                p50 p50Var = (p50) this.f9121r;
                long j12 = p50Var.e;
                i60 i60Var = p50Var.f36450f;
                AccountInstance accountInstance = i60Var.d;
                TLRPC.InputFile inputFile7 = this.f9117b;
                TLRPC.InputFile inputFile8 = this.f9118c;
                TLRPC.VideoSize videoSize3 = this.d;
                TLRPC.PhotoSize photoSize4 = this.h;
                TLRPC.PhotoSize photoSize5 = this.f9120n;
                if (inputFile7 == null && inputFile8 == null && videoSize3 == null) {
                    p50Var.f36449c = photoSize4.location;
                    TLRPC.FileLocation fileLocation6 = photoSize5.location;
                    p50Var.f36448b = fileLocation6;
                    ImageLocation forLocal2 = ImageLocation.getForLocal(fileLocation6);
                    p50Var.d = forLocal2;
                    i60Var.f34430b.A(forLocal2, ImageLocation.getForLocal(p50Var.f36449c));
                    AndroidUtilities.updateVisibleRows(i60Var.Q);
                    return;
                }
                double d10 = this.f9119f;
                String str = this.e;
                if (j12 > 0) {
                ...
                return;
            case 4:
                l70 l70Var = (l70) this.f9121r;
                TLRPC.InputFile inputFile9 = this.f9117b;
                TLRPC.InputFile inputFile10 = this.f9118c;
                ...
                return;
            case 5:
                ProfileActivity.d0((ProfileActivity) this.f9121r, this.f9117b, this.f9118c, this.d, this.f9119f, this.e, this.h, this.f9120n);
                return;
            default:
                f91.e0((f91) this.f9121r, this.f9117b, this.f9118c, this.d, this.f9119f, this.e, this.h, this.f9120n);
                return;
        }
    }
