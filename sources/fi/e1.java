    ...
    public final void run() {
        ...
        switch (this.f9629a) {
            ...
            default:
                ...
                ArrayList arrayList = launchActivity.f33434f0;
                ArrayList arrayList2 = launchActivity.f33430d0;
                ...
                if (tLObject3 instanceof TLRPC.TL_attachMenuBotsBot) {
                    ...
                    if (!tL_attachMenuBot.inactive) {
                        ...
                        x6Var.setColor(j6.w0(null, j6.f20758ia, false));
