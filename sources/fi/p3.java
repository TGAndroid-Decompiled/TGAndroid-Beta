...
public final class p3 implements Runnable {
    ...
    public final Object f9888e;
    public final Object f9889f;
    ...
    public p3(int i10, long j3, Context context, TL_payments.connectedBotStarRef connectedbotstarref, org.telegram.ui.ActionBar.f3 f3Var, f6 f6Var) {
        ...
        this.d = context;
        this.f9886b = j3;
        this.f9888e = connectedbotstarref;
        this.f9889f = f3Var;
        this.h = f6Var;
    }
    ...
    public final void run() {
        ...
        switch (this.f9885a) {
            case 0:
                ...
                TL_payments.connectedBotStarRef connectedbotstarref = (TL_payments.connectedBotStarRef) this.f9888e;
                zh.o.g(i10).f(context, j10, connectedbotstarref.bot_id, new s3(i10, j10, context, connectedbotstarref, (org.telegram.ui.ActionBar.f3) this.f9889f, (f6) this.h));
                return;
            case 1:
                ((TopicsController) this.d).lambda$loadTopics$5((TLRPC.TL_messages_forumTopics) this.f9888e, this.f9886b, (TLRPC.TL_messages_forumTopics) this.f9889f, (a0.i) this.h, this.f9887c);
                return;
            case 2:
                org.telegram.ui.Cells.f6.a((org.telegram.ui.Cells.f6) this.d, (TLObject) this.f9888e, (MessagesStorage) this.f9889f, this.f9886b, this.f9887c, (ArrayList) this.h);
                return;
            case 3:
                TLObject tLObject = (TLObject) this.d;
                int i11 = this.f9887c;
                di.d dVar = (di.d) this.f9888e;
                org.telegram.ui.ActionBar.f3 f3Var = (org.telegram.ui.ActionBar.f3) this.f9889f;
            ...
            case 4:
                ...
                TLRPC.TL_error tL_error2 = (TLRPC.TL_error) this.f9888e;
                TLObject tLObject2 = (TLObject) this.f9889f;
                long j12 = this.f9886b;
                final int i13 = this.f9887c;
                ...
                if (tL_error2 == null && (tLObject2 instanceof Vector)) {
                    ...
                    if (arrayList.isEmpty()) {
                        for (int i16 = 0; i16 < arrayList3.size(); i16++) {
                            ...
                            gi0Var.f36682a.add((Long) pair.first);
                            gi0Var.f36683b.add((Integer) pair.second);
                            gi0Var.f36684c.add((TLObject) hashMap.get(pair.first));
                        }
                        gi0Var.b();
                        return;
                        ...
                        tL_channels_getParticipants.channel = MessagesController.getInstance(i13).getInputChannel(chat.f19869id);
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap3.put(Long.valueOf(user.f20016id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i18 < arrayList5.size()) {
                                                                            ...
                                                                            gi0Var3.f36682a.add((Long) pair2.first);
                                                                            gi0Var3.f36683b.add((Integer) pair2.second);
                                                                            gi0Var3.f36684c.add((TLObject) hashMap3.get(pair2.first));
                                                                            i18++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject5 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i21 < size4) {
                                                                    ...
                                                                    hashMap4.put(Long.valueOf(user2.f20016id), user2);
                                                                    i21++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i20 < arrayList6.size()) {
                                                                            ...
                                                                            gi0Var4.f36682a.add((Long) pair3.first);
                                                                            gi0Var4.f36683b.add((Integer) pair3.second);
                                                                            gi0Var4.f36684c.add((TLObject) hashMap4.get(pair3.first));
                                                                            i20++;
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        if (tLObject4 != null) {
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (i19 < size3) {
                                                                    ...
                                                                    hashMap32.put(Long.valueOf(user.f20016id), user);
                                                                    i19++;
                                                                } else {
                                                                    while (true) {
                                                                        ...
                                                                        if (i182 < arrayList52.size()) {
                                                                            ...
                                                                            gi0Var32.f36682a.add((Long) pair2.first);
                                                                            gi0Var32.f36683b.add((Integer) pair2.second);
                                                                            gi0Var32.f36684c.add((TLObject) hashMap32.get(pair2.first));
                                                                            i182++;
                                                                        }
                                                                    }
                                                                }
                        ...
                        tL_messages_getFullChat.chat_id = chat.f19869id;
            ...
            default:
                ...
                ArrayList arrayList4 = (ArrayList) this.f9888e;
                int i17 = this.f9887c;
                long j15 = this.f9886b;
                p2Var.mo17run(arrayList4, Integer.valueOf(i17), Long.valueOf(j15), (ArrayList) this.f9889f, (ArrayList) this.h);
                return;
        }
    }
    ...
    public p3(TopicsController topicsController, TLRPC.TL_messages_forumTopics tL_messages_forumTopics, long j3, TLRPC.TL_messages_forumTopics tL_messages_forumTopics2, a0.i iVar, int i10) {
        ...
        this.f9888e = tL_messages_forumTopics;
        this.f9886b = j3;
        this.f9889f = tL_messages_forumTopics2;
        this.h = iVar;
        this.f9887c = i10;
    }
