    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f10028a) {
            ...
            case 4:
                ...
                return;
            case 5:
                ((e8) this.f10030c).f25591a[this.f10029b].setVisibility(8);
                return;
            case 6:
                ((pp) this.f10030c).f29453a[this.f10029b].animate().scaleX(1.0f).scaleY(1.0f).setInterpolator(pr.f29468g).setStartDelay(0L).setDuration(100L).start();
                return;
            case 7:
                ...
                TextView textView = cyVar.f25121e;
                if (i13 == 2) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                TextView textView2 = cyVar.f25122f;
                if (i13 == 3) {
                    i12 = 0;
                }
            ...
            case 8:
                ...
                ih0Var.H = null;
                ih0Var.P.f29058d1.delete(this.f10029b);
                return;
            case 9:
                cr crVar = (cr) this.f10030c;
                ((qk0) crVar.d).f29755b.remove(this.f10029b);
            ...
            case 10:
                ...
                ss0Var.f30412e.O1.remove(this.f10029b);
                ss0Var.f30409a.invalidate();
                return;
            default:
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f10028a) {
            case 7:
                ...
                cyVar.f25121e.setVisibility(0);
                cyVar.f25122f.setVisibility(0);
                return;
            default:
