    ...
    public final void onAnimationEnd(Animator animator) {
        ...
        switch (this.f10056a) {
            ...
            case 4:
                ...
                return;
            case 5:
                ((e8) this.f10058c).f25618a[this.f10057b].setVisibility(8);
                return;
            case 6:
                ((pp) this.f10058c).f29480a[this.f10057b].animate().scaleX(1.0f).scaleY(1.0f).setInterpolator(pr.f29495g).setStartDelay(0L).setDuration(100L).start();
                return;
            case 7:
                ...
                TextView textView = cyVar.f25148e;
                if (i13 == 2) {
                    i11 = 0;
                } else {
                    i11 = 8;
                ...
                TextView textView2 = cyVar.f25149f;
                if (i13 == 3) {
                    i12 = 0;
                }
            ...
            case 8:
                ...
                ih0Var.H = null;
                ih0Var.P.f29085d1.delete(this.f10057b);
                return;
            case 9:
                cr crVar = (cr) this.f10058c;
                ((qk0) crVar.d).f29782b.remove(this.f10057b);
            ...
            case 10:
                ...
                ss0Var.f30439e.O1.remove(this.f10057b);
                ss0Var.f30436a.invalidate();
                return;
            default:
    ...
    public void onAnimationStart(Animator animator) {
        switch (this.f10056a) {
            case 7:
                ...
                cyVar.f25148e.setVisibility(0);
                cyVar.f25149f.setVisibility(0);
                return;
            default:
