        ...
        switch (this.f9893a) {
            ...
            default:
                ...
                if (starGift instanceof TL_stars.TL_starGiftUnique) {
                    z10 = p1Var.f50485b0.disallow_unique_stargifts;
                } else {
                    p1Var.getClass();
                    if (starGift.limited) {
                        TLRPC.DisallowedGiftsSettings disallowedGiftsSettings = p1Var.f50485b0;
                    ...
                    z10 = p1Var.f50485b0.disallow_unlimited_stargifts;
                }
                return true ^ z10;
        }
        return !contains;
