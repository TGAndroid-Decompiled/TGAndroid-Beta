...
public final class k3 extends Dialog implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.u3 {
    ...
    public k3(Context context, f6 f6Var) {
        ...
        int v02 = j6.v0(j6.f20608a7, f6Var);
        this.R = v02;
    ...
    public static WindowInsets e(k3 k3Var, View view, WindowInsets windowInsets) {
        r0.i1 i1Var = r0.l1.h(view, windowInsets).f44712a;
        i0.c f7 = i1Var.f(2);
    ...
    public static JSONObject p(f6 f6Var, final boolean z10) {
        try {
            ...
            final int v = j6.v(-16777216, j6.v0(j6.f20735h5, f6Var));
            ...
            jSONObject.put("section_bg_color", callbackReturn.run(Integer.valueOf(j6.v0(j6.f20664d6, f6Var))));
            int i10 = j6.f20608a7;
            ...
            jSONObject.put("header_bg_color", callbackReturn.run(Integer.valueOf(j6.v0(j6.f20938s8, f6Var))));
            ...
            jSONObject.put("subtitle_text_color", callbackReturn.run(Integer.valueOf(j6.v0(j6.f21062z6, f6Var))));
            jSONObject.put("destructive_text_color", callbackReturn.run(Integer.valueOf(j6.v0(j6.f20881p7, f6Var))));
            jSONObject.put("section_separator_color", callbackReturn.run(Integer.valueOf(j6.v0(j6.f20665d7, f6Var))));
    ...
    public final void A() {
        if (!this.U) {
            ...
            h3Var.B(j6.v0(j6.f20975u8, f6Var), false);
    ...
    public final void B() {
        ...
        for (Map.Entry entry : this.J0.entrySet()) {
            ...
            if (k0Var2.c()) {
                ...
                f1Var.f20403b.setPadding(0, 0, AndroidUtilities.dp(32.0f), 0);
            } else if (k0Var2.f9751i) {
                f1Var.setVisibility(8);
            } else {
                f1Var.setRightIcon(0);
                f1Var.f20403b.setPadding(0, 0, 0, 0);
            }
    ...
    public final void E() {
        ...
        if (this.U) {
            ...
            z10 = (AndroidUtilities.isTablet() || i0.a.f(j6.w0(null, j6.f20664d6, true)) < 0.7210000157356262d || this.f9760b < 0.85f) ? false : false;
        }
        Boolean bool = this.d;
    ...
    public final org.telegram.ui.ActionBar.n3 a() {
        ...
        n3Var.f21231q = this.Q;
        n3Var.f21230p = this.f9785u0;
        n3Var.f21228n = this.U;
        n3Var.f21229o = this.V;
        n3Var.f21232r = this.P.getColor();
        n3Var.f21217a = this.f9786v0;
        boolean z13 = false;
        b3 b3Var = this.f9789x;
        ...
        n3Var.f21225k = f7;
        n3Var.C = this.A0;
        n3Var.f21235u = this.f9788w0;
        n3Var.f21238y = this.f9781r0;
        n3Var.v = this.f9761b0;
        n3Var.f21226l = (a3Var == null || a3Var.M) ? true : true;
        n3Var.f21236w = this.f9774l0.f10073e;
        n3Var.f21233s = this.R;
        a1 a1Var = this.B0;
        if (a1Var != null) {
            a1Var.b();
        }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.webViewResultSent) {
            ...
            this.f9789x.f42053n.b(j6.v0(j6.f20664d6, this.E), 153);
            A();
            E();
    ...
    public final void k(boolean z10) {
        ...
        if (z10 && ((launchActivity = LaunchActivity.G1) == null || launchActivity.f33470y0 == null)) {
            z10 = false;
        }
        if (z10) {
    ...
    public final boolean q() {
        ...
        if (this.f9781r0) {
            ...
            alertDialog$Builder.f20199a.R = str;
            alertDialog$Builder.f20199a.T = LocaleController.getString(R.string.BotWebViewChangesMayNotBeSaved);
            alertDialog$Builder.k(LocaleController.getString(R.string.BotWebViewCloseAnyway), new f2(this));
            alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), null);
            org.telegram.ui.ActionBar.b2 b2Var = alertDialog$Builder.f20199a;
            b2Var.show();
            ((TextView) b2Var.d(-1)).setTextColor(j6.v0(j6.f20899q7, this.E));
            return false;
        }
        k(false);
        return true;
    ...
    public final void r() {
        ...
        if (!arrayList3.isEmpty()) {
            ...
            while (i13 < size2) {
                ...
                if (J.f28636e == null) {
                    ...
                    org.telegram.ui.ActionBar.f1 f1Var = new org.telegram.ui.ActionBar.f1(0, J.f28636e, J.d, false, false);
                    arrayList = arrayList3;
                    f1Var.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
                    f1Var.setText(str);
                    f1Var.setSubtext("");
                    Integer num = J.f28646j0;
                    if (num != null) {
                        v02 = num.intValue();
                    } else {
                        v02 = j6.v0(j6.E8, f6Var);
                    }
                    Integer num2 = J.f28648k0;
                    if (num2 != null) {
                        v03 = num2.intValue();
                    } else {
        ...
        if (this.Q != j6.w0(null, j6.f20664d6, false)) {
                ...
                if (i12 != 2) {
                    if (i12 != 3) {
                        ...
                        if (n2Var instanceof co) {
                            ...
                            if (coVar.i() != null) {
                                ...
                                inputPeer2 = MessagesController.getInputPeer(coVar.f35238e);
                            }
                        } else {
                    ...
                    if (n2Var instanceof co) {
                        ...
                        if (coVar2.i() != null) {
                            ...
                            inputPeer = MessagesController.getInputPeer(coVar2.f35238e);
                        }
                    } else {
