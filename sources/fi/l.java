    ...
    public final void run() {
        ...
        switch (this.f9133a) {
            case 0:
                ...
                return;
            case 1:
                k0.q((k0) this.e, this.f9134b, this.f9135c, this.d);
                return;
            case 2:
                ((MessagesController) this.e).lambda$setLastCreatedDialogId$55(this.f9134b, this.f9135c, this.d);
                return;
            default:
                zn.Q0((zn) this.e, this.d, this.f9134b, this.f9135c);
                return;
        }
    }
