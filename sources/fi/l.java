    ...
    public final void run() {
        ...
        switch (this.f9131a) {
            case 0:
                ...
                return;
            case 1:
                k0.q((k0) this.e, this.f9132b, this.f9133c, this.d);
                return;
            case 2:
                ((MessagesController) this.e).lambda$setLastCreatedDialogId$55(this.f9132b, this.f9133c, this.d);
                return;
            default:
                bo.c1((bo) this.e, this.d, this.f9132b, this.f9133c);
                return;
        }
    }
