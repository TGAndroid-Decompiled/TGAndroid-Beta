...
public abstract class q4 extends FrameLayout {
    public static final hv0 f9930b0 = new hv0(new w9(21), new w9(22));
    public Runnable E;
    public p4 F;
    public o1.k G;
    public int H;
    ...
    public float f9932a0;
    public final l.d f9933b;
    ...
    public org.telegram.ui.web.z0 f9941x;
    public Runnable f9942y;

    public q4(Context context) {
        super(context);
        float f7;
        this.f9935e = org.telegram.ui.ActionBar.k.getCurrentActionBarHeight();
        this.f9936f = 0.0f;
        this.h = -1.0f;
        this.f9937n = -2.1474836E9f;
        this.I = new w9(23);
        this.M = true;
        this.R = 0.0f;
        this.S = false;
        ...
        this.U = true;
        this.f9933b = new l.d(context, new o4(this, ViewConfiguration.get(context).getScaledTouchSlop(), 0));
    ...
    public final boolean b(boolean z10) {
        org.telegram.ui.web.z0 z0Var = this.f9941x;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        if (!this.f9934c || motionEvent.getActionIndex() == 0) {
            if (motionEvent.getAction() == 0) {
                this.V = motionEvent.getEventTime();
                this.W = motionEvent.getX();
                this.f9932a0 = motionEvent.getY();
                this.S = false;
                this.R = 0.0f;
                if (this.N) {
                    this.O = false;
            ...
            boolean onTouchEvent = ((GestureDetector) this.f9933b.f15098b).onTouchEvent(obtain);
            obtain.recycle();
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                ...
                if (!this.J || this.L) {
                    if (this.f9940w) {
                        this.f9940w = false;
                    } else if (this.M && (!this.N || (this.f9938r != (-this.f9936f) + this.f9935e && b(false)))) {
                        float f7 = this.f9938r;
                        int i10 = this.H;
                        float f10 = -i10;
                        boolean z11 = this.U;
                        if (f7 <= f10) {
                            if (z11) {
                                e((-this.f9936f) + this.f9935e);
                            }
                            ...
                            float distance = AndroidUtilities.distance(motionEvent.getX(), motionEvent.getY(), this.W, this.f9932a0);
    ...
    public final void f(float f7, boolean z10, Runnable runnable) {
        ...
        if (this.f9938r != f7 && ((kVar = this.G) == null || ((float) kVar.f16852u.f16859i) != f7)) {
            this.f9937n = f7;
            o1.k kVar2 = this.v;
            if (kVar2 != null) {
                kVar2.c();
            ...
            o1.k kVar4 = new o1.k(this, f9930b0, f7);
            kVar4.f16852u = p6.l(f7, 1200.0f, 1.0f);
    ...
    public Object getRenderNode() {
        if (this.f9931a == null && Build.VERSION.SDK_INT >= 31) {
            this.f9931a = android.support.v4.media.session.y.k();
        }
        return this.f9931a;
    }
    ...
    public void setOffsetY(final float f7) {
        ...
        final float f10 = this.f9936f;
        final float f11 = f7 - f10;
        if (Math.abs((this.f9938r + f10) - this.f9935e) <= AndroidUtilities.dp(1.0f)) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (!this.f9939s) {
            ...
            kVar3.f16852u = p6.l(f7, 1400.0f, 1.0f);
            kVar3.b(new o1.g() {
                @Override
                public final void a(o1.h hVar, float f12, float f13) {
                    ...
                    if (z10) {
                        q4Var.f9938r = w7.p.a(q4Var.f9938r - (Math.max(0.0f, f15) * f14), (-q4Var.f9936f) + q4Var.f9935e, (q4Var.getHeight() - q4Var.f9936f) + q4Var.f9935e);
                    }
                    o1.k kVar4 = q4Var.G;
                    if (kVar4 != null) {
                        o1.l lVar = kVar4.f16852u;
                        float f17 = (float) lVar.f16859i;
                        float f18 = q4Var.f9935e;
                        if (f17 == (-f16) + f18) {
                            lVar.f16859i = (-f7) + f18;
                        }
                    }
        ...
        this.f9936f = f7;
        if (z10) {
            this.f9938r = w7.p.a(this.f9938r - Math.max(0.0f, f11), (-this.f9936f) + this.f9935e, (getHeight() - this.f9936f) + this.f9935e);
        }
        c();
    }
