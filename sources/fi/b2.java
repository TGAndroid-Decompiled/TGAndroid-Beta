...
public final class b2 implements Runnable {
    ...
    public final void run() {
        switch (this.f9589a) {
            case 0:
                SendMessagesHelper.getInstance(this.f9591c).sendMessage(SendMessagesHelper.SendMessageParams.of("/privacy", this.f9590b, null, null, null, false, null, null, null, true, 0, 0, null, false));
                return;
            case 1:
                org.telegram.ui.ActionBar.n2 U = LaunchActivity.U();
                if (U != null) {
                    U.presentFragment(co.Q9(this.f9591c, this.f9590b));
                    return;
                }
                return;
            default:
