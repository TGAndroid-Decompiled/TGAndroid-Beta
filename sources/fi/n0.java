...
public final class n0 implements MessagesStorage.LongCallback, MessagesStorage.BooleanCallback {
    ...
    public void run(boolean z10) {
        ...
        uy.u0(this.f9145a, j3, (TLRPC.Chat) this.e, uyVar, z11, z10);
    }
    ...
    public void run(long j3) {
        ...
        MessagesController.getInstance(this.f9145a).linkCommunity(-j3, this.f9146b, this.f9147c, new o0(n2Var, j3, 0));
    }
}
