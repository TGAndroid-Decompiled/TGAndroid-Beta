...
public final class n0 extends FrameLayout {
    ...
    public n0(p0 p0Var, Context context, TL_keyboard.KeyboardButton keyboardButton) {
        ...
        imageView.setColorFilter(j6.v0(j6.Xe, p0Var.f9897a));
    ...
    public final void a() {
        ...
        if (keyboardButtonStyle != null) {
            ...
            i11 = h;
            v04 = -1;
            this.f9861b.setColorFilter(v04);
            this.f9860a.setTextColor(v04);
            z10 = this.d;
            if (!z10 && this.f9863e) {
                i12 = dp;
            } else {
