...
public final class n0 implements MessagesStorage.LongCallback, MessagesStorage.BooleanCallback {
    ...
    public void run(boolean z10) {
        uy uyVar = (uy) this.d;
        long j3 = this.f9141b;
        boolean z11 = this.f9142c;
        uy.u0(this.f9140a, j3, (TLRPC.Chat) this.e, uyVar, z11, z10);
    }
    ...
    public void run(long j3) {
        ...
        MessagesController.getInstance(this.f9140a).linkCommunity(-j3, this.f9141b, this.f9142c, new o0(n2Var, j3, 0));
    }
}
