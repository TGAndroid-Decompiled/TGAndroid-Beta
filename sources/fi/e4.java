...
public final class e4 extends r20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void A0(e4 e4Var, TLObject tLObject, org.telegram.ui.ActionBar.b2 b2Var) {
        ...
        if (tLObject instanceof TL_payments.connectedStarRefBots) {
                ...
                while (true) {
                    if (i12 >= arrayList.size()) {
                        ...
                        if (connectedbotstarref.revoked) {
                            ...
                            d.f52175c = Math.max(d.f52175c - 1, 0);
                        } else {
            ...
            NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.channelConnectedBotsUpdate, Long.valueOf(d.f52174b));
            d.a();
    ...
    public static org.telegram.ui.ActionBar.f3 H0(Context context, int i10, TL_payments.connectedBotStarRef connectedbotstarref, long j3, f6 f6Var) {
        ...
        org.telegram.ui.ActionBar.f3 i18 = vl.i(1, context, f6Var, false);
        ...
        if (connectedbotstarref.participants > 0) {
            ...
            frameLayout2.setBackground(j6.b0(AndroidUtilities.dp(50.0f), j6.v0(j6.f20734h5, f6Var)));
        ...
        int i19 = j6.G6;
        vl.n(i19, f6Var, textView2, 1, 20.0f);
        ...
        vl.n(i19, f6Var, textView4, 1, 14.0f);
        ...
        int v = j6.v(j6.v0(i20, f6Var), j6.v0(j6.f20753i6, f6Var));
        ...
        i18.fixNavigationBar(j6.v0(j6.f20734h5, f6Var2));
    ...
    public final View createView(Context context) {
        ...
        this.S = jnVar;
        jnVar.setBackgroundColor(j6.w0(null, j6.f20752i5, false));
        super.createView(context);
        this.Q = new FrameLayout(context);
        tg.e eVar = new tg.e(context, 1, 3);
        this.R = eVar;
        eVar.setImportantForAccessibility(4);
        tg.a aVar = this.R.f46519b;
        aVar.f46507w = j6.fk;
        aVar.f46508x = j6.gk;
        aVar.b();
        this.R.setStarParticlesView(this.f40042e);
        ...
        this.f40041c.setOnItemClickListener(new bi.x5(2, this, context));
        this.f40041c.setOnItemLongClickListener(new ah.i0(12, this, context));
        s4.j jVar = new s4.j();
        jVar.f45777m = false;
        jVar.C = false;
        jVar.o(pr.h);
        ...
        this.f40041c.setOnScrollListener(new ah.e0(this, 6));
    ...
    public final s4.h0 n0() {
        w3 w3Var = new w3(this, this.f40041c, getParentActivity(), this.currentAccount, this.classGuid, new ci.u(this, 17), getResourceProvider());
        this.T = w3Var;
        return w3Var;
    }
