...
public abstract class x extends FrameLayout {
    ...
    public x(Context context, f6 f6Var) {
        ...
        int v02 = j6.v0(j6.f20664d6, f6Var);
        aVar2.f285b = v02;
        paint.setColor(v02);
    ...
    public static void b(p6 p6Var, w wVar, boolean z10) {
        ...
        if (wVar.f10048f != 0) {
            ...
            spannableStringBuilder.setSpan(new z5(wVar.f10048f, 1.4f, p6Var.f29285a.getFontMetricsInt()), 0, 1, 33);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        v[] vVarArr = this.f10074f;
        int i14 = 1;
        if (vVarArr[1].f10007b.f25566c < vVarArr[0].f10007b.f25566c) {
            i10 = 1;
        } else {
            i10 = 0;
        }
