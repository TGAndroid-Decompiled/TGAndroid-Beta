...
public final class d {
    public static int f42575c;
    public final AccessibilityNodeInfo f42576a;
    public int f42577b = -1;

    public d(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f42576a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f42576a.addAction(i10);
    }

    public final void b(c cVar) {
        this.f42576a.addAction((AccessibilityNodeInfo.AccessibilityAction) cVar.f42573a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f42576a;
    ...
    public final ArrayList d() {
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f42576a.getActionList();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof d)) {
            ...
            AccessibilityNodeInfo accessibilityNodeInfo2 = this.f42576a;
    ...
    public final boolean f(int i10) {
        Bundle extras = this.f42576a.getExtras();
    ...
    public final void h(Rect rect) {
        this.f42576a.setBoundsInParent(rect);
    }
    ...
    public final void i(String str) {
        this.f42576a.setClassName(str);
    }

    public final void j(String str) {
        this.f42576a.setContentDescription(str);
    }
    ...
    public final void o(CharSequence charSequence) {
        this.f42576a.setText(charSequence);
    }

    public final void p(boolean z10) {
        this.f42576a.setVisibleToUser(z10);
    }
    ...
    public final String toString() {
        ...
        for (int i11 = 0; i11 < d.size(); i11++) {
            c cVar = (c) d.get(i11);
            Object obj = cVar.f42573a;
            Object obj2 = cVar.f42573a;
