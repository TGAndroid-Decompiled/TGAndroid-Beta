...
public final class d {
    public static int f42907c;
    public final AccessibilityNodeInfo f42908a;
    public int f42909b = -1;

    public d(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f42908a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f42908a.addAction(i10);
    }

    public final void b(c cVar) {
        this.f42908a.addAction((AccessibilityNodeInfo.AccessibilityAction) cVar.f42905a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f42908a;
    ...
    public final ArrayList d() {
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f42908a.getActionList();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof d)) {
            ...
            AccessibilityNodeInfo accessibilityNodeInfo2 = this.f42908a;
    ...
    public final boolean f(int i10) {
        Bundle extras = this.f42908a.getExtras();
    ...
    public final void h(Rect rect) {
        this.f42908a.setBoundsInParent(rect);
    }
    ...
    public final void i(String str) {
        this.f42908a.setClassName(str);
    }

    public final void j(String str) {
        this.f42908a.setContentDescription(str);
    }
    ...
    public final void o(CharSequence charSequence) {
        this.f42908a.setText(charSequence);
    }

    public final void p(boolean z10) {
        this.f42908a.setVisibleToUser(z10);
    }
    ...
    public final String toString() {
        ...
        for (int i11 = 0; i11 < d.size(); i11++) {
            c cVar = (c) d.get(i11);
            Object obj = cVar.f42905a;
            Object obj2 = cVar.f42905a;
