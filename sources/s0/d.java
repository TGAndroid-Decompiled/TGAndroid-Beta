...
public final class d {
    public static int f47291c;
    public final AccessibilityNodeInfo f47292a;
    public int f47293b = -1;

    public d(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f47292a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i9) {
        this.f47292a.addAction(i9);
    }

    public final void b(c cVar) {
        this.f47292a.addAction((AccessibilityNodeInfo.AccessibilityAction) cVar.f47289a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f47292a;
    ...
    public final ArrayList d() {
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f47292a.getActionList();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof d)) {
            ...
            AccessibilityNodeInfo accessibilityNodeInfo2 = this.f47292a;
    ...
    public final boolean f(int i9) {
        Bundle extras = this.f47292a.getExtras();
    ...
    public final void h(Rect rect) {
        this.f47292a.setBoundsInParent(rect);
    }
    ...
    public final void i(String str) {
        this.f47292a.setClassName(str);
    }

    public final void j(String str) {
        this.f47292a.setContentDescription(str);
    }
    ...
    public final void k(boolean z10) {
        ...
        if (extras != null) {
            int i10 = 0;
            int i11 = extras.getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", 0) & (-3);
            if (z10) {
                i10 = 2;
            }
            extras.putInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", i11 | i10);
        }
    }
    ...
    public final void o(CharSequence charSequence) {
        this.f47292a.setText(charSequence);
    }

    public final void p(boolean z10) {
        this.f47292a.setVisibleToUser(z10);
    }
    ...
    public final String toString() {
        ...
        for (int i10 = 0; i10 < d.size(); i10++) {
            c cVar = (c) d.get(i10);
            Object obj = cVar.f47289a;
            Object obj2 = cVar.f47289a;
