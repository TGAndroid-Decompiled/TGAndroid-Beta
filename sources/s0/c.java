...
public final class c {
    public static int f45685c;
    public final AccessibilityNodeInfo f45686a;
    public int f45687b = -1;

    public c(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f45686a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f45686a.addAction(i10);
    }

    public final void b(b bVar) {
        this.f45686a.addAction((AccessibilityNodeInfo.AccessibilityAction) bVar.f45683a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f45686a;
    ...
    public final ArrayList d() {
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f45686a.getActionList();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof c)) {
            ...
            AccessibilityNodeInfo accessibilityNodeInfo2 = this.f45686a;
    ...
    public final boolean f(int i10) {
        Bundle extras = this.f45686a.getExtras();
    ...
    public final void h(Rect rect) {
        this.f45686a.setBoundsInParent(rect);
    }
    ...
    public final void i(String str) {
        this.f45686a.setClassName(str);
    }

    public final void j(String str) {
        this.f45686a.setContentDescription(str);
    }
    ...
    public final void o(CharSequence charSequence) {
        this.f45686a.setText(charSequence);
    }

    public final void p(boolean z10) {
        this.f45686a.setVisibleToUser(z10);
    }
    ...
    public final String toString() {
        ...
        for (int i11 = 0; i11 < d.size(); i11++) {
            b bVar = (b) d.get(i11);
            Object obj = bVar.f45683a;
            Object obj2 = bVar.f45683a;
