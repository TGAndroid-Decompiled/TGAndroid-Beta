...
public final class c {
    public static int f45713c;
    public final AccessibilityNodeInfo f45714a;
    public int f45715b = -1;

    public c(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f45714a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f45714a.addAction(i10);
    }

    public final void b(b bVar) {
        this.f45714a.addAction((AccessibilityNodeInfo.AccessibilityAction) bVar.f45711a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f45714a;
    ...
    public final ArrayList d() {
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f45714a.getActionList();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof c)) {
            ...
            AccessibilityNodeInfo accessibilityNodeInfo2 = this.f45714a;
    ...
    public final boolean f(int i10) {
        Bundle extras = this.f45714a.getExtras();
    ...
    public final void h(Rect rect) {
        this.f45714a.setBoundsInParent(rect);
    }
    ...
    public final void i(String str) {
        this.f45714a.setClassName(str);
    }

    public final void j(String str) {
        this.f45714a.setContentDescription(str);
    }
    ...
    public final void o(CharSequence charSequence) {
        this.f45714a.setText(charSequence);
    }

    public final void p(boolean z10) {
        this.f45714a.setVisibleToUser(z10);
    }
    ...
    public final String toString() {
        ...
        for (int i11 = 0; i11 < d.size(); i11++) {
            b bVar = (b) d.get(i11);
            Object obj = bVar.f45711a;
            Object obj2 = bVar.f45711a;
