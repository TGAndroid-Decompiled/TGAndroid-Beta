...
public final class c {
    public static int f47481c;
    public final AccessibilityNodeInfo f47482a;
    public int f47483b = -1;

    public c(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f47482a = accessibilityNodeInfo;
    }
    ...
    public final void a(int i10) {
        this.f47482a.addAction(i10);
    }

    public final void b(b bVar) {
        this.f47482a.addAction((AccessibilityNodeInfo.AccessibilityAction) bVar.f47479a);
    }

    public final ArrayList c(String str) {
        AccessibilityNodeInfo accessibilityNodeInfo = this.f47482a;
    ...
    public final ArrayList d() {
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f47482a.getActionList();
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof c)) {
            ...
            AccessibilityNodeInfo accessibilityNodeInfo2 = this.f47482a;
    ...
    public final boolean f(int i10) {
        Bundle extras = this.f47482a.getExtras();
    ...
    public final void h(Rect rect) {
        this.f47482a.setBoundsInParent(rect);
    }
    ...
    public final void i(String str) {
        this.f47482a.setClassName(str);
    }

    public final void j(String str) {
        this.f47482a.setContentDescription(str);
    }
    ...
    public final void o(CharSequence charSequence) {
        this.f47482a.setText(charSequence);
    }

    public final void p(boolean z10) {
        this.f47482a.setVisibleToUser(z10);
    }
    ...
    public final String toString() {
        ...
        if (i10 >= 33) {
            f9 = g0.a.e(accessibilityNodeInfo);
        } else {
            f9 = f(8388608);
        }
        sb2.append(f9);
        ...
        for (int i11 = 0; i11 < d.size(); i11++) {
            b bVar = (b) d.get(i11);
            Object obj = bVar.f47479a;
            Object obj2 = bVar.f47479a;
