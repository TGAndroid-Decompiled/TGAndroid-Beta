...
public abstract class a implements uc.c, d, Serializable {
    ...
    public StackTraceElement getStackTraceElement() {
        ...
        if (v <= 1) {
            ...
            if (y2Var != y2Var2 && (method = y2Var.f13696a) != null && (invoke = method.invoke(getClass(), null)) != null && (method2 = y2Var.f13697b) != null && (invoke2 = method2.invoke(invoke, null)) != null) {
                Method method3 = y2Var.f13698c;
                if (method3 != null) {
