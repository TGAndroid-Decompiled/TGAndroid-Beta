...
public final class n {
    public final TLRPC.TL_premiumGiftOption f5351a;
    public final TLRPC.TL_premiumGiftCodeOption f5352b;
    public final TLRPC.TL_premiumGiftOption f5353c;
    ...
    public n(TLRPC.TL_premiumGiftOption tL_premiumGiftOption) {
        this.f5351a = tL_premiumGiftOption;
        this.f5352b = null;
        this.f5353c = null;
        this.d = null;
    }
    ...
    public final String a() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f5351a;
        if (tL_premiumGiftOption != null) {
            ...
            TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption = this.f5352b;
    ...
    public final int b() {
        if (this.e == 0) {
            ...
            if (this.f5355g != 0) {
                int f10 = (int) ((1.0d - (f() / this.f5355g)) * 100.0d);
                this.e = f10;
                if (f10 == 0) {
                    this.e = -1;
                }
    ...
    public final String c() {
        ...
        if (!BuildVars.useInvoiceBilling() && (((tL_premiumGiftOption = this.f5351a) == null || tL_premiumGiftOption.store_product != null) && ((tL_premiumGiftCodeOption = this.f5352b) == null || tL_premiumGiftCodeOption.store_product != null))) {
            if (this.h == null) {
                return "";
            }
    ...
    public final long g() {
        TLRPC.TL_premiumGiftOption tL_premiumGiftOption = this.f5353c;
        if (tL_premiumGiftOption != null) {
            return tL_premiumGiftOption.amount;
        }
    ...
    public n(TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption2) {
        this.f5351a = null;
        this.f5352b = tL_premiumGiftCodeOption;
        this.f5353c = null;
