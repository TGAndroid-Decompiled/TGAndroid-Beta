...
public abstract class q0 {
    ...
    public static ArrayList e(long j10) {
        ...
        for (int i10 = 0; i10 < allDialogs.size(); i10++) {
            ...
            if (DialogObject.isChatDialog(dialog.f22396id) && ChatObject.isBoostSupported(messagesController.getChat(Long.valueOf(-dialog.f22396id)))) {
    ...
    public static int j(int i10, TLRPC.Chat chat, Utilities.Callback callback) {
        ...
        if (chat != null) {
            ...
            tL_payments_getPremiumGiftCodeOptions.boost_peer = messagesController.getInputPeer(-chat.f22392id);
        }
    ...
    public static void k(ArrayList arrayList, TLRPC.TL_premiumGiftCodeOption tL_premiumGiftCodeOption, TLRPC.Chat chat, TLRPC.TL_textWithEntities tL_textWithEntities, org.telegram.ui.ActionBar.o2 o2Var, Utilities.Callback callback, Utilities.Callback callback2) {
        ...
        if (!h()) {
            ...
            if (chat != null) {
                ...
                tL_inputStorePaymentPremiumGiftCode.boost_peer = messagesController.getInputPeer(-chat.f22392id);
            }
            ...
            connectionsManager.sendRequest(tL_payments_getPaymentForm, new f0(callback2, messagesController, tL_inputInvoicePremiumGiftCode, o2Var, callback, 1));
            return;
        }
        ...
        if (chat != null) {
            ...
            tL_inputStorePaymentPremiumGiftCode2.boost_peer = messagesController2.getInputPeer(-chat.f22392id);
        }
        if (tL_textWithEntities != null && !TextUtils.isEmpty(tL_textWithEntities.text)) {
        ...
        d9.c cVar = new d9.c();
        cVar.f5537c = "inapp";
        cVar.f5536b = tL_premiumGiftCodeOption.store_product;
        BillingController.getInstance().queryProductDetails(Arrays.asList(cVar.a()), new e0(tL_inputStorePaymentPremiumGiftCode2, tL_premiumGiftCodeOption, connectionsManager2, callback2, callback, o2Var, 0));
    }
    ...
    public static void m(int i10, ArrayList arrayList) {
        ...
        f6118a.put(Integer.valueOf(i10), new Pair(Long.valueOf(System.currentTimeMillis()), arrayList));
    }
}
