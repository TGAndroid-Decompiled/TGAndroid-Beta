...
public final class f1 extends i {
    public final int f5204n = 5;
    public final Paint f5205r;
    public final Path f5206s;

    public f1(g1 g1Var, Context context) {
        super(g1Var, context);
        Paint paint = new Paint(1);
        this.f5205r = paint;
        this.f5206s = new Path();
        ...
        switch (this.f5204n) {
            ...
            case 1:
                ...
                if (showAlpha2 > 0.0f) {
                    ...
                    canvas.drawPath(path2, paint5);
                    float f33 = dp3 + f26;
                    Paint paint6 = this.f5241c;
                    canvas.drawCircle(dp3, f33, dpf22, paint6);
                    Paint paint7 = this.f5240b;
            ...
            case 2:
                ...
                if (showAlpha3 > 0.0f) {
                    ...
                    canvas.drawPath(path3, paint9);
                    float f46 = dp5 + f39;
                    Paint paint10 = this.f5241c;
                    canvas.drawCircle(dp5, f46, dpf23, paint10);
                    Paint paint11 = this.f5240b;
            ...
            case 3:
                ...
                if (showAlpha4 > 0.0f) {
                    ...
                    canvas.drawPath(path4, paint13);
                    float f59 = dp7 + f52;
                    Paint paint14 = this.f5241c;
                    canvas.drawCircle(dp7, f59, dpf24, paint14);
                    Paint paint15 = this.f5240b;
            ...
            case 4:
                ...
                if (showAlpha5 > 0.0f) {
                    ...
                    canvas.drawPath(path5, paint17);
                    float f72 = dp9 + f65;
                    Paint paint18 = this.f5241c;
                    canvas.drawCircle(dp9, f72, dpf25, paint18);
                    Paint paint19 = this.f5240b;
            ...
            default:
                ...
                if (showAlpha6 > 0.0f) {
                    ...
                    canvas2.drawPath(path6, paint21);
                    float f85 = dp11 + f78;
                    Paint paint22 = this.f5241c;
                    canvas2.drawCircle(dp11, f85, dpf26, paint22);
                    Paint paint23 = this.f5240b;
