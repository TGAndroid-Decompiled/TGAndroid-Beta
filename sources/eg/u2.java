...
public final class u2 extends FrameLayout implements x0, NotificationCenter.NotificationCenterDelegate {
    ...
    public int P;
    public long Q;
    public final SvgHelper.SvgDrawable f5509a;
    public final Paint f5510b;
    public final Paint f5511c;
    public final boolean d;
    public File e;
    public float f5512f;
    public final String h;
    public final ImageReceiver f5513n;
    public e3.h f5514r;
        ...
        if ((file != null && file.exists()) || SharedConfig.streamMedia) {
            ...
            if (file2 != null && file2.exists()) {
                ...
                try {
                    ...
                    this.f5512f = parseInt / parseInt2;
    ...
    public final void c() {
        ...
        if (this.f5518y != z4) {
            this.f5518y = z4;
            ImageReceiver imageReceiver = this.f5513n;
            if (z4) {
    ...
    public final void onAttachedToWindow() {
        ...
        NotificationCenter.getInstance(this.f5515s).addObserver(this, NotificationCenter.fileLoaded);
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        this.f5517x = false;
        c();
        NotificationCenter.getInstance(this.f5515s).removeObserver(this, NotificationCenter.fileLoaded);
        p pVar = this.M;
        if (pVar != null) {
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        if (this.P != measuredWidth) {
            ...
            p2 p2Var = this.K;
            if (p2Var != null) {
                RectF rectF2 = p2Var.f5418c;
                RectF rectF3 = p2Var.f5416a;
                int i14 = this.v;
                if (i14 != 6 && i14 != 9 && i14 != 3 && i14 != 7 && i14 != 24 && i14 != 43 && i14 != 11 && i14 != 4) {
                    ...
                    p2Var.f5417b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                } else {
            ...
            n2 n2Var = this.L;
            if (n2Var != null) {
                RectF rectF5 = n2Var.f5362a;
                rectF5.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                n2Var.f5363b.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
            ...
            p pVar = this.M;
            if (pVar != null) {
                ((RectF) pVar.f5408g).set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                ((RectF) this.M.h).set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                ((RectF) this.M.f5408g).inset(AndroidUtilities.dp(0.0f), getMeasuredHeight() * 0.1f);
