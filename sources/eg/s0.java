...
public final class s0 extends TextView {
    ...
    public s0(org.telegram.ui.Components.voip.u0 u0Var, Context context) {
        ...
        this.f5481a = 8;
        this.f5483c = u0Var;
        this.f5482b = new Paint[u0Var.f29940f.length];
        int i10 = 0;
        while (true) {
            Paint[] paintArr = (Paint[]) this.f5482b;
    ...
    public void a() {
        j90 j90Var = (j90) this.f5483c;
        y80 y80Var = (y80) this.f5482b;
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f5481a) {
            case 0:
                Paint paint = (Paint) this.f5482b;
                int i10 = j6.f20273z6;
                f6Var = ((g3) ((u0) this.f5483c).e).resourcesProvider;
            ...
            default:
                ...
                return;
            case 2:
                Paint paint2 = (Paint) this.f5482b;
                int dp = AndroidUtilities.dp(1.0f) + (getHeight() / 2);
                int max = Math.max(1, AndroidUtilities.dp(0.66f));
                Layout layout2 = getLayout();
                if (layout2 != null) {
                    paint2.setColor(j6.l1(0.45f, j6.v0(j6.f20256y6, ((oh.r) this.f5483c).T.f16597c)));
                    float f11 = dp;
                    float f12 = max / 2.0f;
                    float f13 = f11 - f12;
                    float f14 = f11 + f12;
    ...
    public void draw(Canvas canvas) {
        switch (this.f5481a) {
            case 4:
                ((org.telegram.ui.i) this.f5483c).f34774b.draw(canvas);
                super.draw(canvas);
                return;
            case 9:
                ((w70) this.f5483c).h.draw(canvas);
                super.draw(canvas);
                return;
            default:
                super.draw(canvas);
    ...
    public void onDraw(Canvas canvas) {
        switch (this.f5481a) {
            case 1:
                Paint paint = (Paint) this.f5482b;
                paint.setColor(((gh.f) this.f5483c).getThemedColor(j6.Oh));
            ...
            case 4:
                super.onDraw(canvas);
                if (((org.telegram.ui.i) this.f5483c).f34780w) {
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
                    ((org.telegram.ui.Components.voip.h) this.f5482b).a(getMeasuredHeight() / 2.0f, canvas, rectF, null);
                    invalidate();
                    return;
                }
                return;
            case 5:
                Paint paint2 = (Paint) this.f5482b;
                paint2.setColor(((li) this.f5483c).getThemedColor(j6.Oh));
                ...
                return;
            case 6:
                if (((p2) this.f5482b) != null) {
                    canvas.save();
                    canvas.clipPath((Path) this.f5483c);
                    ((p2) this.f5482b).d(canvas);
                    canvas.restore();
                    invalidate();
                }
                super.onDraw(canvas);
            ...
            case 8:
                ...
                Paint[] paintArr = (Paint[]) this.f5482b;
                org.telegram.ui.Components.voip.u0 u0Var = (org.telegram.ui.Components.voip.u0) this.f5483c;
                paintArr[u0Var.f29945x].setAlpha(255);
                canvas.drawRoundRect(rectF2, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paintArr[u0Var.f29945x]);
                float f10 = u0Var.f29944w;
                if (f10 > 0.0f) {
                    int i10 = u0Var.f29945x;
                    if (i10 + 1 < paintArr.length) {
                        paintArr[i10 + 1].setAlpha((int) (f10 * 255.0f));
                        canvas.drawRoundRect(rectF2, AndroidUtilities.dp(6.0f), AndroidUtilities.dp(6.0f), paintArr[u0Var.f29945x + 1]);
                    }
                }
                super.onDraw(canvas);
                return;
            case 9:
                ...
                ((org.telegram.ui.Components.voip.h) this.f5482b).a(getMeasuredHeight() / 2.0f, canvas, rectF3, null);
                invalidate();
                return;
            case 10:
                Paint paint3 = (Paint) this.f5482b;
                paint3.setColor(((sh.n) this.f5483c).getThemedColor(j6.Oh));
                ...
                return;
            case 11:
                Paint paint4 = (Paint) this.f5482b;
                vh.a aVar = ((w5) this.f5483c).f46346x;
                if (aVar != null && aVar.f45854c > 0 && aVar.d == 0 && !aVar.e) {
    ...
    public void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        switch (this.f5481a) {
            case 6:
                ...
                ((p2) this.f5482b).f5416a.set(rectF);
                ((p2) this.f5482b).f5417b.set(rectF);
                ((p2) this.f5482b).f();
                Path path = (Path) this.f5483c;
                path.reset();
    ...
    public void setTextColor(int i10) {
        switch (this.f5481a) {
            case 7:
                ...
                ((j90) this.f5483c).f(j6.l1(0.03f, i10), j6.l1(0.175f, i10), j6.l1(0.2f, i10), j6.l1(0.45f, i10));
                return;
            default:
    ...
    public s0(Context context, int i10) {
        ...
        switch (i10) {
            case 7:
                ...
                j90Var.f25921u = 0.65f;
                j90Var.j(4.0f);
                setBackground(j90Var);
                return;
            default:
                this.f5483c = new Path();
                return;
        }
    }
