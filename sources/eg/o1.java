...
public final class o1 extends g3 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int J;
    public l1 K;
    public final org.telegram.ui.ActionBar.p2 f5380b;
    public final c1 f5381c;
    public final ArrayList d;
    public float e;
    public float f5382f;
    public boolean h;
    public final i1 f5383n;
    public final ah.e f5384r;
    public int f5385s;
    public final FrameLayout v;
    public boolean f5386w;
    public final SvgHelper.SvgDrawable f5387x;
    ...
    public final ViewGroup A(Context context, int i10) {
        ...
        if (i12 == 0) {
            ...
            bVar.f5208b.setOnScrollListener(new f1(this, 1));
            return bVar;
            ...
            return new u2(context, this.f5387x, this.currentAccount, ww0Var.f39779a, this.resourcesProvider);
        } else {
            if (i12 == 28) {
                i11 = 1;
            } else {
            ...
            mVar.f5208b.setOnScrollListener(new f1(this, 0));
            return mVar;
        }
    }
    ...
    public final boolean canDismissWithSwipe() {
        int i10 = 0;
        while (true) {
            i1 i1Var = this.f5383n;
            if (i10 >= i1Var.getChildCount()) {
                return true;
            }
            n1 n1Var = (n1) i1Var.getChildAt(i10);
            if (n1Var.f5357a == this.D) {
                ViewGroup viewGroup = n1Var.f5360f;
                if (viewGroup instanceof b) {
                    return !((b) viewGroup).f5208b.canScrollVertically(-1);
                }
            }
            i10++;
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        this.K = l1Var;
        l1Var.setBackgroundColor(getThemedColor(j6.f19952h5));
        this.K.setTitleColor(getThemedColor(j6.G6));
        this.K.B(getThemedColor(j6.f20275z8), false);
        l1 l1Var2 = this.K;
        int i10 = j6.f20258y8;
    ...
    public final void y() {
        ...
        while (true) {
            ...
            int i14 = n1Var.f5357a;
            ViewGroup viewGroup = n1Var.f5360f;
            if (i14 == this.D && (viewGroup instanceof b) && ((m10 = ((b) viewGroup).f5209c.m(0)) == null || (i11 = m10.getTop()) < 0)) {
                i11 = 0;
            }
            if (n1Var.f5357a == this.E && (viewGroup instanceof b) && ((m9 = ((b) viewGroup).f5209c.m(0)) == null || (i12 = m9.getTop()) < 0)) {
                i12 = 0;
            }
            i13++;
        }
        ...
        frameLayout.setAlpha(1.0f - this.f5382f);
        if (this.e == 1.0f) {
        ...
        boolean z10 = this.h;
        ah.e eVar = this.f5384r;
        if (z10) {
            i10 = eVar.getMeasuredWidth();
        } else {
            i10 = -eVar.getMeasuredWidth();
        }
        eVar.setTranslationX(i10 * this.f5382f);
        if (i15 != this.J) {
            this.J = i15;
    ...
    public o1(org.telegram.ui.ActionBar.p2 r11, android.content.Context r12, int r13, boolean r14, int r15, boolean r16, org.telegram.ui.xw0 r17) {
        throw new UnsupportedOperationException("Method not decompiled: eg.o1.<init>(org.telegram.ui.ActionBar.p2, android.content.Context, int, boolean, int, boolean, org.telegram.ui.xw0):void");
    }
    ...
    public o1(org.telegram.ui.ActionBar.p2 p2Var, Context context, int i10, boolean z4, int i11, boolean z10, xw0 xw0Var, f6 f6Var) {
        ...
        this.f5380b = p2Var;
        this.G = xw0Var;
        fixNavigationBar(getThemedColor(j6.f19952h5));
        this.f5388y = i11;
        this.B = z10;
        this.f5387x = SvgHelper.getDrawable(AndroidUtilities.readRes(R.raw.star_loader));
        ...
        while (true) {
            if (i12 >= this.d.size()) {
                i12 = 0;
                break;
            } else if (((ww0) this.d.get(i12)).f39779a == i11) {
                break;
            } else {
                i12++;
            }
        ...
        this.f5381c = c1Var;
        c1Var.f5221r.setOnClickListener(new e1(this, p2Var, z10, ww0Var, 0));
        ...
        frameLayout2.setBackgroundColor(getThemedColor(j6.f19952h5));
