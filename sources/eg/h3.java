...
public final class h3 implements Utilities.Callback {
    ...
    public final void run(Object obj) {
        switch (this.f5236a) {
            case 0:
                Utilities.themeQueue.postRunnable(new d3((o3) this.f5238c, this.f5237b, (List) obj, new ArrayList(), (uq0) this.d, 0));
                return;
            case 1:
                lh.x3 x3Var = (lh.x3) this.f5238c;
                int i10 = this.f5237b;
                ArrayList arrayList = (ArrayList) obj;
                org.telegram.ui.ActionBar.p2 p2Var = x3Var.f13098a;
                j7 j7Var = x3Var.f13101e;
            ...
            case 3:
                ...
                int i11 = this.f5237b;
                d10Var.getClass();
                d10Var.f26156x0 = ((Boolean) obj).booleanValue();
                d10Var.dismiss();
            ...
            default:
                ...
                p2Var2.showDialog(new vh.a(p2Var2.getContext(), chat, -chat2.f20843id, new e8(p2Var2, this.f5237b, chat2, chat, 3)));
                return;
        }
    }
