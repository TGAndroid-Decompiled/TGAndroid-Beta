...
public final class i1 extends m2.h {
    ...
    public final h1 f5294v0;
    public final o1 f5295w0;
    ...
    public final boolean A(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            this.f5292t0 = System.currentTimeMillis();
            return true;
        }
        if (motionEvent.getAction() == 1) {
            if (System.currentTimeMillis() - this.f5292t0 <= ViewConfiguration.getTapTimeout() && (h1Var = this.f5294v0) != null && h1Var.isFinished()) {
                this.f5293u0 = true;
                o1 o1Var = this.f5295w0;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        super.onMeasure(i10, View.MeasureSpec.makeMeasureSpec(dp + this.f5295w0.I, 1073741824));
    }

    @Override
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f5295w0.f5386w) {
