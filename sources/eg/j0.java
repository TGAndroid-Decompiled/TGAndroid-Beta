    ...
    public final Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f5306a) {
            ...
            case 3:
                ...
                animatorSet4.setInterpolator(mr.f27122f);
                return animatorSet4;
            case 4:
                ...
                animatorSet5.setInterpolator(mr.f27126k);
                return animatorSet5;
            default:
                ...
                if (view instanceof k3) {
                    ...
                    view.setScaleX(0.0f);
                    view.setScaleY(0.0f);
                    ofPropertyValuesHolder.setStartDelay(((k3) view).f29726f);
                }
    ...
    public final Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        switch (this.f5306a) {
            ...
            case 4:
                ...
                animatorSet5.setInterpolator(mr.f27122f);
                return animatorSet5;
            default:
