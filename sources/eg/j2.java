...
public abstract class j2 extends sl0 implements NotificationCenter.NotificationCenterDelegate, x0 {
    ...
    public final int Y2;
    public boolean Z2;
    public boolean f5319a3;
    public final androidx.activity.i f5320b3;
    public final nr c3;
    public final ArrayList f5321d3;
    public final e5.f f5322e3;
    public View f5323f3;
    public boolean f5324g3;
    public int f5325h3;
    public int f5326i3;
    public boolean f5327j3;
    public boolean f5328k3;
    ...
    public j2(Context context, int i10) {
        ...
        this.X2 = true;
        g1 g1Var = (g1) this;
        this.f5320b3 = new androidx.activity.i(g1Var, 18);
        this.c3 = new nr(0.0f, 0.5f, 0.5f, 1.0f);
        this.f5321d3 = new ArrayList();
        this.f5322e3 = new e5.f(2);
        this.f5326i3 = -1;
        this.Y2 = i10;
    ...
    public final void dispatchDraw(Canvas canvas) {
        if (this.f5327j3) {
            ArrayList arrayList = this.f5321d3;
            arrayList.clear();
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                ...
                i2Var.f5307a = clamp;
                i2Var.f5308b.setTranslationX((1.0f - this.c3.getInterpolation(clamp)) * (-getMeasuredWidth()) * 2.0f);
                arrayList.add(i2Var);
            }
            Collections.sort(arrayList, this.f5322e3);
            if ((this.X2 || this.f5324g3) && arrayList.size() > 0 && !this.U2.isEmpty()) {
                View view = (View) kh.a2.i(1, arrayList);
                this.f5323f3 = view;
                w1(view, !this.X2);
                this.X2 = false;
                this.f5324g3 = false;
            } else if (this.f5323f3 != kh.a2.i(1, arrayList)) {
                this.f5323f3 = (View) kh.a2.i(1, arrayList);
                if (this.f5319a3) {
                    try {
    ...
    public final void onMeasure(int i10, int i11) {
        if (View.MeasureSpec.getSize(i11) > View.MeasureSpec.getSize(i10)) {
            this.f5325h3 = View.MeasureSpec.getSize(i10);
        } else {
            this.f5325h3 = View.MeasureSpec.getSize(i11);
        }
    ...
    public void setAutoPlayEnabled(boolean z4) {
        if (this.f5328k3 != z4) {
            ...
            AndroidUtilities.cancelRunOnUIThread(this.f5320b3);
            w1(null, true);
        }
    }
    ...
    public final void x1() {
        ...
        androidx.activity.i iVar = this.f5320b3;
