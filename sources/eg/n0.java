...
public final class n0 extends ql0 {
    ...
    public final int j(int i10) {
        int i11;
        v0 v0Var = this.f5356c;
        if (v0Var.f5531i0 == i10) {
            return 0;
        }
        if (v0Var.f5532j0 == i10) {
            return 2;
        }
        if (v0Var.f5533k0 == i10) {
            return 3;
        }
        if (v0Var.f5535n0 == i10) {
            return 5;
        }
        if (v0Var.f5536o0 == i10) {
            return 6;
        }
        if (v0Var.W == i10) {
            return 7;
        }
        if (v0Var.f5537p0 == i10) {
            return 8;
        }
        ArrayList arrayList = v0Var.f5539r0;
        if (arrayList != null && i10 >= (i11 = v0Var.f5538q0) && i10 <= arrayList.size() + i11) {
            return 9;
        }
        int i12 = v0Var.f5527e0;
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        if (i13 != 1) {
            if (i13 != 9) {
                if (i13 != 3) {
                    if (i13 == 4) {
                        f4 f4Var = (f4) view;
                        if (i12 == 5) {
                            TLRPC.Chat chat = (TLRPC.Chat) v0Var.f5544w0.get(i10 - v0Var.f5534l0);
                            String str2 = (String) v0Var.f5545x0.get(i10 - v0Var.f5534l0);
                            String str3 = chat.title;
                            if (i10 == v0Var.m0 - 1.0f) {
                                z11 = false;
                            }
                            f4Var.e(chat, str3, str2, z11);
                            f4Var.c(hashSet.contains(chat), false);
                            return;
                        } else if (i12 == 11 || i12 == 34) {
                            TLRPC.User user = (TLRPC.User) v0Var.f5546y0.get(i10 - v0Var.f5534l0);
                            ArrayList arrayList = v0Var.f5547z0;
                            if (arrayList != null && arrayList.contains(Long.valueOf(user.f19306id))) {
                                z4 = true;
                            } else {
                                z4 = false;
                            }
                            ...
                            f4Var.e(user, formatName, formatUserStatus, z11);
            ...
            int i14 = i10 - v0Var.f5538q0;
            ArrayList arrayList2 = v0Var.f5539r0;
            if (arrayList2 != null && i14 >= 0 && i14 < arrayList2.size()) {
                q0 q0Var = (q0) view;
                p0 p0Var = (p0) v0Var.f5539r0.get(i14);
                dg.s1 s1Var = q0Var.f5441c;
                ImageView imageView = q0Var.f5439a;
                k5 k5Var = q0Var.f5440b;
                if (p0Var instanceof o0) {
                    q0Var.f5442f = (o0) p0Var;
                    q0Var.e = null;
                    imageView.setVisibility(8);
                    k5Var.setVisibility(8);
                    s1Var.setVisibility(0);
                    k5 k5Var2 = q0Var.d;
                    o0 o0Var = q0Var.f5442f;
                    if (o0Var.h) {
                        str = "BoostLevelUnlocks";
                    } else {
                        str = "BoostLevel";
                    }
                    k5Var2.l(LocaleController.formatPluralString(str, o0Var.f5379g, new Object[0]), false);
                    return;
                } else if (p0Var != null) {
                    q0Var.f5442f = null;
                    q0Var.e = p0Var;
                    imageView.setVisibility(0);
                    imageView.setImageResource(q0Var.e.f5410a);
                    ...
                    if (p0Var2.d != null) {
                        ...
                        String string2 = LocaleController.getString(p0Var2.f5411b);
                        if (string2 != null) {
                            str4 = string2;
                        }
                        if (q0Var.e.f5412c != null) {
                            SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(str4);
                            int indexOf2 = str4.indexOf("%s");
                            if (indexOf2 >= 0) {
                                spannableStringBuilder2 = new SpannableStringBuilder(str4);
                                SpannableString spannableString2 = new SpannableString(q0Var.e.f5412c);
        ...
        TLRPC.Chat chat2 = (TLRPC.Chat) v0Var.f5528f0.get(i10 - v0Var.f5534l0);
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            ...
            case 2:
                ...
                u0Var = new y6(context, j6.v0(i19, f6Var), 0);
                break;
            case 3:
            ...
            case 5:
                ...
                break;
            case 6:
                u0Var = new gn(v0Var.getContext(), 1);
                break;
            case 7:
                ...
                textView.setOnClickListener(new View.OnClickListener(this) {
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (r2) {
                            case 0:
                                v0 v0Var2 = this.f5322b.f5356c;
                                org.telegram.ui.ActionBar.p2 p2Var = v0Var2.f28701n;
                                long j10 = v0Var2.X;
                                f6Var13 = ((g3) v0Var2).resourcesProvider;
                                gg.x.m(p2Var, f6Var13, j10, null);
                                return;
                            case 1:
                                v0 v0Var3 = this.f5322b.f5356c;
                                AndroidUtilities.addToClipboard(v0Var3.p1());
                                v0Var3.dismiss();
                                return;
                            case 2:
                                AndroidUtilities.addToClipboard(this.f5322b.f5356c.p1());
                                return;
                            default:
                                v0 v0Var4 = this.f5322b.f5356c;
                                v0Var4.N0.run();
                                v0Var4.dismiss();
                                return;
                        }
            ...
            case 8:
                ...
                if (f6Var8 instanceof nh.b) {
                    ...
                    f90Var.setTextColor(j6.v0(i25, f6Var11));
                } else {
                    int i26 = j6.G6;
                    f6Var9 = ((g3) v0Var).resourcesProvider;
                    f90Var.setTextColor(j6.v0(i26, f6Var9));
                }
                f90Var.setGravity(1);
                f90Var.setOnClickListener(new View.OnClickListener(this) {
                    public final n0 f5322b;
            ...
            default:
                ...
                v0Var.f5523a0 = u0Var2;
                u0Var = u0Var2;
                break;
        }
        return ai.n(u0Var, u0Var, -1, -2);
    }
}
