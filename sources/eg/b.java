...
public class b extends EditTextBoldCursor {
    public final Canvas f5077b;
    public final TextPaint f5078c;
    ...
    public b(Context context) {
        super(context);
        this.f5077b = new Canvas();
        TextPaint textPaint = new TextPaint(1);
        this.f5078c = textPaint;
        this.d = new Paint(1);
        this.f5083s = new uq();
        this.h = 0;
    ...
    private void setFrameRoundRadius(float f10) {
        if (Math.abs(this.f5086y - f10) > 0.1f) {
            this.f5086y = f10;
    ...
    public final void onDraw(Canvas canvas) {
        boolean z4;
        int i10 = 0;
        if (this.f5079e != null && this.h != 0) {
            boolean z10 = this.f5080f;
            TextPaint textPaint = this.f5078c;
            if (z10) {
                int measuredWidth = (getMeasuredWidth() - getPaddingLeft()) - getPaddingRight();
                int measuredHeight = getMeasuredHeight();
                Editable text = getText();
                Bitmap bitmap = this.f5079e;
                Canvas canvas2 = this.f5077b;
                canvas2.setBitmap(bitmap);
                canvas2.drawColor(0, PorterDuff.Mode.CLEAR);
                float f10 = this.f5081n;
                if (f10 <= 0.0f) {
            ...
            canvas.drawBitmap(this.f5079e, 0.0f, 0.0f, textPaint);
        }
        if (this.f5082r != 0) {
            canvas.save();
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            this.f5079e = Bitmap.createBitmap(i10, i11, Bitmap.Config.ARGB_8888);
            return;
        }
        this.f5079e = null;
    }
    ...
    public void setFrameColor(int i10) {
        ...
        if (i10 != 0) {
            ...
            if (computePerceivedBrightness == 0.0f) {
                computePerceivedBrightness = Color.red(this.f5082r) / 255.0f;
            }
