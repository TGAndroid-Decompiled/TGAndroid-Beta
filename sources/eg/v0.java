...
public class v0 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public org.telegram.ui.Cells.s1 f5526d0;
    public final int f5527e0;
    public final ArrayList f5528f0;
    ...
    public int f5537p0;
    public int f5538q0;
    public ArrayList f5539r0;
    public boolean f5540s0;
    public int f5541t0;
    public t0 f5542u0;
    public final HashSet f5543v0;
    public final ArrayList f5544w0;
    public final ArrayList f5545x0;
    public ArrayList f5546y0;
    public ArrayList f5547z0;
    ...
    public v0(int i10, int i11, Context context, org.telegram.ui.ActionBar.p2 p2Var, f6 f6Var) {
        ...
        this.f5538q0 = -1;
        this.f5541t0 = -1;
        this.f5543v0 = new HashSet();
        this.f5544w0 = new ArrayList();
        this.f5545x0 = new ArrayList();
        this.f5546y0 = new ArrayList();
        this.f5547z0 = new ArrayList();
        this.A0 = new ArrayList();
        this.F0 = false;
        this.O0 = 0;
        this.Q0 = -4;
        fixNavigationBar(j6.v0(j6.f19952h5, this.resourcesProvider));
        this.H0 = p2Var;
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.a.k(j6.v0(j6.f19881d6, f6Var), 120);
    ...
    public static void P(v0 v0Var, ArrayList arrayList, TLRPC.User user) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            MessagesController.getInstance(v0Var.currentAccount).deleteParticipantFromChat(chat.f19159id, user);
        }
    }
    ...
    public static void R(v0 v0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        int i11;
        rl0 rl0Var = v0Var.d;
        ArrayList arrayList2 = v0Var.f5545x0;
        arrayList2.clear();
        ArrayList arrayList3 = v0Var.f5544w0;
        arrayList3.clear();
        ...
        v0Var.M1();
        if (v0Var.f5531i0 >= 0 && i11 != 0) {
            ((f2.i0) rl0Var.getLayoutManager()).h1(v0Var.f5531i0 + 1, i11);
        }
        if (v0Var.J0 == null) {
            v0Var.J0 = u1(v0Var.f5527e0, v0Var.currentAccount);
        }
        int max = Math.max(arrayList3.size(), v0Var.J0.f792b);
        t0 t0Var = v0Var.f5542u0;
        if (t0Var != null) {
            t0Var.g(max, false);
            v0Var.f5542u0.setBagePosition(max / v0Var.J0.f793c);
            t0 t0Var2 = v0Var.f5542u0;
            t0Var2.E = true;
            t0Var2.requestLayout();
        }
    }

    public static f6 R0(v0 v0Var) {
        return v0Var.resourcesProvider;
    }

    public static void S(v0 v0Var) {
        long j10;
        int i10 = v0Var.f5527e0;
        ...
        if (v0Var.f5529g0) {
            ...
            if (canApplyBoost.canApply) {
                ...
                return;
            } else if (canApplyBoost.alreadyActive && gg.p0.i() && !v0Var.Z.isMaxLvl) {
        ...
        if (i10 != 11 && i10 != 34) {
            if (!hashSet.isEmpty()) {
                if (i10 == 2) {
                    ...
                    while (it.hasNext()) {
                        v0Var.f5528f0.add((TLRPC.Chat) it.next());
                    }
                    v0Var.D1(arrayList);
                } else if (i10 == 5) {
                    ...
                    if (textView != null) {
                        textView.setTextColor(j6.v0(j6.f20116q7, v0Var.resourcesProvider));
                    }
                }
            }
    ...
    public static void V(v0 v0Var, Context context) {
        ...
        if (i11 != 11 && i11 != 34) {
            ...
            if (canApplyBoost.empty) {
                ...
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new af.a(28));
            ...
            if (z4 && canApplyBoost.replaceDialogId == 0) {
                if (canApplyBoost.needSelector && gg.p0.i()) {
                    v0Var.f5525c0 = true;
                    v0Var.f5542u0.f23065a0 = false;
                    org.telegram.ui.ActionBar.p2 p2Var2 = v0Var.f28701n;
                    ChannelBoostsController.CanApplyBoost canApplyBoost2 = v0Var.Z;
                ...
                paint.setColor(j6.w0(null, j6.f19952h5, false));
                ...
                imageView.setColorFilter(j6.w0(null, j6.f20042m6, false));
                ...
                textView.setTextColor(j6.w0(null, j6.f19987j5, false));
                ...
                alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), new af.a(29));
    ...
    public static void W(v0 v0Var, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n) {
            ...
            nVar.f21388r.a(hashSet.contains(currentChannel), true);
            v0Var.K1();
        } else if (view instanceof f4) {
            if (v0Var.V || ((i10 = v0Var.f5527e0) != 11 && i10 != 34)) {
                f4 f4Var = (f4) view;
                Object object = f4Var.getObject();
                if (f4Var.L) {
                    if (object instanceof TLRPC.User) {
                        long j10 = ((TLRPC.User) object).f19306id;
                        int i11 = -v0Var.Q0;
                        v0Var.Q0 = i11;
    ...
    public static androidx.emoji2.text.p u1(int i10, int i11) {
        ...
        obj.f793c = 0;
        if (i10 == 0) {
            obj.f792b = MessagesController.getInstance(i11).dialogFiltersPinnedLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).dialogFiltersPinnedLimitPremium;
            obj.f791a = R.drawable.msg_limit_pin;
            obj.d = LocaleController.formatString("LimitReachedPinDialogs", R.string.LimitReachedPinDialogs, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedPinDialogsPremium", R.string.LimitReachedPinDialogsPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedPinDialogsLocked", R.string.LimitReachedPinDialogsLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 33) {
            obj.f792b = MessagesController.getInstance(i11).savedDialogsPinnedLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).savedDialogsPinnedLimitPremium;
            obj.f791a = R.drawable.msg_limit_pin;
            obj.d = LocaleController.formatString(R.string.LimitReachedPinSavedDialogs, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 2) {
            obj.f792b = MessagesController.getInstance(i11).publicLinksLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).publicLinksLimitPremium;
            obj.f791a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedPublicLinks", R.string.LimitReachedPublicLinks, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedPublicLinksPremium", R.string.LimitReachedPublicLinksPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedPublicLinksLocked", R.string.LimitReachedPublicLinksLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 12) {
            obj.f792b = MessagesController.getInstance(i11).chatlistInvitesLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).chatlistInvitesLimitPremium;
            obj.f791a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedFolderLinks", R.string.LimitReachedFolderLinks, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedFolderLinksPremium", R.string.LimitReachedFolderLinksPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedFolderLinksLocked", R.string.LimitReachedFolderLinksLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 13) {
            obj.f792b = MessagesController.getInstance(i11).chatlistJoinedLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).chatlistJoinedLimitPremium;
            obj.f791a = R.drawable.msg_limit_folder;
            obj.d = LocaleController.formatString("LimitReachedSharedFolders", R.string.LimitReachedSharedFolders, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedSharedFoldersPremium", R.string.LimitReachedSharedFoldersPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedSharedFoldersLocked", R.string.LimitReachedSharedFoldersLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 3) {
            obj.f792b = MessagesController.getInstance(i11).dialogFiltersLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).dialogFiltersLimitPremium;
            obj.f791a = R.drawable.msg_limit_folder;
            obj.d = LocaleController.formatString("LimitReachedFolders", R.string.LimitReachedFolders, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedFoldersPremium", R.string.LimitReachedFoldersPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedFoldersLocked", R.string.LimitReachedFoldersLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 4) {
            obj.f792b = MessagesController.getInstance(i11).dialogFiltersChatsLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).dialogFiltersChatsLimitPremium;
            obj.f791a = R.drawable.msg_limit_chats;
            obj.d = LocaleController.formatString("LimitReachedChatInFolders", R.string.LimitReachedChatInFolders, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedChatInFoldersPremium", R.string.LimitReachedChatInFoldersPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedChatInFoldersLocked", R.string.LimitReachedChatInFoldersLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 5) {
            obj.f792b = MessagesController.getInstance(i11).channelsLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).channelsLimitPremium;
            obj.f791a = R.drawable.msg_limit_groups;
            obj.d = LocaleController.formatString("LimitReachedCommunities", R.string.LimitReachedCommunities, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedCommunitiesPremium", R.string.LimitReachedCommunitiesPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedCommunitiesLocked", R.string.LimitReachedCommunitiesLocked, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 6) {
            obj.f792b = 100;
            obj.f793c = 200;
            ...
            obj.f794f = LocaleController.formatString("LimitReachedFileSizeLocked", R.string.LimitReachedFileSizeLocked, "2 GB");
            return obj;
        } else if (i10 == 7) {
            obj.f792b = 3;
            obj.f793c = 4;
            obj.f791a = R.drawable.msg_limit_accounts;
            obj.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 3, Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 11) {
            obj.f792b = 0;
            obj.f793c = 0;
            obj.f791a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 0, Integer.valueOf(obj.f793c));
            obj.e = "";
            obj.f794f = "";
            return obj;
        } else if (i10 == 14) {
            obj.f792b = MessagesController.getInstance(i11).storyExpiringLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).storyExpiringLimitPremium;
            obj.f791a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2First", obj.f792b) + "\n" + LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Second", obj.f793c);
            obj.e = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", obj.f793c);
            obj.f794f = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", obj.f792b);
            return obj;
        } else if (i10 == 15) {
            obj.f792b = MessagesController.getInstance(i11).storiesSentWeeklyLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).storiesSentWeeklyLimitPremium;
            obj.f791a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatString("LimitReachedStoriesWeekly", R.string.LimitReachedStoriesWeekly, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(obj.f792b));
            return obj;
        } else if (i10 == 16) {
            obj.f792b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            obj.f791a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f792b));
            return obj;
            ...
            obj.f792b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            obj.f793c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            obj.f791a = R.drawable.filled_limit_boost;
            obj.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(obj.f792b), Integer.valueOf(obj.f793c));
            obj.e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f793c));
            obj.f794f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f792b));
            return obj;
    ...
    public final boolean B1() {
        ...
        TransitionManager.beginDelayedTransition(this.f5523a0, transitionSet);
        u0 u0Var = this.f5523a0;
        gg.b bVar = u0Var.f5506c;
        int indexOfChild = u0Var.indexOfChild(u0Var.f5505b);
        v0 v0Var = u0Var.e;
        if (v0Var.f5524b0) {
            int indexOfChild2 = u0Var.indexOfChild(u0Var.d);
            u0Var.removeView(u0Var.d);
            u0Var.d.removeView(u0Var.f5504a);
            ...
            u0Var.d.addView(u0Var.f5504a, b6.o(-2, -2, 1.0f, 0));
            u0Var.d.addView(bVar, b6.t(-2, -2, 48, 0, 2, 0, 0));
            u0Var.addView(u0Var.d, indexOfChild2, b6.t(-2, -2, 1, 25, 22, 12, 9));
        } else {
            int indexOfChild3 = u0Var.indexOfChild(u0Var.f5504a);
            u0Var.removeView(u0Var.f5504a);
            TextView textView = new TextView(u0Var.getContext());
            u0Var.f5504a = textView;
            textView.setTypeface(AndroidUtilities.bold());
            u0Var.f5504a.setTextSize(1, 20.0f);
            u0Var.f5504a.setTextColor(j6.v0(j6.G6, v0Var.resourcesProvider));
            u0Var.f5504a.setGravity(17);
            u0Var.addView(u0Var.f5504a, indexOfChild3, b6.t(-2, -2, 1, 0, 22, 0, 0));
        }
        u0Var.removeView(u0Var.f5505b);
        TextView textView2 = new TextView(u0Var.getContext());
        u0Var.f5505b = textView2;
        textView2.setTextSize(1, 14.0f);
        TextView textView3 = u0Var.f5505b;
        textView3.setLineSpacing(textView3.getLineSpacingExtra(), u0Var.f5505b.getLineSpacingMultiplier() * 1.1f);
        u0Var.f5505b.setGravity(1);
        u0Var.f5505b.setTextColor(j6.v0(j6.G6, v0Var.resourcesProvider));
        u0Var.addView(u0Var.f5505b, indexOfChild, b6.t(-2, -2, 1, 24, -2, 24, 17));
        this.f5523a0.f5504a.setText(r1());
        TextView textView4 = this.f5523a0.f5505b;
        MessagesController messagesController = MessagesController.getInstance(this.currentAccount);
        boolean x12 = x1();
        int i23 = this.f5527e0;
        if (i23 == 20) {
            if (x12) {
        ...
        this.f5523a0.f5506c.a(this.Z.boostCount, true);
        this.d.x0(0);
        if (i23 == 32) {
            this.f5523a0.f5506c.setVisibility(8);
        }
        return true;
    }
    ...
    public final void D1(ArrayList arrayList) {
        ...
        TextView textView = (TextView) d2Var.d(-1);
        if (textView != null) {
            textView.setTextColor(j6.v0(j6.f20116q7, this.resourcesProvider));
        }
    }
    ...
    public final void E1(HashMap hashMap) {
        ...
        if (!TextUtils.isEmpty(this.R0)) {
            ...
            TLRPC.ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.L0.f19159id);
            if (chatFull == null) {
                dismiss();
                return;
        ...
        HashSet hashSet = this.f5543v0;
        Iterator it = hashSet.iterator();
        while (it.hasNext()) {
            TLRPC.User user = (TLRPC.User) it.next();
            long sendPaidMessagesStars = MessagesController.getInstance(this.currentAccount).getSendPaidMessagesStars(user.f19306id);
            if (sendPaidMessagesStars <= 0) {
                sendPaidMessagesStars = DialogObject.getMessagesStarsPrice(MessagesController.getInstance(this.currentAccount).isUserContactBlocked(user.f19306id));
            }
            if (sendPaidMessagesStars >= 0) {
        ...
        if (hashMap2 == null && !arrayList2.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                i10++;
                arrayList4.add(Long.valueOf(((TLRPC.User) obj).f19306id));
            }
            z4.c0(this.currentAccount, arrayList4, 1, new cg.h0(this, 5));
            return;
        }
        Iterator it2 = hashSet.iterator();
        boolean z4 = false;
        while (it2.hasNext()) {
            ...
            if (hashMap2 == null) {
                ...
                longValue = ((Long) hashMap2.get(Long.valueOf(user2.f19306id))).longValue();
            }
            Iterator it3 = it2;
            SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(str2, user2.f19306id, null, null, null, true, null, null, null, false, 0, 0, null, false);
    ...
    public final void F(qv0 qv0Var) {
        ...
        if (!this.f28702r && (i10 = this.f5527e0) != 18 && i10 != 20 && i10 != 24 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 22 && i10 != 23 && i10 != 21 && i10 != 27 && i10 != 28 && i10 != 30 && i10 != 35) {
            h0 h0Var = new h0(this, context, 0);
            this.I0 = h0Var;
            h0Var.setBackgroundColor(j6.v0(j6.f19952h5, this.resourcesProvider));
        ...
        rl0Var.setOnItemClickListener(new dg.n(this, 2));
        rl0Var.setOnItemLongClickListener(new c0(this, 2));
        this.B0.f5221r.setOnClickListener(new cg.n(3, this, context));
    ...
    public final void I1(TLRPC.Chat chat, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, String str) {
        ...
        this.V = z4;
        this.f5546y0 = new ArrayList(arrayList);
        this.f5547z0 = arrayList2;
        this.A0 = arrayList3;
        HashSet hashSet = this.f5543v0;
        hashSet.clear();
        if (this.V) {
            ArrayList arrayList4 = this.f5546y0;
            ...
            while (i10 < size) {
                ...
                if (arrayList2 == null || !arrayList2.contains(Long.valueOf(user.f19306id))) {
                    hashSet.add(user);
                }
            }
        }
        M1();
        K1();
        int i11 = this.f5527e0;
        if ((i11 == 11 || i11 == 34) && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked()) {
            if (((arrayList3 != null && !arrayList3.isEmpty()) || (arrayList2 != null && arrayList2.size() >= this.f5546y0.size())) && arrayList3 != null && arrayList2 != null) {
        ...
        while (i10 <= i17) {
            ...
            if (arrayList != null && arrayList.size() == arrayList2.size()) {
                for (int i22 = 0; i22 < arrayList.size(); i22++) {
                    ...
                    int i23 = p0Var.e;
                    if (p0Var2 != null && ((p0Var.f5413f && i23 > 2) || (p0Var.f5410a == p0Var2.f5410a && p0Var.f5411b == p0Var2.f5411b && TextUtils.equals(p0Var.f5412c, p0Var2.f5412c) && TextUtils.equals(p0Var.d, p0Var2.d) && i23 == p0Var2.e))) {
                    }
                }
                i10++;
            }
            ArrayList arrayList3 = this.f5539r0;
            arrayList3.add(new o0(i10, arrayList3.isEmpty()));
            this.f5539r0.addAll(arrayList2);
            arrayList = arrayList2;
            i10++;
        }
    }
    ...
    public final void K1() {
        ...
        if (i11 != 19 && i11 != 32 && !y1()) {
            ...
            tq tqVar3 = this.B0.D;
            tqVar3.f29016a.c(hashSet.size(), true);
            this.B0.invalidate();
            return;
        }
            ...
            if (i12 != 18 && i12 != 20 && i12 != 24 && i12 != 25 && i12 != 26 && i12 != 29 && i12 != 22 && i12 != 23 && i12 != 21 && i12 != 27 && i12 != 28 && i12 != 30 && i12 != 35) {
                if (!UserConfig.getInstance(this.currentAccount).isPremium() && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() && !this.K0) {
                    ...
                    if (pVar != null) {
                        ...
                        g0 g0Var = this.B0;
                        g0Var.f5223w.f29637p = null;
                        g0Var.f5225y.setVisibility(8);
                        return;
                    }
                    g0 g0Var2 = this.B0;
                    g0Var2.f5223w.f29637p = null;
                    g0Var2.f5225y.setVisibility(8);
                    return;
                }
                this.B0.d.setText(LocaleController.getString(R.string.OK));
                g0 g0Var3 = this.B0;
                g0Var3.f5223w.f29637p = null;
                g0Var3.f5225y.setVisibility(8);
                return;
            }
        ...
        if (i10 != 19 && i10 != 18 && i10 != 20 && i10 != 24 && i10 != 27 && i10 != 28 && i10 != 22 && i10 != 23 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 21 && i10 != 30 && i10 != 35) {
            if (i10 != 31 && i10 != 32) {
                if (!v1(i10)) {
                    ...
                    if (this.F0) {
                        int i12 = this.f5530h0;
                        this.f5530h0 = i12 + 1;
                        this.f5535n0 = i12;
                    } else if (i10 != 11 || this.V) {
                        if (i10 != 11 || MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() || ((((arrayList = this.A0) == null || arrayList.isEmpty()) && ((arrayList2 = this.f5547z0) == null || arrayList2.size() < this.f5546y0.size())) || (arrayList3 = this.A0) == null || arrayList3.size() != 1 || (arrayList4 = this.f5547z0) == null || arrayList4.size() != 1 || !this.V)) {
                            int i13 = this.f5530h0;
                            this.f5534l0 = i13;
                            if (i10 != 11 && i10 != 34) {
                                if (i10 == 5) {
                                    this.f5530h0 = this.f5544w0.size() + i13;
                                } else {
                                    this.f5530h0 = this.f5528f0.size() + i13;
                                }
                            } else {
                                this.f5530h0 = this.f5546y0.size() + i13;
                            }
                            this.m0 = this.f5530h0;
                        }
                        if (this.m0 - this.f5534l0 > 1) {
                            int i14 = this.f5530h0;
                            this.f5530h0 = i14 + 1;
                            this.f5536o0 = i14;
                        }
                    }
                ...
                this.v = 0.24f;
                J1();
                int i15 = this.f5530h0;
                this.f5534l0 = i15;
                int i16 = i15 + 1;
                this.f5530h0 = i16;
                this.f5538q0 = i15;
                int size = (this.f5539r0.size() - 1) + i16;
                this.f5530h0 = size;
                this.m0 = size;
            }
        } else {
            if (i10 != 19 || ChatObject.hasAdminRights(s1())) {
                this.v = 0.24f;
                int i17 = this.f5530h0;
                this.f5530h0 = i17 + 1;
                this.W = i17;
                if (MessagesController.getInstance(this.currentAccount).giveawayGiftsPurchaseAvailable) {
                    int i18 = this.f5530h0;
                    this.f5530h0 = i18 + 1;
                    this.f5537p0 = i18;
                }
            }
            J1();
            int i19 = this.f5530h0;
            int i20 = i19 + 1;
            this.f5530h0 = i20;
            this.f5538q0 = i19;
            this.f5530h0 = (this.f5539r0.size() - 1) + i20;
        }
        this.d.getAdapter().l();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.boostByChannelCreated) {
            ...
            org.telegram.ui.ActionBar.p2 p2Var3 = this.f28701n;
            ...
            if (lastFragment instanceof mg.s) {
                ...
                if (fragmentStack.size() >= 3) {
                    p2Var2 = (org.telegram.ui.ActionBar.p2) ai.j(3, fragmentStack);
                } else {
                    p2Var2 = null;
                }
                if (fragmentStack.size() >= 4) {
                    p2Var4 = (org.telegram.ui.ActionBar.p2) ai.j(4, fragmentStack);
                }
            ...
            } else if ((lastFragment instanceof dd) && booleanValue) {
                ...
                for (int size = fragmentStack2.size() - 2; size >= 0; size--) {
                    ...
                    if (!(p2Var5 instanceof zn) && !(p2Var5 instanceof qy)) {
                ...
                if (fragmentStack3.size() >= 2) {
                    p2Var4 = (org.telegram.ui.ActionBar.p2) ai.j(2, fragmentStack3);
                }
                p2Var3.finishFragment();
                dismiss();
                if (p2Var4 instanceof zn) {
                    gg.r.f(p2Var4, chat, true);
                }
            } else {
                da daVar2 = da.C2;
                if (daVar2 != null && daVar2.d) {
                    zn R92 = zn.R9(-chat.f19159id);
                    LaunchActivity.R().presentFragment(R92, false, false);
                    da.x();
                    dismiss();
                    gg.r.f(R92, chat, false);
                    return;
                }
                dismiss();
            ...
            if (tL_premium_boostsStatus != null && this.Z != null) {
                ...
                if (this.f5527e0 == 32 && (t12 = t1()) != null) {
                    t12.boosts_applied += intValue;
                }
                z1();
                F1(tL_premium_boostsStatus, this.f5524b0);
                ChannelBoostsController.CanApplyBoost canApplyBoost = this.Z;
    ...
    public final void m1(final i90 i90Var, boolean z4) {
        ...
        MessagesController.getInstance(this.currentAccount).getBoostsController().applyBoost(this.X, this.Z.slot, new Utilities.Callback(this) {
            ...
            public final void run(Object obj) {
                switch (r3) {
                    case 0:
                        MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.X, new f0(this.f5242b, i90Var, (TL_stories.TL_premium_myBoosts) obj, 0));
                        return;
                    default:
                        ...
                        if (startsWith) {
                            ...
                            if (intValue <= 5) {
                                AndroidUtilities.runOnUIThread(new a1.e(26, this.f5242b, i90Var2), intValue * 1000);
                                return;
                            }
                            gg.r.g(intValue);
                        }
    ...
    public final String r1() {
        ...
        boolean z4 = this.f5524b0;
        int i16 = this.f5527e0;
        if (z4) {
            if (i16 == 32) {
                if (x1()) {
    ...
    public final void z1() {
        ...
        t0Var.f23066b++;
        t0Var.f23064a = k7.n.a((i11 - i10) / i12, 0.0f, 1.0f);
        t0Var.T = true;
        t0Var.U = t0Var.f23076n;
        t0Var.g(i11, true);
