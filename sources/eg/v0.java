...
public class v0 extends sa implements NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean f5536c0;
    public org.telegram.ui.Cells.t1 f5537d0;
    ...
    public int f5548p0;
    public int f5549q0;
    public ArrayList f5550r0;
    public boolean f5551s0;
    public int f5552t0;
    public t0 f5553u0;
    public final HashSet f5554v0;
    public final ArrayList f5555w0;
    public final ArrayList f5556x0;
    public ArrayList f5557y0;
    public ArrayList f5558z0;
    ...
    public v0(int i10, int i11, Context context, org.telegram.ui.ActionBar.p2 p2Var, f6 f6Var) {
        ...
        this.f5549q0 = -1;
        this.f5552t0 = -1;
        this.f5554v0 = new HashSet();
        this.f5555w0 = new ArrayList();
        this.f5556x0 = new ArrayList();
        this.f5557y0 = new ArrayList();
        this.f5558z0 = new ArrayList();
        this.A0 = new ArrayList();
        this.F0 = false;
        this.O0 = 0;
        this.Q0 = -4;
        fixNavigationBar(j6.v0(j6.f19977h5, this.resourcesProvider));
        this.H0 = p2Var;
        ...
        if (i10 == 18 || i10 == 20 || i10 == 24 || i10 == 25 || i10 == 26 || i10 == 29 || i10 == 22 || i10 == 23 || i10 == 21 || i10 == 27 || i10 == 28 || i10 == 30 || i10 == 35 || i10 == 31) {
            ...
            int k10 = i0.a.k(j6.v0(j6.f19906d6, f6Var), 120);
    ...
    public static void P(v0 v0Var, ArrayList arrayList, TLRPC.User user) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            MessagesController.getInstance(v0Var.currentAccount).deleteParticipantFromChat(chat.f19184id, user);
        }
    }
    ...
    public static void R(v0 v0Var, ArrayList arrayList, int i10, TLRPC.TL_messages_inactiveChats tL_messages_inactiveChats) {
        int i11;
        sl0 sl0Var = v0Var.d;
        ArrayList arrayList2 = v0Var.f5556x0;
        arrayList2.clear();
        ArrayList arrayList3 = v0Var.f5555w0;
        arrayList3.clear();
        ...
        v0Var.M1();
        if (v0Var.f5542i0 >= 0 && i11 != 0) {
            ((f2.i0) sl0Var.getLayoutManager()).h1(v0Var.f5542i0 + 1, i11);
        }
        if (v0Var.J0 == null) {
            v0Var.J0 = u1(v0Var.f5538e0, v0Var.currentAccount);
        }
        int max = Math.max(arrayList3.size(), v0Var.J0.f780b);
        t0 t0Var = v0Var.f5553u0;
        if (t0Var != null) {
            t0Var.g(max, false);
            v0Var.f5553u0.setBagePosition(max / v0Var.J0.f781c);
            t0 t0Var2 = v0Var.f5553u0;
            t0Var2.E = true;
        ...
        if (i10 != 11 && i10 != 34) {
            if (!hashSet.isEmpty()) {
                if (i10 == 2) {
                    ...
                    while (it.hasNext()) {
                        v0Var.f5539f0.add((TLRPC.Chat) it.next());
                    }
                    v0Var.D1(arrayList);
                } else if (i10 == 5) {
                    ...
                    if (textView != null) {
                        textView.setTextColor(j6.v0(j6.f20141q7, v0Var.resourcesProvider));
                    }
                }
            }
    ...
    public static void V(v0 v0Var, Context context) {
        ...
        if (i11 != 11 && i11 != 34) {
            ...
            if (canApplyBoost.empty) {
                ...
                alertDialog$Builder.h(LocaleController.getString(R.string.Cancel), new androidx.emoji2.text.w(28));
            ...
            if (z4 && canApplyBoost.replaceDialogId == 0) {
                if (canApplyBoost.needSelector && gg.p0.i()) {
                    v0Var.f5536c0 = true;
                    v0Var.f5553u0.f23092a0 = false;
                    org.telegram.ui.ActionBar.p2 p2Var2 = v0Var.f28678n;
                    ChannelBoostsController.CanApplyBoost canApplyBoost2 = v0Var.Z;
                ...
                paint.setColor(j6.w0(null, j6.f19977h5, false));
                ...
                imageView.setColorFilter(j6.w0(null, j6.f20067m6, false));
                ...
                alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), new Object());
    ...
    public static void W(v0 v0Var, View view) {
        ...
        if (view instanceof org.telegram.ui.Cells.n) {
            ...
            nVar.f21413r.a(hashSet.contains(currentChannel), true);
            v0Var.K1();
        } else if (view instanceof g4) {
            if (v0Var.V || ((i10 = v0Var.f5538e0) != 11 && i10 != 34)) {
                g4 g4Var = (g4) view;
                Object object = g4Var.getObject();
                if (g4Var.L) {
                    if (object instanceof TLRPC.User) {
                        long j10 = ((TLRPC.User) object).f19331id;
                        int i11 = -v0Var.Q0;
                        v0Var.Q0 = i11;
    ...
    public static androidx.emoji2.text.p u1(int i10, int i11) {
        ...
        obj.f781c = 0;
        if (i10 == 0) {
            obj.f780b = MessagesController.getInstance(i11).dialogFiltersPinnedLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).dialogFiltersPinnedLimitPremium;
            obj.f779a = R.drawable.msg_limit_pin;
            obj.d = LocaleController.formatString("LimitReachedPinDialogs", R.string.LimitReachedPinDialogs, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedPinDialogsPremium", R.string.LimitReachedPinDialogsPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedPinDialogsLocked", R.string.LimitReachedPinDialogsLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 33) {
            obj.f780b = MessagesController.getInstance(i11).savedDialogsPinnedLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).savedDialogsPinnedLimitPremium;
            obj.f779a = R.drawable.msg_limit_pin;
            obj.d = LocaleController.formatString(R.string.LimitReachedPinSavedDialogs, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString(R.string.LimitReachedPinSavedDialogsLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 2) {
            obj.f780b = MessagesController.getInstance(i11).publicLinksLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).publicLinksLimitPremium;
            obj.f779a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedPublicLinks", R.string.LimitReachedPublicLinks, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedPublicLinksPremium", R.string.LimitReachedPublicLinksPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedPublicLinksLocked", R.string.LimitReachedPublicLinksLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 12) {
            obj.f780b = MessagesController.getInstance(i11).chatlistInvitesLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).chatlistInvitesLimitPremium;
            obj.f779a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedFolderLinks", R.string.LimitReachedFolderLinks, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedFolderLinksPremium", R.string.LimitReachedFolderLinksPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedFolderLinksLocked", R.string.LimitReachedFolderLinksLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 13) {
            obj.f780b = MessagesController.getInstance(i11).chatlistJoinedLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).chatlistJoinedLimitPremium;
            obj.f779a = R.drawable.msg_limit_folder;
            obj.d = LocaleController.formatString("LimitReachedSharedFolders", R.string.LimitReachedSharedFolders, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedSharedFoldersPremium", R.string.LimitReachedSharedFoldersPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedSharedFoldersLocked", R.string.LimitReachedSharedFoldersLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 3) {
            obj.f780b = MessagesController.getInstance(i11).dialogFiltersLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).dialogFiltersLimitPremium;
            obj.f779a = R.drawable.msg_limit_folder;
            obj.d = LocaleController.formatString("LimitReachedFolders", R.string.LimitReachedFolders, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedFoldersPremium", R.string.LimitReachedFoldersPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedFoldersLocked", R.string.LimitReachedFoldersLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 4) {
            obj.f780b = MessagesController.getInstance(i11).dialogFiltersChatsLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).dialogFiltersChatsLimitPremium;
            obj.f779a = R.drawable.msg_limit_chats;
            obj.d = LocaleController.formatString("LimitReachedChatInFolders", R.string.LimitReachedChatInFolders, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedChatInFoldersPremium", R.string.LimitReachedChatInFoldersPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedChatInFoldersLocked", R.string.LimitReachedChatInFoldersLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 5) {
            obj.f780b = MessagesController.getInstance(i11).channelsLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).channelsLimitPremium;
            obj.f779a = R.drawable.msg_limit_groups;
            obj.d = LocaleController.formatString("LimitReachedCommunities", R.string.LimitReachedCommunities, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedCommunitiesPremium", R.string.LimitReachedCommunitiesPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedCommunitiesLocked", R.string.LimitReachedCommunitiesLocked, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 6) {
            obj.f780b = 100;
            obj.f781c = 200;
            ...
            obj.f782f = LocaleController.formatString("LimitReachedFileSizeLocked", R.string.LimitReachedFileSizeLocked, "2 GB");
            return obj;
        } else if (i10 == 7) {
            obj.f780b = 3;
            obj.f781c = 4;
            obj.f779a = R.drawable.msg_limit_accounts;
            obj.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 3, Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedAccountsPremium", R.string.LimitReachedAccountsPremium, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 11) {
            obj.f780b = 0;
            obj.f781c = 0;
            obj.f779a = R.drawable.msg_limit_links;
            obj.d = LocaleController.formatString("LimitReachedAccounts", R.string.LimitReachedAccounts, 0, Integer.valueOf(obj.f781c));
            obj.e = "";
            obj.f782f = "";
            return obj;
        } else if (i10 == 14) {
            obj.f780b = MessagesController.getInstance(i11).storyExpiringLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).storyExpiringLimitPremium;
            obj.f779a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2First", obj.f780b) + "\n" + LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Second", obj.f781c);
            obj.e = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", obj.f781c);
            obj.f782f = LocaleController.formatPluralStringComma("LimitReachedStoriesCount2Premium", obj.f780b);
            return obj;
        } else if (i10 == 15) {
            obj.f780b = MessagesController.getInstance(i11).storiesSentWeeklyLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).storiesSentWeeklyLimitPremium;
            obj.f779a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatString("LimitReachedStoriesWeekly", R.string.LimitReachedStoriesWeekly, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedStoriesWeeklyPremium", R.string.LimitReachedStoriesWeeklyPremium, Integer.valueOf(obj.f780b));
            return obj;
        } else if (i10 == 16) {
            obj.f780b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            obj.f779a = R.drawable.msg_limit_stories;
            obj.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f780b));
            return obj;
            ...
            obj.f780b = MessagesController.getInstance(i11).storiesSentMonthlyLimitDefault;
            obj.f781c = MessagesController.getInstance(i11).storiesSentMonthlyLimitPremium;
            obj.f779a = R.drawable.filled_limit_boost;
            obj.d = LocaleController.formatString("LimitReachedStoriesMonthly", R.string.LimitReachedStoriesMonthly, Integer.valueOf(obj.f780b), Integer.valueOf(obj.f781c));
            obj.e = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f781c));
            obj.f782f = LocaleController.formatString("LimitReachedStoriesMonthlyPremium", R.string.LimitReachedStoriesMonthlyPremium, Integer.valueOf(obj.f780b));
            return obj;
    ...
    public final boolean B1() {
        ...
        TransitionManager.beginDelayedTransition(this.f5534a0, transitionSet);
        u0 u0Var = this.f5534a0;
        gg.b bVar = u0Var.f5517c;
        int indexOfChild = u0Var.indexOfChild(u0Var.f5516b);
        v0 v0Var = u0Var.e;
        if (v0Var.f5535b0) {
            int indexOfChild2 = u0Var.indexOfChild(u0Var.d);
            u0Var.removeView(u0Var.d);
            u0Var.d.removeView(u0Var.f5515a);
            ...
            u0Var.d.addView(u0Var.f5515a, b6.o(-2, -2, 1.0f, 0));
            u0Var.d.addView(bVar, b6.t(-2, -2, 48, 0, 2, 0, 0));
            u0Var.addView(u0Var.d, indexOfChild2, b6.t(-2, -2, 1, 25, 22, 12, 9));
        } else {
            int indexOfChild3 = u0Var.indexOfChild(u0Var.f5515a);
            u0Var.removeView(u0Var.f5515a);
            TextView textView = new TextView(u0Var.getContext());
            u0Var.f5515a = textView;
            textView.setTypeface(AndroidUtilities.bold());
            u0Var.f5515a.setTextSize(1, 20.0f);
            u0Var.f5515a.setTextColor(j6.v0(j6.G6, v0Var.resourcesProvider));
            u0Var.f5515a.setGravity(17);
            u0Var.addView(u0Var.f5515a, indexOfChild3, b6.t(-2, -2, 1, 0, 22, 0, 0));
        }
        u0Var.removeView(u0Var.f5516b);
        TextView textView2 = new TextView(u0Var.getContext());
        u0Var.f5516b = textView2;
        textView2.setTextSize(1, 14.0f);
        TextView textView3 = u0Var.f5516b;
        textView3.setLineSpacing(textView3.getLineSpacingExtra(), u0Var.f5516b.getLineSpacingMultiplier() * 1.1f);
        u0Var.f5516b.setGravity(1);
        u0Var.f5516b.setTextColor(j6.v0(j6.G6, v0Var.resourcesProvider));
        u0Var.addView(u0Var.f5516b, indexOfChild, b6.t(-2, -2, 1, 24, -2, 24, 17));
        this.f5534a0.f5515a.setText(r1());
        TextView textView4 = this.f5534a0.f5516b;
        MessagesController messagesController = MessagesController.getInstance(this.currentAccount);
        boolean x12 = x1();
        int i23 = this.f5538e0;
        if (i23 == 20) {
            if (x12) {
        ...
        this.f5534a0.f5517c.a(this.Z.boostCount, true);
        this.d.x0(0);
        if (i23 == 32) {
            this.f5534a0.f5517c.setVisibility(8);
        }
        return true;
    }
    ...
    public final void D1(ArrayList arrayList) {
        ...
        TextView textView = (TextView) d2Var.d(-1);
        if (textView != null) {
            textView.setTextColor(j6.v0(j6.f20141q7, this.resourcesProvider));
        }
    }
    ...
    public final void E1(HashMap hashMap) {
        ...
        if (!TextUtils.isEmpty(this.R0)) {
            ...
            TLRPC.ChatFull chatFull = MessagesController.getInstance(this.currentAccount).getChatFull(this.L0.f19184id);
            if (chatFull == null) {
                dismiss();
                return;
        ...
        HashSet hashSet = this.f5554v0;
        Iterator it = hashSet.iterator();
        while (it.hasNext()) {
            TLRPC.User user = (TLRPC.User) it.next();
            long sendPaidMessagesStars = MessagesController.getInstance(this.currentAccount).getSendPaidMessagesStars(user.f19331id);
            if (sendPaidMessagesStars <= 0) {
                sendPaidMessagesStars = DialogObject.getMessagesStarsPrice(MessagesController.getInstance(this.currentAccount).isUserContactBlocked(user.f19331id));
            }
            if (sendPaidMessagesStars >= 0) {
        ...
        if (hashMap2 == null && !arrayList2.isEmpty()) {
            ...
            while (i10 < size) {
                ...
                i10++;
                arrayList4.add(Long.valueOf(((TLRPC.User) obj).f19331id));
            }
        ...
        while (it2.hasNext()) {
            ...
            if (hashMap2 == null) {
                ...
                longValue = ((Long) hashMap2.get(Long.valueOf(user2.f19331id))).longValue();
            }
            Iterator it3 = it2;
            SendMessagesHelper.SendMessageParams of2 = SendMessagesHelper.SendMessageParams.of(str2, user2.f19331id, null, null, null, true, null, null, null, false, 0, 0, null, false);
    ...
    public final void F(qv0 qv0Var) {
        ...
        if (!this.f28679r && (i10 = this.f5538e0) != 18 && i10 != 20 && i10 != 24 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 22 && i10 != 23 && i10 != 21 && i10 != 27 && i10 != 28 && i10 != 30 && i10 != 35) {
            h0 h0Var = new h0(this, context, 0);
            this.I0 = h0Var;
            h0Var.setBackgroundColor(j6.v0(j6.f19977h5, this.resourcesProvider));
        ...
        sl0Var.setOnItemClickListener(new dg.n(this, 2));
        sl0Var.setOnItemLongClickListener(new c0(this, 2));
        this.B0.f5232r.setOnClickListener(new cg.n(3, this, context));
    ...
    public final void I1(TLRPC.Chat chat, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, String str) {
        ...
        this.V = z4;
        this.f5557y0 = new ArrayList(arrayList);
        this.f5558z0 = arrayList2;
        this.A0 = arrayList3;
        HashSet hashSet = this.f5554v0;
        hashSet.clear();
        if (this.V) {
            ArrayList arrayList4 = this.f5557y0;
            ...
            while (i10 < size) {
                ...
                if (arrayList2 == null || !arrayList2.contains(Long.valueOf(user.f19331id))) {
                    hashSet.add(user);
                }
            }
        }
        M1();
        K1();
        int i11 = this.f5538e0;
        if ((i11 == 11 || i11 == 34) && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked()) {
            if (((arrayList3 != null && !arrayList3.isEmpty()) || (arrayList2 != null && arrayList2.size() >= this.f5557y0.size())) && arrayList3 != null && arrayList2 != null) {
        ...
        while (i10 <= i17) {
            ...
            if (arrayList != null && arrayList.size() == arrayList2.size()) {
                for (int i22 = 0; i22 < arrayList.size(); i22++) {
                    ...
                    int i23 = p0Var.e;
                    if (p0Var2 != null && ((p0Var.f5424f && i23 > 2) || (p0Var.f5421a == p0Var2.f5421a && p0Var.f5422b == p0Var2.f5422b && TextUtils.equals(p0Var.f5423c, p0Var2.f5423c) && TextUtils.equals(p0Var.d, p0Var2.d) && i23 == p0Var2.e))) {
                    }
                }
                i10++;
            }
            ArrayList arrayList3 = this.f5550r0;
            arrayList3.add(new o0(i10, arrayList3.isEmpty()));
            this.f5550r0.addAll(arrayList2);
            arrayList = arrayList2;
            i10++;
        }
    }
    ...
    public final void K1() {
        ...
        if (i11 != 19 && i11 != 32 && !y1()) {
            ...
            uq uqVar3 = this.B0.D;
            uqVar3.f29272a.c(hashSet.size(), true);
            this.B0.invalidate();
            return;
        }
            ...
            if (i12 != 18 && i12 != 20 && i12 != 24 && i12 != 25 && i12 != 26 && i12 != 29 && i12 != 22 && i12 != 23 && i12 != 21 && i12 != 27 && i12 != 28 && i12 != 30 && i12 != 35) {
                if (!UserConfig.getInstance(this.currentAccount).isPremium() && !MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() && !this.K0) {
                    ...
                    if (pVar != null) {
                        ...
                        g0 g0Var = this.B0;
                        g0Var.f5234w.f29665p = null;
                        g0Var.f5236y.setVisibility(8);
                        return;
                    }
                    g0 g0Var2 = this.B0;
                    g0Var2.f5234w.f29665p = null;
                    g0Var2.f5236y.setVisibility(8);
                    return;
                }
                this.B0.d.setText(LocaleController.getString(R.string.OK));
                g0 g0Var3 = this.B0;
                g0Var3.f5234w.f29665p = null;
                g0Var3.f5236y.setVisibility(8);
                return;
            }
        ...
        if (i10 != 19 && i10 != 18 && i10 != 20 && i10 != 24 && i10 != 27 && i10 != 28 && i10 != 22 && i10 != 23 && i10 != 25 && i10 != 26 && i10 != 29 && i10 != 21 && i10 != 30 && i10 != 35) {
            if (i10 != 31 && i10 != 32) {
                if (!v1(i10)) {
                    ...
                    if (this.F0) {
                        int i12 = this.f5541h0;
                        this.f5541h0 = i12 + 1;
                        this.f5546n0 = i12;
                    } else if (i10 != 11 || this.V) {
                        if (i10 != 11 || MessagesController.getInstance(this.currentAccount).premiumFeaturesBlocked() || ((((arrayList = this.A0) == null || arrayList.isEmpty()) && ((arrayList2 = this.f5558z0) == null || arrayList2.size() < this.f5557y0.size())) || (arrayList3 = this.A0) == null || arrayList3.size() != 1 || (arrayList4 = this.f5558z0) == null || arrayList4.size() != 1 || !this.V)) {
                            int i13 = this.f5541h0;
                            this.f5545l0 = i13;
                            if (i10 != 11 && i10 != 34) {
                                if (i10 == 5) {
                                    this.f5541h0 = this.f5555w0.size() + i13;
                                } else {
                                    this.f5541h0 = this.f5539f0.size() + i13;
                                }
                            } else {
                                this.f5541h0 = this.f5557y0.size() + i13;
                            }
                            this.m0 = this.f5541h0;
                        }
                        if (this.m0 - this.f5545l0 > 1) {
                            int i14 = this.f5541h0;
                            this.f5541h0 = i14 + 1;
                            this.f5547o0 = i14;
                        }
                    }
                ...
                this.v = 0.24f;
                J1();
                int i15 = this.f5541h0;
                this.f5545l0 = i15;
                int i16 = i15 + 1;
                this.f5541h0 = i16;
                this.f5549q0 = i15;
                int size = (this.f5550r0.size() - 1) + i16;
                this.f5541h0 = size;
                this.m0 = size;
            }
        } else {
            if (i10 != 19 || ChatObject.hasAdminRights(s1())) {
                this.v = 0.24f;
                int i17 = this.f5541h0;
                this.f5541h0 = i17 + 1;
                this.W = i17;
                if (MessagesController.getInstance(this.currentAccount).giveawayGiftsPurchaseAvailable) {
                    int i18 = this.f5541h0;
                    this.f5541h0 = i18 + 1;
                    this.f5548p0 = i18;
                }
            }
            J1();
            int i19 = this.f5541h0;
            int i20 = i19 + 1;
            this.f5541h0 = i20;
            this.f5549q0 = i19;
            this.f5541h0 = (this.f5550r0.size() - 1) + i20;
        }
        this.d.getAdapter().l();
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.boostByChannelCreated) {
            ...
            org.telegram.ui.ActionBar.p2 p2Var3 = this.f28678n;
            ...
            if (lastFragment instanceof mg.s) {
                ...
                if (fragmentStack.size() >= 3) {
                    p2Var2 = (org.telegram.ui.ActionBar.p2) yh.k(3, fragmentStack);
                } else {
                    p2Var2 = null;
                }
                if (fragmentStack.size() >= 4) {
                    p2Var4 = (org.telegram.ui.ActionBar.p2) yh.k(4, fragmentStack);
                }
                ...
                for (int size = fragmentStack2.size() - 2; size >= 0; size--) {
                    ...
                    if (!(p2Var5 instanceof xn) && !(p2Var5 instanceof oy)) {
                ...
                if (fragmentStack3.size() >= 2) {
                    p2Var4 = (org.telegram.ui.ActionBar.p2) yh.k(2, fragmentStack3);
                }
                p2Var3.finishFragment();
                dismiss();
            ...
            if (tL_premium_boostsStatus != null && this.Z != null) {
                ...
                if (this.f5538e0 == 32 && (t12 = t1()) != null) {
                    t12.boosts_applied += intValue;
                }
                z1();
                F1(tL_premium_boostsStatus, this.f5535b0);
                ChannelBoostsController.CanApplyBoost canApplyBoost = this.Z;
    ...
    public final void m1(final h90 h90Var, boolean z4) {
        ...
        MessagesController.getInstance(this.currentAccount).getBoostsController().applyBoost(this.X, this.Z.slot, new Utilities.Callback(this) {
            ...
            public final void run(Object obj) {
                switch (r3) {
                    case 0:
                        MessagesController.getInstance(r1.currentAccount).getBoostsController().getBoostsStats(r1.X, new f0(this.f5253b, h90Var, (TL_stories.TL_premium_myBoosts) obj, 0));
                        return;
                    default:
                        ...
                        if (startsWith) {
                            ...
                            if (intValue <= 5) {
                                AndroidUtilities.runOnUIThread(new a1.e(25, this.f5253b, h90Var2), intValue * 1000);
                                return;
                            }
                            gg.r.g(intValue);
                        }
    ...
    public final String r1() {
        ...
        boolean z4 = this.f5535b0;
        int i16 = this.f5538e0;
        if (z4) {
            if (i16 == 32) {
                if (x1()) {
    ...
    public final void z1() {
        ...
        t0Var.f23093b++;
        t0Var.f23091a = k7.n.a((i11 - i10) / i12, 0.0f, 1.0f);
        t0Var.T = true;
        t0Var.U = t0Var.f23103n;
        t0Var.g(i11, true);
