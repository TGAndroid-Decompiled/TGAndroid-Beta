...
public final class b extends InputConnectionWrapper {
    public final EditText f41368a;
    public final na.d f41369b;

    public b(EditText editText, InputConnection inputConnection, EditorInfo editorInfo) {
        super(inputConnection, false);
        int i10;
        na.d dVar = new na.d(19);
        this.f41368a = editText;
        this.f41369b = dVar;
        if (l.f2329j != null) {
            l a2 = l.a();
            ...
            int a10 = bVar.a(4);
            if (a10 != 0) {
                i10 = ((ByteBuffer) bVar.d).getInt(a10 + bVar.f40662a);
            } else {
                i10 = 0;
            }
    ...
    public final boolean deleteSurroundingText(int i10, int i11) {
        Editable editableText = this.f41368a.getEditableText();
