...
public final class b extends InputConnectionWrapper {
    public final EditText f41367a;
    public final na.d f41368b;
    ...
    public b(EditText editText, InputConnection inputConnection, EditorInfo editorInfo) {
        ...
        if (l.f2329j != null) {
            ...
            int a10 = bVar.a(4);
            if (a10 != 0) {
                i10 = ((ByteBuffer) bVar.d).getInt(a10 + bVar.f40661a);
            } else {
                i10 = 0;
            }
    ...
    public final boolean deleteSurroundingText(int i10, int i11) {
        Editable editableText = this.f41367a.getEditableText();
        this.f41368b.getClass();
