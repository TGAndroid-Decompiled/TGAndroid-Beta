...
public final class b extends InputConnectionWrapper {
    public final EditText f44453a;
    public final ab.a f44454b;

    public b(EditText editText, InputConnection inputConnection, EditorInfo editorInfo) {
        super(inputConnection, false);
        int i10;
        ab.a aVar = new ab.a(20);
        this.f44453a = editText;
        this.f44454b = aVar;
        if (l.f834j != null) {
            l a2 = l.a();
            ...
            int a10 = bVar.a(4);
            if (a10 != 0) {
                i10 = ((ByteBuffer) bVar.d).getInt(a10 + bVar.f44117a);
            } else {
                i10 = 0;
            }
    ...
    public final boolean deleteSurroundingText(int i10, int i11) {
        Editable editableText = this.f44453a.getEditableText();
