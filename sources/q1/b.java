...
public final class b extends InputConnectionWrapper {
    public final EditText f41080a;
    public final na.d f41081b;

    public b(EditText editText, InputConnection inputConnection, EditorInfo editorInfo) {
        super(inputConnection, false);
        int i10;
        na.d dVar = new na.d(19);
        this.f41080a = editText;
        this.f41081b = dVar;
        if (l.f2332j != null) {
            l a2 = l.a();
            ...
            p1.b bVar = (p1.b) ((t) fVar.f2324c).f7347b;
            int a10 = bVar.a(4);
            if (a10 != 0) {
                i10 = ((ByteBuffer) bVar.d).getInt(a10 + bVar.f40392a);
            } else {
                i10 = 0;
            }
    ...
    public final boolean deleteSurroundingText(int i10, int i11) {
        Editable editableText = this.f41080a.getEditableText();
