...
public final class k {
    public final Spatializer f45180a;
    public final boolean f45181b;
    public final Handler f45182c;
    public final j d;
    ...
    public k(Context context, p pVar, Boolean bool) {
        ...
        if (e != null && (bool == null || !bool.booleanValue())) {
            ...
            this.f45180a = spatializer;
            this.f45181b = spatializer.getImmersiveAudioLevel() != 0;
            j jVar = new j(pVar);
            this.d = jVar;
            Looper myLooper = Looper.myLooper();
            e2.d.h(myLooper);
            Handler handler = new Handler(myLooper);
            this.f45182c = handler;
    ...
    public final boolean a(b2.e eVar, b2.s sVar) {
        ...
        Spatializer spatializer = this.f45180a;
        spatializer.getClass();
        return spatializer.canBeSpatialized((AudioAttributes) eVar.b().f3341a, channelMask.build());
    }
    ...
    public final void d() {
        ...
        Handler handler;
        Spatializer spatializer = this.f45180a;
        if (spatializer != null && (jVar = this.d) != null && (handler = this.f45182c) != null) {
