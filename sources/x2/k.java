...
public final class k {
    public final Spatializer f45212a;
    ...
    public k(Context context, p pVar, Boolean bool) {
        ...
        if (e != null && (bool == null || !bool.booleanValue())) {
            ...
            this.f45212a = spatializer;
            this.f45213b = spatializer.getImmersiveAudioLevel() != 0;
            j jVar = new j(pVar);
            this.d = jVar;
    ...
    public final boolean a(b2.e eVar, b2.s sVar) {
        ...
        Spatializer spatializer = this.f45212a;
    ...
    public final void d() {
        ...
        Handler handler;
        Spatializer spatializer = this.f45212a;
        if (spatializer != null && (jVar = this.d) != null && (handler = this.f45214c) != null) {
