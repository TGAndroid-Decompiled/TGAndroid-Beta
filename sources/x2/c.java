...
public abstract class c implements r {
    ...
    public c(l1 l1Var, int[] iArr) {
        ...
        this.f45153c = new int[this.f45152b];
        while (true) {
            int i12 = this.f45152b;
            if (i10 < i12) {
                this.f45153c[i10] = l1Var.a(this.d[i10]);
                i10++;
            } else {
                this.e = new long[i12];
                return;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            c cVar = (c) obj;
            if (this.f45151a.equals(cVar.f45151a) && Arrays.equals(this.f45153c, cVar.f45153c)) {
                return true;
            }
        }
        return false;
    ...
    public final int h(int i10) {
        return this.f45153c[i10];
    }

    public final int hashCode() {
        if (this.f45154f == 0) {
            this.f45154f = Arrays.hashCode(this.f45153c) + (System.identityHashCode(this.f45151a) * 31);
        }
        return this.f45154f;
    }
    ...
    @Override
    public final int l() {
        return this.f45153c[c()];
    }

    @Override
    public final int length() {
        return this.f45153c.length;
    }
    ...
    public final boolean o(int i10, long j3) {
        ...
        for (int i11 = 0; i11 < this.f45152b && !a2; i11++) {
    ...
    public final int s(b2.s sVar) {
        for (int i10 = 0; i10 < this.f45152b; i10++) {
            if (this.d[i10] == sVar) {
                return i10;
            }
        }
    ...
    public final int u(int i10) {
        for (int i11 = 0; i11 < this.f45152b; i11++) {
            if (this.f45153c[i11] == i10) {
                return i11;
            }
        }
        return -1;
