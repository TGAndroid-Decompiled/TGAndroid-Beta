...
public final class e extends n implements Comparable {
    ...
    public final i f45185n;
    public final boolean f45186r;
    public final int f45187s;
    public final int v;
    public final int f45188w;
    ...
    public final boolean b(n nVar) {
        ...
        e eVar = (e) nVar;
        b2.s sVar = eVar.d;
        this.f45185n.getClass();
        b2.s sVar2 = this.d;
        int i11 = sVar2.J;
        if (i11 != -1 && i11 == sVar.J) {
            if ((this.f45189x || ((str = sVar2.f3309r) != null && TextUtils.equals(str, sVar.f3309r))) && (i10 = sVar2.K) != -1 && i10 == sVar.K && this.L == eVar.L && this.M == eVar.M) {
                return true;
            }
            return false;
        }
    ...
    public final int compareTo(e eVar) {
        y0 a2;
        boolean z10 = this.f45186r;
        boolean z11 = this.f45184f;
        if (z11 && z10) {
            a2 = p.f45226l;
        } else {
            a2 = p.f45226l.a();
        }
        boolean z12 = eVar.f45186r;
        int i10 = eVar.J;
        z c10 = z.f8146a.c(z10, z12);
        Integer valueOf = Integer.valueOf(this.v);
        Integer valueOf2 = Integer.valueOf(eVar.v);
        x0 x0Var = x0.f8144c;
        z b10 = c10.b(valueOf, valueOf2, x0Var).a(this.f45187s, eVar.f45187s).a(this.f45188w, eVar.f45188w).c(this.G, eVar.G).c(this.f45190y, eVar.f45190y).b(Integer.valueOf(this.E), Integer.valueOf(eVar.E), x0Var).a(this.F, eVar.F).c(z11, eVar.f45184f).b(Integer.valueOf(this.K), Integer.valueOf(eVar.K), x0Var);
        boolean z13 = this.f45185n.B;
        int i11 = this.J;
        if (z13) {
            b10 = b10.b(Integer.valueOf(i11), Integer.valueOf(i10), p.f45226l.a());
        }
