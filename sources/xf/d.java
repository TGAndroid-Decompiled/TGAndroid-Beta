...
public final class d {
    ...
    public final CharSequence[] f46935b;
    public final CharSequence[] f46936c;
    ...
    public d(long r25, long r27, boolean r29, float r30, int r31, android.text.TextPaint r32, android.text.TextPaint r33) {
        throw new UnsupportedOperationException("Method not decompiled: xf.d.<init>(long, long, boolean, float, int, android.text.TextPaint, android.text.TextPaint):void");
    }
    ...
    public final void a(Canvas canvas, int i10, int i11, float f10, float f11, TextPaint textPaint) {
        ...
        if (staticLayout == null) {
            if (i10 == 0) {
                charSequenceArr = this.f46935b;
            } else {
                charSequenceArr = this.f46936c;
            }
