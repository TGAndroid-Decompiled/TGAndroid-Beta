...
public class q {
    public final ArrayList f45166a = new ArrayList();
    public final a0.i f45167b = new a0.i();
    public final a0.i f45168c = new a0.i();
    ...
    public static void a(q qVar, TL_ephemeral.EphemeralMessage ephemeralMessage, TLRPC.TL_message tL_message, MessageObject messageObject) {
        a0.i iVar = qVar.f45168c;
        long dialogId = MessageObject.getDialogId(tL_message);
        qVar.f45166a.add(ephemeralMessage);
        a0.i iVar2 = qVar.f45167b;
