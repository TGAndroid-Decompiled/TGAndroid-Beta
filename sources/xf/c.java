...
public class c extends FrameLayout {
    public final TextView f46928a;
    public final TextView f46929b;
    public final TextView f46930c;
    public final TextView d;
    public boolean e;
    public boolean f46931f;
    public final Drawable h;
    public final int f46932n;
    public final f6 f46933r;
    ...
    public c(Context context, f6 f6Var) {
        ...
        this.f46932n = measureText;
        TextView textView = new TextView(context);
        this.f46928a = textView;
    ...
    public final void a() {
        int i10 = j6.f20012j5;
        f6 f6Var = this.f46933r;
        this.f46928a.setTextColor(j6.v0(i10, f6Var));
        this.f46929b.setTextColor(j6.v0(i10, f6Var));
        this.f46930c.setTextColor(j6.v0(i10, f6Var));
        int i11 = j6.fj;
    ...
    public final void b(long j10, long j11) {
        String format;
        boolean z4 = this.e;
        TextView textView = this.f46929b;
        if (!z4) {
            textView.setVisibility(8);
            this.f46930c.setVisibility(8);
            return;
        }
        if (this.f46931f) {
            j11 += 604800000;
    ...
    public final void c(boolean z4) {
        this.e = z4;
        TextView textView = this.f46928a;
        if (!z4) {
            this.f46930c.setVisibility(8);
            this.f46929b.setVisibility(8);
            textView.setLayoutParams(b6.d(-2, -2.0f, 8388627, 16.0f, 0.0f, 16.0f, 0.0f));
            textView.requestLayout();
            return;
        }
        textView.setLayoutParams(b6.d(-2, -2.0f, 8388627, 16.0f, 0.0f, this.f46932n, 0.0f));
    }
    ...
    public final void d(long j10, boolean z4) {
        ...
        textView.setVisibility(0);
        TextView textView2 = this.f46928a;
        if (z4) {
