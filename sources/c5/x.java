...
public final class x implements ServiceConnection {
    ...
    public final Long a(boolean z10) {
        if (z10) {
            ...
            if (mVar.f6835b) {
                long a2 = mVar.f6834a.a();
                if (mVar.f6835b) {
                    mVar.f6835b = false;
                    long j3 = (a2 - mVar.d) + mVar.f6836c;
                    mVar.f6836c = j3;
        ...
        if (mVar2.f6835b) {
            long a10 = mVar2.f6834a.a();
            if (mVar2.f6835b) {
                mVar2.f6835b = false;
                long j10 = (a10 - mVar2.d) + mVar2.f6836c;
                mVar2.f6836c = j10;
    ...
    public final void b(h hVar, int i10, String str, boolean z10) {
        try {
            ...
            int i11 = hVar.f3895a;
            s10.c();
            k3.r((k3) s10.f6896b, i11);
            String str2 = hVar.f3897c;
            s10.c();
            k3.o((k3) s10.f6896b, str2);
            s10.c();
            k3.q((k3) s10.f6896b, i10);
            if (str != null) {
                s10.c();
                k3.n((k3) s10.f6896b, str);
            }
            Long a2 = a(z10);
            c cVar = this.d;
            if (z10) {
                ...
                if (a2 != null) {
                    ...
                    r10.c();
                    d4.p((d4) r10.f6896b, longValue);
                }
                f3 u10 = g3.u();
                u10.d(s10);
                u10.c();
                g3.t((g3) u10.f6896b, 6);
                u10.e(r10);
                cVar.h((g3) u10.a());
                return;
            }
            z3 p5 = a4.p();
            p5.c();
            a4.n((a4) p5.f6896b, (k3) s10.a());
            if (a2 != null) {
                long longValue2 = a2.longValue();
                p5.c();
                a4.o((a4) p5.f6896b, longValue2);
            }
            cVar.h.g0((a4) p5.a());
        } catch (Throwable th2) {
    ...
    public final void onBindingDied(ComponentName componentName) {
        ...
        synchronized (cVar2.f3847a) {
            if (cVar2.f3848b != 3 && cVar2.f3848b != 0) {
                cVar2.k(0);
                cVar2.m();
                try {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (cVar.f3847a) {
            try {
                ...
                int i10 = com.google.android.gms.internal.play_billing.b.f6746b;
                if (iBinder == null) {
                    aVar = 0;
                } else {
