...
public class c extends b {
    ...
    public volatile g f3852f;
    public final Context f3853g;
    public final of.b h;
    public volatile com.google.android.gms.internal.play_billing.c f3854i;
    public volatile y f3855j;
    ...
    public final qb.b f3868x;
    public final boolean f3869y;
    public ExecutorService f3870z;
    public final Object f3849a = new Object();
    public volatile int f3850b = 0;
    ...
    public c(qb.b bVar, Context context, q qVar, androidx.emoji2.text.f fVar) {
        ...
        this.B = com.google.android.gms.internal.play_billing.i.f6804a;
        this.f3851c = "8.0.0";
        String w10 = w();
        this.d = w10;
        this.f3853g = context.getApplicationContext();
        o3 x10 = p3.x();
        x10.c();
        p3.v((p3) x10.f6898b);
        if (w10 != null) {
            x10.c();
            p3.w((p3) x10.f6898b, w10);
        }
        String packageName = this.f3853g.getPackageName();
        x10.c();
        p3.t((p3) x10.f6898b, packageName);
        x10.c();
        p3.q((p3) x10.f6898b, nextLong);
        x10.c();
        p3.u((p3) x10.f6898b);
        int i10 = Build.VERSION.SDK_INT;
        x10.c();
        p3.n((p3) x10.f6898b, i10);
        x10.d();
        try {
            int i11 = this.f3853g.getPackageManager().getPackageInfo(this.f3853g.getPackageName(), 0).versionCode;
            x10.c();
            p3.o((p3) x10.f6898b, i11);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Error getting app version code.", th2);
        }
        this.h = new of.b(this.f3853g, (p3) x10.a());
        if (qVar == null) {
        ...
        this.f3852f = new g(this.f3853g, qVar, this.h);
        this.f3868x = bVar;
        this.f3869y = false;
        this.f3853g.getPackageName();
    }
        ...
        if (i10 == 0) {
            synchronized (cVar.f3849a) {
                try {
                    ...
                    if (gVar != null) {
                        boolean z10 = cVar.f3866u;
                        h0 h0Var = (h0) gVar.e;
                        IntentFilter intentFilter = new IntentFilter("com.android.vending.billing.PURCHASES_UPDATED");
                        IntentFilter intentFilter2 = new IntentFilter("com.android.vending.billing.LOCAL_BROADCAST_PURCHASES_UPDATED");
                        intentFilter2.addAction("com.android.vending.billing.ALTERNATIVE_BILLING");
                        gVar.f3878a = z10;
                        Context context = (Context) gVar.f3879b;
                        ((h0) gVar.f3881f).a(context, intentFilter2);
                        if (gVar.f3878a) {
    ...
    public final void B(int i10, h hVar, long j3, boolean z10) {
        try {
            int i11 = e0.f3874a;
            this.h.e0(e0.b(i10, 2, hVar, null, m3.BROADCAST_ACTION_UNSPECIFIED), this.f3857l, j3, z10);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public final void C(int i10, h hVar, String str, long j3, boolean z10) {
        try {
            int i11 = e0.f3874a;
            this.h.e0(e0.b(i10, 2, hVar, str, m3.BROADCAST_ACTION_UNSPECIFIED), this.f3857l, j3, z10);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public void c(a4.m mVar, org.telegram.messenger.c0 c0Var) {
        if (f(new u(this, c0Var, mVar, 1), 30000L, new i9.s(5, this, c0Var), r(), e()) == null) {
            h u10 = u();
            y(25, 7, u10);
            com.google.android.gms.internal.play_billing.p pVar = com.google.android.gms.internal.play_billing.r.f6875b;
    ...
    public final synchronized ExecutorService e() {
        try {
            if (this.f3870z == null) {
                this.f3870z = Executors.newFixedThreadPool(com.google.android.gms.internal.play_billing.u.f6895a, new w(this));
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public final void h(g3 g3Var) {
        try {
            ...
            int i10 = this.f3857l;
            bVar.getClass();
            o3 o3Var = (o3) ((p3) bVar.f15682b).g();
            o3Var.c();
            p3.p((p3) o3Var.f6898b, i10);
            bVar.f15682b = (p3) o3Var.a();
            bVar.a0(g3Var);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
        ...
        synchronized (this.f3849a) {
            try {
                if (o()) {
                    ...
                    this.f3855j = new y(this, dVar);
                    com.google.android.gms.internal.play_billing.m mVar = this.f3855j.f3941b;
                    mVar.f6838c = 0L;
                    mVar.f6837b = false;
                    mVar.a();
                    Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
                    intent.setPackage("com.android.vending");
                    List<ResolveInfo> queryIntentServices = this.f3853g.getPackageManager().queryIntentServices(intent, 0);
                    if (queryIntentServices != null && !queryIntentServices.isEmpty()) {
                        ...
                        if (serviceInfo != null) {
                            ...
                            if (Objects.equals(str, "com.android.vending") && str2 != null) {
                                ...
                                intent2.putExtra("playBillingLibraryVersion", this.f3851c);
                                synchronized (this.f3849a) {
                                    try {
                                        if (this.f3850b == 2) {
                                            hVar = t();
                                            ...
                                            y yVar = this.f3855j;
                                            if (this.f3853g.bindService(intent2, yVar, 1)) {
    ...
    public final void m() {
        synchronized (this.f3849a) {
            if (this.f3855j != null) {
                this.f3853g.unbindService(this.f3855j);
                this.f3854i = null;
                this.f3855j = null;
            }
        }
    ...
    public final boolean o() {
        ...
        synchronized (this.f3849a) {
            try {
                z10 = false;
                if (this.f3850b == 2 && this.f3854i != null && this.f3855j != null) {
                    z10 = true;
                }
            } finally {
            }
    ...
    public final void z(int i10, h hVar, long j3) {
        try {
            int i11 = e0.f3874a;
            this.h.b0(e0.b(i10, 2, hVar, null, m3.BROADCAST_ACTION_UNSPECIFIED), this.f3857l, j3);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public c(qb.b bVar, Context context, androidx.emoji2.text.f fVar) {
        ...
        this.h = new of.b(this.f3853g, (p3) x10.a());
        com.google.android.gms.internal.play_billing.u.h("BillingClient", "Billing client should have a valid listener but the provided is null.");
        this.f3852f = new g(this.f3853g, null, this.h);
        this.f3868x = bVar;
        this.f3853g.getPackageName();
    }
}
