...
public class c extends b {
    ...
    public volatile g f4265f;
    public final Context f4266g;
    public final n4.y h;
    public volatile com.google.android.gms.internal.play_billing.c f4267i;
    public volatile y f4268j;
    ...
    public final ob.a f4281x;
    public final boolean f4282y;
    public ExecutorService f4283z;
    public final Object f4262a = new Object();
    public volatile int f4263b = 0;
    ...
    public c(ob.a aVar, Context context, q qVar, androidx.emoji2.text.f fVar) {
        ...
        this.B = com.google.android.gms.internal.play_billing.i.f5577a;
        this.f4264c = "8.0.0";
        String w10 = w();
        this.d = w10;
        this.f4266g = context.getApplicationContext();
        o3 x10 = p3.x();
        x10.c();
        p3.v((p3) x10.f5671b);
        if (w10 != null) {
            x10.c();
            p3.w((p3) x10.f5671b, w10);
        }
        String packageName = this.f4266g.getPackageName();
        x10.c();
        p3.t((p3) x10.f5671b, packageName);
        x10.c();
        p3.q((p3) x10.f5671b, nextLong);
        x10.c();
        p3.u((p3) x10.f5671b);
        int i10 = Build.VERSION.SDK_INT;
        x10.c();
        p3.n((p3) x10.f5671b, i10);
        x10.d();
        try {
            int i11 = this.f4266g.getPackageManager().getPackageInfo(this.f4266g.getPackageName(), 0).versionCode;
            x10.c();
            p3.o((p3) x10.f5671b, i11);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Error getting app version code.", th2);
        }
        this.h = new n4.y(this.f4266g, (p3) x10.a());
        if (qVar == null) {
        ...
        this.f4265f = new g(this.f4266g, qVar, this.h);
        this.f4281x = aVar;
        this.f4282y = false;
        this.f4266g.getPackageName();
    }
        ...
        if (i10 == 0) {
            synchronized (cVar.f4262a) {
                try {
                    ...
                    if (gVar != null) {
                        boolean z10 = cVar.f4279u;
                        h0 h0Var = (h0) gVar.e;
                        IntentFilter intentFilter = new IntentFilter("com.android.vending.billing.PURCHASES_UPDATED");
                        IntentFilter intentFilter2 = new IntentFilter("com.android.vending.billing.LOCAL_BROADCAST_PURCHASES_UPDATED");
                        intentFilter2.addAction("com.android.vending.billing.ALTERNATIVE_BILLING");
                        gVar.f4291a = z10;
                        Context context = (Context) gVar.f4292b;
                        ((h0) gVar.f4294f).a(context, intentFilter2);
                        if (gVar.f4291a) {
    ...
    public final void B(int i10, h hVar, long j3, boolean z10) {
        try {
            int i11 = e0.f4287a;
            this.h.I(e0.b(i10, 2, hVar, null, m3.BROADCAST_ACTION_UNSPECIFIED), this.f4270l, j3, z10);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public final void C(int i10, h hVar, String str, long j3, boolean z10) {
        try {
            int i11 = e0.f4287a;
            this.h.I(e0.b(i10, 2, hVar, str, m3.BROADCAST_ACTION_UNSPECIFIED), this.f4270l, j3, z10);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public final synchronized ExecutorService e() {
        try {
            if (this.f4283z == null) {
                this.f4283z = Executors.newFixedThreadPool(com.google.android.gms.internal.play_billing.u.f5668a, new w(this));
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public final void h(g3 g3Var) {
        try {
            ...
            int i10 = this.f4270l;
            yVar.getClass();
            o3 o3Var = (o3) ((p3) yVar.f13824b).g();
            o3Var.c();
            p3.p((p3) o3Var.f5671b, i10);
            yVar.f13824b = (p3) o3Var.a();
            yVar.B(g3Var);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
        ...
        synchronized (this.f4262a) {
            try {
                if (o()) {
                    ...
                    this.f4268j = new y(this, dVar);
                    com.google.android.gms.internal.play_billing.m mVar = this.f4268j.f4354b;
                    mVar.f5611c = 0L;
                    mVar.f5610b = false;
                    mVar.a();
                    Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
                    intent.setPackage("com.android.vending");
                    List<ResolveInfo> queryIntentServices = this.f4266g.getPackageManager().queryIntentServices(intent, 0);
                    if (queryIntentServices != null && !queryIntentServices.isEmpty()) {
                        ...
                        if (serviceInfo != null) {
                            ...
                            if (Objects.equals(str, "com.android.vending") && str2 != null) {
                                ...
                                intent2.putExtra("playBillingLibraryVersion", this.f4264c);
                                synchronized (this.f4262a) {
                                    try {
                                        if (this.f4263b == 2) {
                                            hVar = t();
                                            ...
                                            y yVar = this.f4268j;
                                            if (this.f4266g.bindService(intent2, yVar, 1)) {
    ...
    public final void m() {
        synchronized (this.f4262a) {
            if (this.f4268j != null) {
                this.f4266g.unbindService(this.f4268j);
                this.f4267i = null;
                this.f4268j = null;
            }
        }
    ...
    public final boolean o() {
        ...
        synchronized (this.f4262a) {
            try {
                z10 = false;
                if (this.f4263b == 2 && this.f4267i != null && this.f4268j != null) {
                    z10 = true;
                }
            } finally {
            }
    ...
    public final j6.l s(h hVar, int i10, String str, Exception exc) {
        ...
        return new j6.l(hVar.f4308a, hVar.f4310c, new ArrayList(), new ArrayList());
    }
    ...
    public final void z(int i10, h hVar, long j3) {
        try {
            int i11 = e0.f4287a;
            this.h.C(e0.b(i10, 2, hVar, null, m3.BROADCAST_ACTION_UNSPECIFIED), this.f4270l, j3);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public c(ob.a aVar, Context context, androidx.emoji2.text.f fVar) {
        ...
        this.h = new n4.y(this.f4266g, (p3) x10.a());
        com.google.android.gms.internal.play_billing.u.h("BillingClient", "Billing client should have a valid listener but the provided is null.");
        this.f4265f = new g(this.f4266g, null, this.h);
        this.f4281x = aVar;
        this.f4266g.getPackageName();
    }
}
