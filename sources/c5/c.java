...
public class c extends b {
    ...
    public volatile g f3851f;
    public final Context f3852g;
    public final of.b h;
    public volatile com.google.android.gms.internal.play_billing.c f3853i;
    public volatile y f3854j;
    ...
    public final qb.b f3867x;
    public final boolean f3868y;
    public ExecutorService f3869z;
    public final Object f3848a = new Object();
    public volatile int f3849b = 0;
    ...
    public c(qb.b bVar, Context context, q qVar, androidx.emoji2.text.f fVar) {
        ...
        this.B = com.google.android.gms.internal.play_billing.i.f6803a;
        this.f3850c = "8.0.0";
        String w10 = w();
        this.d = w10;
        this.f3852g = context.getApplicationContext();
        o3 x10 = p3.x();
        x10.c();
        p3.v((p3) x10.f6897b);
        if (w10 != null) {
            x10.c();
            p3.w((p3) x10.f6897b, w10);
        }
        String packageName = this.f3852g.getPackageName();
        x10.c();
        p3.t((p3) x10.f6897b, packageName);
        x10.c();
        p3.q((p3) x10.f6897b, nextLong);
        x10.c();
        p3.u((p3) x10.f6897b);
        int i10 = Build.VERSION.SDK_INT;
        x10.c();
        p3.n((p3) x10.f6897b, i10);
        x10.d();
        try {
            int i11 = this.f3852g.getPackageManager().getPackageInfo(this.f3852g.getPackageName(), 0).versionCode;
            x10.c();
            p3.o((p3) x10.f6897b, i11);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Error getting app version code.", th2);
        }
        this.h = new of.b(this.f3852g, (p3) x10.a());
        if (qVar == null) {
        ...
        this.f3851f = new g(this.f3852g, qVar, this.h);
        this.f3867x = bVar;
        this.f3868y = false;
        this.f3852g.getPackageName();
    }
        ...
        if (i10 == 0) {
            synchronized (cVar.f3848a) {
                try {
                    ...
                    if (gVar != null) {
                        boolean z10 = cVar.f3865u;
                        h0 h0Var = (h0) gVar.e;
                        IntentFilter intentFilter = new IntentFilter("com.android.vending.billing.PURCHASES_UPDATED");
                        IntentFilter intentFilter2 = new IntentFilter("com.android.vending.billing.LOCAL_BROADCAST_PURCHASES_UPDATED");
                        intentFilter2.addAction("com.android.vending.billing.ALTERNATIVE_BILLING");
                        gVar.f3877a = z10;
                        Context context = (Context) gVar.f3878b;
                        ((h0) gVar.f3880f).a(context, intentFilter2);
                        if (gVar.f3877a) {
    ...
    public final void B(int i10, h hVar, long j3, boolean z10) {
        try {
            int i11 = e0.f3873a;
            this.h.a0(e0.b(i10, 2, hVar, null, m3.BROADCAST_ACTION_UNSPECIFIED), this.f3856l, j3, z10);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public final void C(int i10, h hVar, String str, long j3, boolean z10) {
        try {
            int i11 = e0.f3873a;
            this.h.a0(e0.b(i10, 2, hVar, str, m3.BROADCAST_ACTION_UNSPECIFIED), this.f3856l, j3, z10);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public final synchronized ExecutorService e() {
        try {
            if (this.f3869z == null) {
                this.f3869z = Executors.newFixedThreadPool(com.google.android.gms.internal.play_billing.u.f6894a, new w(this));
            }
        } catch (Throwable th2) {
            throw th2;
        }
        ...
        synchronized (this.f3848a) {
            try {
                if (o()) {
                    ...
                    this.f3854j = new y(this, dVar);
                    com.google.android.gms.internal.play_billing.m mVar = this.f3854j.f3940b;
                    mVar.f6837c = 0L;
                    mVar.f6836b = false;
                    mVar.a();
                    Intent intent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
                    intent.setPackage("com.android.vending");
                    List<ResolveInfo> queryIntentServices = this.f3852g.getPackageManager().queryIntentServices(intent, 0);
                    if (queryIntentServices != null && !queryIntentServices.isEmpty()) {
                        ...
                        if (serviceInfo != null) {
                            ...
                            if (Objects.equals(str, "com.android.vending") && str2 != null) {
                                ...
                                intent2.putExtra("playBillingLibraryVersion", this.f3850c);
                                synchronized (this.f3848a) {
                                    try {
                                        if (this.f3849b == 2) {
                                            hVar = t();
                                            ...
                                            y yVar = this.f3854j;
                                            if (this.f3852g.bindService(intent2, yVar, 1)) {
    ...
    public final void m() {
        synchronized (this.f3848a) {
            if (this.f3854j != null) {
                this.f3852g.unbindService(this.f3854j);
                this.f3853i = null;
                this.f3854j = null;
            }
        }
    ...
    public final boolean o() {
        ...
        synchronized (this.f3848a) {
            try {
                z10 = false;
                if (this.f3849b == 2 && this.f3853i != null && this.f3854j != null) {
                    z10 = true;
                }
            } finally {
            }
    ...
    public final j6.l s(h hVar, int i10, String str, Exception exc) {
        ...
        return new j6.l(hVar.f3894a, hVar.f3896c, new ArrayList(), new ArrayList());
    }
    ...
    public final void z(int i10, h hVar, long j3) {
        try {
            int i11 = e0.f3873a;
            this.h.Y(e0.b(i10, 2, hVar, null, m3.BROADCAST_ACTION_UNSPECIFIED), this.f3856l, j3);
        } catch (Throwable th2) {
            com.google.android.gms.internal.play_billing.u.i("BillingClient", "Unable to log.", th2);
        }
    }
    ...
    public c(qb.b bVar, Context context, androidx.emoji2.text.f fVar) {
        ...
        this.h = new of.b(this.f3852g, (p3) x10.a());
        com.google.android.gms.internal.play_billing.u.h("BillingClient", "Billing client should have a valid listener but the provided is null.");
        this.f3851f = new g(this.f3852g, null, this.h);
        this.f3867x = bVar;
        this.f3852g.getPackageName();
    }
}
