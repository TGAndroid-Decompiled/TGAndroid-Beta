...
public final class u implements Callable {
    ...
    private final Object c() {
        ...
        c cVar2 = (c) this.f4435b;
        String str = (String) this.f4436c;
        ...
        try {
            ...
            return ((com.google.android.gms.internal.play_billing.a) cVar).Y0(cVar2.f4353g.getPackageName(), str, str2);
    ...
    public final Object call() {
        ...
        switch (this.f4434a) {
            case 0:
                c cVar2 = (c) this.f4435b;
                j jVar = (j) this.f4436c;
                i iVar = (i) this.d;
                if (!cVar2.n()) {
                    h hVar = g0.h;
                    cVar2.y(2, 4, hVar);
                    jVar.a(hVar, iVar.f4403a);
                    return null;
                }
                String str2 = "Error consuming purchase with token. Response code: ";
                String str3 = iVar.f4403a;
                try {
                        ...
                        try {
                            if (cVar == null) {
                                ...
                                try {
                                    ...
                                    e = e10;
                                    exc = e;
                                    cVar2.g(jVar, str2, g0.f4387f, 29, "Error consuming purchase!", exc);
                                    return null;
                                }
                            }
                            if (cVar2.f4359n) {
                                String packageName = cVar2.f4353g.getPackageName();
                                boolean z10 = cVar2.f4359n;
                                String str4 = cVar2.f4350c;
                                String str5 = cVar2.d;
                                ...
                                String packageName2 = cVar2.f4353g.getPackageName();
            ...
            case 3:
                return c();
            case 4:
                return Boolean.valueOf(((SharedPreferences) this.f4435b).getBoolean((String) this.f4436c, ((Boolean) this.d).booleanValue()));
            case 5:
                return Integer.valueOf(((SharedPreferences) this.f4435b).getInt((String) this.f4436c, ((Integer) this.d).intValue()));
            case 6:
                return Long.valueOf(((SharedPreferences) this.f4435b).getLong((String) this.f4436c, ((Long) this.d).longValue()));
            default:
                return ((SharedPreferences) this.f4435b).getString((String) this.f4436c, (String) this.d);
        }
    }
