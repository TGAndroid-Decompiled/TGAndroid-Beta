...
public final class k {
    ...
    public final t7.u f3909g;

    public k(JSONObject jSONObject) {
        this.f3905a = jSONObject.optString("formattedPrice");
        this.f3906b = jSONObject.optLong("priceAmountMicros");
        this.f3907c = jSONObject.optString("priceCurrencyCode");
        ...
        this.f3908f = jSONObject.optString("serializedDocid");
