...
public final class f extends v4.e {
    public static final Pattern f2087o = Pattern.compile("^([0-9][0-9]+):([0-9][0-9]):([0-9][0-9])(?:(\\.[0-9]+)|:([0-9][0-9])(?:\\.([0-9]+))?)?$");
    public static final Pattern f2088p = Pattern.compile("^([0-9]+(?:\\.[0-9]+)?)(h|m|s|ms|f|t)$");
    public static final Pattern f2089q = Pattern.compile("^(([0-9]*.)?[0-9]+)(px|em|%)$");
    public static final Pattern f2090r = Pattern.compile("^([-+]?\\d+\\.?\\d*?)%$");
    public static final Pattern f2091s = Pattern.compile("^(\\d+\\.?\\d*?)% (\\d+\\.?\\d*?)%$");
    public static final Pattern f2092t = Pattern.compile("^(\\d+\\.?\\d*?)px (\\d+\\.?\\d*?)px$");
    public static final Pattern f2093u = Pattern.compile("^(\\d+) (\\d+)$");
    public static final d v = new d(30.0f, 1, 1);
    public static final c f2094w = new c(15);
    public final XmlPullParserFactory f2095n;

    public f() {
        super("TtmlDecoder");
        try {
            XmlPullParserFactory newInstance = XmlPullParserFactory.newInstance();
            this.f2095n = newInstance;
    ...
    public static c n(XmlPullParser xmlPullParser, c cVar) {
        ...
        Matcher matcher = f2093u.matcher(attributeValue);
        if (!matcher.matches()) {
    ...
    public static void o(String str, i iVar) {
        ...
        if (matcher.matches()) {
            ...
            group2.getClass();
            iVar.f2120k = Float.parseFloat(group2);
            return;
        }
    ...
    public static e u(XmlPullParser xmlPullParser) {
        ...
        Matcher matcher = f2092t.matcher(t6);
        if (!matcher.matches()) {
    ...
    public final v4.f k(int i10, boolean z4, byte[] bArr) {
        try {
            XmlPullParser newPullParser = this.f2095n.newPullParser();
