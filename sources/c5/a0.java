...
public final class a0 implements r2.u {
    public final int f3843a;
    public int f3844b;
    public Object f3845c;

    public a0(char c10, int i10) {
        this.f3843a = i10;
    }
    ...
    public Object a() {
        Object[] objArr = (Object[]) this.f3845c;
        int i10 = this.f3844b;
        if (i10 <= 0) {
            return null;
        }
    ...
    public MediaCodecInfo b(int i10) {
        if (((MediaCodecInfo[]) this.f3845c) == null) {
            this.f3845c = new MediaCodecList(this.f3844b).getCodecInfos();
        }
        return ((MediaCodecInfo[]) this.f3845c)[i10];
    }

    public void c(long j3) {
        int i10 = this.f3844b;
        long[] jArr = (long[]) this.f3845c;
        if (i10 == jArr.length) {
            this.f3845c = Arrays.copyOf(jArr, i10 * 2);
        }
        int i11 = this.f3844b;
        this.f3844b = i11 + 1;
        ((long[]) this.f3845c)[i11] = j3;
    }
    ...
    public int c0() {
        ...
        return ((MediaCodecInfo[]) this.f3845c).length;
    }

    public void d(long[] jArr) {
        int length = this.f3844b + jArr.length;
        long[] jArr2 = (long[]) this.f3845c;
        if (length > jArr2.length) {
            this.f3845c = Arrays.copyOf(jArr2, Math.max(jArr2.length * 2, length));
        }
        System.arraycopy(jArr, 0, (long[]) this.f3845c, this.f3844b, jArr.length);
        this.f3844b = length;
    }
    ...
    public g.g e() {
        int i10;
        Message message;
        g.c cVar = (g.c) this.f3845c;
        g.g gVar = new g.g(cVar.f9228a, this.f3844b);
        View view = cVar.e;
    ...
    public long f(int i10) {
        if (i10 >= 0 && i10 < this.f3844b) {
            return ((long[]) this.f3845c)[i10];
        }
        StringBuilder k10 = k0.k(i10, "Invalid index ", ", size is ");
        k10.append(this.f3844b);
        throw new IndexOutOfBoundsException(k10.toString());
    }

    public synchronized List g() {
        return DesugarCollections.unmodifiableList(new ArrayList((ArrayList) this.f3845c));
    }

    public long h(c3.l lVar) {
        e2.v vVar = (e2.v) this.f3845c;
        int i10 = 0;
    ...
    public String j(h4 h4Var) {
        ...
        try {
            if (c0Var.E != null) {
                ...
                U0.writeString(str);
                int i11 = com.google.android.gms.internal.play_billing.d.f6758a;
                U0.writeStrongBinder(b0Var);
                eVar.f312b.transact(1, U0, null, 1);
                U0.recycle();
    ...
    public String toString() {
        switch (this.f3843a) {
            case 5:
                return new String((char[]) this.f3845c, 0, this.f3844b);
            default:
    ...
    public a0(Object obj, int i10, int i11) {
        this.f3843a = i11;
        this.f3845c = obj;
        this.f3844b = i10;
    }
    ...
    public a0(int i10, int i11) {
        ...
        switch (i11) {
            case 6:
                if (i10 > 0) {
                    this.f3845c = new Object[i10];
                    return;
                }
                throw new IllegalArgumentException("The max pool size must be > 0");
            default:
                this.f3845c = new long[i10];
                return;
        }
    }
    ...
    public a0(int i10, q0[] q0VarArr) {
        this.f3843a = 4;
        this.f3844b = i10;
        this.f3845c = q0VarArr;
    }

    public a0(Context context) {
        this.f3843a = 3;
        int e = g.g.e(context, 0);
        this.f3845c = new g.c(new ContextThemeWrapper(context, g.g.e(context, e)));
        this.f3844b = e;
    }

    public a0(boolean z10, boolean z11, boolean z12) {
        this.f3843a = 7;
        this.f3844b = (z10 || z11 || z12) ? 1 : 0;
    }
}
