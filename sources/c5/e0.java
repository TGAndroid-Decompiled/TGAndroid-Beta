...
public abstract class e0 {
    ...
    public static String a(Exception exc) {
        ...
        try {
            ...
            int i10 = com.google.android.gms.internal.play_billing.u.f5922a;
            if (str.length() > 40) {
    ...
    public static i3 c(int i10, m3 m3Var) {
        try {
            h3 s10 = i3.s();
            s10.c();
            i3.r((i3) s10.f5925b, i10);
            if (!m3Var.equals(m3.BROADCAST_ACTION_UNSPECIFIED)) {
                s10.c();
                i3.o((i3) s10.f5925b, m3Var);
            }
            return (i3) s10.a();
        } catch (Exception e7) {
