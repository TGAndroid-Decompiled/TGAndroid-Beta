    ...
    public final void accept(Object obj) {
        switch (this.f4448a) {
            case 0:
                ...
                ((org.telegram.messenger.c0) this.f4449b).a((h) obj, sVar);
                return;
            case 1:
                o0.g gVar = (o0.g) obj;
                if (gVar == null) {
                ...
                ((o0.a) this.f4449b).H(gVar);
                return;
            default:
                o0.g gVar2 = (o0.g) obj;
                synchronized (o0.h.f16788c) {
                    try {
                        a0.l lVar = o0.h.d;
                        ArrayList arrayList = (ArrayList) lVar.get((String) this.f4449b);
                        if (arrayList != null) {
                            lVar.remove((String) this.f4449b);
