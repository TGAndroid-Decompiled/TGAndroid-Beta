...
public final class i {
    ...
    public static void a(aa.a aVar, da.d dVar) {
        ...
        String str2 = dVar.f7571b;
        if (str2 != null) {
            aVar.s("X-CRASHLYTICS-DEVICE-MODEL", str2);
        }
        String str3 = dVar.f7572c;
        if (str3 != null) {
    ...
    public static HashMap b(da.d dVar) {
        ...
        hashMap.put("display_version", dVar.f7574g);
        hashMap.put("source", Integer.toString(dVar.f7575i));
        String str = dVar.f7573f;
