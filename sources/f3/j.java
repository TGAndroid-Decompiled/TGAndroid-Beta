...
public final class j extends SQLiteOpenHelper {
    public static final String f5987c = "INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + ")";
    public static final int d = 5;
    public static final List f5988e = Arrays.asList(new i(0), new i(1), new i(2), new i(3), new i(4));
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        a(sQLiteDatabase, 0, this.f5989a);
    }
