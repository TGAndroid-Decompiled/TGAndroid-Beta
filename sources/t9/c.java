...
public final class c {
    public static final c f43048a = new Object();
    ...
    public static ArrayList a(Context context) {
        ...
        while (i11 < size2) {
            ...
            if (str2 != null) {
                obj3.f15255a = str2;
                obj3.f15256b = Integer.valueOf(runningAppProcessInfo.pid);
                obj3.f15257c = Integer.valueOf(runningAppProcessInfo.importance);
    ...
    public final t1 b(Context context) {
        ...
        if (t1Var == null) {
            ...
            ?? obj2 = new Object();
            obj2.f15255a = processName;
            obj2.f15256b = Integer.valueOf(myPid);
            obj2.f15257c = 0;
            obj2.d = false;
            return obj2.f();
        }
