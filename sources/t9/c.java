...
public final class c {
    public static final c f43003a = new Object();
    ...
    public static ArrayList a(Context context) {
        ...
        while (i11 < size2) {
            ...
            if (str2 != null) {
                obj3.f15232a = str2;
                obj3.f15233b = Integer.valueOf(runningAppProcessInfo.pid);
                obj3.f15234c = Integer.valueOf(runningAppProcessInfo.importance);
    ...
    public final t1 b(Context context) {
        ...
        if (t1Var == null) {
            ...
            ?? obj2 = new Object();
            obj2.f15232a = processName;
            obj2.f15233b = Integer.valueOf(myPid);
            obj2.f15234c = 0;
            obj2.d = false;
            return obj2.f();
        }
