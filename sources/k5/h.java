...
public final class h extends a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof a) {
            ...
            if (num != null ? num.equals(((h) aVar).f13457a) : ((h) aVar).f13457a == null) {
                String str = this.f13458b;
                if (str != null ? str.equals(((h) aVar).f13458b) : ((h) aVar).f13458b == null) {
                    String str2 = this.f13459c;
                    if (str2 != null ? str2.equals(((h) aVar).f13459c) : ((h) aVar).f13459c == null) {
                        String str3 = this.d;
                        if (str3 != null ? str3.equals(((h) aVar).d) : ((h) aVar).d == null) {
                            String str4 = this.e;
                            if (str4 != null ? str4.equals(((h) aVar).e) : ((h) aVar).e == null) {
                                String str5 = this.f13460f;
                                if (str5 != null ? str5.equals(((h) aVar).f13460f) : ((h) aVar).f13460f == null) {
                                    String str6 = this.f13461g;
                                    if (str6 != null ? str6.equals(((h) aVar).f13461g) : ((h) aVar).f13461g == null) {
                                        String str7 = this.h;
                                        if (str7 != null ? str7.equals(((h) aVar).h) : ((h) aVar).h == null) {
                                            String str8 = this.f13462i;
                                            if (str8 != null ? str8.equals(((h) aVar).f13462i) : ((h) aVar).f13462i == null) {
                                                String str9 = this.f13463j;
                                                if (str9 != null ? str9.equals(((h) aVar).f13463j) : ((h) aVar).f13463j == null) {
                                                    String str10 = this.f13464k;
                                                    if (str10 != null ? str10.equals(((h) aVar).f13464k) : ((h) aVar).f13464k == null) {
                                                        String str11 = this.f13465l;
                                                        if (str11 != null ? str11.equals(((h) aVar).f13465l) : ((h) aVar).f13465l == null) {
                                                            return true;
                                                        }
                                                    }
                                                }
    ...
    public final String toString() {
        ...
        return a4.a.t(sb2, this.f13465l, "}");
    }
}
