...
public final class h extends a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof a) {
            a aVar = (a) obj;
            Integer num = this.f13467a;
            if (num != null ? num.equals(((h) aVar).f13467a) : ((h) aVar).f13467a == null) {
                String str = this.f13468b;
                if (str != null ? str.equals(((h) aVar).f13468b) : ((h) aVar).f13468b == null) {
                    String str2 = this.f13469c;
                    if (str2 != null ? str2.equals(((h) aVar).f13469c) : ((h) aVar).f13469c == null) {
                        String str3 = this.d;
                        if (str3 != null ? str3.equals(((h) aVar).d) : ((h) aVar).d == null) {
                            String str4 = this.e;
                            if (str4 != null ? str4.equals(((h) aVar).e) : ((h) aVar).e == null) {
                                String str5 = this.f13470f;
                                if (str5 != null ? str5.equals(((h) aVar).f13470f) : ((h) aVar).f13470f == null) {
                                    String str6 = this.f13471g;
                                    if (str6 != null ? str6.equals(((h) aVar).f13471g) : ((h) aVar).f13471g == null) {
                                        String str7 = this.h;
                                        if (str7 != null ? str7.equals(((h) aVar).h) : ((h) aVar).h == null) {
                                            String str8 = this.f13472i;
                                            if (str8 != null ? str8.equals(((h) aVar).f13472i) : ((h) aVar).f13472i == null) {
                                                String str9 = this.f13473j;
                                                if (str9 != null ? str9.equals(((h) aVar).f13473j) : ((h) aVar).f13473j == null) {
                                                    String str10 = this.f13474k;
                                                    if (str10 != null ? str10.equals(((h) aVar).f13474k) : ((h) aVar).f13474k == null) {
                                                        String str11 = this.f13475l;
                                                        if (str11 != null ? str11.equals(((h) aVar).f13475l) : ((h) aVar).f13475l == null) {
                                                            return true;
                                                        }
                                                    }
                                                }
    ...
    public final String toString() {
        ...
        sb2.append(", country=");
        sb2.append(this.f13473j);
        sb2.append(", mccMnc=");
        sb2.append(this.f13474k);
        sb2.append(", applicationBuild=");
        return a4.a.s(sb2, this.f13475l, "}");
    }
}
