...
public final class h extends a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof a) {
            ...
            if (num != null ? num.equals(((h) aVar).f13470a) : ((h) aVar).f13470a == null) {
                String str = this.f13471b;
                if (str != null ? str.equals(((h) aVar).f13471b) : ((h) aVar).f13471b == null) {
                    String str2 = this.f13472c;
                    if (str2 != null ? str2.equals(((h) aVar).f13472c) : ((h) aVar).f13472c == null) {
                        String str3 = this.d;
                        if (str3 != null ? str3.equals(((h) aVar).d) : ((h) aVar).d == null) {
                            String str4 = this.e;
                            if (str4 != null ? str4.equals(((h) aVar).e) : ((h) aVar).e == null) {
                                String str5 = this.f13473f;
                                if (str5 != null ? str5.equals(((h) aVar).f13473f) : ((h) aVar).f13473f == null) {
                                    String str6 = this.f13474g;
                                    if (str6 != null ? str6.equals(((h) aVar).f13474g) : ((h) aVar).f13474g == null) {
                                        String str7 = this.h;
                                        if (str7 != null ? str7.equals(((h) aVar).h) : ((h) aVar).h == null) {
                                            String str8 = this.f13475i;
                                            if (str8 != null ? str8.equals(((h) aVar).f13475i) : ((h) aVar).f13475i == null) {
                                                String str9 = this.f13476j;
                                                if (str9 != null ? str9.equals(((h) aVar).f13476j) : ((h) aVar).f13476j == null) {
                                                    String str10 = this.f13477k;
                                                    if (str10 != null ? str10.equals(((h) aVar).f13477k) : ((h) aVar).f13477k == null) {
                                                        String str11 = this.f13478l;
                                                        if (str11 != null ? str11.equals(((h) aVar).f13478l) : ((h) aVar).f13478l == null) {
                                                            return true;
                                                        }
                                                    }
                                                }
    ...
    public final String toString() {
        ...
        return a4.a.s(sb2, this.f13478l, "}");
    }
}
