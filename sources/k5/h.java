...
public final class h extends a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof a) {
            a aVar = (a) obj;
            Integer num = this.f13469a;
            if (num != null ? num.equals(((h) aVar).f13469a) : ((h) aVar).f13469a == null) {
                String str = this.f13470b;
                if (str != null ? str.equals(((h) aVar).f13470b) : ((h) aVar).f13470b == null) {
                    String str2 = this.f13471c;
                    if (str2 != null ? str2.equals(((h) aVar).f13471c) : ((h) aVar).f13471c == null) {
                        String str3 = this.d;
                        if (str3 != null ? str3.equals(((h) aVar).d) : ((h) aVar).d == null) {
                            String str4 = this.e;
                            if (str4 != null ? str4.equals(((h) aVar).e) : ((h) aVar).e == null) {
                                String str5 = this.f13472f;
                                if (str5 != null ? str5.equals(((h) aVar).f13472f) : ((h) aVar).f13472f == null) {
                                    String str6 = this.f13473g;
                                    if (str6 != null ? str6.equals(((h) aVar).f13473g) : ((h) aVar).f13473g == null) {
                                        String str7 = this.h;
                                        if (str7 != null ? str7.equals(((h) aVar).h) : ((h) aVar).h == null) {
                                            String str8 = this.f13474i;
                                            if (str8 != null ? str8.equals(((h) aVar).f13474i) : ((h) aVar).f13474i == null) {
                                                String str9 = this.f13475j;
                                                if (str9 != null ? str9.equals(((h) aVar).f13475j) : ((h) aVar).f13475j == null) {
                                                    String str10 = this.f13476k;
                                                    if (str10 != null ? str10.equals(((h) aVar).f13476k) : ((h) aVar).f13476k == null) {
                                                        String str11 = this.f13477l;
                                                        if (str11 != null ? str11.equals(((h) aVar).f13477l) : ((h) aVar).f13477l == null) {
                                                            return true;
                                                        }
                                                    }
                                                }
