...
public abstract class j {
    ...
    public static boolean j(r3.l lVar, boolean z4, boolean z10) {
        ...
        while (i15 < i13) {
            wVar.C(8);
            if (!lVar.h(wVar.f7000a, i14, 8, true)) {
                break;
            }
            long v = wVar.v();
            int g10 = wVar.g();
            if (v == 1) {
                lVar.c(8, 8, wVar.f7000a);
                wVar.E(16);
                i10 = i15;
                v = wVar.o();
                i11 = 16;
