...
public final class l implements r3.k, s {
    ...
    public int v;
    public int h = 0;
    public final n f51063f = new n();
    public final ArrayList f51064g = new ArrayList();
    public final w d = new w(16);
    public final ArrayDeque f51062e = new ArrayDeque();
    public final w f51059a = new w(h5.a.d);
    public final w f51060b = new w(4);
    public final w f51061c = new w();
    public int f51069m = -1;
    public r3.m f51073q = r3.m.A;
    public k[] f51074r = new k[0];
    ...
    public final void d(long j10, long j11) {
        ...
        for (k kVar : this.f51074r) {
            r rVar = kVar.f51056b;
            int e6 = d0.e(rVar.f51116f, j11, false);
            while (true) {
                if (e6 >= 0) {
                    if ((rVar.f51117g[e6] & 1) != 0) {
                        break;
                    }
                    e6--;
                } else {
    ...
    public final int h(r3.l lVar, jb jbVar) {
        ...
        while (true) {
            int i12 = this.h;
            ArrayDeque arrayDeque = this.f51062e;
            w wVar2 = this.f51061c;
            int i13 = 4;
            if (i12 != 0) {
                int i14 = 2;
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 == 3) {
                            n nVar = this.f51063f;
                            ArrayList arrayList = nVar.f51081a;
                            int i15 = nVar.f51082b;
                            if (i15 != 0) {
                                if (i15 != 1) {
                                    short s6 = 2816;
                                    short s9 = 2192;
                                    if (i15 != 2) {
                                        if (i15 == 3) {
                                            ...
                                            int length = (int) ((lVar.getLength() - lVar.getPosition()) - nVar.f51083c);
                                            w wVar3 = new w(length);
                                            lVar.readFully(wVar3.f7308a, 0, length);
                                            int i16 = 0;
                                            while (i16 < arrayList.size()) {
                                                m mVar = (m) arrayList.get(i16);
                                                wVar3.F((int) (mVar.f51078a - position));
                                                wVar3.G(i13);
                                                int i17 = wVar3.i();
                                                Charset charset = r8.d.f46769c;
                                                ...
                                                if (c10 != 2192) {
                                                    ...
                                                    List A = n.f51080e.A(wVar3.s(i18, charset));
                                                    ...
                                                    this.f51064g.add(new k4.d(arrayList2));
                                                }
                                                i16++;
                                                i13 = 4;
                                            }
                                        ...
                                        while (i21 < i20 / 12) {
                                            ...
                                            wVar = wVar4;
                                            arrayList.add(new m((length2 - nVar.f51083c) - wVar.i(), wVar.i()));
                                            i21++;
                                            wVar4 = wVar;
                                            s9 = 2192;
                                            i14 = 2;
                                        ...
                                        if (arrayList.isEmpty()) {
                                            ...
                                            nVar.f51082b = 3;
                                            jbVar.f28078a = ((m) arrayList.get(0)).f51078a;
                                        }
                                    }
                                } else {
                                    w wVar5 = new w(8);
                                    lVar.readFully(wVar5.f7308a, 0, 8);
                                    nVar.f51083c = wVar5.i() + 8;
                                    if (wVar5.g() != 1397048916) {
                                        jbVar.f28078a = 0L;
                                    } else {
                                        jbVar.f28078a = lVar.getPosition() - (nVar.f51083c - 12);
                                        nVar.f51082b = 2;
                                    }
                                }
                                i10 = 1;
                    ...
                    if (this.f51069m == -1) {
                        ...
                        while (true) {
                            k[] kVarArr = this.f51074r;
                            if (i24 >= kVarArr.length) {
                                break;
                            }
                            k kVar = kVarArr[i24];
                            int i25 = kVar.f51058e;
                            r rVar = kVar.f51056b;
                            if (i25 != rVar.f51113b) {
                                long j14 = rVar.f51114c[i25];
                                long[][] jArr = this.f51075s;
                                int i26 = d0.f7237a;
                    ...
                    k kVar2 = this.f51074r[this.f51069m];
                    v vVar = kVar2.f51057c;
                    o oVar = kVar2.f51055a;
                    r rVar2 = kVar2.f51056b;
                    int i27 = kVar2.f51058e;
                    long j17 = rVar2.f51114c[i27];
                    int i28 = rVar2.d[i27];
                    r3.w wVar6 = kVar2.d;
                    long j18 = (j17 - position2) + this.f51070n;
                    if (j18 >= 0 && j18 < 262144) {
                        if (oVar.f51089g == 1) {
                            j18 += 8;
                            i28 -= 8;
                        ...
                        lVar.s((int) j18);
                        int i29 = oVar.f51091j;
                        if (i29 != 0) {
                            w wVar7 = this.f51060b;
                            byte[] bArr = wVar7.f7308a;
                            bArr[0] = 0;
                            bArr[1] = 0;
                            bArr[2] = 0;
                            int i30 = 4 - i29;
                            while (this.f51071o < i28) {
                                int i31 = this.f51072p;
                                if (i31 == 0) {
                            ...
                            if ("audio/ac4".equals(oVar.f51088f.C)) {
                                if (this.f51071o == 0) {
                                    l3.a.c(i28, wVar2);
                                    vVar.d(7, wVar2);
                                    this.f51071o += 7;
                        ...
                        int i33 = i28;
                        long j19 = rVar2.f51116f[i27];
                        int i34 = rVar2.f51117g[i27];
                        if (wVar6 != null) {
                            wVar6.b(vVar, j19, i34, i33, 0, null);
                            if (i27 + 1 == rVar2.f51113b) {
                                wVar6.a(vVar, null);
                            }
                        } else {
                ...
                long j20 = this.f51066j - this.f51067k;
                long position3 = lVar.getPosition() + j20;
                w wVar9 = this.f51068l;
                if (wVar9 != null) {
                    lVar.readFully(wVar9.f7308a, this.f51067k, (int) j20);
                    if (this.f51065i == 1718909296) {
                        wVar9.F(8);
                        int g11 = wVar9.g();
                        if (g11 != 1751476579) {
                            if (g11 != 1903435808) {
                        ...
                        ((a) arrayDeque.peek()).d.add(new b(this.f51065i, wVar9));
                    }
                } else if (j20 < 262144) {
                    lVar.s((int) j20);
                } else {
                    jbVar.f28078a = lVar.getPosition() + j20;
                    z10 = true;
                    j(position3);
                    if (z10 && this.h != 2) {
                        return 1;
                ...
                if (i35 == 0) {
                    ...
                    this.f51067k = 8;
                    wVar10.F(0);
                    this.f51066j = wVar10.v();
                    this.f51065i = wVar10.g();
                }
                long j21 = this.f51066j;
                if (j21 == 1) {
                    lVar.readFully(wVar10.f7308a, 8, 8);
                    this.f51067k += 8;
                    this.f51066j = wVar10.y();
                } else if (j21 == 0) {
                    long length4 = lVar.getLength();
                    if (length4 == -1 && (aVar = (a) arrayDeque.peek()) != null) {
                        length4 = aVar.f51003c;
                    }
                    if (length4 != -1) {
                        this.f51066j = (length4 - lVar.getPosition()) + this.f51067k;
                    }
                }
                long j22 = this.f51066j;
                int i36 = this.f51067k;
                if (j22 >= i36) {
                    int i37 = this.f51065i;
                    if (i37 != 1836019574 && i37 != 1953653099 && i37 != 1835297121 && i37 != 1835626086 && i37 != 1937007212 && i37 != 1701082227 && i37 != 1835365473) {
                        if (i37 != 1835296868 && i37 != 1836476516 && i37 != 1751411826 && i37 != 1937011556 && i37 != 1937011827 && i37 != 1937011571 && i37 != 1668576371 && i37 != 1701606260 && i37 != 1937011555 && i37 != 1937011578 && i37 != 1937013298 && i37 != 1937007471 && i37 != 1668232756 && i37 != 1953196132 && i37 != 1718909296 && i37 != 1969517665 && i37 != 1801812339 && i37 != 1768715124) {
                            ...
                            long j23 = this.f51067k;
                            long j24 = position4 - j23;
                            if (this.f51065i == 1836086884) {
                                new k4.b(0L, j24, -9223372036854775807L, j24 + j23, this.f51066j - j23);
                            }
                            this.f51068l = null;
                            this.h = 1;
                        } else {
                            ...
                            h5.a.i(z11);
                            if (this.f51066j <= 2147483647L) {
                                z12 = true;
                            } else {
                                z12 = false;
                            }
                            h5.a.i(z12);
                            w wVar11 = new w((int) this.f51066j);
                        ...
                        long j25 = this.f51066j;
                        long j26 = this.f51067k;
                        long j27 = (position5 + j25) - j26;
                        if (j25 != j26 && this.f51065i == 1835365473) {
                            wVar2.C(8);
                            lVar.b(0, 8, wVar2.f7308a);
                            byte[] bArr2 = e.f51013a;
                        ...
                        arrayDeque.push(new a(this.f51065i, j27));
                        if (this.f51066j == this.f51067k) {
                            j(j27);
                        } else {
                            this.h = 0;
                            this.f51067k = 0;
