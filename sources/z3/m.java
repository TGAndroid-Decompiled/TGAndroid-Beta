...
public final class m implements r3.k, r3.s {
    ...
    public int v;
    public int h = 0;
    public final o f51028f = new o();
    public final ArrayList f51029g = new ArrayList();
    public final w d = new w(16);
    public final ArrayDeque f51027e = new ArrayDeque();
    public final w f51024a = new w(h5.a.d);
    public final w f51025b = new w(4);
    public final w f51026c = new w();
    public int f51034m = -1;
    public r3.m f51038q = r3.m.A;
    public l[] f51039r = new l[0];
    ...
    public final void d(long j10, long j11) {
        ...
        for (l lVar : this.f51039r) {
            s sVar = lVar.f51021b;
            int e6 = d0.e(sVar.f51081f, j11, false);
            while (true) {
                if (e6 >= 0) {
                    if ((sVar.f51082g[e6] & 1) != 0) {
                        break;
                    }
                    e6--;
                } else {
    ...
    public final int h(r3.l lVar, jb jbVar) {
        ...
        while (true) {
            int i12 = this.h;
            ArrayDeque arrayDeque = this.f51027e;
            w wVar2 = this.f51026c;
            int i13 = 4;
            if (i12 != 0) {
                int i14 = 2;
                if (i12 != 1) {
                    if (i12 != 2) {
                        if (i12 == 3) {
                            o oVar = this.f51028f;
                            ArrayList arrayList = oVar.f51046a;
                            int i15 = oVar.f51047b;
                            if (i15 != 0) {
                                if (i15 != 1) {
                                    short s6 = 2816;
                                    short s9 = 2192;
                                    if (i15 != 2) {
                                        if (i15 == 3) {
                                            ...
                                            int length = (int) ((lVar.getLength() - lVar.getPosition()) - oVar.f51048c);
                                            w wVar3 = new w(length);
                                            lVar.readFully(wVar3.f7308a, 0, length);
                                            int i16 = 0;
                                            while (i16 < arrayList.size()) {
                                                n nVar = (n) arrayList.get(i16);
                                                wVar3.F((int) (nVar.f51043a - position));
                                                wVar3.G(i13);
                                                int i17 = wVar3.i();
                                                ...
                                                if (c10 != 2192) {
                                                    ...
                                                    List A = o.f51045e.A(wVar3.s(i18, charset));
                                                    ...
                                                    this.f51029g.add(new k4.d(arrayList2));
                                                }
                                                i16++;
                                                i13 = 4;
                                            }
                                        ...
                                        while (i21 < i20 / 12) {
                                            ...
                                            wVar = wVar4;
                                            arrayList.add(new n((length2 - oVar.f51048c) - wVar.i(), wVar.i()));
                                            i21++;
                                            wVar4 = wVar;
                                            s9 = 2192;
                                            i14 = 2;
                                        ...
                                        if (arrayList.isEmpty()) {
                                            ...
                                            oVar.f51047b = 3;
                                            jbVar.f28091a = ((n) arrayList.get(0)).f51043a;
                                        }
                                    }
                                } else {
                                    w wVar5 = new w(8);
                                    lVar.readFully(wVar5.f7308a, 0, 8);
                                    oVar.f51048c = wVar5.i() + 8;
                                    if (wVar5.g() != 1397048916) {
                                        jbVar.f28091a = 0L;
                                    } else {
                                        jbVar.f28091a = lVar.getPosition() - (oVar.f51048c - 12);
                                        oVar.f51047b = 2;
                                    }
                                }
                                i10 = 1;
                    ...
                    if (this.f51034m == -1) {
                        ...
                        while (true) {
                            l[] lVarArr = this.f51039r;
                            if (i24 >= lVarArr.length) {
                                break;
                            }
                            l lVar2 = lVarArr[i24];
                            int i25 = lVar2.f51023e;
                            s sVar = lVar2.f51021b;
                            if (i25 != sVar.f51078b) {
                                long j14 = sVar.f51079c[i25];
                                long[][] jArr = this.f51040s;
                                int i26 = d0.f7237a;
                    ...
                    l lVar3 = this.f51039r[this.f51034m];
                    v vVar = lVar3.f51022c;
                    p pVar = lVar3.f51020a;
                    s sVar2 = lVar3.f51021b;
                    int i27 = lVar3.f51023e;
                    long j17 = sVar2.f51079c[i27];
                    int i28 = sVar2.d[i27];
                    r3.w wVar6 = lVar3.d;
                    long j18 = (j17 - position2) + this.f51035n;
                    if (j18 >= 0 && j18 < 262144) {
                        if (pVar.f51054g == 1) {
                            j18 += 8;
                            i28 -= 8;
                        ...
                        lVar.s((int) j18);
                        int i29 = pVar.f51056j;
                        if (i29 != 0) {
                            w wVar7 = this.f51025b;
                            byte[] bArr = wVar7.f7308a;
                            bArr[0] = 0;
                            bArr[1] = 0;
                            bArr[2] = 0;
                            int i30 = 4 - i29;
                            while (this.f51036o < i28) {
                                int i31 = this.f51037p;
                                if (i31 == 0) {
                            ...
                            if ("audio/ac4".equals(pVar.f51053f.C)) {
                                if (this.f51036o == 0) {
                                    l3.a.c(i28, wVar2);
                                    vVar.d(7, wVar2);
                                    this.f51036o += 7;
                        ...
                        int i33 = i28;
                        long j19 = sVar2.f51081f[i27];
                        int i34 = sVar2.f51082g[i27];
                        if (wVar6 != null) {
                            wVar6.b(vVar, j19, i34, i33, 0, null);
                            if (i27 + 1 == sVar2.f51078b) {
                                wVar6.a(vVar, null);
                            }
                        } else {
                ...
                long j20 = this.f51031j - this.f51032k;
                long position3 = lVar.getPosition() + j20;
                w wVar9 = this.f51033l;
                if (wVar9 != null) {
                    lVar.readFully(wVar9.f7308a, this.f51032k, (int) j20);
                    if (this.f51030i == 1718909296) {
                        wVar9.F(8);
                        int g11 = wVar9.g();
                        if (g11 != 1751476579) {
                            if (g11 != 1903435808) {
                        ...
                        ((a) arrayDeque.peek()).d.add(new b(this.f51030i, wVar9));
                    }
                } else if (j20 < 262144) {
                    lVar.s((int) j20);
                } else {
                ...
                if (i35 == 0) {
                    ...
                    this.f51032k = 8;
                    wVar10.F(0);
                    this.f51031j = wVar10.v();
                    this.f51030i = wVar10.g();
                }
                long j21 = this.f51031j;
                if (j21 == 1) {
                    lVar.readFully(wVar10.f7308a, 8, 8);
                    this.f51032k += 8;
                    this.f51031j = wVar10.y();
                } else if (j21 == 0) {
                    long length4 = lVar.getLength();
                    if (length4 == -1 && (aVar = (a) arrayDeque.peek()) != null) {
                        length4 = aVar.f50967c;
                    }
                    if (length4 != -1) {
                        this.f51031j = (length4 - lVar.getPosition()) + this.f51032k;
                    }
                }
                long j22 = this.f51031j;
                int i36 = this.f51032k;
                if (j22 >= i36) {
                    int i37 = this.f51030i;
                    if (i37 != 1836019574 && i37 != 1953653099 && i37 != 1835297121 && i37 != 1835626086 && i37 != 1937007212 && i37 != 1701082227 && i37 != 1835365473) {
                        if (i37 != 1835296868 && i37 != 1836476516 && i37 != 1751411826 && i37 != 1937011556 && i37 != 1937011827 && i37 != 1937011571 && i37 != 1668576371 && i37 != 1701606260 && i37 != 1937011555 && i37 != 1937011578 && i37 != 1937013298 && i37 != 1937007471 && i37 != 1668232756 && i37 != 1953196132 && i37 != 1718909296 && i37 != 1969517665 && i37 != 1801812339 && i37 != 1768715124) {
                            ...
                            long j23 = this.f51032k;
                            long j24 = position4 - j23;
                            if (this.f51030i == 1836086884) {
                                new k4.b(0L, j24, -9223372036854775807L, j24 + j23, this.f51031j - j23);
                            }
                            this.f51033l = null;
                            this.h = 1;
                        } else {
                            ...
                            h5.a.i(z11);
                            if (this.f51031j <= 2147483647L) {
                                z12 = true;
                            } else {
                                z12 = false;
                            }
                            h5.a.i(z12);
                            w wVar11 = new w((int) this.f51031j);
                        ...
                        long j25 = this.f51031j;
                        long j26 = this.f51032k;
                        long j27 = (position5 + j25) - j26;
                        if (j25 != j26 && this.f51030i == 1835365473) {
                            wVar2.C(8);
                            lVar.b(0, 8, wVar2.f7308a);
                            byte[] bArr2 = e.f50977a;
                        ...
                        arrayDeque.push(new a(this.f51030i, j27));
                        if (this.f51031j == this.f51032k) {
                            j(j27);
                        } else {
                            this.h = 0;
                            this.f51032k = 0;
