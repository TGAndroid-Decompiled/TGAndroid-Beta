...
public final class n implements h0 {
    public final h0 f48048a;
    public final k f48049b;
    public m f48052g;
    public s h;
    public boolean f48053i;
    public int d = 0;
    public int e = 0;
    public byte[] f48051f = d0.f7872b;
    public final v f48050c = new v();
    ...
    public final void b(s sVar) {
        ...
        m mVar2 = this.f48052g;
        h0 h0Var = this.f48048a;
        if (mVar2 == null) {
            h0Var.b(sVar);
            return;
        }
    ...
    public final int e(b2.k kVar, int i10, boolean z10) {
        if (this.f48052g == null) {
            return this.f48048a.e(kVar, i10, z10);
        }
        g(i10);
        int read = kVar.read(this.f48051f, this.e, i10);
        if (read == -1) {
            if (z10) {
                return -1;
            }
    ...
    public final void f(v vVar, int i10, int i11) {
        if (this.f48052g == null) {
            this.f48048a.f(vVar, i10, i11);
            return;
        }
        g(i10);
        vVar.h(this.e, i10, this.f48051f);
        this.e += i10;
    }

    public final void g(int i10) {
        byte[] bArr;
        int length = this.f48051f.length;
        int i11 = this.e;
        if (length - i11 >= i10) {
            return;
        }
