...
public final class o implements h0 {
    ...
    public int d = 0;
    public int e = 0;
    public byte[] f48408f = d0.f7889b;
    public final v f48407c = new v();
    ...
    public final void b(s sVar) {
        ...
        m mVar2 = this.f48409g;
        h0 h0Var = this.f48405a;
        if (mVar2 == null) {
            h0Var.b(sVar);
            return;
        }
    ...
    public final void c(final long j3, final int i10, int i11, int i12, g0 g0Var) {
        ...
        if (this.f48409g == null) {
            this.f48405a.c(j3, i10, i11, i12, g0Var);
            return;
        }
        if (g0Var == null) {
            z10 = true;
        ...
        try {
            this.f48409g.M(this.f48408f, i13, i11, l.f48399c, new e2.h() {
                @Override
                public final void accept(Object obj) {
                    ...
                    o oVar = o.this;
                    e2.d.h(oVar.h);
                    byte[] C2 = ob.a.C2(aVar.f48380a, aVar.f48382c);
                    v vVar = oVar.f48407c;
                    vVar.getClass();
                    vVar.H(C2.length, C2);
                    oVar.f48405a.d(C2.length, vVar);
                    ...
                    oVar.f48405a.c(j11, i10 | 1, C2.length, 0, null);
                }
            });
    ...
    public final int e(b2.k kVar, int i10, boolean z10) {
        if (this.f48409g == null) {
            return this.f48405a.e(kVar, i10, z10);
        }
        g(i10);
        int read = kVar.read(this.f48408f, this.e, i10);
        if (read == -1) {
            if (z10) {
                return -1;
            }
    ...
    public final void f(v vVar, int i10, int i11) {
        if (this.f48409g == null) {
            this.f48405a.f(vVar, i10, i11);
            return;
        }
        g(i10);
        vVar.h(this.e, i10, this.f48408f);
        this.e += i10;
    }

    public final void g(int i10) {
        byte[] bArr;
        int length = this.f48408f.length;
        int i11 = this.e;
        if (length - i11 >= i10) {
            return;
        }
