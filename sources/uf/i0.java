...
public abstract class i0 extends c {
        ...
        if (i13 == 0) {
            ...
            if (i11 >= 0 && i11 < arrayList.size()) {
                ...
                if (!this.G) {
                    ...
                    if (!this.f48546n && !arrayList.isEmpty()) {
                        size--;
                    }
                    i12 = size;
                    if (i12 >= 0) {
            ...
            u4 u4Var = (u4) view;
            if (i10 == h() - 1 || (!this.f48546n && !arrayList.isEmpty() && i10 == arrayList.size())) {
                z4 = false;
            }
            u4Var.b(tL_messageMediaVenue, i12, z4, false);
        } else if (i13 == 1) {
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        if (i10 == 0) {
            u3Var = new u4(context, g6Var);
        } else {
            u3Var = new u3(context, g6Var);
        }
