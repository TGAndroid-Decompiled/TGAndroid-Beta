...
public final class j1 implements TextView.OnEditorActionListener {
    public final g1 f45326a;
    public final int f45327b;
    public final o1 f45328c;
    public final TextView d;
    public final gg.c1 e;
    public final Utilities.Callback f45329f;
    public final d2[] f45330g;
    public final View h;
    ...
    public j1(g1 g1Var, int i10, o1 o1Var, TextView textView, gg.c1 c1Var, Utilities.Callback callback, d2[] d2VarArr, View view) {
        ...
        this.d = textView;
        this.e = c1Var;
        this.f45329f = callback;
        this.f45330g = d2VarArr;
        this.h = view;
    }
    ...
    public final boolean onEditorAction(TextView textView, int i10, KeyEvent keyEvent) {
        ...
        g1 g1Var = this.f45326a;
        String obj = g1Var.getText().toString();
        if (obj.length() > 0 && obj.length() <= 32) {
            p1 f10 = p1.f(this.f45327b);
            o1 o1Var = this.f45328c;
            if (o1Var == null) {
                i11 = -1;
            } else {
                i11 = o1Var.f45407a;
            ...
            this.f45329f.run(obj);
            d2[] d2VarArr = this.f45330g;
            d2 d2Var = d2VarArr[0];
            if (d2Var != null) {
                d2Var.dismiss();
            }
