...
public final class r implements x, kl0 {
    ...
    public void a(a0.h hVar, ArrayList arrayList) {
        z zVar = this.f48713a;
        int i10 = zVar.f48805p0;
        zVar.f48806q0 = arrayList;
        zVar.f48812u0 = hVar;
        for (int i11 = 0; i11 < zVar.f48806q0.size(); i11++) {
            y yVar = (y) zVar.f48806q0.get(i11);
            TLObject tLObject = yVar.f48775a;
            if (tLObject instanceof TLRPC.User) {
                MessagesController.getInstance(i10).putUser((TLRPC.User) yVar.f48775a, true);
            } else if (tLObject instanceof TLRPC.Chat) {
                MessagesController.getInstance(i10).putChat((TLRPC.Chat) yVar.f48775a, true);
            } else if (tLObject instanceof TLRPC.EncryptedChat) {
                MessagesController.getInstance(i10).putEncryptedChat((TLRPC.EncryptedChat) yVar.f48775a, true);
            }
        }
        zVar.G(null);
        zVar.l();
    ...
    public boolean f(int i10, View view) {
        TLRPC.User user;
        ay ayVar = this.f48713a.R;
        if (ayVar != null) {
            Long l10 = (Long) view.getTag();
            long longValue = l10.longValue();
            py pyVar = ayVar.f35273a;
            if (pyVar.getParentActivity() != null && (user = pyVar.getMessagesController().getUser(l10)) != null) {
                ...
                if (textView != null) {
                    textView.setTextColor(pyVar.getThemedColor(k6.f21897q7));
                }
            }
        }
        return true;
