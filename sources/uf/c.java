...
public final class c extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int D;
    public mr f45257a;
    public org.telegram.ui.ActionBar.w0 f45258b;
    public g61 f45259c;
    public v d;
    public boolean e;
    public boolean f45260f;
    public int h;
    public TL_account.TL_businessAwayMessage f45261n;
    public int f45262r;
    ...
    public final void V(boolean z4) {
        ...
        boolean W = W();
        this.f45258b.setEnabled(W);
        float f14 = 0.0f;
        if (z4) {
            ViewPropertyAnimator animate = this.f45258b.animate();
            if (W) {
                f12 = 1.0f;
            } else {
                f12 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var = this.f45258b;
        if (W) {
            f10 = 1.0f;
        } else {
            f10 = 0.0f;
        ...
        w0Var.setAlpha(f10);
        org.telegram.ui.ActionBar.w0 w0Var2 = this.f45258b;
        if (W) {
            f11 = 1.0f;
        } else {
            f11 = 0.0f;
        ...
        org.telegram.ui.ActionBar.w0 w0Var3 = this.f45258b;
        if (W) {
            f14 = 1.0f;
        }
    ...
    public final boolean W() {
        ...
        v vVar;
        if (this.f45260f) {
            boolean z10 = this.f45263s;
            TL_account.TL_businessAwayMessage tL_businessAwayMessage = this.f45261n;
            ...
            if (z10 == z4) {
                if (z10 && tL_businessAwayMessage != null) {
                    if (tL_businessAwayMessage.recipients.exclude_selected == this.v && ((vVar = this.d) == null || !vVar.g())) {
                        ...
                        int i11 = this.f45265x;
                        if (i10 == i11 && this.f45261n.offline_only == this.f45264w && (i11 != 2 || (this.f45266y == this.C && this.B == this.D))) {
                        }
                    }
                }
            }
    ...
    public final void X() {
        if (this.f45257a.f27111c <= 0.0f) {
            if (!W()) {
                finishFragment();
                return;
            }
            o1 d = p1.f(this.currentAccount).d("away");
            boolean z4 = this.f45263s;
            if (z4 && d == null) {
                BotWebViewVibrationEffect.APP_ERROR.vibrate();
                View y12 = this.f45259c.y1(2);
                int i10 = -this.h;
                this.h = i10;
                AndroidUtilities.shakeViewSpring(y12, i10);
                g61 g61Var = this.f45259c;
                g61Var.x0(g61Var.x1(2));
            } else if (z4 && !this.d.k(this.f45259c)) {
            } else {
                this.f45257a.a(1.0f);
                ...
                if (this.f45263s) {
                    ...
                    tL_inputBusinessAwayMessage.offline_only = this.f45264w;
                    tL_inputBusinessAwayMessage.shortcut_id = d.f45407a;
                    ...
                    if (userFull != null) {
                        ...
                        tL_businessAwayMessage.offline_only = this.f45264w;
                        tL_businessAwayMessage.shortcut_id = d.f45407a;
    ...
    public final void Y() {
        ...
        this.f45261n = tL_businessAwayMessage;
        ...
        TL_account.TL_businessAwayMessage tL_businessAwayMessage2 = this.f45261n;
        ...
        TL_account.TL_businessAwayMessage tL_businessAwayMessage3 = this.f45261n;
    ...
    public final View createView(Context context) {
        ...
        this.f45257a = new mr(mutate, new rp(j6.w0(null, i10, false)));
        this.f45258b = this.actionBar.n().i(AndroidUtilities.dp(56.0f), LocaleController.getString(R.string.Done), this.f45257a);
        V(false);
    ...
    public final boolean onBackPressed(boolean z4) {
        if (W()) {
            if (z4) {
                ...
                alertDialog$Builder.f19503a.Q = LocaleController.getString(R.string.BusinessAwayUnsavedChanges);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f45259c.setPadding(0, 0, 0, i13);
        this.f45259c.setClipToPadding(false);
    }
}
