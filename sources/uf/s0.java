...
public final class s0 extends LinearLayout {
    public final g6 f48681a;
    public final p9 f48682b;
    public final z8 f48683c;
    public final TextView d;
    public final TextView f48684e;

    public s0(Context context, g6 g6Var, boolean z4) {
        super(context);
        int v02;
        this.f48683c = new z8((g6) null);
        this.f48681a = g6Var;
        setOrientation(0);
    ...
    public final void a(int i10, String str, TLRPC.Chat chat) {
        ...
        TextView textView = this.f48684e;
        TextView textView2 = this.d;
        p9 p9Var = this.f48682b;
        if (i10 == 0) {
            pq pqVar = new pq(k6.b0(AndroidUtilities.dp(28.0f), k6.v0(k6.Oh, this.f48681a)), getContext().getResources().getDrawable(R.drawable.menu_hashtag).mutate());
            pqVar.f30172s = AndroidUtilities.dp(-0.66f);
            pqVar.v = 0;
        ...
        z00Var.f43756f = k6.w0(null, k6.Lj, false);
