...
public final class k1 extends FrameLayout {
    public final z8 f45360a;
    public final ImageReceiver f45361b;
    public final TextView f45362c;
    public final TextView d;
    public final lp e;
    public final Path f45363f;
    public final Paint h;
    public final f6 f45364n;
    ...
    public k1(Context context, f6 f6Var) {
        ...
        float f12;
        float f13;
        this.f45360a = new z8((f6) null);
        this.f45361b = new ImageReceiver(this);
        this.f45363f = new Path();
        this.h = new Paint(1);
        this.f45365r = new int[1];
        this.f45364n = f6Var;
        setWillNotDraw(false);
        TextView textView = new TextView(context);
        this.f45362c = textView;
        ...
        org.telegram.ui.b.l(j6.f20298z6, f6Var, textView2, 1, 15.0f);
    ...
    public final void onMeasure(int i10, int i11) {
        float measuredWidth;
        int i12;
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i10), 1073741824), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(78.0f) + (this.f45366s ? 1 : 0), 1073741824));
        ...
        paint.setColor(j6.l1(0.85f, j6.v0(j6.f20298z6, this.f45364n)));
        Path path = this.f45363f;
        path.rewind();
