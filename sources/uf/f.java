...
public final class f extends b3 {
    public final k f48594f;

    public f(k kVar, Context context) {
        super(context);
        this.f48594f = kVar;
        this.f22591a = UserConfig.selectedAccount;
        setOrientation(1);
        ...
        i0Var.f5245b = paint;
        paint.setColor(k6.w0(null, k6.f21661d6, false));
        ...
        p9Var.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        this.f22543b.f22592b.getImageReceiver().startAnimation();
                        return;
                    default:
                        this.f22543b.f48594f.K();
                        return;
                }
            }
        });
        ...
        textView2.setTextColor(k6.w0(null, k6.f22038y6, false));
        i0Var.addView(textView2, c6.t(-1, -2, 49, 0, 7, 0, 0));
        TextView textView3 = new TextView(context);
        this.f22594e = textView3;
