...
public final class m1 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    public static d2 h;
    public g61 f45388a;
    public final ArrayList f45389b;
    public NumberTextView f45390c;
        ...
        if (i10 == m1Var.e) {
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                if (((i51) arrayList.get(i11)).G instanceof o1) {
                    ((o1) ((i51) arrayList.get(i11)).G).f45409c = i11;
                }
            }
            p1 f10 = p1.f(m1Var.currentAccount);
            ArrayList arrayList2 = f10.f45417b;
            ArrayList arrayList3 = new ArrayList();
            for (int i12 = 0; i12 < arrayList2.size(); i12 = yh.e(((o1) arrayList2.get(i12)).f45407a, i12, 1, arrayList3)) {
            }
            Collections.sort(arrayList2, new cu(23));
            for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                if (((o1) arrayList2.get(i13)).f45407a != ((Integer) arrayList3.get(i13)).intValue()) {
                    TLRPC.TL_messages_reorderQuickReplies tL_messages_reorderQuickReplies = new TLRPC.TL_messages_reorderQuickReplies();
                    for (int i14 = 0; i14 < arrayList2.size(); i14 = yh.e(((o1) arrayList2.get(i14)).f45407a, i14, 1, tL_messages_reorderQuickReplies.order)) {
                    }
                    ConnectionsManager.getInstance(f10.f45416a).sendRequest(tL_messages_reorderQuickReplies, new p5(19));
                    f10.l();
                    return;
                }
            }
    ...
    public static void V(m1 m1Var, ArrayList arrayList, w51 w51Var) {
        ...
        int i12 = 0;
        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
            if (i11 == 0 && !"hello".equalsIgnoreCase(((o1) arrayList2.get(i13)).f45408b)) {
                i11 = 0;
            } else {
                i11 = 1;
            }
            if (i12 == 0 && !"away".equalsIgnoreCase(((o1) arrayList2.get(i13)).f45408b)) {
                i12 = 0;
            } else {
                i12 = 1;
            }
        ...
        if (arrayList2.size() + (i11 ^ 1) + (i12 ^ 1) < MessagesController.getInstance(f10.f45416a).quickRepliesLimit) {
            i51 c3 = i51.c(1, R.drawable.msg_viewintopic, LocaleController.getString(R.string.BusinessRepliesAdd));
            c3.f25570q = true;
            arrayList.add(c3);
        }
        m1Var.e = w51Var.M();
        ArrayList arrayList3 = p1.f(m1Var.currentAccount).f45417b;
        ...
        while (i10 < size) {
            ...
            i51Var2.G = o1Var;
            i51Var2.K(m1Var.f45389b.contains(Integer.valueOf(o1Var.f45407a)));
    ...
    public static void W(m1 m1Var, i51 i51Var, View view) {
        if (i51Var.d == 1) {
        ...
        } else if (i51Var.f1808a == 16 && (i51Var.G instanceof o1)) {
            if (!m1Var.f45389b.isEmpty()) {
            ...
            if (!o1Var.f45411g) {
                ...
                h9.putString("quick_reply", o1Var.f45408b);
                xn xnVar = new xn(h9);
                xnVar.nb(o1Var.f45407a);
    ...
    public static void X(m1 m1Var) {
        m1Var.f45389b.clear();
        AndroidUtilities.forEachViews((RecyclerView) m1Var.f45388a, (h5.d) new nh.e(18));
        m1Var.actionBar.r();
        m1Var.f45388a.w1(false);
    }
    ...
    public static void d0(Activity activity, int i10, String str, o1 o1Var, f6 f6Var, Utilities.Callback callback) {
        ...
        d2 d2Var = alertDialog$Builder2.f19503a;
        d2Var.O = string;
        ...
        g1Var.setLineColors(j6.v0(j6.f20031k6, f6Var), j6.v0(j6.f20049l6, f6Var), j6.v0(j6.f20122p7, f6Var));
        ...
        org.telegram.ui.b.l(j6.f20141q7, f6Var, textView2, 1, 16.0f);
        ...
        gg.c1 c1Var = new gg.c1(r15, new ValueAnimator[1], textView2, textView, 16);
        Runnable[] runnableArr = {new ga(c1Var, 22)};
        ...
        alertDialog$Builder2.k(LocaleController.getString(R.string.Done), new m80(g1Var, c1Var, i10, o1Var, textView2, callback));
        alertDialog$Builder2.h(LocaleController.getString(R.string.Cancel), new s0.b(13));
        if (z4) {
            h = d2Var;
            d2VarArr[0] = d2Var;
            ...
            r32 = 0;
            d2Var.L = new org.telegram.ui.web.y0(g1Var, 22);
            d2VarArr[0] = d2Var;
    ...
    public final View createView(Context context) {
        ...
        this.f45390c = numberTextView;
        numberTextView.setTextSize(18);
        this.f45390c.setTypeface(AndroidUtilities.bold());
        this.f45390c.setTextColor(j6.w0(null, j6.f20283y8, false));
        j10.addView(this.f45390c, b6.m(1.0f, 0, -1, 72, 0, 0));
        this.f45390c.setOnTouchListener(new oh.d(2));
        ...
        z51Var.setBackgroundColor(j6.w0(null, j6.f19852a7, false));
        g61 g61Var = new g61(this, new Utilities.Callback2(this) {
            public final m1 f45274b;
            ...
            public final void run(Object obj, Object obj2) {
                switch (r2) {
                    case 0:
                        m1.V(this.f45274b, (ArrayList) obj, (w51) obj2);
                        return;
                    default:
                        m1.U(this.f45274b, ((Integer) obj).intValue(), (ArrayList) obj2);
                        return;
                }
            }
        ...
        this.f45388a = g61Var;
        g61Var.p1();
        g61 g61Var2 = this.f45388a;
        g61Var2.V2.f30240r = false;
        g61Var2.B1(new Utilities.Callback2(this) {
            public final m1 f45274b;
        ...
        z51Var.addView(this.f45388a, b6.c(-1.0f, -1));
        this.actionBar.A(this.f45388a, true);
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        g61 g61Var;
        w51 w51Var;
        if (i10 == NotificationCenter.quickRepliesUpdated && (g61Var = this.f45388a) != null && (w51Var = g61Var.V2) != null) {
            w51Var.N(true);
        }
    }
    ...
    public final void e0(i51 i51Var, View view) {
        ...
        o1 o1Var = (o1) i51Var.G;
        l1 l1Var = (l1) view;
        Integer valueOf = Integer.valueOf(o1Var.f45407a);
        ArrayList arrayList = this.f45389b;
        if (arrayList.contains(valueOf)) {
            arrayList.remove(Integer.valueOf(o1Var.f45407a));
        } else {
            arrayList.add(Integer.valueOf(o1Var.f45407a));
        }
        boolean z10 = true;
        this.f45388a.w1(!arrayList.isEmpty());
        boolean contains = arrayList.contains(Integer.valueOf(o1Var.f45407a));
        i51Var.e = contains;
        ...
        this.f45390c.a(Math.max(1, arrayList.size()), true);
        if (arrayList.size() == 1) {
            z4 = true;
        } else {
            z4 = false;
        ...
        if (z4) {
            ...
            z4 = (c3 == null || p1.g(c3.f45408b)) ? false : false;
        }
        if (this.f45391f != z4) {
            this.f45391f = z4;
            ...
            org.telegram.ui.b.p(scaleX.scaleY(f12), nr.h, 340L);
        }
    }
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f45388a.setPadding(0, 0, 0, i13);
        this.f45388a.setClipToPadding(false);
    }
}
