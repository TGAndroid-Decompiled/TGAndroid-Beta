...
public final class o0 implements Comparator {
    public final a0.h f48664a;
    public final ArrayList f48665b;
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        if (tLObject2 instanceof TLRPC.User) {
            j11 = ((TLRPC.User) tLObject2).f20990id;
        } else {
            j11 = -((TLRPC.Chat) tLObject2).f20843id;
        }
        a0.h hVar = this.f48664a;
        if (hVar.h(j10) < 0 || hVar.h(j11) < 0) {
            if (hVar.h(j10) < 0) {
                if (hVar.h(j11) < 0) {
                    Long valueOf = Long.valueOf(j10);
                    ArrayList arrayList = this.f48665b;
