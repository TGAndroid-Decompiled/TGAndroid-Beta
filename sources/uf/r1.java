...
public final class r1 extends p2 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void U(r1 r1Var, i51 i51Var, View view) {
        if (i51Var.d == -1) {
            ...
            r1Var.h = !z4;
            if (!z4) {
                String str = r1Var.f45431f;
                r1Var.f45432n = str;
                u1 u1Var = r1Var.f45430c;
                if (u1Var != null) {
                    u1Var.run(str);
                }
            }
            ...
            if (i10 >= 0) {
                ...
                if (i10 < arrayList.size()) {
                    b10.g();
                    r1Var.h = false;
                    String str2 = ((TLRPC.TL_timezone) arrayList.get(i51Var.d)).f19322id;
                    r1Var.f45432n = str2;
                    u1 u1Var2 = r1Var.f45430c;
                    if (u1Var2 != null) {
                        u1Var2.run(str2);
                    }
                    if (r1Var.d) {
    ...
    public static void V(r1 r1Var, ArrayList arrayList, w51 w51Var) {
        ...
        if (!z4) {
            ...
            w51Var.T();
            arrayList.add(i51.B(LocaleController.formatString(R.string.TimezoneDetectAutomaticallyInfo, b10.d(r1Var.f45432n, true))));
        }
        w51Var.U();
        if (!z4) {
        ...
        while (true) {
            ...
            i51Var2.f25565l = e;
            i51Var2.f25567n = f10;
            i51Var2.K(TextUtils.equals(tL_timezone.f19322id, r1Var.f45432n));
            if (r1Var.h && !z4) {
                z10 = false;
            } else {
                z10 = true;
        ...
        w51Var.T();
        if (z11) {
            arrayList.add(i51.l(r1Var.f45429b));
        } else {
    ...
    public final View createView(Context context) {
        ...
        this.f45428a = g61Var;
        g61Var.p1();
        this.actionBar.setAdaptiveBackground(this.f45428a);
        frameLayout.addView(this.f45428a, b6.c(-1.0f, -1));
        this.f45428a.setOnScrollListener(new lb0(this, 21));
        LinearLayout linearLayout = new LinearLayout(context);
        this.f45429b = linearLayout;
        linearLayout.setOrientation(1);
        this.f45429b.setMinimumHeight(AndroidUtilities.dp(500.0f));
        ...
        this.f45429b.addView(p9Var, b6.t(130, 130, 49, 0, 42, 0, 12));
        TextView textView = new TextView(context);
        textView.setText(LocaleController.getString(R.string.TimezoneNotFound));
        org.telegram.ui.b.l(j6.f20281y6, this.resourceProvider, textView, 1, 15.0f);
        this.f45429b.addView(textView, b6.t(-2, -2, 49, 0, 0, 0, 0));
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        g61 g61Var;
        w51 w51Var;
        if (i10 == NotificationCenter.timezonesUpdated && (g61Var = this.f45428a) != null && (w51Var = g61Var.V2) != null) {
            w51Var.N(true);
        }
    }
    ...
    public final boolean onFragmentCreate() {
        ...
        this.f45431f = c3;
        this.h = TextUtils.equals(c3, this.f45432n);
    ...
    public final void onInsets(int i10, int i11, int i12, int i13) {
        this.f45428a.setPadding(0, 0, 0, i13);
        this.f45428a.setClipToPadding(false);
    }
}
