...
public final class q extends b61 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void b0(Activity activity, int i10, TL_account.TL_businessChatLink tL_businessChatLink, f6 f6Var) {
        ...
        nVar.setLineColors(j6.v0(j6.f20031k6, f6Var), j6.v0(j6.f20049l6, f6Var), j6.v0(j6.f20122p7, f6Var));
    ...
    public final void U(ArrayList arrayList, w51 w51Var) {
        ...
        if (d10.f45441b.size() < MessagesController.getInstance(d10.f45440a).businessChatLinksLimit) {
            i51 c3 = i51.c(1, R.drawable.menu_link_create, LocaleController.getString(R.string.BusinessLinksAdd));
            c3.f25570q = true;
            arrayList.add(c3);
        }
        ArrayList arrayList2 = t.d(this.currentAccount).f45441b;
        ...
        while (i12 < size) {
            ...
            i12++;
            ?? obj2 = new Object();
            obj2.f45412a = (TL_account.TL_businessChatLink) obj;
    ...
    public final void W(i51 i51Var, View view) {
        if (i51Var.d == 1) {
            ...
            ConnectionsManager.getInstance(d10.f45440a).sendRequest(createbusinesschatlink, new s(d10, 1));
        } else if (i51Var.f1808a == 29) {
            Object obj = i51Var.G;
            if (obj instanceof p) {
                Bundle h = android.support.v4.media.a.h(6, "chatMode");
                h.putString("business_link", ((p) obj).f45412a.link);
    ...
    public final boolean X(i51 i51Var, View view) {
        if (i51Var.f1808a == 29) {
            Object obj = i51Var.G;
            if (obj instanceof p) {
                final TL_account.TL_businessChatLink tL_businessChatLink = ((p) obj).f45412a;
                    ...
                    public final void run() {
                        switch (r3) {
                            case 0:
                                ...
                                return;
                            case 1:
                                q.Y(this.f45368b, tL_businessChatLink);
                                return;
                            default:
                                q qVar2 = this.f45368b;
                                AlertDialog$Builder alertDialog$Builder = new AlertDialog$Builder(qVar2.getParentActivity(), 0, qVar2.getResourceProvider());
                                alertDialog$Builder.f19503a.O = LocaleController.getString(R.string.BusinessLinksDeleteTitle);
                                alertDialog$Builder.f19503a.Q = LocaleController.getString(R.string.BusinessLinksDeleteMessage);
                                ...
                                if (textView != null) {
                                    textView.setTextColor(qVar2.getThemedColor(j6.f20141q7));
                                    return;
                                }
                                return;
                        }
                ...
                H.W(this.f23580a.V0(view, false));
                H.Z();
                return true;
            }
        }
