...
public final class y0 extends rl0 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final xn f48780f;
    public int h;
    public int f48781n;
    public final g6 f48783s;
    public final int v;
    public final boolean f48784w;
    public String f48785x;
    public f6 f48786y;
    public final HashSet d = new HashSet();
    public final ArrayList f48779e = new ArrayList();
    public final int f48782r = UserConfig.selectedAccount;
    ...
    public final Object E(int i10) {
        if (i10 >= 0) {
            ArrayList arrayList = this.f48779e;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storiesListUpdated && objArr[0] == this.f48786y) {
            l();
        }
    }
    ...
    @Override
    public final int h() {
        return this.f48779e.size() + this.f48781n;
    }

    @Override
    public final int j(int i10) {
        if (i10 < this.f48779e.size()) {
            return 0;
        }
        return 1;
    }
    ...
    public final void v(f2.m1 m1Var, int i10) {
        ...
        if (i13 == 0) {
            ...
            if (this.f48784w) {
                ...
                if (messageObject.isOutOwner() || ChatObject.isMonoForum(this.f48782r, dialogId)) {
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        ...
        u00 u00Var;
        if (i10 != 0) {
            g6 g6Var = this.f48783s;
            Context context = this.f48778c;
            if (i10 != 1) {
                if (i10 != 2) {
                    r2Var = null;
                } else {
            ...
            r2Var = new r2(null, this.f48778c, true, this.f48782r, this.f48783s);
        }
