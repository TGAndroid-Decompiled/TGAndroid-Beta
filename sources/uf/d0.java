...
public final class d0 extends FrameLayout {
    ...
    public final g6 f48534a;
    public final p9 f48535b;
    ...
    public final void a() {
        ...
        int i10 = k6.ci;
        g6 g6Var = this.f48534a;
        setBackground(k6.b0(dp, k6.v0(i10, g6Var)));
        this.f48536c.setTextColor(k6.v0(k6.G6, g6Var));
        pq pqVar = this.d;
        if (pqVar != null) {
            if (this.f48537e.d == 7) {
    ...
    public void setData(e0 e0Var) {
        ...
        pq L2 = k6.L(AndroidUtilities.dp(32.0f), e0Var.f48546a);
        this.d = L2;
        int i11 = k6.Oh;
