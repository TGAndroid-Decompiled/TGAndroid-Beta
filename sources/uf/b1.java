...
public final class b1 extends LinearLayout {
    public final f6 f45318a;
    public final j90 f45319b;
    public final ImageReceiver f45320c;
    ...
    public b1(Context context, f6 f6Var) {
        ...
        j90Var.j(4.0f);
        j90Var.f25922w.setStrokeWidth(AndroidUtilities.dp(1.0f));
        ...
        addView(textView, b6.t(-1, -2, 55, i11, 10, i12, 4));
        ...
        addView(textView2, b6.t(-1, -2, 55, i13, 0, i14, 8));
    ...
    public final void a(TLRPC.TL_businessLocation tL_businessLocation, boolean z4) {
        if (tL_businessLocation != null) {
            ...
            if (tL_businessLocation.geo_point != null) {
                this.f45320c.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(tL_businessLocation.geo_point, AndroidUtilities.dp(44.0f), AndroidUtilities.dp(44.0f), 15, Math.min(2, (int) Math.ceil(AndroidUtilities.density)))), "44_44", this.f45319b, 0L, (String) null, (Object) null, 0);
            } else {
                this.f45320c.setImageBitmap((Drawable) null);
            }
        }
        this.e = z4;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f45319b && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
