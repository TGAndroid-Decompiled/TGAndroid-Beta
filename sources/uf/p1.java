...
public final class p1 {
    public static volatile p1[] f45415g = new p1[4];
    public static final Object[] h = new Object[4];
    public final int f45416a;
    public final ArrayList f45417b = new ArrayList();
    ...
    public final void a(String str) {
        ...
        while (true) {
            if (i10 < size) {
                ...
                i10++;
                o1Var = (o1) obj;
                if (TextUtils.equals(str, o1Var.f45408b)) {
                    break;
                }
            } else {
                o1Var = null;
        ...
        if (o1Var != null) {
            ...
            NotificationCenter.getInstance(this.f45416a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
        }
    }
    ...
    public final o1 c(long j10) {
        ArrayList arrayList = this.f45417b;
        int size = arrayList.size();
        int i10 = 0;
        while (i10 < size) {
            Object obj = arrayList.get(i10);
    ...
    public final ArrayList e() {
        ...
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f45417b;
            if (i10 < arrayList2.size()) {
                if (!g(((o1) arrayList2.get(i10)).f45408b)) {
                            ...
                            for (int i12 = 0; i12 < arrayList.size(); i12++) {
                                ...
                                while (true) {
                                    if (i13 < arrayList3.size()) {
                                        if (((o1) arrayList3.get(i13)).f45407a == tL_quickReply.shortcut_id) {
                                ...
                                o1Var.f45407a = tL_quickReply.shortcut_id;
                                o1Var.f45408b = tL_quickReply.shortcut;
                                o1Var.f45410f = tL_quickReply.count;
                                o1Var.f45409c = i12;
                                ...
                                p1Var.a(o1Var.f45408b);
                            }
                            p1Var.l();
                            NotificationCenter.getInstance(p1Var.f45416a).lambda$postNotificationNameOnUIThread$1(NotificationCenter.quickRepliesUpdated, new Object[0]);
                            return;
                        case 1:
                            p1 p1Var2 = this.f45398b;
                            ArrayList arrayList4 = p1Var2.f45417b;
                            int i14 = p1Var2.f45416a;
                            ...
                            if (c3 != null) {
                                c3.f45408b = tL_quickReply2.shortcut;
                                c3.f45410f = tL_quickReply2.count;
                                ...
                                o1 o1Var2 = new o1();
                                o1Var2.f45407a = tL_quickReply2.shortcut_id;
                                o1Var2.f45408b = tL_quickReply2.shortcut;
                                o1Var2.f45410f = tL_quickReply2.count;
                                o1Var2.d = tL_quickReply2.top_message;
                                for (int i15 = 0; i15 < arrayList4.size(); i15++) {
                                    ((o1) arrayList4.get(i15)).f45409c = i15;
                                }
                                arrayList4.add(o1Var2);
                                p1Var2.a(o1Var2.f45408b);
                            }
                            p1Var2.l();
                            ...
                            return;
                        case 2:
                            p1 p1Var3 = this.f45398b;
                            int i16 = p1Var3.f45416a;
                            o1 c10 = p1Var3.c(((TL_update.TL_updateDeleteQuickReply) update).shortcut_id);
                            if (c10 != null) {
                                p1Var3.f45417b.remove(c10);
                                p1Var3.a(c10.f45408b);
                                int i17 = c10.f45407a;
                            ...
                            return;
                        default:
                            p1 p1Var4 = this.f45398b;
                            int i18 = p1Var4.f45416a;
                            ...
                            if (c11 != null) {
                                int size = c11.f45410f - tL_updateDeleteQuickReplyMessages.messages.size();
                                c11.f45410f = size;
                                if (size <= 0) {
                                    p1Var4.f45417b.remove(c11);
                                }
    ...
    public final void l() {
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f45416a);
