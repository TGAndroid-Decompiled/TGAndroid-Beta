...
public final class o2 extends ChatActivityEnterView {
    public ValueAnimator f15678k5;
    public int f15679l5;
    public int f15680m5;
    public int f15681n5;
    public final d4 f15682o5;
    ...
    public final void C0(int i10, int i11) {
        d4 d4Var = this.f15682o5;
        if (d4Var.Y1 != null) {
            this.f22762j3 = true;
            this.f15680m5 = this.B0.getMeasuredHeight();
            this.f15681n5 = this.B0.getScrollY();
            invalidate();
            d4Var.invalidate();
            this.f15679l5 = d4Var.Y1.getBackgroundTop();
        }
    }
    ...
    public final boolean S0() {
        ...
        int i10;
        int i11;
        if (this.f22827w1.getAlpha() < 0.5f) {
            H0();
            return false;
        }
        d4 d4Var = this.f15682o5;
        if (d4Var.L1.f15094f) {
            ...
            int[] iArr = MessagesController.getInstance(d4Var.f15243z2).starsGroupcallMessageLimits;
            ...
            if (!d4Var.D0(true)) {
                ...
                int i12 = (int) max;
                if (i11 > t.b(d4Var.f15243z2, i12, 2) || formatTextWithEntities.length() > t.b(d4Var.f15243z2, i12, 1)) {
                    d4Var.O0();
                    return false;
                }
            }
    ...
    public final boolean T0(int i10, boolean z4, int i11, boolean z10, long j10) {
        d4 d4Var = this.f15682o5;
        if (MessagesController.getInstance(d4Var.f15243z2).isFrozen()) {
            org.telegram.ui.c.b(d4Var.f15243z2);
            return false;
        }
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (!isEnabled()) {
            ...
            d4 d4Var = this.f15682o5;
            if (d4Var.f15177f2 != null) {
                f10 = this.f22837y * 1.5f;
            } else {
                f10 = 0.0f;
            }
            ...
            if (motionEvent.getAction() == 0) {
                if (contains && (textView2 = d4Var.f15177f2) != null) {
                    textView2.setPressed(true);
                }
            } else if (motionEvent.getAction() == 1) {
                TextView textView3 = d4Var.f15177f2;
                if (textView3 != null) {
                    if (contains && textView3.isPressed()) {
                        d4.h0(d4Var);
                    }
                    d4Var.f15177f2.setPressed(false);
                }
            } else if (motionEvent.getAction() == 3 && (textView = d4Var.f15177f2) != null) {
                textView.setPressed(false);
            }
            TextView textView4 = d4Var.f15177f2;
    ...
    public final void h0(Menu menu) {
        zn.k8(menu, null, false, !this.f15682o5.L1.f15094f, true, true);
    }

    @Override
    public final void h1(float f10, float f11, float f12, boolean z4) {
        LinearLayout linearLayout = this.f15682o5.f15171d2;
    ...
    public final boolean r1(Runnable runnable) {
        this.f15682o5.n0(runnable);
        return true;
    }

    @Override
    public final boolean t() {
        return this.f15682o5.D0(true);
    }
