...
public final class z7 extends View implements v9 {
    ...
    public final a8 G;
    public final PorterDuffColorFilter f16123a;
    public boolean f16124b;
    public final TextPaint f16125c;
    public final TextPaint d;
    public final Paint e;
    public final Paint f16126f;
    public float h;
    public float f16127n;
    public final y7[] f16128r;
    public int f16129s;
    public StaticLayout v;
    public float f16130w;
    public boolean f16131x;
    public final boolean f16132y;

    public z7(a8 a8Var, Context context) {
        super(context);
        this.G = a8Var;
        TextPaint textPaint = new TextPaint(1);
        this.f16125c = textPaint;
        ...
        this.f16123a = new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN);
    }
    ...
    public final void b(CharSequence charSequence, v7 v7Var, v7 v7Var2, boolean z4, boolean z10) {
        ...
        y7[] y7VarArr = this.f16128r;
        if (MediaDataController.stringsEqual(y7VarArr[0].f16095n, charSequence)) {
            y7 y7Var = y7VarArr[0];
            if (y7Var.f16096o == v7Var && y7Var.f16097p == v7Var2) {
                y7Var.f16098q = z4;
                invalidate();
                return;
            }
        ...
        if (z10) {
            ...
            y7Var2.g(y7Var3.f16095n, y7Var3.f16096o, y7Var3.f16097p);
            y7 y7Var4 = y7VarArr[1];
            y7 y7Var5 = y7VarArr[0];
            y7Var4.f16098q = y7Var5.f16098q;
            y7Var4.f16099r.d(y7Var5.f16099r.f31241c, true);
            y7VarArr[0].g(charSequence, v7Var, v7Var2);
            y7 y7Var6 = y7VarArr[0];
            y7Var6.f16098q = z4;
            y7Var6.f16099r.d(0.0f, true);
            this.D = 1.0f;
            ...
            this.F.setInterpolator(nr.f27347g);
            this.F.start();
            return;
        }
        y7VarArr[0].g(charSequence, v7Var, v7Var2);
        y7VarArr[0].f16098q = z4;
        invalidate();
        this.D = 0.0f;
    }
    ...
    public Layout getStaticTextLayout() {
        return this.f16128r[0].e;
    }

    @Override
    public CharSequence getText() {
        return this.f16128r[0].f16095n;
    }
    ...
    public final void onDetachedFromWindow() {
        ...
        int i10 = 0;
        y7 y7Var = this.f16128r[0];
        z7 z7Var = y7Var.v;
        org.telegram.ui.Components.u5.release(z7Var, y7Var.d);
        org.telegram.ui.Components.u5.release(z7Var, y7Var.f16088f);
        if (y7Var.h == null) {
            return;
        }
        while (true) {
            ...
            if (i10 < w7VarArr.length) {
                ...
                if (w7Var != null) {
                    org.telegram.ui.Components.u5.release(z7Var, w7Var.f16038a);
                }
                i10++;
            } else {
                return;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v != null) {
            ...
            int clamp = (int) ((1.0f - Utilities.clamp(this.f16130w / 0.5f, 1.0f, 0.0f)) * 255.0f);
            Paint paint = this.f16126f;
            paint.setAlpha(clamp);
            Paint paint2 = this.e;
            paint2.setAlpha(clamp);
            this.d.setAlpha(clamp);
            canvas2.save();
            canvas2.translate(this.f16127n - AndroidUtilities.dp(32.0f), scrollY);
            canvas2.drawRect(0.0f, 0.0f, AndroidUtilities.dp(32.0f), this.v.getHeight() + this.C, paint);
            canvas2.restore();
            canvas2.drawRect(this.f16127n - AndroidUtilities.dp(16.0f), scrollY, getMeasuredWidth(), this.v.getHeight() + scrollY + this.C, paint2);
            canvas2.save();
            canvas2.translate(this.f16127n, scrollY);
            this.v.draw(canvas2);
            canvas2.restore();
        }
        canvas2.restore();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        ...
        if ((y7Var2 != null && (y7Var2.f16100s == drawable || (((v7Var3 = y7Var2.f16096o) != null && v7Var3.f16001j == drawable) || ((v7Var4 = y7Var2.f16097p) != null && v7Var4.f16001j == drawable)))) || ((y7Var = y7VarArr[1]) != null && (y7Var.f16100s == drawable || (((v7Var = y7Var.f16096o) != null && v7Var.f16001j == drawable) || ((v7Var2 = y7Var.f16097p) != null && v7Var2.f16001j == drawable))))) {
            return true;
        }
