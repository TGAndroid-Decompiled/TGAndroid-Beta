...
public final class b extends ci.d implements le.d {
    public final le.b f15231h0;
    public final e6 f15232i0;

    public b(Context context, e6 e6Var) {
        super(context, e6Var, true);
        this.f15231h0 = new le.b(0, this, qr.h, 320L, true);
        this.f15232i0 = e6Var;
        e();
        setOutlineProvider(j0.f46839b);
    }

    @Override
    public final void D(int i10, float f7, float f10, e eVar) {
        boolean q6;
        e6 e6Var = this.f15232i0;
        if (e6Var != null) {
            q6 = e6Var.a();
        } else {
            q6 = i6.I.q();
        }
        float f11 = this.f15231h0.e;
        setElevation((1.0f - f11) * AndroidUtilities.dp(1.0f));
        setColor(i0.a.d(f11, m(i6.f18836d6), m(i6.Oh)));
        setTextColor(i0.a.d(f11, m(i6.f19074q7), m(i6.Sh)));
