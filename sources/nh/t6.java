...
public final class t6 {
    ...
    public final g7 f15924k;
    public final SharedPreferences f15925l;
    ...
    public int f15934u;
    public int v;
    public final ph.t0 f15935w;
    public String f15937y;
    public final a0.h f15918b = new a0.h();
    public final a0.h f15919c = new a0.h();
    public int d = 0;
    public final a0.h e = new a0.h();
    public LongSparseIntArray f15920f = new LongSparseIntArray();
    public final ArrayList f15921g = new ArrayList();
    public final ArrayList h = new ArrayList();
    public final a0.h f15922i = new a0.h();
    public final LongSparseIntArray f15923j = new LongSparseIntArray();
    public final a0.h f15926m = new a0.h();
    public final a0.h f15936x = new a0.h();
    public boolean f15938z = true;
    ...
    public t6(int i10) {
        ...
        ?? obj = new Object();
        obj.f15365a = i10;
        obj.f15366b = MessagesStorage.getInstance(i10);
        this.f15924k = obj;
        SharedPreferences mainSettings = MessagesController.getInstance(i10).getMainSettings();
        this.f15925l = mainSettings;
        this.f15928o = mainSettings.getString("last_stories_state", "");
        this.f15937y = mainSettings.getString("last_stories_state_hidden", "");
        this.v = mainSettings.getInt("total_stores_hidden", 0);
        this.f15934u = mainSettings.getInt("total_stores", 0);
        this.f15932s = mainSettings.getBoolean("read_loaded", false);
        this.f15933t = new HashSet(mainSettings.getStringSet("unsupported_stories_checked", new HashSet()));
        ...
        g7 g7Var = this.f15924k;
        g7Var.f15366b.getStorageQueue().postRunnable(new n4(11, g7Var, new w5(this, 0)));
        this.K = new af.b(this, i10, 11);
        this.f15935w = new ph.t0(i10);
    }
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            try {
                ...
                if (((MessageObject) arrayList.get(i10)).storyItem == null) {
                    ...
                    str = str + storyItem.f19419id + "@" + storyItem.dialogId;
                }
    ...
    public static String h0(List list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            try {
                ...
                str = str + ((TL_stories.StoryItem) list.get(i10)).f19419id + "@" + ((TL_stories.StoryItem) list.get(i10)).dialogId;
            } catch (Exception unused) {
                return "err";
            }
        }
    ...
    public final l6 A(long j10, int i10, int i11, boolean z4) {
        if (i10 == 0 && i11 > 0) {
            ...
            if (l6Var == null && z4) {
                l6 l6Var2 = new l6(this.f15917a, j10, i10, i11, new cg.h0(this, 27));
        ...
        if (l6Var3 == null && z4) {
            if (i10 == 4) {
                ...
                d6 d6Var = new d6(this.f15917a, j10, null, new cg.h0(this, 27));
                hashMap4.put(valueOf2, d6Var);
                return d6Var;
            }
            HashMap hashMap5 = hashMapArr[i10];
            Long valueOf3 = Long.valueOf(j10);
            l6 l6Var4 = new l6(this.f15917a, j10, i10, i11, new cg.h0(this, 27));
    ...
    public final h6 B(long j10, boolean z4) {
        ...
        if (h6Var == null && z4) {
            h6 h6Var2 = new h6(this.f15917a, j10, this);
            hVar.k(h6Var2, j10);
            return h6Var2;
        }
        return h6Var;
    ...
    public final int C(boolean z4) {
        if (z4) {
            ...
            return this.h.size();
        } else if (this.f15929p) {
            return Math.max(1, this.f15934u);
        } else {
            return this.f15921g.size();
        }
    }
    ...
    public final int D(int i10, long j10) {
        ...
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f15922i.f(j10);
        if (peerStories == null) {
            peerStories = z(j10);
        }
        if (peerStories == null) {
        ...
        if (j10 == UserConfig.getInstance(this.f15917a).getClientUserId() && !Utilities.isNullOrEmpty((Collection) this.f15918b.f(j10))) {
            return 1;
        }
        int max = Math.max(peerStories.max_read_id, this.f15920f.get(j10, 0));
        boolean z4 = false;
        for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
            ...
            if ((i10 == 0 || peerStories.stories.get(i11).f19419id == i10) && peerStories.stories.get(i11).f19419id > max) {
    ...
    public final ArrayList E(long j10) {
        return (ArrayList) this.f15918b.f(j10);
    }
    ...
    public final boolean G() {
        if (H()) {
            ...
            if (arrayList.isEmpty() || (arrayList.size() == 1 && DialogObject.getPeerDialogId(((TL_stories.PeerStories) arrayList.get(0)).peer) == UserConfig.getInstance(this.f15917a).clientUserId)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean H() {
        long j10 = UserConfig.getInstance(this.f15917a).clientUserId;
        TL_stories.PeerStories peerStories = (TL_stories.PeerStories) this.f15922i.f(j10);
        if ((peerStories != null && !peerStories.stories.isEmpty()) || !Utilities.isNullOrEmpty((Collection) this.f15918b.f(j10))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean J(long j10) {
        ...
        for (int i10 = 0; i10 < peerStories.stories.size(); i10++) {
            ...
            if (storyItem != null && storyItem.f19419id > peerStories.max_read_id) {
                return true;
            }
        }
        return false;
    ...
    public final boolean K(long j10) {
        ArrayList arrayList = (ArrayList) this.f15918b.f(j10);
    ...
    public final boolean M(TLRPC.User user) {
        if (user != null) {
            if (user.contact || user.f19331id == MessagesController.getInstance(this.f15917a).storiesChangelogUserId) {
                return true;
            }
            return false;
        }
    ...
    public final void P() {
        ...
        ConnectionsManager.getInstance(this.f15917a).sendRequest(tL_contacts_getBlocked, new s5(this, 3));
    }
    ...
    public final void Q(boolean z4) {
        ...
        boolean z10;
        if (!z4 || !this.f15931r) {
            if ((!z4 && this.f15930q) || this.f15927n) {
                return;
            }
            boolean z11 = true;
            if (z4) {
            ...
            ConnectionsManager.getInstance(this.f15917a).sendRequest(tL_stories_getAllStories, new z5(this, z4, tL_stories_getAllStories, z11));
        }
    }
    ...
    public final void R() {
        if (!this.U && !this.V) {
            this.U = true;
            ConnectionsManager.getInstance(this.f15917a).sendRequest(new TL_stories.TL_stories_getChatsToSend(), new s5(this, 2));
        }
    }
            ...
            if (!hashSet.contains(valueOf)) {
                ...
                for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
                    if (peerStories.stories.get(i11) instanceof TL_stories.TL_storyItemSkipped) {
                        ...
                        arrayList.add(Integer.valueOf(peerStories.stories.get(i11).f19419id));
                    }
                ...
                if (arrayList != null) {
                    ...
                    tL_stories_getStoriesByID.f19426id = arrayList;
                    int i12 = this.f15917a;
    ...
    public final void T() {
        if (this.A) {
            ...
            g7 g7Var = this.f15924k;
            g7Var.f15366b.getStorageQueue().postRunnable(new n4(12, g7Var, w5Var));
        } else {
            Q(false);
            Q(true);
        }
    ...
    public final boolean V(TL_stories.PeerStories peerStories, TL_stories.StoryItem storyItem, boolean z4) {
        if (storyItem != null && peerStories != null) {
            ...
            int i10 = this.f15920f.get(peerDialogId);
            int max = Math.max(peerStories.max_read_id, Math.max(i10, storyItem.f19419id));
            ...
            this.f15920f.put(peerDialogId, max);
            if (max > i10) {
                if (!z4) {
                    this.f15924k.i(max, peerDialogId);
                }
                ...
                tL_stories_readStories.max_id = storyItem.f19419id;
                    ...
                    for (int i11 = 0; i11 < Math.min(2, storyItem.media_areas.size()); i11++) {
                        if (storyItem.media_areas.get(i11) instanceof TL_stories.TL_mediaAreaSuggestedReaction) {
                            ...
                            if (d.f14107f != null) {
                                ...
                                org.telegram.ui.Components.l5 l5Var = new org.telegram.ui.Components.l5(1, i10, d.f14108g);
                                l5Var.f26571m = true;
                                l5Var.v();
                            }
                        }
    ...
    public final void X(TL_stories.PeerStories peerStories) {
        ...
        while (true) {
            if (i11 >= peerStories.stories.size()) {
                break;
            } else if (peerStories.stories.get(i11).f19419id > peerStories.max_read_id) {
                i10 = i11;
                break;
            } else {
                i11++;
    ...
    public final void Y(TL_stories.TL_stories_allStories tL_stories_allStories, boolean z4, boolean z10, boolean z11) {
        ...
        ArrayList arrayList3 = this.f15921g;
        if (!z11) {
            if (!z4) {
                arrayList3.clear();
            } else {
        ...
        for (int i12 = 0; i12 < tL_stories_allStories.peer_stories.size(); i12++) {
            ...
            while (i13 < peerStories.stories.size()) {
                ...
                if ((storyItem instanceof TL_stories.TL_storyItemDeleted) || ((storyItem instanceof TL_stories.TL_storyItem) && currentTime > storyItem.expire_date && !(storyItem.media instanceof TLRPC.TL_messageMediaVideoStream))) {
                    NotificationsController.getInstance(i11).processDeleteStory(peerDialogId, storyItem.f19419id);
        ...
        if (!z10) {
            ...
            g7 g7Var = this.f15924k;
            g7Var.f15366b.getStorageQueue().postRunnable(new cg.x0(g7Var, arrayList4, z11, z4, n0Var, 3));
        }
        af.b bVar = this.K;
    ...
    public final void Z(TL_stories.TL_updateStory tL_updateStory) {
        ...
        g7 g7Var = this.f15924k;
        if (i10 > 0) {
            user = MessagesController.getInstance(this.f15917a).getUser(Long.valueOf(peerDialogId));
            if (user != null && (M(user) || user.self)) {
                g7Var.f15366b.getStorageQueue().postRunnable(new n4(10, g7Var, tL_updateStory));
            }
        } else {
            g7Var.f15366b.getStorageQueue().postRunnable(new n4(10, g7Var, tL_updateStory));
            user = null;
    ...
    public final void a0(long j10, TL_stories.PeerStories peerStories) {
        ...
        if (j10 > 0) {
            ...
            if (M(user) || user.self) {
                g7Var.f15366b.getStorageQueue().postRunnable(new d7(g7Var, peerStories, 0));
            }
    ...
    public final void b(int i10, long j10, ArrayList arrayList) {
        ...
        while (i12 < size) {
            ...
            i12++;
            tL_updateAlbum.add_stories.add(Integer.valueOf(((TL_stories.StoryItem) obj).f19419id));
        }
        ...
        l6 A = t6Var.A(B.f15385b, 0, i10, false);
        if (A != null) {
            A.D(arrayList, true);
        }
        ...
        while (i14 < size3) {
            ...
            i14++;
            l6 A2 = t6Var.A(B.f15385b, 0, ((m6) obj3).f15618a, false);
            if (A2 != null) {
        ...
        if (peerStories2 != null && (arrayList = peerStories2.stories) != null && !arrayList.isEmpty() && peerStories != null && (arrayList2 = peerStories.stories) != null && !arrayList2.isEmpty()) {
            for (int i10 = 0; i10 < peerStories.stories.size(); i10++) {
                if (peerStories.stories.get(i10) instanceof TL_stories.TL_storyItemSkipped) {
                    int i11 = peerStories.stories.get(i10).f19419id;
                    int i12 = 0;
                    while (true) {
                        if (i12 >= peerStories2.stories.size()) {
                            break;
                        }
                        if (peerStories2.stories.get(i12).f19419id == i11 && (peerStories2.stories.get(i12) instanceof TL_stories.TL_storyItem)) {
    ...
    public final void c0(int i10, long j10, ArrayList arrayList) {
        ...
        while (i13 < size) {
            ...
            i13++;
            tL_updateAlbum.delete_stories.add(Integer.valueOf(((TL_stories.StoryItem) obj).f19419id));
        }
        int size2 = arrayList.size();
        int i14 = 0;
        while (i14 < size2) {
    ...
    public final void d0(long j10, int i10, h5.d dVar) {
        ...
        if (y10 != null) {
            for (int i11 = 0; i11 < y10.stories.size(); i11++) {
                if (y10.stories.get(i11).f19419id == i10 && !(y10.stories.get(i11) instanceof TL_stories.TL_storyItemSkipped)) {
    ...
    public final void e0(long j10, boolean z4) {
        LongSparseIntArray longSparseIntArray = this.f15923j;
        if (z4) {
    ...
    public final void g0(long j10, TL_stories.StoryItem storyItem, mg.q0 q0Var) {
        ...
        tL_stories_sendReaction.story_id = storyItem.f19419id;
        int i10 = this.f15917a;
        ...
        if (q0Var == null) {
            ...
            tL_reactionCustomEmoji.document_id = q0Var.f14108g;
    ...
    public final boolean h(long j10) {
        TLRPC.Chat chat;
        if (j10 >= 0 || (chat = MessagesController.getInstance(this.f15917a).getChat(Long.valueOf(-j10))) == null) {
            return false;
        }
        if (!chat.creator) {
    ...
    public final boolean i(long j10) {
        if (UserConfig.getInstance(this.f15917a).getClientUserId() != j10 && !h(j10)) {
            return false;
        }
        return true;
    }
    ...
    public final void i0(long j10, boolean z4, boolean z10) {
        ...
        ArrayList arrayList2 = this.f15921g;
        if (z4) {
        ...
        if (inputPeer != null && !(inputPeer instanceof TLRPC.TL_inputPeerEmpty)) {
            ...
            if (z10) {
                if (z4) {
                    ...
                    tL_contacts_block.f19227id = inputPeer;
                    ...
                    tL_contacts_unblock2.f19232id = inputPeer;
    ...
    public final void k0(long j10, List list) {
        ...
        if (B != null && (arrayList = B.h) != null) {
            ...
            while (i10 < size) {
                ...
                i10++;
                l6 A3 = t6Var.A(j10, 0, ((m6) obj).f15618a, false);
                if (A3 != null) {
                    A3.A(list);
                }
                t6Var = this;
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            while (true) {
                if (i12 < peerStories.stories.size()) {
                    if (peerStories.stories.get(i12).f19419id == storyItem.f19419id) {
                        z10 = true;
                        if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                            ...
                            kh.a2.t(storyItem.f19419id, new StringBuilder("StoriesController update story for full peer storyId="));
                        }
                    } else {
                        i12++;
                    }
            ...
            if (!z10) {
                if (storyItem instanceof TL_stories.TL_storyItemDeleted) {
                    kh.a2.t(storyItem.f19419id, new StringBuilder("StoriesController story is not found, but already deleted storyId="));
                } else if (z4) {
                    kh.a2.t(storyItem.f19419id, new StringBuilder("StoriesController add new story for full peer storyId="));
    ...
    public final void m(TL_stories.PeerStories peerStories) {
        if (peerStories != null && peerStories.stories != null) {
            ...
            while (i10 < peerStories.stories.size()) {
                if (m7.w(this.f15917a, peerStories.stories.get(i10))) {
    ...
    public final void m0(long j10, TL_stories.PeerStories peerStories) {
        ...
        if (peerStories != null && (peerStories2 = (TL_stories.PeerStories) this.f15922i.f(j10)) != null) {
            ...
            for (int i10 = 0; i10 < peerStories2.stories.size(); i10++) {
                if (peerStories2.stories.get(i10) instanceof TL_stories.TL_storyItemSkipped) {
                    int i11 = peerStories2.stories.get(i10).f19419id;
                    int i12 = 0;
                    while (true) {
                        if (i12 >= peerStories.stories.size()) {
                            break;
                        }
                        if (peerStories.stories.get(i12).f19419id == i11 && (peerStories.stories.get(i12) instanceof TL_stories.TL_storyItem)) {
    ...
    public final void n0(long j10, List list, boolean z4) {
        ...
        if (B != null && (arrayList = B.h) != null) {
            ...
            while (i10 < size2) {
                int i12 = i10 + 1;
                l6 A3 = t6Var.A(j10, 0, ((m6) arrayList.get(i10)).f15618a, false);
                if (A3 != null) {
                    A3.D(list, z4);
                }
                t6Var = this;
    ...
    public final n6 o() {
        ...
        ArrayList arrayList2 = (ArrayList) this.f15919c.f(UserConfig.getInstance(i11).getClientUserId());
        if (arrayList2 == null) {
            size = 0;
        } else {
    ...
    public final void o0(long j10, ArrayList arrayList, boolean z4, d3 d3Var) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                storyItem.pinned = z4;
                togglepinned.f19433id.add(Integer.valueOf(storyItem.f19419id));
                if (y10 != null) {
                    for (int i11 = 0; i11 < y10.stories.size(); i11++) {
                        if (y10.stories.get(i11).f19419id == storyItem.f19419id) {
                            y10.stories.get(i11).pinned = z4;
                            this.f15924k.k(j10, storyItem);
                        }
                    }
                }
            }
    ...
    public final void p(int i10, long j10) {
        ...
        if (hashSet.contains(str) || this.f15933t.contains(str)) {
            return;
        }
        hashSet.add(str);
        TL_stories.TL_stories_getStoriesByID tL_stories_getStoriesByID = new TL_stories.TL_stories_getStoriesByID();
    ...
    public final void p0(long j10, TL_stories.StoryItem storyItem, boolean z4) {
        ...
        if (storyItem == null) {
            ...
            str = storyItem.f19419id + "@" + storyItem.dialogId;
        }
        s6.append(str);
        FileLog.d(s6.toString());
    ...
    public final void q() {
        ...
        this.f15937y = "";
        this.f15928o = "";
        this.f15925l.edit().putBoolean("stories_loaded", false).remove("last_stories_state").putBoolean("stories_loaded_hidden", false).remove("last_stories_state_hidden").putBoolean("read_loaded", false).apply();
        ph.t0 t0Var = this.f15935w;
        ...
        ConnectionsManager.getInstance(this.f15917a).sendRequest(new TL_stories.TL_stories_getAllReadPeerStories(), new s5(this, 0));
    }
    ...
    public final void r(long j10, String str, Utilities.Callback callback) {
        ...
        tL_createAlbum.peer = MessagesController.getInstance(i10).getInputPeer(B.f15385b);
    ...
    public final void s(long j10, ArrayList arrayList) {
            ...
            if (!(storyItem instanceof TL_stories.TL_storyItemDeleted)) {
                if (peerStories2 != null) {
                    ...
                    while (true) {
                        if (i12 >= peerStories2.stories.size()) {
                            break;
                        } else if (peerStories2.stories.get(i12).f19419id == storyItem.f19419id) {
                ...
                tL_stories_deleteStories.f19422id.add(Integer.valueOf(storyItem.f19419id));
            }
        }
            ...
            if (!(storyItem2 instanceof TL_stories.TL_storyItemDeleted) && peerStories2 != null) {
                ...
                while (true) {
                    if (i14 >= peerStories2.stories.size()) {
                        break;
                    } else if (peerStories2.stories.get(i14).f19419id == storyItem2.f19419id) {
        ...
        k0(j10, arrayList);
        ArrayList<Integer> arrayList2 = tL_stories_deleteStories.f19422id;
        g7 g7Var = this.f15924k;
        g7Var.f15366b.getStorageQueue().postRunnable(new i5.v(g7Var, arrayList2, j10, 8));
        NotificationCenter.getInstance(i10).lambda$postNotificationNameOnUIThread$1(NotificationCenter.storiesUpdated, new Object[0]);
    }
    ...
    public final s6 t(long j10, TL_stories.StoryItem storyItem) {
        HashMap hashMap = (HashMap) this.e.f(j10);
        if (hashMap != null && !hashMap.isEmpty()) {
            return (s6) hashMap.get(Integer.valueOf(storyItem.f19419id));
        }
        return null;
    }
    ...
    public final TL_stories.StoryItem u(int i10, long j10) {
        ...
        if (peerStories != null) {
            for (int i11 = 0; i11 < peerStories.stories.size(); i11++) {
                if (peerStories.stories.get(i11).f19419id == i10) {
    ...
    public final void v(ArrayList arrayList) {
        ...
        while (i10 < arrayList.size()) {
            ...
            long peerDialogId = DialogObject.getPeerDialogId(peerStories.peer);
            if (peerDialogId > 0 && (user = MessagesController.getInstance(this.f15917a).getUser(Long.valueOf(peerDialogId))) != null && !M(user)) {
    ...
    public final int x(long j10) {
        ...
        if (y10 != null) {
            return Math.max(y10.max_read_id, this.f15920f.get(j10, 0));
        }
        return this.f15920f.get(j10, 0);
    }

    public final TL_stories.PeerStories y(long j10) {
        return (TL_stories.PeerStories) this.f15922i.f(j10);
    }
