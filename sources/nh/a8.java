...
public class a8 extends NestedScrollView implements o70 {
    ...
    public final z7 V;
    public boolean W;
    public float f15056a0;
    public float f15057b0;
    public float f15058c0;
    public float f15059d0;
    public float f15060e0;
    public float f15061f0;
    public float f15062g0;
    public final OverScroller f15063h0;
    public boolean f15064i0;
    public int f15065j0;
    public int f15066k0;
    public int f15067l0;
    public int m0;
    public int f15068n0;
    public final FrameLayout f15069o0;
    public boolean f15070p0;
    public boolean f15071q0;
    public int f15072r0;
    public boolean f15073s0;
    public boolean f15074t0;
    ...
    public a8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        o1.j jVar = new o1.j(z7Var, o1.h.f16162n, 0.0f);
        this.U = jVar;
        ...
        try {
            ...
            this.f15063h0 = (OverScroller) declaredField.get(this);
        } catch (Exception e6) {
            this.f15063h0 = null;
            FileLog.e(e6);
        }
    ...
    public final void B(int i10) {
        ...
        if (this.W && i10 == 0) {
            this.W = false;
            if (this.f15056a0 != 0.0f && (overScroller = this.f15063h0) != null && overScroller.isFinished()) {
                K(this.f15058c0);
            }
        }
    }
    ...
    public final void a(RectF rectF) {
        ...
        if (y7VarArr != null && (y7Var = y7VarArr[0]) != null && y7Var.f16077p != null) {
            int i10 = z7Var.C;
            int i11 = z7Var.C;
            y7 y7Var2 = z7Var.f16108r[0];
            rectF.set(z7Var.B, (AndroidUtilities.lerp(y7Var.f16074m, y7Var.f16073l, z7Var.f16110w) + i10) - z7Var.f16108r[0].f16077p.b(), getWidth() - z7Var.B, AndroidUtilities.lerp(y7Var2.f16074m, y7Var2.f16073l, z7Var.f16110w) + i11);
            float x10 = z7Var.getX() - getScrollX();
            FrameLayout frameLayout = this.f15069o0;
    ...
    public final void b(Canvas canvas, float f10) {
        ...
        if (y7VarArr != null && (y7Var = y7VarArr[0]) != null && y7Var.f16077p != null) {
            ...
            canvas.translate(x11, (y10 + AndroidUtilities.lerp(y7Var2.f16074m, y7Var2.f16073l, z7Var.f16110w)) - y7VarArr2[0].f16077p.b());
            v7 v7Var = y7VarArr2[0].f16077p;
            int width = getWidth();
            int i10 = z7Var.B;
    ...
    public final void computeScroll() {
        OverScroller overScroller;
        super.computeScroll();
        if (!this.W && this.f15056a0 != 0.0f && (overScroller = this.f15063h0) != null && overScroller.isFinished()) {
            K(0.0f);
        }
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        canvas.clipRect(0, scrollY, width, this.f15072r0 + i10);
    ...
    public final boolean g(int i10, int i11, int i12, int[] iArr, int[] iArr2) {
        ...
        int i13;
        iArr[1] = 0;
        if (!this.W || (((this.f15056a0) <= 0.0f || i11 <= 0) && (f10 >= 0.0f || i11 >= 0))) {
            return false;
        }
        float f11 = i11;
        float f12 = f10 - f11;
        ...
        this.V.setTranslationY(this.f15056a0);
        this.T.x();
        return true;
    }
    ...
    public int getPendingMarginTopDiff() {
        int i10 = this.f15068n0;
        if (i10 >= 0) {
            return i10 - ((ViewGroup.MarginLayoutParams) this.f15069o0.getLayoutParams()).topMargin;
        }
        return 0;
    }
    ...
    public float getTextTop() {
        return (this.V.getTranslationY() + this.f15069o0.getTop()) - getScrollY();
    }
    ...
    public final void h(int i10, int i11, int i12, int i13, int[] iArr, int i14, int[] iArr2) {
        ...
        float f12;
        if (i13 != 0) {
            int round = Math.round((1.0f - Math.abs((-this.f15056a0) / this.f15069o0.getTop())) * i13);
            if (round != 0) {
                boolean z4 = this.W;
                z7 z7Var = this.V;
                if (!z4) {
                    if (!this.U.f16172f) {
                        OverScroller overScroller = this.f15063h0;
                        ...
                        if (!Float.isNaN(f10)) {
                            ...
                            f11 = min * (-this.f15057b0);
                        } else {
                            f11 = 0.0f;
                        }
                        if (round != 0) {
                            float f13 = this.f15056a0 - round;
                            this.f15056a0 = f13;
    ...
    public final boolean z(int i10, int i11) {
        if (i11 == 0) {
            this.U.c();
            this.W = true;
            this.f15056a0 = this.V.getTranslationY();
        }
        return true;
    }
