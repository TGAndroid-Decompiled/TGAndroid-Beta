...
public final class w8 extends qv0 {
    ...
    public final i9 F0;
    public float f16022t0;
    public float f16023u0;
    public float f16024v0;
    public final float[] f16025w0;
    public final Path f16026x0;
    public final RectF f16027y0;
    public final RectF f16028z0;

    public w8(i9 i9Var, Context context, org.telegram.ui.ActionBar.p2 p2Var) {
        super(context, null);
        this.F0 = i9Var;
        this.E0 = p2Var;
        this.f16025w0 = new float[8];
        this.f16026x0 = new Path();
        this.f16027y0 = new RectF();
        this.f16028z0 = new RectF();
        this.A0 = new RectF();
        this.B0 = new RectF();
        this.C0 = new RectF();
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        float f10 = 0.0f;
        if (i9Var.f15455m1 && currentPeerView != null && (pk0Var = currentPeerView.f15204o3) != null) {
            float f11 = 0.0f;
            for (View view = currentPeerView; view != null && (view.getParent() instanceof View); view = (View) view.getParent()) {
                f10 += view.getX();
                f11 += view.getY();
            }
            if (currentPeerView.f15204o3.getReactionsWindow() != null && currentPeerView.f15204o3.getReactionsWindow().f13962c != null) {
                motionEvent.offsetLocation(-f10, (-f11) - currentPeerView.f15204o3.getReactionsWindow().f13962c.getTranslationY());
                currentPeerView.f15204o3.getReactionsWindow().f13962c.dispatchTouchEvent(motionEvent);
                return true;
            }
        ...
        if (motionEvent.getAction() != 1 && motionEvent.getAction() != 3) {
            ...
            if (f12 != 0.0f) {
                ...
                i9Var.D.setInterpolator(mr.f27122f);
                i9Var.D.start();
            }
            if (i9Var.S >= 0.3f) {
                i9Var.q(true);
        ...
        if (motionEvent.getAction() == 0) {
            i9Var.X = false;
            if (currentPeerView != null) {
                dh.d dVar = currentPeerView.f15225v0;
                n8 n8Var = currentPeerView.f15241z0;
                i3 i3Var = currentPeerView.Z0;
                ph.f3 f3Var = currentPeerView.C0;
                if (f3Var != null && f3Var.S && n8Var != null) {
                    if (!f3Var.f41668o0.contains(motionEvent.getX() - (currentPeerView.C0.getX() + (i3Var.getX() + currentPeerView.getX())), motionEvent.getY() - (currentPeerView.C0.getY() + (i3Var.getY() + currentPeerView.getY()))) && !currentPeerView.H0(motionEvent, n8Var)) {
                        currentPeerView.C0.e(true);
                    }
                }
                ph.f3 f3Var2 = currentPeerView.D0;
                if (f3Var2 != null && f3Var2.S && dVar != null && !f3Var2.f41668o0.contains(motionEvent.getX() - (currentPeerView.D0.getX() + (i3Var.getX() + currentPeerView.getX())), motionEvent.getY() - (currentPeerView.D0.getY() + (i3Var.getY() + currentPeerView.getY()))) && !currentPeerView.H0(motionEvent, dVar)) {
                    currentPeerView.D0.e(true);
                }
            }
            i9Var.f15452k0.onTouchEvent(MotionEvent.obtain(0L, 0L, 3, 0.0f, 0.0f, 0));
        }
        if (!i9Var.f15477x && !i9Var.E0 && !i9Var.F0) {
            z10 = true;
        } else {
            z10 = false;
        }
        float f13 = i9Var.f15432b0;
        SparseArray sparseArray = this.D0;
        if (f13 == 0.0f && !i9Var.f15444g0 && i9Var.f15452k0.C0 == 1 && motionEvent.getAction() == 2 && z10 && (((((Float) sparseArray.get(motionEvent.getPointerId(0), Float.valueOf(0.0f))).floatValue() - motionEvent.getX(0)) != 0.0f && (((i11 = (y8Var = i9Var.f15452k0).F0) == 0 && y8Var.H0 == 0.0f && floatValue < 0.0f) || (i11 == y8Var.getAdapter().b() - 1 && y8Var.H0 == 0.0f && i10 > 0))) || i9Var.U != 0.0f)) {
            float f14 = i9Var.U;
            if (f14 == 0.0f) {
                i9Var.V = -floatValue;
            }
        ...
        if (currentPeerView != null && i9Var.f15432b0 == 0.0f && !i9Var.f15444g0 && !i9Var.I0 && !i9Var.F0 && i9Var.f15452k0.C0 != 1) {
            AndroidUtilities.getViewPositionInParent(currentPeerView.Z0, this, fArr);
            motionEvent.offsetLocation(-fArr[0], -fArr[1]);
            d4 currentPeerView2 = i9Var.f15452k0.getCurrentPeerView();
        ...
        if (!z11) {
            ...
            if (motionEvent.getAction() == 1 || motionEvent.getAction() == 3) {
                if (i9Var.f15432b0 != 0.0f && !i9Var.f15438d1 && i9Var.m0 < AndroidUtilities.dp(20.0f)) {
                    if (i9Var.f15475w.f15591f > 0.5f) {
                        z12 = true;
                    } else {
                        z12 = false;
                    }
                ...
                d4 t6 = i9Var.t();
                if (t6 != null) {
                    t6.H0.f15074t0 = false;
                }
            }
            if (z4 && !i9Var.X) {
                i9Var.m();
            }
            if (!dispatchTouchEvent && (!i9.f15422u1 || !i9Var.f15457n0)) {
                return false;
            }
        }
        return true;
    ...
    public final void onMeasure(int i10, int i11) {
        i9 i9Var = this.F0;
        ((FrameLayout.LayoutParams) i9Var.f15430a1.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight - AndroidUtilities.dp(2.0f);
        i9Var.f15430a1.getLayoutParams().height = AndroidUtilities.dp(2.0f);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (!i9Var.f15444g0 && !i9Var.f15477x && i9Var.W == 0.0f && ((i9Var.f15432b0 == 0.0f || (!i9Var.f15435c0 && !i9Var.f15437d0)) && !i9Var.f15445g1)) {
            return false;
        }
        i9Var.f15442f0.onTouchEvent(motionEvent);
        return true;
    }
