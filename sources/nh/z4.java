...
public final class z4 extends rl0 {
    public final ArrayList f16119c = new ArrayList();
    public final d5 d;
    ...
    public final void E() {
        ArrayList arrayList = this.f16119c;
        arrayList.clear();
        d5 d5Var = this.d;
        c5 c5Var = d5Var.B;
        int i10 = 0;
        if (d5Var.N) {
            ...
            arrayList.add(new u4(0));
            if (c5Var != null) {
                p4 p4Var = c5Var.f15161s;
                boolean z4 = c5Var.f15152j;
                if (c5Var.b() <= 0 && (z4 || (!c5Var.e && !c5Var.f15155m))) {
                    if (!TextUtils.isEmpty(p4Var.f15748c)) {
                        arrayList.add(new u4(7));
                    } else if (z4) {
                        arrayList.add(new u4(5));
                    } else {
                        int i11 = c5Var.f15146a;
                        if (i11 > 0 && p4Var.f15747b) {
            ...
            if (c5Var != null) {
                ArrayList arrayList2 = c5Var.f15150g;
                ArrayList arrayList3 = c5Var.f15151i;
                if (c5Var.f15149f) {
            ...
            if (c5Var != null && (c5Var.e || c5Var.f15155m)) {
                if (c5Var.b() <= 0) {
                    arrayList.add(new u4(6));
                } else {
                    arrayList.add(new u4(4));
                }
            } else if (c5Var != null && c5Var.f15153k) {
                arrayList.add(new u4(11));
            } else if (c5Var != null) {
                p4 p4Var2 = c5Var.f15161s;
                if (c5Var.b() < c5Var.f15146a && TextUtils.isEmpty(p4Var2.f15748c) && !p4Var2.f15747b) {
    ...
    public final int j(int i10) {
        return ((u4) this.f16119c.get(i10)).f15959a;
    }
    ...
    public final void v(f2.l1 l1Var, int i10) {
        ...
        d5 d5Var = this.d;
        int i16 = d5Var.v;
        if (l1Var.f5788f == 1 && i10 >= 0) {
            ArrayList arrayList = this.f16119c;
            if (i10 < arrayList.size()) {
                u4 u4Var = (u4) arrayList.get(i10);
                org.telegram.ui.Cells.n6 n6Var = (org.telegram.ui.Cells.n6) l1Var.f5785a;
                TL_stories.StoryView storyView = u4Var.f15960b;
                ...
                boolean remove = d5Var.C.f15158p.remove(Long.valueOf(j10));
                if (storyView != null) {
                    TLRPC.Reaction reaction3 = storyView.reaction;
                    if (reaction3 != null && (str2 = mg.q0.d(reaction3).f14107f) != null && str2.equals("❤")) {
                        j12 = 0;
                        z10 = true;
                    } else {
                        j12 = 0;
                    ...
                    if (storyView instanceof TL_stories.TL_storyViewPublicRepost) {
                        ...
                        if (storyView instanceof TL_stories.TL_storyViewPublicForward) {
                            ...
                            l5 l5Var = d5Var.f15274y;
                            if (l5Var == null) {
                                storyItem2 = null;
                            } else {
                                storyItem2 = l5Var.f15573a;
                            }
                    ...
                    if (i10 < arrayList.size() - 1) {
                        i15 = ((u4) arrayList.get(i10 + 1)).f15959a;
                    } else {
                        i15 = -1;
                    }
                ...
                if (storyReaction != null) {
                    if (storyReaction instanceof TL_stories.TL_storyReaction) {
                        ...
                        if (reaction4 != null && (str = mg.q0.d(reaction4).f14107f) != null && str.equals("❤")) {
                            z4 = true;
                        } else {
                            z4 = false;
                        }
                        ...
                        if (storyReaction instanceof TL_stories.TL_storyReactionPublicRepost) {
                            ...
                            l5 l5Var2 = d5Var.f15274y;
                            if (l5Var2 == null) {
                                storyItem = null;
                            } else {
                                storyItem = l5Var2.f15573a;
                            }
                    ...
                    boolean z12 = true;
                    if (i10 < arrayList.size() - 1) {
                        i12 = ((u4) arrayList.get(i10 + 1)).f15959a;
                    } else {
                        i12 = -1;
                    }
    ...
    public final f2.l1 x(ViewGroup viewGroup, int i10) {
        ...
        switch (i10) {
            case 0:
                e90Var = new w4(this, d5Var.getContext(), 0);
                break;
            case 1:
                bc0 bc0Var = org.telegram.ui.Cells.n6.D;
                e90Var = new x4(i12, d5Var.getContext(), bVar, this);
                break;
            case 2:
            case 9:
            default:
                e90Var = new w4(this, d5Var.getContext(), 1);
                break;
            case 3:
                e90Var = new org.telegram.ui.Cells.s3(d5Var.getContext(), 70);
                break;
            case 4:
            ...
            case 10:
                ...
                if (i10 == 7) {
                    ...
                    if (!premiumFeaturesBlocked) {
                        ...
                        ((LinearLayout.LayoutParams) e90Var2.getLayoutParams()).topMargin = AndroidUtilities.dp(12.0f);
                        TextView textView = new TextView(y4Var.getContext());
                        textView.setText(string);
                        int i13 = org.telegram.ui.ActionBar.j6.Sh;
                        org.telegram.ui.ActionBar.f6 f6Var = y4Var.f31458n;
            ...
            case 11:
            case 12:
                e90 e90Var3 = new e90(d5Var.getContext(), null);
                e90Var3.setTextSize(1, 13.0f);
                e90Var3.setTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20281y6, bVar));
                e90Var3.setLinkTextColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.J6, bVar));
                int dp2 = AndroidUtilities.dp(16.0f);
                int dp3 = AndroidUtilities.dp(21.0f);
                e90Var3.setPadding(dp3, dp2, dp3, dp2);
                e90Var3.setMaxLines(Integer.MAX_VALUE);
                e90Var3.setGravity(17);
                e90Var3.setDisablePaddingsOffsetY(true);
                if (i10 == 11) {
                    e90Var3.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(R.string.StoryViewsPremiumHint), new lh.b(this, 29)));
                } else {
                    e90Var3.setText(LocaleController.getString(R.string.ServerErrorViewersFull));
                }
                e90Var3.setLayoutParams(new f2.w0(-1, -2));
                e90Var = e90Var3;
                break;
        }
        return new f2.l1(e90Var);
    }
}
