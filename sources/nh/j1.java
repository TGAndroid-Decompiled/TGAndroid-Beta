...
public final class j1 implements NotificationCenter.NotificationCenterDelegate, df.a {
    ...
    public WindowManager f15483b;
    public WindowManager.LayoutParams f15484c;
    public i1 d;
    public dg.u2 e;
    public ph.k3 f15485f;
    public FrameLayout h;
    public org.telegram.ui.Components.p9 f15486n;
    public gn f15487r;
    public boolean f15488s;
    public e1 v;
    public int f15489w;
    public ScaleGestureDetector f15490x;
    public zz f15491y;
    ...
    public static void o(Activity activity, e1 e1Var) {
        ...
        if (e1Var != null && !j1Var.P) {
            ...
            j1Var.f15490x = scaleGestureDetector;
            int i11 = Build.VERSION.SDK_INT;
            scaleGestureDetector.setQuickScaleEnabled(false);
            if (i11 >= 23) {
                j1Var.f15490x.setStylusScaleEnabled(false);
            }
            j1Var.f15491y = new zz(context, new h1(scaledTouchSlop));
            dg.u2 u2Var = new dg.u2(context, 11);
            u2Var.f4817b = new Path();
            j1Var.e = u2Var;
            ...
            j1Var.e.setBackgroundColor(org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f19945gg, false));
            org.telegram.ui.Components.p9 p9Var = new org.telegram.ui.Components.p9(context);
            j1Var.f15486n = p9Var;
            j1Var.e.addView(p9Var, k7.b6.c(-1.0f, -1));
            ph.k3 k3Var = new ph.k3(context, j1Var.f15489w);
            j1Var.f15485f = k3Var;
            k3Var.setAlpha(0.0f);
            j1Var.e.addView(j1Var.f15485f, k7.b6.c(-1.0f, -1));
            ...
            int i12 = org.telegram.ui.ActionBar.j6.f19962hg;
            ...
            j1Var.f15483b = (WindowManager) context.getSystemService("window");
            ...
            j1Var.f15483b.addView(j1Var.d, j1Var.f15484c);
            ...
            if (activity != null && ef.d.a(activity) == 1) {
                ...
                eVar.f1809c = "pip-live-story";
                eVar.e = 1;
                eVar.d = AndroidUtilities.dp(10.0f);
                eVar.f1813j = j1Var.d;
                eVar.f1814k = j1Var.f15485f.getPlaceholderView();
                j1Var.I = eVar.a();
            }
        }
    }
    ...
    public final void a(c2.p pVar) {
        ...
        if (fVar != null && fVar.h.b()) {
            WindowManager.LayoutParams layoutParams = this.f15484c;
            int width = this.I.h.f5199a.width();
            this.G = width;
            layoutParams.width = width;
            WindowManager.LayoutParams layoutParams2 = this.f15484c;
            int height = this.I.h.f5199a.height();
            this.H = height;
            layoutParams2.height = height;
        }
        this.T = false;
        this.f15483b.addView(this.d, this.f15484c);
        this.d.invalidate();
        ph.k3 k3Var = this.S;
        if (k3Var != null) {
            k3Var.b();
    ...
    public final Bitmap d() {
        ph.k3 k3Var = this.f15485f;
        if (k3Var != null && k3Var.a()) {
            return this.f15485f.getBitmap();
        }
        return null;
    }
    ...
    public final void e(c2.p pVar) {
        i();
        this.T = true;
        this.f15483b.removeView(this.d);
        this.d.invalidate();
    }
    ...
    @Override
    public final View h() {
        ph.k3 k3Var = new ph.k3(this.f15485f.getContext(), this.f15489w);
        this.S = k3Var;
        return k3Var;
    }
    ...
    public final void i() {
        ...
        if (e1Var != null) {
            ...
            if (k3Var != null) {
                ...
                this.v.s(this.f15485f.getSink());
            }
        }
        if (this.f15488s) {
            this.f15487r.animate().cancel();
            ViewPropertyAnimator duration = this.f15487r.animate().alpha(0.0f).setDuration(150L);
            mr mrVar = mr.f27122f;
            duration.setInterpolator(mrVar).start();
            this.f15486n.animate().cancel();
            this.f15486n.animate().alpha(0.0f).setDuration(150L).setInterpolator(mrVar).start();
            this.f15485f.animate().cancel();
            this.f15485f.animate().alpha(1.0f).setDuration(150L).setInterpolator(mrVar).start();
            this.f15488s = false;
        }
        ...
        AndroidUtilities.updateViewLayout(this.f15483b, this.d, this.f15484c);
        o1.j jVar = this.M;
        float f11 = this.K;
        jVar.f16170b = f11;
        jVar.f16171c = true;
        ...
        this.M.f();
        o1.j jVar2 = this.N;
        jVar2.f16170b = this.L;
        jVar2.f16171c = true;
        jVar2.f16178u.f16184i = k7.n.a(f10, AndroidUtilities.dp(16.0f), (AndroidUtilities.displaySize.y - (m() * this.J)) - AndroidUtilities.dp(16.0f));
        this.N.f();
    }
    ...
    public final void k(boolean z4) {
        if (this.P) {
            ...
            NotificationCenter.getInstance(this.f15489w).removeObserver(this, NotificationCenter.liveStoryUpdated);
    ...
    public final float l() {
        if (this.O == null) {
            ...
            this.f15482a = (Math.min(point.x, point.y) - AndroidUtilities.dp(32.0f)) / n();
        }
