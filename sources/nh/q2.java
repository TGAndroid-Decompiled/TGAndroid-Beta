...
public final class q2 extends pa0 {
    ...
    public final void f(Canvas canvas, Rect rect, float f10) {
        ...
        canvas.drawRoundRect(rectF, f10, f10, d4Var.f15212k2);
        if (rectF.top < getMeasuredHeight() - 1) {
            canvas.drawRect(0.0f, getMeasuredHeight(), getMeasuredWidth(), getMeasuredHeight() - 1, d4Var.f15257y0.G("paintDivider"));
        }
    }
}
