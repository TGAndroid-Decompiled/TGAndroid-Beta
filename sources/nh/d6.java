...
public final class d6 extends l6 {
    ...
    public final void C(ArrayList arrayList, boolean z4) {
        ...
        ArrayList arrayList5 = this.f15580i;
        arrayList5.clear();
    ...
    public final void F(ArrayList arrayList) {
        int i10 = 0;
        while (true) {
            ArrayList arrayList2 = this.f15580i;
    ...
    public final void G(TLRPC.InputMedia inputMedia, TL_bots.botPreviewMedia botpreviewmedia) {
            ...
            if (i10 < arrayList.size()) {
                ...
                if (inputMedia != null && (storyItem = messageObject.storyItem) != null && (messageMedia = storyItem.media) != null) {
                    if (inputMedia instanceof TLRPC.TL_inputMediaPhoto) {
                        ...
                        if (photo != null && photo.f19208id == ((TLRPC.TL_inputMediaPhoto) inputMedia).f19247id.f19203id) {
                            break;
                        }
                    } else if ((inputMedia instanceof TLRPC.TL_inputMediaDocument) && (document = messageMedia.document) != null && document.f19190id == ((TLRPC.TL_inputMediaDocument) inputMedia).f19245id.f19196id) {
                        break;
                    }
                }
                i10++;
        ...
        MessageObject messageObject2 = new MessageObject(this.f15577c, new c6(this, this.d, botpreviewmedia));
    ...
    public final void I(TL_bots.botPreviewMedia botpreviewmedia) {
        MessageObject messageObject = new MessageObject(this.f15577c, new c6(this, this.d, botpreviewmedia));
        TL_stories.StoryItem storyItem = messageObject.storyItem;
        TLRPC.Message message = messageObject.messageOwner;
        int i10 = this.I;
        this.I = i10 + 1;
        message.f19205id = i10;
        storyItem.f19419id = i10;
        ...
        this.f15580i.add(0, messageObject);
        i6 i6Var = this.f15588q;
        AndroidUtilities.cancelRunOnUIThread(i6Var);
        AndroidUtilities.runOnUIThread(i6Var);
    }
