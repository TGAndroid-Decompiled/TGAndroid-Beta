...
public final class e1 implements NotificationCenter.NotificationCenterDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    public ArrayList R;
    public ArrayList S;
    public final TL_stories.StoryItem f15292a;
    public final long f15293b;
    public final int f15294c;
    public final Context d;
    public final int e;
    public final TLRPC.InputGroupCall f15295f;
    ...
    public e1(Context context, int i10, TL_stories.StoryItem storyItem, long j10, int i11, boolean z4, TLRPC.InputGroupCall inputGroupCall, boolean z10, boolean z11) {
        ...
        this.d = context;
        this.e = i10;
        this.f15295f = inputGroupCall;
        this.f15292a = storyItem;
        this.f15293b = j10;
        this.f15294c = i11;
        this.h = z4;
        this.f15296n = z10;
        ...
        this.E = c1Var;
        FileLog.d("[LivePlayer] setup to call " + inputGroupCall.f19201id);
    ...
    public final boolean a() {
        ...
        if (!this.f15299w && !this.f15296n && this.f15298s && T == null && (groupCall = this.v) != null && !groupCall.rtmp_stream && groupCall.creator) {
            return true;
        }
        return false;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.storyGroupCallUpdated) {
            ...
            if (this.f15293b == longValue) {
                mf.d.a(this.v, groupCall);
                this.v = groupCall;
                NotificationCenter.getInstance(this.e).lambda$postNotificationNameOnUIThread$1(NotificationCenter.liveStoryUpdated, Long.valueOf(groupCall.f19194id));
            }
        }
    }
    ...
    public final void e() {
        if (!this.f15299w) {
            ...
            if (this.f15300x) {
                ...
                leavegroupcall.call = this.f15295f;
    ...
    public final boolean f(TLRPC.InputGroupCall inputGroupCall) {
        TLRPC.InputGroupCall inputGroupCall2 = this.f15295f;
        if (inputGroupCall2 != inputGroupCall && inputGroupCall2.f19201id != inputGroupCall.f19201id) {
            return false;
        }
        return true;
    }
    ...
    public final long g() {
        ...
        TLRPC.InputGroupCall inputGroupCall = this.f15295f;
        if (inputGroupCall != null) {
            return inputGroupCall.f19201id;
        }
        return 0L;
    }
    ...
    public final void k() {
        ...
        NativeInstance makeGroup = NativeInstance.makeGroup(org.telegram.ui.Components.voip.f2.d("live_" + this.f15295f.f19201id), 0L, false, SharedConfig.noiseSupression, new w0(this, 0), new m.j0(2), new w0(this, 2), new w0(this, 3), new w0(this, 4), new w0(this, 5), false);
        this.B = makeGroup;
    ...
    public final void p() {
        ...
        checkgroupcall.call = this.f15295f;
    ...
    public final void q() {
        ...
        getgroupcall.call = this.f15295f;
    ...
    public final void t(boolean z4) {
        if (!this.f15299w && this.f15298s != z4) {
            if (this.f15296n && z4) {
                return;
            }
            this.f15298s = z4;
    ...
    public final void w() {
        ...
        int i10 = this.e;
        tL_updateStory.peer = MessagesController.getInstance(i10).getPeer(this.f15293b);
        TL_stories.TL_storyItemDeleted tL_storyItemDeleted = new TL_stories.TL_storyItemDeleted();
        tL_updateStory.story = tL_storyItemDeleted;
        tL_storyItemDeleted.f19419id = this.f15294c;
        MessagesController.getInstance(i10).getStoriesController().Z(tL_updateStory);
        e();
    }

    public final void x() {
        if (!this.f15299w && this.B != null) {
