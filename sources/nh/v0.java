...
public abstract class v0 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public final z f15950a0;
    public final FrameLayout f15951b;
    public ValueAnimator f15952b0;
    public final lh.e1 f15953c;
    public boolean f15954c0;
    public final f2.i0 d;
    public final z f15955d0;
    public final f0 e;
    public final rb1 f15956f;
    public final f2.i0 h;
    public final w51 f15957n;
    public final ArrayList f15958r;
    public final ArrayList f15959s;
    ...
    public v0(Context context, i9 i9Var, ViewGroup viewGroup, View view, FrameLayout frameLayout) {
        ...
        this.f15950a0 = new z(g2Var, 1);
        this.f15954c0 = false;
        this.f15955d0 = new z(g2Var, 2);
        this.f15949a = view;
        this.f15951b = frameLayout;
        view.setAlpha(0.5f);
        ...
        f0 f0Var = new f0(g2Var, e1Var, context, i10, new Utilities.Callback2() {
            ...
            public final void run(Object obj, Object obj2) {
                ...
                switch (i11) {
                    case 0:
                        ArrayList arrayList2 = g2Var2.f15958r;
                        e1 e1Var2 = g2Var2.M;
                        if (e1Var2 == null) {
                            j10 = 0;
                        } else {
                        ...
                        while (i12 < arrayList2.size()) {
                            ...
                            if (t0Var.f15877b || !t0Var.e || t0Var.f15880g >= j10) {
                                int i13 = n0.f15632a;
                        ...
                        return;
                    default:
                        ArrayList arrayList3 = g2Var2.f15959s;
        ...
        rb1 rb1Var = new rb1(context, 1, null);
        this.f15956f = rb1Var;
        rb1Var.setWillNotDraw(false);
        f2.i0 i0Var2 = new f2.i0(0, false);
        this.h = i0Var2;
        rb1Var.setLayoutManager(i0Var2);
        w51 w51Var = new w51(rb1Var, context, i10, 0, false, new Utilities.Callback2() {
            @Override
            public final void run(Object obj, Object obj2) {
                long j10;
                int i11 = r2;
    ...
    public static Integer a(v0 v0Var, Long l10) {
        ...
        ic M = new qc(v0Var.f15951b, new b()).M(v0Var.getStarsToastTitle(), v0Var.getStarsToastSubtitle(), R.raw.stars_topup);
        boolean z4 = false;
        M.f25679r = false;
        M.k(true);
        long j10 = 0;
    ...
    public final void b() {
        this.O = 0L;
        h(getDefaultPeerId());
        s1 s1Var = ((g2) this).f15326f0.W1;
        r1 r1Var = s1Var.f15844a;
        r1Var.c(s1Var);
        r1Var.b();
        j();
    }
    ...
    public final void c(int i10) {
        ...
        int i11 = 0;
        while (true) {
            arrayList = this.f15958r;
            if (i11 < arrayList.size()) {
                if (((t0) arrayList.get(i11)).f15876a == i10) {
        ...
        if (t0Var != null) {
            ...
            int i12 = 0;
            while (true) {
                arrayList2 = this.f15959s;
                if (i12 >= arrayList2.size()) {
                    break;
                } else if (((u0) arrayList2.get(i12)).f15930f.contains(t0Var)) {
                    ((u0) arrayList2.get(i12)).f15930f.remove(t0Var);
    ...
    public final o0 d(int i10) {
        ...
        while (true) {
            ...
            if (i11 < e1Var.getChildCount()) {
                ...
                if ((childAt instanceof o0) && (t0Var = (o0Var = (o0) childAt).H) != null && t0Var.f15876a == i10) {
                    return o0Var;
                }
                i11++;
            } else {
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.liveStoryMessageUpdate) {
            ...
            if (tLObject instanceof TL_update.TL_updateGroupCallMessage) {
                ...
                if (inputGroupCall2 != null && inputGroupCall2.f19176id == longValue) {
    ...
    public final boolean f() {
        ...
        if (getDefaultPeerId() >= 0 || getDefaultPeerId() == this.J) {
            ...
            e1 e1Var = this.M;
            if (e1Var != null && (inputGroupCall = this.L) != null && inputGroupCall.f19176id == e1Var.g() && (groupCall = this.M.v) != null && groupCall.creator) {
                return true;
            }
    ...
    public int getUnreadMessagesCount() {
        ...
        int i11 = 0;
        while (true) {
            ArrayList arrayList = this.f15958r;
            if (i10 < arrayList.size()) {
                t0 t0Var = (t0) arrayList.get(i10);
                int i12 = t0Var.f15876a;
                if (i12 >= 0 && i12 > this.C && (t0Var.f15877b || !t0Var.e || t0Var.f15880g >= j10)) {
                    i11++;
                }
                i10++;
            } else {
    ...
    public final void l(int i10, int i11, boolean z4, long j10, TLRPC.TL_textWithEntities tL_textWithEntities, long j11, boolean z10) {
        ...
        while (true) {
            ...
            if (i13 < arrayList.size()) {
                if (((t0) arrayList.get(i13)).f15876a != i11) {
                    i13++;
                } else {
                    return;
                }
                ...
                obj.f15877b = z4;
                obj.f15878c = j10;
                obj.f15879f = tL_textWithEntities;
                obj.f15880g = j11;
                obj.f15876a = i11;
                obj.e = TextUtils.isEmpty(tL_textWithEntities.text);
                int b10 = t.b(i14, (int) obj.f15880g, 0);
                long j12 = obj.f15880g;
                ArrayList arrayList2 = this.f15959s;
                boolean z12 = true;
                if (j12 > 0 && b10 > 0 && currentTime - obj.d <= b10) {
                    int i15 = 0;
                    while (true) {
                        if (i15 < arrayList2.size()) {
                            if (((u0) arrayList2.get(i15)).f15928b == j10) {
                ...
                if (obj.f15876a >= 0) {
                    for (int size = arrayList.size() - 1; size >= 0; size--) {
                        if (obj.f15876a < ((t0) arrayList.get(size)).f15876a) {
                            i12 = size + 1;
                            break;
                        }
                    }
                ...
                if (i12 <= 0 && !z10 && (!this.f15953c.canScrollVertically(1) || obj.f15876a < 0)) {
                ...
                invalidate();
                g2 g2Var = (g2) this;
                a aVar = g2Var.f15326f0.U1;
                if (aVar != null) {
                    aVar.setCount(g2Var.getUnreadMessagesCount());
                }
                if (!z10 && i11 > 0 && obj.f15880g > 0) {
                    int i17 = 0;
                    while (true) {
                        if (i17 < this.Q.size()) {
                            if (DialogObject.getPeerDialogId(((TL_phone.groupCallDonor) this.Q.get(i17)).peer_id) == obj.f15878c) {
                    ...
                    if (groupcalldonor == null) {
                        ...
                        if (UserConfig.getInstance(i14).getClientUserId() != obj.f15878c) {
                            z12 = false;
                        }
                        groupcalldonor.my = z12;
                        groupcalldonor.peer_id = MessagesController.getInstance(i14).getPeer(obj.f15878c);
                        groupcalldonor.stars = 0L;
                        for (int i18 = 0; i18 < arrayList2.size(); i18++) {
                            if (((u0) arrayList2.get(i18)).f15928b == obj.f15878c) {
                    ...
                    long j15 = obj.f15880g;
                    long j16 = j14 + j15;
                    groupcalldonor.stars = j16;
                    i((int) j16, (int) j15, obj.f15878c);
                }
                t();
                if (z10) {
                    z zVar = this.f15955d0;
    ...
    public final void m() {
        ...
        ArrayList arrayList = this.f15959s;
        int size = arrayList.size();
        ...
        while (i11 < size) {
            ...
            while (i14 < size2) {
                ...
                if (t0Var.f15880g > 0) {
                    ...
                    i10 = i15;
                    i13 = Math.max(i13, t.b(u0Var.f15927a, (int) t0Var.f15880g, 0) + t0Var.d);
                } else {
                    i10 = i15;
                }
                ...
                if (z10) {
                    ...
                    while (i14 < size) {
                        ...
                        if (sendgroupcallmessage.random_id == tL_updateMessageID.random_id) {
                            int i15 = tL_updateMessageID.f19412id;
                            ArrayList arrayList = v0Var.f15958r;
    ...
    public final void p() {
        ...
        if (icVar == null || !icVar.f25673l) {
            ...
            ic f10 = ic.f(this.f15951b, this.U, -1);
            this.T = f10;
            f10.f25679r = false;
            f10.k(true);
            this.T.v = zVar;
        ...
        this.U.f23921b.setText(getStarsToastTitle());
        this.U.f23922c.setText(getStarsToastSubtitle());
        this.W.f23614b = 5000L;
        AndroidUtilities.cancelRunOnUIThread(zVar);
        ...
        int[] iArr2 = r1Var.f15808f;
        gj0 gj0Var = new gj0(iArr2[Utilities.fastRandom.nextInt(iArr2.length)], AndroidUtilities.dp(70.0f), AndroidUtilities.dp(70.0f));
        gj0Var.f25176s0 = r1Var;
        gj0Var.H(true);
        gj0Var.I(0);
        gj0Var.start();
        arrayList.add(gj0Var);
        r1Var.invalidate();
        org.telegram.ui.Components.j6 j6Var = r1Var.f15807c;
        j6Var.b();
        ...
        long j11 = currentTimeMillis - s1Var.f15853y;
        if (j11 < 100) {
            s1Var.B += 0.5f;
        } else {
            ...
            s1Var.B = 0.0f;
            s1Var.f15853y = currentTimeMillis;
        }
        j();
    }
    ...
    public final boolean r(long j10, TLRPC.InputGroupCall inputGroupCall) {
        ...
        if (inputGroupCall2 == null) {
            ...
            j11 = inputGroupCall2.f19176id;
        }
        if (inputGroupCall != null) {
            j12 = inputGroupCall.f19176id;
        }
        if (j11 != j12) {
            this.f15958r.clear();
            z4 = true;
    ...
    public void setLivePlayer(e1 e1Var) {
        ...
        this.M = e1Var;
        if (z4 && e1Var != null && (arrayList = e1Var.R) != null && (arrayList2 = e1Var.S) != null && arrayList != (arrayList3 = this.f15958r) && arrayList2 != (arrayList4 = this.f15959s) && arrayList3.isEmpty() && arrayList4.isEmpty()) {
    ...
    public final void t() {
        ...
        int i16 = 0;
        while (true) {
            ArrayList arrayList3 = this.f15958r;
            if (i16 >= arrayList3.size()) {
                break;
            }
            t0 t0Var3 = (t0) arrayList3.get(i16);
            int e6 = e(t0Var3.f15878c);
            if (e6 != t0Var3.h) {
                t0Var3.h = e6;
            }
            i16++;
        ...
        int i17 = 0;
        while (true) {
            rb1 rb1Var = this.f15956f;
            if (i17 >= rb1Var.getChildCount()) {
                break;
            }
            View childAt2 = rb1Var.getChildAt(i17);
            if ((childAt2 instanceof s0) && (u0Var = (s0Var = (s0) childAt2).f15843f) != null) {
                int e10 = e(u0Var.f15928b);
        ...
        while (true) {
            ArrayList arrayList4 = this.f15959s;
            if (i10 < arrayList4.size()) {
                u0 u0Var3 = (u0) arrayList4.get(i10);
                int e11 = e(u0Var3.f15928b);
                if (e11 != u0Var3.e) {
                    u0Var3.e = e11;
                }
                i10++;
    ...
    public final void u(boolean z4) {
        ...
        if (z4) {
            ...
            ViewPropertyAnimator animate2 = rb1Var.animate();
            if (this.G) {
                dp4 = 0.0f;
            } else {
            ...
            translationY2.alpha(f10).setInterpolator(mrVar).setDuration(420L).start();
            return;
        }
        if (!isEmpty) {
            dp = 0.0f;
