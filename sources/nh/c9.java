...
public final class c9 {
    ...
    public final ArrayList f17485f;
            ...
            if (tL_privacyValueDisallowUsers != null) {
                ...
                while (i11 < tL_privacyValueDisallowUsers.users.size()) {
                    ...
                    if (!(inputUser instanceof TLRPC.TL_inputUserEmpty)) {
                        ...
                        this.f17483c.add(l10);
                        this.f17484e.add(inputUser);
                    }
                    i11++;
                }
                this.f17482b.add(tL_inputPrivacyValueDisallowUsers);
            }
            ...
            if (tL_privacyValueAllowUsers != null) {
                ...
                while (i11 < tL_privacyValueAllowUsers.users.size()) {
                    ...
                    if (inputUser2 != null && !(inputUser2 instanceof TLRPC.TL_inputUserEmpty)) {
                        ...
                        this.f17483c.add(l11);
                        this.f17484e.add(inputUser2);
                    }
                    i11++;
                }
                this.f17482b.add(tL_inputPrivacyValueAllowUsers);
                ...
                if (tL_privacyValueDisallowUsers2 != null) {
                    ...
                    while (i11 < tL_privacyValueDisallowUsers2.users.size()) {
                        ...
                        if (!(inputUser3 instanceof TLRPC.TL_inputUserEmpty)) {
                            ...
                            this.f17483c.add(l12);
                            this.f17484e.add(inputUser3);
                        }
                        i11++;
                    }
                    this.f17482b.add(tL_inputPrivacyValueDisallowUsers2);
                }
            } else {
                this.f17481a = 4;
            }
    ...
    public final boolean b(TLRPC.User user) {
        ...
        if (i10 == 4) {
            return !arrayList.contains(Long.valueOf(user.f22539id));
        }
        if (i10 == 2) {
            if (arrayList.contains(Long.valueOf(user.f22539id)) || !user.contact) {
                return false;
            }
            return true;
        } else if (i10 == 1) {
            ...
            if (i10 == 3) {
                if (arrayList.contains(Long.valueOf(user.f22539id))) {
                    return true;
                }
                for (ArrayList arrayList2 : this.d.values()) {
                    if (arrayList2.contains(Long.valueOf(user.f22539id))) {
                        return true;
                    }
                }
            }
    ...
    public c9(int i10, ArrayList arrayList, int i11) {
        ...
        if (i10 == 4) {
            ...
            while (i12 < arrayList.size()) {
                ...
                if (inputUser != null) {
                    tL_inputPrivacyValueDisallowUsers.users.add(inputUser);
                    this.f17483c.add(Long.valueOf(inputUser.user_id));
                    this.f17484e.add(inputUser);
                }
                i12++;
            }
            ...
            while (i12 < arrayList.size()) {
                ...
                if (inputUser2 != null) {
                    tL_inputPrivacyValueDisallowUsers2.users.add(inputUser2);
                    this.f17483c.add(Long.valueOf(inputUser2.user_id));
                    this.f17484e.add(inputUser2);
                }
                i12++;
            }
            ...
            if (i10 == 5) {
                while (i12 < arrayList.size()) {
                    ...
                    if (inputUser3 != null) {
                        this.f17485f.add(Long.valueOf(inputUser3.user_id));
                    }
                    i12++;
                }
            }
            ...
            if (!arrayList.isEmpty()) {
                while (i12 < arrayList.size()) {
                    ...
                    if (inputUser4 != null) {
                        ...
                        this.f17483c.add(Long.valueOf(inputUser4.user_id));
                        this.f17484e.add(inputUser4);
                    }
                    i12++;
                }
            }
