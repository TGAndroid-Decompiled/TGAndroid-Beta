...
public final class m3 extends a8 {
    public final i9 f15583u0;
    public final org.telegram.ui.ActionBar.f6 f15584v0;
    public final d4 f15585w0;
    ...
    public final void F(org.telegram.ui.Components.u5 u5Var) {
        if (u5Var != null) {
            d4 d4Var = this.f15585w0;
            if (d4Var.N1 != null) {
                TLRPC.Document document = u5Var.document;
                if (document == null) {
                    document = org.telegram.ui.Components.l5.f(d4Var.f15243z2, u5Var.documentId);
                }
                if (document != null) {
                    i3 i3Var = d4Var.Z0;
                    org.telegram.ui.ActionBar.f6 f6Var = this.f15584v0;
                    ic h = new qc(i3Var, f6Var).h(document, 2, new kh.h(this, this.f15583u0, f6Var, 4));
                    if (h != null) {
                        h.f25665a = 1;
                        h.k(true);
                    }
    ...
    public final void G(CharacterStyle characterStyle, View view) {
        ...
        i9 i9Var = this.f15583u0;
        d4 d4Var = this.f15585w0;
        if (z4) {
            TLRPC.User user = MessagesController.getInstance(d4Var.f15243z2).getUser(Utilities.parseLong(((p51) characterStyle).getURL()));
            if (user != null) {
                MessagesController.getInstance(d4Var.f15243z2).openChatOrProfileWith(user, null, i9Var.f15441f, 0, false);
            }
            ...
            if (b10 != null) {
                ...
                if (url.startsWith("@")) {
                    MessagesController.getInstance(d4Var.f15243z2).openByUserName(lowerCase, i9Var.f15441f, 0, null);
                    return;
                } else {
            ...
            org.telegram.ui.b.m(R.string.TextCopied, new qc(d4Var.Z0, this.f15584v0));
    ...
    public final void H(final URLSpan uRLSpan, final View view, n5 n5Var) {
        ...
        final org.telegram.ui.ActionBar.f6 f6Var2 = this.f15584v0;
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() {
            ...
            public final void onClick(DialogInterface dialogInterface, int i10) {
                ...
                if (i10 == 0) {
                    ...
                    new qc(m3Var.f15585w0.Z0, f6Var2).k(false).j();
                }
            }
        };
    ...
    public final void I(v7 v7Var) {
        ...
        final TLRPC.Document document = v7Var.f15979g;
        d4 d4Var = this.f15585w0;
        i9 i9Var = this.f15583u0;
        final org.telegram.ui.ActionBar.f6 f6Var = this.f15584v0;
        if (document != null) {
            ...
            F.l(R.drawable.msg_saved, LocaleController.getString(R.string.StoryAudioAddToSavedMessages), new Runnable(this) {
                ...
                public final void run() {
                    ...
                    switch (r4) {
                        case 0:
                            d4 d4Var2 = this.f15496b.f15585w0;
                            SendMessagesHelper sendMessagesHelper = SendMessagesHelper.getInstance(d4Var2.f15243z2);
                            TLRPC.TL_document tL_document = (TLRPC.TL_document) document;
                            long clientUserId = UserConfig.getInstance(d4Var2.f15243z2).getClientUserId();
                            b4 b4Var = d4Var2.L1;
                            if (b4Var != null) {
                                storyItem = b4Var.f15091a;
                            } else {
                                storyItem = null;
                            }
                            ...
                            return;
                        default:
                            d4 d4Var3 = this.f15496b.f15585w0;
                            ...
                            if (MediaController.getInstance().currentSavedMusicList != null && MediaController.getInstance().currentSavedMusicList.dialogId == UserConfig.getInstance(d4Var3.f15243z2).getClientUserId()) {
                                MediaController.getInstance().currentSavedMusicList.add(document2);
                            }
                            ConnectionsManager.getInstance(d4Var3.f15243z2).sendRequest(tL_account_saveMusic, null);
            ...
            F.Z();
        } else if (v7Var.e && v7Var.f15976b != null && v7Var.d != null) {
            Bundle bundle = new Bundle();
        ...
        } else if (v7Var.f15976b != null && v7Var.f15977c != null) {
            MessagesController.getInstance(d4Var.f15243z2).getStoriesController().d0(v7Var.f15976b.longValue(), v7Var.f15977c.intValue(), new gg.n1(this, v7Var, i9Var, f6Var, 1));
        } else {
    ...
    public final void M(int i10, String str, CharacterStyle characterStyle, boolean z4) {
        ...
        if (i10 != 0 && i10 != 2) {
            if (i10 == 1) {
                org.telegram.ui.Components.z4.r0(i9Var.f15441f, str, true, true, false, false, null, null, this.f15584v0);
                return;
            }
            return;
        }
        if ((characterStyle instanceof o51) && (s01Var = ((o51) characterStyle).f27467a) != null && (s01Var.f28632a & 1024) != 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        org.telegram.ui.Components.z4.r0(i9Var.f15441f, str, true, true, true, z10, null, null, this.f15584v0);
    }
}
