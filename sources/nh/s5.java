    ...
    public final void run(final TLObject tLObject, TLRPC.TL_error tL_error) {
        switch (this.f15879a) {
            case 0:
                ...
                if (updates != null) {
                    t6 t6Var = this.f15880b;
                    MessagesController.getInstance(t6Var.f15917a).processUpdateArray(updates.updates, updates.users, updates.chats, false, updates.date);
                    AndroidUtilities.runOnUIThread(new x5(t6Var, 1));
                    return;
                }
                return;
            case 1:
                AndroidUtilities.runOnUIThread(new lh.p6(this.f15880b, tLObject, tL_error, 5));
                return;
            case 2:
                final t6 t6Var2 = this.f15880b;
