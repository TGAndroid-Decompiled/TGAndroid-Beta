...
public final class v2 implements xj {
    ...
    public final void l(ArrayList arrayList, String str, ArrayList arrayList2, ArrayList arrayList3, boolean z4, int i10, long j10, boolean z10, long j11) {
        ...
        boolean z11;
        d4 d4Var = this.f15965a;
        TL_stories.StoryItem storyItem = d4Var.L1.f15091a;
        if (storyItem != null && !(storyItem instanceof TL_stories.TL_storyItemSkipped)) {
            accountInstance = d4Var.getAccountInstance();
            SendMessagesHelper.prepareSendingDocuments(accountInstance, (ArrayList<String>) arrayList, (ArrayList<String>) arrayList, (ArrayList<Uri>) null, str, (String) null, d4Var.f15238y1, (MessageObject) null, (MessageObject) null, storyItem, (pn) null, (MessageObject) null, z4, i10, (t0.i) null, (SendMessageChatArguments) null, 0L, false, j11);
            if (j11 <= 0) {
                z11 = true;
            } else {
                z11 = false;
    ...
    public final void x() {
        try {
            ...
            intent.setType("*/*");
            org.telegram.ui.ActionBar.p2 p2Var = this.f15965a.G0.f15441f;
