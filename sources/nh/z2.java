...
public final class z2 extends FrameLayout {
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        switch (this.f16090a) {
            case 0:
                d4 d4Var = this.f16091b;
                if (d4Var.C2.getVisibility() == 0 && d4Var.C2.getLayoutParams().width != (x10 = (int) (((d4Var.f15235x2.getX() + d4Var.f15235x2.getMeasuredWidth()) - d4Var.C2.getX()) + AndroidUtilities.dp(10.0f)))) {
    ...
    public boolean verifyDrawable(Drawable drawable) {
        switch (this.f16090a) {
            case 1:
                if (drawable != this.f16091b.O0 && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            case 2:
                if (drawable != this.f16091b.N0 && !super.verifyDrawable(drawable)) {
                    return false;
                }
                return true;
            default:
