...
public final class p8 extends k8 {
    ...
    public p8(Context context, m8 m8Var, TL_stories.TL_mediaAreaSuggestedReaction tL_mediaAreaSuggestedReaction, bz bzVar) {
        ...
        str = str == null ? MessageObject.findAnimatedEmojiEmoticon(org.telegram.ui.Components.l5.f(bzVar.f33049b, d.f14108g)) : str;
        ...
        if (this.F.f14107f != null && (tL_availableReaction = MediaDataController.getInstance(UserConfig.selectedAccount).getReactionsMap().get(this.F.f14107f)) != null) {
