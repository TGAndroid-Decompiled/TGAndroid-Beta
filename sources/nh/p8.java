...
public final class p8 extends k8 {
    ...
    public p8(Context context, m8 m8Var, TL_stories.TL_mediaAreaSuggestedReaction tL_mediaAreaSuggestedReaction, dz dzVar) {
        ...
        str = str == null ? MessageObject.findAnimatedEmojiEmoticon(org.telegram.ui.Components.l5.f(dzVar.f33558b, d.f14096g)) : str;
        ...
        if (this.F.f14095f != null && (tL_availableReaction = MediaDataController.getInstance(UserConfig.selectedAccount).getReactionsMap().get(this.F.f14095f)) != null) {
