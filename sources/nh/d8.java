...
public final class d8 extends View {
    ...
    public final org.telegram.ui.ActionBar.f6 f15278a;
    public final TextPaint f15279b;
    public final PorterDuffColorFilter f15280c;
    public StaticLayout d;
    public float e;
    public org.telegram.ui.Components.q5 f15281f;
    public final i90 h;
    public final Path f15282n;
    public final ArrayList f15283r;
    public final ArrayList f15284s;
    public boolean v;
    public boolean f15285w;
    public final Object f15286x;
    ...
    public d8(Context context, int i10, TLObject tLObject, Object obj, boolean z4, ArrayList arrayList, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        setBackground(org.telegram.ui.ActionBar.j6.Y(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19996i6, f6Var), 0, 8));
        setClickable(true);
        TextPaint textPaint = new TextPaint(1);
        this.f15279b = textPaint;
        textPaint.setTextSize(AndroidUtilities.dp(13.0f));
        int i11 = org.telegram.ui.ActionBar.j6.E8;
        textPaint.setColor(org.telegram.ui.ActionBar.j6.v0(i11, f6Var));
        this.f15280c = new PorterDuffColorFilter(org.telegram.ui.ActionBar.j6.v0(i11, f6Var), PorterDuff.Mode.SRC_IN);
        ...
        this.f15286x = obj;
        if (z4) {
            this.f15283r = new ArrayList();
            this.f15284s = new ArrayList();
            this.v = false;
            this.f15285w = false;
        ...
        this.f15284s = arrayList2;
        arrayList2.addAll(arrayList);
        if (this.f15284s.size() == 1) {
            MediaDataController.getInstance(i10).getStickerSet((TLRPC.InputStickerSet) this.f15284s.get(0), 0, false, new c8(this, 0));
            return;
        }
        set(this.f15284s.size());
        d(false);
    }
    ...
    public static void a(d8 d8Var, TLObject tLObject, Object obj, ArrayList arrayList, boolean[] zArr, int i10) {
        ...
        for (int i12 = 0; i12 < vector.objects.size(); i12++) {
            ...
            d8Var.f15283r.add(stickerSetCovered);
            TLRPC.StickerSet stickerSet = stickerSetCovered.set;
            if (stickerSet != null) {
                d8Var.f15284s.add(MediaDataController.getInputStickerSet(stickerSet));
        ...
        ArrayList arrayList2 = d8Var.f15283r;
        if (arrayList2 == null) {
            size = 0;
        } else {
        ...
        int i13 = i11 + size;
        if (d8Var.f15284s != null && arrayList != null && !arrayList.isEmpty()) {
            for (int i14 = 0; i14 < arrayList.size(); i14++) {
                TLRPC.InputStickerSet inputStickerSet = (TLRPC.InputStickerSet) arrayList.get(i14);
                long j10 = inputStickerSet.f19204id;
                int i15 = 0;
                while (true) {
                    if (i15 < d8Var.f15284s.size()) {
                        if (((TLRPC.InputStickerSet) d8Var.f15284s.get(i15)).f19204id == j10) {
                            break;
                        }
                        i15++;
                    } else {
                        d8Var.f15284s.add(inputStickerSet);
                        break;
                    }
                }
            }
        ...
        if (i13 == 1) {
            if (d8Var.f15283r.size() >= 1) {
                d8Var.set((TLRPC.StickerSetCovered) d8Var.f15283r.get(0));
    ...
    private void set(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        spannableString.setSpan(new ForegroundColorSpan(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, this.h.f25632a)), 0, spannableString.length(), 33);
        ...
        while (true) {
            if (i10 >= arrayList.size()) {
                document = null;
                break;
            } else if (arrayList.get(i10).f19190id == tL_messages_stickerSet.set.thumb_document_id) {
        ...
        if (document != null) {
            spannableString.setSpan(new org.telegram.ui.Components.u5(document, this.f15279b.getFontMetricsInt()), 0, 1, 33);
    ...
    public final void d(boolean z4) {
        ...
        if (z4) {
            boolean z10 = false;
            this.E = ValueAnimator.ofFloat(this.f15287y, 1.0f);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10 = this.f15287y;
        if (f10 < 1.0f) {
            i90 i90Var = this.h;
            i90Var.setAlpha((int) ((1.0f - f10) * 255.0f));
            Path path = this.f15282n;
            path.rewind();
        ...
        if (this.d != null) {
            ...
            if (this.f15287y > 0.0f) {
                ...
                this.f15279b.setAlpha((int) (this.f15287y * 255.0f));
                this.d.draw(canvas);
                org.telegram.ui.Components.u5.drawAnimatedEmojis(canvas, this.d, this.f15281f, 0.0f, null, 0.0f, 0.0f, 0.0f, this.f15287y, this.f15280c);
                canvas.restore();
            }
        }
    }
    ...
    public mv getAlert() {
        ...
        return new mv(null, getContext(), this.f15278a, this.f15284s);
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        int paddingBottom = getPaddingBottom() + AndroidUtilities.lerp(dp, height, this.f15287y) + paddingTop;
        if (z4) {
    ...
    public void setText(CharSequence charSequence) {
        ...
        StaticLayout staticLayout = new StaticLayout(charSequence, this.f15279b, measuredWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        this.d = staticLayout;
        ...
        this.f15281f = org.telegram.ui.Components.u5.update(0, this, this.f15281f, this.d);
    }
    ...
    private void set(TLRPC.StickerSetCovered stickerSetCovered) {
        ...
        if (document == null && (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered)) {
            ...
            for (int i10 = 0; i10 < arrayList.size(); i10++) {
                if (arrayList.get(i10).f19190id == stickerSetCovered.set.thumb_document_id) {
                    document = arrayList.get(i10);
                }
            }
            if (document == null && !arrayList.isEmpty()) {
    ...
    private void set(int i10) {
        ...
        i90 i90Var = this.h;
        if (z4 && this.f15285w) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickersEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, i90Var.f25632a), null));
        } else if (z4) {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsEmoji", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, i90Var.f25632a), null));
        } else {
            setText(AndroidUtilities.replaceSingleTag(LocaleController.formatPluralString("StoryContainsStickers", i10, new Object[0]), 0, org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f19966gc, i90Var.f25632a), null));
        }
    }
}
