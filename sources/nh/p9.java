...
public final class p9 implements Runnable {
    ...
    public final void run() {
        q9 q9Var = this.f15734a;
        int i10 = q9Var.f15793a;
        ...
        if (!arrayList.isEmpty()) {
            ...
            for (int i11 = 0; i11 < arrayList2.size(); i11++) {
                tL_stories_getPeerMaxIDs.f19400id.add(MessagesController.getInstance(i10).getInputPeer(((Long) arrayList2.get(i11)).longValue()));
            }
