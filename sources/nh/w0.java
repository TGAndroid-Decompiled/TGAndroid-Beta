...
public final class w0 implements Runnable {
    ...
    public final MessagesStorage f18774b;
    public final ArrayList f18775c;

    public w0(int i10, ArrayList arrayList, MessagesStorage messagesStorage) {
        this.f18773a = i10;
        this.f18774b = messagesStorage;
    ...
    public final void run() {
        switch (this.f18773a) {
            case 0:
                MessagesStorage messagesStorage = this.f18774b;
                ArrayList arrayList = this.f18775c;
                try {
            ...
            case 1:
                MessagesStorage messagesStorage2 = this.f18774b;
                ArrayList arrayList2 = this.f18775c;
            ...
            default:
                MessagesStorage messagesStorage3 = this.f18774b;
                ArrayList arrayList3 = this.f18775c;
                try {
