...
public final class p6 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.f15750a) {
            case 0:
                s6 s6Var = this.f15751b;
                long j10 = s6Var.G;
                String str = s6Var.f15884f;
                boolean z11 = s6Var.f15882b;
                ph.u6 u6Var = s6Var.f15883c;
                int i14 = s6Var.J.f15917a;
                if (tLObject instanceof TLRPC.Updates) {
                            ...
                            if (storyItem == null) {
                                ...
                                while (true) {
                                    ...
                                    if (i19 < arrayList2.size()) {
                                        ...
                                        storyItem.f19419id = tL_updateStoryID.f19438id;
                    ...
                    if (s6Var.v) {
                        ...
                        if (inputPeer != null) {
                            tL_stories_deleteStories.f19422id.add(Integer.valueOf(i16));
                ...
                } else if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && u6Var.f42405c0 != null && (hVar = u6Var.f42407d0) != null) {
                ...
                return;
            default:
                AndroidUtilities.runOnUIThread(new x5(this.f15751b.J, 2));
                return;
        }
    }
}
