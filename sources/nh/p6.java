...
public final class p6 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        switch (this.f15730a) {
            case 0:
                s6 s6Var = this.f15731b;
                long j10 = s6Var.G;
                String str = s6Var.f15864f;
                boolean z11 = s6Var.f15862b;
                ph.t6 t6Var = s6Var.f15863c;
                int i14 = s6Var.J.f15897a;
                if (tLObject instanceof TLRPC.Updates) {
                            ...
                            if (storyItem == null) {
                                ...
                                while (true) {
                                    ...
                                    if (i19 < arrayList2.size()) {
                                        ...
                                        storyItem.f19394id = tL_updateStoryID.f19413id;
                    ...
                    if (s6Var.v) {
                        ...
                        if (inputPeer != null) {
                            tL_stories_deleteStories.f19397id.add(Integer.valueOf(i16));
                ...
                } else if (tL_error != null && FileRefController.isFileRefError(tL_error.text) && t6Var.f42406c0 != null && (hVar = t6Var.f42408d0) != null) {
                ...
                return;
            default:
                AndroidUtilities.runOnUIThread(new x5(this.f15731b.J, 2));
                return;
        }
    }
}
