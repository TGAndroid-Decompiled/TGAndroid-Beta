...
public final class i5 implements fy {
    ...
    public final boolean k() {
        bg.b editText = ((bg.f4) this.f17884a.F0).getEditText();
    ...
    public final void x(long j10, TLRPC.Document document, String str, boolean z10) {
        ...
        if (editText != null) {
            ...
            try {
                ...
                if (document != null) {
                    y5Var = new org.telegram.ui.Components.y5(document.f22398id, 1.0f, editText.getPaint().getFontMetricsInt());
