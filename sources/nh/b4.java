...
public final class b4 {
    public TL_stories.StoryItem f15111a = null;
    public s6 f15112b = null;
    public TL_stories.StoryItem f15113c;
    public boolean d;
    public boolean e;
    ...
    public static String c(b4 b4Var) {
        ...
        if (storyItem != null && (messageMedia = storyItem.media) != null) {
            if (messageMedia.photo != null) {
                ...
                sb.append(b4Var.f15111a.media.photo.f19208id);
                sb.append("at");
                return android.support.v4.media.a.m(b4Var.f15111a.media.photo.dc_id, "dc", sb);
            } else if (messageMedia.document != null) {
                StringBuilder sb2 = new StringBuilder("doc#");
                sb2.append(b4Var.f15111a.media.document.f19190id);
                sb2.append("at");
                return android.support.v4.media.a.m(b4Var.f15111a.media.document.dc_id, "dc", sb2);
            } else {
                return "unknown";
            }
        } else if (b4Var.f15112b != null) {
            return "uploading from " + b4Var.f15112b.e;
        } else {
            return "unknown";
        }
    }
    ...
    public final boolean d() {
        s6 s6Var = this.f15112b;
        if (s6Var != null) {
            return s6Var.f15883c.H0;
        }
        TL_stories.StoryItem storyItem = this.f15111a;
        if (storyItem != null) {
            if (storyItem.noforwards) {
                return false;
            }
            if (storyItem.pinned) {
                TLRPC.Chat chat = MessagesController.getInstance(this.f15118k.f15263z2).getChat(Long.valueOf(-storyItem.dialogId));
    ...
    public final String e() {
        d4 d4Var = this.f15118k;
        if (d4Var.L1.f15111a == null) {
            return null;
        }
        if (d4Var.f15258y1 > 0) {
            TLRPC.User user = MessagesController.getInstance(d4Var.f15263z2).getUser(Long.valueOf(d4Var.f15258y1));
            ...
            return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", UserObject.getPublicUsername(user), Integer.valueOf(d4Var.L1.f15111a.f19419id));
        }
        ...
        return String.format(Locale.US, "https://t.me/%1$s/s/%2$s", ChatObject.getPublicUsername(chat), Integer.valueOf(d4Var.L1.f15111a.f19419id));
    }
    ...
    public final v7 g() {
        ...
        if (this.f15116i == null && (storyItem = this.f15111a) != null) {
            ...
            if (document != null && (tL_documentAttributeAudio = (TLRPC.TL_documentAttributeAudio) AndroidUtilities.find(document.attributes, TLRPC.TL_documentAttributeAudio.class)) != null) {
                ...
                if (!TextUtils.isEmpty(str) || !TextUtils.isEmpty(str2)) {
                    v7Var = new v7();
                    v7Var.f15998f = true;
                    v7Var.f15999g = document;
                    if (TextUtils.isEmpty(str)) {
                        v7Var.f16002k = new SpannableStringBuilder(v7.d()).append((CharSequence) " ").append((CharSequence) str2);
                    } else if (TextUtils.isEmpty(str2)) {
                        v7Var.f16002k = new SpannableStringBuilder(v7.d()).append((CharSequence) " ").append((CharSequence) str);
                    } else {
                        SpannableStringBuilder append = new SpannableStringBuilder(v7.d()).append((CharSequence) " ").append((CharSequence) str2);
                        v7Var.f16002k = append;
                        int length = append.length();
                        v7Var.f16002k.append((CharSequence) " ・ ");
                        v7Var.f16002k.setSpan(new CharacterStyle(), length, v7Var.f16002k.length(), 33);
                        v7Var.f16002k.append((CharSequence) str);
                    }
                }
            }
            this.f15116i = v7Var;
    ...
    public final File h() {
        ...
        if (storyItem != null) {
            ...
            if (messageMedia != null && messageMedia.getDocument() != null) {
                return FileLoader.getInstance(d4Var.f15263z2).getPathToAttach(this.f15111a.media.getDocument());
            }
            TLRPC.MessageMedia messageMedia2 = this.f15111a.media;
            if (messageMedia2 != null && (photo = messageMedia2.photo) != null) {
                ...
                File pathToAttach = FileLoader.getInstance(d4Var.f15263z2).getPathToAttach(closestPhotoSizeWithSize, true);
                if (!pathToAttach.exists()) {
                    return FileLoader.getInstance(d4Var.f15263z2).getPathToAttach(closestPhotoSizeWithSize, false);
                }
                return pathToAttach;
            }
            return null;
            ...
            if (storyItem != null) {
                ...
                if (storyItem.fwd_from != null) {
                    ...
                    if (peer != null) {
                        ...
                        v7Var.f15996b = Long.valueOf(peerDialogId);
                        if (peerDialogId >= 0) {
                            v7Var.f16002k = new SpannableStringBuilder(MessageObject.userSpan()).append((CharSequence) " ").append((CharSequence) UserObject.getUserName(MessagesController.getInstance(i11).getUser(Long.valueOf(peerDialogId))));
                        } else {
                            ...
                            v7Var.f16002k = append.append((CharSequence) str);
                        }
                    } else if (storyFwdHeader.from_name != null) {
                        v7Var.f16002k = new SpannableStringBuilder(MessageObject.userSpan()).append((CharSequence) " ").append((CharSequence) storyItem.fwd_from.from_name);
                    }
                    v7Var.f15998f = true;
                    TL_stories.StoryFwdHeader storyFwdHeader2 = storyItem.fwd_from;
                    if ((storyFwdHeader2.flags & 4) != 0) {
                        v7Var.f15997c = Integer.valueOf(storyFwdHeader2.story_id);
                    }
                    v7Var.c();
                    ...
                    if (tL_mediaAreaChannelPost != null && (chat2 = MessagesController.getInstance(i11).getChat(Long.valueOf(tL_mediaAreaChannelPost.channel_id))) != null) {
                        v7Var = new v7();
                        v7Var.f15996b = Long.valueOf(-chat2.f19184id);
                        v7Var.e = true;
                        v7Var.f15995a = i11;
                        v7Var.f15998f = true;
                        ...
                        v7Var.f16002k = new SpannableStringBuilder(groupSpan2).append((CharSequence) " ").append((CharSequence) chat2.title);
                    }
                }
                this.f15117j = v7Var;
            } else {
                ...
                if (s6Var != null) {
                    ...
                    if (u6Var != null) {
                        if (u6Var.f42425n) {
                            v7Var = new v7();
                            v7Var.f16002k = u6Var.f42429p;
                            String str2 = u6Var.f42435s;
                            v7Var.f16003l = str2;
                            v7Var.f15998f = TextUtils.isEmpty(str2);
                        } else if (u6Var.f42439u && (arrayList = u6Var.v) != null && arrayList.size() > 0) {
                            ...
                            if (p10 < 0 && (chat = MessagesController.getInstance(messageObject.currentAccount).getChat(Long.valueOf(-p10))) != null) {
                                v7Var = new v7();
                                v7Var.f15996b = Long.valueOf(p10);
                                v7Var.e = true;
                                v7Var.f15995a = messageObject.currentAccount;
                                v7Var.f15998f = true;
                                ...
                                v7Var.f16002k = new SpannableStringBuilder(groupSpan).append((CharSequence) " ").append((CharSequence) chat.title);
                            }
                        }
                    }
                    this.f15117j = v7Var;
    ...
    public final boolean k(long j10) {
        ...
        if (storyItem != null) {
            TLRPC.MessageMedia messageMedia = storyItem.media;
            if ((messageMedia instanceof TLRPC.TL_messageMediaVideoStream) && j10 == ((TLRPC.TL_messageMediaVideoStream) messageMedia).call.f19201id) {
                return true;
            }
            return false;
        }
    ...
    public final void o() {
        ...
        if (s6Var != null) {
            CharSequence charSequence = s6Var.f15883c.C0;
            this.h = charSequence;
            ...
            TLRPC.User user = MessagesController.getInstance(d4Var.f15263z2).getUser(Long.valueOf(d4Var.f15258y1));
            if (d4Var.f15258y1 < 0 || MessagesController.getInstance(d4Var.f15263z2).storyEntitiesAllowed(user)) {
        ...
        if (storyItem != null) {
            if (storyItem.translated && storyItem.translatedText != null && TextUtils.equals(storyItem.translatedLng, v31.B())) {
                this.f15115g = true;
                TLRPC.TL_textWithEntities tL_textWithEntities = b4Var.f15111a.translatedText;
                ...
                if (replaceEmoji2 != null && tL_textWithEntities.entities != null) {
                    ...
                    i10 = (d4Var.f15258y1 < 0 || MessagesController.getInstance(d4Var.f15263z2).storyEntitiesAllowed(MessagesController.getInstance(d4Var.f15263z2).getUser(Long.valueOf(d4Var.f15258y1)))) ? 1 : 1;
                    if (i10 != 0) {
            ...
            String str2 = b4Var.f15111a.caption;
            this.h = str2;
            CharSequence replaceEmoji3 = Emoji.replaceEmoji(str2, m3Var.V.getPaint().getFontMetricsInt(), false);
            this.h = replaceEmoji3;
            if (replaceEmoji3 != null && b4Var.f15111a.entities != null) {
                SpannableStringBuilder valueOf3 = SpannableStringBuilder.valueOf(MessageObject.replaceAnimatedEmoji(new SpannableStringBuilder(b4Var.f15111a.caption), b4Var.f15111a.entities, m3Var.V.getPaint().getFontMetricsInt(), false));
                ...
                MessageObject.addEntitiesToText(valueOf3, b4Var.f15111a.entities, false, true, true, false, i10 ^ 1);
                this.h = valueOf3;
            }
        }
    }
