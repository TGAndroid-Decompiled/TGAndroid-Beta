...
public final class g8 extends FrameLayout {
    public final Paint f15347a;
    public final Paint f15348b;
    ...
    public g8(Context context, org.telegram.ui.ActionBar.f6 f6Var) {
        ...
        this.f15348b = paint2;
        paint.setColor(org.telegram.ui.ActionBar.j6.v0(org.telegram.ui.ActionBar.j6.f20116q7, f6Var));
        paint2.setColor(-1);
    ...
    public final void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(dp, height, AndroidUtilities.dp(10.0f), this.f15347a);
    ...
    public void set(TLRPC.TL_error tL_error) {
        TextView textView = this.f15349c;
