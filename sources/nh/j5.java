...
public final class j5 extends m2.a {
    ...
    public final Object e(m2.h hVar, int i10) {
        m5 m5Var = this.e;
        i5 i5Var = new i5(this, this.f15498c, this.d, m5Var.E, new mg.i(this, 2));
        i5Var.setTag(Integer.valueOf(i10));
        i5Var.setShadowDrawable(m5Var.f15594s);
        i5Var.setPadding(0, AndroidUtilities.dp(16.0f), 0, 0);
        i5Var.g(m5Var.f15597y, (l5) m5Var.C.get(i10));
