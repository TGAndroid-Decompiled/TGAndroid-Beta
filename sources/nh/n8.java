...
public final class n8 extends View {
    public int f15668a;
    public int f15669b;
    public final Matrix f15670c;
    public final Paint[] d;
    public final org.telegram.ui.Components.z5 e;
    public boolean f15671f;
    public int h;
    public final Drawable[] f15672n;
    public final float[] f15673r;
    public boolean f15674s;
    public final Paint v;
    public final Path f15675w;
    public final rc f15676x;

    public n8(Context context) {
        super(context);
        this.f15670c = new Matrix();
        this.d = r0;
        this.e = new org.telegram.ui.Components.z5(this, 0L, 260L, nr.h);
        this.f15672n = new Drawable[2];
        this.f15673r = new float[2];
        Paint paint = new Paint(1);
        this.v = paint;
        this.f15675w = new Path();
        this.f15676x = new rc(this, 0.6f, 5.0f);
    ...
    public final void a(boolean z4, s6 s6Var, boolean z10) {
        ...
        this.f15671f = true;
        int i10 = 0;
        if (s6Var != null && (d8Var = s6Var.f15883c.E0) != null) {
            int i11 = d8Var.f41466a;
    ...
    public final void c(float f10, int i10) {
        ...
        Drawable[] drawableArr = this.f15672n;
        Drawable drawable = drawableArr[0];
        drawableArr[1] = drawable;
        float[] fArr = this.f15673r;
        fArr[1] = fArr[0];
    ...
    public final void d(int i10, int i11) {
        ...
        if (this.f15668a == i10 && this.f15669b == i11) {
            return;
        }
        this.f15668a = i10;
        this.f15669b = i11;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float a2 = this.f15676x.a(0.075f);
        canvas.save();
        ...
        if (drawable != null && d > 0.5f) {
            ...
            c3 = 0;
            f10 = 12.0f;
            drawableArr[1].setBounds((int) org.telegram.messenger.y3.A(fArr[1], 2.0f, abs, centerX2), (int) (centerY - f12), (int) (f12 + centerX2), (int) vh.v2.c(fArr[1], 2.0f, abs, rectF.centerY()));
        ...
        if (drawableArr[c3] != null && d <= f11) {
            ...
            drawableArr[c3].setBounds((int) org.telegram.messenger.y3.A(fArr[c3], 2.0f, abs, centerX), (int) (centerY2 - f13), (int) (f13 + centerX), (int) vh.v2.c(fArr[c3], 2.0f, abs, rectF.centerY()));
            drawableArr[c3].draw(canvas);
        }
        if (this.f15674s) {
            Path path = this.f15675w;
            path.rewind();
