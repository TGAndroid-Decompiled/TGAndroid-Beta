...
public final class n8 extends View {
    ...
    public int h;
    public final Drawable[] f15652n;
    public final float[] f15653r;
    public boolean f15654s;
    public final Paint v;
    public final Path f15655w;
    public final rc f15656x;
    ...
    public n8(Context context) {
        ...
        this.f15652n = new Drawable[2];
        this.f15653r = new float[2];
        Paint paint = new Paint(1);
        this.v = paint;
        this.f15655w = new Path();
        this.f15656x = new rc(this, 0.6f, 5.0f);
    ...
    public final void a(boolean z4, s6 s6Var, boolean z10) {
        ...
        this.f15651f = true;
        int i10 = 0;
        if (s6Var != null && (c8Var = s6Var.f15863c.E0) != null) {
            int i11 = c8Var.f41437a;
    ...
    public final void c(float f10, int i10) {
        ...
        Drawable[] drawableArr = this.f15652n;
        Drawable drawable = drawableArr[0];
        drawableArr[1] = drawable;
        float[] fArr = this.f15653r;
        fArr[1] = fArr[0];
    ...
    public final void d(int i10, int i11) {
        ...
        if (this.f15648a == i10 && this.f15649b == i11) {
            return;
        }
        this.f15648a = i10;
        this.f15649b = i11;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float a2 = this.f15656x.a(0.075f);
        canvas.save();
        ...
        if (drawable != null && d > 0.5f) {
            ...
            c3 = 0;
            f10 = 12.0f;
            drawableArr[1].setBounds((int) org.telegram.messenger.y3.A(fArr[1], 2.0f, abs, centerX2), (int) (centerY - f12), (int) (f12 + centerX2), (int) vh.w2.c(fArr[1], 2.0f, abs, rectF.centerY()));
        ...
        if (drawableArr[c3] != null && d <= f11) {
            ...
            drawableArr[c3].setBounds((int) org.telegram.messenger.y3.A(fArr[c3], 2.0f, abs, centerX), (int) (centerY2 - f13), (int) (f13 + centerX), (int) vh.w2.c(fArr[c3], 2.0f, abs, rectF.centerY()));
            drawableArr[c3].draw(canvas);
        }
        if (this.f15654s) {
            Path path = this.f15655w;
            path.rewind();
