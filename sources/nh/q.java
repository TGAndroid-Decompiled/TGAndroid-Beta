...
public abstract class q extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, xd.b {
    ...
    public float W;
    public final xd.a f15755a;
    public float f15756a0;
    public final int f15757b;
    public final oy f15758b0;
    public final Drawable f15759c;
    public CharSequence f15760c0;
    public final l d;
    public boolean f15761d0;
    public int e;
    public int f15762e0;
    public final int f15763f;
    public SpannableStringBuilder f15764f0;
    public ValueAnimator f15765g0;
    public final i h;
    public o f15766h0;
    public boolean f15767i0;
    public boolean f15768j0;
    public float f15769k0;
    public int f15770l0;
    public p m0;
    public kj0 f15771n;
    public org.telegram.ui.ActionBar.k f15772n0;
    public j7 f15773o0;
    public float f15774p0;
    public final float f15775q0;
    public final i f15776r;
    public final float f15777r0;
    public final t6 f15778s;
    public final float f15779s0;
    public final e5.f f15780t0;
    public LinearGradient f15781u0;
    public final ArrayList v;
    public Matrix f15782v0;
    public final ArrayList f15783w;
    public Paint f15784w0;
    public final ArrayList f15785x;
    public boolean f15786x0;
    public final ArrayList f15787y;
    public final float f15788y0;
    public ValueAnimator f15789z0;

    public q(Context context, oy oyVar, int i10, int i11) {
        super(context);
        float f10;
        this.f15755a = new xd.a(1, this, nr.h, 380L, false);
        this.v = new ArrayList();
        this.f15783w = new ArrayList();
        this.f15785x = new ArrayList();
        this.f15787y = new ArrayList();
        gx gxVar = (gx) this;
        ...
        this.f15763f = i10;
        this.f15758b0 = oyVar;
        this.f15774p0 = AndroidUtilities.dp(68.0f);
        this.f15778s = MessagesController.getInstance(i10).getStoriesController();
        ...
        this.f15759c = getContext().getDrawable(R.drawable.msg_mini_addstory);
    ...
    public final void b() {
        int i10;
        this.K = 1.0f - AndroidUtilities.lerp(1.0f - this.W, 1.0f, 1.0f - this.f15756a0);
        d();
        float f10 = this.K;
        if (f10 == 1.0f) {
            i10 = 2;
        ...
        if (this.L != i10) {
            ...
            if (i11 == 0) {
                ...
                if (i11 == 1) {
                    ...
                    int i13 = 0;
                    while (true) {
                        ArrayList arrayList2 = this.f15785x;
                        if (i13 >= arrayList2.size()) {
                            break;
                        }
                        if (((n) arrayList2.get(i13)).f15651c != UserConfig.getInstance(i12).getClientUserId() || m()) {
                            arrayList.add(Long.valueOf(((n) arrayList2.get(i13)).f15651c));
                            if (arrayList.size() == 3) {
                                break;
                            }
                        }
    ...
    public final void c() {
        ...
        f2.i0 i0Var = this.P;
        int N02 = i0Var.N0() + 10;
        ArrayList arrayList = this.f15785x;
        int size = arrayList.size();
        t6 t6Var = this.f15778s;
        boolean z4 = false;
        if (N02 > size || ((N0 = i0Var.N0() + 9) < arrayList.size() && t6Var.D(0, ((n) arrayList.get(N0)).f15651c) == 0)) {
            if (this.f15757b == 1) {
                z4 = true;
            }
            if (z4) {
    ...
    public final void d() {
        ...
        int i11;
        int i12;
        float a2 = k7.n.a(Math.min(this.K, this.f15756a0), 0.0f, 1.0f);
        float f10 = this.f15755a.e;
        float f11 = 1.0f - f10;
        float f12 = f10 * a2;
        float f13 = f11 * a2;
        int i13 = 8;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        boolean z4;
        if (i10 == NotificationCenter.storiesUpdated && this.f15767i0) {
            if (getVisibility() == 0) {
                z4 = true;
            } else {
                z4 = false;
    ...
    public final int f(int i10) {
        oy oyVar = this.f15758b0;
        if (oyVar != null && oyVar.getResourceProvider() != null) {
            return oyVar.getThemedColor(i10);
        }
    ...
    public final void h() {
        ...
        arrayList.add(Long.valueOf(UserConfig.getInstance(this.f15763f).clientUserId));
        this.f15758b0.getOrCreateStoryViewer().F(getContext(), null, arrayList, 0, null, null, c7.a(this.f15776r), false);
    }
    ...
    public final void i(p pVar, boolean z4) {
        ...
        if ((!z4 || (valueAnimator = this.E0) == null || !valueAnimator.isRunning()) && pVar != null) {
            ...
            t6 t6Var = this.f15778s;
            if (z10 && !t6Var.H()) {
                if (!MessagesController.getInstance(this.f15763f).storiesEnabled()) {
                    n();
                } else {
                    j(0L);
                }
    ...
    public final void j(long j10) {
        ...
        if (i11 == 0 && (o10 = MessagesController.getInstance(i10).getStoriesController().o()) != null && o10.a(i10, 1)) {
            oyVar.showDialog(new eg.v0(o10.b(), this.f15763f, getContext(), this.f15758b0, null));
            return;
        }
        int i12 = 0;
        while (true) {
        ...
        if (i11 != 0) {
            if (oyVar != null) {
                f6Var = oyVar.getResourceProvider();
            }
    ...
    public final boolean k(long j10) {
        ...
        while (true) {
            ...
            if (i10 < arrayList.size()) {
                if (((n) arrayList.get(i10)).f15651c == j10) {
                    break;
                }
                i10++;
            } else {
    ...
    public final void l(float f10, boolean z4) {
        ...
        if (this.W != f10) {
            this.W = f10;
            b();
            if (f10 > this.f15788y0) {
                z10 = true;
            } else {
                z10 = false;
            }
            if (z10 != this.f15786x0) {
                this.f15786x0 = z10;
                ...
                if (z4) {
                    ...
                    this.f15789z0 = ofFloat;
                    ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) {
                        public final q f15131b;
                        ...
                        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                            switch (r2) {
                                case 0:
                                    q qVar = this.f15131b;
                                    qVar.getClass();
                                    qVar.f15756a0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                    qVar.b();
                                    return;
                                case 1:
                                    q qVar2 = this.f15131b;
                                    qVar2.getClass();
                                    qVar2.D0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                    return;
                                case 2:
                                    q qVar3 = this.f15131b;
                                    qVar3.getClass();
                                    qVar3.B0 = ((Float) valueAnimator.getAnimatedValue()).floatValue();
                                    return;
                                default:
                                    q qVar4 = this.f15131b;
                                    qVar4.getClass();
                    ...
                    this.f15789z0.setInterpolator(nr.h);
                    float f15 = this.W;
                    if (z10) {
                        f12 = f15;
                    } else {
                    ...
                    ArrayList arrayList = new ArrayList();
                    arrayList.add(this.f15789z0);
                    arrayList.add(this.C0);
                    if (this.f15786x0) {
                        this.H0.setDuration(1000L);
                        float f16 = this.f15756a0;
                        if (!z10) {
                            f13 = 0.0f;
                        }
                        ...
                        OvershootInterpolator overshootInterpolator = new OvershootInterpolator(this.f15777r0);
                        this.G0 = overshootInterpolator;
                        this.A0.setInterpolator(overshootInterpolator);
                        this.A0.setDuration(750L);
                        arrayList.add(this.A0);
                    } else {
                        float f17 = this.f15756a0;
                        if (!z10) {
                            f13 = 0.0f;
                        }
                        this.E0 = ValueAnimator.ofFloat(f17, f13);
                        this.E0.setInterpolator(new OvershootInterpolator(this.f15779s0));
    ...
    public final boolean m() {
        long j10 = UserConfig.getInstance(this.f15763f).clientUserId;
        t6 t6Var = this.f15778s;
        if (!t6Var.J(j10)) {
            if (!t6Var.H() || t6Var.f15921g.size() > 3) {
                return false;
            }
            return true;
        }
    ...
    public final void o() {
        ...
        if (m7.d != null) {
            ...
            int w03 = org.telegram.ui.ActionBar.j6.w0(null, org.telegram.ui.ActionBar.j6.f20141q7, false);
        ...
        AndroidUtilities.forEachViews((RecyclerView) this.h, new h5.d() {
            ...
            public final void accept(Object obj) {
                p pVar = (p) ((View) obj);
                pVar.invalidate();
                pVar.f15735y.setTextColor(textColor);
            }
        });
        AndroidUtilities.forEachViews((RecyclerView) this.f15776r, (h5.d) new e(2));
    }
    ...
    public final void onAttachedToWindow() {
        ...
        p(false, false);
        NotificationCenter.getInstance(this.f15763f).addObserver(this, NotificationCenter.storiesUpdated);
        cb.m mVar = this.I0;
        mVar.f2232a = true;
    ...
    public final void onDetachedFromWindow() {
        ...
        NotificationCenter.getInstance(this.f15763f).removeObserver(this, NotificationCenter.storiesUpdated);
        cb.m mVar = this.I0;
        mVar.f2232a = false;
    ...
    public final void p(boolean z4, boolean z10) {
        ...
        boolean z13;
        String string;
        if ((this.L == 1 || this.f15769k0 != 0.0f) && !z10) {
            this.H = true;
            return;
        }
        ArrayList arrayList3 = this.v;
        arrayList3.clear();
        ArrayList arrayList4 = this.f15785x;
        arrayList3.addAll(arrayList4);
        ArrayList arrayList5 = this.f15783w;
        arrayList5.clear();
        ArrayList arrayList6 = this.f15787y;
        arrayList5.addAll(arrayList6);
        arrayList4.clear();
        int i10 = this.f15757b;
        int i11 = this.f15763f;
        if (i10 != 1) {
        ...
        if (G) {
            ...
            if (t6Var.K(UserConfig.getInstance(i11).getClientUserId())) {
                ...
                if (string2.indexOf("…") > 0) {
                    if (this.f15764f0 == null) {
                        ...
                        o9Var.f15720a = k6Var;
                        o9Var.f15724n = true;
                        this.f15764f0 = valueOf;
                    }
                    this.f15760c0 = this.f15764f0;
                } else {
                    this.f15760c0 = string2;
                }
            } else {
                if (this.f15774p0 < AndroidUtilities.dp(50.0f)) {
                    string = null;
                } else {
                    string = LocaleController.getString(R.string.MyStory);
                }
                this.f15760c0 = string;
            }
        } else {
            arrayList2 = arrayList4;
            if (this.f15774p0 < AndroidUtilities.dp(50.0f)) {
            ...
            this.f15760c0 = formatPluralString;
        }
        if (!this.f15761d0) {
            CharSequence charSequence = this.f15760c0;
        ...
        if (TextUtils.isEmpty(this.f15760c0) && !this.f15761d0) {
            z12 = false;
        } else {
            z12 = true;
        }
        this.f15755a.a(z12, z4);
        arrayList6.clear();
        for (int i13 = 0; i13 < arrayList2.size(); i13++) {
            if (((n) arrayList2.get(i13)).f15651c != UserConfig.getInstance(i11).clientUserId || m()) {
    ...
    public void setOverscroll(float f10) {
        this.f15769k0 = f10 / AndroidUtilities.dp(90.0f);
        invalidate();
        this.h.invalidate();
    }
