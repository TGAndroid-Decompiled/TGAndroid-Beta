...
public final class o1 extends FrameLayout {
    public final FrameLayout f15692a;
    public final View f15693b;
    public final ImageView f15694c;
    public final n1 d;
    public boolean e;
    public ValueAnimator f15695f;
    public boolean h;
    public float f15696n;
    public ValueAnimator f15697r;
    ...
    public final void a(boolean z4, boolean z10) {
        ...
        this.e = z4;
        ValueAnimator valueAnimator = this.f15695f;
        ...
        if (!z10) {
            ...
            this.f15695f = ofFloat;
            ofFloat.addUpdateListener(new m1(this, 0));
            this.f15695f.setDuration(320L);
            this.f15695f.setInterpolator(nr.h);
            this.f15695f.start();
        }
        if (!this.h && z4) {
            z11 = false;
    ...
    public final void b(boolean z4, boolean z10) {
        ...
        int i11;
        this.h = z4;
        ImageView imageView = this.f15694c;
        if (!z10) {
            if (z4) {
    ...
    public final void c(boolean z4, boolean z10) {
        ValueAnimator valueAnimator = this.f15697r;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f15697r = null;
        }
        ...
        if (!z10) {
            ...
            view.setScaleX(1.0f - this.f15696n);
            view.setScaleY(1.0f - this.f15696n);
            this.f15694c.setColorFilter(new PorterDuffColorFilter(i0.a.d(this.f15696n, -1, -2960428), PorterDuff.Mode.SRC_IN));
            this.f15692a.invalidate();
            return;
        }
        float f11 = this.f15696n;
        if (z4) {
            f10 = 1.0f;
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(f11, f10);
        this.f15697r = ofFloat;
        ofFloat.addUpdateListener(new m1(this, 1));
        this.f15697r.setInterpolator(nr.h);
        this.f15697r.setDuration(420L);
        this.f15697r.start();
    }
}
