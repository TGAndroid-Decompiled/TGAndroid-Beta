...
public final class i9 implements NotificationCenter.NotificationCenterDelegate, org.telegram.ui.ActionBar.l2, ef.a {
    ...
    public static boolean f15442u1;
    public static TL_stories.StoryItem f15444w1;
    public static boolean f15445x1;
    public ph.k3 A0;
    public boolean B;
    public ph.k3 B0;
    ...
    public boolean Z;
    public boolean Z0;
    public float f15449a0;
    public s7 f15450a1;
    public float f15452b0;
    public final LongSparseIntArray f15453b1;
    public boolean f15455c0;
    public boolean f15456c1;
    public boolean f15457d0;
    public boolean f15458d1;
    public boolean f15459e0;
    public boolean f15460e1;
    public final org.telegram.ui.ActionBar.p2 f15461f;
    public GestureDetector f15462f0;
    public boolean f15463f1;
    public boolean f15464g0;
    public boolean f15465g1;
    public int h;
    public boolean f15466h0;
    public boolean f15467h1;
    public boolean f15468i0;
    public boolean f15469i1;
    public boolean f15470j0;
    public boolean f15471j1;
    public y8 f15472k0;
    public n5 f15473k1;
    public k3 l1;
    public int m0;
    public boolean f15475m1;
    public WindowManager f15476n;
    public boolean f15477n0;
    public float f15478n1;
    public float f15479o0;
    public boolean f15480o1;
    public final f9 f15481p0;
    public boolean f15482p1;
    public e9 f15483q0;
    public long f15484q1;
    public WindowManager.LayoutParams f15485r;
    public Dialog f15486r0;
    public x6 f15487r1;
    public w8 f15488s;
    public org.telegram.ui.ActionBar.l2 f15489s0;
    public ValueAnimator f15490s1;
    public boolean f15491t0;
    public boolean f15492t1;
    public final ArrayList f15493u0;
    public x8 v;
    public org.telegram.ui.o4 f15494v0;
    public m5 f15495w;
    public h9 f15496w0;
    public boolean f15497x;
    public e1 f15498x0;
    public a9 f15500y0;
    public SurfaceView f15501z0;
    public static final ArrayList f15443v1 = new ArrayList();
    public static float f15446y1 = 1.0f;
    public static boolean f15447z1 = true;
    public static final LongSparseArray B1 = new LongSparseArray();
    public boolean f15448a = SharedConfig.useSurfaceInStories;
    public boolean f15451b = true;
    public boolean f15454c = false;
    public boolean d = false;
    public boolean e = true;
    public final b f15499y = new b();
    public final RectF Q = new RectF();
    public final float[] f15474l0 = new float[2];

    public i9(org.telegram.ui.ActionBar.p2 p2Var) {
        ?? obj = new Object();
        obj.f15339k = 1.0f;
        this.f15481p0 = obj;
        this.f15493u0 = new ArrayList();
        this.E0 = true;
        this.G0 = new AnimationNotificationsLocker();
        this.J0 = new ArrayList();
        this.W0 = false;
        this.Y0 = new k3(this, 4);
        this.f15453b1 = new LongSparseIntArray();
        new Paint(1);
        this.f15461f = p2Var;
    }
    ...
    public static void J(long j10, TL_stories.StoryItem storyItem, Editable editable) {
        if (j10 != 0 && storyItem != null) {
            B1.put(j10 + (j10 >> 16) + (storyItem.f19419id << 16), editable);
        }
    }
    ...
    public static boolean i(i9 i9Var, w8 w8Var, float f10, float f11, boolean z4) {
        ...
        if (w8Var != null) {
            if (!i9Var.U0) {
                if (i9Var.f15495w == null || i9Var.f15452b0 == 0.0f) {
                    d4 currentPeerView = i9Var.f15472k0.getCurrentPeerView();
                    if (currentPeerView != null) {
                        if (!currentPeerView.G0(currentPeerView, ((f10 - i9Var.v.getX()) - i9Var.f15472k0.getX()) - currentPeerView.getX(), ((f11 - i9Var.v.getY()) - i9Var.f15472k0.getY()) - currentPeerView.getY(), z4)) {
                            if (currentPeerView.f15235s2) {
                                return false;
                            }
                        } else {
                            return true;
                    ...
                    if (currentPeerView != null && (o2Var2 = currentPeerView.Y1) != null && o2Var2.getVisibility() == 0) {
                        if (f11 > currentPeerView.Y1.getY() + currentPeerView.getY() + i9Var.f15472k0.getY() + i9Var.v.getY()) {
                            return true;
                        }
                    }
                    if ((currentPeerView != null && (o2Var = currentPeerView.Y1) != null && o2Var.w0()) || i9Var.f15487r1 != null) {
                        return true;
                    }
    ...
    public static void k(i9 i9Var) {
        ...
        if (i9Var.S != clamp01) {
            ...
            i9Var.o();
            d4 currentPeerView = i9Var.f15472k0.getCurrentPeerView();
            if (currentPeerView != null && currentPeerView.f15243u2) {
                currentPeerView.invalidate();
            }
            e1 e1Var = i9Var.f15498x0;
            if (e1Var != null) {
    ...
    public static CharSequence u(long j10, TL_stories.StoryItem storyItem) {
        ...
        return (CharSequence) B1.get(j10 + (j10 >> 16) + (storyItem.f19419id << 16), "");
    }

    public static boolean x(MessageObject messageObject) {
        if (f15444w1 == null || ((messageObject.type != 23 && !messageObject.isWebpage()) || f15445x1 || f15444w1.messageId != messageObject.getId() || f15444w1.messageType == 3)) {
            return false;
        }
        return true;
    }
    ...
    public final void A(int i10, Context context, TL_stories.StoryItem storyItem, ArrayList arrayList, int i11, l6 l6Var, TL_stories.PeerStories peerStories, e9 e9Var, boolean z4) {
        ...
        ArrayList arrayList2 = this.f15493u0;
        if (!isContextSafe) {
            arrayList2.clear();
            return;
        }
        ...
        f15446y1 = 1.0f;
        h9 h9Var = this.f15496w0;
        if (h9Var != null) {
            h9Var.setSpeed(1.0f);
        }
        boolean z14 = false;
        if (!AndroidUtilities.isTablet() && !this.f15480o1) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        this.f15485r.flags = -2147417728;
        this.E0 = false;
        this.Z0 = false;
        org.telegram.ui.ActionBar.p2 R = LaunchActivity.R();
        if (this.f15488s == null) {
            this.f15462f0 = new GestureDetector(new s8(this));
            this.f15488s = new w8(this, context, R);
        }
        if (this.v == null) {
            this.v = new x8(context, this);
            y8 y8Var2 = new y8(this, this.h, context, this, this.f15499y);
            this.f15472k0 = y8Var2;
            y8Var2.setDelegate(new z8(this, l6Var, arrayList, context));
            this.v.addView(this.f15472k0, k7.b6.e(-1, -1, 1));
            this.f15494v0 = new org.telegram.ui.o4(context);
            if (this.f15448a) {
                SurfaceView surfaceView = new SurfaceView(context);
                this.f15501z0 = surfaceView;
                surfaceView.setZOrderMediaOverlay(false);
                this.f15501z0.setZOrderOnTop(false);
                this.f15494v0.addView(this.f15501z0);
            } else {
                a9 a9Var = new a9(context, this);
                this.f15500y0 = a9Var;
                this.f15494v0.addView(a9Var);
            }
            ph.k3 k3Var = new ph.k3(context, this.h);
            this.A0 = k3Var;
            k3Var.setVisibility(8);
            this.f15494v0.addView(this.A0);
            ?? view = new View(context);
            Paint paint = new Paint(1);
            view.f15891a = paint;
            view.f15893c = new m2.b((Object) view, 4);
        ...
        AndroidUtilities.removeFromParent(this.f15494v0);
        this.f15488s.addView(this.f15494v0);
        SurfaceView surfaceView2 = this.f15501z0;
        if (surfaceView2 != null) {
            surfaceView2.setVisibility(4);
        }
        AndroidUtilities.removeFromParent(this.v);
        this.f15488s.addView(this.v);
        this.f15488s.setClipChildren(false);
        if (this.K0) {
            Q();
        }
        if (l6Var != null) {
            this.f15472k0.D(this.h, l6Var.d, l6Var.h());
        } else {
            y8 y8Var3 = this.f15472k0;
            int i13 = this.h;
            y8Var3.f15849x0 = arrayList;
            y8Var3.f15847v0 = i13;
            y8Var3.setAdapter(null);
            y8Var3.setAdapter(y8Var3.f15848w0);
            y8Var3.setCurrentItem(i11);
            y8Var3.f15851z0 = true;
        }
        this.f15476n = (WindowManager) context.getSystemService("window");
        if (R == null || R.getLayoutContainer() == null || R.isSupportEdgeToEdge()) {
            this.f15451b = false;
        }
        if (this.f15451b && R != null && R.isSupportEdgeToEdge()) {
            z13 = true;
        } else {
            z13 = false;
        }
        ...
        r0.b0.j(x8Var, m5Var);
        if (this.f15451b) {
            AndroidUtilities.removeFromParent(this.f15488s);
            this.f15488s.setTag(R.id.sheet_attached_to_fragment_tag, new Object());
            R.getLayoutContainer().addView(this.f15488s);
            if (!this.f15454c) {
                AndroidUtilities.requestAdjustResize(R.getParentActivity(), R.getClassGuid());
            }
        } else {
            this.f15488s.setFocusable(false);
            this.v.setFocusable(false);
            this.v.setSystemUiVisibility(1792);
            AndroidUtilities.setPreferredMaxRefreshRate(this.f15476n, this.f15488s, this.f15485r);
            this.f15476n.addView(this.f15488s, this.f15485r);
            if (Build.VERSION.SDK_INT >= 33 && (findOnBackInvokedDispatcher = this.f15488s.findOnBackInvokedDispatcher()) != null) {
                findOnBackInvokedDispatcher.registerOnBackInvokedCallback(0, new androidx.activity.r(this, 3));
            }
        }
        this.f15488s.requestLayout();
        f15445x1 = true;
        Q();
        this.R = 0.0f;
        o();
        ...
        if (f15447z1) {
            f15447z1 = false;
            if (((AudioManager) this.f15488s.getContext().getSystemService("audio")).getRingerMode() != 2) {
                z14 = true;
            }
            A1 = z14;
        }
    ...
    public final void D(Context context, long j10, e9 e9Var) {
        ...
        int i10 = storiesController.f15917a;
        ...
        if (y10 != null) {
            ...
            if (y10.stories.isEmpty() && !storiesController.J(j10)) {
                storiesController.f15921g.remove(y10);
    ...
    public final void I() {
        ...
        arrayList.clear();
        a0.h hVar = MessagesController.getInstance(this.h).getStoriesController().f15926m;
        ...
        org.telegram.ui.ActionBar.p2 p2Var = this.f15461f;
        if (p2Var != null) {
            p2Var.removeSheet(this);
        }
        f15443v1.remove(this);
        this.f15493u0.clear();
        this.f15452b0 = 0.0f;
        f15444w1 = null;
    }
    ...
    public final void K(boolean z4) {
        this.f15477n0 = z4;
        if (z4) {
            m2.b bVar = this.f15450a1.f15893c;
    ...
    public final void L(boolean z4) {
        ...
        if (this.X0 != z4) {
            this.X0 = z4;
            if (z4 && !this.f15456c1 && (currentPeerView2 = this.f15472k0.getCurrentPeerView()) != null && (b4Var = currentPeerView2.L1) != null && !b4Var.f15114f && b4Var.f15112b == null) {
                if (!this.f15466h0 && !this.f15464g0 && (c4Var = this.D0) != null && c4Var.f15142b != null) {
                    currentPeerView2.Z0.invalidate();
                    BotWebViewVibrationEffect.IMPACT_LIGHT.vibrate();
                }
                c4 c4Var2 = this.D0;
                if (c4Var2 != null && (h9Var = c4Var2.f15142b) != null && !this.f15466h0) {
    ...
    public final void M(boolean z4) {
        ...
        if (this.f15451b && launchActivity != null) {
            if (z4) {
                this.f15491t0 = AndroidUtilities.getLightNavigationBar(launchActivity.getWindow());
            }
            if (this.f15491t0) {
    ...
    public final void O() {
        ...
        d4 currentPeerView = this.f15472k0.getCurrentPeerView();
        if (currentPeerView != null) {
            currentPeerView.f15242u1.a(A1, true);
        }
        if (!A1) {
            this.f15450a1.b();
        }
    ...
    public final void P() {
        ...
        this.f15472k0.A0 = (this.f15497x || this.E0 || this.F0 || this.X0 || this.f15456c1 || this.f15452b0 != 0.0f || this.f15465g1) ? false : false;
    }
    ...
    public final void a(c2.p pVar) {
        ...
        if (this.f15451b) {
            AndroidUtilities.removeFromParent(this.f15488s);
            this.f15461f.getLayoutContainer().addView(this.f15488s);
        } else {
            this.f15476n.addView(this.f15488s, this.f15485r);
        }
        ...
        this.f15488s.invalidate();
        this.f15498x0.s(this.A0.getSink());
    }

    @Override
    public final boolean attachedToParent() {
        if (this.f15451b && this.f15488s != null) {
            return true;
        }
        return false;
    }
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        ...
        if (i10 == NotificationCenter.storiesListUpdated) {
            if (this.L0 == ((l6) objArr[0])) {
                ...
                m5 m5Var = this.f15495w;
                if (m5Var != null) {
                    TL_stories.StoryItem selectedStory = m5Var.getSelectedStory();
                    ArrayList arrayList2 = new ArrayList();
                    int i13 = 0;
                    while (i12 < this.L0.f15580i.size()) {
                        if (selectedStory != null && selectedStory.f19419id == ((MessageObject) this.L0.f15580i.get(i12)).storyItem.f19419id) {
                            i13 = i12;
                        }
                        arrayList2.add(((MessageObject) this.L0.f15580i.get(i12)).storyItem);
                        i12++;
                    }
                    this.f15495w.b(i13, this.L0.d, arrayList2);
                }
            }
        } else if (i10 == NotificationCenter.storiesUpdated) {
            e9 e9Var = this.f15483q0;
            if (e9Var instanceof c7) {
                c7 c7Var = (c7) e9Var;
                if (c7Var.f15168r && !c7Var.f15167n) {
                    t6 storiesController = MessagesController.getInstance(this.h).getStoriesController();
                    if (c7Var.f15166f) {
                    ...
                    ArrayList<Long> dialogIds = this.f15472k0.getDialogIds();
                    boolean z4 = false;
                    ...
                    if (z4) {
                        this.f15472k0.getAdapter().g();
                    }
                } else {
                    return;
                }
            }
            m5 m5Var2 = this.f15495w;
            if (m5Var2 != null) {
            ...
            if (i10 != i15 && i10 != NotificationCenter.articleClosed) {
                if (i10 == NotificationCenter.storyDeleted) {
                    ...
                    if (storyItem != null && storyItem.dialogId == longValue && storyItem.f19419id == intValue) {
                        this.P0 = true;
                        return;
                    }
                    return;
            ...
            if (i10 == i15) {
                h9 h9Var = this.f15496w0;
                if (h9Var != null) {
                    this.f15484q1 = h9Var.currentPosition;
                    this.f15496w0.release(null);
                    this.f15496w0 = null;
                    return;
                }
                this.f15484q1 = 0L;
            } else if (!this.f15482p1 && t() != null) {
                t().f1(false);
            }
        }
    }
    ...
    public final void e(c2.p pVar) {
        ...
        if (k3Var != null) {
            k3Var.setOnFirstFrameCallback(pVar);
            this.f15498x0.s(this.B0.getSink());
        }
        if (this.f15451b) {
            AndroidUtilities.removeFromParent(this.f15488s);
        } else {
            this.f15476n.removeView(this.f15488s);
        }
        this.f15488s.invalidate();
    }
    ...
    public final boolean g() {
        org.telegram.ui.ActionBar.p2 p2Var = this.f15461f;
        if (p2Var != null && t() != null && AndroidUtilities.findActivity(p2Var.getContext()) != null && this.f15498x0 != null && this.A0 != null && !this.E0) {
            return true;
        }
        return false;
    }
    ...
    public final void l(boolean z4) {
        ...
        if (!BuildVars.DEBUG_PRIVATE_VERSION) {
            ...
            if (this.e != z10) {
                this.e = z10;
                SurfaceView surfaceView = this.f15501z0;
                if (surfaceView != null) {
                ...
                if (z10) {
                    this.f15485r.flags &= -8193;
                    AndroidUtilities.logFlagSecure();
                } else {
                    this.f15485r.flags |= 8192;
                    AndroidUtilities.logFlagSecure();
                }
                try {
                    this.f15476n.updateViewLayout(this.f15488s, this.f15485r);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            }
    ...
    public final void m() {
        if (this.E == null) {
            ...
            this.E.setInterpolator(org.telegram.ui.ActionBar.r1.f20543w);
            this.E.start();
        }
    }

    public final void n(boolean z4) {
        if (this.f15490s1 == null) {
            if (this.m0 != 0) {
                AndroidUtilities.hideKeyboard(this.f15495w);
                return;
            }
            float f10 = 0.0f;
            if (!this.Z && this.f15452b0 == 0.0f) {
                return;
            }
            this.G0.lock();
            if (!z4) {
                float f11 = this.f15452b0;
                m5 m5Var = this.f15495w;
                float f12 = m5Var.f15610c;
                if (f11 == f12) {
                    float f13 = f12 - 1.0f;
                    this.f15452b0 = f13;
                    m5Var.setOffset(f13);
            ...
            float f14 = this.f15452b0;
            if (z4) {
                f10 = this.f15495w.f15610c;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(f14, f10);
            this.f15490s1 = ofFloat;
            ofFloat.addUpdateListener(new q8(this, 3));
            this.f15490s1.addListener(new dg.w2(7, this, z4));
            if (z4) {
                this.f15490s1.setDuration(350L);
                this.f15490s1.setInterpolator(nr.h);
            } else {
                this.f15490s1.setDuration(350L);
                this.f15490s1.setInterpolator(nr.f27346f);
            }
            this.f15490s1.start();
        }
    }
    ...
    public final void o() {
        ...
        if (this.f15451b && (launchActivity = LaunchActivity.D1) != null) {
    ...
    public final boolean onAttachedBackPressed() {
        ...
        if (this.f15452b0 != 0.0f) {
            ...
            if (currentPage != null) {
                j4 j4Var = currentPage.f15270r;
                s4 s4Var = currentPage.f15268f;
                if (s4Var != null && s4Var.f30078b) {
                    s4Var.a();
                    return true;
                } else if (Math.abs(currentPage.f15267c.getTranslationY() - j4Var.getPaddingTop()) > AndroidUtilities.dp(2.0f)) {
    ...
    public final void p() {
        ...
        if (currentPeerView != null) {
            if (this.L0 != null) {
                ArrayList arrayList = new ArrayList();
                for (int i10 = 0; i10 < this.L0.f15580i.size(); i10++) {
                    arrayList.add(((MessageObject) this.L0.f15580i.get(i10)).storyItem);
                }
                this.f15495w.b(currentPeerView.getListPosition(), this.L0.d, arrayList);
                return;
            }
            this.f15495w.b(currentPeerView.getSelectedPosition(), currentPeerView.getCurrentPeer(), currentPeerView.getStoryItems());
        }
    }

    public final void q(boolean z4) {
        AndroidUtilities.hideKeyboard(this.f15488s);
        this.E0 = true;
        this.f15460e1 = true;
        P();
        M(false);
    ...
    public final void r(KeyEvent keyEvent) {
        ...
        this.f15450a1.onKeyDown(keyEvent.getKeyCode(), keyEvent);
    }

    public final void s(Runnable runnable) {
        if (runnable != null) {
            this.f15493u0.add(runnable);
        }
    }
    ...
    public final void setKeyboardHeightFromParent(int i10) {
        if (this.m0 != i10) {
            this.m0 = i10;
            this.f15472k0.setKeyboardHeight(i10);
            this.f15472k0.requestLayout();
            m5 m5Var = this.f15495w;
            if (m5Var != null) {
    ...
    public final boolean w() {
        org.telegram.ui.ActionBar.p2 p2Var;
        if (!this.U0 && !this.W0 && !this.V0 && !this.I0 && !this.f15477n0 && !this.f15497x && this.f15486r0 == null && this.f15489s0 == null && !this.E0 && !this.F0 && this.R == 1.0f && this.f15452b0 == 0.0f && !this.f15463f1) {
            if ((!this.f15469i1 || !this.f15448a) && !this.f15467h1 && !this.f15465g1 && !this.f15475m1 && this.S == 0.0f && this.f15487r1 == null) {
                if (!this.f15451b || (p2Var = this.f15461f) == null || p2Var.getLastStoryViewer() == this) {
                    return false;
                }
                return true;
            }
    ...
    public final void z(boolean z4) {
        int i10;
        Activity findActivity = AndroidUtilities.findActivity(this.f15461f.getContext());
