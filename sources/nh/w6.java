...
public final class w6 extends View {
    ...
    public final gj0 f16014c;
    public final Paint d;
    public final TextPaint e;
    public final TextPaint f16015f;
    public final RectF h;
    public float f16016n;
    public final Rect f16017r;

    public w6(Context context, int i10, String str, String str2) {
        super(context);
        this.f16017r = new Rect();
        this.f16012a = str;
        this.f16013b = str2;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        int dp2 = (int) ((AndroidUtilities.dp(8.0f) * this.f16016n) + AndroidUtilities.dp(36.0f));
        int i10 = dp2 / 2;
        int i11 = dp - i10;
        int measuredHeight = (getMeasuredHeight() / 2) - i10;
        gj0 gj0Var = this.f16014c;
        gj0Var.setBounds(i11, measuredHeight, i11 + dp2, dp2 + measuredHeight);
        gj0Var.draw(canvas);
        if (this.f16016n > 0.0f) {
            float dpf2 = (1.0f - this.f16016n) * AndroidUtilities.dpf2(4.0f);
            float f10 = dpf2 * 2.0f;
            ...
            int i12 = (int) (this.f16016n * 30.0f);
            Paint paint = this.d;
            paint.setAlpha(i12);
            canvas.drawRoundRect(rectF, AndroidUtilities.dpf2(12.0f), AndroidUtilities.dpf2(12.0f), paint);
            canvas.save();
            float f11 = this.f16016n;
            canvas.scale((f11 * 0.05f) + 1.0f, (f11 * 0.05f) + 1.0f, getMeasuredWidth() / 2.0f, getMeasuredHeight() / 2.0f);
        }
        canvas.drawText(this.f16012a, AndroidUtilities.dpf2(80.0f), (getMeasuredHeight() / 2.0f) - AndroidUtilities.dpf2(4.0f), this.e);
        canvas.drawText(this.f16013b, AndroidUtilities.dpf2(80.0f), AndroidUtilities.dpf2(18.0f) + (getMeasuredHeight() / 2.0f), this.f16015f);
        if (this.f16016n > 0.0f) {
            canvas.restore();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f16014c.setBounds(i13, measuredHeight, i13 + dp2, dp2 + measuredHeight);
    }
}
