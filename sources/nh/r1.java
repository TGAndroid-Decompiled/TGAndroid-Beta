...
public final class r1 extends View {
    ...
    public final RectF f15826b;
    public final org.telegram.ui.Components.j6 f15827c;
    public final p1 d;
    public final ArrayList e;
    public final int[] f15828f;
    public final ArrayList h;
    public float f15829n;
    public ValueAnimator f15830r;
    public boolean f15831s;

    public r1(Context context, int i10) {
        super(context);
        this.f15826b = new RectF();
        nr nrVar = nr.f27346f;
        org.telegram.ui.Components.j6 j6Var = new org.telegram.ui.Components.j6(false, false, false, false);
        this.f15827c = j6Var;
        this.e = new ArrayList();
        this.f15828f = new int[]{R.raw.star_reaction_effect1, R.raw.star_reaction_effect2, R.raw.star_reaction_effect3, R.raw.star_reaction_effect4, R.raw.star_reaction_effect5};
    ...
    public final void a(float f10, p1 p1Var) {
        ValueAnimator valueAnimator = this.f15830r;
        if (valueAnimator != null) {
            this.f15830r = null;
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.f15829n, f10);
        this.f15830r = ofFloat;
        ofFloat.addUpdateListener(new dg.o1(this, 26));
        this.f15830r.addListener(new lh.k5(this, f10, p1Var, 1));
        this.f15830r.setInterpolator(nr.h);
        this.f15830r.setDuration(320L);
        this.f15830r.start();
    }
    ...
    public final void b() {
        ...
        this.f15827c.q("", true, true);
        invalidate();
        a(0.0f, new p1(this, 1));
    }

    public final void c(s1 s1Var) {
        this.f15826b.set(s1Var.getX() - getX(), s1Var.getY() - getY(), (s1Var.getX() - getX()) + s1Var.getWidth(), (s1Var.getY() - getY()) + s1Var.getHeight());
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10 = 1.0f;
        float lerp = AndroidUtilities.lerp(1.0f, 1.8f, r1Var.f15829n);
        ...
        while (true) {
            ...
            if (gj0Var.Y >= gj0Var.e[0]) {
                ...
                gj0Var.setAlpha((int) (r1Var.f15829n * 255.0f));
                gj0Var.draw(canvas2);
            }
            i11++;
        }
        ...
        while (true) {
            ...
            if (i12 < arrayList2.size()) {
                ...
                float f12 = q1Var.f15794c;
                float f13 = q1Var.f15793b;
                ImageReceiver imageReceiver = q1Var.f15795f;
                float d = q1Var.f15797i.d(f10, z4);
                float e = q1Var.f15798j.e(q1Var.h);
                float dp2 = AndroidUtilities.dp(23.0f) + q1Var.f15796g.f26084c;
                ...
                q1Var.f15796g.c(AndroidUtilities.dp(18.0f), f16, lerp2, -1, canvas3);
                canvas2 = canvas3;
                canvas2.restore();
                if (gj0Var2 != null) {
                    canvas2.save();
                ...
                if (d < 1.0f && e < 1.0f) {
                    ...
                    ((q1) arrayList2.get(i14)).f15795f.onDetachedFromWindow();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f15827c && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
