...
public final class s1 extends View {
    ...
    public final r1 f15844a;
    public final RectF f15845b;
    public final Path f15846c;
    public final wa d;
    public final org.telegram.ui.Components.z5 e;
    public final org.telegram.ui.Components.z5 f15847f;
    public final org.telegram.ui.Components.j6 h;
    public final Paint f15848n;
    public final Paint f15849r;
    public final Drawable f15850s;
    public final ng.i v;
    public int f15851w;
    ...
    public s1(Context context, r1 r1Var, qg.b bVar) {
        ...
        this.f15846c = new Path();
        mr mrVar = mr.h;
        this.e = new org.telegram.ui.Components.z5(this, 320L, mrVar);
        this.f15847f = new org.telegram.ui.Components.z5(this, 320L, mrVar);
        ...
        this.f15844a = r1Var;
        k7.d6.a(this);
        this.f15850s = context.getResources().getDrawable(R.drawable.star).mutate();
        ng.i iVar = new ng.i();
        this.v = iVar;
        iVar.a(bVar);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float e = this.e.e(this.f15852x);
        if (this.f15851w > 0) {
            z4 = true;
        } else {
            z4 = false;
        }
        float e6 = this.f15847f.e(z4);
        ...
        if (e6 > 0.0f) {
            ...
            canvas.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f15849r);
            rectF2.set(getWidth() - max, 0.0f, getWidth(), AndroidUtilities.dp(13.0f));
