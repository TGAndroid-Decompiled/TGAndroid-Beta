...
public final class s1 extends View {
    ...
    public final r1 f15864a;
    public final RectF f15865b;
    public final Path f15866c;
    public final wa d;
    public final org.telegram.ui.Components.z5 e;
    public final org.telegram.ui.Components.z5 f15867f;
    public final org.telegram.ui.Components.j6 h;
    public final Paint f15868n;
    public final Paint f15869r;
    public final Drawable f15870s;
    public final ng.i v;
    public int f15871w;
    ...
    public s1(Context context, r1 r1Var, qg.b bVar) {
        super(context);
        this.f15865b = new RectF();
        this.f15866c = new Path();
        nr nrVar = nr.h;
        this.e = new org.telegram.ui.Components.z5(this, 320L, nrVar);
        this.f15867f = new org.telegram.ui.Components.z5(this, 320L, nrVar);
        ...
        this.f15864a = r1Var;
        k7.d6.a(this);
        this.f15870s = context.getResources().getDrawable(R.drawable.star).mutate();
        ng.i iVar = new ng.i();
        this.v = iVar;
        iVar.a(bVar);
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (e6 > 0.0f) {
            ...
            canvas.drawRoundRect(rectF2, rectF2.height() / 2.0f, rectF2.height() / 2.0f, this.f15869r);
            rectF2.set(getWidth() - max, 0.0f, getWidth(), AndroidUtilities.dp(13.0f));
