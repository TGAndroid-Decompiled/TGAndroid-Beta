...
public final class o8 extends Drawable {
    ...
    public final Paint f15695c;
    public final Paint d;
    public final org.telegram.ui.Components.z5 f15697g;
    public boolean h;
    public Paint f15698i;
    public int e = 255;
    public final float[] f15696f = new float[15];
    public final Path f15699j = new Path();

    public o8(View view) {
        this.f15694b = view;
        this.f15697g = new org.telegram.ui.Components.z5(view, 350L, mr.h);
    ...
    public final void b(boolean z4, boolean z10) {
        ...
        if (!z10) {
            ...
            this.f15697g.d(f10, true);
            return;
        }
        this.f15694b.invalidate();
    }

    public final void c(float f10) {
        this.f15695c.setShadowLayer(AndroidUtilities.dp(2.0f) / f10, 0.0f, AndroidUtilities.dpf2(0.7f) / f10, i0.a.k(-16777216, 45));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        float d = this.f15697g.d(f10, false);
        int i16 = this.f15693a;
        Paint paint2 = this.d;
        if (i16 == 0) {
            paint2.setColor(-1);
        } else if (i16 == 1) {
            if (this.f15698i == null) {
                ...
                this.f15698i.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
                this.f15698i.setStrokeWidth(AndroidUtilities.dp(3.0f));
            }
            paint2.setColor(i0.a.k(-16777216, 127));
        }
        if (this.e == 255 && this.f15693a != 1) {
            canvas.save();
        } else {
        ...
        Path path = this.f15699j;
        path.rewind();
        int i17 = 0;
        while (i17 < i13) {
            if (this.f15693a != i12 || i17 != 0) {
                if (i17 == 0) {
                    paint = this.f15695c;
                } else {
                    paint = paint2;
