...
public final class u2 implements ji {
    ...
    public final void H(int i10, boolean z4, boolean z10, int i11, int i12, long j10, boolean z11, boolean z12, long j11) {
        ...
        String str;
        String str2;
        d4 d4Var = this.f15954a;
        if (d4Var.G0.f15470j0 && (storyItem = d4Var.L1.f15111a) != null && !(storyItem instanceof TL_stories.TL_storyItemSkipped)) {
            if (i10 != 8 && i10 != 7 && (i10 != 4 || d4Var.F2.f26702g0.getSelectedPhotos().isEmpty())) {
                t2 t2Var = d4Var.F2;
                if (t2Var != null) {
            ...
            HashMap<Object, Object> selectedPhotos = d4Var.F2.f26702g0.getSelectedPhotos();
            ArrayList<Object> selectedPhotosOrder = d4Var.F2.f26702g0.getSelectedPhotosOrder();
    ...
    public final void X(ArrayList arrayList, CharSequence charSequence, boolean z4, int i10, int i11, long j10, boolean z10, long j11) {
        ...
        if (storyItem != null && !(storyItem instanceof TL_stories.TL_storyItemSkipped)) {
            ...
            SendMessagesHelper.prepareSendingAudioDocuments(accountInstance, arrayList, charSequence2, d4Var.f15258y1, null, null, storyItem, z4, i10, i11, null, null, j10, z10, j11);
            if (j11 <= 0) {
                z11 = true;
            } else {
                z11 = false;
    ...
    public final boolean k() {
        return this.f15954a.N0();
    }

    @Override
    public final void x(wg wgVar) {
        NotificationCenter.getInstance(this.f15954a.f15263z2).doOnIdle(wgVar);
    }
