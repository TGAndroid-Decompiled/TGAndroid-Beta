...
public final class c extends FrameLayout implements le.d, a6 {
    public ShapeDrawable f15243a;
    public final f6 f15244b;
    public final f8 f15245c;
    ...
    public final void D(int i10, float f7, float f10, e eVar) {
        ShapeDrawable shapeDrawable = this.f15243a;
    ...
    public final void a(boolean z10, boolean z11) {
        if (z10 && this.f15243a == null) {
            this.f15243a = j6.b0(AndroidUtilities.dp(10.0f), i0.a.k(j6.v0(j6.Wk, this.f15244b), 25));
        }
        le.b bVar = this.e;
        if (bVar.f13985f == z10 && !z11) {
            return;
        }
        bVar.a(z10, z11);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        if (shapeDrawable != null) {
            ...
            if (bVar.e > 0.0f) {
                ...
                p.b(canvas, this.f15243a, AndroidUtilities.lerp(0.9f, 1.0f, bVar.e));
            }
        }
    ...
    public void setPack(TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        ...
        this.f15245c.d(document, null, null, null, false, false);
    }
