...
public final class a extends FrameLayout {
    public final ImageView f15015a;
    public final org.telegram.ui.Components.j6 f15016b;
    public final Paint f15017c;
    public final Paint d;
    public boolean e;
    public int f15018f;
    public float h;
    public ValueAnimator f15019n;
    ...
    public final void a(boolean z4, boolean z10) {
        ...
        if (z10) {
            ...
            org.telegram.ui.b.p(animate.rotation(f10), mr.h, 420L);
            return;
        }
        if (z4) {
            f10 = 0.0f;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        float f10 = this.h;
        org.telegram.ui.Components.j6 j6Var = this.f15016b;
        ...
        rectF.set(getWidth() - max, 0.0f, getWidth(), AndroidUtilities.dp(13.0f));
        canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, this.f15017c);
    ...
    public void setCount(int i10) {
        ...
        this.f15016b.q(formatNumber, true, true);
        if (this.f15018f != i10) {
            ValueAnimator valueAnimator = this.f15019n;
            if (valueAnimator != null) {
                valueAnimator.cancel();
                this.f15019n = null;
            }
            ValueAnimator ofFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
            this.f15019n = ofFloat;
            ofFloat.addUpdateListener(new dg.o1(this, 19));
            this.f15019n.addListener(new cg.l0(this, 15));
            this.f15019n.setInterpolator(new OvershootInterpolator(2.5f));
            this.f15019n.setDuration(200L);
            this.f15019n.start();
            this.f15018f = i10;
        }
        invalidate();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f15016b && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
