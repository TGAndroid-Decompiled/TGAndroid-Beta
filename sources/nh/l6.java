...
public class l6 {
    ...
    public final AbstractSet f15562k;
    public final AbstractSet f15563l;
    public boolean f15569r;
    public boolean f15571t;
    public boolean f15572u;
    public boolean v;
    public boolean f15573w;
    public final n4 f15574x;
    public k6 f15575y;
    public boolean f15576z;
    public int f15555a = 0;
    public final ArrayList f15556b = new ArrayList();
    public final ArrayList f15559g = new ArrayList();
    public final HashMap h = new HashMap();
    public final ArrayList f15560i = new ArrayList();
    public final HashMap f15561j = new HashMap();
    public final HashSet f15564m = new HashSet();
    public boolean f15565n = true;
    public boolean f15566o = true;
    public final ArrayList f15567p = new ArrayList();
    public final i6 f15568q = new i6(this, 0);
    public int f15570s = -1;
    public int A = -1;
    ...
    public l6(int i10, long j10, int i11, int i12, Utilities.Callback callback) {
        ...
        this.e = i11;
        this.f15558f = i12;
        this.f15574x = new n4(5, this, callback);
        if (i11 == 0 && i12 > 0) {
            this.f15562k = new LinkedHashSet();
            this.f15563l = new LinkedHashSet();
        } else {
            this.f15562k = new TreeSet(Comparator$CC.reverseOrder());
            this.f15563l = new TreeSet(Comparator$CC.reverseOrder());
        }
        s();
    }
    ...
    public final void A(List list) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < list.size(); i10++) {
                ...
                if (storyItem != null) {
                    Integer valueOf = Integer.valueOf(storyItem.f19394id);
                    AbstractSet abstractSet = this.f15563l;
                    boolean contains = abstractSet.contains(valueOf);
                    AbstractSet abstractSet2 = this.f15562k;
                    if (contains || abstractSet2.contains(Integer.valueOf(storyItem.f19394id))) {
                        abstractSet.remove(Integer.valueOf(storyItem.f19394id));
                        abstractSet2.remove(Integer.valueOf(storyItem.f19394id));
                        int i11 = this.f15570s;
                        if (i11 != -1) {
                            this.f15570s = i11 - 1;
                        }
                        z4 = true;
                    }
                    u(storyItem.f19394id, true);
                }
            }
            if (z4) {
                d(true);
    ...
    public final void B(ArrayList arrayList, boolean z4) {
        v(this.f15562k, arrayList);
        v(this.f15563l, arrayList);
        d(false);
        if (z4) {
            ...
            tL_updateAlbum.album_id = this.f15558f;
    ...
    public void C(ArrayList arrayList, boolean z4) {
        ...
        ArrayList arrayList3 = this.f15559g;
        ...
        if (z4) {
            ...
            tL_togglePinnedToTop.f19407id.addAll(arrayList3);
    ...
    public final void D(List list, boolean z4) {
        ...
        if (list != null) {
            ...
            while (true) {
                ...
                if (storyItem2 != null) {
                    Integer valueOf = Integer.valueOf(storyItem2.f19394id);
                    AbstractSet abstractSet = this.f15563l;
                    boolean contains = abstractSet.contains(valueOf);
                    AbstractSet abstractSet2 = this.f15562k;
                    if (!contains && !abstractSet2.contains(Integer.valueOf(storyItem2.f19394id))) {
                        z10 = false;
                    } else {
                        z10 = true;
                    }
                    ...
                    HashMap hashMap = this.f15561j;
                    if (z10 != z11) {
                        if (!z11) {
                            kf.k0.t(storyItem2.f19394id, new StringBuilder("StoriesList remove story "));
                            u(storyItem2.f19394id, true);
                            int i13 = this.f15570s;
                            if (i13 != -1) {
                                this.f15570s = i13 - 1;
                            }
                        } else if (this.f15569r) {
                            FileLog.d("StoriesList put story " + storyItem2.f19394id);
                            t(y(storyItem2), false);
                            arrayList.add(Integer.valueOf(storyItem2.f19394id));
                            int i14 = this.f15570s;
                            if (i14 != -1) {
                                this.f15570s = i14 + 1;
                            }
                        } else if (!this.f15572u) {
                            FileLog.d("StoriesList cannot put story " + storyItem2.f19394id + " -> reload");
                            if (this.A != -1) {
                                ConnectionsManager.getInstance(this.f15557c).cancelRequest(this.A, true);
                                this.A = -1;
                            }
                            w();
                    ...
                    } else if (z10 && z11 && ((messageObject = (MessageObject) hashMap.get(Integer.valueOf(storyItem2.f19394id))) == null || z4 || (storyItem = messageObject.storyItem) == null || (storyItem != storyItem2 && (storyItem.f19394id != storyItem2.f19394id || storyItem.media != storyItem2.media || !TextUtils.equals(storyItem.caption, storyItem2.caption))))) {
                        kf.k0.t(storyItem2.f19394id, new StringBuilder("StoriesList update story "));
                        hashMap.put(Integer.valueOf(storyItem2.f19394id), y(storyItem2));
                    }
                    z12 = true;
                }
                i12++;
    ...
    public final void E(int i10, ArrayList arrayList, boolean z4) {
        ...
        while (i11 < size) {
            ...
            Integer num = (Integer) obj;
            num.getClass();
            MessageObject messageObject = (MessageObject) this.f15561j.get(num);
    ...
    public final boolean a() {
        Long l10;
        if (B == null || (l10 = (Long) B.get(Integer.valueOf(Objects.hash(Integer.valueOf(this.f15557c), Integer.valueOf(this.e), Long.valueOf(this.d), Integer.valueOf(this.f15558f))))) == null || System.currentTimeMillis() - l10.longValue() > 120000) {
            return true;
        }
        return false;
    }
    ...
    public final void d(boolean z4) {
        c(this.f15560i, this.f15565n, this.f15566o);
        if (z4) {
            i6 i6Var = this.f15568q;
    ...
    public MessageObject f(int i10) {
        return (MessageObject) this.f15561j.get(Integer.valueOf(i10));
    }

    public int g() {
        boolean z4 = this.f15566o;
        ArrayList arrayList = this.f15560i;
        if (z4 && this.f15565n) {
            if (this.f15570s < 0) {
                return arrayList.size();
            }
            return Math.max(arrayList.size(), this.f15570s);
        }
        return arrayList.size();
    }
    ...
    public ArrayList h() {
        ...
        int i10 = 0;
        int i11 = this.e;
        if (i11 == 0 && this.f15558f > 0) {
            ArrayList arrayList3 = new ArrayList();
            ArrayList arrayList4 = this.f15560i;
            int size = arrayList4.size();
            while (i10 < size) {
                Object obj = arrayList4.get(i10);
                i10++;
                arrayList3.add(Integer.valueOf(((MessageObject) obj).storyItem.f19394id));
            }
            arrayList2.add(arrayList3);
            return arrayList2;
        }
        ArrayList arrayList5 = this.f15559g;
    ...
    public void j() {
        ...
        w();
        MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f15557c);
        messagesStorage.getStorageQueue().postRunnable(new j6(this, messagesStorage, 1));
    }

    public boolean k() {
        if (!this.f15571t && !this.f15572u) {
            return false;
        }
        return true;
    }
    ...
    public final boolean m(int i10) {
        if (this.e == 0 && this.f15558f <= 0) {
            return this.f15559g.contains(Integer.valueOf(i10));
        }
        return false;
    }
    ...
    public final int o() {
        ...
        this.f15555a = i10 + 1;
        this.f15556b.add(Integer.valueOf(i10));
        n4 n4Var = this.f15574x;
        if (n4Var != null) {
    ...
    public boolean q(int i10, List list, boolean z4) {
        ...
        int i11;
        if (this.f15572u || ((this.f15569r || this.f15573w || !a()) && !z4)) {
            return false;
        }
        if (this.f15571t) {
            this.f15575y = new k6(this, z4, i10, list);
            return false;
        }
        int i12 = this.e;
        long j10 = this.d;
        int i13 = this.f15557c;
        if (i12 == 0 && (i11 = this.f15558f) > 0) {
            ...
            tL_stories_getStoriesByID.f19401id.addAll(list);
            n10 = -1;
    ...
    public void s() {
        if (!this.f15571t && !this.f15572u && !this.f15573w) {
            this.f15571t = true;
            MessagesStorage messagesStorage = MessagesStorage.getInstance(this.f15557c);
    ...
    public final void t(MessageObject messageObject, boolean z4) {
        ...
        this.f15561j.put(Integer.valueOf(messageObject.getId()), messageObject);
        if (z4) {
            abstractSet = this.f15562k;
        } else {
            abstractSet = this.f15563l;
        }
    ...
    public final void u(int i10, boolean z4) {
        MessageObject messageObject = (MessageObject) this.f15561j.remove(Integer.valueOf(i10));
        if (z4) {
            this.f15562k.remove(Integer.valueOf(i10));
        }
        this.f15563l.remove(Integer.valueOf(i10));
        this.f15559g.remove(Integer.valueOf(i10));
        if (messageObject != null) {
            long b10 = b(messageObject);
            Long valueOf = Long.valueOf(b10);
            HashMap hashMap = this.h;
    ...
    public final void w() {
        HashMap hashMap = B;
        if (hashMap != null) {
            hashMap.remove(Integer.valueOf(Objects.hash(Integer.valueOf(this.f15557c), Integer.valueOf(this.e), Long.valueOf(this.d), Integer.valueOf(this.f15558f))));
        }
    }
    ...
    public void x() {
        ...
        this.f15576z = true;
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList(this.f15559g);
    ...
    public final MessageObject y(TL_stories.StoryItem storyItem) {
        ...
        MessageObject messageObject = new MessageObject(this.f15557c, storyItem);
    ...
    public final void z(int i10) {
        ...
        if (arrayList.isEmpty() && (n4Var = this.f15574x) != null) {
            AndroidUtilities.cancelRunOnUIThread(n4Var);
