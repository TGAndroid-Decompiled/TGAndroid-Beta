...
public final class z3 extends FrameLayout {
    public final y3 f16112a;
    public final ig.c f16113b;
    public final TextView[] f16114c;
    public kj0 d;
    public final b4 e;
    public Paint f16115f;
    public float h;
    public boolean f16116n;
    public boolean f16117r;
    public ValueAnimator f16118s;

    public z3(Context context, b4 b4Var) {
        super(context);
        this.f16114c = new TextView[2];
        this.e = b4Var;
        ...
        for (int i10 = 0; i10 < 2; i10++) {
            this.f16114c[i10] = new TextView(context);
            this.f16114c[i10].setTextSize(1, 12.0f);
            this.f16114c[i10].setMaxLines(1);
            this.f16114c[i10].setSingleLine(true);
            this.f16114c[i10].setEllipsize(TextUtils.TruncateAt.MIDDLE);
            this.f16114c[i10].setTextColor(-1);
            this.f16114c[i10].setPadding(AndroidUtilities.dp(3.0f), 0, AndroidUtilities.dp(3.0f), AndroidUtilities.dp(1.0f));
            addView(this.f16114c[i10], k7.b6.d(-2, -2.0f, 0, 51.0f, 18.0f, 83.0f, 0.0f));
        }
        this.f16113b.setTextColor(-1);
    }
    ...
    public final void b(float f10, Canvas canvas, RectF rectF, boolean z4) {
        ...
        s6 s6Var;
        b4 b4Var = this.e;
        if ((b4Var != null && b4Var.f15112b != null) || this.h != 0.0f) {
            if (b4Var != null && (s6Var = b4Var.f15112b) != null && !s6Var.F) {
                this.h = 1.0f;
                f11 = s6Var.h;
                if (!this.f16116n) {
                    this.f16116n = true;
            ...
            if (this.f16117r && z10 && this.d.f26286f >= 0.9f) {
                this.h = Utilities.clamp(this.h - ((1000.0f / AndroidUtilities.screenRefreshRate) / 300.0f), 1.0f, 0.0f);
            }
            if (z4) {
                if (f10 != 1.0f) {
                ...
                if (this.f16115f == null) {
                    ...
                    this.f16115f = paint;
                    paint.setColor(-1);
                    this.f16115f.setStrokeWidth(AndroidUtilities.dp(2.0f));
                    this.f16115f.setStyle(Paint.Style.STROKE);
                    this.f16115f.setStrokeCap(Paint.Cap.ROUND);
                }
                this.f16115f.setAlpha((int) (255.0f * f10 * this.h));
                kj0 kj0Var5 = this.d;
                kj0Var5.f26299t = this.f16115f;
                kj0Var5.a(canvas);
            }
        }
    }
    ...
    public final void c(CharSequence charSequence, boolean z4) {
        ValueAnimator valueAnimator = this.f16118s;
        if (valueAnimator != null) {
            valueAnimator.cancel();
            this.f16118s = null;
        }
        TextView[] textViewArr = this.f16114c;
        if (z4) {
            ...
            this.f16118s = ofFloat;
            ofFloat.addUpdateListener(new dg.o1(this, 27));
            this.f16118s.addListener(new cg.l0(this, 20));
            this.f16118s.setInterpolator(nr.h);
            this.f16118s.setDuration(340L);
            this.f16118s.start();
            return;
        }
        textViewArr[0].setVisibility(0);
