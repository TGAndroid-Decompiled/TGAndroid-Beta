...
public abstract class r7 extends m2.h {
    ...
    public int L0;
    public float M0;
    public long f15845t0;
    public ArrayList f15846u0;
    public int f15847v0;
    public o7 f15848w0;
    public ArrayList f15849x0;
    public x3 f15850y0;
    public boolean f15851z0;
                ...
                if (((Integer) getChildAt(i10).getTag()).intValue() == getCurrentItem() && getCurrentItem() == this.L0) {
                    ...
                    if (!q7Var.d) {
                        ...
                        if (this.f15846u0 != null) {
                            ...
                            q7Var.f15807a.U0(0, q7Var.f15808b);
                        }
                    }
                }
            }
    ...
    public final boolean E(boolean z4) {
        ...
        if (z4) {
            ...
            ArrayList arrayList = this.f15846u0;
            if (arrayList == null) {
                arrayList = this.f15849x0;
            }
            if (currentItem < arrayList.size() - 1) {
                int currentItem2 = getCurrentItem() + 1;
                if (i9Var.f15448a && Build.VERSION.SDK_INT < 33) {
                    z10 = true;
                }
                x(currentItem2, !z10);
                return true;
    ...
    public long getCurrentDialogId() {
        ...
        if (getCurrentItem() < this.f15849x0.size()) {
            return ((Long) this.f15849x0.get(getCurrentItem())).longValue();
        }
        return 0L;
    }
