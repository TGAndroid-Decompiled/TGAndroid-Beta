...
public class k8 extends View {
    ...
    public final Path D;
    public final n5 E;
    public final org.telegram.ui.Components.z5 f15528a;
    public final TL_stories.MediaArea f15529b;
    public final Paint f15530c;
    public final Paint d;
    public LinearGradient e;
    public LinearGradient f15531f;
    public final Matrix h;
    public final org.telegram.ui.Cells.z f15532n;
    public final rc f15533r;
    public final boolean f15534s;
    public final boolean v;
    public final boolean f15535w;
    public final boolean f15536x;
    public final boolean f15537y;
    ...
    public k8(Context context, View view, TL_stories.MediaArea mediaArea) {
        ...
        this.f15537y = z11;
        this.f15536x = z11;
        this.f15528a = new org.telegram.ui.Components.z5(view, 0L, 120L, new LinearInterpolator());
    ...
    public final void b(Canvas canvas) {
        ...
        org.telegram.ui.Cells.z zVar = this.f15532n;
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        org.telegram.ui.Cells.z zVar = this.f15532n;
        rc rcVar = this.f15533r;
        if (action == 0) {
            if (getParent() instanceof View) {
                View view = (View) getParent();
                Objects.requireNonNull(view);
                rcVar.f28453f = new gu(1, view);
            }
            rcVar.c(true);
    ...
    public float getInnerRadius() {
        ...
        if ((getParent() instanceof View) && (mediaArea = this.f15529b) != null && (mediaAreaCoordinates = mediaArea.coordinates) != null) {
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.v && this.B && this.e != null) {
            ...
            this.f15531f.setLocalMatrix(matrix);
            LinearGradient linearGradient2 = this.f15531f;
            Paint paint2 = this.d;
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f15532n && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
