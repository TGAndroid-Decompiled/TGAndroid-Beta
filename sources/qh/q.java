...
public final class q extends FrameLayout {
    public final k9 f41799a;
    public final TextView f41800b;
    public k f41801c;

    public q(Context context, int i10, e6 e6Var) {
        super(context);
        this.f41799a = new k9(i10, this, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dpf2(1.0f));
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        k9 k9Var = this.f41799a;
        k9Var.setBounds(width - ((int) k9Var.f25569c.d.f13989f.f13996a), AndroidUtilities.dp(12.0f), getWidth() - AndroidUtilities.dp(11.0f), AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(12.0f));
        k9Var.c(canvas);
    }
