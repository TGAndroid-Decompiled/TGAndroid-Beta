...
public final class q extends FrameLayout {
    public final m9 f42074a;
    public final TextView f42075b;
    public k f42076c;

    public q(Context context, int i10, d6 d6Var) {
        super(context);
        this.f42074a = new m9(i10, this, AndroidUtilities.dp(24.0f), AndroidUtilities.dp(10.0f), AndroidUtilities.dpf2(1.0f));
        TextView textView = new TextView(context);
        this.f42075b = textView;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        m9 m9Var = this.f42074a;
        m9Var.setBounds(width - ((int) m9Var.f26404c.d.f14202f.f14209a), AndroidUtilities.dp(12.0f), getWidth() - AndroidUtilities.dp(11.0f), AndroidUtilities.dp(24.0f) + AndroidUtilities.dp(12.0f));
        m9Var.c(canvas);
    }
