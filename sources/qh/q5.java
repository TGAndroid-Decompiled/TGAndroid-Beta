...
public final class q5 extends View implements b2 {
    ...
    public boolean W;
    public o5 f45925a;
    public boolean f45926a0;
    public final ImageReceiver f45927b;
    public boolean f45928b0;
    public final pq f45929c;
    public boolean f45930c0;
    public final Drawable d;
    public float f45931d0;
    public final Drawable f45932e;
    public final org.telegram.ui.Components.z5 f45933e0;
    public final Drawable f45934f;
    public float f45935f0;
    public float f45936g0;
    public final Drawable h;
    public float f45937h0;
    public float f45938i0;
    public final org.telegram.ui.Components.z5 f45939j0;
    public float f45940k0;
    public boolean f45941l0;
    public final org.telegram.ui.Components.z5 m0;
    public final Drawable f45942n;
    public final org.telegram.ui.Components.z5 f45943n0;
    public boolean f45944o0;
    public final float[] f45945p0;
    public final org.telegram.ui.Components.z5 f45946q0;
    public final Paint f45947r;
    public boolean f45948r0;
    public final Paint f45949s;
    public long f45950s0;
    public boolean f45951t0;
    public boolean f45952u0;
    public final Paint v;
    public float f45953v0;
    public final Paint f45954w;
    public boolean f45955w0;
    public final Paint f45956x;
    public boolean f45957x0;
    public final Paint f45958y;
    public final org.telegram.ui.Components.z5 f45959y0;
    public final org.telegram.ui.Components.z5 f45960z0;

    public q5(Activity activity) {
        super(activity);
        ImageReceiver imageReceiver = new ImageReceiver();
        this.f45927b = imageReceiver;
        this.f45947r = new Paint(1);
        ...
        this.f45933e0 = new org.telegram.ui.Components.z5(this, 0L, 200L, pr.f30168f);
        this.f45939j0 = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.f45940k0 = -1.0f;
        this.f45941l0 = true;
        this.m0 = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.f45943n0 = new org.telegram.ui.Components.z5(this, 0L, 850L, prVar);
        this.f45945p0 = new float[2];
        this.f45946q0 = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.f45959y0 = new org.telegram.ui.Components.z5(this, 0L, 350L, prVar);
        this.f45960z0 = new org.telegram.ui.Components.z5(this, 0L, 650L, prVar);
        this.A0 = new org.telegram.ui.Components.z5(this, 0L, 160L, pr.f30170i);
    ...
    public final void g(boolean z4) {
        this.f45948r0 = false;
        if (!z4) {
            org.telegram.ui.Components.z5 z5Var = this.f45946q0;
            z5Var.getClass();
            z5Var.d(0.0f, true);
        }
        invalidate();
    ...
    public final void h() {
        ...
        o5 o5Var = this.f45925a;
        ImageReceiver imageReceiver = this.f45927b;
        if (o5Var != null) {
            o5Var.getClass();
            ArrayList arrayList2 = MessagesController.getInstance(imageReceiver.getCurrentAccount()).getStoriesController().f17791w.f46116b;
            imageReceiver.setOrientation(0, 0, true);
            if (arrayList2 != null && !arrayList2.isEmpty() && ((r6) arrayList2.get(0)).O0 != null) {
                this.f45927b.setImage(ImageLocation.getForPath(((r6) arrayList2.get(0)).O0.getAbsolutePath()), "80_80", null, null, this.f45929c, 0L, null, null, 0);
                return;
            }
        }
        ...
        if (photoEntry != null && (str = photoEntry.thumbPath) != null) {
            this.f45927b.setImage(ImageLocation.getForPath(str), "80_80", null, null, this.f45929c, 0L, null, null, 0);
        } else if (photoEntry != null && photoEntry.path != null) {
            if (photoEntry.isVideo) {
                this.f45927b.setImage(ImageLocation.getForPath("vthumb://" + photoEntry.imageId + ":" + photoEntry.path), "80_80", null, null, this.f45929c, 0L, null, null, 0);
                return;
            }
            imageReceiver.setOrientation(photoEntry.orientation, photoEntry.invert, true);
            this.f45927b.setImage(ImageLocation.getForPath("thumb://" + photoEntry.imageId + ":" + photoEntry.path), "80_80", null, null, this.f45929c, 0L, null, null, 0);
        } else {
            imageReceiver.setImageBitmap(this.f45929c);
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f45927b.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        this.f45927b.onDetachedFromWindow();
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float d13 = this.f45943n0.d(f11, false);
        float f46 = this.f45940k0;
        if (f46 < 0.0f) {
            if (this.f45941l0) {
                f45 = 1.0f;
            } else {
        ...
        float d14 = this.f45959y0.d(f12, false);
        rc rcVar2 = this.G;
        if (Math.abs(this.f45953v0 - this.f45935f0) < AndroidUtilities.dp(64.0f) && (this.f45944o0 || rcVar2.h)) {
            f13 = 1.0f;
        } else {
            f13 = 0.0f;
        }
        float d15 = this.f45960z0.d(f13, false) * d14;
        if (Math.abs(this.f45953v0 - this.f45935f0) < AndroidUtilities.dp(64.0f)) {
            f14 = 1.0f;
        } else {
            f14 = 0.0f;
        }
        float d16 = this.A0.d(f14, false) * d14;
        float clamp = Utilities.clamp((this.f45953v0 - this.f45935f0) / AndroidUtilities.dp(16.0f), 1.0f, -1.0f);
        float clamp2 = Utilities.clamp((this.f45953v0 - this.f45935f0) / AndroidUtilities.dp(64.0f), 1.0f, -1.0f);
        if (Math.min(Math.abs(this.f45953v0 - this.f45938i0), Math.abs(this.f45953v0 - this.f45937h0)) < AndroidUtilities.dp(16.0f)) {
            f15 = 1.0f;
        } else {
            f15 = 0.0f;
        }
        ...
        if (f16 > 0.0f) {
            f22 = 1.0f;
            float dp = this.f45935f0 - AndroidUtilities.dp(50.0f);
            f23 = 0.0f;
            float dp2 = this.f45935f0 + AndroidUtilities.dp(50.0f);
            Paint paint2 = this.B;
            ...
            c3 = 1;
            f20 = e10;
            canvas.drawLine(dp2, this.f45936g0, AndroidUtilities.lerp(dp2, this.f45938i0 - AndroidUtilities.dp(30.0f), f16), this.f45936g0, paint3);
            canvas.drawLine(dp2, this.f45936g0, AndroidUtilities.lerp(dp2, this.f45938i0 - AndroidUtilities.dp(30.0f), f48), this.f45936g0, paint2);
            canvas.drawLine(dp, this.f45936g0, AndroidUtilities.lerp(dp, this.f45937h0 + AndroidUtilities.dp(30.0f), f48), this.f45936g0, paint3);
            canvas2 = canvas;
            canvas2.drawLine(dp, this.f45936g0, AndroidUtilities.lerp(dp, this.f45937h0 + AndroidUtilities.dp(30.0f), f48), this.f45936g0, paint2);
        } else {
            f17 = d16;
            f18 = d17;
            f19 = e6;
        ...
        float lerp4 = AndroidUtilities.lerp(rcVar2.a(f24), (this.f45933e0.d(this.f45931d0, false) * 0.2f) + f22, d12);
        RectF rectF4 = AndroidUtilities.rectTmp;
        float f50 = lerp - lerp2;
        float f51 = this.f45936g0;
        float f52 = lerp + lerp2;
        rectF4.set(f50, f51 - lerp2, f52, f51 + lerp2);
        float f53 = f22 - f20;
        int d19 = i0.a.d(max * f53, -1, -577231);
        Paint paint4 = this.f45947r;
        paint4.setColor(d19);
        int i11 = (f20 > f23 ? 1 : (f20 == f23 ? 0 : -1));
        if (i11 > 0) {
            canvas2.save();
            canvas2.scale(lerp4, lerp4, this.f45935f0, this.f45936g0);
        ...
        canvas2.scale(f30, f30, this.f45935f0, this.f45936g0);
        paint.setAlpha(255);
        ...
        if (i11 > 0) {
            ...
            canvas2.translate(this.f45935f0, this.f45936g0);
        ...
        canvas2.scale(max2, max2, this.f45935f0, this.f45936g0);
        ...
        float e11 = this.f45946q0.e(this.f45948r0);
        Paint paint7 = this.v;
        ...
        if (e11 <= 0.0f) {
            ...
            tp.a(this.f45945p0, (float) ((SystemClock.elapsedRealtime() - this.f45950s0) % 5400));
            invalidate();
            float[] fArr = this.f45945p0;
            float f60 = fArr[0];
            float f61 = fArr[c3];
        ...
        if (this.f45944o0) {
            ...
            if (j12 != this.O / 1000) {
                ((x8) this.f45925a).f46318a.G0.a(j12, true);
            }
        ...
        canvas3.restore();
        boolean z12 = this.f45957x0;
        rc rcVar3 = this.I;
        if (z12) {
            float a2 = rcVar3.a(0.2f) * f27;
            if (a2 > 0.0f) {
                canvas3.save();
                canvas3.scale(a2, a2, this.f45937h0, this.f45936g0);
                canvas3.drawCircle(this.f45937h0, this.f45936g0, AndroidUtilities.dp(22.0f), this.f45954w);
                canvas3.rotate(-getRotation(), this.f45937h0, this.f45936g0);
                this.f45934f.draw(canvas3);
                canvas3.restore();
            }
        }
        ...
        if (a10 > 0.0f) {
            canvas3.save();
            canvas3.scale(a10, a10, this.f45937h0, this.f45936g0);
            canvas3.rotate(-getRotation(), this.f45937h0, this.f45936g0);
            this.f45927b.draw(canvas3);
            canvas3.restore();
        }
        if (this.L) {
            f35 = 1.0f;
        ...
        Paint paint8 = this.f45956x;
        org.telegram.ui.Components.z5 z5Var2 = this.K;
        rc rcVar4 = this.H;
        if (d20 > 0.0f) {
            canvas3.save();
            float a11 = rcVar4.a(0.2f) * d20 * f25;
            canvas3.scale(a11, a11, this.f45938i0, this.f45936g0);
            canvas3.rotate(z5Var2.d(this.J, false) - getRotation(), this.f45938i0, this.f45936g0);
            canvas3.drawCircle(this.f45938i0, this.f45936g0, AndroidUtilities.dp(22.0f), paint8);
            this.f45932e.draw(canvas3);
            canvas3.restore();
        }
        if (d20 < 1.0f) {
            canvas3.save();
            ...
            canvas3.scale(y10, y10, this.f45938i0, this.f45936g0);
            canvas3.rotate(z5Var2.d(this.J, false) - getRotation(), this.f45938i0, this.f45936g0);
            canvas3.drawCircle(this.f45938i0, this.f45936g0, AndroidUtilities.dp(22.0f), this.f45954w);
            this.d.draw(canvas3);
            canvas3.restore();
        } else {
            f36 = f25;
        ...
        if (!this.f45955w0 && this.f45944o0) {
            f38 = 1.0f;
        } else {
            f38 = 0.0f;
        }
        ...
        if (i12 > 0) {
            Paint paint9 = this.f45958y;
            paint9.setAlpha(255);
            canvas3.drawCircle(this.f45953v0, this.f45936g0, f37, paint9);
            float f67 = this.f45953v0;
            f42 = 22.0f;
        ...
        if (i10 > 0 || f40 > 0.0f) {
            ...
            path3.rewind();
            if (i10 > 0) {
                path3.addCircle(this.f45953v0, this.f45936g0, f39, Path.Direction.CW);
            }
            if (f40 > 0.0f && this.f45957x0) {
                path3.addCircle(this.f45937h0, this.f45936g0, f40 * AndroidUtilities.dp(f42) * a12, Path.Direction.CW);
            }
            canvas3.clipPath(path3);
            if (this.f45957x0) {
                canvas3.save();
                canvas3.scale(a12, a12, this.f45937h0, this.f45936g0);
                canvas3.drawCircle(this.f45937h0, this.f45936g0, AndroidUtilities.dp(f42), paint8);
                canvas3.rotate(-getRotation(), this.f45937h0, this.f45936g0);
                this.h.draw(canvas3);
                canvas3.restore();
            }
            ...
            canvas3.save();
            canvas3.scale(a13, a13, this.f45938i0, this.f45936g0);
            canvas3.rotate(z5Var.d(this.J, false) - getRotation(), this.f45938i0, this.f45936g0);
            canvas3.drawCircle(this.f45938i0, this.f45936g0, AndroidUtilities.dp(f42), paint8);
            this.f45932e.draw(canvas3);
            canvas3.restore();
            canvas3.restore();
        }
        ...
        if (p5Var != null) {
            boolean b10 = b();
            boolean z14 = this.U;
            boolean z15 = this.f45944o0;
            if (z14 == z15 && this.V == b10 && this.W == this.L && this.f45926a0 == this.f45941l0 && this.f45928b0 == this.f45948r0 && this.f45930c0 == this.f45957x0) {
                return;
            }
            this.U = z15;
            this.V = b10;
            this.W = this.L;
            this.f45926a0 = this.f45941l0;
            this.f45928b0 = this.f45948r0;
            this.f45930c0 = this.f45957x0;
            p5Var.i();
        }
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        float f10 = size;
        this.f45935f0 = f10 / 2.0f;
        this.f45936g0 = dp / 2.0f;
        float min = Math.min(AndroidUtilities.dp(135.0f), f10 * 0.35f);
        float f11 = this.f45935f0;
        this.f45937h0 = f11 - min;
        float f12 = f11 + min;
        this.f45938i0 = f12;
        float f13 = this.f45936g0;
        float dp2 = AndroidUtilities.dp(14.0f);
        this.d.setBounds((int) (f12 - dp2), (int) (f13 - dp2), (int) (f12 + dp2), (int) (f13 + dp2));
        float f14 = this.f45938i0;
        float f15 = this.f45936g0;
        float dp3 = AndroidUtilities.dp(14.0f);
        this.f45932e.setBounds((int) (f14 - dp3), (int) (f15 - dp3), (int) (f14 + dp3), (int) (f15 + dp3));
        f(this.f45934f, this.f45937h0, this.f45936g0);
        f(this.h, this.f45937h0, this.f45936g0);
        f(this.f45942n, this.f45937h0, this.f45936g0);
        this.f45927b.setImageCoords(this.f45937h0 - AndroidUtilities.dp(20.0f), this.f45936g0 - AndroidUtilities.dp(20.0f), AndroidUtilities.dp(40.0f), AndroidUtilities.dp(40.0f));
        Matrix matrix = this.E;
        matrix.reset();
        matrix.postTranslate(this.f45935f0, this.f45936g0);
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        float clamp = Utilities.clamp(motionEvent.getX() + 0.0f, this.f45938i0, this.f45937h0);
        float y10 = motionEvent.getY() + 0.0f;
        boolean c3 = c(clamp, y10, this.f45938i0, this.f45936g0, AndroidUtilities.dp(7.0f), true);
        boolean z11 = this.f45948r0;
        rc rcVar = this.I;
        rc rcVar2 = this.G;
        rc rcVar3 = this.H;
        boolean z12 = true;
        ...
        if (z11) {
            ...
            rcVar3.c(false);
            rcVar.c(false);
        } else if (action == 0 || this.f45951t0) {
            rcVar2.c(c(clamp, y10, this.f45935f0, this.f45936g0, AndroidUtilities.dp(60.0f), false));
            if (c(clamp, y10, this.f45938i0, this.f45936g0, AndroidUtilities.dp(30.0f), true) && !b()) {
                z4 = true;
            } else {
                z4 = false;
            }
            rcVar3.c(z4);
            if (c(clamp, y10, this.f45937h0, this.f45936g0, AndroidUtilities.dp(30.0f), false) && !b()) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        if (action == 0) {
            this.f45951t0 = true;
            this.f45952u0 = (rcVar2.h || rcVar3.h) ? true : true;
            System.currentTimeMillis();
            this.f45953v0 = clamp;
            if (Math.abs(clamp - this.f45935f0) < AndroidUtilities.dp(50.0f)) {
            ...
            if (this.f45951t0) {
                this.f45953v0 = Utilities.clamp(clamp, this.f45938i0, this.f45937h0);
                invalidate();
                if (this.f45944o0 && !this.U0 && c3) {
                    d(180.0f);
                    ((x8) this.f45925a).b();
                }
                if (this.f45944o0 && this.f45955w0) {
                    float clamp2 = Utilities.clamp(((this.f45936g0 - AndroidUtilities.dp(48.0f)) - y10) / (AndroidUtilities.displaySize.y / 2.0f), 1.0f, 0.0f);
                    ba baVar = ((x8) this.f45925a).f46318a;
            ...
            if (this.f45951t0) {
                ...
                boolean z14 = this.f45944o0;
                if (!z14 && rcVar.h) {
                    ba baVar2 = ((x8) this.f45925a).f46318a;
                    if (baVar2.f45048c0 == 0 && !baVar2.M1 && !baVar2.N1 && ba.b(baVar2)) {
                        baVar2.f(true);
                    }
                } else if (z14 && this.f45955w0) {
                    if (rcVar.h) {
                        this.f45955w0 = false;
                        this.D0.d(1.0f, true);
                        d3 d3Var = ((x8) this.f45925a).f46318a.Q0;
                        d3Var.f45223a.q(LocaleController.getString(R.string.StoryHintPinchToZoom), true, true);
                        d3Var.invalidate();
                    } else {
                        this.f45944o0 = false;
                        this.f45950s0 = SystemClock.elapsedRealtime();
                        this.f45948r0 = true;
                        ((x8) this.f45925a).d(false);
                    }
                } else if (rcVar2.h) {
                    if (b()) {
                        ((x8) this.f45925a).a();
                    } else if (!this.f45941l0 && !this.f45944o0 && !this.f45955w0) {
                        ((x8) this.f45925a).c();
                    } else if (!this.f45944o0) {
                        if (ba.d(((x8) this.f45925a).f46318a)) {
                            this.O = 0L;
                            this.N = System.currentTimeMillis();
                            this.f45957x0 = false;
                            ((x8) this.f45925a).e(new n5(this, 1), false);
                        }
                    } else {
                        this.f45944o0 = false;
                        this.f45950s0 = SystemClock.elapsedRealtime();
    ...
    public void setInvert(float f10) {
        this.f45949s.setColor(i0.a.d(f10, -1, -16777216));
        this.f45954w.setColor(i0.a.d(f10, 1677721600, 369098752));
        ...
        this.f45934f.setColorFilter(new PorterDuffColorFilter(i0.a.d(f10, -1, -16777216), mode));
    }
}
