...
public final class h {
    public final f f41736a;
    public final TLRPC.TL_messageMediaPoll f41737b;
    public final TLRPC.TL_inputMediaPoll f41738c;
    public final long d;
    public final String e;
    public final ArrayList f41739f;
        ...
        if (fVar != null) {
            ...
            for (int i11 = 0; i11 < size2; i11++) {
                ...
                if (eVar instanceof rh.e) {
                    ...
                    f.k(tL_inputMediaPoll, keyAt, zf.d.h(((rh.f) eVar).f42550b));
                } else if (eVar instanceof rh.h) {
                    TLRPC.TL_inputMediaDocument tL_inputMediaDocument = new TLRPC.TL_inputMediaDocument();
                    TLRPC.TL_inputDocument tL_inputDocument = new TLRPC.TL_inputDocument();
                    TLRPC.Document document = ((rh.h) eVar).f42553b;
