...
public final class pa extends View {
    public final Paint f45902a;
    public final org.telegram.ui.Components.j6 f45903b;
    ...
    public pa(Activity activity) {
        ...
        sb.append("00:00:00");
        if (!TextUtils.equals(sb, j6Var.f28003g)) {
            j6Var.b();
    ...
    public final void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        org.telegram.ui.Components.j6 j6Var = this.f45903b;
        float d = j6Var.d();
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), this.f45902a);
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (this.f45903b != drawable && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
