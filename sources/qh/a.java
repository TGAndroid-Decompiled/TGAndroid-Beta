...
public final class a extends View {
    public final ImageReceiver f44903a;
    public final String f44904b;
    public final String f44905c;
    public final TextPaint d;
    public StaticLayout f44906e;
    public float f44907f;
    public float h;
    public final TextPaint f44908n;
    public StaticLayout f44909r;
    public float f44910s;
    public float v;
    ...
    public a(Context context, MediaController.PhotoEntry photoEntry, String str, int i10, org.telegram.ui.ActionBar.g6 g6Var) {
        ...
        this.f44903a = imageReceiver;
        TextPaint textPaint = new TextPaint(1);
        this.d = textPaint;
        TextPaint textPaint2 = new TextPaint(1);
        this.f44908n = textPaint2;
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        ImageReceiver imageReceiver = this.f44903a;
        ...
        if (this.f44906e != null) {
            canvas.save();
            canvas.translate(dp - this.h, (getMeasuredHeight() - this.f44906e.getHeight()) / 2.0f);
            this.f44906e.draw(canvas);
            dp = dp + this.f44907f + AndroidUtilities.dp(6.0f);
            canvas.restore();
        }
        if (this.f44909r != null) {
            canvas.save();
            canvas.translate(dp - this.v, AndroidUtilities.dpf2(1.6f) + ((getMeasuredHeight() - this.f44909r.getHeight()) / 2.0f));
            this.f44909r.draw(canvas);
            canvas.restore();
        }
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.f44903a.onAttachedToWindow();
    }

    @Override
    public final void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        this.f44903a.onDetachedFromWindow();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        StaticLayout staticLayout = this.f44906e;
        if (staticLayout == null || staticLayout.getWidth() != size) {
            ...
            this.f44906e = staticLayout2;
            int lineCount = staticLayout2.getLineCount();
            float f13 = 0.0f;
            if (lineCount > 0) {
                f10 = this.f44906e.getLineLeft(0);
            } else {
                f10 = 0.0f;
            }
            this.h = f10;
            if (this.f44906e.getLineCount() > 0) {
                f11 = this.f44906e.getLineWidth(0);
            } else {
                f11 = 0.0f;
            }
            this.f44907f = f11;
            int dp = size - ((int) (f11 + AndroidUtilities.dp(8.0f)));
            TextPaint textPaint2 = this.f44908n;
            StaticLayout staticLayout3 = new StaticLayout(TextUtils.ellipsize(this.f44905c, textPaint2, dp, truncateAt), textPaint2, Math.max(0, dp), alignment, 1.0f, 0.0f, false);
            this.f44909r = staticLayout3;
            if (staticLayout3.getLineCount() > 0) {
                f12 = this.f44909r.getLineLeft(0);
            } else {
                f12 = 0.0f;
            }
            this.v = f12;
            if (this.f44909r.getLineCount() > 0) {
                f13 = this.f44909r.getLineWidth(0);
            }
            this.f44910s = f13;
        }
        if (View.MeasureSpec.getMode(i10) == Integer.MIN_VALUE) {
            setMeasuredDimension((int) Math.min(AndroidUtilities.dp(12.0f) + AndroidUtilities.dp(30.0f) + getPaddingLeft() + this.f44907f + AndroidUtilities.dp(8.0f) + this.f44910s + getPaddingRight(), View.MeasureSpec.getSize(i10)), AndroidUtilities.dp(48.0f));
