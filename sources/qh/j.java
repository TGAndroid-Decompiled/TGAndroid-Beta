    ...
    public final void run(Object obj, Object obj2) {
        ...
        switch (i10) {
            case 0:
                ...
                x51 x51Var = (x51) obj2;
                arrayList.clear();
                ArrayList arrayList2 = pVar.f41829j;
                ...
                while (i11 < size) {
                    ...
                    TLObject userOrChat = MessagesController.getInstance(pVar.f41823a).getUserOrChat(peerDialogId);
            ...
            default:
                ...
                if (tL_messages_votesList != null) {
                    ...
                    pVar.h = z10;
                    pVar.f41829j.addAll(tL_messages_votesList.votes);
                    u0 u0Var = pVar.e;
                    if (u0Var != null) {
                        u0Var.run();
                        return;
