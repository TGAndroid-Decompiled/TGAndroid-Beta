...
public final class d extends View {
    public final Drawable f42061a;
    public final le.b f42062b;
    public final int f42063c;
    public e d;

    public d(Context context, int i10) {
        super(context);
        this.f42062b = new le.b(this, qr.h, 380L);
        this.f42063c = i10;
        Drawable mutate = context.getResources().getDrawable(R.drawable.outline_poll_attach_24).mutate();
        this.f42061a = mutate;
        mutate.setColorFilter(new PorterDuffColorFilter(j6.w0(null, j6.f19297o7, false), PorterDuff.Mode.SRC_IN));
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        float f7 = this.f42062b.e;
        if (f7 < 1.0f) {
            canvas.save();
            float f10 = 1.0f - f7;
            canvas.scale(f10, f10, width, height);
            this.f42061a.draw(canvas);
            canvas.restore();
        }
        if (f7 > 0.0f) {
            float f11 = this.f42063c;
    ...
    public final void onSizeChanged(int i10, int i11, int i12, int i13) {
        ...
        int i14 = (i10 - dp) / 2;
        int i15 = (i11 - dp) / 2;
        this.f42061a.setBounds(i14, i15, i14 + dp, dp + i15);
    }
}
