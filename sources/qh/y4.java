...
public final class y4 extends LinearLayout {
    public final TextView f46365a;
    public final mc1 f46366b;
    public ImageView f46367c;
    public ImageView d;
    public float f46368e;
    public boolean f46369f;
    public ValueAnimator h;
    public final ImageView f46370n;
    public final a5 f46371r;
    ...
    public y4(a5 a5Var, Context context) {
        ...
        this.f46365a = textView;
        textView.setTextColor(org.telegram.ui.ActionBar.k6.v0(i11, p4Var));
        textView.setTextSize(1, 16.0f);
        addView(textView, k7.c6.t(-2, -2, 19, 0, 0, 16, 0));
        ImageView imageView4 = new ImageView(context);
        this.f46370n = imageView4;
        imageView4.setImageResource(R.drawable.msg_text_check);
        imageView4.setScaleType(scaleType);
        imageView4.setColorFilter(new PorterDuffColorFilter(org.telegram.ui.ActionBar.k6.v0(org.telegram.ui.ActionBar.k6.f21735h7, p4Var), PorterDuff.Mode.MULTIPLY));
    ...
    public final void a(int i10, boolean z4, boolean z10) {
        ...
        this.f46367c.setImageResource(i10);
    }
    ...
    public void setSelected(boolean z4) {
        ...
        this.f46370n.setVisibility(i10);
    }

    public void setText(CharSequence charSequence) {
        this.f46365a.setText(charSequence);
    }
}
