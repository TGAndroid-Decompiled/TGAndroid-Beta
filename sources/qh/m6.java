...
public class m6 extends View {
    ...
    public float f45670c;
    public float d;
    public boolean f45671e;
    public final org.telegram.ui.Components.z5 f45672f;
    public Utilities.Callback h;
    public final Paint f45673n;
    public final Paint f45674r;
    public final Paint f45675s;
    public final Paint v;
    public final Paint f45676w;
    public final org.telegram.ui.Components.j6 f45677x;
    public final org.telegram.ui.Components.j6 f45678y;
    ...
    public m6(Context context, int i10) {
        ...
        this.f45670c = 1.0f;
        pr prVar = pr.h;
        this.f45672f = new org.telegram.ui.Components.z5(this, 0L, 320L, prVar);
    ...
    public final void a(float f10) {
        ...
        this.d = (f10 - f11) / (this.f45670c - f11);
        e(f10);
    }
    ...
    public final void d(float f10) {
        float f11 = this.f45669b;
        float f12 = (f10 - f11) / (this.f45670c - f11);
        this.d = f12;
        this.f45672f.d(f12, true);
        e(f10);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        boolean z10 = false;
        if (this.f45671e) {
            f10 = this.f45672f.d(this.d, false);
        } else {
            f10 = this.d;
        }
        float f13 = f10;
        ...
        org.telegram.ui.Components.j6 j6Var = this.f45677x;
        if (i10 == 0) {
            ...
            org.telegram.ui.Components.j6 j6Var2 = this.f45678y;
        ...
        if (i10 == 0) {
            canvas.drawPath(this.C, this.f45674r);
            canvas.drawPath(this.D, this.f45675s);
            float f14 = this.f45670c;
            float f15 = this.f45669b;
            float f16 = f14 - f15;
            if (f16 != 0.0f) {
                f11 = (f16 * this.d) + f15;
            } else {
            ...
            Paint paint2 = this.f45676w;
            paint2.setAlpha((int) (e10 * 255.0f));
            canvas.drawPath(this.F, paint2);
            canvas.restore();
        }
        canvas.save();
        canvas.drawRect(0.0f, 0.0f, this.L * f13, this.M, this.f45673n);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            float f11 = this.f45670c;
            float f12 = this.f45669b;
            float f13 = 0.0f;
            if (f11 - f12 != 0.0f) {
    ...
    public final void e(float f10) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.f45677x;
        if (!TextUtils.equals(j6Var.f28033g, str)) {
            j6Var.b();
            if (this.f45671e) {
                j10 = 320;
            } else {
        ...
        if (this.f45668a == 1) {
            this.f45673n.setColor(d2.f(f10));
        }
        invalidate();
    }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f45677x.t(AndroidUtilities.dp(15.0f));
        int i12 = this.O;
        int i13 = this.f45668a;
        if (i12 > 0) {
            this.L = i12;
        ...
        if (i13 == 0) {
            ...
            this.f45674r.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            Path path = this.C;
            path.rewind();
            ...
            path.close();
            this.f45675s.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(2.66f)));
            Path path2 = this.D;
            path2.rewind();
    ...
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f45677x && drawable != this.f45678y && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
