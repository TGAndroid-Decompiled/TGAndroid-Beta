    ...
    public final void run() {
        ...
        switch (i12) {
            case 0:
                ...
                return;
            default:
                boolean z4 = kVar.f45522j0;
                FrameLayout frameLayout = kVar.G;
                h hVar = kVar.f45530r;
                f fVar = kVar.f45517f;
                if (kVar.m0 != z4) {
                    kVar.m0 = z4;
                    ValueAnimator valueAnimator = kVar.f45526n0;
                    if (valueAnimator != null) {
                        valueAnimator.cancel();
                        kVar.f45526n0 = null;
                    }
                    Utilities.Callback callback = kVar.f45520h0;
                    if (callback != null) {
                    ...
                    kVar.f45526n0 = ofFloat;
                    ofFloat.addUpdateListener(new oh.f5(kVar, 12));
                    if (!z4) {
                        fVar.getEditText().setAllowDrawCursor(false);
                    }
                    kVar.f45526n0.addListener(new qd1(7, kVar, z4));
                    if (z4) {
                        kVar.f45526n0.setInterpolator(org.telegram.ui.ActionBar.r1.f22249w);
                        kVar.f45526n0.setDuration(250L);
                    } else {
                        kVar.f45526n0.setInterpolator(new u1.a());
                        kVar.f45526n0.setDuration(420L);
                    }
                    kVar.f45526n0.start();
                    ...
                    if (z4 && SharedConfig.getDevicePerformanceClass() >= 1 && !LiteMode.isPowerSaverApplied()) {
                        if (kVar.f45527o0 == null) {
                            kVar.f45527o0 = Bitmap.createBitmap((int) (frameLayout.getWidth() / 12.0f), (int) (frameLayout.getHeight() / 12.0f), Bitmap.Config.ARGB_8888);
                        }
                        kVar.f45536v0 = true;
                        kVar.i(kVar.f45527o0);
                        kVar.f45536v0 = false;
                        Bitmap bitmap = kVar.f45527o0;
                        if (bitmap != null && !bitmap.isRecycled()) {
                            Bitmap bitmap2 = kVar.f45527o0;
                            Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                            kVar.f45528p0 = new BitmapShader(bitmap2, tileMode, tileMode);
                            Matrix matrix = kVar.f45529q0;
                            if (matrix == null) {
                                kVar.f45529q0 = new Matrix();
                            } else {
                                matrix.reset();
                            }
                            ...
                            kVar.f45531r0.setShader(kVar.f45528p0);
                            return;
                        }
                        kVar.f45527o0 = null;
                        return;
