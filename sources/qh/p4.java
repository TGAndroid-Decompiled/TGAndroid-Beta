...
public final class p4 implements org.telegram.ui.ActionBar.g6 {
    public PorterDuffColorFilter f45893a;
    public final org.telegram.ui.ActionBar.g6 f45894b;
    ...
    public final int B0(int i10) {
        ...
        if (i10 == org.telegram.ui.ActionBar.k6.f21733h5) {
            return -14737633;
        }
        if (i10 == org.telegram.ui.ActionBar.k6.f21768j5) {
            return -592138;
        }
        if (i10 == org.telegram.ui.ActionBar.k6.f21913r5) {
            return -8553091;
        }
        ...
        if (i10 == org.telegram.ui.ActionBar.k6.f21752i6) {
            return 536870911;
        }
        ...
        if (i10 != org.telegram.ui.ActionBar.k6.Je && i10 != i11) {
            ...
            if (i10 == org.telegram.ui.ActionBar.k6.f21607a7) {
                return -15921907;
            }
            org.telegram.ui.ActionBar.g6 g6Var = this.f45894b;
            if (g6Var != null) {
                return g6Var.B0(i10);
            }
    ...
    public final ColorFilter w() {
        if (this.f45893a == null) {
            this.f45893a = new PorterDuffColorFilter(-1, PorterDuff.Mode.SRC_IN);
        }
        return this.f45893a;
    }
