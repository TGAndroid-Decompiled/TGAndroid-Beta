...
public abstract class w5 extends FrameLayout {
    public float B;
    public final v5 f46227a;
    public final File f46228b;
    public long f46229c;
    public long d;
    public final Paint f46230e;
    public final Paint f46231f;
    public final s5 h;
    public oh.z f46232n;
    public l f46233r;
    public float f46234s;
    public eg.z2 v;
    public ValueAnimator f46235w;
    public boolean f46236x;
    public ValueAnimator f46237y;

    public w5(Context context) {
        super(context);
        this.f46229c = -1L;
        this.d = -1L;
        this.f46230e = new Paint(1);
        ...
        this.f46228b = s6.x(UserConfig.selectedAccount, true);
    ...
    public final void a(boolean z4) {
        ...
        this.f46227a.destroy(true, null);
        try {
            this.f46228b.delete();
        ...
        ValueAnimator valueAnimator = this.f46237y;
        if (valueAnimator != null) {
            valueAnimator.cancel();
        }
        ValueAnimator ofFloat = ValueAnimator.ofFloat(this.B, 1.0f);
        this.f46237y = ofFloat;
        ofFloat.addUpdateListener(new oh.f5(this, 20));
        this.f46237y.addListener(new j2(this, 4));
        this.f46237y.setInterpolator(pr.h);
        this.f46237y.setDuration(280L);
        this.f46237y.start();
    }
    ...
    public final long b() {
        ...
        return Math.min(59500L, j10 - this.f46229c);
    }
    ...
    public final void dispatchDraw(Canvas canvas) {
        ...
        int l1 = org.telegram.ui.ActionBar.k6.l1(this.f46234s, 536870912);
        Paint paint = this.f46230e;
        paint.setShadowLayer(AndroidUtilities.dp(2.0f), 0.0f, AndroidUtilities.dp(0.66f), l1);
        paint.setAlpha((int) (this.f46234s * 255.0f));
        ...
        if (z2Var != null && z2Var.getWidth() > 0 && this.v.getHeight() > 0) {
            ...
            this.v.setDraw(true);
            this.v.setAlpha(1.0f - this.f46234s);
            this.v.draw(canvas);
        ...
        if (this.f46229c > 0) {
            ...
            Paint paint2 = this.f46231f;
            paint2.setStrokeWidth(AndroidUtilities.dp(3.33f));
            paint2.setColor(org.telegram.ui.ActionBar.k6.l1(this.f46234s, -1090519041));
            paint2.setShadowLayer(AndroidUtilities.dp(1.0f), 0.0f, AndroidUtilities.dp(0.33f), org.telegram.ui.ActionBar.k6.l1(this.f46234s, 536870912));
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f46227a.measure(View.MeasureSpec.makeMeasureSpec(min, 1073741824), View.MeasureSpec.makeMeasureSpec(min, 1073741824));
