...
public final class g extends l20 implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ph.d Y;
    public ph.d Z;
    public boolean f43076a0;
    public boolean f43077b0;
    public d f43078c0;
    ...
    public static void x0(g gVar, int i10) {
        i51 G;
        d dVar = gVar.f43078c0;
        if (dVar != null && (G = dVar.G(i10)) != null) {
            int i11 = G.d;
            if (i11 == -1) {
                gVar.f43078c0.N(true);
            } else if (i11 == -2) {
    ...
    public final void C0(ArrayList arrayList, w51 w51Var) {
        ...
        i51Var.f25559c = (h0) super.r0(getParentActivity());
        ...
        animate.alpha(f10).withEndAction(new Runnable(this) {
            ...
            public final void run() {
                switch (r3) {
                    case 0:
                        if (z4) {
                            this.f43069b.V.setVisibility(8);
                            return;
                        }
                        return;
                    default:
                        if (!z4) {
                            this.f43069b.X.setVisibility(8);
                            return;
                        }
                        return;
                }
    ...
    public final View createView(Context context) {
        ...
        this.f35881c.setOnItemClickListener(new n(this, 17));
        this.f35885s.addView(new r00(getParentActivity()), b6.c(-1.0f, -1));
        ...
        this.U.setText(LocaleController.getString(R.string.YourTonBalance));
        this.U.setTextColor(j6.v0(j6.f20298z6, this.resourceProvider));
        ...
        if (z4) {
            ...
            this.W.setOnClickListener(new View.OnClickListener(this) {
                ...
                public final void onClick(View view) {
                    switch (r2) {
                        case 0:
                            af.g.u(this.f43067b.getParentActivity(), LocaleController.getString(R.string.TopUpViaFragmentLink));
                            return;
                        case 1:
                            af.g.u(this.f43067b.getParentActivity(), LocaleController.getString(R.string.TopUpViaFragmentLink));
                            return;
    ...
    public final void didReceivedNotification(int i10, int i11, Object... objArr) {
        if (i10 == NotificationCenter.starOptionsLoaded) {
            ...
            t7 y10 = t7.y(this.currentAccount, true);
            if (this.f43076a0 != y10.O(0)) {
                this.f43076a0 = y10.O(0);
                s0();
                d dVar2 = this.f43078c0;
                if (dVar2 != null) {
                    dVar2.N(true);
                }
                if (this.K == 0 && this.L < 0) {
    ...
    public final int getNavigationBarColor() {
        return j6.w0(null, j6.f19995i5, false);
    }

    @Override
    public final o0 n0() {
        d dVar = new d(this, this.f35881c, getParentActivity(), this.currentAccount, this.classGuid, new d4(this, 5), getResourceProvider());
        this.f43078c0 = dVar;
        dVar.f30240r = false;
        return dVar;
    }
    ...
    public final boolean q0() {
        ...
        if (iaVar != null && (iaVar.getParent() instanceof View)) {
            if (this.f35881c.getHeight() - ((View) this.O.getParent()).getBottom() >= 0) {
                z4 = true;
            }
        }
        return !z4;
