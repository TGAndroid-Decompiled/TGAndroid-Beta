...
public final class g extends Drawable implements DownloadController.FileDownloadProgressListener, no0 {
    ...
    public boolean X;
    public boolean Y;
    public final le.c f42038a;
    public int f42039a0;
    public final ImageReceiver f42040b;
    public int f42041b0;
    public final int f42042c;
    public final u1 d;
    public final int f42044d0;
    public String e;
    public int f42045e0;
    ...
    public t01 f42051s;
    public t01 v;
    public final RadialProgress2 f42053x;
    public final boolean f42054y;
    public final Paint f42052w = new Paint(1);
    public int Z = 0;
    public int f42043c0 = 255;

    public g(int i10, u1 u1Var, d6 d6Var, boolean z10) {
        ImageReceiver imageReceiver = new ImageReceiver(u1Var);
        this.f42040b = imageReceiver;
        imageReceiver.setRoundRadius(AndroidUtilities.dp(6.0f));
        this.f42042c = i10;
        this.f42054y = z10;
        this.f42053x = new RadialProgress2(u1Var, d6Var);
        this.d = u1Var;
        oo0 oo0Var = new oo0(u1Var);
        this.K = oo0Var;
        oo0Var.h = this;
        this.f42038a = new le.c(u1Var, ke.a.f13575a, 180L);
        this.f42044d0 = DownloadController.getInstance(i10).generateObserverTag();
    }

    public final void a() {
        this.f42040b.onAttachedToWindow();
        this.f42053x.e();
    }
    ...
    public final void c(boolean z10) {
        ...
        this.f42052w.setColor(1711276032);
        t01 t01Var2 = this.v;
        if (t01Var2 != null) {
            t01Var2.o(-1);
        }
        ...
        boolean z11 = this.X;
        RadialProgress2 radialProgress2 = this.f42053x;
        if (!z11 && !this.W) {
            radialProgress2.g(h6.f19198le, h6.f19217me, h6.ne, h6.f19253oe);
            return;
        }
        oo0 oo0Var = this.K;
        if (z10) {
            int w02 = h6.w0(null, h6.f19399wb, false);
            int w03 = h6.w0(null, h6.f19416xb, false);
            int i12 = h6.f19452zb;
            oo0Var.h(w02, w03, h6.w0(null, i12, false), h6.w0(null, i12, false), h6.w0(null, h6.f19433yb, false));
            radialProgress2.g(h6.Nb, h6.Ob, h6.Pa, h6.Qa);
            return;
        }
        radialProgress2.g(h6.f19142ie, h6.f19160je, h6.f19364uc, h6.f19381vc);
        int w04 = h6.w0(null, h6.f19365ud, false);
        int w05 = h6.w0(null, h6.f19382vd, false);
        int i13 = h6.f19417xd;
        oo0Var.h(w04, w05, h6.w0(null, i13, false), h6.w0(null, i13, false), h6.w0(null, h6.f19400wd, false));
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (this.f42043c0 != 0 && !bounds.isEmpty()) {
            int i11 = 0;
            f(false);
            boolean z10 = this.W;
            int i12 = 2;
            RadialProgress2 radialProgress2 = this.f42053x;
            if (!z10 && !this.X) {
                ImageReceiver imageReceiver = this.f42040b;
                imageReceiver.setAlpha(this.f42043c0 / 255.0f);
                ...
                if (this.G && this.v != null) {
                    canvas.drawRoundRect(AndroidUtilities.dp(6.0f) + bounds.left, AndroidUtilities.dp(6.0f) + bounds.top, bounds.left + this.v.f28357c + AndroidUtilities.dp(18.0f), AndroidUtilities.dp(23.0f) + bounds.top, AndroidUtilities.dp(8.5f), AndroidUtilities.dp(8.5f), this.f42052w);
                    this.v.e(canvas, AndroidUtilities.dp(12.0f) + bounds.left, AndroidUtilities.dp(15.0f) + bounds.top);
                }
            } else {
                int i13 = bounds.left;
                boolean z11 = this.f42054y;
                if (z11) {
                    dp = 0;
                } else {
                ...
                if (this.X) {
                    float f7 = this.f42038a.e;
                    if (this.f42050r != null && f7 < 1.0f) {
                        canvas.save();
                        float f10 = 1.0f - f7;
                        int i17 = i16 + i11;
                        canvas.scale(f10, f10, AndroidUtilities.dp(56.0f) + i14, AndroidUtilities.dp(35.0f) + i17);
                        this.f42050r.f28355a.setAlpha((int) (f10 * 255.0f));
                        this.f42050r.e(canvas, AndroidUtilities.dp(56.0f) + i14, AndroidUtilities.dp(35.0f) + i17);
                        canvas.restore();
                    }
                    if (f7 > 0.0f) {
                        oo0 oo0Var = this.K;
        ...
        if (this.Z != dp || z10) {
            ...
            if (str != null) {
                if (this.f42049n == null) {
                    this.f42049n = new t01(str, 15.0f, AndroidUtilities.bold());
                }
                t01 t01Var = this.f42049n;
                t01Var.r(TextUtils.ellipsize(this.e, t01Var.f28355a, dp, TextUtils.TruncateAt.MIDDLE));
            }
            String str2 = this.f42046f;
            if (str2 != null) {
                if (this.f42050r == null) {
                    this.f42050r = new t01(str2, 14.0f, null);
                }
                t01 t01Var2 = this.f42050r;
                t01Var2.r(TextUtils.ellipsize(this.f42046f, t01Var2.f28355a, dp, TextUtils.TruncateAt.END));
            }
            String str3 = this.h;
            if (str3 != null) {
                if (this.f42051s == null) {
                    this.f42051s = new t01(str3, 12.0f, null);
                }
                t01 t01Var3 = this.f42051s;
                t01Var3.r(TextUtils.ellipsize(this.h, t01Var3.f28355a, dp, TextUtils.TruncateAt.END));
            }
            if (this.G && this.v == null) {
    ...
    public final int getAlpha() {
        return this.f42043c0;
    }

    @Override
    public final int getObserverTag() {
        return this.f42044d0;
    }
    ...
    public final boolean i() {
        if (this.X && MediaController.getInstance().isPlayingMessage(this.H) && MediaController.getInstance().getPlayingMessageObject() != null && MediaController.getInstance().getPlayingMessageObject().isPlayingExplanationObject == this.f42054y) {
            return true;
        }
        return false;
    }
    ...
    public final boolean j(float f7, float f10, int i10) {
        if (!this.X || this.f42047f0 == 4) {
            return false;
        }
        if (i10 == 0) {
            int dp = AndroidUtilities.dp(36.0f);
            int dp2 = AndroidUtilities.dp(27.0f);
            int i11 = this.f42039a0 + dp2;
            if (f7 >= i11 && f7 <= i11 + dp) {
                int i12 = this.f42041b0 + dp2;
        ...
        if (z10) {
            if (i10 == 1) {
                a aVar = this.Q;
                if (aVar != null) {
                    TLRPC.Document document = aVar.f42016b;
                    int i13 = aVar.f42015a;
                    if (aVar.f42019g) {
    ...
    public final void k(int i10) {
        if (this.f42045e0 != i10) {
            this.f42045e0 = i10;
            this.f42053x.setIcon(i10, true, true);
        }
    }

    public final void l(int i10, boolean z10) {
        if (this.f42047f0 != i10) {
            this.f42047f0 = i10;
            this.f42053x.k(i10, true, z10);
        }
    }
