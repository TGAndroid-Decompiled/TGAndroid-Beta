...
public abstract class f0 extends FrameLayout {
    public boolean B;
    public final i5 f45320a;
    public eg.t2 f45321b;
    public final org.telegram.ui.Components.z5 f45322c;
    public final org.telegram.ui.Components.z5 d;
    public final e0 f45323e;
    public final FrameLayout f45324f;
    public final a0 h;
    public final zf.e f45325n;
    public final FrameLayout f45326r;
    public float f45327s;
    public final int[] v;
    public final int[] f45328w;
    public final int[] f45329x;
    public final zf.f f45330y;

    public f0(Context context, i5 i5Var) {
        super(context);
        this.f45327s = 0.0f;
        this.v = new int[2];
        this.f45328w = new int[2];
        this.f45329x = new int[2];
        this.f45330y = new Object();
        this.f45320a = i5Var;
        e0 e0Var = new e0(this, context);
        this.f45323e = e0Var;
        pr prVar = pr.h;
        this.f45322c = new org.telegram.ui.Components.z5(e0Var, 0L, 320L, prVar);
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ((l9) this.f45216b).C.l0(-1, false, true);
                        return;
                    case 1:
                        f0 f0Var = this.f45216b;
                        f0Var.h.l(true);
                        zf.e eVar2 = f0Var.f45325n;
                        eVar2.setRotated(false);
                        eVar2.setMirrored(false);
                        eVar2.b(0.0f);
                        return;
                    default:
                        f0 f0Var2 = this.f45216b;
                        eg.t2 t2Var = f0Var2.f45321b;
                        if (t2Var != null) {
                            t2Var.D0 = new MediaController.CropState();
                            f0Var2.h.b(f0Var2.f45321b.D0);
                            eg.t2 t2Var2 = f0Var2.f45321b;
                            t2Var2.D0.orientation = t2Var2.getOrientation();
                            f0Var2.f45321b.k();
                            f0Var2.f45321b.requestLayout();
                            f0Var2.f45321b.f5491w0.requestLayout();
                            f0Var2.f45321b.f5491w0.invalidate();
                            f0Var2.f45321b.f5491w0.post(new org.telegram.ui.web.s0(f0Var2, 11));
                        }
    ...
    public int getCurrentHeight() {
        eg.t2 t2Var = this.f45321b;
        if (t2Var == null) {
            return 1;
        }
        if (t2Var.getOrientation() != 90 && this.f45321b.getOrientation() != 270) {
            return this.f45321b.getContentHeight();
        }
        return this.f45321b.getContentWidth();
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        ...
        a0Var.setBottomPadding(AndroidUtilities.dp(116.0f) + this.f45324f.getPaddingBottom());
    ...
    public void set(eg.t2 t2Var) {
        ...
        this.f45320a.getLocationOnScreen(this.f45328w);
        t2Var.getLocationOnScreen(this.f45329x);
        MediaController.CropState cropState = t2Var.D0;
        if (cropState == null) {
            cropState = null;
        }
        a0Var.p(t2Var.getOrientation(), this.f45330y, cropState);
        float rotation = a0Var.getRotation();
        zf.e eVar = this.f45325n;
        eVar.setRotation(rotation);
        org.telegram.ui.Components.z5 z5Var = this.f45322c;
        if (cropState != null) {
        ...
        a0Var.r(false);
        e0 e0Var = this.f45323e;
        e0Var.setVisibility(0);
        e0Var.invalidate();
    }

    public void setAppearProgress(float f10) {
        if (Math.abs(this.f45327s - f10) < 0.001f) {
            return;
        }
        this.f45327s = f10;
        this.f45323e.invalidate();
        a0 a0Var = this.h;
