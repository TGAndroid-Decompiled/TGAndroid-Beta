...
public abstract class c0 extends FrameLayout {
    public final i5 f45128a;
    public final org.telegram.ui.Components.z5 f45129b;
    public final org.telegram.ui.Components.z5 f45130c;
    public final b0 d;
    public final FrameLayout f45131e;
    public final a0 f45132f;
    public final zf.e h;
    public final FrameLayout f45133n;
    public float f45134r;
    public final int[] f45135s;
    public final int[] v;
    public final zf.f f45136w;
    public r6 f45137x;
    ...
    public c0(Context context, i5 i5Var) {
        super(context);
        this.f45134r = 0.0f;
        this.f45135s = new int[2];
        this.v = new int[2];
        this.f45136w = new Object();
        this.f45128a = i5Var;
        b0 b0Var = new b0(this, context);
        this.d = b0Var;
        pr prVar = pr.h;
        this.f45129b = new org.telegram.ui.Components.z5(b0Var, 0L, 320L, prVar);
        this.f45130c = new org.telegram.ui.Components.z5(this, 0L, 360L, prVar);
        a0 a0Var = new a0(this, context, 0);
        this.f45132f = a0Var;
        a0Var.setListener(new oh.h4(this, 11));
        addView(a0Var);
        FrameLayout frameLayout = new FrameLayout(context);
        this.f45131e = frameLayout;
        ...
        textView.setOnClickListener(new View.OnClickListener(this) {
            ...
            public final void onClick(View view) {
                switch (r2) {
                    case 0:
                        ((k9) this.f46379b).B.l0(-1, false, true);
                        return;
                    case 1:
                        c0 c0Var = this.f46379b;
                        c0Var.f45132f.l(true);
                        zf.e eVar2 = c0Var.h;
                        ...
                        return;
                    default:
                        c0 c0Var2 = this.f46379b;
                        r6 r6Var = c0Var2.f45137x;
                        if (r6Var != null) {
                            r6Var.m0 = new MediaController.CropState();
                            c0Var2.f45132f.b(c0Var2.f45137x.m0);
                            r6 r6Var2 = c0Var2.f45137x;
    ...
    public int getCurrentHeight() {
        r6 r6Var = this.f45137x;
        if (r6Var == null) {
            return 1;
        }
        int i10 = r6Var.Q;
        i5 i5Var = this.f45128a;
        if (i10 != 90 && i10 != 270) {
            return i5Var.getContentHeight();
        }
        return i5Var.getContentWidth();
    }
    ...
    public final void onLayout(boolean z4, int i10, int i11, int i12, int i13) {
        this.f45132f.setBottomPadding(AndroidUtilities.dp(116.0f) + this.f45131e.getPaddingBottom());
        super.onLayout(z4, i10, i11, i12, i13);
    }

    public void setAppearProgress(float f10) {
        if (Math.abs(this.f45134r - f10) < 0.001f) {
            return;
        }
        this.f45134r = f10;
        b0 b0Var = this.d;
        b0Var.setAlpha(f10);
        b0Var.invalidate();
        a0 a0Var = this.f45132f;
        CropAreaView cropAreaView = a0Var.f51201a;
        CropAreaView cropAreaView2 = a0Var.f51201a;
        cropAreaView.setDimAlpha(0.5f * f10);
        cropAreaView2.setFrameAlpha(f10);
        cropAreaView2.invalidate();
        this.f45128a.invalidate();
    }
    ...
    public void setEntry(r6 r6Var) {
        ...
        a0 a0Var = this.f45132f;
        a0Var.G = true;
        getLocationOnScreen(this.f45135s);
        int[] iArr = this.v;
        i5 i5Var = this.f45128a;
        ...
        a0Var.r(false);
        this.f45130c.d(fVar.f51165i, true);
        b0 b0Var = this.d;
