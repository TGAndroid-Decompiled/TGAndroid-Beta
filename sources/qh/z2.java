...
public abstract class z2 extends sl0 {
    ...
    public String h;
    public TLRPC.User f46376n;
    public boolean f46377r;
    public final a3 f46379w;
    public final ArrayList f46373c = new ArrayList();
    public int f46374e = -1;
    public final ColorDrawable f46378s = new ColorDrawable(285212671);
        ...
        if (!this.d) {
            ...
            if (this.f46376n == null) {
                ...
                if (userOrChat instanceof TLRPC.User) {
                    this.f46376n = (TLRPC.User) userOrChat;
                }
            }
            TLRPC.User user = this.f46376n;
            if (user == null && !this.f46377r) {
                TLRPC.TL_contacts_resolveUsername tL_contacts_resolveUsername = new TLRPC.TL_contacts_resolveUsername();
                tL_contacts_resolveUsername.username = str;
                this.f46374e = ConnectionsManager.getInstance(i10).sendRequest(tL_contacts_resolveUsername, new li1(2, this, messagesController));
            } else if (user == null) {
            } else {
                TLRPC.TL_messages_getInlineBotResults tL_messages_getInlineBotResults = new TLRPC.TL_messages_getInlineBotResults();
                tL_messages_getInlineBotResults.bot = messagesController.getInputUser(this.f46376n);
                ...
                this.f46374e = ConnectionsManager.getInstance(i10).sendRequest(tL_messages_getInlineBotResults, new zd(13, this, TextUtils.isEmpty(str3)));
            }
        }
    }
    ...
    public final f2.m1 x(ViewGroup viewGroup, int i10) {
        return new f2.m1(new mh.z4(this.f46379w.getContext(), 1));
    }
}
