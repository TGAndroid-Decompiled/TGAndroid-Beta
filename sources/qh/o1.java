...
public final class o1 extends j1 {
    public final d1 f45820b;
    public final n1 f45821c;
    public final f2.w d;
    public final l1 f45822e;
    public final s1 f45823f;
    public int h;
    public float f45824n;
    public boolean f45825r;
    public final y1 f45826s;
    ...
    public final void a(int i10) {
        ...
        this.h = i11;
        this.d.y1(i11);
        boolean z10 = this.f45825r;
        n1 n1Var = this.f45821c;
        if (!z10) {
            n1Var.D(null);
        }
        y1 y1Var = this.f45826s;
        int i14 = y1Var.f46343c;
        s1 s1Var = this.f45823f;
        if (i14 >= 0) {
            s1Var.f46033r = true;
            s1Var.d.setText("");
            s1Var.f46033r = false;
            ...
            if (r1Var != null) {
                r1Var.E1(y1Var.f46343c);
                s1Var.f46031f.C1();
                if (s1Var.f46031f.getSelectedCategory() != null) {
                    n1Var.E = s1Var.f46031f.getSelectedCategory().f31738a;
                    org.telegram.ui.web.s0 s0Var = n1Var.J;
                    AndroidUtilities.cancelRunOnUIThread(s0Var);
                    AndroidUtilities.runOnUIThread(s0Var);
                }
            }
        } else if (!TextUtils.isEmpty(y1Var.f46342b)) {
            s1Var.d.setText(y1Var.f46342b);
            r1 r1Var2 = s1Var.f46031f;
            if (r1Var2 != null) {
                r1Var2.F1(null);
                s1Var.f46031f.D1();
            }
    ...
    public final float b() {
        float f10 = this.f45824n;
        if (f10 >= 0.0f) {
            return f10;
        }
        int i10 = 0;
        while (true) {
            d1 d1Var = this.f45820b;
    ...
    public final void c() {
        ...
        this.f45822e.setTranslationY(AndroidUtilities.dp(16.0f) + max);
        this.f45823f.setTranslationY(AndroidUtilities.dp(52.0f) + max);
        d1 d1Var = this.f45820b;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f45822e.setTranslationY(AndroidUtilities.dp(16.0f));
        this.f45823f.setTranslationY(AndroidUtilities.dp(52.0f));
        ...
        this.f45820b.setPadding(dp, dp2, dp3, AndroidUtilities.dp(f10) + i14);
