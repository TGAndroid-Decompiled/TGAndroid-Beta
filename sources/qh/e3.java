...
public final class e3 extends View implements c2 {
    public final org.telegram.ui.Components.j6 f45242a;
    ...
    public final void draw(Canvas canvas) {
        ...
        org.telegram.ui.Components.j6 j6Var = this.f45242a;
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        this.f45242a.G = getMeasuredWidth();
    }

    @Override
    public void setInvert(float f10) {
        this.f45242a.r(i0.a.d(f10, -1, -16777216));
    }

    @Override
    public final boolean verifyDrawable(Drawable drawable) {
        if (drawable != this.f45242a && !super.verifyDrawable(drawable)) {
            return false;
        }
        return true;
    }
