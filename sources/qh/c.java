...
public final class c extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final le.b H;
    public final le.b I;
    public final b6 f41774a;
    public final b f41775b;
    public final d f41776c;
    public final bo d;
    public final FrameLayout.LayoutParams e;
    public final k5 f41777f;
    public e h;
    public t1 f41778n;
    public int f41779r;
    public wg f41780s;
    public final t41 v;
    public final t41 f41781w;
    ...
    public c(Activity activity, f6 f6Var, bo boVar) {
        ...
        this.d = boVar;
        this.f41782x = boVar.getMessagesController().config.pollAnswerLengthMax.get();
    ...
    public static void a(c cVar) {
        k5 k5Var = cVar.f41777f;
        y10.d(k5Var, cVar.H.e);
        int i10 = j6.A6;
        bo boVar = cVar.d;
        k5Var.setTextColor(i0.a.d(cVar.I.e, j6.v0(i10, boVar.getResourceProvider()), j6.v0(j6.f19082p7, boVar.getResourceProvider())));
    }
    ...
    public final boolean onPreDraw() {
        t1 t1Var;
        sh.a aVar;
        t1 t1Var2 = this.f41778n;
        if (t1Var2 != null) {
            int id2 = t1Var2.getMessageObject().getId();
            if (this.f41778n.isAttachedToWindow() && this.f41779r == id2 && (aVar = (t1Var = this.f41778n).f20987a6) != null && t1Var.f21172n6) {
                Rect bounds = aVar.getBounds();
                Rect rect = this.E;
                rect.set(bounds);
                t1 t1Var3 = this.f41778n;
                int[] iArr = this.f41783y;
    ...
    public void setCellToWatch(t1 t1Var) {
        this.f41778n = t1Var;
        this.f41779r = t1Var.getMessageObject().getId();
    }
    ...
    public void setColor(int i10) {
        if (this.G != i10) {
            ...
            b bVar = this.f41775b;
            bVar.f41772b.setColorFilter(porterDuffColorFilter);
            bVar.f41773c.setColorFilter(porterDuffColorFilter);
            this.f41776c.f41784a.setColorFilter(porterDuffColorFilter);
            b6 b6Var = this.f41774a;
