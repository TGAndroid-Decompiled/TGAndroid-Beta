...
public final class c extends ph.e {
    ...
    public final Uri f41012c;
    public final String d;
    public final long e;
    public final String f41013f;
    public final Drawable h;
    public final StaticLayout f41014n;
    ...
    public c(String str) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            this.f41014n = new StaticLayout(TextUtils.ellipsize(str2, textPaint, AndroidUtilities.dp(34.0f), TextUtils.TruncateAt.END), textPaint, AndroidUtilities.dp(34.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            return;
        }
        this.f41014n = null;
    }
    ...
    public static b d(View view, String str, String str2, TLRPC.Document document, MessageObject messageObject) {
        b bVar = new b();
        bVar.f41002a.setColor(j6.w0(null, j6.G6, false));
        bVar.f41003b.setColor(j6.w0(null, j6.f18306y6, false));
        RadialProgress2 radialProgress2 = new RadialProgress2(view, null);
        bVar.f41004c = radialProgress2;
        radialProgress2.setCircleRadius(AndroidUtilities.dp(21.0f));
        bVar.f41004c.g(j6.f18025ie, j6.f18043je, j6.f18242uc, j6.f18259vc);
        if (MessageObject.isMusicDocument(document)) {
            if (MessageObject.isDocumentHasThumb(document)) {
                ...
                bVar.f41004c.j(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.dp(44.0f), true, closestPhotoSizeWithSize, true), closestPhotoSizeWithSize, document, messageObject);
            } else {
                String artworkUrl = MessageObject.getArtworkUrl(document, true);
                if (!TextUtils.isEmpty(artworkUrl)) {
                    bVar.f41004c.h(artworkUrl);
                } else {
                    bVar.f41004c.i(null, null, null);
                }
            }
            bVar.f41004c.setIcon(0, false, false);
        } else {
            bVar.f41004c.setIcon(5, false, false);
        }
        if (str == null) {
            str = "";
        }
    ...
    public c(Uri uri) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            textPaint.setTypeface(AndroidUtilities.bold());
            textPaint.setColor(j6.w0(null, j6.Bi, false));
            this.f41014n = new StaticLayout(TextUtils.ellipsize(str, textPaint, AndroidUtilities.dp(34.0f), TextUtils.TruncateAt.END), textPaint, AndroidUtilities.dp(34.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            return;
        }
        this.f41014n = null;
    }
