...
public abstract class d {
    ...
    public static int a(b bVar, boolean z10) {
        int i10;
        byte b10;
        int i11 = bVar.f12955b;
        int i12 = bVar.f12956c;
        if (z10) {
            i10 = i12;
        } else {
            i10 = i11;
    ...
    public static void b(dc.a aVar, hc.c cVar, hc.f fVar, int i10, b bVar) {
        ...
        int i17;
        int i18;
        byte[][] bArr2 = bVar.f12954a;
        int i19 = bVar.f12955b;
        int i20 = bVar.f12956c;
        for (byte[] bArr3 : bArr2) {
            Arrays.fill(bArr3, (byte) -1);
        }
        int length = f12959a[0].length;
        e(0, 0, bVar);
        int i21 = i19 - length;
        e(i21, 0, bVar);
        e(0, i21, bVar);
        ...
        if (bVar.a(8, i23) != 0) {
            bVar.b(8, i23, 1);
            int i25 = fVar.f10179a;
            if (i25 < 2) {
                c11 = 1;
                c10 = 0;
            } else {
                c10 = 0;
                int[] iArr = f12961c[i25 - 1];
                c11 = 1;
            ...
            dc.a aVar2 = new dc.a();
            if (i10 >= 0 && i10 < 8) {
                int i41 = (cVar.f10165a << 3) | i10;
                aVar2.b(i41, 5);
                aVar2.b(c(i41, 1335), 10);
                dc.a aVar3 = new dc.a();
                aVar3.b(21522, 15);
                if (aVar2.f7614b == aVar3.f7614b) {
                    int i42 = 0;
                    while (true) {
                        int[] iArr3 = aVar2.f7613a;
                        if (i42 >= iArr3.length) {
                            break;
                        }
                        iArr3[i42] = iArr3[i42] ^ aVar3.f7613a[i42];
                        i42++;
                    }
                    if (aVar2.f7614b == 15) {
                        int i43 = 0;
                        while (true) {
                            int i44 = aVar2.f7614b;
                            if (i43 >= i44) {
                                break;
                            }
                        ...
                        if (i25 >= 7) {
                            ...
                            if (aVar4.f7614b == 18) {
                                ...
                                throw new Exception("should not happen but we got: " + aVar4.f7614b);
                            }
                        }
                        int i50 = i37 - 1;
                        int i51 = i20 - 1;
                        ...
                        throw new Exception("Not all bits consumed: " + i52 + '/' + aVar.f7614b);
                    }
                    throw new Exception("should not happen but we got: " + aVar2.f7614b);
                }
