...
public final class b {
    public final byte[][] f12952a;
    public final int f12953b;
    public final int f12954c;

    public b(int i10, int i11) {
        this.f12952a = (byte[][]) Array.newInstance(Byte.TYPE, i11, i10);
        this.f12953b = i10;
        this.f12954c = i11;
    }

    public final byte a(int i10, int i11) {
        return this.f12952a[i11][i10];
    }

    public final void b(int i10, int i11, int i12) {
        this.f12952a[i11][i10] = (byte) i12;
    }
