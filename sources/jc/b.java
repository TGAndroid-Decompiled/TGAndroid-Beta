...
public final class b {
    ...
    public b(int i10, int i11) {
        this.f12944a = (byte[][]) Array.newInstance(Byte.TYPE, i11, i10);
        this.f12945b = i10;
        this.f12946c = i11;
    }

    public final byte a(int i10, int i11) {
        return this.f12944a[i11][i10];
    }

    public final void b(int i10, int i11, int i12) {
        this.f12944a[i11][i10] = (byte) i12;
    }

    public final String toString() {
        int i10 = this.f12945b;
        int i11 = this.f12946c;
        StringBuilder sb2 = new StringBuilder((i10 * 2 * i11) + 2);
        for (int i12 = 0; i12 < i11; i12++) {
            byte[] bArr = this.f12944a[i12];
