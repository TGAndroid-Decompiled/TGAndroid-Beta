...
import zd.m;
public class i {
    public static final AtomicReferenceFieldUpdater f11092b = AtomicReferenceFieldUpdater.newUpdater(i.class, Object.class, "head$volatile");
    public static final AtomicLongFieldUpdater f11093c = AtomicLongFieldUpdater.newUpdater(i.class, "deqIdx$volatile");
    ...
    public static final AtomicIntegerFieldUpdater f11094f = AtomicIntegerFieldUpdater.newUpdater(i.class, "_availablePermits$volatile");
    ...
    public final void a(c cVar) {
        ...
        d dVar = cVar.f11085b;
        while (true) {
            int andDecrement = f11094f.getAndDecrement(this);
            if (andDecrement <= 1) {
                ...
                f fVar = f.f11088a;
                long j3 = andIncrement / j.f11099f;
                while (true) {
                ...
                int i10 = (int) (andIncrement % j.f11099f);
