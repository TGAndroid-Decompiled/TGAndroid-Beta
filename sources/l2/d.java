...
public final class d implements y2.h {
    ...
    public k4.d n(y2.j jVar, long j3, long j10, IOException iOException, int i10) {
        p pVar = (p) jVar;
        g gVar = this.f13814a;
        a5.a aVar = gVar.f13832q;
        long j11 = pVar.f46294a;
        Uri uri = pVar.d.f9349c;
        aVar.r(new t(j10), pVar.f46296c, iOException, true);
    ...
    public void q(y2.j jVar, long j3, long j10) {
        ...
        gVar.L = ((Long) pVar.f46297f).longValue() - j3;
        gVar.y(true);
    }
