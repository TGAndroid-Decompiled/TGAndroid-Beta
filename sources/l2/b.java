...
public final class b implements d0, c1, v2.g {
    ...
    public final a5.a f13803b;
    public final g2.c0 f13804c;
    public final n2.m d;
    public final qb.b e;
    public final t f13805f;
    public final long h;
    public final y2.n f13806n;
    public final y2.d f13807r;
    public final o1 f13808s;
    public final a[] v;
    public final ob.a f13809w;
    public final o f13810x;
    public boolean N = true;
    public v2.h[] H = new v2.h[0];
    public l[] I = new l[0];
    public final IdentityHashMap f13811y = new IdentityHashMap();
    ...
    public b(int i10, m2.c cVar, t tVar, int i11, a5.a aVar, g2.c0 c0Var, n2.m mVar, n2.j jVar, qb.b bVar, a5.a aVar2, long j3, y2.n nVar, y2.d dVar, ob.a aVar3, ka.c cVar2, j2.k kVar) {
        ...
        this.f13807r = dVar;
        this.f13809w = aVar3;
        this.f13810x = new o(cVar, cVar2, dVar);
        aVar3.getClass();
        g0 g0Var = i0.f8081b;
        a1 a1Var = a1.e;
        ...
        for (int i15 = 0; i15 < size; i15++) {
            hashMap.put(Long.valueOf(((m2.a) list2.get(i15)).f14384a), Integer.valueOf(i15));
        ...
        for (int i16 = 0; i16 < size; i16++) {
            ...
            List list3 = aVar4.e;
            List list4 = aVar4.f14387f;
            m2.f e7 = e("http://dashif.org/guidelines/trickmode", list3);
            e7 = e7 == null ? e("http://dashif.org/guidelines/trickmode", list4) : e7;
            int intValue = (e7 == null || (num = (Integer) hashMap.get(Long.valueOf(Long.parseLong(e7.f14411b)))) == null || !b(aVar4, (m2.a) list2.get(num.intValue()))) ? i16 : num.intValue();
            if (intValue == i16 && (e = e("urn:mpeg:dash:adaptation-set-switching:2016", list4)) != null) {
                String str = e.f14411b;
        ...
        while (i18 < size2) {
            ...
            while (true) {
                ...
                List list7 = ((m2.a) list2.get(iArr3[i20])).f14386c;
                iArr = iArr2;
            ...
            while (true) {
                if (i22 < length2) {
                    ...
                    while (i24 < list8.size()) {
                        ...
                        zArr = zArr2;
                        sVarArr = sVarArr3;
                        if ("urn:scte:dash:cc:cea-608:2015".equals(fVar.f14410a)) {
                            r rVar = new r();
                            rVar.f3250q = r0.n("application/cea-608");
                            rVar.f3237a = a4.a.s(new StringBuilder(), aVar5.f14384a, ":cea608");
                            sVarArr2 = n(fVar, P, new s(rVar));
                            break;
                        } else if ("urn:scte:dash:cc:cea-708:2015".equals(fVar.f14410a)) {
                            r rVar2 = new r();
                            rVar2.f3250q = r0.n("application/cea-708");
                            rVar2.f3237a = a4.a.s(new StringBuilder(), aVar5.f14384a, ":cea708");
        ...
        while (i26 < size2) {
            ...
            for (int i27 : iArr7) {
                arrayList3.addAll(((m2.a) list2.get(i27)).f14386c);
            }
            ...
            while (i28 < size4) {
                int i29 = size2;
                s sVar = ((m2.m) arrayList3.get(i28)).f14428a;
                int i30 = i25;
                r a2 = sVar.a();
                a2.R = mVar2.L0(sVar);
            ...
            if (i33 != -1) {
                ...
                r rVar3 = new r();
                rVar3.f3237a = g10;
                rVar3.f3250q = r0.n("application/x-emsg");
        ...
        while (i37 < list.size()) {
            ...
            r rVar4 = new r();
            rVar4.f3237a = gVar.a();
            rVar4.f3250q = r0.n("application/x-emsg");
        ...
        this.f13808s = (o1) create.first;
        this.v = (a[]) create.second;
    }

    public static boolean b(m2.a aVar, m2.a aVar2) {
        int i10 = aVar.f14385b;
        List list = aVar.f14386c;
        int i11 = aVar2.f14385b;
        List list2 = aVar2.f14386c;
        if (i10 == i11) {
            if (!list.isEmpty() && !list2.isEmpty()) {
                s sVar = ((m2.m) list.get(0)).f14428a;
                s sVar2 = ((m2.m) list2.get(0)).f14428a;
                int i12 = sVar.f3295f & (-16385);
                int i13 = sVar2.f3295f & (-16385);
    ...
    public static void j(a5.a aVar, s[] sVarArr) {
        ...
        for (int i10 = 0; i10 < sVarArr.length; i10++) {
            s sVar = sVarArr[i10];
            p pVar = (p) aVar.d;
            if (pVar.f3173b && ((qb.b) pVar.f3174c).W(sVar)) {
                r a2 = sVar.a();
                String str2 = sVar.f3299k;
                a2.f3250q = r0.n("application/x-media3-cues");
                a2.O = ((qb.b) pVar.f3174c).D(sVar);
    ...
    public static s[] n(m2.f fVar, Pattern pattern, s sVar) {
        ...
        for (int i10 = 0; i10 < split.length; i10++) {
            ...
            r a2 = sVar.a();
            a2.f3237a = sVar.f3292a + ":" + parseInt;
            a2.N = parseInt;
    ...
    public final int f(int i10, int[] iArr) {
        ...
        if (i11 != -1) {
            ...
            for (int i13 = 0; i13 < iArr.length; i13++) {
                int i14 = iArr[i13];
                if (i14 == i12 && aVarArr[i14].f13799c == 0) {
                    return i13;
                }
            }
        }
    ...
    public final long h(long j3) {
        ...
        for (v2.h hVar : this.H) {
            u2.a1[] a1VarArr = hVar.f43856y;
            u2.a1 a1Var = hVar.f43855x;
            y2.m mVar = hVar.f43852r;
        ...
        for (l lVar : this.I) {
            int a2 = e2.d0.a(lVar.f13858c, j3, true);
            lVar.h = a2;
            if (lVar.d && a2 == lVar.f13858c.length) {
                j10 = j3;
            } else {
    ...
    public final void i(long j3) {
        ...
        for (v2.h hVar : this.H) {
            if (!hVar.y()) {
                u2.a1 a1Var = hVar.f43855x;
                int i10 = a1Var.f43321q;
                a1Var.j(j3, true);
                u2.a1 a1Var2 = hVar.f43855x;
                int i11 = a1Var2.f43321q;
                if (i11 > i10) {
                    synchronized (a1Var2) {
                        if (a1Var2.f43320p == 0) {
                            j10 = Long.MIN_VALUE;
                        } else {
                            j10 = a1Var2.f43318n[a1Var2.f43322r];
                        }
                    }
                    int i12 = 0;
                    while (true) {
    ...
    public final long p(x2.r[] rVarArr, boolean[] zArr, b1[] b1VarArr, boolean[] zArr2, long j3) {
        ...
        while (true) {
            ...
            if (rVar != null) {
                iArr3[i14] = this.f13808s.b(rVar.b());
            } else {
                iArr3[i14] = -1;
            }
            i14++;
        ...
        while (true) {
            ...
            if ((r33 instanceof u2.q) || (r33 instanceof v2.f)) {
                ...
                if (f7 == -1) {
                    ...
                    ?? r72 = b1VarArr[i17];
                    z12 = ((r72 instanceof v2.f) && ((v2.f) r72).f43844a == b1VarArr[f7]) ? false : false;
                }
                if (!z12) {
                    ?? r34 = b1VarArr[i17];
        ...
        while (i19 < rVarArr.length) {
            ...
            if (rVar2 == null) {
                ...
                if (r35 == 0) {
                    ...
                    int i20 = aVar.f13799c;
                    if (i20 == 0) {
                        int i21 = aVar.f13800f;
                        if (i21 != i10) {
                            z11 = true;
                        } else {
                            z11 = false;
                        ...
                        if (z11) {
                            l1Var = this.f13808s.a(i21);
                            i12 = 1;
                        } else {
                            l1Var = null;
                            i12 = 0;
                        }
                        int i22 = aVar.f13801g;
                        if (i22 != i10) {
                            a1Var = this.v[i22].h;
                        } else {
                            g0 g0Var = i0.f8081b;
                        ...
                        if (this.K.d && z11) {
                            o oVar = this.f13810x;
                            nVar = new n(oVar, oVar.f13866a);
                        } else {
                            nVar = null;
                        }
                        a5.a aVar2 = this.f13803b;
                        y2.n nVar2 = this.f13806n;
                        m2.c cVar = this.K;
                        t tVar = this.f13805f;
                        int i24 = this.L;
                        int[] iArr5 = aVar.f13797a;
                        int i25 = aVar.f13798b;
                        iArr2 = iArr3;
                        long j10 = this.h;
                        g2.c0 c0Var = this.f13804c;
                        ...
                        n nVar3 = nVar;
                        i11 = i19;
                        v2.h hVar3 = new v2.h(aVar.f13798b, iArr4, sVarArr, new k((p) aVar2.d, nVar2, cVar, tVar, i24, iArr5, rVar2, i25, createDataSource, j10, aVar2.f277b, z11, arrayList, nVar), this, this.f13807r, j3, this.d, this.F, this.e, this.E, this.N);
                        synchronized (this) {
                            this.f13811y.put(hVar3, nVar3);
                        }
                        b1VarArr[i11] = hVar3;
                    } else {
                        iArr2 = iArr3;
            ...
            if (b1VarArr[i26] == 0 && rVarArr[i26] != null) {
                ...
                if (aVar3.f13799c == 1) {
                    ...
                    if (f10 == -1) {
                        ...
                        int i27 = aVar3.f13798b;
                        boolean[] zArr5 = hVar4.d;
                        u2.a1[] a1VarArr = hVar4.f43856y;
                        for (int i28 = 0; i28 < a1VarArr.length; i28++) {
                            if (hVar4.f43848b[i28] == i27) {
                                e2.d.g(!zArr5[i28]);
                                zArr5[i28] = true;
