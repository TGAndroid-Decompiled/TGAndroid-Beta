...
public final class b implements d0, c1, v2.g {
    ...
    public final long k(long j3) {
        ...
        for (v2.h hVar : this.H) {
            u2.a1[] a1VarArr = hVar.f47348y;
            u2.a1 a1Var = hVar.f47347x;
            y2.m mVar = hVar.f47344r;
    ...
    public final void l(long j3) {
        ...
        for (v2.h hVar : this.H) {
            if (!hVar.z()) {
                u2.a1 a1Var = hVar.f47347x;
                int i10 = a1Var.f46661q;
                a1Var.j(j3, true);
                u2.a1 a1Var2 = hVar.f47347x;
                int i11 = a1Var2.f46661q;
                if (i11 > i10) {
                    synchronized (a1Var2) {
                        if (a1Var2.f46660p == 0) {
                            j10 = Long.MIN_VALUE;
                        } else {
                            j10 = a1Var2.f46658n[a1Var2.f46662r];
                        }
                    }
                    int i12 = 0;
                    while (true) {
        ...
        for (int i15 = 0; i15 < rVarArr.length; i15++) {
            if (rVarArr[i15] == null || !zArr[i15]) {
                ...
                if (r32 instanceof v2.h) {
                    ...
                    v2.f fVar = (v2.f) r32;
                    v2.h hVar = fVar.f47337e;
                    boolean[] zArr3 = hVar.d;
                    int i16 = fVar.f47336c;
                    e2.d.g(zArr3[i16]);
                    hVar.d[i16] = false;
                }
                b1VarArr[i15] = 0;
        ...
        while (true) {
            ...
            if ((r33 instanceof u2.q) || (r33 instanceof v2.f)) {
                ...
                if (g10 == -1) {
                    ...
                    ?? r72 = b1VarArr[i17];
                    z12 = ((r72 instanceof v2.f) && ((v2.f) r72).f47334a == b1VarArr[g10]) ? false : false;
                }
                if (!z12) {
                    ?? r34 = b1VarArr[i17];
                    if (r34 instanceof v2.f) {
                        v2.f fVar2 = (v2.f) r34;
                        v2.h hVar2 = fVar2.f47337e;
                        boolean[] zArr4 = hVar2.d;
                        int i18 = fVar2.f47336c;
                        e2.d.g(zArr4[i18]);
                        hVar2.d[i18] = false;
                    }
                    b1VarArr[i17] = 0;
            ...
            if (rVar2 == null) {
                ...
                if (r35 == 0) {
                    ...
                    if (r35 instanceof v2.h) {
                        ((v2.h) r35).f47341e.f15261j = rVar2;
                    }
                }
            }
            i19 = i11 + 1;
            ...
            if (b1VarArr[i26] == 0 && rVarArr[i26] != null) {
                ...
                if (aVar3.f15204c == 1) {
                    ...
                    if (g11 == -1) {
                        ...
                        u2.a1[] a1VarArr = hVar4.f47348y;
                        for (int i28 = 0; i28 < a1VarArr.length; i28++) {
                            if (hVar4.f47339b[i28] == i27) {
                                e2.d.g(!zArr5[i28]);
                                zArr5[i28] = true;
