...
public final class b implements d0, c1, v2.g {
    ...
    public final a5.a f14012b;
    public final g2.c0 f14013c;
    public final n2.n d;
    public final qb.b e;
    public final t f14014f;
    public final long h;
    public final y2.n f14015n;
    public final y2.d f14016r;
    public final p1 f14017s;
    public final a[] v;
    public final ob.a f14018w;
    public final o f14019x;
    public boolean N = true;
    public v2.h[] H = new v2.h[0];
    public l[] I = new l[0];
    public final IdentityHashMap f14020y = new IdentityHashMap();
    ...
    public b(int i10, m2.c cVar, t tVar, int i11, a5.a aVar, g2.c0 c0Var, n2.n nVar, n2.k kVar, qb.b bVar, a5.a aVar2, long j3, y2.n nVar2, y2.d dVar, ob.a aVar3, u uVar, j2.k kVar2) {
        ...
        this.f14016r = dVar;
        this.f14018w = aVar3;
        this.f14019x = new o(cVar, uVar, dVar);
        aVar3.getClass();
        g0 g0Var = i0.f8066b;
        a1 a1Var = a1.e;
        ...
        for (int i14 = 0; i14 < size; i14++) {
            hashMap.put(Long.valueOf(((m2.a) list2.get(i14)).f14612a), Integer.valueOf(i14));
        ...
        for (int i15 = 0; i15 < size; i15++) {
            ...
            List list3 = aVar4.e;
            List list4 = aVar4.f14615f;
            m2.f e7 = e("http://dashif.org/guidelines/trickmode", list3);
            e7 = e7 == null ? e("http://dashif.org/guidelines/trickmode", list4) : e7;
            int intValue = (e7 == null || (num = (Integer) hashMap.get(Long.valueOf(Long.parseLong(e7.f14639b)))) == null || !a(aVar4, (m2.a) list2.get(num.intValue()))) ? i15 : num.intValue();
            if (intValue == i15 && (e = e("urn:mpeg:dash:adaptation-set-switching:2016", list4)) != null) {
                String str = e.f14639b;
        ...
        while (i17 < size2) {
            ...
            while (true) {
                ...
                List list7 = ((m2.a) list2.get(iArr3[i19])).f14614c;
                iArr = iArr2;
            ...
            while (true) {
                if (i21 < length2) {
                    ...
                    while (i23 < list8.size()) {
                        ...
                        zArr = zArr2;
                        sVarArr = sVarArr3;
                        if ("urn:scte:dash:cc:cea-608:2015".equals(fVar.f14638a)) {
                            r rVar = new r();
                            rVar.f3245q = r0.n("application/cea-608");
                            rVar.f3232a = a4.a.s(new StringBuilder(), aVar5.f14612a, ":cea608");
                            sVarArr2 = n(fVar, P, new s(rVar));
                            break;
                        } else if ("urn:scte:dash:cc:cea-708:2015".equals(fVar.f14638a)) {
                            r rVar2 = new r();
                            rVar2.f3245q = r0.n("application/cea-708");
                            rVar2.f3232a = a4.a.s(new StringBuilder(), aVar5.f14612a, ":cea708");
        ...
        while (i25 < size2) {
            ...
            for (int i26 : iArr7) {
                arrayList3.addAll(((m2.a) list2.get(i26)).f14614c);
            }
            ...
            while (i27 < size4) {
                int i28 = size2;
                s sVar = ((m2.m) arrayList3.get(i27)).f14656a;
                int i29 = i24;
                r a2 = sVar.a();
                a2.R = nVar3.L0(sVar);
        ...
        this.f14017s = (p1) create.first;
        this.v = (a[]) create.second;
    }

    public static boolean a(m2.a aVar, m2.a aVar2) {
        int i10 = aVar.f14613b;
        List list = aVar.f14614c;
        int i11 = aVar2.f14613b;
        List list2 = aVar2.f14614c;
        if (i10 == i11) {
            if (!list.isEmpty() && !list2.isEmpty()) {
                s sVar = ((m2.m) list.get(0)).f14656a;
                s sVar2 = ((m2.m) list2.get(0)).f14656a;
    ...
    public final int f(int i10, int[] iArr) {
        ...
        if (i11 != -1) {
            ...
            for (int i13 = 0; i13 < iArr.length; i13++) {
                int i14 = iArr[i13];
                if (i14 == i12 && aVarArr[i14].f14008c == 0) {
                    return i13;
                }
            }
        }
    ...
    public final long h(long j3) {
        ...
        for (v2.h hVar : this.H) {
            u2.a1[] a1VarArr = hVar.f44128y;
            u2.a1 a1Var = hVar.f44127x;
            y2.m mVar = hVar.f44124r;
        ...
        for (l lVar : this.I) {
            int a2 = e2.d0.a(lVar.f14067c, j3, true);
            lVar.h = a2;
            if (lVar.d && a2 == lVar.f14067c.length) {
                j10 = j3;
            } else {
    ...
    public final void i(long j3) {
        ...
        for (v2.h hVar : this.H) {
            if (!hVar.y()) {
                u2.a1 a1Var = hVar.f44127x;
                int i10 = a1Var.f43595q;
                a1Var.j(j3, true);
                u2.a1 a1Var2 = hVar.f44127x;
                int i11 = a1Var2.f43595q;
                if (i11 > i10) {
                    synchronized (a1Var2) {
                        if (a1Var2.f43594p == 0) {
                            j10 = Long.MIN_VALUE;
                        } else {
                            j10 = a1Var2.f43592n[a1Var2.f43596r];
                        }
                    }
                    int i12 = 0;
                    while (true) {
    ...
    public final long q(x2.r[] rVarArr, boolean[] zArr, b1[] b1VarArr, boolean[] zArr2, long j3) {
        ...
        while (true) {
            ...
            if (rVar != null) {
                iArr3[i14] = this.f14017s.b(rVar.b());
            } else {
                iArr3[i14] = -1;
            }
            i14++;
        ...
        while (true) {
            ...
            if ((r33 instanceof u2.q) || (r33 instanceof v2.f)) {
                ...
                if (f7 == -1) {
                    ...
                    ?? r72 = b1VarArr[i17];
                    z12 = ((r72 instanceof v2.f) && ((v2.f) r72).f44116a == b1VarArr[f7]) ? false : false;
                }
                if (!z12) {
                    ?? r34 = b1VarArr[i17];
        ...
        while (i19 < rVarArr.length) {
            ...
            if (rVar2 == null) {
                ...
                if (r35 == 0) {
                    ...
                    int i20 = aVar.f14008c;
                    if (i20 == 0) {
                        int i21 = aVar.f14009f;
                        if (i21 != i10) {
                            z11 = true;
                        } else {
                            z11 = false;
                        ...
                        if (z11) {
                            l1Var = this.f14017s.a(i21);
                            i12 = 1;
                        } else {
                            l1Var = null;
                            i12 = 0;
                        }
                        int i22 = aVar.f14010g;
                        if (i22 != i10) {
                            a1Var = this.v[i22].h;
                        } else {
                            g0 g0Var = i0.f8066b;
                        ...
                        if (this.K.d && z11) {
                            o oVar = this.f14019x;
                            nVar = new n(oVar, oVar.f14075a);
                        } else {
                            nVar = null;
                        }
                        a5.a aVar2 = this.f14012b;
                        y2.n nVar2 = this.f14015n;
                        m2.c cVar = this.K;
                        t tVar = this.f14014f;
                        int i24 = this.L;
                        int[] iArr5 = aVar.f14006a;
                        int i25 = aVar.f14007b;
                        iArr2 = iArr3;
                        long j10 = this.h;
                        g2.c0 c0Var = this.f14013c;
                        ...
                        n nVar3 = nVar;
                        i11 = i19;
                        v2.h hVar3 = new v2.h(aVar.f14007b, iArr4, sVarArr, new k((p) aVar2.d, nVar2, cVar, tVar, i24, iArr5, rVar2, i25, createDataSource, j10, aVar2.f277b, z11, arrayList, nVar), this, this.f14016r, j3, this.d, this.F, this.e, this.E, this.N);
                        synchronized (this) {
                            this.f14020y.put(hVar3, nVar3);
                        }
                        b1VarArr[i11] = hVar3;
                    } else {
                        iArr2 = iArr3;
            ...
            if (b1VarArr[i26] == 0 && rVarArr[i26] != null) {
                ...
                if (aVar3.f14008c == 1) {
                    ...
                    if (f10 == -1) {
                        ...
                        int i27 = aVar3.f14007b;
                        boolean[] zArr5 = hVar4.d;
                        u2.a1[] a1VarArr = hVar4.f44128y;
                        for (int i28 = 0; i28 < a1VarArr.length; i28++) {
                            if (hVar4.f44120b[i28] == i27) {
                                e2.d.g(!zArr5[i28]);
                                zArr5[i28] = true;
