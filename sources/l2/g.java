...
public final class g extends u2.a {
    ...
    public final d0 c(u2.f0 f0Var, y2.d dVar, long j3) {
        int intValue = ((Integer) f0Var.f46668a).intValue() - this.O;
        a5.a b10 = b(f0Var);
    ...
    public final void w(p pVar, long j3) {
        long j10 = pVar.f49522a;
        Uri uri = pVar.d.f10298c;
        t tVar = new t(j3);
        this.f15210m.getClass();
        this.f15214q.n(tVar, pVar.f49524c, -1, null, 0, null, -9223372036854775807L, -9223372036854775807L);
    }
