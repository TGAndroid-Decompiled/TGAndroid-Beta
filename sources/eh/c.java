...
public final class c extends dh.h {
    ...
    public final Uri f5590c;
    public final String d;
    public final long e;
    public final String f5591f;
    public final Drawable h;
    public final StaticLayout f5592n;
    ...
    public c(String str) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            this.f5592n = new StaticLayout(TextUtils.ellipsize(str2, textPaint, AndroidUtilities.dp(34.0f), TextUtils.TruncateAt.END), textPaint, AndroidUtilities.dp(34.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            return;
        }
        this.f5592n = null;
    }
    ...
    public static b d(View view, String str, String str2, TLRPC.Document document, MessageObject messageObject) {
        b bVar = new b();
        bVar.f5580a.setColor(j6.w0(null, j6.G6, false));
        bVar.f5581b.setColor(j6.w0(null, j6.f20256y6, false));
        RadialProgress2 radialProgress2 = new RadialProgress2(view, null);
        bVar.f5582c = radialProgress2;
        radialProgress2.setCircleRadius(AndroidUtilities.dp(21.0f));
        bVar.f5582c.g(j6.f19978ie, j6.f19995je, j6.f20188uc, j6.f20206vc);
        if (MessageObject.isMusicDocument(document)) {
            if (MessageObject.isDocumentHasThumb(document)) {
                ...
                bVar.f5582c.j(FileLoader.getClosestPhotoSizeWithSize(document.thumbs, AndroidUtilities.dp(44.0f), true, closestPhotoSizeWithSize, true), closestPhotoSizeWithSize, document, messageObject);
            } else {
                String artworkUrl = MessageObject.getArtworkUrl(document, true);
                if (!TextUtils.isEmpty(artworkUrl)) {
                    bVar.f5582c.h(artworkUrl);
                } else {
                    bVar.f5582c.i(null, null, null);
                }
            }
            bVar.f5582c.setIcon(0, false, false);
        } else {
            bVar.f5582c.setIcon(5, false, false);
        }
        if (str == null) {
            str = "";
        }
    ...
    public c(Uri uri) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            textPaint.setTypeface(AndroidUtilities.bold());
            textPaint.setColor(j6.w0(null, j6.Bi, false));
            this.f5592n = new StaticLayout(TextUtils.ellipsize(str, textPaint, AndroidUtilities.dp(34.0f), TextUtils.TruncateAt.END), textPaint, AndroidUtilities.dp(34.0f), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
            return;
        }
        this.f5592n = null;
    }
