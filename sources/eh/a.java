...
public final class a implements d, e6 {
    ...
    public int g(e6 e6Var, boolean z10) {
        ...
        switch (this.f8205a) {
            case 0:
                if (!b.c(UserConfig.selectedAccount, this.f8206b)) {
            ...
            case 1:
                ...
                return i6.l1(f10, i6.v0(i6.f18825ce, e6Var));
            default:
                if (!b.c(UserConfig.selectedAccount, this.f8206b)) {
                    if (z10) {
                        i11 = i6.f19113s8;
                ...
                return i6.l1(f11, i6.v0(i6.f18825ce, e6Var));
        }
    }
