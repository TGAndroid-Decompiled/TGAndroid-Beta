...
public final class h extends d7.m {
    public static final ThreadLocal f49694b = new ThreadLocal();
    public final ThreadPoolExecutor f49695a;
    ...
    public h() {
        ...
        this.f49695a = threadPoolExecutor;
        threadPoolExecutor.allowCoreThreadTimeOut(true);
    }

    @Override
    public final void execute(Runnable runnable) {
        Deque deque = (Deque) f49694b.get();
        ...
        this.f49695a.execute(new n(0, runnable));
    }
}
